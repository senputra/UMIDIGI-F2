...
typedef enum Bandwidth {
    Bandwidth_bandwidth_1_4_mhz = 1,
    Bandwidth_bandwidth_3_mhz   = 2,
    Bandwidth_bandwidth_5_mhz   = 3,
    Bandwidth_bandwidth_10_mhz  = 4,
    Bandwidth_bandwidth_15_mhz  = 5,
    Bandwidth_bandwidth_20_mhz  = 6
} e_Bandwidth;
