#ifndef __CLIENTAPI_PROXY_DISPATCHER_H__
#define __CLIENTAPI_PROXY_DISPATCHER_H__
...
/* initialize the connection with volte disapatcher and initlize the sip and event callbacl for CLIENTAPI */
int CLIENTAPI_Proxy_Init(void);



/* send SIP message to the Dispatcher */
int clientapi_send_sip_msg(char *sip_message_string, int length);
...
#endif /* __CLIENTAPI_PROXY_DISPATCHER_H__ */
