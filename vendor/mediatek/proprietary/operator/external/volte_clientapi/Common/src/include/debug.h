#ifndef __CLIENTAPI_DEBUG_H__
#define __CLIENTAPI_DEBUG_H__

#include <stdio.h>

#define SYSLOG
#define TAG         "CLIENTAPI_UA"
...
#define AutoTestMsg(tag, message, ...) __android_log_print(ANDROID_LOG_INFO,    "CLIENTAPI_Auto_Testing", "[%d][%s] " message, imcb_auto_testing_get_id(), tag, ##__VA_ARGS__)
