#ifndef __CLIENTAPI_PROXY_ADAPTER_H__
#define __CLIENTAPI_PROXY_ADAPTER_H__
...
//list of the CLIENTAPI proxy events
//b/w CLIENTAPI_proxy and CLIENTAPI_proxy_adapter
//the NAMES OF THE EVENT AND THEIR VALUE IS SAME IN JAVA CLASSES
enum CLIENTAPI_PROXY_Event_e
{
    /* ------------------------------------------------ */
    /*  CLIENTAPI_PROXY_ADAPTER --> CLIENTAPI_PROXY                 */
    /* ------------------------------------------------ */
    BASE = 20000,
...
/* clientapi proxt structure to store Reg state informatoins */
typedef struct _CLIENTAPI_PROXY_Event_Reg_State_
{
...
} CLIENTAPI_PROXY_Event_Reg_State;

typedef struct _CLIENTAPI_PROXY_Event_Reg_State2_
{
    INT32 id;           /* /< the account id */
    INT32 state;        /* /< refer to ::VoLTE_Event_Reg_State_e */
    INT32  clientapi_state;
    INT32  clientapi_feature;
...
} CLIENTAPI_PROXY_Event_Reg_State2;

/* initialize CLIENTAPI_adapter */
void CLIENTAPI_Proxy_adapter_Init_hal(int source_id);

/* temp fnction to send test event response back to clientapi_proxy_adapter */
...
#endif /* __CLIENTAPI_PROXY_ADAPTER_H__ */ /* __CLIENTAPI_PROXY__ADAPTER_H__ */
