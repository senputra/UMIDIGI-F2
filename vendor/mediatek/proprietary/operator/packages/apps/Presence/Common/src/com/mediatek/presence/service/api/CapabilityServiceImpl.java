...
public class CapabilityServiceImpl extends ICapabilityService.Stub {
    ...
    public Capabilities getMyCapabilities(int slotId) {
        ...
        caps.setGeolocationPushviaSmsSupport(capabilities.isGeolocationPushviaSmsSupported());
    ...
    public Capabilities getContactCapabilities(
        ...
        if (serviceActive && capabilities != null) {
            ...
            contactCapabilities.setTimestamp(capabilities.getTimestamp());
            contactCapabilities.setFileTransferThumbnailSupport(capabilities
                    .isFileTransferThumbnailSupported());
            contactCapabilities.setGeolocationPushviaSmsSupport(capabilities
                    .isGeolocationPushviaSmsSupported());
    ...
    public void receiveCapabilities(String contact, com.mediatek.presence.core.ims.service.capability.Capabilities capabilities) {
        synchronized(lock) {
            ...
            c.setStandaloneMsgSupport(capabilities.isStandaloneMsgSupport());
            c.setFileTransferThumbnailSupport(capabilities.isFileTransferThumbnailSupported());
            c.setGeolocationPushviaSmsSupport(capabilities.isGeolocationPushviaSmsSupported());
        ...
        try {
            Thread t = new Thread() {
                public void run() {
                    ...
                    presCaps.setGeolocationPushviaSmsSupport(caps.isGeolocationPushviaSmsSupported());
