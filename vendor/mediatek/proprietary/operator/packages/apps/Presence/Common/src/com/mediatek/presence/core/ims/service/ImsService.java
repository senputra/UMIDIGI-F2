...
public abstract class ImsService {
     ...
     * Capability service
     */
    public static final int PRESENCE_SERVICE = 1;
     ...
     * Presence service
     */
    public static final int CAPABILITY_SERVICE = 5;
     ...
     */
    public abstract void onForbiddenReceived(ImsModule.EabActions action, String reason);

    public abstract void onNotProvisionedReceived();
    ...
    public void sendErrorResponse(SipRequest invite, int error) {
        try {
            ...
            SipResponse resp = SipMessageFactory.createResponse(slotId, contactHeader, invite, IdGenerator.getIdentifier(), error);
