...
public class Op20CellbroadcastReceiverCustomizationFactory extends OpCmasCustomizationFactoryBase {
    public Context mContext;

    public Op20CellbroadcastReceiverCustomizationFactory(Context context) {
        mContext = context;
    }

    @Override
    public ICmasMainSettingsExt makeCmasMainSettings(Context context) {
        return new OP20CmasMainSettingsExt(mContext);
    }

    @Override
    public ICmasMessageInitiationExt makeCmasMessageInitiation(Context context) {
        return new OP20CmasMessageInitiationExt(context);
    }
