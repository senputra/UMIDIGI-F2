...
public class OP20CmasMainSettingsExt extends DefaultCmasMainSettingsExt {

    private static final String TAG = "CellBroadcastReceiver/OP20CmasMainSettingsExt";
    ...
    public OP20CmasMainSettingsExt(Context context) {
        super(context);
        mContext = context;
        Log.i(TAG, "Load OP20 CmasMainSetting Plugin");
    }
   ...
   /**
    ...
    public void addNewChannelAlertsSetting(PreferenceFragment fragment,
        ...
        Log.i(TAG, "public Safty alert added isPublicSaftyEnable = " + isPublicSaftyEnable);
