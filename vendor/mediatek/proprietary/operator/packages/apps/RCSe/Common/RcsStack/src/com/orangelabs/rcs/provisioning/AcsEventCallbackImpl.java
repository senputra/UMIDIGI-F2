...
public class AcsEventCallbackImpl {
    ...
    private void resetRcsCapabilities() {
        logger.debug("resetRcsCapabilities");
        RcsSettings settings = RcsSettings.getInstance();
        settings.writeParameter(RcsSettingsData.CAPABILITY_IM_SESSION, RcsSettingsData.FALSE);
        settings.writeParameter(RcsSettingsData.CAPABILITY_FILE_TRANSFER, RcsSettingsData.FALSE);
        settings.writeParameter(RcsSettingsData.CAPABILITY_VIDEO_SHARING, RcsSettingsData.FALSE);
        settings.writeParameter(RcsSettingsData.CAPABILITY_IMAGE_SHARING, RcsSettingsData.FALSE);
        settings.writeParameter(RcsSettingsData.CAPABILITY_GEOLOCATION_PUSH, RcsSettingsData.FALSE);
        settings.writeParameter(RcsSettingsData.CAPABILITY_IP_VOICE_CALL, RcsSettingsData.FALSE);
        settings.writeParameter(RcsSettingsData.CAPABILITY_IP_VIDEO_CALL, RcsSettingsData.FALSE);
        settings.writeParameter(RcsSettingsData.STANDALONE_MSG_SUPPORT, RcsSettingsData.FALSE);
        settings.writeParameter(RcsSettingsData.CAPABILITY_FILE_TRANSFER_THUMBNAIL, RcsSettingsData.FALSE);
        settings.writeParameter(RcsSettingsData.FT_HTTP_SERVER, "");
    }
}
