...
public class Capabilities implements Parcelable {
    ...
    /**
     * Geolocation pushVia Sms support
     */
    private boolean geolocPushviaSms = false;
    ...
    public Capabilities(Parcel source) {
        ...
        this.chatbot = source.readInt() != 0;
        this.chatbotSa = source.readInt() != 0;
        this.callcomposer = source.readInt() != 0;
        this.geolocPushviaSms = source.readInt() != 0;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(chatbot ? 1 : 0);
        dest.writeInt(chatbotSa ? 1 : 0);
        dest.writeInt(callcomposer ? 1 : 0);
        dest.writeInt(geolocPushviaSms ? 1 : 0);
    }
    ...
    public boolean isGeolocationPushviaSmsSupported() {
        Logger.i(TAG, "isGeolocationPushviaSmsSupported value " + geolocPushviaSms);
        return geolocPushviaSms;
    }

    /**
     * Set the Geolocation Push Via SMS support
     *
     * @param supported Supported
     */
    public void setGeolocationPushviaSmsSupport(boolean supported) {
        this.geolocPushviaSms = supported;
    }
