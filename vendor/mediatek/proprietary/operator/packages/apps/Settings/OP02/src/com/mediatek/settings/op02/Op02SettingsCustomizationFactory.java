...
import com.mediatek.settings.ext.INetworkSettingExt;
import com.mediatek.settings.ext.ISimManagementExt;
import com.mediatek.settings.ext.OpSettingsCustomizationFactoryBase;

public class Op02SettingsCustomizationFactory extends
        OpSettingsCustomizationFactoryBase {

    private static String TAG = "Op02SettingsCustomizationFactory";

    private Context mContext;

    public Op02SettingsCustomizationFactory(Context context) {
        super(context);
        Log.d(TAG, "Op02SettingsCustomizationFactory, context=" + context);
        mContext = context;
    }
    ...
    public IApnSettingsExt makeApnSettingsExt(Context context) {
        ...
        return new OP02ApnSettingsExt(context);
    }

    @Override
    public INetworkSettingExt makeNetworkSettingExt(Context context) {
        Log.d(TAG, "makeNetworkSettingExt, context=" + mContext);
    ...
    public IMobileNetworkSettingsExt makeMobileNetworkSettingsExt(Context context) {
        Log.d(TAG, "makeNetworkSettingExt, context=" + mContext);
        return new OP02MobileNetworkSettingsExt(mContext);
    }
}
