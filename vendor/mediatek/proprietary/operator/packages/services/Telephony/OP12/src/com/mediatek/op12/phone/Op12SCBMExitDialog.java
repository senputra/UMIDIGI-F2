                    ...
                    .setPositiveButton(R.string.alert_dialog_yes,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    // User clicked Yes. Send an Inten to exit SCBM
                                    Intent intent = new Intent(
                                            TelephonyIntents.ACTION_EXIT_SCBM);
                                    SubscriptionManager.putPhoneIdAndSubIdExtra(intent, mPhoneId);
                                    Op12SCBMExitDialog.this.sendBroadcastAsUser(
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(
                ...
                if (intent.getBooleanExtra("phoneinSCMState", false) == false) {
                    ...
                    mPhoneId = intent.getIntExtra(PhoneConstants.PHONE_KEY, 0);
                    Log.d(TAG, "ACTION_SCBM_CHANGED true. phoneId =" + mPhoneId);
                }
            }
        }
    };
