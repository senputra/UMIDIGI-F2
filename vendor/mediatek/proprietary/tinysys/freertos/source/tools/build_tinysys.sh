...
TINYSYS_ANDROID_MK="${TINYSYS_ROOT}/source/Android.mk"
CLEAN_TARGET=0
...
# Here we build
#######################################
BUILD_CMD="ONE_SHOT_MAKEFILE=${TINYSYS_ANDROID_MK} make ${SCP_TARGET} ${ADSP_TARGET} ${CMD_ARGS}"
CLEAN_CMD="ONE_SHOT_MAKEFILE=${TINYSYS_ANDROID_MK} make ${CLEAN_SCP_TARGET} ${CLEAN_ADSP_TARGET} ${CMD_ARGS}"
