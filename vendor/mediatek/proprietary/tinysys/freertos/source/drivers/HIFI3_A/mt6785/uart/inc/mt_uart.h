...
#define INFO_SCP_LOG_THRU_AP_UART  1


#define UART0_BASE          ADSP_UART_BASE
...
#ifndef CONFIG_MTK_FPGA
#define UART_LOG_BAUD_RATE  (921600) //use in real chip
#else
#define UART_LOG_BAUD_RATE  (460800) //use in FPGA
#endif
