...
void uart_platform_setting(void)
{
    ...
    UART_SET_BITS(CLK_AP_CG_CTRL_CLR, CLK_AP_UART0_CLK);
#else
    ...
    /* scpuart1 backup. GPIO200 as TP_URXD2_AO, GPIO201 as TP_UTXD2_AO */
    DRV_WriteReg32(0xA0005490, (DRV_Reg32(0xA0005490)&0xFFFFFF88)|0x00000055);
    ...
    /* scpuart1 backup. GPIO200 as TP_URXD1_AO, GPIO201 as TP_UTXD1_AO */
    DRV_WriteReg32(0xA0005490, (DRV_Reg32(0xA0005490)&0xFFFFFF88)|0x00000033);
