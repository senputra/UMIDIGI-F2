...
#define SW_TRIGGER_26M_TO_NORMAL    1
...
#define MT6359_PMIC_REG_BASE (0x0)
#define MT6359_BUCK_VCORE_SSHUB_CON0        ((unsigned int)(MT6359_PMIC_REG_BASE+0x152a))
#define PMIC_RG_BUCK_VCORE_SSHUB_VOSEL_ADDR         MT6359_BUCK_VCORE_SSHUB_CON0
#define PMIC_RG_BUCK_VCORE_SSHUB_VOSEL_MASK         0x7f
#define PMIC_RG_BUCK_VCORE_SSHUB_VOSEL_SHIFT        4

#define MT6359_LDO_VSRAM_OTHERS_SSHUB        ((unsigned int)(MT6359_PMIC_REG_BASE+0x1f26))
#define PMIC_RG_LDO_VSRAM_OTHERS_SSHUB_VOSEL_ADDR         MT6359_LDO_VSRAM_OTHERS_SSHUB
#define PMIC_RG_LDO_VSRAM_OTHERS_SSHUB_VOSEL_MASK         0x7f
#define PMIC_RG_LDO_VSRAM_OTHERS_SSHUB_VOSEL_SHIFT        1

#define MT6359_BUCK_VCORE_SSHUB_CON0        ((unsigned int)(MT6359_PMIC_REG_BASE+0x152a))
#define PMIC_RG_BUCK_VCORE_SSHUB_EN_ADDR         MT6359_BUCK_VCORE_SSHUB_CON0
#define PMIC_RG_BUCK_VCORE_SSHUB_EN_MASK         0x1
#define PMIC_RG_BUCK_VCORE_SSHUB_EN_SHIFT        0

#define MT6359_LDO_VSRAM_OTHERS_SSHUB  ((unsigned int)(MT6359_PMIC_REG_BASE+0x1f26))
#define PMIC_RG_LDO_VSRAM_OTHERS_SSHUB_EN_ADDR   MT6359_LDO_VSRAM_OTHERS_SSHUB
...
#define REQ_26M_WAIT_TIME_US    1053
#define REQ_INFRA_WAIT_TIME_US  150
#define REQ_DRAM_WAIT_TIME_US   385
...
enum {
    FREQ_METER_ABIST_AD_OSC_CK = 38,
    FREQ_METER_ABIST_AD_OSC_CK_2 = 37,
};
...
extern void enable_dram_resource_for_dmgr(scp_reserve_mem_id_t dma_id);
extern int32_t get_dram_ack_from_isr_for_dmgr(void);
