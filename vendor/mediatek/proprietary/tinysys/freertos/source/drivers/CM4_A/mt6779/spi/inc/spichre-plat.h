...
#define SCP_SPI0_GPIO_BASE    (SCP_GPIO_BASE + 0x400)

#define SCP_SPI1_GPIO_BASE    (SCP_GPIO_BASE + 0x350)
#define SCP_SPI1_GPIO_BASE2    (SCP_GPIO_BASE + 0x360)

#define SCP_SPI2_GPIO_BASE    (SCP_GPIO_BASE + 0x300)
#define SCP_SPI2_GPIO_BASE2    (SCP_GPIO_BASE + 0x3F0)
