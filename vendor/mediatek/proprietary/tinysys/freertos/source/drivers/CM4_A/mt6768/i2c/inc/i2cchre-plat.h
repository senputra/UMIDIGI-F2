...
enum I2C_REGS_OFFSET {
    ...
    OFFSET_AED_PATCH = 0x80,
    OFFSET_DCM_EN = 0xf88,

    /*v2 add*/
    OFFSET_TRAFFIC = 0x54,
    OFFSET_COMMAND = 0x58,
    OFFSET_CRC_CODE_ = 0x5c,
    OFFSET_TERNARY = 0x60,
    OFFSET_IBI_TIMING = 0x64,
    OFFSET_SHAPE = 0x6c,
    OFFSET_HFIFO_DATA = 0x70,
    OFFSET_ERROR = 0x84,
    OFFSET_DELAY_STEP = 0xd4,
    OFFSET_DELAY_SAMPLE = 0xd8,
    OFFSET_DMA_INFO = 0xdc,
    OFFSET_IRQ_INFO = 0xe0,
    OFFSET_DMA_FSM_DEBUG = 0xec,
    OFFSET_HFIFO_STAT = 0xfc,
    OFFSET_ROLLBACK = 0xf98,

    /*not in v2*/
    OFFSET_PATH_DIR = 0xfff, /*0x60*/
};
