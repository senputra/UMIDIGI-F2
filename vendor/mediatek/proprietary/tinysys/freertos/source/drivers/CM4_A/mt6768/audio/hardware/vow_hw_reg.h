...
#define ECHO_DELAY_FRM                  (1)
#define ECHO_DELAY_SAMPLE               (110)
#define VOW_ECHO_SW_SRC
#define ECHO_REF_NONSRC_BUF_LEN         (0x1E0 * 4)   // 48kSampleRate, 40msec
#define ECHO_REF_NONSRC_FRM_LEN         (0x1E0)

#define BLISRC_ECHO_INPUT_SAMPLING_RATE_IN_HZ   (48000)
#define BLISRC_ECHO_OUTPUT_SAMPLING_RATE_IN_HZ  (16000)
#define BLISRC_ECHO_INTERNAL_BUFFER_WORD_SIZE   (526)

#define BLISRC_ECHO_INPUT_BUFFER_SIZE_IN_HALF_WORD       (480)
#define BLISRC_ECHO_OUTPUT_BUFFER_SIZE_IN_HALF_WORD      (160)  // 10msec voice data
#endif
