...
#define SCP_GPIO_BASE    (0xA0005000) //Notice: AP 0x1xxx_xxxx map to scp 0xAxxx_xxxx (256MB)

#define SCP_SPI0_GPIO_BASE    (SCP_GPIO_BASE + 0x310)
#define SCP_SPI0_GPIO_BASE_2    (SCP_GPIO_BASE + 0x320)
#define SCP_SPI0_GPIO_BASE_3    (SCP_GPIO_BASE + 0x330)

#define SCP_SPI1_GPIO_BASE    (SCP_GPIO_BASE + 0x300)
...
void spi_gpio_set(uint32_t id, int pad_select);
#endif
void spi_init(void);
