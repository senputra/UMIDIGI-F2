...
#define SCP_SPI0_GPIO_BASE    (SCP_GPIO_BASE + 0x3A0)
#define SCP_SPI0_CLK_BASE    (SCP_GPIO_BASE + 0x3B0)

#define SCP_SPI1_GPIO_BASE    (SCP_GPIO_BASE + 0x440)

#define SCP_SPI2_GPIO_BASE    (SCP_GPIO_BASE + 0x300)
#define SCP_SPI2_MI_GPIO_BASE    (SCP_GPIO_BASE + 0x3B0)
