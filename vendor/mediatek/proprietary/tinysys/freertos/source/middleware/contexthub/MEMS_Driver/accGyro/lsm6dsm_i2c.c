...
#define I2C_BUF_SIZE    ((FIFO_DATA_SIZE + 4) + (TEMPERATURE_SIZE + 4) + 4)
...
static struct LSM6DSMTask {
    ...
    uint8_t wakeupBuffer[1];
    uint8_t tempStatusBuffer[1];
    ...
    uint8_t txrxBuffer[I2C_BUF_SIZE];
    uint16_t mWbufCnt;
    uint8_t mRegCnt;
    uint8_t mRetryLeft;
#ifdef CFG_HW_STEP_COUNTER_SUPPORT
                            ...
                            void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    if (!mTask.sensors[ACC].powered) {
        ...
        mTask.txBuf[0] = LSM6DSM_CTRL6_C_ADDR;
        mTask.txBuf[1] = LSM6DSM_CTRL6_C_BASE | LSM6DSM_XL_LOWPOWER_MODE;
    ...
    if (!mTask.sensors[ACC].configed) {
        if (mTask.sensors[GYR].configed && (mTask.sensors[GYR].hwRate >= SENSOR_HZ(52.0f))) {
            ...
            mTask.txBuf[0] = LSM6DSM_CTRL1_XL_ADDR;
            mTask.txBuf[1] = LSM6DSM_CTRL1_XL_BASE | LSM6DSM_ODR_52HZ_REG_VALUE;
            i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                               NULL, 0, NULL, NULL, 25);
            ...
            mTask.txBuf[0] = LSM6DSM_CTRL1_XL_ADDR;
            mTask.txBuf[1] = LSM6DSM_CTRL1_XL_BASE | LSM6DSM_ODR_12HZ_REG_VALUE;
            i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                               NULL, 0, NULL, NULL, 25);
    ...
    mTask.txBuf[0] = LSM6DSM_WAKE_UP_DUR_ADDR;
    mTask.txBuf[1] = LSM6DSM_WAKE_UP_DUR_BASE;
    i2cMasterTx(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2, NULL, NULL);
    mTask.txBuf[0] = LSM6DSM_WAKE_UP_THS;
    mTask.txBuf[1] = 0x01;
    i2cMasterTx(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2, NULL, NULL);
    mTask.txBuf[0] = LSM6DSM_TAP_CFG_ADDR;
    mTask.txBuf[1] = LSM6DSM_TAP_CFG_BASE | LSM6DSM_TAP_INTERRUPTS_ENABLE;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, delay);
    mTask.txBuf[0] = LSM6DSM_MD1_CFG_ADDR;
    mTask.txBuf[1] = LSM6DSM_MD1_CFG_BASE | LSM6DSM_WU_INIT1_ENABLE;
                             ...
                             void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    mTask.txBuf[0] = LSM6DSM_MD1_CFG_ADDR;
    mTask.txBuf[1] = LSM6DSM_MD1_CFG_BASE;
    i2cMasterTx(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2, NULL, NULL);
    mTask.txBuf[0] = LSM6DSM_TAP_CFG_ADDR;
    mTask.txBuf[1] = LSM6DSM_TAP_CFG_BASE;
    i2cMasterTx(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2, NULL, NULL);
...
#endif
        mTask.txBuf[0] = LSM6DSM_CTRL1_XL_ADDR;
        mTask.txBuf[1] = LSM6DSM_CTRL1_XL_BASE;
        i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                           NULL, 0, i2cCallBack, next_state, 25);
        osLog(LOG_INFO, "anyMotionPowerOff, acc off, set power down mode\n");
    } else {
        mTask.txBuf[0] = LSM6DSM_WAI_ADDR;
        i2cMasterTxRx(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 1, mTask.rxBuf, 1, i2cCallBack, next_state);
    }
    return 0;
}
                            ...
                            void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    if (!mTask.sensors[ACC].powered && !mTask.sensors[STEPCNT].powered) {
        ...
        mTask.txBuf[0] = LSM6DSM_CTRL6_C_ADDR;
        mTask.txBuf[1] = LSM6DSM_CTRL6_C_BASE;
        i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                           NULL, 0, NULL, NULL, 25);
        mTask.txBuf[0] = LSM6DSM_CTRL1_XL_ADDR;
        mTask.txBuf[1] = LSM6DSM_CTRL1_XL_BASE | LSM6DSM_ODR_26HZ_REG_VALUE;
        i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                           NULL, 0, NULL, NULL, 25);
    ...
    mTask.txBuf[0] = LSM6DSM_CTRL10_C_ADDR;
    mTask.txBuf[1] = LSM6DSM_CTRL10_C_BASE | LSM6DSM_CTRL10_C_FUNC_EN | LSM6DSM_CTRL10_C_PEDO_EN;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                             ...
                             void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    mTask.txBuf[0] = LSM6DSM_CTRL10_C_ADDR;
    mTask.txBuf[1] = LSM6DSM_CTRL10_C_BASE;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 5);
    ...
    if (!mTask.sensors[ACC].powered && !mTask.sensors[ANYMO].powered) {
        ...
        mTask.txBuf[1] = LSM6DSM_CTRL1_XL_BASE;
        i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                           NULL, 0, i2cCallBack, next_state, 5000);
...
static int stepCntGetData(I2cCallbackF i2cCallBack, SpiCbkF spiCallBack, void *next_state,
                          ...
                          void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    mTask.txBuf[0] = LSM6DSM_STEP_COUNTER_L_ADDR;
    return i2cMasterTxRx(mTask.hw->i2c_num, mTask.i2c_addr, &mTask.txBuf[0], 1,
                         &mTask.stepBuffer, 2, i2cCallBack,
                         next_state);
}
                             ...
                             void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    if (!mTask.accGyroPowerd) {
        ...
        mTask.txBuf[0] = LSM6DSM_INT1_CTRL_ADDR;
        mTask.txBuf[1] = LSM6DSM_INT1_CTRL_BASE;
        i2cMasterTx(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2, i2cCallBack, next_state);
    } else {
        mTask.txBuf[0] = LSM6DSM_WAI_ADDR;
        i2cMasterTxRx(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 1, mTask.rxBuf, 1, i2cCallBack, next_state);
                              ...
                              void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    if (!mTask.accGyroPowerd) {
        ...
        mTask.txBuf[0] = LSM6DSM_INT1_CTRL_ADDR;
        mTask.txBuf[1] = LSM6DSM_INT1_CTRL_BASE;
        i2cMasterTx(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2, i2cCallBack,
                    next_state);
    } else
        sensorFsmEnqueueFakeI2cEvt(i2cCallBack, next_state, SUCCESS_EVT);
    /*
    ...
    if (min_latency == SENSOR_LATENCY_NODATA) {
        ...
        for (handle = ACC; handle <= GYR; handle++) {
            if (mTask.sensors[handle].hwRate) {
                ...
                osLog(LOG_INFO, "lsm6dsmCalcuWm_Decimation, delay=%d, latency:%lld, min_wm=%d, total_cnt=%d\n",
...
static void lsm6dsmConfigFifo(bool odr_change)
{
    ...
    if (odr_change) {
        ...
        mTask.txBuf[0] = LSM6DSM_FIFO_CTRL1_ADDR;
        mTask.txBuf[1] = buffer[0];
        i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                           NULL, 0, NULL, NULL, 5);

        mTask.txBuf[0] = LSM6DSM_FIFO_CTRL2_ADDR;
        mTask.txBuf[1] = buffer[1];
        i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                           NULL, 0, NULL, NULL, 5);

        mTask.txBuf[0] = LSM6DSM_FIFO_CTRL3_ADDR;
        mTask.txBuf[1] = buffer[2];
        i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                           NULL, 0, NULL, NULL, 5);

        mTask.txBuf[0] = LSM6DSM_FIFO_CTRL5_ADDR;
        mTask.txBuf[1] = LSM6DSM_FIFO_BYPASS_MODE;
        i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                           NULL, 0, NULL, NULL, 50);
                          ...
                          void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    osLog(LOG_ERROR, "lsm6dsmAccRate\n");
    ...
    if (mTask.sensors[GYR].configed) {
        ...
        if ((maxRate != mTask.sensors[ACC].hwRate) || (maxRate != mTask.sensors[GYR].hwRate)) {
            ...
            osLog(LOG_ERROR, "delay:%u, odr:%d, rate:%u\n", delay, odr, mTask.sensors[ACC].hwRate);
            ...
            mTask.txBuf[0] = LSM6DSM_CTRL1_XL_ADDR;
            mTask.txBuf[1] = LSM6DSM_CTRL1_XL_BASE | regValue;
            i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                               NULL, 0, NULL, NULL, 30);
            mTask.txBuf[0] = LSM6DSM_CTRL2_G_ADDR;
            mTask.txBuf[1] = LSM6DSM_CTRL2_G_BASE | regValue;
            i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                               NULL, 0, NULL, NULL, 30);
    ...
    if (mTask.sensors[ANYMO].powered) {
        mTask.txBuf[0] = LSM6DSM_TAP_CFG_ADDR;
        mTask.txBuf[1] = LSM6DSM_TAP_CFG_BASE | LSM6DSM_TAP_INTERRUPTS_ENABLE;
        osLog(LOG_ERROR, "only acc delay:%u, odr:%d, rate:%u\n", delay, odr, mTask.sensors[ACC].hwRate);
        i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                           NULL, 0, NULL, NULL, delay);
        mTask.txBuf[0] = LSM6DSM_MD1_CFG_ADDR;
        mTask.txBuf[1] = LSM6DSM_MD1_CFG_BASE | LSM6DSM_WU_INIT1_ENABLE;
                              ...
                              void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    if (mTask.sensors[GYR].powered == false) {
        ...
        if (mTask.sensors[GYR].hwRate != mTask.sensors[GYR].preRealRate) {
            ...
            i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                               NULL, 0, NULL, NULL, 30);
            osLog(LOG_INFO, "lsm6dsmAccPowerOff, gyro change rate to preRealRate:%d\n", mTask.sensors[GYR].hwRate);
        }
    }
                               ...
                               void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    if (mTask.sensors[ACC].powered == false) {
        ...
        if (mTask.sensors[ACC].hwRate != mTask.sensors[ACC].preRealRate) {
            ...
            i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                               NULL, 0, NULL, NULL, 30);
            osLog(LOG_INFO, "lsm6dsmGyroPowerOff, acc change rate to preRealRate:%d\n", mTask.sensors[ACC].hwRate);
        }
    }
    mTask.txBuf[0] = LSM6DSM_CTRL2_G_ADDR;
    mTask.txBuf[1] = LSM6DSM_CTRL2_G_BASE;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 30);
...
{
    if (mTask.sensors[ANYMO].powered) {
        // osLog(LOG_INFO, "lsm6dsmIntStatusCheck1\n");
        mTask.txBuf[0] = LSM6DSM_WAKEUP_SRC_ADDR;
        i2cMasterTxRx(mTask.hw->i2c_num, mTask.i2c_addr, &mTask.txBuf[0], 1,
                      &mTask.wakeupBuffer[0], 1, NULL,
                      NULL);

    }
    mTask.txBuf[0] = LSM6DSM_FIFO_STATUS2_ADDR;
    return i2cMasterTxRx(mTask.hw->i2c_num, mTask.i2c_addr, &mTask.txBuf[0], 1,
                         &mTask.statusBuffer[0], 1, i2cCallBack,
                         next_state);
                              ...
                              void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    uint8_t fifo_status_2 = mTask.statusBuffer[0];
    uint8_t regValue;
    // osLog(LOG_INFO, "lsm6dsmIntHandling, fifo_status_2:0x%x\n", fifo_status_2);

    if (mTask.sensors[ANYMO].powered) {
        uint8_t anymo_status = mTask.wakeupBuffer[0];
    ...
    if ((fifo_status_2 & LSM6DSM_FIFO_STATUS2_FIFO_ERROR) == 0) {
        ...
        if ((fifo_status_2 & LSM6DSM_FIFO_STATUS2_FIFO_FULL_SMART)
            ...
            mTask.txBuf[1] = regValue;
            i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                               NULL, 0, i2cCallBack, next_state, 2);
        } else {
                         ...
                         void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    mTask.txBuf[0] = LSM6DSM_FIFO_STATUS1_ADDR;
    i2cMasterTxRx(mTask.hw->i2c_num, mTask.i2c_addr, &mTask.txBuf[0], 1,
                  &mTask.statusBuffer[0], 2, NULL, NULL);

    mTask.txBuf[0] = LSM6DSM_STATUS_REG_ADDR;
    i2cMasterTxRx(mTask.hw->i2c_num, mTask.i2c_addr, &mTask.txBuf[0], 1,
                  &mTask.tempStatusBuffer[0], 1, i2cIsrCallBack,
                  next_state);
                           ...
                           void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    uint8_t fifo_status_1 = mTask.statusBuffer[0];
    uint8_t fifo_status_2 = mTask.statusBuffer[1];
    uint8_t temp_status = mTask.tempStatusBuffer[0];
    uint16_t tmp = 0;
    uint32_t maxRate = 0;
    ...
    if (temp_status & 0x04) {
        ...
        mTask.txBuf[0] = LSM6DSM_OUT_TEMP_L_ADDR;
        i2cMasterTxRx(mTask.hw->i2c_num, mTask.i2c_addr, &mTask.txBuf[0], 1,
                      &mTask.tempBuffer[0], 2, NULL, NULL);
    } else
        mTask.tempReady = false;

    mTask.txBuf[0] = LSM6DSM_FIFO_DATA_OUT_L_ADDR;
    if (mTask.fifoDataToRead < 8)
        i2cMasterTxRx(mTask.hw->i2c_num, mTask.i2c_addr, &mTask.txBuf[0], 1,
                      &mTask.txrxBuffer[0], mTask.fifoDataToRead, i2cCallBack, next_state);
    else {
        i2cMasterTxRx(mTask.hw->i2c_num, mTask.i2c_addr, &mTask.txBuf[0], 1,
                      NULL, 0, NULL, NULL);
...
static void parseRawData(struct accGyroData *data, uint8_t *buf, uint8_t sensorType)
{
    ...
    if (sensorType == SENS_TYPE_ACCEL) {
        ...
        // osLog(LOG_INFO, "ACCEL:x=%f, y=%f, z=%f\n",
        ...
        // osLog(LOG_INFO, "GYRO:x=%f, y=%f, z=%f\n",
        //    (double)temp_data[AXIS_X], (double)temp_data[AXIS_Y], (double)temp_data[AXIS_Z]);
                          ...
                          void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    uint8_t *fifo_data = &mTask.txrxBuffer[0];

    uint16_t fifo_offset = 0;
    uint8_t gyro_sip, accel_sip;
    int16_t temperature16 = 0;
    float temperature = 0;
    //osLog(LOG_INFO, "GYR Discard:%d, ACC Discard:%d\n",
...
#endif
    if (mTask.tempReady) {
        uint16_t temp_h = mTask.tempBuffer[1];
        uint16_t temp_l = mTask.tempBuffer[0];
                          ...
                          void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    mTask.txBuf[0] = LSM6DSM_CTRL3_C_ADDR;
    mTask.txBuf[1] = LSM6DSM_SW_RESET;
                          ...
                          void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
...
#if 1
    //mTask.debug_trace = 1;
    /*disable access embed reg*/
    mTask.txBuf[0] = LSM6DSM_FUNC_CFG_ACCESS_ADDR;
    mTask.txBuf[1] = LSM6DSM_FUNC_CFG_ACCESS_BASE;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 50);
    /*bit 8 latched mode*/
    mTask.txBuf[0] = LSM6DSM_DRDY_PULSE_CFG_ADDR;
    mTask.txBuf[1] = LSM6DSM_DRDY_PULSE_CFG_BASE;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 1000);
    /*acc power down +-8g, bandwidth = odr/4*/
    mTask.txBuf[0] = LSM6DSM_CTRL1_XL_ADDR;
    mTask.txBuf[1] = LSM6DSM_CTRL1_XL_BASE;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 1000);
    /*gyro power down 2000dps*/
    mTask.txBuf[0] = LSM6DSM_CTRL2_G_ADDR;
    mTask.txBuf[1] = LSM6DSM_CTRL2_G_BASE;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 1000);
    ...
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 1000);
    mTask.txBuf[0] = LSM6DSM_FUNC_CFG_ACCESS_ADDR;
    mTask.txBuf[1] = LSM6DSM_FUNC_CFG_ACCESS_FUNC_CFG_EN;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 1000);

    mTask.txBuf[0] = LSM6DSM_PEDO_THS_REG;
    mTask.txBuf[1] = 0x8E;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 1000);
    ...
    /*BDU INC*/
    mTask.txBuf[0] = LSM6DSM_CTRL3_C_ADDR;
    mTask.txBuf[1] = LSM6DSM_CTRL3_C_BASE;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 1000);
    /*signal on int1, I2C enable*/
    mTask.txBuf[0] = LSM6DSM_CTRL4_C_ADDR;
    mTask.txBuf[1] = LSM6DSM_CTRL4_C_BASE;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 1000);

    mTask.txBuf[0] = LSM6DSM_CTRL5_C_ADDR;
    mTask.txBuf[1] = LSM6DSM_CTRL5_C_BASE;
    i2cMasterTxRxDelay(mTask.hw->i2c_num, mTask.i2c_addr, mTask.txBuf, 2,
                       NULL, 0, NULL, NULL, 1000);
                                   ...
                                   void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    osLog(LOG_INFO, "lsm6dsmEintRegistration\n");
...
int lsm6dsmInit(void)
{
    ...
    mTask.i2c_addr = (uint32_t)mTask.hw->i2c_addr[0];
    osLog(LOG_INFO, "acc i2c_num: %d, i2c_addr: %u\n", mTask.hw->i2c_num, mTask.i2c_addr);
