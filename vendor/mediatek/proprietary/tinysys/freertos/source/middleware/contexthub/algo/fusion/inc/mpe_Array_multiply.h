...
int get_Eigenvalue2x2_double(double *matrixA, double *eVal, double *eVec);
void ABAT_double(double *matrixA,double *matrixB,double *matrixC,int sizeAR,int sizeAC,int sizeBR,int sizeBC);
