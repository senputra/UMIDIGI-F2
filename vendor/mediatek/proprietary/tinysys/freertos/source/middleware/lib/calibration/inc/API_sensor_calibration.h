...
*   None
*****************************************************************************/
void Acc_init_calibration( MPE_SENSOR_DATA bias );
...
*   None
*****************************************************************************/
void Gyro_init_calibration( MPE_SENSOR_DATA bias );
...
*   success(0) or fail(-1)
*****************************************************************************/
int Acc_run_calibration(int dt, int data_count, MPE_SENSOR_DATA * raw_data_input, MPE_SENSOR_DATA * calibrated_data_output, int *calibrate_acc );
...
*   success(0) or fail(-1)
*****************************************************************************/
int Gyro_run_calibration(int dt, int data_count, MPE_SENSOR_DATA * raw_data_input, MPE_SENSOR_DATA * calibrated_data_output, int *calibrate_acc );
