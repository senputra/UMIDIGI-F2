...
typedef enum {
    ...
    BLISRC_IN_Q9P23_OUT_Q9P23 = 4    // 32-bit Q9.23 input, 32-bit Q9.23 output
} BLISRC_PCM_FORMAT;
...
|                                   4 (BLISRC_IN_Q9P23_OUT_Q9P23):
|                                       32-bit Q9.23 input, 32-bit Q9.23 output
|**************************************************************************************/
typedef struct {
...
/*
    ...
    p_in_byte_cnt [I] Valid input buffer size in bytes
                  [O] Remained input buffer size in bytes
