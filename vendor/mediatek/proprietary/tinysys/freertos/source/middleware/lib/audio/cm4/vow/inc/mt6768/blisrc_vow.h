...
#ifndef __BLISRC_VOW_H__
#define __BLISRC_VOW_H__
...
/********************************************************************************************\
|   Function:                                                                                |
|       blisrc_vow_get_buffer_size                                                           |
|                                                                                            |
|   Description:                                                                             |
|       Get the required internal buffer size for BLISRC VOW SWIP.                           |
|                                                                                            |
|   Return Value:                                                                            |
...
|                                                                                            |
|   Description:                                                                             |
|       Open BLISRC VOW SWIP handle with the given initial parameters.                       |
|                                                                                            |
|   Parameters:                                                                              |
