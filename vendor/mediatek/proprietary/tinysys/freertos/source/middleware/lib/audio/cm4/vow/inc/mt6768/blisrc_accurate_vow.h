 ...
 * Description:
 * ------------
 *   BLISRC Interface for ACCURATE VOW
 *
 * Author:
 * -------
 *   Scholar Chang
...
#ifndef __BLISRC_ACCURATE_VOW_H__
#define __BLISRC_ACCURATE_VOW_H__
...
} blisrc_accurate_vow_init_param_t;

/********************************************************************************************\
|   Function:                                                                                |
|       blisrc_accurate_vow_get_buffer_size                                                  |
|                                                                                            |
|   Description:                                                                             |
|       Get the required internal buffer size for BLISRC ACCURATE VOW SWIP.                  |
|                                                                                            |
|   Return Value:                                                                            |
|       Internal buffer size (unit: byte)                                                    |
|                                                                                            |
\********************************************************************************************/
uint32_t blisrc_accurate_vow_get_buffer_size (void);

/********************************************************************************************\
|   Function:                                                                                |
|       blisrc_accurate_vow_open                                                             |
|                                                                                            |
|   Description:                                                                             |
|       Open BLISRC ACCURATE VOW SWIP handle with the given initial parameters.              |
|                                                                                            |
|   Parameters:                                                                              |
...
|                                                                                            |
\********************************************************************************************/
int32_t blisrc_accurate_vow_open (void **p_handle,
                                  uint8_t *p_internal_buf,
                                  blisrc_accurate_vow_init_param_t *p_param);

/********************************************************************************************\
|   Function:                                                                                |
|       blisrc_accurate_vow_process                                                          |
|                                                                                            |
|   Description:                                                                             |
|       Process the BLISRC ACCURATE VOW SWIP.                                                |
|                                                                                            |
|   Parameters:                                                                              |
...
|                                                                                            |
\********************************************************************************************/
int32_t blisrc_accurate_vow_process (void *handle,
                                     int16_t *p_in_buf,
                                     uint32_t *available_in_size,
                                     int16_t *p_ou_buf,
                                     uint32_t *available_ou_size);

#endif  /* __BLISRC_ACCURATE_VOW_H__ */
