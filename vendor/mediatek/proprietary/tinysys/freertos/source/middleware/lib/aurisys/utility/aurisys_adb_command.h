...
#define MAX_ADB_CMD_TYPE_DATA_SIZE (512)
#define MAX_ADB_CMD_KEY_VALUE_SIZE (512)
...
struct aurisys_adb_command_t *parse_adb_cmd(uint8_t *data_buf, uint32_t data_size);
