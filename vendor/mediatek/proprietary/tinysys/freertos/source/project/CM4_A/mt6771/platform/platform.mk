...
# Heap size config
###################################################################
$(eval TOTAL_HEAP_SIZE=$(shell echo $$(((45 * 1024)))))
...
FEATURE_INCLUDES := \
  ...
  $(SOURCE_DIR)/middleware/lib/audio/cm4/vow/inc/mt6771 \
...
FEATURE_LIBFLAGS := \
  ...
  -L$(SOURCE_DIR)/middleware/lib/audio/cm4/vow/mt6771 -lblisrc_vow
...
FEATURE_LIBFLAGS := \
  ...
  -L$(SOURCE_DIR)/middleware/lib/audio/cm4/vow/mt6771 -lblisrc_accurate_vow
include $(REGISTER_FEATURE)
