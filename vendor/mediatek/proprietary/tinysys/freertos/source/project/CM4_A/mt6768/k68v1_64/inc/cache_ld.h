...
//#define CACHE_VOW_IN_SRAM_DATA \
//    ?*/middleware/lib/audio/cm4/vow/libaec.a:MemoryPool.o(DRAM_DATA_SECTIONS)

#define CACHE_VOW_TEXT \
    ?*/middleware/lib/audio/cm4/vow/libaec.a:*.o(DRAM_TEXT_SECTIONS) \
    ?*/middleware/lib/audio/cm4/vow/mt6768/libblisrc_accurate_vow.a:*.o(DRAM_TEXT_SECTIONS) \
    ?*/middleware/lib/audio/cm4/vow/mt6768/libblisrc_echo_ref_vow.a:*.o(DRAM_TEXT_SECTIONS)

#define CACHE_VOW_DATA \
    ?*/middleware/lib/audio/cm4/vow/libaec.a:*.o(DRAM_DATA_SECTIONS) \
    ?*/middleware/lib/audio/cm4/vow/mt6768/libblisrc_accurate_vow.a:*.o(DRAM_DATA_SECTIONS) \
    ?*/middleware/lib/audio/cm4/vow/mt6768/libblisrc_echo_ref_vow.a:*.o(DRAM_DATA_SECTIONS)
