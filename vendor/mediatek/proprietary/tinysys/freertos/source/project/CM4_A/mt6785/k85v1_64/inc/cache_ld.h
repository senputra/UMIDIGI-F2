...
#define CACHE_SAR_TEXT \
    ?*/middleware/contexthub/MEMS_Driver/sar/?*.o(DRAM_TEXT_SECTIONS)
#define CACHE_SAR_DATA \
    ?*/middleware/contexthub/MEMS_Driver/sar/?*.o(DRAM_DATA_SECTIONS)
...
#define CACHE_VOW_TEXT \
    ...
    ?*/middleware/lib/audio/cm4/vow/mt6785/libblisrc_accurate_vow.a:*.o(DRAM_TEXT_SECTIONS)

#define CACHE_VOW_DATA \
    ?*/middleware/lib/audio/cm4/vow/libaec.a:*.o(DRAM_DATA_SECTIONS) \
    ?*/middleware/lib/audio/cm4/vow/mt6785/libblisrc_accurate_vow.a:*.o(DRAM_DATA_SECTIONS)
