...
CFG_MTK_AURISYS_PHONE_CALL_SUPPORT = yes
...
CFG_HIFI3_SRAM_ADDRESS = 0x56000000
...
DRIVERS_PLATFORM_DIR_COMMON = $(DRIVERS_DIR)/$(PROCESSOR)/$(PLATFORM)


INCLUDES += \
  $(PLATFORM_DIR)/inc \
  $(DRIVERS_PLATFORM_DIR_COMMON)/feature_manager/inc

C_FILES += \
  $(PLATFORM_DIR)/src/main.c \
  $(PLATFORM_DIR)/src/platform.c \
  $(DRIVERS_PLATFORM_DIR_COMMON)/feature_manager/src/feature_manager.c
...
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/cache/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/cache/src/hal_cache.c
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/cache/src/hal_cache_internal.c
endif
...
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/xgpt/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/xgpt/src/xgpt.c
endif

ifeq ($(CFG_UART_SUPPORT),yes)
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/uart/inc
C_FILES  += $(SOURCE_DIR)/drivers/common/uart/v01/uart.c
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/uart/src/uart_platform.c
endif

ifeq ($(CFG_TRAX_SUPPORT),yes)
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/trax/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/trax/src/adsp_trax.c
endif

ifeq ($(CFG_SEM_SUPPORT),yes)
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/sem/inc
...
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/ipi/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/ipi/src/adsp_ipi.c
endif

ifeq ($(CFG_ADSP_LOGGER_SUPPORT),yes)
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/logger/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/logger/src/adsp_logger.c
endif

ifeq ($(CFG_WDT_SUPPORT),yes)
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/wdt/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/wdt/src/wdt.c
endif

ifeq ($(CFG_DMA_SUPPORT),yes)
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/dma/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/dma/src/dma.c
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/dma/src/dma_api.c
endif
...
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/ap_awake/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/ap_awake/src/ap_awake.c
endif
...
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/bus_monitor/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/bus_monitor/src/bus_monitor.c
endif

ifeq ($(CFG_UT_TESTSUITE_SUPPORT),yes)
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/tests/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/tests/src/test_main.c
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/tests/src/testsuite_dma.c
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/tests/src/testsuite_wdt.c
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/tests/src/testsuite_dvfs.c
endif
...
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/dvfs/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/dvfs/src/dvfs_common.c
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/dvfs/src/dvfs.c
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/dvfs/src/dvfs_config_parser.c
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/dvfs/src/sleep.c
endif

ifeq ($(CFG_PERFORMANCE_MONITOR_SUPPORT),yes)
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/perf_mon/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/perf_mon/src/perf_mon.c
endif

ifeq ($(CFG_MCPS_PROF_SUPPORT),yes)
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/mcps_prof/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/mcps_prof/src/mcps_prof.c
CFLAGS  += -DMCPS_PROF_SUPPORT
endif

ifeq ($(CFG_MPU_SUPPORT),yes)
INCLUDES += $(SOURCE_DIR)/kernel/service/HIFI3/include
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/mpu/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/mpu/src/mpu_mtk.c
endif
...
INCLUDES += $(DRIVERS_PLATFORM_DIR_COMMON)/audio/hardware
...
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/audio/hardware/audio_hw.c
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/audio/hardware/audio_irq.c
...
C_FILES  += $(DRIVERS_PLATFORM_DIR_COMMON)/audio/hardware/audio_hw_hal.c
...
INCLUDES += \
  ...
  $(DRIVERS_PLATFORM_DIR_COMMON)/audio/tasks/mp3 \
...
C_FILES += \
  ...
  $(DRIVERS_PLATFORM_DIR_COMMON)/audio/tasks/mp3/audio_dma_mp3.c
LIBFLAGS += \
