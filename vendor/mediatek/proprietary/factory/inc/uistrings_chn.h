...
#define uistr_key_pre 					 "上一页"
#define uistr_key_next 					 "下一页"
...
#define uistr_bio_sensor		"生理传感器"
#define uistr_bio_sensor_c	"生理传感器校准"
...
#define uistr_humidity			"湿度传感器"
#define uistr_heart_monitor			"心率侦测"

/* AP AuxADC */
#define uistr_info_ap_auxadc		"AP-AuxADC 测试"
#define uistr_info_auxadc_chn	"AP-AuxADC通道 初始化"
...
#define uistr_info_audio_speaker_rdc_calibration				"喇叭阻值校正"
#define uistr_info_audio_loopback_note							      "如果测试耳机麦克风到接收器的回路, \n请插入耳机...\n\n\n"
#define uistr_info_audio_headset_note                     "请插入耳机...\n\n"
#define uistr_info_audio_headset_avail                    "耳机可用: "
#define uistr_info_audio_headset_mic_avail                "耳机麦克风:"
#define uistr_info_audio_headset_Button                   "耳机按键:"
...
#define uistr_info_audio_receiver_freq_response           "接收器Response"
#define uistr_info_audio_speaker_freq_response            "扬声器Response"
#define uistr_info_audio_receiver_thd                     "接收器THD"
#define uistr_info_audio_speaker_thd                      "扬声器THD"
#define uistr_info_audio_headset_thd                      "耳机THD"
...
#define uistr_info_speaker_oc_pass							          "扬声器OC测试通过"
#define uistr_info_speaker_oc_fail							          "扬声器OC测试失败"
...
#define uistr_info_emergency_call_in_modem1        "modem1 拨打112"
#define uistr_info_emergency_call_in_modem2        "modem2 拨打112"
#define uistr_info_emergency_call_in_modem5        "modem5 拨打112"
...
#define uistr_info_emmc_fat		"FAT 分区"
#define uistr_info_emmc_format_item		"格式化FAT 分区"
#define uistr_info_emmc_format_stat		"格式化状态"
#define uistr_info_emmc_format_stat_start		"正在格式化FAT 分区..."
#define uistr_info_emmc_format_data_start   "正在格式化data 分区..."
#define uistr_info_reboot			"正在重启手机"
#define uistr_info_emmc_format_stat_success		"格式化FAT 分区成功!"
#define uistr_info_emmc_format_stat_fail		"格式化FAT 分区失败!"
...
#define uistr_info_bt_no_dev          "设备列表尾未发现蓝牙设备\n"
...
#define uistr_info_wifi_iface_err   "读取网卡失败"
#define uistr_info_wifi_fail_scan    "扫描失败"
#define uistr_info_wifi_no_scan_res "没有扫描结果"
#define uistr_info_wifi_connect_err "连线失败"
#define uistr_info_wifi_no_ap       "没有可连接的AP"
...
#define uistr_main3_sensor 	"主照相机3"
#define uistr_main4_sensor 	"主照相机4"
#define uistr_sub_sensor 	"副照相机"
#define uistr_sub2_sensor 	"副照相机2"
...
#define uistr_info_title_slave_charger_connect "连接"
#define uistr_info_title_slave_charger_no_connect "未连接"
...
#define uistr_info_sensor_cali_do									"进行校准"
...
#define uistr_info_bio_sensor_max							"最大"
#define uistr_info_bio_sensor_min							"最小"
#define uistr_info_bio_sensor_thres						"门限"
#define uistr_info_bio_sensor_result							"测试结果"
/*test report*/
...
/* IrTx */
#define uistr_info_irtx_led_test "IrTx LED 测试"
#define uistr_info_irtx_open_device "状态: 打开设备节点"
#define uistr_info_irtx_call_ioctl "状态: ioctl调用"
#define uistr_info_irtx_led_enable "打开 IRTX LED"
#define uistr_info_irtx_led_disable "关闭 IRTX LED"

/* Fingerprint */
/* goodix begin */
#define uistr_goodix_fingerprint "指纹测试"
/* goodix end */

/* efuse */
#define uistr_info_efuse_test   "EFUSE"
#define uistr_info_efuse_result "EFUSE blow result"
