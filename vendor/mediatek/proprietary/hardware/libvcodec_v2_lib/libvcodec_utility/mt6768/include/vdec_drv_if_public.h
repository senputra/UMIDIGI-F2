...
#define MTK_VDEC_VALUE_WAITKEYFRAME_FOR_THUMBNAIL  (1 << 3)

#define DIVX_LICENSE_SO "liblic_divx.so"
...
typedef enum _VDEC_DRV_QUERY_TYPE_T {
	...
	VDEC_DRV_QUERY_TYPE_FRAME_SIZES,        /* /< Query VDEC_DRV_QUERY_TYPE_FRAME_SIZES */
        VDEC_DRV_QUERY_TYPE_DIVX_LICENSE,       /* /< Query VDEC_DRV_QUERY_TYPE_DIVX_LICENSE */
} VDEC_DRV_QUERY_TYPE_T;
