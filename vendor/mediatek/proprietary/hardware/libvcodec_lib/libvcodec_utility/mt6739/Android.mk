...
LOCAL_SHARED_LIBRARIES_64 := libcutils liblog libbwc libion libion_mtk libdl libmtk_drvb
...
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_TAGS := optional
LOCAL_SHARED_LIBRARIES := libcutils liblog libbwc libion libion_mtk libdl libmtk_drvb
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/include
LOCAL_MULTILIB := 32
