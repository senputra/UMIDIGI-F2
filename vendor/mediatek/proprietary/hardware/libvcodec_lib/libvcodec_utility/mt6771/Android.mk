...
LOCAL_SHARED_LIBRARIES_64 := libcutils libbwc libion libion_mtk liblog libdl libmtk_drvb
...
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_TAGS := optional
LOCAL_SHARED_LIBRARIES := libcutils libbwc libion libion_mtk liblog libdl libmtk_drvb
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/include
LOCAL_MULTILIB := 32
