...
#ifndef _MTK_MFNRUTILS_ERRCODE_H
#define _MTK_MFNRUTILS_ERRCODE_H
...
#define MODULE_MTK_MFNRUTILS (0) // Temp value

#define MTKMFNRUTILS_OKCODE(errid)         OKCODE(MODULE_MTK_MFNRUTILS, errid)
#define MTKMFNRUTILS_ERRCODE(errid)        ERRCODE(MODULE_MTK_MFNRUTILS, errid)


// Detection error code
#define S_MFNRUTILS_OK                  MTKMFNRUTILS_OKCODE(0x0000)

#define E_MFNRUTILS_NEED_OVER_WRITE     MTKMFNRUTILS_ERRCODE(0x0001)
#define E_MFNRUTILS_NULL_OBJECT         MTKMFNRUTILS_ERRCODE(0x0002)
#define E_MFNRUTILS_WRONG_STATE         MTKMFNRUTILS_ERRCODE(0x0003)
#define E_MFNRUTILS_WRONG_CMD_ID        MTKMFNRUTILS_ERRCODE(0x0004)
#define E_MFNRUTILS_WRONG_CMD_PARAM     MTKMFNRUTILS_ERRCODE(0x0005)
#define E_MFNRUTILS_NOT_ENOUGH_MEM      MTKMFNRUTILS_ERRCODE(0x0006)

#define E_MFNRUTILS_ERR                 MTKMFNRUTILS_ERRCODE(0x0100)
