...
#define MTKTSF_REVISION 8435001
...
typedef enum
{
	...
	MTKTSF_FEATURE_TSFS_REG,             // feature id to gen TSFS register
...
typedef struct
{
    ...
    MUINT32                     Bitdepth;        // input stat's bitdepth
...
typedef struct
{
	...
	int                     TSFS_PIXEL_CNT1;
	int                     TSFS_PIXEL_CNT2;
} MTK_TSF_TSFS_INFO_STRUCT, *P_MTK_TSF_TSFS_INFO_STRUCT;
