...
#ifndef _MTK_NRUTILS_ERRCODE_H
#define _MTK_NRUTILS_ERRCODE_H
...
#define MODULE_MTK_NRUTILS (0) // Temp value

#define MTKNRUTILS_OKCODE(errid)         OKCODE(MODULE_MTK_NRUTILS, errid)
#define MTKNRUTILS_ERRCODE(errid)        ERRCODE(MODULE_MTK_NRUTILS, errid)


// Detection error code
#define S_NRUTILS_OK                  MTKNRUTILS_ERRCODE(0x0000)

#define E_NRUTILS_NEED_OVER_WRITE     MTKNRUTILS_ERRCODE(0x0001)
#define E_NRUTILS_NULL_OBJECT         MTKNRUTILS_ERRCODE(0x0002)
#define E_NRUTILS_WRONG_STATE         MTKNRUTILS_ERRCODE(0x0003)
#define E_NRUTILS_WRONG_CMD_ID        MTKNRUTILS_ERRCODE(0x0004)
#define E_NRUTILS_WRONG_CMD_PARAM     MTKNRUTILS_ERRCODE(0x0005)
#define E_NRUTILS_NOT_ENOUGH_MEM      MTKNRUTILS_ERRCODE(0x0006)

#define E_NRUTILS_ERR                 MTKNRUTILS_ERRCODE(0x0100)
