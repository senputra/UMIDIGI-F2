...
#ifndef _MTK_NRCORE_ERRCODE_H
#define _MTK_NRCORE_ERRCODE_H
...
#define MODULE_MTK_NRCORE (0) // Temp value

#define MTKNRCORE_OKCODE(errid)         OKCODE(MODULE_MTK_NRCORE, errid)
#define MTKNRCORE_ERRCODE(errid)        ERRCODE(MODULE_MTK_NRCORE, errid)


// Detection error code
#define S_NRCORE_OK                  MTKNRCORE_ERRCODE(0x0000)

#define E_NRCORE_NEED_OVER_WRITE     MTKNRCORE_ERRCODE(0x0001)
#define E_NRCORE_NULL_OBJECT         MTKNRCORE_ERRCODE(0x0002)
#define E_NRCORE_WRONG_STATE         MTKNRCORE_ERRCODE(0x0003)
#define E_NRCORE_WRONG_CMD_ID        MTKNRCORE_ERRCODE(0x0004)
#define E_NRCORE_WRONG_CMD_PARAM     MTKNRCORE_ERRCODE(0x0005)
#define E_NRCORE_NOT_ENOUGH_MEM      MTKNRCORE_ERRCODE(0x0006)
#define E_NRCORE_INVALID_RESOLUTION  MTKNRCORE_ERRCODE(0x0007)

#define E_NRCORE_ERR                 MTKNRCORE_ERRCODE(0x0100)
