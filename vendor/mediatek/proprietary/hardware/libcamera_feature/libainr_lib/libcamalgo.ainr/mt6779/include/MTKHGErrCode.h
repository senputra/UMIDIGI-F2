...
#ifndef _MTK_HG_ERRCODE_H
#define _MTK_HG_ERRCODE_H
...
#define MODULE_MTK_HG (0) // Temp value

#define MTKHG_OKCODE(errid)         OKCODE(MODULE_MTK_HG, errid)
#define MTKHG_ERRCODE(errid)        ERRCODE(MODULE_MTK_HG, errid)


// Detection error code
#define S_HG_OK                  MTKHG_ERRCODE(0x0000)

#define E_HG_NEED_OVER_WRITE     MTKHG_ERRCODE(0x0001)
#define E_HG_NULL_OBJECT         MTKHG_ERRCODE(0x0002)
#define E_HG_WRONG_STATE         MTKHG_ERRCODE(0x0003)
#define E_HG_WRONG_CMD_ID        MTKHG_ERRCODE(0x0004)
#define E_HG_WRONG_CMD_PARAM     MTKHG_ERRCODE(0x0005)
#define E_HG_NOT_ENOUGH_MEM      MTKHG_ERRCODE(0x0006)

#define E_HG_ERR                 MTKHG_ERRCODE(0x0100)
