...
#else
    int level = va_arg(args, int /* enums promoted to ints in va_args in C */);
#endif
...
#else
	va_list* tmp = va_arg(args, void*);
	va_copy(innerArgs, (*(va_list*)(&tmp)));
#endif
...
#if 0 //plz have i2c owner test this flow
...
{
#if 0 //plz have gpio owner test this flow
