...
enum {
    ...
    GRALLOC_USAGE_SMVR                  = GRALLOC_USAGE_PRIVATE_1,
    GRALLOC_USAGE_NO_COMPRESS           = GRALLOC_USAGE_PRIVATE_3,
    /* buffer will be forcibly used to output HAL_PIXEL_FORMAT_YV12 format CR ID:ALPS05171287*/
    GRALLOC_USAGE_FORCE_NV21		= 0x02000000U,
};
