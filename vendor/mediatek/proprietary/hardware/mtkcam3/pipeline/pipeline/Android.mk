...
#
# Pipeline
LOCAL_SRC_FILES += Dispatcher.cpp
LOCAL_SRC_FILES += InFlightRequest.cpp
LOCAL_SRC_FILES += InitFrameHandler.cpp
LOCAL_SRC_FILES += NodeActorImpl.cpp
LOCAL_SRC_FILES += RequestBuilderImpl.cpp
LOCAL_SRC_FILES += PipelineContext.cpp
LOCAL_SRC_FILES += PipelineContextImpl.cpp
LOCAL_SRC_FILES += PipelineContextBuilders.cpp
# Session life holder
LOCAL_SRC_FILES += SessionLifeHolder.cpp
...
LOCAL_SHARED_LIBRARIES += libmtkcam_pipeline_fbm
