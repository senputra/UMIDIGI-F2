...
protected:  ////                    Data Members. (Config)
    ...
    MUINT32                         mQualitySwitchingState;
    MUINT32                         mQualitySwitchingValue;
...
protected:  ////                    Operations.
    ...
    MVOID                           setQualitySwitching(
                                        MUINT32 uState,
                                        MUINT32 * pValue = nullptr
                                    );

    MVOID                           getQualitySwitching(
                                        MUINT32 * pState,
                                        MUINT32 * pValue
                                    );

    MBOOL                           isQualitySwitching(
                                        void
                                    );
...
protected:  ////                    Hardware Operations.
   ...
   MERROR                          setupSubInfo(
    ...
    MBOOL                           checkQualitySwitch(
                                        MUINT32 * pActState = (MUINT32*)NULL
                                    );
