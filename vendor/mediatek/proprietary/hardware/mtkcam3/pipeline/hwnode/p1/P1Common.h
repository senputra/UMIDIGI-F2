...
enum QUALITY_SWITCH_PROGRESS // to record switch progress for whole-situation
{
    QUALITY_SWITCH_PROGRESS_NOT_START   = 0, // not switching
    QUALITY_SWITCH_PROGRESS_WAIT_TO_SENDCMD,
    QUALITY_SWITCH_PROGRESS_WAIT_FOR_CALLBACK,
};

enum QUALITY_SWITCH_STATE // to record switch status for act
{
    QUALITY_SWITCH_STATE_NONE       = 0, // no QUALITY switch request
    QUALITY_SWITCH_STATE_RECEIVED,      // while the QUALITY switch received
    QUALITY_SWITCH_STATE_PROCESSING,    // under the QUALITY switch processing
