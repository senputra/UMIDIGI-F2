...
#define KEY_CROPPER_DUMP            "vendor.debug.mtkcam.p2.cropper.dump"
...
#define TRACE_SMVR_QUEUE            0
#define TRACE_STREAMING_PROCESSOR   0
#define TRACE_STREAMING_3DNR        0
#define TRACE_STREAMING_DSDN        0
#define TRACE_STREAMING_EIS         0
#define TRACE_STREAMING_FSC         0
#define TRACE_STREAMING_VSDOF       0
#define TRACE_STREAMING_SMVR        0
#define TRACE_VR_GRALLOC            0

#define TRACE_RELEASE_BUNDLE        0
#define TRACE_P2_BUFFER_HANDLE      0
#define TRACE_P2_METADATA_HANDLE    0
