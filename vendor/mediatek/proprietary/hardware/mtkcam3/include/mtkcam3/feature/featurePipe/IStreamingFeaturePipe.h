...
public:
    ...
    public:
        MUINT32 mMode = 0;
        MUINT32 mMaxRatioMultiple = 1;
        MUINT32 mMaxRatioDivider = 1;
        MBOOL hasDSDN20() const { return mMode == 1; }
        MBOOL hasDSDN25() const { return mMode == 2; }
    };
...
{
public:
    enum MSG_TYPE { MSG_FRAME_DONE, MSG_DISPLAY_DONE, MSG_RSSO_DONE, MSG_FD_DONE, MSG_P2B_SET_3A, MSG_N3D_SET_SHOTMODE, MSG_INVALID };
