...
#define IS_KEEP_CONTENT (true)
#define IS_CENTER_CONTENT (true)
...
struct StereoArea {
     ...
     *        N must be one of 128/64/32/16/8/4/2
     * \details Sometimes user needs N-aligned size for further process
     *
     * \param n must be one of 128/64/32/16/8/4/2
     ...
     */
    inline StereoArea &applyNAlign(ENUM_SIZE_ALIGNMENT n, bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) {
        NSCam::MSize szContent = contentSize();
    ...
    inline StereoArea &apply128Align(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlign(E_128_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply64Align(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlign(E_64_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply32Align(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlign(E_32_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply16Align(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlign(E_16_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply8Align(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlign(E_8_ALIGN,  keepContent, centerContent); }
    inline StereoArea &apply4Align(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlign(E_4_ALIGN,  keepContent, centerContent); }
    inline StereoArea &apply2Align(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlign(E_2_ALIGN,  keepContent, centerContent); }

    /**
     * \brief Apply N-align to size, size will be rounding, which means it may be smaller after rounding
     *        N-align meas its size is multiple of N
     *        N must be one of 32/16/8/4/2
     * \details Sometimes user needs N-aligned size for further process
     *
     * \param n must be one of 32/16/8/4/2
     * \param keepContent keep content and only changes padding
     * \param centerContent set to centerize content if padding is not zero
     * \return N-aligned area
     */
    inline StereoArea &applyNAlignRounding(ENUM_SIZE_ALIGNMENT n, bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) {
        NSCam::MSize szContent = contentSize();
    ...
    inline StereoArea &apply32AlignRounding(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlignRounding(E_32_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply16AlignRounding(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlignRounding(E_16_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply8AlignRounding(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlignRounding(E_8_ALIGN,  keepContent, centerContent); }
    inline StereoArea &apply4AlignRounding(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlignRounding(E_4_ALIGN,  keepContent, centerContent); }
    inline StereoArea &apply2AlignRounding(bool keepContent=!IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlignRounding(E_2_ALIGN,  keepContent, centerContent); }
    ...
    inline StereoArea &apply4AlignToContent()  { return applyNAlignToContent(E_4_ALIGN); }
     ...
     */
    inline StereoArea &applyNAlignToWidth(ENUM_SIZE_ALIGNMENT n, bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) {
    ...
    inline StereoArea &apply128AlignToWidth(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlignToWidth(E_128_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply64AlignToWidth(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlignToWidth(E_64_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply32AlignToWidth(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlignToWidth(E_32_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply16AlignToWidth(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlignToWidth(E_16_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply8AlignToWidth(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlignToWidth(E_8_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply4AlignToWidth(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlignToWidth(E_4_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply2AlignToWidth(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlignToWidth(E_2_ALIGN, keepContent, centerContent); }
     ...
     */
    inline StereoArea &applyNAlignToHeight(ENUM_SIZE_ALIGNMENT n, bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) {
    ...
    inline StereoArea &apply128AlignToHeight(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlignToHeight(E_128_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply64AlignToHeight(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlignToHeight(E_64_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply32AlignToHeight(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlignToHeight(E_32_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply16AlignToHeight(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT) { return applyNAlignToHeight(E_16_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply8AlignToHeight(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlignToHeight(E_8_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply4AlignToHeight(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlignToHeight(E_4_ALIGN, keepContent, centerContent); }
    inline StereoArea &apply2AlignToHeight(bool keepContent=IS_KEEP_CONTENT, bool centerContent=IS_CENTER_CONTENT)  { return applyNAlignToHeight(E_2_ALIGN, keepContent, centerContent); }
    ...
    inline StereoArea &apply4AlignToContentWidth()  { return applyNAlignToContentWidth(E_4_ALIGN); }
    ...
    inline StereoArea &apply4AlignToContentHeight()  { return applyNAlignToContentHeight(E_4_ALIGN); }
