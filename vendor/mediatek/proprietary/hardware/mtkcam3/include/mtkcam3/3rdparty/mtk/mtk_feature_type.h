...
enum eFeatureIndexMtk {
    ...
    MTK_FEATURE_FUSION      = 1ULL << 10,
    MTK_FEATURE_FSC         = 1ULL << 11,
    MTK_FEATURE_3DNR        = 1ULL << 12,
    MTK_FEATURE_EIS         = 1ULL << 13,
    MTK_FEATURE_AINR        = 1ULL << 14,
    MTK_FEATURE_DUAL_YUV    = 1ULL << 15,
    MTK_FEATURE_DUAL_HWDEPTH  = 1ULL << 16,
    MTK_FEATURE_HFG         = 1ULL << 18,
    MTK_FEATURE_DCE         = 1ULL << 19,
    MTK_FEATURE_AINR_YUV    = 1ULL << 20,
    MTK_FEATURE_ASYNC_ASD   = 1ULL << 21,
    MTK_FEATURE_FOVA        = 1ULL << 22,
    ...
    MTK_FEATURE_AIHDR = 1ULL << 25,
    MTK_FEATURE_HIGH_QUALITY_YUV = (MTK_FEATURE_CZ|MTK_FEATURE_DRE|MTK_FEATURE_HFG),  // P2C's P2A high quality YUV output option
