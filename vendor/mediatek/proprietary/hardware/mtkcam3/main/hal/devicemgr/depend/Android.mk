...
#-----------------------------------------------------------
# ifneq (,$(filter $(strip $(TARGET_BOARD_PLATFORM)), mt6739 mt6765 mt6761 mt6771 mt6779 mt6768))
...
#
LOCAL_STATIC_LIBRARIES += android.hardware.camera.provider@2.4-impl-static
