...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////    Operations.
    static  auto                    castFrom(IStreamInfo const* pInfo) -> Camera3ImageStreamInfo const*;

public:     ////                    Instantiation.
                                    Camera3ImageStreamInfo(CreationInfo const& info);
            ///< copy constructor
                                    Camera3ImageStreamInfo(Camera3ImageStreamInfo const& other, int imgFormat = eImgFmt_UNKNOWN, size_t const stride = 0);
...
struct Camera3ImageStreamInfoBuilder : public IImageStreamInfoBuilder
{
    ...
    virtual void    setSecureInfo(SecureInfo const& secureInfo __unused)    {}  /* not support */
    virtual void    setMaxBufNum(size_t maxBufNum __unused)                 {}  /* not support */
    virtual void    setMinInitBufNum(size_t minInitBufNum __unused)         {}  /* not support */
