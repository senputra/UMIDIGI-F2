...
static constexpr size_t CAMERA_RESULT_METADATA_QUEUE_SIZE  = 4 << 20 /* 32MB */;
// result metadata queue size is not constant, may changed in initial stage
static constexpr size_t CAMERA_RESULT_METADATA_QUEUE_SIZE_CES  = 24 << 20 /* 32MB */;
...
protected:  ////    Operations.
    ...
    MINT32 extractE2EHDRInfo(const V3_4::StreamConfiguration& requestedConfiguration);

    bool checkResizeFMQ(const V3_4::StreamConfiguration& requestedConfiguration);
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Interfaces.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////    Operations.
