...
#ifndef _MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICE_3_X_INCLUDE_APPSTREAMBUFFERS_H_
#define _MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICE_3_X_INCLUDE_APPSTREAMBUFFERS_H_
//
...
public:     ////                                Definitions.
    ...
    struct  AppStreamBufferHandle
    {
        buffer_handle_t bufferHandle = nullptr;
        //
        AppStreamBufferHandle(buffer_handle_t);
...
public:     ////                                Operations.
    std::shared_ptr<AppStreamBufferHandle>      mpAppStreamBufferHandle;
...
#endif  //_MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICE_3_X_INCLUDE_APPSTREAMBUFFERS_H_
