...
#if ((MFLL_MF_TAG_VERSION > 0) && (MFLL_MF_TAG_VERSION != 11))
#   error "MT6779 only supports MF_TAG_VERSION 11"
#endif
...
{
#if 1
    mfllLogE("TODO: Please fix it<dump_exif_info>");
#else
//{{{
...
#undef  _D_PREFIX
    ...
    case STAGE_MFB: {
        // MT6771 / MT6775 / MT6779, using stand alone MFB
