...
#define MFLL_DUMP_PATTERN_ALIGNWIDTH        "{ALIGNWIDTH}"
#define MFLL_DUMP_PATTERN_ALIGNHEIGHT       "{ALIGNHEIGHT}"
#define MFLL_DUMP_PATTERN_STRIDE            "{STRIDE}"
...
#define MFLL_DUMP_FILE_NAME_RAW \
    "{UNIQUEKEY}-{REQUESTNO}-{FRAMENO}-mfll-iso-{ISO}-exp-{EXP}-{STAGE}-{BUFNAME}__{WIDTH}x{HEIGHT}_{BITS}_{BAYERORDER}.{EXT}"

#define MFLL_DUMP_FILE_NAME_OTHER \
    "{UNIQUEKEY}-{REQUESTNO}-{FRAMENO}-mfll-iso-{ISO}-exp-{EXP}-{STAGE}-{BUFNAME}__{WIDTH}x{HEIGHT}.{EXT}"

#define MFLL_DUMP_FILE_NAME_RAW_ALIGNMENT \
    "{UNIQUEKEY}-{REQUESTNO}-{FRAMENO}-mfll-iso-{ISO}-exp-{EXP}-{STAGE}-{BUFNAME}-PW{ALIGNWIDTH}-PH{ALIGNHEIGHT}-BW{STRIDE}__{WIDTH}x{HEIGHT}_{BITS}_{BAYERORDER}.{EXT}"

#define MFLL_DUMP_FILE_NAME_OTHER_ALIGNMENT \
    "{UNIQUEKEY}-{REQUESTNO}-{FRAMENO}-mfll-iso-{ISO}-exp-{EXP}-{STAGE}-{BUFNAME}-PW{ALIGNWIDTH}-PH{ALIGNHEIGHT}-BW{STRIDE}__{WIDTH}x{HEIGHT}.{EXT}"
