...
public:
     ...
     */
    static bool getMDPPQParam(VSDOFParam &vsdofParam);
     ...
     * \return true if success
     */
    static bool getDPETuningInfo(NSCam::NSIoPipe::DPEConfig *tuningBuffer, StereoHAL::ENUM_STEREO_SCENARIO eScenario=StereoHAL::eSTEREO_SCENARIO_PREVIEW);
    ...
    /**
     * \brief Get ISP tuning for FE
     * \details Enable ISP path for stereo
     *
     * \param tuningBuffer Ouptut of tuning buffer, type: dip_x_reg_t*
     * \return true if success
     */
    static bool getISPFETuningInfo(void *tuningBuffer);
