...
onThreadStart()
{
    ...
    // init DPEStream
    mpDPEStream = NSCam::NSIoPipe::NSDpe::IDpeStream::createInstance(DPE_USER_NAME);
    if(mpDPEStream == NULL)
    {
    ...
    mpDPEStream->init();
    // init the last DMP
    sp<FatImageBufferPool> pPool = mpBuffPoolMgr->getImageBufferPool(BID_DPE_INTERNAL_LAST_DMP);
    mLastDMP_L = pPool->request();
    mLastDMP_R = pPool->request();
...
debugDPEConfig(NSIoPipe::DVEConfig& config)
{
    ...
    MY_LOGD("DVEConfig.Dve_Ord_DownSample_En=%d", config.Dve_Ord_DownSample_En);
    ...
    #define LOG_DPEBuf(bufInfo) \
        ...
        MY_LOGD("DVEConfig." #bufInfo ".u4BufVA=%#" PRIxPTR "", config.bufInfo.u4BufVA); \
        MY_LOGD("DVEConfig." #bufInfo ".u4BufPA=%#" PRIxPTR "", config.bufInfo.u4BufPA); \
    ...
    MY_LOGD("DVEConfig.DVE_RESPO_SEL=%d", config.DVE_RESPO_SEL);
    MY_LOGD("DVEConfig.DVE_CONFO_SEL=%d", config.DVE_CONFO_SEL);
    MY_LOGD("DVEConfig.Dve_Ord_As_TH=%d", config.Dve_Ord_As_TH);
    MY_LOGD("DVEConfig.Dve_Ord_As_Mask=%d %d %d %d",
                config.Dve_Ord_As_Mask.DVE_ORD_AS_MASK_0,
                config.Dve_Ord_As_Mask.DVE_ORD_AS_MASK_1,
                config.Dve_Ord_As_Mask.DVE_ORD_AS_MASK_2,
                config.Dve_Ord_As_Mask.DVE_ORD_AS_MASK_3);
    MY_LOGD("DVEConfig.Dve_Ord_Ref_Mask_A=%d %d %d %d %d %d %d",
                config.Dve_Ord_Ref_Mask_A.DVE_ORD_REF_MASK_A_0,
                config.Dve_Ord_Ref_Mask_A.DVE_ORD_REF_MASK_A_1,
                config.Dve_Ord_Ref_Mask_A.DVE_ORD_REF_MASK_A_2,
                config.Dve_Ord_Ref_Mask_A.DVE_ORD_REF_MASK_A_3,
                config.Dve_Ord_Ref_Mask_A.DVE_ORD_REF_MASK_A_4,
                config.Dve_Ord_Ref_Mask_A.DVE_ORD_REF_MASK_A_5,
                config.Dve_Ord_Ref_Mask_A.DVE_ORD_REF_MASK_A_6);
    MY_LOGD("DVEConfig.Dve_Ord_Ref_Mask_B=%d %d %d %d %d %d %d",
                config.Dve_Ord_Ref_Mask_B.DVE_ORD_REF_MASK_B_0,
                config.Dve_Ord_Ref_Mask_B.DVE_ORD_REF_MASK_B_2,
                config.Dve_Ord_Ref_Mask_B.DVE_ORD_REF_MASK_B_2,
                config.Dve_Ord_Ref_Mask_B.DVE_ORD_REF_MASK_B_3,
                config.Dve_Ord_Ref_Mask_B.DVE_ORD_REF_MASK_B_4,
                config.Dve_Ord_Ref_Mask_B.DVE_ORD_REF_MASK_B_5,
                config.Dve_Ord_Ref_Mask_B.DVE_ORD_REF_MASK_B_6);
    MY_LOGD("DVEConfig.Dve_Ord_Ref_Mask_C=%d %d %d %d %d %d %d",
                config.Dve_Ord_Ref_Mask_C.DVE_ORD_REF_MASK_C_0,
                config.Dve_Ord_Ref_Mask_C.DVE_ORD_REF_MASK_C_2,
                config.Dve_Ord_Ref_Mask_C.DVE_ORD_REF_MASK_C_2,
                config.Dve_Ord_Ref_Mask_C.DVE_ORD_REF_MASK_C_3,
                config.Dve_Ord_Ref_Mask_C.DVE_ORD_REF_MASK_C_4,
                config.Dve_Ord_Ref_Mask_C.DVE_ORD_REF_MASK_C_5,
                config.Dve_Ord_Ref_Mask_C.DVE_ORD_REF_MASK_C_6);
    MY_LOGD("DVEDonfig.Dve_Ord_Ref_Mask_D=%d %d %d %d %d %d %d",
                config.Dve_Ord_Ref_Mask_D.DVE_ORD_REF_MASK_D_0,
                config.Dve_Ord_Ref_Mask_D.DVE_ORD_REF_MASK_D_2,
                config.Dve_Ord_Ref_Mask_D.DVE_ORD_REF_MASK_D_2,
                config.Dve_Ord_Ref_Mask_D.DVE_ORD_REF_MASK_D_3,
                config.Dve_Ord_Ref_Mask_D.DVE_ORD_REF_MASK_D_4,
                config.Dve_Ord_Ref_Mask_D.DVE_ORD_REF_MASK_D_5,
                config.Dve_Ord_Ref_Mask_D.DVE_ORD_REF_MASK_D_6);
}
/*******************************************************************************
 *
 ********************************************************************************/
...
handleDPEEnqueDone(DVEParams& rParams, EnqueCookieContainer* pEnqueCookie)
{
    ...
    sp<BaseBufferHandler> pBufferHandler = pRequest->getBufferHandler();
    IImageBuffer *pImgBuf_DMP_L = nullptr, *pImgBuf_DMP_R = nullptr;
    IImageBuffer *pImgBuf_CFM_L = nullptr, *pImgBuf_CFM_R = nullptr;
    IImageBuffer *pImgBuf_RESPO_L = nullptr, *pImgBuf_RESPO_R = nullptr;
    MBOOL bRet = MTRUE;
    DepthMapPipeNodeID notifyNodeID = (pRequest->getRequestAttr().opState == eSTATE_NORMAL) ?
                                        eDPETHMAP_PIPE_NODEID_HWOCC : eDPETHMAP_PIPE_NODEID_OCC;
    DepthMapDataID notifyDataID = (pRequest->getRequestAttr().opState == eSTATE_NORMAL) ?
                                        DPE_TO_HWOCC_MVSV_DMP : DPE_TO_OCC_MVSV_DMP_CFM;
    // check flush status
    ...
    pBufferHandler->configOutBuffer(getNodeId(), BID_DPE_OUT_DMP_L, notifyNodeID);
    pBufferHandler->configOutBuffer(getNodeId(), BID_DPE_OUT_DMP_R, notifyNodeID);
    pBufferHandler->configOutBuffer(getNodeId(), BID_DPE_OUT_CFM_L, notifyNodeID);
    pBufferHandler->configOutBuffer(getNodeId(), BID_DPE_OUT_CFM_R, notifyNodeID);
    ...
    // pass MV/SV to OCC
    pBufferHandler->configOutBuffer(getNodeId(), BID_N3D_OUT_MV_Y, notifyNodeID);
    pBufferHandler->configOutBuffer(getNodeId(), BID_N3D_OUT_SV_Y, notifyNodeID);
    // post to OCC/HWOCC node
    handleDataAndDump(notifyDataID, pRequest);
lbExit:
...
)
{
    ...
    // update last DMP, record SmartFatImageBuffer to avoid release
