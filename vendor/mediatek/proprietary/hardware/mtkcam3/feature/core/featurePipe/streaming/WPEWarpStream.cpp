...
MVOID WPEWarpStream::prepareDIPParams(Feature::P2Util::DIPParams &param, WPEEnqueData &data)
{
    TRACE_FUNC_ENTER();
    checkMDPOut(data);
...
MVOID WPEWarpStream::setBasic(Feature::P2Util::DIPFrameParams &fparam, const WarpParam &warpParam)
{
    TRACE_FUNC_ENTER();
...
MVOID WPEWarpStream::setInBuffer(Feature::P2Util::DIPFrameParams &fparam, const WarpParam &warpParam)
{
    TRACE_FUNC_ENTER();
...
MVOID WPEWarpStream::setWPEDIPParams(Feature::P2Util::DIPFrameParams &fparam, WPEQParams &wpeQParam, const WarpParam &warpParam)
{
    TRACE_FUNC_ENTER();
...
MVOID WPEWarpStream::setWPECrop(WPEQParams &wpeQParam, const WarpParam &warpParam)
{
    ...
    wpeQParam.wpecropinfo.x_end_point = (dstSize.w & ~(0x1)) - 1;
    wpeQParam.wpecropinfo.y_end_point = (dstSize.h & ~(0x1)) - 1;
