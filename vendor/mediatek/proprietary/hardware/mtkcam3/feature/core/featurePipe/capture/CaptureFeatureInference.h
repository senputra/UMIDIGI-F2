...
struct DataItem
{
    ...
    void initFormat(Format_T fmt, vector<Format_T> vSupportFormats);
    /**
...
private:
    ...
    CaptureFeatureInferenceData(MINT32 iLogLevel = -1);
    ...
    inline MVOID markSupportCroppedFSYUV(MUINT64 nodeId) {
        mSupportCroppedFSYUV.markBit(nodeId);
    }
...
public:
    ...
    android::BitSet64       mSupportCroppedFSYUV;
...
private:
    MVOID syncRequestStatus(const sp<CaptureFeatureRequest> pRequest);
