...
LOCAL_SRC_FILES += ./src/TuningBufferPool.cpp
LOCAL_SRC_FILES += ./src/IIBuffer.cpp
LOCAL_SRC_FILES += ./src/ImageBufferPool.cpp
LOCAL_SRC_FILES += ./src/SecureBufferPool.cpp
LOCAL_SRC_FILES += ./src/NativeBufferWrapper.cpp
LOCAL_SRC_FILES += ./src/SharedBufferPool.cpp
LOCAL_SRC_FILES += ./src/StringUtil.cpp
...
LOCAL_SRC_FILES += ./src/JpegEncodeThread.cpp
################################################################################
