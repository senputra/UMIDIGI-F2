...
MBOOL DepthMapPipe::onInit()
{
    ...
    TEST_AND_CREATE_NODE(eDPETHMAP_PIPE_NODEID_P2A, P2ANode, "P2A");
    TEST_AND_CREATE_NODE(eDPETHMAP_PIPE_NODEID_N3D, N3DNode, "N3D");
    TEST_AND_CREATE_NODE(eDPETHMAP_PIPE_NODEID_DPE, DPENode, "DPE");
    TEST_AND_CREATE_NODE(eDPETHMAP_PIPE_NODEID_WMF, WMFNode, "WMF");
    TEST_AND_CREATE_NODE(eDPETHMAP_PIPE_NODEID_OCC, OCCNode, "OCC");
    TEST_AND_CREATE_NODE(eDPETHMAP_PIPE_NODEID_HWOCC, HW_OCCNode, "HW_OCC");
    TEST_AND_CREATE_NODE(eDPETHMAP_PIPE_NODEID_FD, StereoFDNode, "SFD");
    TEST_AND_CREATE_NODE(eDPETHMAP_PIPE_NODEID_GF, GFNode, "GF");
    TEST_AND_CREATE_NODE(eDPETHMAP_PIPE_NODEID_P2ABAYER, P2ABayerNode, "P2AByer");
...
flush()
{
    ...
    MY_LOGD("DepthMapPipe::flush +:  req size=%zu", mvRequestDataMap.size());
    // set flush status
...
enque(sp<IDepthMapEffectRequest>& request)
{
    ...
    // autolock for request map
    {
        ...
        VSDOF_LOGD("reqID=%d mvRequestDataMap size=%zu ids=%s",
    ...
    if(mvRequestDataMap.size()>MAX_QUEUE_FRAME)
    {
        ...
        MY_LOGE("[Critical] Might occur memory leak, request inside DepthMapPipe is too much, size=%zu", mvRequestDataMap.size());
        return MFALSE;
    }
