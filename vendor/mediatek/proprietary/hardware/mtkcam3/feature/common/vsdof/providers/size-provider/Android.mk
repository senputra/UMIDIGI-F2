...
# For __getBufferSize
ifeq ($(wildcard $(LOCAL_PATH)/buffer-size/$(PLATFORM)),)
	LOCAL_SRC_FILES += buffer-size/default/buffer_size.cpp
else
	LOCAL_SRC_FILES += buffer-size/$(PLATFORM)/buffer_size.cpp
endif
...
ifeq ($(wildcard $(LOCAL_PATH)/size-config/$(PLATFORM)),)
	LOCAL_C_INCLUDES += $(LOCAL_PATH)/size-config/default
else
	LOCAL_C_INCLUDES += $(LOCAL_PATH)/size-config/$(PLATFORM)
endif
