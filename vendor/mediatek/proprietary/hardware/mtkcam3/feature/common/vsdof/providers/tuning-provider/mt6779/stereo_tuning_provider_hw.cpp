...
bool
StereoTuningProvider::getMDPPQParam(VSDOFParam &param)
{
    TuningQuery_T query;
...
bool
StereoTuningProvider::getDPETuningInfo(DPEConfig *tuningBuffer, ENUM_STEREO_SCENARIO eScenario)
{
...
bool
StereoTuningProvider::getISPFETuningInfo(void *tuningBuffer)
{
    TuningQuery_T query;
    query.results[QUERY_KEY_ISP_FE_INFO] = tuningBuffer;
    return StereoTuningProviderKernel::getInstance()->getTuningParams(E_TUNING_HW_ISP_FE, query);
}