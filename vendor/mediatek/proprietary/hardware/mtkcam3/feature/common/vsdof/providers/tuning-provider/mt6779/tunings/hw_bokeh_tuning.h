...
typedef map<int, CNR_REG_D1A_CNR_BOK_TUN*> HW_BOKEH_MAP_T;
...
private:
    ...
    // CNR_REG_D1A_CNR_BOK_TUN weakSetting;
    CNR_REG_D1A_CNR_BOK_TUN normalSetting;
    CNR_REG_D1A_CNR_BOK_TUN strongSetting;
};
