...
# 	LOCAL_WHOLE_STATIC_LIBRARIES += libfeature.vsdof.hal.bokeh
	ifeq ($(HAS_AIDEPTH), 1)
		LOCAL_WHOLE_STATIC_LIBRARIES += libfeature.vsdof.hal.aidepth
		LOCAL_WHOLE_STATIC_LIBRARIES += libfeature.vsdof.hal.videoaidepth
	endif
...
LOCAL_SHARED_LIBRARIES += libmtkcam_calibration_provider
...
endif	#check MTK_CAM_STEREO_CAMERA_SUPPORT
