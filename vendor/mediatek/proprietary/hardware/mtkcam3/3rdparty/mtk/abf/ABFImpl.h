...
#include <mtkcam3/feature/abf/AbfAdapter.h>
...
*
******************************************************************************/
class AbfPluginProviderImp : public YuvPlugin::IProvider
{
...
protected:
    ...
    int32_t                        doAbf(RequestPtr const req);

    AbfAdapter*                    getAbfAdapter();

    bool                           isAbfEnable(IMetadata* pIMetadata_App);
