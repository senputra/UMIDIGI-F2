...
#-----------------------------------------------------------
LOCAL_HEADER_LIBRARIES := libutils_headers liblog_headers libhardware_headers libmtkcam_headers libmtkcam3_headers

#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam.plugin.abf
