...
protected:
    ...
    void*                          getTuningFromNvram(MUINT32 openId, MINT32 magicNo, MINT64 featureCombination, const IMetadata* pInHalMeta) const;

    bool                           queryNrThreshold(MINT32 sensorId, MINT64 const featureCombination, int& hw_threshold, int& swnr_threshold);
