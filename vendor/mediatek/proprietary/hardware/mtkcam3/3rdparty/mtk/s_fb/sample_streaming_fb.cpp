...
#define STR_SHARED_INPUT    "vendor.debug.tpi.s.fb.shareinput"
...
MERROR S_FB_Plugin::getConfigSetting(Selection &sel)
{
    ...
    MINT32 isShareInput = property_get_int32(STR_SHARED_INPUT,0);
    sel.mCfgSharedInput = (isShareInput > 0);
...
MERROR S_FB_Plugin::process(RequestPtr pRequest, RequestCallbackPtr pCallback)
{
        ...
        pRequest->mOBufferMain1 != NULL )
    {
        ...
        bool changeRoi = property_get_bool("vendor.debug.tpi.s.fb.changeRoi", 0);
