...
$(info Create symbol link for vulkan $(TARGET_OUT_VENDOR)/lib64/hw/vulkan.$(TARGET_BOARD_PLATFORM).so)
...
#symbol link for vulkan.$(TARGET_BOARD_PLATFORM).so
$(info Create symbol link for vulkan $(TARGET_OUT_VENDOR)/lib/hw/vulkan.$(TARGET_BOARD_PLATFORM).so)
LOCAL_POST_INSTALL_CMD := \
