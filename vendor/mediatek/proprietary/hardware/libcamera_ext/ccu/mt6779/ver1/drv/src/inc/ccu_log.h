...
#define DECLARE_DBG_LOG_VARIABLE(ModuleName)    \
    ...
    bool CcuDefaultLogV3 = false; \
    bool CcuIsUserLoad = false; \
...
#define EXTERN_DBG_LOG_VARIABLE(ModuleName)    \
    ...
    extern bool CcuDefaultLogV3; \
    extern bool CcuIsUserLoad; \
...
#define DBG_LOG_CONFIG(GroupName, ModuleName)                                       \
    do {                                                                            \
        char acDbgLogLevel[PROPERTY_VALUE_MAX] = {'\0'};                            \
                                                                                    \
        if(CcuDefaultLogV3)                                                       \
            property_get("vendor.debug." #GroupName "." #ModuleName, acDbgLogLevel, "3");  \
        else                                                                        \
            property_get("vendor.debug." #GroupName "." #ModuleName, acDbgLogLevel, "4");  \
                                                                                    \
...
#define DBG_LOG_SET_DEFAULT_LV3() do {CcuDefaultLogV3 = true;} while(0)
#define DBG_LOG_SET_IS_USER_LOAD() do {CcuIsUserLoad = true;} while(0)

#define DEBUG_LOAD_ONLY(STATEMENT) \
    { \
        if(!CcuIsUserLoad) \
        { STATEMENT; } \
    } \
