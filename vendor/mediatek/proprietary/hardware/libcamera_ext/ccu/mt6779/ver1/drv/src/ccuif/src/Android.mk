...
LOCAL_SRC_FILES += ccu_buffer_ltm.cpp
LOCAL_SRC_FILES += ccu_buffer_ae.cpp
LOCAL_SRC_FILES += ccu_buffer_3actrl.cpp
LOCAL_SRC_FILES += ccu_buffer_system.cpp
LOCAL_SRC_FILES += ccu_ctrl.cpp
LOCAL_SRC_FILES += ccu_ctrl_ae.cpp
LOCAL_SRC_FILES += ccu_ctrl_af.cpp
LOCAL_SRC_FILES += ccu_ctrl_ltm.cpp
LOCAL_SRC_FILES += ccu_ctrl_3actrl.cpp
LOCAL_SRC_FILES += ccu_ctrl_system.cpp
LOCAL_SRC_FILES += ccu_mem_mgr.cpp
LOCAL_SRC_FILES += ../../util/ccu_drvutil.cpp
LOCAL_SRC_FILES += ccu_cmd_param_info.cpp

#Feature options
FEATURE_CFLAGS :=
FEATURE_CFLAGS += -DCCU_AF_ENABLE
#FEATURE_CFLAGS += -D__PLATFORM__
...
#for af algo interface
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/isp_50
