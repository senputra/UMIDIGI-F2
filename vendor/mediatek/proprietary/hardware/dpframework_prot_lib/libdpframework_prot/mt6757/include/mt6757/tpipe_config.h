...
#define TPIPE_ISP_BASE_HW     (0x15022000)
#define TPIPE_ISP_ADDR_START  (0x15022000)
#define TPIPE_ISP_ADDR_END    (0x1502647C)
#define TPIPE_REG_DUMP_SKIP_NO ((unsigned int)(TPIPE_ISP_ADDR_START - TPIPE_ISP_BASE_HW)>>2)
...
#define HW_ISP_REG_CMP(CMD, a, b, c, d, e) \
	...
	CMD(a, b, c, d, e, top.pixel_id, REG_CHECK_EN(c, IMGI_EN), 0x00000014, 0x15022014, 0x30000000, 28, DIP_A_CTL_FMT_SEL, PIX_ID, 0x00000014, 0x15022014, 0x30000000, 28, DIP_A_CTL_FMT_SEL, PIX_ID)\
	CMD(a, b, c, d, e, top.cam_in_fmt, REG_CHECK_EN(c, IMGI_EN), 0x00000014, 0x15022014, 0x0000001F, 0, DIP_A_CTL_FMT_SEL, IMGI_FMT, 0x00000014, 0x15022014, 0x0000001F, 0, DIP_A_CTL_FMT_SEL, IMGI_FMT)\
	CMD(a, b, c, d, e, top.ctl_extension_en, REG_CHECK_EN(c, IMGI_EN), 0x00000050, 0x15022050, 0x00000002, 1, DIP_A_CTL_TDR_CTL, CTL_EXTENSION_EN, 0x00000050, 0x15022050, 0x00000002, 1, DIP_A_CTL_TDR_CTL, CTL_EXTENSION_EN)\
	CMD(a, b, c, d, e, top.fg_mode, REG_CHECK_EN(c, IMGI_EN), 0x00000014, 0x15022014, 0x00080000, 19, DIP_A_CTL_FMT_SEL, FG_MODE, 0x00000014, 0x15022014, 0x00080000, 19, DIP_A_CTL_FMT_SEL, FG_MODE)\
	CMD(a, b, c, d, e, top.ufo_imgi_en, REG_CHECK_EN(c, IMGI_EN), 0x0000021C, 0x1502221C, 0x20000000, 29, DIP_A_SPECIAL_FUN_EN, UFO_IMGI_EN, 0x0000021C, 0x1502221C, 0x20000000, 29, DIP_A_SPECIAL_FUN_EN, UFO_IMGI_EN)\
	CMD(a, b, c, d, e, top.ufdi_fmt, REG_CHECK_EN(c, IMGI_EN), 0x00000014, 0x15022014, 0x00010000, 16, DIP_A_CTL_FMT_SEL, UFDI_FMT, 0x00000014, 0x15022014, 0x00010000, 16, DIP_A_CTL_FMT_SEL, UFDI_FMT)\
	CMD(a, b, c, d, e, top.vipi_fmt, REG_CHECK_EN(c, IMGI_EN), 0x00000014, 0x15022014, 0x00001F00, 8, DIP_A_CTL_FMT_SEL, VIPI_FMT, 0x00000014, 0x15022014, 0x00001F00, 8, DIP_A_CTL_FMT_SEL, VIPI_FMT)\
	CMD(a, b, c, d, e, top.img3o_fmt, REG_CHECK_EN(c, IMGI_EN), 0x00000014, 0x15022014, 0x00700000, 20, DIP_A_CTL_FMT_SEL, IMG3O_FMT, 0x00000014, 0x15022014, 0x00700000, 20, DIP_A_CTL_FMT_SEL, IMG3O_FMT)\
	CMD(a, b, c, d, e, top.img2o_fmt, REG_CHECK_EN(c, IMGI_EN), 0x00000014, 0x15022014, 0x01000000, 24, DIP_A_CTL_FMT_SEL, IMG2O_FMT, 0x00000014, 0x15022014, 0x01000000, 24, DIP_A_CTL_FMT_SEL, IMG2O_FMT)\
	CMD(a, b, c, d, e, top.pak2_fmt, REG_CHECK_EN(c, IMGI_EN), 0x0000001C, 0x1502201C, 0x0000F000, 12, DIP_A_CTL_MISC_SEL, PAK2_FMT, 0x0000001C, 0x1502201C, 0x0000F000, 12, DIP_A_CTL_MISC_SEL, PAK2_FMT)\
	CMD(a, b, c, d, e, top.imgi_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000001, 0, DIP_A_CTL_DMA_EN, IMGI_EN, 0x00000010, 0x15022010, 0x00000001, 0, DIP_A_CTL_DMA_EN, IMGI_EN)\
	CMD(a, b, c, d, e, top.imgbi_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000002, 1, DIP_A_CTL_DMA_EN, IMGBI_EN, 0x00000010, 0x15022010, 0x00000002, 1, DIP_A_CTL_DMA_EN, IMGBI_EN)\
	CMD(a, b, c, d, e, top.imgci_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000004, 2, DIP_A_CTL_DMA_EN, IMGCI_EN, 0x00000010, 0x15022010, 0x00000004, 2, DIP_A_CTL_DMA_EN, IMGCI_EN)\
	CMD(a, b, c, d, e, top.ufdi_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000008, 3, DIP_A_CTL_DMA_EN, UFDI_EN, 0x00000010, 0x15022010, 0x00000008, 3, DIP_A_CTL_DMA_EN, UFDI_EN)\
	CMD(a, b, c, d, e, top.unp_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000001, 0, DIP_A_CTL_RGB_EN, UNP_EN, 0x0000000C, 0x1502200C, 0x00000001, 0, DIP_A_CTL_RGB_EN, UNP_EN)\
	CMD(a, b, c, d, e, top.ufd_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000002, 1, DIP_A_CTL_RGB_EN, UFD_EN, 0x0000000C, 0x1502200C, 0x00000002, 1, DIP_A_CTL_RGB_EN, UFD_EN)\
	CMD(a, b, c, d, e, top.lsc2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00008000, 15, DIP_A_CTL_RGB_EN, LSC2_EN, 0x0000000C, 0x1502200C, 0x00008000, 15, DIP_A_CTL_RGB_EN, LSC2_EN)\
	CMD(a, b, c, d, e, top.sl2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000008, 3, DIP_A_CTL_RGB_EN, SL2_EN, 0x0000000C, 0x1502200C, 0x00000008, 3, DIP_A_CTL_RGB_EN, SL2_EN)\
	CMD(a, b, c, d, e, top.rnr_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00040000, 18, DIP_A_CTL_RGB_EN, RNR_EN, 0x0000000C, 0x1502200C, 0x00040000, 18, DIP_A_CTL_RGB_EN, RNR_EN)\
	CMD(a, b, c, d, e, top.udm_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000010, 4, DIP_A_CTL_RGB_EN, UDM_EN, 0x0000000C, 0x1502200C, 0x00000010, 4, DIP_A_CTL_RGB_EN, UDM_EN)\
	CMD(a, b, c, d, e, top.c24_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000004, 2, DIP_A_CTL_YUV_EN, C24_EN, 0x00000004, 0x15022004, 0x00000004, 2, DIP_A_CTL_YUV_EN, C24_EN)\
	CMD(a, b, c, d, e, top.vipi_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000010, 4, DIP_A_CTL_DMA_EN, VIPI_EN, 0x00000010, 0x15022010, 0x00000010, 4, DIP_A_CTL_DMA_EN, VIPI_EN)\
	CMD(a, b, c, d, e, top.vip2i_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000020, 5, DIP_A_CTL_DMA_EN, VIP2I_EN, 0x00000010, 0x15022010, 0x00000020, 5, DIP_A_CTL_DMA_EN, VIP2I_EN)\
	CMD(a, b, c, d, e, top.vip3i_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000040, 6, DIP_A_CTL_DMA_EN, VIP3I_EN, 0x00000010, 0x15022010, 0x00000040, 6, DIP_A_CTL_DMA_EN, VIP3I_EN)\
	CMD(a, b, c, d, e, top.mfb_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000001, 0, DIP_A_CTL_YUV_EN, MFB_EN, 0x00000004, 0x15022004, 0x00000001, 0, DIP_A_CTL_YUV_EN, MFB_EN)\
	CMD(a, b, c, d, e, top.mfbw_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x04000000, 26, DIP_A_CTL_YUV_EN, MFBW_EN, 0x00000004, 0x15022004, 0x04000000, 26, DIP_A_CTL_YUV_EN, MFBW_EN)\
	CMD(a, b, c, d, e, top.mfbo_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000400, 10, DIP_A_CTL_DMA_EN, MFBO_EN, 0x00000010, 0x15022010, 0x00000400, 10, DIP_A_CTL_DMA_EN, MFBO_EN)\
	CMD(a, b, c, d, e, top.g2c_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000008, 3, DIP_A_CTL_YUV_EN, G2C_EN, 0x00000004, 0x15022004, 0x00000008, 3, DIP_A_CTL_YUV_EN, G2C_EN)\
	CMD(a, b, c, d, e, top.c42_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000010, 4, DIP_A_CTL_YUV_EN, C42_EN, 0x00000004, 0x15022004, 0x00000010, 4, DIP_A_CTL_YUV_EN, C42_EN)\
	CMD(a, b, c, d, e, top.sl2b_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000800, 11, DIP_A_CTL_YUV_EN, SL2B_EN, 0x00000004, 0x15022004, 0x00000800, 11, DIP_A_CTL_YUV_EN, SL2B_EN)\
	CMD(a, b, c, d, e, top.nbc_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000020, 5, DIP_A_CTL_YUV_EN, NBC_EN, 0x00000004, 0x15022004, 0x00000020, 5, DIP_A_CTL_YUV_EN, NBC_EN)\
	CMD(a, b, c, d, e, top.nbc2_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000040, 6, DIP_A_CTL_YUV_EN, NBC2_EN, 0x00000004, 0x15022004, 0x00000040, 6, DIP_A_CTL_YUV_EN, NBC2_EN)\
	CMD(a, b, c, d, e, top.mix1_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00040000, 18, DIP_A_CTL_YUV_EN, MIX1_EN, 0x00000004, 0x15022004, 0x00040000, 18, DIP_A_CTL_YUV_EN, MIX1_EN)\
	CMD(a, b, c, d, e, top.mix2_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00080000, 19, DIP_A_CTL_YUV_EN, MIX2_EN, 0x00000004, 0x15022004, 0x00080000, 19, DIP_A_CTL_YUV_EN, MIX2_EN)\
	CMD(a, b, c, d, e, top.pca_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000080, 7, DIP_A_CTL_YUV_EN, PCA_EN, 0x00000004, 0x15022004, 0x00000080, 7, DIP_A_CTL_YUV_EN, PCA_EN)\
	CMD(a, b, c, d, e, top.sl2c_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00001000, 12, DIP_A_CTL_YUV_EN, SL2C_EN, 0x00000004, 0x15022004, 0x00001000, 12, DIP_A_CTL_YUV_EN, SL2C_EN)\
	CMD(a, b, c, d, e, top.sl2d_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00002000, 13, DIP_A_CTL_YUV_EN, SL2D_EN, 0x00000004, 0x15022004, 0x00002000, 13, DIP_A_CTL_YUV_EN, SL2D_EN)\
	CMD(a, b, c, d, e, top.sl2e_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00004000, 14, DIP_A_CTL_YUV_EN, SL2E_EN, 0x00000004, 0x15022004, 0x00004000, 14, DIP_A_CTL_YUV_EN, SL2E_EN)\
	CMD(a, b, c, d, e, top.sl2g_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00080000, 19, DIP_A_CTL_RGB_EN, SL2G_EN, 0x0000000C, 0x1502200C, 0x00080000, 19, DIP_A_CTL_RGB_EN, SL2G_EN)\
	CMD(a, b, c, d, e, top.sl2h_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00100000, 20, DIP_A_CTL_RGB_EN, SL2H_EN, 0x0000000C, 0x1502200C, 0x00100000, 20, DIP_A_CTL_RGB_EN, SL2H_EN)\
	CMD(a, b, c, d, e, top.sl2i_en, REG_CHECK_EN(c, IMGI_EN), 0x00000008, 0x15022008, 0x00000020, 5, DIP_A_CTL_YUV2_EN, SL2I_EN, 0x00000008, 0x15022008, 0x00000020, 5, DIP_A_CTL_YUV2_EN, SL2I_EN)\
	CMD(a, b, c, d, e, top.hfg_en, REG_CHECK_EN(c, IMGI_EN), 0x00000008, 0x15022008, 0x00000010, 4, DIP_A_CTL_YUV2_EN, HFG_EN, 0x00000008, 0x15022008, 0x00000010, 4, DIP_A_CTL_YUV2_EN, HFG_EN)\
	CMD(a, b, c, d, e, top.seee_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000100, 8, DIP_A_CTL_YUV_EN, SEEE_EN, 0x00000004, 0x15022004, 0x00000100, 8, DIP_A_CTL_YUV_EN, SEEE_EN)\
	CMD(a, b, c, d, e, top.lcei_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000080, 7, DIP_A_CTL_DMA_EN, LCEI_EN, 0x00000010, 0x15022010, 0x00000080, 7, DIP_A_CTL_DMA_EN, LCEI_EN)\
	CMD(a, b, c, d, e, top.lce_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000020, 5, DIP_A_CTL_RGB_EN, LCE_EN, 0x0000000C, 0x1502200C, 0x00000020, 5, DIP_A_CTL_RGB_EN, LCE_EN)\
	CMD(a, b, c, d, e, top.mix3_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00100000, 20, DIP_A_CTL_YUV_EN, MIX3_EN, 0x00000004, 0x15022004, 0x00100000, 20, DIP_A_CTL_YUV_EN, MIX3_EN)\
	CMD(a, b, c, d, e, top.crz_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00020000, 17, DIP_A_CTL_YUV_EN, CRZ_EN, 0x00000004, 0x15022004, 0x00020000, 17, DIP_A_CTL_YUV_EN, CRZ_EN)\
	CMD(a, b, c, d, e, top.img2o_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000800, 11, DIP_A_CTL_DMA_EN, IMG2O_EN, 0x00000010, 0x15022010, 0x00000800, 11, DIP_A_CTL_DMA_EN, IMG2O_EN)\
	CMD(a, b, c, d, e, top.img2bo_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00001000, 12, DIP_A_CTL_DMA_EN, IMG2BO_EN, 0x00000010, 0x15022010, 0x00001000, 12, DIP_A_CTL_DMA_EN, IMG2BO_EN)\
	CMD(a, b, c, d, e, top.srz1_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00008000, 15, DIP_A_CTL_YUV_EN, SRZ1_EN, 0x00000004, 0x15022004, 0x00008000, 15, DIP_A_CTL_YUV_EN, SRZ1_EN)\
	CMD(a, b, c, d, e, top.fe_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x02000000, 25, DIP_A_CTL_YUV_EN, FE_EN, 0x00000004, 0x15022004, 0x02000000, 25, DIP_A_CTL_YUV_EN, FE_EN)\
	CMD(a, b, c, d, e, top.feo_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00010000, 16, DIP_A_CTL_DMA_EN, FEO_EN, 0x00000010, 0x15022010, 0x00010000, 16, DIP_A_CTL_DMA_EN, FEO_EN)\
	CMD(a, b, c, d, e, top.c02_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x01000000, 24, DIP_A_CTL_YUV_EN, C02_EN, 0x00000004, 0x15022004, 0x01000000, 24, DIP_A_CTL_YUV_EN, C02_EN)\
	CMD(a, b, c, d, e, top.c02b_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000002, 1, DIP_A_CTL_YUV_EN, C02B_EN, 0x00000004, 0x15022004, 0x00000002, 1, DIP_A_CTL_YUV_EN, C02B_EN)\
	CMD(a, b, c, d, e, top.nr3d_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00000400, 10, DIP_A_CTL_YUV_EN, NR3D_EN, 0x00000004, 0x15022004, 0x00000400, 10, DIP_A_CTL_YUV_EN, NR3D_EN)\
	CMD(a, b, c, d, e, top.crsp_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00200000, 21, DIP_A_CTL_YUV_EN, CRSP_EN, 0x00000004, 0x15022004, 0x00200000, 21, DIP_A_CTL_YUV_EN, CRSP_EN)\
	CMD(a, b, c, d, e, top.img3o_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00002000, 13, DIP_A_CTL_DMA_EN, IMG3O_EN, 0x00000010, 0x15022010, 0x00002000, 13, DIP_A_CTL_DMA_EN, IMG3O_EN)\
	CMD(a, b, c, d, e, top.img3bo_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00004000, 14, DIP_A_CTL_DMA_EN, IMG3BO_EN, 0x00000010, 0x15022010, 0x00004000, 14, DIP_A_CTL_DMA_EN, IMG3BO_EN)\
	CMD(a, b, c, d, e, top.img3co_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00008000, 15, DIP_A_CTL_DMA_EN, IMG3CO_EN, 0x00000010, 0x15022010, 0x00008000, 15, DIP_A_CTL_DMA_EN, IMG3CO_EN)\
	CMD(a, b, c, d, e, top.c24b_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00400000, 22, DIP_A_CTL_YUV_EN, C24B_EN, 0x00000004, 0x15022004, 0x00400000, 22, DIP_A_CTL_YUV_EN, C24B_EN)\
	CMD(a, b, c, d, e, top.mdp_crop_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00800000, 23, DIP_A_CTL_YUV_EN, MDPCROP_EN, 0x00000004, 0x15022004, 0x00800000, 23, DIP_A_CTL_YUV_EN, MDPCROP_EN)\
	CMD(a, b, c, d, e, top.srz2_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x00010000, 16, DIP_A_CTL_YUV_EN, SRZ2_EN, 0x00000004, 0x15022004, 0x00010000, 16, DIP_A_CTL_YUV_EN, SRZ2_EN)\
	CMD(a, b, c, d, e, top.pgn_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000004, 2, DIP_A_CTL_RGB_EN, PGN_EN, 0x0000000C, 0x1502200C, 0x00000004, 2, DIP_A_CTL_RGB_EN, PGN_EN)\
	CMD(a, b, c, d, e, top.g2g_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000040, 6, DIP_A_CTL_RGB_EN, G2G_EN, 0x0000000C, 0x1502200C, 0x00000040, 6, DIP_A_CTL_RGB_EN, G2G_EN)\
	CMD(a, b, c, d, e, top.flc_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00200000, 21, DIP_A_CTL_RGB_EN, FLC_EN, 0x0000000C, 0x1502200C, 0x00200000, 21, DIP_A_CTL_RGB_EN, FLC_EN)\
	CMD(a, b, c, d, e, top.flc2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00400000, 22, DIP_A_CTL_RGB_EN, FLC2_EN, 0x0000000C, 0x1502200C, 0x00400000, 22, DIP_A_CTL_RGB_EN, FLC2_EN)\
	CMD(a, b, c, d, e, top.ggm_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000080, 7, DIP_A_CTL_RGB_EN, GGM_EN, 0x0000000C, 0x1502200C, 0x00000080, 7, DIP_A_CTL_RGB_EN, GGM_EN)\
	CMD(a, b, c, d, e, top.dmgi_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000200, 9, DIP_A_CTL_DMA_EN, DMGI_EN, 0x00000010, 0x15022010, 0x00000200, 9, DIP_A_CTL_DMA_EN, DMGI_EN)\
	CMD(a, b, c, d, e, top.depi_en, REG_CHECK_EN(c, IMGI_EN), 0x00000010, 0x15022010, 0x00000100, 8, DIP_A_CTL_DMA_EN, DEPI_EN, 0x00000010, 0x15022010, 0x00000100, 8, DIP_A_CTL_DMA_EN, DEPI_EN)\
	CMD(a, b, c, d, e, top.plnr1_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x20000000, 29, DIP_A_CTL_YUV_EN, PLNR1_EN, 0x00000004, 0x15022004, 0x20000000, 29, DIP_A_CTL_YUV_EN, PLNR1_EN)\
	CMD(a, b, c, d, e, top.plnr2_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x80000000, 31, DIP_A_CTL_YUV_EN, PLNR2_EN, 0x00000004, 0x15022004, 0x80000000, 31, DIP_A_CTL_YUV_EN, PLNR2_EN)\
	CMD(a, b, c, d, e, top.plnw1_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x10000000, 28, DIP_A_CTL_YUV_EN, PLNW1_EN, 0x00000004, 0x15022004, 0x10000000, 28, DIP_A_CTL_YUV_EN, PLNW1_EN)\
	CMD(a, b, c, d, e, top.plnw2_en, REG_CHECK_EN(c, IMGI_EN), 0x00000004, 0x15022004, 0x40000000, 30, DIP_A_CTL_YUV_EN, PLNW2_EN, 0x00000004, 0x15022004, 0x40000000, 30, DIP_A_CTL_YUV_EN, PLNW2_EN)\
	CMD(a, b, c, d, e, top.dbs2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000400, 10, DIP_A_CTL_RGB_EN, DBS2_EN, 0x0000000C, 0x1502200C, 0x00000400, 10, DIP_A_CTL_RGB_EN, DBS2_EN)\
	CMD(a, b, c, d, e, top.bnr2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00002000, 13, DIP_A_CTL_RGB_EN, BNR2_EN, 0x0000000C, 0x1502200C, 0x00002000, 13, DIP_A_CTL_RGB_EN, BNR2_EN)\
	CMD(a, b, c, d, e, top.gdr1_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000100, 8, DIP_A_CTL_RGB_EN, GDR1_EN, 0x0000000C, 0x1502200C, 0x00000100, 8, DIP_A_CTL_RGB_EN, GDR1_EN)\
	CMD(a, b, c, d, e, top.gdr2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000200, 9, DIP_A_CTL_RGB_EN, GDR2_EN, 0x0000000C, 0x1502200C, 0x00000200, 9, DIP_A_CTL_RGB_EN, GDR2_EN)\
	CMD(a, b, c, d, e, top.obc2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00000800, 11, DIP_A_CTL_RGB_EN, OBC2_EN, 0x0000000C, 0x1502200C, 0x00000800, 11, DIP_A_CTL_RGB_EN, OBC2_EN)\
	CMD(a, b, c, d, e, top.rmg2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00001000, 12, DIP_A_CTL_RGB_EN, RMG2_EN, 0x0000000C, 0x1502200C, 0x00001000, 12, DIP_A_CTL_RGB_EN, RMG2_EN)\
	CMD(a, b, c, d, e, top.rmm2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00004000, 14, DIP_A_CTL_RGB_EN, RMM2_EN, 0x0000000C, 0x1502200C, 0x00004000, 14, DIP_A_CTL_RGB_EN, RMM2_EN)\
	CMD(a, b, c, d, e, top.srz3_en, REG_CHECK_EN(c, IMGI_EN), 0x00000008, 0x15022008, 0x00000002, 1, DIP_A_CTL_YUV2_EN, SRZ3_EN, 0x00000008, 0x15022008, 0x00000002, 1, DIP_A_CTL_YUV2_EN, SRZ3_EN)\
	CMD(a, b, c, d, e, top.srz4_en, REG_CHECK_EN(c, IMGI_EN), 0x00000008, 0x15022008, 0x00000004, 2, DIP_A_CTL_YUV2_EN, SRZ4_EN, 0x00000008, 0x15022008, 0x00000004, 2, DIP_A_CTL_YUV2_EN, SRZ4_EN)\
	CMD(a, b, c, d, e, top.rcp2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00010000, 16, DIP_A_CTL_RGB_EN, RCP2_EN, 0x0000000C, 0x1502200C, 0x00010000, 16, DIP_A_CTL_RGB_EN, RCP2_EN)\
	CMD(a, b, c, d, e, top.pak2_en, REG_CHECK_EN(c, IMGI_EN), 0x0000000C, 0x1502200C, 0x00020000, 17, DIP_A_CTL_RGB_EN, PAK2_EN, 0x0000000C, 0x1502200C, 0x00020000, 17, DIP_A_CTL_RGB_EN, PAK2_EN)\
	...
	CMD(a, b, c, d, e, top.pgn_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00000004, 2, DIP_A_CTL_PATH_SEL, PGN_SEL, 0x00000018, 0x15022018, 0x00000004, 2, DIP_A_CTL_PATH_SEL, PGN_SEL)\
	CMD(a, b, c, d, e, top.rcp2_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00060000, 17, DIP_A_CTL_PATH_SEL, RCP2_SEL, 0x00000018, 0x15022018, 0x00060000, 17, DIP_A_CTL_PATH_SEL, RCP2_SEL)\
	CMD(a, b, c, d, e, top.g2g_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00000003, 0, DIP_A_CTL_PATH_SEL, G2G_SEL, 0x00000018, 0x15022018, 0x00000003, 0, DIP_A_CTL_PATH_SEL, G2G_SEL)\
	CMD(a, b, c, d, e, top.g2c_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00000010, 4, DIP_A_CTL_PATH_SEL, G2C_SEL, 0x00000018, 0x15022018, 0x00000010, 4, DIP_A_CTL_PATH_SEL, G2C_SEL)\
	CMD(a, b, c, d, e, top.srz1_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x000000C0, 6, DIP_A_CTL_PATH_SEL, SRZ1_SEL, 0x00000018, 0x15022018, 0x000000C0, 6, DIP_A_CTL_PATH_SEL, SRZ1_SEL)\
	CMD(a, b, c, d, e, top.mix1_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00000100, 8, DIP_A_CTL_PATH_SEL, MIX1_SEL, 0x00000018, 0x15022018, 0x00000100, 8, DIP_A_CTL_PATH_SEL, MIX1_SEL)\
	CMD(a, b, c, d, e, top.crz_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00003000, 12, DIP_A_CTL_PATH_SEL, CRZ_SEL, 0x00000018, 0x15022018, 0x00003000, 12, DIP_A_CTL_PATH_SEL, CRZ_SEL)\
	CMD(a, b, c, d, e, top.nr3d_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00004000, 14, DIP_A_CTL_PATH_SEL, NR3D_SEL, 0x00000018, 0x15022018, 0x00004000, 14, DIP_A_CTL_PATH_SEL, NR3D_SEL)\
	CMD(a, b, c, d, e, top.fe_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00010000, 16, DIP_A_CTL_PATH_SEL, FE_SEL, 0x00000018, 0x15022018, 0x00010000, 16, DIP_A_CTL_PATH_SEL, FE_SEL)\
	CMD(a, b, c, d, e, top.mdp_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00008000, 15, DIP_A_CTL_PATH_SEL, MDP_SEL, 0x00000018, 0x15022018, 0x00008000, 15, DIP_A_CTL_PATH_SEL, MDP_SEL)\
	CMD(a, b, c, d, e, top.nbcw_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00000800, 11, DIP_A_CTL_PATH_SEL, NBCW_SEL, 0x00000018, 0x15022018, 0x00000800, 11, DIP_A_CTL_PATH_SEL, NBCW_SEL)\
	CMD(a, b, c, d, e, top.nbc_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00000400, 10, DIP_A_CTL_PATH_SEL, NBC_SEL, 0x00000018, 0x15022018, 0x00000400, 10, DIP_A_CTL_PATH_SEL, NBC_SEL)\
	CMD(a, b, c, d, e, top.mfbo_sel, REG_CHECK_EN(c, IMGI_EN), 0x0000001C, 0x1502201C, 0x00000300, 8, DIP_A_CTL_MISC_SEL, MFBO_SEL, 0x0000001C, 0x1502201C, 0x00000300, 8, DIP_A_CTL_MISC_SEL, MFBO_SEL)\
	CMD(a, b, c, d, e, top.crsp_sel, REG_CHECK_EN(c, IMGI_EN), 0x00000018, 0x15022018, 0x00080000, 19, DIP_A_CTL_PATH_SEL, CRSP_SEL, 0x00000018, 0x15022018, 0x00080000, 19, DIP_A_CTL_PATH_SEL, CRSP_SEL)\
	CMD(a, b, c, d, e, top.feo_sel, REG_CHECK_EN(c, IMGI_EN), 0x0000001C, 0x1502201C, 0x00000400, 10, DIP_A_CTL_MISC_SEL, FEO_SEL, 0x0000001C, 0x1502201C, 0x00000400, 10, DIP_A_CTL_MISC_SEL, FEO_SEL)\
	CMD(a, b, c, d, e, top.interlace_mode, REG_CHECK_EN(c, IMGI_EN), 0x0000021C, 0x1502221C, 0x40000000, 30, DIP_A_SPECIAL_FUN_EN, INTERLACE_MODE, 0x0000021C, 0x1502221C, 0x40000000, 30, DIP_A_SPECIAL_FUN_EN, INTERLACE_MODE)\
	...
	CMD(a, b, c, d, e, mfb.bld_deblock_en, REG_CMP_EQ(c, LOG_MFB_EN, 1), 0x00000810, 0x15022810, 0x00000020, 5, DIP_A_MFB_CON, BLD_LL_DB_EN, 0x00000810, 0x15022810, 0x00000020, 5, DIP_A_MFB_CON, BLD_LL_DB_EN)\
	CMD(a, b, c, d, e, mfb.bld_brz_en, REG_CMP_EQ(c, LOG_MFB_EN, 1), 0x00000810, 0x15022810, 0x00000010, 4, DIP_A_MFB_CON, BLD_LL_BRZ_EN, 0x00000810, 0x15022810, 0x00000010, 4, DIP_A_MFB_CON, BLD_LL_BRZ_EN)\
	CMD(a, b, c, d, e, mfb.bld_mbd_wt_en, REG_CMP_EQ(c, LOG_MFB_EN, 1), 0x00000810, 0x15022810, 0x00000040, 6, DIP_A_MFB_CON, BLD_MBD_WT_EN, 0x00000810, 0x15022810, 0x00000040, 6, DIP_A_MFB_CON, BLD_MBD_WT_EN)\
...
typedef struct ISP_DRIVER_CONFIG_STRUCT
{
    ...
    unsigned int regCount; //read how many register from this request, Maximum is four.
    unsigned int ReadAddrList[MAX_READ_REG_NUM];  // saved which register addresss which you are interested in
...
{
    int se_edge;
    int itune_see_method; // E2 remove 2016/08/17
