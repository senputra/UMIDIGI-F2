...
#define tile_driver_printf(fmt, ...) ((void)__android_log_print(ANDROID_LOG_ERROR, "MDP/T", "[%s][%d] " fmt, __FILE__, __LINE__, ##__VA_ARGS__))
...
#define MAX_ISP_MASK_HEX_PER_TILE (160)
#define MAX_ISP_TILE_TDR_HEX_NO (MAX_TILE_TOT_NO*MAX_ISP_DUMP_HEX_PER_TILE)
#define MAX_ISP_DUMP_HEX_PER_TILE_INTERNAL (32)
#define MAX_ISP_MASK_HEX_PER_TILE_INTERNAL (32)
...
#define MAX_TILE_FUNC_EN_NO (100)
...
#define TILE_MODE_CAL(tile_sel) ((((tile_sel) & 0x1)?1:0) + (((tile_sel) & 0x2)?1:0))
...
typedef enum TILE_FUNC_ID_ENUM
{
    ...
    TILE_FUNC_MFB_WT_ID = (303),
    TILE_FUNC_MFB_PAD_ID = (1301),
    TILE_FUNC_MFBO_ID = (1040),
    TILE_FUNC_MFBW_ID = (2301),
    TILE_FUNC_MFBW_PAD_ID = (2302),
    TILE_FUNC_G2C_ID = (4),
    TILE_FUNC_C42_ID = (51),
    TILE_FUNC_SL2B_ID = (218),
    TILE_FUNC_SL2B_CROP_ID = (2218),
    ...
    TILE_FUNC_FLC_ID = (3017),
    TILE_FUNC_FLC2_ID = (3018),
    TILE_FUNC_GGM_ID = (3012),
    TILE_FUNC_PGN_ID = (3013),
    TILE_FUNC_RMG2_ID = (3014),
    TILE_FUNC_RCP2_ID = (3015),
    TILE_FUNC_PAK2_ID = (3016),
    TILE_FUNC_SL2G_ID = (3031),
    TILE_FUNC_SL2G_CROP_ID = (3032),
    TILE_FUNC_HLR2_ID = (3033),
	TILE_FUNC_SL2I_ID = (3034),
    TILE_FUNC_HFG_ID = (3035),
    TILE_FUNC_HFG_CROP_ID = (3036),
    TILE_FUNC_HFC_ID = (3037),
...
#define TILE_FUNC_BLOCK_LUT(CMD, a, b, c, d, e) \
    ...
    CMD(a, b, c, d, e, int, in_tile_width_max,,,, S,,)\
    ...
    CMD(a, b, c, d, e, int, out_tile_width_max,,,, S,,)\
    ...
    CMD(a, b, c, d, e, int, in_tile_height_max,,,, S,,)\
    ...
    CMD(a, b, c, d, e, int, out_tile_height_max,,,, S,,)\
...
#define TILE_SUPPORT_DUMP_LUT_INTERNAL(LABEL, CMD, a, b, c, d, e, f, max_count, result) \
    LABEL##_TILE_SUPPORT_DUMP_LUT_INTERNAL(CMD, a, b, c, d, e, f, max_count, result)\
...
#define TILE_REG_TO_DUMP(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) TILE_REG_TO_DUMP_##m(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...)
#define TILE_REG_TO_DUMP_U(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
            ...
            {\
				...
				{\
					...
					{\
						...
						{\
							(b) |= (((a)->i << count) & j);\
							/* tile_driver_printf("hex no: %d, dump name: %s\r\n", (f), #i); */\
							break;\
						}\
					}\
				}\
...
#define TILE_REG_TO_DUMP_S(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if ((g) != (c))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_MASK_TO_DUMP(a, b, c, d, e, f, max_count, result, g, h, i, j, k,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if ((g) != (c))\
...
//e: mask_val
//f: dump_file
#define TILE_MASK_VAL_DUMP(a, b, c, d, e, f, max_count, result, g, h, i, j, k,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if ((g) != (c))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_BACKUP_TO_DUMP(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) TILE_BACKUP_TO_DUMP_##m(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l,...)
#define TILE_BACKUP_TO_DUMP_U(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_BACKUP_TO_DUMP_S(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
				...
				{\
					...
					{\
						...
						{\
							...
							if (temp_reg < 0)\
							{\
								*((d) + (b)) |= (((j>>count) + temp_reg + 1) << count) & j;\
							}\
							else\
							{\
								*((d) + (b)) |= (temp_reg << count) & j;\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_BACKUP_TO_DUMP_D(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) TILE_BACKUP_TO_DUMP_D_##m(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...)
#define TILE_BACKUP_TO_DUMP_D_U(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_BACKUP_TO_DUMP_D_S(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_RESTORE_TO_REG(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) TILE_RESTORE_TO_REG_##m(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...)
#define TILE_RESTORE_TO_REG_U(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_RESTORE_TO_REG_S(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
			...
			{\
				...
				{\
					...
					{\
						...
						{\
							int temp_reg = (*((d) + (b)) >> count) & (j >> count);\
							if (temp_reg & (((j >> count) & 0x1) + (j >>(count + 1))))\
							{\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_RESTORE_TO_REG_D(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) TILE_RESTORE_TO_REG_D_##m(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...)
#define TILE_RESTORE_TO_REG_D_U(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_RESTORE_TO_REG_D_S(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_UPDATE_TO_REG(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) TILE_UPDATE_TO_REG_##m(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...)
#define TILE_UPDATE_TO_REG_U(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_UPDATE_TO_REG_S(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_UPDATE_TO_REG_D(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) TILE_UPDATE_TO_REG_D_##m(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...)
#define TILE_UPDATE_TO_REG_D_U(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_UPDATE_TO_REG_D_S(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_DUMP_INV_REG(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) TILE_DUMP_INV_REG_##m(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...)
#define TILE_DUMP_INV_REG_U(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
	if (ISP_MESSAGE_TILE_OK == (result))\
	{\
		if ((g) != (c))\
...
#define TILE_DUMP_INV_REG_S(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
	if (ISP_MESSAGE_TILE_OK == (result))\
	{\
		if ((g) != (c))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_FPRINT_TDR_DUMP_HEX(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) TILE_FPRINT_TDR_DUMP_HEX_##m(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...)
#define TILE_FPRINT_TDR_DUMP_HEX_U(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if ((g) != (c))\
...
#define TILE_FPRINT_TDR_DUMP_HEX_S(a, b, c, d, e, f, max_count, result, g, h, i, j, k, l, m,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if ((g) != (c))\
