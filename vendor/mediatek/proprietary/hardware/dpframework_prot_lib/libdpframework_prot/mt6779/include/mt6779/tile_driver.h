...
#define TILE_DIRECT_LINK_FUNC_NUM	TILE_FUNC_MCRP_D1_ID
//#define TILE_DIRECT_LINK_FUNC_NUM	TILE_FUNC_IMG2O_ID
//#define TILE_DIRECT_LINK_FUNC_NUM	TILE_FUNC_IMG3O_ID
//#define TILE_DIRECT_LINK_FUNC_NUM	TILE_FUNC_MCRP_D2_ID
...
#define MAX_TILE_WIDTH_HW_MFB (256) /* 0: read tile width from INIT_PROPERTY_LUT, 256: unified HW tile width */
#define MAX_TILE_WIDTH_MFB 0 /* 0: read tile width from INIT_PROPERTY_LUT, MAX_TILE_WIDTH_HW_MFB: unified HW tile width */
#define MAX_TILE_HEIGHT_HW (8192)
#define MAX_ISP_MASK_HEX_PER_TILE (342)
#define MAX_ISP_MASK_HEX_PER_TILE_WPE (4)
#define MAX_ISP_MASK_HEX_PER_TILE_MFB (64)
...
#define MAX_ISP_TILE_TDR_HEX_NO_WPE_S (MAX_TILE_TOT_NO*MAX_ISP_DUMP_HEX_PER_TILE_WPE_S)
#define MAX_ISP_TILE_TDR_HEX_NO_MFB (MAX_TILE_TOT_NO*MAX_ISP_DUMP_HEX_PER_TILE_MFB)
#define MAX_ISP_DUMP_HEX_PER_TILE_INTERNAL (128)
#define MAX_ISP_MASK_HEX_PER_TILE_INTERNAL (128)
#define MAX_ISP_DUMP_HEX_PER_TILE_INTERNAL_WPE (4)
#define MAX_ISP_MASK_HEX_PER_TILE_INTERNAL_WPE (4)
#define MAX_ISP_DUMP_HEX_PER_TILE_INTERNAL_MFB (32)
#define MAX_ISP_MASK_HEX_PER_TILE_INTERNAL_MFB (32)
...
#define MAX_ISP_TILE_TDR_HEX_NO_INTERNAL_MFB (MAX_TILE_TOT_NO*MAX_ISP_DUMP_HEX_PER_TILE_INTERNAL_MFB)
...
#define MIN_TDR_WORD_NO_WPE (3)
#define MIN_TDR_WORD_NO_MFB (4)
...
#define MAX_TILE_FUNC_EN_NO (180)
#define MAX_TILE_FUNC_SUBRDMA_NO (32)
...
#define TILE_SEL_MFB_A (0x100000)
#define TILE_SEL_COUNT (TILE_SEL_COUNT_A + TILE_SEL_COUNT_B)
#define TILE_SEL_COUNT_A ((TILE_SEL_DIP_A?1:0) + (TILE_SEL_WPE_A?1:0) + (TILE_SEL_MFB_A?1:0))
...
#define TILE_SEL_COUNT_MFB (TILE_SEL_MFB_A?1:0)
#define TILE_SEL_SUM (TILE_SEL_SUM_A | TILE_SEL_SUM_B)
#define TILE_SEL_SUM_A (TILE_SEL_DIP_A | TILE_SEL_WPE_A | TILE_SEL_MFB_A)
...
#define TILE_SEL_SUM_MFB (TILE_SEL_MFB_A)
...
#define TILE_SEL_MFB_FIRST(tile_group) (((tile_group) & TILE_SEL_MFB_A)?TILE_SEL_MFB_A:0)
...
#define TILE_SEL_SUPPORT_LIST(CMD, a, b, c, d, e, f) \
	CMD(a, b, c, d, e, f, 0x1)/* 1, DIP_A */\
	CMD(a, b, c, d, e, f, 0x10)/* 10, WPE_A */\
	CMD(a, b, c, d, e, f, 0x11)/* 11, DIP_A+WPE_A */\
	...
	CMD(a, b, c, d, e, f, 0x100000)/* 100000, MFB_A */\
	CMD(a, b, c, d, e, f, 0x100001)/* 100001, MFB_A+DIP_A */\
...
typedef enum TILE_FUNC_ID_ENUM
{
    ...
    /* isp func id */
    TILE_FUNC_IMGI_D1_ID = (1001),
    TILE_FUNC_IMGBI_D1_ID,/* 1002*/
    TILE_FUNC_IMGCI_D1_ID,/* 1003*/
    TILE_FUNC_VIPI_D1_ID,/* 1004*/
    TILE_FUNC_VIPBI_D1_ID,/* 1005 */
    TILE_FUNC_VIPCI_D1_ID,/* 1006 */
    TILE_FUNC_UFDI_D1_ID,/* 1007 */
    TILE_FUNC_DMGI_D1_ID,/* 1008 */
    TILE_FUNC_DEPI_D1_ID,/* 1009 */
	TILE_FUNC_LCEI_D1_ID,/* 1010 */
    TILE_FUNC_SMTI_D1_ID,/* 1011 */
    TILE_FUNC_SMTI_D2_ID,/* 1012 */
    TILE_FUNC_SMTI_D3_ID,/* 1013 */
    TILE_FUNC_SMTI_D4_ID,/* 1014 */
    TILE_FUNC_SMTO_D1_ID,/* 1015 */
    TILE_FUNC_SMTO_D2_ID,/* 1016 */
    TILE_FUNC_SMTO_D3_ID,/* 1017 */
    TILE_FUNC_SMTO_D4_ID,/* 1018 */
    TILE_FUNC_SMT_D1_ID,/* 1019 */
    TILE_FUNC_SMT_D2_ID,/* 1020 */
    TILE_FUNC_SMT_D3_ID,/* 1021 */
    TILE_FUNC_SMT_D4_ID,/* 1022 */
	TILE_FUNC_IMG3O_D1_ID,/* 1023 */
	TILE_FUNC_IMG3BO_D1_ID,/* 1024 */
	TILE_FUNC_IMG3CO_D1_ID,/* 1025 */
	TILE_FUNC_CRZO_D1_ID,/* 1026 */
	TILE_FUNC_CRZBO_D1_ID,/* 1027 */
	TILE_FUNC_TIMGO_D1_ID,/* 1028 */
	TILE_FUNC_BS_D1_ID,/* 1029 */
	TILE_FUNC_BCV_D1_ID,/* 1030 */
	TILE_FUNC_GDR_D1_ID,/* 1031 */
	TILE_FUNC_UNP_D1_ID,/* 1032 */
	TILE_FUNC_UNP_D2_ID,/* 1033 */
	TILE_FUNC_UNP_D3_ID,/* 1034 */
	TILE_FUNC_UNP_D4_ID,/* 1035 */
	TILE_FUNC_UNP_D6_ID,/* 1036 */
	TILE_FUNC_UNP_D7_ID,/* 1037 */
	TILE_FUNC_UNP_D8_ID,/* 1038 */
	TILE_FUNC_UNP_D9_ID,/* 1039 */
	TILE_FUNC_UNP_D10_ID,/* 1040 */
	TILE_FUNC_UNP_D11_ID,/* 1041 */
    TILE_FUNC_UFD_D1_ID,/* 1042 */
	TILE_FUNC_OBC_D1_ID,/* 1043 */
	TILE_FUNC_BPC_D1_ID,/* 1044 */
	TILE_FUNC_ZFUS_D1_ID,/* 1045 */
	TILE_FUNC_DGN_D1_ID,/* 1046 */
	TILE_FUNC_LSC_D1_ID,/* 1047 */
	TILE_FUNC_WB_D1_ID,/* 1048 */
	TILE_FUNC_HLR_D1_ID,/* 1049 */
	TILE_FUNC_LTM_D1_ID,/* 1050 */
	TILE_FUNC_DM_D1_ID,/* 1051 */
	TILE_FUNC_LDNR_D1_ID,/* 1052 */
	TILE_FUNC_FLC_D1_ID,/* 1053 */
	TILE_FUNC_CCM_D1_ID,/* 1054 */
	TILE_FUNC_CCM_D2_ID,/* 1055 */
	TILE_FUNC_GGM_D1_ID,/* 1056 */
	TILE_FUNC_GGM_D2_ID,/* 1057 */
	TILE_FUNC_GGM_D4_ID,/* 1058 */
	TILE_FUNC_G2C_D4_ID,/* 1059 */
	TILE_FUNC_C42_D4_ID,/* 1060 */
	TILE_FUNC_CRP_D1_ID,/* 1061 */
	TILE_FUNC_CRP_D4_ID,/* 1062 */
	TILE_FUNC_G2CX_D1_ID,/* 1063 */
	TILE_FUNC_C42_D1_ID,/* 1064 */
	TILE_FUNC_SRZ_D1_ID,/* 1065 */
	TILE_FUNC_SRZ_D3_ID,/* 1066 */
	TILE_FUNC_SRZ_D4_ID,/* 1066 */
	TILE_FUNC_CRZ_D1_ID,/* 1067 */
	TILE_FUNC_SLK_D1_ID,/* 1068 */
	TILE_FUNC_SLK_D2_ID,/* 1069 */
	TILE_FUNC_SLK_D3_ID,/* 1070 */
	TILE_FUNC_SLK_D4_ID,/* 1071 */
	TILE_FUNC_SLK_D5_ID,/* 1072 */
	TILE_FUNC_SLK_D6_ID,/* 1073 */
	TILE_FUNC_YNR_LTM_D1_ID,/* 1074 */
	TILE_FUNC_YNR_PAD_D1_ID,/* 1075 */
	TILE_FUNC_NDG_D1_ID,/* 1076 */
	TILE_FUNC_NDG_PAD_ID,/* 1077 */
	TILE_FUNC_YNR_D1_ID,/* 1078 */
	TILE_FUNC_C24_D1_ID,/* 1079 */
	TILE_FUNC_C24_D2_ID,/* 1080 */
	TILE_FUNC_C24_D3_ID,/* 1081 */
	TILE_FUNC_C2G_D1_ID,/* 1082 */
	TILE_FUNC_IGGM_D1_ID,/* 1083 */
	TILE_FUNC_CCM_D3_ID,/* 1084 */
	TILE_FUNC_LCE_D1_ID,/* 1085 */
	TILE_FUNC_DCE_D1_ID,/* 1086 */
	TILE_FUNC_DCES_D1_ID,/* 1087 */
	TILE_FUNC_DCESO_D1_ID,/* 1088 */
	TILE_FUNC_GGM_D3_ID,/* 1089 */
	TILE_FUNC_G2C_D1_ID,/* 1090 */
	TILE_FUNC_C02_D1_ID,/* 1091 */
	TILE_FUNC_C02_OUT_CROP_D1_ID,/* 1092 */
	TILE_FUNC_C02_D2_ID,/* 1093 */
	TILE_FUNC_C02_OUT_CROP_D2_ID,/* 1094 */
	TILE_FUNC_CRSP_D1_ID,/* 1095 */
	TILE_FUNC_CRSP_IN_CROP_D1_ID,/* 1096 */
	TILE_FUNC_C42_D2_ID,/* 1097 */
	TILE_FUNC_EE_D1_ID,/* 1098 */
	TILE_FUNC_CNR_PAD_D1_ID,/* 1099 */
	TILE_FUNC_NDG_D2_ID,/* 1100 */
	TILE_FUNC_NDG2_PAD_ID,/* 1101 */
	TILE_FUNC_CNR_D1_ID,/* 1102 */
	TILE_FUNC_CNR_BOK_D1_ID,/* 1103 */
	TILE_FUNC_CRP_D2_ID,/* 1104 */
	TILE_FUNC_COLOR_D1_ID,/* 1105 */
	TILE_FUNC_NR3D_D1_ID,/* 1106 */
	TILE_FUNC_NR3D_IN_CROP_D1_ID,/* 1107 */
	TILE_FUNC_MIX_D1_ID,/* 1108 */
	TILE_FUNC_MIX_D2_ID,/* 1109 */
	TILE_FUNC_MIX_D3_ID,/* 1109 */
	TILE_FUNC_MIX_D4_ID,/* 1110 */
    TILE_FUNC_PAK_D1_ID,/* 1111 */
    TILE_FUNC_PAKG_D1_ID,/* 1112 */
    TILE_FUNC_PAK_D2_ID,/* 1113 */
    TILE_FUNC_PAK_D3_ID,/* 1114 */
    TILE_FUNC_PAK_D4_ID,/* 1115 */
    TILE_FUNC_PAK_D6_ID,/* 1116 */
    TILE_FUNC_PAK_D7_ID,/* 1117 */
    TILE_FUNC_PAK_D8_ID,/* 1118 */
	TILE_FUNC_PLNR_D1_ID,/* 1119 */
	TILE_FUNC_PLNR_D2_ID,/* 1120 */
	TILE_FUNC_PLNW_D1_ID,/* 1121 */
	TILE_FUNC_PLNW_D2_ID,/* 1122 */
	TILE_FUNC_DFE_D1_ID,/* 1123 */
	TILE_FUNC_FEO_D1_ID,/* 1124 */
	TILE_FUNC_MCRP_D1_ID,/* 1125 */
	TILE_FUNC_MCRP_D2_ID,/* 1126 */
	TILE_FUNC_FM_D1_ID,/* 1127 */
	TILE_FUNC_LPCNR_D1_ID,/* 1128 */
	TILE_FUNC_BYPASS_ID,/* 1129 */
	TILE_FUNC_BYPASS_SMT_FULLG_ID,/* 1130 */
	TILE_FUNC_BYPASS_ZERO_ID,/* 1131 */
	TILE_FUNC_BYTE42_ID,/* 1132 */
	TILE_FUNC_BYTE24_ID,/* 1133 */
	TILE_FUNC_BC_D1_ID,/* 1134 */
	TILE_FUNC_BC_D2_ID,/* 1135 */
	TILE_FUNC_BC_D3_ID,/* 1136 */
	TILE_FUNC_BC_D4_ID,/* 1137 */
	TILE_FUNC_BC_D5_ID,/* 1138 */
	TILE_FUNC_BC_D6_ID,/* 1139 */
	TILE_FUNC_BC_D7_ID,/* 1140 */
	TILE_FUNC_BC_D8_ID,/* 1141 */
	TILE_FUNC_BC_D9_ID,/* 1142 */
	TILE_FUNC_BC_D10_ID,/* 1143 */
	TILE_FUNC_BC_D11_ID,/* 1145 */
	TILE_FUNC_BC_D12_ID,/* 1146 */
	TILE_FUNC_BC_D13_ID,/* 1147 */
	TILE_FUNC_BC_D14_ID,/* 1148 */
	TILE_FUNC_BC_D15_ID,/* 1149 */
	TILE_FUNC_BC_D16_ID,/* 1150 */
	TILE_FUNC_BC_D17_ID,/* 1151 */
	TILE_FUNC_BC_D18_ID,/* 1152 */
	TILE_FUNC_BC_D19_ID,/* 1153 */
	TILE_FUNC_BC_D20_ID,/* 1154 */
	TILE_FUNC_OFT_D1_ID,/* 1155 */
	TILE_FUNC_OFT_CROP_D1_ID,/* 1156 */
	TILE_FUNC_OFT_CRZ_D1_ID,/* 1157 */
	TILE_FUNC_OFT_C24_D1_ID,/* 1158 */
	TILE_FUNC_OFT_C2G_D1_ID,/* 1159 */
    TILE_FUNC_OFT_IGGM_D1_ID,/* 1160 */
    TILE_FUNC_OFT_CCM_D1_ID,/* 1161 */
    TILE_FUNC_OFT_GCE_D1_ID,/* 1162 */
	TILE_FUNC_OFT_DTH_D1_ID,/* 1163 */
	TILE_FUNC_OFT_BITCVT_D1_ID,/* 1164 */
	TILE_FUNC_OFT_G2C_D1_ID,/* 1165 */
	TILE_FUNC_OFT_C42_D1_ID,/* 1166 */
	TILE_FUNC_OFT_HSV_D1_ID,/* 1167 */
	TILE_FUNC_OFT_LAB_D1_ID,/* 1168 */
	TILE_FUNC_OFT_C20_D1_ID,/* 1169 */
	TILE_FUNC_OFT_C20_IN_CROP_D1_ID,/* 1170 */
	TILE_FUNC_OFT_R2B_D1_ID,/* 1171 */
    TILE_FUNC_OFTL_D1_ID,/* 1172 */
    TILE_FUNC_OFTL_CROP_D1_ID,/* 1173 */
    TILE_FUNC_OFTL_CRZ_D1_ID,/* 1174 */
    TILE_FUNC_OFTL_C24_D1_ID,/* 1175 */
    TILE_FUNC_OFTL_C2G_D1_ID,/* 1176 */
    TILE_FUNC_OFTL_IGGM_D1_ID,/* 1177 */
    TILE_FUNC_OFTL_CCM_D1_ID,/* 1178 */
    TILE_FUNC_OFTL_GCE_D1_ID,/* 1179 */
    TILE_FUNC_OFTL_DTH_D1_ID,/* 1180 */
    TILE_FUNC_OFTL_BITCVT_D1_ID,/* 1181 */
    TILE_FUNC_OFTL_G2C_D1_ID,/* 1182 */
    TILE_FUNC_OFTL_C42_D1_ID,/* 1183 */
    TILE_FUNC_OFTL_C20_D1_ID,/* 1184 */
	TILE_FUNC_OFTL_C20_IN_CROP_D1_ID,/* 1185 */
    TILE_FUNC_OFTL_R2B_D1_ID,/* 1186 */
    TILE_FUNC_WPE_DL_ID,/* 1187 */
    TILE_FUNC_MFB_DL_ID,/* 1188 */
	TILE_FUNC_MFB_PAD_ID,/* 1189 */
	TILE_FUNC_MFB_SRZ_ID,/* 1190 */
	TILE_FUNC_MFB_WT_ID,/* 1191 */
    TILE_FUNC_MFB_MFBI_ID,/* 1192 */
	TILE_FUNC_MFB_MFBI_B_ID,/* 1193 */
    TILE_FUNC_MFB_MFB3I_ID,/* 1194 */
    TILE_FUNC_MFB_MFB4I_ID,/* 1195 */
    TILE_FUNC_MFB_OMC_ID,/* 1196 */
    TILE_FUNC_MFB_BLD_ID,/* 1197 */
    TILE_FUNC_MFB_MFBO_ID,/* 1198 */
    TILE_FUNC_MFB_MFBO_B_ID,/* 1199 */
    TILE_FUNC_MFB_MFB2O_ID,/* 1200 */
	TILE_FUNC_MFB_C02_ID,/* 1201 */
	TILE_FUNC_MFB_C02_OUT_CROP_ID,/* 1202 */
	TILE_FUNC_MFB_CRSP_IN_CROP_ID,/* 1203 */
	TILE_FUNC_MFB_CRSP_ID,/* 1204 */
...
#define CAM_IN_FMT_BAYER_15_2	    (17)
#define CAM_IN_FMT_BAYER_16	    (18)
#define CAM_IN_FMT_BAYER_19	    (19)
#define CAM_IN_FMT_YUV8_x2	    (20)
#define CAM_IN_FMT_YUV12_x2	    (21)
#define CAM_IN_FMT_YUV10_x4	    (22)
/* RGB format */
...
/* OFT output format */
#define OFT_OUT_FMT_RGB888 (0)
#define OFT_OUT_FMT_YUV420 (1)
#define OFT_OUT_FMT_YUV422 (2)
#define OFT_OUT_FMT_YUV444 (3)
#define OFT_OUT_FMT_HSV888 (4)
#define OFT_OUT_FMT_LAB888 (5)
#define OFT_OUT_FMT_EXTISP (6)
/* OFT EXP ISP format */
#define OFT_EXT_ISP_FMT_YUV8_x2 (0)
#define OFT_EXT_ISP_FMT_YUV10_x4 (1)
#define OFT_EXT_ISP_FMT_YUV12_x2 (2)
#define OFT_EXT_ISP_FMT_RGB565_LSB (4)
#define OFT_EXT_ISP_FMT_RGB888 (5)
#define OFT_EXT_ISP_FMT_RGB565_MSB (6)
/* LCE power no */
#define CAM_LCE_FRAC_NO (15)
#define CAM_LCE_FRAC_MASK (0x7FFF)
/* DCESO */
#define CAM_DCESO_SIZE (512)
/* resizer prec bits */
...
#define TILE_SW_REG_LUT(LABEL, CMD, a, b, c, d, e)	LABEL##_TILE_SW_REG_LUT(CMD, a, b, c, d, e)
...
/* last function id */
/* last function name */
#define TILE_SUPPORT_FUN_LUT(LABEL, CMD, a, b, c, d, e, f)	LABEL##_TILE_SUPPORT_FUN_LUT(CMD, a, b, c, d, e, f)
...
#define TILE_SUB_RDMA_FUNC_SUPPORT_LUT(LABEL, CMD, a, b, c, d, e)	LABEL##_TILE_SUB_RDMA_FUNC_SUPPORT_LUT(CMD, a, b, c, d, e)
...
#define TILE_FUNC_ENABLE_LUT(LABEL, CMD, a, b, c, d, e)	LABEL##_TILE_FUNC_ENABLE_LUT(CMD, a, b, c, d, e)
...
#define TILE_FUNC_OUTPUT_DISABLE_LUT(LABEL, CMD, a, b, c, d, e)	LABEL##_TILE_FUNC_OUTPUT_DISABLE_LUT(CMD, a, b, c, d, e)
...
#define TILE_CPP_CODE_PRINTF_ISP_REG_ADDR_NAME(a, b, c, d, e, f, g, h, i, j, k, m, n, p, q,...) \
	{\
		...
		{\
			...
			{\
				(b) = temp_addr;\
				tile_sprintf(c, sizeof(c), "\tCMD(a, b, c, 0x%08X, 0x%08X, %s)\\\r\n",\
					temp_addr - (e), temp_addr, #m);\
			}\
			else\
			{\
				if (temp_addr < (b))\
...
/* a: add old, b: addr new, c: str name */
#define TILE_FPRINTF_ISP_REG_ADDR_VAL(a, b, c, d, e, f, g, h, i, j, k, m, n, p, q,...) \
	{\
		unsigned int temp_addr = (size_t)(&((d)->m));\
		if ((a) < temp_addr)\
		{\
...
#define TILE_WRAPPER_CURRENT_CMODEL_COPY(a, b, c, d, e, f, g, h, i,...) read_int_register_by_name(&(a)->i, g);
#define TILE_WRAPPER_CURRENT_CMODEL_COPY_D(a, b, c, d, e, f, g, h, i, j, k, m, n, p, q,...) read_int_register_by_name(&(a)->i, q);
#define TILE_WRAPPER_CURRENT_CMODEL_COPY_PATH(a, b, c, d, e, f, g, h, i,...) (a)->i = (f)g;
#define TILE_INTERNAL_REG_CLEAR(a, b, c, d, e, f, g, h, i,...) (a)->i = 0;
...
#define TILE_WRAPPER_DATA_PRINT_CPP(a, b, c, d, e, f, g, h, i, j,...) \
{\
...
/* output c model param cpp file */
#define TILE_WRAPPER_DATA_PRINT_CPP_D(a, b, c, d, e, f, g, h, i, j, k, m, n, p, q,...) \
{\
...
/* c: value to fill */
/* d: found flag */
#define TILE_UT_REG_CMP_FILL_VAL(a, b, c, d, e, f, g, h, i,...) \
    if (false == (d))\
    {\
...
/* d: found flag */
/* e: ptr_reg_flag */
#define TILE_DIRECT_LINK_REG_FILL_VAL_FLAG(a, b, c, d, e, f, g, h, i,...) \
    if (false == (d))\
    {\
		if (0 == memcmp(b, #i, sizeof(#i)))\
		{\
...
/* data copy from platform to reg param */
#define TILE_WRAPPER_ISP_REG_TO_HW_COPY(a, b, c, d, e, f, g, h, i, j, k, m, n, p, q,...) \
	if (ISP_BITS((b), m, n))\
	{\
...
/* data copy from platform to reg param */
#define TILE_WRAPPER_ISP_CONFIG_TO_HW_COPY(a, b, c, d, e, f, g, h, i, j, k, m, n, p, q,...) \
	if (ISP_BITS((b), m, n))\
	{\
		printf("Warning duplicated hw reg with last val: 0x%08X\r\n", ISP_BITS((a), m, n));\
...
/* data copy from platform to reg param */
#define TILE_WRAPPER_PLATFORM_TO_REG_COPY_ISP(a, b, c, d, e, f, g, h, i,...) (a)->i = (b)->h;
/* output c model param txt file */
#define TILE_WRAPPER_DATA_PRINT_TXT(a, b, c, d, e, f, g, h, i, j,...) c(a, "%s%s%s%d\r\n", #i, #j, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR, (b)->i);
...
#define TILE_WRAPPER_PLATFORM_PRINT_TXT_ISP(a, b, c, d, e, f, g, h, i, j, k,...) \
    d(a, "%s %s%s%s%d %s\r\n", TPIPE_DEBUG_DUMP_HEADER, #h, #j, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR, (b)->h, (k)?LOG_REMARK_MUST_FILL_STR:"");
#define TILE_WRAPPER_PLATFORM_DEBUG_PRINT_TXT(a, b, c, d, e, f, g, h, i, j,...) \
...
#define TILE_WRAPPER_PLATFORM_ISP_UART_PRINT_TXT(a, b, c, d, e, f, g, h, i, j, k,...) \
    a("%s %s%s%s%d %s\r\n", TPIPE_DEBUG_DUMP_HEADER, #h, #j, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR, (b)->h, (c)?((k)?LOG_REMARK_MUST_FILL_STR:""):"");
#define TILE_WRAPPER_PLATFORM_UART_DEBUG_PRINT_TXT(a, b, c, d, e, f, g, h, i, j,...) \
...
#define TILE_WRAPPER_CHECK_REG_SEL(a, b, c, d, e, f, g, h, i, j, k, m, n, p, q,...) \
    if ((b).flag->i && (c).flag->i)/* same hw reg flag */\
    {\
		if ((b).val->i == (c).val->i)\
		{\
			fprintf(a, "%s.%s%s0x%X /* %s */\r\n", #m, #n, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR,\
				(b).val->i, (4 == p)?LOG_REMARK_MUST_FILL_STR:"");\
		}\
		else\
		{\
			if (4 == p)\
			{\
				printf("%s.%s%s0x%X %s, dual%s0x%X %s\r\n", #m, #n, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR,\
					(b).val->i, LOG_REMARK_HW_DIFF_STR, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR,\
					(c).val->i, (4 == p)?LOG_REMARK_MUST_FILL_STR:"");\
				(e)++;\
			}\
			fprintf(a, "%s.%s%s0x%X %s /* dual%s0x%X %s */\r\n", #m, #n, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR,\
				(b).val->i, LOG_REMARK_HW_DIFF_STR, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR,\
				(c).val->i, (4 == p)?LOG_REMARK_MUST_FILL_STR:"");\
        }\
    }\
    ...
    {\
		if (4 == p)\
		{\
			printf("%s.%s%s0x%X %s dual%s0x%X %s%s\r\n", #m, #n, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR,\
				(b).val->i, (b).flag->i?"":LOG_REMARK_HW_NOT_FOUND_STR, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR,\
				(c).val->i, (c).flag->i?"":LOG_REMARK_HW_NOT_FOUND_STR, (4 == p)?LOG_REMARK_MUST_FILL_STR:"");\
			(d)++;\
		}\
		fprintf(a, "%s.%s%s0x%X %s /* dual%s0x%X %s%s */\r\n", #m, #n, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR,\
			(b).val->i, (b).flag->i?"":LOG_REMARK_HW_NOT_FOUND_STR, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR,\
			(c).val->i, (c).flag->i?"":LOG_REMARK_HW_NOT_FOUND_STR, (4 == p)?LOG_REMARK_MUST_FILL_STR:"");\
    }\

#define TILE_ISP_REG_OFFSET_MASK_LSB_CODE_GEN(a, b, c, d, e, f, g, h, i, j, k, m, n, o, p,...) \
    if (o == 4)\
    {\
        int temp_count = 0;\
...
#define TILE_TPIPE_CONF_AND_ISP_REG_CMP(a, b, c, d, e, f, g, h, i, j, k, l, m,...) \
    if(g)\
    {\
...
/* b: ptr_isp_reg_t */
/* c: ptr_reg_map_struct */
#define TILE_TPIPE_CONF_AND_ISP_REG_CMP_PLATFORM(a, b, c, d, e, f, g, h, i, j, k, l, m,...) \
    if (g)\
    {\
		int value = (*(((unsigned int*)(b))+(h>>2))>>k) & (j>>k) ;\
        if( value != (d)->f)\
...
#define TILE_REG_TO_DUMP(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) TILE_REG_TO_DUMP_##m(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...)
#define TILE_REG_TO_DUMP_U(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    ...
    {\
        ...
        {\
            ...
            {\
				if (e)\
				{\
					if (((unsigned int)1<<q) == (j & (((unsigned int)1<<q) + (((unsigned int)1<<q) - 1))))\
					{\
						...
						{\
							...
							tile_driver_printf("Error: %s\r\n", tile_print_error_message(result));\
							tile_driver_printf("Error hex no: %d, dump name: %s, val: 0x%08X, mask: 0x%08X, lsb: 0x%08X\r\n", (f), #i, (a)->i, j, 1<<q);\
						}\
					}\
					else\
					{\
						(result) = ISP_MESSAGE_INCONSISTENT_TDR_MASK_LSB_ERROR;\
						tile_driver_printf("Error: %s\r\n", tile_print_error_message(result));\
						tile_driver_printf("Wrong register: %s, mask: 0x%08X, lsb: 0x%08X\r\n", #i, j, 1<<q);\
					}\
				}\
                /* or mask count */\
                (d) |= (j);\
            ...
            {\
				...
				{\
					...
					{\
						(result) = ISP_MESSAGE_INCONSISTENT_TDR_MASK_LSB_ERROR;\
						tile_driver_printf("Error: %s\r\n", tile_print_error_message(result));\
						tile_driver_printf("Error register: %s, mask: 0x%08X, lsb: 0x%08X\r\n", #i, j, 1<<q);\
					}\
				}\
                /* or mask count */\
                (d) |= (j);\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_MASK_TO_DUMP(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if ((g) != (c))\
        ...
        {\
            ...
            {\
				...
				{\
					(result) = ISP_MESSAGE_INCONSISTENT_TDR_MASK_LSB_ERROR;\
					tile_driver_printf("Error: %s\r\n", tile_print_error_message(result));\
					tile_driver_printf("Duplicated register: %s, mask: 0x%08X, lsb: 0x%08X\r\n", #i, j, 1<<q);\
				}\
            }\
        }\
    }\
...
//e: mask_val
//f: dump_file
#define TILE_MASK_VAL_DUMP(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if ((g) != (c))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_BACKUP_TO_DUMP(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) TILE_BACKUP_TO_DUMP_##m(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...)
#define TILE_BACKUP_TO_DUMP_U(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
					...
					{\
						...
						*((d) + (b)) |= (temp_reg << q) & (j);\
						...
						{\
							(result) = ISP_MESSAGE_INCONSISTENT_TDR_DUMP_MASK_ERROR;\
							tile_driver_printf("Error: %s\r\n", tile_print_error_message(result));\
							tile_driver_printf("Error hex no: %d, backup name: %s, val: 0x%08X, mask: 0x%08X, lsb: 0x%08X\r\n", a, #i, temp_reg, j, 1<<q);\
						}\
					}\
					else\
					{\
...
#define TILE_BACKUP_TO_DUMP_S(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_BACKUP_TO_DUMP_D(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) TILE_BACKUP_TO_DUMP_D_##m(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...)
#define TILE_BACKUP_TO_DUMP_D_U(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_BACKUP_TO_DUMP_D_S(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_RESTORE_TO_REG(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) TILE_RESTORE_TO_REG_##m(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...)
#define TILE_RESTORE_TO_REG_U(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_RESTORE_TO_REG_S(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
		...
		{\
			...
			{\
				...
				{\
					...
					{\
						int temp_reg = (*((d) + (b)) >> q) & ((j) >> q);\
						if (temp_reg & (0x1 + ((j) >>(q + 1))))\
						{\
							write_int_register_by_name(-(int)(((j) >> q) - (unsigned int)temp_reg + 1), k);\
						}\
						else\
						{\
							write_int_register_by_name(temp_reg, k);\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_RESTORE_TO_REG_D(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) TILE_RESTORE_TO_REG_D_##m(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...)
#define TILE_RESTORE_TO_REG_D_U(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_RESTORE_TO_REG_D_S(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
			...
			{\
				...
				{\
					...
					{\
						...
						if (temp_reg & (0x1 + ((j) >> (q + 1))))\
						{\
							write_int_register_by_name(-(int)(((j) >> q) - (unsigned int)temp_reg + 1), l);\
						}\
						else\
						{\
							write_int_register_by_name(temp_reg, l);\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_UPDATE_TO_REG(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) TILE_UPDATE_TO_REG_##m(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...)
#define TILE_UPDATE_TO_REG_U(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_UPDATE_TO_REG_S(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_UPDATE_TO_REG_D(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) TILE_UPDATE_TO_REG_D_##m(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...)
#define TILE_UPDATE_TO_REG_D_U(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
#define TILE_UPDATE_TO_REG_D_S(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if (g != (a))\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_DUMP_INV_REG(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) TILE_DUMP_INV_REG_##m(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...)
#define TILE_DUMP_INV_REG_U(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
	if (ISP_MESSAGE_TILE_OK == (result))\
	{\
		if ((g) != (c))\
...
#define TILE_DUMP_INV_REG_S(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
	if (ISP_MESSAGE_TILE_OK == (result))\
	{\
		if ((g) != (c))\
		...
		{\
			...
			{\
				...
				{\
					...
					if ((f) < (max_count))\
					{\
						int temp_reg = (*((e) + (f)) >> q) & ((j) >> q);\
						if (temp_reg & (0x1 + ((j) >> (q + 1))))\
						{\
							(a)->i = -(int)(((j) >> q) - (unsigned int)temp_reg + 1);\
						}\
						else\
						{\
							(a)->i = temp_reg;\
...
//e: ptr of dump word
//f: word count or offset to dump
#define TILE_FPRINT_TDR_DUMP_HEX(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) TILE_FPRINT_TDR_DUMP_HEX_##m(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...)
#define TILE_FPRINT_TDR_DUMP_HEX_U(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if ((g) != (c))\
...
#define TILE_FPRINT_TDR_DUMP_HEX_S(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if ((g) != (c))\
            ...
            {\
				...
				{\
                    ...
                    {\
						...
						if (val & (0x1 + ((j) >> (q + 1))))\
						{\
							fprintf(b, " [%s][0x%X]=%d", #i, j, -(int)(((j) >> q) - (unsigned int)val + 1));\
						}\
						else\
						{\
							fprintf(b, " [%s][0x%X]=%d", #i, j, val);\
...
typedef struct TILE_REG_MAP_STRUCT
{
    ...
    TILE_SW_REG_LUT(MFB, TILE_HW_REG_TYPE_DECLARE,,,,,)
    TILE_HW_REG_LUT(DIP, TILE_HW_REG_TYPE_DECLARE,,,,,)
    TILE_HW_REG_LUT(WPE, TILE_HW_REG_TYPE_DECLARE,,,,,)
    TILE_HW_REG_LUT(MFB, TILE_HW_REG_TYPE_DECLARE,,,,,)
...
typedef struct ISP_TILE_HEX_DUMP_STRUCT
{
	...
	/* wpe_s */
	unsigned int used_tile_no_wpe_s;
	unsigned int config_no_per_tile_wpe_s;
    unsigned int tile_config_wpe_s[MAX_ISP_TILE_TDR_HEX_NO_WPE_S];
	unsigned int used_word_no_wpe_s;
    unsigned int total_word_no_wpe_s;
	/* mfb */
	unsigned int config_no_per_tile_mfb;
    unsigned int tile_config_mfb[MAX_ISP_TILE_TDR_HEX_NO_MFB];
    unsigned int tile_mask_mfb[MAX_ISP_MASK_HEX_PER_TILE_MFB];
    unsigned int tile_backup_mfb[MAX_ISP_MASK_HEX_PER_TILE_MFB];
    TILE_INFORMATION_STRUCT tile_info_mfb[MAX_TILE_TOT_NO];
    unsigned int total_word_no_mfb;
	unsigned int used_word_no_mfb;
	unsigned int tile_sel_mfb;
	/* mfb internal used */
	unsigned int config_no_per_tile_internal_mfb;
    unsigned int tile_config_internal_mfb[MAX_ISP_TILE_TDR_HEX_NO_INTERNAL_MFB];
    unsigned int tile_mask_internal_mfb[MAX_ISP_MASK_HEX_PER_TILE_INTERNAL_MFB];
    unsigned int tile_backup_internal_mfb[MAX_ISP_MASK_HEX_PER_TILE_INTERNAL_MFB];
	unsigned int total_word_no_internal_mfb;
	unsigned int used_word_no_internal_mfb;
