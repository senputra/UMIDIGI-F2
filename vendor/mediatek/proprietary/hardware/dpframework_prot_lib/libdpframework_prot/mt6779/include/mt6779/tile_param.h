...
extern ISP_TILE_MESSAGE_ENUM tile_tdr_isp_dump_inv_reg_mfb(TILE_REG_MAP_STRUCT *ptr_tile_reg_map,
							TILE_REG_MAP_STRUCT *ptr_tile_reg_map_flag, int tile_id, unsigned int *hex_ptr, unsigned int max_count,
							unsigned int config_no_per_tile);
extern ISP_TILE_MESSAGE_ENUM tile_tdr_isp_dump_inv_reg_internal_mfb(TILE_REG_MAP_STRUCT *ptr_tile_reg_map,
							TILE_REG_MAP_STRUCT *ptr_tile_reg_map_flag, int tile_id, unsigned int *hex_ptr, unsigned int max_count,
							unsigned int config_no_per_tile);
