...
CMD(a, b, c, d, e, top.rmg_en, true, 0x15004004, 0x00400000, 22, CAM_CTL_EN_P1, RMG_EN)\
...
CMD(a, b, c, d, e, top.nsl2_en, true, 0x15004018, 0x00000004, 2, CAM_CTL_EN_P2, NSL2_EN)\
CMD(a, b, c, d, e, top.udm_en, true, 0x15004018, 0x00000008, 3, CAM_CTL_EN_P2, UDM_EN)\
...
CMD(a, b, c, d, e, top.nbc2_en, true, 0x15004018, 0x00010000, 16, CAM_CTL_EN_P2, NBC2_EN)\
CMD(a, b, c, d, e, top.nsl2a_en, true, 0x15004018, 0x01000000, 24, CAM_CTL_EN_P2, NSL2A_EN)\
CMD(a, b, c, d, e, top.nsl2b_en, true, 0x15004018, 0x02000000, 25, CAM_CTL_EN_P2, NSL2B_EN)\
...
CMD(a, b, c, d, e, nsl2.nsl2_hrz_comp, REG_CMP_EQ(c, LOG_NSL2_EN, 1), 0x15004A88, 0x00003FFF, 0, CAM_NSL2_RZ, SL2_HRZ_COMP)\
CMD(a, b, c, d, e, nsl2.nsl2_vrz_comp, REG_CMP_EQ(c, LOG_NSL2_EN, 1), 0x15004A88, 0x3FFF0000, 16, CAM_NSL2_RZ, SL2_VRZ_COMP)\
CMD(a, b, c, d, e, udm.bayer_bypass, REG_CMP_EQ(c, LOG_UDM_EN, 1), 0x150048A0, 0x40000000, 30, CAM_UDM_INTP_CRS, UDM_BYP)\
...
CMD(a, b, c, d, e, nsl2a.nsl2a_hrz_comp, REG_CMP_EQ(c, LOG_NSL2A_EN, 1), 0x15004A30, 0x00003FFF, 0, CAM_NSL2A_RZ, SL2_HRZ_COMP)\
CMD(a, b, c, d, e, nsl2a.nsl2a_vrz_comp, REG_CMP_EQ(c, LOG_NSL2A_EN, 1), 0x15004A30, 0x3FFF0000, 16, CAM_NSL2A_RZ, SL2_VRZ_COMP)\
CMD(a, b, c, d, e, nsl2b.nsl2b_hrz_comp, REG_CMP_EQ(c, LOG_NSL2B_EN, 1), 0x15004A60, 0x00003FFF, 0, CAM_NSL2B_RZ, SL2_HRZ_COMP)\
CMD(a, b, c, d, e, nsl2b.nsl2b_vrz_comp, REG_CMP_EQ(c, LOG_NSL2B_EN, 1), 0x15004A60, 0x3FFF0000, 16, CAM_NSL2B_RZ, SL2_VRZ_COMP)\
CMD(a, b, c, d, e, nbc.anr1_eny, REG_CMP_EQ(c, LOG_NBC_EN, 1), 0x15007A00, 0x00000002, 1, CAM_ANR_CON1, ANR1_ENY)\
CMD(a, b, c, d, e, nbc.anr1_enc, REG_CMP_EQ(c, LOG_NBC_EN, 1), 0x15007A00, 0x00000001, 0, CAM_ANR_CON1, ANR1_ENC)\
CMD(a, b, c, d, e, nbc.anr1_scale_mode, REG_CMP_EQ(c, LOG_NBC_EN, 1), 0x15007A00, 0x00000030, 4, CAM_ANR_CON1, ANR1_SCALE_MODE)\
CMD(a, b, c, d, e, nbc2.anr2_eny, REG_CMP_EQ(c, LOG_NBC2_EN, 1), 0x15007B00, 0x00000002, 1, CAM_ANR2_CON1, ANR2_ENY)\
CMD(a, b, c, d, e, nbc2.anr2_enc, REG_CMP_EQ(c, LOG_NBC2_EN, 1), 0x15007B00, 0x00000001, 0, CAM_ANR2_CON1, ANR2_ENC)\
CMD(a, b, c, d, e, nbc2.anr2_scale_mode, REG_CMP_EQ(c, LOG_NBC2_EN, 1), 0x15007B00, 0x00000030, 4, CAM_ANR2_CON1, ANR2_SCALE_MODE)\
...
typedef struct ISP_TPIPE_CONFIG_NSL2_STRUCT
{
    int nsl2_hrz_comp;
    int nsl2_vrz_comp;
}ISP_TPIPE_CONFIG_NSL2_STRUCT;
...
typedef struct ISP_TPIPE_CONFIG_NSL2B_STRUCT
{
    int nsl2b_hrz_comp;
    int nsl2b_vrz_comp;
}ISP_TPIPE_CONFIG_NSL2B_STRUCT;
