...
#define ISP_TILE_ERROR_MESSAGE_ENUM(n, CMD) \
    ...
    CMD(n, ISP_MESSAGE_UNDER_UDM_MIN_XSIZE_ERROR, ISP_TPIPE_MESSAGE_FAIL)\
    ...
    CMD(n, ISP_MESSAGE_UNDER_NBC2_MIN_XSIZE_ERROR, ISP_TPIPE_MESSAGE_FAIL)\
    CMD(n, ISP_MESSAGE_UNDER_NBC2_MIN_YSIZE_ERROR, ISP_TPIPE_MESSAGE_FAIL)\
...
#define ISP_TILE_HW_REG_LUT(CMD, a, b, c, d, e) \
    ...
    CMD(a, b, c, d, e, int, TILE_RMG_EN, top.rmg_en, RMG_EN,, true, CAM_CTL_EN_P1, RMG_EN, 4)\
    ...
    CMD(a, b, c, d, e, int, TILE_NSL2_EN, top.nsl2_en, NSL2_EN,, true, CAM_CTL_EN_P2, NSL2_EN, 4)\
    CMD(a, b, c, d, e, int, TILE_UDM_EN, top.udm_en, UDM_EN,, true, CAM_CTL_EN_P2, UDM_EN, 4)\
    ...
    CMD(a, b, c, d, e, int, TILE_NBC2_EN, top.nbc2_en, NBC2_EN,, true, CAM_CTL_EN_P2, NBC2_EN, 4)\
    CMD(a, b, c, d, e, int, TILE_NSL2A_EN, top.nsl2a_en, NSL2A_EN,, true, CAM_CTL_EN_P2, NSL2A_EN, 4)\
    CMD(a, b, c, d, e, int, TILE_NSL2B_EN, top.nsl2b_en, NSL2B_EN,, true, CAM_CTL_EN_P2, NSL2B_EN, 4)\
    ...
    /* 2D BPC */\
    CMD(a, b, c, d, e, int, TILE_BPC_2D_EN, bnr.bpc_en, BPC_ENABLE,, REG_CMP_EQ(c, LOG_BNR_EN, 1), CAM_BPC_CON, BPC_EN, 4)\
    CMD(a, b, c, d, e, int, BPC_LUT_EN, bnr.bpc_tbl_en, BPC_TBL_EN,, REG_CMP_EQ(c, LOG_BNR_EN, 1), CAM_BPC_CON, BPC_LUT_EN, 4)\
    /* LSCI */\
    ...
    /* SL2 */\
    CMD(a, b, c, d, e, int, NSL2_HRZ_COMP, nsl2.nsl2_hrz_comp, NSL2_HRZ_COMP,, REG_CMP_EQ(c, LOG_NSL2_EN, 1), CAM_NSL2_RZ, SL2_HRZ_COMP, 4)\
    CMD(a, b, c, d, e, int, NSL2_VRZ_COMP, nsl2.nsl2_vrz_comp, NSL2_VRZ_COMP,, REG_CMP_EQ(c, LOG_NSL2_EN, 1), CAM_NSL2_RZ, SL2_VRZ_COMP, 4)\
    /* UDM */\
    CMD(a, b, c, d, e, int, UDM_BYP, udm.bayer_bypass, BAYER_BYPASS,, REG_CMP_EQ(c, LOG_UDM_EN, 1), CAM_UDM_INTP_CRS, UDM_BYP, 4)\
    /* VIPI */\
    ...
    /* NSL2B */\
    CMD(a, b, c, d, e, int, NSL2B_HRZ_COMP, nsl2b.nsl2b_hrz_comp, NSL2B_HRZ_COMP,, REG_CMP_EQ(c, LOG_NSL2B_EN, 1), CAM_NSL2B_RZ, SL2_HRZ_COMP, 4)\
    CMD(a, b, c, d, e, int, NSL2B_VRZ_COMP, nsl2b.nsl2b_vrz_comp, NSL2B_VRZ_COMP,, REG_CMP_EQ(c, LOG_NSL2B_EN, 1), CAM_NSL2B_RZ, SL2_VRZ_COMP, 4)\
    /* NBC */\
    CMD(a, b, c, d, e, int, ANR1_ENY, nbc.anr1_eny, ANR_ENY,, REG_CMP_EQ(c, LOG_NBC_EN, 1), CAM_ANR_CON1, ANR1_ENY, 4)\
    CMD(a, b, c, d, e, int, ANR1_ENC, nbc.anr1_enc, ANR_ENC,, REG_CMP_EQ(c, LOG_NBC_EN, 1), CAM_ANR_CON1, ANR1_ENC, 4)\
    CMD(a, b, c, d, e, int, ANR1_SCALE_MODE, nbc.anr1_scale_mode, ANR_SCALE_MODE,, REG_CMP_EQ(c, LOG_NBC_EN, 1), CAM_ANR_CON1, ANR1_SCALE_MODE, 4)\
    /* NBC2 */\
    CMD(a, b, c, d, e, int, ANR2_ENY, nbc2.anr2_eny, ANR2_ENY,, REG_CMP_EQ(c, LOG_NBC2_EN, 1), CAM_ANR2_CON1, ANR2_ENY, 4)\
    CMD(a, b, c, d, e, int, ANR2_ENC, nbc2.anr2_enc, ANR2_ENC,, REG_CMP_EQ(c, LOG_NBC2_EN, 1), CAM_ANR2_CON1, ANR2_ENC, 4)\
    CMD(a, b, c, d, e, int, ANR2_SCALE_MODE, nbc2.anr2_scale_mode, ANR2_SCALE_MODE,, REG_CMP_EQ(c, LOG_NBC2_EN, 1), CAM_ANR2_CON1, ANR2_SCALE_MODE, 4)\
    /* SL2C */\
...
#define ISP_TILE_INTERNAL_TDR_REG_LUT(CMD, a, b, c, d, e) \
    ...
    /* SL2 */\
    CMD(a, b, c, d, e, int,,, NSL2_TILE_IN_XOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2_TILE_IN_YOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2_TILE_IN_WD,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2_TILE_IN_HT,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2_TILE_OUT_XOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2_TILE_OUT_YOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2_TILE_OUT_WD,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2_TILE_OUT_HT,,,,,)\
    /* VIPI */\
    ...
    /* NSL2B */\
    CMD(a, b, c, d, e, int,,, NSL2B_TILE_IN_XOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2B_TILE_IN_YOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2B_TILE_IN_WD,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2B_TILE_IN_HT,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2B_TILE_OUT_XOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2B_TILE_OUT_YOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2B_TILE_OUT_WD,,,,,)\
    CMD(a, b, c, d, e, int,,, NSL2B_TILE_OUT_HT,,,,,)\
    /* SL2C */\
    CMD(a, b, c, d, e, int,,, SL2C_TILE_XOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2C_TILE_YOFF,,,,,)\
	/* DBS */\
    CMD(a, b, c, d, e, int,,, DBS_TILE_LE_INV_CTL,,,,,)\
	/* RMG */\
    CMD(a, b, c, d, e, int,,, RMG_TILE_LE_INV_CTL,,,,,)\
    /* BNR */\
    ...
    CMD(a, b, c, d, e, int,,, BNR_TILE_LE_INV_CTL,,,,,)\
    /* LCEI */\
    ...
    CMD(a, b, c, d, e, int,,, CTRL_NSL2B_EN,,,,,)\
...
#define ISP_TILE_INTERNAL_REG_LUT(CMD, a, b, c, d, e) \
    ...
    CMD(a, b, c, d, e, int,,, TCM_NSL2B_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, TCM_NBC_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, TCM_NBC2_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, TCM_SL2C_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, TCM_DBS_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, TCM_RMG_EN,,,,,)\
    ...
    CMD(a, b, c, d, e, int,,, LOG_RMG_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, LOG_LSCI_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, LOG_LSC_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, LOG_NSL2_EN,,,,,)\
    ...
    CMD(a, b, c, d, e, int,,, LOG_NSL2B_EN,,,,,)\
