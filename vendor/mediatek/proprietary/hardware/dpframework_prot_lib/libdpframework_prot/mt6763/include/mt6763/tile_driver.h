...
#define TILE_SEL_WPE2_A (0x100) /* old: (0x100) */
...
#define TILE_SEL_SUPPORT_LIST(CMD, a, b, c, d, e, f) \
	...
	CMD(a, b, c, d, e, f, 0x10011)/* 10111, DIP_A+WPE_A+MDP_A */\
...
typedef enum TILE_FUNC_ID_ENUM
{
    ...
    TILE_FUNC_RCP4_ID = (4015),
    TILE_FUNC_PAK2_ID = (3016),
    TILE_FUNC_PAKG2_ID = (4016),
	...
	/* PMD */
    TILE_FUNC_PMDX_ID = (3047),
    TILE_FUNC_PMIX_ID = (3048),
    TILE_FUNC_PMOX_ID = (3049),
    TILE_FUNC_PMDY_ID = (3050),
    TILE_FUNC_PMIY_ID = (3051),
    TILE_FUNC_PMOY_ID = (3052),
    TILE_FUNC_PMDX2_ID = (4047),
    TILE_FUNC_PMIX2_ID = (4048),
    TILE_FUNC_PMOX2_ID = (4049),
    TILE_FUNC_PMDXG2_ID = (4050),
...
#define TILE_FUNC_BLOCK_LUT(CMD, a, b, c, d, e) \
    ...
    CMD(a, b, c, d, e, int, in_tile_width_loss,,,, S,,)\
    CMD(a, b, c, d, e, int, out_tile_width_loss,,,, S,,)\
    ...
    CMD(a, b, c, d, e, int, min_in_crop_xs,,,, S,,)\
    CMD(a, b, c, d, e, int, max_in_crop_xe,,,, S,,)\
    CMD(a, b, c, d, e, int, min_out_crop_xs,,,, S,,)\
    CMD(a, b, c, d, e, int, max_out_crop_xe,,,, S,,)\
...
#define TILE_REG_TO_DUMP(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p,...) TILE_REG_TO_DUMP_##m##_##n(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p,...)
#define TILE_REG_TO_DUMP_U_C(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p,...) \
    /* different id or word */\
    if ((ISP_MESSAGE_TILE_OK == (result)) && (a) && (word_no))\
    {\
        if ((g) != (c))\
        {\
            /* last merge count > 0 */\
...
#define TILE_REG_TO_DUMP_S_C(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p,...) \
    /* different id or word */\
    if ((ISP_MESSAGE_TILE_OK == (result)) && (a) && (word_no))\
    {\
        if ((g) != (c))\
...
#define TILE_REG_TO_DUMP_U_L(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p,...) \
    /* different id or word */\
    if ((ISP_MESSAGE_TILE_OK == (result)) && (a) && (word_no))\
    {\
        if ((g) != (c))\
				...
				{\
					...
					{\
						...
						{\
							...
							{\
								/* update last */\
								if (((int)(f) >= (word_no)*(a)->p) && ((int)(f) < (int)(max_count) + (word_no)*(a)->p))\
								{\
									*((e) + (f) - (word_no)*(a)->p) &= ~(j);\
									*((e) + (f) - (word_no)*(a)->p) |= ((a)->i << count) & j;\
...
#define TILE_REG_TO_DUMP_S_L(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p,...) \
    /* different id or word */\
    if ((ISP_MESSAGE_TILE_OK == (result)) && (a) && (word_no))\
    {\
        if ((g) != (c))\
							...
							{\
								...
								{\
									*((e) + (f) - (word_no)*(a)->p) &= ~(j);\
									if ((a)->i < 0)\
									{\
										*((e) + (f) - (word_no)*(a)->p) |= (((j>>count) + (a)->i + 1) << count) & j;\
									}\
									else\
									{\
										*((e) + (f) - (word_no)*(a)->p) |= ((a)->i << count) & j;\
...
#define TILE_MASK_TO_DUMP(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p,...) \
    /* different id or word */\
    if ((ISP_MESSAGE_TILE_OK == (result)) && (a))\
    {\
        if ((g) != (c))\
        {\
			/* prevent corrupt memory */\
