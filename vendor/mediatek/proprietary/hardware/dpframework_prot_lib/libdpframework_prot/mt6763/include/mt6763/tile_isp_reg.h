...
#define ISP_TILE_ERROR_MESSAGE_ENUM(n, CMD) \
    ...
    CMD(n, ISP_MESSAGE_ILLEGAL_NBCW_SEL_CONFIG_ERROR, ISP_TPIPE_MESSAGE_FAIL)\
    ...
    CMD(n, ISP_MESSAGE_ILLEGAL_MFBO_SEL_CONFIG_ERROR, ISP_TPIPE_MESSAGE_FAIL)\
    ...
    CMD(n, ISP_MESSAGE_MFBO_YSIZE_ERROR, ISP_TPIPE_MESSAGE_FAIL)\
    CMD(n, ISP_MESSAGE_NOT_SUPPORT_MFBO_PATH_ERROR, ISP_TPIPE_MESSAGE_FAIL)\
	...
	/* PMD config check */\
    CMD(n, ISP_MESSAGE_INVALID_PMD_CONFIG_ERROR, ISP_TPIPE_MESSAGE_FAIL)\
...
#define ISP_TILE_SW_REG_LUT(CMD, a, b, c, d, e) \
	...
	CMD(a, b, c, d, e, int, PMDX_A_EN, sw.pmdx_en, PMDX_EN,, true,,, 1, PMDX_B_EN,,)\
	CMD(a, b, c, d, e, int, PMIX_A_EN, sw.pmix_en, PMIX_EN,, true,,, 1, PMIX_B_EN,,)\
	CMD(a, b, c, d, e, int, PMOX_A_EN, sw.pmox_en, PMOX_EN,, true,,, 1, PMOX_B_EN,,)\
	CMD(a, b, c, d, e, int, PMDY_A_EN, sw.pmdy_en, PMDY_EN,, true,,, 1, PMDY_B_EN,,)\
	CMD(a, b, c, d, e, int, PMIY_A_EN, sw.pmiy_en, PMIY_EN,, true,,, 1, PMIY_B_EN,,)\
	CMD(a, b, c, d, e, int, PMOY_A_EN, sw.pmoy_en, PMOY_EN,, true,,, 1, PMOY_B_EN,,)\
    /* PMIX */\
    CMD(a, b, c, d, e, int, PMIX_A_STRIDE, pmix.pmix_stride, PMIX_STRIDE,, REG_CMP_EQ(c, PMIX_EN, 1),,, 1, PMIX_B_STRIDE,,)\
    CMD(a, b, c, d, e, int, PMIX_A_YSIZE, pmix.pmix_ysize, PMIX_YSIZE,, REG_CMP_EQ(c, PMIX_EN, 1),,, 1, PMIX_B_YSIZE,,)\
    /* PMOX */\
    CMD(a, b, c, d, e, int, PMOX_A_STRIDE, pmox.pmox_stride, PMOX_STRIDE,, REG_CMP_EQ(c, PMOX_EN, 1),,, 1, PMOX_B_STRIDE,,)\
    CMD(a, b, c, d, e, int, PMOX_A_YSIZE, pmox.pmox_ysize, PMOX_YSIZE,, REG_CMP_EQ(c, PMOX_EN, 1),,, 1, PMOX_B_YSIZE,,)\
    /* PMIY */\
    CMD(a, b, c, d, e, int, PMIY_A_STRIDE, pmiy.pmiy_stride, PMIY_STRIDE,, REG_CMP_EQ(c, PMIY_EN, 1),,, 1, PMIY_B_STRIDE,,)\
    CMD(a, b, c, d, e, int, PMIY_A_YSIZE, pmiy.pmiy_ysize, PMIY_YSIZE,, REG_CMP_EQ(c, PMIY_EN, 1),,, 1, PMIY_B_YSIZE,,)\
    /* PMOY */\
    CMD(a, b, c, d, e, int, PMOY_A_STRIDE, pmoy.pmoy_stride, PMOY_STRIDE,, REG_CMP_EQ(c, PMOY_EN, 1),,, 1, PMOY_B_STRIDE,,)\
    CMD(a, b, c, d, e, int, PMOY_A_YSIZE, pmoy.pmoy_ysize, PMOY_YSIZE,, REG_CMP_EQ(c, PMOY_EN, 1),,, 1, PMOY_B_YSIZE,,)\
	/* Hybrid UFDG */\
	CMD(a, b, c, d, e, int, PMDX2_A_EN, sw.pmdx2_en, PMDX2_EN,, true,,, 1, PMDX2_B_EN,,)\
	CMD(a, b, c, d, e, int, PMIX2_A_EN, sw.pmix2_en, PMIX2_EN,, true,,, 1, PMIX2_B_EN,,)\
	CMD(a, b, c, d, e, int, PMOX2_A_EN, sw.pmox2_en, PMOX2_EN,, true,,, 1, PMOX2_B_EN,,)\
    CMD(a, b, c, d, e, int, UNP3_A_EN, sw.unp3_en, UNP3_EN,, true,,, 1, UNP3_B_EN,,)\
    CMD(a, b, c, d, e, int, PAKG2_A_EN, sw.pakg2_en, PAKG2_EN,, true,,, 1, PAKG2_B_EN,,)\
    CMD(a, b, c, d, e, int, RCP4_A_EN, sw.rcp4_en, RCP4_EN,, true,,, 1, RCP4_B_EN,,)\
    /* PMIX2 */\
    CMD(a, b, c, d, e, int, PMIX2_A_V_FLIP_EN, pmix2.pmix2_v_flip_en, PMIX2_V_FLIP_EN,, REG_CMP_EQ(c, PMIX2_EN, 1),,, 1, PMIX2_B_V_FLIP_EN,,)\
    CMD(a, b, c, d, e, int, PMIX2_A_STRIDE, pmix2.pmix2_stride, PMIX2_STRIDE,, REG_CMP_EQ(c, PMIX2_EN, 1),,, 1, PMIX2_B_STRIDE,,)\
    CMD(a, b, c, d, e, int, PMIX2_A_YSIZE, pmix2.pmix2_ysize, PMIX2_YSIZE,, REG_CMP_EQ(c, PMIX2_EN, 1),,, 1, PMIX2_B_YSIZE,,)\
    /* PMOX */\
    CMD(a, b, c, d, e, int, PMOX2_A_STRIDE, pmox2.pmox2_stride, PMOX2_STRIDE,, REG_CMP_EQ(c, PMOX2_EN, 1),,, 1, PMOX2_B_STRIDE,,)\
    CMD(a, b, c, d, e, int, PMOX2_A_YSIZE, pmox2.pmox2_ysize, PMOX2_YSIZE,, REG_CMP_EQ(c, PMOX2_EN, 1),,, 1, PMOX2_B_YSIZE,,)\
...
#define DIP_TILE_HW_REG_LUT(CMD, a, b, c, d, e) \
	...
	CMD(a, b, c, d, e, int, HLR2_A_EN, top.hlr2_en, HLR2_EN,, true, DIP_A_CTL_RGB_EN, HLR2_EN, 4, HLR2_B_EN, DIP_A_CTL_RGB_EN, HLR2_EN)\
    ...
    CMD(a, b, c, d, e, int, MFB_A_EN, top.mfb_en, MFB_EN,, true, DIP_A_CTL_YUV_EN, MFB_EN, 4, MFB_B_EN, DIP_A_CTL_YUV_EN, MFB_EN)\
    CMD(a, b, c, d, e, int, MFBW_A_EN, top.mfbw_en, MFBW_EN,, true, DIP_A_CTL_YUV_EN, MFBW_EN, 4, MFBW_B_EN, DIP_A_CTL_YUV_EN, MFBW_EN)\
    CMD(a, b, c, d, e, int, MFBO_A_EN, top.mfbo_en, MFBO_EN,, true, DIP_A_CTL_DMA_EN, MFBO_EN, 4, MFBO_B_EN, DIP_A_CTL_DMA_EN, MFBO_EN)\
    ...
    CMD(a, b, c, d, e, int, SRZ5_A_EN, top.srz5_en, SRZ5_EN,, true, DIP_A_CTL_YUV2_EN, SRZ5_EN, 4, SRZ5_B_EN, DIP_A_CTL_YUV2_EN, SRZ5_EN)\
    CMD(a, b, c, d, e, int, SL2K_A_EN, top.sl2k_en, SL2K_EN,, true, DIP_A_CTL_RGB_EN, SL2K_EN, 4, SL2K_B_EN, DIP_A_CTL_RGB_EN, SL2K_EN)\
    ...
    CMD(a, b, c, d, e, int, NBCW_A_SEL, top.nbcw_sel, NBCW_SEL,, true, DIP_A_CTL_PATH_SEL, NBCW_SEL, 4, NBCW_B_SEL, DIP_A_CTL_PATH_SEL, NBCW_SEL)\
    CMD(a, b, c, d, e, int, NBC_A_SEL, top.nbc_sel, NBC_SEL,, true, DIP_A_CTL_PATH_SEL, NBC_SEL, 4, NBC_B_SEL, DIP_A_CTL_PATH_SEL, NBC_SEL)\
    CMD(a, b, c, d, e, int, MFBO_A_SEL, top.mfbo_sel, MFBO_SEL,, true, DIP_A_CTL_MISC_SEL, MFBO_SEL, 4, MFBO_B_SEL, DIP_A_CTL_MISC_SEL, MFBO_SEL)\
    ...
    CMD(a, b, c, d, e, int, IMGBI_A_V_FLIP_EN, imgbi.imgbi_v_flip_en, IMGBI_V_FLIP_EN,, REG_CMP_EQ(c, IMGBI_EN, 1), DIP_A_VERTICAL_FLIP_EN, IMGBI_V_FLIP_EN, 4, IMGBI_B_V_FLIP_EN, DIP_A_VERTICAL_FLIP_EN, IMGBI_V_FLIP_EN)\
    ...
    /* MFBO */\
    CMD(a, b, c, d, e, int, MFBO_A_STRIDE, mfbo.mfbo_stride, MFBO_STRIDE,, REG_CMP_EQ(c, LOG_MFBO_EN, 1), DIP_A_MFBO_STRIDE, STRIDE, 4, MFBO_B_STRIDE, DIP_A_MFBO_STRIDE, STRIDE)\
    CMD(a, b, c, d, e, int, MFBO_A_XOFFSET, mfbo.mfbo_xoffset, MFBO_XOFFSET,, REG_CMP_EQ(c, LOG_MFBO_EN, 1), DIP_A_MFBO_CROP, XOFFSET, 0, MFBO_B_XOFFSET, DIP_A_MFBO_CROP, XOFFSET)\
    CMD(a, b, c, d, e, int, MFBO_A_YOFFSET, mfbo.mfbo_yoffset, MFBO_YOFFSET,, REG_CMP_EQ(c, LOG_MFBO_EN, 1), DIP_A_MFBO_CROP, YOFFSET, 0, MFBO_B_YOFFSET, DIP_A_MFBO_CROP, YOFFSET)\
    CMD(a, b, c, d, e, int, MFBO_A_XSIZE, mfbo.mfbo_xsize, MFBO_XSIZE,, REG_CMP_EQ(c, LOG_MFBO_EN, 1), DIP_A_MFBO_XSIZE, XSIZE, 0, MFBO_B_XSIZE, DIP_A_MFBO_XSIZE, XSIZE)\
    CMD(a, b, c, d, e, int, MFBO_A_YSIZE, mfbo.mfbo_ysize, MFBO_YSIZE,, REG_CMP_EQ(c, LOG_MFBO_EN, 1), DIP_A_MFBO_YSIZE, YSIZE, 0, MFBO_B_YSIZE, DIP_A_MFBO_YSIZE, YSIZE)\
    /* G2C */\
	...
	/* NBC */\
	CMD(a, b, c, d, e, int, ANR_A_ENY, nbc.anr_eny, ANR_ENY,, REG_CMP_EQ(c, LOG_NBC_EN, 1), DIP_A_ANR_CON1, ANR_ENY, 4, ANR_B_ENY, DIP_A_ANR_CON1, ANR_ENY)\
    CMD(a, b, c, d, e, int, ANR_A_ENC, nbc.anr_enc, ANR_ENC,, REG_CMP_EQ(c, LOG_NBC_EN, 1), DIP_A_ANR_CON1, ANR_ENC, 4, ANR_B_ENC, DIP_A_ANR_CON1, ANR_ENC)\
    CMD(a, b, c, d, e, int, ANR_A_SCALE_MODE, nbc.anr_scale_mode, ANR_SCALE_MODE,, REG_CMP_EQ(c, LOG_NBC_EN, 1), DIP_A_ANR_CON1, ANR_SCALE_MODE, 4, ANR_B_SCALE_MODE, DIP_A_ANR_CON1, ANR_SCALE_MODE)\
	/* NBC2 */\
	CMD(a, b, c, d, e, int, ANR2_A_ENY, nbc2.anr2_eny, ANR2_ENY,, REG_CMP_EQ(c, LOG_NBC2_EN, 1), DIP_A_ANR2_CON1, ANR2_ENY, 4, ANR2_B_ENY, DIP_A_ANR2_CON1, ANR2_ENY)\
    CMD(a, b, c, d, e, int, ANR2_A_ENC, nbc2.anr2_enc, ANR2_ENC,, REG_CMP_EQ(c, LOG_NBC2_EN, 1), DIP_A_ANR2_CON1, ANR2_ENC, 4, ANR2_B_ENC, DIP_A_ANR2_CON1, ANR2_ENC)\
    CMD(a, b, c, d, e, int, ANR2_A_SCALE_MODE, nbc2.anr2_scale_mode, ANR2_SCALE_MODE,, REG_CMP_EQ(c, LOG_NBC2_EN, 1), DIP_A_ANR2_CON1, ANR2_SCALE_MODE, 4, ANR2_B_SCALE_MODE, DIP_A_ANR2_CON1, ANR2_SCALE_MODE)\
    CMD(a, b, c, d, e, int, ANR2_A_MODE, nbc2.anr2_mode, ANR2_MODE,, REG_CMP_EQ(c, LOG_NBC2_EN, 1), DIP_A_ANR2_CON1, ANR2_MODE, 4, ANR2_B_MODE, DIP_A_ANR2_CON1, ANR2_MODE)\
    CMD(a, b, c, d, e, int, ANR2_A_BOK_MODE, nbc2.anr2_bok_mode, ANR2_BOK_MODE,, REG_CMP_EQ(c, LOG_NBC2_EN, 1), DIP_A_BOK_CON, BOK_MODE, 4, ANR2_B_BOK_MODE, DIP_A_BOK_CON, BOK_MODE)\
    CMD(a, b, c, d, e, int, ANR2_A_BOK_PF_EN, nbc2.anr2_bok_pf_en, ANR2_BOK_PF_EN,, REG_CMP_EQ(c, LOG_NBC2_EN, 1), DIP_A_BOK_CON, BOK_PF_EN, 4, ANR2_B_BOK_PF_EN, DIP_A_BOK_CON, BOK_PF_EN)\
	CMD(a, b, c, d, e, int, ABF_A_ENC, nbc2.abf_en, ABF_EN,, REG_CMP_EQ(c, LOG_NBC2_EN, 1), DIP_A_ABF_CON1, ABF_EN, 4, ABF_B_ENC, DIP_A_ABF_CON1, ABF_EN)\
    /* SL2C */\
	...
	/* SEEE */\
    CMD(a, b, c, d, e, int, SEEE_A_OUT_EDGE_SEL, seee.se_edge, SE_EDGE,, REG_CMP_EQ(c, LOG_SEEE_EN, 1), DIP_A_SEEE_OUT_EDGE_CTRL, SEEE_OUT_EDGE_SEL, 4, SEEE_B_OUT_EDGE_SEL, DIP_A_SEEE_OUT_EDGE_CTRL, SEEE_OUT_EDGE_SEL)\
    /* LCEI */\
    ...
    /* LCE */\
    CMD(a, b, c, d, e, int, HLR_tmp5_MODE, lce.lce_hlr_mode, LCE_HLR_MODE,, REG_CMP_EQ(c, LOG_LCE_EN, 1), DIP_A_HLR2_CFG, HLR_MODE, 0, HLR_tmp6_MODE, DIP_A_HLR2_CFG, HLR_MODE)\
	...
	/* COLOR */\
    CMD(a, b, c, d, e, int, COLOR_A_DISP_COLOR_START, nr3d.tnr_color_en, TNR_COLOR_EN,, REG_CMP_EQ(c, LOG_NR3D_EN, 1), DIP_A_CAM_COLOR_START, COLOR_DISP_COLOR_START, 4, COLOR_B_DISP_COLOR_START, DIP_A_CAM_COLOR_START, COLOR_DISP_COLOR_START)\
    CMD(a, b, c, d, e, int, NR3D_A_CAM_TNR_EN, nr3d.tnr_en, TNR_EN,, REG_CMP_EQ(c, LOG_NR3D_EN, 1), DIP_A_CAM_TNR_ENG_CON, NR3D_CAM_TNR_EN, 4, NR3D_B_CAM_TNR_EN, DIP_A_CAM_TNR_ENG_CON, NR3D_CAM_TNR_EN)\
	/* CRSP */\
    ...
    /* SRZ5 */\
    CMD(a, b, c, d, e, int, SRZ5_A_IN_CROP_WD, srz5.srz_input_crop_width, SRZ5_Input_Image_W,, REG_CMP_EQ(c, LOG_SRZ5_EN, 1), DIP_A_SRZ5_IN_IMG, SRZ_IN_WD, 0, SRZ5_B_IN_CROP_WD, DIP_A_SRZ5_IN_IMG, SRZ_IN_WD)\
    CMD(a, b, c, d, e, int, SRZ5_A_IN_CROP_HT, srz5.srz_input_crop_height, SRZ5_Input_Image_H,, REG_CMP_EQ(c, LOG_SRZ5_EN, 1), DIP_A_SRZ5_IN_IMG, SRZ_IN_HT, 0, SRZ5_B_IN_CROP_HT, DIP_A_SRZ5_IN_IMG, SRZ_IN_HT)\
    CMD(a, b, c, d, e, int, SRZ5_A_OUT_WD, srz5.srz_output_width, SRZ5_Output_Image_W,, REG_CMP_EQ(c, LOG_SRZ5_EN, 1), DIP_A_SRZ5_OUT_IMG, SRZ_OUT_WD, 0, SRZ5_B_OUT_WD, DIP_A_SRZ5_OUT_IMG, SRZ_OUT_WD)\
    CMD(a, b, c, d, e, int, SRZ5_A_OUT_HT, srz5.srz_output_height, SRZ5_Output_Image_H,, REG_CMP_EQ(c, LOG_SRZ5_EN, 1), DIP_A_SRZ5_OUT_IMG, SRZ_OUT_HT, 0, SRZ5_B_OUT_HT, DIP_A_SRZ5_OUT_IMG, SRZ_OUT_HT)\
    CMD(a, b, c, d, e, int, SRZ5_A_HORI_INT_OFST, srz5.srz_luma_horizontal_integer_offset, SRZ5_Luma_Horizontal_Integer_Offset,, REG_CMP_EQ(c, LOG_SRZ5_EN, 1), DIP_A_SRZ5_HORI_INT_OFST, SRZ_HORI_INT_OFST, 0, SRZ5_B_HORI_INT_OFST, DIP_A_SRZ5_HORI_INT_OFST, SRZ_HORI_INT_OFST)\
    CMD(a, b, c, d, e, int, SRZ5_A_HORI_SUB_OFST, srz5.srz_luma_horizontal_subpixel_offset, SRZ5_Luma_Horizontal_Subpixel_Offset,, REG_CMP_EQ(c, LOG_SRZ5_EN, 1), DIP_A_SRZ5_HORI_SUB_OFST, SRZ_HORI_SUB_OFST, 0, SRZ5_B_HORI_SUB_OFST, DIP_A_SRZ5_HORI_SUB_OFST, SRZ_HORI_SUB_OFST)\
    CMD(a, b, c, d, e, int, SRZ5_A_VERT_INT_OFST, srz5.srz_luma_vertical_integer_offset, SRZ5_Luma_Vertical_Integer_Offset,, REG_CMP_EQ(c, LOG_SRZ5_EN, 1), DIP_A_SRZ5_VERT_INT_OFST, SRZ_VERT_INT_OFST, 0, SRZ5_B_VERT_INT_OFST, DIP_A_SRZ5_VERT_INT_OFST, SRZ_VERT_INT_OFST)\
    CMD(a, b, c, d, e, int, SRZ5_A_VERT_SUB_OFST, srz5.srz_luma_vertical_subpixel_offset, SRZ5_Luma_Vertical_Subpixel_Offset,, REG_CMP_EQ(c, LOG_SRZ5_EN, 1), DIP_A_SRZ5_VERT_SUB_OFST, SRZ_VERT_SUB_OFST, 0, SRZ5_B_VERT_SUB_OFST, DIP_A_SRZ5_VERT_SUB_OFST, SRZ_VERT_SUB_OFST)\
    CMD(a, b, c, d, e, int, SRZ5_A_HORI_STEP, srz5.srz_horizontal_coeff_step, SRZ5_Horizontal_Coeff_Step,, REG_CMP_EQ(c, LOG_SRZ5_EN, 1), DIP_A_SRZ5_HORI_STEP, SRZ_HORI_STEP, 4, SRZ5_B_HORI_STEP, DIP_A_SRZ5_HORI_STEP, SRZ_HORI_STEP)\
    CMD(a, b, c, d, e, int, SRZ5_A_VERT_STEP, srz5.srz_vertical_coeff_step, SRZ5_Vertical_Coeff_Step,, REG_CMP_EQ(c, LOG_SRZ5_EN, 1), DIP_A_SRZ5_VERT_STEP, SRZ_VERT_STEP, 4, SRZ5_B_VERT_STEP, DIP_A_SRZ5_VERT_STEP, SRZ_VERT_STEP)\
	/* SL2K */\
    CMD(a, b, c, d, e, int, SL2K_A_HRZ_COMP, sl2k.sl2k_hrz_comp, SL2K_HRZ_COMP,, REG_CMP_EQ(c, LOG_SL2K_EN, 1), DIP_A_SL2K_RZ, SL2_HRZ_COMP, 4, SL2K_B_HRZ_COMP, DIP_A_SL2K_RZ, SL2_HRZ_COMP)\
    CMD(a, b, c, d, e, int, SL2K_A_VRZ_COMP, sl2k.sl2k_vrz_comp, SL2K_VRZ_COMP,, REG_CMP_EQ(c, LOG_SL2K_EN, 1), DIP_A_SL2K_RZ, SL2_VRZ_COMP, 4, SL2K_B_VRZ_COMP, DIP_A_SL2K_RZ, SL2_VRZ_COMP)\
...
#define EAF_TILE_HW_REG_LUT(CMD, a, b, c, d, e) \
    /* Common */\
	CMD(a, b, c, d, e, int, EAF_A_EN, top.eaf_en, EAF_EN,, true, EAF_A_MAIN_CFG0, EAF_EN, 2, EAF_A_EN, EAF_A_MAIN_CFG0, EAF_EN)\
	CMD(a, b, c, d, e, int, EAFI_A_MASK_EN, top.eafi_mask_en, EAFI_MASK_EN,, true, EAF_A_MAIN_CFG1, EAFI_MASK_EN, 2, EAFI_A_MASK_EN, EAF_A_MAIN_CFG1, EAFI_MASK_EN)\
	CMD(a, b, c, d, e, int, EAFI_A_CUR_Y_EN, top.eafi_cur_y_en, EAFI_CUR_Y_EN,, true, EAF_A_MAIN_CFG1, EAFI_CUR_Y_EN, 2, EAFI_A_CUR_Y_EN, EAF_A_MAIN_CFG1, EAFI_CUR_Y_EN)\
	CMD(a, b, c, d, e, int, EAFI_A_CUR_UV_EN, top.eafi_cur_uv_en, EAFI_CUR_UV_EN,, true, EAF_A_MAIN_CFG1, EAFI_CUR_UV_EN, 2, EAFI_A_CUR_UV_EN, EAF_A_MAIN_CFG1, EAFI_CUR_UV_EN)\
	CMD(a, b, c, d, e, int, EAFI_A_PRE_Y_EN, top.eafi_pre_y_en, EAFI_PRE_Y_EN,, true, EAF_A_MAIN_CFG1, EAFI_PRE_Y_EN, 2, EAFI_A_PRE_Y_EN, EAF_A_MAIN_CFG1, EAFI_PRE_Y_EN)\
	CMD(a, b, c, d, e, int, EAFI_A_PRE_UV_EN, top.eafi_pre_uv_en, EAFI_PRE_UV_EN,, true, EAF_A_MAIN_CFG1, EAFI_PRE_UV_EN, 2, EAFI_A_PRE_UV_EN, EAF_A_MAIN_CFG1, EAFI_PRE_UV_EN)\
	CMD(a, b, c, d, e, int, EAFI_A_LKH_WMAP_EN, top.eafi_lkh_wmap_en, EAFI_LKH_WMAP_EN,, true, EAF_A_MAIN_CFG1, EAFI_LKH_WMAP_EN, 2, EAFI_A_LKH_WMAP_EN, EAF_A_MAIN_CFG1, EAFI_LKH_WMAP_EN)\
	CMD(a, b, c, d, e, int, EAFI_A_LKH_EMAP_EN, top.eafi_lkh_emap_en, EAFI_LKH_EMAP_EN,, true, EAF_A_MAIN_CFG1, EAFI_LKH_EMAP_EN, 2, EAFI_A_LKH_EMAP_EN, EAF_A_MAIN_CFG1, EAFI_LKH_EMAP_EN)\
	CMD(a, b, c, d, e, int, EAFI_A_DEPTH_EN, top.eafi_depth_en, EAFI_DEPTH_EN,, true, EAF_A_MAIN_CFG1, EAFI_DEP_EN, 2, EAFI_A_DEPTH_EN, EAF_A_MAIN_CFG1, EAFI_DEP_EN)\
	CMD(a, b, c, d, e, int, SRZ6_A_EN, top.srz6_en, SRZ6_EN,, true, EAF_A_MAIN_CFG0, EAF_SRZ_EN, 2, SRZ6_A_EN, EAF_A_MAIN_CFG0, EAF_SRZ_EN)\
	CMD(a, b, c, d, e, int, EAFO_A_FOUT_EN, top.eafo_fout_en, EAFO_FOUT_EN,, true, EAF_A_MAIN_CFG1, EAFO_FOUT_EN, 2, EAFO_A_FOUT_EN, EAF_A_MAIN_CFG1, EAFO_FOUT_EN)\
	CMD(a, b, c, d, e, int, EAF_A_JBFR_REF_SEL, eaf.jbfr_ref_sel, EAF_JBFR_REF_SEL,, true, EAF_A_MAIN_CFG0, EAF_JBFR_REF_SEL, 2, EAF_A_JBFR_REF_SEL, EAF_A_MAIN_CFG0, EAF_JBFR_REF_SEL)\
    /* EAFI */\
...
#define ISP_TILE_INTERNAL_TDR_REG_LUT(CMD, a, b, c, d, e) \
    ...
    /* SL2B */\
    CMD(a, b, c, d, e, int,,, SL2B_IN_TILE_XOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2B_IN_TILE_YOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2B_IN_TILE_WIDTH,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2B_IN_TILE_HEIGHT,,,,,)\
    ...
    CMD(a, b, c, d, e, int,,, SL2B_TILE_TOP_LOSS,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2B_TILE_BOTTOM_LOSS,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2B_TILE_LEFT_LOSS,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2B_TILE_RIGHT_LOSS,,,,,)\
	/* MFBW */\
    CMD(a, b, c, d, e, int,,, MFBW_TILE_TOP_LOSS,,,,,)\
    CMD(a, b, c, d, e, int,,, MFBW_TILE_BOTTOM_LOSS,,,,,)\
    CMD(a, b, c, d, e, int,,, MFBW_TILE_LEFT_LOSS,,,,,)\
    CMD(a, b, c, d, e, int,,, MFBW_TILE_RIGHT_LOSS,,,,,)\
	/* NDG */\
    ...
    /* SL2K */\
    CMD(a, b, c, d, e, int,,, SL2K_IN_TILE_XOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_IN_TILE_YOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_IN_TILE_WIDTH,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_IN_TILE_HEIGHT,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_OUT_TILE_XOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_OUT_TILE_YOFF,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_OUT_TILE_WIDTH,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_OUT_TILE_HEIGHT,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_TILE_TOP_LOSS,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_TILE_BOTTOM_LOSS,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_TILE_LEFT_LOSS,,,,,)\
    CMD(a, b, c, d, e, int,,, SL2K_TILE_RIGHT_LOSS,,,,,)\
    /* HFG */\
    ...
    CMD(a, b, c, d, e, int,,, NR3D_FULL_XSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, NR3D_FULL_YSIZE,,,,,)\
    ...
    /* SRZ5 */\
    CMD(a, b, c, d, e, int,,, SRZ5_Tile_Input_Image_W,,,,,)\
    CMD(a, b, c, d, e, int,,, SRZ5_Tile_Input_Image_H,,,,,)\
    CMD(a, b, c, d, e, int,,, SRZ5_Tile_Output_Image_W,,,,,)\
    CMD(a, b, c, d, e, int,,, SRZ5_Tile_Output_Image_H,,,,,)\
    CMD(a, b, c, d, e, int,,, SRZ5_Tile_Luma_Horizontal_Integer_Offset,,,,,)\
    CMD(a, b, c, d, e, int,,, SRZ5_Tile_Luma_Horizontal_Subpixel_Offset,,,,,)\
    CMD(a, b, c, d, e, int,,, SRZ5_Tile_Luma_Vertical_Integer_Offset,,,,,)\
    CMD(a, b, c, d, e, int,,, SRZ5_Tile_Luma_Vertical_Subpixel_Offset,,,,,)\
    /* FEO */\
	...
	/* HLR2 */\
    CMD(a, b, c, d, e, int,,, HLR2_TILE_EDGE,,,,,)\
    /* PMIX */\
    CMD(a, b, c, d, e, int,,, PMIX_TILE_OFFSET_ADDR,,,,,)\
    CMD(a, b, c, d, e, int,,, PMIX_TILE_XSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMIX_TILE_YSIZE,,,,,)\
    /* PMOX */\
    CMD(a, b, c, d, e, int,,, PMOX_TILE_OFFSET_ADDR,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX_TILE_XSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX_TILE_YSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX_TILE_XOFFSET,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX_TILE_YOFFSET,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX_TILE_FULL_XSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX_TILE_FULL_YSIZE,,,,,)\
    /* PMIY */\
    CMD(a, b, c, d, e, int,,, PMIY_TILE_OFFSET_ADDR,,,,,)\
    CMD(a, b, c, d, e, int,,, PMIY_TILE_XSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMIY_TILE_YSIZE,,,,,)\
    /* PMOY */\
    CMD(a, b, c, d, e, int,,, PMOY_TILE_OFFSET_ADDR,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOY_TILE_XSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOY_TILE_YSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOY_TILE_XOFFSET,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOY_TILE_YOFFSET,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOY_TILE_FULL_XSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOY_TILE_FULL_YSIZE,,,,,)\
    /* PMIX2 */\
    CMD(a, b, c, d, e, int,,, PMIX2_TILE_OFFSET_ADDR,,,,,)\
    CMD(a, b, c, d, e, int,,, PMIX2_TILE_XSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMIX2_TILE_YSIZE,,,,,)\
    /* PMOX2 */\
    CMD(a, b, c, d, e, int,,, PMOX2_TILE_OFFSET_ADDR,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX2_TILE_XSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX2_TILE_YSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX2_TILE_XOFFSET,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX2_TILE_YOFFSET,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX2_TILE_FULL_XSIZE,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOX2_TILE_FULL_YSIZE,,,,,)\
    /* SRZ6 */\
    ...
    CMD(a, b, c, d, e, int,,, CTRL_SL2K_EN,,,,,)\
    ...
    CMD(a, b, c, d, e, int,,, CTRL_PMDX_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_PMIX_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_PMOX_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_PMDY_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_PMIY_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_PMOY_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_PMDX2_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_PMIX2_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_PMOX2_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_UNP3_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_SL2B_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_SL2D_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_SRZ2_EN,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_MFBW_EN,,,,,)\
    ...
    CMD(a, b, c, d, e, int,,, CTRL_RCP4_EN,,,,,)\
    ...
    CMD(a, b, c, d, e, int,,, CTRL_HLR2_EN,,,,,)\
    ...
    /* RCP4 */\
    CMD(a, b, c, d, e, int,,, CTRL_RCP4_XSTART,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_RCP4_XEND,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_RCP4_YSTART,,,,,)\
    CMD(a, b, c, d, e, int,,, CTRL_RCP4_YEND,,,,,)\
    /* HFG_CROP_EN */\
	...
	/* PMD */\
    CMD(a, b, c, d, e, int,,, PMOX_TDR_OFFSET,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDX_SIG_MODE_1,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDX_SIG_MODE_2,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDX_STR_X,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDX_END_X,,,,,)\
    CMD(a, b, c, d, e, int,,, PMOY_TDR_OFFSET,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDY_SIG_MODE_1,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDY_SIG_MODE_2,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDY_STR_Y,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDY_END_Y,,,,,)\
	/* PMD2 */\
    CMD(a, b, c, d, e, int,,, PMOX2_TDR_OFFSET,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDX2_SIG_MODE_1,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDX2_SIG_MODE_2,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDX2_STR_X,,,,,)\
    CMD(a, b, c, d, e, int,,, PMDX2_END_X,,,,,)\
...
#define ISP_TILE_INTERNAL_REG_LUT(CMD, a, b, c, d, e) \
	...
	/* PMD */\
    CMD(a, b, c, d, e, bool,,, pmdx_enable_flag,,,,,)\
    CMD(a, b, c, d, e, int,,, pmo_xs,,,,,)\
    CMD(a, b, c, d, e, int,,, pmo_xe,,,,,)\
    CMD(a, b, c, d, e, int,,, pmiox_offset,,,,,)\
    CMD(a, b, c, d, e, bool,,, pmdy_enable_flag,,,,,)\
    CMD(a, b, c, d, e, int,,, pmo_ys,,,,,)\
    CMD(a, b, c, d, e, int,,, pmo_ye,,,,,)\
    CMD(a, b, c, d, e, int,,, pmioy_offset,,,,,)\
	/* PMD2 */\
    CMD(a, b, c, d, e, bool,,, pmdx2_enable_flag,,,,,)\
    CMD(a, b, c, d, e, int,,, pmo2_xs,,,,,)\
    CMD(a, b, c, d, e, int,,, pmo2_xe,,,,,)\
    CMD(a, b, c, d, e, int,,, pmiox2_offset,,,,,)\
