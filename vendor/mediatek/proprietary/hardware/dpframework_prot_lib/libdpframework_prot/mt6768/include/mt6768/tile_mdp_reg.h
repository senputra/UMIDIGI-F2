...
#define MDP_TILE_FUNC_ID_ENUM_DECLARE \
    ...
    TILE_FUNC_CAMIN_ID = TILE_FUNC_MDP_BASE + 6, /* tCAMIN */\
    TILE_FUNC_RDMA0_ID,\
    TILE_FUNC_CCORR0_ID,\
    TILE_FUNC_PRZ0_ID,\
    TILE_FUNC_PRZ1_ID,\
...
#define MDP_TILE_SW_REG_LUT(CMD, a, b, c, d, e) \
    ...
    /* working variable for tile ring */\
    /* mcu size of y */\
    CMD(a, b, c, d, e, int, ring_buffer_mcu_y_size, , ring_buffer_mcu_y_size,, true,,,)\
    /*ring buffer mcu no of y size */\
    CMD(a, b, c, d, e, int, ring_buffer_mcu_no, , ring_buffer_mcu_no,, true,,,)\
    CMD(a, b, c, d, e, int, enable_ISP, , ISP_EN,, true,,,)\
    CMD(a, b, c, d, e, int, enable_PRZ0, , PRZ0_EN,, REG_CMP_EQ(c, LOG_PRZ0_EN, 1),,,)\
    CMD(a, b, c, d, e, int, enable_PRZ1, , PRZ1_EN,, REG_CMP_EQ(c, LOG_PRZ1_EN, 1),,,)\
    CMD(a, b, c, d, e, int, RDMA0_ring_size, , RDMA_RING_SIZE,, 1,,,)\
	/* duplicated hw registers */\
    CMD(a, b, c, d, e, int, PRZ0_422to444_clip_width, , PRZ0_422to444_width,, REG_CMP_EQ(c, LOG_PRZ0_EN, 1), PRZ0_OUTPUT_IMAGE, 0x00001FFF,)\
    CMD(a, b, c, d, e, int, PRZ1_422to444_clip_width, , PRZ1_422to444_width,, REG_CMP_EQ(c, LOG_PRZ1_EN, 1), PRZ1_OUTPUT_IMAGE, 0x00001FFF,)\
