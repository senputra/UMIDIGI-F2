...
#define RIL_CHANNEL_1     SIM_CHANNEL
#define RIL_CHANNEL_2     CC_CHANNEL
#define RIL_CHANNEL_3     NW_CHANNEL
#define RIL_CHANNEL_4     DATA_CHANNEL
#define RIL_CHANNEL_5     SMS_CHANNEL
#define RIL_CHANNEL_6     ATCI_CHANNEL
#define RIL_CHANNEL_7     DEFAULT_CHANNEL
