...
private:
    ...
    sp<NSCam::v1::CallbackBufferPool>            mpPool_Yuv00 = nullptr;
    sp<NSCam::v1::CallbackBufferPool>            mpPool_Yuv01 = nullptr;
    //
    sp<ImageStreamManager>            mpImageStreamManager = nullptr;
    //
    mutable Mutex                                 mPPQueueLock;
    std::queue< sp<IPostProcRequestBuilder> >     mvPPQueue;
    //
    sp<TPPPListener>                  mpListener = nullptr;
    //
    MUINT32                           miRequestNo = 8000;
};
/******************************************************************************
 *
 ******************************************************************************/
