...
#ifndef _MTK_LEGACYPIPELINE_MULTI_FRAME_POST_PROC_REQUEST_BUILDER_H_
#define _MTK_LEGACYPIPELINE_MULTI_FRAME_POST_PROC_REQUEST_BUILDER_H_
...
public:
// Constructor
    MulitFramePostProcRequestBuilder() = delete;
    ...
    virtual ~MulitFramePostProcRequestBuilder();
public:
    status_t allocOutputBuffer() override final;
    status_t setInputBuffer(
                        MUINT32 inputDataSeq,
                        MUINT32 index,
                        sp<NSCam::v1::CallbackBufferPool> pPool_YUV00,
                        sp<NSCam::v1::CallbackBufferPool> pPool_YUV01) override final;
    android::status_t setInputBuffer(
                        android::DefaultKeyedVector<
                                            StreamId_T,
                                            sp<NSCam::v1::CallbackBufferPool> >&cbPool) override final;
...
#endif  //_MTK_LEGACYPIPELINE_MULTI_FRAME_POST_PROC_REQUEST_BUILDER_H_
