...
public:
    ...
    virtual MINT32  enque_drop(MVOID);
...
public:
            ...
            MINT32  dropEnqueueBuf(list<MUINT32>* pLPortNum, list<MUINT32>* pLMagicNum);
            ...
            MBOOL   updateSuspendDone(void);            // notify STT suspend done, change cam state
