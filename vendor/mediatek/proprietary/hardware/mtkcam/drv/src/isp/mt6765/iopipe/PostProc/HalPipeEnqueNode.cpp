    ...
    )
{
    ...
    for(int q=0;q<framePack.frameNum;q++)
    {
        ...
        LOG_INF("sDrvScen:%d, CQIdx:%d, dupCQIdx:%d, burstQIdx:%d, RingBufIndex:%d,  mTuningData ptr:%lx\n", drvScen, p2CQ, p2dupCQ, q, RingBufIndex,  (unsigned long)framePack.rParams.mvFrameParams[q].mTuningData); 
