...
void TuningMgr_DeEnQue(TuningMgr* tuningMgr, MINT32* magicNum, MINT32 BQNum, MBOOL* isVerify = NULL){
    ...
    for(int i = 0; i < BQNum; i++)
    {
     ...
     // Update OBC
     tuningMgr->updateEngine(eTuningMgrFunc_OBC_R1, ctlEn, i);
     ...
     // Update FLK
     tuningMgr->updateEngine(eTuningMgrFunc_FLK_R1, ctlEn, i);
