...
{    public:
    ...
    public:
        ...
        static MINT32 setFlc(IspImageioPackage &imageioPackage);
        static MINT32 setFlc2(IspImageioPackage &imageioPackage);
        //Yuv
        ...
        static MINT32 setSrz5(IspImageioPackage &imageioPackage);
