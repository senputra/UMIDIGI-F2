...
#include "imageio/inc/crz_drv.h"
//#include <crz_drv.h>
#include <drv/isp_drv.h>
#include <../../inc/twin_drv.h>
#include <../../inc/dual_isp_config.h>
#include <drv/imem_drv.h>

#include <imageio/ispio_pipe_scenario.h>    // For enum EDrvScenario.
#include "imageio/p1HwCfg.h" //add this for p1 tuning notification
...
//ISP_DMA_CAMSV_IMGO
#define MT6593_DMA_CAMSV_IMGO_BASE          (MT6593_ISP_TOP_BASE + (0x5208 ))
#define MT6593_DMA_CAMSV_IMGO_REG_RANGE     (0x20)
//ISP_DMA_CAMSV2_IMGO
#define MT6593_DMA_CAMSV2_IMGO_BASE         (MT6593_ISP_TOP_BASE + (0X5228 ) )
...
#define CHECK_TUNING_P2_EN_BITS       15 //19
...
#define TUNING_SCENARIO_IP_EN_P1_TAG    0x000000F0
 ...
 ={  {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x80037856, 0x00000000 },  // ISP_SUB_MODE_RAW
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x80037A76, 0x00000000 },  // ISP_SUB_MODE_YUV
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x80037856, 0x00000000 },  // ISP_SUB_MODE_RGB
 ...
 ={  {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x8003FAFE, 0x00000000 },  // ISP_SUB_MODE_RAW
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x8003FAFE, 0x00000000 },  // ISP_SUB_MODE_YUV
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x8003FAFE, 0x00000000 },  // ISP_SUB_MODE_RGB
     {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 },  // ISP_SUB_MODE_JPG
 };

 const IspTopEnTable gIspTurningTopTag_fb[ISP_SUB_MODE_MAX]  //CFA,G2G,G2C,MFB,NR3D, LCE & LCEI be controled by imagaio path
 ={  {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x80033856, 0x00000000 },  // ISP_SUB_MODE_RAW
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x80033A76, 0x00000000 },  // ISP_SUB_MODE_YUV
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x80033856, 0x00000000 },  // ISP_SUB_MODE_RGB
     {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 },  // ISP_SUB_MODE_JPG
 };

 const IspTopEnTable gIspTurningFieldTag_fb[ISP_SUB_MODE_MAX] //LCE & LCEI be controled by imagaio path
 ={  {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x8003BAFE, 0x00000000 },  // ISP_SUB_MODE_RAW
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x8003BAFE, 0x00000000 },  // ISP_SUB_MODE_YUV
     {0x000000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x8003BAFE, 0x00000000 },  // ISP_SUB_MODE_RGB
     {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 },  // ISP_SUB_MODE_JPG
 };
 ...
 ={  {0x010000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x80037856, 0x00000020 },  // ISP_SUB_MODE_RAW
     {0x010000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x80037876, 0x00000020 },  // ISP_SUB_MODE_YUV
     {0x010000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x80037856, 0x00000020 },  // ISP_SUB_MODE_RGB
     {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 },  // ISP_SUB_MODE_JPG
 };

 const IspTopEnTable gIspTurningFieldTag_ip[ISP_SUB_MODE_MAX]
 ={  {0x010000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x8003FAFE, 0x00000020 },  // ISP_SUB_MODE_RAW
     {0x010000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x8003FAFE, 0x00000020 },  // ISP_SUB_MODE_YUV
     {0x010000F0, 0x000000C0, 0x00000070, 0x000000C0, 0x8003FAFE, 0x00000020 },  // ISP_SUB_MODE_RGB
     {0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 },  // ISP_SUB_MODE_JPG
 };
...
class IspDrvShell:virtual public IspDrv_B
{
    protected:
        ...
        virtual             ~IspDrvShell() {};
    public:
        static IspDrvShell* createInstance(NSImageioIsp3::NSIspio::EDrvScenario eScenarioID =NSImageioIsp3::NSIspio::eDrvScenario_CC);
...
public:
    IspFunction_B(): m_Reg_Base_Addr(0),m_pP1IspDrvD(NULL),m_pP1CurCQDIspReg(NULL),bypass(0),m_twin_sdnumX(0),m_twin_lblkW(0){};
...
public:
    ...
    MBOOL                   getP2EnTuningTag(MBOOL isTopEngine, ISP_DRV_CQ_ENUM cq, MUINT32 magicNum, MUINT32 drvScenario, MUINT32 subMode, MUINT32 &tuningEnTag, MUINT32 &tuningDmaTag, MBOOL isV3 = MFALSE);
    MBOOL                   getP1EnTuningTag(MBOOL isTopEngine, ISP_DRV_CQ_ENUM cq, MUINT32 magicNum, MUINT32 drvScenario, MUINT32 subMode, MUINT32 &tuningEnTag, MUINT32 &tuningDmaTag, MBOOL isV3 = MFALSE);
...
public: //isp driver operationr
    ...
    inline int              dumpRegister( int mode ){UNUSED(mode);return (int)m_pPhyIspDrv->dumpReg();}
...
public: /*ctor/dtor*/
    DMAI_B():dupCqIdx(0),burstQueIdx(0),CQ(CAM_ISP_CQ_NONE),CQ_D(CAM_ISP_CQ_NONE),cqTrigSrc(-1),cqTrigSrc_D(-1),isP2IspOnly(0),p2MdpSrcFmt(eImgFmt_YV12),p2MdpSrcW(0),p2MdpSrcH(0),p2MdpSrcYStride(0),p2MdpSrcUVStride(0),p2MdpSrcSize(0),p2MdpSrcCSize(0),p2MdpSrcVSize(0),isTwinMode(0)
        {dma_cfg.pixel_byte = 1;};
public: /*[IspFunction_B]*/
    virtual int checkBusy( unsigned long* param ){UNUSED(param);return 0;}
private:/*[IspFunction_B]*/
    virtual int _config( void );
    virtual int _enable( void* pParam ){UNUSED(pParam);return 0;}
...
public:
    DMAO_B():isTwinMode(MFALSE),dupCqIdx(0),burstQueIdx(0),CQ(CAM_ISP_CQ_NONE),CQ_D(CAM_ISP_CQ_NONE)
        {dma_cfg.pixel_byte = 1;};
...
public:
    ISP_TOP_CTRL():
        ...
        isApplyTuning(MFALSE)
        {
            ...
            isp_top_ctl.CAMSV_FMT_SEL_MASK=0;
            isp_top_ctl.CAMSV2_FMT_SEL_MASK=0;
            isp_top_ctl.CAMSV_PAK_MASK=0;
            isp_top_ctl.CAMSV2_PAK_MASK=0;
         };
...
public:
   ISP_RAW_CENTRAL_CTRL_INFO():
        ...
        mTopCtrl()
   {
        /* Kxxstone: memset will wipe out the vtable. */
...
public:
    ...
    SrzCfg  srz2_cfg;
    Nr3DCfg nr3dCfg;
      // p2 tuning data set by tuning provider
public:
...
public:
    ...
    MBOOL isV3;
    MBOOL isApplyTuning;
    MVOID       *WDMAPQParam; // set WDMAPQParam
    MVOID       *WROTPQParam; // set WROTPQParam
    static Mutex        mdp_mgr_Lock;
    static Mutex        mdp_pipe_config_Lock;
...
public:
    ...
    MBOOL startVideoRecord( MINT32 wd,MINT32 ht, MINT32 fps,NSImageioIsp3::NSIspio::EDrvScenario drvScen,MUINT32 cqIdx);
    MBOOL stopVideoRecord( NSImageioIsp3::NSIspio::EDrvScenario drvScen,MUINT32 cqIdx);
};
...
public:
    ...
    MUINT32 lceInputH;
    isp_reg_t *pTuningIspReg;  // p2 tuning data set by tuning provider
    static Mutex cam_tdri_pipe_Lock;

public:
    CAM_TDRI_PIPE():dupCqIdx(0),burstQueIdx(0),enTdri(0),CQ(CAM_ISP_CQ_NONE),isV3(MFALSE),isApplyTuning(MFALSE),tcm_en(0),tdr_en(0),magicNum(0),drvScenario(0),sub_mode(0),lceInputW(0),lceInputH(0),pTuningIspReg(NULL){};
...
public:
    ISP_BUF_CTRL():pPass1Ctrl(NULL),path(0),path_D(ISP_PASS_NONE),drvScenario(-1),dequeCq(CAM_ISP_CQ_NONE),dequeDupCqIdx(0),dequeBurstQueIdx(0),CQ(CAM_ISP_CQ_NONE),CQ_D(CAM_ISP_CQ_NONE),dupCqIdx(0),burstQueIdx(0)
