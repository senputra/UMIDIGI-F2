...
LOCAL_SRC_FILES += FakeSensor.cpp FakeIspClk.cpp
#endif
LOCAL_SRC_FILES += rss_cb.cpp
...
LOCAL_HEADER_LIBRARIES += libcam_p1mt6765_inc_headers
LOCAL_HEADER_LIBRARIES += libcam_p1mt6765_imageio_headers
...
#-----------------------------------------------------------
LOCAL_SHARED_LIBRARIES += liblog libutils libcutils libhardware libmtkcam_ulog
