...
public:
    ...
    virtual MINT32                  dropEnqueueBuf(const TWIN_MGR_PATH_CFG_IN_PARAM& cfgInParam, list<MUINT32>* pLPortNum, list<MUINT32>* pLMagicNum);
    ...
    virtual MBOOL                   updateSuspendDone(void);        // notify STT suspend done, change cam state
    ...
    virtual MINT32                  dropTwin(const TWIN_MGR_PATH_CFG_IN_PARAM& cfgInParam, list<MUINT32>* pLPortNum, list<MUINT32>* pLMagicNum);
