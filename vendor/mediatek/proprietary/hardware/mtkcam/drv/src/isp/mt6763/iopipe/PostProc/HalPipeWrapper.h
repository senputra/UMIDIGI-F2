...
public:     ////                    Instantiation.
     ...
     */
    MBOOL                   init(char const* szCallerName, NSCam::NSIoPipe::EStreamPipeID streamPipeID);
    /**
