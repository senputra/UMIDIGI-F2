...
public:     ////    Buffer Quening.
    ...
    virtual MUINT32   dequeBuf(MBOOL& isVencContained, QTimeStampBufInfo& rQBufInfo,EDrvScenario eDrvSce=eDrvScenario_P2A, MINT32 dequeCq=0,MINT32 const dequeBurstQIdx=0, MINT32 const dequeDupCqIdx=0, MUINT32 const moduleIdx=0, MUINT32 const u4TimeoutMs = 0xFFFFFFFF);
...
private:
    ...
    MBOOL PrintPipePortInfo(vector<PortInfo const*>const& vInPorts, vector<PortInfo const*>const& vOutPorts);
