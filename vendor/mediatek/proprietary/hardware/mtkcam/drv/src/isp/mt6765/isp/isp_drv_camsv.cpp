        ...
        case _GET_INT_ERR:
            {
                ...
                if(ioctl(this->m_pIspDrvImp->m_Fd,ISP_GET_INT_ERR,(unsigned char*)IntStatus) < 0){
                    ...
                    switch(this->m_hwModule){
                        case CAMSV_0:
                            *(MUINT32*)pData = IntStatus[ISP_IRQ_TYPE_INT_CAMSV_0_ST];
                            break;
                        case CAMSV_1:
                            *(MUINT32*)pData = IntStatus[ISP_IRQ_TYPE_INT_CAMSV_1_ST];
                            break;
                        case CAMSV_2:
                            *(MUINT32*)pData = IntStatus[ISP_IRQ_TYPE_INT_CAMSV_2_ST];
                            break;
                        case CAMSV_3:
                            *(MUINT32*)pData = IntStatus[ISP_IRQ_TYPE_INT_CAMSV_3_ST];
                            break;
                        case CAMSV_4:
                            *(MUINT32*)pData = IntStatus[ISP_IRQ_TYPE_INT_CAMSV_4_ST];
                            break;
                        case CAMSV_5:
                            *(MUINT32*)pData = IntStatus[ISP_IRQ_TYPE_INT_CAMSV_5_ST];
                            break;
                        default:
