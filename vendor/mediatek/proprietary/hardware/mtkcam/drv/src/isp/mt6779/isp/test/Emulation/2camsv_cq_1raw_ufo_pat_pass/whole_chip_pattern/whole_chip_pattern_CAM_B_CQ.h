ptr->writeReg(0x0208, 0x5df7de20, CAM_B);       //TOP.CAM_CAM_1.CAM_B.CAMCQ_R1.CAMCQ_CQ_THR0_BASEADDR
...
ptr->writeReg(0x0200, 0x10, CAM_B);             //TOP.CAM_CAM_1.CAM_B.CAMCQ_R1.CAMCQ_CQ_EN
ptr->writeReg(0x4018, 0x4107e000, CAM_B);       //TOP.CAM_CAM_1.CAM_B.CAMDMATOP1_R1.CAMDMATOP1_SPECIAL_FUN_EN1
