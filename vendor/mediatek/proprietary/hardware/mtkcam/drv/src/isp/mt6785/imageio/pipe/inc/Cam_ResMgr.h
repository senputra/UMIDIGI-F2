...
public:
    ...
    ISP_HW_MODULE   Register_search(MUINT32 width, char Name[32], MUINT32 SensorNum);
    ISP_HW_MODULE   Register_search(MUINT32 index, MUINT32 SensorNum, Res_Arbitor_In* inParams, Res_Arbitor_Out* outParams, char Name[32]);
private:
    ISP_HW_MODULE   RegisterPriorityCam(ISP_HW_MODULE priorityCam, char Name[32]);
...
public:
    ...
    static Cam_ResMgr*      Res_Attach(MUINT32 width, char Name[32], MUINT32 SensorNum);
    //booking master cam resource & get working obj
    static Cam_ResMgr*      Res_Attach(ISP_HW_MODULE master,char Name[32]);
    //booking master cam resource & get working obj
    static Cam_ResMgr*      Res_Attach(MUINT32 index, MUINT32 SensorNum, Res_Arbitor_In* inParams, Res_Arbitor_Out* outParams, char Name[32]);
...
private:
    ...
    MBOOL                   m_offTwin;    // 1: force to off twin
};
