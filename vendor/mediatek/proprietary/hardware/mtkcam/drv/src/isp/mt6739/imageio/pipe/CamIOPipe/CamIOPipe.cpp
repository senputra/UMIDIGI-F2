...
#include "imageio/pipe/inc/CamIOPipe.h"
//
#include <cutils/properties.h>  // For property_get().
#include <iopipe/CamIO/IHalCamIO.h> // for p1hwcfg module sel
...
MUINT32 _p1GetModuleTgIdx(MUINT32 id,MBOOL bTwin) {\
    switch (id) {
        ...
        case EModule_AAO    :
        case EModule_ESFKO  :
        case EModule_AFO_D  : // Only AFO_D is functional
        case EModule_EISO   :
#if 0
        case EModule_LCSO   :
#endif
        case EModule_iHDR   :
             return NSImageio::NSIspio::EPortIndex_TG1I;
             break;
        ...
        case EModule_iHDR_D :
             if (ePxlMode_Two_Twin == bTwin){
                  ...
                  return NSImageio::NSIspio::EPortIndex_TG2I;
             }
             break;
        default:
            PIPE_ERR("Not support module(%d)",id);
            return NSImageio::NSIspio::EPortIndex_UNKNOW;
            break;
    }
}
...
MUINT32 p1ConvModuleID(MUINT32 id) {
    ...
    switch (id) {
        ...
        case EModule_SGG5: newId = CAM_ISP_SGG5; break;
        case EModule_SGG3: newId = CAM_ISP_SGG3; break;
        ...
        case EModule_AFO_D: newId = CAM_DMA_AFO_D; break; // Only AFO_D is functional
...
HWRWCTRL_P1SEL_MODULE
 p1ConvModuleToSelectID(MUINT32 id) {
   ...
   HWRWCTRL_P1SEL_MODULE newId = HWRWCTRL_P1SEL_RSVD;
    ...
    switch (id) {
        //raw
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_SGG:    newId = HWRWCTRL_P1SEL_SGG; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_SGG_EN: newId = HWRWCTRL_P1SEL_SGG_EN; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_LCS:    newId = HWRWCTRL_P1SEL_LSC; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_LCS_EN: newId = HWRWCTRL_P1SEL_LSC_EN; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_IMG:    newId = HWRWCTRL_P1SEL_IMG; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_UFE:    newId = HWRWCTRL_P1SEL_UFE; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_W2G:    newId = HWRWCTRL_P1SEL_W2G; break;

        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_SGG_D:    newId = HWRWCTRL_P1SEL_SGG_D; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_SGG_EN_D: newId = HWRWCTRL_P1SEL_SGG_EN_D; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_LCS_D:     newId = HWRWCTRL_P1SEL_LSC_D; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_LCS_EN_D:  newId = HWRWCTRL_P1SEL_LSC_EN_D; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_IMG_D:     newId = HWRWCTRL_P1SEL_IMG_D; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_UFE_D:     newId = HWRWCTRL_P1SEL_UFE_D; break;
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_W2G_D:     newId = HWRWCTRL_P1SEL_W2G_D; break;
...
MINT32 _p1ConvSelectIdToTg(MUINT32 id,MBOOL btwin) {
    ...
    switch (id) {
        //raw
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_SGG:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_SGG_EN:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_LCS:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_LCS_EN:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_IMG:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_UFE:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_W2G:
            return NSImageio::NSIspio::EPortIndex_TG1I;

        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_SGG_D:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_SGG_EN_D:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_LCS_D:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_LCS_EN_D:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_IMG_D:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_UFE_D:
        case NSCam::NSIoPipeIsp3::NSCamIOPipe::EPipe_P1Sel_W2G_D:
            if (MTRUE == btwin){
                 return  NSImageio::NSIspio::EPortIndex_TG1I;
            }
            else {
...
MINT32 getOutPxlByteNFmt( MBOOL bDupicate,MBOOL bCamSV,MUINT32 bRRZO, MUINT32 imgFmt, MINT32* pPixel_byte, MINT32* pFmt, MINT32* pEn_p1)
{
    ...
    _pak_en = (bDupicate)?( (bCamSV)?(CAMSV2_MODULE_PAK_EN): \
         ((bRRZO)?(CAM_CTL_EN_P1_D_PAKG_D_EN):(CAM_CTL_EN_P1_D_PAK_D_EN)) ) : \
        ( (bCamSV)?(CAMSV_MODULE_PAK_EN): \
...
MINT32 getPipelineMinSize(MSize* size, MINT32 two_pxl)
{
    ...
    if (two_pxl == 1) {
        size->w = CAM_PIPELINE_MIN_WIDTH_SIZE*2; //win_w*2 in two pixel mode
    } else {
      ...
      mPath1(0)
{
    ...
    /* Recommendation of coding pattern with strncpy */
    std::strncpy((char*)m_szUsrName, (char const*)szUsrName, sizeof(m_szUsrName)-1);
    ...
    mMagicNum0_SV1 = 0xFFFE; //mw
    mMagicNum0_SV2 = 0xFFFE; //mw
    mOpenedPort = 0x0;
    mImgSel0 = 0x0;
    mImgSel1 = 0x0;
...
int path  = CAM_ISP_PASS1_START;
    PIPE_INF(":E");
    if ((m_camPass1Param.path != ISP_PASS1_CAMSV) && (m_camPass1Param.path != ISP_PASS1_CAMSV_D) &&
        (m_camPass1Param.pathD != ISP_PASS1_CAMSV) && (m_camPass1Param.pathD != ISP_PASS1_CAMSV_D) &&
        (( CAM_ISP_CQ_NONE != m_pass1_Raw_CQ ) || ( CAM_ISP_CQ_NONE != m_pass1_RawD_CQ ))) {
...
enqueInBuf(PortID const portID, QBufInfo const& rQBufInfo)
{
    ...
    PIPE_DBG("QBufInfo:(user, reserved, num)=(%x, %d, %u)", rQBufInfo.u4User, rQBufInfo.u4Reserved, rQBufInfo.vBufInfo.size());
    //
    return  MTRUE;
}
...
enqueOutBuf(PortID const portID, QBufInfo const& rQBufInfo,MBOOL bImdMode)
{
    ...
    //
    if (NSImageio::NSIspio::EPortIndex_IMGO == portID.index) {dmaChannel = ISP_DMA_IMGO; }
    else if (NSImageio::NSIspio::EPortIndex_UFEO == portID.index) { dmaChannel = ISP_DMA_UFEO; }
    else if (NSImageio::NSIspio::EPortIndex_RRZO == portID.index) { dmaChannel = ISP_DMA_RRZO; }
    else if (NSImageio::NSIspio::EPortIndex_IMGO_D == portID.index) { dmaChannel = ISP_DMA_IMGO_D; }
    else if (NSImageio::NSIspio::EPortIndex_RRZO_D == portID.index) { dmaChannel = ISP_DMA_RRZO_D; }
    else if (NSImageio::NSIspio::EPortIndex_CAMSV_IMGO == portID.index) { dmaChannel = ISP_DMA_CAMSV_IMGO; }
    else if (NSImageio::NSIspio::EPortIndex_CAMSV2_IMGO == portID.index) { dmaChannel = ISP_DMA_CAMSV2_IMGO; }
    //enque buffer
...
dequeOutBuf(PortID const portID, QTimeStampBufInfo& rQBufInfo, MUINT32 const u4TimeoutMs /*= 0xFFFFFFFF*/)
{
    ...
    for ( MINT32 i = 0; i < (MINT32)rQBufInfo.vBufInfo.size() ; i++) {
        ...
        rQBufInfo.vBufInfo[i].mBufIdx           = bufList.front().mBufIdx;
...
unsigned int tg3InFmt = 0;
unsigned int tg4InFmt = 0;
...
int int_p1_en2 = 0;
int ctl_sel = 0;
MSize min_size = MSize(0,0); //record TG min size for AA constraint
MSize tg_size = MSize(0,0);
int two_pxl_bmx = 0; //turn off when TG size smaller than min_size in two pxl mode
...
#else
int int_p1_en_d=CAM_CTL_INT_P1_EN_D_AF_DON_EN ;
#endif
int int_p1_en2_d = 0;
int ctl_sel_d = 0;
...
* camsv(none)
********************************************************************************/
int int_camsv_en = CAMSV_INT_EN_VS1_INT_EN | \
...
int en_camsv = CAMSV_MODULE_DB_EN;
...
* camsv_d(none)
********************************************************************************/
int int_camsv2_en = CAMSV2_INT_EN_VS1_INT_EN | \
                    CAMSV2_INT_EN_PASS1_DON_INT_EN | \
                    CAMSV2_INT_EN_TG_SOF_INT_EN;
int idx_camsv2_tgi = -1;
int idx_camsv2_imgo = -1;
int en_camsv2 = CAMSV2_MODULE_DB_EN;
...
PIPE_DBG("+, CQ:%d/%d",m_pass1_Raw_CQ, m_pass1_RawD_CQ);
    ...
    for (MUINT32 i = 0 ; i < vInPorts.size() ; i++ ) {
        ...
        tg_size.w = vInPorts[i]->u4ImgWidth;
        tg_size.h = vInPorts[i]->u4ImgHeight;
        //
        // Check if CAMSV is using by other feature.
        if (vInPorts[i]->index == NSImageio::NSIspio::EPortIndex_CAMSV_TG1I) {
            MUINT32 vfdata = 0x0;
            IspDrv* pDrv = this->m_pIspDrvShell->getPhyIspDrv();
            vfdata = ISP_READ_BITS_NOPROTECT(pDrv, CAMSV_TG_VF_CON, VFDATA_EN);
            if (vfdata == 1) {
                PIPE_ERR("ERROR: CAMSV_TG_VF is already enable.");
                return MFALSE;
            }
        } else if (vInPorts[i]->index == NSImageio::NSIspio::EPortIndex_CAMSV_TG2I) {
            MUINT32 vfdata = 0x0;
            IspDrv* pDrv = this->m_pIspDrvShell->getPhyIspDrv();
            vfdata = ISP_READ_BITS_NOPROTECT(pDrv, CAMSV_TG2_VF_CON, VFDATA_EN);
            if (vfdata == 1) {
                PIPE_ERR("ERROR: CAMSV_TG2_VF is already enable.");
                return MFALSE;
            }
        }
        switch ( vInPorts[i]->index ) {
            case NSImageio::NSIspio::EPortIndex_TG1I:
                ...
                m_P1HWRWctrl[NSImageio::NSIspio::EPortIndex_TG1I].init((ISP_DRV_CQ_ENUM)pass1_CQ, \
                                     (MUINT32*)this->m_pIspDrvShell);
                tgFps = vInPorts[i]->tgFps;
                //PIPE_DBG("EPortIndex_TG1I-");
                break;
            case NSImageio::NSIspio::EPortIndex_TG2I:
                path = ISP_PASS_NONE;
                ...
                //CAM_ULOGMD("m_P1HWRWctrl[2].init ");
                m_P1HWRWctrl[NSImageio::NSIspio::EPortIndex_TG2I].init((ISP_DRV_CQ_ENUM)pass1_CQ_D, \
                                 (MUINT32*)this->m_pIspDrvShell);
                //PIPE_DBG("EPortIndex_TG2I-");
                break;
            case NSImageio::NSIspio::EPortIndex_CAMSV_TG1I:
                mPath1 |= path = ISP_PASS1_CAMSV;
                pathD = ISP_PASS_NONE;
                idx_camsv_tgi = i;
                portInfo_camsv_tgi = (PortInfo)*vInPorts[i];
                tg3InFmt = cvtTgFmtToHwVal(vInPorts[i]->eImgFmt);
                en_camsv |= CAMSV_MODULE_TG_EN;
                ...
                break;
            case NSImageio::NSIspio::EPortIndex_CAMSV_TG2I:
                path = ISP_PASS_NONE;
                mPath1 |= pathD = ISP_PASS1_CAMSV_D;
                idx_camsv2_tgi = i;
                portInfo_camsv2_tgi = (PortInfo)*vInPorts[i];
                tg4InFmt = cvtTgFmtToHwVal(vInPorts[i]->eImgFmt);
                en_camsv2 |= CAMSV2_MODULE_TG_EN;
                switch(vInPorts[i]->ePxlMode) {
    ...
    for (MUINT32 i = 0 ; i < vOutPorts.size() ; i++ ) {
        ...
        //
        if ( NSImageio::NSIspio::EPortIndex_IMGO == vOutPorts[i]->index ) {
            idx_imgo = i;
        ...
        else if ( NSImageio::NSIspio::EPortIndex_RRZO == vOutPorts[i]->index ) {
            idx_rrzo = i;
        ...
        else if ( NSImageio::NSIspio::EPortIndex_IMGO_D == vOutPorts[i]->index ) {
            idx_imgo_d = i;
        ...
        else if ( NSImageio::NSIspio::EPortIndex_RRZO_D == vOutPorts[i]->index ) {
            idx_rrzo_d = i;
        ...
        else if (NSImageio::NSIspio::EPortIndex_CAMSV_IMGO == vOutPorts[i]->index) {
            en_camsv |= CAMSV_MODULE_TG_EN;
            en_camsv |= CAMSV_MODULE_PAK_EN;
            en_camsv |= CAMSV_MODULE_DB_EN;
            bCamsv_2pix = MTRUE;

            idx_camsv_imgo = i;
            en_camsv |= CAMSV_MODULE_IMGO_EN;
            ...
            if(1 == vOutPorts[i]->u4PureRaw){
                if(0 == vOutPorts[i]->u4PureRawPak) {
                    en_camsv |= CAMSV_MODULE_PAK_SEL;
                    if( (1 << CAM_ISP_PIXEL_BYTE_FP) !=  pixel_byte_camsv_imgo)
                        pixel_byte_camsv_imgo= (2 << CAM_ISP_PIXEL_BYTE_FP);
                }
            }
        }
        else if (NSImageio::NSIspio::EPortIndex_CAMSV2_IMGO == vOutPorts[i]->index) {
            en_camsv2 |= CAMSV2_MODULE_TG_EN;
            en_camsv2 |= CAMSV2_MODULE_PAK_EN;
            en_camsv2 |= CAMSV2_MODULE_DB_EN;
            bCamsv2_2pix = MTRUE;

            idx_camsv2_imgo = i;
            en_camsv2 |= CAMSV2_MODULE_IMGO_EN;
            portInfo_camsv2_imgo = (PortInfo)*vOutPorts[idx_camsv2_imgo];
            getOutPxlByteNFmt(1,1,0, (MUINT32)vOutPorts[i]->eImgFmt, \
                (MINT32*)&pixel_byte_camsv2_imgo, (MINT32*)&camsv2_fmt, (MINT32*)&en_camsv2 );
            if(1 == vOutPorts[i]->u4PureRaw){
                if(0 == vOutPorts[i]->u4PureRawPak) {
                    en_camsv2 |= CAMSV2_MODULE_PAK_SEL;
                    if( (1 << CAM_ISP_PIXEL_BYTE_FP) !=  pixel_byte_camsv2_imgo)
    ...
    for (MUINT32 i = 0 ; i < vInPorts.size() ; i++ ) {
         ...
         switch (scenarioFmt) /*(meScenarioFmt)*/ {
             case eScenarioFmt_RAW:
                 if (NSImageio::NSIspio::EPortIndex_TG1I == vInPorts[i]->index) {
                     subMode = ISP_SUB_MODE_RAW;
                 } else if (NSImageio::NSIspio::EPortIndex_TG2I == vInPorts[i]->index)  {
             ...
             case eScenarioFmt_YUV:
                 ...
                 }else if (NSImageio::NSIspio::EPortIndex_CAMSV_TG1I == vInPorts[i]->index)  {
                     subMode = ISP_SUB_MODE_YUV;
                     subModeD = ISP_SUB_MODE_YUV;
                 }else if (NSImageio::NSIspio::EPortIndex_CAMSV_TG2I == vInPorts[i]->index)  {
                     subMode = ISP_SUB_MODE_YUV;
                     subModeD = ISP_SUB_MODE_YUV;
                 }
                 ...
                 if(en_camsv & CAMSV_MODULE_TG_EN) {
                      if(MTRUE == bCamsv_2pix) {
                        PIPE_INF("sv1 yuv fmt support only 1pix mode: to be check\n");
                        //bCamsv_2pix = MFALSE;
                      }
                      en_camsv |= CAMSV_MODULE_PAK_SEL;
                 }
                 if(en_camsv2 & CAMSV2_MODULE_TG_EN){
                      if(MTRUE == bCamsv2_2pix) {
                        PIPE_INF("sv2 yuv fmt support only 1pix mode: to be check\n");
                        //bCamsv2_2pix = MFALSE;
                      }
                      en_camsv2 |= CAMSV2_MODULE_PAK_SEL;
                 }
    ...
    //query min TG grab size
    getPipelineMinSize(&min_size, two_pxl);
    if (tg_size.w >= min_size.w) {
        two_pxl_bmx = two_pxl;
    } else if ((tg_size.w < min_size.w) && (tg_size.w >= min_size.w/2) && (two_pxl == 1)) {
        two_pxl_bmx = 0;
        PIPE_DBG("BMX change to 1 pixel mode.(%d/%d)", tg_size.w, min_size.w);
    } else {
        PIPE_ERR("TG size(%d) is smaller than min_size(%d) because of AA constraint.", tg_size.w, min_size.w);
    }

    //enable HBIN
    if (two_pxl_bmx == 1) {
        en_p1 |= CAM_CTL_EN_P1_HBIN2_EN;
        en_p1 |= CAM_CTL_EN_P1_HBIN1_EN;
    }

    //enable table
    en_p1 |= CAM_CTL_EN_P1_RLB_EN;
    ...
    m_camPass1Param.isp_top_ctl.CAMSV_MODULE_EN.Raw = en_camsv;
    m_camPass1Param.isp_top_ctl.CAMSV_INT_EN.Raw    = int_camsv_en;
    m_camPass1Param.isp_top_ctl.CAMSV2_MODULE_EN.Raw= en_camsv2;
    m_camPass1Param.isp_top_ctl.CAMSV2_INT_EN.Raw   = int_camsv2_en;
    //
    ...
    m_camPass1Param.isp_top_ctl.CAM_CTL_FMT_SEL_P1.Bits.TWO_PIX_BMX = two_pxl_bmx;
    ...
    m_camPass1Param.isp_top_ctl.CAM_CTL_FMT_SEL_P1_D.Bits.TWO_PIX_BMX_D = two_pxl_bmx;
    ...
    m_camPass1Param.isp_top_ctl.CAMSV_FMT_SEL_MASK = 0x0f030000;
    m_camPass1Param.isp_top_ctl.CAMSV_FMT_SEL.Raw  = 0;
    m_camPass1Param.isp_top_ctl.CAMSV_FMT_SEL.Bits.IMGO_FORMAT = camsv_imgofmt;
    m_camPass1Param.isp_top_ctl.CAMSV_FMT_SEL.Bits.TG1_FMT     = tg3InFmt;
    m_camPass1Param.isp_top_ctl.CAMSV_FMT_SEL.Bits.IMGO_BUS_SIZE = camsv_imgo_bus;

    m_camPass1Param.isp_top_ctl.CAMSV2_FMT_SEL_MASK = 0x0f030000;
    m_camPass1Param.isp_top_ctl.CAMSV2_FMT_SEL.Raw  = 0;
    m_camPass1Param.isp_top_ctl.CAMSV2_FMT_SEL.Bits.IMGO_FORMAT = camsv2_imgofmt;
    m_camPass1Param.isp_top_ctl.CAMSV2_FMT_SEL.Bits.TG1_FMT     = tg4InFmt;
    m_camPass1Param.isp_top_ctl.CAMSV2_FMT_SEL.Bits.IMGO_BUS_SIZE = camsv2_imgo_bus;

    //camsv pak
    m_camPass1Param.isp_top_ctl.CAMSV_PAK.Raw = 0;
    m_camPass1Param.isp_top_ctl.CAMSV_PAK.Bits.PAK_DBL_MODE = bCamsv_2pix;
    switch(camsv_fmt) {
        case CAMSV_FMT_SEL_TG_FMT_RAW8:
            m_camPass1Param.isp_top_ctl.CAMSV_PAK.Bits.PAK_MODE = CAMSV_PAK_MODE_FMT_RAW8;
            break;
        case CAMSV_FMT_SEL_TG_FMT_RAW10:
            m_camPass1Param.isp_top_ctl.CAMSV_PAK.Bits.PAK_MODE = CAMSV_PAK_MODE_FMT_RAW10;
            break;
        case CAMSV_FMT_SEL_TG_FMT_RAW12:
            m_camPass1Param.isp_top_ctl.CAMSV_PAK.Bits.PAK_MODE = CAMSV_PAK_MODE_FMT_RAW12;
            break;
        case CAMSV_FMT_SEL_TG_FMT_RAW14:
            m_camPass1Param.isp_top_ctl.CAMSV_PAK.Bits.PAK_MODE = CAMSV_PAK_MODE_FMT_RAW14;
            break;
    }
    m_camPass1Param.isp_top_ctl.CAMSV2_PAK.Raw = 0;
    m_camPass1Param.isp_top_ctl.CAMSV2_PAK.Bits.PAK_DBL_MODE = bCamsv2_2pix;
    switch(camsv2_fmt) {
        case CAMSV_FMT_SEL_TG_FMT_RAW8:
            m_camPass1Param.isp_top_ctl.CAMSV2_PAK.Bits.PAK_MODE = CAMSV_PAK_MODE_FMT_RAW8;
            break;
        case CAMSV_FMT_SEL_TG_FMT_RAW10:
            m_camPass1Param.isp_top_ctl.CAMSV2_PAK.Bits.PAK_MODE = CAMSV_PAK_MODE_FMT_RAW10;
            break;
        case CAMSV_FMT_SEL_TG_FMT_RAW12:
            m_camPass1Param.isp_top_ctl.CAMSV2_PAK.Bits.PAK_MODE = CAMSV_PAK_MODE_FMT_RAW12;
            break;
        case CAMSV_FMT_SEL_TG_FMT_RAW14:
            m_camPass1Param.isp_top_ctl.CAMSV2_PAK.Bits.PAK_MODE = CAMSV_PAK_MODE_FMT_RAW14;
            break;
    }
    ...
    if ( -1 != idx_camsv_tgi) {
        m_camPass1Param.tg_out_size.w = vInPorts[idx_camsv_tgi]->u4ImgWidth;
        m_camPass1Param.tg_out_size.h = vInPorts[idx_camsv_tgi]->u4ImgHeight;
        PIPE_DBG("camsv TGIn: %d,%d", vInPorts[idx_camsv_tgi]->u4ImgWidth, vInPorts[idx_camsv_tgi]->u4ImgHeight);
    } else {
        PIPE_DBG("-1 == idx_camsv_tgi");
    }

    if ( -1 != idx_camsv2_tgi) {
        m_camPass1Param.tg_out_size.w = vInPorts[idx_camsv2_tgi]->u4ImgWidth;
        m_camPass1Param.tg_out_size.h = vInPorts[idx_camsv2_tgi]->u4ImgHeight;
        PIPE_DBG("camsv2 TGIn: %d,%d", vInPorts[idx_camsv2_tgi]->u4ImgWidth, vInPorts[idx_camsv2_tgi]->u4ImgHeight);
    } else {
        PIPE_DBG("-1 == idx_camsv2_tgi");
    }
    //
...
//        m_camPass1Param.imgo.format = portInfo_imgo.eImgFmt;
    ...
    if (-1 != idx_rrzo ) { // use output dma crop
        ...
        PIPE_INF("[3ASync]rrzo crop=%lu,%lu",m_camPass1Param.rrzo.crop.w, m_camPass1Param.rrzo.crop.h );
...
//        m_camPass1Param.rrzo_d.format = portInfo_rrzo_d.eImgFmt;
    ...
    if(-1 != idx_camsv_imgo){
        ...
        if((portInfo_camsv_imgo.crop1.y!=0) || (portInfo_camsv_imgo.crop1.h != portInfo_camsv_imgo.u4ImgHeight))
            PIPE_DBG("[warning]camsv crop_y=%d dstsize_h(%d) crop_h=%d ", \
                portInfo_camsv_imgo.crop1.y,portInfo_camsv_imgo.u4ImgHeight,portInfo_camsv_imgo.crop1.h);
        if((portInfo_camsv_imgo.crop1.x!=0) || (portInfo_camsv_imgo.crop1.w != portInfo_camsv_imgo.u4ImgWidth))
            PIPE_DBG("[warning]camsv crop_x=%d dstsize_w(%d) crop_w=%d ", \
                portInfo_camsv_imgo.crop1.x,portInfo_camsv_imgo.u4ImgWidth,portInfo_camsv_imgo.crop1.w);
    ...
    if(-1 != idx_camsv2_imgo){
        ...
        if((portInfo_camsv2_imgo.crop1.y!=0) || (portInfo_camsv2_imgo.crop1.h != portInfo_camsv2_imgo.u4ImgHeight))
            PIPE_DBG("[warning]camsv2 crop_y=%d dstsize_h(%d) crop_h=%d ", \
                portInfo_camsv2_imgo.crop1.y,portInfo_camsv2_imgo.u4ImgHeight,portInfo_camsv2_imgo.crop1.h);
        if((portInfo_camsv2_imgo.crop1.x!=0) || (portInfo_camsv2_imgo.crop1.w != portInfo_camsv2_imgo.u4ImgWidth))
            PIPE_DBG("[warning]camsv2 crop_x=%d dstsize_w(%d) crop_w=%d ", \
                portInfo_camsv2_imgo.crop1.x,portInfo_camsv2_imgo.u4ImgWidth,portInfo_camsv2_imgo.crop1.w);
...
irq(EPipePass pass,EPipeIRQ irq_int, int userEnum)
{
    ...
    if ((EPipePass_PASS1_TG1 != pass) && (EPipePass_PASS1_TG1_D != pass) &&
         (EPipePass_CAMSV1_TG != pass) && (EPipePass_CAMSV2_TG != pass)) {
...
CamIOPipe::getIspReg(MUINT32 path)
{
    ...
    if ( m_pIspDrvShell ) {
        ...
        if ( NSImageio::NSIspio::EPortIndex_TG1I == path ) {
            cq = ISP_DRV_CQ0;
        }
        else if ( NSImageio::NSIspio::EPortIndex_TG2I == path ) {
            cq = ISP_DRV_CQ0_D;
        }
        else {
            PIPE_ERR("%d",path);
...
sendCommand(MINT32 cmd, MINTPTR arg1, MINTPTR arg2, MINTPTR arg3)
{
    ...
    switch ( cmd ) {
        ...
        case EPIPECmd_SET_D_CQ_TRIGGER_MODE:
            ...
            break;
        case EPIPECmd_SET_CQ_CHANNEL_BYPASS:
            m_pass1_Raw_CQ = CAM_ISP_CQ_BYP;
            m_CamPathPass1.CQ = m_pass1_Raw_CQ;
            break;
        case EPIPECmd_SET_D_CQ_CHANNEL_BYPASS:
            m_pass1_RawD_CQ = CAM_ISP_CQ_BYP;
            m_CamPathPass1.CQ_D = m_pass1_RawD_CQ;
            break;

        case EPIPECmd_SET_RRZ:
            //Arg1: RRZCfg
            //Arg2: EPortIndex_TG1I/EPortIndex_TG2I/EPortIndex_CAMSV_TG1I/EPortIndex_CAMSV_TG2I
            //Arg3: sensorDev
            if ((MINTPTR)NULL == arg1) {
            ...
            if (0 == pUserRrzPara->out.stride) {
                PIPE_ERR("[3ASync] SET_RRZ Invalid stride(0x%lx)!",((RRZCfg*)arg1)->out.stride);
            }

            //if (0 ==pUserRrzPara->out.stride * pUserRrzPara->crop.w * pUserRrzPara->crop.h) {
            if (0 == pUserRrzPara->crop.w * pUserRrzPara->crop.h) {
                PIPE_ERR("[3ASync] SET_RRZ Invalid Para(0x%lx/0x%lx/0x%lx)!",pUserRrzPara->out.stride, pUserRrzPara->crop.w, pUserRrzPara->crop.h);
                return MFALSE;
            }

            if (0 == pUserRrzPara->out.w * pUserRrzPara->out.h) {
                PIPE_ERR("[3ASync] SET_RRZ Invalid OutWind Para(0x%lx/0x%lx)!", pUserRrzPara->out.w, pUserRrzPara->out.h);
                return MFALSE;
            }
            ...
            if ( NSImageio::NSIspio::EPortIndex_TG1I == arg2){
                if (pUserRrzPara->crop.x > this->m_camPass1Param.rrz_in_size.w) {
                    PIPE_ERR("[3ASync]ERROR: Crop invalid(x(%d)>size_w(%lu))",pUserRrzPara->crop.x, this->m_camPass1Param.rrz_in_size.w);
                    m_rrz_update_cnt = 0;
                    this->mRunTimeCfgLock.unlock();
                    return MFALSE;
                }
                if (pUserRrzPara->crop.w > this->m_camPass1Param.rrz_in_size.w) {
                    PIPE_ERR("[3ASync]ERROR: Not Support Scale up(in(%lu)<roi_w(%lu))", pUserRrzPara->crop.w, this->m_camPass1Param.rrz_in_size.w);
                    m_rrz_update_cnt = 0;
                    this->mRunTimeCfgLock.unlock();
                    return MFALSE;
                }
            ...
            else if ( NSImageio::NSIspio::EPortIndex_TG2I == arg2){
                if (pUserRrzPara->crop.x > this->m_camPass1Param.rrz_d_in_size.w) {
                    PIPE_ERR("[3ASync]ERROR:D: CropInvalid(x(%d)>size_w(%lu))",pUserRrzPara->crop.x, this->m_camPass1Param.rrz_d_in_size.w);
                    m_rrzd_update_cnt = 0;
                    this->mRunTimeCfgLock.unlock();
                    return MFALSE;
                }
                if (pUserRrzPara->crop.w > this->m_camPass1Param.rrz_d_in_size.w) {
                    PIPE_ERR("[3ASync]ERROR:D: NotSupportScale up roi_w(%lu)>(in(%lu))", pUserRrzPara->crop.w, this->m_camPass1Param.rrz_d_in_size.w);
                    m_rrzd_update_cnt = 0;
                    this->mRunTimeCfgLock.unlock();
                    return MFALSE;
                }
            ...
            else if ( NSImageio::NSIspio::EPortIndex_CAMSV_TG1I == arg2){
                pRrz_cfg = &m_rrz_d_cfg;
                m_rrzd_update_cnt++;
            }
            else if ( NSImageio::NSIspio::EPortIndex_CAMSV_TG2I == arg2){
                pRrz_cfg = &m_rrz_d_cfg;
                m_rrzd_update_cnt++;
            }
            if (pRrz_cfg == NULL){
            ...
            if ( NSImageio::NSIspio::EPortIndex_TG1I == arg2){
                ...
                !((mMagicNum0 & _DUMMY_MAGIC) && (mMagicNum1 & _DUMMY_MAGIC) && (mMagicNum2 & _DUMMY_MAGIC))) {
                    ...
                    if((mImgSel0 == eRawFmt_Pure ) || (mImgSel1 == eRawFmt_Pure)){
                            rrz_cfg.mImgSel = eRawFmt_Pure;
                    }
                ...
                !((mMagicNum0_D & _DUMMY_MAGIC) && (mMagicNum1_D & _DUMMY_MAGIC) && (mMagicNum2_D & _DUMMY_MAGIC))) {
                    m_CamPathPass1.BurstQNum = mDupCmdQMgr.CmdQMgr_GetBurstQ();
                    m_CamPathPass1.DupQIdx = mDupCmdQMgr.CmdQMgr_GetDuqQIdx();
            ...
            else if (arg2 == NSImageio::NSIspio::EPortIndex_CAMSV_TG1I){
                mMagicNum0_SV1= pRrz_cfg->m_num_0;
                m_CamPathPass1.pass1_path = ISP_PASS1_CAMSV;
                m_rrzd_update_cnt = 0;
                if(m_CamPathPass1.setP1MagicNum(mMagicNum0_SV1) != 0){
                    ret = -1;
                }
            }
            else if (arg2 == NSImageio::NSIspio::EPortIndex_CAMSV_TG2I){
                mMagicNum0_SV2= pRrz_cfg->m_num_0;
                m_CamPathPass1.pass1_path = ISP_PASS1_CAMSV_D;
                m_rrzd_update_cnt = 0;
                if(m_CamPathPass1.setP1MagicNum(mMagicNum0_SV2) != 0){
                    ret = -1;
                }
            }
            this->mRunTimeCfgLock.unlock();
            PIPE_DBG("[3ASync]SET_RRZ [%d/%d], m_num_0=%lx -", m_rrz_update_cnt, m_rrzd_update_cnt, pRrz_cfg->m_num_0);
        ...
        case EPIPECmd_SET_P1_UPDATE:
            ...
            if (((NSImageio::NSIspio::EPortIndex)arg1 != NSImageio::NSIspio::EPortIndex_TG1I) &&
                ((NSImageio::NSIspio::EPortIndex)arg1 != NSImageio::NSIspio::EPortIndex_TG2I) &&
                ((NSImageio::NSIspio::EPortIndex)arg1 != NSImageio::NSIspio::EPortIndex_CAMSV_TG1I) &&
                ((NSImageio::NSIspio::EPortIndex)arg1 != NSImageio::NSIspio::EPortIndex_CAMSV_TG2I)){
                PIPE_ERR("[3ASync]NOT support PortIndex(0x%x)!",arg1);
                ret = -1;
                return ret;
            }
            this->mRunTimeCfgLock.lock();
            if ( NSImageio::NSIspio::EPortIndex_TG1I == arg1 ) {
                ...
                !((mMagicNum0 & _DUMMY_MAGIC) && (mMagicNum1 & _DUMMY_MAGIC) && (mMagicNum2 & _DUMMY_MAGIC))){
                    ...
                    PIPE_DBG("[3ASync]: P1_UPDATE:TG1I Magic0(0x%x)!= Magic1(0x%x) != magic2(0x%x)-", mMagicNum0, mMagicNum1,mMagicNum2);
                }
            }
            else if ( NSImageio::NSIspio::EPortIndex_TG2I == arg1 ) {
                //update param here
        ...
        case EPIPECmd_SET_IMGO:
            {
                ...
                if (0 == _pDma->out.stride) {
                    PIPE_ERR("[3ASync] SET_IMGO Invalid stride(0x%lx)!",_pDma->out.stride);
                }

                //if (0 ==_pDma->out.stride * _pDma->crop.w * _pDma->crop.h) {
                if (0 == _pDma->crop.w * _pDma->crop.h) {
                    PIPE_ERR("[3ASync] SET_IMGO Invalid Para(0x%lx/0x%lx/0x%lx)!",_pDma->out.stride, _pDma->crop.w, _pDma->crop.h);
                    return MFALSE;
                }

                if (0 == _pDma->out.w * _pDma->out.h) {
                    PIPE_ERR("[3ASync] SET_IMGO Invalid OutWind Para(0x%lx/0x%lx)!", _pDma->out.w, _pDma->out.h);
                    return MFALSE;
                }
                ...
                if (_pDma->crop.x > this->m_camPass1Param.tg_out_size.w) {
                    PIPE_ERR("[3ASync]ERROR:TG:0x%x Crop invalid(x(%d)>size_w(%ld))",arg2,_pDma->crop.x, this->m_camPass1Param.tg_out_size.w);
                    return MFALSE;
                }
                if (_pDma->crop.w > this->m_camPass1Param.tg_out_size.w) {
                    PIPE_ERR("[3ASync]ERROR:TG:0x%x Not Support Scale up(in(%lu)<tg_w(%lu))",arg2, _pDma->crop.w, this->m_camPass1Param.tg_out_size.w);
                    return MFALSE;
                }
                ...
                //Arg2: EPortIndex_TG1I/EPortIndex_TG2I/EPortIndex_CAMSV_TG1I/EPortIndex_CAMSV_TG2I
                //Arg3: sensorDev
                if (((NSImageio::NSIspio::EPortIndex)arg2 != NSImageio::NSIspio::EPortIndex_TG1I) &&
                    ((NSImageio::NSIspio::EPortIndex)arg2 != NSImageio::NSIspio::EPortIndex_TG2I) &&
                    ((NSImageio::NSIspio::EPortIndex)arg2 != NSImageio::NSIspio::EPortIndex_CAMSV_TG1I) &&
                    ((NSImageio::NSIspio::EPortIndex)arg2 != NSImageio::NSIspio::EPortIndex_CAMSV_TG2I)) {
                ...
                mImgSel1 = this->m_ImgoCfg.mImgSel;
                ...
                if ( NSImageio::NSIspio::EPortIndex_TG1I == arg2 ) {
                    ...
                    mMagicNum0_SV1 = this->m_ImgoCfg.m_num;
                    m_CamPathPass1.pass1_path = ISP_PASS1_CAMSV;
                    m_rrzd_update_cnt = 0;
                    if (m_CamPathPass1.setP1MagicNum(mMagicNum0_SV1) != 0) {
                        ret = -1;
                    ...
                    mMagicNum0_SV2 = this->m_ImgoCfg.m_num;
                    m_CamPathPass1.pass1_path = ISP_PASS1_CAMSV_D;
                    m_rrzd_update_cnt = 0;
                    if (m_CamPathPass1.setP1MagicNum(mMagicNum0_SV2) != 0) {
                        ret = -1;
        ...
        case EPIPECmd_GET_MODULE_HANDLE: //handle-based
             ...
             if (((NSImageio::NSIspio::EPortIndex_TG1I == tg) && (!(this->mPath1 & ISP_PASS1)))||
                ((NSImageio::NSIspio::EPortIndex_TG2I == tg) && (!(this->mPath1 & ISP_PASS1_D)))) {
                PIPE_ERR("GET_MODULE_HANDLE: User(%s), tg=%d NotMatch Path=0x%x",(char*)arg3, tg, mPath1);
                return MFALSE;
             }
             if (NSImageio::NSIspio::EPortIndex_UNKNOW == tg ) {
                 CAM_ULOGME("GET_MODULE_HANDLE:User(%s), tg=%d is Invalid",(char*)arg3, tg);
                 return -1;
             }
             //CAM_ULOGMD("GET_MODULE_HANDLE:User(%s)!, tg=%d",arg3, tg);
             *((MINTPTR*)arg2) = (MINTPTR) (m_P1HWRWctrl[tg].getModuleHandle((CAM_MODULE_ENUM)p1ConvModuleID(arg1), (char const*)arg3));
             if ((MINT32)NULL == *((MINT32*)arg2)) {
                PIPE_ERR("NOT Rdy || Not-supported module(0x%x ,%u)!",arg1,p1ConvModuleID(arg1));
                ret = -1;
             }
             break;
        ...
        case EPIPECmd_RELEASE_MODULE_HANDLE: //handle-based
            ...
            //CAM_ULOGMD("Handle(0x%x), %s!",arg1, arg2);
             if (!arg1) {
        ...
        case EPIPECmd_SET_MODULE_EN:
            ...
            if ( EModule_CAMSV_IMGO == arg1)  {
                ...
                ISP_WRITE_REG(pPhyIspDrv,CAMSV_CLK_EN,0x00008005,ISP_DRV_USER_ISPF);
                ISP_WRITE_REG(pPhyIspDrv,CAMSV_INT_EN ,0x481,ISP_DRV_USER_ISPF);
                ISP_WRITE_REG(pPhyIspDrv,CAMSV_TG_VF_CON,0x00001001,ISP_DRV_USER_ISPF);
                ISP_WRITE_REG(pPhyIspDrv,CAMSV_MODULE_EN,0x40000015,ISP_DRV_USER_ISPF);
                if (true == this->m_pass1TwinMode)
                {
                    ISP_WRITE_REG(pPhyIspDrv,CAMSV_PAK,0x07,ISP_DRV_USER_ISPF);
                }
                else
                {
                    ISP_WRITE_REG(pPhyIspDrv,CAMSV_PAK,0x03,ISP_DRV_USER_ISPF);
                }
                ISP_WRITE_REG(pPhyIspDrv,CAMSV_FMT_SEL,0x01000000, ISP_DRV_USER_ISPF);
                ret = 0;
            }
             else if ( EModule_CAMSV2_IMGO == arg1)  {
                IspDrv* pPhyIspDrv = this->m_pIspDrvShell->getPhyIspDrv();
                ISP_WRITE_REG(pPhyIspDrv,CAMSV2_CLK_EN,0x00008005,ISP_DRV_USER_ISPF);
                ISP_WRITE_REG(pPhyIspDrv,CAMSV2_INT_EN ,0x481,ISP_DRV_USER_ISPF);
                ISP_WRITE_REG(pPhyIspDrv,CAMSV_TG2_VF_CON,0x00001001,ISP_DRV_USER_ISPF);
                ISP_WRITE_REG(pPhyIspDrv,CAMSV2_MODULE_EN,0x40000015,ISP_DRV_USER_ISPF);
                if (true == this->m_pass1TwinMode)
                {
                    ISP_WRITE_REG(pPhyIspDrv,CAMSV_PAK,0x06,ISP_DRV_USER_ISPF);
                }
                else
                {
                    ISP_WRITE_REG(pPhyIspDrv,CAMSV2_PAK,0x02,ISP_DRV_USER_ISPF);
                }
                ISP_WRITE_REG(pPhyIspDrv,CAMSV2_FMT_SEL,0x01000000, ISP_DRV_USER_ISPF);
                ret = 0;
            }
            else {
                tg = _p1GetModuleTgIdx(arg1,this->m_pass1TwinMode);
                if (NSImageio::NSIspio::EPortIndex_UNKNOW == tg ) {
                    CAM_ULOGME("SET_MODULE_EN:User(%s), tg=%d is Invalid",(char*)arg3, tg);
                    return -1;
                }
                if (((NSImageio::NSIspio::EPortIndex_TG1I == tg) && (!(this->mPath1 & ISP_PASS1)))||
                     ((NSImageio::NSIspio::EPortIndex_TG2I == tg) && (!(this->mPath1 & ISP_PASS1_D)))) {
                            PIPE_ERR("SET_MODULE_EN: User(%s), tg=%d NotMatch Path=0x%x",(char*)arg3, tg, mPath1);
                            return MFALSE;
                        }
        ...
        case EPIPECmd_SET_MODULE_SEL:
            ...
            if (NSImageio::NSIspio::EPortIndex_UNKNOW == tg ) {
                CAM_ULOGME("SET_MODULE_SEL:User(%s), tg=%d is Invalid",(char*)arg3, tg);
                return -1;
            }
            if (((NSImageio::NSIspio::EPortIndex_TG1I == tg) && (!(this->mPath1 & ISP_PASS1)))||
                ((NSImageio::NSIspio::EPortIndex_TG2I == tg) && (!(this->mPath1 & ISP_PASS1_D)))) {
                PIPE_ERR("SET_MODULE_SEL: User(%s), tg=%d NotMatch Path=0x%x",(char*)arg3, tg, mPath1);
                return MFALSE;
            }
        ...
        case EPIPECmd_SET_MODULE_DBG_DUMP: //dbg only
            //arg1 : handle;
            tg = _p1GetModuleTgIdx(arg1,this->m_pass1TwinMode);
            if(tg == NSImageio::NSIspio::EPortIndex_UNKNOW) {
                ret = -1;
                break;
            }
        ...
        case EPIPECmd_GET_CUR_FRM_RAWFMT:
            {
                ...
                IspDrv* pDrv = NULL;
                pDrv = this->m_pIspDrvShell->getPhyIspDrv();
                if (arg2 == NSImageio::NSIspio::EPortIndex_TG1I)
                {
                    cam_crl_sel = pDrv->readReg(0x00004034);
                }
                else if (arg2 == NSImageio::NSIspio::EPortIndex_TG2I)
                {
        ...
        case EPIPECmd_GET_HBIN_INFO:
            {
                MUINT32 cam_ctl_en_p1 = 0x0;
                IspDrv* pDrv = NULL;
                pDrv = this->m_pIspDrvShell->getPhyIspDrv();
                cam_ctl_en_p1 = ISP_READ_BITS_NOPROTECT(pDrv,CAM_CTL_EN_P1,HBIN1_EN) && ISP_READ_BITS_NOPROTECT(pDrv,CAM_CTL_EN_P1,HBIN2_EN);
                if (cam_ctl_en_p1 == 1) {
                    *(MINT32*)arg3 = 1;
                } else {
                    *(MINT32*)arg3 = 0;
