...
#define MAX_WPE_ENQUEUE_USER  (MAX_WPE_DUP_IDX_NUM)
#define MAX_SUPPORT_WPE_FRAME_NUM  (MAX_WPE_BURST_IDX_NUM)
...
private:
    ...
    NSImageio::NSIspio::IWarpEnginePipe*    mwarpengine;
    ...
    list<WPEFramePackage>      mLWPEDQFramePackList; //list for frame package dequeued from hw using WPE
};
