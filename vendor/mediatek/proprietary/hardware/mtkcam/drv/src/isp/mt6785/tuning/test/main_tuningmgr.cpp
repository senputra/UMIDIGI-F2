...
#undef LOG_ERR
#undef LOG_AST
#define LOG_VRB(fmt, arg...)        do { if (tuning_mgr_test_DbgLogEnable_VERBOSE) { printf(fmt, ##arg); } } while(0)
#define LOG_DBG(fmt, arg...)        do { if (tuning_mgr_test_DbgLogEnable_DEBUG  ) { printf(fmt, ##arg); } } while(0)
//#define LOG_DBG(fmt, arg...)        do { if (tuning_mgr_DbgLogEnable_INFO  ) { BASE_LOG_INF(fmt, ##arg); } } while(0)
#define LOG_INF(fmt, arg...)        do { if (tuning_mgr_test_DbgLogEnable_INFO   ) { printf(fmt, ##arg); } } while(0)
#define LOG_WRN(fmt, arg...)        do { if (tuning_mgr_test_DbgLogEnable_WARN   ) { printf(fmt, ##arg); } } while(0)
#define LOG_ERR(fmt, arg...)        do { if (tuning_mgr_test_DbgLogEnable_ERROR  ) { printf(fmt, ##arg); } } while(0)
#define LOG_AST(cond, fmt, arg...)  do { if (tuning_mgr_test_DbgLogEnable_ASSERT ) { printf(cond, fmt, ##arg); } } while(0)
//-----------------------------------------------------------------------------
