...
typedef enum _IOPIPE_TRACE_EN_MODE {
    ...
    IOPIPE_TRACE_EN_NORMALSVPIPE = 3,
 ...
 ******************************************************************************/
    ...
    #define NSVPIPE_TRACE_BEGIN(name) 	do { _TRACE_BEGIN(name, IOPIPE_TRACE_EN_NORMALSVPIPE); _METTAG_BEGIN(name, IOPIPE_TRACE_EN_NORMALSVPIPE); } while(0)
    #define NSVPIPE_TRACE_END(name)		do { _TRACE_END(name, IOPIPE_TRACE_EN_NORMALSVPIPE); _METTAG_END(name, IOPIPE_TRACE_EN_NORMALSVPIPE); } while(0)
