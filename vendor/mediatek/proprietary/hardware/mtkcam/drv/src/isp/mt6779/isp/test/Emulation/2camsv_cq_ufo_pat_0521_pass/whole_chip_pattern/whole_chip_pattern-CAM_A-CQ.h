ptr->writeReg(0x0208, 0x5d834800, CAM_A);      //TOP.CAM_CAM_1.CAM_A.CAMCQ_R1.CAMCQ_CQ_THR0_BASEADDR
...
ptr->writeReg(0x0200, 0x110, CAM_A);           //TOP.CAM_CAM_1.CAM_A.CAMCQ_R1.CAMCQ_CQ_EN
...
ptr->writeReg(0x417c, 0x000000, CAM_A);  			//TOP.CAM_CAM_1.CAM_A.PDO_R1.PDO_CON2 
ptr->writeReg(0x4180, 0x000000, CAM_A);  			//TOP.CAM_CAM_1.CAM_A.PDO_R1.PDO_CON3 
