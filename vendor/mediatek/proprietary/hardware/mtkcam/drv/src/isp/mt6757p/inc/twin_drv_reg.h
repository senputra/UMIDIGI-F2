...
typedef union _CAM_A_REG_BNR_RSV1_
{
		struct	/* 0x1A004658 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_BNR_RSV1;	/* CAM_A_BNR_RSV1 */

typedef union _CAM_A_REG_BNR_RSV2_
{
		struct	/* 0x1A00465C */
		{
		...
		UINT32 Raw;
}CAM_A_REG_BNR_RSV2;	/* CAM_A_BNR_RSV2 */
...
typedef union _CAM_A_REG_AE_HST_CTL_
{
		struct	/* 0x1A0049E0 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_AE_HST_CTL;	/* CAM_A_AE_HST_CTL */
...
typedef union _CAM_A_REG_AE_HST_SET_
{
		struct	/* 0x1A004A10 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_AE_HST_SET;	/* CAM_A_AE_HST_SET */

typedef union _CAM_A_REG_AE_HST0_RNG_
{
		struct	/* 0x1A004A14 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_AE_HST0_RNG;	/* CAM_A_AE_HST0_RNG */

typedef union _CAM_A_REG_AE_HST1_RNG_
{
		struct	/* 0x1A004A18 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_AE_HST1_RNG;	/* CAM_A_AE_HST1_RNG */

typedef union _CAM_A_REG_AE_HST2_RNG_
{
		struct	/* 0x1A004A1C */
		{
		...
		UINT32 Raw;
}CAM_A_REG_AE_HST2_RNG;	/* CAM_A_AE_HST2_RNG */

typedef union _CAM_A_REG_AE_HST3_RNG_
{
		struct	/* 0x1A004A20 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_AE_HST3_RNG;	/* CAM_A_AE_HST3_RNG */
...
typedef union _CAM_A_REG_AE_HST_SEL_
{
		struct	/* 0x1A004A54 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_AE_HST_SEL;	/* CAM_A_AE_HST_SEL */
...
typedef union _CAM_A_REG_CAC_TILE_SIZE_
{
		struct	/* 0x1A004AF0 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_CAC_TILE_SIZE;	/* CAM_A_CAC_TILE_SIZE */

typedef union _CAM_A_REG_CAC_TILE_OFFSET_
{
		struct	/* 0x1A004AF4 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_CAC_TILE_OFFSET;	/* CAM_A_CAC_TILE_OFFSET */

typedef union _CAM_A_REG_PMX_CTL_
{
		struct	/* 0x1A004B00 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_PMX_CTL;	/* CAM_A_PMX_CTL */

typedef union _CAM_A_REG_PMX_CROP_
{
		struct	/* 0x1A004B04 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_PMX_CROP;	/* CAM_A_PMX_CROP */

typedef union _CAM_A_REG_PMX_VSIZE_
{
		struct	/* 0x1A004B08 */
		{
		...
		UINT32 Raw;
}CAM_A_REG_PMX_VSIZE;	/* CAM_A_PMX_VSIZE */
...
typedef union _CAM_A_REG_QBN4_MODE_
{
		struct	/* 0x1A004D00 */
		{
				FIELD  QBN_ACC                               :  2;		/*  0.. 1, 0x00000003 */
		...
		UINT32 Raw;
}CAM_A_REG_QBN4_MODE;	/* CAM_A_QBN4_MODE */
...
typedef union _CAM_B_REG_BNR_RSV1_
{
		struct	/* 0x1A005658 */
		{
				FIELD  RSV1                                  : 32;		/*  0..31, 0xFFFFFFFF */
		...
		UINT32 Raw;
}CAM_B_REG_BNR_RSV1;	/* CAM_B_BNR_RSV1 */

typedef union _CAM_B_REG_BNR_RSV2_
{
		struct	/* 0x1A00565C */
		{
				FIELD  RSV2                                  : 32;		/*  0..31, 0xFFFFFFFF */
		...
		UINT32 Raw;
}CAM_B_REG_BNR_RSV2;	/* CAM_B_BNR_RSV2 */
...
typedef union _CAM_B_REG_AE_HST_CTL_
{
		struct	/* 0x1A0059E0 */
		{
				FIELD  AE_HST0_EN                            :  1;		/*  0.. 0, 0x00000001 */
		...
		UINT32 Raw;
}CAM_B_REG_AE_HST_CTL;	/* CAM_B_AE_HST_CTL */
...
typedef union _CAM_B_REG_AE_HST_SET_
{
		struct	/* 0x1A005A10 */
		{
				FIELD  AE_BIN_MODE_0                         :  2;		/*  0.. 1, 0x00000003 */
		...
		UINT32 Raw;
}CAM_B_REG_AE_HST_SET;	/* CAM_B_AE_HST_SET */

typedef union _CAM_B_REG_AE_HST0_RNG_
{
		struct	/* 0x1A005A14 */
		{
				FIELD  AE_X_LOW_0                            :  7;		/*  0.. 6, 0x0000007F */
		...
		UINT32 Raw;
}CAM_B_REG_AE_HST0_RNG;	/* CAM_B_AE_HST0_RNG */

typedef union _CAM_B_REG_AE_HST1_RNG_
{
		struct	/* 0x1A005A18 */
		{
				FIELD  AE_X_LOW_1                            :  7;		/*  0.. 6, 0x0000007F */
		...
		UINT32 Raw;
}CAM_B_REG_AE_HST1_RNG;	/* CAM_B_AE_HST1_RNG */

typedef union _CAM_B_REG_AE_HST2_RNG_
{
		struct	/* 0x1A005A1C */
		{
				FIELD  AE_X_LOW_2                            :  7;		/*  0.. 6, 0x0000007F */
		...
		UINT32 Raw;
}CAM_B_REG_AE_HST2_RNG;	/* CAM_B_AE_HST2_RNG */

typedef union _CAM_B_REG_AE_HST3_RNG_
{
		struct	/* 0x1A005A20 */
		{
				FIELD  AE_X_LOW_3                            :  7;		/*  0.. 6, 0x0000007F */
		...
		UINT32 Raw;
}CAM_B_REG_AE_HST3_RNG;	/* CAM_B_AE_HST3_RNG */
...
typedef union _CAM_B_REG_AE_HST_SEL_
{
		struct	/* 0x1A005A54 */
		{
				FIELD  AE_HST_SEL                            :  1;		/*  0.. 0, 0x00000001 */
		...
		UINT32 Raw;
}CAM_B_REG_AE_HST_SEL;	/* CAM_B_AE_HST_SEL */
...
typedef union _CAM_B_REG_CAC_TILE_SIZE_
{
		struct	/* 0x1A005AF0 */
		{
				FIELD  CAC_TILE_WIDTH                        : 16;		/*  0..15, 0x0000FFFF */
		...
		UINT32 Raw;
}CAM_B_REG_CAC_TILE_SIZE;	/* CAM_B_CAC_TILE_SIZE */

typedef union _CAM_B_REG_CAC_TILE_OFFSET_
{
		struct	/* 0x1A005AF4 */
		{
				FIELD  CAC_OFFSET_X                          : 16;		/*  0..15, 0x0000FFFF */
		...
		UINT32 Raw;
}CAM_B_REG_CAC_TILE_OFFSET;	/* CAM_B_CAC_TILE_OFFSET */

typedef union _CAM_B_REG_PMX_CTL_
{
		struct	/* 0x1A005B00 */
		{
				FIELD  PMX_SRAM_SIZE                         : 16;		/*  0..15, 0x0000FFFF */
		...
		UINT32 Raw;
}CAM_B_REG_PMX_CTL;	/* CAM_B_PMX_CTL */

typedef union _CAM_B_REG_PMX_CROP_
{
		struct	/* 0x1A005B04 */
		{
				FIELD  PMX_STR_X                             : 16;		/*  0..15, 0x0000FFFF */
		...
		UINT32 Raw;
}CAM_B_REG_PMX_CROP;	/* CAM_B_PMX_CROP */

typedef union _CAM_B_REG_PMX_VSIZE_
{
		struct	/* 0x1A005B08 */
		{
				FIELD  PMX_HT                                : 16;		/*  0..15, 0x0000FFFF */
		...
		UINT32 Raw;
}CAM_B_REG_PMX_VSIZE;	/* CAM_B_PMX_VSIZE */
...
typedef union _CAM_B_REG_QBN4_MODE_
{
		struct	/* 0x1A005D00 */
		{
				FIELD  QBN_ACC                               :  2;		/*  0.. 1, 0x00000003 */
		...
		UINT32 Raw;
}CAM_B_REG_QBN4_MODE;	/* CAM_B_QBN4_MODE */
...
typedef struct _cam_a_reg_t_	/* 0x1A004000..0x1A004FFF */
{
	...
	CAM_A_REG_CQ_EN                                 CAM_A_CQ_EN;                                     /* 0160, 0x1A004160 */
	CAM_A_REG_CQ_THR0_CTL                           CAM_A_CQ_THR0_CTL;                               /* 0164, 0x1A004164 */
	CAM_A_REG_CQ_THR0_BASEADDR                      CAM_A_CQ_THR0_BASEADDR;                          /* 0168, 0x1A004168 */
	CAM_A_REG_CQ_THR0_DESC_SIZE                     CAM_A_CQ_THR0_DESC_SIZE;                         /* 016C, 0x1A00416C */
	CAM_A_REG_CQ_THR1_CTL                           CAM_A_CQ_THR1_CTL;                               /* 0170, 0x1A004170 */
	CAM_A_REG_CQ_THR1_BASEADDR                      CAM_A_CQ_THR1_BASEADDR;                          /* 0174, 0x1A004174 */
	CAM_A_REG_CQ_THR1_DESC_SIZE                     CAM_A_CQ_THR1_DESC_SIZE;                         /* 0178, 0x1A004178 */
	CAM_A_REG_CQ_THR2_CTL                           CAM_A_CQ_THR2_CTL;                               /* 017C, 0x1A00417C */
	CAM_A_REG_CQ_THR2_BASEADDR                      CAM_A_CQ_THR2_BASEADDR;                          /* 0180, 0x1A004180 */
	CAM_A_REG_CQ_THR2_DESC_SIZE                     CAM_A_CQ_THR2_DESC_SIZE;                         /* 0184, 0x1A004184 */
	CAM_A_REG_CQ_THR3_CTL                           CAM_A_CQ_THR3_CTL;                               /* 0188, 0x1A004188 */
	CAM_A_REG_CQ_THR3_BASEADDR                      CAM_A_CQ_THR3_BASEADDR;                          /* 018C, 0x1A00418C */
	CAM_A_REG_CQ_THR3_DESC_SIZE                     CAM_A_CQ_THR3_DESC_SIZE;                         /* 0190, 0x1A004190 */
	CAM_A_REG_CQ_THR4_CTL                           CAM_A_CQ_THR4_CTL;                               /* 0194, 0x1A004194 */
	CAM_A_REG_CQ_THR4_BASEADDR                      CAM_A_CQ_THR4_BASEADDR;                          /* 0198, 0x1A004198 */
	CAM_A_REG_CQ_THR4_DESC_SIZE                     CAM_A_CQ_THR4_DESC_SIZE;                         /* 019C, 0x1A00419C */
	CAM_A_REG_CQ_THR5_CTL                           CAM_A_CQ_THR5_CTL;                               /* 01A0, 0x1A0041A0 */
	CAM_A_REG_CQ_THR5_BASEADDR                      CAM_A_CQ_THR5_BASEADDR;                          /* 01A4, 0x1A0041A4 */
	CAM_A_REG_CQ_THR5_DESC_SIZE                     CAM_A_CQ_THR5_DESC_SIZE;                         /* 01A8, 0x1A0041A8 */
	CAM_A_REG_CQ_THR6_CTL                           CAM_A_CQ_THR6_CTL;                               /* 01AC, 0x1A0041AC */
	CAM_A_REG_CQ_THR6_BASEADDR                      CAM_A_CQ_THR6_BASEADDR;                          /* 01B0, 0x1A0041B0 */
	CAM_A_REG_CQ_THR6_DESC_SIZE                     CAM_A_CQ_THR6_DESC_SIZE;                         /* 01B4, 0x1A0041B4 */
	CAM_A_REG_CQ_THR7_CTL                           CAM_A_CQ_THR7_CTL;                               /* 01B8, 0x1A0041B8 */
	CAM_A_REG_CQ_THR7_BASEADDR                      CAM_A_CQ_THR7_BASEADDR;                          /* 01BC, 0x1A0041BC */
	CAM_A_REG_CQ_THR7_DESC_SIZE                     CAM_A_CQ_THR7_DESC_SIZE;                         /* 01C0, 0x1A0041C0 */
	CAM_A_REG_CQ_THR8_CTL                           CAM_A_CQ_THR8_CTL;                               /* 01C4, 0x1A0041C4 */
	CAM_A_REG_CQ_THR8_BASEADDR                      CAM_A_CQ_THR8_BASEADDR;                          /* 01C8, 0x1A0041C8 */
	CAM_A_REG_CQ_THR8_DESC_SIZE                     CAM_A_CQ_THR8_DESC_SIZE;                         /* 01CC, 0x1A0041CC */
	CAM_A_REG_CQ_THR9_CTL                           CAM_A_CQ_THR9_CTL;                               /* 01D0, 0x1A0041D0 */
	CAM_A_REG_CQ_THR9_BASEADDR                      CAM_A_CQ_THR9_BASEADDR;                          /* 01D4, 0x1A0041D4 */
	CAM_A_REG_CQ_THR9_DESC_SIZE                     CAM_A_CQ_THR9_DESC_SIZE;                         /* 01D8, 0x1A0041D8 */
	CAM_A_REG_CQ_THR10_CTL                          CAM_A_CQ_THR10_CTL;                              /* 01DC, 0x1A0041DC */
	CAM_A_REG_CQ_THR10_BASEADDR                     CAM_A_CQ_THR10_BASEADDR;                         /* 01E0, 0x1A0041E0 */
	CAM_A_REG_CQ_THR10_DESC_SIZE                    CAM_A_CQ_THR10_DESC_SIZE;                        /* 01E4, 0x1A0041E4 */
	CAM_A_REG_CQ_THR11_CTL                          CAM_A_CQ_THR11_CTL;                              /* 01E8, 0x1A0041E8 */
	CAM_A_REG_CQ_THR11_BASEADDR                     CAM_A_CQ_THR11_BASEADDR;                         /* 01EC, 0x1A0041EC */
	CAM_A_REG_CQ_THR11_DESC_SIZE                    CAM_A_CQ_THR11_DESC_SIZE;                        /* 01F0, 0x1A0041F0 */
	CAM_A_REG_CQ_THR12_CTL                          CAM_A_CQ_THR12_CTL;                              /* 01F4, 0x1A0041F4 */
	CAM_A_REG_CQ_THR12_BASEADDR                     CAM_A_CQ_THR12_BASEADDR;                         /* 01F8, 0x1A0041F8 */
	CAM_A_REG_CQ_THR12_DESC_SIZE                    CAM_A_CQ_THR12_DESC_SIZE;                        /* 01FC, 0x1A0041FC */
	CAM_A_REG_DMA_SOFT_RSTSTAT                      CAM_A_DMA_SOFT_RSTSTAT;                          /* 0200, 0x1A004200 */
	CAM_A_REG_CQ0I_BASE_ADDR                        CAM_A_CQ0I_BASE_ADDR;                            /* 0204, 0x1A004204 */
	CAM_A_REG_CQ0I_XSIZE                            CAM_A_CQ0I_XSIZE;                                /* 0208, 0x1A004208 */
	CAM_A_REG_VERTICAL_FLIP_EN                      CAM_A_VERTICAL_FLIP_EN;                          /* 020C, 0x1A00420C */
	CAM_A_REG_DMA_SOFT_RESET                        CAM_A_DMA_SOFT_RESET;                            /* 0210, 0x1A004210 */
	CAM_A_REG_LAST_ULTRA_EN                         CAM_A_LAST_ULTRA_EN;                             /* 0214, 0x1A004214 */
	CAM_A_REG_SPECIAL_FUN_EN                        CAM_A_SPECIAL_FUN_EN;                            /* 0218, 0x1A004218 */
	UINT32                                          rsv_021C;                                        /* 021C, 0x1A00421C */
	CAM_A_REG_IMGO_BASE_ADDR                        CAM_A_IMGO_BASE_ADDR;                            /* 0220, 0x1A004220 */
	UINT32                                          rsv_0224;                                        /* 0224, 0x1A004224 */
	CAM_A_REG_IMGO_OFST_ADDR                        CAM_A_IMGO_OFST_ADDR;                            /* 0228, 0x1A004228 */
	UINT32                                          rsv_022C;                                        /* 022C, 0x1A00422C */
	CAM_A_REG_IMGO_XSIZE                            CAM_A_IMGO_XSIZE;                                /* 0230, 0x1A004230 */
	CAM_A_REG_IMGO_YSIZE                            CAM_A_IMGO_YSIZE;                                /* 0234, 0x1A004234 */
	CAM_A_REG_IMGO_STRIDE                           CAM_A_IMGO_STRIDE;                               /* 0238, 0x1A004238 */
	CAM_A_REG_IMGO_CON                              CAM_A_IMGO_CON;                                  /* 023C, 0x1A00423C */
	CAM_A_REG_IMGO_CON2                             CAM_A_IMGO_CON2;                                 /* 0240, 0x1A004240 */
	CAM_A_REG_IMGO_CON3                             CAM_A_IMGO_CON3;                                 /* 0244, 0x1A004244 */
	CAM_A_REG_IMGO_CROP                             CAM_A_IMGO_CROP;                                 /* 0248, 0x1A004248 */
	UINT32                                          rsv_024C;                                        /* 024C, 0x1A00424C */
	CAM_A_REG_RRZO_BASE_ADDR                        CAM_A_RRZO_BASE_ADDR;                            /* 0250, 0x1A004250 */
	UINT32                                          rsv_0254;                                        /* 0254, 0x1A004254 */
	CAM_A_REG_RRZO_OFST_ADDR                        CAM_A_RRZO_OFST_ADDR;                            /* 0258, 0x1A004258 */
	UINT32                                          rsv_025C;                                        /* 025C, 0x1A00425C */
	CAM_A_REG_RRZO_XSIZE                            CAM_A_RRZO_XSIZE;                                /* 0260, 0x1A004260 */
	CAM_A_REG_RRZO_YSIZE                            CAM_A_RRZO_YSIZE;                                /* 0264, 0x1A004264 */
	CAM_A_REG_RRZO_STRIDE                           CAM_A_RRZO_STRIDE;                               /* 0268, 0x1A004268 */
	CAM_A_REG_RRZO_CON                              CAM_A_RRZO_CON;                                  /* 026C, 0x1A00426C */
	CAM_A_REG_RRZO_CON2                             CAM_A_RRZO_CON2;                                 /* 0270, 0x1A004270 */
	CAM_A_REG_RRZO_CON3                             CAM_A_RRZO_CON3;                                 /* 0274, 0x1A004274 */
	CAM_A_REG_RRZO_CROP                             CAM_A_RRZO_CROP;                                 /* 0278, 0x1A004278 */
	UINT32                                          rsv_027C;                                        /* 027C, 0x1A00427C */
	CAM_A_REG_AAO_BASE_ADDR                         CAM_A_AAO_BASE_ADDR;                             /* 0280, 0x1A004280 */
	UINT32                                          rsv_0284;                                        /* 0284, 0x1A004284 */
	CAM_A_REG_AAO_OFST_ADDR                         CAM_A_AAO_OFST_ADDR;                             /* 0288, 0x1A004288 */
	UINT32                                          rsv_028C;                                        /* 028C, 0x1A00428C */
	CAM_A_REG_AAO_XSIZE                             CAM_A_AAO_XSIZE;                                 /* 0290, 0x1A004290 */
	CAM_A_REG_AAO_YSIZE                             CAM_A_AAO_YSIZE;                                 /* 0294, 0x1A004294 */
	CAM_A_REG_AAO_STRIDE                            CAM_A_AAO_STRIDE;                                /* 0298, 0x1A004298 */
	CAM_A_REG_AAO_CON                               CAM_A_AAO_CON;                                   /* 029C, 0x1A00429C */
	CAM_A_REG_AAO_CON2                              CAM_A_AAO_CON2;                                  /* 02A0, 0x1A0042A0 */
	CAM_A_REG_AAO_CON3                              CAM_A_AAO_CON3;                                  /* 02A4, 0x1A0042A4 */
	UINT32                                          rsv_02A8[2];                                     /* 02A8..02AF, 0x1A0042A8..1A0042AF */
	CAM_A_REG_AFO_BASE_ADDR                         CAM_A_AFO_BASE_ADDR;                             /* 02B0, 0x1A0042B0 */
	UINT32                                          rsv_02B4;                                        /* 02B4, 0x1A0042B4 */
	CAM_A_REG_AFO_OFST_ADDR                         CAM_A_AFO_OFST_ADDR;                             /* 02B8, 0x1A0042B8 */
	UINT32                                          rsv_02BC;                                        /* 02BC, 0x1A0042BC */
	CAM_A_REG_AFO_XSIZE                             CAM_A_AFO_XSIZE;                                 /* 02C0, 0x1A0042C0 */
	CAM_A_REG_AFO_YSIZE                             CAM_A_AFO_YSIZE;                                 /* 02C4, 0x1A0042C4 */
	CAM_A_REG_AFO_STRIDE                            CAM_A_AFO_STRIDE;                                /* 02C8, 0x1A0042C8 */
	CAM_A_REG_AFO_CON                               CAM_A_AFO_CON;                                   /* 02CC, 0x1A0042CC */
	CAM_A_REG_AFO_CON2                              CAM_A_AFO_CON2;                                  /* 02D0, 0x1A0042D0 */
	CAM_A_REG_AFO_CON3                              CAM_A_AFO_CON3;                                  /* 02D4, 0x1A0042D4 */
	UINT32                                          rsv_02D8[2];                                     /* 02D8..02DF, 0x1A0042D8..1A0042DF */
	CAM_A_REG_LCSO_BASE_ADDR                        CAM_A_LCSO_BASE_ADDR;                            /* 02E0, 0x1A0042E0 */
	UINT32                                          rsv_02E4;                                        /* 02E4, 0x1A0042E4 */
	CAM_A_REG_LCSO_OFST_ADDR                        CAM_A_LCSO_OFST_ADDR;                            /* 02E8, 0x1A0042E8 */
	UINT32                                          rsv_02EC;                                        /* 02EC, 0x1A0042EC */
	CAM_A_REG_LCSO_XSIZE                            CAM_A_LCSO_XSIZE;                                /* 02F0, 0x1A0042F0 */
	CAM_A_REG_LCSO_YSIZE                            CAM_A_LCSO_YSIZE;                                /* 02F4, 0x1A0042F4 */
	CAM_A_REG_LCSO_STRIDE                           CAM_A_LCSO_STRIDE;                               /* 02F8, 0x1A0042F8 */
	CAM_A_REG_LCSO_CON                              CAM_A_LCSO_CON;                                  /* 02FC, 0x1A0042FC */
	CAM_A_REG_LCSO_CON2                             CAM_A_LCSO_CON2;                                 /* 0300, 0x1A004300 */
	CAM_A_REG_LCSO_CON3                             CAM_A_LCSO_CON3;                                 /* 0304, 0x1A004304 */
	UINT32                                          rsv_0308[2];                                     /* 0308..030F, 0x1A004308..1A00430F */
	CAM_A_REG_UFEO_BASE_ADDR                        CAM_A_UFEO_BASE_ADDR;                            /* 0310, 0x1A004310 */
	UINT32                                          rsv_0314;                                        /* 0314, 0x1A004314 */
	CAM_A_REG_UFEO_OFST_ADDR                        CAM_A_UFEO_OFST_ADDR;                            /* 0318, 0x1A004318 */
	UINT32                                          rsv_031C;                                        /* 031C, 0x1A00431C */
	CAM_A_REG_UFEO_XSIZE                            CAM_A_UFEO_XSIZE;                                /* 0320, 0x1A004320 */
	CAM_A_REG_UFEO_YSIZE                            CAM_A_UFEO_YSIZE;                                /* 0324, 0x1A004324 */
	CAM_A_REG_UFEO_STRIDE                           CAM_A_UFEO_STRIDE;                               /* 0328, 0x1A004328 */
	CAM_A_REG_UFEO_CON                              CAM_A_UFEO_CON;                                  /* 032C, 0x1A00432C */
	CAM_A_REG_UFEO_CON2                             CAM_A_UFEO_CON2;                                 /* 0330, 0x1A004330 */
	CAM_A_REG_UFEO_CON3                             CAM_A_UFEO_CON3;                                 /* 0334, 0x1A004334 */
	UINT32                                          rsv_0338[2];                                     /* 0338..033F, 0x1A004338..1A00433F */
	CAM_A_REG_PDO_BASE_ADDR                         CAM_A_PDO_BASE_ADDR;                             /* 0340, 0x1A004340 */
	UINT32                                          rsv_0344;                                        /* 0344, 0x1A004344 */
	CAM_A_REG_PDO_OFST_ADDR                         CAM_A_PDO_OFST_ADDR;                             /* 0348, 0x1A004348 */
	UINT32                                          rsv_034C;                                        /* 034C, 0x1A00434C */
	CAM_A_REG_PDO_XSIZE                             CAM_A_PDO_XSIZE;                                 /* 0350, 0x1A004350 */
	CAM_A_REG_PDO_YSIZE                             CAM_A_PDO_YSIZE;                                 /* 0354, 0x1A004354 */
	CAM_A_REG_PDO_STRIDE                            CAM_A_PDO_STRIDE;                                /* 0358, 0x1A004358 */
	CAM_A_REG_PDO_CON                               CAM_A_PDO_CON;                                   /* 035C, 0x1A00435C */
	CAM_A_REG_PDO_CON2                              CAM_A_PDO_CON2;                                  /* 0360, 0x1A004360 */
	CAM_A_REG_PDO_CON3                              CAM_A_PDO_CON3;                                  /* 0364, 0x1A004364 */
	UINT32                                          rsv_0368[2];                                     /* 0368..036F, 0x1A004368..1A00436F */
	CAM_A_REG_BPCI_BASE_ADDR                        CAM_A_BPCI_BASE_ADDR;                            /* 0370, 0x1A004370 */
	UINT32                                          rsv_0374;                                        /* 0374, 0x1A004374 */
	CAM_A_REG_BPCI_OFST_ADDR                        CAM_A_BPCI_OFST_ADDR;                            /* 0378, 0x1A004378 */
	UINT32                                          rsv_037C;                                        /* 037C, 0x1A00437C */
	CAM_A_REG_BPCI_XSIZE                            CAM_A_BPCI_XSIZE;                                /* 0380, 0x1A004380 */
	CAM_A_REG_BPCI_YSIZE                            CAM_A_BPCI_YSIZE;                                /* 0384, 0x1A004384 */
	CAM_A_REG_BPCI_STRIDE                           CAM_A_BPCI_STRIDE;                               /* 0388, 0x1A004388 */
	CAM_A_REG_BPCI_CON                              CAM_A_BPCI_CON;                                  /* 038C, 0x1A00438C */
	CAM_A_REG_BPCI_CON2                             CAM_A_BPCI_CON2;                                 /* 0390, 0x1A004390 */
	CAM_A_REG_BPCI_CON3                             CAM_A_BPCI_CON3;                                 /* 0394, 0x1A004394 */
	UINT32                                          rsv_0398[2];                                     /* 0398..039F, 0x1A004398..1A00439F */
	CAM_A_REG_CACI_BASE_ADDR                        CAM_A_CACI_BASE_ADDR;                            /* 03A0, 0x1A0043A0 */
	UINT32                                          rsv_03A4;                                        /* 03A4, 0x1A0043A4 */
	CAM_A_REG_CACI_OFST_ADDR                        CAM_A_CACI_OFST_ADDR;                            /* 03A8, 0x1A0043A8 */
	UINT32                                          rsv_03AC;                                        /* 03AC, 0x1A0043AC */
	CAM_A_REG_CACI_XSIZE                            CAM_A_CACI_XSIZE;                                /* 03B0, 0x1A0043B0 */
	CAM_A_REG_CACI_YSIZE                            CAM_A_CACI_YSIZE;                                /* 03B4, 0x1A0043B4 */
	CAM_A_REG_CACI_STRIDE                           CAM_A_CACI_STRIDE;                               /* 03B8, 0x1A0043B8 */
	CAM_A_REG_CACI_CON                              CAM_A_CACI_CON;                                  /* 03BC, 0x1A0043BC */
	CAM_A_REG_CACI_CON2                             CAM_A_CACI_CON2;                                 /* 03C0, 0x1A0043C0 */
	CAM_A_REG_CACI_CON3                             CAM_A_CACI_CON3;                                 /* 03C4, 0x1A0043C4 */
	UINT32                                          rsv_03C8[2];                                     /* 03C8..03CF, 0x1A0043C8..1A0043CF */
	CAM_A_REG_LSCI_BASE_ADDR                        CAM_A_LSCI_BASE_ADDR;                            /* 03D0, 0x1A0043D0 */
	UINT32                                          rsv_03D4;                                        /* 03D4, 0x1A0043D4 */
	CAM_A_REG_LSCI_OFST_ADDR                        CAM_A_LSCI_OFST_ADDR;                            /* 03D8, 0x1A0043D8 */
	UINT32                                          rsv_03DC;                                        /* 03DC, 0x1A0043DC */
	CAM_A_REG_LSCI_XSIZE                            CAM_A_LSCI_XSIZE;                                /* 03E0, 0x1A0043E0 */
	CAM_A_REG_LSCI_YSIZE                            CAM_A_LSCI_YSIZE;                                /* 03E4, 0x1A0043E4 */
	CAM_A_REG_LSCI_STRIDE                           CAM_A_LSCI_STRIDE;                               /* 03E8, 0x1A0043E8 */
	CAM_A_REG_LSCI_CON                              CAM_A_LSCI_CON;                                  /* 03EC, 0x1A0043EC */
	CAM_A_REG_LSCI_CON2                             CAM_A_LSCI_CON2;                                 /* 03F0, 0x1A0043F0 */
	CAM_A_REG_LSCI_CON3                             CAM_A_LSCI_CON3;                                 /* 03F4, 0x1A0043F4 */
	UINT32                                          rsv_03F8[2];                                     /* 03F8..03FF, 0x1A0043F8..1A0043FF */
	CAM_A_REG_LSC3I_BASE_ADDR                       CAM_A_LSC3I_BASE_ADDR;                           /* 0400, 0x1A004400 */
	UINT32                                          rsv_0404;                                        /* 0404, 0x1A004404 */
	CAM_A_REG_LSC3I_OFST_ADDR                       CAM_A_LSC3I_OFST_ADDR;                           /* 0408, 0x1A004408 */
	UINT32                                          rsv_040C;                                        /* 040C, 0x1A00440C */
	CAM_A_REG_LSC3I_XSIZE                           CAM_A_LSC3I_XSIZE;                               /* 0410, 0x1A004410 */
	CAM_A_REG_LSC3I_YSIZE                           CAM_A_LSC3I_YSIZE;                               /* 0414, 0x1A004414 */
	CAM_A_REG_LSC3I_STRIDE                          CAM_A_LSC3I_STRIDE;                              /* 0418, 0x1A004418 */
	CAM_A_REG_LSC3I_CON                             CAM_A_LSC3I_CON;                                 /* 041C, 0x1A00441C */
	CAM_A_REG_LSC3I_CON2                            CAM_A_LSC3I_CON2;                                /* 0420, 0x1A004420 */
	CAM_A_REG_LSC3I_CON3                            CAM_A_LSC3I_CON3;                                /* 0424, 0x1A004424 */
	UINT32                                          rsv_0428[6];                                     /* 0428..043F, 0x1A004428..1A00443F */
	CAM_A_REG_DMA_ERR_CTRL                          CAM_A_DMA_ERR_CTRL;                              /* 0440, 0x1A004440 */
	CAM_A_REG_IMGO_ERR_STAT                         CAM_A_IMGO_ERR_STAT;                             /* 0444, 0x1A004444 */
	CAM_A_REG_RRZO_ERR_STAT                         CAM_A_RRZO_ERR_STAT;                             /* 0448, 0x1A004448 */
	CAM_A_REG_AAO_ERR_STAT                          CAM_A_AAO_ERR_STAT;                              /* 044C, 0x1A00444C */
	CAM_A_REG_AFO_ERR_STAT                          CAM_A_AFO_ERR_STAT;                              /* 0450, 0x1A004450 */
	CAM_A_REG_LCSO_ERR_STAT                         CAM_A_LCSO_ERR_STAT;                             /* 0454, 0x1A004454 */
	CAM_A_REG_UFEO_ERR_STAT                         CAM_A_UFEO_ERR_STAT;                             /* 0458, 0x1A004458 */
	CAM_A_REG_PDO_ERR_STAT                          CAM_A_PDO_ERR_STAT;                              /* 045C, 0x1A00445C */
	CAM_A_REG_BPCI_ERR_STAT                         CAM_A_BPCI_ERR_STAT;                             /* 0460, 0x1A004460 */
	CAM_A_REG_CACI_ERR_STAT                         CAM_A_CACI_ERR_STAT;                             /* 0464, 0x1A004464 */
	CAM_A_REG_LSCI_ERR_STAT                         CAM_A_LSCI_ERR_STAT;                             /* 0468, 0x1A004468 */
	CAM_A_REG_LSC3I_ERR_STAT                        CAM_A_LSC3I_ERR_STAT;                            /* 046C, 0x1A00446C */
	CAM_A_REG_DMA_DEBUG_ADDR                        CAM_A_DMA_DEBUG_ADDR;                            /* 0470, 0x1A004470 */
	CAM_A_REG_DMA_RSV1                              CAM_A_DMA_RSV1;                                  /* 0474, 0x1A004474 */
	CAM_A_REG_DMA_RSV2                              CAM_A_DMA_RSV2;                                  /* 0478, 0x1A004478 */
	CAM_A_REG_DMA_RSV3                              CAM_A_DMA_RSV3;                                  /* 047C, 0x1A00447C */
	CAM_A_REG_DMA_RSV4                              CAM_A_DMA_RSV4;                                  /* 0480, 0x1A004480 */
	CAM_A_REG_DMA_RSV5                              CAM_A_DMA_RSV5;                                  /* 0484, 0x1A004484 */
	CAM_A_REG_DMA_RSV6                              CAM_A_DMA_RSV6;                                  /* 0488, 0x1A004488 */
	CAM_A_REG_DMA_DEBUG_SEL                         CAM_A_DMA_DEBUG_SEL;                             /* 048C, 0x1A00448C */
	CAM_A_REG_DMA_BW_SELF_TEST                      CAM_A_DMA_BW_SELF_TEST;                          /* 0490, 0x1A004490 */
	UINT32                                          rsv_0494[27];                                    /* 0494..04FF, 0x1A004494..1A0044FF */
	CAM_A_REG_TG_SEN_MODE                           CAM_A_TG_SEN_MODE;                               /* 0500, 0x1A004500 */
	CAM_A_REG_TG_VF_CON                             CAM_A_TG_VF_CON;                                 /* 0504, 0x1A004504 */
	CAM_A_REG_TG_SEN_GRAB_PXL                       CAM_A_TG_SEN_GRAB_PXL;                           /* 0508, 0x1A004508 */
	CAM_A_REG_TG_SEN_GRAB_LIN                       CAM_A_TG_SEN_GRAB_LIN;                           /* 050C, 0x1A00450C */
	CAM_A_REG_TG_PATH_CFG                           CAM_A_TG_PATH_CFG;                               /* 0510, 0x1A004510 */
	CAM_A_REG_TG_MEMIN_CTL                          CAM_A_TG_MEMIN_CTL;                              /* 0514, 0x1A004514 */
	CAM_A_REG_TG_INT1                               CAM_A_TG_INT1;                                   /* 0518, 0x1A004518 */
	CAM_A_REG_TG_INT2                               CAM_A_TG_INT2;                                   /* 051C, 0x1A00451C */
	CAM_A_REG_TG_SOF_CNT                            CAM_A_TG_SOF_CNT;                                /* 0520, 0x1A004520 */
	CAM_A_REG_TG_SOT_CNT                            CAM_A_TG_SOT_CNT;                                /* 0524, 0x1A004524 */
	CAM_A_REG_TG_EOT_CNT                            CAM_A_TG_EOT_CNT;                                /* 0528, 0x1A004528 */
	CAM_A_REG_TG_ERR_CTL                            CAM_A_TG_ERR_CTL;                                /* 052C, 0x1A00452C */
	CAM_A_REG_TG_DAT_NO                             CAM_A_TG_DAT_NO;                                 /* 0530, 0x1A004530 */
	CAM_A_REG_TG_FRM_CNT_ST                         CAM_A_TG_FRM_CNT_ST;                             /* 0534, 0x1A004534 */
	CAM_A_REG_TG_FRMSIZE_ST                         CAM_A_TG_FRMSIZE_ST;                             /* 0538, 0x1A004538 */
	CAM_A_REG_TG_INTER_ST                           CAM_A_TG_INTER_ST;                               /* 053C, 0x1A00453C */
	CAM_A_REG_TG_FLASHA_CTL                         CAM_A_TG_FLASHA_CTL;                             /* 0540, 0x1A004540 */
	CAM_A_REG_TG_FLASHA_LINE_CNT                    CAM_A_TG_FLASHA_LINE_CNT;                        /* 0544, 0x1A004544 */
	CAM_A_REG_TG_FLASHA_POS                         CAM_A_TG_FLASHA_POS;                             /* 0548, 0x1A004548 */
	CAM_A_REG_TG_FLASHB_CTL                         CAM_A_TG_FLASHB_CTL;                             /* 054C, 0x1A00454C */
	CAM_A_REG_TG_FLASHB_LINE_CNT                    CAM_A_TG_FLASHB_LINE_CNT;                        /* 0550, 0x1A004550 */
	CAM_A_REG_TG_FLASHB_POS                         CAM_A_TG_FLASHB_POS;                             /* 0554, 0x1A004554 */
	CAM_A_REG_TG_FLASHB_POS1                        CAM_A_TG_FLASHB_POS1;                            /* 0558, 0x1A004558 */
	UINT32                                          rsv_055C;                                        /* 055C, 0x1A00455C */
	CAM_A_REG_TG_I2C_CQ_TRIG                        CAM_A_TG_I2C_CQ_TRIG;                            /* 0560, 0x1A004560 */
	CAM_A_REG_TG_CQ_TIMING                          CAM_A_TG_CQ_TIMING;                              /* 0564, 0x1A004564 */
	CAM_A_REG_TG_CQ_NUM                             CAM_A_TG_CQ_NUM;                                 /* 0568, 0x1A004568 */
	UINT32                                          rsv_056C;                                        /* 056C, 0x1A00456C */
	CAM_A_REG_TG_TIME_STAMP                         CAM_A_TG_TIME_STAMP;                             /* 0570, 0x1A004570 */
	CAM_A_REG_TG_SUB_PERIOD                         CAM_A_TG_SUB_PERIOD;                             /* 0574, 0x1A004574 */
	CAM_A_REG_TG_DAT_NO_R                           CAM_A_TG_DAT_NO_R;                               /* 0578, 0x1A004578 */
	CAM_A_REG_TG_FRMSIZE_ST_R                       CAM_A_TG_FRMSIZE_ST_R;                           /* 057C, 0x1A00457C */
	CAM_A_REG_DMX_CTL                               CAM_A_DMX_CTL;                                   /* 0580, 0x1A004580 */
	CAM_A_REG_DMX_CROP                              CAM_A_DMX_CROP;                                  /* 0584, 0x1A004584 */
	CAM_A_REG_DMX_VSIZE                             CAM_A_DMX_VSIZE;                                 /* 0588, 0x1A004588 */
	UINT32                                          rsv_058C[5];                                     /* 058C..059F, 0x1A00458C..1A00459F */
	CAM_A_REG_RMG_HDR_CFG                           CAM_A_RMG_HDR_CFG;                               /* 05A0, 0x1A0045A0 */
	CAM_A_REG_RMG_HDR_GAIN                          CAM_A_RMG_HDR_GAIN;                              /* 05A4, 0x1A0045A4 */
	CAM_A_REG_RMG_HDR_CFG2                          CAM_A_RMG_HDR_CFG2;                              /* 05A8, 0x1A0045A8 */
	UINT32                                          rsv_05AC[5];                                     /* 05AC..05BF, 0x1A0045AC..1A0045BF */
	CAM_A_REG_RMM_OSC                               CAM_A_RMM_OSC;                                   /* 05C0, 0x1A0045C0 */
	CAM_A_REG_RMM_MC                                CAM_A_RMM_MC;                                    /* 05C4, 0x1A0045C4 */
	CAM_A_REG_RMM_REVG_1                            CAM_A_RMM_REVG_1;                                /* 05C8, 0x1A0045C8 */
	CAM_A_REG_RMM_REVG_2                            CAM_A_RMM_REVG_2;                                /* 05CC, 0x1A0045CC */
	CAM_A_REG_RMM_LEOS                              CAM_A_RMM_LEOS;                                  /* 05D0, 0x1A0045D0 */
	CAM_A_REG_RMM_MC2                               CAM_A_RMM_MC2;                                   /* 05D4, 0x1A0045D4 */
	CAM_A_REG_RMM_DIFF_LB                           CAM_A_RMM_DIFF_LB;                               /* 05D8, 0x1A0045D8 */
	CAM_A_REG_RMM_MA                                CAM_A_RMM_MA;                                    /* 05DC, 0x1A0045DC */
	CAM_A_REG_RMM_TUNE                              CAM_A_RMM_TUNE;                                  /* 05E0, 0x1A0045E0 */
	UINT32                                          rsv_05E4[3];                                     /* 05E4..05EF, 0x1A0045E4..1A0045EF */
	CAM_A_REG_OBC_OFFST0                            CAM_A_OBC_OFFST0;                                /* 05F0, 0x1A0045F0 */
	CAM_A_REG_OBC_OFFST1                            CAM_A_OBC_OFFST1;                                /* 05F4, 0x1A0045F4 */
	CAM_A_REG_OBC_OFFST2                            CAM_A_OBC_OFFST2;                                /* 05F8, 0x1A0045F8 */
	CAM_A_REG_OBC_OFFST3                            CAM_A_OBC_OFFST3;                                /* 05FC, 0x1A0045FC */
	CAM_A_REG_OBC_GAIN0                             CAM_A_OBC_GAIN0;                                 /* 0600, 0x1A004600 */
	CAM_A_REG_OBC_GAIN1                             CAM_A_OBC_GAIN1;                                 /* 0604, 0x1A004604 */
	CAM_A_REG_OBC_GAIN2                             CAM_A_OBC_GAIN2;                                 /* 0608, 0x1A004608 */
	CAM_A_REG_OBC_GAIN3                             CAM_A_OBC_GAIN3;                                 /* 060C, 0x1A00460C */
	UINT32                                          rsv_0610[4];                                     /* 0610..061F, 0x1A004610..1A00461F */
	CAM_A_REG_BNR_BPC_CON                           CAM_A_BNR_BPC_CON;                               /* 0620, 0x1A004620 */
	CAM_A_REG_BNR_BPC_TH1                           CAM_A_BNR_BPC_TH1;                               /* 0624, 0x1A004624 */
	CAM_A_REG_BNR_BPC_TH2                           CAM_A_BNR_BPC_TH2;                               /* 0628, 0x1A004628 */
	CAM_A_REG_BNR_BPC_TH3                           CAM_A_BNR_BPC_TH3;                               /* 062C, 0x1A00462C */
	CAM_A_REG_BNR_BPC_TH4                           CAM_A_BNR_BPC_TH4;                               /* 0630, 0x1A004630 */
	CAM_A_REG_BNR_BPC_DTC                           CAM_A_BNR_BPC_DTC;                               /* 0634, 0x1A004634 */
	CAM_A_REG_BNR_BPC_COR                           CAM_A_BNR_BPC_COR;                               /* 0638, 0x1A004638 */
	CAM_A_REG_BNR_BPC_TBLI1                         CAM_A_BNR_BPC_TBLI1;                             /* 063C, 0x1A00463C */
	CAM_A_REG_BNR_BPC_TBLI2                         CAM_A_BNR_BPC_TBLI2;                             /* 0640, 0x1A004640 */
	CAM_A_REG_BNR_BPC_TH1_C                         CAM_A_BNR_BPC_TH1_C;                             /* 0644, 0x1A004644 */
	CAM_A_REG_BNR_BPC_TH2_C                         CAM_A_BNR_BPC_TH2_C;                             /* 0648, 0x1A004648 */
	CAM_A_REG_BNR_BPC_TH3_C                         CAM_A_BNR_BPC_TH3_C;                             /* 064C, 0x1A00464C */
	CAM_A_REG_BNR_NR1_CON                           CAM_A_BNR_NR1_CON;                               /* 0650, 0x1A004650 */
	CAM_A_REG_BNR_NR1_CT_CON                        CAM_A_BNR_NR1_CT_CON;                            /* 0654, 0x1A004654 */
	CAM_A_REG_BNR_RSV1                              CAM_A_BNR_RSV1;                                  /* 0658, 0x1A004658 */
	CAM_A_REG_BNR_RSV2                              CAM_A_BNR_RSV2;                                  /* 065C, 0x1A00465C */
	CAM_A_REG_BNR_PDC_CON                           CAM_A_BNR_PDC_CON;                               /* 0660, 0x1A004660 */
	CAM_A_REG_BNR_PDC_GAIN_L0                       CAM_A_BNR_PDC_GAIN_L0;                           /* 0664, 0x1A004664 */
	CAM_A_REG_BNR_PDC_GAIN_L1                       CAM_A_BNR_PDC_GAIN_L1;                           /* 0668, 0x1A004668 */
	CAM_A_REG_BNR_PDC_GAIN_L2                       CAM_A_BNR_PDC_GAIN_L2;                           /* 066C, 0x1A00466C */
	CAM_A_REG_BNR_PDC_GAIN_L3                       CAM_A_BNR_PDC_GAIN_L3;                           /* 0670, 0x1A004670 */
	CAM_A_REG_BNR_PDC_GAIN_L4                       CAM_A_BNR_PDC_GAIN_L4;                           /* 0674, 0x1A004674 */
	CAM_A_REG_BNR_PDC_GAIN_R0                       CAM_A_BNR_PDC_GAIN_R0;                           /* 0678, 0x1A004678 */
	CAM_A_REG_BNR_PDC_GAIN_R1                       CAM_A_BNR_PDC_GAIN_R1;                           /* 067C, 0x1A00467C */
	CAM_A_REG_BNR_PDC_GAIN_R2                       CAM_A_BNR_PDC_GAIN_R2;                           /* 0680, 0x1A004680 */
	CAM_A_REG_BNR_PDC_GAIN_R3                       CAM_A_BNR_PDC_GAIN_R3;                           /* 0684, 0x1A004684 */
	CAM_A_REG_BNR_PDC_GAIN_R4                       CAM_A_BNR_PDC_GAIN_R4;                           /* 0688, 0x1A004688 */
	CAM_A_REG_BNR_PDC_TH_GB                         CAM_A_BNR_PDC_TH_GB;                             /* 068C, 0x1A00468C */
	CAM_A_REG_BNR_PDC_TH_IA                         CAM_A_BNR_PDC_TH_IA;                             /* 0690, 0x1A004690 */
	CAM_A_REG_BNR_PDC_TH_HD                         CAM_A_BNR_PDC_TH_HD;                             /* 0694, 0x1A004694 */
	CAM_A_REG_BNR_PDC_SL                            CAM_A_BNR_PDC_SL;                                /* 0698, 0x1A004698 */
	CAM_A_REG_BNR_PDC_POS                           CAM_A_BNR_PDC_POS;                               /* 069C, 0x1A00469C */
	UINT32                                          rsv_06A0[4];                                     /* 06A0..06AF, 0x1A0046A0..1A0046AF */
	CAM_A_REG_SCM_CFG0                              CAM_A_SCM_CFG0;                                  /* 06B0, 0x1A0046B0 */
	CAM_A_REG_SCM_CFG1                              CAM_A_SCM_CFG1;                                  /* 06B4, 0x1A0046B4 */
	UINT32                                          rsv_06B8[2];                                     /* 06B8..06BF, 0x1A0046B8..1A0046BF */
	CAM_A_REG_RPG_SATU_1                            CAM_A_RPG_SATU_1;                                /* 06C0, 0x1A0046C0 */
	CAM_A_REG_RPG_SATU_2                            CAM_A_RPG_SATU_2;                                /* 06C4, 0x1A0046C4 */
	CAM_A_REG_RPG_GAIN_1                            CAM_A_RPG_GAIN_1;                                /* 06C8, 0x1A0046C8 */
	CAM_A_REG_RPG_GAIN_2                            CAM_A_RPG_GAIN_2;                                /* 06CC, 0x1A0046CC */
	CAM_A_REG_RPG_OFST_1                            CAM_A_RPG_OFST_1;                                /* 06D0, 0x1A0046D0 */
	CAM_A_REG_RPG_OFST_2                            CAM_A_RPG_OFST_2;                                /* 06D4, 0x1A0046D4 */
	UINT32                                          rsv_06D8[2];                                     /* 06D8..06DF, 0x1A0046D8..1A0046DF */
	CAM_A_REG_RRZ_CTL                               CAM_A_RRZ_CTL;                                   /* 06E0, 0x1A0046E0 */
	CAM_A_REG_RRZ_IN_IMG                            CAM_A_RRZ_IN_IMG;                                /* 06E4, 0x1A0046E4 */
	CAM_A_REG_RRZ_OUT_IMG                           CAM_A_RRZ_OUT_IMG;                               /* 06E8, 0x1A0046E8 */
	CAM_A_REG_RRZ_HORI_STEP                         CAM_A_RRZ_HORI_STEP;                             /* 06EC, 0x1A0046EC */
	CAM_A_REG_RRZ_VERT_STEP                         CAM_A_RRZ_VERT_STEP;                             /* 06F0, 0x1A0046F0 */
	CAM_A_REG_RRZ_HORI_INT_OFST                     CAM_A_RRZ_HORI_INT_OFST;                         /* 06F4, 0x1A0046F4 */
	CAM_A_REG_RRZ_HORI_SUB_OFST                     CAM_A_RRZ_HORI_SUB_OFST;                         /* 06F8, 0x1A0046F8 */
	CAM_A_REG_RRZ_VERT_INT_OFST                     CAM_A_RRZ_VERT_INT_OFST;                         /* 06FC, 0x1A0046FC */
	CAM_A_REG_RRZ_VERT_SUB_OFST                     CAM_A_RRZ_VERT_SUB_OFST;                         /* 0700, 0x1A004700 */
	CAM_A_REG_RRZ_MODE_TH                           CAM_A_RRZ_MODE_TH;                               /* 0704, 0x1A004704 */
	CAM_A_REG_RRZ_MODE_CTL                          CAM_A_RRZ_MODE_CTL;                              /* 0708, 0x1A004708 */
	UINT32                                          rsv_070C[13];                                    /* 070C..073F, 0x1A00470C..1A00473F */
	CAM_A_REG_RMX_CTL                               CAM_A_RMX_CTL;                                   /* 0740, 0x1A004740 */
	CAM_A_REG_RMX_CROP                              CAM_A_RMX_CROP;                                  /* 0744, 0x1A004744 */
	CAM_A_REG_RMX_VSIZE                             CAM_A_RMX_VSIZE;                                 /* 0748, 0x1A004748 */
	UINT32                                          rsv_074C[5];                                     /* 074C..075F, 0x1A00474C..1A00475F */
	CAM_A_REG_SGG5_PGN                              CAM_A_SGG5_PGN;                                  /* 0760, 0x1A004760 */
	CAM_A_REG_SGG5_GMRC_1                           CAM_A_SGG5_GMRC_1;                               /* 0764, 0x1A004764 */
	CAM_A_REG_SGG5_GMRC_2                           CAM_A_SGG5_GMRC_2;                               /* 0768, 0x1A004768 */
	UINT32                                          rsv_076C[5];                                     /* 076C..077F, 0x1A00476C..1A00477F */
	CAM_A_REG_BMX_CTL                               CAM_A_BMX_CTL;                                   /* 0780, 0x1A004780 */
	CAM_A_REG_BMX_CROP                              CAM_A_BMX_CROP;                                  /* 0784, 0x1A004784 */
	CAM_A_REG_BMX_VSIZE                             CAM_A_BMX_VSIZE;                                 /* 0788, 0x1A004788 */
	UINT32                                          rsv_078C[13];                                    /* 078C..07BF, 0x1A00478C..1A0047BF */
	CAM_A_REG_UFE_CON                               CAM_A_UFE_CON;                                   /* 07C0, 0x1A0047C0 */
	UINT32                                          rsv_07C4[3];                                     /* 07C4..07CF, 0x1A0047C4..1A0047CF */
	CAM_A_REG_LSC_CTL1                              CAM_A_LSC_CTL1;                                  /* 07D0, 0x1A0047D0 */
	CAM_A_REG_LSC_CTL2                              CAM_A_LSC_CTL2;                                  /* 07D4, 0x1A0047D4 */
	CAM_A_REG_LSC_CTL3                              CAM_A_LSC_CTL3;                                  /* 07D8, 0x1A0047D8 */
	CAM_A_REG_LSC_LBLOCK                            CAM_A_LSC_LBLOCK;                                /* 07DC, 0x1A0047DC */
	CAM_A_REG_LSC_RATIO_0                           CAM_A_LSC_RATIO_0;                               /* 07E0, 0x1A0047E0 */
	CAM_A_REG_LSC_TPIPE_OFST                        CAM_A_LSC_TPIPE_OFST;                            /* 07E4, 0x1A0047E4 */
	CAM_A_REG_LSC_TPIPE_SIZE                        CAM_A_LSC_TPIPE_SIZE;                            /* 07E8, 0x1A0047E8 */
	CAM_A_REG_LSC_GAIN_TH                           CAM_A_LSC_GAIN_TH;                               /* 07EC, 0x1A0047EC */
	CAM_A_REG_LSC_RATIO_1                           CAM_A_LSC_RATIO_1;                               /* 07F0, 0x1A0047F0 */
	UINT32                                          rsv_07F4[3];                                     /* 07F4..07FF, 0x1A0047F4..1A0047FF */
	CAM_A_REG_AF_CON                                CAM_A_AF_CON;                                    /* 0800, 0x1A004800 */
	CAM_A_REG_AF_TH_0                               CAM_A_AF_TH_0;                                   /* 0804, 0x1A004804 */
	CAM_A_REG_AF_TH_1                               CAM_A_AF_TH_1;                                   /* 0808, 0x1A004808 */
	CAM_A_REG_AF_FLT_1                              CAM_A_AF_FLT_1;                                  /* 080C, 0x1A00480C */
	CAM_A_REG_AF_FLT_2                              CAM_A_AF_FLT_2;                                  /* 0810, 0x1A004810 */
	CAM_A_REG_AF_FLT_3                              CAM_A_AF_FLT_3;                                  /* 0814, 0x1A004814 */
	CAM_A_REG_AF_FLT_4                              CAM_A_AF_FLT_4;                                  /* 0818, 0x1A004818 */
	CAM_A_REG_AF_FLT_5                              CAM_A_AF_FLT_5;                                  /* 081C, 0x1A00481C */
	CAM_A_REG_AF_FLT_6                              CAM_A_AF_FLT_6;                                  /* 0820, 0x1A004820 */
	CAM_A_REG_AF_FLT_7                              CAM_A_AF_FLT_7;                                  /* 0824, 0x1A004824 */
	CAM_A_REG_AF_FLT_8                              CAM_A_AF_FLT_8;                                  /* 0828, 0x1A004828 */
	UINT32                                          rsv_082C;                                        /* 082C, 0x1A00482C */
	CAM_A_REG_AF_SIZE                               CAM_A_AF_SIZE;                                   /* 0830, 0x1A004830 */
	CAM_A_REG_AF_VLD                                CAM_A_AF_VLD;                                    /* 0834, 0x1A004834 */
	CAM_A_REG_AF_BLK_0                              CAM_A_AF_BLK_0;                                  /* 0838, 0x1A004838 */
	CAM_A_REG_AF_BLK_1                              CAM_A_AF_BLK_1;                                  /* 083C, 0x1A00483C */
	CAM_A_REG_AF_TH_2                               CAM_A_AF_TH_2;                                   /* 0840, 0x1A004840 */
	UINT32                                          rsv_0844[15];                                    /* 0844..087F, 0x1A004844..1A00487F */
	CAM_A_REG_LCS25_CON                             CAM_A_LCS25_CON;                                 /* 0880, 0x1A004880 */
	CAM_A_REG_LCS25_ST                              CAM_A_LCS25_ST;                                  /* 0884, 0x1A004884 */
	CAM_A_REG_LCS25_AWS                             CAM_A_LCS25_AWS;                                 /* 0888, 0x1A004888 */
	CAM_A_REG_LCS25_FLR                             CAM_A_LCS25_FLR;                                 /* 088C, 0x1A00488C */
	CAM_A_REG_LCS25_LRZR_1                          CAM_A_LCS25_LRZR_1;                              /* 0890, 0x1A004890 */
	CAM_A_REG_LCS25_LRZR_2                          CAM_A_LCS25_LRZR_2;                              /* 0894, 0x1A004894 */
	CAM_A_REG_LCS25_SATU_1                          CAM_A_LCS25_SATU_1;                              /* 0898, 0x1A004898 */
	CAM_A_REG_LCS25_SATU_2                          CAM_A_LCS25_SATU_2;                              /* 089C, 0x1A00489C */
	CAM_A_REG_LCS25_GAIN_1                          CAM_A_LCS25_GAIN_1;                              /* 08A0, 0x1A0048A0 */
	CAM_A_REG_LCS25_GAIN_2                          CAM_A_LCS25_GAIN_2;                              /* 08A4, 0x1A0048A4 */
	CAM_A_REG_LCS25_OFST_1                          CAM_A_LCS25_OFST_1;                              /* 08A8, 0x1A0048A8 */
	CAM_A_REG_LCS25_OFST_2                          CAM_A_LCS25_OFST_2;                              /* 08AC, 0x1A0048AC */
	CAM_A_REG_LCS25_G2G_CNV_1                       CAM_A_LCS25_G2G_CNV_1;                           /* 08B0, 0x1A0048B0 */
	CAM_A_REG_LCS25_G2G_CNV_2                       CAM_A_LCS25_G2G_CNV_2;                           /* 08B4, 0x1A0048B4 */
	CAM_A_REG_LCS25_G2G_CNV_3                       CAM_A_LCS25_G2G_CNV_3;                           /* 08B8, 0x1A0048B8 */
	CAM_A_REG_LCS25_G2G_CNV_4                       CAM_A_LCS25_G2G_CNV_4;                           /* 08BC, 0x1A0048BC */
	CAM_A_REG_LCS25_G2G_CNV_5                       CAM_A_LCS25_G2G_CNV_5;                           /* 08C0, 0x1A0048C0 */
	CAM_A_REG_LCS25_LPF                             CAM_A_LCS25_LPF;                                 /* 08C4, 0x1A0048C4 */
	UINT32                                          rsv_08C8[10];                                    /* 08C8..08EF, 0x1A0048C8..1A0048EF */
	CAM_A_REG_RCP_CROP_CON1                         CAM_A_RCP_CROP_CON1;                             /* 08F0, 0x1A0048F0 */
	CAM_A_REG_RCP_CROP_CON2                         CAM_A_RCP_CROP_CON2;                             /* 08F4, 0x1A0048F4 */
	UINT32                                          rsv_08F8[2];                                     /* 08F8..08FF, 0x1A0048F8..1A0048FF */
	CAM_A_REG_SGG1_PGN                              CAM_A_SGG1_PGN;                                  /* 0900, 0x1A004900 */
	CAM_A_REG_SGG1_GMRC_1                           CAM_A_SGG1_GMRC_1;                               /* 0904, 0x1A004904 */
	CAM_A_REG_SGG1_GMRC_2                           CAM_A_SGG1_GMRC_2;                               /* 0908, 0x1A004908 */
	UINT32                                          rsv_090C;                                        /* 090C, 0x1A00490C */
	CAM_A_REG_QBN2_MODE                             CAM_A_QBN2_MODE;                                 /* 0910, 0x1A004910 */
	UINT32                                          rsv_0914[3];                                     /* 0914..091F, 0x1A004914..1A00491F */
	CAM_A_REG_AWB_WIN_ORG                           CAM_A_AWB_WIN_ORG;                               /* 0920, 0x1A004920 */
	CAM_A_REG_AWB_WIN_SIZE                          CAM_A_AWB_WIN_SIZE;                              /* 0924, 0x1A004924 */
	CAM_A_REG_AWB_WIN_PIT                           CAM_A_AWB_WIN_PIT;                               /* 0928, 0x1A004928 */
	CAM_A_REG_AWB_WIN_NUM                           CAM_A_AWB_WIN_NUM;                               /* 092C, 0x1A00492C */
	CAM_A_REG_AWB_GAIN1_0                           CAM_A_AWB_GAIN1_0;                               /* 0930, 0x1A004930 */
	CAM_A_REG_AWB_GAIN1_1                           CAM_A_AWB_GAIN1_1;                               /* 0934, 0x1A004934 */
	CAM_A_REG_AWB_LMT1_0                            CAM_A_AWB_LMT1_0;                                /* 0938, 0x1A004938 */
	CAM_A_REG_AWB_LMT1_1                            CAM_A_AWB_LMT1_1;                                /* 093C, 0x1A00493C */
	CAM_A_REG_AWB_LOW_THR                           CAM_A_AWB_LOW_THR;                               /* 0940, 0x1A004940 */
	CAM_A_REG_AWB_HI_THR                            CAM_A_AWB_HI_THR;                                /* 0944, 0x1A004944 */
	CAM_A_REG_AWB_PIXEL_CNT0                        CAM_A_AWB_PIXEL_CNT0;                            /* 0948, 0x1A004948 */
	CAM_A_REG_AWB_PIXEL_CNT1                        CAM_A_AWB_PIXEL_CNT1;                            /* 094C, 0x1A00494C */
	CAM_A_REG_AWB_PIXEL_CNT2                        CAM_A_AWB_PIXEL_CNT2;                            /* 0950, 0x1A004950 */
	CAM_A_REG_AWB_ERR_THR                           CAM_A_AWB_ERR_THR;                               /* 0954, 0x1A004954 */
	CAM_A_REG_AWB_ROT                               CAM_A_AWB_ROT;                                   /* 0958, 0x1A004958 */
	CAM_A_REG_AWB_L0_X                              CAM_A_AWB_L0_X;                                  /* 095C, 0x1A00495C */
	CAM_A_REG_AWB_L0_Y                              CAM_A_AWB_L0_Y;                                  /* 0960, 0x1A004960 */
	CAM_A_REG_AWB_L1_X                              CAM_A_AWB_L1_X;                                  /* 0964, 0x1A004964 */
	CAM_A_REG_AWB_L1_Y                              CAM_A_AWB_L1_Y;                                  /* 0968, 0x1A004968 */
	CAM_A_REG_AWB_L2_X                              CAM_A_AWB_L2_X;                                  /* 096C, 0x1A00496C */
	CAM_A_REG_AWB_L2_Y                              CAM_A_AWB_L2_Y;                                  /* 0970, 0x1A004970 */
	CAM_A_REG_AWB_L3_X                              CAM_A_AWB_L3_X;                                  /* 0974, 0x1A004974 */
	CAM_A_REG_AWB_L3_Y                              CAM_A_AWB_L3_Y;                                  /* 0978, 0x1A004978 */
	CAM_A_REG_AWB_L4_X                              CAM_A_AWB_L4_X;                                  /* 097C, 0x1A00497C */
	CAM_A_REG_AWB_L4_Y                              CAM_A_AWB_L4_Y;                                  /* 0980, 0x1A004980 */
	CAM_A_REG_AWB_L5_X                              CAM_A_AWB_L5_X;                                  /* 0984, 0x1A004984 */
	CAM_A_REG_AWB_L5_Y                              CAM_A_AWB_L5_Y;                                  /* 0988, 0x1A004988 */
	CAM_A_REG_AWB_L6_X                              CAM_A_AWB_L6_X;                                  /* 098C, 0x1A00498C */
	CAM_A_REG_AWB_L6_Y                              CAM_A_AWB_L6_Y;                                  /* 0990, 0x1A004990 */
	CAM_A_REG_AWB_L7_X                              CAM_A_AWB_L7_X;                                  /* 0994, 0x1A004994 */
	CAM_A_REG_AWB_L7_Y                              CAM_A_AWB_L7_Y;                                  /* 0998, 0x1A004998 */
	CAM_A_REG_AWB_L8_X                              CAM_A_AWB_L8_X;                                  /* 099C, 0x1A00499C */
	CAM_A_REG_AWB_L8_Y                              CAM_A_AWB_L8_Y;                                  /* 09A0, 0x1A0049A0 */
	CAM_A_REG_AWB_L9_X                              CAM_A_AWB_L9_X;                                  /* 09A4, 0x1A0049A4 */
	CAM_A_REG_AWB_L9_Y                              CAM_A_AWB_L9_Y;                                  /* 09A8, 0x1A0049A8 */
	CAM_A_REG_AWB_SPARE                             CAM_A_AWB_SPARE;                                 /* 09AC, 0x1A0049AC */
	CAM_A_REG_AWB_MOTION_THR                        CAM_A_AWB_MOTION_THR;                            /* 09B0, 0x1A0049B0 */
	CAM_A_REG_AWB_RC_CNV_0                          CAM_A_AWB_RC_CNV_0;                              /* 09B4, 0x1A0049B4 */
	CAM_A_REG_AWB_RC_CNV_1                          CAM_A_AWB_RC_CNV_1;                              /* 09B8, 0x1A0049B8 */
	CAM_A_REG_AWB_RC_CNV_2                          CAM_A_AWB_RC_CNV_2;                              /* 09BC, 0x1A0049BC */
	CAM_A_REG_AWB_RC_CNV_3                          CAM_A_AWB_RC_CNV_3;                              /* 09C0, 0x1A0049C0 */
	CAM_A_REG_AWB_RC_CNV_4                          CAM_A_AWB_RC_CNV_4;                              /* 09C4, 0x1A0049C4 */
	UINT32                                          rsv_09C8[6];                                     /* 09C8..09DF, 0x1A0049C8..1A0049DF */
	CAM_A_REG_AE_HST_CTL                            CAM_A_AE_HST_CTL;                                /* 09E0, 0x1A0049E0 */
	CAM_A_REG_AE_GAIN2_0                            CAM_A_AE_GAIN2_0;                                /* 09E4, 0x1A0049E4 */
	CAM_A_REG_AE_GAIN2_1                            CAM_A_AE_GAIN2_1;                                /* 09E8, 0x1A0049E8 */
	CAM_A_REG_AE_LMT2_0                             CAM_A_AE_LMT2_0;                                 /* 09EC, 0x1A0049EC */
	CAM_A_REG_AE_LMT2_1                             CAM_A_AE_LMT2_1;                                 /* 09F0, 0x1A0049F0 */
	CAM_A_REG_AE_RC_CNV_0                           CAM_A_AE_RC_CNV_0;                               /* 09F4, 0x1A0049F4 */
	CAM_A_REG_AE_RC_CNV_1                           CAM_A_AE_RC_CNV_1;                               /* 09F8, 0x1A0049F8 */
	CAM_A_REG_AE_RC_CNV_2                           CAM_A_AE_RC_CNV_2;                               /* 09FC, 0x1A0049FC */
	CAM_A_REG_AE_RC_CNV_3                           CAM_A_AE_RC_CNV_3;                               /* 0A00, 0x1A004A00 */
	CAM_A_REG_AE_RC_CNV_4                           CAM_A_AE_RC_CNV_4;                               /* 0A04, 0x1A004A04 */
	CAM_A_REG_AE_YGAMMA_0                           CAM_A_AE_YGAMMA_0;                               /* 0A08, 0x1A004A08 */
	CAM_A_REG_AE_YGAMMA_1                           CAM_A_AE_YGAMMA_1;                               /* 0A0C, 0x1A004A0C */
	CAM_A_REG_AE_HST_SET                            CAM_A_AE_HST_SET;                                /* 0A10, 0x1A004A10 */
	CAM_A_REG_AE_HST0_RNG                           CAM_A_AE_HST0_RNG;                               /* 0A14, 0x1A004A14 */
	CAM_A_REG_AE_HST1_RNG                           CAM_A_AE_HST1_RNG;                               /* 0A18, 0x1A004A18 */
	CAM_A_REG_AE_HST2_RNG                           CAM_A_AE_HST2_RNG;                               /* 0A1C, 0x1A004A1C */
	CAM_A_REG_AE_HST3_RNG                           CAM_A_AE_HST3_RNG;                               /* 0A20, 0x1A004A20 */
	CAM_A_REG_AE_SPARE                              CAM_A_AE_SPARE;                                  /* 0A24, 0x1A004A24 */
	CAM_A_REG_AE_OVER_EXPO_CFG                      CAM_A_AE_OVER_EXPO_CFG;                          /* 0A28, 0x1A004A28 */
	CAM_A_REG_AE_PIX_HST_CTL                        CAM_A_AE_PIX_HST_CTL;                            /* 0A2C, 0x1A004A2C */
	CAM_A_REG_AE_PIX_HST_SET                        CAM_A_AE_PIX_HST_SET;                            /* 0A30, 0x1A004A30 */
	CAM_A_REG_AE_PIX_HST0_YRNG                      CAM_A_AE_PIX_HST0_YRNG;                          /* 0A34, 0x1A004A34 */
	CAM_A_REG_AE_PIX_HST0_XRNG                      CAM_A_AE_PIX_HST0_XRNG;                          /* 0A38, 0x1A004A38 */
	CAM_A_REG_AE_PIX_HST1_YRNG                      CAM_A_AE_PIX_HST1_YRNG;                          /* 0A3C, 0x1A004A3C */
	CAM_A_REG_AE_PIX_HST1_XRNG                      CAM_A_AE_PIX_HST1_XRNG;                          /* 0A40, 0x1A004A40 */
	CAM_A_REG_AE_PIX_HST2_YRNG                      CAM_A_AE_PIX_HST2_YRNG;                          /* 0A44, 0x1A004A44 */
	CAM_A_REG_AE_PIX_HST2_XRNG                      CAM_A_AE_PIX_HST2_XRNG;                          /* 0A48, 0x1A004A48 */
	CAM_A_REG_AE_PIX_HST3_YRNG                      CAM_A_AE_PIX_HST3_YRNG;                          /* 0A4C, 0x1A004A4C */
	CAM_A_REG_AE_PIX_HST3_XRNG                      CAM_A_AE_PIX_HST3_XRNG;                          /* 0A50, 0x1A004A50 */
	CAM_A_REG_AE_HST_SEL                            CAM_A_AE_HST_SEL;                                /* 0A54, 0x1A004A54 */
	CAM_A_REG_AE_STAT_EN                            CAM_A_AE_STAT_EN;                                /* 0A58, 0x1A004A58 */
	CAM_A_REG_AE_YCOEF                              CAM_A_AE_YCOEF;                                  /* 0A5C, 0x1A004A5C */
	UINT32                                          rsv_0A60[24];                                    /* 0A60..0ABF, 0x1A004A60..1A004ABF */
	CAM_A_REG_QBN1_MODE                             CAM_A_QBN1_MODE;                                 /* 0AC0, 0x1A004AC0 */
	UINT32                                          rsv_0AC4[3];                                     /* 0AC4..0ACF, 0x1A004AC4..1A004ACF */
	CAM_A_REG_CPG_SATU_1                            CAM_A_CPG_SATU_1;                                /* 0AD0, 0x1A004AD0 */
	CAM_A_REG_CPG_SATU_2                            CAM_A_CPG_SATU_2;                                /* 0AD4, 0x1A004AD4 */
	CAM_A_REG_CPG_GAIN_1                            CAM_A_CPG_GAIN_1;                                /* 0AD8, 0x1A004AD8 */
	CAM_A_REG_CPG_GAIN_2                            CAM_A_CPG_GAIN_2;                                /* 0ADC, 0x1A004ADC */
	CAM_A_REG_CPG_OFST_1                            CAM_A_CPG_OFST_1;                                /* 0AE0, 0x1A004AE0 */
	CAM_A_REG_CPG_OFST_2                            CAM_A_CPG_OFST_2;                                /* 0AE4, 0x1A004AE4 */
	UINT32                                          rsv_0AE8[2];                                     /* 0AE8..0AEF, 0x1A004AE8..1A004AEF */
	CAM_A_REG_CAC_TILE_SIZE                         CAM_A_CAC_TILE_SIZE;                             /* 0AF0, 0x1A004AF0 */
	CAM_A_REG_CAC_TILE_OFFSET                       CAM_A_CAC_TILE_OFFSET;                           /* 0AF4, 0x1A004AF4 */
	UINT32                                          rsv_0AF8[2];                                     /* 0AF8..0AFF, 0x1A004AF8..1A004AFF */
	CAM_A_REG_PMX_CTL                               CAM_A_PMX_CTL;                                   /* 0B00, 0x1A004B00 */
	CAM_A_REG_PMX_CROP                              CAM_A_PMX_CROP;                                  /* 0B04, 0x1A004B04 */
	CAM_A_REG_PMX_VSIZE                             CAM_A_PMX_VSIZE;                                 /* 0B08, 0x1A004B08 */
	UINT32                                          rsv_0B0C[13];                                    /* 0B0C..0B3F, 0x1A004B0C..1A004B3F */
	CAM_A_REG_VBN_GAIN                              CAM_A_VBN_GAIN;                                  /* 0B40, 0x1A004B40 */
	CAM_A_REG_VBN_OFST                              CAM_A_VBN_OFST;                                  /* 0B44, 0x1A004B44 */
	CAM_A_REG_VBN_TYPE                              CAM_A_VBN_TYPE;                                  /* 0B48, 0x1A004B48 */
	CAM_A_REG_VBN_SPARE                             CAM_A_VBN_SPARE;                                 /* 0B4C, 0x1A004B4C */
	UINT32                                          rsv_0B50[4];                                     /* 0B50..0B5F, 0x1A004B50..1A004B5F */
	CAM_A_REG_AMX_CTL                               CAM_A_AMX_CTL;                                   /* 0B60, 0x1A004B60 */
	CAM_A_REG_AMX_CROP                              CAM_A_AMX_CROP;                                  /* 0B64, 0x1A004B64 */
	CAM_A_REG_AMX_VSIZE                             CAM_A_AMX_VSIZE;                                 /* 0B68, 0x1A004B68 */
	UINT32                                          rsv_0B6C[5];                                     /* 0B6C..0B7F, 0x1A004B6C..1A004B7F */
	CAM_A_REG_BIN_CTL                               CAM_A_BIN_CTL;                                   /* 0B80, 0x1A004B80 */
	CAM_A_REG_BIN_FTH                               CAM_A_BIN_FTH;                                   /* 0B84, 0x1A004B84 */
	CAM_A_REG_BIN_SPARE                             CAM_A_BIN_SPARE;                                 /* 0B88, 0x1A004B88 */
	UINT32                                          rsv_0B8C[5];                                     /* 0B8C..0B9F, 0x1A004B8C..1A004B9F */
	CAM_A_REG_DBN_GAIN                              CAM_A_DBN_GAIN;                                  /* 0BA0, 0x1A004BA0 */
	CAM_A_REG_DBN_OFST                              CAM_A_DBN_OFST;                                  /* 0BA4, 0x1A004BA4 */
	CAM_A_REG_DBN_SPARE                             CAM_A_DBN_SPARE;                                 /* 0BA8, 0x1A004BA8 */
	UINT32                                          rsv_0BAC;                                        /* 0BAC, 0x1A004BAC */
	CAM_A_REG_PBN_TYPE                              CAM_A_PBN_TYPE;                                  /* 0BB0, 0x1A004BB0 */
	CAM_A_REG_PBN_LST                               CAM_A_PBN_LST;                                   /* 0BB4, 0x1A004BB4 */
	CAM_A_REG_PBN_VSIZE                             CAM_A_PBN_VSIZE;                                 /* 0BB8, 0x1A004BB8 */
	UINT32                                          rsv_0BBC;                                        /* 0BBC, 0x1A004BBC */
	CAM_A_REG_RCP3_CROP_CON1                        CAM_A_RCP3_CROP_CON1;                            /* 0BC0, 0x1A004BC0 */
	CAM_A_REG_RCP3_CROP_CON2                        CAM_A_RCP3_CROP_CON2;                            /* 0BC4, 0x1A004BC4 */
	UINT32                                          rsv_0BC8[14];                                    /* 0BC8..0BFF, 0x1A004BC8..1A004BFF */
	CAM_A_REG_DBS_SIGMA                             CAM_A_DBS_SIGMA;                                 /* 0C00, 0x1A004C00 */
	CAM_A_REG_DBS_BSTBL_0                           CAM_A_DBS_BSTBL_0;                               /* 0C04, 0x1A004C04 */
	CAM_A_REG_DBS_BSTBL_1                           CAM_A_DBS_BSTBL_1;                               /* 0C08, 0x1A004C08 */
	CAM_A_REG_DBS_BSTBL_2                           CAM_A_DBS_BSTBL_2;                               /* 0C0C, 0x1A004C0C */
	CAM_A_REG_DBS_BSTBL_3                           CAM_A_DBS_BSTBL_3;                               /* 0C10, 0x1A004C10 */
	CAM_A_REG_DBS_CTL                               CAM_A_DBS_CTL;                                   /* 0C14, 0x1A004C14 */
	CAM_A_REG_DBS_CTL_2                             CAM_A_DBS_CTL_2;                                 /* 0C18, 0x1A004C18 */
	CAM_A_REG_DBS_SIGMA_2                           CAM_A_DBS_SIGMA_2;                               /* 0C1C, 0x1A004C1C */
	CAM_A_REG_DBS_YGN                               CAM_A_DBS_YGN;                                   /* 0C20, 0x1A004C20 */
	CAM_A_REG_DBS_SL_Y12                            CAM_A_DBS_SL_Y12;                                /* 0C24, 0x1A004C24 */
	CAM_A_REG_DBS_SL_Y34                            CAM_A_DBS_SL_Y34;                                /* 0C28, 0x1A004C28 */
	CAM_A_REG_DBS_SL_G12                            CAM_A_DBS_SL_G12;                                /* 0C2C, 0x1A004C2C */
	CAM_A_REG_DBS_SL_G34                            CAM_A_DBS_SL_G34;                                /* 0C30, 0x1A004C30 */
	UINT32                                          rsv_0C34[3];                                     /* 0C34..0C3F, 0x1A004C34..1A004C3F */
	CAM_A_REG_SL2F_CEN                              CAM_A_SL2F_CEN;                                  /* 0C40, 0x1A004C40 */
	CAM_A_REG_SL2F_RR_CON0                          CAM_A_SL2F_RR_CON0;                              /* 0C44, 0x1A004C44 */
	CAM_A_REG_SL2F_RR_CON1                          CAM_A_SL2F_RR_CON1;                              /* 0C48, 0x1A004C48 */
	CAM_A_REG_SL2F_GAIN                             CAM_A_SL2F_GAIN;                                 /* 0C4C, 0x1A004C4C */
	CAM_A_REG_SL2F_RZ                               CAM_A_SL2F_RZ;                                   /* 0C50, 0x1A004C50 */
	CAM_A_REG_SL2F_XOFF                             CAM_A_SL2F_XOFF;                                 /* 0C54, 0x1A004C54 */
	CAM_A_REG_SL2F_YOFF                             CAM_A_SL2F_YOFF;                                 /* 0C58, 0x1A004C58 */
	CAM_A_REG_SL2F_SLP_CON0                         CAM_A_SL2F_SLP_CON0;                             /* 0C5C, 0x1A004C5C */
	CAM_A_REG_SL2F_SLP_CON1                         CAM_A_SL2F_SLP_CON1;                             /* 0C60, 0x1A004C60 */
	CAM_A_REG_SL2F_SIZE                             CAM_A_SL2F_SIZE;                                 /* 0C64, 0x1A004C64 */
	UINT32                                          rsv_0C68[38];                                    /* 0C68..0CFF, 0x1A004C68..1A004CFF */
	CAM_A_REG_QBN4_MODE                             CAM_A_QBN4_MODE;                                 /* 0D00, 0x1A004D00 */
	UINT32                                          rsv_0D04[3];                                     /* 0D04..0D0F, 0x1A004D04..1A004D0F */
	CAM_A_REG_PS_AWB_WIN_ORG                        CAM_A_PS_AWB_WIN_ORG;                            /* 0D10, 0x1A004D10 */
	CAM_A_REG_PS_AWB_WIN_SIZE                       CAM_A_PS_AWB_WIN_SIZE;                           /* 0D14, 0x1A004D14 */
	CAM_A_REG_PS_AWB_WIN_PIT                        CAM_A_PS_AWB_WIN_PIT;                            /* 0D18, 0x1A004D18 */
	CAM_A_REG_PS_AWB_WIN_NUM                        CAM_A_PS_AWB_WIN_NUM;                            /* 0D1C, 0x1A004D1C */
	CAM_A_REG_PS_AWB_PIXEL_CNT0                     CAM_A_PS_AWB_PIXEL_CNT0;                         /* 0D20, 0x1A004D20 */
	CAM_A_REG_PS_AWB_PIXEL_CNT1                     CAM_A_PS_AWB_PIXEL_CNT1;                         /* 0D24, 0x1A004D24 */
	CAM_A_REG_PS_AWB_PIXEL_CNT2                     CAM_A_PS_AWB_PIXEL_CNT2;                         /* 0D28, 0x1A004D28 */
	CAM_A_REG_PS_AWB_PIXEL_CNT3                     CAM_A_PS_AWB_PIXEL_CNT3;                         /* 0D2C, 0x1A004D2C */
	CAM_A_REG_PS_AE_YCOEF0                          CAM_A_PS_AE_YCOEF0;                              /* 0D30, 0x1A004D30 */
	CAM_A_REG_PS_AE_YCOEF1                          CAM_A_PS_AE_YCOEF1;                              /* 0D34, 0x1A004D34 */
	UINT32                                          rsv_0D38[18];                                    /* 0D38..0D7F, 0x1A004D38..1A004D7F */
	CAM_A_REG_PSO_BASE_ADDR                         CAM_A_PSO_BASE_ADDR;                             /* 0D80, 0x1A004D80 */
	UINT32                                          rsv_0D84;                                        /* 0D84, 0x1A004D84 */
	CAM_A_REG_PSO_OFST_ADDR                         CAM_A_PSO_OFST_ADDR;                             /* 0D88, 0x1A004D88 */
	UINT32                                          rsv_0D8C;                                        /* 0D8C, 0x1A004D8C */
	CAM_A_REG_PSO_XSIZE                             CAM_A_PSO_XSIZE;                                 /* 0D90, 0x1A004D90 */
	CAM_A_REG_PSO_YSIZE                             CAM_A_PSO_YSIZE;                                 /* 0D94, 0x1A004D94 */
	CAM_A_REG_PSO_STRIDE                            CAM_A_PSO_STRIDE;                                /* 0D98, 0x1A004D98 */
	CAM_A_REG_PSO_CON                               CAM_A_PSO_CON;                                   /* 0D9C, 0x1A004D9C */
	CAM_A_REG_PSO_CON2                              CAM_A_PSO_CON2;                                  /* 0DA0, 0x1A004DA0 */
	CAM_A_REG_PSO_CON3                              CAM_A_PSO_CON3;                                  /* 0DA4, 0x1A004DA4 */
	CAM_A_REG_PSO_ERR_STAT                          CAM_A_PSO_ERR_STAT;                              /* 0DA8, 0x1A004DA8 */
	UINT32                                          rsv_0DAC;                                        /* 0DAC, 0x1A004DAC */
	CAM_A_REG_PSO_FH_SPARE_2                        CAM_A_PSO_FH_SPARE_2;                            /* 0DB0, 0x1A004DB0 */
	CAM_A_REG_PSO_FH_SPARE_3                        CAM_A_PSO_FH_SPARE_3;                            /* 0DB4, 0x1A004DB4 */
	CAM_A_REG_PSO_FH_SPARE_4                        CAM_A_PSO_FH_SPARE_4;                            /* 0DB8, 0x1A004DB8 */
	CAM_A_REG_PSO_FH_SPARE_5                        CAM_A_PSO_FH_SPARE_5;                            /* 0DBC, 0x1A004DBC */
	CAM_A_REG_PSO_FH_SPARE_6                        CAM_A_PSO_FH_SPARE_6;                            /* 0DC0, 0x1A004DC0 */
	CAM_A_REG_PSO_FH_SPARE_7                        CAM_A_PSO_FH_SPARE_7;                            /* 0DC4, 0x1A004DC4 */
	CAM_A_REG_PSO_FH_SPARE_8                        CAM_A_PSO_FH_SPARE_8;                            /* 0DC8, 0x1A004DC8 */
	CAM_A_REG_PSO_FH_SPARE_9                        CAM_A_PSO_FH_SPARE_9;                            /* 0DCC, 0x1A004DCC */
	CAM_A_REG_PSO_FH_SPARE_10                       CAM_A_PSO_FH_SPARE_10;                           /* 0DD0, 0x1A004DD0 */
	CAM_A_REG_PSO_FH_SPARE_11                       CAM_A_PSO_FH_SPARE_11;                           /* 0DD4, 0x1A004DD4 */
	CAM_A_REG_PSO_FH_SPARE_12                       CAM_A_PSO_FH_SPARE_12;                           /* 0DD8, 0x1A004DD8 */
	CAM_A_REG_PSO_FH_SPARE_13                       CAM_A_PSO_FH_SPARE_13;                           /* 0DDC, 0x1A004DDC */
	CAM_A_REG_PSO_FH_SPARE_14                       CAM_A_PSO_FH_SPARE_14;                           /* 0DE0, 0x1A004DE0 */
	CAM_A_REG_PSO_FH_SPARE_15                       CAM_A_PSO_FH_SPARE_15;                           /* 0DE4, 0x1A004DE4 */
	CAM_A_REG_PSO_FH_SPARE_16                       CAM_A_PSO_FH_SPARE_16;                           /* 0DE8, 0x1A004DE8 */
	UINT32                                          rsv_0DEC[5];                                     /* 0DEC..0DFF, 0x1A004DEC..1A004DFF */
	CAM_A_REG_DMA_FRAME_HEADER_EN                   CAM_A_DMA_FRAME_HEADER_EN;                       /* 0E00, 0x1A004E00 */
	CAM_A_REG_IMGO_FH_BASE_ADDR                     CAM_A_IMGO_FH_BASE_ADDR;                         /* 0E04, 0x1A004E04 */
	CAM_A_REG_RRZO_FH_BASE_ADDR                     CAM_A_RRZO_FH_BASE_ADDR;                         /* 0E08, 0x1A004E08 */
	CAM_A_REG_AAO_FH_BASE_ADDR                      CAM_A_AAO_FH_BASE_ADDR;                          /* 0E0C, 0x1A004E0C */
	CAM_A_REG_AFO_FH_BASE_ADDR                      CAM_A_AFO_FH_BASE_ADDR;                          /* 0E10, 0x1A004E10 */
	CAM_A_REG_LCSO_FH_BASE_ADDR                     CAM_A_LCSO_FH_BASE_ADDR;                         /* 0E14, 0x1A004E14 */
	CAM_A_REG_UFEO_FH_BASE_ADDR                     CAM_A_UFEO_FH_BASE_ADDR;                         /* 0E18, 0x1A004E18 */
	CAM_A_REG_PDO_FH_BASE_ADDR                      CAM_A_PDO_FH_BASE_ADDR;                          /* 0E1C, 0x1A004E1C */
	CAM_A_REG_PSO_FH_BASE_ADDR                      CAM_A_PSO_FH_BASE_ADDR;                          /* 0E20, 0x1A004E20 */
	UINT32                                          rsv_0E24[3];                                     /* 0E24..0E2F, 0x1A004E24..1A004E2F */
	CAM_A_REG_IMGO_FH_SPARE_2                       CAM_A_IMGO_FH_SPARE_2;                           /* 0E30, 0x1A004E30 */
	CAM_A_REG_IMGO_FH_SPARE_3                       CAM_A_IMGO_FH_SPARE_3;                           /* 0E34, 0x1A004E34 */
	CAM_A_REG_IMGO_FH_SPARE_4                       CAM_A_IMGO_FH_SPARE_4;                           /* 0E38, 0x1A004E38 */
	CAM_A_REG_IMGO_FH_SPARE_5                       CAM_A_IMGO_FH_SPARE_5;                           /* 0E3C, 0x1A004E3C */
	CAM_A_REG_IMGO_FH_SPARE_6                       CAM_A_IMGO_FH_SPARE_6;                           /* 0E40, 0x1A004E40 */
	CAM_A_REG_IMGO_FH_SPARE_7                       CAM_A_IMGO_FH_SPARE_7;                           /* 0E44, 0x1A004E44 */
	CAM_A_REG_IMGO_FH_SPARE_8                       CAM_A_IMGO_FH_SPARE_8;                           /* 0E48, 0x1A004E48 */
	CAM_A_REG_IMGO_FH_SPARE_9                       CAM_A_IMGO_FH_SPARE_9;                           /* 0E4C, 0x1A004E4C */
	CAM_A_REG_IMGO_FH_SPARE_10                      CAM_A_IMGO_FH_SPARE_10;                          /* 0E50, 0x1A004E50 */
	CAM_A_REG_IMGO_FH_SPARE_11                      CAM_A_IMGO_FH_SPARE_11;                          /* 0E54, 0x1A004E54 */
	CAM_A_REG_IMGO_FH_SPARE_12                      CAM_A_IMGO_FH_SPARE_12;                          /* 0E58, 0x1A004E58 */
	CAM_A_REG_IMGO_FH_SPARE_13                      CAM_A_IMGO_FH_SPARE_13;                          /* 0E5C, 0x1A004E5C */
	CAM_A_REG_IMGO_FH_SPARE_14                      CAM_A_IMGO_FH_SPARE_14;                          /* 0E60, 0x1A004E60 */
	CAM_A_REG_IMGO_FH_SPARE_15                      CAM_A_IMGO_FH_SPARE_15;                          /* 0E64, 0x1A004E64 */
	CAM_A_REG_IMGO_FH_SPARE_16                      CAM_A_IMGO_FH_SPARE_16;                          /* 0E68, 0x1A004E68 */
	UINT32                                          rsv_0E6C;                                        /* 0E6C, 0x1A004E6C */
	CAM_A_REG_RRZO_FH_SPARE_2                       CAM_A_RRZO_FH_SPARE_2;                           /* 0E70, 0x1A004E70 */
	CAM_A_REG_RRZO_FH_SPARE_3                       CAM_A_RRZO_FH_SPARE_3;                           /* 0E74, 0x1A004E74 */
	CAM_A_REG_RRZO_FH_SPARE_4                       CAM_A_RRZO_FH_SPARE_4;                           /* 0E78, 0x1A004E78 */
	CAM_A_REG_RRZO_FH_SPARE_5                       CAM_A_RRZO_FH_SPARE_5;                           /* 0E7C, 0x1A004E7C */
	CAM_A_REG_RRZO_FH_SPARE_6                       CAM_A_RRZO_FH_SPARE_6;                           /* 0E80, 0x1A004E80 */
	CAM_A_REG_RRZO_FH_SPARE_7                       CAM_A_RRZO_FH_SPARE_7;                           /* 0E84, 0x1A004E84 */
	CAM_A_REG_RRZO_FH_SPARE_8                       CAM_A_RRZO_FH_SPARE_8;                           /* 0E88, 0x1A004E88 */
	CAM_A_REG_RRZO_FH_SPARE_9                       CAM_A_RRZO_FH_SPARE_9;                           /* 0E8C, 0x1A004E8C */
	CAM_A_REG_RRZO_FH_SPARE_10                      CAM_A_RRZO_FH_SPARE_10;                          /* 0E90, 0x1A004E90 */
	CAM_A_REG_RRZO_FH_SPARE_11                      CAM_A_RRZO_FH_SPARE_11;                          /* 0E94, 0x1A004E94 */
	CAM_A_REG_RRZO_FH_SPARE_12                      CAM_A_RRZO_FH_SPARE_12;                          /* 0E98, 0x1A004E98 */
	CAM_A_REG_RRZO_FH_SPARE_13                      CAM_A_RRZO_FH_SPARE_13;                          /* 0E9C, 0x1A004E9C */
	CAM_A_REG_RRZO_FH_SPARE_14                      CAM_A_RRZO_FH_SPARE_14;                          /* 0EA0, 0x1A004EA0 */
	CAM_A_REG_RRZO_FH_SPARE_15                      CAM_A_RRZO_FH_SPARE_15;                          /* 0EA4, 0x1A004EA4 */
	CAM_A_REG_RRZO_FH_SPARE_16                      CAM_A_RRZO_FH_SPARE_16;                          /* 0EA8, 0x1A004EA8 */
	UINT32                                          rsv_0EAC;                                        /* 0EAC, 0x1A004EAC */
	CAM_A_REG_AAO_FH_SPARE_2                        CAM_A_AAO_FH_SPARE_2;                            /* 0EB0, 0x1A004EB0 */
	CAM_A_REG_AAO_FH_SPARE_3                        CAM_A_AAO_FH_SPARE_3;                            /* 0EB4, 0x1A004EB4 */
	CAM_A_REG_AAO_FH_SPARE_4                        CAM_A_AAO_FH_SPARE_4;                            /* 0EB8, 0x1A004EB8 */
	CAM_A_REG_AAO_FH_SPARE_5                        CAM_A_AAO_FH_SPARE_5;                            /* 0EBC, 0x1A004EBC */
	CAM_A_REG_AAO_FH_SPARE_6                        CAM_A_AAO_FH_SPARE_6;                            /* 0EC0, 0x1A004EC0 */
	CAM_A_REG_AAO_FH_SPARE_7                        CAM_A_AAO_FH_SPARE_7;                            /* 0EC4, 0x1A004EC4 */
	CAM_A_REG_AAO_FH_SPARE_8                        CAM_A_AAO_FH_SPARE_8;                            /* 0EC8, 0x1A004EC8 */
	CAM_A_REG_AAO_FH_SPARE_9                        CAM_A_AAO_FH_SPARE_9;                            /* 0ECC, 0x1A004ECC */
	CAM_A_REG_AAO_FH_SPARE_10                       CAM_A_AAO_FH_SPARE_10;                           /* 0ED0, 0x1A004ED0 */
	CAM_A_REG_AAO_FH_SPARE_11                       CAM_A_AAO_FH_SPARE_11;                           /* 0ED4, 0x1A004ED4 */
	CAM_A_REG_AAO_FH_SPARE_12                       CAM_A_AAO_FH_SPARE_12;                           /* 0ED8, 0x1A004ED8 */
	CAM_A_REG_AAO_FH_SPARE_13                       CAM_A_AAO_FH_SPARE_13;                           /* 0EDC, 0x1A004EDC */
	CAM_A_REG_AAO_FH_SPARE_14                       CAM_A_AAO_FH_SPARE_14;                           /* 0EE0, 0x1A004EE0 */
	CAM_A_REG_AAO_FH_SPARE_15                       CAM_A_AAO_FH_SPARE_15;                           /* 0EE4, 0x1A004EE4 */
	CAM_A_REG_AAO_FH_SPARE_16                       CAM_A_AAO_FH_SPARE_16;                           /* 0EE8, 0x1A004EE8 */
	UINT32                                          rsv_0EEC;                                        /* 0EEC, 0x1A004EEC */
	CAM_A_REG_AFO_FH_SPARE_2                        CAM_A_AFO_FH_SPARE_2;                            /* 0EF0, 0x1A004EF0 */
	CAM_A_REG_AFO_FH_SPARE_3                        CAM_A_AFO_FH_SPARE_3;                            /* 0EF4, 0x1A004EF4 */
	CAM_A_REG_AFO_FH_SPARE_4                        CAM_A_AFO_FH_SPARE_4;                            /* 0EF8, 0x1A004EF8 */
	CAM_A_REG_AFO_FH_SPARE_5                        CAM_A_AFO_FH_SPARE_5;                            /* 0EFC, 0x1A004EFC */
	CAM_A_REG_AFO_FH_SPARE_6                        CAM_A_AFO_FH_SPARE_6;                            /* 0F00, 0x1A004F00 */
	CAM_A_REG_AFO_FH_SPARE_7                        CAM_A_AFO_FH_SPARE_7;                            /* 0F04, 0x1A004F04 */
	CAM_A_REG_AFO_FH_SPARE_8                        CAM_A_AFO_FH_SPARE_8;                            /* 0F08, 0x1A004F08 */
	CAM_A_REG_AFO_FH_SPARE_9                        CAM_A_AFO_FH_SPARE_9;                            /* 0F0C, 0x1A004F0C */
	CAM_A_REG_AFO_FH_SPARE_10                       CAM_A_AFO_FH_SPARE_10;                           /* 0F10, 0x1A004F10 */
	CAM_A_REG_AFO_FH_SPARE_11                       CAM_A_AFO_FH_SPARE_11;                           /* 0F14, 0x1A004F14 */
	CAM_A_REG_AFO_FH_SPARE_12                       CAM_A_AFO_FH_SPARE_12;                           /* 0F18, 0x1A004F18 */
	CAM_A_REG_AFO_FH_SPARE_13                       CAM_A_AFO_FH_SPARE_13;                           /* 0F1C, 0x1A004F1C */
	CAM_A_REG_AFO_FH_SPARE_14                       CAM_A_AFO_FH_SPARE_14;                           /* 0F20, 0x1A004F20 */
	CAM_A_REG_AFO_FH_SPARE_15                       CAM_A_AFO_FH_SPARE_15;                           /* 0F24, 0x1A004F24 */
	CAM_A_REG_AFO_FH_SPARE_16                       CAM_A_AFO_FH_SPARE_16;                           /* 0F28, 0x1A004F28 */
	UINT32                                          rsv_0F2C;                                        /* 0F2C, 0x1A004F2C */
	CAM_A_REG_LCSO_FH_SPARE_2                       CAM_A_LCSO_FH_SPARE_2;                           /* 0F30, 0x1A004F30 */
	CAM_A_REG_LCSO_FH_SPARE_3                       CAM_A_LCSO_FH_SPARE_3;                           /* 0F34, 0x1A004F34 */
	CAM_A_REG_LCSO_FH_SPARE_4                       CAM_A_LCSO_FH_SPARE_4;                           /* 0F38, 0x1A004F38 */
	CAM_A_REG_LCSO_FH_SPARE_5                       CAM_A_LCSO_FH_SPARE_5;                           /* 0F3C, 0x1A004F3C */
	CAM_A_REG_LCSO_FH_SPARE_6                       CAM_A_LCSO_FH_SPARE_6;                           /* 0F40, 0x1A004F40 */
	CAM_A_REG_LCSO_FH_SPARE_7                       CAM_A_LCSO_FH_SPARE_7;                           /* 0F44, 0x1A004F44 */
	CAM_A_REG_LCSO_FH_SPARE_8                       CAM_A_LCSO_FH_SPARE_8;                           /* 0F48, 0x1A004F48 */
	CAM_A_REG_LCSO_FH_SPARE_9                       CAM_A_LCSO_FH_SPARE_9;                           /* 0F4C, 0x1A004F4C */
	CAM_A_REG_LCSO_FH_SPARE_10                      CAM_A_LCSO_FH_SPARE_10;                          /* 0F50, 0x1A004F50 */
	CAM_A_REG_LCSO_FH_SPARE_11                      CAM_A_LCSO_FH_SPARE_11;                          /* 0F54, 0x1A004F54 */
	CAM_A_REG_LCSO_FH_SPARE_12                      CAM_A_LCSO_FH_SPARE_12;                          /* 0F58, 0x1A004F58 */
	CAM_A_REG_LCSO_FH_SPARE_13                      CAM_A_LCSO_FH_SPARE_13;                          /* 0F5C, 0x1A004F5C */
	CAM_A_REG_LCSO_FH_SPARE_14                      CAM_A_LCSO_FH_SPARE_14;                          /* 0F60, 0x1A004F60 */
	CAM_A_REG_LCSO_FH_SPARE_15                      CAM_A_LCSO_FH_SPARE_15;                          /* 0F64, 0x1A004F64 */
	CAM_A_REG_LCSO_FH_SPARE_16                      CAM_A_LCSO_FH_SPARE_16;                          /* 0F68, 0x1A004F68 */
	UINT32                                          rsv_0F6C;                                        /* 0F6C, 0x1A004F6C */
	CAM_A_REG_UFEO_FH_SPARE_2                       CAM_A_UFEO_FH_SPARE_2;                           /* 0F70, 0x1A004F70 */
	CAM_A_REG_UFEO_FH_SPARE_3                       CAM_A_UFEO_FH_SPARE_3;                           /* 0F74, 0x1A004F74 */
	CAM_A_REG_UFEO_FH_SPARE_4                       CAM_A_UFEO_FH_SPARE_4;                           /* 0F78, 0x1A004F78 */
	CAM_A_REG_UFEO_FH_SPARE_5                       CAM_A_UFEO_FH_SPARE_5;                           /* 0F7C, 0x1A004F7C */
	CAM_A_REG_UFEO_FH_SPARE_6                       CAM_A_UFEO_FH_SPARE_6;                           /* 0F80, 0x1A004F80 */
	CAM_A_REG_UFEO_FH_SPARE_7                       CAM_A_UFEO_FH_SPARE_7;                           /* 0F84, 0x1A004F84 */
	CAM_A_REG_UFEO_FH_SPARE_8                       CAM_A_UFEO_FH_SPARE_8;                           /* 0F88, 0x1A004F88 */
	CAM_A_REG_UFEO_FH_SPARE_9                       CAM_A_UFEO_FH_SPARE_9;                           /* 0F8C, 0x1A004F8C */
	CAM_A_REG_UFEO_FH_SPARE_10                      CAM_A_UFEO_FH_SPARE_10;                          /* 0F90, 0x1A004F90 */
	CAM_A_REG_UFEO_FH_SPARE_11                      CAM_A_UFEO_FH_SPARE_11;                          /* 0F94, 0x1A004F94 */
	CAM_A_REG_UFEO_FH_SPARE_12                      CAM_A_UFEO_FH_SPARE_12;                          /* 0F98, 0x1A004F98 */
	CAM_A_REG_UFEO_FH_SPARE_13                      CAM_A_UFEO_FH_SPARE_13;                          /* 0F9C, 0x1A004F9C */
	CAM_A_REG_UFEO_FH_SPARE_14                      CAM_A_UFEO_FH_SPARE_14;                          /* 0FA0, 0x1A004FA0 */
	CAM_A_REG_UFEO_FH_SPARE_15                      CAM_A_UFEO_FH_SPARE_15;                          /* 0FA4, 0x1A004FA4 */
	CAM_A_REG_UFEO_FH_SPARE_16                      CAM_A_UFEO_FH_SPARE_16;                          /* 0FA8, 0x1A004FA8 */
	UINT32                                          rsv_0FAC;                                        /* 0FAC, 0x1A004FAC */
	CAM_A_REG_PDO_FH_SPARE_2                        CAM_A_PDO_FH_SPARE_2;                            /* 0FB0, 0x1A004FB0 */
	CAM_A_REG_PDO_FH_SPARE_3                        CAM_A_PDO_FH_SPARE_3;                            /* 0FB4, 0x1A004FB4 */
	CAM_A_REG_PDO_FH_SPARE_4                        CAM_A_PDO_FH_SPARE_4;                            /* 0FB8, 0x1A004FB8 */
	CAM_A_REG_PDO_FH_SPARE_5                        CAM_A_PDO_FH_SPARE_5;                            /* 0FBC, 0x1A004FBC */
	CAM_A_REG_PDO_FH_SPARE_6                        CAM_A_PDO_FH_SPARE_6;                            /* 0FC0, 0x1A004FC0 */
	CAM_A_REG_PDO_FH_SPARE_7                        CAM_A_PDO_FH_SPARE_7;                            /* 0FC4, 0x1A004FC4 */
	CAM_A_REG_PDO_FH_SPARE_8                        CAM_A_PDO_FH_SPARE_8;                            /* 0FC8, 0x1A004FC8 */
	CAM_A_REG_PDO_FH_SPARE_9                        CAM_A_PDO_FH_SPARE_9;                            /* 0FCC, 0x1A004FCC */
	CAM_A_REG_PDO_FH_SPARE_10                       CAM_A_PDO_FH_SPARE_10;                           /* 0FD0, 0x1A004FD0 */
	CAM_A_REG_PDO_FH_SPARE_11                       CAM_A_PDO_FH_SPARE_11;                           /* 0FD4, 0x1A004FD4 */
	CAM_A_REG_PDO_FH_SPARE_12                       CAM_A_PDO_FH_SPARE_12;                           /* 0FD8, 0x1A004FD8 */
	CAM_A_REG_PDO_FH_SPARE_13                       CAM_A_PDO_FH_SPARE_13;                           /* 0FDC, 0x1A004FDC */
	CAM_A_REG_PDO_FH_SPARE_14                       CAM_A_PDO_FH_SPARE_14;                           /* 0FE0, 0x1A004FE0 */
	CAM_A_REG_PDO_FH_SPARE_15                       CAM_A_PDO_FH_SPARE_15;                           /* 0FE4, 0x1A004FE4 */
	CAM_A_REG_PDO_FH_SPARE_16                       CAM_A_PDO_FH_SPARE_16;                           /* 0FE8, 0x1A004FE8 */
	UINT32                                          rsv_0FEC[5];                                     /* 0FEC..0FFF, 1A004FEC..1A004FFF */
}cam_a_reg_t;

typedef struct _cam_b_reg_t_	/* 0x1A005000..0x1A005FFF */
{
	CAM_B_REG_CTL_START                             CAM_B_CTL_START;                                 /* 0000, 0x1A005000 */
	CAM_B_REG_CTL_EN                                CAM_B_CTL_EN;                                    /* 0004, 0x1A005004 */
	CAM_B_REG_CTL_DMA_EN                            CAM_B_CTL_DMA_EN;                                /* 0008, 0x1A005008 */
	CAM_B_REG_CTL_FMT_SEL                           CAM_B_CTL_FMT_SEL;                               /* 000C, 0x1A00500C */
	CAM_B_REG_CTL_SEL                               CAM_B_CTL_SEL;                                   /* 0010, 0x1A005010 */
	CAM_B_REG_CTL_MISC                              CAM_B_CTL_MISC;                                  /* 0014, 0x1A005014 */
	UINT32                                          rsv_0018[2];                                     /* 0018..001F, 0x1A005018..1A00501F */
	CAM_B_REG_CTL_RAW_INT_EN                        CAM_B_CTL_RAW_INT_EN;                            /* 0020, 0x1A005020 */
	CAM_B_REG_CTL_RAW_INT_STATUS                    CAM_B_CTL_RAW_INT_STATUS;                        /* 0024, 0x1A005024 */
	CAM_B_REG_CTL_RAW_INT_STATUSX                   CAM_B_CTL_RAW_INT_STATUSX;                       /* 0028, 0x1A005028 */
	UINT32                                          rsv_002C;                                        /* 002C, 0x1A00502C */
	CAM_B_REG_CTL_RAW_INT2_EN                       CAM_B_CTL_RAW_INT2_EN;                           /* 0030, 0x1A005030 */
	CAM_B_REG_CTL_RAW_INT2_STATUS                   CAM_B_CTL_RAW_INT2_STATUS;                       /* 0034, 0x1A005034 */
	CAM_B_REG_CTL_RAW_INT2_STATUSX                  CAM_B_CTL_RAW_INT2_STATUSX;                      /* 0038, 0x1A005038 */
	UINT32                                          rsv_003C;                                        /* 003C, 0x1A00503C */
	CAM_B_REG_CTL_SW_CTL                            CAM_B_CTL_SW_CTL;                                /* 0040, 0x1A005040 */
	CAM_B_REG_CTL_AB_DONE_SEL                       CAM_B_CTL_AB_DONE_SEL;                           /* 0044, 0x1A005044 */
	CAM_B_REG_CTL_CD_DONE_SEL                       CAM_B_CTL_CD_DONE_SEL;                           /* 0048, 0x1A005048 */
	CAM_B_REG_CTL_UNI_DONE_SEL                      CAM_B_CTL_UNI_DONE_SEL;                          /* 004C, 0x1A00504C */
	CAM_B_REG_CTL_SPARE0                            CAM_B_CTL_SPARE0;                                /* 0050, 0x1A005050 */
	CAM_B_REG_CTL_SPARE1                            CAM_B_CTL_SPARE1;                                /* 0054, 0x1A005054 */
	CAM_B_REG_CTL_SPARE2                            CAM_B_CTL_SPARE2;                                /* 0058, 0x1A005058 */
	CAM_B_REG_CTL_SW_PASS1_DONE                     CAM_B_CTL_SW_PASS1_DONE;                         /* 005C, 0x1A00505C */
	CAM_B_REG_CTL_FBC_RCNT_INC                      CAM_B_CTL_FBC_RCNT_INC;                          /* 0060, 0x1A005060 */
	UINT32                                          rsv_0064[3];                                     /* 0064..006F, 0x1A005064..1A00506F */
	CAM_B_REG_CTL_DBG_SET                           CAM_B_CTL_DBG_SET;                               /* 0070, 0x1A005070 */
	CAM_B_REG_CTL_DBG_PORT                          CAM_B_CTL_DBG_PORT;                              /* 0074, 0x1A005074 */
	CAM_B_REG_CTL_DATE_CODE                         CAM_B_CTL_DATE_CODE;                             /* 0078, 0x1A005078 */
	CAM_B_REG_CTL_PROJ_CODE                         CAM_B_CTL_PROJ_CODE;                             /* 007C, 0x1A00507C */
	CAM_B_REG_CTL_RAW_DCM_DIS                       CAM_B_CTL_RAW_DCM_DIS;                           /* 0080, 0x1A005080 */
	CAM_B_REG_CTL_DMA_DCM_DIS                       CAM_B_CTL_DMA_DCM_DIS;                           /* 0084, 0x1A005084 */
	CAM_B_REG_CTL_TOP_DCM_DIS                       CAM_B_CTL_TOP_DCM_DIS;                           /* 0088, 0x1A005088 */
	UINT32                                          rsv_008C;                                        /* 008C, 0x1A00508C */
	CAM_B_REG_CTL_RAW_DCM_STATUS                    CAM_B_CTL_RAW_DCM_STATUS;                        /* 0090, 0x1A005090 */
	CAM_B_REG_CTL_DMA_DCM_STATUS                    CAM_B_CTL_DMA_DCM_STATUS;                        /* 0094, 0x1A005094 */
	CAM_B_REG_CTL_TOP_DCM_STATUS                    CAM_B_CTL_TOP_DCM_STATUS;                        /* 0098, 0x1A005098 */
	UINT32                                          rsv_009C;                                        /* 009C, 0x1A00509C */
	CAM_B_REG_CTL_RAW_REQ_STATUS                    CAM_B_CTL_RAW_REQ_STATUS;                        /* 00A0, 0x1A0050A0 */
	CAM_B_REG_CTL_DMA_REQ_STATUS                    CAM_B_CTL_DMA_REQ_STATUS;                        /* 00A4, 0x1A0050A4 */
	CAM_B_REG_CTL_RAW_RDY_STATUS                    CAM_B_CTL_RAW_RDY_STATUS;                        /* 00A8, 0x1A0050A8 */
	CAM_B_REG_CTL_DMA_RDY_STATUS                    CAM_B_CTL_DMA_RDY_STATUS;                        /* 00AC, 0x1A0050AC */
	CAM_B_REG_CTL_RAW_CCU_INT_EN                    CAM_B_CTL_RAW_CCU_INT_EN;                        /* 00B0, 0x1A0050B0 */
	CAM_B_REG_CTL_RAW_CCU_INT_STATUS                CAM_B_CTL_RAW_CCU_INT_STATUS;                    /* 00B4, 0x1A0050B4 */
	CAM_B_REG_CTL_RAW_CCU_INT2_EN                   CAM_B_CTL_RAW_CCU_INT2_EN;                       /* 00B8, 0x1A0050B8 */
	CAM_B_REG_CTL_RAW_CCU_INT2_STATUS               CAM_B_CTL_RAW_CCU_INT2_STATUS;                   /* 00BC, 0x1A0050BC */
	UINT32                                          rsv_00C0[20];                                    /* 00C0..010F, 0x1A0050C0..1A00510F */
	CAM_B_REG_FBC_IMGO_CTL1                         CAM_B_FBC_IMGO_CTL1;                             /* 0110, 0x1A005110 */
	CAM_B_REG_FBC_IMGO_CTL2                         CAM_B_FBC_IMGO_CTL2;                             /* 0114, 0x1A005114 */
	CAM_B_REG_FBC_RRZO_CTL1                         CAM_B_FBC_RRZO_CTL1;                             /* 0118, 0x1A005118 */
	CAM_B_REG_FBC_RRZO_CTL2                         CAM_B_FBC_RRZO_CTL2;                             /* 011C, 0x1A00511C */
	CAM_B_REG_FBC_UFEO_CTL1                         CAM_B_FBC_UFEO_CTL1;                             /* 0120, 0x1A005120 */
	CAM_B_REG_FBC_UFEO_CTL2                         CAM_B_FBC_UFEO_CTL2;                             /* 0124, 0x1A005124 */
	CAM_B_REG_FBC_LCSO_CTL1                         CAM_B_FBC_LCSO_CTL1;                             /* 0128, 0x1A005128 */
	CAM_B_REG_FBC_LCSO_CTL2                         CAM_B_FBC_LCSO_CTL2;                             /* 012C, 0x1A00512C */
	CAM_B_REG_FBC_AFO_CTL1                          CAM_B_FBC_AFO_CTL1;                              /* 0130, 0x1A005130 */
	CAM_B_REG_FBC_AFO_CTL2                          CAM_B_FBC_AFO_CTL2;                              /* 0134, 0x1A005134 */
	CAM_B_REG_FBC_AAO_CTL1                          CAM_B_FBC_AAO_CTL1;                              /* 0138, 0x1A005138 */
	CAM_B_REG_FBC_AAO_CTL2                          CAM_B_FBC_AAO_CTL2;                              /* 013C, 0x1A00513C */
	CAM_B_REG_FBC_PDO_CTL1                          CAM_B_FBC_PDO_CTL1;                              /* 0140, 0x1A005140 */
	CAM_B_REG_FBC_PDO_CTL2                          CAM_B_FBC_PDO_CTL2;                              /* 0144, 0x1A005144 */
	CAM_B_REG_FBC_PSO_CTL1                          CAM_B_FBC_PSO_CTL1;                              /* 0148, 0x1A005148 */
	CAM_B_REG_FBC_PSO_CTL2                          CAM_B_FBC_PSO_CTL2;                              /* 014C, 0x1A00514C */
	UINT32                                          rsv_0150[4];                                     /* 0150..015F, 0x1A005150..1A00515F */
	CAM_B_REG_CQ_EN                                 CAM_B_CQ_EN;                                     /* 0160, 0x1A005160 */
	CAM_B_REG_CQ_THR0_CTL                           CAM_B_CQ_THR0_CTL;                               /* 0164, 0x1A005164 */
	CAM_B_REG_CQ_THR0_BASEADDR                      CAM_B_CQ_THR0_BASEADDR;                          /* 0168, 0x1A005168 */
	CAM_B_REG_CQ_THR0_DESC_SIZE                     CAM_B_CQ_THR0_DESC_SIZE;                         /* 016C, 0x1A00516C */
	CAM_B_REG_CQ_THR1_CTL                           CAM_B_CQ_THR1_CTL;                               /* 0170, 0x1A005170 */
	CAM_B_REG_CQ_THR1_BASEADDR                      CAM_B_CQ_THR1_BASEADDR;                          /* 0174, 0x1A005174 */
	CAM_B_REG_CQ_THR1_DESC_SIZE                     CAM_B_CQ_THR1_DESC_SIZE;                         /* 0178, 0x1A005178 */
	CAM_B_REG_CQ_THR2_CTL                           CAM_B_CQ_THR2_CTL;                               /* 017C, 0x1A00517C */
	CAM_B_REG_CQ_THR2_BASEADDR                      CAM_B_CQ_THR2_BASEADDR;                          /* 0180, 0x1A005180 */
	CAM_B_REG_CQ_THR2_DESC_SIZE                     CAM_B_CQ_THR2_DESC_SIZE;                         /* 0184, 0x1A005184 */
	CAM_B_REG_CQ_THR3_CTL                           CAM_B_CQ_THR3_CTL;                               /* 0188, 0x1A005188 */
	CAM_B_REG_CQ_THR3_BASEADDR                      CAM_B_CQ_THR3_BASEADDR;                          /* 018C, 0x1A00518C */
	CAM_B_REG_CQ_THR3_DESC_SIZE                     CAM_B_CQ_THR3_DESC_SIZE;                         /* 0190, 0x1A005190 */
	CAM_B_REG_CQ_THR4_CTL                           CAM_B_CQ_THR4_CTL;                               /* 0194, 0x1A005194 */
	CAM_B_REG_CQ_THR4_BASEADDR                      CAM_B_CQ_THR4_BASEADDR;                          /* 0198, 0x1A005198 */
	CAM_B_REG_CQ_THR4_DESC_SIZE                     CAM_B_CQ_THR4_DESC_SIZE;                         /* 019C, 0x1A00519C */
	CAM_B_REG_CQ_THR5_CTL                           CAM_B_CQ_THR5_CTL;                               /* 01A0, 0x1A0051A0 */
	CAM_B_REG_CQ_THR5_BASEADDR                      CAM_B_CQ_THR5_BASEADDR;                          /* 01A4, 0x1A0051A4 */
	CAM_B_REG_CQ_THR5_DESC_SIZE                     CAM_B_CQ_THR5_DESC_SIZE;                         /* 01A8, 0x1A0051A8 */
	CAM_B_REG_CQ_THR6_CTL                           CAM_B_CQ_THR6_CTL;                               /* 01AC, 0x1A0051AC */
	CAM_B_REG_CQ_THR6_BASEADDR                      CAM_B_CQ_THR6_BASEADDR;                          /* 01B0, 0x1A0051B0 */
	CAM_B_REG_CQ_THR6_DESC_SIZE                     CAM_B_CQ_THR6_DESC_SIZE;                         /* 01B4, 0x1A0051B4 */
	CAM_B_REG_CQ_THR7_CTL                           CAM_B_CQ_THR7_CTL;                               /* 01B8, 0x1A0051B8 */
	CAM_B_REG_CQ_THR7_BASEADDR                      CAM_B_CQ_THR7_BASEADDR;                          /* 01BC, 0x1A0051BC */
	CAM_B_REG_CQ_THR7_DESC_SIZE                     CAM_B_CQ_THR7_DESC_SIZE;                         /* 01C0, 0x1A0051C0 */
	CAM_B_REG_CQ_THR8_CTL                           CAM_B_CQ_THR8_CTL;                               /* 01C4, 0x1A0051C4 */
	CAM_B_REG_CQ_THR8_BASEADDR                      CAM_B_CQ_THR8_BASEADDR;                          /* 01C8, 0x1A0051C8 */
	CAM_B_REG_CQ_THR8_DESC_SIZE                     CAM_B_CQ_THR8_DESC_SIZE;                         /* 01CC, 0x1A0051CC */
	CAM_B_REG_CQ_THR9_CTL                           CAM_B_CQ_THR9_CTL;                               /* 01D0, 0x1A0051D0 */
	CAM_B_REG_CQ_THR9_BASEADDR                      CAM_B_CQ_THR9_BASEADDR;                          /* 01D4, 0x1A0051D4 */
	CAM_B_REG_CQ_THR9_DESC_SIZE                     CAM_B_CQ_THR9_DESC_SIZE;                         /* 01D8, 0x1A0051D8 */
	CAM_B_REG_CQ_THR10_CTL                          CAM_B_CQ_THR10_CTL;                              /* 01DC, 0x1A0051DC */
	CAM_B_REG_CQ_THR10_BASEADDR                     CAM_B_CQ_THR10_BASEADDR;                         /* 01E0, 0x1A0051E0 */
	CAM_B_REG_CQ_THR10_DESC_SIZE                    CAM_B_CQ_THR10_DESC_SIZE;                        /* 01E4, 0x1A0051E4 */
	CAM_B_REG_CQ_THR11_CTL                          CAM_B_CQ_THR11_CTL;                              /* 01E8, 0x1A0051E8 */
	CAM_B_REG_CQ_THR11_BASEADDR                     CAM_B_CQ_THR11_BASEADDR;                         /* 01EC, 0x1A0051EC */
	CAM_B_REG_CQ_THR11_DESC_SIZE                    CAM_B_CQ_THR11_DESC_SIZE;                        /* 01F0, 0x1A0051F0 */
	CAM_B_REG_CQ_THR12_CTL                          CAM_B_CQ_THR12_CTL;                              /* 01F4, 0x1A0051F4 */
	CAM_B_REG_CQ_THR12_BASEADDR                     CAM_B_CQ_THR12_BASEADDR;                         /* 01F8, 0x1A0051F8 */
	CAM_B_REG_CQ_THR12_DESC_SIZE                    CAM_B_CQ_THR12_DESC_SIZE;                        /* 01FC, 0x1A0051FC */
	CAM_B_REG_DMA_SOFT_RSTSTAT                      CAM_B_DMA_SOFT_RSTSTAT;                          /* 0200, 0x1A005200 */
	CAM_B_REG_CQ0I_BASE_ADDR                        CAM_B_CQ0I_BASE_ADDR;                            /* 0204, 0x1A005204 */
	CAM_B_REG_CQ0I_XSIZE                            CAM_B_CQ0I_XSIZE;                                /* 0208, 0x1A005208 */
	CAM_B_REG_VERTICAL_FLIP_EN                      CAM_B_VERTICAL_FLIP_EN;                          /* 020C, 0x1A00520C */
	CAM_B_REG_DMA_SOFT_RESET                        CAM_B_DMA_SOFT_RESET;                            /* 0210, 0x1A005210 */
	CAM_B_REG_LAST_ULTRA_EN                         CAM_B_LAST_ULTRA_EN;                             /* 0214, 0x1A005214 */
	CAM_B_REG_SPECIAL_FUN_EN                        CAM_B_SPECIAL_FUN_EN;                            /* 0218, 0x1A005218 */
	UINT32                                          rsv_021C;                                        /* 021C, 0x1A00521C */
	CAM_B_REG_IMGO_BASE_ADDR                        CAM_B_IMGO_BASE_ADDR;                            /* 0220, 0x1A005220 */
	UINT32                                          rsv_0224;                                        /* 0224, 0x1A005224 */
	CAM_B_REG_IMGO_OFST_ADDR                        CAM_B_IMGO_OFST_ADDR;                            /* 0228, 0x1A005228 */
	UINT32                                          rsv_022C;                                        /* 022C, 0x1A00522C */
	CAM_B_REG_IMGO_XSIZE                            CAM_B_IMGO_XSIZE;                                /* 0230, 0x1A005230 */
	CAM_B_REG_IMGO_YSIZE                            CAM_B_IMGO_YSIZE;                                /* 0234, 0x1A005234 */
	CAM_B_REG_IMGO_STRIDE                           CAM_B_IMGO_STRIDE;                               /* 0238, 0x1A005238 */
	CAM_B_REG_IMGO_CON                              CAM_B_IMGO_CON;                                  /* 023C, 0x1A00523C */
	CAM_B_REG_IMGO_CON2                             CAM_B_IMGO_CON2;                                 /* 0240, 0x1A005240 */
	CAM_B_REG_IMGO_CON3                             CAM_B_IMGO_CON3;                                 /* 0244, 0x1A005244 */
	CAM_B_REG_IMGO_CROP                             CAM_B_IMGO_CROP;                                 /* 0248, 0x1A005248 */
	UINT32                                          rsv_024C;                                        /* 024C, 0x1A00524C */
	CAM_B_REG_RRZO_BASE_ADDR                        CAM_B_RRZO_BASE_ADDR;                            /* 0250, 0x1A005250 */
	UINT32                                          rsv_0254;                                        /* 0254, 0x1A005254 */
	CAM_B_REG_RRZO_OFST_ADDR                        CAM_B_RRZO_OFST_ADDR;                            /* 0258, 0x1A005258 */
	UINT32                                          rsv_025C;                                        /* 025C, 0x1A00525C */
	CAM_B_REG_RRZO_XSIZE                            CAM_B_RRZO_XSIZE;                                /* 0260, 0x1A005260 */
	CAM_B_REG_RRZO_YSIZE                            CAM_B_RRZO_YSIZE;                                /* 0264, 0x1A005264 */
	CAM_B_REG_RRZO_STRIDE                           CAM_B_RRZO_STRIDE;                               /* 0268, 0x1A005268 */
	CAM_B_REG_RRZO_CON                              CAM_B_RRZO_CON;                                  /* 026C, 0x1A00526C */
	CAM_B_REG_RRZO_CON2                             CAM_B_RRZO_CON2;                                 /* 0270, 0x1A005270 */
	CAM_B_REG_RRZO_CON3                             CAM_B_RRZO_CON3;                                 /* 0274, 0x1A005274 */
	CAM_B_REG_RRZO_CROP                             CAM_B_RRZO_CROP;                                 /* 0278, 0x1A005278 */
	UINT32                                          rsv_027C;                                        /* 027C, 0x1A00527C */
	CAM_B_REG_AAO_BASE_ADDR                         CAM_B_AAO_BASE_ADDR;                             /* 0280, 0x1A005280 */
	UINT32                                          rsv_0284;                                        /* 0284, 0x1A005284 */
	CAM_B_REG_AAO_OFST_ADDR                         CAM_B_AAO_OFST_ADDR;                             /* 0288, 0x1A005288 */
	UINT32                                          rsv_028C;                                        /* 028C, 0x1A00528C */
	CAM_B_REG_AAO_XSIZE                             CAM_B_AAO_XSIZE;                                 /* 0290, 0x1A005290 */
	CAM_B_REG_AAO_YSIZE                             CAM_B_AAO_YSIZE;                                 /* 0294, 0x1A005294 */
	CAM_B_REG_AAO_STRIDE                            CAM_B_AAO_STRIDE;                                /* 0298, 0x1A005298 */
	CAM_B_REG_AAO_CON                               CAM_B_AAO_CON;                                   /* 029C, 0x1A00529C */
	CAM_B_REG_AAO_CON2                              CAM_B_AAO_CON2;                                  /* 02A0, 0x1A0052A0 */
	CAM_B_REG_AAO_CON3                              CAM_B_AAO_CON3;                                  /* 02A4, 0x1A0052A4 */
	UINT32                                          rsv_02A8[2];                                     /* 02A8..02AF, 0x1A0052A8..1A0052AF */
	CAM_B_REG_AFO_BASE_ADDR                         CAM_B_AFO_BASE_ADDR;                             /* 02B0, 0x1A0052B0 */
	UINT32                                          rsv_02B4;                                        /* 02B4, 0x1A0052B4 */
	CAM_B_REG_AFO_OFST_ADDR                         CAM_B_AFO_OFST_ADDR;                             /* 02B8, 0x1A0052B8 */
	UINT32                                          rsv_02BC;                                        /* 02BC, 0x1A0052BC */
	CAM_B_REG_AFO_XSIZE                             CAM_B_AFO_XSIZE;                                 /* 02C0, 0x1A0052C0 */
	CAM_B_REG_AFO_YSIZE                             CAM_B_AFO_YSIZE;                                 /* 02C4, 0x1A0052C4 */
	CAM_B_REG_AFO_STRIDE                            CAM_B_AFO_STRIDE;                                /* 02C8, 0x1A0052C8 */
	CAM_B_REG_AFO_CON                               CAM_B_AFO_CON;                                   /* 02CC, 0x1A0052CC */
	CAM_B_REG_AFO_CON2                              CAM_B_AFO_CON2;                                  /* 02D0, 0x1A0052D0 */
	CAM_B_REG_AFO_CON3                              CAM_B_AFO_CON3;                                  /* 02D4, 0x1A0052D4 */
	UINT32                                          rsv_02D8[2];                                     /* 02D8..02DF, 0x1A0052D8..1A0052DF */
	CAM_B_REG_LCSO_BASE_ADDR                        CAM_B_LCSO_BASE_ADDR;                            /* 02E0, 0x1A0052E0 */
	UINT32                                          rsv_02E4;                                        /* 02E4, 0x1A0052E4 */
	CAM_B_REG_LCSO_OFST_ADDR                        CAM_B_LCSO_OFST_ADDR;                            /* 02E8, 0x1A0052E8 */
	UINT32                                          rsv_02EC;                                        /* 02EC, 0x1A0052EC */
	CAM_B_REG_LCSO_XSIZE                            CAM_B_LCSO_XSIZE;                                /* 02F0, 0x1A0052F0 */
	CAM_B_REG_LCSO_YSIZE                            CAM_B_LCSO_YSIZE;                                /* 02F4, 0x1A0052F4 */
	CAM_B_REG_LCSO_STRIDE                           CAM_B_LCSO_STRIDE;                               /* 02F8, 0x1A0052F8 */
	CAM_B_REG_LCSO_CON                              CAM_B_LCSO_CON;                                  /* 02FC, 0x1A0052FC */
	CAM_B_REG_LCSO_CON2                             CAM_B_LCSO_CON2;                                 /* 0300, 0x1A005300 */
	CAM_B_REG_LCSO_CON3                             CAM_B_LCSO_CON3;                                 /* 0304, 0x1A005304 */
	UINT32                                          rsv_0308[2];                                     /* 0308..030F, 0x1A005308..1A00530F */
	CAM_B_REG_UFEO_BASE_ADDR                        CAM_B_UFEO_BASE_ADDR;                            /* 0310, 0x1A005310 */
	UINT32                                          rsv_0314;                                        /* 0314, 0x1A005314 */
	CAM_B_REG_UFEO_OFST_ADDR                        CAM_B_UFEO_OFST_ADDR;                            /* 0318, 0x1A005318 */
	UINT32                                          rsv_031C;                                        /* 031C, 0x1A00531C */
	CAM_B_REG_UFEO_XSIZE                            CAM_B_UFEO_XSIZE;                                /* 0320, 0x1A005320 */
	CAM_B_REG_UFEO_YSIZE                            CAM_B_UFEO_YSIZE;                                /* 0324, 0x1A005324 */
	CAM_B_REG_UFEO_STRIDE                           CAM_B_UFEO_STRIDE;                               /* 0328, 0x1A005328 */
	CAM_B_REG_UFEO_CON                              CAM_B_UFEO_CON;                                  /* 032C, 0x1A00532C */
	CAM_B_REG_UFEO_CON2                             CAM_B_UFEO_CON2;                                 /* 0330, 0x1A005330 */
	CAM_B_REG_UFEO_CON3                             CAM_B_UFEO_CON3;                                 /* 0334, 0x1A005334 */
	UINT32                                          rsv_0338[2];                                     /* 0338..033F, 0x1A005338..1A00533F */
	CAM_B_REG_PDO_BASE_ADDR                         CAM_B_PDO_BASE_ADDR;                             /* 0340, 0x1A005340 */
	UINT32                                          rsv_0344;                                        /* 0344, 0x1A005344 */
	CAM_B_REG_PDO_OFST_ADDR                         CAM_B_PDO_OFST_ADDR;                             /* 0348, 0x1A005348 */
	UINT32                                          rsv_034C;                                        /* 034C, 0x1A00534C */
	CAM_B_REG_PDO_XSIZE                             CAM_B_PDO_XSIZE;                                 /* 0350, 0x1A005350 */
	CAM_B_REG_PDO_YSIZE                             CAM_B_PDO_YSIZE;                                 /* 0354, 0x1A005354 */
	CAM_B_REG_PDO_STRIDE                            CAM_B_PDO_STRIDE;                                /* 0358, 0x1A005358 */
	CAM_B_REG_PDO_CON                               CAM_B_PDO_CON;                                   /* 035C, 0x1A00535C */
	CAM_B_REG_PDO_CON2                              CAM_B_PDO_CON2;                                  /* 0360, 0x1A005360 */
	CAM_B_REG_PDO_CON3                              CAM_B_PDO_CON3;                                  /* 0364, 0x1A005364 */
	UINT32                                          rsv_0368[2];                                     /* 0368..036F, 0x1A005368..1A00536F */
	CAM_B_REG_BPCI_BASE_ADDR                        CAM_B_BPCI_BASE_ADDR;                            /* 0370, 0x1A005370 */
	UINT32                                          rsv_0374;                                        /* 0374, 0x1A005374 */
	CAM_B_REG_BPCI_OFST_ADDR                        CAM_B_BPCI_OFST_ADDR;                            /* 0378, 0x1A005378 */
	UINT32                                          rsv_037C;                                        /* 037C, 0x1A00537C */
	CAM_B_REG_BPCI_XSIZE                            CAM_B_BPCI_XSIZE;                                /* 0380, 0x1A005380 */
	CAM_B_REG_BPCI_YSIZE                            CAM_B_BPCI_YSIZE;                                /* 0384, 0x1A005384 */
	CAM_B_REG_BPCI_STRIDE                           CAM_B_BPCI_STRIDE;                               /* 0388, 0x1A005388 */
	CAM_B_REG_BPCI_CON                              CAM_B_BPCI_CON;                                  /* 038C, 0x1A00538C */
	CAM_B_REG_BPCI_CON2                             CAM_B_BPCI_CON2;                                 /* 0390, 0x1A005390 */
	CAM_B_REG_BPCI_CON3                             CAM_B_BPCI_CON3;                                 /* 0394, 0x1A005394 */
	UINT32                                          rsv_0398[2];                                     /* 0398..039F, 0x1A005398..1A00539F */
	CAM_B_REG_CACI_BASE_ADDR                        CAM_B_CACI_BASE_ADDR;                            /* 03A0, 0x1A0053A0 */
	UINT32                                          rsv_03A4;                                        /* 03A4, 0x1A0053A4 */
	CAM_B_REG_CACI_OFST_ADDR                        CAM_B_CACI_OFST_ADDR;                            /* 03A8, 0x1A0053A8 */
	UINT32                                          rsv_03AC;                                        /* 03AC, 0x1A0053AC */
	CAM_B_REG_CACI_XSIZE                            CAM_B_CACI_XSIZE;                                /* 03B0, 0x1A0053B0 */
	CAM_B_REG_CACI_YSIZE                            CAM_B_CACI_YSIZE;                                /* 03B4, 0x1A0053B4 */
	CAM_B_REG_CACI_STRIDE                           CAM_B_CACI_STRIDE;                               /* 03B8, 0x1A0053B8 */
	CAM_B_REG_CACI_CON                              CAM_B_CACI_CON;                                  /* 03BC, 0x1A0053BC */
	CAM_B_REG_CACI_CON2                             CAM_B_CACI_CON2;                                 /* 03C0, 0x1A0053C0 */
	CAM_B_REG_CACI_CON3                             CAM_B_CACI_CON3;                                 /* 03C4, 0x1A0053C4 */
	UINT32                                          rsv_03C8[2];                                     /* 03C8..03CF, 0x1A0053C8..1A0053CF */
	CAM_B_REG_LSCI_BASE_ADDR                        CAM_B_LSCI_BASE_ADDR;                            /* 03D0, 0x1A0053D0 */
	UINT32                                          rsv_03D4;                                        /* 03D4, 0x1A0053D4 */
	CAM_B_REG_LSCI_OFST_ADDR                        CAM_B_LSCI_OFST_ADDR;                            /* 03D8, 0x1A0053D8 */
	UINT32                                          rsv_03DC;                                        /* 03DC, 0x1A0053DC */
	CAM_B_REG_LSCI_XSIZE                            CAM_B_LSCI_XSIZE;                                /* 03E0, 0x1A0053E0 */
	CAM_B_REG_LSCI_YSIZE                            CAM_B_LSCI_YSIZE;                                /* 03E4, 0x1A0053E4 */
	CAM_B_REG_LSCI_STRIDE                           CAM_B_LSCI_STRIDE;                               /* 03E8, 0x1A0053E8 */
	CAM_B_REG_LSCI_CON                              CAM_B_LSCI_CON;                                  /* 03EC, 0x1A0053EC */
	CAM_B_REG_LSCI_CON2                             CAM_B_LSCI_CON2;                                 /* 03F0, 0x1A0053F0 */
	CAM_B_REG_LSCI_CON3                             CAM_B_LSCI_CON3;                                 /* 03F4, 0x1A0053F4 */
	UINT32                                          rsv_03F8[2];                                     /* 03F8..03FF, 0x1A0053F8..1A0053FF */
	CAM_B_REG_LSC3I_BASE_ADDR                       CAM_B_LSC3I_BASE_ADDR;                           /* 0400, 0x1A005400 */
	UINT32                                          rsv_0404;                                        /* 0404, 0x1A005404 */
	CAM_B_REG_LSC3I_OFST_ADDR                       CAM_B_LSC3I_OFST_ADDR;                           /* 0408, 0x1A005408 */
	UINT32                                          rsv_040C;                                        /* 040C, 0x1A00540C */
	CAM_B_REG_LSC3I_XSIZE                           CAM_B_LSC3I_XSIZE;                               /* 0410, 0x1A005410 */
	CAM_B_REG_LSC3I_YSIZE                           CAM_B_LSC3I_YSIZE;                               /* 0414, 0x1A005414 */
	CAM_B_REG_LSC3I_STRIDE                          CAM_B_LSC3I_STRIDE;                              /* 0418, 0x1A005418 */
	CAM_B_REG_LSC3I_CON                             CAM_B_LSC3I_CON;                                 /* 041C, 0x1A00541C */
	CAM_B_REG_LSC3I_CON2                            CAM_B_LSC3I_CON2;                                /* 0420, 0x1A005420 */
	CAM_B_REG_LSC3I_CON3                            CAM_B_LSC3I_CON3;                                /* 0424, 0x1A005424 */
	UINT32                                          rsv_0428[6];                                     /* 0428..043F, 0x1A005428..1A00543F */
	CAM_B_REG_DMA_ERR_CTRL                          CAM_B_DMA_ERR_CTRL;                              /* 0440, 0x1A005440 */
	CAM_B_REG_IMGO_ERR_STAT                         CAM_B_IMGO_ERR_STAT;                             /* 0444, 0x1A005444 */
	CAM_B_REG_RRZO_ERR_STAT                         CAM_B_RRZO_ERR_STAT;                             /* 0448, 0x1A005448 */
	CAM_B_REG_AAO_ERR_STAT                          CAM_B_AAO_ERR_STAT;                              /* 044C, 0x1A00544C */
	CAM_B_REG_AFO_ERR_STAT                          CAM_B_AFO_ERR_STAT;                              /* 0450, 0x1A005450 */
	CAM_B_REG_LCSO_ERR_STAT                         CAM_B_LCSO_ERR_STAT;                             /* 0454, 0x1A005454 */
	CAM_B_REG_UFEO_ERR_STAT                         CAM_B_UFEO_ERR_STAT;                             /* 0458, 0x1A005458 */
	CAM_B_REG_PDO_ERR_STAT                          CAM_B_PDO_ERR_STAT;                              /* 045C, 0x1A00545C */
	CAM_B_REG_BPCI_ERR_STAT                         CAM_B_BPCI_ERR_STAT;                             /* 0460, 0x1A005460 */
	CAM_B_REG_CACI_ERR_STAT                         CAM_B_CACI_ERR_STAT;                             /* 0464, 0x1A005464 */
	CAM_B_REG_LSCI_ERR_STAT                         CAM_B_LSCI_ERR_STAT;                             /* 0468, 0x1A005468 */
	CAM_B_REG_LSC3I_ERR_STAT                        CAM_B_LSC3I_ERR_STAT;                            /* 046C, 0x1A00546C */
	CAM_B_REG_DMA_DEBUG_ADDR                        CAM_B_DMA_DEBUG_ADDR;                            /* 0470, 0x1A005470 */
	CAM_B_REG_DMA_RSV1                              CAM_B_DMA_RSV1;                                  /* 0474, 0x1A005474 */
	CAM_B_REG_DMA_RSV2                              CAM_B_DMA_RSV2;                                  /* 0478, 0x1A005478 */
	CAM_B_REG_DMA_RSV3                              CAM_B_DMA_RSV3;                                  /* 047C, 0x1A00547C */
	CAM_B_REG_DMA_RSV4                              CAM_B_DMA_RSV4;                                  /* 0480, 0x1A005480 */
	CAM_B_REG_DMA_RSV5                              CAM_B_DMA_RSV5;                                  /* 0484, 0x1A005484 */
	CAM_B_REG_DMA_RSV6                              CAM_B_DMA_RSV6;                                  /* 0488, 0x1A005488 */
	CAM_B_REG_DMA_DEBUG_SEL                         CAM_B_DMA_DEBUG_SEL;                             /* 048C, 0x1A00548C */
	CAM_B_REG_DMA_BW_SELF_TEST                      CAM_B_DMA_BW_SELF_TEST;                          /* 0490, 0x1A005490 */
	UINT32                                          rsv_0494[27];                                    /* 0494..04FF, 0x1A005494..1A0054FF */
	CAM_B_REG_TG_SEN_MODE                           CAM_B_TG_SEN_MODE;                               /* 0500, 0x1A005500 */
	CAM_B_REG_TG_VF_CON                             CAM_B_TG_VF_CON;                                 /* 0504, 0x1A005504 */
	CAM_B_REG_TG_SEN_GRAB_PXL                       CAM_B_TG_SEN_GRAB_PXL;                           /* 0508, 0x1A005508 */
	CAM_B_REG_TG_SEN_GRAB_LIN                       CAM_B_TG_SEN_GRAB_LIN;                           /* 050C, 0x1A00550C */
	CAM_B_REG_TG_PATH_CFG                           CAM_B_TG_PATH_CFG;                               /* 0510, 0x1A005510 */
	CAM_B_REG_TG_MEMIN_CTL                          CAM_B_TG_MEMIN_CTL;                              /* 0514, 0x1A005514 */
	CAM_B_REG_TG_INT1                               CAM_B_TG_INT1;                                   /* 0518, 0x1A005518 */
	CAM_B_REG_TG_INT2                               CAM_B_TG_INT2;                                   /* 051C, 0x1A00551C */
	CAM_B_REG_TG_SOF_CNT                            CAM_B_TG_SOF_CNT;                                /* 0520, 0x1A005520 */
	CAM_B_REG_TG_SOT_CNT                            CAM_B_TG_SOT_CNT;                                /* 0524, 0x1A005524 */
	CAM_B_REG_TG_EOT_CNT                            CAM_B_TG_EOT_CNT;                                /* 0528, 0x1A005528 */
	CAM_B_REG_TG_ERR_CTL                            CAM_B_TG_ERR_CTL;                                /* 052C, 0x1A00552C */
	CAM_B_REG_TG_DAT_NO                             CAM_B_TG_DAT_NO;                                 /* 0530, 0x1A005530 */
	CAM_B_REG_TG_FRM_CNT_ST                         CAM_B_TG_FRM_CNT_ST;                             /* 0534, 0x1A005534 */
	CAM_B_REG_TG_FRMSIZE_ST                         CAM_B_TG_FRMSIZE_ST;                             /* 0538, 0x1A005538 */
	CAM_B_REG_TG_INTER_ST                           CAM_B_TG_INTER_ST;                               /* 053C, 0x1A00553C */
	CAM_B_REG_TG_FLASHA_CTL                         CAM_B_TG_FLASHA_CTL;                             /* 0540, 0x1A005540 */
	CAM_B_REG_TG_FLASHA_LINE_CNT                    CAM_B_TG_FLASHA_LINE_CNT;                        /* 0544, 0x1A005544 */
	CAM_B_REG_TG_FLASHA_POS                         CAM_B_TG_FLASHA_POS;                             /* 0548, 0x1A005548 */
	CAM_B_REG_TG_FLASHB_CTL                         CAM_B_TG_FLASHB_CTL;                             /* 054C, 0x1A00554C */
	CAM_B_REG_TG_FLASHB_LINE_CNT                    CAM_B_TG_FLASHB_LINE_CNT;                        /* 0550, 0x1A005550 */
	CAM_B_REG_TG_FLASHB_POS                         CAM_B_TG_FLASHB_POS;                             /* 0554, 0x1A005554 */
	CAM_B_REG_TG_FLASHB_POS1                        CAM_B_TG_FLASHB_POS1;                            /* 0558, 0x1A005558 */
	UINT32                                          rsv_055C;                                        /* 055C, 0x1A00555C */
	CAM_B_REG_TG_I2C_CQ_TRIG                        CAM_B_TG_I2C_CQ_TRIG;                            /* 0560, 0x1A005560 */
	CAM_B_REG_TG_CQ_TIMING                          CAM_B_TG_CQ_TIMING;                              /* 0564, 0x1A005564 */
	CAM_B_REG_TG_CQ_NUM                             CAM_B_TG_CQ_NUM;                                 /* 0568, 0x1A005568 */
	UINT32                                          rsv_056C;                                        /* 056C, 0x1A00556C */
	CAM_B_REG_TG_TIME_STAMP                         CAM_B_TG_TIME_STAMP;                             /* 0570, 0x1A005570 */
	CAM_B_REG_TG_SUB_PERIOD                         CAM_B_TG_SUB_PERIOD;                             /* 0574, 0x1A005574 */
	CAM_B_REG_TG_DAT_NO_R                           CAM_B_TG_DAT_NO_R;                               /* 0578, 0x1A005578 */
	CAM_B_REG_TG_FRMSIZE_ST_R                       CAM_B_TG_FRMSIZE_ST_R;                           /* 057C, 0x1A00557C */
	CAM_B_REG_DMX_CTL                               CAM_B_DMX_CTL;                                   /* 0580, 0x1A005580 */
	CAM_B_REG_DMX_CROP                              CAM_B_DMX_CROP;                                  /* 0584, 0x1A005584 */
	CAM_B_REG_DMX_VSIZE                             CAM_B_DMX_VSIZE;                                 /* 0588, 0x1A005588 */
	UINT32                                          rsv_058C[5];                                     /* 058C..059F, 0x1A00558C..1A00559F */
	CAM_B_REG_RMG_HDR_CFG                           CAM_B_RMG_HDR_CFG;                               /* 05A0, 0x1A0055A0 */
	CAM_B_REG_RMG_HDR_GAIN                          CAM_B_RMG_HDR_GAIN;                              /* 05A4, 0x1A0055A4 */
	CAM_B_REG_RMG_HDR_CFG2                          CAM_B_RMG_HDR_CFG2;                              /* 05A8, 0x1A0055A8 */
	UINT32                                          rsv_05AC[5];                                     /* 05AC..05BF, 0x1A0055AC..1A0055BF */
	CAM_B_REG_RMM_OSC                               CAM_B_RMM_OSC;                                   /* 05C0, 0x1A0055C0 */
	CAM_B_REG_RMM_MC                                CAM_B_RMM_MC;                                    /* 05C4, 0x1A0055C4 */
	CAM_B_REG_RMM_REVG_1                            CAM_B_RMM_REVG_1;                                /* 05C8, 0x1A0055C8 */
	CAM_B_REG_RMM_REVG_2                            CAM_B_RMM_REVG_2;                                /* 05CC, 0x1A0055CC */
	CAM_B_REG_RMM_LEOS                              CAM_B_RMM_LEOS;                                  /* 05D0, 0x1A0055D0 */
	CAM_B_REG_RMM_MC2                               CAM_B_RMM_MC2;                                   /* 05D4, 0x1A0055D4 */
	CAM_B_REG_RMM_DIFF_LB                           CAM_B_RMM_DIFF_LB;                               /* 05D8, 0x1A0055D8 */
	CAM_B_REG_RMM_MA                                CAM_B_RMM_MA;                                    /* 05DC, 0x1A0055DC */
	CAM_B_REG_RMM_TUNE                              CAM_B_RMM_TUNE;                                  /* 05E0, 0x1A0055E0 */
	UINT32                                          rsv_05E4[3];                                     /* 05E4..05EF, 0x1A0055E4..1A0055EF */
	CAM_B_REG_OBC_OFFST0                            CAM_B_OBC_OFFST0;                                /* 05F0, 0x1A0055F0 */
	CAM_B_REG_OBC_OFFST1                            CAM_B_OBC_OFFST1;                                /* 05F4, 0x1A0055F4 */
	CAM_B_REG_OBC_OFFST2                            CAM_B_OBC_OFFST2;                                /* 05F8, 0x1A0055F8 */
	CAM_B_REG_OBC_OFFST3                            CAM_B_OBC_OFFST3;                                /* 05FC, 0x1A0055FC */
	CAM_B_REG_OBC_GAIN0                             CAM_B_OBC_GAIN0;                                 /* 0600, 0x1A005600 */
	CAM_B_REG_OBC_GAIN1                             CAM_B_OBC_GAIN1;                                 /* 0604, 0x1A005604 */
	CAM_B_REG_OBC_GAIN2                             CAM_B_OBC_GAIN2;                                 /* 0608, 0x1A005608 */
	CAM_B_REG_OBC_GAIN3                             CAM_B_OBC_GAIN3;                                 /* 060C, 0x1A00560C */
	UINT32                                          rsv_0610[4];                                     /* 0610..061F, 0x1A005610..1A00561F */
	CAM_B_REG_BNR_BPC_CON                           CAM_B_BNR_BPC_CON;                               /* 0620, 0x1A005620 */
	CAM_B_REG_BNR_BPC_TH1                           CAM_B_BNR_BPC_TH1;                               /* 0624, 0x1A005624 */
	CAM_B_REG_BNR_BPC_TH2                           CAM_B_BNR_BPC_TH2;                               /* 0628, 0x1A005628 */
	CAM_B_REG_BNR_BPC_TH3                           CAM_B_BNR_BPC_TH3;                               /* 062C, 0x1A00562C */
	CAM_B_REG_BNR_BPC_TH4                           CAM_B_BNR_BPC_TH4;                               /* 0630, 0x1A005630 */
	CAM_B_REG_BNR_BPC_DTC                           CAM_B_BNR_BPC_DTC;                               /* 0634, 0x1A005634 */
	CAM_B_REG_BNR_BPC_COR                           CAM_B_BNR_BPC_COR;                               /* 0638, 0x1A005638 */
	CAM_B_REG_BNR_BPC_TBLI1                         CAM_B_BNR_BPC_TBLI1;                             /* 063C, 0x1A00563C */
	CAM_B_REG_BNR_BPC_TBLI2                         CAM_B_BNR_BPC_TBLI2;                             /* 0640, 0x1A005640 */
	CAM_B_REG_BNR_BPC_TH1_C                         CAM_B_BNR_BPC_TH1_C;                             /* 0644, 0x1A005644 */
	CAM_B_REG_BNR_BPC_TH2_C                         CAM_B_BNR_BPC_TH2_C;                             /* 0648, 0x1A005648 */
	CAM_B_REG_BNR_BPC_TH3_C                         CAM_B_BNR_BPC_TH3_C;                             /* 064C, 0x1A00564C */
	CAM_B_REG_BNR_NR1_CON                           CAM_B_BNR_NR1_CON;                               /* 0650, 0x1A005650 */
	CAM_B_REG_BNR_NR1_CT_CON                        CAM_B_BNR_NR1_CT_CON;                            /* 0654, 0x1A005654 */
	CAM_B_REG_BNR_RSV1                              CAM_B_BNR_RSV1;                                  /* 0658, 0x1A005658 */
	CAM_B_REG_BNR_RSV2                              CAM_B_BNR_RSV2;                                  /* 065C, 0x1A00565C */
	CAM_B_REG_BNR_PDC_CON                           CAM_B_BNR_PDC_CON;                               /* 0660, 0x1A005660 */
	CAM_B_REG_BNR_PDC_GAIN_L0                       CAM_B_BNR_PDC_GAIN_L0;                           /* 0664, 0x1A005664 */
	CAM_B_REG_BNR_PDC_GAIN_L1                       CAM_B_BNR_PDC_GAIN_L1;                           /* 0668, 0x1A005668 */
	CAM_B_REG_BNR_PDC_GAIN_L2                       CAM_B_BNR_PDC_GAIN_L2;                           /* 066C, 0x1A00566C */
	CAM_B_REG_BNR_PDC_GAIN_L3                       CAM_B_BNR_PDC_GAIN_L3;                           /* 0670, 0x1A005670 */
	CAM_B_REG_BNR_PDC_GAIN_L4                       CAM_B_BNR_PDC_GAIN_L4;                           /* 0674, 0x1A005674 */
	CAM_B_REG_BNR_PDC_GAIN_R0                       CAM_B_BNR_PDC_GAIN_R0;                           /* 0678, 0x1A005678 */
	CAM_B_REG_BNR_PDC_GAIN_R1                       CAM_B_BNR_PDC_GAIN_R1;                           /* 067C, 0x1A00567C */
	CAM_B_REG_BNR_PDC_GAIN_R2                       CAM_B_BNR_PDC_GAIN_R2;                           /* 0680, 0x1A005680 */
	CAM_B_REG_BNR_PDC_GAIN_R3                       CAM_B_BNR_PDC_GAIN_R3;                           /* 0684, 0x1A005684 */
	CAM_B_REG_BNR_PDC_GAIN_R4                       CAM_B_BNR_PDC_GAIN_R4;                           /* 0688, 0x1A005688 */
	CAM_B_REG_BNR_PDC_TH_GB                         CAM_B_BNR_PDC_TH_GB;                             /* 068C, 0x1A00568C */
	CAM_B_REG_BNR_PDC_TH_IA                         CAM_B_BNR_PDC_TH_IA;                             /* 0690, 0x1A005690 */
	CAM_B_REG_BNR_PDC_TH_HD                         CAM_B_BNR_PDC_TH_HD;                             /* 0694, 0x1A005694 */
	CAM_B_REG_BNR_PDC_SL                            CAM_B_BNR_PDC_SL;                                /* 0698, 0x1A005698 */
	CAM_B_REG_BNR_PDC_POS                           CAM_B_BNR_PDC_POS;                               /* 069C, 0x1A00569C */
	UINT32                                          rsv_06A0[4];                                     /* 06A0..06AF, 0x1A0056A0..1A0056AF */
	CAM_B_REG_SCM_CFG0                              CAM_B_SCM_CFG0;                                  /* 06B0, 0x1A0056B0 */
	CAM_B_REG_SCM_CFG1                              CAM_B_SCM_CFG1;                                  /* 06B4, 0x1A0056B4 */
	UINT32                                          rsv_06B8[2];                                     /* 06B8..06BF, 0x1A0056B8..1A0056BF */
	CAM_B_REG_RPG_SATU_1                            CAM_B_RPG_SATU_1;                                /* 06C0, 0x1A0056C0 */
	CAM_B_REG_RPG_SATU_2                            CAM_B_RPG_SATU_2;                                /* 06C4, 0x1A0056C4 */
	CAM_B_REG_RPG_GAIN_1                            CAM_B_RPG_GAIN_1;                                /* 06C8, 0x1A0056C8 */
	CAM_B_REG_RPG_GAIN_2                            CAM_B_RPG_GAIN_2;                                /* 06CC, 0x1A0056CC */
	CAM_B_REG_RPG_OFST_1                            CAM_B_RPG_OFST_1;                                /* 06D0, 0x1A0056D0 */
	CAM_B_REG_RPG_OFST_2                            CAM_B_RPG_OFST_2;                                /* 06D4, 0x1A0056D4 */
	UINT32                                          rsv_06D8[2];                                     /* 06D8..06DF, 0x1A0056D8..1A0056DF */
	CAM_B_REG_RRZ_CTL                               CAM_B_RRZ_CTL;                                   /* 06E0, 0x1A0056E0 */
	CAM_B_REG_RRZ_IN_IMG                            CAM_B_RRZ_IN_IMG;                                /* 06E4, 0x1A0056E4 */
	CAM_B_REG_RRZ_OUT_IMG                           CAM_B_RRZ_OUT_IMG;                               /* 06E8, 0x1A0056E8 */
	CAM_B_REG_RRZ_HORI_STEP                         CAM_B_RRZ_HORI_STEP;                             /* 06EC, 0x1A0056EC */
	CAM_B_REG_RRZ_VERT_STEP                         CAM_B_RRZ_VERT_STEP;                             /* 06F0, 0x1A0056F0 */
	CAM_B_REG_RRZ_HORI_INT_OFST                     CAM_B_RRZ_HORI_INT_OFST;                         /* 06F4, 0x1A0056F4 */
	CAM_B_REG_RRZ_HORI_SUB_OFST                     CAM_B_RRZ_HORI_SUB_OFST;                         /* 06F8, 0x1A0056F8 */
	CAM_B_REG_RRZ_VERT_INT_OFST                     CAM_B_RRZ_VERT_INT_OFST;                         /* 06FC, 0x1A0056FC */
	CAM_B_REG_RRZ_VERT_SUB_OFST                     CAM_B_RRZ_VERT_SUB_OFST;                         /* 0700, 0x1A005700 */
	CAM_B_REG_RRZ_MODE_TH                           CAM_B_RRZ_MODE_TH;                               /* 0704, 0x1A005704 */
	CAM_B_REG_RRZ_MODE_CTL                          CAM_B_RRZ_MODE_CTL;                              /* 0708, 0x1A005708 */
	UINT32                                          rsv_070C[13];                                    /* 070C..073F, 0x1A00570C..1A00573F */
	CAM_B_REG_RMX_CTL                               CAM_B_RMX_CTL;                                   /* 0740, 0x1A005740 */
	CAM_B_REG_RMX_CROP                              CAM_B_RMX_CROP;                                  /* 0744, 0x1A005744 */
	CAM_B_REG_RMX_VSIZE                             CAM_B_RMX_VSIZE;                                 /* 0748, 0x1A005748 */
	UINT32                                          rsv_074C[5];                                     /* 074C..075F, 0x1A00574C..1A00575F */
	CAM_B_REG_SGG5_PGN                              CAM_B_SGG5_PGN;                                  /* 0760, 0x1A005760 */
	CAM_B_REG_SGG5_GMRC_1                           CAM_B_SGG5_GMRC_1;                               /* 0764, 0x1A005764 */
	CAM_B_REG_SGG5_GMRC_2                           CAM_B_SGG5_GMRC_2;                               /* 0768, 0x1A005768 */
	UINT32                                          rsv_076C[5];                                     /* 076C..077F, 0x1A00576C..1A00577F */
	CAM_B_REG_BMX_CTL                               CAM_B_BMX_CTL;                                   /* 0780, 0x1A005780 */
	CAM_B_REG_BMX_CROP                              CAM_B_BMX_CROP;                                  /* 0784, 0x1A005784 */
	CAM_B_REG_BMX_VSIZE                             CAM_B_BMX_VSIZE;                                 /* 0788, 0x1A005788 */
	UINT32                                          rsv_078C[13];                                    /* 078C..07BF, 0x1A00578C..1A0057BF */
	CAM_B_REG_UFE_CON                               CAM_B_UFE_CON;                                   /* 07C0, 0x1A0057C0 */
	UINT32                                          rsv_07C4[3];                                     /* 07C4..07CF, 0x1A0057C4..1A0057CF */
	CAM_B_REG_LSC_CTL1                              CAM_B_LSC_CTL1;                                  /* 07D0, 0x1A0057D0 */
	CAM_B_REG_LSC_CTL2                              CAM_B_LSC_CTL2;                                  /* 07D4, 0x1A0057D4 */
	CAM_B_REG_LSC_CTL3                              CAM_B_LSC_CTL3;                                  /* 07D8, 0x1A0057D8 */
	CAM_B_REG_LSC_LBLOCK                            CAM_B_LSC_LBLOCK;                                /* 07DC, 0x1A0057DC */
	CAM_B_REG_LSC_RATIO_0                           CAM_B_LSC_RATIO_0;                               /* 07E0, 0x1A0057E0 */
	CAM_B_REG_LSC_TPIPE_OFST                        CAM_B_LSC_TPIPE_OFST;                            /* 07E4, 0x1A0057E4 */
	CAM_B_REG_LSC_TPIPE_SIZE                        CAM_B_LSC_TPIPE_SIZE;                            /* 07E8, 0x1A0057E8 */
	CAM_B_REG_LSC_GAIN_TH                           CAM_B_LSC_GAIN_TH;                               /* 07EC, 0x1A0057EC */
	CAM_B_REG_LSC_RATIO_1                           CAM_B_LSC_RATIO_1;                               /* 07F0, 0x1A0057F0 */
	UINT32                                          rsv_07F4[3];                                     /* 07F4..07FF, 0x1A0057F4..1A0057FF */
	CAM_B_REG_AF_CON                                CAM_B_AF_CON;                                    /* 0800, 0x1A005800 */
	CAM_B_REG_AF_TH_0                               CAM_B_AF_TH_0;                                   /* 0804, 0x1A005804 */
	CAM_B_REG_AF_TH_1                               CAM_B_AF_TH_1;                                   /* 0808, 0x1A005808 */
	CAM_B_REG_AF_FLT_1                              CAM_B_AF_FLT_1;                                  /* 080C, 0x1A00580C */
	CAM_B_REG_AF_FLT_2                              CAM_B_AF_FLT_2;                                  /* 0810, 0x1A005810 */
	CAM_B_REG_AF_FLT_3                              CAM_B_AF_FLT_3;                                  /* 0814, 0x1A005814 */
	CAM_B_REG_AF_FLT_4                              CAM_B_AF_FLT_4;                                  /* 0818, 0x1A005818 */
	CAM_B_REG_AF_FLT_5                              CAM_B_AF_FLT_5;                                  /* 081C, 0x1A00581C */
	CAM_B_REG_AF_FLT_6                              CAM_B_AF_FLT_6;                                  /* 0820, 0x1A005820 */
	CAM_B_REG_AF_FLT_7                              CAM_B_AF_FLT_7;                                  /* 0824, 0x1A005824 */
	CAM_B_REG_AF_FLT_8                              CAM_B_AF_FLT_8;                                  /* 0828, 0x1A005828 */
	UINT32                                          rsv_082C;                                        /* 082C, 0x1A00582C */
	CAM_B_REG_AF_SIZE                               CAM_B_AF_SIZE;                                   /* 0830, 0x1A005830 */
	CAM_B_REG_AF_VLD                                CAM_B_AF_VLD;                                    /* 0834, 0x1A005834 */
	CAM_B_REG_AF_BLK_0                              CAM_B_AF_BLK_0;                                  /* 0838, 0x1A005838 */
	CAM_B_REG_AF_BLK_1                              CAM_B_AF_BLK_1;                                  /* 083C, 0x1A00583C */
	CAM_B_REG_AF_TH_2                               CAM_B_AF_TH_2;                                   /* 0840, 0x1A005840 */
	UINT32                                          rsv_0844[15];                                    /* 0844..087F, 0x1A005844..1A00587F */
	CAM_B_REG_LCS25_CON                             CAM_B_LCS25_CON;                                 /* 0880, 0x1A005880 */
	CAM_B_REG_LCS25_ST                              CAM_B_LCS25_ST;                                  /* 0884, 0x1A005884 */
	CAM_B_REG_LCS25_AWS                             CAM_B_LCS25_AWS;                                 /* 0888, 0x1A005888 */
	CAM_B_REG_LCS25_FLR                             CAM_B_LCS25_FLR;                                 /* 088C, 0x1A00588C */
	CAM_B_REG_LCS25_LRZR_1                          CAM_B_LCS25_LRZR_1;                              /* 0890, 0x1A005890 */
	CAM_B_REG_LCS25_LRZR_2                          CAM_B_LCS25_LRZR_2;                              /* 0894, 0x1A005894 */
	CAM_B_REG_LCS25_SATU_1                          CAM_B_LCS25_SATU_1;                              /* 0898, 0x1A005898 */
	CAM_B_REG_LCS25_SATU_2                          CAM_B_LCS25_SATU_2;                              /* 089C, 0x1A00589C */
	CAM_B_REG_LCS25_GAIN_1                          CAM_B_LCS25_GAIN_1;                              /* 08A0, 0x1A0058A0 */
	CAM_B_REG_LCS25_GAIN_2                          CAM_B_LCS25_GAIN_2;                              /* 08A4, 0x1A0058A4 */
	CAM_B_REG_LCS25_OFST_1                          CAM_B_LCS25_OFST_1;                              /* 08A8, 0x1A0058A8 */
	CAM_B_REG_LCS25_OFST_2                          CAM_B_LCS25_OFST_2;                              /* 08AC, 0x1A0058AC */
	CAM_B_REG_LCS25_G2G_CNV_1                       CAM_B_LCS25_G2G_CNV_1;                           /* 08B0, 0x1A0058B0 */
	CAM_B_REG_LCS25_G2G_CNV_2                       CAM_B_LCS25_G2G_CNV_2;                           /* 08B4, 0x1A0058B4 */
	CAM_B_REG_LCS25_G2G_CNV_3                       CAM_B_LCS25_G2G_CNV_3;                           /* 08B8, 0x1A0058B8 */
	CAM_B_REG_LCS25_G2G_CNV_4                       CAM_B_LCS25_G2G_CNV_4;                           /* 08BC, 0x1A0058BC */
	CAM_B_REG_LCS25_G2G_CNV_5                       CAM_B_LCS25_G2G_CNV_5;                           /* 08C0, 0x1A0058C0 */
	CAM_B_REG_LCS25_LPF                             CAM_B_LCS25_LPF;                                 /* 08C4, 0x1A0058C4 */
	UINT32                                          rsv_08C8[10];                                    /* 08C8..08EF, 0x1A0058C8..1A0058EF */
	CAM_B_REG_RCP_CROP_CON1                         CAM_B_RCP_CROP_CON1;                             /* 08F0, 0x1A0058F0 */
	CAM_B_REG_RCP_CROP_CON2                         CAM_B_RCP_CROP_CON2;                             /* 08F4, 0x1A0058F4 */
	UINT32                                          rsv_08F8[2];                                     /* 08F8..08FF, 0x1A0058F8..1A0058FF */
	CAM_B_REG_SGG1_PGN                              CAM_B_SGG1_PGN;                                  /* 0900, 0x1A005900 */
	CAM_B_REG_SGG1_GMRC_1                           CAM_B_SGG1_GMRC_1;                               /* 0904, 0x1A005904 */
	CAM_B_REG_SGG1_GMRC_2                           CAM_B_SGG1_GMRC_2;                               /* 0908, 0x1A005908 */
	UINT32                                          rsv_090C;                                        /* 090C, 0x1A00590C */
	CAM_B_REG_QBN2_MODE                             CAM_B_QBN2_MODE;                                 /* 0910, 0x1A005910 */
	UINT32                                          rsv_0914[3];                                     /* 0914..091F, 0x1A005914..1A00591F */
	CAM_B_REG_AWB_WIN_ORG                           CAM_B_AWB_WIN_ORG;                               /* 0920, 0x1A005920 */
	CAM_B_REG_AWB_WIN_SIZE                          CAM_B_AWB_WIN_SIZE;                              /* 0924, 0x1A005924 */
	CAM_B_REG_AWB_WIN_PIT                           CAM_B_AWB_WIN_PIT;                               /* 0928, 0x1A005928 */
	CAM_B_REG_AWB_WIN_NUM                           CAM_B_AWB_WIN_NUM;                               /* 092C, 0x1A00592C */
	CAM_B_REG_AWB_GAIN1_0                           CAM_B_AWB_GAIN1_0;                               /* 0930, 0x1A005930 */
	CAM_B_REG_AWB_GAIN1_1                           CAM_B_AWB_GAIN1_1;                               /* 0934, 0x1A005934 */
	CAM_B_REG_AWB_LMT1_0                            CAM_B_AWB_LMT1_0;                                /* 0938, 0x1A005938 */
	CAM_B_REG_AWB_LMT1_1                            CAM_B_AWB_LMT1_1;                                /* 093C, 0x1A00593C */
	CAM_B_REG_AWB_LOW_THR                           CAM_B_AWB_LOW_THR;                               /* 0940, 0x1A005940 */
	CAM_B_REG_AWB_HI_THR                            CAM_B_AWB_HI_THR;                                /* 0944, 0x1A005944 */
	CAM_B_REG_AWB_PIXEL_CNT0                        CAM_B_AWB_PIXEL_CNT0;                            /* 0948, 0x1A005948 */
	CAM_B_REG_AWB_PIXEL_CNT1                        CAM_B_AWB_PIXEL_CNT1;                            /* 094C, 0x1A00594C */
	CAM_B_REG_AWB_PIXEL_CNT2                        CAM_B_AWB_PIXEL_CNT2;                            /* 0950, 0x1A005950 */
	CAM_B_REG_AWB_ERR_THR                           CAM_B_AWB_ERR_THR;                               /* 0954, 0x1A005954 */
	CAM_B_REG_AWB_ROT                               CAM_B_AWB_ROT;                                   /* 0958, 0x1A005958 */
	CAM_B_REG_AWB_L0_X                              CAM_B_AWB_L0_X;                                  /* 095C, 0x1A00595C */
	CAM_B_REG_AWB_L0_Y                              CAM_B_AWB_L0_Y;                                  /* 0960, 0x1A005960 */
	CAM_B_REG_AWB_L1_X                              CAM_B_AWB_L1_X;                                  /* 0964, 0x1A005964 */
	CAM_B_REG_AWB_L1_Y                              CAM_B_AWB_L1_Y;                                  /* 0968, 0x1A005968 */
	CAM_B_REG_AWB_L2_X                              CAM_B_AWB_L2_X;                                  /* 096C, 0x1A00596C */
	CAM_B_REG_AWB_L2_Y                              CAM_B_AWB_L2_Y;                                  /* 0970, 0x1A005970 */
	CAM_B_REG_AWB_L3_X                              CAM_B_AWB_L3_X;                                  /* 0974, 0x1A005974 */
	CAM_B_REG_AWB_L3_Y                              CAM_B_AWB_L3_Y;                                  /* 0978, 0x1A005978 */
	CAM_B_REG_AWB_L4_X                              CAM_B_AWB_L4_X;                                  /* 097C, 0x1A00597C */
	CAM_B_REG_AWB_L4_Y                              CAM_B_AWB_L4_Y;                                  /* 0980, 0x1A005980 */
	CAM_B_REG_AWB_L5_X                              CAM_B_AWB_L5_X;                                  /* 0984, 0x1A005984 */
	CAM_B_REG_AWB_L5_Y                              CAM_B_AWB_L5_Y;                                  /* 0988, 0x1A005988 */
	CAM_B_REG_AWB_L6_X                              CAM_B_AWB_L6_X;                                  /* 098C, 0x1A00598C */
	CAM_B_REG_AWB_L6_Y                              CAM_B_AWB_L6_Y;                                  /* 0990, 0x1A005990 */
	CAM_B_REG_AWB_L7_X                              CAM_B_AWB_L7_X;                                  /* 0994, 0x1A005994 */
	CAM_B_REG_AWB_L7_Y                              CAM_B_AWB_L7_Y;                                  /* 0998, 0x1A005998 */
	CAM_B_REG_AWB_L8_X                              CAM_B_AWB_L8_X;                                  /* 099C, 0x1A00599C */
	CAM_B_REG_AWB_L8_Y                              CAM_B_AWB_L8_Y;                                  /* 09A0, 0x1A0059A0 */
	CAM_B_REG_AWB_L9_X                              CAM_B_AWB_L9_X;                                  /* 09A4, 0x1A0059A4 */
	CAM_B_REG_AWB_L9_Y                              CAM_B_AWB_L9_Y;                                  /* 09A8, 0x1A0059A8 */
	CAM_B_REG_AWB_SPARE                             CAM_B_AWB_SPARE;                                 /* 09AC, 0x1A0059AC */
	CAM_B_REG_AWB_MOTION_THR                        CAM_B_AWB_MOTION_THR;                            /* 09B0, 0x1A0059B0 */
	CAM_B_REG_AWB_RC_CNV_0                          CAM_B_AWB_RC_CNV_0;                              /* 09B4, 0x1A0059B4 */
	CAM_B_REG_AWB_RC_CNV_1                          CAM_B_AWB_RC_CNV_1;                              /* 09B8, 0x1A0059B8 */
	CAM_B_REG_AWB_RC_CNV_2                          CAM_B_AWB_RC_CNV_2;                              /* 09BC, 0x1A0059BC */
	CAM_B_REG_AWB_RC_CNV_3                          CAM_B_AWB_RC_CNV_3;                              /* 09C0, 0x1A0059C0 */
	CAM_B_REG_AWB_RC_CNV_4                          CAM_B_AWB_RC_CNV_4;                              /* 09C4, 0x1A0059C4 */
	UINT32                                          rsv_09C8[6];                                     /* 09C8..09DF, 0x1A0059C8..1A0059DF */
	CAM_B_REG_AE_HST_CTL                            CAM_B_AE_HST_CTL;                                /* 09E0, 0x1A0059E0 */
	CAM_B_REG_AE_GAIN2_0                            CAM_B_AE_GAIN2_0;                                /* 09E4, 0x1A0059E4 */
	CAM_B_REG_AE_GAIN2_1                            CAM_B_AE_GAIN2_1;                                /* 09E8, 0x1A0059E8 */
	CAM_B_REG_AE_LMT2_0                             CAM_B_AE_LMT2_0;                                 /* 09EC, 0x1A0059EC */
	CAM_B_REG_AE_LMT2_1                             CAM_B_AE_LMT2_1;                                 /* 09F0, 0x1A0059F0 */
	CAM_B_REG_AE_RC_CNV_0                           CAM_B_AE_RC_CNV_0;                               /* 09F4, 0x1A0059F4 */
	CAM_B_REG_AE_RC_CNV_1                           CAM_B_AE_RC_CNV_1;                               /* 09F8, 0x1A0059F8 */
	CAM_B_REG_AE_RC_CNV_2                           CAM_B_AE_RC_CNV_2;                               /* 09FC, 0x1A0059FC */
	CAM_B_REG_AE_RC_CNV_3                           CAM_B_AE_RC_CNV_3;                               /* 0A00, 0x1A005A00 */
	CAM_B_REG_AE_RC_CNV_4                           CAM_B_AE_RC_CNV_4;                               /* 0A04, 0x1A005A04 */
	CAM_B_REG_AE_YGAMMA_0                           CAM_B_AE_YGAMMA_0;                               /* 0A08, 0x1A005A08 */
	CAM_B_REG_AE_YGAMMA_1                           CAM_B_AE_YGAMMA_1;                               /* 0A0C, 0x1A005A0C */
	CAM_B_REG_AE_HST_SET                            CAM_B_AE_HST_SET;                                /* 0A10, 0x1A005A10 */
	CAM_B_REG_AE_HST0_RNG                           CAM_B_AE_HST0_RNG;                               /* 0A14, 0x1A005A14 */
	CAM_B_REG_AE_HST1_RNG                           CAM_B_AE_HST1_RNG;                               /* 0A18, 0x1A005A18 */
	CAM_B_REG_AE_HST2_RNG                           CAM_B_AE_HST2_RNG;                               /* 0A1C, 0x1A005A1C */
	CAM_B_REG_AE_HST3_RNG                           CAM_B_AE_HST3_RNG;                               /* 0A20, 0x1A005A20 */
	CAM_B_REG_AE_SPARE                              CAM_B_AE_SPARE;                                  /* 0A24, 0x1A005A24 */
	CAM_B_REG_AE_OVER_EXPO_CFG                      CAM_B_AE_OVER_EXPO_CFG;                          /* 0A28, 0x1A005A28 */
	CAM_B_REG_AE_PIX_HST_CTL                        CAM_B_AE_PIX_HST_CTL;                            /* 0A2C, 0x1A005A2C */
	CAM_B_REG_AE_PIX_HST_SET                        CAM_B_AE_PIX_HST_SET;                            /* 0A30, 0x1A005A30 */
	CAM_B_REG_AE_PIX_HST0_YRNG                      CAM_B_AE_PIX_HST0_YRNG;                          /* 0A34, 0x1A005A34 */
	CAM_B_REG_AE_PIX_HST0_XRNG                      CAM_B_AE_PIX_HST0_XRNG;                          /* 0A38, 0x1A005A38 */
	CAM_B_REG_AE_PIX_HST1_YRNG                      CAM_B_AE_PIX_HST1_YRNG;                          /* 0A3C, 0x1A005A3C */
	CAM_B_REG_AE_PIX_HST1_XRNG                      CAM_B_AE_PIX_HST1_XRNG;                          /* 0A40, 0x1A005A40 */
	CAM_B_REG_AE_PIX_HST2_YRNG                      CAM_B_AE_PIX_HST2_YRNG;                          /* 0A44, 0x1A005A44 */
	CAM_B_REG_AE_PIX_HST2_XRNG                      CAM_B_AE_PIX_HST2_XRNG;                          /* 0A48, 0x1A005A48 */
	CAM_B_REG_AE_PIX_HST3_YRNG                      CAM_B_AE_PIX_HST3_YRNG;                          /* 0A4C, 0x1A005A4C */
	CAM_B_REG_AE_PIX_HST3_XRNG                      CAM_B_AE_PIX_HST3_XRNG;                          /* 0A50, 0x1A005A50 */
	CAM_B_REG_AE_HST_SEL                            CAM_B_AE_HST_SEL;                                /* 0A54, 0x1A005A54 */
	CAM_B_REG_AE_STAT_EN                            CAM_B_AE_STAT_EN;                                /* 0A58, 0x1A005A58 */
	CAM_B_REG_AE_YCOEF                              CAM_B_AE_YCOEF;                                  /* 0A5C, 0x1A005A5C */
	UINT32                                          rsv_0A60[24];                                    /* 0A60..0ABF, 0x1A005A60..1A005ABF */
	CAM_B_REG_QBN1_MODE                             CAM_B_QBN1_MODE;                                 /* 0AC0, 0x1A005AC0 */
	UINT32                                          rsv_0AC4[3];                                     /* 0AC4..0ACF, 0x1A005AC4..1A005ACF */
	CAM_B_REG_CPG_SATU_1                            CAM_B_CPG_SATU_1;                                /* 0AD0, 0x1A005AD0 */
	CAM_B_REG_CPG_SATU_2                            CAM_B_CPG_SATU_2;                                /* 0AD4, 0x1A005AD4 */
	CAM_B_REG_CPG_GAIN_1                            CAM_B_CPG_GAIN_1;                                /* 0AD8, 0x1A005AD8 */
	CAM_B_REG_CPG_GAIN_2                            CAM_B_CPG_GAIN_2;                                /* 0ADC, 0x1A005ADC */
	CAM_B_REG_CPG_OFST_1                            CAM_B_CPG_OFST_1;                                /* 0AE0, 0x1A005AE0 */
	CAM_B_REG_CPG_OFST_2                            CAM_B_CPG_OFST_2;                                /* 0AE4, 0x1A005AE4 */
	UINT32                                          rsv_0AE8[2];                                     /* 0AE8..0AEF, 0x1A005AE8..1A005AEF */
	CAM_B_REG_CAC_TILE_SIZE                         CAM_B_CAC_TILE_SIZE;                             /* 0AF0, 0x1A005AF0 */
	CAM_B_REG_CAC_TILE_OFFSET                       CAM_B_CAC_TILE_OFFSET;                           /* 0AF4, 0x1A005AF4 */
	UINT32                                          rsv_0AF8[2];                                     /* 0AF8..0AFF, 0x1A005AF8..1A005AFF */
	CAM_B_REG_PMX_CTL                               CAM_B_PMX_CTL;                                   /* 0B00, 0x1A005B00 */
	CAM_B_REG_PMX_CROP                              CAM_B_PMX_CROP;                                  /* 0B04, 0x1A005B04 */
	CAM_B_REG_PMX_VSIZE                             CAM_B_PMX_VSIZE;                                 /* 0B08, 0x1A005B08 */
	UINT32                                          rsv_0B0C[13];                                    /* 0B0C..0B3F, 0x1A005B0C..1A005B3F */
	CAM_B_REG_VBN_GAIN                              CAM_B_VBN_GAIN;                                  /* 0B40, 0x1A005B40 */
	CAM_B_REG_VBN_OFST                              CAM_B_VBN_OFST;                                  /* 0B44, 0x1A005B44 */
	CAM_B_REG_VBN_TYPE                              CAM_B_VBN_TYPE;                                  /* 0B48, 0x1A005B48 */
	CAM_B_REG_VBN_SPARE                             CAM_B_VBN_SPARE;                                 /* 0B4C, 0x1A005B4C */
	UINT32                                          rsv_0B50[4];                                     /* 0B50..0B5F, 0x1A005B50..1A005B5F */
	CAM_B_REG_AMX_CTL                               CAM_B_AMX_CTL;                                   /* 0B60, 0x1A005B60 */
	CAM_B_REG_AMX_CROP                              CAM_B_AMX_CROP;                                  /* 0B64, 0x1A005B64 */
	CAM_B_REG_AMX_VSIZE                             CAM_B_AMX_VSIZE;                                 /* 0B68, 0x1A005B68 */
	UINT32                                          rsv_0B6C[5];                                     /* 0B6C..0B7F, 0x1A005B6C..1A005B7F */
	CAM_B_REG_BIN_CTL                               CAM_B_BIN_CTL;                                   /* 0B80, 0x1A005B80 */
	CAM_B_REG_BIN_FTH                               CAM_B_BIN_FTH;                                   /* 0B84, 0x1A005B84 */
	CAM_B_REG_BIN_SPARE                             CAM_B_BIN_SPARE;                                 /* 0B88, 0x1A005B88 */
	UINT32                                          rsv_0B8C[5];                                     /* 0B8C..0B9F, 0x1A005B8C..1A005B9F */
	CAM_B_REG_DBN_GAIN                              CAM_B_DBN_GAIN;                                  /* 0BA0, 0x1A005BA0 */
	CAM_B_REG_DBN_OFST                              CAM_B_DBN_OFST;                                  /* 0BA4, 0x1A005BA4 */
	CAM_B_REG_DBN_SPARE                             CAM_B_DBN_SPARE;                                 /* 0BA8, 0x1A005BA8 */
	UINT32                                          rsv_0BAC;                                        /* 0BAC, 0x1A005BAC */
	CAM_B_REG_PBN_TYPE                              CAM_B_PBN_TYPE;                                  /* 0BB0, 0x1A005BB0 */
	CAM_B_REG_PBN_LST                               CAM_B_PBN_LST;                                   /* 0BB4, 0x1A005BB4 */
	CAM_B_REG_PBN_VSIZE                             CAM_B_PBN_VSIZE;                                 /* 0BB8, 0x1A005BB8 */
	UINT32                                          rsv_0BBC;                                        /* 0BBC, 0x1A005BBC */
	CAM_B_REG_RCP3_CROP_CON1                        CAM_B_RCP3_CROP_CON1;                            /* 0BC0, 0x1A005BC0 */
	CAM_B_REG_RCP3_CROP_CON2                        CAM_B_RCP3_CROP_CON2;                            /* 0BC4, 0x1A005BC4 */
	UINT32                                          rsv_0BC8[14];                                    /* 0BC8..0BFF, 0x1A005BC8..1A005BFF */
	CAM_B_REG_DBS_SIGMA                             CAM_B_DBS_SIGMA;                                 /* 0C00, 0x1A005C00 */
	CAM_B_REG_DBS_BSTBL_0                           CAM_B_DBS_BSTBL_0;                               /* 0C04, 0x1A005C04 */
	CAM_B_REG_DBS_BSTBL_1                           CAM_B_DBS_BSTBL_1;                               /* 0C08, 0x1A005C08 */
	CAM_B_REG_DBS_BSTBL_2                           CAM_B_DBS_BSTBL_2;                               /* 0C0C, 0x1A005C0C */
	CAM_B_REG_DBS_BSTBL_3                           CAM_B_DBS_BSTBL_3;                               /* 0C10, 0x1A005C10 */
	CAM_B_REG_DBS_CTL                               CAM_B_DBS_CTL;                                   /* 0C14, 0x1A005C14 */
	CAM_B_REG_DBS_CTL_2                             CAM_B_DBS_CTL_2;                                 /* 0C18, 0x1A005C18 */
	CAM_B_REG_DBS_SIGMA_2                           CAM_B_DBS_SIGMA_2;                               /* 0C1C, 0x1A005C1C */
	CAM_B_REG_DBS_YGN                               CAM_B_DBS_YGN;                                   /* 0C20, 0x1A005C20 */
	CAM_B_REG_DBS_SL_Y12                            CAM_B_DBS_SL_Y12;                                /* 0C24, 0x1A005C24 */
	CAM_B_REG_DBS_SL_Y34                            CAM_B_DBS_SL_Y34;                                /* 0C28, 0x1A005C28 */
	CAM_B_REG_DBS_SL_G12                            CAM_B_DBS_SL_G12;                                /* 0C2C, 0x1A005C2C */
	CAM_B_REG_DBS_SL_G34                            CAM_B_DBS_SL_G34;                                /* 0C30, 0x1A005C30 */
	UINT32                                          rsv_0C34[3];                                     /* 0C34..0C3F, 0x1A005C34..1A005C3F */
	CAM_B_REG_SL2F_CEN                              CAM_B_SL2F_CEN;                                  /* 0C40, 0x1A005C40 */
	CAM_B_REG_SL2F_RR_CON0                          CAM_B_SL2F_RR_CON0;                              /* 0C44, 0x1A005C44 */
	CAM_B_REG_SL2F_RR_CON1                          CAM_B_SL2F_RR_CON1;                              /* 0C48, 0x1A005C48 */
	CAM_B_REG_SL2F_GAIN                             CAM_B_SL2F_GAIN;                                 /* 0C4C, 0x1A005C4C */
	CAM_B_REG_SL2F_RZ                               CAM_B_SL2F_RZ;                                   /* 0C50, 0x1A005C50 */
	CAM_B_REG_SL2F_XOFF                             CAM_B_SL2F_XOFF;                                 /* 0C54, 0x1A005C54 */
	CAM_B_REG_SL2F_YOFF                             CAM_B_SL2F_YOFF;                                 /* 0C58, 0x1A005C58 */
	CAM_B_REG_SL2F_SLP_CON0                         CAM_B_SL2F_SLP_CON0;                             /* 0C5C, 0x1A005C5C */
	CAM_B_REG_SL2F_SLP_CON1                         CAM_B_SL2F_SLP_CON1;                             /* 0C60, 0x1A005C60 */
	CAM_B_REG_SL2F_SIZE                             CAM_B_SL2F_SIZE;                                 /* 0C64, 0x1A005C64 */
	UINT32                                          rsv_0C68[38];                                    /* 0C68..0CFF, 0x1A005C68..1A005CFF */
	CAM_B_REG_QBN4_MODE                             CAM_B_QBN4_MODE;                                 /* 0D00, 0x1A005D00 */
	UINT32                                          rsv_0D04[3];                                     /* 0D04..0D0F, 0x1A005D04..1A005D0F */
	CAM_B_REG_PS_AWB_WIN_ORG                        CAM_B_PS_AWB_WIN_ORG;                            /* 0D10, 0x1A005D10 */
	CAM_B_REG_PS_AWB_WIN_SIZE                       CAM_B_PS_AWB_WIN_SIZE;                           /* 0D14, 0x1A005D14 */
	CAM_B_REG_PS_AWB_WIN_PIT                        CAM_B_PS_AWB_WIN_PIT;                            /* 0D18, 0x1A005D18 */
	CAM_B_REG_PS_AWB_WIN_NUM                        CAM_B_PS_AWB_WIN_NUM;                            /* 0D1C, 0x1A005D1C */
	CAM_B_REG_PS_AWB_PIXEL_CNT0                     CAM_B_PS_AWB_PIXEL_CNT0;                         /* 0D20, 0x1A005D20 */
	CAM_B_REG_PS_AWB_PIXEL_CNT1                     CAM_B_PS_AWB_PIXEL_CNT1;                         /* 0D24, 0x1A005D24 */
	CAM_B_REG_PS_AWB_PIXEL_CNT2                     CAM_B_PS_AWB_PIXEL_CNT2;                         /* 0D28, 0x1A005D28 */
	CAM_B_REG_PS_AWB_PIXEL_CNT3                     CAM_B_PS_AWB_PIXEL_CNT3;                         /* 0D2C, 0x1A005D2C */
	CAM_B_REG_PS_AE_YCOEF0                          CAM_B_PS_AE_YCOEF0;                              /* 0D30, 0x1A005D30 */
	CAM_B_REG_PS_AE_YCOEF1                          CAM_B_PS_AE_YCOEF1;                              /* 0D34, 0x1A005D34 */
	UINT32                                          rsv_0D38[18];                                    /* 0D38..0D7F, 0x1A005D38..1A005D7F */
	CAM_B_REG_PSO_BASE_ADDR                         CAM_B_PSO_BASE_ADDR;                             /* 0D80, 0x1A005D80 */
	UINT32                                          rsv_0D84;                                        /* 0D84, 0x1A005D84 */
	CAM_B_REG_PSO_OFST_ADDR                         CAM_B_PSO_OFST_ADDR;                             /* 0D88, 0x1A005D88 */
	UINT32                                          rsv_0D8C;                                        /* 0D8C, 0x1A005D8C */
	CAM_B_REG_PSO_XSIZE                             CAM_B_PSO_XSIZE;                                 /* 0D90, 0x1A005D90 */
	CAM_B_REG_PSO_YSIZE                             CAM_B_PSO_YSIZE;                                 /* 0D94, 0x1A005D94 */
	CAM_B_REG_PSO_STRIDE                            CAM_B_PSO_STRIDE;                                /* 0D98, 0x1A005D98 */
	CAM_B_REG_PSO_CON                               CAM_B_PSO_CON;                                   /* 0D9C, 0x1A005D9C */
	CAM_B_REG_PSO_CON2                              CAM_B_PSO_CON2;                                  /* 0DA0, 0x1A005DA0 */
	CAM_B_REG_PSO_CON3                              CAM_B_PSO_CON3;                                  /* 0DA4, 0x1A005DA4 */
	CAM_B_REG_PSO_ERR_STAT                          CAM_B_PSO_ERR_STAT;                              /* 0DA8, 0x1A005DA8 */
	UINT32                                          rsv_0DAC;                                        /* 0DAC, 0x1A005DAC */
	CAM_B_REG_PSO_FH_SPARE_2                        CAM_B_PSO_FH_SPARE_2;                            /* 0DB0, 0x1A005DB0 */
	CAM_B_REG_PSO_FH_SPARE_3                        CAM_B_PSO_FH_SPARE_3;                            /* 0DB4, 0x1A005DB4 */
	CAM_B_REG_PSO_FH_SPARE_4                        CAM_B_PSO_FH_SPARE_4;                            /* 0DB8, 0x1A005DB8 */
	CAM_B_REG_PSO_FH_SPARE_5                        CAM_B_PSO_FH_SPARE_5;                            /* 0DBC, 0x1A005DBC */
	CAM_B_REG_PSO_FH_SPARE_6                        CAM_B_PSO_FH_SPARE_6;                            /* 0DC0, 0x1A005DC0 */
	CAM_B_REG_PSO_FH_SPARE_7                        CAM_B_PSO_FH_SPARE_7;                            /* 0DC4, 0x1A005DC4 */
	CAM_B_REG_PSO_FH_SPARE_8                        CAM_B_PSO_FH_SPARE_8;                            /* 0DC8, 0x1A005DC8 */
	CAM_B_REG_PSO_FH_SPARE_9                        CAM_B_PSO_FH_SPARE_9;                            /* 0DCC, 0x1A005DCC */
	CAM_B_REG_PSO_FH_SPARE_10                       CAM_B_PSO_FH_SPARE_10;                           /* 0DD0, 0x1A005DD0 */
	CAM_B_REG_PSO_FH_SPARE_11                       CAM_B_PSO_FH_SPARE_11;                           /* 0DD4, 0x1A005DD4 */
	CAM_B_REG_PSO_FH_SPARE_12                       CAM_B_PSO_FH_SPARE_12;                           /* 0DD8, 0x1A005DD8 */
	CAM_B_REG_PSO_FH_SPARE_13                       CAM_B_PSO_FH_SPARE_13;                           /* 0DDC, 0x1A005DDC */
	CAM_B_REG_PSO_FH_SPARE_14                       CAM_B_PSO_FH_SPARE_14;                           /* 0DE0, 0x1A005DE0 */
	CAM_B_REG_PSO_FH_SPARE_15                       CAM_B_PSO_FH_SPARE_15;                           /* 0DE4, 0x1A005DE4 */
	CAM_B_REG_PSO_FH_SPARE_16                       CAM_B_PSO_FH_SPARE_16;                           /* 0DE8, 0x1A005DE8 */
	UINT32                                          rsv_0DEC[5];                                     /* 0DEC..0DFF, 0x1A005DEC..1A005DFF */
	CAM_B_REG_DMA_FRAME_HEADER_EN                   CAM_B_DMA_FRAME_HEADER_EN;                       /* 0E00, 0x1A005E00 */
	CAM_B_REG_IMGO_FH_BASE_ADDR                     CAM_B_IMGO_FH_BASE_ADDR;                         /* 0E04, 0x1A005E04 */
	CAM_B_REG_RRZO_FH_BASE_ADDR                     CAM_B_RRZO_FH_BASE_ADDR;                         /* 0E08, 0x1A005E08 */
	CAM_B_REG_AAO_FH_BASE_ADDR                      CAM_B_AAO_FH_BASE_ADDR;                          /* 0E0C, 0x1A005E0C */
	CAM_B_REG_AFO_FH_BASE_ADDR                      CAM_B_AFO_FH_BASE_ADDR;                          /* 0E10, 0x1A005E10 */
	CAM_B_REG_LCSO_FH_BASE_ADDR                     CAM_B_LCSO_FH_BASE_ADDR;                         /* 0E14, 0x1A005E14 */
	CAM_B_REG_UFEO_FH_BASE_ADDR                     CAM_B_UFEO_FH_BASE_ADDR;                         /* 0E18, 0x1A005E18 */
	CAM_B_REG_PDO_FH_BASE_ADDR                      CAM_B_PDO_FH_BASE_ADDR;                          /* 0E1C, 0x1A005E1C */
	CAM_B_REG_PSO_FH_BASE_ADDR                      CAM_B_PSO_FH_BASE_ADDR;                          /* 0E20, 0x1A005E20 */
	UINT32                                          rsv_0E24[3];                                     /* 0E24..0E2F, 0x1A005E24..1A005E2F */
	CAM_B_REG_IMGO_FH_SPARE_2                       CAM_B_IMGO_FH_SPARE_2;                           /* 0E30, 0x1A005E30 */
	CAM_B_REG_IMGO_FH_SPARE_3                       CAM_B_IMGO_FH_SPARE_3;                           /* 0E34, 0x1A005E34 */
	CAM_B_REG_IMGO_FH_SPARE_4                       CAM_B_IMGO_FH_SPARE_4;                           /* 0E38, 0x1A005E38 */
	CAM_B_REG_IMGO_FH_SPARE_5                       CAM_B_IMGO_FH_SPARE_5;                           /* 0E3C, 0x1A005E3C */
	CAM_B_REG_IMGO_FH_SPARE_6                       CAM_B_IMGO_FH_SPARE_6;                           /* 0E40, 0x1A005E40 */
	CAM_B_REG_IMGO_FH_SPARE_7                       CAM_B_IMGO_FH_SPARE_7;                           /* 0E44, 0x1A005E44 */
	CAM_B_REG_IMGO_FH_SPARE_8                       CAM_B_IMGO_FH_SPARE_8;                           /* 0E48, 0x1A005E48 */
	CAM_B_REG_IMGO_FH_SPARE_9                       CAM_B_IMGO_FH_SPARE_9;                           /* 0E4C, 0x1A005E4C */
	CAM_B_REG_IMGO_FH_SPARE_10                      CAM_B_IMGO_FH_SPARE_10;                          /* 0E50, 0x1A005E50 */
	CAM_B_REG_IMGO_FH_SPARE_11                      CAM_B_IMGO_FH_SPARE_11;                          /* 0E54, 0x1A005E54 */
	CAM_B_REG_IMGO_FH_SPARE_12                      CAM_B_IMGO_FH_SPARE_12;                          /* 0E58, 0x1A005E58 */
	CAM_B_REG_IMGO_FH_SPARE_13                      CAM_B_IMGO_FH_SPARE_13;                          /* 0E5C, 0x1A005E5C */
	CAM_B_REG_IMGO_FH_SPARE_14                      CAM_B_IMGO_FH_SPARE_14;                          /* 0E60, 0x1A005E60 */
	CAM_B_REG_IMGO_FH_SPARE_15                      CAM_B_IMGO_FH_SPARE_15;                          /* 0E64, 0x1A005E64 */
	CAM_B_REG_IMGO_FH_SPARE_16                      CAM_B_IMGO_FH_SPARE_16;                          /* 0E68, 0x1A005E68 */
	UINT32                                          rsv_0E6C;                                        /* 0E6C, 0x1A005E6C */
	CAM_B_REG_RRZO_FH_SPARE_2                       CAM_B_RRZO_FH_SPARE_2;                           /* 0E70, 0x1A005E70 */
	CAM_B_REG_RRZO_FH_SPARE_3                       CAM_B_RRZO_FH_SPARE_3;                           /* 0E74, 0x1A005E74 */
	CAM_B_REG_RRZO_FH_SPARE_4                       CAM_B_RRZO_FH_SPARE_4;                           /* 0E78, 0x1A005E78 */
	CAM_B_REG_RRZO_FH_SPARE_5                       CAM_B_RRZO_FH_SPARE_5;                           /* 0E7C, 0x1A005E7C */
	CAM_B_REG_RRZO_FH_SPARE_6                       CAM_B_RRZO_FH_SPARE_6;                           /* 0E80, 0x1A005E80 */
	CAM_B_REG_RRZO_FH_SPARE_7                       CAM_B_RRZO_FH_SPARE_7;                           /* 0E84, 0x1A005E84 */
	CAM_B_REG_RRZO_FH_SPARE_8                       CAM_B_RRZO_FH_SPARE_8;                           /* 0E88, 0x1A005E88 */
	CAM_B_REG_RRZO_FH_SPARE_9                       CAM_B_RRZO_FH_SPARE_9;                           /* 0E8C, 0x1A005E8C */
	CAM_B_REG_RRZO_FH_SPARE_10                      CAM_B_RRZO_FH_SPARE_10;                          /* 0E90, 0x1A005E90 */
	CAM_B_REG_RRZO_FH_SPARE_11                      CAM_B_RRZO_FH_SPARE_11;                          /* 0E94, 0x1A005E94 */
	CAM_B_REG_RRZO_FH_SPARE_12                      CAM_B_RRZO_FH_SPARE_12;                          /* 0E98, 0x1A005E98 */
	CAM_B_REG_RRZO_FH_SPARE_13                      CAM_B_RRZO_FH_SPARE_13;                          /* 0E9C, 0x1A005E9C */
	CAM_B_REG_RRZO_FH_SPARE_14                      CAM_B_RRZO_FH_SPARE_14;                          /* 0EA0, 0x1A005EA0 */
	CAM_B_REG_RRZO_FH_SPARE_15                      CAM_B_RRZO_FH_SPARE_15;                          /* 0EA4, 0x1A005EA4 */
	CAM_B_REG_RRZO_FH_SPARE_16                      CAM_B_RRZO_FH_SPARE_16;                          /* 0EA8, 0x1A005EA8 */
	UINT32                                          rsv_0EAC;                                        /* 0EAC, 0x1A005EAC */
	CAM_B_REG_AAO_FH_SPARE_2                        CAM_B_AAO_FH_SPARE_2;                            /* 0EB0, 0x1A005EB0 */
	CAM_B_REG_AAO_FH_SPARE_3                        CAM_B_AAO_FH_SPARE_3;                            /* 0EB4, 0x1A005EB4 */
	CAM_B_REG_AAO_FH_SPARE_4                        CAM_B_AAO_FH_SPARE_4;                            /* 0EB8, 0x1A005EB8 */
	CAM_B_REG_AAO_FH_SPARE_5                        CAM_B_AAO_FH_SPARE_5;                            /* 0EBC, 0x1A005EBC */
	CAM_B_REG_AAO_FH_SPARE_6                        CAM_B_AAO_FH_SPARE_6;                            /* 0EC0, 0x1A005EC0 */
	CAM_B_REG_AAO_FH_SPARE_7                        CAM_B_AAO_FH_SPARE_7;                            /* 0EC4, 0x1A005EC4 */
	CAM_B_REG_AAO_FH_SPARE_8                        CAM_B_AAO_FH_SPARE_8;                            /* 0EC8, 0x1A005EC8 */
	CAM_B_REG_AAO_FH_SPARE_9                        CAM_B_AAO_FH_SPARE_9;                            /* 0ECC, 0x1A005ECC */
	CAM_B_REG_AAO_FH_SPARE_10                       CAM_B_AAO_FH_SPARE_10;                           /* 0ED0, 0x1A005ED0 */
	CAM_B_REG_AAO_FH_SPARE_11                       CAM_B_AAO_FH_SPARE_11;                           /* 0ED4, 0x1A005ED4 */
	CAM_B_REG_AAO_FH_SPARE_12                       CAM_B_AAO_FH_SPARE_12;                           /* 0ED8, 0x1A005ED8 */
	CAM_B_REG_AAO_FH_SPARE_13                       CAM_B_AAO_FH_SPARE_13;                           /* 0EDC, 0x1A005EDC */
	CAM_B_REG_AAO_FH_SPARE_14                       CAM_B_AAO_FH_SPARE_14;                           /* 0EE0, 0x1A005EE0 */
	CAM_B_REG_AAO_FH_SPARE_15                       CAM_B_AAO_FH_SPARE_15;                           /* 0EE4, 0x1A005EE4 */
	CAM_B_REG_AAO_FH_SPARE_16                       CAM_B_AAO_FH_SPARE_16;                           /* 0EE8, 0x1A005EE8 */
	UINT32                                          rsv_0EEC;                                        /* 0EEC, 0x1A005EEC */
	CAM_B_REG_AFO_FH_SPARE_2                        CAM_B_AFO_FH_SPARE_2;                            /* 0EF0, 0x1A005EF0 */
	CAM_B_REG_AFO_FH_SPARE_3                        CAM_B_AFO_FH_SPARE_3;                            /* 0EF4, 0x1A005EF4 */
	CAM_B_REG_AFO_FH_SPARE_4                        CAM_B_AFO_FH_SPARE_4;                            /* 0EF8, 0x1A005EF8 */
	CAM_B_REG_AFO_FH_SPARE_5                        CAM_B_AFO_FH_SPARE_5;                            /* 0EFC, 0x1A005EFC */
	CAM_B_REG_AFO_FH_SPARE_6                        CAM_B_AFO_FH_SPARE_6;                            /* 0F00, 0x1A005F00 */
	CAM_B_REG_AFO_FH_SPARE_7                        CAM_B_AFO_FH_SPARE_7;                            /* 0F04, 0x1A005F04 */
	CAM_B_REG_AFO_FH_SPARE_8                        CAM_B_AFO_FH_SPARE_8;                            /* 0F08, 0x1A005F08 */
	CAM_B_REG_AFO_FH_SPARE_9                        CAM_B_AFO_FH_SPARE_9;                            /* 0F0C, 0x1A005F0C */
	CAM_B_REG_AFO_FH_SPARE_10                       CAM_B_AFO_FH_SPARE_10;                           /* 0F10, 0x1A005F10 */
	CAM_B_REG_AFO_FH_SPARE_11                       CAM_B_AFO_FH_SPARE_11;                           /* 0F14, 0x1A005F14 */
	CAM_B_REG_AFO_FH_SPARE_12                       CAM_B_AFO_FH_SPARE_12;                           /* 0F18, 0x1A005F18 */
	CAM_B_REG_AFO_FH_SPARE_13                       CAM_B_AFO_FH_SPARE_13;                           /* 0F1C, 0x1A005F1C */
	CAM_B_REG_AFO_FH_SPARE_14                       CAM_B_AFO_FH_SPARE_14;                           /* 0F20, 0x1A005F20 */
	CAM_B_REG_AFO_FH_SPARE_15                       CAM_B_AFO_FH_SPARE_15;                           /* 0F24, 0x1A005F24 */
	CAM_B_REG_AFO_FH_SPARE_16                       CAM_B_AFO_FH_SPARE_16;                           /* 0F28, 0x1A005F28 */
	UINT32                                          rsv_0F2C;                                        /* 0F2C, 0x1A005F2C */
	CAM_B_REG_LCSO_FH_SPARE_2                       CAM_B_LCSO_FH_SPARE_2;                           /* 0F30, 0x1A005F30 */
	CAM_B_REG_LCSO_FH_SPARE_3                       CAM_B_LCSO_FH_SPARE_3;                           /* 0F34, 0x1A005F34 */
	CAM_B_REG_LCSO_FH_SPARE_4                       CAM_B_LCSO_FH_SPARE_4;                           /* 0F38, 0x1A005F38 */
	CAM_B_REG_LCSO_FH_SPARE_5                       CAM_B_LCSO_FH_SPARE_5;                           /* 0F3C, 0x1A005F3C */
	CAM_B_REG_LCSO_FH_SPARE_6                       CAM_B_LCSO_FH_SPARE_6;                           /* 0F40, 0x1A005F40 */
	CAM_B_REG_LCSO_FH_SPARE_7                       CAM_B_LCSO_FH_SPARE_7;                           /* 0F44, 0x1A005F44 */
	CAM_B_REG_LCSO_FH_SPARE_8                       CAM_B_LCSO_FH_SPARE_8;                           /* 0F48, 0x1A005F48 */
	CAM_B_REG_LCSO_FH_SPARE_9                       CAM_B_LCSO_FH_SPARE_9;                           /* 0F4C, 0x1A005F4C */
	CAM_B_REG_LCSO_FH_SPARE_10                      CAM_B_LCSO_FH_SPARE_10;                          /* 0F50, 0x1A005F50 */
	CAM_B_REG_LCSO_FH_SPARE_11                      CAM_B_LCSO_FH_SPARE_11;                          /* 0F54, 0x1A005F54 */
	CAM_B_REG_LCSO_FH_SPARE_12                      CAM_B_LCSO_FH_SPARE_12;                          /* 0F58, 0x1A005F58 */
	CAM_B_REG_LCSO_FH_SPARE_13                      CAM_B_LCSO_FH_SPARE_13;                          /* 0F5C, 0x1A005F5C */
	CAM_B_REG_LCSO_FH_SPARE_14                      CAM_B_LCSO_FH_SPARE_14;                          /* 0F60, 0x1A005F60 */
	CAM_B_REG_LCSO_FH_SPARE_15                      CAM_B_LCSO_FH_SPARE_15;                          /* 0F64, 0x1A005F64 */
	CAM_B_REG_LCSO_FH_SPARE_16                      CAM_B_LCSO_FH_SPARE_16;                          /* 0F68, 0x1A005F68 */
	UINT32                                          rsv_0F6C;                                        /* 0F6C, 0x1A005F6C */
	CAM_B_REG_UFEO_FH_SPARE_2                       CAM_B_UFEO_FH_SPARE_2;                           /* 0F70, 0x1A005F70 */
	CAM_B_REG_UFEO_FH_SPARE_3                       CAM_B_UFEO_FH_SPARE_3;                           /* 0F74, 0x1A005F74 */
	CAM_B_REG_UFEO_FH_SPARE_4                       CAM_B_UFEO_FH_SPARE_4;                           /* 0F78, 0x1A005F78 */
	CAM_B_REG_UFEO_FH_SPARE_5                       CAM_B_UFEO_FH_SPARE_5;                           /* 0F7C, 0x1A005F7C */
	CAM_B_REG_UFEO_FH_SPARE_6                       CAM_B_UFEO_FH_SPARE_6;                           /* 0F80, 0x1A005F80 */
	CAM_B_REG_UFEO_FH_SPARE_7                       CAM_B_UFEO_FH_SPARE_7;                           /* 0F84, 0x1A005F84 */
	CAM_B_REG_UFEO_FH_SPARE_8                       CAM_B_UFEO_FH_SPARE_8;                           /* 0F88, 0x1A005F88 */
	CAM_B_REG_UFEO_FH_SPARE_9                       CAM_B_UFEO_FH_SPARE_9;                           /* 0F8C, 0x1A005F8C */
	CAM_B_REG_UFEO_FH_SPARE_10                      CAM_B_UFEO_FH_SPARE_10;                          /* 0F90, 0x1A005F90 */
	CAM_B_REG_UFEO_FH_SPARE_11                      CAM_B_UFEO_FH_SPARE_11;                          /* 0F94, 0x1A005F94 */
	CAM_B_REG_UFEO_FH_SPARE_12                      CAM_B_UFEO_FH_SPARE_12;                          /* 0F98, 0x1A005F98 */
	CAM_B_REG_UFEO_FH_SPARE_13                      CAM_B_UFEO_FH_SPARE_13;                          /* 0F9C, 0x1A005F9C */
	CAM_B_REG_UFEO_FH_SPARE_14                      CAM_B_UFEO_FH_SPARE_14;                          /* 0FA0, 0x1A005FA0 */
	CAM_B_REG_UFEO_FH_SPARE_15                      CAM_B_UFEO_FH_SPARE_15;                          /* 0FA4, 0x1A005FA4 */
	CAM_B_REG_UFEO_FH_SPARE_16                      CAM_B_UFEO_FH_SPARE_16;                          /* 0FA8, 0x1A005FA8 */
	UINT32                                          rsv_0FAC;                                        /* 0FAC, 0x1A005FAC */
	CAM_B_REG_PDO_FH_SPARE_2                        CAM_B_PDO_FH_SPARE_2;                            /* 0FB0, 0x1A005FB0 */
	CAM_B_REG_PDO_FH_SPARE_3                        CAM_B_PDO_FH_SPARE_3;                            /* 0FB4, 0x1A005FB4 */
	CAM_B_REG_PDO_FH_SPARE_4                        CAM_B_PDO_FH_SPARE_4;                            /* 0FB8, 0x1A005FB8 */
	CAM_B_REG_PDO_FH_SPARE_5                        CAM_B_PDO_FH_SPARE_5;                            /* 0FBC, 0x1A005FBC */
	CAM_B_REG_PDO_FH_SPARE_6                        CAM_B_PDO_FH_SPARE_6;                            /* 0FC0, 0x1A005FC0 */
	CAM_B_REG_PDO_FH_SPARE_7                        CAM_B_PDO_FH_SPARE_7;                            /* 0FC4, 0x1A005FC4 */
	CAM_B_REG_PDO_FH_SPARE_8                        CAM_B_PDO_FH_SPARE_8;                            /* 0FC8, 0x1A005FC8 */
	CAM_B_REG_PDO_FH_SPARE_9                        CAM_B_PDO_FH_SPARE_9;                            /* 0FCC, 0x1A005FCC */
	CAM_B_REG_PDO_FH_SPARE_10                       CAM_B_PDO_FH_SPARE_10;                           /* 0FD0, 0x1A005FD0 */
	CAM_B_REG_PDO_FH_SPARE_11                       CAM_B_PDO_FH_SPARE_11;                           /* 0FD4, 0x1A005FD4 */
	CAM_B_REG_PDO_FH_SPARE_12                       CAM_B_PDO_FH_SPARE_12;                           /* 0FD8, 0x1A005FD8 */
	CAM_B_REG_PDO_FH_SPARE_13                       CAM_B_PDO_FH_SPARE_13;                           /* 0FDC, 0x1A005FDC */
	CAM_B_REG_PDO_FH_SPARE_14                       CAM_B_PDO_FH_SPARE_14;                           /* 0FE0, 0x1A005FE0 */
	CAM_B_REG_PDO_FH_SPARE_15                       CAM_B_PDO_FH_SPARE_15;                           /* 0FE4, 0x1A005FE4 */
	CAM_B_REG_PDO_FH_SPARE_16                       CAM_B_PDO_FH_SPARE_16;                           /* 0FE8, 0x1A005FE8 */
	UINT32                                          rsv_0FEC[5];                                     /* 0FEC..0FFF, 1A005FEC..1A005FFF */
}cam_b_reg_t;
