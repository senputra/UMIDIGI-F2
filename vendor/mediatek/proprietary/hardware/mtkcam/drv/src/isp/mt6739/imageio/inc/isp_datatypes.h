...
public:
    ...
    public:
        MdpRotDMACfg():
            pixel_byte(1),capbility(0x00),crop_en(0),uv_plane_swap(0),Format(CRZ_DRV_FORMAT_YUV422),Plane(CRZ_DRV_PLANE_1),Sequence(CRZ_DRV_SEQUENCE_YVYU),Rotation(CRZ_DRV_ROTATION_0),withCropM(0),enSrcCrop(0),srcCropX(0),srcCropFloatX(0),srcCropY(0),srcCropFloatY(0),srcCropW(0),srcCropH(0),Flip(0)
            {};
};
