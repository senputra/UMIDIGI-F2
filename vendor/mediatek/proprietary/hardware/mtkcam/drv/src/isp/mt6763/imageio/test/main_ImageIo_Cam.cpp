...
#define EIS_YSIZE   0x0
    ...
    /* 0x3554 */ eis_cfg._EIS_REG.CTRL_2 = (0x0000506C/*RSTVAL*/);
    ...
    */
    ...
    if(this->bypass_imgo == MFALSE){
        ...
        for(MUINT32 i=0;i<(this->m_subSample+1);i++){
            ...
            printf("enque_imgo: pa:%p_%p,mag:0x%x,crop:%d_%d_%d_%d,rawtype:%d\n",\
                (MUINT8*)rQBufInfo.vBufInfo.at(i).u4BufPA[0],\
    ...
    if(this->bypass_rrzo == MFALSE){
        ...
        for(MUINT32 i=0;i<(this->m_subSample+1);i++){
            ...
            rQBufInfo.vBufInfo[i].u4BufSize[0]  = (MUINT32)this->buf_rrzo[this->ring_cnt*(this->m_subSample+1) + i].size;
            rQBufInfo.vBufInfo[i].u4BufVA[0]    = (MUINTPTR)this->buf_rrzo[this->ring_cnt*(this->m_subSample+1) + i].virtAddr;
            rQBufInfo.vBufInfo[i].u4BufPA[0]    = (MUINTPTR)this->buf_rrzo[this->ring_cnt*(this->m_subSample+1) + i].phyAddr;
            rQBufInfo.vBufInfo[i].Frame_Header.u4BufSize    = (MUINT32)this->buf_rrzo_fh[this->ring_cnt*(this->m_subSample+1) + i].size;
            rQBufInfo.vBufInfo[i].Frame_Header.u4BufVA      = (MUINTPTR)this->buf_rrzo_fh[this->ring_cnt*(this->m_subSample+1) + i].virtAddr;
            rQBufInfo.vBufInfo[i].Frame_Header.u4BufPA      = (MUINTPTR)this->buf_rrzo_fh[this->ring_cnt*(this->m_subSample+1) + i].phyAddr;
    ...
    if(this->bypass_eiso == MFALSE){
        for(MUINT32 i=0;i<(this->m_subSample+1);i++){
            ...
            rQBufInfo.vBufInfo[i].u4BufSize[0]  = (MUINT32)this->buf_eiso[this->ring_cnt*(this->m_subSample+1) + i].size;
            rQBufInfo.vBufInfo[i].u4BufVA[0]    = (MUINTPTR)this->buf_eiso[this->ring_cnt*(this->m_subSample+1) + i].virtAddr;
            rQBufInfo.vBufInfo[i].u4BufPA[0]    = (MUINTPTR)this->buf_eiso[this->ring_cnt*(this->m_subSample+1) + i].phyAddr;
            rQBufInfo.vBufInfo[i].Frame_Header.u4BufSize    = (MUINT32)this->buf_eiso_fh[this->ring_cnt*(this->m_subSample+1) + i].size;
            rQBufInfo.vBufInfo[i].Frame_Header.u4BufVA      = (MUINTPTR)this->buf_eiso_fh[this->ring_cnt*(this->m_subSample+1) + i].virtAddr;
            rQBufInfo.vBufInfo[i].Frame_Header.u4BufPA      = (MUINTPTR)this->buf_eiso_fh[this->ring_cnt*(this->m_subSample+1) + i].phyAddr;
    ...
    if(this->bypass_af == MFALSE){
        ...
        rQBufInfo.vBufInfo[0].u4BufSize[0]  = (MUINT32)this->buf_afo[this->ring_cnt].size;
        rQBufInfo.vBufInfo[0].u4BufVA[0]    = (MUINTPTR)this->buf_afo[this->ring_cnt].virtAddr;
        rQBufInfo.vBufInfo[0].u4BufPA[0]    = (MUINTPTR)this->buf_afo[this->ring_cnt].phyAddr;
        rQBufInfo.vBufInfo[0].Frame_Header.u4BufSize    = (MUINT32)this->buf_afo_fh[this->ring_cnt].size;
        rQBufInfo.vBufInfo[0].Frame_Header.u4BufVA      = (MUINTPTR)this->buf_afo_fh[this->ring_cnt].virtAddr;
        rQBufInfo.vBufInfo[0].Frame_Header.u4BufPA      = (MUINTPTR)this->buf_afo_fh[this->ring_cnt].phyAddr;
        ...
        printf("enque_afo: pa:%p_%p,crop:%d_%d_%d_%d\n",\
            (MUINT8*)rQBufInfo.vBufInfo.at(0).u4BufPA[0],\
...
int TEST_CAMIO::deque(void)
{
    ...
    if(this->bypass_imgo == MFALSE){
        ...
        for(UINT32 i=0;i<rQBufInfo.vBufInfo.size();i++){
            printf("##############################\n");
            printf("deque_imgo_%d: pa:%px_%p,mag:0x%x,time:0x%x_0x%x,tg size:%dx%d,crop:%d_%d_%d_%d\n",i,\
                (MUINT8*)rQBufInfo.vBufInfo.at(i).u4BufPA[0],\
                (MUINT8*)rQBufInfo.vBufInfo.at(i).Frame_Header.u4BufPA,\
                rQBufInfo.vBufInfo.at(i).m_num,\
    ...
    if(this->bypass_rrzo == MFALSE){
        ...
        for(UINT32 i=0;i<rQBufInfo.vBufInfo.size();i++){
            printf("##############################\n");
            printf("deque_rrzo_%d: pa:%p_%p,mag:0x%x,time:0x%x_0x%x,tg size:%dx%d,crop:%d_%d_%d_%d,out:%d_%d\n",i,\
                (MUINT8*)rQBufInfo.vBufInfo.at(i).u4BufPA[0],\
                (MUINT8*)rQBufInfo.vBufInfo.at(i).Frame_Header.u4BufPA,\
                rQBufInfo.vBufInfo.at(i).m_num,\
                rQBufInfo.vBufInfo.at(i).i4TimeStamp_sec,\
    ...
    if(this->bypass_eiso == MFALSE){
        ...
        for(UINT32 i=0;i<rQBufInfo.vBufInfo.size();i++){
            printf("##############################\n");
            printf("deque_eiso_%d: pa:%p_%p,mag:0x%x,time:0x%x_0x%x\n",i,\
                (MUINT8*)rQBufInfo.vBufInfo.at(i).u4BufPA[0],\
                (MUINT8*)rQBufInfo.vBufInfo.at(i).Frame_Header.u4BufPA,\
                rQBufInfo.vBufInfo.at(i).m_num,\
                rQBufInfo.vBufInfo.at(i).i4TimeStamp_sec,\
    ...
    if(this->bypass_af == MFALSE){
        ...
        for(UINT32 i=0;i<rQBufInfo.vBufInfo.size();i++){
            printf("##############################\n");
            printf("deque_afo_%d: pa:%p_%p,mag:0x%x,time:0x%x_0x%x,tg size:%dx%d\n",i,\
                (MUINT8*)rQBufInfo.vBufInfo.at(i).u4BufPA[0],\
                (MUINT8*)rQBufInfo.vBufInfo.at(i).Frame_Header.u4BufPA,\
                rQBufInfo.vBufInfo.at(i).m_num,\
                rQBufInfo.vBufInfo.at(i).i4TimeStamp_sec,\
...
int TEST_CAMIO::Case_0(void)
{
    ...
    if (CamInfo.GetCapibility(
            ...
            NSCam::NSIoPipe::NSCamIOPipe::NormalPipe_InputInfo((EImageFormat)this->imgo.eImgFmt, this->imgo.u4ImgWidth, NSCam::NSIoPipe::NSCamIOPipe::_UNKNOWN_PIX_MODE),
        ...
        if(rst.stride_byte != this->imgo.u4Stride[ESTRIDE_1ST_PLANE]){
            printf("cur dma(%d) stride:0x%x, recommanded:0x%x",this->imgo.index,this->imgo.u4Stride[ESTRIDE_1ST_PLANE],rst.stride_byte);
        }
    }
    ...
    this->rrzo.u4Stride[ESTRIDE_1ST_PLANE] = this->buf_rrzo[0].size / rrz_size_h;
    //prepare for enque if needed
    ...
    if (CamInfo.GetCapibility(
            this->rrzo.index,
            NSCam::NSIoPipe::NSCamIOPipe::ENPipeQueryCmd_STRIDE_BYTE,
            NSCam::NSIoPipe::NSCamIOPipe::NormalPipe_InputInfo((EImageFormat)this->rrzo.eImgFmt, this->rrzo.u4ImgWidth, NSCam::NSIoPipe::NSCamIOPipe::_UNKNOWN_PIX_MODE),
            rst, E_CAM_UNKNOWNN) == MFALSE) {
        printf("##############################\n");
        ...
        if(rst.stride_byte != this->rrzo.u4Stride[ESTRIDE_1ST_PLANE]){
            printf("cur dma(%d) stride:0x%x, recommanded:0x%x",this->rrzo.index,this->rrzo.u4Stride[ESTRIDE_1ST_PLANE],rst.stride_byte);
        }
    }
    this->rrzo.u4Stride[ESTRIDE_2ND_PLANE] = 0;//vInPorts.mPortInfo.at(i).mStride[1];
    this->rrzo.u4Stride[ESTRIDE_3RD_PLANE] = 0;//vInPorts.mPortInfo.at(i).mStride[2];
...
int Test_ImageIo_Cam(int argc, char** argv)
{
    ...
    switch(path){
        case 0:
            ...
            pCamio->Surce = ICamIOPipe::TG_A;
            pCamio->TG_PixMode = ePxlMode_One_;
        ...
        case 4:
            ...
            pCamio_2->Surce = ICamIOPipe::TG_B;
            pCamio_2->TG_PixMode = ePxlMode_One_;
        ...
        case 7:
            ...
            pCamio = new TEST_CAMIO(0);
            pCamio->Surce = ICamIOPipe::TG_A;
            pCamio->TG_PixMode = ePxlMode_Two_;
            pCamio->Source_Size = E_8M;
            pCamio->bypass_imgo = MFALSE;
            pCamio->bypass_rrzo = MFALSE;
        ...
        case 21:
         ...
         case 22:
            ...
            pCamio = new TEST_CAMIO(0);
            pCamio->Surce = ICamIOPipe::TG_A;
            pCamio->TG_PixMode = ePxlMode_Four_;
            pCamio->Source_Size = E_8M;
            pCamio->bypass_imgo = MFALSE;
            pCamio->bypass_rrzo = MFALSE;
