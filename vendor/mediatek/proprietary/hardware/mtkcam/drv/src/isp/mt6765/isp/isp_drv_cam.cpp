...
#define ISP_DRV_CQ_DUMMY_TOKEN(Module)   ((ISP_CQ_NOP_INST<<ISP_CQ_INST_BIT)|((CQ_DUMMY_REG + Module*0x1000) & CQ_DES_RANGE))
...
{
    {TWIN_CQ_BASEADDRESS,           0x0168, 0x10a0,  1   }, //this is for twin's master cam use only , use master cam to program salve cam's cq baseaddress
#if TWIN_CQ_SW_WORKAROUND
    {CAM_CQ0_EN_,                   0x0164, 0x0164,  1   }, //this is for twin's master cam use only , due to hw design defect!!(dmx_sel/dmx_id have no db)
    ...
    {CAM_CTL_INT_EN_,               0x4020, 0x0020,  1   },
    {CAM_CTL_INT2_EN_,              0x4030, 0x0030,  1   },
    {CAM_CTL_DONE_SEL_,             0x4044, 0x0044,  3   },
    {CAM_TWIN_INFO,                 0x4050, 0x0050,  2   },
    ...
    {CAM_DMA_IMGO_BA,               0x4220, 0x0220,  1   },
    {CAM_DMA_IMGO_BA_OFST,          0x4228, 0x0228,  1   },
    {CAM_DMA_IMGO_,                 0x4230, 0x0230,  3   },
    {CAM_DMA_IMGO_CROP_,            0x4248, 0x0248,  1   },
    {CAM_DMA_RRZO_BA,               0x4250, 0x0250,  1   },
    {CAM_DMA_RRZO_BA_OFST,          0x4258, 0x0258,  1   },
    {CAM_DMA_RRZO_,                 0x4260, 0x0260,  3   },
    {CAM_DMA_RRZO_CROP_,            0x4278, 0x0278,  1   },
    {CAM_DMA_AAO_BA,                0x4280, 0x0280,  1   },
    {CAM_DMA_AAO_,                  0x4290, 0x0290,  3   },
    {CAM_DMA_AFO_BA,                0x42B0, 0x02B0,  1   },
    {CAM_DMA_AFO_BA_OFST,           0x42B8, 0x02B8,  1   },
    {CAM_DMA_AFO_,                  0x42C0, 0x02C0,  3   },
    {CAM_DMA_LCSO_BA,               0x42E0, 0x02E0,  1   },
    {CAM_DMA_LCSO_,                 0x42F0, 0x02F0,  3   },
    {CAM_DMA_UFEO_BA,               0x4310, 0x0310,  1   },
    {CAM_DMA_UFEO_BA_OFST,          0x4318, 0x0318,  1   },
    {CAM_DMA_UFEO_,                 0x4320, 0x0320,  3   },
    {CAM_DMA_PDO_BA,                0x4340, 0x0340,  1   },
    {CAM_DMA_PDO_,                  0x4350, 0x0350,  3   },
    ...
    {CAM_DMA_FH_AAO_SPARE_,         0x4EB4, 0x0EB4,  14  },
    ...
    {CAM_ISP_DBS_,                  0x4C00, 0x0C00,  13  },/*New regs*/
    {CAM_ISP_OBC_,                  0x45F0, 0x05F0,  8   },
    {CAM_ISP_RMG_,                  0x45A0, 0x05A0,  3   },
    {CAM_ISP_BNR_,                  0x4620, 0x0620,  32  },
    {CAM_ISP_STM_,                  0x46A0, 0x06A0,  2   },
    {CAM_ISP_SCM_,                  0x46B0, 0x06B0,  2   },
    ...
    {CAM_ISP_SL2F_,                 0x4C40, 0x0C40,  12  },
    {CAM_ISP_PCP_CROP_,             0x4CC0, 0x0CC0,  2   },
    {CAM_ISP_SGG2_,                 0x4CD0, 0x0CD0,  3   },
    {CAM_ISP_SL2J_,                 0x4C80, 0x0C80,  12  },
    {CAM_ISP_HLR_,                  0x4850, 0x0850,  12  },
    {CAM_ISP_PSB_,                  0x4CE0, 0x0CE0,  2   },
    {CAM_ISP_PDE_,                  0x4CF0, 0x0CF0,  1   },
    {CAM_ISP_LCS_,                  0x4880, 0x0880,  18  },
    {CAM_ISP_AE_,                   0x49E0, 0x09E0,  27  },
    {CAM_ISP_VBN_,                  0x4B40, 0x0B40,  4   },
...
/*    {UNI_ISP_HDS_B_,                0x3610, 0x0610,  1   }, //TBD
    {UNI_ISP_RSS_B_,                0x3630, 0x0630,  9   },*/
    {UNI_B_CTL_EN_,                   0x3110, 0x0110,  2   },
    {UNI_B_CTL_SEL_,                  0x3118, 0x0118,  1   },
    {UNI_B_CTL_FMT_,                  0x311C, 0x011C,  1   },
    {UNI_B_FBC_FLKO_,                 0x3180, 0x0180,  1   },
    {UNI_B_FBC_EISO_,                 0x3188, 0x0188,  1   },
    {UNI_B_FBC_RSSO_,                 0x3190, 0x0190,  1   },
    {UNI_B_DMA_V_FLIP_,               0x3604, 0x0604,  1   },
    {UNI_B_DMA_EISO_BA,               0x3620, 0x0620,  2   },
    {UNI_B_DMA_EISO_,                 0x3628, 0x0628,  5   },
    {UNI_B_DMA_FLKO_BA,               0x3650, 0x0650,  1   },
    {UNI_B_DMA_FLKO_,                 0x3658, 0x0658,  5   },
    {UNI_B_DMA_RSSO_A_BA,             0x3680, 0x0680,  2   },
    {UNI_B_DMA_RSSO_A_,               0x3688, 0x0688,  5   },
    {UNI_B_DMA_RSSO_B_BA,             0x36B0, 0x06B0,  2   },
    {UNI_B_DMA_RSSO_B_,               0x36B8, 0x06B8,  5   },
    {UNI_B_DMA_RAWI_,                 0x3740, 0x0740,  7   },
    {UNI_B_DMA_FH_EN_,                0x37C0, 0x07C0,  1   },
    {UNI_B_DMA_FH_EISO_,              0x37C4, 0x07C4,  1   },
    {UNI_B_DMA_FH_EISO_SPARE_,        0x37E0, 0x07E0,  15  },
    {UNI_B_DMA_FH_FLKO_,              0x37C8, 0x07C8,  1   },
    {UNI_B_DMA_FH_FLKO_SPARE_MAGIC_,  0x3820, 0x0820,  1   },
    {UNI_B_DMA_FH_FLKO_SPARE_,        0x3824, 0x0824,  14  },
    {UNI_B_DMA_FH_RSSO_A_,            0x37CC, 0x07CC,  1   },
    {UNI_B_DMA_FH_RSSO_A_SPARE_,      0x3860, 0x0860,  15  },
    {UNI_B_DMA_FH_RSSO_B_,            0x37D0, 0x07D0,  1   },
    {UNI_B_DMA_FH_RSSO_B_SPARE_,      0x38A0, 0x08A0,  15  },
    {UNI_B_ISP_UNP2_,                 0x3900, 0x0900,  1   },
    {UNI_B_ISP_SGG3_,                 0x3920, 0x0920,  3   },
    {UNI_B_ISP_FLK_,                  0x3930, 0x0930,  4   },
    {UNI_B_ISP_HDS_,                  0x39A0, 0x09A0,  1   },
    {UNI_B_ISP_EIS_,                  0x3950, 0x0950,  9   },
    {UNI_B_ISP_RSS_,                  0x39C0, 0x09C0,  9   },
    {CAM_DUMMY_,                    0x4FFC, 0x0FFC,  1   },
    {CAM_CTL_FBC_RCNT_INC_,         0x4060, 0x0060,  1   }, //must be allocated after all FBC_en descirptor
    {CAM_CQ_EN_,                    0x4160, 0x0160,  1   }, //control
...
#define MAX_ION_BUFFER_KEEP_CNT /*512*/ 0 //optmize cpu usage, but need redesign

android::Mutex  gIonTableMutex[CAM_B + 1];
std::vector<ION_MEM_HANDLE_ST_NODE> gIonTable[CAM_B + 1];
...
ISP_DRV_CAM::ISP_DRV_CAM(ISP_HW_MODULE module,E_ISP_CAM_CQ cq,MUINT32 pageIdx)
{
    ...
    m_IspVirRegSize_method1 = 0;

    m_Module = module;
    switch(module){
        case CAM_A_TWIN://this is a virtual hw
            m_HWModule = CAM_B;
            break;
        default:
            m_HWModule = module;
...
MBOOL ISP_DRV_CAM::CQ_Allocate_method1(MUINT32 step)
{
    ...
    switch(step){
        case 0:
            // allocate virCmdQ
            LOG_DBG("virQ rage:0x%x",m_IspVirRegSize_method1);
            ...
            //imem allocate
            this->m_ispVirRegBufInfo.size = ((m_IspVirRegSize_method1 + 0x3) & (~0x3)); //4byte alignment,round up
            ...
            if(( (_tmpVirAddr=this->m_ispVirRegBufInfo.virtAddr) % 0x4) != 0 ){
                LOG_INF("iMem virRegAddr not 4 bytes alignment(0x%" PRIXPTR "), round up",this->m_ispVirRegBufInfo.virtAddr);
                _tmpVirAddr = (this->m_ispVirRegBufInfo.virtAddr + 0x3) & (~0x3);
            }
            if(( (_tmpPhyAddr=this->m_ispVirRegBufInfo.phyAddr) % 0x4) != 0 ){
                LOG_INF("iMem phyRegAddr not 4 bytes alignment(0x%" PRIXPTR "), round up",this->m_ispVirRegBufInfo.phyAddr);
                _tmpPhyAddr = (this->m_ispVirRegBufInfo.phyAddr + 0x3) & (~0x3);
            }
            //va/pa 0 init
            memset((MUINT8*)_tmpVirAddr,0x0,m_IspVirRegSize_method1);
            ...
            if(( (_tmpVirAddr=this->m_ispCQDescBufInfo.virtAddr) % 0x4) != 0 ){
                LOG_INF("iMem virDescriptAddr not 4 bytes alignment(0x%" PRIXPTR "), round up",this->m_ispCQDescBufInfo.virtAddr);
                _tmpVirAddr = (this->m_ispCQDescBufInfo.virtAddr + 0x3) & (~0x3);
            }
            if(( (_tmpPhyAddr=this->m_ispCQDescBufInfo.phyAddr) % 0x4) != 0 ){
                LOG_INF("iMem phyDescriptAddr not 4 bytes alignment(0x%" PRIXPTR "), round up",this->m_ispCQDescBufInfo.phyAddr);
...
MBOOL ISP_DRV_CAM::init(const char* userName)
{
    ...
    m_IspVirRegSize_method1 = (((CAM_BASE_RANGE_SPECIAL + UNI_BASE_RANGE) + PAGE_SIZE) / PAGE_SIZE) * PAGE_SIZE;
    ...
    if(1){//(this->m_bInit[this->m_HWModule] == MFALSE){
        ...
        this->m_bInit[this->m_Module] = MTRUE;
    }
...
MBOOL ISP_DRV_CAM::uninit(const char* userName)
{
    ...
    for(MUINT32 i=0;i<ISP_DRV_CAM_BASIC_CQ_NUM;i++){
        for(MUINT32 j=0;j<Max_PageNum;j++){
            if(gPageTbl[this->m_Module][i][j] != NULL){
                bClr++;
    ...
    if(bClr <= 1){
        this->m_bInit[this->m_Module] = MFALSE;
    }
#endif
...
MBOOL ISP_DRV_CAM::getDeviceInfo(E_DEVICE_INFO eCmd,MUINT8* pData)
{
    ...
    switch(eCmd){
        ...
        case _GET_START_TIME:
            ...
            LOG_INF("_GET_START_TIME Check pData size:%zd",sizeof(pData));
            break;

        case _GET_TRANSFOR_CCU_REG:

            if(ioctl(this->m_pIspDrvImp->m_Fd,ISP_TRANSFOR_CCU_REG,(unsigned char*)pData) < 0){
                LOG_INF("_GET_TRANSFOR_CCU_REG Check pData 0 size:%zd",sizeof(pData));
                LOG_ERR("_GET_TRANSFOR_CCU_REG fail\n");
                rst = MFALSE;
            }
            LOG_INF("_GET_TRANSFOR_CCU_REG Check pData 1 size:%zd",sizeof(pData));
            break;
        ...
        case _GET_SUPPORTED_ISP_CLOCKS:
            if(ioctl(this->m_pIspDrvImp->m_Fd,ISP_GET_SUPPORTED_ISP_CLOCKS,(ISP_CLK_INFO*)pData) < 0){
...
MBOOL ISP_DRV_CAM::setDeviceInfo(E_DEVICE_INFO eCmd,MUINT8* pData)
{
    ...
    switch(eCmd){
        ...
        case _SET_ION_HANDLE:
            if(((ION_MEM_HANDLE_ST_NODE*)pData)->ionNode.memID <= 0) {
                LOG_ERR("_set_ion_handle error, memID(%d)\n",
                    ((ION_MEM_HANDLE_ST_NODE*)pData)->ionNode.memID);
                return MFALSE;
            }
            {
                gIonTableMutex[this->m_HWModule].lock();
                for(MUINT32 i = 0 ; i < gIonTable[this->m_HWModule].size() ; i++){
                    if(gIonTable[this->m_HWModule].at(i).ionNode.memID == ((ION_MEM_HANDLE_ST_NODE*)pData)->ionNode.memID){
                        gIonTable[this->m_HWModule].at(i).ionCnt = 1;
                        gIonTableMutex[this->m_HWModule].unlock();
                        return MTRUE;
                    }
                }
                gIonTableMutex[this->m_HWModule].unlock();
            }
            {
                ...
                node.dmaPort = ((ION_MEM_HANDLE_ST_NODE*)pData)->ionNode.dmaPort;
                node.memID = ((ION_MEM_HANDLE_ST_NODE*)pData)->ionNode.memID;
                ...
                switch(this->m_HWModule){
                    ...
                    case CAM_B: node.devNode = (unsigned int)ISP_CAM_B_IDX;
                        break;
                    default:
                        LOG_ERR("unsupported module:%d\n",((ION_MEM_HANDLE_ST_NODE*)pData)->ionNode.devNode);
                        break;
                }
                ...
                // add new ion table node
                gIonTableMutex[this->m_HWModule].lock();
                if(gIonTable[this->m_HWModule].size() < MAX_ION_BUFFER_KEEP_CNT){
                    ION_MEM_HANDLE_ST_NODE tNode;
                    tNode.ionNode = ((ION_MEM_HANDLE_ST_NODE*)pData)->ionNode;
                    tNode.ionCnt = 1;
                    gIonTable[this->m_HWModule].push_back(tNode);
                }
                gIonTableMutex[this->m_HWModule].unlock();
                //
        ...
        case _SET_ION_FREE:
            ...
            }
            {
                ...
                for(MUINT32 i = 0 ; i < gIonTable[this->m_HWModule].size() ; i++){
                    if(gIonTable[this->m_HWModule].at(i).ionNode.memID == ((ION_MEM_HANDLE_ST_NODE*)pData)->ionNode.memID){
                        gIonTable[this->m_HWModule].at(i).ionCnt = 0;
                        gIonTableMutex[this->m_HWModule].unlock();
                        return MTRUE;
                    }
                }
        ...
        case _SET_ION_FREE_BY_HWMODULE:
            ...
            {
                gIonTableMutex[*pData].lock();
                gIonTable[*pData].clear();
                gIonTableMutex[*pData].unlock();
            }
        ...
        case _SET_SEC_DAPC_REG:
            {
                ...
                dbg[1] = 1; // sec_on
                dbg[2] = this->readReg(0x4, this->m_HWModule);   // CAM_CTL_EN
                dbg[3] = this->readReg(0x8, this->m_HWModule);   // CAM_CTL_DMA_EN
                dbg[4] = this->readReg(0x10, this->m_HWModule);  // CAM_CTL_SEL
//                dbg[5] = this->readReg(0x18, this->m_HWModule);  // CAM_CTL_EN2
                dbg[5] = 0;
...
MBOOL ISP_DRV_CAM::cqAddModule(MUINT32 moduleId, MUINT32 extModuleId)
{
    ...
    switch(moduleId){
        case CAM_NEXT_Thread_:
            ...
            break;
        default:
            if(this->twinPath_CQ_Ctrl(moduleId) == MFALSE){
                LOG_ERR("bypass module:%d with descriptor:%d\n",this->m_Module,moduleId);
                return MFALSE;
            }
...
MBOOL ISP_DRV_CAM::twinPath_CQ_Ctrl(MUINT32 moduleId)
{
    MBOOL ret = MTRUE;
    ...
    switch(moduleId){
        case TWIN_CQ_BASEADDRESS:
            switch(this->m_Module){
                case CAM_A: //case for CAM_A as master cam.
                    mIspCQModuleInfo[moduleId].addr_ofst = (mIspCQModuleInfo[moduleId].addr_ofst&(REG_SIZE-1)) + 0x5000;    //0x5000 is cam_b's BA
                    break;
                case CAM_B: //case for CAM_B as master cam
                    mIspCQModuleInfo[moduleId].addr_ofst = (mIspCQModuleInfo[moduleId].addr_ofst&(REG_SIZE-1)) + 0x4000;    //0x4000 is cam_a's BA
                    break;
                default:
                    ret= MFALSE;
                    break;
...
MBOOL ISP_DRV_CAM::dumpCQTable(void)
{
        ...
        if(this->m_pIspDescript_vir[i].u.cmd != ISP_DRV_CQ_DUMMY_TOKEN(this->m_HWModule)) {
            ...
            for(unsigned int j=0;j<mIspCQModuleInfo[i].reg_num;j++){
                if(mIspCQModuleInfo[i].addr_ofst < 0x4000)
                    snprintf(_tmp, sizeof(_tmp), "0x%08x-",this->readReg(mIspCQModuleInfo[i].sw_addr_ofst + (j*0x4),UNI_A));
                else
                    snprintf(_tmp, sizeof(_tmp), "0x%08x-",this->readReg(mIspCQModuleInfo[i].sw_addr_ofst + (j*0x4)));
                strncat(_str,_tmp, (sizeof(_str) - strlen(_str)) - 1);
            }
            LOG_INF(" %s\n",_str);
            _str[0] = '\0';
        }
    ...
    if(this->m_pIspDescript_vir[CAM_NEXT_Thread_].u.cmd != ISP_DRV_CQ_DUMMY_TOKEN(this->m_HWModule)) {
        ...
        for(unsigned int j=0;j<mIspCQModuleInfo_SpecialCQ[this->m_CQ].reg_num;j++){
            snprintf(_tmp, sizeof(_tmp), "0x%08x-",this->m_pIspVirRegAddr_va[(mIspCQModuleInfo_SpecialCQ[this->m_CQ].sw_addr_ofst >>2) + j]);
            strncat(_str,_tmp, (sizeof(_str) - strlen(_str)) - 1);
        }
        LOG_INF(" %s\n",_str);
        _str[0] = '\0';
    ...
    if(bPhy){
        ...
        for(MUINT32 i=0x0;i<CAM_BASE_RANGE;i+=0x20){
            ...
            for(MUINT32 j=i;j<(i+0x20);j+=0x4){
                ...
                strncat(_chr,_tmpchr,(sizeof(_chr) - strlen(_chr)) - 1);
            }
            LOG_WRN("%s\n",_chr);
        }
        LOG_ERR("###################\n");
        ...
        for(MUINT32 i=0x0;i<CAM_BASE_RANGE_SPECIAL;i+=0x20){
            ...
            for(MUINT32 j=i;j<(i+0x20);j+=0x4){
                if(j >= CAM_BASE_RANGE_SPECIAL)
                    break;
                _tmpchr[0] = '\0';
                snprintf(_tmpchr, sizeof(_tmpchr), "0x%x - ",this->readReg(j,this->m_HWModule));
                strncat(_chr,_tmpchr, (sizeof(_chr) - strlen(_chr)) - 1);
            }
            LOG_WRN("%s\n",_chr);
        }
        ...
        for(MUINT32 i=0x0;i<UNI_BASE_RANGE;i+=0x20){
            _chr[0] = '\0';
            snprintf(_chr, sizeof(_chr), "0x%8x: ",shift + i);
            for(MUINT32 j=i;j<(i+0x20);j+=0x4){
                if(j >= UNI_BASE_RANGE)
                    break;
                _tmpchr[0] = '\0';
                snprintf(_tmpchr, sizeof(_tmpchr), "0x%x - ",this->readReg(j,UNI_A));
                strncat(_chr,_tmpchr, (sizeof(_chr) - strlen(_chr)) - 1);
            }
            LOG_WRN("%s\n",_chr);
        }
...
MBOOL ISP_DRV_CAM::readRegs(ISP_DRV_REG_IO_STRUCT*  pRegIo,MUINT32 Count,MINT32 caller)
{
    ...
    if((pRegIo[0].Addr >= legal_range) || ((pRegIo[0].Addr + 4 * Count) >= legal_range)){
        LOG_ERR("over range(0x%x_%d)\n",pRegIo[0].Addr,Count);
        return MFALSE;
    }

    for(unsigned int i=0; i<Count; i++){
        pRegIo[i].Addr = pRegIo[0].Addr + i * 4;
...
MUINT32 ISP_DRV_CAM::readReg(MUINT32 Addr,MINT32 caller)
{
    ...
    switch(caller){
        ...
        case UNI_A:
            legal_range = UNI_BASE_RANGE;
            if (this->m_Module == CAM_B) {
                if ((Addr < 0x100) && (Addr >= 0x4))
                    Addr += 0x100;
                else if (Addr >= 0x200)
                    Addr += 0x400;
            }
...
MBOOL ISP_DRV_CAM::writeRegs(ISP_DRV_REG_IO_STRUCT*  pRegIo,MUINT32 Count,MINT32 caller)
{
    ...
    switch(caller){
        ...
        case UNI_A:
            legal_range = UNI_BASE_RANGE;
            if (this->m_Module == CAM_B) {
                if ((pRegIo[0].Addr < 0x100) && (pRegIo[0].Addr >= 0x4))
                    offset = 0x100;
                else if (pRegIo[0].Addr >= 0x200)
                    offset = 0x400;
            }
#if Vir_Buf_Order
            shift = CAM_BASE_RANGE_SPECIAL;
    ...
    if((pRegIo[0].Addr + offset >= legal_range) || ((pRegIo[0].Addr + offset + 4 * Count) >= legal_range)){
        LOG_ERR("over range(0x%x_%d_%d)\n",pRegIo[0].Addr,offset,Count);
        return MFALSE;
    }

    for(unsigned int i=0; i<Count; i++){
        pRegIo[i].Addr = pRegIo[0].Addr + i * 4;
        this->m_pIspVirRegAddr_va[(pRegIo[i].Addr+offset+shift)>>2] = pRegIo[i].Data;
        LOG_DBG("%d:addr:0x%x,data:0x%x",i,(pRegIo[i].Addr+offset),this->m_pIspVirRegAddr_va[(pRegIo[i].Addr+offset+shift)>>2]);
    }
    return MTRUE;
}
        ...
        switch(this->m_CQ){
            ...
            case ISP_DRV_CQ_THRE8:
                ...
                if(this->m_HWModule == CAM_B){
                    moduleid[0] = UNI_B_DMA_FLKO_BA;
                    moduleid[1] = UNI_B_DMA_FH_FLKO_;
                    moduleid[2] = UNI_B_DMA_FH_FLKO_SPARE_;
                }
...
MUINT32* ISP_DRV_CAM::update_FH_Spare(CQ_RingBuf_ST *pBuf_ctrl)
{
    ...
    if(i == pcqrtbcring_va->dma_ring_size){
        ...
        for(i=0;i<pcqrtbcring_va->dma_ring_size;i++){
            snprintf(_tmp, sizeof(_tmp), "0x%08x-",pcqrtbcring_va->rtbc_ring[i].cq_rtbc.dma_base_pa);
            strncat(_str,_tmp, (sizeof(_str) - strlen(_str)) - 1);
        }
        LOG_ERR("%s\n",_str);
        return NULL;
