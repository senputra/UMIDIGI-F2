...
public:
    CAM_TWIN_PIPE()
    {
        ...
        m_suspend_Rcnt = 0;
        fbc_AAO.Raw = 0xf7f7f7f7; //special value used to recognize is first time to record fbc cnt;
        fbc_PSO.Raw = 0xf7f7f7f7;
        fbc_PDO.Raw = 0xf7f7f7f7;
    };
