...
// These value are input to twin drv: DUAL_IN_CONFIG_STRUCT
// Also, write register that are existed in physical but not in CQ. EX: TG cropping window
MBOOL TwinMgr::prepareDualInCfg()
{
    MBOOL ret = MTRUE;
    ...
    gDualInputParam.dualInCfg->SW.TWIN_AF_MARGIN_L = 0;
    gDualInputParam.dualInCfg->SW.TWIN_AF_MARGIN_R = 0;
...
MUINT32 TwinMgr::CQ_cfg(MINTPTR arg1, MINTPTR arg2)
{
    E_ISP_CAM_CQ cq;
