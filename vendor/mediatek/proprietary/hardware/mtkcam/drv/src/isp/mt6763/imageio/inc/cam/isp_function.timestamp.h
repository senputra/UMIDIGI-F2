...
public:
    ...
    static CAM_TIMESTAMP*   getInstance(ISP_HW_MODULE module,const ISP_DRV_CAM* pDrv);
           ...
           MBOOL            TimeStamp_mapping(MUINT32* pSec, MUINT32* pUsec,_isp_dma_enum_ dma,ISP_HW_MODULE module);
#else
           MBOOL            TimeStamp_mapping(MUINT32* pSec, MUINT32* pUsec,_isp_dma_enum_ dma,ISP_HW_MODULE nocare = CAM_MAX);
#endif
