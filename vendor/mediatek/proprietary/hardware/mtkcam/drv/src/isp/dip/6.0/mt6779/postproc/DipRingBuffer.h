...
struct DipWorkingBuffer
{
    ...
    //
    unsigned long mfbtpipeTablePa;
    unsigned int *mfbtpipeTableVa;
...
class DipRingBuffer
{
    ...
    public:
        ...
        virtual bool skipTpipeCalculatebyIdx(E_ISP_DIP_CQ CmdqId, unsigned int& frameflag, unsigned int& RefRingBufIdx, DipWorkingBuffer* pCurrFrameDipWBuf, unsigned int frameNum)= 0;
...
class DipRingBufferImp : public DipRingBuffer
{
    ...
    public:
        ...
        virtual bool skipTpipeCalculatebyIdx(E_ISP_DIP_CQ CmdqId, unsigned int& frameflag, unsigned int& RefRingBufIdx, DipWorkingBuffer* pCurrFrameDipWBuf, unsigned int frameNum);
    ...
    private:
        ...
        IMEM_BUF_INFO  m_MFBTpipeBufInfo;
