...
#include <mtkcam/utils/std/ULog.h>
    ...
    #define BASE_LOG_VRB(fmt, arg...)       do { CAM_ULOGV(NSCam::Utils::ULog::MOD_DRV_NORMAL_PIPE, DBG_LOG_TAG "[%s] " fmt NEW_LINE_CHAR, __func__, ##arg);  } while(0)	// <Verbose>: Show more detail debug information. E.g. Entry/exit of private function; contain of local variable in function or code block; return value of system function/API...
    #define BASE_LOG_DBG(fmt, arg...)       do { CAM_ULOGD(NSCam::Utils::ULog::MOD_DRV_NORMAL_PIPE, DBG_LOG_TAG "[%s] " fmt NEW_LINE_CHAR, __func__, ##arg);  } while(0)	// <Debug>: Show general debug information. E.g. Change of state machine; entry point or parameters of Public function or OS callback; Start/end of process thread...
    #define BASE_LOG_INF(fmt, arg...)       do { CAM_ULOGD(NSCam::Utils::ULog::MOD_DRV_NORMAL_PIPE, DBG_LOG_TAG "[%s] " fmt NEW_LINE_CHAR, __func__, ##arg);  } while(0)	// <Info>: Show general system information. Like OS version, start/end of Service...
