    ...
    switch(InPut){
        ...
        case TG_CAMSV_0:
            if(gCamsvioPipe[CAMSV_0-CAMSV_START].m_occupied == MTRUE){
                ...
                std::strcpy((char*)gCamsvioPipe[CAMSV_0-CAMSV_START].m_szUsrName,(char const*)szUsrName);
        ...
        case TG_CAMSV_1:
            if(gCamsvioPipe[CAMSV_1-CAMSV_START].m_occupied == MTRUE){
                ...
                std::strcpy((char*)gCamsvioPipe[CAMSV_1-CAMSV_START].m_szUsrName,(char const*)szUsrName);
        ...
        case TG_CAMSV_2:
            if(gCamsvioPipe[CAMSV_2-CAMSV_START].m_occupied == MTRUE){
                ...
                std::strcpy((char*)gCamsvioPipe[CAMSV_2-CAMSV_START].m_szUsrName,(char const*)szUsrName);
        ...
        case TG_CAMSV_3:
            if(gCamsvioPipe[CAMSV_3-CAMSV_START].m_occupied == MTRUE){
                ...
                std::strcpy((char*)gCamsvioPipe[CAMSV_3-CAMSV_START].m_szUsrName,(char const*)szUsrName);
        ...
        case TG_CAMSV_4:
            if(gCamsvioPipe[CAMSV_4-CAMSV_START].m_occupied == MTRUE){
                ...
                std::strcpy((char*)gCamsvioPipe[CAMSV_4-CAMSV_START].m_szUsrName,(char const*)szUsrName);
        ...
        case TG_CAMSV_5:
            if(gCamsvioPipe[CAMSV_5-CAMSV_START].m_occupied == MTRUE){
                ...
                std::strcpy((char*)gCamsvioPipe[CAMSV_5-CAMSV_START].m_szUsrName,(char const*)szUsrName);
