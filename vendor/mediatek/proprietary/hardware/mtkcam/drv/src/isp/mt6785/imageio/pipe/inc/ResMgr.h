...
public:
    ...
    //booking cam resource & get working obj, which isn't needed to be specified by user. user can get module by ResMgr::Res_GetModule() (passive)
     ...
     static ResMgr*         Res_Attach(E_USER user,char Name[32],MUINT32 input, MUINT32 SensorNum);

    static MBOOL            Res_AattachArbitor(MUINT32 index, MUINT32 SensorNum, Res_Arbitor_In* inParams, Res_Arbitor_Out *outParams, char Name[32]);
