...
{
    {7520, 3600,  "No limitation"},
    {6240, 3760,  "Bonding at 25M"},
...
void test_iq_query()
{
    ...
    // query
    if (MFALSE == getNormalPipeModule()->query(
            (MUINT32)ENPipeQueryCmd_IQ_LEVEL,
            (MUINTPTR)&sIQ)) {
        MY_LOGI("ENPipeQueryCmd_IQ_LEVEL is false");
    }
