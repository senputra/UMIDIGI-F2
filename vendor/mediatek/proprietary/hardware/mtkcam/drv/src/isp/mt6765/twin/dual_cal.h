...
#define DUAL_CAC_WD (6144)
#define DUAL_CAC_WD_D (3072)
#define DUAL_AMX_WD_ALL (3400)
#define DUAL_BMX_WD_ALL (3400)
#define DUAL_PMX_WD_ALL (2118)
#define DUAL_RRZ_WD_ALL (4736)
#define DUAL_RRZ_RLB_OFFSET (2368)
...
#define DUAL_HW_A_LIST(CMD, a, b, c, d, e, f) \
    ...
    /* SL2J */\
    CMD(a, b, c, d, e, f, CAM_A_CTL_DMA_EN, SL2J_EN, SL2J_A_EN, U)\
    CMD(a, b, c, d, e, f, CAM_A_SL2J_RZ, SL2_HRZ_COMP, SL2J_A_HRZ_COMP, U)\
    CMD(a, b, c, d, e, f, CAM_A_SL2J_RZ, SL2_VRZ_COMP, SL2J_A_VRZ_COMP, U)\
    CMD(a, b, c, d, e, f, CAM_A_SL2J_XOFF, SL2_X_OFST, SL2J_A_X_OFST, U)\
    CMD(a, b, c, d, e, f, CAM_A_SL2J_YOFF, SL2_Y_OFST, SL2J_A_Y_OFST, U)\
    CMD(a, b, c, d, e, f, CAM_A_SL2J_SIZE, SL2_TPIPE_WD, SL2J_A_TPIPE_WD, U)\
    CMD(a, b, c, d, e, f, CAM_A_SL2J_SIZE, SL2_TPIPE_HT, SL2J_A_TPIPE_HT, U)\
    /* VBN */\
    ...
    /* HLR */\
    CMD(a, b, c, d, e, f, CAM_A_CTL_DMA_EN, HLR_EN, HLR_A_EN, U)\
    /* LSCI */\
    ...
    /* PDO */\
    CMD(a, b, c, d, e, f, CAM_A_CTL_EN, PKP_EN, PKP_A_EN, U)\
    CMD(a, b, c, d, e, f, CAM_A_CTL_DMA_EN, PDO_EN, PDO_A_EN, U)\
    CMD(a, b, c, d, e, f, CAM_A_PDO_BASE_ADDR, BASE_ADDR, PDO_A_BASE_ADDR, U)\
    CMD(a, b, c, d, e, f, CAM_A_PDO_OFST_ADDR, OFFSET_ADDR, PDO_A_OFFSET_ADDR, U)\
    CMD(a, b, c, d, e, f, CAM_A_PDO_XSIZE, XSIZE, PDO_A_XSIZE, U)\
    CMD(a, b, c, d, e, f, CAM_A_PDO_YSIZE, YSIZE, PDO_A_YSIZE, U)\
    CMD(a, b, c, d, e, f, CAM_A_PDO_STRIDE, STRIDE, PDO_A_STRIDE, U)\
    /* PAKG */\
    ...
    CMD(a, b, c, d, e, f, CAM_A_UFE_CON, UFE_FORCE_PCM, UFEG_A_FORCE_PCM, U)\
    /* UFEO */\
    ...
    /*QBIN1 */\
    CMD(a, b, c, d, e, f, CAM_A_CTL_EN, QBIN1_EN, QBIN1_A_EN, U)\
    CMD(a, b, c, d, e, f, CAM_A_QBN1_MODE, QBN_ACC, QBN1_tmp1_ACC, U)\
    CMD(a, b, c, d, e, f, CAM_A_QBN1_MODE, QBN_ACC_MODE, QBN1_tmp1_ACC_MODE, U)\
    /*QBIN4 */\
    CMD(a, b, c, d, e, f, CAM_A_CTL_SEL, QBIN4_SEL, QBIN4_A_SEL, U)\
    CMD(a, b, c, d, e, f, CAM_A_CTL_DMA_EN, QBIN4_EN, QBIN4_A_EN, U)\
    CMD(a, b, c, d, e, f, CAM_A_QBN4_MODE, QBN_ACC, QBN4_tmp1_ACC, U)\
    CMD(a, b, c, d, e, f, CAM_A_QBN4_MODE, QBN_ACC_MODE, QBN4_tmp1_ACC_MODE, U)\
    /* PCP */\
    CMD(a, b, c, d, e, f, CAM_A_CTL_DMA_EN, PCP_EN, PCP_A_EN, U)\
    CMD(a, b, c, d, e, f, CAM_A_PCP_CROP_CON1, PCP_STR_X, PCP_tmp_STR_X, U)\
    CMD(a, b, c, d, e, f, CAM_A_PCP_CROP_CON1, PCP_END_X, PCP_tmp_END_X, U)\
    CMD(a, b, c, d, e, f, CAM_A_PCP_CROP_CON2, PCP_STR_Y, PCP_tmp_STR_Y, U)\
    CMD(a, b, c, d, e, f, CAM_A_PCP_CROP_CON2, PCP_END_Y, PCP_tmp_END_Y, U)\
    /* GSE */\
    CMD(a, b, c, d, e, f, CAM_A_CTL_SEL, HDS1_SEL, HDS1_A_SEL, U)\
    CMD(a, b, c, d, e, f, CAM_A_CTL_DMA_EN, GSE_EN, GSE_A_EN, U)\
    /* SGG2 */\
    CMD(a, b, c, d, e, f, CAM_A_CTL_DMA_EN, SGG2_EN, SGG2_A_EN, U)\
    /* PSB */\
    CMD(a, b, c, d, e, f, CAM_A_CTL_DMA_EN, PSB_EN, PSB_A_EN, U)\
    CMD(a, b, c, d, e, f, CAM_A_PSB_CON, PSB_MODE, PSB_tmp1_MODE, U)\
    CMD(a, b, c, d, e, f, CAM_A_PSB_CON, PSB_STR, PSB_tmp1_STR, U)\
    CMD(a, b, c, d, e, f, CAM_A_PSB_SIZE, PSB_WD, PSB_tmp1_WD, U)\
    CMD(a, b, c, d, e, f, CAM_A_PSB_SIZE, PSB_HT, PSB_tmp1_HT, U)\
...
#define DUAL_HW_B_LIST(CMD, a, b, c, d, e, f) \
    ...
    /* SL2J_D */\
    CMD(a, b, c, d, e, f, CAM_B_CTL_DMA_EN, SL2J_EN, SL2J_B_EN, U)\
    CMD(a, b, c, d, e, f, CAM_B_SL2J_XOFF, SL2_X_OFST, SL2J_B_X_OFST, U)\
    CMD(a, b, c, d, e, f, CAM_B_SL2J_YOFF, SL2_Y_OFST, SL2J_B_Y_OFST, U)\
    CMD(a, b, c, d, e, f, CAM_B_SL2J_SIZE, SL2_TPIPE_WD, SL2J_B_TPIPE_WD, U)\
    CMD(a, b, c, d, e, f, CAM_B_SL2J_SIZE, SL2_TPIPE_HT, SL2J_B_TPIPE_HT, U)\
    /* DBS_D */\
    ...
    /* HLR_D */\
    CMD(a, b, c, d, e, f, CAM_B_CTL_DMA_EN, HLR_EN, HLR_B_EN, U)\
    /* RCR_D */\
    ...
    /* PDO_D */\
    CMD(a, b, c, d, e, f, CAM_B_CTL_EN, PKP_EN, PKP_B_EN, U)\
    CMD(a, b, c, d, e, f, CAM_B_CTL_DMA_EN, PDO_EN, PDO_B_EN, U)\
    CMD(a, b, c, d, e, f, CAM_B_PDO_BASE_ADDR, BASE_ADDR, PDO_B_BASE_ADDR, U)\
    CMD(a, b, c, d, e, f, CAM_B_PDO_OFST_ADDR, OFFSET_ADDR, PDO_B_OFFSET_ADDR, U)\
    CMD(a, b, c, d, e, f, CAM_B_PDO_XSIZE, XSIZE, PDO_B_XSIZE, U)\
    CMD(a, b, c, d, e, f, CAM_B_PDO_YSIZE, YSIZE, PDO_B_YSIZE, U)\
    CMD(a, b, c, d, e, f, CAM_B_PDO_STRIDE, STRIDE, PDO_B_STRIDE, U)\
    /* RRZO_D */\
    ...
    CMD(a, b, c, d, e, f, CAM_B_UFE_CON, UFE_FORCE_PCM, UFEG_B_FORCE_PCM, U)\
    /* UFEO_D */\
    ...
    /*QBIN1_D */\
    CMD(a, b, c, d, e, f, CAM_B_CTL_EN, QBIN1_EN, QBIN1_B_EN, U)\
    CMD(a, b, c, d, e, f, CAM_B_QBN1_MODE, QBN_ACC, QBN1_tmp2_ACC, U)\
    CMD(a, b, c, d, e, f, CAM_B_QBN1_MODE, QBN_ACC_MODE, QBN1_tmp2_ACC_MODE, U)\
    /*QBIN4_D */\
    CMD(a, b, c, d, e, f, CAM_B_CTL_DMA_EN, QBIN4_EN, QBIN4_B_EN, U)\
    CMD(a, b, c, d, e, f, CAM_B_QBN4_MODE, QBN_ACC, QBN4_tmp2_ACC, U)\
    CMD(a, b, c, d, e, f, CAM_B_QBN4_MODE, QBN_ACC_MODE, QBN4_tmp2_ACC_MODE, U)\
    /* PCP_D */\
    CMD(a, b, c, d, e, f, CAM_B_CTL_DMA_EN, PCP_EN, PCP_B_EN, U)\
    CMD(a, b, c, d, e, f, CAM_B_PCP_CROP_CON1, PCP_STR_X, PCP_tmp1_STR_X, U)\
    CMD(a, b, c, d, e, f, CAM_B_PCP_CROP_CON1, PCP_END_X, PCP_tmp1_END_X, U)\
    CMD(a, b, c, d, e, f, CAM_B_PCP_CROP_CON2, PCP_STR_Y, PCP_tmp1_STR_Y, U)\
    CMD(a, b, c, d, e, f, CAM_B_PCP_CROP_CON2, PCP_END_Y, PCP_tmp1_END_Y, U)\
    /* GSE_D */\
    CMD(a, b, c, d, e, f, CAM_B_CTL_DMA_EN, GSE_EN, GSE_B_EN, U)\
    /* SGG2_D */\
    CMD(a, b, c, d, e, f, CAM_B_CTL_DMA_EN, SGG2_EN, SGG2_B_EN, U)\
    /* PSB_D */\
    CMD(a, b, c, d, e, f, CAM_B_CTL_DMA_EN, PSB_EN, PSB_B_EN, U)\
    CMD(a, b, c, d, e, f, CAM_B_PSB_CON, PSB_MODE, PSB_tmp2_MODE, U)\
    CMD(a, b, c, d, e, f, CAM_B_PSB_CON, PSB_STR, PSB_tmp2_STR, U)\
    CMD(a, b, c, d, e, f, CAM_B_PSB_SIZE, PSB_WD, PSB_tmp2_WD, U)\
    CMD(a, b, c, d, e, f, CAM_B_PSB_SIZE, PSB_HT, PSB_tmp2_HT, U)\
