...
MINT32 CAM_TOP_CTRL::_config( void )
{
    ...
    */
    ...
    CAM_WRITE_REG(this->m_pDrv->getPhyObj(),CAM_CTL_RAW_INT2_EN, CAM_READ_REG(this->m_pDrv->getPhyObj(),CAM_CTL_RAW_INT2_EN) | 0x1FFF0000);
    CAM_WRITE_REG(this->m_pDrv,CAM_CTL_RAW_INT2_EN, CAM_READ_REG(this->m_pDrv,CAM_CTL_RAW_INT2_EN) | 0x1FFF0000);
    //db_en
