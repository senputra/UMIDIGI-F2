...
)
{
    ...
    switch(engine)
    {
        ...
        case eTuningMgrFunc_AF:
            ...
            TUNING_MGR_WRITE_REG_CAM(this, CAM_CTL_DMA_EN, this->mCtlEnDMA_CAM, BQIdx);
            LOG_WRN("[temp log] AF enable(%d_0x%x_0x%x)",ctlEn,this->mCtlEn_CAM,this->mCtlEnDMA_CAM);
            break;
        ...
        case eTuningMgrFunc_SGG3:
            this->mCtlEn_UNI= (ctlEn == MTRUE) ? (this->mCtlEn_UNI | SGG3_A_EN_) : (this->mCtlEn_UNI & ~SGG3_A_EN_);
            TUNING_MGR_WRITE_REG_UNI(this, CAM_UNI_TOP_MOD_EN, this->mCtlEn_UNI, BQIdx);
            TUNING_MGR_WRITE_REG_UNI(this, CAM_UNI_B_TOP_MOD_EN, this->mCtlEn_UNI, BQIdx);
            break;
        case eTuningMgrFunc_FLK:
            this->mCtlEn_UNI= (ctlEn == MTRUE) ? (this->mCtlEn_UNI | FLK_A_EN_) : (this->mCtlEn_UNI & ~FLK_A_EN_);
            TUNING_MGR_WRITE_REG_UNI(this, CAM_UNI_TOP_MOD_EN, this->mCtlEn_UNI, BQIdx);
            TUNING_MGR_WRITE_REG_UNI(this, CAM_UNI_B_TOP_MOD_EN, this->mCtlEn_UNI, BQIdx);

            this->mCtlEnDMA_UNI = (ctlEn == MTRUE) ? (this->mCtlEnDMA_UNI | FLKO_A_EN_) : (this->mCtlEnDMA_UNI & ~FLKO_A_EN_);
            TUNING_MGR_WRITE_REG_UNI(this, CAM_UNI_TOP_DMA_EN, this->mCtlEnDMA_UNI, BQIdx);
            TUNING_MGR_WRITE_REG_UNI(this, CAM_UNI_B_TOP_DMA_EN, this->mCtlEnDMA_UNI, BQIdx);
            break;
        case eTuningMgrFunc_SL2F:
            this->mCtlEnDMA_CAM = (ctlEn == MTRUE) ? (this->mCtlEnDMA_CAM | SL2F_EN_) : (this->mCtlEnDMA_CAM & ~SL2F_EN_);
            TUNING_MGR_WRITE_REG_CAM(this, CAM_CTL_DMA_EN, this->mCtlEnDMA_CAM, BQIdx);
            break;
        ...
        case eTuningMgrFunc_PS:
            this->mCtlEnDMA_CAM = (ctlEn == MTRUE) ? (this->mCtlEnDMA_CAM | (PS_EN_|PSO_EN_)) : (this->mCtlEnDMA_CAM & ~(PS_EN_|PSO_EN_));
            TUNING_MGR_WRITE_REG_CAM(this, CAM_CTL_DMA_EN, this->mCtlEnDMA_CAM, BQIdx);
            break;
        case eTuningMgrFunc_SGG5:
            this->mCtlEnDMA_CAM = (ctlEn == MTRUE) ? (this->mCtlEnDMA_CAM | SGG5_EN_) : (this->mCtlEnDMA_CAM & ~SGG5_EN_);
            TUNING_MGR_WRITE_REG_CAM(this, CAM_CTL_DMA_EN, this->mCtlEnDMA_CAM, BQIdx);
            break;
        case eTuningMgrFunc_HLR:
            this->mCtlEnDMA_CAM = (ctlEn == MTRUE) ? (this->mCtlEnDMA_CAM | HLR_EN_) : (this->mCtlEnDMA_CAM & ~HLR_EN_);
            TUNING_MGR_WRITE_REG_CAM(this, CAM_CTL_DMA_EN, this->mCtlEnDMA_CAM, BQIdx);
            break;
        case eTuningMgrFunc_SL2J:
            this->mCtlEnDMA_CAM = (ctlEn == MTRUE) ? (this->mCtlEnDMA_CAM | SL2J_EN_) : (this->mCtlEnDMA_CAM & ~SL2J_EN_);
            TUNING_MGR_WRITE_REG_CAM(this, CAM_CTL_DMA_EN, this->mCtlEnDMA_CAM, BQIdx);
            break;
        default:
...
//-----------------------------------------------------------------------------
MBOOL TuningMgrImp::dequeBuffer(MINT32* magicNum,MBOOL* isVerify)
{
...
//-----------------------------------------------------------------------------
MBOOL TuningMgrImp::enqueBuffer()
{
    MBOOL ret = MTRUE;
