...
public:
    ...
    MUINT32  tgFps;          //tgFps
    IspDMACfg():
        pixel_byte(1),swap(0), format_en(0),format(0),bus_size_en(0),bus_size(0),ring_en(0),ring_size(0),memBuf_c_ofst(0),memBuf_v_ofst(0),v_flip_en(0),lIspColorfmt(eImgFmt_IMPLEMENTATION_DEFINED),capbility(0x00),tgFps(30)
        {};
};
...
public:
    ...
    public:
        MdpRotDMACfg():
            crop_en(0),pixel_byte(1),uv_plane_swap(0),Format(CRZ_DRV_FORMAT_YUV422),Plane(CRZ_DRV_PLANE_1),Sequence(CRZ_DRV_SEQUENCE_YVYU),Rotation(CRZ_DRV_ROTATION_0),withCropM(0),enSrcCrop(0),srcCropX(0),srcCropFloatX(0),srcCropY(0),srcCropFloatY(0),srcCropW(0),srcCropH(0),Flip(0),capbility(0x00),bIsRwbEn(0)
            {};
};
...
struct stIspTopCtl {
    ...
    CAMSV_REG_MODULE_EN  CAMSV_CAMSV_MODULE_EN;
    CAMSV2_REG_MODULE_EN CAMSV_CAMSV2_MODULE_EN;
    CAMSV_REG_FMT_SEL       CAMSV_CAMSV_FMT_SEL;
    MUINT32                       CAMSV_CAMSV_FMT_SEL_MASK;
    CAMSV_REG_FMT_SEL       CAMSV_CAMSV2_FMT_SEL;
    MUINT32                       CAMSV_CAMSV2_FMT_SEL_MASK;
    CAMSV_REG_INT_EN       CAMSV_CAMSV_INT_EN;
    CAMSV2_REG_INT_EN       CAMSV_CAMSV2_INT_EN;
    MUINT32                       CAMSV_CAMSV_PAK_MASK;
    CAMSV_REG_PAK           CAMSV_CAMSV_PAK;
    MUINT32                       CAMSV_CAMSV2_PAK_MASK;
    CAMSV2_REG_PAK       CAMSV_CAMSV2_PAK;
