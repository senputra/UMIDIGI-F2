...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_EAF_EafStream_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_EAF_EafStream_H_
//
 ...
 *
 ******************************************************************************/
class EafStream : public IEafStream
{
    friend  class IEafStream;
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  IPipe Interface.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     * @note
     * 
     * @param[in] rEafParams: Reference to a request of EAFParams structure.
     *
     * @return 
     * - MTRUE indicates success;
     ...
     * @note
     * 
     * @param[in] rEafParams: Reference to a result of EAFParams structure.
     *
...
private:
    ...
    MVOID releaseLock();
    MINT32 getUs();
    MBOOL saveToFile(char const* filepath, EAFBufInfo* buffer);
...
#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_EAF_EafStream_H_
