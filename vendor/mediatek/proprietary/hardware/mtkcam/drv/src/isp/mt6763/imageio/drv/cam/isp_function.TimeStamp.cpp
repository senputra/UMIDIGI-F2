...
MBOOL CAM_TIMESTAMP::TimeStamp_mapping(MUINT32* pSec, MUINT32* pUsec,_isp_dma_enum_ dma,ISP_HW_MODULE module)
{
    MBOOL ret = MTRUE;
    MUINT64 time;
    ...
    CAM_FUNC_DBG("time stamp test:%u_%u_%" PRIu64 ",%d\n",*pSec,this->m_Arithmetic[dma].nOverFlow,time,dma);
