      ...
      m_SeeeEn(MFALSE)
{
    ...
    m_pDipRingBuf = DipRingBuffer::createInstance((ISP_DIP_MODULE_IDX)ISP_DIP_MODULE_IDX_DIP_A);
}
...
{
    MBOOL ret=MTRUE;
    PIPE_INF("+, szCallerName(%s)",szCallerName);
    //
    if ( m_pIspDrvShell ) {
...
MUINT32
PostProcPipe::
dequeBuf(MBOOL& isVencContained, QTimeStampBufInfo& rQBufInfo, MUINTPTR& tpipeVa, MUINTPTR& ispVirRegVa, EDrvScenario eDrvSce, MINT32 dequeCq,MINT32 const dequeBurstQIdx, MINT32 const dequeDupCqIdx, MUINT32 const RingBufIdx, MUINT32 const u4TimeoutMs /*= 0xFFFFFFFF*/)
{
    int idex=0;
    EIspRetStatus ret;
    ...
    //
    PIPE_DBG("dQDBGout path(%d)  cq=(%d, %d, %d, %d), timeoutMs(%d)", eDrvSce, dequeCq,dequeDupCqIdx,dequeBurstQIdx,RingBufIdx,u4TimeoutMs);
    ...
    //ret = this->ispBufCtrl.dequeHwBuf(isVencContained,tpipeVa,ispVirRegVa);
...
MBOOL
PostProcPipe::
PrintPipePortInfo(vector<PortInfo const*>const& vInPorts, vector<PortInfo const*>const& vOutPorts, MUINT32 FrameNo, MUINT32 RequestNo, MUINT32 Timestamp, MINT32 UniqueKey, MBOOL SecureFra)
{
    ...
    switch (vInPorts.size())
    {
        case 1:
            ...
            PIPE_INF("vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d)",\
                                                            FrameNo,
                                                            RequestNo,
                                                            Timestamp,
                                                            UniqueKey,
                                                            ...
                                                            vInPorts[0]->SecureTag);

            sprintf(mmpathStr,"MMPath: hw=P2, pid=%d, in_0=0x%x, in_0_width=%d, in_0_height=%d, in_0_fmt=%s, in_0_bpp=%d, in_0_hw=%s, ",getpid(),(unsigned long)vInPorts[0]->u4BufPA[0],vInPorts[0]->u4ImgWidth,vInPorts[0]->u4ImgHeight, ColorFormatMapping(vInPorts[0]->eImgFmt).c_str(), ColorBppMapping(vInPorts[0]->eImgFmt),DmaPortMapping(vInPorts[0]->index).c_str());
            break;
        case 2:
            if ( (0 == vInPorts[0]) ||  (0 == vInPorts[1])) { break; }
            PIPE_INF("vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d)",\
                                                            FrameNo,
                                                            RequestNo,
                                                            Timestamp,
                                                            UniqueKey,
                                                            ...
                                                            vInPorts[1]->SecureTag);

            sprintf(mmpathStr,"MMPath: hw=P2, pid=%d, in_0=0x%x, in_0_width=%d, in_0_height=%d, in_0_fmt=%s, in_0_bpp=%d, in_0_hw=%s, "
                                                     "in_1=0x%x, in_1_width=%d, in_1_height=%d, in_1_fmt=%s, in_1_bpp=%d, in_1_hw=%s, ",\
                 getpid(),(unsigned long)vInPorts[0]->u4BufPA[0],vInPorts[0]->u4ImgWidth,vInPorts[0]->u4ImgHeight, ColorFormatMapping(vInPorts[0]->eImgFmt).c_str(), ColorBppMapping(vInPorts[0]->eImgFmt), DmaPortMapping(vInPorts[0]->index).c_str(),
                          (unsigned long)vInPorts[1]->u4BufPA[0],vInPorts[1]->u4ImgWidth,vInPorts[1]->u4ImgHeight, ColorFormatMapping(vInPorts[1]->eImgFmt).c_str(), ColorBppMapping(vInPorts[1]->eImgFmt), DmaPortMapping(vInPorts[1]->index).c_str()
            );
            break;
        case 3:
            ...
            PIPE_INF("vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d)",\
                                                            FrameNo,
                                                            RequestNo,
                                                            Timestamp,
                                                            UniqueKey,
                                                            ...
                                                            vInPorts[2]->SecureTag
                                                            );

            sprintf(mmpathStr,"MMPath: hw=P2, pid=%d, in_0=0x%x, in_0_width=%d, in_0_height=%d, in_0_fmt=%s, in_0_bpp=%d, in_0_hw=%s, "
                                                     "in_1=0x%x, in_1_width=%d, in_1_height=%d, in_1_fmt=%s, in_1_bpp=%d, in_1_hw=%s, "
                                                     "in_2=0x%x, in_2_width=%d, in_2_height=%d, in_2_fmt=%s, in_2_bpp=%d, in_2_hw=%s, ",\
                 getpid(),(unsigned long)vInPorts[0]->u4BufPA[0],vInPorts[0]->u4ImgWidth,vInPorts[0]->u4ImgHeight, ColorFormatMapping(vInPorts[0]->eImgFmt).c_str(), ColorBppMapping(vInPorts[0]->eImgFmt), DmaPortMapping(vInPorts[0]->index).c_str(),
                          (unsigned long)vInPorts[1]->u4BufPA[0],vInPorts[1]->u4ImgWidth,vInPorts[1]->u4ImgHeight, ColorFormatMapping(vInPorts[1]->eImgFmt).c_str(), ColorBppMapping(vInPorts[1]->eImgFmt), DmaPortMapping(vInPorts[1]->index).c_str(),
                          (unsigned long)vInPorts[2]->u4BufPA[0],vInPorts[2]->u4ImgWidth,vInPorts[2]->u4ImgHeight, ColorFormatMapping(vInPorts[2]->eImgFmt).c_str(), ColorBppMapping(vInPorts[2]->eImgFmt), DmaPortMapping(vInPorts[2]->index).c_str()
            );
            break;
        case 4:
            ...
            PIPE_INF("vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[3]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d)",\
                                                            FrameNo,
                                                            RequestNo,
                                                            Timestamp,
                                                            UniqueKey,
                                                            ...
                                                            vInPorts[3]->SecureTag
                                                            );

            sprintf(mmpathStr,"MMPath: hw=P2, pid=%d, in_0=0x%x, in_0_width=%d, in_0_height=%d, in_0_fmt=%s, in_0_bpp=%d, in_0_hw=%s, "
                                                     "in_1=0x%x, in_1_width=%d, in_1_height=%d, in_1_fmt=%s, in_1_bpp=%d, in_1_hw=%s, "
                                                     "in_2=0x%x, in_2_width=%d, in_2_height=%d, in_2_fmt=%s, in_2_bpp=%d, in_2_hw=%s, "
                                                     "in_3=0x%x, in_3_width=%d, in_3_height=%d, in_3_fmt=%s, in_3_bpp=%d, in_3_hw=%s, ",\
                 getpid(),(unsigned long)vInPorts[0]->u4BufPA[0],vInPorts[0]->u4ImgWidth,vInPorts[0]->u4ImgHeight, ColorFormatMapping(vInPorts[0]->eImgFmt).c_str(), ColorBppMapping(vInPorts[0]->eImgFmt), DmaPortMapping(vInPorts[0]->index).c_str(),
                          (unsigned long)vInPorts[1]->u4BufPA[0],vInPorts[1]->u4ImgWidth,vInPorts[1]->u4ImgHeight, ColorFormatMapping(vInPorts[1]->eImgFmt).c_str(), ColorBppMapping(vInPorts[1]->eImgFmt), DmaPortMapping(vInPorts[1]->index).c_str(),
                          (unsigned long)vInPorts[2]->u4BufPA[0],vInPorts[2]->u4ImgWidth,vInPorts[2]->u4ImgHeight, ColorFormatMapping(vInPorts[2]->eImgFmt).c_str(), ColorBppMapping(vInPorts[2]->eImgFmt), DmaPortMapping(vInPorts[2]->index).c_str(),
                          (unsigned long)vInPorts[3]->u4BufPA[0],vInPorts[3]->u4ImgWidth,vInPorts[3]->u4ImgHeight, ColorFormatMapping(vInPorts[3]->eImgFmt).c_str(), ColorBppMapping(vInPorts[3]->eImgFmt), DmaPortMapping(vInPorts[3]->index).c_str()
            );
            break;
        case 5:
            ...
            PIPE_INF("vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      ...
                      vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[3]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vInPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[4]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d)",\
                                                            FrameNo,
                                                            RequestNo,
                                                            Timestamp,
                                                            UniqueKey,
            ...
            sprintf(mmpathStr,"MMPath: hw=P2, pid=%d, in_0=0x%x, in_0_width=%d, in_0_height=%d, in_0_fmt=%s, in_0_bpp=%d, in_0_hw=%s, "
                                                     ...
                                                     "in_2=0x%x, in_2_width=%d, in_2_height=%d, in_2_fmt=%s, in_2_bpp=%d, in_2_hw=%s, "
                                                     "in_3=0x%x, in_3_width=%d, in_3_height=%d, in_3_fmt=%s, in_3_bpp=%d, in_3_hw=%s, "
                                                     "in_4=0x%x, in_4_width=%d, in_4_height=%d, in_4_fmt=%s, in_4_bpp=%d, in_4_hw=%s, ",\
                 getpid(),(unsigned long)vInPorts[0]->u4BufPA[0],vInPorts[0]->u4ImgWidth,vInPorts[0]->u4ImgHeight, ColorFormatMapping(vInPorts[0]->eImgFmt).c_str(), ColorBppMapping(vInPorts[0]->eImgFmt), DmaPortMapping(vInPorts[0]->index).c_str(),
                          (unsigned long)vInPorts[1]->u4BufPA[0],vInPorts[1]->u4ImgWidth,vInPorts[1]->u4ImgHeight, ColorFormatMapping(vInPorts[1]->eImgFmt).c_str(), ColorBppMapping(vInPorts[1]->eImgFmt), DmaPortMapping(vInPorts[1]->index).c_str(),
                          (unsigned long)vInPorts[2]->u4BufPA[0],vInPorts[2]->u4ImgWidth,vInPorts[2]->u4ImgHeight, ColorFormatMapping(vInPorts[2]->eImgFmt).c_str(), ColorBppMapping(vInPorts[2]->eImgFmt), DmaPortMapping(vInPorts[2]->index).c_str(),
                          (unsigned long)vInPorts[3]->u4BufPA[0],vInPorts[3]->u4ImgWidth,vInPorts[3]->u4ImgHeight, ColorFormatMapping(vInPorts[3]->eImgFmt).c_str(), ColorBppMapping(vInPorts[3]->eImgFmt), DmaPortMapping(vInPorts[3]->index).c_str(),
                          (unsigned long)vInPorts[4]->u4BufPA[0],vInPorts[4]->u4ImgWidth,vInPorts[4]->u4ImgHeight, ColorFormatMapping(vInPorts[4]->eImgFmt).c_str(), ColorBppMapping(vInPorts[4]->eImgFmt), DmaPortMapping(vInPorts[4]->index).c_str()
            );
            break;
        default:
    ...
    switch (vOutPorts.size())
    {
        case 1:
            ...
            PIPE_INF("vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d)",\
                                                            FrameNo,
                                                            RequestNo,
                                                            Timestamp,
                                                            UniqueKey,
                                                            ...
                                                            vOutPorts[0]->SecureTag);
            sprintf(mmpathStrOut,"out_0=0x%x, out_0_width=%d, out_0_height=%d, out_0_fmt=%s, out_0_bpp=%d, out_0_hw=%s",\
                (unsigned long)vOutPorts[0]->u4BufPA[0],vOutPorts[0]->u4ImgWidth,vOutPorts[0]->u4ImgHeight, ColorFormatMapping(vOutPorts[0]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[0]->eImgFmt), DmaPortMapping(vOutPorts[0]->index).c_str()
            );
            break;
        case 2:
            if ( (0 == vOutPorts[0]) || (0 == vOutPorts[1])) { break; }
            PIPE_INF("vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d)",\
                                                            FrameNo,
                                                            RequestNo,
                                                            Timestamp,
                                                            UniqueKey,
                                                            ...
                                                            vOutPorts[1]->SecureTag
                                                            );
            sprintf(mmpathStrOut,"out_0=0x%x, out_0_width=%d, out_0_height=%d, out_0_fmt=%s, out_0_bpp=%d, out_0_hw=%s, "
                                 "out_1=0x%x, out_1_width=%d, out_1_height=%d, out_1_fmt=%s, out_1_bpp=%d, out_1_hw=%s",\
                (unsigned long)vOutPorts[0]->u4BufPA[0],vOutPorts[0]->u4ImgWidth,vOutPorts[0]->u4ImgHeight, ColorFormatMapping(vOutPorts[0]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[0]->eImgFmt), DmaPortMapping(vOutPorts[0]->index).c_str(),
                (unsigned long)vOutPorts[1]->u4BufPA[0],vOutPorts[1]->u4ImgWidth,vOutPorts[1]->u4ImgHeight, ColorFormatMapping(vOutPorts[1]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[1]->eImgFmt), DmaPortMapping(vOutPorts[1]->index).c_str()
            );
            break;
        case 3:
            ...
            PIPE_INF("vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d)",\
                                                            FrameNo,
                                                            RequestNo,
                                                            Timestamp,
                                                            UniqueKey,
                                                            ...
                                                            vOutPorts[2]->SecureTag
                                                            );

            sprintf(mmpathStrOut,"out_0=0x%x, out_0_width=%d, out_0_height=%d, out_0_fmt=%s, out_0_bpp=%d, out_0_hw=%s, "
                                 "out_1=0x%x, out_1_width=%d, out_1_height=%d, out_1_fmt=%s, out_1_bpp=%d, out_1_hw=%s, "
                                 "out_2=0x%x, out_2_width=%d, out_2_height=%d, out_2_fmt=%s, out_2_bpp=%d, out_2_hw=%s",\
                (unsigned long)vOutPorts[0]->u4BufPA[0],vOutPorts[0]->u4ImgWidth,vOutPorts[0]->u4ImgHeight, ColorFormatMapping(vOutPorts[0]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[0]->eImgFmt), DmaPortMapping(vOutPorts[0]->index).c_str(),
                (unsigned long)vOutPorts[1]->u4BufPA[0],vOutPorts[1]->u4ImgWidth,vOutPorts[1]->u4ImgHeight, ColorFormatMapping(vOutPorts[1]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[1]->eImgFmt), DmaPortMapping(vOutPorts[1]->index).c_str(),
                (unsigned long)vOutPorts[2]->u4BufPA[0],vOutPorts[2]->u4ImgWidth,vOutPorts[2]->u4ImgHeight, ColorFormatMapping(vOutPorts[2]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[2]->eImgFmt), DmaPortMapping(vOutPorts[2]->index).c_str()
            );
            break;
        case 4:
            ...
            PIPE_INF("vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[3]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d)",\
                                                            FrameNo,
                                                            RequestNo,
                                                            Timestamp,
                                                            UniqueKey,
                                                            ...
                                                            vOutPorts[3]->SecureTag
                                                            );

            sprintf(mmpathStrOut,"out_0=0x%x, out_0_width=%d, out_0_height=%d, out_0_fmt=%s, out_0_bpp=%d, out_0_hw=%s, "
                                 "out_1=0x%x, out_1_width=%d, out_1_height=%d, out_1_fmt=%s, out_1_bpp=%d, out_1_hw=%s, "
                                 "out_2=0x%x, out_2_width=%d, out_2_height=%d, out_2_fmt=%s, out_2_bpp=%d, out_2_hw=%s, "
                                 "out_3=0x%x, out_3_width=%d, out_3_height=%d, out_3_fmt=%s, out_3_bpp=%d, out_3_hw=%s",\
                (unsigned long)vOutPorts[0]->u4BufPA[0],vOutPorts[0]->u4ImgWidth,vOutPorts[0]->u4ImgHeight, ColorFormatMapping(vOutPorts[0]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[0]->eImgFmt), DmaPortMapping(vOutPorts[0]->index).c_str(),
                (unsigned long)vOutPorts[1]->u4BufPA[0],vOutPorts[1]->u4ImgWidth,vOutPorts[1]->u4ImgHeight, ColorFormatMapping(vOutPorts[1]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[1]->eImgFmt), DmaPortMapping(vOutPorts[1]->index).c_str(),
                (unsigned long)vOutPorts[2]->u4BufPA[0],vOutPorts[2]->u4ImgWidth,vOutPorts[2]->u4ImgHeight, ColorFormatMapping(vOutPorts[2]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[2]->eImgFmt), DmaPortMapping(vOutPorts[2]->index).c_str(),
                (unsigned long)vOutPorts[3]->u4BufPA[0],vOutPorts[3]->u4ImgWidth,vOutPorts[3]->u4ImgHeight, ColorFormatMapping(vOutPorts[3]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[3]->eImgFmt), DmaPortMapping(vOutPorts[3]->index).c_str()
            );
            break;
        case 5:
            ...
            PIPE_INF("vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      ...
                      vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[3]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d),\n\
                      vOutPorts:FN(%d),RN(%d),TS(0x%x),UK(0x%x),Sec(%d),[4]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%lx,0x%lx,0x%lx),PA(0x%lx,0x%lx,0x%lx),secPort(%d)",\
                                                            FrameNo,
                                                            RequestNo,
                                                            Timestamp,
                                                            UniqueKey,
            ...
            sprintf(mmpathStrOut,"out_0=0x%x, out_0_width=%d, out_0_height=%d, out_0_fmt=%s, out_0_bpp=%d, out_0_hw=%s, "
                                 ...
                                 "out_2=0x%x, out_2_width=%d, out_2_height=%d, out_2_fmt=%s, out_2_bpp=%d, out_2_hw=%s, "
                                 "out_3=0x%x, out_3_width=%d, out_3_height=%d, out_3_fmt=%s, out_3_bpp=%d, out_3_hw=%s, "
                                 "out_4=0x%x, out_4_width=%d, out_4_height=%d, out_4_fmt=%s, out_4_bpp=%d, out_4_hw=%s",\
                (unsigned long)vOutPorts[0]->u4BufPA[0],vOutPorts[0]->u4ImgWidth,vOutPorts[0]->u4ImgHeight, ColorFormatMapping(vOutPorts[0]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[0]->eImgFmt), DmaPortMapping(vOutPorts[0]->index).c_str(),
                (unsigned long)vOutPorts[1]->u4BufPA[0],vOutPorts[1]->u4ImgWidth,vOutPorts[1]->u4ImgHeight, ColorFormatMapping(vOutPorts[1]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[1]->eImgFmt), DmaPortMapping(vOutPorts[1]->index).c_str(),
                (unsigned long)vOutPorts[2]->u4BufPA[0],vOutPorts[2]->u4ImgWidth,vOutPorts[2]->u4ImgHeight, ColorFormatMapping(vOutPorts[2]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[2]->eImgFmt), DmaPortMapping(vOutPorts[2]->index).c_str(),
                (unsigned long)vOutPorts[3]->u4BufPA[0],vOutPorts[3]->u4ImgWidth,vOutPorts[3]->u4ImgHeight, ColorFormatMapping(vOutPorts[3]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[3]->eImgFmt), DmaPortMapping(vOutPorts[3]->index).c_str(),
                (unsigned long)vOutPorts[4]->u4BufPA[0],vOutPorts[4]->u4ImgWidth,vOutPorts[4]->u4ImgHeight, ColorFormatMapping(vOutPorts[4]->eImgFmt).c_str(), ColorBppMapping(vOutPorts[4]->eImgFmt), DmaPortMapping(vOutPorts[4]->index).c_str()
            );
            break;
...
MBOOL
PostProcPipe::
configPipe(vector<PortInfo const*>const& vInPorts, vector<PortInfo const*>const& vOutPorts, PipePackageInfo *pPipePackageInfo, char const* szCallerName)
{
    MBOOL ret = MTRUE;
    ...
    m_pDipWorkingBuf->m_pMdpCfg->ExpectedEndTime.tv_sec = pPipePackageInfo->ExpectedEndTime.tv_sec;
    m_pDipWorkingBuf->m_pMdpCfg->ExpectedEndTime.tv_usec = pPipePackageInfo->ExpectedEndTime.tv_usec;
    ...
    ispDipPipe.isSecureFra = pPipePackageInfo->SecureFra;
    ...
    if (pPipePackageInfo->ForceSkipConfig == 1)
    {
        ...
        ispDipPipe.dipTh = pPipePackageInfo->p2cqIdx;
        ispDipPipe.dupCqIdx = pPipePackageInfo->dupCqIdx;
        ispDipPipe.burstQueIdx = pPipePackageInfo->burstQIdx;
        ...
        pMdpCfg->srcPhyAddr  = portInfo_imgi.u4BufPA[ESTRIDE_1ST_PLANE];
        ...
        for(MINT32 index = 0; index < ISP_OUTPORT_NUM; index++) {
            ...
            if(pPreFrmMdpCfg->dstPortCfg[index] == 1) {
                ...
                {
                    pMdpCfg->dstDma[index].memBuf.base_vAddr = portInfo_wdmao.u4BufVA[0];
                    pMdpCfg->dstDma[index].memBuf_c.base_vAddr = portInfo_wdmao.u4BufVA[1];
                    pMdpCfg->dstDma[index].memBuf_v.base_vAddr = portInfo_wdmao.u4BufVA[2];
                    pMdpCfg->dstDma[index].memBuf.base_pAddr = portInfo_wdmao.u4BufPA[0];
                    pMdpCfg->dstDma[index].memBuf_c.base_pAddr = portInfo_wdmao.u4BufPA[1];
                    pMdpCfg->dstDma[index].memBuf_v.base_pAddr = portInfo_wdmao.u4BufPA[2];
                ...
                {
                    pMdpCfg->dstDma[index].memBuf.base_vAddr = portInfo_wroto.u4BufVA[0];
                    pMdpCfg->dstDma[index].memBuf_c.base_vAddr = portInfo_wroto.u4BufVA[1];
                    pMdpCfg->dstDma[index].memBuf_v.base_vAddr = portInfo_wroto.u4BufVA[2];
                    pMdpCfg->dstDma[index].memBuf.base_pAddr = portInfo_wroto.u4BufPA[0];
                    pMdpCfg->dstDma[index].memBuf_c.base_pAddr = portInfo_wroto.u4BufPA[1];
                    pMdpCfg->dstDma[index].memBuf_v.base_pAddr = portInfo_wroto.u4BufPA[2];
        ...
        //Update IMGI Address
        pMdpCfg->ispTpipeCfgInfo.drvinfo.dip_imgi_base_addr = portInfo_imgi.u4BufPA[ESTRIDE_1ST_PLANE];
        pMdpCfg->ispTpipeCfgInfo.drvinfo.dip_lcei_base_addr = portInfo_lcei.u4BufPA[ESTRIDE_1ST_PLANE];
        pMdpCfg->ispTpipeCfgInfo.drvinfo.frameflag = 0x3; //force skip
        pMdpCfg->ispTpipeCfgInfo.drvinfo.burstCqIdx = pPipePackageInfo->burstQIdx;
        pMdpCfg->ispTpipeCfgInfo.drvinfo.dupCqIdx = pPipePackageInfo->dupCqIdx;
        pMdpCfg->ispTpipeCfgInfo.drvinfo.RingBufIdx = m_pDipWorkingBuf->m_BufIdx;

        ispDipPipe.PushFrameCQforMDPStart();
        PIPE_INF("imgi(VA/PA:0x%x,0x%x),lcei(VA/PA:0x%x,0x%x),wdmo(VA/PA:0x%x,0x%x),wroto(VA/PA:0x%x,0x%x),tv_sec(%u),tv_usec(%u)",
            portInfo_imgi.u4BufVA[0], portInfo_imgi.u4BufPA[0],portInfo_lcei.u4BufVA[0], portInfo_lcei.u4BufPA[0],WDMA_vAddr, WDMA_pAddr, WROT_vAddr, WROT_pAddr,
    ...
    PrintPipePortInfo(vInPorts,vOutPorts,pPipePackageInfo->FrameNo,pPipePackageInfo->RequestNo,pPipePackageInfo->Timestamp,pPipePackageInfo->UniqueKey,pPipePackageInfo->SecureFra);
    for (MUINT32 i = 0 ; i < vInPorts.size() ; i++ )
    {
        if ( 0 == vInPorts[i] ) { continue; }
        //
        ...
        switch(vInPorts[i]->index)
        {
	        case EPortIndex_IMGI:   //may multi-plane
                ...
                portInfo_imgi =  (PortInfo)*vInPorts[idx_imgi];
                pixIdImgBuf = PixelIDMapping(pPipePackageInfo->ColorArrangement);
                ...
                PIPE_DBG("[Imgi][crop_1](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,f_w,h,f_h)=(%d,%d,%d,%d),(tarW,tarH)=(%d,%d)-\n\
                                [crop_2](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,f_w,h,f_h)=(%d,%d,%d,%d),(tarW,tarH)=(%d,%d)-\n\
                                [crop_3](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,f_w,h,f_h)=(%d,%d,%d,%d),(tarW,tarH)=(%d,%d),dupCqIdx(%d)", \
                    portInfo_imgi.crop1.x,portInfo_imgi.crop1.floatX,portInfo_imgi.crop1.y,portInfo_imgi.crop1.floatY, \
                    portInfo_imgi.crop1.w,portInfo_imgi.crop1.floatW,portInfo_imgi.crop1.h,portInfo_imgi.crop1.floatH, \
                    portInfo_imgi.resize1.tar_w,portInfo_imgi.resize1.tar_h, \
                    portInfo_imgi.crop2.x,portInfo_imgi.crop2.floatX,portInfo_imgi.crop2.y,portInfo_imgi.crop2.floatY, \
                    portInfo_imgi.crop2.w,portInfo_imgi.crop2.floatW,portInfo_imgi.crop2.h,portInfo_imgi.crop2.floatH, \
                    portInfo_imgi.resize2.tar_w,portInfo_imgi.resize2.tar_h, \
                    portInfo_imgi.crop3.x,portInfo_imgi.crop3.floatX,portInfo_imgi.crop3.y,portInfo_imgi.crop3.floatY, \
                    portInfo_imgi.crop3.w,portInfo_imgi.crop3.floatW,portInfo_imgi.crop3.h,portInfo_imgi.crop3.floatH, \
                    portInfo_imgi.resize3.tar_w,portInfo_imgi.resize3.tar_h,pPipePackageInfo->dupCqIdx);
    ...
    if (imgxi_en!=0)
	{
        ...
        if ((imgi_fmt>=DIP_IMGI_FMT_BAYER8) &&(imgi_fmt<=DIP_IMGI_FMT_BAYER10_MIPI))
        {
            ...
            {
                PIPE_DBG("[Error] ImgBuf PixelID(%d) is not the same as NormalStream Query(%d)!!",pixIdImgBuf, pPipePackageInfo->pixIdP2);
            }
        }
    }
    //
	...
	*/
    ...
    if(pPipePackageInfo->pTuningQue != NULL){
        ...
        b12bitMode = ispDipPipe.pTuningIspReg->DIP_X_CTL_FMT_SEL.Bits.LP_MODE;
            ...
            tdr_tcm2_en |= (dip_ctl_dma_en & (DIP_X_REG_CTL_DMA_EN_ADL)) << 13; //ADL2
    ...
    if (pPipePackageInfo->pTuningQue != NULL)
    {
        pTuningDipReg = (dip_x_reg_t *)pPipePackageInfo->pTuningQue;
                PIPE_INF("[Imgi][crop_1](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,f_w,h,f_h)=(%d,%d,%d,%d),(tarW,tarH)=(%d,%d)-\n\
                    [crop_2](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,f_w,h,f_h)=(%d,%d,%d,%d),(tarW,tarH)=(%d,%d)-\n\
                    [crop_3](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,f_w,h,f_h)=(%d,%d,%d,%d),(tarW,tarH)=(%d,%d),dupCqIdx(%d),[vipi]ofst(%d),rW/H(%d/%d)\n,\
                    isDipOnly(%d), hwmodule(%d/%d), dipCQ/dup/burst(%d/%d/%d), drvSc(%d), isWtf(%d),tdr_tpipe(%d),en_yuv/yuv2/rgb/dma/fmt_sel/ctl_sel/misc (0x%x/0x%x/0x%x/0x%x/0x%x/0x%x/0x%x), tcm(0x%x/0x%x/0x%x), last(%d), CRZ_EN(%d), img3o ofset(%d,%d),userName(%s),PIX_ID(%d),ImgBuf_PIX_ID(%d),tv_sec(%u),tv_usec(%u)",\
                    portInfo_imgi.crop1.x,portInfo_imgi.crop1.floatX,portInfo_imgi.crop1.y,portInfo_imgi.crop1.floatY, \
                    portInfo_imgi.crop1.w,portInfo_imgi.crop1.floatW,portInfo_imgi.crop1.h,portInfo_imgi.crop1.floatH, \
                    portInfo_imgi.resize1.tar_w,portInfo_imgi.resize1.tar_h, \
                    portInfo_imgi.crop2.x,portInfo_imgi.crop2.floatX,portInfo_imgi.crop2.y,portInfo_imgi.crop2.floatY, \
                    ...
                    ispDipPipe.tdr_ctl, ispDipPipe.tdr_tcm_en, ispDipPipe.tdr_tcm2_en,  lastFrame, m_CrzEn, Img3oCrspTmp.m_CrspInfo.p_integral.x, Img3oCrspTmp.m_CrspInfo.p_integral.y, szCallerName, pPipePackageInfo->pixIdP2, pixIdImgBuf,
                    pPipePackageInfo->ExpectedEndTime.tv_sec, pPipePackageInfo->ExpectedEndTime.tv_usec);
            }
            else
            {
                PIPE_INF("[Imgi][crop_1](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,f_w,h,f_h)=(%d,%d,%d,%d),(tarW,tarH)=(%d,%d)-\n\
    ...
    if ( -1 != idx_wroto) {
        ...
        ispMdpPipe.wroto_out.srcCropFloatX = portInfo_imgi.crop3.floatX;
        ...
        ispMdpPipe.wroto_out.srcCropFloatY = portInfo_imgi.crop3.floatY;
        ...
        ispMdpPipe.wroto_out.srcCropFloatW = portInfo_imgi.crop3.floatW;
        //    ((portInfo_imgi.crop3.floatW>>(CROP_FLOAT_PECISE_BIT-CROP_TPIPE_PECISE_BIT)) & ((1<<CROP_TPIPE_PECISE_BIT)-1));/* tpipe calculate via 0~19 bits */
        ispMdpPipe.wroto_out.srcCropH = portInfo_imgi.crop3.h;
        ispMdpPipe.wroto_out.srcCropFloatH = portInfo_imgi.crop3.floatH;
        //    ((portInfo_imgi.crop3.floatH>>(CROP_FLOAT_PECISE_BIT-CROP_TPIPE_PECISE_BIT)) & ((1<<CROP_TPIPE_PECISE_BIT)-1));/* tpipe calculate via 0~19 bits */
        //
    ...
    if ( -1 != idx_wdmao) {
        ...
        ispMdpPipe.wdmao_out.srcCropFloatX = portInfo_imgi.crop2.floatX;
        ...
        ispMdpPipe.wdmao_out.srcCropFloatY = portInfo_imgi.crop2.floatY;
        ...
        ispMdpPipe.wdmao_out.srcCropFloatW = portInfo_imgi.crop2.floatW;
        //    ((portInfo_imgi.crop2.floatW>>(CROP_FLOAT_PECISE_BIT-CROP_TPIPE_PECISE_BIT)) & ((1<<CROP_TPIPE_PECISE_BIT)-1));/* tpipe calculate via 0~19 bits */
        ispMdpPipe.wdmao_out.srcCropH = portInfo_imgi.crop2.h;
        ispMdpPipe.wdmao_out.srcCropFloatH = portInfo_imgi.crop2.floatH;
        //    ((portInfo_imgi.crop2.floatH>>(CROP_FLOAT_PECISE_BIT-CROP_TPIPE_PECISE_BIT)) & ((1<<CROP_TPIPE_PECISE_BIT)-1));/* tpipe calculate via 0~19 bits */
        //
    ...
    if ( -1 != idx_venco) {
        ...
        ispMdpPipe.venco_out.srcCropFloatW = portInfo_imgi.crop2.floatW;
        ispMdpPipe.venco_out.srcCropH = portInfo_imgi.crop2.h;
        ispMdpPipe.venco_out.srcCropFloatH = portInfo_imgi.crop2.floatH;
        //
...
//DMA
    ...
    if (drvScen == eDrvScenario_FM)
    {
        ...
        (ispDipPipe.DMADepi.dma_cfg.size.xsize*ispDipPipe.DMADepi.dma_cfg.size.h)+(ispDipPipe.DMAMfbo.dma_cfg.size.xsize*ispDipPipe.DMAMfbo.dma_cfg.size.h);
    }
    else
    {
...
PostProcPipe::configDmaPort(PortInfo const* portInfo,IspDMACfg &a_dma,MUINT32 pixel_Byte,MUINT32 swap, MUINT32 isBypassOffset,EIMAGE_STRIDE planeNum)
{
    ...
    if ((portInfo->SecureTag != 0) & (portInfo->SecHandle != 0))	// For tuning secure check
    {
        a_dma.memBuf.base_pAddr  = portInfo->SecHandle;
    }
    else
    {
    ...
    a_dma.secureTag=portInfo->SecureTag;
...
configMdpOutPort(PortInfo const* oImgInfo, MdpRotDMACfg &a_rotDma)
{
    ...
    //
    //PIPE_DBG("[oImgInfo]w(%d),h(%d),stride(%d/%d/%d),crop(%d,%d,%d,%d)_f(0x%x, 0x%x, 0x%x, 0x%x),rot(%d) eImgFmt(%d)",
    ...
    //    oImgInfo->crop1.x,oImgInfo->crop1.y,oImgInfo->crop1.w,oImgInfo->crop1.h,oImgInfo->crop1.floatX,oImgInfo->crop1.floatY,oImgInfo->crop1.floatW,oImgInfo->crop1.floatH, \
    ...
    a_rotDma.secureTag=oImgInfo->SecureTag;
...
queryCQ(EDrvScenario sDrvScen, MUINT32 sensorDev, MINT32 p2burstQIdx, MINT32 frameNum, MUINT32& RingBufIndex, MUINTPTR& pVirIspAddr)
{
    ...
    pVirIspAddr = (MUINTPTR)m_pIspDrvShell->getIspVirRegVirAddr(p2CQ, p2burstQIdx, dupCQIdx);
#endif
