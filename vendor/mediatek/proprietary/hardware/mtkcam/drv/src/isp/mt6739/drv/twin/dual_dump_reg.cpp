...
#define FOLDER_SYMBOL_STR "/"
#define FOLDER_SYMBOL_CHAR '/'
#define mtk_sprintf(dst_ptr, size_dst, ...)                     snprintf(dst_ptr, size_dst, __VA_ARGS__)
...
#define uart_printf(fmt, arg...) CAM_ULOGMD(LOG_TAG "[%s] " fmt NEW_LINE_CHAR, __func__, ##arg)
#endif //END LDVT
#else //not arm
#define uart_printf printf
#endif //END platform
...
#define DUMP_ISP_REG_MAP(CMD, a, b, c) \
	...
	CMD(a, b, c, 0x150047CC, CAM_RRZ_RLB_AOFST, W)\
	CMD(a, b, c, 0x15004800, CAM_BNR_BPC_CON, R)\
	CMD(a, b, c, 0x15004804, CAM_BNR_BPC_TH1, R)\
	CMD(a, b, c, 0x15004808, CAM_BNR_BPC_TH2, R)\
	CMD(a, b, c, 0x1500480C, CAM_BNR_BPC_TH3, R)\
	CMD(a, b, c, 0x15004810, CAM_BNR_BPC_TH4, R)\
	CMD(a, b, c, 0x15004814, CAM_BNR_BPC_DTC, R)\
	CMD(a, b, c, 0x15004818, CAM_BNR_BPC_COR, R)\
	CMD(a, b, c, 0x1500481C, CAM_BNR_BPC_TBLI1, W)\
	CMD(a, b, c, 0x15004820, CAM_BNR_BPC_TBLI2, W)\
	CMD(a, b, c, 0x15004824, CAM_BNR_BPC_TH1_C, R)\
	CMD(a, b, c, 0x15004828, CAM_BNR_BPC_TH2_C, R)\
	CMD(a, b, c, 0x1500482C, CAM_BNR_BPC_TH3_C, R)\
	CMD(a, b, c, 0x15004830, CAM_BNR_NR1_CON, R)\
	CMD(a, b, c, 0x15004834, CAM_BNR_NR1_CT_CON, R)\
	CMD(a, b, c, 0x15004838, CAM_BNR_RSV1, R)\
	CMD(a, b, c, 0x1500483C, CAM_BNR_RSV2, R)\
	CMD(a, b, c, 0x15004840, CAM_BNR_PDC_CON, R)\
	CMD(a, b, c, 0x15004844, CAM_BNR_PDC_GAIN_L0, R)\
	CMD(a, b, c, 0x15004848, CAM_BNR_PDC_GAIN_L1, R)\
	CMD(a, b, c, 0x1500484C, CAM_BNR_PDC_GAIN_L2, R)\
	CMD(a, b, c, 0x15004850, CAM_BNR_PDC_GAIN_L3, R)\
	CMD(a, b, c, 0x15004854, CAM_BNR_PDC_GAIN_L4, R)\
	CMD(a, b, c, 0x15004858, CAM_BNR_PDC_GAIN_R0, R)\
	CMD(a, b, c, 0x1500485C, CAM_BNR_PDC_GAIN_R1, R)\
	CMD(a, b, c, 0x15004860, CAM_BNR_PDC_GAIN_R2, R)\
	CMD(a, b, c, 0x15004864, CAM_BNR_PDC_GAIN_R3, R)\
	CMD(a, b, c, 0x15004868, CAM_BNR_PDC_GAIN_R4, R)\
	CMD(a, b, c, 0x1500486C, CAM_BNR_PDC_TH_GB, R)\
	CMD(a, b, c, 0x15004870, CAM_BNR_PDC_TH_IA, R)\
	CMD(a, b, c, 0x15004874, CAM_BNR_PDC_TH_HD, R)\
	CMD(a, b, c, 0x15004878, CAM_BNR_PDC_SL, R)\
	CMD(a, b, c, 0x1500487C, CAM_BNR_PDC_POS, W)\
	CMD(a, b, c, 0x15004C00, CAM_DBS_SIGMA, R)\
	CMD(a, b, c, 0x15004C04, CAM_DBS_BSTBL_0, R)\
	CMD(a, b, c, 0x15004C08, CAM_DBS_BSTBL_1, R)\
	CMD(a, b, c, 0x15004C0C, CAM_DBS_BSTBL_2, R)\
	CMD(a, b, c, 0x15004C10, CAM_DBS_BSTBL_3, R)\
	CMD(a, b, c, 0x15004C14, CAM_DBS_CTL, R)\
	CMD(a, b, c, 0x15004C18, CAM_DBS_CTL_2, R)\
	CMD(a, b, c, 0x15004C1C, CAM_DBS_SIGMA_2, R)\
	CMD(a, b, c, 0x15004C20, CAM_DBS_YGN, R)\
	CMD(a, b, c, 0x15004C24, CAM_DBS_SL_Y12, R)\
	CMD(a, b, c, 0x15004C28, CAM_DBS_SL_Y34, R)\
	CMD(a, b, c, 0x15004C2C, CAM_DBS_SL_G12, R)\
	CMD(a, b, c, 0x15004C30, CAM_DBS_SL_G34, R)\
	...
	CMD(a, b, c, 0x150067CC, CAM_RRZ_D_RLB_AOFST, W)\
	CMD(a, b, c, 0x15006800, CAM_BNR_D_BPC_CON, W)\
	CMD(a, b, c, 0x15006804, CAM_BNR_D_BPC_TH1, W)\
	CMD(a, b, c, 0x15006808, CAM_BNR_D_BPC_TH2, W)\
	CMD(a, b, c, 0x1500680C, CAM_BNR_D_BPC_TH3, W)\
	CMD(a, b, c, 0x15006810, CAM_BNR_D_BPC_TH4, W)\
	CMD(a, b, c, 0x15006814, CAM_BNR_D_BPC_DTC, W)\
	CMD(a, b, c, 0x15006818, CAM_BNR_D_BPC_COR, W)\
	CMD(a, b, c, 0x1500681C, CAM_BNR_D_BPC_TBLI1, W)\
	CMD(a, b, c, 0x15006820, CAM_BNR_D_BPC_TBLI2, W)\
	CMD(a, b, c, 0x15006824, CAM_BNR_D_BPC_TH1_C, W)\
	CMD(a, b, c, 0x15006828, CAM_BNR_D_BPC_TH2_C, W)\
	CMD(a, b, c, 0x1500682C, CAM_BNR_D_BPC_TH3_C, W)\
	CMD(a, b, c, 0x15006830, CAM_BNR_D_NR1_CON, W)\
	CMD(a, b, c, 0x15006834, CAM_BNR_D_NR1_CT_CON, W)\
	CMD(a, b, c, 0x15006838, CAM_BNR_D_RSV1, W)\
	CMD(a, b, c, 0x1500683C, CAM_BNR_D_RSV2, W)\
	CMD(a, b, c, 0x15006840, CAM_BNR_D_PDC_CON, W)\
	CMD(a, b, c, 0x15006844, CAM_BNR_D_PDC_GAIN_L0, W)\
	CMD(a, b, c, 0x15006848, CAM_BNR_D_PDC_GAIN_L1, W)\
	CMD(a, b, c, 0x1500684C, CAM_BNR_D_PDC_GAIN_L2, W)\
	CMD(a, b, c, 0x15006850, CAM_BNR_D_PDC_GAIN_L3, W)\
	CMD(a, b, c, 0x15006854, CAM_BNR_D_PDC_GAIN_L4, W)\
	CMD(a, b, c, 0x15006858, CAM_BNR_D_PDC_GAIN_R0, W)\
	CMD(a, b, c, 0x1500685C, CAM_BNR_D_PDC_GAIN_R1, W)\
	CMD(a, b, c, 0x15006860, CAM_BNR_D_PDC_GAIN_R2, W)\
	CMD(a, b, c, 0x15006864, CAM_BNR_D_PDC_GAIN_R3, W)\
	CMD(a, b, c, 0x15006868, CAM_BNR_D_PDC_GAIN_R4, W)\
	CMD(a, b, c, 0x1500686C, CAM_BNR_D_PDC_TH_GB, W)\
	CMD(a, b, c, 0x15006870, CAM_BNR_D_PDC_TH_IA, W)\
	CMD(a, b, c, 0x15006874, CAM_BNR_D_PDC_TH_HD, W)\
	CMD(a, b, c, 0x15006878, CAM_BNR_D_PDC_SL, W)\
	CMD(a, b, c, 0x1500687C, CAM_BNR_D_PDC_POS, W)\
	CMD(a, b, c, 0x15006C00, CAM_DBS_D_SIGMA, W)\
	CMD(a, b, c, 0x15006C04, CAM_DBS_D_BSTBL_0, W)\
	CMD(a, b, c, 0x15006C08, CAM_DBS_D_BSTBL_1, W)\
	CMD(a, b, c, 0x15006C0C, CAM_DBS_D_BSTBL_2, W)\
	CMD(a, b, c, 0x15006C10, CAM_DBS_D_BSTBL_3, W)\
	CMD(a, b, c, 0x15006C14, CAM_DBS_D_CTL, W)\
	CMD(a, b, c, 0x15006C18, CAM_DBS_D_CTL_2, W)\
	CMD(a, b, c, 0x15006C1C, CAM_DBS_D_SIGMA_2, W)\
	CMD(a, b, c, 0x15006C20, CAM_DBS_D_YGN, W)\
	CMD(a, b, c, 0x15006C24, CAM_DBS_D_SL_Y12, W)\
	CMD(a, b, c, 0x15006C28, CAM_DBS_D_SL_Y34, W)\
	CMD(a, b, c, 0x15006C2C, CAM_DBS_D_SL_G12, W)\
	CMD(a, b, c, 0x15006C30, CAM_DBS_D_SL_G34, W)\
