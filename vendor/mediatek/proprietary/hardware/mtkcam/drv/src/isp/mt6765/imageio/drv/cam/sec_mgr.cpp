...
MBOOL SecMgrImp::SecMgr_OpenCA()
{
    ...
    SecMgr_INF("SecMgr_OpenCA+ (%p)",ispHandle);
...
MBOOL SecMgrImp::SecMgr_attach(MUINT32 tg,MUINT32 sen_idx,vector<MUINT32> sec_port,MUINT32 burstq,MUINT32 tee_type,MUINT64 chk)
{
    ...
    switch(tg)
    {
        case 0:
            ...
            SecMgr_INF("Secure Cam(0x%x) attached",this->CamInfo[0].CamModule);
            break;
        ...
        case 1:
            ...
            SecMgr_INF("Secure Cam(0x%x) attached",this->CamInfo[1].CamModule);
            break;
