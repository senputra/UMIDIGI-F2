...
/*    UNI_ISP_HDS_B_,              // 1    3610 //TBD
    UNI_ISP_RSS_B_,              // 9    3630~3650*/
    //UNI_B
    UNI_B_CTL_EN_,                   // 2  3110~3114
    UNI_B_CTL_SEL_,                  // 1  3118
    UNI_B_CTL_FMT_,                  // 1  311C
    UNI_B_FBC_FLKO_,                 // 1  3180
    UNI_B_FBC_EISO_,                 // 1  3188
    UNI_B_FBC_RSSO_,                 // 1  3190
    UNI_B_DMA_V_FLIP_,               // 1  3604
    UNI_B_DMA_EISO_BA,               // 2  3620~3624
    UNI_B_DMA_EISO_,                 // 5  3628~
    UNI_B_DMA_FLKO_BA,               // 1  3650
    UNI_B_DMA_FLKO_,                 // 5  3658~
    UNI_B_DMA_RSSO_A_BA,             // 2  3680~3684
    UNI_B_DMA_RSSO_A_,               // 5  3688~
    UNI_B_DMA_RSSO_B_BA,             // 2  36B0~36B4
    UNI_B_DMA_RSSO_B_,               // 5  36B8~
    UNI_B_DMA_RAWI_,                 // 7  3740~
    UNI_B_DMA_FH_EN_,                // 1  37C0
    UNI_B_DMA_FH_EISO_,              // 1  37C4
    UNI_B_DMA_FH_EISO_SPARE_,        // 15 37E0
    UNI_B_DMA_FH_FLKO_,              // 1  37C8
    UNI_B_DMA_FH_FLKO_SPARE_MAGIC_,  // 1  3820
    UNI_B_DMA_FH_FLKO_SPARE_,        // 14 3824~
    UNI_B_DMA_FH_RSSO_A_,            // 1  37CC
    UNI_B_DMA_FH_RSSO_A_SPARE_,      // 15 3860~
    UNI_B_DMA_FH_RSSO_B_,            // 1  37D0
    UNI_B_DMA_FH_RSSO_B_SPARE_,      // 15 38A0~
    UNI_B_ISP_UNP2_,                 // 1  3900
    UNI_B_ISP_SGG3_,                 // 3  3920~3928
    UNI_B_ISP_FLK_,                  // 4  3930~393C
    UNI_B_ISP_HDS_,                  // 1  39A0
    UNI_B_ISP_EIS_,                  // 9  3950~
    UNI_B_ISP_RSS_,                  // 9  39C0~
    //
    CAM_DUMMY_,                  // 1    4ffc
...
#define CAM_BURST_READ_REGS(IspDrvPtr,RegName,RegStruct,RegCount,...)({\
    MBOOL ret=0;\
    RegStruct[0].Addr = (MUINT8*)(&( ((cam_reg_t*)(IspDrvPtr->m_pIspRegMap))->RegName)) - \
...
typedef struct _ion_mem_handle_st_node_
{
    ISP_DEV_ION_NODE_STRUCT ionNode;
    MUINT32 ionCnt;
}ION_MEM_HANDLE_ST_NODE;
...
class ISP_DRV_CAM : public IspDrvVir, public IspDrv
{
    ...
    private:
                ...
                MBOOL   twinPath_CQ_Ctrl(MUINT32 moduleId); //this is for master cam to control salve cam under twin mode
    public:

    private:
        volatile MINT32         m_UserCnt;
        mutable android::Mutex           IspRegMutex;
        mutable android::Mutex           IspVirRegProt;
        //
        ...
        E_ISP_CAM_CQ    m_CQ;
        MBOOL           m_bVirRegValid;
        ISP_HW_MODULE   m_HWModule;
        ISP_HW_MODULE   m_Module;           //phy + virtual hw module
        MUINT32         m_pageIdx;
        char            m_useName[32];
        MUINT32         m_IspVirRegSize_method1; //for mprotect, now is only apply on CQ which is allocated by method 1
