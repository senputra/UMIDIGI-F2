...
//extern int test_iopipe(int testNum, int testType, int loopNum);
...
int main(int argc, char** argv)
{
    ...
    int testcaseNum;
    int testtype2;
    int p2LoopNum = atoi(argv[3]);

    testcaseType = atoi(argv[2]);
    testcaseNum = atoi(argv[3]);
    testtype2 = atoi(argv[4]);
...
#if 0
    case 2:
        ret = test_iopipe(testnum, testtype, p2LoopNum);
        break;
#endif
#if 0
    case 3:
