...
#define MAX_WPE_BURST_IDX_NUM   2
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    virtual MBOOL   init(ISP_WPE_MODULE_IDX module_idx) = 0;
    virtual MBOOL   uninit(ISP_WPE_MODULE_IDX module_idx) = 0;

    virtual MINT32 configwpe(WpePackage wpepackage) = 0;
    virtual MINT32 configWpeCommandData(NSCam::NSIoPipe::WPEConfig wpeconfig, MUINT32 configExtraFeture)= 0;
    virtual MVOID  configTpipeData(NSCam::NSIoPipe::WPEConfig wpeconfig, MUINT32 configExtraFeture)= 0;
    virtual MINT32 start(MINT32  wpeDupIdx, MINT32  wpeBurstIdx, MUINT32 wpeDupCmdIdx)= 0;
    virtual MINT32 dequeue(MINT32  wpeDupIdx, MINT32  wpeBurstIdx, MUINT32 wpeDupCmdIdx, QParams rParams)= 0;
