...
class TwinDrvImp : public TwinDrv
{
    ...
    public:
        ...
        virtual MBOOL   init(E_TWIN_MODE mode);
        virtual MBOOL   uninit(void);
        virtual MBOOL   configTwinPara(void);
    ...
    public://driver object operation
        ...
        inline virtual void*    getIspPtr(void) {return (void*)&m_isp_reg_ptr;}
    //
    public:
        DUAL_IN_CONFIG_STRUCT  m_dual_isp_in_config;
        DUAL_OUT_CONFIG_STRUCT m_dual_isp_out_config;
        ISP_REG_PTR_STRUCT     m_isp_reg_ptr;
