...
public:
    ...
    virtual MINT32                  dropEnqueueBuf(const TWIN_MGR_PATH_CFG_IN_PARAM& cfgInParam, list<MUINT32>* pLPortNum, list<MUINT32>* pLMagicNum) = 0;
    ...
    virtual MBOOL                   updateSuspendDone(void) = 0;  // notify STT suspend done, change cam state
    virtual MBOOL                   resume(void) = 0;

    virtual MBOOL                   recoverTwin(E_CAMPATH_STEP step) = 0;
    //per-frame control
    ...
    virtual MINT32                  dropTwin(const TWIN_MGR_PATH_CFG_IN_PARAM& cfgInParam, list<MUINT32>* pLPortNum, list<MUINT32>* pLMagicNum) = 0;
