...
int ef_test()
{
    ...
    PortInfo m_imgo;
           PortInfo m_rrzo;
    NSImageioIsp3::NSIspio::PortID mPortID;
    QBufInfo rQBufInfo;
    ...
    QTimeStampBufInfo rQTSBufInfo;
        ...
        m_tgi.type        = NSCam::NSIoPipeIsp3::EPortType_Sensor;               // EPortType
        ...
        m_imgo.type  = NSCam::NSIoPipeIsp3::EPortType_Memory;        // EPortType
        ...
        m_imgo.inout = EPortDirection_Out;      // 0:in/1:out
                    ...
                    m_rrzo.type   = NSCam::NSIoPipeIsp3::EPortType_Memory;     //  EPortType
        ...
        for(int j=0;j<3;j++)
        {
            ...
            if(ret_mem != 0)
            {
                LOG_ERR("map rrzo physical memory fail!");
                                ...
                                mPortID.index = NSImageio::NSIspio::EPortIndex_RRZO;
