...
#include <mtkcam/utils/std/ULog.h>
    ...
    #define BASE_LOG_INF(fmt, arg...)       CAM_ULOGI(NSCam::Utils::ULog::MOD_DRV_NORMAL_PIPE, DBG_LOG_TAG "[%s] " fmt, __func__, ##arg)    // <Info>: Show general system information. Like OS version, start/end of Service...
