...
#define RSS_LOG(fmt, arg...)     CAM_LOGD("[%s]" fmt, __func__, ##arg)
#define RSS_INF(fmt, arg...)      CAM_LOGI("[%s]" fmt, __func__, ##arg)
#define RSS_WRN(fmt, arg...)    CAM_LOGW("[%s] WRN(%5d):" fmt, __func__, __LINE__, ##arg)
#define RSS_ERR(fmt, arg...)     CAM_LOGE("[%s] %s ERROR(%5d):" fmt, __func__,__FILE__, __LINE__, ##arg)
...
RssP1CbImpl::RssP1CbImpl() : RssP1Cb()
{
    ...
    property_get("debug.rssdrv.dump", value, NULL);
