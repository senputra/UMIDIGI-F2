...
/**
    this define is for CmdQ null cmd BUG
*/
#define CQ_NULL_BUG 0
...
typedef enum {
    ...
    CAM_CTL_FMT_,                // 1    400c
    CAM_CTL_SEL_,                // 1    4010
    CAM_CTL_DONE_SEL_BUG_A,
    CAM_CTL_DONE_SEL_,           // 3    4044~404c
    CAM_CTL_DONE_SEL_BUG_,
    CAM_TWIN_COUNTER,            // 1    4054
    ...
    CAM_DMA_IMGO_BA_BUG_A,
    CAM_DMA_IMGO_BA,             // 2    4220~4224
    CAM_DMA_IMGO_BA_BUG_,
    CAM_DMA_IMGO_BUG_A,
    CAM_DMA_IMGO_,               // 5    4228~4238
    CAM_DMA_IMGO_BUG_,
    CAM_DMA_IMGO_CROP_,          // 1    4248
    CAM_DMA_RRZO_BA_BUG_A,
    CAM_DMA_RRZO_BA,             // 2    4250~4254
    CAM_DMA_RRZO_BA_BUG_,
    CAM_DMA_RRZO_BUG_A,
    CAM_DMA_RRZO_,               // 5    4258~4268
    CAM_DMA_RRZO_BUG_,
    CAM_DMA_RRZO_CROP_,          // 1    4278
    CAM_DMA_AAO_BA,              // 1    4280~4284
    CAM_DMA_AAO_BUG_A,
    CAM_DMA_AAO_,                // 5    4280~4298
    CAM_DMA_AAO_BUG_,
    CAM_DMA_AFO_BA,              // 1    42b0~42b4
    CAM_DMA_AFO_BA_OFST_BUG_A,
    CAM_DMA_AFO_BA_OFST,         // 2    42b8~42bc
    CAM_DMA_AFO_BA_OFST_BUG_,
    CAM_DMA_AFO_BUG_A,
    CAM_DMA_AFO_,                // 5    42B0~42C8
    CAM_DMA_AFO_BUG_,
    CAM_DMA_LCSO_BA_BUG_A,
    CAM_DMA_LCSO_BA,             // 2    42E0~42E4
    CAM_DMA_LCSO_BA_BUG_,
    CAM_DMA_LCSO_BUG_A,
    CAM_DMA_LCSO_,               // 5    42E8~42F8
    CAM_DMA_LCSO_BUG_,
    CAM_DMA_UFEO_BA_BUG_A,
    CAM_DMA_UFEO_BA,             // 2    4310~4314
    CAM_DMA_UFEO_BA_BUG_,
    CAM_DMA_UFEO_BUG_A,
    CAM_DMA_UFEO_,               // 5    4318~4328
    CAM_DMA_UFEO_BUG_,
    CAM_DMA_PDO_BA,              // 2    4340~4344
    CAM_DMA_PDO_BUG_A,
    CAM_DMA_PDO_,                // 5    4348~4358
    CAM_DMA_PDO_BUG_,
    CAM_DMA_BPCI_BUG_A,
    ...
    CAM_DMA_FH_IMGO_SPARE_BUG_A,
    CAM_DMA_FH_IMGO_SPARE_,      // 15   4C30~4C68
    CAM_DMA_FH_IMGO_SPARE_BUG_,
    CAM_DMA_FH_RRZO_,            // 1    4C08
    CAM_DMA_FH_RRZO_SPARE_BUG_A,
    CAM_DMA_FH_RRZO_SPARE_,      // 15   4C70~4CA8
    CAM_DMA_FH_RRZO_SPARE_BUG_,
    CAM_DMA_FH_AAO_,             // 1    4C0C
    CAM_DMA_FH_AAO_SPARE_MAGIC_, // 1    4cb0
    CAM_DMA_FH_AAO_SPARE_BUG_A,
    CAM_DMA_FH_AAO_SPARE_,       // 14   4CB4~4CE8
    CAM_DMA_FH_AAO_SPARE_BUG_,
    CAM_DMA_FH_AFO_,             // 1    4C10
    CAM_DMA_FH_AFO_SPARE_MAGIC_BUG_A,
    CAM_DMA_FH_AFO_SPARE_MAGIC_, // 2    4cf0~4CF4
    CAM_DMA_FH_AFO_SPARE_MAGIC_BUG_,
    CAM_DMA_FH_AFO_SPARE_BUG_A,
    CAM_DMA_FH_AFO_SPARE_,       // 13   4CF8~4D28
    CAM_DMA_FH_AFO_SPARE_BUG_,
    CAM_DMA_FH_LCSO_,            // 1    4C14
    CAM_DMA_FH_LCSO_SPARE_BUG_A,
    CAM_DMA_FH_LCSO_SPARE_,      // 15   4D30~4D68
    CAM_DMA_FH_LCSO_SPARE_BUG_,
    CAM_DMA_FH_UFEO_,            // 1    4C18
    CAM_DMA_FH_UFEO_SPARE_BUG_A,
    CAM_DMA_FH_UFEO_SPARE_,      // 15   4D70~4DA8
    CAM_DMA_FH_UFEO_SPARE_BUG_,
    CAM_DMA_FH_PDO_,             // 1    4C1C
    CAM_DMA_FH_PDO_SPARE_MAGIC_BUG_A,
    CAM_DMA_FH_PDO_SPARE_MAGIC_, // 7    4db0~4dC8
    CAM_DMA_FH_PDO_SPARE_MAGIC_BUG_,
    CAM_DMA_FH_PDO_SPARE_BUG_A,
    CAM_DMA_FH_PDO_SPARE_,       // 8    4DCC~4DE8
    CAM_DMA_FH_PDO_SPARE_BUG_,
    CAM_CQ_THRE0_ADDR_,          // 1    4168
    CAM_CQ_THRE0_SIZE_,          // 1    4170
    CAM_CQ_THRE1_ADDR_,          // 1    4180
    CAM_CQ_THRE1_SIZE_,          // 1    4184
    CAM_CQ_THRE2_ADDR_,          // 1    418c
    CAM_CQ_THRE2_SIZE_,          // 1    4190
    CAM_CQ_THRE3_ADDR_,          // 1    4198
    CAM_CQ_THRE3_SIZE_,          // 1    419C
    CAM_CQ_THRE4_ADDR_,          // 1    41a4
    CAM_CQ_THRE4_SIZE_,          // 1    41A8
    CAM_CQ_THRE5_ADDR_,          // 1    41b0
    CAM_CQ_THRE5_SIZE_,          // 1    41B4
    CAM_CQ_THRE6_ADDR_,          // 1    41bc
    CAM_CQ_THRE6_SIZE_,          // 1    41C0
    CAM_CQ_THRE7_ADDR_,          // 1    41c8
    CAM_CQ_THRE7_SIZE_,          // 1    41CC
    CAM_CQ_THRE8_ADDR_,          // 1    41d4
    CAM_CQ_THRE8_SIZE_,          // 1    41D8
    CAM_CQ_THRE9_ADDR_,          // 1    41e0
    CAM_CQ_THRE9_SIZE_,          // 1    41E4
    CAM_CQ_THRE10_ADDR_,         // 1    41ec
    CAM_CQ_THRE10_SIZE_,         // 1    41F0
    CAM_CQ_THRE11_ADDR_,         // 1    41f8
    CAM_CQ_THRE11_SIZE_,         // 1    41FC
    CAM_ISP_DMX_BUG_A,
    ...
    UNI_DMA_FLKO_BUG_,
    UNI_DMA_RSSO_A_BA_BUG_A,
    UNI_DMA_RSSO_A_BA,           // 2    3280~3284
    UNI_DMA_RSSO_A_BA_BUG_,
    UNI_DMA_RSSO_A_BUG_A,
    UNI_DMA_RSSO_A_,             // 5    3288~3298
    UNI_DMA_RSSO_A_BUG_,
    UNI_DMA_RSSO_B_BA_BUG_A,
    UNI_DMA_RSSO_B_BA,           // 2    32b0~32b4
    UNI_DMA_RSSO_B_BA_BUG_,
    UNI_DMA_RSSO_B_BUG_A,
    ...
    UNI_ISP_FLK_BUG_,
    UNI_ISP_SGG2_A_BUG_A,
    UNI_ISP_SGG2_A_,             // 3    3590~3598
    UNI_ISP_SGG2_A_BUG_,
    ...
    UNI_ISP_RSS_A_BUG_,
    UNI_ISP_SGG2_B_BUG_A,
    UNI_ISP_SGG2_B_,             // 3    3600~3608
    UNI_ISP_SGG2_B_BUG_,
...
typedef enum {
    ...
    CAM_DMA_RRZO_,               // 5    4258~4268
    CAM_DMA_RRZO_CROP_,          // 1    4278
    CAM_DMA_AAO_BA,              // 2    4280~4284
    CAM_DMA_AAO_,                // 5    4280~4298
    CAM_DMA_AFO_BA,              // 2    42b0~42b4
    CAM_DMA_AFO_BA_OFST,         // 2    42b8~42bc
    CAM_DMA_AFO_,                // 5    42B0~42C8
    CAM_DMA_LCSO_BA,             // 2    42E0~42E4
    CAM_DMA_LCSO_,               // 5    42E8~42F8
...
#define CAM_CQ_THRE1_ADDR_CQONLY    (CAM_NEXT_Thread_)  // 1    C180           // for CQ access only
#define CAM_CQ_THRE2_ADDR_CQONLY    (CAM_NEXT_Thread_)  // 1    C18C           // for CQ access only
#define CAM_CQ_THRE3_ADDR_CQONLY    (CAM_NEXT_Thread_)  // 1    C198           // for CQ access only
#define CAM_CQ_THRE4_ADDR_CQONLY    (CAM_NEXT_Thread_)  // 1    C1A4           // for CQ access only
#define CAM_CQ_THRE5_ADDR_CQONLY    (CAM_NEXT_Thread_)  // 1    C1B0           // for CQ access only
#define CAM_CQ_THRE6_ADDR_CQONLY    (CAM_NEXT_Thread_)  // 1    C1BC           // for CQ access only
#define CAM_CQ_THRE7_ADDR_CQONLY    (CAM_NEXT_Thread_)  // 1    C1C8           // for CQ access only
#define CAM_CQ_THRE8_ADDR_CQONLY    (CAM_NEXT_Thread_)  // 1    C1D4           // for CQ access only
#define CAM_CQ_THRE9_ADDR_CQONLY    (CAM_NEXT_Thread_)  // 1    C1E0           // for CQ access only
#define CAM_CQ_THRE10_ADDR_CQONLY   (CAM_NEXT_Thread_)  // 1    C1EC           // for CQ access only
#define CAM_CQ_THRE11_ADDR_CQONLY   (CAM_NEXT_Thread_)  // 1    C1F8           // for CQ access only
///////////////////////////////////////////////////////////////////////////
