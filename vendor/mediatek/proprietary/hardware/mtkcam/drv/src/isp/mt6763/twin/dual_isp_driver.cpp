    ...
    if (ptr_isp_reg_param && ptr_dual_in_config && ptr_dual_out_config && (0x3 == dual_sel))
    {
        ...
        if (ptr_isp_reg_param->ptr_isp_reg && ptr_isp_reg_param->ptr_isp_reg_d)
        {
			if (TWIN_SCENARIO_AF_FAST_P2 == ptr_dual_in_config->SW.TWIN_SCENARIO)
			{
				...
				ptr_dual_in_config->CAM_A_CTL_FMT_SEL.Raw = ptr_isp_reg->CAM_A_CTL_FMT_SEL.Raw;
				ptr_dual_in_config->CAM_A_RMG_HDR_CFG.Raw = ptr_isp_reg->CAM_A_RMG_HDR_CFG.Raw;
				ptr_dual_in_config->CAM_B_CTL_EN.Raw = ptr_isp_reg_d->CAM_B_CTL_EN.Raw;
				ptr_dual_in_config->CAM_B_CTL_DMA_EN.Raw = ptr_isp_reg_d->CAM_B_CTL_DMA_EN.Raw;
				...
				ptr_dual_in_config->CAM_A_AF_TH_0.Raw = ptr_isp_reg->CAM_A_AF_TH_0.Raw;
				ptr_dual_in_config->CAM_A_AF_TH_1.Raw = ptr_isp_reg->CAM_A_AF_TH_1.Raw;
				ptr_dual_in_config->CAM_A_AF_FLT_1.Raw = ptr_isp_reg->CAM_A_AF_FLT_1.Raw;
				ptr_dual_in_config->CAM_A_AF_FLT_2.Raw = ptr_isp_reg->CAM_A_AF_FLT_2.Raw;
				ptr_dual_in_config->CAM_A_AF_FLT_3.Raw = ptr_isp_reg->CAM_A_AF_FLT_3.Raw;
				ptr_dual_in_config->CAM_A_AF_FLT_4.Raw = ptr_isp_reg->CAM_A_AF_FLT_4.Raw;
				ptr_dual_in_config->CAM_A_AF_FLT_5.Raw = ptr_isp_reg->CAM_A_AF_FLT_5.Raw;
				ptr_dual_in_config->CAM_A_AF_FLT_6.Raw = ptr_isp_reg->CAM_A_AF_FLT_6.Raw;
				ptr_dual_in_config->CAM_A_AF_FLT_7.Raw = ptr_isp_reg->CAM_A_AF_FLT_7.Raw;
				ptr_dual_in_config->CAM_A_AF_FLT_8.Raw = ptr_isp_reg->CAM_A_AF_FLT_8.Raw;
				ptr_dual_in_config->CAM_A_AF_TH_2.Raw = ptr_isp_reg->CAM_A_AF_TH_2.Raw;
				ptr_dual_in_config->CAM_B_AF_BLK_0.Raw = ptr_isp_reg_d->CAM_B_AF_BLK_0.Raw;
				ptr_dual_in_config->CAM_B_AF_CON.Raw = ptr_isp_reg_d->CAM_B_AF_CON.Raw;
				ptr_dual_in_config->CAM_B_AF_TH_0.Raw = ptr_isp_reg_d->CAM_B_AF_TH_0.Raw;
				ptr_dual_in_config->CAM_B_AF_TH_1.Raw = ptr_isp_reg_d->CAM_B_AF_TH_1.Raw;
				ptr_dual_in_config->CAM_B_AF_FLT_1.Raw = ptr_isp_reg_d->CAM_B_AF_FLT_1.Raw;
				ptr_dual_in_config->CAM_B_AF_FLT_2.Raw = ptr_isp_reg_d->CAM_B_AF_FLT_2.Raw;
				ptr_dual_in_config->CAM_B_AF_FLT_3.Raw = ptr_isp_reg_d->CAM_B_AF_FLT_3.Raw;
				ptr_dual_in_config->CAM_B_AF_FLT_4.Raw = ptr_isp_reg_d->CAM_B_AF_FLT_4.Raw;
				ptr_dual_in_config->CAM_B_AF_FLT_5.Raw = ptr_isp_reg_d->CAM_B_AF_FLT_5.Raw;
				ptr_dual_in_config->CAM_B_AF_FLT_6.Raw = ptr_isp_reg_d->CAM_B_AF_FLT_6.Raw;
				ptr_dual_in_config->CAM_B_AF_FLT_7.Raw = ptr_isp_reg_d->CAM_B_AF_FLT_7.Raw;
				ptr_dual_in_config->CAM_B_AF_FLT_8.Raw = ptr_isp_reg_d->CAM_B_AF_FLT_8.Raw;
				ptr_dual_in_config->CAM_B_AF_TH_2.Raw = ptr_isp_reg_d->CAM_B_AF_TH_2.Raw;
				/* DUAL_ENGINE_LIST_HW_RW_RW */
				ptr_dual_in_config->CAM_A_AF_SIZE.Raw = ptr_isp_reg->CAM_A_AF_SIZE.Raw;
				...
				ptr_dual_in_config->CAM_A_AFO_OFST_ADDR.Raw = ptr_isp_reg->CAM_A_AFO_OFST_ADDR.Raw;
				ptr_dual_in_config->CAM_A_AFO_XSIZE.Raw = ptr_isp_reg->CAM_A_AFO_XSIZE.Raw;
				ptr_dual_in_config->CAM_A_AFO_YSIZE.Raw = ptr_isp_reg->CAM_A_AFO_YSIZE.Raw;
				ptr_dual_in_config->CAM_B_AF_SIZE.Raw = ptr_isp_reg_d->CAM_B_AF_SIZE.Raw;
				ptr_dual_in_config->CAM_B_AF_BLK_1.Raw = ptr_isp_reg_d->CAM_B_AF_BLK_1.Raw;
				ptr_dual_in_config->CAM_B_AF_VLD.Raw = ptr_isp_reg_d->CAM_B_AF_VLD.Raw;
				ptr_dual_in_config->CAM_B_AFO_OFST_ADDR.Raw = ptr_isp_reg_d->CAM_B_AFO_OFST_ADDR.Raw;
				ptr_dual_in_config->CAM_B_AFO_XSIZE.Raw = ptr_isp_reg_d->CAM_B_AFO_XSIZE.Raw;
				ptr_dual_in_config->CAM_B_AFO_YSIZE.Raw = ptr_isp_reg_d->CAM_B_AFO_YSIZE.Raw;
			}
			else
			{
				DUAL_REG_A_STRUCT *ptr_isp_reg = ptr_isp_reg_param->ptr_isp_reg;
				...
				DUAL_ENGINE_ARRAY_HW(DUAL_COPY_ARRAY_A_A, ptr_dual_in_config, ptr_isp_reg,,,,);
				/* B to B and A to B */
				...
				DUAL_ENGINE_ARRAY_HW(DUAL_COPY_ARRAY_A_B, ptr_dual_out_config, ptr_isp_reg,,,,);
			}
        }
    }
    return 0;
    ...
    if (ptr_isp_reg_param && ptr_dual_in_config && ptr_dual_out_config)
    {
        ...
        if (ptr_isp_reg_param->ptr_isp_reg && ptr_isp_reg_param->ptr_isp_reg_d && (0x3 == dual_sel))
        {
			if (TWIN_SCENARIO_AF_FAST_P2 == ptr_dual_in_config->SW.TWIN_SCENARIO)
			{
				...
				ptr_isp_reg_d->CAM_B_AF_TH_0.Raw = ptr_dual_out_config->CAM_B_AF_TH_0.Raw;
				ptr_isp_reg_d->CAM_B_AF_TH_1.Raw = ptr_dual_out_config->CAM_B_AF_TH_1.Raw;
				ptr_isp_reg_d->CAM_B_AF_FLT_1.Raw = ptr_dual_out_config->CAM_B_AF_FLT_1.Raw;
				ptr_isp_reg_d->CAM_B_AF_FLT_2.Raw = ptr_dual_out_config->CAM_B_AF_FLT_2.Raw;
				ptr_isp_reg_d->CAM_B_AF_FLT_3.Raw = ptr_dual_out_config->CAM_B_AF_FLT_3.Raw;
				ptr_isp_reg_d->CAM_B_AF_FLT_4.Raw = ptr_dual_out_config->CAM_B_AF_FLT_4.Raw;
				ptr_isp_reg_d->CAM_B_AF_FLT_5.Raw = ptr_dual_out_config->CAM_B_AF_FLT_5.Raw;
				ptr_isp_reg_d->CAM_B_AF_FLT_6.Raw = ptr_dual_out_config->CAM_B_AF_FLT_6.Raw;
				ptr_isp_reg_d->CAM_B_AF_FLT_7.Raw = ptr_dual_out_config->CAM_B_AF_FLT_7.Raw;
				ptr_isp_reg_d->CAM_B_AF_FLT_8.Raw = ptr_dual_out_config->CAM_B_AF_FLT_8.Raw;
				ptr_isp_reg_d->CAM_B_AF_TH_2.Raw = ptr_dual_out_config->CAM_B_AF_TH_2.Raw;
				/* DUAL_ENGINE_LIST_HW_RW_RW */
			...
			else
			{
				...
				DUAL_ENGINE_ARRAY_HW(DUAL_COPY_ARRAY_B_B, ptr_isp_reg_d, ptr_dual_out_config,,,,);
			}
		}
	}
	return 0;
