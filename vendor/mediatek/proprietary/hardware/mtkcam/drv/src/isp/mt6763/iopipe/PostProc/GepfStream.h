...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_GEPF_GepfStream_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_GEPF_GepfStream_H_
//
...
IGepfStream* getGepfStreamImp(char const* szCallerName);

struct  GEPFRequest
{
    void* m_pGepfStream;
    unsigned int m_Num;
    GEPFParams m_GEPFParams;
};
 ...
 *
 ******************************************************************************/
class GepfStream : public IGepfStream
{
    friend  class IGepfStream;
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  IPipe Interface.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     *   getLastErrorCode().
     */
    virtual MBOOL                   GEPFenque(
                                        GEPFParams const& rGepfParams
                                    );
...
private:
    ...
    MVOID releaseLock();
    MINT32 getUs();
    MBOOL saveToFile(char const* filepath, GEPFBufInfo* buffer);
...
#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_GEPF_GepfStream_H_
