...
public:     ////    Constructor/Destructor.
    SImager(IImageBuffer const * pImageBuffer, MINT32 iSensorIdx = -1);
    virtual ~SImager() {};
...
public:     ////    Operations.
    virtual MBOOL    execute(struct timeval *endTime = NULL, MUINT32 u4TimeoutMs = 0xFFFFFFFF);
