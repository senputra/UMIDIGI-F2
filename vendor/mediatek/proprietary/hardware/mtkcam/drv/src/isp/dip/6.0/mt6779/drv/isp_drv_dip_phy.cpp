...
MBOOL PhyDipDrvImp::getDipDumpInfo(MUINT32& tdriaddr, MUINT32& cmdqaddr, MUINT32& imgiaddr)
{
    ...
    tdriaddr = (get_dumpinfo.tdri_baseaddr & 0xFFFFF000);
...
MBOOL PhyDipDrvImp::dumpDipHwReg(IspDumpDbgLogDipPackage* pP2Package, int m_dumpDipHwTpipeReg)
{
    dip_x_reg_t dipReg;
    MUINT32 i, gce_err;
    ...
    MUINT32 size=sizeof(dip_x_reg_t);
    DIP_GET_DUMP_INFO_STRUCT get_dumpinfo;
    if(ioctl(this->m_Fd,DIP_CMD_GET_GCE_FIRST_ERR,&gce_err) < 0){
        LOG_ERR("gce_err:0x%x\n", gce_err);
    }
    switch (gce_err)
    {
        case DIP_GCE_EVENT_DPE:
            LOG_INF("DPE is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_RSC:
            LOG_INF("RSC is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_WPE:
            LOG_INF("WPE is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_MFB:
            LOG_INF("MFB is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_FDVT:
            LOG_INF("FDVT is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_DIP:
            LOG_INF("DIP is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_MDP:
            LOG_INF("MDP is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_DISP:
            LOG_INF("DISP is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_JPGE:
            LOG_INF("JPGE is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_VENC:
            LOG_INF("VENC is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_CMDQ:
            LOG_INF("CMDQ is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        case DIP_GCE_EVENT_THEOTHERS:
            LOG_INF("THEOTHERS is 1st Error!! gce_err:0x%x\n", gce_err);
            break;
        default:
            break;
    }
    ...
    //dump top regs
    LOG_INF("DIPCTL_D1A_DIPCTL_START=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_START-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_RGB_EN1=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_RGB_EN1-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_RGB_EN2=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_RGB_EN2-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_YUV_EN1=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_YUV_EN1-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_YUV_EN2=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_YUV_EN2-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_DMA_EN1=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_DMA_EN1-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_DMA_EN2=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_DMA_EN2-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_MUX_SEL1=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_MUX_SEL1-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_MUX_SEL2=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_MUX_SEL2-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_FMT_SEL1=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_FMT_SEL1-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_FMT_SEL2=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_FMT_SEL2-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_MISC_SEL=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_MISC_SEL-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_TDR_CTL=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_TDR_CTL-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_TDR_SEL=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_TDR_SEL-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_TDR_TCM_EN1=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_TDR_TCM_EN1-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_TDR_TCM_EN2=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_TDR_TCM_EN2-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_TDR_TCM_EN3=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_TDR_TCM_EN3-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_TDR_TCM_EN4=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_TDR_TCM_EN4-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_TDR_TCM_EN5=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_TDR_TCM_EN5-(MUINT8*)&dipReg)), DIP_HW_A));
    LOG_INF("DIPCTL_D1A_DIPCTL_TDR_TCM_EN6=0x%08x",readReg(((MUINT32)((MUINT8*)&dipReg.DIPCTL_D1A_DIPCTL_TDR_TCM_EN6-(MUINT8*)&dipReg)), DIP_HW_A));

    //dump tpipe
    regTpipePA = readReg((MUINT32)((MUINT8*)&dipReg.DIPDMATOP_D1A_DIPDMATOP_TDRI_BASE_ADDR-(MUINT8*)&dipReg));
    ...
    if(m_dumpDipHwTpipeReg!=1) {
        dumpTpipeLine = 36;  // reduce Tpipe Dump
    }
    ...
    for(i=0x0;i<=size;i+=16){
        LOG_INF("(0x%08x,0x%08x)(0x%08x,0x%08x)(0x%08x,0x%08x)(0x%08x,0x%08x)",
            0x15021000+i,readReg(i, DIP_HW_A),0x15021000+i+4,readReg(i+4, DIP_HW_A),0x15021000+i+8,readReg(i+8, DIP_HW_A),0x15021000+i+12,readReg(i+12, DIP_HW_A));
    }
    ...
    {
        if ((get_dumpinfo.imgi_baseaddr != DIP_DUMP_ADDR_MASK) && (get_dumpinfo.imgi_baseaddr == pP2Package->IspVirRegAddrVa[DIP_IMGI_BASEADDR_OFFSET]))
        {
    ...
    if (pP2Package->pTuningQue != NULL)
    {
        ...
        for(i=0x0;i<size;i+=32){
            LOG_INF("QQ (0x%08x,0x%08x)(0x%08x,0x%08x)(0x%08x,0x%08x)(0x%08x,0x%08x)(0x%08x,0x%08x)(0x%08x,0x%08x)(0x%08x,0x%08x)(0x%08x,0x%08x)",
                0x15021000+i,pTuningBuf[(i>>2)],0x15021000+i+4,pTuningBuf[(i>>2)+1],0x15021000+i+8,pTuningBuf[(i>>2)+2],0x15021000+i+12,pTuningBuf[(i>>2)+3],0x15021000+i+16,pTuningBuf[(i>>2)+4],0x15021000+i+20,pTuningBuf[(i>>2)+5],0x15021000+i+24,pTuningBuf[(i>>2)+6],0x15021000+i+28,pTuningBuf[(i>>2)+7]);
        }
        if ((dip_size-size)>0)
        {
            for(i=size;i<dip_size;i=i+4){
                LOG_INF("res QQ (0x%08x,0x%08x)",
                    0x15021000+i,pTuningBuf[(i>>2)]);
            }
        }
