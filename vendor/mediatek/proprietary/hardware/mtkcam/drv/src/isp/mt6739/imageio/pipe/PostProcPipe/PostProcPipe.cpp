...
//#include <mtkcam_legacy_platform/featureio/eis_type.h>
...
MINT32 u4PortID[DMA_PORT_TYPE_NUM][DMA_OUT_PORT_NUM] = {/*0*/{(MINT32)NSImageio::NSIspio::EPortIndex_IMG2O, (MINT32)NSImageio::NSIspio::EPortIndex_IMG3O, (MINT32)NSImageio::NSIspio::EPortIndex_WDMAO, (MINT32)NSImageio::NSIspio::EPortIndex_WROTO, (MINT32)NSImageio::NSIspio::EPortIndex_JPEGO, (MINT32)NSImageio::NSIspio::EPortIndex_FEO, (MINT32)NSImageio::NSIspio::EPortIndex_VIPI},
                                                        /*1*/{(MINT32)NSImageio::NSIspio::EPortIndex_IMG2O, (MINT32)NSImageio::NSIspio::EPortIndex_IMG3O, (MINT32)NSImageio::NSIspio::EPortIndex_WDMAO, (MINT32)NSImageio::NSIspio::EPortIndex_VIPI, (MINT32)-1,  (MINT32)-1,             (MINT32)-1},
                                                        /*2*/{(MINT32)NSImageio::NSIspio::EPortIndex_IMG2O, (MINT32)NSImageio::NSIspio::EPortIndex_IMG3O, (MINT32)NSImageio::NSIspio::EPortIndex_WROTO, (MINT32)NSImageio::NSIspio::EPortIndex_VIPI, (MINT32)-1,  (MINT32)-1,             (MINT32)-1},
                                                        /*3*/{(MINT32)NSImageio::NSIspio::EPortIndex_WDMAO, (MINT32)-1, (MINT32)-1, (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        /*4*/{(MINT32)NSImageio::NSIspio::EPortIndex_WROTO, (MINT32)-1, (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        /*5*/{(MINT32)NSImageio::NSIspio::EPortIndex_IMG2O, (MINT32)NSImageio::NSIspio::EPortIndex_IMG3O, (MINT32)NSImageio::NSIspio::EPortIndex_VIPI,  (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        /*6*/{(MINT32)NSImageio::NSIspio::EPortIndex_IMG2O, (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        /*7*/{(MINT32)NSImageio::NSIspio::EPortIndex_IMG3O, (MINT32)NSImageio::NSIspio::EPortIndex_VIPI,  (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        /*8*/{(MINT32)NSImageio::NSIspio::EPortIndex_FEO,   (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        };
 ...
 Scen_Map_CropPathInfo_STRUCT mCropPathInfo[]
    ...
    //eDrvScenario_IP_TPipe
    {eDrvScenario_IP_TPipe,        (MUINT32)(ECropGroupIndex_NONE),                &(u4PortID[7][0])},
...
uninit()
{
    ...
    //
    if ( ! m_pIspDrvShell )
        PIPE_ERR("m_pIspDrvShell is Null");
    else if ( ! m_pIspDrvShell->getPhyIspDrv() )
        PIPE_ERR("m_pIspDrvShell->getPhyIspDrv is Null");
    else
    {
        ...
        PIPE_INF("m_pPhyIspDrv_bak(%p) ",(unsigned int*)m_pIspDrvShell->getPhyIspDrv());
        // record the p2 pipe user count and reset isp p2 if this is the last user.
...
enqueInBuf(PortID const portID, QBufInfo const& rQBufInfo,MINT32 const enqueCq,MINT32 const dupCqIdx)
{
    ...
    PIPE_DBG("QBufInfo:(user, reserved, num)=(%x, %d, %lu)", rQBufInfo.u4User, rQBufInfo.u4Reserved, (unsigned long)(rQBufInfo.vBufInfo.size()));
...
dequeInBuf(PortID const portID, QTimeStampBufInfo& rQBufInfo, EDrvScenario eDrvSce, MINT32 const dequeCq,MINT32 const dequeBurstQIdx, MINT32 const dequeDupCqIdx, MUINT32 const u4TimeoutMs /*= 0xFFFFFFFF*/)
{
    ...
    //
    if (NSImageio::NSIspio::EPortIndex_IMGI == portID.index) {
        dmaChannel = ISP_DMA_IMGI;
    }
    else if (NSImageio::NSIspio::EPortIndex_VIPI == portID.index) {
        dmaChannel = ISP_DMA_VIPI;
    }
    else if (NSImageio::NSIspio::EPortIndex_VIP2I == portID.index) {
        dmaChannel = ISP_DMA_VIP2I;
    }
    else if (NSImageio::NSIspio::EPortIndex_VIP3I == portID.index) {
        dmaChannel = ISP_DMA_VIP3I;
    }
    else if (NSImageio::NSIspio::EPortIndex_LSCI == portID.index) {
        dmaChannel = ISP_DMA_LSCI;
    }
    else if (NSImageio::NSIspio::EPortIndex_LCEI == portID.index) {
        dmaChannel = ISP_DMA_LCEI;
    }
    else if (NSImageio::NSIspio::EPortIndex_UFDI == portID.index) {
        dmaChannel = ISP_DMA_UFDI;
    }
    //
...
enqueOutBuf(PortID const portID, QBufInfo const& rQBufInfo,MINT32 const enqueCq,MINT32 const dupCqIdx)
{
    ...
    PIPE_INF("[%d]: (0x%08x,0x%08lu,0x%08lu)/(0x%08x,0x%08lu,0x%08lu)/(0x%08x,0x%08lu,0x%08lu) ",portID.index,
                                        rQBufInfo.vBufInfo[0].u4BufSize[0],
                                        (unsigned long)(rQBufInfo.vBufInfo[0].u4BufVA[0]),
                                        (unsigned long)(rQBufInfo.vBufInfo[0].u4BufPA[0]),
                                        rQBufInfo.vBufInfo[0].u4BufSize[1],
                                        (unsigned long)(rQBufInfo.vBufInfo[0].u4BufVA[1]),
                                        (unsigned long)(rQBufInfo.vBufInfo[0].u4BufPA[1]),
                                        rQBufInfo.vBufInfo[0].u4BufSize[2],
                                        (unsigned long)(rQBufInfo.vBufInfo[0].u4BufVA[2]),
                                        (unsigned long)(rQBufInfo.vBufInfo[0].u4BufPA[2]));
...
dequeOutBuf(PortID const portID, QTimeStampBufInfo& rQBufInfo, EDrvScenario eDrvSce, MINT32 const dequeCq,MINT32 const dequeBurstQIdx, MINT32 const dequeDupCqIdx, MUINT32 const u4TimeoutMs /*= 0xFFFFFFFF*/)
{
    ...
    if(portID.index==NSImageio::NSIspio::EPortIndex_JPEGO)
    {
    ...
    for ( MINT32 i = 0; i < (MINT32)rQBufInfo.vBufInfo.size() ; i++) {
        ...
        PIPE_DBG("i(%d),va(0x%08lu/0x%08lu/0x%08lu),pa(0x%08lu/0x%08lu/0x%08lu),size(0x%08x/0x%08x/0x%08x)",
            i,(unsigned long)(rQBufInfo.vBufInfo.at(i).u4BufVA[0]),(unsigned long)(rQBufInfo.vBufInfo.at(i).u4BufVA[1]),(unsigned long)(rQBufInfo.vBufInfo.at(i).u4BufVA[2]),\
            (unsigned long)(rQBufInfo.vBufInfo.at(i).u4BufPA[0]),(unsigned long)(rQBufInfo.vBufInfo.at(i).u4BufPA[1]),(unsigned long)(rQBufInfo.vBufInfo.at(i).u4BufPA[2]),\
...
configPipe(vector<PortInfo const*>const& vInPorts, vector<PortInfo const*>const& vOutPorts, PipePackageInfo *pPipePackageInfo)
{
    ...
    //CAM_REG_CTL_SEL_P2 *pP2Sel; //not used
    int idx_imgi = -1;
    int idx_vipi = -1;
    int idx_vip2i = -1;
    int idx_vip3i = -1;
    ...
    EDrvScenario drvScenario = pPipePackageInfo->drvScen;
...
//    }
    ...
    ///////////////////////////////////////////////////////////////////////////////////////
    //in/out dma check
    PIPE_DBG("in[%lu]/out[%lu]", (unsigned long)(vInPorts.size()), (unsigned long)(vOutPorts.size()));
    for (MUINT32 i = 0 ; i < vInPorts.size() ; i++ )
    {
        if ( 0 == vInPorts[i] ) { continue; }
        //
        PIPE_INF("vInPorts:[%d]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08lu,0x%08lu,0x%08lu),PA(0x%08lu,0x%08lu,0x%08lu),memID(0x%x,0x%x,0x%x),magicNum(0x%x)",\
                                                        i,
                                                        vInPorts[i]->eImgFmt,
        ...
        switch(vInPorts[i]->index)
        {
            case NSImageio::NSIspio::EPortIndex_IMGI:
                ...
                break;
            case NSImageio::NSIspio::EPortIndex_VIPI:    //may multi-plane, vipi~vip3i, Not Support
            #if 0
                idx_vipi = i;
            ...
            tcm_en_collect |= CAM_CTL_TPIPE_VIPI_TCM_EN;
                ...
                break;
            case NSImageio::NSIspio::EPortIndex_VIP3I: //only vip3i input(weighting table), there are only vipi+vip3i without vip2i for mfb mixing path, Not Support
            #if 0
                idx_vip3i = i;
                en_p2_dma |=  CAM_CTL_EN_P2_DMA_VIP3I_EN;
                tcm_en_collect |= CAM_CTL_TPIPE_VIP3I_TCM_EN;
                ...
                PIPE_ERR("[Error]Not support this input port(%d),i(%d)",vInPorts[i]->index,i);
                break;
            case NSImageio::NSIspio::EPortIndex_LCEI:// Not Support
            #if 0
                idx_lcei = i;
                ...
                if(drvScenario!=eDrvScenario_CC_vFB_FB)
                {
                ...
                PIPE_ERR("[Error]Not support this input port(%d),i(%d)",vInPorts[i]->index,i);
                break;
            case NSImageio::NSIspio::EPortIndex_UFDI:// Not Support
            #if 0
                idx_ufdi = i;
                en_p2_dma |=  CAM_CTL_EN_P2_DMA_UFDI_EN;
                tcm_en_collect |= CAM_CTL_TPIPE_UFDI_TCM_EN;
                portInfo_ufdi =  (PortInfo)*vInPorts[idx_ufdi];
                if((drvScenario!=eDrvScenario_CC_vFB_FB)&&(drvScenario!=eDrvScenario_CC_MFB_Mixing)&&(drvScenario!=eDrvScenario_VSS_MFB_Mixing))
                {
    ...
    for (MUINT32 i = 0 ; i < vOutPorts.size() ; i++ )
    {
        ...
        //
        PIPE_INF("vOutPorts:[%d]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08lu,0x%08lu,0x%08lu),PA(0x%08lu,0x%08lu,0x%08lu),memID(0x%x,0x%x,0x%x)",i,\
                                                        vOutPorts[i]->eImgFmt,
        ...
        if ((MTRUE == getCropFunctionEnable(drvScenario, (MINT32)vOutPorts[i]->index, CropGroup))
        ...
        switch(vOutPorts[i]->index){
            case NSImageio::NSIspio::EPortIndex_IMG2O:
                ...
                break;
            case NSImageio::NSIspio::EPortIndex_IMG3O:// Not Support
            #if 0
                idx_img3o = i;
             ...
             #endif
                PIPE_ERR("[Error]Not support this vOutPorts(%d),i(%d)",vOutPorts[i]->index,i);
                break;
            case NSImageio::NSIspio::EPortIndex_WROTO:
                idx_wroto = i;
            ...
            case NSImageio::NSIspio::EPortIndex_JPEGO:
                ...
                break;
            case NSImageio::NSIspio::EPortIndex_FEO:// Not Support
            #if 0
                if(drvScenario == eDrvScenario_CC_vFB_FB)
                {
                ...
                PIPE_ERR("[Error]Not support this vOutPorts(%d),i(%d)",vOutPorts[i]->index,i);
                break;
            case NSImageio::NSIspio::EPortIndex_IMGO: // ip raw scenario
                if((drvScenario!=eDrvScenario_IP) && (drvScenario!=eDrvScenario_CC_RAW))
                {
                    PIPE_ERR("[Error]do not support DMA IMGO for this scenario(%d)",drvScenario);
                    return MFALSE;
                }
                ...
                break;
            case NSImageio::NSIspio::EPortIndex_MFBO: // mfb blending, Not Support
            #if 0
                idx_mfbo = i;
                        ...
                        if(reinterpret_cast<Nr3DCfg*>(pPipePackageInfo->vModuleParams[i].moduleStruct))
                {
                    ...
                    if(idx_vipi != -1)
                    {
                        ...
                        portInfo_vipi.yoffset = m_camPass2Param.nr3d_cfg.vipi_offst / portInfo_vipi.u4Stride[0];
                          ...
                          PIPE_DBG("VIPI starting PA(0x%lu/0x%lu/0x%lu)/VIP2I(0x%lu/0x%lu/0x%lu)/VIP3I(0x%lu/0x%lu/0x%lu)",\
                              (unsigned long)(portInfo_vipi.u4BufPA[0]),(unsigned long)(portInfo_vipi.u4BufPA[1]),(unsigned long)(portInfo_vipi.u4BufPA[2]),\
                              (unsigned long)(portInfo_vip2i.u4BufPA[0]),(unsigned long)(portInfo_vip2i.u4BufPA[1]),(unsigned long)(portInfo_vip2i.u4BufPA[2]),\
                              (unsigned long)(portInfo_vip3i.u4BufPA[0]),(unsigned long)(portInfo_vip3i.u4BufPA[1]),(unsigned long)(portInfo_vip3i.u4BufPA[2]));
    ...
    // check rrz info. and pixel id
        ...
        PIPE_DBG("[rrz]dma=%d,pixIdP2(%d)",(((stISP_BUF_INFO*)(pPipePackageInfo->pPrivateData))->dma),pixIdP2);
            ...
            if((((stISP_BUF_INFO*)(pPipePackageInfo->pPrivateData))->rrz_info.dstH)) {
                ...
                PIPE_ERR("[Error]wrong dstH(%d),pCookie(0x%lx),rrz_info(0x%lx)",(((stISP_BUF_INFO*)(pPipePackageInfo->pPrivateData))->rrz_info.dstH),(unsigned long)(pPipePackageInfo->pPrivateData),(unsigned long)(&(((stISP_BUF_INFO*)(pPipePackageInfo->pPrivateData))->rrz_info)));
            }
            PIPE_DBG("[rrz]pCookie(0x%lx),src(%d,%d,%d,%d),dst(%d,%d)",(unsigned long)(pPipePackageInfo->pPrivateData), \
...
//                en_p2_dma |=  CAM_CTL_DMA_EN_VIPI_EN;
    ...
    PIPE_INF("drvScenario:[%d],subMode(%d),eImgFmt(%d),dma(0x%x)",drvScenario,subMode,portInfo_imgi.eImgFmt,en_p2_dma);
    ...
    if(pPipePackageInfo->isV3==true){
            ...
            if(en_p1_dma & CAM_CTL_EN_P1_DMA_LSCI_EN){
                ...
                PIPE_INF("[LSCI](x,y)=(%lu,%lu),s(%lu),pa(0x%lu)",\
                    m_camPass2Param.lsci.size.w,m_camPass2Param.lsci.size.h,m_camPass2Param.lsci.size.stride,\
                    (unsigned long)(m_camPass2Param.lsci.memBuf.base_pAddr));
            }
            ...
            //
            PIPE_DBG("[V3]pIspPhyReg(0x%lx)",(unsigned long)pIspPhyReg);
            PIPE_INF("[V3]hwScenario(%d),p2SubMode(%d),tuningEn1Tag(0x%x),tuningEn2Tag(0x%x),tuningDmaTag(0x%x), en1(0x%08x),en2(0x%08x),P1dma(0x%08x)P2dma(0x%08x)",
                                              hwScenario,p2SubMode,tuningEn1Tag,tuningEn2Tag,tuningDmaTag,pIspPhyReg->CAM_CTL_EN_P1.Raw, \
                                              pIspPhyReg->CAM_CTL_EN_P2.Raw,pIspPhyReg->CAM_CTL_EN_P1_DMA.Raw,pIspPhyReg->CAM_CTL_EN_P2_DMA.Raw);
            PIPE_DBG("[V3]en1(0x%08x),en2(0x%08x),P1dma(0x%08x),P2dma(0x%08x)",en_p1,en_p2,en_p1_dma, en_p2_dma);
        } else {
        ...
        PIPE_INF("[hrz]crop(%d,%d),src(%d,%d),dst(%d,%d)", \
    ...
    // HW tie calue PCA_SEL = 0, FE_SEL = 0, NR3D_SEL = 0, CRZ_SEL = 0, MIX1_SEL = 0, SRZ1_SEL = 0
    //                    C24_SEL = 0, UFD_SEL = 0, W2G_SEL = 0, mdp_sel=1 for all scenario
    switch (drvScenario) {
        ...
        case eDrvScenario_CC_vFB_Normal: //vFB p2a
            ...
            */
            //ctl_sel=0x000015C0;
            ctl_sel=0x00000800;    //fe_sel is 0 for eis
            break;
        case eDrvScenario_CC_vFB_FB:
        ...
        case eDrvScenario_VSS_MFB_Blending:
            /*
            if(drvScenario==eDrvScenario_CC_MFB_Blending)
            {
            //drvScenario = eDrvScenario_CC_MFB_Blending;
            }
            else
            */
            if(drvScenario==eDrvScenario_VSS_MFB_Blending)
            {
        ...
        case eDrvScenario_VSS_MFB_Mixing:
            /*
            if(drvScenario==eDrvScenario_CC_MFB_Mixing)
            {
            //drvScenario = eDrvScenario_CC_MFB_Mixing;
            }
            else
            */
            if(drvScenario==eDrvScenario_VSS_MFB_Mixing)
            {
        ...
        case eDrvScenario_IP_TPipe:
            hwScenario = ISP_HW_SCENARIO_IP;
            //drvScenario = eDrvScenario_IP_TPipe;
            ctl_sel=0x00000800;
            break;
        default:
            PIPE_ERR("NOT Support scenario(%d)",drvScenario);
            return MFALSE;
    }
    ...
    PIPE_INF("isCropG1En(%d),m_CrzEn(%d)",isCropG1En,m_CrzEn);
    ...
    PIPE_INF("drvScenario(%d),mdpCheck1(%d),mdpCheck2(%d),crop1TableIdx(%d) ctl_sel(%d)",drvScenario,mdpCheck1,mdpCheck2,crop1TableIdx,  ctl_sel);
            ...
            switch(mCropPathInfo[crop1TableIdx].u4PortID[i]){
                ...
                case NSImageio::NSIspio::EPortIndex_IMG3O:
                    if(en_p2_dma & CAM_CTL_EN_P2_DMA_IMG3O_EN){
                        ...
                        #endif
                        PIPE_ERR("[Error]NOT Support IMG3O");
                    }
                    break;
                case NSImageio::NSIspio::EPortIndex_FEO:
                    if(en_p2_dma & CAM_CTL_EN_P2_DMA_FEO_EN){
                        ...
                        #endif
                        PIPE_ERR("[Error]NOT Support FEO");
                    }
                    break;
                case NSImageio::NSIspio::EPortIndex_VIPI:
                    if(en_p2_dma & CAM_CTL_EN_P2_DMA_VIPI_EN){
                        ...
                        #endif
                        PIPE_ERR("[Error]NOT Support VIPI");
                    }
                    break;
                default:
                    break;
    ...
    PIPE_INF("Pass(%d),imgi.fmt(0x%x),isCropG1En(%d),m_CrzEn(%d),mdpSrcFmt(0x%x),mdp_src(%lu,%lu,%lu,%lu),en_p2_dma(0x%08x),crop1TableIdx(%d),mdpCheck1(%d),mdpCheck2(%d),drvScenario(%d),tcm_en(0x%x)",\
    this->m_pipePass,portInfo_imgi.eImgFmt,isCropG1En,m_CrzEn,m_camPass2Param.croppara.mdp_src_fmt, \
    ...
    PIPE_INF("SelGlo(0x%x),EnP2(0x%x),EnP2Dma(0x%x),EnP1Dma(0x%x),CqEn(0x%x),IntP2En(0x%x),fmtSelP2(0x%x),selP2(0x%x)", \
    ...
    if ( -1 != idx_imgi ) {
        ...
        //
        m_camPass2Param.src_img_size.w = vInPorts[idx_imgi]->u4ImgWidth;
    ...
    if (-1 != idx_vipi ) {
        ...
        PIPE_DBG("[vipi]size(0x%08x),Va(0x%08lu),Pa(0x%08lu),offset(0x%08x),align(0x%08x),stride(0x%08lu)",
                m_camPass2Param.vipi.memBuf.size,(unsigned long)(m_camPass2Param.vipi.memBuf.base_vAddr),(unsigned long)(m_camPass2Param.vipi.memBuf.base_pAddr),m_camPass2Param.vipi.memBuf.ofst_addr,m_camPass2Param.vipi.memBuf.alignment,(unsigned long)(m_camPass2Param.vipi.size.stride));
        ...
        {    //multi-plane input image, vipi/vip2i/vip3i
            ...
            PIPE_DBG("[vip2i]size[%lu,%lu](0x%08x),offset(0x%08x),align(0x%08x),stride(0x%08lu)",m_camPass2Param.vip2i.size.w,m_camPass2Param.vip2i.size.h,
            ...
            if (-1 != idx_vip3i )
            {
                ...
                PIPE_DBG("[vip3i]size[%lu,%lu](0x%08x),Va(0x%08lu),Pa(0x%08lu),offset(0x%08x),align(0x%08x),stride(0x%08lu),vipi_uv_swap(%d)",m_camPass2Param.vip3i.size.w,m_camPass2Param.vip3i.size.h,
                        m_camPass2Param.vip3i.memBuf.size,(unsigned long)(m_camPass2Param.vip3i.memBuf.base_vAddr),(unsigned long)(m_camPass2Param.vip3i.memBuf.base_pAddr),m_camPass2Param.vip3i.memBuf.ofst_addr,m_camPass2Param.vip3i.memBuf.alignment,m_camPass2Param.vip3i.size.stride,vipi_uv_swap);
            }
        }
        else
        {
    ...
    if (-1 != idx_mfbo) {
        ...
        PIPE_ERR("[Error]NOT Support MFBO");
    ...
    if (-1 != idx_imgo ) {  // only support frame mode for dma imgo in ip scenario
        PIPE_DBG("isSetMdpOut(%d),u4BufSize(0x%x)-u4BufVA(0x%lu)-u4BufPA(0x%lu)",isSetMdpOut, vOutPorts[idx_imgo]->u4BufSize[0],(unsigned long)(vOutPorts[idx_imgo]->u4BufVA[0]),
                    (unsigned long)(vOutPorts[idx_imgo]->u4BufPA[0]));
    ...
    if (-1 != idx_img2o ) {
        ...
        PIPE_DBG("u4BufSize(0x%x)-u4BufVA(0x%lu)-u4BufPA(0x%lu)", vOutPorts[idx_img2o]->u4BufSize[0],(unsigned long)(vOutPorts[idx_img2o]->u4BufVA[0]),
                    (unsigned long)(vOutPorts[idx_img2o]->u4BufPA[0]));
    ...
    if (-1 != idx_img3o ) {
        ...
        PIPE_DBG("[img3o]size(0x%08x),Va(0x%08lu),Pa(0x%08lu),offset(0x%08x),align(0x%08x),stride(0x%08lu)",
                m_camPass2Param.img3o.memBuf.size,(unsigned long)(m_camPass2Param.img3o.memBuf.base_vAddr),(unsigned long)(m_camPass2Param.img3o.memBuf.base_pAddr),m_camPass2Param.img3o.memBuf.ofst_addr,m_camPass2Param.img3o.memBuf.alignment,m_camPass2Param.img3o.size.stride);
        ...
        if (-1 != idx_img3bo )
        {
            ...
            PIPE_DBG("[img3bo]size[%lu,%lu](0x%08x),offset(0x%08x),align(0x%08x),stride(0x%08lu)",m_camPass2Param.img3bo.size.w,m_camPass2Param.img3bo.size.h,
            ...
            if (-1 != idx_img3co )
            {
                ...
                PIPE_DBG("[img3co]size[%lu,%lu](0x%08x),Va(0x%08lu),Pa(0x%08lu),offset(0x%08x),align(0x%08x),stride(0x%08lu),img3o_uv_swap(%d)",m_camPass2Param.img3co.size.w,m_camPass2Param.img3co.size.h,
                        m_camPass2Param.img3co.memBuf.size,(unsigned long)(m_camPass2Param.img3co.memBuf.base_vAddr),(unsigned long)(m_camPass2Param.img3co.memBuf.base_pAddr),m_camPass2Param.img3co.memBuf.ofst_addr,m_camPass2Param.img3co.memBuf.alignment,(unsigned long)(m_camPass2Param.img3co.size.stride),img3o_uv_swap);
            }
        }
    }
...
{
    UNUSED(vInPorts);UNUSED(vOutPorts);
...
{
    int    ret = 0;
    //MUINT32 dmaChannel = 0; //not used

    PIPE_DBG("tid(%d) (cmd,arg1,arg2,arg3)=(0x%08x,0x%08lu,0x%08lu,0x%08lu)", gettid(), cmd, (unsigned long)arg1, (unsigned long)arg2, (unsigned long)arg3);
...
*/
        ...
        case EPIPECmd_SET_CURRENT_BUFFER:
            //
            if ( NSImageio::NSIspio::EPortIndex_IMGI == arg1 ) { dmaChannel = ISP_DMA_IMGI; }
            if ( NSImageio::NSIspio::EPortIndex_VIPI == arg1 ) { dmaChannel = ISP_DMA_VIPI; }
            if ( NSImageio::NSIspio::EPortIndex_VIP2I == arg1 ) { dmaChannel = ISP_DMA_VIP2I; }
            if ( NSImageio::NSIspio::EPortIndex_VIP3I == arg1 ) { dmaChannel = ISP_DMA_VIP3I; }
            if ( NSImageio::NSIspio::EPortIndex_IMG2O == arg1 ) { dmaChannel = ISP_DMA_IMG2O; }
            if ( NSImageio::NSIspio::EPortIndex_IMG3O == arg1 ) { dmaChannel = ISP_DMA_IMG3O; }
            if ( NSImageio::NSIspio::EPortIndex_IMG3BO == arg1 ) { dmaChannel = ISP_DMA_IMG3BO; }
            if ( NSImageio::NSIspio::EPortIndex_IMG3CO == arg1 ) { dmaChannel = ISP_DMA_IMG3CO; }
            //
        ...
        case EPIPECmd_SET_NEXT_BUFFER:
            if ( NSImageio::NSIspio::EPortIndex_IMGI == arg1 ) {
                dmaChannel = ISP_DMA_IMGI;
            }
            if ( NSImageio::NSIspio::EPortIndex_VIPI == arg1 ) {
                dmaChannel = ISP_DMA_VIPI;
            }
            if ( NSImageio::NSIspio::EPortIndex_VIP2I == arg1 ) {
                dmaChannel = ISP_DMA_VIP2I;
            }
            if ( NSImageio::NSIspio::EPortIndex_DISPO == arg1 ) {
                dmaChannel = ISP_DMA_IMG3O;
            }
            if ( NSImageio::NSIspio::EPortIndex_VIDO == arg1 ) {
                dmaChannel = ISP_DMA_IMG3BO;
            }
            //
...
*
********************************************************************************/
MBOOL PostProcPipe::endequeFrameCtrl(EPIPE_BUFQUECmd cmd, unsigned long callerID, MINT32 p2burstQIdx,
        MINT32 p2dupCQIdx, MINT32 frameNum, MINT32 p2Scenario, MINT32 timeout)
{
    MBOOL ret=MFALSE;
    ...
    switch(cmd)
    {
        case EPIPE_BUFQUECmd_ENQUE_FRAME:
            ret=m_pIspDrvShell->getPhyIspDrv()->enqueP2Frame(callerID,p2burstQIdx,p2dupCQIdx,frameNum, p2Scenario);
            break;
        case EPIPE_BUFQUECmd_WAIT_DEQUE:
            ret=m_pIspDrvShell->getPhyIspDrv()->waitP2Deque();
            break;
        case EPIPE_BUFQUECmd_DEQUE_SUCCESS:
            ret=m_pIspDrvShell->getPhyIspDrv()->dequeP2FrameSuccess(callerID,p2dupCQIdx, p2Scenario);
            break;
        case EPIPE_BUFQUECmd_DEQUE_FAIL:
            ret=m_pIspDrvShell->getPhyIspDrv()->dequeP2FrameFail(callerID,p2dupCQIdx,p2Scenario);
            break;
        case EPIPE_BUFQUECmd_WAIT_FRAME:
            ret=m_pIspDrvShell->getPhyIspDrv()->waitP2Frame(callerID,p2dupCQIdx,p2Scenario,timeout);
            break;
