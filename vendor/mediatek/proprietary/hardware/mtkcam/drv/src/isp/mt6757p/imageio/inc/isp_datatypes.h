...
public:
    ...
    IspDMACfg():
        pixel_byte(1),swap(0), format_en(0),format(0),bus_size_en(0),bus_size(0),capbility(0x00),memBuf_c_ofst(0),memBuf_v_ofst(0),v_flip_en(0),lIspColorfmt(eImgFmt_IMPLEMENTATION_DEFINED)
        {};
};
