...
{
    MUINT32 plane_num = 1;
    //MUINT32 uv_resample = 1; //not used
    ...
    PIPE_DBG("[a_rotDma]crop(%u,%u,%lu,%lu)_f(0x%x,0x%x)",a_rotDma.crop.x,a_rotDma.crop.y,a_rotDma.crop.w,a_rotDma.crop.h,a_rotDma.crop.floatX,a_rotDma.crop.floatY);
