...
static PortID sttPortIDMap[__MAXDMAO_STT] = {PORT_AAO, PORT_AFO, PORT_FLKO, PORT_PDO, PORT_TSFSO};
inline MINT InverseFmt(MINT Fmt)
{
    ...
    case NSCam::eImgFmt_YUV_P010_3PLANE: return NSCam::eImgFmt_MTK_YUV_P010_3PLANE;
    case NSCam::eImgFmt_YUV_P210_3PLANE: return NSCam::eImgFmt_MTK_YUV_P210_3PLANE;
    case NSCam::eImgFmt_MTK_YUV_P010_3PLANE: return NSCam::eImgFmt_YUV_P010_3PLANE;
    case NSCam::eImgFmt_MTK_YUV_P210_3PLANE: return NSCam::eImgFmt_YUV_P210_3PLANE;
    case NSCam::eImgFmt_YVU_P010: return NSCam::eImgFmt_MTK_YVU_P010;
    case NSCam::eImgFmt_YUV_P010: return NSCam::eImgFmt_MTK_YUV_P010;
    case NSCam::eImgFmt_YVU_P210: return NSCam::eImgFmt_MTK_YVU_P210;
    case NSCam::eImgFmt_YUV_P210: return NSCam::eImgFmt_MTK_YUV_P210;
    case NSCam::eImgFmt_MTK_YVU_P010: return NSCam::eImgFmt_YVU_P010;
    case NSCam::eImgFmt_MTK_YUV_P010: return NSCam::eImgFmt_YUV_P010;
    case NSCam::eImgFmt_MTK_YVU_P210: return NSCam::eImgFmt_YVU_P210;
    case NSCam::eImgFmt_MTK_YUV_P210: return NSCam::eImgFmt_YUV_P210;
    case NSCam::eImgFmt_VYUY_Y210: return NSCam::eImgFmt_MTK_VYUY_Y210;
    case NSCam::eImgFmt_UYVY_Y210: return NSCam::eImgFmt_MTK_UYVY_Y210;
    case NSCam::eImgFmt_YVYU_Y210: return NSCam::eImgFmt_MTK_YVYU_Y210;
    case NSCam::eImgFmt_YUYV_Y210: return NSCam::eImgFmt_MTK_YUYV_Y210;
    case NSCam::eImgFmt_MTK_VYUY_Y210: return NSCam::eImgFmt_VYUY_Y210;
    case NSCam::eImgFmt_MTK_UYVY_Y210: return NSCam::eImgFmt_UYVY_Y210;
    case NSCam::eImgFmt_MTK_YVYU_Y210: return NSCam::eImgFmt_YVYU_Y210;
    case NSCam::eImgFmt_MTK_YUYV_Y210: return NSCam::eImgFmt_YUYV_Y210;
...
void sttProcLoop(MUINT32 dmao, NPipeUT* _this)
{
    ...
    for ( ; MFALSE == _this->m_bStop; ) {
         ...
         */
        if(dmao != __PDO){//pdo support no memcpy
            _this->mpSttBufSize[portIdx] = rDQBuf.mvOut.at(0).mSize;
            if(_this->mpSttBufSize[portIdx] > 0){
        ...
        for (i = 0; i < rDQBuf.mvOut.size(); i++) {
            ...
            rEQBuf.mvOut.at(i).mMemID   = rDQBuf.mvOut.at(i).mMemID;
            rEQBuf.mvOut.at(i).mSize    = rDQBuf.mvOut.at(i).mSize;
        ...
        //for w+t switch: if virtual port and buffer size zero, wait one more sof
        if(rDQBuf.mvOut.at(0).mSize == 0 && (dmao == __FLKO || dmao == __PDO) && (_this->m_bStop == MFALSE)){
            _this->mpNPipe->wait(EPipeSignal_SOF, EPipeSignal_ClearWait, _this->mSttSofUserKey[dmao], 7788);
        }
    }
...
void *_sttProcLoop_TSFSO_ (void *arg)
{
    sttProcLoop(__TSFSO, (NPipeUT*)arg);
    return 0;
}
...
MVOID* deque_loop(void* arg)
{
    ...
    if (_this->m_enablePort & __RAWI_ENABLE) {
        deqPorts.mvPortId.push_back(PORT_RAWI);
    }
    if (_this->m_enablePort & __IMGO_ENABLE) {
        deqPorts.mvPortId.push_back(PORT_IMGO);
    }
    if (_this->m_enablePort & __SV_DCIF_IMGO_ENABLE) {
        deqPorts.mvPortId.push_back(PORT_CAMSV_IMGO);
    }
    ...
    if (_this->m_enablePort & __YUVO_ENABLE) {
        deqPorts.mvPortId.push_back(PORT_YUVO);
    }
    if (_this->m_enablePort & __CRZO_ENABLE) {
        deqPorts.mvPortId.push_back(PORT_CRZO_R1);
    }
    if (_this->m_enablePort & __CRZO_R2_ENABLE) {
        deqPorts.mvPortId.push_back(PORT_CRZO_R2);
    }
    while(1){
        ...
        if (_this->mpNPipe->deque(deqPorts, dequeBufInfo, 19527) == MTRUE) {
            MUINT32 rawi_idx,imgo_idx;
            MBOOL bBit_True = MFALSE;
            for (i = 0; i < dequeBufInfo.mvOut.size(); i++) {
                if (0 == dequeBufInfo.mvOut.at(i).mBuffer) {
                    MY_LOGE("deque wrong");
                    break;
                }
                MY_LOGD("S_%d[deque]: sec:0x%x, dma:0x%x, PA:%lx, crop:%d_%d_%d_%d_%d_%d_%d_%d, size:%dx%d, mag:0x%x, bufidx:0x%x",\
                    _this->mSensorIdx, _this->mSecEnable,\
                ...
                if(dequeBufInfo.mvOut.at(i).mPortID.index == PORT_RAWI.index){
                    bBit_True = MTRUE;
                    rawi_idx = i;
                }
            ...
            if(bBit_True){
                if(dequeBufInfo.mvOut.at(imgo_idx).mMetaData.mRawType == 1){
                    MUINTPTR *rawi_ptr= NULL,*imgo_ptr=NULL;
                    MUINT32 err_cnt = 0;
                    MY_LOGI("..................................");
                    MY_LOGI("...........start bit-true check............");
                    MY_LOGI("..................................");
                    rawi_ptr = (MUINTPTR *)dequeBufInfo.mvOut.at(rawi_idx).mVa;
                    imgo_ptr = (MUINTPTR *)dequeBufInfo.mvOut.at(imgo_idx).mVa;
                    for(MUINT32 size=0; size< dequeBufInfo.mvOut.at(rawi_idx).mSize;size+=sizeof(MUINTPTR)){
                        if(*rawi_ptr++ != *imgo_ptr++){
                            err_cnt++;
                        }
                    }
                    if(err_cnt == 0 ){
                        MY_LOGI("..................................");
                        MY_LOGI("...........bit-true PASS!!............");
                        MY_LOGI("..................................");
                    }
                    else{
                        MY_LOGI("..................................");
                        MY_LOGI("...........bit-true FAIL(%d)!!............",err_cnt);
                        MY_LOGI("RAWI_VA(0x%" PRIXPTR "),IMGO_VA(0x%" PRIXPTR ")",rawi_ptr,imgo_ptr);
                        MY_LOGI("..................................");
                    }
                }
                else{
                    MY_LOGI("IMGO not pure raw , bypass bit-true;");
                    bBit_True = MFALSE;
                }
            }
            _this->mDeqCount += _this->mBurstQNum;
            _this->mLoopCount++;
        }
        else {
            _this->mFailCount++;
            ...
            default:
                {
                    ...
                    for (i = enqBufIdx; i < (enqBufIdx + _this->mBurstQNum); i++) {
                        MBOOL bin_en = MFALSE;
                        MUINT32 bin_w,bin_h;
                        ...
                        if (_this->m_enablePort & __RAWI_ENABLE) {
                            ...
                            if(_this->m_ufdi_en == MTRUE){
                                pIBuf = _this->mpImgBuffer[__UFDI].at(0);
                            }
                            else{
                                pIBuf = _this->mpImgBuffer[__RAWI].at(0);
                            }

                            _cropsize.p.x = 0;
                            _cropsize.p.y = 0;
                            _cropsize.s.w = _this->mTgSize.w;
                            _cropsize.s.h = _this->mTgSize.h;
                            enqQ.mvOut.push_back(BufInfo(PORT_RAWI, pIBuf, _cropsize.s,
                                                    _cropsize,_this->mMagicNum, sof_idx,
                                                    0xFFFF ));
                        }
                        if (_this->m_enablePort & __IMGO_ENABLE) {
                            IImageBuffer* pIBuf;
                            ...
                            enqQ.mvOut.push_back(BufInfo(PORT_IMGO, pIBuf, _cropsize.s,
                                                    _cropsize,_this->mMagicNum, sof_idx,
                                                    ((_this->m_enablePort & __IMGO_PURE_RAW) || ((_this->mMagicNum % 3 == 0)&&(_this->mBurstQNum == 1)))?1:0, 0xFFFF));
                        }
                        if (_this->m_enablePort & __SV_DCIF_IMGO_ENABLE) {
                            for(j = 0 ; j < _this->mDCIFBurstQNum ; j++){
                                IImageBuffer* pIBuf = _this->mpImgBuffer[__SV_IMGO].at(j + (i * _this->mDCIFBurstQNum));
                                MRect _cropsize;
                                ...
                                enqQ.mvOut.push_back(BufInfo(PORT_CAMSV_IMGO, pIBuf, _cropsize.s,
                                                        _cropsize, _this->mMagicNum, sof_idx, 1, 0xFFFF));
                            }
                        }
                        if (_this->m_enablePort & __RRZO_ENABLE) {
                            IImageBuffer* pIBuf;
                        ...
                        if (_this->m_enablePort & __CRZO_ENABLE) {
                            IImageBuffer* pIBuf = _this->mpImgBuffer[__CRZO].at(i);
                            MRect _cropsize;
                            MSize _destsize;
                            MUINT32 ran ;

                            if(_this->m_enablePort & __YUVO_ENABLE){//due to dm_sel is different when YUV is opened
                                _cropsize.s.w = _this->mTgSize.w;
                                _cropsize.s.h = _this->mTgSize.h;
                                _cropsize.p.x = _cropsize.p.y = 0;
                            }
                            else{
                                _this->m_crop.GetScaleInfo(PORT_RRZO,(EImageFormat)_this->mpImgBuffer[__RRZO].at(j)->getImgFormat(),_destsize,_this->mScaleSel,_this->mScaleFactor);
                            ...
                            if(_destsize.w > _this->mCrzMaxSize.w)
                                 _destsize.w = _this->mCrzMaxSize.w;
                            _destsize.h = _cropsize.s.h / ran;
                            _destsize.h = (_destsize.h & 0x1) ? (_destsize.h - 1): (_destsize.h);
                            if(_destsize.h > _this->mCrzMaxSize.h)
                                _destsize.h = _this->mCrzMaxSize.h;
                            MY_LOGD("CRZ output size: %dx%d", _destsize.w, _destsize.h);


                            enqQ.mvOut.push_back(BufInfo(PORT_CRZO_R1, pIBuf, _destsize,\
                                                    _cropsize,_this->mMagicNum, sof_idx, 0xFFFF));
                        }
                        if (_this->m_enablePort & __CRZO_R2_ENABLE) {
                            IImageBuffer* pIBuf = _this->mpImgBuffer[__CRZO_R2].at(i);
                            MRect _cropsize;
                            MSize _destsize;
                            MUINT32 ran ;
                            ...
                            _destsize.w = _cropsize.s.w / ran;
                            _destsize.w = (_destsize.w & 0x1) ? (_destsize.w - 1): (_destsize.w);
                            if(_destsize.w > _this->mCrzR2MaxSize.w)
                                _destsize.w = _this->mCrzR2MaxSize.w;
                            _destsize.h = _cropsize.s.h / ran;
                            _destsize.h = (_destsize.h & 0x1) ? (_destsize.h - 1): (_destsize.h);
                            if(_destsize.h > _this->mCrzR2MaxSize.h)
                                _destsize.h = _this->mCrzR2MaxSize.h;
                            MY_LOGD("CRZ_R2 output size: %dx%d", _destsize.w, _destsize.h);


                            enqQ.mvOut.push_back(BufInfo(PORT_CRZO_R2, pIBuf, _destsize,\
                                                    _cropsize,_this->mMagicNum, sof_idx, 0xFFFF));
                        }
                        if (_this->m_enablePort & __YUVO_ENABLE) {
                            IImageBuffer* pIBuf = _this->mpImgBuffer[__YUVO].at(i);
                            MRect _cropsize;
                            ...
                            enqQ.mvOut.push_back(BufInfo(PORT_YUVO, pIBuf, _cropsize.s,_cropsize, _this->mMagicNum, 0, 0xFFFF));
                        }
                        if (_this->m_enablePort & __EISO_ENABLE) {
                        ...
                        pMag[i-enqBufIdx] = _this->mMagicNum + i - enqBufIdx;

                    }
                    _this->mMagicNum += _this->mBurstTuningQNum;
...
MVOID* enque_loop(void* arg)
{
    NPipeUT*        _this = (NPipeUT*)arg;
    QBufInfo        enqQ;
    MUINT32         i = 0, j = 0, sof_idx = 0, enqBufIdx = 0;
    MUINT32         *pMag = NULL;
    ...
    MY_LOGD("runtime 1st magic num: %d\n", _this->mMagicNum);
    while (!_this->m_bStop) {
        if ((_this->mEnqCount + _this->mBurstQNum) > (_this->mDeqCount + _this->mPortBufDepth)) {
        ...
        for (i = enqBufIdx; i < (enqBufIdx + _this->mBurstQNum); i++) {
            ...
            if (_this->m_enablePort & __IMGO_ENABLE) {
                ...
                if(_this->mSecEnable){
                    ...
                    _buf.mSecon = 1;
                    _buf.mChk_handle = _this->mImemSecChkBuf[__IMGO].at(i).phyAddr;
                    MY_LOGD("IMGO size:0x%x va:0x%x pa:0x%x memID:0x%x chk:0x%llx",_this->mImemSecBuf[__IMGO].at(i).size,
                             _this->mImemSecBuf[__IMGO].at(i).virtAddr,_this->mImemSecBuf[__IMGO].at(i).phyAddr,
                             _this->mImemSecBuf[__IMGO].at(i).memID,_this->mImemSecChkBuf[__IMGO].at(i).phyAddr);
            ...
            if (_this->m_enablePort & __RRZO_ENABLE) {
                ...
                if(_this->mSecEnable){
                    ...
                    _buf.mSecon = 1;
                    _buf.mChk_handle = _this->mImemSecChkBuf[__RRZO].at(i).phyAddr;
                    MY_LOGD("RRZO size:0x%x va:0x%x pa:0x%x memID:0x%x chk:0x%llx",_this->mImemSecBuf[__RRZO].at(i).size,
                             _this->mImemSecBuf[__RRZO].at(i).virtAddr,_this->mImemSecBuf[__RRZO].at(i).phyAddr,
                             _this->mImemSecBuf[__RRZO].at(i).memID,_this->mImemSecChkBuf[__RRZO].at(i).phyAddr);
                    enqQ.mvOut.push_back(_buf);
                }else{
                    enqQ.mvOut.push_back(BufInfo(PORT_RRZO, pIBuf, _rrz,\
                                        _cropsize,_this->mMagicNum, sof_idx, 0xFFFF));
            ...
            if (_this->m_enablePort & __YUVO_ENABLE) {
...

                {
                    ...
                    fmt = (EImageFormat)((_this->mMagicNum % 3) ? InverseFmt(pIBuf->getImgFormat()) : pIBuf->getImgFormat());
                    ImgBufCreator creator(fmt);
                    pIBuf = _this->mpHeap[__YUVO].at(i)->createImageBuffer(&creator);
                    pIBuf->incStrong(pIBuf);
                    pIBuf->lockBuf(mThisName, eBUFFER_USAGE_HW_CAMERA_READWRITE |
                                              eBUFFER_USAGE_SW_READ_OFTEN |
                                              eBUFFER_USAGE_SW_WRITE_OFTEN);
                    _this->mpImgBuffer[__YUVO].at(i) = pIBuf;
                }
                _cropsize.s.w = _this->mTgSize.w;
                _cropsize.s.h = _this->mTgSize.h;
                _cropsize.p.x = _cropsize.p.y = 0;
        ...
        for (i = 0; i < enqQ.mvOut.size(); i++) {
            MY_LOGD("S_%d[enque] sec:0x%x dma:0x%x sof:%d PA:%lx crop:%d_%d_%d_%d size:%dx%d mag:0x%x",\
                    _this->mSensorIdx, _this->mSecEnable,\
                    enqQ.mvOut.at(i).mPortID.index, sof_idx, enqQ.mvOut.at(i).mBuffer->getBufPA(0),\
                    enqQ.mvOut.at(i).FrameBased.mCropRect.p.x,enqQ.mvOut.at(i).FrameBased.mCropRect.p.y,\
                    enqQ.mvOut.at(i).FrameBased.mCropRect.s.w,enqQ.mvOut.at(i).FrameBased.mCropRect.s.h,\
                    enqQ.mvOut.at(i).FrameBased.mDstSize.w,enqQ.mvOut.at(i).FrameBased.mDstSize.h,\
                    enqQ.mvOut.at(i).FrameBased.mMagicNum_tuning);
...
{
    NPipeUT*    _this = (NPipeUT*)arg;
    MUINT32     mnum = 0, dumpBufSize = 0, i, idx;
    ...
    for (mnum = 0; MFALSE == _this->m_bStop; mnum++) {
        for (i = 0 ; i < _this->m_vCamsvFeatureIdx.size() ; i++){
            idx = _this->m_vCamsvFeatureIdx[i];
            PortID _dq_portID;
            ...
            if (_this->mpCamsvSttPipe[idx]->deque(_dq_portID, _dq_rQBufInfo) == MFALSE) {
                MY_LOGD("##############################");
                MY_LOGD("# error:deque fail (%d)      #", idx);
                MY_LOGD("##############################");
#if 0
                MUINT32 _cnt = 0;
                while (_this->mSuspendState == 1) {
            ...
            if (_dq_rQBufInfo.mvOut.size()) {
                _this->mCamsvBufVa[idx] = _dq_rQBufInfo.mvOut.at(0).mVa;
                _this->mCamsvBufSize[idx] = _dq_rQBufInfo.mvOut.at(0).mSize;
            ...
            if (_this->mpCamsvSttPipe[idx]->enque(_eq_rQBufInfo) == MFALSE) {
                MY_LOGD("##############################");
                MY_LOGD("# error:enque fail (%d)      #", idx);
                MY_LOGD("##############################");
                break;
            }
        }
...
, mSecEnable(0)
, mbDynSwitch(MFALSE)
, mTarQBNOut(MSize(0,0))
, mTarBINOut(MSize(0,0))
, mCurTgOut(MSize(0,0))
{
    MUINT32 i;
...
MVOID NPipeUT::setTuning(MUINT32* pMagic, TUNING_TYPE_ENUM tuningType, MVOID* pIn, MVOID* pOut)
{
    ...
    tuningMgr->dequeBuffer((MINT32*)pMagic, NULL, (tuningType == TYPE_SET_TUNING)?TUNING_MGR_TYPE_SETTUNING:TUNING_MGR_TYPE_CALLBACK);

    for(MUINT32 i=0;i<this->mBurstTuningQNum;i++){
...
#define AF_WIN_SZ     48
            ...
            this->mCBMutex.lock();
            h_size = this->mTarBINOut.w;
            v_size = this->mTarBINOut.h;
            this->mCBMutex.unlock();
            ...
            if((af_con.Bits.AF_V_AVG_LVL == 3) && (af_con.Bits.AF_V_GONLY == 1)){
                win_h_size = win_h_size/32 * 32;
            }
            else if((af_con.Bits.AF_V_AVG_LVL == 3) && (af_con.Bits.AF_V_GONLY  == 0)){
                win_h_size = win_h_size/16 * 16;
            }
            else if((af_con.Bits.AF_V_AVG_LVL == 2) && (af_con.Bits.AF_V_GONLY  == 1)){
                win_h_size = win_h_size/16 * 16;
            }
            else{
                win_h_size = win_h_size/8 * 8;
                if(af_con.Bits.AF_V_AVG_LVL < 2){
                    MY_LOGE("AF_V_AVG_LVL can only be 2 or 3\n");
                }
            }
            ...
            //af
            tuningMgr->updateEngine(eTuningMgrFunc_AF_R1, MTRUE, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AF_R1_AF_SIZE, h_size, i); //case for no frontal binning

            //offset
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AF_R1_AF_VLD, (start_y<<16|start_x), i);

            //window num
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AF_R1_AF_BLK_1, ((AF_WIN_NUM_Y<<16)|AF_WIN_NUM_X), i);

            //window size
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AF_R1_AF_BLK_0, ((win_v_size<<16)|win_h_size), i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AF_R1_AF_BLK_PROT, ((win_v_size<<16)|win_h_size), i);

            //afo
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AFO_R1_AFO_XSIZE, afo_xsize, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AFO_R1_AFO_YSIZE, afo_ysize, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AFO_R1_AFO_STRIDE, afo_xsize, i);

            //af_con, af_con2
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AF_R1_AF_CON, af_con.Raw, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AF_R1_AF_CON2, af_con2.Raw, i);
        }
    ////////////////////////////////////////////////////////////////////////////////////////
    //AAO
        if(this->mEnableSttPort & __AAO_ENABLE){
            tuningMgr->updateEngine(eTuningMgrFunc_AA_R1, MTRUE, i);

            MUINT32 ae_hst_sel,aa_in_h,aa_in_v,aa_start_x,aa_start_y,_en=0;
...
#define AA_AE_OVERCNT_EN        1
#define AA_AE_SE_STAT_EN        1
#define AA_AE_HST_DMA_OUT_EN    1

            this->mCBMutex.lock();
            aa_in_h = this->mTarQBNOut.w;
            aa_in_v = this->mTarQBNOut.h;
            this->mCBMutex.unlock();
            ...
            aa_xsize = (AA_WIN_H*AA_WIN_V*16); // awb, 16 bytes each win
            ...
            if(AA_AE_HST_DMA_OUT_EN){
                _en |= 0x4;
                aa_xsize += (256*3*6*2); // 3 bytes each bin, 256 bins each hist, 6 hists each LE/SE
            }
            ...
            //win number
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AWB_WIN_NUM, (AA_WIN_H | (AA_WIN_V<<16)), i);

            //win size
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AWB_WIN_SIZE, (aa_win_size_h|(aa_win_size_v<<16)), i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AWB_WIN_PIT,  (aa_win_size_h|(aa_win_size_v<<16)), i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AWB_WIN_ORG, (aa_start_x|(aa_start_y<<16)), i);

            if(AA_AE_HST_DMA_OUT_EN){
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AE_PIX_HST_CTL, 0x3F3F, i);
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AE_PIX_HST_SET, 0x1111, i);
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AE_PIX_HST_SET_1, 0x11, i);
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AE_PIX_SE_HST_SET, 0x1111, i);
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AE_PIX_SE_HST_SET_1, 0x11, i);
            }

            //enable control
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AE_STAT_EN, _en, i);

            //pix cnt
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AWB_PIXEL_CNT0, awb_pix_cnt*2, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AWB_PIXEL_CNT1, awb_pix_cnt, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AA_R1_AA_AWB_PIXEL_CNT2, awb_pix_cnt*2, i);

            //aao
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AAO_R1_AAO_XSIZE, aa_xsize, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AAO_R1_AAO_YSIZE, 1, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, AAO_R1_AAO_STRIDE, aa_xsize, i);
        }
    ////////////////////////////////////////////////////////////////////////////////////////
    //PDO
        if(this->mEnableSttPort & __PDO_ENABLE){
#define SPECIAL_TOKEN 0xc000
            MUINT32 xsize = 0, ysize = 0, tg_w = 0, tg_h = 0;
            ...
            if (!this->m_Dualpd.Bits.bDual) {
                ...
                this->mCBMutex.lock();
                tg_w = this->mCurTgOut.w;
                tg_h = this->mCurTgOut.h;
                this->mCBMutex.unlock();

                tuningMgr->updateEngine(eTuningMgrFunc_PDE_R1, MTRUE, i);
                tuningMgr->updateEngineFD(eTuningMgrFunc_PDE_R1, i, m_bpciBuf.memID, m_bpciBuf.virtAddr);
                //pdi
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, PDI_R1_PDI_BASE_ADDR, m_bpciBuf.phyAddr, i);
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, PDI_R1_PDI_XSIZE, m_bpciBuf.size, i);
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, PDI_R1_PDI_YSIZE, 1, i);
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, PDI_R1_PDI_STRIDE, m_bpciBuf.size, i);
                ...
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, PDO_R1_PDO_XSIZE, xsize, i);
                ...
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, PDO_R1_PDO_YSIZE, ysize, i);
                //pdo stride must be 16-alignment
                if((xsize %16) != 0)
                    xsize = (xsize + 15) / 16 * 16;
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, PDO_R1_PDO_STRIDE, xsize, i);
            } else {
                MY_LOGD("dual PD");
                ...
                //dual pd
                tuningMgr->updateEngine(eTuningMgrFunc_PBN_R1, MTRUE, i);
                //
                if(this->m_Dualpd.Bits.Density == MTRUE){
                    ...
                    //
                    TUNING_MGR_WRITE_BITS_CAM(tuningMgr, PBN_R1_PBN_PBN_TYPE, PBN_PBN_TYPE, 0, i);
                    TUNING_MGR_WRITE_BITS_CAM(tuningMgr, PBN_R1_PBN_PBN_LST, PBN_PBN_LST, 1, i);
                    TUNING_MGR_WRITE_BITS_CAM(tuningMgr, PBN_R1_PBN_PBN_VSIZE, PBN_PBN_VSIZE, tg_h, i);

                    //using TG as input size when config, so using TG as output size
                    xsize = (tg_w>>4)<<1;  // output 2 pixs per 16 pixs input
                    xsize = xsize * 2;                // 1 pair of L/R per bayer pix
                    xsize = xsize * 2;                // 2 byte per pix
                    ysize = (tg_h>>3);     // output 1 line per 8 line
                }
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, PDO_R1_PDO_XSIZE, xsize, i);//PDO is 2byte per pix
                TUNING_MGR_WRITE_REG_CAM(tuningMgr, PDO_R1_PDO_YSIZE, ysize, i);
...
#define FLK_WIN_V   2
            ...
            this->mCBMutex.lock();
            h_size = this->mTarQBNOut.w;
            v_size = this->mTarQBNOut.h;
            this->mCBMutex.unlock();
            ...
            //xsize
            xsize = (FLK_WIN_H * FLK_WIN_V * v_size * 6);

            //flk
            tuningMgr->updateEngine(eTuningMgrFunc_FLK_R1, MTRUE, i);

            //offset
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_OFST, 0, i);

            //win num
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_NUM, ((FLK_WIN_V<<4)|FLK_WIN_H), i);

            //win size
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_SIZE, ((v_size<<16)|h_size), i);

            //flko
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLKO_R1_FLKO_XSIZE, xsize, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLKO_R1_FLKO_YSIZE, 1, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLKO_R1_FLKO_STRIDE, xsize, i);

            //sgg
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_SGG_GAIN, 0x82, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_SGG_GMR1, 0x6AEB, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_SGG_GMR2, 0xBB68, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_SGG_GMR3, 0xD377, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_SGG_GMR4, 0xE7F2, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_SGG_GMR5, 0xF9ED, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_SGG_GMR6, 0xFD5B, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_SGG_GMR7, 0xFF5F, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, FLK_R1_FLK_ZHDR, 0x86028A7F, i);
        }

////////////////////////////////////////////////////////////////////////////////////////
    //TSFSO
        if(this->mEnableSttPort & __TSFSO_ENABLE){
            tuningMgr->updateEngine(eTuningMgrFunc_TSFS_R1, MTRUE, i);

            MUINT32 tsfs_in_h,tsfs_in_v,tsfs_start_x,tsfs_start_y;
            MUINT32 tsfs_win_size_h,tsfs_win_size_v, tsfs_size;
            MUINT32 tsfs_xsize = 0;
            MUINT32 tsfs_pix_cnt;

#undef TSFS_WIN_H
#undef TSFS_WIN_V
#define TSFS_WIN_H    40
#define TSFS_WIN_V    30
#define TSFS_CHANNELS  3

            this->mCBMutex.lock();
            tsfs_in_h = this->mTarQBNOut.w;
            tsfs_in_v = this->mTarQBNOut.h;
            this->mCBMutex.unlock();

            MY_LOGI("[TSFSO] tuningtype:%d tsfs_in_h:%d tsfs_in_v:%d", tuningType, tsfs_in_h, tsfs_in_v);

            //tsfs win/pit size, win size <= pit size
            tsfs_win_size_h = (tsfs_in_h / TSFS_WIN_H) /2 * 2;
            tsfs_win_size_v = (tsfs_in_v / TSFS_WIN_V) /2 * 2;

            //tsfs start coordinate
            tsfs_start_x = (tsfs_in_h - tsfs_win_size_h * TSFS_WIN_H);
            tsfs_start_y = (tsfs_in_v - tsfs_win_size_v * TSFS_WIN_V);

            if(tsfs_win_size_h < 4)
                MY_LOGE("h-min is 4 , error\n");
            if(tsfs_win_size_v < 2)
                MY_LOGE("v-min is 2 , error\n");

            tsfs_xsize = (TSFS_WIN_H*TSFS_CHANNELS*4); // 4 bytes each win
            tsfs_size = tsfs_win_size_h*tsfs_win_size_v/4;

            //pix cnt
            tsfs_pix_cnt = ((1<<24)+(tsfs_size>>1)) / tsfs_size;

            //win number
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, TSFS_R1_TSFS_NUM, (TSFS_WIN_V | (TSFS_WIN_H<<16)) , i);

            //win size
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, TSFS_R1_TSFS_SIZE, (tsfs_win_size_v|(tsfs_win_size_h<<16)), i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, TSFS_R1_TSFS_PIT,  (tsfs_win_size_v|(tsfs_win_size_h<<16)), i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, TSFS_R1_TSFS_ORG, (tsfs_start_y|(tsfs_start_x<<16)), i);

            //pix cnt
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, TSFS_R1_TSFS_PC0, tsfs_pix_cnt, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, TSFS_R1_TSFS_PC1,(tsfs_pix_cnt>>1), i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, TSFS_R1_TSFS_PC2, tsfs_pix_cnt, i);

            //tsfso
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, TSFSO_R1_TSFSO_XSIZE, tsfs_xsize, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, TSFSO_R1_TSFSO_YSIZE, TSFS_WIN_V, i);
            TUNING_MGR_WRITE_REG_CAM(tuningMgr, TSFSO_R1_TSFSO_STRIDE, tsfs_xsize, i);
        }

    }

    tuningMgr->enqueBuffer((tuningType == TYPE_SET_TUNING)?TUNING_MGR_TYPE_SETTUNING:TUNING_MGR_TYPE_CALLBACK);
}
...
void NPipeUT::setZHdrTuning(MUINT32* pMagic)
{
    ...
    for(MUINT32 i=0;i<this->mBurstTuningQNum;i++){
        ...
        // LafiteEP_Todo  remove: eTuningMgrFunc_DBS
        #if 0
        ...
        #endif
        // LafiteEP_Todo  remove: eTuningMgrFunc_RMG
        #if 0
        ...
        #endif
        // LafiteEP_Todo eTuningMgrFunc_RMM
        #if 0
...
void TuningNotifyImp_CQS::p1TuningNotify(MVOID* pIn, MVOID* pOut)
{
    MY_LOGI("[CQ Start Notify] CQ start notify");
}
...
#define RSSO_VSIZE                 (511)
    ...
    MY_LOGD("RSS info: in_%d_%d", rss_in.rss_in_w, rss_in.rss_in_h);
...
{
    LCES_INPUT_INFO* lces_input = (LCES_INPUT_INFO*)pIn;
    LCES_REG_CFG*    lces_cfg = (LCES_REG_CFG*)pOut;
    MSize            lces_in = queryLcsInSize(mpNPipeUtObj->mTgSize);
    MSize            lces_out = queryLcsOutSize(mpNPipeUtObj->mTgSize);
    ...
    lces_in.w = lces_input->sHBINOut.w;
    lces_in.h = lces_input->sHBINOut.h;
#endif

    lrzr_x = ((lces_out.w-1)*1048576)/((lces_in.w>>1)-1);
    lrzr_y = ((lces_out.h-1)*1048576)/((lces_in.h>>1)-1);

    MY_LOGD("LCS info: in_%d_%d out_%d_%d lrzr_%d_%d", lces_in.w, lces_in.h, lces_out.w, lces_out.h,
            lrzr_x, lrzr_y);


    lces_cfg->bLCES_EN = MTRUE;
    lces_cfg->bLCES_Bypass = MFALSE;
    lces_cfg->u4LCESO_Stride = 768;
    lces_cfg->_LCES_REG.LCES_IN_SIZE = (((lces_in.w&0x1FFF)<<16) | (lces_in.h&0x1FFF));
    lces_cfg->_LCES_REG.LCES_OUT_SIZE = (((lces_out.w&0x1FF)<<16) | (lces_out.h&0x1FF));
    lces_cfg->_LCES_REG.LCES_LRZRX = (lrzr_x&0xFFFFF);
    lces_cfg->_LCES_REG.LCES_LRZRY = (lrzr_y&0xFFFFF);
}
...
void TuningNotifyImp_CRZCB::p1TuningNotify(MVOID* pIn, MVOID* pOut)
{
#if 1
    CRZ_REG_CFG* pout = (CRZ_REG_CFG*)pOut;
    BIN_INPUT_INFO* pin = (BIN_INPUT_INFO*)pIn;
    ...
    pout->src_x = pout->src_y = 0;
    pout->src_w = pin->CrzIn_W;
    pout->src_h = pin->CrzIn_H;

    pout->tar_w = mpNPipeUtObj->mCrzMaxSize.w / ran;
    pout->tar_h = mpNPipeUtObj->mCrzMaxSize.h / ran;
    if(pout->tar_w & 0x1)
        pout->tar_w -= 1;
    if(pout->tar_h & 0x1)
        pout->tar_h -= 1;

    pout->bCRZ_Bypass = MFALSE;

    MY_LOGD("CRZ_CB: in:%d_%d,out:%d_%d\n",pout->src_w,pout->src_h,pout->tar_w,pout->tar_h);
#else
    //FIXME:CRZCB is not ready
    MY_LOGE("CRZCB is not ready");
#endif
}

void TuningNotifyImp_CRZR2CB::p1TuningNotify(MVOID* pIn, MVOID* pOut)
{
    ...
    pout->tar_w = mpNPipeUtObj->mCrzR2MaxSize.w / ran;
    pout->tar_h = mpNPipeUtObj->mCrzR2MaxSize.h / ran;
    if(pout->tar_w & 0x1)
        pout->tar_w -= 1;
    if(pout->tar_h & 0x1)
        pout->tar_h -= 1;
    ...
    MY_LOGD("CRZR2_CB: in:%d_%d,out:%d_%d\n",pout->src_w,pout->src_h,pout->tar_w,pout->tar_h);
#else
    //FIXME:CRZR2CB is not ready
    MY_LOGE("CRZR2CB is not ready");
#endif

}

void TuningNotifyImp_3ACB::p1TuningNotify(MVOID* pIn, MVOID* pOut)
{
    MY_LOGD("[3ACB Notify] sttPort:%d pIn:0%x pOut:0x%x", mpNPipeUtObj->mEnableSttPort, pIn, pOut);
    ...
    if(mpNPipeUtObj->mEnableSttPort){
        mpNPipeUtObj->mCBMutex.lock();
        mpNPipeUtObj->mTarQBNOut = MSize(pDataIn->TarQBNOut_W, pDataIn->TarBinOut_H);
        mpNPipeUtObj->mTarBINOut = MSize(pDataIn->TarBinOut_W, pDataIn->TarBinOut_H);
        mpNPipeUtObj->mCurTgOut  = MSize(pDataIn->TgOut_W, pDataIn->TgOut_H);
        mpNPipeUtObj->mCBMutex.unlock();
    }
}
...
void TuningNotifyImp_TuningCB::p1TuningNotify(MVOID* pIn, MVOID* pOut)
{
    ...
    TUNINGCB_INPUT_INFO *pDataIn = (TUNINGCB_INPUT_INFO *)pIn;

    MY_LOGI("Magic:%d TgOut_W:%d TgOut_H:%d FrontalBin:%d "
            "src_w:%d src_h:%d "
            "crop_x:%d crop_y:%d "
            "crop_w:%d crop_h:%d "
            "tar_w:%d tar_h:%d ",
            pDataIn->Magic, pDataIn->TgOut_W, pDataIn->TgOut_H, pDataIn->FrontalBin,
            pDataIn->RRZ_IN_CROP.src_w, pDataIn->RRZ_IN_CROP.src_h,
            pDataIn->RRZ_IN_CROP.crop_x, pDataIn->RRZ_IN_CROP.crop_y,
            pDataIn->RRZ_IN_CROP.crop_w, pDataIn->RRZ_IN_CROP.crop_h,
            pDataIn->RRZ_IN_CROP.tar_w, pDataIn->RRZ_IN_CROP.tar_h);

    if(mpNPipeUtObj->mEnableSttPort){
        mpNPipeUtObj->setTuning(&(pDataIn->Magic), TYPE_TUNING_CB, pIn, pOut);
    }
}
