...
public:
    CamsvStatisticPipe_Thread*  mpCamsvStatisticPipeThread;
    QueueMgr<QBufInfo>*         mpEnqueContainer;
    mutable Mutex               mEnqueContainerLock;
    MBOOL                       mInitSettingApplied;
};

class CamsvStatisticPipe_Thread {
    friend class CamsvStatisticPipe;
public:
    CamsvStatisticPipe_Thread(CamsvStatisticPipe* obj);
    ~CamsvStatisticPipe_Thread(){};
    static CamsvStatisticPipe_Thread* createInstance(CamsvStatisticPipe* obj);
...
public:
    static MVOID* procCamsvEnque(void* arg);

public:
    CamsvStatisticPipe* mpCamsvStatisticPipe;
...
private:
    ...
    volatile MINT32 mInitCnt;
    MBOOL m_bStart;
    MINT32 m_irqUserKey;
    MUINT32 m_ShutterTimeMs[2];
};
