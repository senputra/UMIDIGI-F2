...
#include "inc/drv_log.h"                    // Note: DBG_LOG_TAG will be used in header file, so header must be included after definition.
...
class IMemDrvImp : public IMemDrv
{
    ...
    public:
        ...
        virtual MINT32  doIonCacheFlush(MINT32 memID,void* virAddr,MUINT32 size,eIONCacheFlushType flushtype);
