...
MBOOL TuningDrv_DeEnQue(TuningDrv* p1TuningDrvObj, ETuningDrvUser p1TuningDrvUser, MINT32* magicNum)
{
    ...
    for(MUINT32 i = 0; i < p1TuningDrvObj->getBQNum(); i++)
    {
       // Check OBC
       shift = 0;
       for(int j = 0; j < 4; j++)
       {
           ...
           LOG_INF("0x4%3x(0x%x)\n", 0x600 + j * 4, regValue);
           if(regValue != ((MUINT32)(magicNum[0] + j + 1)))
           {
       ...
       for(int j = 0; j < 5; j++)
       {
           ...
           regValue = vpTuningNodes[i]->pTuningRegBuf[(addr + shift) >> 2];
           LOG_INF("0x4%3x(0x%x)\n", 0xB40 + j * 4, regValue);
           if(regValue != ((MUINT32)(magicNum[0] + j + 5)))
           {
       ...
       for(int j = 0; j < 3; j++)
       {
           ...
           regValue = vpTuningNodes[i]->pTuningRegBuf[(addr + shift) >> 2];
           LOG_INF("0x3%3x(0x%x)\n", 0x534 + j * 4, regValue);
           if(regValue != ((MUINT32)(magicNum[0] + j + 0xA)))
           {
...
MBOOL TestCase_01(){
    ...
    for(int i = 0; i < BQNum; i++)
    {
        ...
        if(regValue != ((MUINT32)(magicNum[0] + 1)))
        {
        ...
        if(regValue != ((MUINT32)(magicNum[0] + 2)))
        {
        ...
        if(regValue != ((MUINT32)(magicNum[0] + 3)))
        {
        ...
        if(regValue != ((MUINT32)(magicNum[0] + 4)))
        {
