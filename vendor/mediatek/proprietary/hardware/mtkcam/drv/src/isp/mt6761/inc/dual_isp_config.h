#ifndef __DUAL_ISP_CONFIG_ISP3_H__
#define __DUAL_ISP_CONFIG_ISP3_H__
...
#define DUAL_IN_OUT_STRUCT_LUT_HW(CMD, a, b, c, d, e, f) \
	...
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_POS, CAM_BNR_PDC_POS, R)\
	/* BPC_D */\
	...
	/* RMG */\
	CMD(a, b, c, d, e, f, CAM_REG_RMG_HDR_CFG, CAM_RMG_HDR_CFG, R)\
	CMD(a, b, c, d, e, f, CAM_REG_RMG_HDR_GAIN, CAM_RMG_HDR_GAIN, R)\
	/* RMG_D */\
	CMD(a, b, c, d, e, f, CAM_REG_RMG_D_HDR_CFG, CAM_RMG_D_HDR_CFG, W)\
	CMD(a, b, c, d, e, f, CAM_REG_RMG_D_HDR_GAIN, CAM_RMG_D_HDR_GAIN, W)\
