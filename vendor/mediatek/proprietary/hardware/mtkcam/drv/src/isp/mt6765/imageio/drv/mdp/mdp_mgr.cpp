...
MINT32 _startMdp(MDPMGR_DPSTREAM_TYPE dpStreamtype,MDPMGR_CFG_STRUCT &cfgData,T* pDpStream, int p2tpipedumpEnable, int p2disableSkipTpipe)
{
    ...
    if(p2disableSkipTpipe)
    {
        ...
        HMyo CQ(%d_%d_%d),(va:0x%lx,dstpa:0x%lx)\nflag(%d_0x%x->0x%x),startStm(%d us),WDPQ(0x%8x),WRPQ(0x%8x)",\
                ...
                cfgData.ispTpipeCfgInfo.drvinfo.tpipeTablePa, p2disableSkipTpipe, cfgData.ispTpipeCfgInfo.drvinfo.frameflag, 0, b-a, WDMAPQEnable, WROTPQEnable);
    ...
    else
    {
        ...
        (va:0x%lx,dstpa:0x%lx)\nflag(%d_0x%x->0x%x),startStm(%d us),WDPQ(0x%8x),WRPQ(0x%8x)",\
                ...
                mdpPortMapping[ISP_ONLY_OUT_TPIPE].mdpPortIdx,
                (unsigned long)cfgData.ispTpipeCfgInfo.drvinfo.tpipeTableVa, \
                cfgData.ispTpipeCfgInfo.drvinfo.tpipeTablePa, p2disableSkipTpipe, cfgData.ispTpipeCfgInfo.drvinfo.frameflag, cfgData.ispTpipeCfgInfo.drvinfo.frameflag, b-a, WDMAPQEnable, WROTPQEnable);
