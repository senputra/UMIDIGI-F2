...
#define CRZ_DRV_RZ_4N_TAP_RATIO_MIN         (8)    // For this definition, it really means the denominator of MinRatio (1/64).
//
#define CRZ_DRV_RZ_N_TAP_RATIO_MAX          (8)    // For this definition, it really means the denominator of MaxRatio (1/64).
...
class CrzDrvImp : public CrzDrv
{
    ...
    public:
        ...
        // [isp_reg review] temp use, need crz owner to review this code
		virtual MBOOL   SetIspDrv(DipDrv* pIspDrv);
		...
		ISP_TPIPE_CONFIG_CRZ_STRUCT crz_setting;
    ...
    private:
        ...
        //SYSRAM_ALLOC_STRUCT SysramAlloc; //no used
        //CRZ_DRV_BUF_STRUCT  mRotationBuf[CRZ_DRV_ROTDMA_AMOUNT][CRZ_DRV_LC_AMOUNT]; //no used
        DipDrv*             m_pIspDrv;
        //DipDrv*             m_pPhyIspDrv; //no used
        //dip_x_reg_t*        m_pPhyIspReg; //no used
        MINT32              mFdSysram;
        bool                m_fgIsGdmaMode;
	    bool                m_fgVertFirst;
};
