...
#undef LOG_ERR
#undef LOG_AST
#define LOG_VRB(fmt, arg...)        do { if (isp_drv_camsv_DbgLogEnable_VERBOSE) { BASE_LOG_VRB("[0x%x]:" fmt, this->m_hwModule,##arg); } } while(0)
#define LOG_DBG(fmt, arg...)        do { if (isp_drv_camsv_DbgLogEnable_DEBUG  ) { BASE_LOG_DBG("[0x%x]:" fmt, this->m_hwModule,##arg); } } while(0)
#define LOG_INF(fmt, arg...)        do { if (isp_drv_camsv_DbgLogEnable_INFO   ) { BASE_LOG_INF("[0x%x]:" fmt, this->m_hwModule,##arg); } } while(0)
#define LOG_WRN(fmt, arg...)        do { if (isp_drv_camsv_DbgLogEnable_WARN   ) { BASE_LOG_WRN("[0x%x]:" fmt, this->m_hwModule,##arg); } } while(0)
#define LOG_ERR(fmt, arg...)        do { if (isp_drv_camsv_DbgLogEnable_ERROR  ) { BASE_LOG_ERR("[0x%x]:" fmt, this->m_hwModule,##arg); } } while(0)
...
IspDrv* IspDrvCamsv::createInstance(ISP_HW_MODULE hwModule)
{
    ...
    if(hwModule < CAMSV_MAX && hwModule >= CAMSV_START){
        ...
        BASE_LOG_DBG("moduleIdx(%d),hwModule(%d)",moduleIdx,hwModule);
    } else {
        BASE_LOG_ERR("[Error]hwModule(%d) out of the range",hwModule);
        return NULL;
    }
...
MBOOL IspDrvCamsv::signalIrq(ISP_WAIT_IRQ_ST* pWaitIrq)
{
    ...
    switch(this->m_hwModule){
        ...
        case CAMSV_5:
            ...
            break;
        case CAMSV_6:
            wait.Type = ISP_IRQ_TYPE_INT_CAMSV_6_ST;
            break;
        case CAMSV_7:
            wait.Type = ISP_IRQ_TYPE_INT_CAMSV_7_ST;
            break;
        default:
...
MBOOL IspDrvCamsv::getDeviceInfo(E_DEVICE_INFO eCmd,MUINT8* pData)
{
    ...
    switch(eCmd){
            ...
            switch(this->m_hwModule){
                ...
                case CAMSV_5:
                    *(MUINT32*)pData = ISP_IRQ_TYPE_INT_CAMSV_5_ST;
                    break;
                case CAMSV_6:
                    *(MUINT32*)pData = ISP_IRQ_TYPE_INT_CAMSV_6_ST;
                    break;
                case CAMSV_7:
                    *(MUINT32*)pData = ISP_IRQ_TYPE_INT_CAMSV_7_ST;
                    break;
                default:
                ...
                if(ioctl(this->m_pIspDrvImp->m_Fd,ISP_GET_INT_ERR,(struct ISP_RAW_INT_STATUS*)IntStatus) < 0){
                    ...
                    switch(this->m_hwModule){
                        ...
                        case CAMSV_5:
                            ...
                            break;
                        case CAMSV_6:
                            memcpy(pData, &IntStatus[ISP_IRQ_TYPE_INT_CAMSV_6_ST], sizeof(struct ISP_RAW_INT_STATUS));
                            break;
                        case CAMSV_7:
                            memcpy(pData, &IntStatus[ISP_IRQ_TYPE_INT_CAMSV_7_ST], sizeof(struct ISP_RAW_INT_STATUS));
                            break;
                        default:
        ...
        case _GET_SUPPORTED_ISP_CLOCKS:
            if(ioctl(this->m_pIspDrvImp->m_Fd,SV_GET_SUPPORTED_ISP_CLOCKS,(struct ISP_CLK_INFO*)pData) < 0){
                LOG_ERR("_GET_SUPPORTED_ISP_CLOCKS fail\n");
                rst = MFALSE;
            }
            break;
        case _GET_CUR_ISP_CLOCK:
            if(ioctl(this->m_pIspDrvImp->m_Fd,SV_GET_CUR_ISP_CLOCK,(struct ISP_GET_CLK_INFO*)pData) < 0){
...
MBOOL IspDrvCamsv::setDeviceInfo(E_DEVICE_INFO eCmd,MUINT8* pData)
{
    ...
    switch(eCmd){
        ...
        case _SET_VF_OFF:
            {
                ...
                switch(this->m_hwModule){
                    ...
                    case CAMSV_5: dbg[1] = ISP_CAMSV5_IDX;
                        break;
                    case CAMSV_6: dbg[1] = ISP_CAMSV6_IDX;
                        break;
                    case CAMSV_7: dbg[1] = ISP_CAMSV7_IDX;
                        break;
                    default:
                        LOG_ERR("unsupported module:0x%x\n", this->m_hwModule);
                        return MFALSE;
        ...
        case _SET_BUF_CTRL:
            switch(this->m_hwModule){
                ...
                case CAMSV_5:
                    ...
                    break;
                case CAMSV_6:
                    ((ISP_BUFFER_CTRL_STRUCT*)pData)->module = ISP_IRQ_TYPE_INT_CAMSV_6_ST;
                    break;
                case CAMSV_7:
                    ((ISP_BUFFER_CTRL_STRUCT*)pData)->module = ISP_IRQ_TYPE_INT_CAMSV_7_ST;
                    break;
                default:
                    LOG_ERR("unsupported module:0x%x\n",this->m_hwModule);
                    return MFALSE;
        ...
        case _SET_RESET_HW_MOD:
            {
                ...
                switch(this->m_hwModule){
                    ...
                    case CAMSV_5:
                        ...
                        break;
                    case CAMSV_6:
                        resetModule = ISP_CAMSV6_IDX;
                        break;
                    case CAMSV_7:
                        resetModule = ISP_CAMSV7_IDX;
                        break;
                    default:
                        LOG_ERR("unsupported module:0x%x\n", this->m_hwModule);
                        return MFALSE;
        ...
        case _SET_PM_QOS_INFO:
            {
                ISP_SV_PM_QOS_INFO_STRUCT *TemppData = (ISP_SV_PM_QOS_INFO_STRUCT*)pData;
                switch(this->m_hwModule){
                    case CAMSV_0:   TemppData->module = ISP_IRQ_TYPE_INT_CAMSV_0_ST;
                        break;
                    case CAMSV_1:   TemppData->module = ISP_IRQ_TYPE_INT_CAMSV_1_ST;
                        break;
                    case CAMSV_2:   TemppData->module = ISP_IRQ_TYPE_INT_CAMSV_2_ST;
                        break;
                    case CAMSV_3:   TemppData->module = ISP_IRQ_TYPE_INT_CAMSV_3_ST;
                        break;
                    case CAMSV_4:   TemppData->module = ISP_IRQ_TYPE_INT_CAMSV_4_ST;
                        break;
                    case CAMSV_5:   TemppData->module = ISP_IRQ_TYPE_INT_CAMSV_5_ST;
                        break;
                    case CAMSV_6:   TemppData->module = ISP_IRQ_TYPE_INT_CAMSV_6_ST;
                        break;
                    case CAMSV_7:   TemppData->module = ISP_IRQ_TYPE_INT_CAMSV_7_ST;
                        break;
                    default:
                        LOG_ERR("unsupported module:0x%x\n", this->m_hwModule);
                        return MFALSE;
            ...
            if(ioctl(this->m_pIspDrvImp->m_Fd, SV_SET_PM_QOS_INFO, (ISP_SV_PM_QOS_INFO_STRUCT*)pData) < 0){
        ...
        case _SET_PM_QOS_RESET:
            {
                MUINT32 dbg[2];
                switch(this->m_hwModule){
                    case CAMSV_0:   dbg[1] = ISP_IRQ_TYPE_INT_CAMSV_0_ST;
                        break;
                    case CAMSV_1:   dbg[1] = ISP_IRQ_TYPE_INT_CAMSV_1_ST;
                        break;
                    case CAMSV_2:   dbg[1] = ISP_IRQ_TYPE_INT_CAMSV_2_ST;
                        break;
                    case CAMSV_3:   dbg[1] = ISP_IRQ_TYPE_INT_CAMSV_3_ST;
                        break;
                    case CAMSV_4:   dbg[1] = ISP_IRQ_TYPE_INT_CAMSV_4_ST;
                        break;
                    case CAMSV_5:   dbg[1] = ISP_IRQ_TYPE_INT_CAMSV_5_ST;
                        break;
                    case CAMSV_6:   dbg[1] = ISP_IRQ_TYPE_INT_CAMSV_6_ST;
                        break;
                    case CAMSV_7:   dbg[1] = ISP_IRQ_TYPE_INT_CAMSV_7_ST;
                        break;
                    default:
                        LOG_ERR("unsupported module:0x%x\n", this->m_hwModule);
                        return MFALSE;
                ...
                dbg[0] = 0;
                if(ioctl(this->m_pIspDrvImp->m_Fd, SV_SET_PM_QOS, (unsigned int*)dbg) < 0){
