...
typedef struct {
    ...
    MBOOL               bypass_imgo;
    MBOOL               bypass_yuvo;
    MBOOL               bypass_crzo_r1;
    MBOOL               bypass_crzo_r2;
...
public:
    ...
    virtual MBOOL                   P1Notify_Mapping(MUINT32 cmd,P1_TUNING_NOTIFY* pObj,MBOOL bInitFBC = MTRUE) = 0;
    virtual MBOOL                   P1Notify_Global_Mapping(MUINT32 cmd,P1_TUNING_NOTIFY* pObj) = 0;
    ...
    virtual MBOOL                   getIsTwin(MBOOL bDeque = MFALSE,MBOOL bDyuv = MFALSE) = 0; // this is for camio only, bDeque can only be true if function is involked at deque()
    virtual MBOOL                   getIsInitTwin() = 0;
    virtual MBOOL                   getIsStartTwin() = 0;
    ...
    virtual void                    setDBLoadHold(MBOOL bHold, vector<MUINT32>* tuning_moduleEn, void* pCmdQ) = 0;
};
