...
public:
    ...
    MBOOL   GetScaleInfo(NSCam::NSIoPipe::PortID iport,NSCam::EImageFormat ifmt,NSCam::MSize& oSize);
...
private:
    ...
    MBOOL   Generator_RRZO(NSCam::EImageFormat ifmt,NSCam::MSize& oStart);
private:
    NSCam::MSize   mInput;
    NSCam::MSize   mTG;
    ECROP   mFunc;
