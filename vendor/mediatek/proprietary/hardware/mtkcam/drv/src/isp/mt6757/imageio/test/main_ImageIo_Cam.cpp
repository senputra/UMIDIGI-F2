...
int TEST_CAMIO::Case_0(void)
{
    ...
    if(ISP_QuerySize(this->imgo.index,ISP_QUERY_STRIDE_BYTE,this->imgo.eImgFmt,this->imgo.u4ImgWidth,QueryRst) == 0){
        printf("##############################\n");
    ...
    if(ISP_QuerySize(this->rrzo.index,ISP_QUERY_STRIDE_BYTE,this->rrzo.eImgFmt,this->rrzo.u4ImgWidth,QueryRst) == 0){
        printf("##############################\n");
        ...
        if(QueryRst.stride_byte != this->rrzo.u4Stride[ESTRIDE_1ST_PLANE]){
            printf("cur dma(%d) stride:0x%x, recommanded:0x%x",this->rrzo.index,this->rrzo.u4Stride[ESTRIDE_1ST_PLANE],QueryRst.stride_byte);
        }
    }
