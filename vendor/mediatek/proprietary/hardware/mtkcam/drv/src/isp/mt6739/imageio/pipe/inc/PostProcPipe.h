...
struct Scen_Map_CropPathInfo_STRUCT{
    ...
    Scen_Map_CropPathInfo_STRUCT()
    {
       ...
       u4CropGroup = 0;
       u4PortID[0] = NSImageio::NSIspio::EPortIndex_IMG2O;
       u4PortID[1] = NSImageio::NSIspio::EPortIndex_IMG2O;
       u4PortID[2] = NSImageio::NSIspio::EPortIndex_IMG2O;
       u4PortID[3] = NSImageio::NSIspio::EPortIndex_IMG2O;
       u4PortID[4] = NSImageio::NSIspio::EPortIndex_IMG2O;
       u4PortID[5] = NSImageio::NSIspio::EPortIndex_IMG2O;
       u4PortID[6] = NSImageio::NSIspio::EPortIndex_IMG2O;
       u4PortID[7] = NSImageio::NSIspio::EPortIndex_IMG2O;
       u4PortID[8] = NSImageio::NSIspio::EPortIndex_IMG2O;
    }
...
public:     ////    enqueue/dequeue control in ihalpipewarpper
    virtual MBOOL   endequeFrameCtrl(EPIPE_BUFQUECmd cmd,unsigned long callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx,MINT32 frameNum,MINT32 p2Scenario,MINT32 timeout=0);
public:
