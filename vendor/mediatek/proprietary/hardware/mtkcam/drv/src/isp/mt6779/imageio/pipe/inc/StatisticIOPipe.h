...
public:     ////    Buffer Quening.
    ...
    virtual MINT32   enqueInBuf(PortID const portID, QBufInfo const& rQBufInfo){portID;rQBufInfo;return 0;}
    virtual E_BUF_STATUS   dequeInBuf(PortID const portID, QTimeStampBufInfo& rQBufInfo, MUINT32 const u4TimeoutMs = 0xFFFFFFFF, CAM_STATE_NOTIFY *pNotify = NULL){portID;rQBufInfo;u4TimeoutMs;return eBuf_Pass;}
...
private:
    ...
    MBOOL                   m_byPassTSFSO;
    DMA_TSFSO               m_TSFSO;
    BUF_CTRL_TSFSO          m_TSFSO_FBC;

    STT_SEL_CTRL            m_STT_CTRL;

    MRect                   m_Dlp[2];   //0:pmx,1:1:bmx
