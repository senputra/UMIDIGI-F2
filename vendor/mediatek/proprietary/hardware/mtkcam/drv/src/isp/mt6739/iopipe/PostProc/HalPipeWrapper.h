...
#define MAX_VSS_ENQUEUE_USER_PERCQ  1
/*******************************************************************************
...
{   //must in this order cuz deque order
    ...
    EPostProcPortIdx_IMG2BO ,
    EPostProcPortIdx_IMG2O  ,
    EPostProcPortIdx_JPEGO  ,
    EPostProcPortIdx_WROTO  ,       //15
    EPostProcPortIdx_WDMAO  ,
    EPostProcPortIdx_VENC_STREAMO ,
    //
    EPostProcPortIdx_NUM    = 18    //18
};
#endif
/*******************************************************************************
...
struct PortTypeMapping
{
    ...
    NSCam::NSIoPipe::EPortType      eCamPortType;
    NSImageioIsp3::NSIspio::EPortType   eImgIOPortType;
};
...
struct TransformMapping
{
    ...
    NSImageioIsp3::NSIspio::EImageRotation  eImgRot;
    NSImageioIsp3::NSIspio::EImageFlip      eImgFlip;   //TODO, need judge vflip/hflip
};
...
struct SwHwScenarioPathMapping
{
    ...
    NSImageioIsp3::NSIspio::EDrvScenario hwPath;
    NSImageioIsp3::NSIspio::EPipePass   ePipePass;
    EPathCQ                         ePathCQ;
};
/******************************************************************************
 *
...
struct BufParamPackage
{
    ...
    MINT32  p2BurstQIdx;
    unsigned long callerID;       //different thread, special buffer id to recognize the buffer source(in default we use address of dequeuedBufList from caller)
    EBufferTag  bufTag;     //blocking or vss
    MINT32  jpgo_idx;       //index of jpego in mvOut vector
    NSCam::NSIoPipe::QParams rParams;        //image buffer information
    MUINT32  frameNum;   //total number of frame units in a single package
    ...
    NSImageioIsp3::NSIspio::EDrvScenario drvSce;
    ...
    , frameNum(0)
    , dequedNum(0)
    , drvSce(NSImageioIsp3::NSIspio::eDrvScenario_CC)
...
enum ELockEnum
{
    ...
    ELockEnum_VencCnt          ,
    ELockEnum_VssOccupied      ,// For Vss Concurrency Check
    ELockEnum_MultiFrameEnQ
};
...
public:     ////                    Instantiation.
     ...
     */
    MBOOL                   init(ESoftwareScenario swScenario,unsigned long & callerPostProc,MBOOL isV3,MUINT32 pixIdP2);
    /**
     ...
     * - MFALSE indicates failure, and an error code can be retrived by getLastErrorCode().
     */
    MBOOL                   uninit(ESoftwareScenario swScenario,NSImageioIsp3::NSIspio::IPostProcPipe *callerPostProc);
...
public:     ////
     ...
     *   getLastErrorCode().
     */
    MBOOL                   enque(ESoftwareScenario swScenario,
    						      MINT32 pixID,
     ...
     * - MFALSE indicates failure, and an error code can be retrived by getLastErrorCode().
     */
    MBOOL                   deque(ESoftwareScenario swScenario,
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   /**
     ...
     */
    MBOOL   queryFrame(NSCam::NSIoPipe::QParams& params,QFeatureData& featureParams,unsigned long callerID);
    /**
...
private:
   ...
   MBOOL dequeDoneNotify(EBufferListTag bufferListTag,
                                ...
                                MINT32 p2Scenario,
                                MBOOL  isIPRaw,
                                NSImageioIsp3::NSIspio::EPIPE_BUFQUECmd cmd=NSImageioIsp3::NSIspio::EPIPE_BUFQUECmd_DEQUE_SUCCESS,
                                unsigned long callerID=0x0);
     /**
...
private:
    ...
    IMemDrv*            m_pIMemDrv ;
    volatile MBOOL      mIsVssOccupied;   // For Vss Concurrency Check
