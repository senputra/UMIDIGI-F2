...
enum TSTMP_SRC_SOF{
    TSTMP_SRC_INTERNAL = 0,
    TSTMP_SRC_EXTERNAL = 1
};
...
public:
    ...
    static CAM_TIMESTAMP*   getInstance(ISP_HW_MODULE module,const ISP_DRV_CAM* pDrv,const IspDrvCamsv* pSVDrv=NULL);
           ...
           MBOOL            TimeStamp_mapping(MUINT64* pSec, MUINT32* pUsec,_isp_dma_enum_ dma, ISP_HW_MODULE masterModule=CAM_MAX);
           MBOOL            TimeStamp_mapping(MUINT64* pUsec,MUINT64* pUsec_B, _isp_dma_enum_ dma, ISP_HW_MODULE masterModule=CAM_MAX);
           ...
           MBOOL            TimeStamp_SrcSofSel(TSTMP_SRC_SOF src_sof = TSTMP_SRC_INTERNAL);
private:
