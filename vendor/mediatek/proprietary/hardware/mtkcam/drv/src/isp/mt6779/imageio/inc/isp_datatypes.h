...
typedef struct _ST_CAM_TOP_CTRL {
    REG_CAMCTL_R1_CAMCTL_EN FUNC_EN;
    REG_CAMCTL_R1_CAMCTL_EN2 FUNC_EN2;
    REG_CAMCTL_R1_CAMCTL_EN3 FUNC_EN3;
    REG_CAMCTL_R1_CAMCTL_EN4 FUNC_EN4;
    REG_CAMCTL_R1_CAMCTL_FMT_SEL FMT_SEL;
    REG_CAMCTL_R1_CAMCTL_FMT2_SEL FMT2_SEL;
    REG_CAMCTL_R1_CAMCTL_FMT3_SEL FMT3_SEL;
    REG_CAMCTL_R1_CAMCTL_SEL CTRL_SEL;
    REG_CAMCTL_R1_CAMCTL_SEL2 CTRL_SEL2;
}ST_CAM_TOP_CTRL;

typedef struct _ST_UNI_TOP_CTRL{
    //LafiteEP_TODO: UNI removed: CAM_UNI_REG_TOP_MOD_EN      FUNC_EN;
    //LafiteEP_TODO: UNI removed: CAM_UNI_REG_TOP_FMT_SEL     FMT_SEL;
}ST_UNI_TOP_CTRL;

/* _CAM_SV */
struct ST_CAMSV_TOP_CTRL {
    REG_CAMSV_MODULE_EN            FUNC_EN;
...
public:
    IspRect      crop;
    IspSize      out;
    MUINT32      rawType;    //0:proc, 1:pure, 2 before lsc, 3:between Lsc & WB
    EImageFormat img_fmt;
