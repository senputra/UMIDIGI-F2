...
public:
    ...
    */
    ...
    virtual MUINTPTR    reg_Base_Addr_Phy( void ) {return 0;};      //Phy reg base address, usually a fixed value
...
public:
    ...
    static Mutex   fbcPhyLock_IMGO[CAM_MAX];
    static Mutex   fbcPhyLock_RRZO[CAM_MAX];
    static Mutex   fbcPhyLock_UFEO[CAM_MAX];
    static Mutex   fbcPhyLock_AFO[CAM_MAX];
    static Mutex   fbcPhyLock_AAO[CAM_MAX];
    static Mutex   fbcPhyLock_LCSO[CAM_MAX];
    static Mutex   fbcPhyLock_PDO[CAM_MAX];
    static Mutex   fbcPhyLock_PSO[CAM_MAX];
    static Mutex   fbcPhyLock_EISO[CAM_MAX];
    static Mutex   fbcPhyLock_FLKO[CAM_MAX];
    static Mutex   fbcPhyLock_RSSO[CAM_MAX];
};
...
*/
typedef vector<stISP_BUF_INFO> ISP_BUF_INFO_L;
