...
class TuningMgrImp : public TuningMgr
{
    ...
    public:
        ...
        virtual MBOOL enableEngine(ETuningMgrFunc engine, MBOOL ctlEn, MUINT32 BQIdx = 0){return MFALSE;};
        virtual MBOOL tuningEngine(ETuningMgrFunc engine, MBOOL update, MUINT32 BQIdx = 0){return MFALSE;};

        virtual MBOOL dequeBuffer(MINT32* magicNum, MBOOL* isVerify = NULL); // magic# of tuning node, isVerify: if tuning node need to verify by 3A lately
