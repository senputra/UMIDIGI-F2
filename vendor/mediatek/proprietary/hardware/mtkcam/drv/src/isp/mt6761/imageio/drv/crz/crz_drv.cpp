...
#include <drv/isp_drv.h>    // For ISP_[READ|WRITE]_[BITS|REG] macros.
...
{
    LOG_VRB("- E. pIspReg: 0x%08lx.", (unsigned long)pIspReg);
...
{
    LOG_VRB("- E. pPhyIspDrv: %p", pPhyIspDrv);
