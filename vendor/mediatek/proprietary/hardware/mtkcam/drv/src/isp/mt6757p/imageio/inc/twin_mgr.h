...
typedef enum _E_TWN_SCENARIO{/*plz refer to dual_cal.h*/
    TWN_SCENARIO_NORMAL = 0,
    TWN_SCENARIO_AF_FAST_P1,
    TWN_SCENARIO_AF_FAST_P2
}E_TWN_SCENARIO;
...
public:
    ...
    MBOOL                   initTwin(DupCmdQMgr* pAFMainCmdQMgr);
    ...
    MBOOL                   runTwinDrv(MUINT32 scenario); // Run twin drv

    //CQ ctrl under twin mode.
    MUINT32                 CQ_cfg(E_ISP_CAM_CQ cq, MINTPTR arg1, MINTPTR arg2);
    MUINT32                 CQ_Trig(E_ISP_CAM_CQ cq);
...
private:
    ...
    MBOOL                   prepareDualInCfg(MUINT32 scenario);
...
private:
    ...
    DupCmdQMgr*                     m_pMainCQ5CmdQMgr; // CmdQMgr for cq5 main hwModule
