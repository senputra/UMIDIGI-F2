...
#define DUAL_ERROR_MESSAGE_DATA(n, CMD) \
    ...
    CMD(n, DUAL_MESSAGE_INVALID_SGG1_CONFIG_ERROR)\
...
#define DUAL_TILE_LOSS_RRZ(n) (8 + ((1==(n))?8:16))
#define DUAL_TILE_LOSS_RRZ_L(n) (6)
...
#define DUAL_SW_LIST(CMD, a, b, c, d, e, f) \
	...
	/* AF */\
	CMD(a, b, c, d, e, f, SW, TWIN_AF_MARGIN_L, TWIN_AF_MARGIN_L, TWIN_AF_MARGIN_L)\
	CMD(a, b, c, d, e, f, SW, TWIN_AF_MARGIN_R, TWIN_AF_MARGIN_R, TWIN_AF_MARGIN_R)\
