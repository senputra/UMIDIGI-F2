...
public:
    ...
    MBOOL   TBC_config(CAM_TWIN_PIPE* pTwinctrl,DupCmdQMgr* pMain,DupCmdQMgr* pTwin,list<MUINT32>* pchannel,const NSImageio::NSIspio::PortID* pInput);
...
public:
    ...
    virtual MBOOL                   getIsInit();
    virtual MBOOL                   getIsStart();
...
private:
    ...
    list<ISP_HW_MODULE>     m_occupiedModule;   //phy module
