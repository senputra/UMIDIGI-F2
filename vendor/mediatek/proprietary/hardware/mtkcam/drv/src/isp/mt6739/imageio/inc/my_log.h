...
#include "imageio/inc/imageio_log.h"                    // Note: DBG_LOG_TAG will be used in header file, so header must be included after definition.
...
#define UTIL_VRB(fmt,...)      CAM_ULOGD(NSCam::Utils::ULog::MOD_DRV_NORMAL_PIPE, "[%s]" fmt"\n", __FUNCTION__, ##__VA_ARGS__)
#define UTIL_DBG(fmt,...)      CAM_ULOGD(NSCam::Utils::ULog::MOD_DRV_NORMAL_PIPE, "[%s]" fmt"\n", __FUNCTION__, ##__VA_ARGS__)
#define UTIL_INF(fmt,...)      CAM_ULOGI(NSCam::Utils::ULog::MOD_DRV_NORMAL_PIPE, "[%s]" fmt"\n", __FUNCTION__, ##__VA_ARGS__)
#define UTIL_WRN(fmt,...)      CAM_ULOGW(NSCam::Utils::ULog::MOD_DRV_NORMAL_PIPE, "[%s]" fmt"\n", __FUNCTION__, ##__VA_ARGS__)
#define UTIL_ERR(fmt,...)      CAM_ULOGE(NSCam::Utils::ULog::MOD_DRV_NORMAL_PIPE, "[%s]" fmt"\n", __FUNCTION__, ##__VA_ARGS__)
