...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   /**
     ...
     */
    MBOOL   queryFrame(NSCam::NSIoPipe::QParams& params,QFeatureData& featureParams,MINT32 callerID);
    /**
...
private:
   ...
   MBOOL dequeDoneNotify(EBufferListTag bufferListTag,
    ...
    MBOOL waitDequeVSSBufAgain();
     /**
     * @brief maping sensor format order to p2 pixelID.
     *
     * @details
     *
     * @note
     ...
     *
     */
    int pixelIDMapping(MUINT32 sensorFormatOrder);
