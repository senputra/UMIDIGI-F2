...
///////////////////////////////////////////////////////////////////////////
    ...
    #define BASE_LOG_INF(fmt, arg...)       do { CAM_LOGI(DBG_LOG_TAG "[%s] " fmt NEW_LINE_CHAR, __func__, ##arg); } while(0)    // <Info>: Show general system information. Like OS version, start/end of Service...
