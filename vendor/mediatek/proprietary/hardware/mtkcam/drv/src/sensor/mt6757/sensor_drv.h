...
typedef enum {
    ...
    CMD_SENSOR_SET_SENSOR_DUAL_GAIN,
    ...
    CMD_SENSOR_SET_STREAMING_SUSPEND,
    CMD_SENSOR_SET_STREAMING_RESUME,
    ...
    CMD_SENSOR_SET_SENSOR_SET_WAKE_LOCK,
    CMD_SENSOR_GET_4CELL_DATA,
    CMD_SENSOR_GET_SENSOR_SYNC_MODE_CAPACITY,
    CMD_SENSOR_GET_SENSOR_SYNC_MODE,
    CMD_SENSOR_SET_SENSOR_SYNC_MODE,
...
public:
    ...
    virtual MINT32 getInfo(MUINT32 ScenarioId[3],ACDK_SENSOR_INFO_STRUCT *pSensorInfo[3],ACDK_SENSOR_CONFIG_STRUCT *pSensorConfigData[3]) = 0;
#else
...
#ifdef MTK_SUB2_IMGSENSOR
    virtual NSFeature::SensorInfoBase*  getSub2SensorInfo()  const = 0;
    virtual MUINT32 getSub2SensorID() const = 0;
#endif
