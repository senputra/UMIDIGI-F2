...
public:
    ...
    virtual MINT32 getInfo(MUINT32 ScenarioId[3],ACDK_SENSOR_INFO_STRUCT *pSensorInfo[3],ACDK_SENSOR_CONFIG_STRUCT *pSensorConfigData[3]);
#else
...
#ifdef MTK_SUB2_IMGSENSOR
    virtual MINT32 getResolution(ACDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution[3]);
#else
...
#ifdef MTK_SUB2_IMGSENSOR
	virtual NSFeature::SensorInfoBase*  getSub2SensorInfo()  const { return  m_pSub2SensorInfo;  }
	virtual MUINT32 getSub2SensorID() const { return m_sub2SensorId; }
#endif
    //
...
#ifdef MTK_SUB2_IMGSENSOR
    MUINT32  m_LineTimeInus[3];
    MUINT32  m_MinFrameLength[3];
#else
    MUINT32  m_LineTimeInus[2];
    MUINT32  m_MinFrameLength[2];
#endif
...
#ifdef MTK_SUB2_IMGSENSOR
    SENSOR_DRIVER_LIST_T m_sub2SensorDrv;
#endif
...
#ifdef MTK_SUB2_IMGSENSOR
    NSFeature::SensorInfoBase*  m_pSub2SensorInfo;
#endif

    MSDK_SENSOR_INIT_FUNCTION_STRUCT*   m_pstSensorInitFunc;
#ifdef MTK_SUB2_IMGSENSOR
    ACDK_SENSOR_RESOLUTION_INFO_STRUCT  m_SenosrResInfo[3];
    ACDK_SENSOR_INFO_STRUCT m_sensorInfo[3];
    ACDK_SENSOR_INFO_STRUCT* m_psensorInfo[3];
    ACDK_SENSOR_CONFIG_STRUCT m_sensorConfigData[3];
    ACDK_SENSOR_CONFIG_STRUCT* m_psensorConfigData[3];
#else
