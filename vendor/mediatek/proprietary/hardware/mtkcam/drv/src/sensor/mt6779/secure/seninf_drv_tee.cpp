...
{
    return SeninfDrvImp::setSeninfCamTGMuxCtrl(targetCamTG, seninfMuxSrc);
}
...
{
    return setSeninfMuxCtrl(mux, hsPol, vsPol,
...
{
    return SeninfDrvImp::setSeninfMuxCrop(mux, start_x, end_x, enable);
}
...
{
    return SeninfDrvImp::enableMUX(mux);
}
...
{
    return SeninfDrvImp::disableMUX(mux);
}
