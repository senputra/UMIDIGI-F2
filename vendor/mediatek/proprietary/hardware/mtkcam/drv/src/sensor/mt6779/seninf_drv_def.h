...
#define SENINF_CAM_MUX_CAM_END SENINF_CAM_MUX2
#define SENINF_CAM_MUX_SV_START SENINF_CAM_MUX3
...
#define SENINF_CAM_MUX_MAX      SENINF_MUX4
#define SENINF_CAMSV_MUX_MIN    SENINF_MUX4
