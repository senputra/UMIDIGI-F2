...
********************************************************************************/
typedef enum{
    MTK_CSIRX_DESKEW_LANE_A_0 = 0,
    MTK_CSIRX_DESKEW_LANE_A_1,
    MTK_CSIRX_DESKEW_LANE_A_2,
    MTK_CSIRX_DESKEW_LANE_B_0,
    MTK_CSIRX_DESKEW_LANE_B_1,
    MTK_CSIRX_DESKEW_LANE_B_2
}mtk_csirx_deskew_lane;
...
#define SENINF_CAM_MUX_CAM_START SENINF_CAM_MUX0
#define SENINF_CAM_MUX_CAM_END SENINF_CAM_MUX1
#define SENINF_CAM_MUX_SV_START SENINF_CAM_MUX2
#define SENINF_CAM_MUX_SV_END SENINF_CAM_MUX10
...
#define SENINF_PIXEL_MODE_CAMSV TWO_PIXEL_MODE

#define SENINF_TIMESTAMP_CLK    1000
#define MCLK_DRIVE_CURRENT_BY_PINCTRL
#define CAM_MUX_CONFIGURABLE
#define IS_MUX_HW_BUFFERED(x) 1
#define DFS_SUPPORT 1
#define HW_BUF_EFFECT 80
#define OFFSET_START_EXPOSURE 3000000
#define GET_PCLK_BY_SCENARIO 1
//#define HALSENSOR_AUTO_DESKEW
