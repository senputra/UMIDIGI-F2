...
SENINF_COMMON_SRC = ../../common/v1/custom
...
MY_CUST_SENSOR_METADATA_PATH_PLATFORM := $(MTK_PATH_CUSTOM_PLATFORM_HAL1)/hal/imgsensor_metadata
MY_CUST_SENSOR_METADATA_PATH_PROJECT := $(MTK_PATH_SOURCE)/custom/$(MTK_TARGET_PROJECT)/hal1/hal/imgsensor_metadata
else
...
ifneq ($(wildcard $(MY_CUST_SENSOR_METADATA_PATH_PROJECT)),)
