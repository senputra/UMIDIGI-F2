...
#define HALSENSOR_CAM_PIXEL_MODE TWO_PIXEL_MODE
#define HALSENSOR_CAMSV_PIXEL_MODE FOUR_PIXEL_MODE
#define OFFSET_START_EXPOSURE 2500000
...
typedef enum{
    SENINF_TOP_TG1 = SENINF_MUX1,
    SENINF_TOP_TG2 = SENINF_MUX2,
    SENINF_TOP_SV1 = SENINF_MUX3,
    SENINF_TOP_SV2 = SENINF_MUX4,
    SENINF_TOP_SV3 = SENINF_MUX5,
    SENINF_TOP_SV4 = SENINF_MUX6,
    SENINF_P1_NUM,
}SENINF_TOP_P1_ENUM;
