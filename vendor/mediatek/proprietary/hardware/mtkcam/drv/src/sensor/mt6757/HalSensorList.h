...
extern NSCam::SensorStaticInfo sensorStaticInfo[4];
#else
...
typedef struct {
 ...
 typedef struct {
    ...
    */
    ...
    MUINT debugMode;
    MUINT HDRMode;
    MUINT MIPI_PHY_TYPE; // 0: NCSI2(1.5G), 1:CSI2(2.5G), 2:CPHY
	...
	MUINT32 SensorMIPIDeskew; /*0: no suport hw deskew, 1: DPHY1.2 deskew*/
