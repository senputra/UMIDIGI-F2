...
public:
    ...
    virtual int setSeninfTopMuxCtrl(unsigned int seninfMuXIdx, SENINF_ENUM seninfSrc) = 0;
    virtual int setSeninfVC(SENINF_ENUM SenInfsel, unsigned int vc0Id, unsigned int vc1Id, unsigned int vc2Id,
    	unsigned int vc3Id, unsigned int vc4Id, unsigned int vc5Id) = 0;
    ...
    TG_FORMAT_ENUM inDataType, unsigned int twoPxlMode, unsigned long CSI_TYPE) = 0;
    ...
    virtual int setSeninfCSI2(seninf_csi_para *seninf) = 0;
    virtual int setSeninfCSI2_CPHY(seninf_csi_para *seninf) = 0;
    ...
    //
    virtual int autoDeskewCalibrationSeninf(EMipiPort csi_sel, unsigned int lane_num, bool is_sw_deskew ) = 0;

	virtual int CSI0_OffsetCal(unsigned long mode) = 0;

	virtual int CSI_TimingDelayCal(unsigned long mode);

	virtual int getISPClk() =0;

	virtual int getCSIpara(EMipiPort csiIndex ,seninf_csi_para *pSeninfpara) =0;
};
