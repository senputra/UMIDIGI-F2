...
void test_SensorInterface(int sendev, int scenario)
{
    ...
    //PRINT_ERR("pHalSensor->powerOn end 2 (%p)\n\n",m_pSensorHalObj);
...
int main(int argc, char** argv)
{
    ...
    if (argc < 2) {
        PRINT_MSG("Param: 1 <sensorDev> <scenario>\n");
        PRINT_MSG("<sensorDev> : main(1), Sub(2), Main2(4)\n");
