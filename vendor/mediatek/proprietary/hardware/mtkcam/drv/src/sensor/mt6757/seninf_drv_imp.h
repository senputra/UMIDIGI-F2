...
public:
    ...
    //
    virtual int setTg1Cfg(TG_FORMAT_ENUM inDataType, SENSOR_DATA_BITS_ENUM senInLsb, unsigned int twoPxlMode, unsigned int sof_Src = 0);
    //
    virtual int setTg2Cfg(TG_FORMAT_ENUM inDataType, SENSOR_DATA_BITS_ENUM senInLsb, unsigned int twoPxlMode, unsigned int sof_Src = 0);
    //
    ...
    //
    virtual int setSeninfVC(unsigned int SenInfsel, unsigned int vc0Id, unsigned int vc1Id, unsigned int vc2Id, unsigned int vc3Id);
    //
    ...
    //
    virtual int setSeninfNCSI2(Seninf_para *seninf);
    //
...
private:
    ...
    unsigned int *mpSeninf2HwRegAddr;
    unsigned int *mpSeninf3HwRegAddr;
    unsigned int *mpSeninf4HwRegAddr;
    unsigned int *mpSeninfMux1BaseAddr;
    unsigned int *mpSeninfMux2BaseAddr;
    unsigned int *mpSeninfMux3BaseAddr;
    unsigned int *mpSeninfMux4BaseAddr;
    unsigned int *mpSeninfMux5BaseAddr;
    unsigned int *mpSeninfMux6BaseAddr;
