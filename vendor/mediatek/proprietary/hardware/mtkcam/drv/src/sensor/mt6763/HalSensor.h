...
protected:
    virtual MINT                     setTgPhase(IMGSENSOR_SENSOR_IDX sensorIdx, MINT32 pcEn);
    virtual MINT                     setSensorIODrivingCurrent(IMGSENSOR_SENSOR_IDX sensorIdx);
    virtual MINT                    seninfControl(MUINT8 enable, IMGSENSOR_SENSOR_IDX sensorIdx);
};
