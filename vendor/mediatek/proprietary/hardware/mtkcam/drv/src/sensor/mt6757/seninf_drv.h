...
typedef enum { 
	...
	SENINF2_CSI1	= 0x2, /*4 Lane*/ 
	SENINF4_CSI2	= 0x3, /*2 Lane*/ 
	SENINF3_CSI1A	= 0x4,
	SENINF4_CSI1B	= 0x5,
	SENINF4_CSI2A	= 0x6,
	SENINF5_CSI2B	= 0x7,
...
public:
 ...
 //
    ...
    //
    virtual int setSeninfVC(unsigned int SenInfsel, unsigned int vc0Id, unsigned int vc1Id, unsigned int vc2Id, unsigned int vc3Id)=0;
    //
    ...
    TG_FORMAT_ENUM inDataType, unsigned int twoPxlMode) = 0; //, unsigned long CSI_TYPE) = 0;
    //
    ...
    //
    virtual int setSeninfNCSI2(Seninf_para *seninf) = 0;
    //
