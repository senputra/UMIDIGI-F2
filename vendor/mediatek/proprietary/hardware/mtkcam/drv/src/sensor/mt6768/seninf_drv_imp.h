...
protected:
    virtual int setIntegration(IMGSENSOR_SENSOR_IDX sensorIdx, SENINF_MUX_ENUM mux,
            SENINF_CONFIG_STRUCT *psensorPara, ACDK_SENSOR_INFO2_STRUCT *sensorInfo);
    virtual int debug();
    int configInputForCSI(SENINF_CONFIG_STRUCT *pseninfPara, SensorDynamicInfo *psensorDynamicInfo,
            ACDK_SENSOR_INFO2_STRUCT *sensorInfo, bool enable);
