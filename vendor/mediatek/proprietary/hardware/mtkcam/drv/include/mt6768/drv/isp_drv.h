...
typedef enum{
    CAM_A   = 0,
    CAM_B,
    CAM_A_TWIN,  //virtual hw for CAM_B's CQ-operation
    //CAM_C,        //not supported 97
    //CAM_D,        //not supported 97
    CAM_MAX,
    CAMSV_START = CAM_MAX,
    CAMSV_0 = CAMSV_START,
    CAMSV_1,
...
typedef enum{
    ...
    _GET_DIP_DBG_INFO       = (1L<<15),     //data size:
    ...
    _GET_TRANSFOR_CCU_REG   = (1L<<21),
    _GET_VSYNC_CNT          = (1L<<22),     //data size: 1 word.  out: current vsync counter
    _GET_SUPPORTED_ISP_CLOCKS = (1L<<23),
    _GET_CUR_ISP_CLOCK = (1L<<24),
    _SET_PM_QOS_INFO        = (1L<<25),
    _SET_PM_QOS_ON          = (1L<<26),
    _SET_PM_QOS_RESET       = (1L<<27),
    _SET_SEC_DAPC_REG       = (1L<<28),
}E_DEVICE_INFO;
...
class IspDrvImp : public IspDrv
{
    ...
    private:
        ...
        E_SENINF    m_seninf;          //for special function to access seninf phy reg
