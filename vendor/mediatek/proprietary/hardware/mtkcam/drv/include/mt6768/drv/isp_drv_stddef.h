...
/**
    CAM path: hw image heaer depth
*/
#define CAM_IMAGE_HEADER    (16)
...
*/
#define AFO_MAX_WIN_SZ      (32)
#define AFO_STRIDE          (128 * AFO_MAX_WIN_SZ)
#define AFO_MAX_SIZE        (128 * 128 * AFO_MAX_WIN_SZ)
#define AFO_DUMMY_STRIDE    (1 * AFO_MAX_WIN_SZ)
...
#define AE_OE_WIN    (8)
#define TSF_WIN      (16)
#define AE_HISTOGRAM (128*24)
#define AE_EN_NUM    (4)
#define AAO_MAX_SIZE ((AA_WIN_H*AA_WIN_V*(AWB_WIN+AE_WIN+HDR_WIN+AE_OE_WIN+TSF_WIN) + AE_HISTOGRAM*AE_EN_NUM)/8)
#define PS_TSF_WIN      (32) /*R/Gr/B/Gb*/
#define PSO_MAX_SIZE ((AA_WIN_H*AA_WIN_V*(AWB_WIN+AE_WIN+HDR_WIN+PS_TSF_WIN))/8)
...
#define EFUSE_INDEX (3)
#define EFUSE_ISP_BOUND(SpareREG) ((SpareREG & 0x30) >> 4)
#define EFUSE_DUAL_CAM(SpareREG) ((SpareREG & 0xC0) >> 6)
...
typedef enum{
    ...
    ENUM_DIP_CTL_YUV_EN_NDG        = (1L<<6),
    ENUM_DIP_CTL_YUV_EN_NDG2       = (1L<<7),
...
typedef enum{
    ...
    ENUM_DIP_CTL_RGB_EN_FLC         = (1L<<23),
    ENUM_DIP_CTL_RGB_EN_FLC2        = (1L<<24)
}ENUM_DIP_CTL_RGB_EN;
