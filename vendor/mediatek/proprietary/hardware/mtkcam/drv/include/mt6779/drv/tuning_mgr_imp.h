...
#define getIspTuningMgrFunc(hw) ({\
    ...
    switch (hw) {\
        ...
        case eTuningMgrFunc_MOBC_R2:\
            f = eIspTuningMgrFunc_MOBC_R2;\
            break;\
        case eTuningMgrFunc_WB_R1:\
            f = eIspTuningMgrFunc_WB;\
            break;\
        case eTuningMgrFunc_DGN_R1:\
            f = eIspTuningMgrFunc_DGN;\
            break;\
        case eTuningMgrFunc_TSFS_R1:\
            f = eIspTuningMgrFunc_TSFS;\
            break;\
        case eTuningMgrFunc_DM_R1:\
            f = eIspTuningMgrFunc_DM;\
            break;\
        case eTuningMgrFunc_FLC_R1:\
            f = eIspTuningMgrFunc_FLC;\
            break;\
        case eTuningMgrFunc_CCM_R1:\
            f = eIspTuningMgrFunc_CCM;\
            break;\
        case eTuningMgrFunc_GGM_R1:\
            f = eIspTuningMgrFunc_GGM;\
            break;\
        case eTuningMgrFunc_GGM_R2:\
            f = eIspTuningMgrFunc_GGM_R2;\
            break;\
        case eTuningMgrFunc_G2C_R1:\
            f = eIspTuningMgrFunc_G2C;\
            break;\
        case eTuningMgrFunc_G2C_R2:\
            f = eIspTuningMgrFunc_G2C_R2;\
            break;\
        case eTuningMgrFunc_YNRS_R1:\
            f = eIspTuningMgrFunc_YNRS;\
            break;\
        case eTuningMgrFunc_RSS_R2:\
            f = eIspTuningMgrFunc_RSS_R2;\
            break;\
        case eTuningMgrFunc_SLK_R1:\
            f = eIspTuningMgrFunc_SLK;\
            break;\
        case eTuningMgrFunc_SLK_R2:\
            f = eIspTuningMgrFunc_SLK_R2;\
            break;\
        case eTuningMgrFunc_BPCI_R1:\
            f = eIspTuningMgrFunc_BPCI;\
            break;\
        case eTuningMgrFunc_LCES_R1:\
            f = eIspTuningMgrFunc_LCES;\
            break;\
        case eTuningMgrFunc_LTMS_R1:\
            f = eIspTuningMgrFunc_LTMS;\
            break;\
        case eTuningMgrFunc_LTM_R1:\
            f = eIspTuningMgrFunc_LTM;\
            break;\
        case eTuningMgrFunc_LTMTC_R1_CURVE:\
            f = eIspTuningMgrFunc_LTMTC_R1_CURVE;\
            break;\
...
class TuningMgrImp : public TuningMgr
{
    ...
    private:
        ...
        MUINT32             mCtlEn3_CAM;    // used to en/disable update engine
        MUINT32             mCtlEn4_CAM;    // used to en/disable update engine
        MUINT32             mCtlEnDMA_CAM;  // used to en/disable update engine
        MUINT32             mCtlEnDMA2_CAM; // used to en/disable update engine
