...
/**
    REG size for each module is 0x10000
*/
#define REG_SIZE        (ISP_REG_RANGE)
#define CAM_BASE_RANGE  (REG_SIZE)
#define CAM_BASE_RANGE_WITH_INNER (0x10000)
#define CAM_BASE_RANGE_SETCLR   (0x1000)
#define CAM_BASE_RANGE_SPECIAL  (sizeof(cam_reg_t)) //for CQ special baseaddress
#define UNI_BASE_RANGE  (0)
#define CAMSV_BASE_RANGE        (ISPSV_REG_RANGE)
