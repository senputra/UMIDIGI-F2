...
enum EPIPECmd {
    ...
    EPIPECmd_SET_YUVO                   = 0x1020,
    EPIPECmd_SET_CRZOR1                 = 0x1021,
    EPIPECmd_SET_CRZOR2                 = 0x1022,
    EPIPECmd_SET_RAWI                   = 0x1023,
    ...
    //EPIPECmd_GET_PSO_CONS               = 0x1126, //LafiteEP_TODO: PS/PSO removed
    EPIPECmd_GET_HEADER_SIZE            = 0x1127,//get header size by input dma
    EPIPECmd_GET_TSFSO_CONS             = 0x1128,
    EPIPECmd_GET_RMB_INFO               = 0x113D,
    EPIPECmd_GET_PIPE_BIT_MODE          = 0x113E,
    ...
    EPIPECmd_SET_SGG2_CBFP              = 0X1303,//ISP4/5 for SGG2;ISP6 for GSE
    ...
    EPIPECmd_SET_CRZR1_CBFP             = 0x130A,
    EPIPECmd_SET_CRZR2_CBFP             = 0x130B,
    EPIPECmd_SET_CQSTART_CBFP           = 0x130C,
    EPIPECmd_SET_SWITCH_CBFP            = 0x130D, //ISP 6 for W and T
    EPIPECmd_GET_SWITCH_STATUS          = 0x130E, //ISP 6 for W and T
    EPIPECmd_SET_3A_HAL_CBFP            = 0x130F,

    //phase out pm_qos cmd for iopipe, these cmd should be a imageio internal cmd.
    //EPIPECmd_SET_PM_QOS_INFO            = 0x1408,EPIPECmd_SET_PM_QOS_RESET
    ...
    EPIPECmd_SET_DBLOAD_HOLD            = 0x1417,
    EPIPECmd_GET_CUR_RAW                = 0x1418,
...
enum E_LBIT_GROUP
{
    eLbitGroup_AfterTG      = 0x01, //G1
    eLbitGroup_AfterFUS     = 0x02, //G2
};
