...
typedef enum{
    ...
    //CAM_B_TWIN_A,    //CAMB use this virtual hw for CAM_A's CQ-operation
    CAM_MAX,
    CAMSV_START = CAM_MAX,
    CAMSV_0 = CAMSV_START,
    CAMSV_1,
...
typedef enum{
    ...
    _SET_DFS_UPDATE         = (1L<<14),     //data size: 1 word, set isp clk
    _SET_DFS_RESET          = (1L<<25),     //reset isp clk, scenario function
    _SET_PM_QOS_INFO        = (1L<<24),     //set qos
    _SET_PM_QOS_RESET       = (1L<<26),     //reset qos, scenario function.
    ...
    _GET_SUPPORTED_ISP_CLOCKS = (1L<<22),   //get supported isp clk from qos
    _GET_CUR_ISP_CLOCK      = (1L<<23),     //get current isp clk
    _NOTE_CQTHR0_BASE        = (1L<<28),
}E_DEVICE_INFO;
...
class IspDrv
{
    ...
    public:
        ...
        virtual MBOOL   waitIrq(ISP_WAIT_IRQ_STRUCT* pWaitIrq) = 0;
        ...
        virtual MBOOL   signalIrq(ISP_WAIT_IRQ_STRUCT* pWaitIrq) = 0;
        ...
        virtual MUINT32 readInnerReg(MUINT32 Addr,MINT32 caller=0) = 0;
        ...
        virtual MUINT32*  getHwRegAddr(void) = 0;
        //read registers according to offset
        virtual MBOOL   readPtrRegs(MUINT32 **ptr, MUINT32 offset, MUINT32 size,MINT32 caller=0) = 0;
...
class IspDrvImp : public IspDrv
{
    ...
    public:
        ...
        virtual MBOOL   signalIrq(ISP_WAIT_IRQ_STRUCT* pWaitIrq){(void)pWaitIrq;return MFALSE;};
        ...
        virtual MBOOL   readPtrRegs(MUINT32 **ptr, MUINT32 offset, MUINT32 size,MINT32 caller=0);
    private:
