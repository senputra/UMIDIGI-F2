...
/**
    for CamSV control
*/
class IspDrvCamsv : public IspDrvVir, public IspDrvImp
{
    public:
                        ~IspDrvCamsv(void){}
                        IspDrvCamsv(void);
    ...
    public:
        ...
        virtual MBOOL   waitIrq(ISP_WAIT_IRQ_STRUCT* pWaitIrq){(void)pWaitIrq;return MFALSE;};
        ...
        virtual MBOOL   cqAddModule(MUINT32 moduleId){return MTRUE; };
        virtual MBOOL   cqDelModule(MUINT32 moduleId){return MTRUE; };
        virtual MBOOL   cqNopModule(MUINT32 moduleId){return MTRUE; };
        virtual MBOOL   cqApbModule(MUINT32 moduleId){return MTRUE; };
        virtual MBOOL   dumpCQTable(void){return MTRUE; };
        virtual MUINT32*    getCQDescBufPhyAddr(void){return NULL; };
        virtual MBOOL   getCQModuleInfo(MUINT32 moduleId, MUINT32 &addrOffset, MUINT32 &moduleSize){return MTRUE; };
        virtual MBOOL   flushCmdQ(void){return MTRUE; };
