...
typedef enum {
    ...
    DIP_A_SL2,              //0x15022740~0x15022764
    DIP_A_SL2_BUG_2,        //0x15022764
    ...
    DIP_A_MFB_BUG_1,        //0x15022810
    DIP_A_MFB,              //0x15022810~0x15022824
    DIP_A_MFB_BUG_2,        //0x15022824
    ...
    DIP_A_SL2B,             //0x15022b30~0x15022b54
    DIP_A_SL2B_BUG_2,       //0x15022b54
    DIP_A_SL2C_BUG_1,       //0x15022b70
    DIP_A_SL2C,             //0x15022b70~0x15022b94
    DIP_A_SL2C_BUG_2,       //0x15022b94
    ...
    DIP_A_SL2D,             //0x15022ca0~0x15022cc4
    DIP_A_SL2D_BUG_2,       //0x15022cc4
    DIP_A_SL2E_BUG_1,       //0x15022ce0
    DIP_A_SL2E,             //0x15022ce0~0x15022d04
    DIP_A_SL2E_BUG_2,       //0x15022d04
    ...
    DIP_A_MFB2_BUG_1,       //0x15022f78
    DIP_A_MFB2,             //0x15022f78~0x15022fB8
    DIP_A_MFB2_BUG_2,       //0x15022fB8
    ...
    DIP_A_SL2G,             //0x15024500~0x15024524
    DIP_A_SL2G_BUG_2,       //0x15024524
    DIP_A_SL2H_BUG_1,       //0x15024540
    DIP_A_SL2H,             //0x15024540~0x15024564
    DIP_A_SL2H_BUG_2,       //0x15024564
    ...
    DIP_A_SL2I,             //0x15024670~0x15024694
    DIP_A_SL2I_BUG_2,       //0x15024694
...
static ISP_DRV_CQ_MODULE_INFO_STRUCT mIspDipCQModuleInfo[DIP_A_MODULE_MAX]
   =  {{DIP_A_CTL_BUG_1,        0x22004, 0x0004, 1  },  //0x15022004
       ...
       {DIP_A_SL2,              0x22740, 0x0740, 10 },  //0x15022740 ~ 0x15022764
       {DIP_A_SL2_BUG_2,        0x22764, 0x0764, 1  },  //0x15022764
       ...
       {DIP_A_MFB_BUG_1,        0x22810, 0x0810, 1  },  //0x15022810
       {DIP_A_MFB,              0x22810, 0x0810, 6  },  //0x15022810 ~ 0x15022824
       {DIP_A_MFB_BUG_2,        0x22824, 0x0824, 1  },  //0x15022824
       ...
       {DIP_A_SL2B,             0x22b30, 0x0b30, 10 },  //0x15022b30 ~ 0x15022b54
       {DIP_A_SL2B_BUG_2,       0x22b54, 0x0b54, 1  },  //0x15022b54
       {DIP_A_SL2C_BUG_1,       0x22b70, 0x0b70, 1  },  //0x15022b70
       {DIP_A_SL2C,             0x22b70, 0x0b70, 10 },  //0x15022b70 ~ 0x15022b94
       {DIP_A_SL2C_BUG_2,       0x22b94, 0x0b94, 1  },  //0x15022b94
       ...
       {DIP_A_SL2D,             0x22ca0, 0x0ca0, 10 },  //0x15022ca0 ~ 0x15022cc4
       {DIP_A_SL2D_BUG_2,       0x22cc4, 0x0cc4, 1  },  //0x15022cc4
       {DIP_A_SL2E_BUG_1,       0x22ce0, 0x0ce0, 1  },  //0x15022ce0
       {DIP_A_SL2E,             0x22ce0, 0x0ce0, 10 },  //0x15022ce0 ~ 0x15022d04
       {DIP_A_SL2E_BUG_2,       0x22d04, 0x0d04, 1  },  //0x15022d04
       ...
       {DIP_A_MFB2_BUG_1,       0x22f78, 0x0f78, 1  },  //0x15022f78
       {DIP_A_MFB2,             0x22f78, 0x0f78, 17 },  //0x15022f78 ~ 0x15022fb8
       {DIP_A_MFB2_BUG_2,       0x22fb8, 0x0fb8, 1  },  //0x15022fb8
       ...
       {DIP_A_SL2G,             0x24500, 0x2500, 10 },  //0x15024500 ~ 0x15024524
       {DIP_A_SL2G_BUG_2,       0x24524, 0x2524, 1  },  //0x15024524
       {DIP_A_SL2H_BUG_1,       0x24540, 0x2540, 1  },  //0x15024540
       {DIP_A_SL2H,             0x24540, 0x2540, 10 },  //0x15024540 ~ 0x15024564
       {DIP_A_SL2H_BUG_2,       0x24564, 0x2564, 1  },  //0x15024564
       ...
       {DIP_A_SL2I,             0x24670, 0x2670, 10 },  //0x15024670 ~ 0x15024694
       {DIP_A_SL2I_BUG_2,       0x24694, 0x2694, 1  },  //0x15024694
...
#define DIP_X_REG_CTL_YUV_EN_reserve                   (1L<<9)
...
#define DIP_X_REG_CTL_YUV_EN_DRZ                   (1L<<27)
...
#define DIP_X_REG_CTL_RGB_EN_FLC                    (1L<<21)
#define DIP_X_REG_CTL_RGB_EN_FLC2                   (1L<<22)
...
#define DIP_X_REG_CTL_TDR_FLC_TCM_EN                        (1L<<28)
#define DIP_X_REG_CTL_TDR_FLC2_TCM_EN                       (1L<<29)
#define DIP_X_REG_CTL_TDR_rsv_30							(1L<<30)
