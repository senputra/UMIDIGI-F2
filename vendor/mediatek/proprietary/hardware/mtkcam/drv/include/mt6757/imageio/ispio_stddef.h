...
enum EPIPECmd {
    ...
    EPIPECmd_SET_STT_SUSPEND_CB         = 0x0813,
...
//  EPIPECmd_SET_CAM_MODE               = 0x1004,
    ...
    EPIPECmd_AE_SMOOTH                  = 0x1105,//phase out
    ...
    EPIPECmd_GET_AFO_STRIDE_INFO        = 0x1123,
    EPIPECmd_GET_PDO_CONS               = 0x1124,
    EPIPECmd_GET_PDO_STRIDE_INFO        = 0x1125,
    EPIPECmd_GET_PSO_CONS               = 0x1126,
    EPIPECmd_SET_FAST_AF                = 0x1127,
    ...
    EPIPECmd_SET_REGDUMP_CBFP           = 0x1130,
...
public:     //// fields.
    ...
    MUINT32     img_pxl_id;
    MUINT32     m_num;
    MUINT32     m_num_tuning;//for AAO, tuning serial number
    MUINT32     frm_cnt;
