...
*/
#define CAM_RRZ_MAX_LINE_BUFFER_IN_PIXEL (4608)
#define CAM_BNR_MAX_LINE_BUFFER_IN_PIXEL (5376)
...
//avoid CAM_A or CAM_B'S  afo being disabled by twin drv af touch at the corner of image
#define AFO_STRIDE_DUMMY(xSz) ((xSz) + AFO_DUMMY_STRIDE)
/**
    for AAO
*/
#define AA_WIN_H     (120)
...
typedef enum{
    ...
    ENUM_DIP_CTL_RGB_EN_FLC         = (1L<<21),
    ENUM_DIP_CTL_RGB_EN_FLC2        = (1L<<22),
}ENUM_DIP_CTL_RGB_EN;
