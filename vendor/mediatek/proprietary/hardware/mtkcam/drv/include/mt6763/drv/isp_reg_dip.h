...
typedef volatile union _DIP_X_REG_ADL_DMA_A_IPUO_BASE_ADDR_2_
{
		volatile struct	/* 0x15024C34 */
		{
				FIELD  BASE_ADDR_2                           :  2;		/*  0.. 1, 0x00000003 */
				FIELD  rsv_2                                 : 30;		/*  2..31, 0xFFFFFFFC */
		} Bits;
		UINT32 Raw;
}DIP_X_REG_ADL_DMA_A_IPUO_BASE_ADDR_2;	/* DIP_X_ADL_DMA_A_IPUO_BASE_ADDR_2, DIP_A_ADL_DMA_A_IPUO_BASE_ADDR_2*/

typedef volatile union _DIP_X_REG_ADL_DMA_A_IPUO_OFST_ADDR_
{
		volatile struct	/* 0x15024C38 */
		{
				FIELD  OFFSET_ADDR                           : 32;		/*  0..31, 0xFFFFFFFF */
		} Bits;
		UINT32 Raw;
...
typedef volatile union _DIP_X_REG_ADL_DMA_A_IPUO_OFST_ADDR_2_
{
		volatile struct	/* 0x15024C3C */
		{
				FIELD  OFFSET_ADDR_2                         :  2;		/*  0.. 1, 0x00000003 */
				FIELD  rsv_2                                 : 30;		/*  2..31, 0xFFFFFFFC */
		} Bits;
		UINT32 Raw;
}DIP_X_REG_ADL_DMA_A_IPUO_OFST_ADDR_2;	/* DIP_X_ADL_DMA_A_IPUO_OFST_ADDR_2, DIP_A_ADL_DMA_A_IPUO_OFST_ADDR_2*/

typedef volatile union _DIP_X_REG_ADL_DMA_A_IPUO_XSIZE_
{
		volatile struct	/* 0x15024C40 */
		{
				FIELD  XSIZE                                 : 16;		/*  0..15, 0x0000FFFF */
				FIELD  rsv_16                                : 16;		/* 16..31, 0xFFFF0000 */
		} Bits;
...
typedef volatile union _DIP_X_REG_ADL_DMA_A_IPUI_BASE_ADDR_2_
{
		volatile struct	/* 0x15024C94 */
		{
				FIELD  BASE_ADDR_2                           :  2;		/*  0.. 1, 0x00000003 */
				FIELD  rsv_2                                 : 30;		/*  2..31, 0xFFFFFFFC */
		} Bits;
		UINT32 Raw;
}DIP_X_REG_ADL_DMA_A_IPUI_BASE_ADDR_2;	/* DIP_X_ADL_DMA_A_IPUI_BASE_ADDR_2, DIP_A_ADL_DMA_A_IPUI_BASE_ADDR_2*/

typedef volatile union _DIP_X_REG_ADL_DMA_A_IPUI_OFST_ADDR_
{
		volatile struct	/* 0x15024C98 */
		{
				FIELD  OFFSET_ADDR                           : 32;		/*  0..31, 0xFFFFFFFF */
		} Bits;
		UINT32 Raw;
...
typedef volatile union _DIP_X_REG_ADL_DMA_A_IPUI_OFST_ADDR_2_
{
		volatile struct	/* 0x15024C9C */
		{
				FIELD  OFFSET_ADDR_2                         :  2;		/*  0.. 1, 0x00000003 */
				FIELD  rsv_2                                 : 30;		/*  2..31, 0xFFFFFFFC */
		} Bits;
		UINT32 Raw;
}DIP_X_REG_ADL_DMA_A_IPUI_OFST_ADDR_2;	/* DIP_X_ADL_DMA_A_IPUI_OFST_ADDR_2, DIP_A_ADL_DMA_A_IPUI_OFST_ADDR_2*/

typedef volatile union _DIP_X_REG_ADL_DMA_A_IPUI_XSIZE_
{
		volatile struct	/* 0x15024CA0 */
		{
				FIELD  XSIZE                                 : 16;		/*  0..15, 0x0000FFFF */
				FIELD  rsv_16                                : 16;		/* 16..31, 0xFFFF0000 */
		} Bits;
...
{
		volatile struct	/* 0x15024F84 */
		{
				FIELD  Reserved                              : 16;		/*  0..15, 0x0000FFFF */
				FIELD  ADL_A_WR_RING_STRIDE                  : 16;		/* 16..31, 0xFFFF0000 */
		} Bits;
		UINT32 Raw;
...
{
		volatile struct	/* 0x15024F8C */
		{
				FIELD  Reserved                              : 16;		/*  0..15, 0x0000FFFF */
				FIELD  ADL_A_RD_RING_STRIDE                  : 16;		/* 16..31, 0xFFFF0000 */
		} Bits;
		UINT32 Raw;
...
{
	UINT32                                          rsv_0000[70];                                    /* 0000..0117, 15000000..15000117 */
}isp_img_reg_t;
...
typedef volatile struct _dip_x_reg_t_	/* 0x15022000..0x150264FF */
{
	...
	UINT32                                          rsv_00E0[8];                                     /* 00E0..00FF, 0x150220E0..150220FF */
	...
	UINT32                                          rsv_2978[162];                                   /* 2978..2BFF, 0x15024978..15024BFF */
	DIP_X_REG_ADL_DMA_A_DMA_SOFT_RSTSTAT            DIP_X_ADL_DMA_A_DMA_SOFT_RSTSTAT;                /* 2C00, 0x15024C00, DIP_A_ADL_DMA_A_DMA_SOFT_RSTSTAT */
	DIP_X_REG_ADL_DMA_A_VERTICAL_FLIP_EN            DIP_X_ADL_DMA_A_VERTICAL_FLIP_EN;                /* 2C04, 0x15024C04, DIP_A_ADL_DMA_A_VERTICAL_FLIP_EN */
	DIP_X_REG_ADL_DMA_A_DMA_SOFT_RESET              DIP_X_ADL_DMA_A_DMA_SOFT_RESET;                  /* 2C08, 0x15024C08, DIP_A_ADL_DMA_A_DMA_SOFT_RESET */
	DIP_X_REG_ADL_DMA_A_LAST_ULTRA_EN               DIP_X_ADL_DMA_A_LAST_ULTRA_EN;                   /* 2C0C, 0x15024C0C, DIP_A_ADL_DMA_A_LAST_ULTRA_EN */
	DIP_X_REG_ADL_DMA_A_SPECIAL_FUN_EN              DIP_X_ADL_DMA_A_SPECIAL_FUN_EN;                  /* 2C10, 0x15024C10, DIP_A_ADL_DMA_A_SPECIAL_FUN_EN */
	DIP_X_REG_ADL_DMA_A_IPUO_RING                   DIP_X_ADL_DMA_A_IPUO_RING;                       /* 2C14, 0x15024C14, DIP_A_ADL_DMA_A_IPUO_RING */
	DIP_X_REG_ADL_DMA_A_IPUI_RING                   DIP_X_ADL_DMA_A_IPUI_RING;                       /* 2C18, 0x15024C18, DIP_A_ADL_DMA_A_IPUI_RING */
	UINT32                                          rsv_2C1C[5];                                     /* 2C1C..2C2F, 0x15024C1C..15024C2F */
	DIP_X_REG_ADL_DMA_A_IPUO_BASE_ADDR              DIP_X_ADL_DMA_A_IPUO_BASE_ADDR;                  /* 2C30, 0x15024C30, DIP_A_ADL_DMA_A_IPUO_BASE_ADDR */
	DIP_X_REG_ADL_DMA_A_IPUO_BASE_ADDR_2            DIP_X_ADL_DMA_A_IPUO_BASE_ADDR_2;                /* 2C34, 0x15024C34, DIP_A_ADL_DMA_A_IPUO_BASE_ADDR_2 */
	DIP_X_REG_ADL_DMA_A_IPUO_OFST_ADDR              DIP_X_ADL_DMA_A_IPUO_OFST_ADDR;                  /* 2C38, 0x15024C38, DIP_A_ADL_DMA_A_IPUO_OFST_ADDR */
	DIP_X_REG_ADL_DMA_A_IPUO_OFST_ADDR_2            DIP_X_ADL_DMA_A_IPUO_OFST_ADDR_2;                /* 2C3C, 0x15024C3C, DIP_A_ADL_DMA_A_IPUO_OFST_ADDR_2 */
	DIP_X_REG_ADL_DMA_A_IPUO_XSIZE                  DIP_X_ADL_DMA_A_IPUO_XSIZE;                      /* 2C40, 0x15024C40, DIP_A_ADL_DMA_A_IPUO_XSIZE */
	DIP_X_REG_ADL_DMA_A_IPUO_YSIZE                  DIP_X_ADL_DMA_A_IPUO_YSIZE;                      /* 2C44, 0x15024C44, DIP_A_ADL_DMA_A_IPUO_YSIZE */
	DIP_X_REG_ADL_DMA_A_IPUO_STRIDE                 DIP_X_ADL_DMA_A_IPUO_STRIDE;                     /* 2C48, 0x15024C48, DIP_A_ADL_DMA_A_IPUO_STRIDE */
	DIP_X_REG_ADL_DMA_A_IPUO_CON                    DIP_X_ADL_DMA_A_IPUO_CON;                        /* 2C4C, 0x15024C4C, DIP_A_ADL_DMA_A_IPUO_CON */
	DIP_X_REG_ADL_DMA_A_IPUO_CON2                   DIP_X_ADL_DMA_A_IPUO_CON2;                       /* 2C50, 0x15024C50, DIP_A_ADL_DMA_A_IPUO_CON2 */
	DIP_X_REG_ADL_DMA_A_IPUO_CON3                   DIP_X_ADL_DMA_A_IPUO_CON3;                       /* 2C54, 0x15024C54, DIP_A_ADL_DMA_A_IPUO_CON3 */
	UINT32                                          rsv_2C58[14];                                    /* 2C58..2C8F, 0x15024C58..15024C8F */
	DIP_X_REG_ADL_DMA_A_IPUI_BASE_ADDR              DIP_X_ADL_DMA_A_IPUI_BASE_ADDR;                  /* 2C90, 0x15024C90, DIP_A_ADL_DMA_A_IPUI_BASE_ADDR */
	DIP_X_REG_ADL_DMA_A_IPUI_BASE_ADDR_2            DIP_X_ADL_DMA_A_IPUI_BASE_ADDR_2;                /* 2C94, 0x15024C94, DIP_A_ADL_DMA_A_IPUI_BASE_ADDR_2 */
	DIP_X_REG_ADL_DMA_A_IPUI_OFST_ADDR              DIP_X_ADL_DMA_A_IPUI_OFST_ADDR;                  /* 2C98, 0x15024C98, DIP_A_ADL_DMA_A_IPUI_OFST_ADDR */
	DIP_X_REG_ADL_DMA_A_IPUI_OFST_ADDR_2            DIP_X_ADL_DMA_A_IPUI_OFST_ADDR_2;                /* 2C9C, 0x15024C9C, DIP_A_ADL_DMA_A_IPUI_OFST_ADDR_2 */
	DIP_X_REG_ADL_DMA_A_IPUI_XSIZE                  DIP_X_ADL_DMA_A_IPUI_XSIZE;                      /* 2CA0, 0x15024CA0, DIP_A_ADL_DMA_A_IPUI_XSIZE */
	DIP_X_REG_ADL_DMA_A_IPUI_YSIZE                  DIP_X_ADL_DMA_A_IPUI_YSIZE;                      /* 2CA4, 0x15024CA4, DIP_A_ADL_DMA_A_IPUI_YSIZE */
	DIP_X_REG_ADL_DMA_A_IPUI_STRIDE                 DIP_X_ADL_DMA_A_IPUI_STRIDE;                     /* 2CA8, 0x15024CA8, DIP_A_ADL_DMA_A_IPUI_STRIDE */
	DIP_X_REG_ADL_DMA_A_IPUI_CON                    DIP_X_ADL_DMA_A_IPUI_CON;                        /* 2CAC, 0x15024CAC, DIP_A_ADL_DMA_A_IPUI_CON */
	DIP_X_REG_ADL_DMA_A_IPUI_CON2                   DIP_X_ADL_DMA_A_IPUI_CON2;                       /* 2CB0, 0x15024CB0, DIP_A_ADL_DMA_A_IPUI_CON2 */
	DIP_X_REG_ADL_DMA_A_IPUI_CON3                   DIP_X_ADL_DMA_A_IPUI_CON3;                       /* 2CB4, 0x15024CB4, DIP_A_ADL_DMA_A_IPUI_CON3 */
	UINT32                                          rsv_2CB8[18];                                    /* 2CB8..2CFF, 0x15024CB8..15024CFF */
	DIP_X_REG_ADL_DMA_A_DMA_ERR_CTRL                DIP_X_ADL_DMA_A_DMA_ERR_CTRL;                    /* 2D00, 0x15024D00, DIP_A_ADL_DMA_A_DMA_ERR_CTRL */
	DIP_X_REG_ADL_DMA_A_IPUO_ERR_STAT               DIP_X_ADL_DMA_A_IPUO_ERR_STAT;                   /* 2D04, 0x15024D04, DIP_A_ADL_DMA_A_IPUO_ERR_STAT */
	DIP_X_REG_ADL_DMA_A_IPUI_ERR_STAT               DIP_X_ADL_DMA_A_IPUI_ERR_STAT;                   /* 2D08, 0x15024D08, DIP_A_ADL_DMA_A_IPUI_ERR_STAT */
	DIP_X_REG_ADL_DMA_A_DMA_DEBUG_ADDR              DIP_X_ADL_DMA_A_DMA_DEBUG_ADDR;                  /* 2D0C, 0x15024D0C, DIP_A_ADL_DMA_A_DMA_DEBUG_ADDR */
	DIP_X_REG_ADL_DMA_A_DMA_RSV1                    DIP_X_ADL_DMA_A_DMA_RSV1;                        /* 2D10, 0x15024D10, DIP_A_ADL_DMA_A_DMA_RSV1 */
	DIP_X_REG_ADL_DMA_A_DMA_RSV2                    DIP_X_ADL_DMA_A_DMA_RSV2;                        /* 2D14, 0x15024D14, DIP_A_ADL_DMA_A_DMA_RSV2 */
	DIP_X_REG_ADL_DMA_A_DMA_RSV3                    DIP_X_ADL_DMA_A_DMA_RSV3;                        /* 2D18, 0x15024D18, DIP_A_ADL_DMA_A_DMA_RSV3 */
	DIP_X_REG_ADL_DMA_A_DMA_RSV4                    DIP_X_ADL_DMA_A_DMA_RSV4;                        /* 2D1C, 0x15024D1C, DIP_A_ADL_DMA_A_DMA_RSV4 */
	DIP_X_REG_ADL_DMA_A_DMA_RSV5                    DIP_X_ADL_DMA_A_DMA_RSV5;                        /* 2D20, 0x15024D20, DIP_A_ADL_DMA_A_DMA_RSV5 */
	DIP_X_REG_ADL_DMA_A_DMA_RSV6                    DIP_X_ADL_DMA_A_DMA_RSV6;                        /* 2D24, 0x15024D24, DIP_A_ADL_DMA_A_DMA_RSV6 */
	DIP_X_REG_ADL_DMA_A_DMA_DEBUG_SEL               DIP_X_ADL_DMA_A_DMA_DEBUG_SEL;                   /* 2D28, 0x15024D28, DIP_A_ADL_DMA_A_DMA_DEBUG_SEL */
	DIP_X_REG_ADL_DMA_A_DMA_BW_SELF_TEST            DIP_X_ADL_DMA_A_DMA_BW_SELF_TEST;                /* 2D2C, 0x15024D2C, DIP_A_ADL_DMA_A_DMA_BW_SELF_TEST */
	UINT32                                          rsv_2D30[52];                                    /* 2D30..2DFF, 0x15024D30..15024DFF */
	...
	UINT32                                          rsv_2E74[35];                                    /* 2E74..2EFF, 0x15024E74..15024EFF */
	DIP_X_REG_ADL_RESET                             DIP_X_ADL_RESET;                                 /* 2F00, 0x15024F00, DIP_A_ADL_RESET */
	DIP_X_REG_ADL_CTL                               DIP_X_ADL_CTL;                                   /* 2F04, 0x15024F04, DIP_A_ADL_CTL */
	UINT32                                          rsv_2F08[10];                                    /* 2F08..2F2F, 0x15024F08..15024F2F */
	DIP_X_REG_ADL_CROP_IN_START                     DIP_X_ADL_CROP_IN_START;                         /* 2F30, 0x15024F30, DIP_A_ADL_CROP_IN_START */
	DIP_X_REG_ADL_CROP_IN_END                       DIP_X_ADL_CROP_IN_END;                           /* 2F34, 0x15024F34, DIP_A_ADL_CROP_IN_END */
	DIP_X_REG_ADL_CROP_OUT_START                    DIP_X_ADL_CROP_OUT_START;                        /* 2F38, 0x15024F38, DIP_A_ADL_CROP_OUT_START */
	DIP_X_REG_ADL_CROP_OUT_END                      DIP_X_ADL_CROP_OUT_END;                          /* 2F3C, 0x15024F3C, DIP_A_ADL_CROP_OUT_END */
	DIP_X_REG_ADL_DMA_ST                            DIP_X_ADL_DMA_ST;                                /* 2F40, 0x15024F40, DIP_A_ADL_DMA_ST */
	DIP_X_REG_ADL_DCM_DIS                           DIP_X_ADL_DCM_DIS;                               /* 2F44, 0x15024F44, DIP_A_ADL_DCM_DIS */
	DIP_X_REG_ADL_DCM_ST                            DIP_X_ADL_DCM_ST;                                /* 2F48, 0x15024F48, DIP_A_ADL_DCM_ST */
	DIP_X_REG_ADL_DMA_ERR_ST                        DIP_X_ADL_DMA_ERR_ST;                            /* 2F4C, 0x15024F4C, DIP_A_ADL_DMA_ERR_ST */
	DIP_X_REG_ADL_DMA_0_DEBUG                       DIP_X_ADL_DMA_0_DEBUG;                           /* 2F50, 0x15024F50, DIP_A_ADL_DMA_0_DEBUG */
	DIP_X_REG_ADL_DMA_1_DEBUG                       DIP_X_ADL_DMA_1_DEBUG;                           /* 2F54, 0x15024F54, DIP_A_ADL_DMA_1_DEBUG */
	UINT32                                          rsv_2F58[6];                                     /* 2F58..2F6F, 0x15024F58..15024F6F */
	DIP_X_REG_ADL_SPARE                             DIP_X_ADL_SPARE;                                 /* 2F70, 0x15024F70, DIP_A_ADL_SPARE */
	UINT32                                          rsv_2F74[3];                                     /* 2F74..2F7F, 0x15024F74..15024F7F */
	DIP_X_REG_ADL_INFO00                            DIP_X_ADL_INFO00;                                /* 2F80, 0x15024F80, DIP_A_ADL_INFO00 */
	DIP_X_REG_ADL_INFO01                            DIP_X_ADL_INFO01;                                /* 2F84, 0x15024F84, DIP_A_ADL_INFO01 */
	DIP_X_REG_ADL_INFO02                            DIP_X_ADL_INFO02;                                /* 2F88, 0x15024F88, DIP_A_ADL_INFO02 */
	DIP_X_REG_ADL_INFO03                            DIP_X_ADL_INFO03;                                /* 2F8C, 0x15024F8C, DIP_A_ADL_INFO03 */
	DIP_X_REG_ADL_INFO04                            DIP_X_ADL_INFO04;                                /* 2F90, 0x15024F90, DIP_A_ADL_INFO04 */
	DIP_X_REG_ADL_INFO05                            DIP_X_ADL_INFO05;                                /* 2F94, 0x15024F94, DIP_A_ADL_INFO05 */
	DIP_X_REG_ADL_INFO06                            DIP_X_ADL_INFO06;                                /* 2F98, 0x15024F98, DIP_A_ADL_INFO06 */
	DIP_X_REG_ADL_INFO07                            DIP_X_ADL_INFO07;                                /* 2F9C, 0x15024F9C, DIP_A_ADL_INFO07 */
	DIP_X_REG_ADL_INFO08                            DIP_X_ADL_INFO08;                                /* 2FA0, 0x15024FA0, DIP_A_ADL_INFO08 */
	DIP_X_REG_ADL_INFO09                            DIP_X_ADL_INFO09;                                /* 2FA4, 0x15024FA4, DIP_A_ADL_INFO09 */
	DIP_X_REG_ADL_INFO10                            DIP_X_ADL_INFO10;                                /* 2FA8, 0x15024FA8, DIP_A_ADL_INFO10 */
	DIP_X_REG_ADL_INFO11                            DIP_X_ADL_INFO11;                                /* 2FAC, 0x15024FAC, DIP_A_ADL_INFO11 */
	DIP_X_REG_ADL_INFO12                            DIP_X_ADL_INFO12;                                /* 2FB0, 0x15024FB0, DIP_A_ADL_INFO12 */
	DIP_X_REG_ADL_INFO13                            DIP_X_ADL_INFO13;                                /* 2FB4, 0x15024FB4, DIP_A_ADL_INFO13 */
	DIP_X_REG_ADL_INFO14                            DIP_X_ADL_INFO14;                                /* 2FB8, 0x15024FB8, DIP_A_ADL_INFO14 */
	DIP_X_REG_ADL_INFO15                            DIP_X_ADL_INFO15;                                /* 2FBC, 0x15024FBC, DIP_A_ADL_INFO15 */
	DIP_X_REG_ADL_INFO16                            DIP_X_ADL_INFO16;                                /* 2FC0, 0x15024FC0, DIP_A_ADL_INFO16 */
	DIP_X_REG_ADL_INFO17                            DIP_X_ADL_INFO17;                                /* 2FC4, 0x15024FC4, DIP_A_ADL_INFO17 */
	DIP_X_REG_ADL_INFO18                            DIP_X_ADL_INFO18;                                /* 2FC8, 0x15024FC8, DIP_A_ADL_INFO18 */
	DIP_X_REG_ADL_INFO19                            DIP_X_ADL_INFO19;                                /* 2FCC, 0x15024FCC, DIP_A_ADL_INFO19 */
	DIP_X_REG_ADL_INFO20                            DIP_X_ADL_INFO20;                                /* 2FD0, 0x15024FD0, DIP_A_ADL_INFO20 */
	DIP_X_REG_ADL_INFO21                            DIP_X_ADL_INFO21;                                /* 2FD4, 0x15024FD4, DIP_A_ADL_INFO21 */
	DIP_X_REG_ADL_INFO22                            DIP_X_ADL_INFO22;                                /* 2FD8, 0x15024FD8, DIP_A_ADL_INFO22 */
	DIP_X_REG_ADL_INFO23                            DIP_X_ADL_INFO23;                                /* 2FDC, 0x15024FDC, DIP_A_ADL_INFO23 */
	DIP_X_REG_ADL_INFO24                            DIP_X_ADL_INFO24;                                /* 2FE0, 0x15024FE0, DIP_A_ADL_INFO24 */
	DIP_X_REG_ADL_INFO25                            DIP_X_ADL_INFO25;                                /* 2FE4, 0x15024FE4, DIP_A_ADL_INFO25 */
	DIP_X_REG_ADL_INFO26                            DIP_X_ADL_INFO26;                                /* 2FE8, 0x15024FE8, DIP_A_ADL_INFO26 */
	DIP_X_REG_ADL_INFO27                            DIP_X_ADL_INFO27;                                /* 2FEC, 0x15024FEC, DIP_A_ADL_INFO27 */
	DIP_X_REG_ADL_INFO28                            DIP_X_ADL_INFO28;                                /* 2FF0, 0x15024FF0, DIP_A_ADL_INFO28 */
	DIP_X_REG_ADL_INFO29                            DIP_X_ADL_INFO29;                                /* 2FF4, 0x15024FF4, DIP_A_ADL_INFO29 */
	DIP_X_REG_ADL_INFO30                            DIP_X_ADL_INFO30;                                /* 2FF8, 0x15024FF8, DIP_A_ADL_INFO30 */
	DIP_X_REG_ADL_INFO31                            DIP_X_ADL_INFO31;                                /* 2FFC, 0x15024FFC, DIP_A_ADL_INFO31 */
	...
	UINT32                                          rsv_3000[17];                                    /* 3004..304F, 15025004..1502504F */
}dip_x_reg_t;
