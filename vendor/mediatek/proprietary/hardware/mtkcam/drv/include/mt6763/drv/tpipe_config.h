...
typedef struct ISP_TPIPE_CONFIG_PMIX2_STRUCT
{
    int pmix2_v_flip_en;
	int pmix2_stride;
    int pmix2_ysize;
}ISP_TPIPE_CONFIG_PMIX2_STRUCT;
...
typedef struct ISP_TPIPE_CONFIG_PMIX_STRUCT
{
    int pmix_ysize;
	int pmix_stride;
}ISP_TPIPE_CONFIG_PMIX_STRUCT;

typedef struct ISP_TPIPE_CONFIG_PMOX_STRUCT
{
    int pmox_ysize;
	int pmox_stride;
}ISP_TPIPE_CONFIG_PMOX_STRUCT;

typedef struct ISP_TPIPE_CONFIG_PMIY_STRUCT
{
    int pmiy_ysize;
	int pmiy_stride;
}ISP_TPIPE_CONFIG_PMIY_STRUCT;

typedef struct ISP_TPIPE_CONFIG_PMOY_STRUCT
{
    int pmoy_ysize;
	int pmoy_stride;
}ISP_TPIPE_CONFIG_PMOY_STRUCT;

typedef struct ISP_TPIPE_CONFIG_PMOX2_STRUCT
{
    int pmox2_ysize;
	int pmox2_stride;
}ISP_TPIPE_CONFIG_PMOX2_STRUCT;
...
typedef struct ISP_TPIPE_CONFIG_STRUCT
{
    ...
    ISP_TPIPE_CONFIG_PMIX_STRUCT pmix;
    ISP_TPIPE_CONFIG_PMIY_STRUCT pmiy;
    ISP_TPIPE_CONFIG_PMOX_STRUCT pmox;
    ISP_TPIPE_CONFIG_PMOY_STRUCT pmoy;
    ISP_TPIPE_CONFIG_PMIX2_STRUCT pmix2;
    ISP_TPIPE_CONFIG_PMOX2_STRUCT pmox2;
