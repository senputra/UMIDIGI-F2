 ...
 ************************************************************************************************/
#ifndef _ISPIO_I_CAMIO_PIPE_ISP3_H_
#define _ISPIO_I_CAMIO_PIPE_ISP3_H_
...
public:
    ...
    virtual MBOOL   irq(EPipePass pass, EPipeIRQ irq_int, int userEnumss, MUINT32 const u4TimeoutMs) = 0;
    virtual MBOOL   flushIrq(EPipePass pass, EPipeIRQ irq_int, int userEnumss, MUINT32 const u4TimeoutMs) = 0;
...
#endif  //  _ISPIO_I_CAMIO_PIPE_ISP3_H_
