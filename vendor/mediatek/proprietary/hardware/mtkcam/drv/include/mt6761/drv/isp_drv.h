...
#define CAM_CTL_EN_P1_HBIN1_EN                  (1L<<25)
#define CAM_CTL_EN_P1_SGG3_EN                   (1L<<26)
#define CAM_CTL_EN_P1_SGG5_EN                   (1L<<27)
...
#define CAM_CTL_EN_P1_DMA_AFO_EN                    (1L<<8)
...
#define CAM_CTL_EN_P1_D_rsv_18                    (1L<<18)
#define CAM_CTL_EN_P1_D_AA_D_EN                   (1L<<19)
#define CAM_CTL_EN_P1_D_rsv_20                    (1L<<20)
#define CAM_CTL_EN_P1_D_rsv_21                    (1L<<21)
#define CAM_CTL_EN_P1_D_RMG_D_EN                  (1L<<22)
#define CAM_CTL_EN_P1_D_CPG_D_EN                  (1L<<23)
#define CAM_CTL_EN_P1_D_DBS_D_EN                  (1L<<24)
#define CAM_CTL_EN_P1_D_HBIN1_D_EN                (1L<<25)
#define CAM_CTL_EN_P1_D_SGG3_D_EN                 (1L<<26)
#define CAM_CTL_EN_P1_D_SGG5_D_EN                 (1L<<27)
...
#define CAM_CTL_CQ_EN_rsv_13                    (1L<<13)
#define CAM_CTL_CQ_EN_rsv_14                    (1L<<14)
#define CAM_CTL_CQ_EN_CQ0_D_EN                  (1L<<15)
#define CAM_CTL_CQ_EN_CQ_APT_2T                 (1L<<16)
...
#define CAM_CTL_INT_P1_EN_CQ0_DONE_ST_EN            (1L<<12)
...
//CAM_REG_CTL_TCM_EN reg_4084
#define CAM_CTL_TCM_SEEE_TCM_EN                     (1L<<23)
#define CAM_CTL_TCM_SL2C_TCM_EN                     (1L<<24)
#define CAM_CTL_TCM_MIX2_TCM_EN                     (1L<<25)
#define CAM_CTL_TCM_PCA_TCM_EN                      (1L<<26)
#define CAM_CTL_TCM_MIX1_TCM_EN                     (1L<<27)
#define CAM_CTL_TCM_MFBO_TCM_EN                     (1L<<28)
//CAM_REG_CTL_TDR_DBG_STATUS reg_4088
#define CAM_CTL_TDR_DBG_RMG_TCM_EN                  (1L<<26)
#define CAM_CTL_TDR_DBG_DBS_TCM_EN                  (1L<<27)
#define CAM_CTL_TDR_DBG_NSL2A_TCM_EN                (1L<<28)
#define CAM_CTL_TDR_DBG_NSL2B_TCM_EN                (1L<<29)
#define CAM_CTL_TDR_DBG_NSL2_TCM_EN                 (1L<<30)
// for control extenstion-----
...
//TH    CAM_TOP_IMGSYS  = 0, // 99   15000000~15000188
    ...
    CAM_CTL_TDR_DBG_STATUS, // 1    15004088~15004088	// for control extension
    ...
    CAM_ISP_AF,          // 18   150046B0~150046F4
    CAM_ISP_SGG3,        // 3    15004700~15004708
    CAM_ISP_SGG5,        // 3    15004710~15004718
    ...
    CAM_ISP_AE_D,        // 19   15006650~15006698
    CAM_ISP_SGG1_D,      // 3   150066A0~150066A8
    CAM_ISP_AF_D,        // 18   150066B0~150066F4
    CAM_ISP_SGG3_D,      // 3    15006700~15006708
    CAM_ISP_SGG5_D,      // 3    15006710~15006718
    ...
    CAM_DMA_AFO,         // 7    15007480~15007498
    // CAM_DMA_FEO,         // 7    15007480~15007498  // TODO: wait for P2 to modify
...
typedef enum{
    _SET_PM_QOS_INFO        = (1L<<0),
    _SET_PM_QOS_ON          = (1L<<1),
    _SET_PM_QOS_RESET       = (1L<<2),
}E_PMQOS_CMD;

typedef enum{
    _UPDATE_MMDVFS_STEP     = (1L<<0),
    _GET_MMDVFS_STEP        = (1L<<1),
}E_MMDVFS_CMD;
...
typedef enum
{
    ISP_DRV_PASS1_PATH_P1       = 0,
    ISP_DRV_PASS1_PATH_P1_D     = 1,
    ISP_DRV_PASS1_PATH_CAMSV    = 2,
    ISP_DRV_PASS1_PATH_CAMSV_D  = 3,
}ISP_DRV_PASS1_PATH_ENUM;
...
*/
typedef enum{
    _RESET_VSYNC_CNT        = (1L<<0),
    _GET_SOF_CNT            = (1L<<1),     //data size: 2 words, 1st for RAW-path, 2nd for index
    _GET_VSYNC_CNT          = (1L<<2),     //data size: 1 word.  out: current vsync counter
}E_DEVICE_INFO;
...
class IspDrv
{
	...
	virtual MBOOL   checkCQBufAllocated(void) = 0;
        ...
        virtual MBOOL   enqueP2Frame(MUINT32 callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx,MINT32 frameNum,MINT32 p2Scenario)=0;
        virtual MBOOL   waitP2Deque()=0;
        virtual MBOOL   dequeP2FrameSuccess(MUINT32 callerID,MINT32 p2dupCQIdx,MINT32 p2Scenario)=0;
        virtual MBOOL   dequeP2FrameFail(MUINT32 callerID,MINT32 p2dupCQIdx,MINT32 p2Scenario)=0;
        virtual MBOOL   waitP2Frame(MUINT32 callerID,MINT32 p2dupCQIdx,MINT32 p2Scenario,MINT32 timeoutUs)=0;
        ...
        virtual MBOOL set_pmqos(E_PMQOS_CMD eCmd,MUINT8* pData) = 0;
        virtual MBOOL mmdvfs_ctrl(E_MMDVFS_CMD eCmd,MUINT8* pData, MUINT8* pIncClk) = 0;
        virtual MBOOL getDeviceInfo(E_DEVICE_INFO eCmd, ISP_DRV_PASS1_PATH_ENUM path, MUINT8* pData) = 0;  // temp for hwsync use
        virtual MBOOL setDeviceInfo(E_DEVICE_INFO eCmd, ISP_DRV_PASS1_PATH_ENUM path, MUINT8* pData) = 0;  // temp for hwsync use
    protected:
