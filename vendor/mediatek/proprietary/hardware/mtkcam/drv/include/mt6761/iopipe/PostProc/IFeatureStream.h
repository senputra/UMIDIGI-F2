...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_POSTPROC_IFEATURESTREAM_ISP3_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_IOPIPE_POSTPROC_IFEATURESTREAM_ISP3_H_
//
...
enum EFeatureStreamTag
{
    ...
    EFeatureStreamTag_MFB_Cap_Vss  ,
    EFeatureStreamTag_MFB_Bld_Vss  ,
    EFeatureStreamTag_MFB_Mix_Vss  ,
    EFeatureStreamTag_N3D_Stream_M  ,
    EFeatureStreamTag_N3D_Stream_M2 ,
    EFeatureStreamTag_PRaw_Stream   ,
    EFeatureStreamTag_CCRaw_Stream  ,
    EFeatureStreamTag_IPRAWTPipe_Stream  ,
...
enum EFeatureModule
{
    ...
    EFeatureModule_STA_LCEI  = 0x0020,  //when use statistic dma data in lcei (only for work around)
};
...
public:     ////                    Attributes.
     ...
     *   getLastErrorCode().
     */
    using IHalPostProcPipe::enque; //avoid build warning, overloaded confirmed
    virtual MBOOL                   enque(
     ...
     */
    using IHalPostProcPipe::deque; //avoid build warning, overloaded confirmed
    virtual MBOOL                   deque(
                                        QParams& rParams,
