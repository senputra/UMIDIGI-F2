 ...
 ************************************************************************************************/
#ifndef _ISPIO_STDDEF_ISP3_H_
#define _ISPIO_STDDEF_ISP3_H_
...
enum EPIPECmd {
    ...
    EPIPECmd_GET_HBIN_INFO              = 0x1111,   //Only get HBIN2 before AA
    EPIPECmd_GET_EIS_INFO               = 0x1112,
    EPIPECmd_GET_HBIN1_INFO             = 0x1113,   //Only get HBIN1 before AF
...
public:     //// fields.
    ...
    MUINT32     pixelRate;      //  sensor mipi pixel rate
    ...
    STImgResize resize3;
    // for crop4 +++++
    STImgCrop   crop4;           // image crop info. (ring buffer use curz to run crop)
    STImgResize resize4;
    // for crop4 -----
