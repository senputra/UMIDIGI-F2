 ...
 ************************************************************************************************/
#ifndef _ISPIO_PIPE_PORTS_ISP3_H_
#define _ISPIO_PIPE_PORTS_ISP3_H_
//
#include <vector>
//
using namespace std;
...
* Pipe Port index.
********************************************************************************/
// User should use the PortMap.h instead for IP Base
/* pointer to ispio_port_index.h */
/*
enum EPortIndex
{
    EPortIndex_TG1I,        // 0
...
#endif  //  _ISPIO_PIPE_PORTS_ISP3_H_
