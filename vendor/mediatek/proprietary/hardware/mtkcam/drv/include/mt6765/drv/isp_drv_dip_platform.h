...
typedef enum {
    ...
    DIP_A_CTL_TDR3,         //0x150220e0  //special for Cervino FE
    ...
    DIP_A_IMGI_BUG_1,       // 0x15022408
    DIP_A_IMGI,             // 0x15022408~0x15022418
...
static ISP_DRV_CQ_MODULE_INFO_STRUCT mIspDipCQModuleInfo[DIP_A_MODULE_MAX]
   =  {{DIP_A_CTL_BUG_1,        0x22004, 0x0004, 1  },  //0x15022004
       ...
       {DIP_A_CTL_TDR3,		0x220e0, 0x00e0, 1  },	//0x150220e0
       ...
       {DIP_A_IMGI_BUG_1,       0x22400, 0x0400, 1  },  // 0x15022408
       {DIP_A_IMGI,             0x22400, 0x0400, 7  },  // 0x15022408 ~ 0x15022418
...
static ISP_DRV_CQ_MODULE_INFO_STRUCT mIspDipCQModuleInfo[DIP_A_MODULE_MAX]
   =  {{DIP_A_CTL,              0x22004, 0x0004, 7  },  //0x15022004 ~ 0x1502201c
       ...
       {DIP_A_VECTICAL_FLIP,    0x22210, 0x0210, 1  },  //0x15022210
       {DIP_A_SPECIAL_FUN,      0x2221c, 0x021c, 1  },  //0x1502221c
       {DIP_A_IMG2O,            0x22238, 0x0238, 5  },  // 0x15022238 ~ 0x15022248
       {DIP_A_IMG2O_CRSP,       0x22258, 0x0258, 1  },  //0x15022258
       {DIP_A_IMG2BO,           0x22268, 0x0268, 5  },  // 0x15022268 ~ 0x15022278
       {DIP_A_IMG2BO_CRSP,      0x22288, 0x0288, 1  },  //0x15022288
       {DIP_A_IMG3O,            0x22298, 0x0298, 5  },  // 0x15022298 ~ 0x150222a8
       {DIP_A_IMG3O_CRSP,       0x222b8, 0x02b8, 1  },  //0x150222b8
       {DIP_A_IMG3BO,           0x222c8, 0x02c8, 5  },  // 0x150222c8 ~ 0x150222d8
       {DIP_A_IMG3BO_CRSP,      0x222e8, 0x02e8, 1  },  //0x150222e8
       {DIP_A_IMG3CO,           0x222f8, 0x02f8, 5  },  // 0x150222f8 ~ 0x15022308
       {DIP_A_IMG3CO_CRSP,      0x22318, 0x0318, 1  },  //0x15022318
       {DIP_A_FEO,              0x22328, 0x0328, 5  },  // 0x15022328 ~ 0x15022338
       {DIP_A_MFBO,             0x22358, 0x0358, 5  },  // 0x15022358 ~ 0x15022368
       {DIP_A_MFBO_CROP,        0x22378, 0x0378, 1  },  //0x15022378
       {DIP_A_IMGI,             0x22408, 0x0408, 5  },  // 0x15022408 ~ 0x15022418
       {DIP_A_IMGBI,            0x22438, 0x0438, 5  },  // 0x15022438 ~ 0x15022448
       {DIP_A_IMGCI,            0x22468, 0x0468, 5  },  // 0x15022468 ~ 0x15022478
       {DIP_A_VIPI,             0x22498, 0x0498, 5  },  // 0x15022498 ~ 0x150224a8
       {DIP_A_VIP2I,            0x224c8, 0x04c8, 5  },  // 0x150224c8 ~ 0x150224d8
       {DIP_A_VIP3I,            0x224f8, 0x04f8, 5  },  // 0x150224f8 ~ 0x15022508
       {DIP_A_DMGI,             0x22528, 0x0528, 5  },  // 0x15022528 ~ 0x15022538
       {DIP_A_DEPI,             0x22558, 0x0558, 5  },  // 0x15022558 ~ 0x15022568
       {DIP_A_LCEI,             0x22588, 0x0588, 5  },  // 0x15022588 ~ 0x15022598
       {DIP_A_UFDI,             0x225b8, 0x05b8, 5  },  // 0x150225b8 ~ 0x150225c8
       {DIP_A_UFD,              0x22700, 0x0700, 5  },  //0x15022700 ~ 0x15022710
       {DIP_A_PGN,              0x22720, 0x0720, 6  },  //0x15022720 ~ 0x15022734
       {DIP_A_SL2,              0x22740, 0x0740, 12 },  //0x15022740 ~ 0x1502276c
       {DIP_A_UDM,              0x22780, 0x0780, 19 },  //0x15022780 ~ 0x150227c8
...
#define DIP_X_REG_CTL_TDR_ADL_TCM_EN               (1L<<30)
#define DIP_X_REG_CTL_TDR_FLC_TCM_EN               (1L<<31)

//DIP_X_REG_CTL_TDR_TCM3_EN,  0x150220E0
#define DIP_X_REG_CTL_TDR_FE_TCM_EN                (1L<<0)

///////////////////////////////////////////////////////////
/**
dip initial setting
*/
#define ISP_DIP_INIT_SETTING_COUNT  94 // 82
static ISP_DRV_REG_IO_STRUCT mIspDipInitReg[ISP_DIP_INIT_SETTING_COUNT]
    =  {{DIP_A, 0x0020, 0x00000000},   // DIP_X_REG_CTL_INT_EN
        {DIP_A, 0x0024, 0x00000000},   // DIP_X_REG_CTL_CQ_INT_EN
        {DIP_A, 0x0028, 0x00000000},   // DIP_X_REG_CTL_CQ_INT2_EN
        {DIP_A, 0x002C, 0x00000000},   // DIP_X_REG_CTL_CQ_INT3_EN
        {DIP_A, 0x0090, 0x00000001},   // DIP_X_REG_CTL_YUV_DCM_DIS
...
#define DIP_REG_RANGE           (0x5000) //PAGE_SIZE*5 = 4096*5, dependent on device tree setting 
