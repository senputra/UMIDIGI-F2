 ...
 ************************************************************************************************/
#ifndef _ISP_DRV_ISP3_H_
#define _ISP_DRV_ISP3_H_
...
#define CAM_CTL_INT_P1_STATUS2_CQ0_DONE_ST               (1L<<12)
#define CAM_CTL_INT_P1_STATUS2_CQ0B_DONE_ST              (1L<<13)
#define CAM_CTL_INT_P1_STATUS2_CQ0C_DONE_ST              (1L<<14)
...
#define CAM_CTL_INT_P1_STATUS2_D_CQ0_DONE_ST               (1L<<12)
#define CAM_CTL_INT_P1_STATUS2_D_CQ0B_DONE_ST              (1L<<13)
#define CAM_CTL_INT_P1_STATUS2_D_CQ0C_DONE_ST              (1L<<14)
...
#define CAM_CTL_INT_P2_STATUS_IMG3BO_DONE_ST            (1L<<23)
#define CAM_CTL_INT_P2_STATUS_IMG3O_DONE_ST             (1L<<24)
#define CAM_CTL_INT_P2_STATUS_IMG3CO_DONE_ST            (1L<<25)
#define CAM_CTL_INT_P2_STATUS_FEO_DONE_ST               (1L<<26)
#define CAM_CTL_INT_P2_STATUS_DMA_ERR_ST                (1L<<27)
#define CAM_CTL_INT_P2_STATUS_GGM_COLLISION_ST          (1L<<28)
#define CAM_CTL_INT_P2_STATUS_PCA_COLLISION_ST          (1L<<29)
...
#define CAM_CTL_INT_STATUS3X_DMA_ERR_ST                (1L<<27)
#define CAM_CTL_INT_STATUS3X_GGM_COLLISION_ST          (1L<<28)
#define CAM_CTL_INT_STATUS3X_PCA_COLLISION_ST          (1L<<29)
...
#define CAM_CTL_EN_P1_HBIN2_EN                  (1L<<18)
...
#define CAM_CTL_EN_P1_RLB_EN                    (1L<<25)
#define CAM_CTL_EN_P1_HBIN1_EN                  (1L<<26)
#define CAM_CTL_EN_P1_SGG3_EN                   (1L<<27)
#define CAM_CTL_EN_P1_SGG5_EN                   (1L<<28)
...
#define CAM_CTL_EN_P1_D_DMX_D_EN                  (1L<<1)
...
#define CAM_CTL_EN_P1_D_RMX_D_EN                  (1L<<9)
#define CAM_CTL_EN_P1_D_PAKG_D_EN                 (1L<<10)
#define CAM_CTL_EN_P1_D_BMX_D_EN                  (1L<<11)
...
#define CAM_CTL_EN_P2_UFD_EN                    (1UL<<0)
#define CAM_CTL_EN_P2_PGN_EN                    (1UL<<1)
#define CAM_CTL_EN_P2_SL2_EN                    (1UL<<2)
#define CAM_CTL_EN_P2_CFA_EN                    (1UL<<3)
#define CAM_CTL_EN_P2_CCL_EN                    (1UL<<4)
#define CAM_CTL_EN_P2_G2G_EN                    (1UL<<5)
#define CAM_CTL_EN_P2_GGM_EN                    (1UL<<6)
#define CAM_CTL_EN_P2_MFB_EN                    (1UL<<7)
#define CAM_CTL_EN_P2_C24_EN                    (1UL<<8)
#define CAM_CTL_EN_P2_G2C_EN                    (1UL<<9)
#define CAM_CTL_EN_P2_C42_EN                    (1UL<<10)
#define CAM_CTL_EN_P2_NBC_EN                    (1UL<<11)
#define CAM_CTL_EN_P2_PCA_EN                    (1UL<<12)
#define CAM_CTL_EN_P2_SEEE_EN                   (1UL<<13)
#define CAM_CTL_EN_P2_LCE_EN                    (1UL<<14)
#define CAM_CTL_EN_P2_NR3D_EN                   (1UL<<15)
#define CAM_CTL_EN_P2_C02_EN                    (1UL<<16)
#define CAM_CTL_EN_P2_SL2C_EN                   (1UL<<17)
#define CAM_CTL_EN_P2_SRZ1_EN                   (1UL<<18)
#define CAM_CTL_EN_P2_SRZ2_EN                   (1UL<<19)
#define CAM_CTL_EN_P2_CRZ_EN                    (1UL<<20)
#define CAM_CTL_EN_P2_MIX1_EN                   (1UL<<21)
#define CAM_CTL_EN_P2_MIX2_EN                   (1UL<<22)
#define CAM_CTL_EN_P2_MIX3_EN                   (1UL<<23)
#define CAM_CTL_EN_P2_MIR1_EN                   (1UL<<24)
#define CAM_CTL_EN_P2_MIR2_EN                   (1UL<<25)
#define CAM_CTL_EN_P2_CRSP_EN                   (1UL<<26)
#define CAM_CTL_EN_P2_C24B_EN                   (1UL<<27)
#define CAM_CTL_EN_P2_MDPCROP_EN                (1UL<<28)
#define CAM_CTL_EN_P2_FE_EN                     (1UL<<29)
#define CAM_CTL_EN_P2_UNP_EN                    (1UL<<30)
#define CAM_CTL_EN_P2_NSL2A_EN                  (1UL<<31)
...
#define CAM_CTL_CQ_EN_CQ_APB_2T                 (1L<<16)
...
#define CAM_CTL_SEL_P1_SGG_SEL                  (1L<<1)
#define CAM_CTL_SEL_P1_SGG_SEL_EN               (1L<<3)
#define CAM_CTL_SEL_P1_LCS_SEL                  (1L<<4)
#define CAM_CTL_SEL_P1_LCS_SEL_EN               (1L<<5)
#define CAM_CTL_SEL_P1_IMG_SEL                  (1L<<6)
#define CAM_CTL_SEL_P1_UFE_SEL                  (1L<<8)
#define CAM_CTL_SEL_P1_UFE_SEL2                 (1L<<9)
#define CAM_CTL_SEL_P1_EIS_SEL                  (1L<<10)
#define CAM_CTL_SEL_P1_W2G_SEL                  (1L<<12)
//enable CAM_CTL_SEL_P1_D   reg_4038
#define CAM_CTL_SEL_P1_D_SGG_SEL_D              (1L<<1)
#define CAM_CTL_SEL_P1_D_SGG_SEL_EN_D           (1L<<3)
#define CAM_CTL_SEL_P1_D_LCS_SEL_D              (1L<<4)
#define CAM_CTL_SEL_P1_D_LCS_SEL_EN_D           (1L<<5)
#define CAM_CTL_SEL_P1_D_IMG_SEL_D              (1L<<6)
#define CAM_CTL_SEL_P1_D_UFE_SEL_D              (1L<<8)
#define CAM_CTL_SEL_P1_D_UFE_SEL2_D             (1L<<9)
#define CAM_CTL_SEL_P1_D_EIS_SEL_D              (1L<<10)
#define CAM_CTL_SEL_P1_D_W2G_SEL_D              (1L<<12)
...
//reg_9000
#define CAMSV_MODULE_TG_EN                    (1L<<0)
#define CAMSV_MODULE_PAK_EN                   (1L<<2)
#define CAMSV_MODULE_PAK_SEL                  (1L<<3)
#define CAMSV_MODULE_IMGO_EN                  (1L<<4)
#define CAMSV_MODULE_DB_EN                    (1L<<30)
#define CAMSV_MODULE_DB_LOCK                  (1L<<31)
//reg_9008
#define CAMSV_INT_EN_VS1_INT_EN                (1L<<0)
#define CAMSV_INT_EN_TG_INT1_EN                (1L<<1)
#define CAMSV_INT_EN_TG_INT2_EN                (1L<<2)
#define CAMSV_INT_EN_EXPDON1_INT_EN            (1L<<3)
#define CAMSV_INT_EN_TG_ERR_INT_EN             (1L<<4)
#define CAMSV_INT_EN_TG_GBERR_INT_EN           (1L<<5)
#define CAMSV_INT_EN_TG_DROP_INT_EN            (1L<<6)
#define CAMSV_INT_EN_TG_SOF_INT_EN             (1L<<7)
#define CAMSV_INT_EN_PASS1_DON_INT_EN          (1L<<10)
#define CAMSV_INT_EN_IMGO_ERR_INT_EN           (1L<<16)
#define CAMSV_INT_EN_IMGO_OVERR_INT_EN         (1L<<17)
#define CAMSV_INT_EN_IMGO_DROP_INT_EN          (1L<<19)
#define CAMSV_INT_EN_INT_WCLR_EN               (1L<<31)
//reg_900c
#define CAMSV_INT_STATUS_VS1_ST               (1L<<0)
#define CAMSV_INT_STATUS_TG_ST1               (1L<<1)
#define CAMSV_INT_STATUS_TG_ST2               (1L<<2)
...
#define CAMSV_INT_STATUS_TG_ERR_ST            (1L<<4)
#define CAMSV_INT_STATUS_TG_GBERR_ST          (1L<<5)
#define CAMSV_INT_STATUS_TG_DROP_INT_ST       (1L<<6)
#define CAMSV_INT_STATUS_TG_SOF1_INT_ST       (1L<<7)
#define CAMSV_INT_STATUS_PASS1_DON_ST         (1L<<10)
#define CAMSV_INT_STATUS_IMGO_ERR_ST          (1L<<16)
#define CAMSV_INT_STATUS_IMGO_OVERR_ST        (1L<<17)
#define CAMSV_INT_STATUS_IMGO_DROP_ST         (1L<<19)
...
//reg_9800
#define CAMSV2_MODULE_TG_EN                    (1L<<0)
#define CAMSV2_MODULE_PAK_EN                   (1L<<2)
#define CAMSV2_MODULE_PAK_SEL                  (1L<<3)
#define CAMSV2_MODULE_IMGO_EN                  (1L<<4)
#define CAMSV2_MODULE_DB_EN                    (1L<<30)
#define CAMSV2_MODULE_DB_LOCK                  (1L<<31)
//reg_9808
#define CAMSV2_INT_EN_VS1_INT_EN               (1L<<0)
#define CAMSV2_INT_EN_TG_INT1_EN               (1L<<1)
#define CAMSV2_INT_EN_TG_INT2_EN               (1L<<2)
#define CAMSV2_INT_EN_EXPDON1_INT_EN           (1L<<3)
#define CAMSV2_INT_EN_TG_ERR_INT_EN            (1L<<4)
#define CAMSV2_INT_EN_TG_GBERR_INT_EN          (1L<<5)
#define CAMSV2_INT_EN_TG_DROP_INT_EN           (1L<<6)
#define CAMSV2_INT_EN_TG_SOF_INT_EN            (1L<<7)
#define CAMSV2_INT_EN_PASS1_DON_INT_EN         (1L<<10)
#define CAMSV2_INT_EN_IMGO_ERR_INT_EN          (1L<<16)
#define CAMSV2_INT_EN_IMGO_OVERR_INT_EN        (1L<<17)
#define CAMSV2_INT_EN_IMGO_DROP_INT_EN         (1L<<19)
#define CAMSV2_INT_EN_INT_WCLR_EN              (1L<<31)
//reg_980c
#define CAMSV2_INT_STATUS_VS1_ST               (1L<<0)
#define CAMSV2_INT_STATUS_TG_ST1               (1L<<1)
#define CAMSV2_INT_STATUS_TG_ST2               (1L<<2)
...
#define CAMSV2_INT_STATUS_TG_ERR_ST            (1L<<4)
#define CAMSV2_INT_STATUS_TG_GBERR_ST          (1L<<5)
#define CAMSV2_INT_STATUS_TG_DROP_INT_ST       (1L<<6)
#define CAMSV2_INT_STATUS_TG_SOF1_INT_ST       (1L<<7)
#define CAMSV2_INT_STATUS_PASS1_DON_ST         (1L<<10)
#define CAMSV2_INT_STATUS_IMGO_ERR_ST          (1L<<16)
#define CAMSV2_INT_STATUS_IMGO_OVERR_ST        (1L<<17)
#define CAMSV2_INT_STATUS_IMGO_DROP_ST         (1L<<19)
...
//
typedef enum {
//TH    CAM_TOP_IMGSYS  = 0,// 65   15000000~15000104
    ...
    CAM_ISP_SGG5,        // 3    15004590~15004598
    CAM_ISP_AWB,         // 36   150045B0~1500463C
    CAM_ISP_AE,          // 19   15004650~15004698
    CAM_ISP_SGG1,        // 3    150046A0~150046A8
    CAM_ISP_AF,          // 16   150046B0~150046F0
    ...
    CAM_ISP_RRZ,         // 12    150047A0~150047CC
    CAM_ISP_BNR,         // 32    15004800~1500487C
    ...
    CAM_ISP_DBS,         // 13   15004C00~15004C30
    ...
    CAM_ISP_NSL2A,        // 10  15004F60~15004F84
...
#endif
    CAM_ISP_RRZ_D,       // 12   150067A0~150067CC
    CAM_ISP_BNR_D,       // 32   15006800~1500687C
    CAM_ISP_DBS_D,       // 13   15006C00~15006C30
...
#endif
    CAM_DMA_IMGI_CON3,   // 1    15007500~15007500
    CAM_DMA_BPCI_CON3,   // 1    15007504~15007504
    CAM_DMA_LSCI_CON3,   // 1    15007508~15007508
    CAM_DMA_IMGO_CON3,   // 1    1500750C~1500750C
    CAM_DMA_RRZO_CON3,   // 1    15007510~15007510
    CAM_DMA_ESFKO_CON3,  // 1    15007514~15007514
    CAM_DMA_AAO_CON3,    // 1    15007518~15007518
    CAM_DMA_IMG2O_CON3,  // 1    1500751C~1500751C
    CAM_DMA_BPCI_D_CON3, // 1    15007520~15007520
    CAM_DMA_LSCI_D_CON3, // 1    15007524~15007524
    CAM_DMA_AFO_D,       // 8    15007528~15007548
#if 0
...
typedef struct ISP_DRV_WAIT_IRQ_STRUCT
{
    ...
    :Clear(ISP_DRV_IRQ_CLEAR_NONE),Type(ISP_DRV_IRQ_TYPE_INT_P1_ST),Status(0x0),UserNumber(-1),Timeout(1000),UserName((char *)""),irq_TStamp(0x0),bDumpReg(0xfe),SpecUser(ISP_DRV_WAITIRQ_SPEUSER_NONE)
    {}
...
typedef struct IISP_DRV_USERKEY_STRUCT
{
    ...
    :userKey(-1),userName((const char *)"DefaultUserNametoAllocMem")
    {}
    int  userKey;
    const char* userName;
}IISP_DRV_USERKEY_STRUCT;
...
class IspDrv
{
    ...
    virtual MBOOL   checkCQBufAllocated(void) = 0;
        ...
        virtual MBOOL   enqueP2Frame(unsigned long callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx,MINT32 frameNum,MINT32 p2Scenario)=0;
        virtual MBOOL   waitP2Deque()=0;
        virtual MBOOL   dequeP2FrameSuccess(unsigned long callerID,MINT32 p2dupCQIdx,MINT32 p2Scenario)=0;
        virtual MBOOL   dequeP2FrameFail(unsigned long callerID,MINT32 p2dupCQIdx,MINT32 p2Scenario)=0;
        virtual MBOOL   waitP2Frame(unsigned long callerID,MINT32 p2dupCQIdx,MINT32 p2Scenario,MINT32 timeoutUs)=0;
        virtual MBOOL   wakeP2WaitedFrames()=0;
        virtual MBOOL   freeAllP2Frames()=0;
        //update magic number
        virtual MBOOL   updateMagicNumber(MUINT32* value)=0;
        //
