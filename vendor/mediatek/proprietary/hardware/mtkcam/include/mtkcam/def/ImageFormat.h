...
enum EImageFormat
{
    ...
    eImgFmt_YUV_P012,                                                           /*!< 420 format, 16bit, 2 plane (Y),(UV) = P012 */
    eImgFmt_YVU_P012,                                                           /*!< 420 format, 16bit, 2 plane (Y),(VU)        */

    eImgFmt_MTK_YUV_P012,                                                       /*!< 420 format, 12bit, 2 plane (Y),(UV) = P012 */
    eImgFmt_MTK_YVU_P012,                                                       /*!< 420 format, 12 bit, 2 plane (Y),(VU)       */
    ...
    eImgFmt_BAYER16_UNPAK,                                                      /*!< Bayer format,unpaked 16-bit */
    eImgFmt_BAYER22_PAK,                                                        /*!< Bayer format, 22-bit valid in 24-bit plane */
    ...
    eImgFmt_ISP_TUING,                                                          /*!< For ISP private data */
