 ...
 */
PIPELINE_TABLE_BEGIN(BackgroundServiceData, PP, BG_SRV_FULL)
    // ==================================================================
    ...
    IMAGE_BEGIN(BGImgStreamTbl)
        ...
        IMAGE_STREAM_ADD("Hal:Image:TP_YUV_JPEG",   eSTREAMID_IMAGE_PIPE_YUV_JPEG,      INOUT, 0, 0, CAM_SW_READWRITE_HW_READWRITE, eImgFmt_YV12, MSize(1, 1), 0, 0, HAL_PROVIDER)
        ...
        IMAGE_STREAM_ADD("Hal:Image:TP_YUV_JPEG0",  eSTREAMID_IMAGE_PIPE_TP_OUT00,      INOUT, 0, 0, CAM_SW_READWRITE_HW_READWRITE, eImgFmt_YV12, MSize(1, 1), 0, 0, HAL_PROVIDER)
        IMAGE_STREAM_ADD("Hal:Image:TP_Y_Depth",    eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_DEPTHMAPYUV, OUT, 0, 0, CAM_SW_READWRITE_HW_READWRITE, eImgFmt_Y8, MSize(1, 1), 0, 0, HAL_PROVIDER)
