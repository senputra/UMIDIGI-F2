...
public:     ////    Instantiation.
     ...
     * @param[in] iSensorIdx: sensor idx, used in bypass ISP for 10bits flow
     *
     * @return
     * -   The instance of the ISImager
     *
     */
    static ISImager* createInstance(IImageBuffer const * pImageBuffer, MINT32 iSensorIdx = -1);
...
public:     ////
     ...
     *
     */
    virtual MBOOL    execute(struct timeval *endTime = NULL, MUINT32 const u4TimeoutMs = 0xFFFFFFFF) = 0;
