...
// V1 will phaseout after metadata V2 MP.
...
#define META_LOGE(fmt, arg...)              CAM_ULOGE(META_LOG_MODULE_ID, "%s(%d):" fmt,__FUNCTION__,__LINE__, ##arg)
#define META_LOGW(fmt, arg...)              CAM_ULOGW(META_LOG_MODULE_ID, "%s(%d):" fmt,__FUNCTION__,__LINE__, ##arg)
#define META_LOGI(fmt, arg...)              CAM_ULOGI(META_LOG_MODULE_ID, "%s(%d):" fmt,__FUNCTION__,__LINE__, ##arg)
#define META_LOGD(fmt, arg...)              CAM_ULOGD(META_LOG_MODULE_ID, "%s(%d):" fmt,__FUNCTION__,__LINE__, ##arg)
#define META_LOGV(fmt, arg...)              CAM_ULOGV(META_LOG_MODULE_ID, "%s(%d):" fmt,__FUNCTION__,__LINE__, ##arg)
#define META_ASSERTV(cond, fmt, arg...)     CAM_ULOG_ASSERT(META_LOG_MODULE_ID, cond,"%s(%d):" fmt,__FUNCTION__,__LINE__, ##arg)
#define META_ASSERT(cond, fmt, arg...)      CAM_ULOG_ASSERT(META_LOG_MODULE_ID, cond,"%s(%d):" fmt,__FUNCTION__,__LINE__, ##arg)
#define META_FATAL(fmt, arg...)             CAM_ULOG_FATAL(META_LOG_MODULE_ID, "%s(%d):" fmt,__FUNCTION__,__LINE__, ##arg)
...
#define META_LOGV_IF(cond, ...)             do { if ( (cond) ) { META_LOGV(__VA_ARGS__); } }while(0)
#define META_LOGD_IF(cond, ...)             do { if ( (cond) ) { META_LOGD(__VA_ARGS__); } }while(0)
#define META_LOGI_IF(cond, ...)             do { if ( (cond) ) { META_LOGI(__VA_ARGS__); } }while(0)
#define META_LOGW_IF(cond, ...)             do { if ( (cond) ) { META_LOGW(__VA_ARGS__); } }while(0)
#define META_LOGE_IF(cond, ...)             do { if ( (cond) ) { META_LOGE(__VA_ARGS__); } }while(0)
#define META_LOGE_CALLSTACK_IF(cond, ...)   do { if ( (cond) ) { META_LOGE_CALLSTACK(__VA_ARGS__); } }while(0)
...
#define META_LOGV_CALLSTACK(fmt,arg...)
#define META_LOGE_CALLSTACK(fmt,arg...)     CAM_ULOGE(META_LOG_MODULE_ID, "%s(%d):" fmt,__FUNCTION__,__LINE__, ##arg)
 ...
 ******************************************************************************/
#include "IMetadataV2.h"


#else // V1 will remove after V2 MP
/******************************************************************************
 * Metadata V1 header files
 ******************************************************************************/
