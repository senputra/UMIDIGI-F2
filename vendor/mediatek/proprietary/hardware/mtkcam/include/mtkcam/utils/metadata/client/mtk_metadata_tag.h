...
typedef enum mtk_camera_metadata_section_start {
    ...
    MTK_HEIC_START                  = MTK_HEIC                  << 16,
    MTK_HEIC_INFO_START             = MTK_HEIC_INFO             << 16,
    ...
    MTK_CONTROL_CAPTURE_START                   = (MTK_CONTROL_CAPTURE + MTK_VENDOR_TAG_SECTION) << 16,
...
typedef enum mtk_camera_metadata_tag {
    ...
    MTK_LENS_FACING,
    MTK_SENSOR_INFO_FACING              = MTK_LENS_FACING,
    ...
    MTK_REQUEST_AVAILABLE_SESSION_KEYS,           // int32[]      | ndk_public   | HIDL v3.3
    MTK_REQUEST_AVAILABLE_PHYSICAL_CAMERA_REQUEST_KEYS,
                                                  // int32[]      | hidden       | HIDL v3.3
    MTK_REQUEST_CHARACTERISTIC_KEYS_NEEDING_PERMISSION,
    ...
    MTK_SCALER_AVAILABLE_RECOMMENDED_INPUT_OUTPUT_FORMATS_MAP,
                                                  // int32        | ndk_public   | HIDL v3.4
    MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_WITH_DURATIONS,  // int64[]      | mtk extension
    MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_WITH_DURATIONS_CANDIDATES,  // int64[]      | mtk extension
    MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_CANDIDATES,
    MTK_SCALER_END,
    ...
    MTK_STATISTICS_OIS_DATA_MODE,
    MTK_STATISTICS_OIS_TIMESTAMPS,
    MTK_STATISTICS_OIS_X_SHIFTS,
    MTK_STATISTICS_OIS_Y_SHIFTS,
    ...
    MTK_STATISTICS_INFO_AVAILABLE_OIS_DATA_MODES,
    ...
    MTK_DEPTH_AVAILABLE_RECOMMENDED_DEPTH_STREAM_CONFIGURATIONS,
    MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STREAM_CONFIGURATIONS,
    MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_MIN_FRAME_DURATIONS,
    MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STALL_DURATIONS,
    MTK_DEPTH_END,
    ...
    MTK_LOGICAL_MULTI_CAMERA_END,

    MTK_DISTORTION_CORRECTION_MODE =              // enum         | public       | HIDL v3.3
            MTK_DISTORTION_CORRECTION_START,
    MTK_DISTORTION_CORRECTION_AVAILABLE_MODES,    // byte[]       | public       | HIDL v3.3
    MTK_DISTORTION_CORRECTION_END,

    MTK_HEIC_AVAILABLE_HEIC_STREAM_CONFIGURATIONS =
                                                  // enum[]       | ndk_public   | HIDL v3.4
            MTK_HEIC_START,
    MTK_HEIC_AVAILABLE_HEIC_MIN_FRAME_DURATIONS,  // int64[]      | ndk_public   | HIDL v3.4
    MTK_HEIC_AVAILABLE_HEIC_STALL_DURATIONS,      // int64[]      | ndk_public   | HIDL v3.4
    MTK_HEIC_END,

    MTK_HEIC_INFO_SUPPORTED =                 // enum         | system       | HIDL v3.4
            MTK_HEIC_INFO_START,
    MTK_HEIC_INFO_MAX_JPEG_APP_SEGMENTS_COUNT,// byte         | system       | HIDL v3.4
    MTK_HEIC_INFO_END,
    ...
    MTK_HDR_FEATURE_HDR_HAL_MODE,           // hal metadata, middleware use, for version control
    MTK_HDR_FEATURE_HDR_DETECTION_RESULT,   // Dynamic Meta, reply hdr detector result
    MTK_HDR_FEATURE_AVAILABLE_HDR_MODES_PHOTO,  // Static Meta, for App query use, runtime decided in MetadataProvider
    MTK_HDR_FEATURE_AVAILABLE_HDR_MODES_VIDEO,  // Static Meta, for App query use, runtime decided in MetadataProvider
    MTK_HDR_FEATURE_AVAILABLE_VHDR_MODES,  // Static Meta, for middleware query use
    MTK_HDR_FEATURE_AVAILABLE_MSTREAM_HDR_MODES,// Static Meta, for App query use
    MTK_HDR_FEATURE_AVAILABLE_SINGLE_FRAME_HDR,  // Static Meta, for middleware query use
    MTK_HDR_FEATURE_END,
    ...
    MTK_EIS_FEATURE_NEW_SHUTTER_TIMESTAMP,  // Dynamic Meta, middleware use, override timestamp for record
    MTK_EIS_FEATURE_PREVIEW_EIS,
    MTK_EIS_FEATURE_END,

    MTK_STREAMING_FEATURE_RECORD_STATE = MTK_STREAMING_FEATURE_START, // Control Meta, app use, tell recording or stopping
    MTK_STREAMING_FEATURE_AVAILABLE_RECORD_STATES,  // Static Meta, for app query use
    MTK_STREAMING_FEATURE_HFPS_MODE,
    MTK_STREAMING_FEATURE_AVAILABLE_HFPS_MODES,  // Static Meta, for app query use
    MTK_STREAMING_FEATURE_AVAILABLE_HFPS_MAX_RESOLUTIONS, // Static Meta, for app query use [maxW, maxH, fps]
    ...
    MTK_MFNR_FEATURE_BSS_GOLDEN_INDEX,
    ...
    MTK_3A_FEATURE_AE_SENSOR_GAIN_VALUE,
    MTK_3A_FEATURE_AE_ISP_GAIN_VALUE,
    MTK_3A_FEATURE_AE_LUX_INDEX_VALUE,
    MTK_3A_FEATURE_ADRC_GAIN_VALUE,
    ...
    MTK_VSDOF_FEATURE_AVAILABLE_PREVIEW_MODE, // for app static metadata use, and it will set in metadata provider.
    MTK_VSDOF_FEATURE_WARNING, // [vendor tag] for vsdof feature warning message
    MTK_VSDOF_FEATURE_CAPTURE_WARNING_MSG, // [vendor tag] for vsdof capture request in takePicture.
    MTK_VSDOF_FEATURE_END,

    MTK_MULTI_CAM_FEATURE_MODE = MTK_MULTI_CAM_FEATURE_START,
    MTK_MULTI_CAM_FEATURE_AVAILABLE_MODE, // for app static metadata use, and it will set in metadata provider.
    MTK_MULTI_CAM_FEATURE_SENSOR_MANUAL_UPDATED,
    MTK_MULTI_CAM_ZOOM_RANGE,
    MTK_MULTI_CAM_ZOOM_VALUE,
    MTK_MULTI_CAM_ZOOM_STEPS,
    MTK_MULTI_CAM_AF_ROI,
    MTK_MULTI_CAM_MASTER_ID,
    MTK_MULTI_CAM_FOV_CROP_REGION,
    MTK_MULTI_CAM_SENSOR_CROP_REGION,
    MTK_MULTI_CAM_STREAMING_ID,
    ...
    MTK_CONTROL_CAPTURE_AVAILABLE_ZSL_MODES,    // zsl
    MTK_CONTROL_CAPTURE_DEFAULT_ZSL_MODE,
    MTK_CONTROL_CAPTURE_ZSL_MODE,
    MTK_CONTROL_CAPTURE_SINGLE_YUV_NR, // To enable or disable P2C output high quality yuv
    MTK_CONTROL_CAPTURE_HIGH_QUALITY_YUV, // To enable or disable single YUV NR
    MTK_CONTROL_CAPTURE_HINT_FOR_RAW_REPROCESS,
    ...
    MTK_CONTROL_CAPTURE_ISP_TUNING_DATA_SIZE_FOR_RAW,
    MTK_CONTROL_CAPTURE_ISP_TUNING_DATA_SIZE_FOR_YUV,
    MTK_CONTROL_CAPTURE_ISP_TUNING_REQUEST,
    MTK_CONTROL_CAPTURE_ISP_TUNING_DATA_RAW,
    MTK_CONTROL_CAPTURE_ISP_TUNING_DATA_YUV,
    MTK_CONTROL_CAPTURE_PACKED_RAW_SUPPORT,
    MTK_CONTROL_CAPTURE_PACKED_RAW_ENABLE,
    MTK_CONTROL_CAPTURE_PROCESS_RAW_ENABLE,
    MTK_CONTROL_CAPTURE_RAW_BPP,
    MTK_CONTROL_CAPTURE_YUV_NO_MARGIN,
    MTK_CONTROL_CAPTURE_END,

    MTK_BGSERVICE_FEATURE_PRERELEASE_AVAILABLE_MODES = MTK_BGSERVICE_FEATURE_START,
    MTK_BGSERVICE_FEATURE_PRERELEASE,
    MTK_BGSERVICE_FEATURE_IMAGEREADERID,
    MTK_BGSERVICE_FEATURE_END,

    MTK_CONFIGURE_SETTING_INIT_REQUEST               = MTK_CONFIGURE_SETTING_START,
    MTK_CONFIGURE_ISP_YUV_DIRECT_JPEG,
    MTK_CONFIGURE_SETTING_PROPRIETARY,
    MTK_CONFIGURE_SETTING_END,

    MTK_FLASH_FEATURE_CALIBRATION_AVAILABLE = MTK_FLASH_FEATURE_START,    // flash calibration available
    MTK_FLASH_FEATURE_CALIBRATION_ENABLE,    // flash calibration enable
    MTK_FLASH_FEATURE_CALIBRATION_RESULT,    // flash calibration result
    MTK_FLASH_FEATURE_CUSTOMIZATION_AVAILABLE,
    MTK_FLASH_FEATURE_CUSTOMIZED_RESULT,
    MTK_FLASH_FEATURE_CUSTOMIZED_TORCH_DUTY,
    MTK_FLASH_FEATURE_END,

    MTK_SMVR_FEATURE_SMVR_MODE                       = MTK_SMVR_FEATURE_START,
    MTK_SMVR_FEATURE_AVAILABLE_SMVR_MODES,
    MTK_SMVR_FEATURE_SMVR_RESULT,
    MTK_SMVR_FEATURE_END,

    MTK_ABF_FEATURE_ABF_MODE           = MTK_ABF_FEATURE_START,
...
// MTK_CONTROL_AF_SCENE_CHANGE
typedef enum mtk_camera_metadata_enum_android_control_af_scene_change {
    MTK_CONTROL_AF_SCENE_CHANGE_NOT_DETECTED,
    MTK_CONTROL_AF_SCENE_CHANGE_DETECTED,
} mtk_camera_metadata_enum_android_control_af_scene_change_t;
...
typedef enum mtk_camera_metadata_enum_android_flash_feature_customized_torch_duty {
    MTK_FLASH_FEATURE_CUSTOMIZED_TORCH_DUTY_LOW,
    MTK_FLASH_FEATURE_CUSTOMIZED_TORCH_DUTY_MID,
    MTK_FLASH_FEATURE_CUSTOMIZED_TORCH_DUTY_HIGH,
} mtk_camera_metadata_enum_android_flash_feature_customized_torch_duty_t;
...
typedef enum mtk_camera_metadata_enum_android_lens_pose_reference {
    MTK_LENS_POSE_REFERENCE_PRIMARY_CAMERA,
    MTK_LENS_POSE_REFERENCE_GYROSCOPE,
} mtk_camera_metadata_enum_android_lens_pose_reference_t;
...
typedef enum mtk_camera_metadata_enum_android_request_available_capabilities {
    ...
    MTK_REQUEST_AVAILABLE_CAPABILITIES_SECURE_IMAGE_DATA        , // HIDL v3.4
...
typedef enum mtk_camera_metadata_enum_android_scaler_available_formats {
    ...
    MTK_SCALER_AVAILABLE_FORMATS_RAW10                      = 0x25, // HIDL v3.4
    MTK_SCALER_AVAILABLE_FORMATS_RAW12                      = 0x26, // HIDL v3.4
    MTK_SCALER_AVAILABLE_FORMATS_Y8                         = 0x20203859, // HIDL v3.4:
...
// MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS
typedef enum mtk_camera_metadata_enum_android_scaler_available_recommended_stream_configurations {// HIDL v3.4
    MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_PREVIEW
                                                                      = 0x1 << 0x0, // 1 << ANDROID_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_PREVIEW
    MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_RECORD
                                                                      = 0x1 << 0x1, // 1 << ANDROID_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_RECORD
    MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_VIDEO_SNAPSHOT
                                                                      = 0x1 << 0x2, // 1 << ANDROID_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_VIDEO_SNAPSHOT
    ...
    MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_ZSL        = 0x1 << 0x4, // 1 << ANDROID_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_ZSL
    MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_RAW        = 0x1 << 0x5, // 1 << ANDROID_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_RAW
    MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_LOW_LATENCY_SNAPSHOT
                                                                      = 0x1 << 0x6, // 1 << ANDROID_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_LOW_LATENCY_SNAPSHOT
    MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_PUBLIC_END
                                                                      = 0x1 << 0x7, // 1 << ANDROID_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_PUBLIC_END
    MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_VENDOR_START
                                                                      = 0x1 << 0x18, // 1 << ANDROID_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_VENDOR_START
} mtk_camera_metadata_enum_android_scaler_available_recommended_stream_configurations_t;
...
typedef enum mtk_camera_metadata_enum_android_sensor_info_color_filter_arrangement {
    ...
    MTK_SENSOR_INFO_COLOR_FILTER_ARRANGEMENT_MONO,
...
// MTK_STATISTICS_OIS_DATA_MODE
typedef enum mtk_camera_metadata_enum_android_statistics_ois_data_mode {
    MTK_STATISTICS_OIS_DATA_MODE_OFF,
...
// MTK_INFO_SUPPORTED_BUFFER_MANAGEMENT_VERSION
typedef enum mtk_camera_metadata_enum_android_info_supported_buffer_management_version {
    MTK_INFO_SUPPORTED_BUFFER_MANAGEMENT_VERSION_HIDL_DEVICE_3_5, // HIDL v3.4
} mtk_camera_metadata_enum_android_info_supported_buffer_management_version_t;
...
// MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STREAM_CONFIGURATIONS
typedef enum mtk_camera_metadata_enum_android_depth_available_dynamic_depth_stream_configurations {
    MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STREAM_CONFIGURATIONS_OUTPUT
                                                                     , // HIDL v3.4
    MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STREAM_CONFIGURATIONS_INPUT
                                                                     , // HIDL v3.4
} mtk_camera_metadata_enum_android_depth_available_dynamic_depth_stream_configurations_t;
...
// MTK_DISTORTION_CORRECTION_MODE
typedef enum mtk_camera_metadata_enum_android_distortion_correction_mode {
...
} mtk_camera_metadata_enum_android_distortion_correction_mode_t;

// MTK_HEIC_AVAILABLE_HEIC_STREAM_CONFIGURATIONS
typedef enum mtk_camera_metadata_enum_android_heic_available_heic_stream_configurations {
    MTK_HEIC_AVAILABLE_HEIC_STREAM_CONFIGURATIONS_OUTPUT        , // HIDL v3.4
    MTK_HEIC_AVAILABLE_HEIC_STREAM_CONFIGURATIONS_INPUT         , // HIDL v3.4
} mtk_camera_metadata_enum_android_heic_available_heic_stream_configurations_t;

// MTK_HEIC_INFO_SUPPORTED
typedef enum mtk_camera_metadata_enum_android_heic_info_supported {
    MTK_HEIC_INFO_SUPPORTED_FALSE                               , // HIDL v3.4
    MTK_HEIC_INFO_SUPPORTED_TRUE                                , // HIDL v3.4
} mtk_camera_metadata_enum_android_heic_info_supported_t;
...
typedef enum mtk_camera_metadata_num_hal_version {
    ...
    MTK_HAL_VERSION_3_5 = MTKCAM_DEVICE_API_VERSION(3, 5),
...
typedef enum mtk_camera_metadata_enum_hdr_hal_mode {
    ...
    MTK_HDR_FEATURE_HDR_HAL_MODE_MSTREAM_CAPTURE_PREVIEW = ( MTK_HDR_FEATURE_HDR_HAL_MODE_MSTREAM_CAPTURE |
                                                             MTK_HDR_FEATURE_HDR_HAL_MODE_MSTREAM_PREVIEW ),
} mtk_camera_metadata_enum_mstream_hdr_mode_t;
...
// raw reprocess hint
typedef enum mtk_camera_metadata_enum_control_capture_hint_for_raw_reprocess {
    MTK_CONTROL_CAPTURE_HINT_FOR_RAW_REPROCESS_FALSE = 0,
    MTK_CONTROL_CAPTURE_HINT_FOR_RAW_REPROCESS_TRUE,
} mtk_camera_metadata_enum_control_capture_hint_for_raw_reprocess;

// raw reprocess hint
typedef enum mtk_camera_metadata_enum_control_capture_hint_for_isp_tuning {
    MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING_DEFAULT_NONE = 0,
    MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING_MFNR,
    MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING_AINR,
    MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING_YUV_REPROCESS,
    // Above only for MTK turn key feautre usage

    // MUST add customer hint as below. (reserved for customer features' hint)
    MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING_FOR_3RD_PARTY = 5000,
    MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING_CUSTOMER_YUV_HDR,
    MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING_CUSTOMER_RAW_HDR,
    MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING_CUSTOMER_SUPER_NIGHT,
    MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING_CUSTOMER_SUPER_RESOLUTION,
    MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING_END,
} mtk_camera_metadata_enum_control_capture_hint_for_isp_tuning;
...
// zsl
typedef enum mtk_camera_metadata_enum_control_capture_zsl_mode {
    MTK_CONTROL_CAPTURE_ZSL_MODE_OFF = 0,
    MTK_CONTROL_CAPTURE_ZSL_MODE_ON,
} mtk_camera_metadata_enum_control_capture_zsl_mode;

// isp tuning
typedef enum mtk_camera_metadata_enum_control_capture_tuning_request {
    MTK_CONTROL_CAPTURE_ISP_TUNING_REQ_RAW = 0x1,
    MTK_CONTROL_CAPTURE_ISP_TUNING_REQ_YUV = 0x2,
} mtk_camera_metadata_enum_control_capture_tuning_request;

//packed raw
typedef enum mtk_camera_metadata_enum_control_capture_packed_raw_support {
    MTK_CONTROL_CAPTURE_PACKED_RAW_SUPPORT_OFF = 0,
    MTK_CONTROL_CAPTURE_PACKED_RAW_SUPPORT_ON,
...
typedef enum mtk_camera_metadata_enum_preview_eis {
    MTK_EIS_FEATURE_PREVIEW_EIS_OFF = 0,
    MTK_EIS_FEATURE_PREVIEW_EIS_ON  = 1,
} mtk_camera_metadata_enum_preview_eis_t;

typedef enum mtk_camera_metadata_enum_record_state {
    // STATE_PREVIEW : It can be video preview or recording stop state, decided by has encode buffer or not
...
typedef enum mtk_camera_metadata_enum_streaming_hfps_mode {
    MTK_STREAMING_FEATURE_HFPS_MODE_NORMAL = 0,
    MTK_STREAMING_FEATURE_HFPS_MODE_60FPS,
} mtk_camera_metadata_enum_streaming_hfps_mode_t;
...
//MTK_ABF_FEATURE_ABF_MODE
typedef enum mtk_camera_metadata_enum_afb {
    MTK_ABF_FEATURE_ABF_OFF = 0,
    MTK_ABF_FEATURE_ABF_ON,
} mtk_camera_metadata_enum_afb_t;
