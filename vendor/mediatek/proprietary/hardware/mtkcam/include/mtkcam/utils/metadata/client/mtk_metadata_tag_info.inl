...
_IMP_SECTION_INFO_(MTK_HEIC,                        "mtk.heic")
...
_IMP_TAG_INFO_( MTK_CONTROL_ENABLE_ZSL,
                MUINT8,     "enableZsl")
_IMP_TAG_INFO_( MTK_CONTROL_AF_SCENE_CHANGE,
                MUINT8,     "afsceneChange")
//
...
_IMP_TAG_INFO_( MTK_LENS_POSE_REFERENCE,
                MUINT8,     "poseReference")
_IMP_TAG_INFO_( ANDROID_LENS_DISTORTION,
                MFLOAT,     "distortion")
//
...
_IMP_TAG_INFO_( MTK_REQUEST_CHARACTERISTIC_KEYS_NEEDING_PERMISSION,
                MINT32, "characteristicKeysNeedingPermissiont")
//
...
_IMP_TAG_INFO_( MTK_SCALER_CROPPING_TYPE,
                MUINT8,      "croppingType")
_IMP_TAG_INFO_( MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS,
                MINT32,      "availableRecommendedStreamConfigurationsr")
_IMP_TAG_INFO_( MTK_SCALER_AVAILABLE_RECOMMENDED_INPUT_OUTPUT_FORMATS_MAP,
                MINT32,      "availableRecommendedInputOutputFormats_map")
_IMP_TAG_INFO_( MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_WITH_DURATIONS,
                MINT64,      "availableStreamConfigurationsWithDurations")
_IMP_TAG_INFO_( MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_WITH_DURATIONS_CANDIDATES,
                MINT64,      "availableStreamConfigurationsWithDurationsCandidates")
//
...
_IMP_TAG_INFO_( MTK_STATISTICS_INFO_AVAILABLE_LENS_SHADING_MAP_MODES,
                MUINT8,      "availableLensShadingMapModes")
_IMP_TAG_INFO_( MTK_STATISTICS_INFO_AVAILABLE_OIS_DATA_MODES,
                MUINT8,      "availableOisDataModes")
//
...
_IMP_TAG_INFO_( MTK_STATISTICS_OIS_DATA_MODE,
                MINT32,     "oisDatamode")
_IMP_TAG_INFO_( MTK_STATISTICS_OIS_TIMESTAMPS,
                MINT64,     "oisTimestamps")
_IMP_TAG_INFO_( MTK_STATISTICS_OIS_X_SHIFTS,
                MFLOAT,     "oisXshifts")
_IMP_TAG_INFO_( MTK_STATISTICS_OIS_Y_SHIFTS,
                MFLOAT,     "oisYshifts")
//
...
_IMP_TAG_INFO_( MTK_INFO_VERSION,
                MUINT8,     "version")
_IMP_TAG_INFO_( MTK_INFO_SUPPORTED_BUFFER_MANAGEMENT_VERSION,
                MUINT8,     "supportedBufferManagementVersion")
//
...
_IMP_TAG_INFO_( MTK_DEPTH_AVAILABLE_RECOMMENDED_DEPTH_STREAM_CONFIGURATIONS,
                MINT32,     "depthAvailableRecommendedDepthStreamConfigurations")
_IMP_TAG_INFO_( MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STREAM_CONFIGURATIONS,
                MINT32,     "depthAvailableDynamicDepthStreamConfigurations")
_IMP_TAG_INFO_( MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_MIN_FRAME_DURATIONS,
                MINT64,     "depthAvailableDynamicDepthMinFrameDurations")
_IMP_TAG_INFO_( MTK_DEPTH_AVAILABLE_DYNAMIC_DEPTH_STALL_DURATIONS,
                MINT64,     "depthAvailableDynamicDepthStallDurations")
//
...
_IMP_TAG_INFO_( MTK_LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_ID,
                MUINT8,     "multiCameraActivePhysicalId")
//
_IMP_TAG_INFO_( MTK_HEIC_AVAILABLE_HEIC_STREAM_CONFIGURATIONS ,
                MINT32,     "heicAvailableHeicStreamConfigurations")
_IMP_TAG_INFO_( MTK_HEIC_AVAILABLE_HEIC_MIN_FRAME_DURATIONS,
                MINT64,     "heicAvailableHeicMinFrameDurations")
_IMP_TAG_INFO_( MTK_HEIC_AVAILABLE_HEIC_STALL_DURATIONS,
                MINT64,     "heicAvailableHeicStallDurations")
_IMP_TAG_INFO_( MTK_HEIC_INFO_SUPPORTED ,
                MINT32,     "heicInfoSupported")
_IMP_TAG_INFO_( MTK_HEIC_INFO_MAX_JPEG_APP_SEGMENTS_COUNT,
                MUINT8,     "heicInfoMaxJpegAppSegmentsCount")
//
...
_IMP_TAG_INFO_( MTK_FACE_FEATURE_FACE_ADDITIONAL_RESULT,
                MINT32,     "additionalresult")
...
_IMP_TAG_INFO_( MTK_HDR_FEATURE_AVAILABLE_MSTREAM_HDR_MODES,
                MINT32,     "availableMStreamHdrModes")
...
_IMP_TAG_INFO_( MTK_EIS_FEATURE_PREVIEW_EIS,
                MINT32,     "previeweis")
...
_IMP_TAG_INFO_( MTK_STREAMING_FEATURE_HFPS_MODE,
                MINT32,     "hfpsMode")

_IMP_TAG_INFO_( MTK_STREAMING_FEATURE_AVAILABLE_HFPS_MODES,
                MINT32,     "availableHfpsModes")

_IMP_TAG_INFO_( MTK_STREAMING_FEATURE_AVAILABLE_HFPS_MAX_RESOLUTIONS,
                MINT32,     "availableHfpsMaxResolutions")
...
_IMP_TAG_INFO_( MTK_3A_FEATURE_AE_AVERAGE_BRIGHTNESS,
                MINT32,     "aeAverageBrightness")

_IMP_TAG_INFO_( MTK_3A_FEATURE_AE_PLINE_INDEX,
                MINT32,     "aePlineIndex")

_IMP_TAG_INFO_( MTK_3A_FEATURE_AE_CUSTOM_PLINE_MODE,
                MINT32,     "aeCustomPlineMode")
...
_IMP_TAG_INFO_( MTK_3A_FEATURE_AE_SENSOR_GAIN_VALUE,
                MINT32,     "aeSensorGain")

_IMP_TAG_INFO_( MTK_3A_FEATURE_AE_ISP_GAIN_VALUE,
                MINT32,     "aeIspGain")

_IMP_TAG_INFO_( MTK_3A_FEATURE_AE_LUX_INDEX_VALUE,
                MINT32,     "aeLuxIndex")

_IMP_TAG_INFO_( MTK_3A_FEATURE_ADRC_GAIN_VALUE,
                MINT32,     "adrcGain")
...
_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_SINGLE_YUV_NR,
                MINT32,     "singleYuvNr")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_HIGH_QUALITY_YUV,
                MINT32,     "highQualityYuv")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_HINT_FOR_RAW_REPROCESS,
                MUINT8,     "hintForRawReprocess")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING,
                MINT32,     "hintForIspTuning")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_HINT_FOR_ISP_FRAME_COUNT,
                MINT32,     "hintForIspFrameCount")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_HINT_FOR_ISP_FRAME_INDEX,
                MINT32,     "hintForIspFrameIndex")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_HINT_FOR_ISP_FRAME_TUNING_INDEX,
                MINT64,     "hintForIspFrameTuningIndex")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_YUV_NO_MARGIN,
                MUINT8,     "yuvNoMargin")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_REMOSAIC_EN,
                MINT32,     "remosaicenable")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_ISP_TUNING_DATA_ENABLE,
                MUINT8,     "ispMetaEnable")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_ISP_TUNING_DATA_SIZE_FOR_RAW,
                MINT32,     "ispMetaSizeForRaw")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_ISP_TUNING_DATA_SIZE_FOR_YUV,
                MINT32,     "ispMetaSizeForYuv")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_ISP_TUNING_REQUEST,
                MUINT8,     "ispTuningRequest")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_ISP_TUNING_DATA_RAW,
                MUINT8,     "ispTuningDataRaw")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_ISP_TUNING_DATA_YUV,
                MUINT8,     "ispTuningDataYuv")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_PACKED_RAW_SUPPORT,
                MINT32,     "packedRaw.support")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_PACKED_RAW_ENABLE,
                MINT32,     "packedRaw.enable")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_PROCESS_RAW_ENABLE,
                MINT32,     "processRaw.enable")

_IMP_TAG_INFO_( MTK_CONTROL_CAPTURE_RAW_BPP,
                MINT32,     "raw.bpp")
...
_IMP_TAG_INFO_( MTK_BGSERVICE_FEATURE_IMAGEREADERID,
                MINT32,     "imagereaderid")
...
_IMP_TAG_INFO_( MTK_VSDOF_FEATURE_WARNING,
                MINT32,     "vsdofFeatureWarning")

_IMP_TAG_INFO_( MTK_VSDOF_FEATURE_CAPTURE_WARNING_MSG,
                MINT32,     "vsdofFeatureCaptureWarningMsg")
...
_IMP_TAG_INFO_( MTK_MULTI_CAM_FEATURE_SENSOR_MANUAL_UPDATED,
                MINT64,     "availableMultiCamFeatureSensorManualUpdated")

_IMP_TAG_INFO_( MTK_MULTI_CAM_ZOOM_RANGE,
                MFLOAT,     "multiCamZoomRange")

_IMP_TAG_INFO_( MTK_MULTI_CAM_ZOOM_VALUE,
                MFLOAT,     "multiCamZoomValue")

_IMP_TAG_INFO_( MTK_MULTI_CAM_ZOOM_STEPS,
                MFLOAT,     "multiCamZoomSteps")

_IMP_TAG_INFO_( MTK_MULTI_CAM_AF_ROI,
                MINT32,     "multiCamAfRoi")

_IMP_TAG_INFO_( MTK_MULTI_CAM_MASTER_ID,
                MINT32,     "multiCamMasterId")

_IMP_TAG_INFO_( MTK_MULTI_CAM_FOV_CROP_REGION,
                MINT32,     "multiCamFovCropRegion")

_IMP_TAG_INFO_( MTK_MULTI_CAM_SENSOR_CROP_REGION,
                MINT32,     "multiCamSensorCropRegion")

_IMP_TAG_INFO_( MTK_MULTI_CAM_STREAMING_ID,
                MINT32,     "multiCamStreamingId")

_IMP_TAG_INFO_( MTK_CONFIGURE_SETTING_INIT_REQUEST,
                MINT32,     "initrequest")

_IMP_TAG_INFO_( MTK_CONFIGURE_ISP_YUV_DIRECT_JPEG,
                MINT32,     "yuvdirectjpeg")

_IMP_TAG_INFO_( MTK_CONFIGURE_SETTING_PROPRIETARY,
                MINT32,     "proprietaryRequest")

_IMP_TAG_INFO_( MTK_FLASH_FEATURE_CALIBRATION_AVAILABLE,
                           MINT32,     "calibration.available")

_IMP_TAG_INFO_( MTK_FLASH_FEATURE_CALIBRATION_ENABLE,
                           MINT32,     "calibration.enable")

_IMP_TAG_INFO_( MTK_FLASH_FEATURE_CALIBRATION_RESULT,
                           MINT32,     "calibration.result")

_IMP_TAG_INFO_( MTK_FLASH_FEATURE_CUSTOMIZATION_AVAILABLE,
                MUINT8,     "customization.available")

_IMP_TAG_INFO_( MTK_FLASH_FEATURE_CUSTOMIZED_RESULT,
                MUINT8,     "customizedResult")

_IMP_TAG_INFO_( MTK_FLASH_FEATURE_CUSTOMIZED_TORCH_DUTY,
                MUINT8,     "customizedTorchDuty")

_IMP_TAG_INFO_( MTK_SMVR_FEATURE_SMVR_MODE,
                MINT32,     "smvrMode")
_IMP_TAG_INFO_( MTK_SMVR_FEATURE_AVAILABLE_SMVR_MODES,
                MINT32,     "availableSmvrModes")
_IMP_TAG_INFO_( MTK_SMVR_FEATURE_SMVR_RESULT,
                MINT32,     "availableSmvrResult")
