...
typedef enum mtk_platform_metadata_tag {
    ...
    MTK_HAL_REQUEST_ZSD_RAW_FOR_ISPHIDL,                       //MINT32
    ...
    MTK_HAL_REQUEST_IS_YUVREPROCESS,                           //MBOOL
    ...
    MTK_STEREO_DCMF_POSTVIEW_SIZE,                             //MSize
    MTK_STEREO_CALLBACK_CLIENT,                                //MINT64
    MTK_STEREO_BG_SERVICE_SUPPORT,                             //MINT32
    MTK_STEREO_NEED_BG_POSTVIEW,                               //MINT32
...
//MTK_FEATURE_CAP_PIPE_DCE_DISABLE
typedef enum mtk_platform_metadata_enum_cap_pipe_dce_disable {
    MTK_FEATURE_CAP_PIPE_DCE_DISABLE_ON = 1,
    MTK_FEATURE_CAP_PIPE_DCE_DISABLE_OFF = 0
} mtk_platform_metadata_enum_cap_pipe_dce_disable_t;
