...
#define ABF_C_OPT               (1)
#define ABF_NEON_OPT            (0)
#define ABF_NEON_OPT2           (0)     // optimization without flexibility
#define ABF_MULTI_CORE_OPT      (1)
#define ABF_MAX_CORE_NO         (8)
...
static const MUINT32 ABFPerfGearOption[ABF_MAX_GEAR_NUM][6] =
{
    // LL, L, B
    {4, 1391000, 4, 1950000, 0, 2288000},
    {4, 1391000, 4, 1352000, 0, 2288000},
    {4, 1391000, 4, 1794000, 0, 2288000},
