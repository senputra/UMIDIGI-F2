    ...
    : mSceneHandle(-1)
{
    ...
    {
        minCores = property_get_int32("vendor.mediatek.hdr.debug.mincore0", 4);
        maxCores = property_get_int32("vendor.mediatek.hdr.debug.maxcore0", 4);
        minFreq  = property_get_int32("vendor.mediatek.hdr.debug.minfreq0", 1638000);
        maxFreq  = property_get_int32("vendor.mediatek.hdr.debug.maxfreq0", 1638000);
    ...
    {
        minCores = property_get_int32("vendor.mediatek.hdr.debug.mincore1", 4);
        maxCores = property_get_int32("vendor.mediatek.hdr.debug.maxcore1", 4);
        minFreq  = property_get_int32("vendor.mediatek.hdr.debug.minfreq1", 2340000);
        maxFreq  = property_get_int32("vendor.mediatek.hdr.debug.maxfreq1", 2340000);
