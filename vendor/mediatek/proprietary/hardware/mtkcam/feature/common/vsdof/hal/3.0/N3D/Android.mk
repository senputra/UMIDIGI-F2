...
#-----------------------------------------------------------
LOCAL_SRC_FILES += n3d_hal_kernel.cpp
LOCAL_SRC_FILES += n3d_hal_kernel.log.cpp
LOCAL_SRC_FILES += n3d_hal_kernel.dump.cpp
LOCAL_SRC_FILES += n3d_hal_imp.cpp
LOCAL_SRC_FILES += n3d_hal_imp.dump.cpp
LOCAL_SRC_FILES += n3d_hal_imp.ext_cal.cpp
LOCAL_SRC_FILES += n3d_debug_util_imp.cpp

#-----------------------------------------------------------
LOCAL_C_INCLUDES += \
    $(VSDOF_COMMON_INC) \
    $(TOP)/vendor/mediatek/proprietary/hardware/libcamera_feature/libn3d_lib/include \
    ...
    $(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_3a/libaf_core_lib/$(PLATFORM)/include \
    $(TOP)/external/lz4/lib \

LOCAL_SHARED_LIBRARIES += libcamalgo.n3d
