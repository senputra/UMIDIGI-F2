 ...
 */
#ifndef _MTK_CAMERA_VSDOF_DCMF_FEATURE_PIPE_EXIF_WRITER_H_
#define _MTK_CAMERA_VSDOF_DCMF_FEATURE_PIPE_EXIF_WRITER_H_
...
#endif // _MTK_CAMERA_VSDOF_DCMF_FEATURE_PIPE_EXIF_WRITER_H_
