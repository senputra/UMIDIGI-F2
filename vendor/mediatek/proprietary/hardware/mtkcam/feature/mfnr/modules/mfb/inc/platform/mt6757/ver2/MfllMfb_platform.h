...
#if ((MFLL_MF_TAG_VERSION > 0) && (MFLL_MF_TAG_VERSION != 5))
#   error "MT6757 ver2 only supports MF_TAG_VERSION 5"
#endif
...
#   define _D(tag, value) do{} while(0)
    ...
    case STAGE_MFB:
        ...
        _D(MF_TAG_BLEND_DIP_X_MFB_LL_CON3,              t->DIP_X_MFB_LL_CON3  );
        _D(MF_TAG_BLEND_DIP_X_MFB_LL_CON4,              t->DIP_X_MFB_LL_CON4  );
        _D(MF_TAG_BLEND_DIP_X_MFB_EDGE,                 t->DIP_X_MFB_EDGE     );
        // since new MFB
        _D(MF_TAG_BLEND_DIP_X_MFB_LL_CON5,              t->DIP_X_MFB_LL_CON5  );
        _D(MF_TAG_BLEND_DIP_X_MFB_LL_CON6,              t->DIP_X_MFB_LL_CON6  );
        _D(MF_TAG_BLEND_DIP_X_MFB_LL_CON7,              t->DIP_X_MFB_LL_CON7  );
        _D(MF_TAG_BLEND_DIP_X_MFB_LL_CON8,              t->DIP_X_MFB_LL_CON8  );
        _D(MF_TAG_BLEND_DIP_X_MFB_LL_CON9,              t->DIP_X_MFB_LL_CON9  );
        _D(MF_TAG_BLEND_DIP_X_MFB_LL_CON10,             t->DIP_X_MFB_LL_CON10 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON0,             t->DIP_X_MFB_MBD_CON0 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON1,             t->DIP_X_MFB_MBD_CON1 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON2,             t->DIP_X_MFB_MBD_CON2 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON3,             t->DIP_X_MFB_MBD_CON3 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON4,             t->DIP_X_MFB_MBD_CON4 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON5,             t->DIP_X_MFB_MBD_CON5 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON6,             t->DIP_X_MFB_MBD_CON6 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON7,             t->DIP_X_MFB_MBD_CON7 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON8,             t->DIP_X_MFB_MBD_CON8 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON9,             t->DIP_X_MFB_MBD_CON9 );
        _D(MF_TAG_BLEND_DIP_X_MFB_MBD_CON10,            t->DIP_X_MFB_MBD_CON10);
        // }}} STAGE_MFB
        break;
