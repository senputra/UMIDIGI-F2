...
# Include path
# -----------------------------------------------------------------------------
LOCAL_C_INCLUDES += $(MTKCAM_C_INCLUDES)  # from mtkcam
LOCAL_C_INCLUDES += $(MFLL_INCLUDE_PATH)

# custom
LOCAL_C_INCLUDES += $(MTK_PATH_COMMON)/hal/inc # common
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc # platform
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/$(MTK_CAM_SW_VERSION) # platform + ver
...
# algorithm
LOCAL_C_INCLUDES += $(MFLL_INCLUDE_PATH_ALGO)
