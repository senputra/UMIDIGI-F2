...
put(ISP_NVRAM_ANR_T const& rParam)
{
    ...
    PUT_REG_INFO(DIP_X_ANR_MED5,    med5);
...
get(ISP_NVRAM_ANR_T& rParam, const dip_x_reg_t* pReg) const
{
    if (pReg)
    {
        ...
        GET_REG_INFO_BUF(DIP_X_ANR_MED1,    med1);
        GET_REG_INFO_BUF(DIP_X_ANR_MED2,    med2);
        GET_REG_INFO_BUF(DIP_X_ANR_MED3,    med3);
        GET_REG_INFO_BUF(DIP_X_ANR_MED4,    med4);
        GET_REG_INFO_BUF(DIP_X_ANR_MED5,    med5);
        GET_REG_INFO_BUF(DIP_X_ANR_HP1,     hp1);
        GET_REG_INFO_BUF(DIP_X_ANR_HP2,     hp2);
        GET_REG_INFO_BUF(DIP_X_ANR_HP3,     hp3);
