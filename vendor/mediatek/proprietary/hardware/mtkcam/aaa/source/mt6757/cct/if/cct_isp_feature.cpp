...
IMP_CCT_CTRL( ACDK_CCT_OP_QUERY_ISP_ID )
{
    ...
    *reinterpret_cast<MUINT32 *>(puParaOut) = sizeof(MUINTPTR) == 4 ? 0x67578A00 : 0x67578AFF; // 00 means 32bit; FF means 64bit
...
IMP_CCT_CTRL( ACDK_CCT_V2_OP_QUERY_ISP_INDEX_SET )
{
    ...
    *pu4RealParaOutLen = sizeof(o_type);
    ...
    MY_LOG("IMP_CCT_CTRL( ACDK_CCT_V2_OP_QUERY_ISP_INDEX_SET ) done, SL2F(%d) DBS(%d) OBC(%d) BPC(%d) NR1(%d) PDC(%d) RMM(%d) RNR(%d) SL2(%d) UDM(%d) ANR(%d) ANR2(%d) CCR(%d) HFG(%d) EE(%d) MFB(%d) MIX3(%d)\n",
    ...
    pCustNvramRegIdx->RMM, pCustNvramRegIdx->RNR, pCustNvramRegIdx->SL2, pCustNvramRegIdx->UDM, pCustNvramRegIdx->ANR, pCustNvramRegIdx->ANR2, pCustNvramRegIdx->CCR,
    pCustNvramRegIdx->HFG, pCustNvramRegIdx->EE, pCustNvramRegIdx->MFB, pCustNvramRegIdx->MIXER3);
