...
public: // Operations.
    ...
    MBOOL getLCSparam(MINT32 const i4SensorDev, LCS_ISP_INFO_T &lcs_info);
    ...
    MVOID* getBPCItable(MINT32 const i4SensorDev);
 ...
 */
    ...
    enum E_ISPTUNING_CTRL
    {
        ...
        //Bayer+Mono sensor
        E_ISPTUNING_SET_RAW_FMT_MONO   = 0x4000, // SENSOR_RAW_Bayer = 0x0;  or SENSOR_RAW_MONO = 1;

        //LCE
        E_ISPTUNING_SET_LCE_SCENARIO   = 0x5000, //preview/capture/video

        //Shading
        E_ISPTUNING_UPDATE_LSC_INFO    = 0x6000,
