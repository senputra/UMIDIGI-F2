...
static VOID vCapCb(VOID *a_pParam)
{
    ...
    if (pImgBufInfo->eImgType == RAW_TYPE)
    {
        ...
        bRet = bRAW10To8(pImgBufInfo->rRawBufInfo.pucRawBuf,
                                       ...
                                       pBuf);
        FILE *pFp = fopen("/sdcard/test8.raw", "wb");
...
MRESULT mrCCAPAWBGetAWBPara_Cmd(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    ACDK_LOGD("rUnitGain.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rUnitGain.i4R);
    ACDK_LOGD("rUnitGain.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rUnitGain.i4G);
    ACDK_LOGD("rUnitGain.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rUnitGain.i4B);
    ACDK_LOGD("rGoldenGain.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rGoldenGain.i4R);
    ACDK_LOGD("rGoldenGain.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rGoldenGain.i4G);
    ACDK_LOGD("rGoldenGain.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rGoldenGain.i4B);
    ACDK_LOGD("rTuningUnitGain.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rTuningUnitGain.i4R);
    ACDK_LOGD("rTuningUnitGain.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rTuningUnitGain.i4G);
    ACDK_LOGD("rTuningUnitGain.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rTuningUnitGain.i4B);
    ACDK_LOGD("rD65Gain.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rD65Gain.i4R);
    ACDK_LOGD("rD65Gain.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rD65Gain.i4G);
    ACDK_LOGD("rD65Gain.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCalData.rD65Gain.i4B);


    ACDK_LOGD("rOriginalXY.rStrobe.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rStrobe.i4X);
    ACDK_LOGD("rOriginalXY.rStrobe.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rStrobe.i4Y);
    ACDK_LOGD("rOriginalXY.rHorizon.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rHorizon.i4X);
    ACDK_LOGD("rOriginalXY.rHorizon.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rHorizon.i4Y);
    ACDK_LOGD("rOriginalXY.rA.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rA.i4X);
    ACDK_LOGD("rOriginalXY.rA.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rA.i4Y);
    ACDK_LOGD("rOriginalXY.rTL84.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rTL84.i4X);
    ACDK_LOGD("rOriginalXY.rTL84.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rTL84.i4Y);
    ACDK_LOGD("rOriginalXY.rCWF.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rCWF.i4X);
    ACDK_LOGD("rOriginalXY.rCWF.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rCWF.i4Y);
    ACDK_LOGD("rOriginalXY.rDNP.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rDNP.i4X);
    ACDK_LOGD("rOriginalXY.rDNP.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rDNP.i4Y);
    ACDK_LOGD("rOriginalXY.rD65.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rD65.i4X);
    ACDK_LOGD("rOriginalXY.rD65.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rD65.i4Y);
    ACDK_LOGD("rOriginalXY.rDF.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rDF.i4X);
    ACDK_LOGD("rOriginalXY.rDF.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rOriginalXY.rDF.i4Y);

    ACDK_LOGD("rRotatedXY.rStrobe.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rStrobe.i4X);
    ACDK_LOGD("rRotatedXY.rStrobe.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rStrobe.i4Y);
    ACDK_LOGD("rRotatedXY.rHorizon.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rHorizon.i4X);
    ACDK_LOGD("rRotatedXY.rHorizon.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rHorizon.i4Y);
    ACDK_LOGD("rRotatedXY.rA.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rA.i4X);
    ACDK_LOGD("rRotatedXY.rA.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rA.i4Y);
    ACDK_LOGD("rRotatedXY.rTL84.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rTL84.i4X);
    ACDK_LOGD("rRotatedXY.rTL84.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rTL84.i4Y);
    ACDK_LOGD("rRotatedXY.rCWF.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rCWF.i4X);
    ACDK_LOGD("rRotatedXY.rCWF.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rCWF.i4Y);
    ACDK_LOGD("rRotatedXY.rDNP.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rDNP.i4X);
    ACDK_LOGD("rRotatedXY.rDNP.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rDNP.i4Y);
    ACDK_LOGD("rRotatedXY.rD65.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rD65.i4X);
    ACDK_LOGD("rRotatedXY.rD65.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rD65.i4Y);
    ACDK_LOGD("rRotatedXY.rDF.i4X = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rDF.i4X);
    ACDK_LOGD("rRotatedXY.rDF.i4Y = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotatedXY.rDF.i4Y);

    ACDK_LOGD("rStrobe.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rStrobe.i4R);
    ACDK_LOGD("rStrobe.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rStrobe.i4G);
    ACDK_LOGD("rStrobe.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rStrobe.i4B);
    ACDK_LOGD("rHorizon.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rHorizon.i4R);
    ACDK_LOGD("rHorizon.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rHorizon.i4G);
    ACDK_LOGD("rHorizon.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rHorizon.i4B);
    ACDK_LOGD("rA.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rA.i4R);
    ACDK_LOGD("rA.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rA.i4G);
    ACDK_LOGD("rA.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rA.i4B);
    ACDK_LOGD("rTL84.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rTL84.i4R);
    ACDK_LOGD("rTL84.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rTL84.i4G);
    ACDK_LOGD("rTL84.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rTL84.i4B);
    ACDK_LOGD("rCWF.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rCWF.i4R);
    ACDK_LOGD("rCWF.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rCWF.i4G);
    ACDK_LOGD("rCWF.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rCWF.i4B);
    ACDK_LOGD("rDNP.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rDNP.i4R);
    ACDK_LOGD("rDNP.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rDNP.i4G);
    ACDK_LOGD("rDNP.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rDNP.i4B);
    ACDK_LOGD("rD65.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rD65.i4R);
    ACDK_LOGD("rD65.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rD65.i4G);
    ACDK_LOGD("rD65.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rD65.i4B);
    ACDK_LOGD("rDF.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rDF.i4R);
    ACDK_LOGD("rDF.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rDF.i4G);
    ACDK_LOGD("rDF.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rLightAWBGain.rDF.i4B);

    ACDK_LOGD("rRotationMatrix.i4RotationAngle = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotationMatrix.i4RotationAngle);
    ACDK_LOGD("rRotationMatrix.i4Cos = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotationMatrix.i4Cos);
    ACDK_LOGD("rRotationMatrix.i4Sin = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rRotationMatrix.i4Sin);

    ACDK_LOGD("rDaylightLocus.i4SlopeNumerator = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rDaylightLocus.i4SlopeNumerator);
    ACDK_LOGD("rDaylightLocus.i4SlopeDenominator = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rDaylightLocus.i4SlopeDenominator);

    ACDK_LOGD("rAWBNVRAM.rPredictorGain.i4PrefRatio100 = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.i4PrefRatio100);
    ACDK_LOGD("rAWBNVRAM.rPredictorGain.rSpatial_DaylightLocus_H.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rSpatial_DaylightLocus_H.i4R);
    ACDK_LOGD("rAWBNVRAM.rPredictorGain.rSpatial_DaylightLocus_H.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rSpatial_DaylightLocus_H.i4G);
    ACDK_LOGD("rAWBNVRAM.rPredictorGain.rSpatial_DaylightLocus_H.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rSpatial_DaylightLocus_H.i4B);
    ACDK_LOGD("rAWBNVRAM.rPredictorGain.rSpatial_DaylightLocus_L.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rSpatial_DaylightLocus_L.i4R);
    ACDK_LOGD("rAWBNVRAM.rPredictorGain.rSpatial_DaylightLocus_L.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rSpatial_DaylightLocus_L.i4G);
    ACDK_LOGD("rAWBNVRAM.rPredictorGain.rSpatial_DaylightLocus_L.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rSpatial_DaylightLocus_L.i4B);
    ACDK_LOGD("rAWBNVRAM.rPredictorGain.rTemporal_General.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rTemporal_General.i4R);
    ACDK_LOGD("rAWBNVRAM.rPredictorGain.rTemporal_General.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rTemporal_General.i4G);
    ACDK_LOGD("rAWBNVRAM.rPredictorGain.rTemporal_General.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rTemporal_General.i4B);

    ACDK_LOGD("rAWBLightArea.rStrobe.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rStrobe.i4RightBound);
    ACDK_LOGD("rAWBLightArea.rStrobe.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rStrobe.i4LeftBound);
    ACDK_LOGD("rAWBLightArea.rStrobe.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rStrobe.i4UpperBound);
    ACDK_LOGD("rAWBLightArea.rStrobe.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rStrobe.i4LowerBound);
    ACDK_LOGD("rAWBLightArea.rTungsten.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rTungsten.i4RightBound);
    ACDK_LOGD("rAWBLightArea.rTungsten.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rTungsten.i4LeftBound);
    ACDK_LOGD("rAWBLightArea.rTungsten.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rTungsten.i4UpperBound);
    ACDK_LOGD("rAWBLightArea.rTungsten.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rTungsten.i4LowerBound);
    ACDK_LOGD("rAWBLightArea.rWarmFluorescent.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rWarmFluorescent.i4RightBound);
    ACDK_LOGD("rAWBLightArea.rWarmFluorescent.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rWarmFluorescent.i4LeftBound);
    ACDK_LOGD("rAWBLightArea.rWarmFluorescent.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rWarmFluorescent.i4UpperBound);
    ACDK_LOGD("rAWBLightArea.rWarmFluorescent.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rWarmFluorescent.i4LowerBound);
    ACDK_LOGD("rAWBLightArea.rFluorescent.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rFluorescent.i4RightBound);
    ACDK_LOGD("rAWBLightArea.rFluorescent.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rFluorescent.i4LeftBound);
    ACDK_LOGD("rAWBLightArea.rFluorescent.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rFluorescent.i4UpperBound);
    ACDK_LOGD("rAWBLightArea.rFluorescent.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rFluorescent.i4LowerBound);
    ACDK_LOGD("rAWBLightArea.rCWF.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rCWF.i4RightBound);
    ACDK_LOGD("rAWBLightArea.rCWF.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rCWF.i4LeftBound);
    ACDK_LOGD("rAWBLightArea.rCWF.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rCWF.i4UpperBound);
    ACDK_LOGD("rAWBLightArea.rCWF.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rCWF.i4LowerBound);
    ACDK_LOGD("rAWBLightArea.rDaylight.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rDaylight.i4RightBound);
    ACDK_LOGD("rAWBLightArea.rDaylight.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rDaylight.i4LeftBound);
    ACDK_LOGD("rAWBLightArea.rDaylight.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rDaylight.i4UpperBound);
    ACDK_LOGD("rAWBLightArea.rDaylight.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rDaylight.i4LowerBound);
    ACDK_LOGD("rAWBLightArea.rShade.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rShade.i4RightBound);
    ACDK_LOGD("rAWBLightArea.rShade.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rShade.i4LeftBound);
    ACDK_LOGD("rAWBLightArea.rShade.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rShade.i4UpperBound);
    ACDK_LOGD("rAWBLightArea.rShade.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rShade.i4LowerBound);
    ACDK_LOGD("rAWBLightArea.rDaylightFluorescent.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rDaylightFluorescent.i4RightBound);
    ACDK_LOGD("rAWBLightArea.rDaylightFluorescent.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rDaylightFluorescent.i4LeftBound);
    ACDK_LOGD("rAWBLightArea.rDaylightFluorescent.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rDaylightFluorescent.i4UpperBound);
    ACDK_LOGD("rAWBLightArea.rDaylightFluorescent.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rAWBLightArea.rDaylightFluorescent.i4LowerBound);

    ACDK_LOGD("rPWBLightArea.rReferenceArea.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rReferenceArea.i4RightBound);
    ACDK_LOGD("rPWBLightArea.rReferenceArea.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rReferenceArea.i4LeftBound);
    ACDK_LOGD("rPWBLightArea.rReferenceArea.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rReferenceArea.i4UpperBound);
    ACDK_LOGD("rPWBLightArea.rReferenceArea.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rReferenceArea.i4LowerBound);
    ACDK_LOGD("rPWBLightArea.rDaylight.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rDaylight.i4RightBound);
    ACDK_LOGD("rPWBLightArea.rDaylight.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rDaylight.i4LeftBound);
    ACDK_LOGD("rPWBLightArea.rDaylight.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rDaylight.i4UpperBound);
    ACDK_LOGD("rPWBLightArea.rDaylight.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rDaylight.i4LowerBound);
    ACDK_LOGD("rPWBLightArea.rCloudyDaylight.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rCloudyDaylight.i4RightBound);
    ACDK_LOGD("rPWBLightArea.rCloudyDaylight.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rCloudyDaylight.i4LeftBound);
    ACDK_LOGD("rPWBLightArea.rCloudyDaylight.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rCloudyDaylight.i4UpperBound);
    ACDK_LOGD("rPWBLightArea.rCloudyDaylight.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rCloudyDaylight.i4LowerBound);
    ACDK_LOGD("rPWBLightArea.rShade.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rShade.i4RightBound);
    ACDK_LOGD("rPWBLightArea.rShade.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rShade.i4LeftBound);
    ACDK_LOGD("rPWBLightArea.rShade.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rShade.i4UpperBound);
    ACDK_LOGD("rPWBLightArea.rShade.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rShade.i4LowerBound);
    ACDK_LOGD("rPWBLightArea.rTwilight.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rTwilight.i4RightBound);
    ACDK_LOGD("rPWBLightArea.rTwilight.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rTwilight.i4LeftBound);
    ACDK_LOGD("rPWBLightArea.rTwilight.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rTwilight.i4UpperBound);
    ACDK_LOGD("rPWBLightArea.rTwilight.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rTwilight.i4LowerBound);
    ACDK_LOGD("rPWBLightArea.rFluorescent.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rFluorescent.i4RightBound);
    ACDK_LOGD("rPWBLightArea.rFluorescent.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rFluorescent.i4LeftBound);
    ACDK_LOGD("rPWBLightArea.rFluorescent.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rFluorescent.i4UpperBound);
    ACDK_LOGD("rPWBLightArea.rFluorescent.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rFluorescent.i4LowerBound);
    ACDK_LOGD("rPWBLightArea.rWarmFluorescent.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rWarmFluorescent.i4RightBound);
    ACDK_LOGD("rPWBLightArea.rWarmFluorescent.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rWarmFluorescent.i4LeftBound);
    ACDK_LOGD("rPWBLightArea.rWarmFluorescent.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rWarmFluorescent.i4UpperBound);
    ACDK_LOGD("rPWBLightArea.rWarmFluorescent.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rWarmFluorescent.i4LowerBound);
    ACDK_LOGD("rPWBLightArea.rIncandescent.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rIncandescent.i4RightBound);
    ACDK_LOGD("rPWBLightArea.rIncandescent.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rIncandescent.i4LeftBound);
    ACDK_LOGD("rPWBLightArea.rIncandescent.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rIncandescent.i4UpperBound);
    ACDK_LOGD("rPWBLightArea.rIncandescent.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rIncandescent.i4LowerBound);
    ACDK_LOGD("rPWBLightArea.rGrayWorld.i4RightBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rGrayWorld.i4RightBound);
    ACDK_LOGD("rPWBLightArea.rGrayWorld.i4LeftBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rGrayWorld.i4LeftBound);
    ACDK_LOGD("rPWBLightArea.rGrayWorld.i4UpperBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rGrayWorld.i4UpperBound);
    ACDK_LOGD("rPWBLightArea.rGrayWorld.i4LowerBound = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBLightArea.rGrayWorld.i4LowerBound);

    ACDK_LOGD("rPWBDefaultGain.rDaylight.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rDaylight.i4R);
    ACDK_LOGD("rPWBDefaultGain.rDaylight.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rDaylight.i4G);
    ACDK_LOGD("rPWBDefaultGain.rDaylight.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rDaylight.i4B);
    ACDK_LOGD("rPWBDefaultGain.rCloudyDaylight.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rCloudyDaylight.i4R);
    ACDK_LOGD("rPWBDefaultGain.rCloudyDaylight.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rCloudyDaylight.i4G);
    ACDK_LOGD("rPWBDefaultGain.rCloudyDaylight.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rCloudyDaylight.i4B);
    ACDK_LOGD("rPWBDefaultGain.rShade.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rShade.i4R);
    ACDK_LOGD("rPWBDefaultGain.rShade.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rShade.i4G);
    ACDK_LOGD("rPWBDefaultGain.rShade.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rShade.i4B);
    ACDK_LOGD("rPWBDefaultGain.rTwilight.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rTwilight.i4R);
    ACDK_LOGD("rPWBDefaultGain.rTwilight.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rTwilight.i4G);
    ACDK_LOGD("rPWBDefaultGain.rTwilight.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rTwilight.i4B);
    ACDK_LOGD("rPWBDefaultGain.rFluorescent.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rFluorescent.i4R);
    ACDK_LOGD("rPWBDefaultGain.rFluorescent.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rFluorescent.i4G);
    ACDK_LOGD("rPWBDefaultGain.rFluorescent.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rFluorescent.i4B);
    ACDK_LOGD("rPWBDefaultGain.rWarmFluorescent.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rWarmFluorescent.i4R);
    ACDK_LOGD("rPWBDefaultGain.rWarmFluorescent.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rWarmFluorescent.i4G);
    ACDK_LOGD("rPWBDefaultGain.rWarmFluorescent.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rWarmFluorescent.i4B);
    ACDK_LOGD("rPWBDefaultGain.rIncandescent.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rIncandescent.i4R);
    ACDK_LOGD("rPWBDefaultGain.rIncandescent.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rIncandescent.i4G);
    ACDK_LOGD("rPWBDefaultGain.rIncandescent.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rIncandescent.i4B);
    ACDK_LOGD("rPWBDefaultGain.rGrayWorld.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rGrayWorld.i4R);
    ACDK_LOGD("rPWBDefaultGain.rGrayWorld.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rGrayWorld.i4G);
    ACDK_LOGD("rPWBDefaultGain.rGrayWorld.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPWBDefaultGain.rGrayWorld.i4B);

    ACDK_LOGD("rPreferenceColor.rTungsten.i4SliderValue = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPreferenceColor.rTungsten.i4SliderValue);
    ACDK_LOGD("rPreferenceColor.rTungsten.i4OffsetThr = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPreferenceColor.rTungsten.i4OffsetThr);
    ACDK_LOGD("rPreferenceColor.rWarmFluorescent.i4SliderValue = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPreferenceColor.rWarmFluorescent.i4SliderValue);
    ACDK_LOGD("rPreferenceColor.rWarmFluorescent.i4OffsetThr = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPreferenceColor.rWarmFluorescent.i4OffsetThr);
    ACDK_LOGD("rPreferenceColor.rShade.i4SliderValue = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPreferenceColor.rShade.i4SliderValue);
    ACDK_LOGD("rPreferenceColor.rShade.i4OffsetThr = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPreferenceColor.rShade.i4OffsetThr);

    ACDK_LOGD("rAWBNVRAM.rAlgoTuningParam.bAWBBackupEnable = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoTuningParam.bAWBBackupEnable);
    ACDK_LOGD("rAWBNVRAM.rAlgoTuningParam.rAWBGain_LSC.i4R = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rAWBGain_LSC.i4R);
    ACDK_LOGD("rAWBNVRAM.rAlgoTuningParam.rAWBGain_LSC.i4G = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rAWBGain_LSC.i4G);
    ACDK_LOGD("rAWBNVRAM.rAlgoTuningParam.rAWBGain_LSC.i4B = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rPredictorGain.rAWBGain_LSC.i4B);
    ...
    ACDK_LOGD("rAWBNVRAM.rAlgoTuningParam.rFeaturePropThr.rSunsetProp.i4LVThr = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoTuningParam.rFeaturePropThr.rSunsetProp.i4LVThr_L);

    ACDK_LOGD("rCCTEstimation.i4CCT[0] = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCCTEstimation.i4CCT[0]);
    ACDK_LOGD("rCCTEstimation.i4CCT[1] = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCCTEstimation.i4CCT[1]);
    ACDK_LOGD("rCCTEstimation.i4CCT[2] = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCCTEstimation.i4CCT[2]);
    ACDK_LOGD("rCCTEstimation.i4CCT[3] = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCCTEstimation.i4CCT[3]);
    ACDK_LOGD("rCCTEstimation.i4CCT[4] = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCCTEstimation.i4CCT[4]);

    ACDK_LOGD("rCCTEstimation.i4RotatedXCoordinate[0] = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCCTEstimation.i4RotatedXCoordinate[0]);
    ACDK_LOGD("rCCTEstimation.i4RotatedXCoordinate[1] = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCCTEstimation.i4RotatedXCoordinate[1]);
    ACDK_LOGD("rCCTEstimation.i4RotatedXCoordinate[2] = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCCTEstimation.i4RotatedXCoordinate[2]);
    ACDK_LOGD("rCCTEstimation.i4RotatedXCoordinate[3] = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCCTEstimation.i4RotatedXCoordinate[3]);
    ACDK_LOGD("rCCTEstimation.i4RotatedXCoordinate[4] = %d\n", rAWBNVRAM[AWB_NVRAM_IDX_VHDR].rAlgoCalParam.rCCTEstimation.i4RotatedXCoordinate[4]);
