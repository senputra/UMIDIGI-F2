...
public:
     ...
     */
    MRESULT configPdoHW(MINT32 i4SensorDev);
    /**
     * @brief start pd mgr.
     */
    EPDBuf_Type_t start(MINT32 i4SensorDev, MINT32 i4SensorIdx, SPDProfile_t *iPDProfile, MUINT32 uPdPipeCtrl);
    /**
     * @brief stop pd mgr.
     */
     ...
     */
    MRESULT setPDCaliData(MINT32 i4SensorDev, MVOID *ptrInTuningData, MVOID *ptrInCaliData, MINT32 &i4OutInfoSz, MINT32 **ptrOutInfo);
    /**
     ...
     * @brief pdo merge
     */
    MINT32 PDOMerge(MINT32 i4SensorDev, MVOID *ptrInPDOData, SPDOBUFINFO_T &outsPDOBuf);
