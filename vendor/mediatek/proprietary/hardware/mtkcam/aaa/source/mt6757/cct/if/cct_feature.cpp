...
)
{
    ...
    case ACDK_CCT_OP_DEV_AE_APPLY_INFO:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAEApplyNVRAMParam(mSensorDev, (VOID *)puParaIn);
        break;
    ...
    case ACDK_CCT_V2_OP_AWB_APPLY_CAMERA_PARA2:
        err = NS3Av3::IAwbMgr::getInstance().CCTOPAWBApplyNVRAMParam(mSensorDev, (VOID *)puParaIn);
        break;
    ...
    case ACDK_CCT_V2_OP_AF_APPLY:
        err = NS3Av3::IAfMgr::getInstance().CCTOPAFApplyNVRAMParam(mSensorDev, (VOID *)puParaIn);
        break;
