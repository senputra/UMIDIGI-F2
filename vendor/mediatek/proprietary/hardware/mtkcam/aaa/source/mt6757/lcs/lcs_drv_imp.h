...
public:
    ...
    /**
       ...
       */
    virtual MVOID SetLCSInfo(MINT32 i4FrmId, const MINTPTR aLCS_info);
...
protected:
    typedef List<LCS_ISP_INFO_T> LCS_info_List_T;
    LCS_info_List_T        m_rLCS_info_Queue;
    MUINT32                m_u4Capacity;
    MINT32                 m_i4LastFrmId;
    Mutex                  m_Lock;

private:
    virtual MVOID       clearList();
    virtual MINT32      updateLCSList(MINT32 i4FrmId, const LCS_ISP_INFO_T& rLCSinfo);
public:
    virtual MINT32      getLCSList_info(MINT32 i4FrmId, LCS_ISP_INFO_T& rLCSinfo);
    virtual MINT32      getLCSListLast(LCS_ISP_INFO_T& rLCSinfo);
    virtual LCS_ISP_INFO_T*   getLCSList_info(MINT32 i4FrmId);  /*be careful to get refernce! must be protected by mutex*/
};
