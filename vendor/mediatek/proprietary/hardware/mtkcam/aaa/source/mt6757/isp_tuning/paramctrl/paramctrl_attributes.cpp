...
setAWBInfo(AWB_INFO_T const &rAWBInfo)
{
  ...
  // Evaluate CCM index
     ...
     if ( checkParamChange(eIdx_CCM_old, eIdx_CCM_new) )
     {
                ...
                CAM_LOGD_IF(m_bDebugEnable, "[setAWBInfo][ParamChangeCount:%d]" "CCM index(old, new) =(%d, %d)", getParamChangeCount(), eIdx_CCM_old, eIdx_CCM_new);
     }
    ...
    if ((m_rIspCamInfo.eIspProfile == EIspProfile_iHDR_Preview) ||
       ...
       (m_rIspCamInfo.eIspProfile == EIspProfile_iHDR_Preview_VSS)                 ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_zHDR_Preview_VSS)                 ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_mHDR_Preview_VSS)                 ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_iHDR_Video_VSS)                   ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_zHDR_Video_VSS)                   ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_mHDR_Video_VSS)                   ||
        (m_rIspCamInfo.eIspProfile == EIspProfile_zHDR_Capture) ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_mHDR_Capture)                     ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_iHDR_Preview)                ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_zHDR_Preview)                ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_mHDR_Preview)                ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_iHDR_Video)                  ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_zHDR_Video)                  ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_mHDR_Video)                  ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_iHDR_Preview_VSS)            ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_zHDR_Preview_VSS)            ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_mHDR_Preview_VSS)            ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_iHDR_Video_VSS)              ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_zHDR_Video_VSS)              ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_mHDR_Video_VSS)              ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_zHDR_Capture)                ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_Auto_mHDR_Capture)                ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_zHDR_Capture_MFNR_Before_Blend)   ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_zHDR_Capture_MFNR_Single)         ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_zHDR_Capture_MFNR_MFB)            ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_zHDR_Capture_MFNR_After_Blend)    ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_iHDR_Preview)                 ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_zHDR_Preview)                 ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_mHDR_Preview)                 ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_iHDR_Video)                   ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_zHDR_Video)                   ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_mHDR_Video)                   ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_Auto_iHDR_Preview)            ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_Auto_zHDR_Preview)            ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_Auto_mHDR_Preview)            ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_Auto_iHDR_Video)              ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_Auto_zHDR_Video)              ||
       (m_rIspCamInfo.eIspProfile == EIspProfile_EIS_Auto_mHDR_Video)) {
    ...
    if  ( checkParamChange(eIdx_PCA_LUT_old, eIdx_PCA_LUT_new) )
    {
        ...
        CAM_LOGD_IF(m_bDebugEnable, "[setAWBInfo][ParamChangeCount:%d]" "PCA LUT index(old, new) =(%d, %d)", getParamChangeCount(), eIdx_PCA_LUT_old, eIdx_PCA_LUT_new);
    }
    ...
    if  ( checkParamChange(eIdx_ANR_TBL_old, eIdx_ANR_TBL_new) )
    {
        ...
        CAM_LOGD("[setAWBInfo][ParamChangeCount:%d]" "ANR CT index(old, new) =(%d, %d)", getParamChangeCount(), eIdx_ANR_TBL_old, eIdx_ANR_TBL_new);
    }
...
setAEInfo(AE_INFO_T const &rAEInfo_)
{
    ...
    {
        rAEInfo.u4RealISOValue = m_pIspTuningCustom->remap_ISP_ISO_with_LV(m_rIspIsoEnv, rAEInfo.i4LightValue_x10, rAEInfo.u4RealISOValue, 1);
    }
    ...
    if (checkParamChange(m_rIspCamInfo.u4ISOValue, rAEInfo.u4RealISOValue)) {
        CAM_LOGD_IF(m_bDebugEnable, "[+m_rIspCamInfo.u4ISOValue](old, new)=(%d, %d)", m_rIspCamInfo.u4ISOValue, rAEInfo.u4RealISOValue);
    ...
    if (checkParamChange(m_rIspCamInfo.i4LightValue_x10, rAEInfo.i4LightValue_x10)) {
        CAM_LOGD_IF(m_bDebugEnable, "[+m_rIspCamInfo.i4LightValue_x10](old, new)=(%d, %d)", m_rIspCamInfo.i4LightValue_x10, rAEInfo.i4LightValue_x10);
        m_rIspCamInfo.i4LightValue_x10 = rAEInfo.i4LightValue_x10;

        CAM_LOGD_IF(m_bDebugEnable, "LV value(%d)",rAEInfo.i4LightValue_x10);
    }
    ...
    get_ISOIdx_neighbor(m_rIspCamInfo, m_rIspCamInfo.eIdx_ISO, m_rIspCamInfo.u4ISOValue);
    return  MERR_OK;
}
...
{
    MUINT32 t_low = 0, t_high = m_rIspIsoEnv.u2Length - 1;

    MUINT32 t_Iso = u4Iso;
    MUINT32 t_ceiling =m_rIspIsoEnv.IDX_Part_Middle[t_high];
    ...
    while ( (t_low <= t_high) && (t_high > 1) )
    {
        ...
        MUINT32 t_u4mid = m_rIspIsoEnv.IDX_Part_Middle[t_mid];

        if ( (t_Iso < t_u4mid) && (t_Iso >= m_rIspIsoEnv.IDX_Part_Middle[t_mid-1]) )
        {
    ...
    if (t_high < 2){
        if ( (t_Iso < m_rIspIsoEnv.IDX_Part_Middle[t_high]) && (t_Iso >= m_rIspIsoEnv.IDX_Part_Middle[t_low])){
...
map_ISO_index2value(EIndex_ISO_T const eIdx) const
{
    ...
    if(tIdx>(m_rIspIsoEnv.u2Length-1))
        tIdx = (EIndex_ISO_T)(m_rIspIsoEnv.u2Length-1);

    return (MUINT32)m_rIspIsoEnv.IDX_Partition[tIdx];
}
...
{
      if (u4Iso < m_rIspIsoEnv.IDX_Partition[IsoIdx]){
        ...
        rIspCamInfo.eIdx_ISO_L = IsoIdx;

        if(IsoIdx < (m_rIspIsoEnv.u2Length-1)){
            rIspCamInfo.eIdx_ISO_U = static_cast<EIndex_ISO_T>(IsoIdx + 1);
        }
        else{
            rIspCamInfo.eIdx_ISO_U = static_cast<EIndex_ISO_T>(m_rIspIsoEnv.u2Length-1);
        }
      }
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
{
    CAM_LOGD_IF(m_bDebugEnable, "setFlashDynamicInfo(%d)", i4FlashOnOff);
...
sendIspTuningIOCtrl(MUINT32 ctrl, MINTPTR arg1, MINTPTR arg2)
{
    ...
    case IspTuningMgr::E_ISPTUNING_GET_ISP_GAMMA:
        ...
        break;
    case IspTuningMgr::E_ISPTUNING_SET_RAW_FMT_MONO:
        m_bMono = arg1;
        break;
    case IspTuningMgr::E_ISPTUNING_NOTIFY_SENSOR_TYPE:
        ...
        ISP_MGR_BNR2_T::getInstance(m_eSensorDev).setPDSensorInfo((arg1 == SENSOR_RAW_PD ? MTRUE : MFALSE));
            ...
            if(!NvBufUtil::getInstance().getBufAndRead(CAMERA_DATA_PDC_TABLE, m_eSensorDev, (void*&)buf, 1))
