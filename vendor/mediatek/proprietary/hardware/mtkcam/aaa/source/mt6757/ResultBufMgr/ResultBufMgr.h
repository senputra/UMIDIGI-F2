...
public:
    ...
    virtual Result_T*   getResult(MINT32 i4FrmId);  /*be careful to get refernce! must be protected by mutex*/
    virtual MVOID       updateCapacity(MUINT32 u4FrmId);
    virtual MVOID updateRepeatQueue(MINT32 maginNum);
    virtual MBOOL queryRepeatQueue(MINT32 maginNum);
    virtual MBOOL isRepeatQueueEmpty();

protected:
    virtual MVOID clearRepeatQueue();
    typedef List<Result_T> ResultList_T;
    List<MINT32>        m_rRepeatResultQueue;
