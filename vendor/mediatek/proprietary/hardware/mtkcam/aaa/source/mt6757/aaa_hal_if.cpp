...
********************************************************************************/
Hal3AIf*
Hal3AIf::createInstance(MINT32 const i4SensorOpenIndex, E_FlowControl_Type eType, MINT32 i4SubsampleCount)
{
    CAM_LOGD("[%s] sensoridx(%d)", __FUNCTION__, i4SensorOpenIndex);
    switch (eType)
    {
    case Hal3AIf::E_FlowControl_Type_SMVR:
        return Hal3AFlowCtrl_SMVR::createInstance(i4SensorOpenIndex, i4SubsampleCount);
...
void NS3Av3::UtilConvertCamInfo(const NSIspTuning::RAWIspCamInfo_U& rCamInfoU, NSIspTuning::RAWIspCamInfo& rCamInfoT)
{
    ...
    rCamInfoT.eIdx_ANR_TBL_CT       = rCamInfoU.eIdx_ANR_TBL_CT         ;
    rCamInfoT.eIdx_ANR_TBL_ISO      = rCamInfoU.eIdx_ANR_TBL_ISO        ;
...
//    rCamInfoT.rColorCorrectionTransform = rCamInfoU.rColorCorrectionTransform;
    ...
    rCamInfoT.fgRWBSensor           = rCamInfoU.fgRWBSensor             ;
}
void NS3Av3::UtilConvertCamInfo(const NSIspTuning::RAWIspCamInfo& rCamInfoT, NSIspTuning::RAWIspCamInfo_U& rCamInfoU)
{
    ...
    rCamInfoU.eIdx_ANR_TBL_CT       = rCamInfoT.eIdx_ANR_TBL_CT         ;
    rCamInfoU.eIdx_ANR_TBL_ISO      = rCamInfoT.eIdx_ANR_TBL_ISO        ;
...
//    rCamInfoU.rColorCorrectionTransform = rCamInfoT.rColorCorrectionTransform;
    ...
    rCamInfoU.fgRWBSensor           = rCamInfoT.fgRWBSensor             ;
}
