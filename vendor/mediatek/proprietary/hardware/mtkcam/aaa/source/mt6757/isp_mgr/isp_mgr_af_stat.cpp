...
MVOID
ISP_MGR_AF_STAT_CONFIG_T::
init(MUINT32 eSensorDev)
{
    CAM_LOGD("[%s] +", __FUNCTION__);
    #if defined(MTKCAM_CMDQ_SUPPORT)
    if (m_pCqTuningMgr == NULL)
    {
        m_pCqTuningMgr = (CqTuningMgr*)CqTuningMgr::getInstance(eSensorDev);
...
MBOOL
ISP_MGR_AF_STAT_CONFIG_T::
config(AF_CONFIG_T &a_sAFConfig, AREA_T &sOutHWROI, MINT32 &i4OutHWBlkNumX, MINT32 &i4OutHWBlkNumY, MINT32 &i4OutHWBlkSizeX, MINT32 &i4OutHWBlkSizeY)
{
