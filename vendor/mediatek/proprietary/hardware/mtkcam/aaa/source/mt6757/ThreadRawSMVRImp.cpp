...
*******************************************************************************/
MVOID
ThreadRawSMVRImp::changeFLKThreadSetting()
{
    // (1) set name
...
*******************************************************************************/
MVOID*
ThreadRawSMVRImp::onFLKThreadLoop(MVOID *arg)
{

    MY_LOGD("[%s] +" ,__FUNCTION__);
    MY_LOGD("[FLKThread] tid: %d \n", gettid());
...
MVOID
ThreadRawSMVRImp::triggerFLKThread(StatisticBufInfo* rBufInfo)
{
...
*******************************************************************************/
MVOID
ThreadRawSMVRImp::enableFLKThread()
{
...
*******************************************************************************/
MVOID
ThreadRawSMVRImp::disableFLKThread()
{
