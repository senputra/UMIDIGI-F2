...
MVOID
CcmMgr::
calculateCCM(ISP_CCM_INFO_T& ccm_info, AWB_INFO_T const& rAWBInfo, MBOOL bWithPreferenceGain, MINT32 i4FlashOnOff, MINT32 i4SmoothMethod, MBOOL bRWBSensor, MINT32 ProMehod, MINT32 ProMax)
{
    {
    if (bWithPreferenceGain)
        SmoothCCM(m_rCCMInput, rAWBInfo.rCurrentAWBGain, 3, 9, m_rISPMultiCCM, ccm_info.rCCM, ccm_info.rCCMWeight, i4FlashOnOff, i4SmoothMethod, ProMehod, ProMax);
    else
            SmoothCCM(m_rCCMInput, rAWBInfo.rCurrentFullAWBGain, 3, 9, m_rISPMultiCCM, ccm_info.rCCM, ccm_info.rCCMWeight, i4FlashOnOff, i4SmoothMethod, ProMehod, ProMax);
    }
    ...
    {
        if (bWithPreferenceGain)
        SmoothCCM(rAWBInfo.rCurrentAWBGain, 3, 9, m_rISPMultiCCM, ccm_info.rCCM, ccm_info.rCCMWeight, i4FlashOnOff, i4SmoothMethod, ProMehod, ProMax);
        else
            SmoothCCM(rAWBInfo.rCurrentFullAWBGain, 3, 9, m_rISPMultiCCM, ccm_info.rCCM, ccm_info.rCCMWeight, i4FlashOnOff, i4SmoothMethod, ProMehod, ProMax);    
    }
#endif
}
