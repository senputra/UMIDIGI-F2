...
class ISP_MGR_RMM_DEV : public ISP_MGR_RMM_T
{
public:
    static
    ISP_MGR_RMM_T&
    getInstance()
    {
        static ISP_MGR_RMM_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_RMM_DEV()
        : ISP_MGR_RMM_T(eSensorDev)
    {}

    virtual ~ISP_MGR_RMM_DEV() {}
...
template <ESensorDev_T const eSensorDev>
class ISP_MGR_RMM2_DEV : public ISP_MGR_RMM2_T
{
public:
    static
    ISP_MGR_RMM2_T&
    getInstance()
    {
        static ISP_MGR_RMM2_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_RMM2_DEV()
        : ISP_MGR_RMM2_T(eSensorDev)
    {}

    virtual ~ISP_MGR_RMM2_DEV() {}
