...
MVOID SmoothANR2(MUINT32 u4RealISO,  // Real ISO
                MUINT32 u4UpperISO, // Upper ISO
                MUINT32 u4LowerISO, // Lower ISO
                ISP_NVRAM_ANR2_T const& rUpperANR, // ANR2 settings for upper ISO
                ISP_NVRAM_ANR2_T const& rLowerANR,   // ANR2 settings for lower ISO
...
MVOID SmoothNR3D(MUINT32 u4RealISO,  // Real ISO
               MUINT32 u4UpperISO, // Upper ISO
               MUINT32 u4LowerISO, // Lower ISO
               ISP_NVRAM_NR3D_T const& rUpperNR3D, // EE settings for upper ISO
               ISP_NVRAM_NR3D_T const& rLowerNR3D,   // EE settings for lower ISO
