...
public:
    struct AFParam_T
    {
        MUINT32                 u4MagicNum;    /* request magic number */
        MUINT32                 u4MagicNumCur; /* statistic magic number */
        MUINT32                 u4AfMode;
...
public:
    ...
    virtual MVOID postToAESenThread() = 0;
    virtual MVOID enableAFThread(AfStateMgr* pAfStateMgr) = 0;
    virtual MVOID disableAFThread() = 0;
    virtual MVOID enableFLKThread() = 0;
    virtual MVOID disableFLKThread() = 0;
    virtual MVOID triggerFLKThread(StatisticBufInfo* rBufInfo) = 0;
    virtual MBOOL sendRequest(ECmd_T const eCmd, MUINTPTR const i4Arg = 0) = 0;
    virtual MVOID enableAFVsyncThread() = 0;
    virtual MVOID disableAFVsyncThread() = 0;
