...
public:
    static
    GmaMgr*
    getInstance(ISP_NVRAM_REGISTER_STRUCT& rIspNvramReg, ISP_NVRAM_GMA_TUNING_PARAM_T* pIspNvramGmaPara)
    {
    ...
    GmaMgrDev(ISP_NVRAM_REGISTER_STRUCT& rIspNvramReg, ISP_NVRAM_GMA_TUNING_PARAM_T* pIspNvramGmaPara)
...
GmaMgr*
GmaMgr::
createInstance(ESensorDev_T const eSensorDev, ISP_NVRAM_REGISTER_STRUCT& rIspNvramReg, ISP_NVRAM_GMA_TUNING_PARAM_T* pIspNvramGmaPara)
{
...
GmaMgr::GmaMgr(ESensorDev_T const eSensorDev, ISP_NVRAM_REGISTER_STRUCT& rIspNvramReg, ISP_NVRAM_GMA_TUNING_PARAM_T* pIspNvramGmaPara)
    ...
    , mfgGMA_HDR(MFALSE)
{
    ...
    CAM_LOGD_IF(1, "[%s()] m_pGmaAlgo(%p), m_eSensorDev(%d), m_pIspNvramGmaPara(%d)", __FUNCTION__, m_pGmaAlgo, m_eSensorDev, m_pIspNvramGmaPara);
...
*/
    int isp_profile = eIspProfile;
    mInInfo.eGmaProfile = (eGMA_PROFILE_T)isp_profile;
