...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    case ESensorDev_Main: //  Main Sensor
        return  ISP_MGR_SL2F_DEV<ESensorDev_Main>::getInstance();
    case ESensorDev_MainSecond: //  Main Second Sensor
        return  ISP_MGR_SL2F_DEV<ESensorDev_MainSecond>::getInstance();
    case ESensorDev_Sub: //  Sub Sensor
        return  ISP_MGR_SL2F_DEV<ESensorDev_Sub>::getInstance();
    default:
...
MBOOL
ISP_MGR_SL2F_T::
apply(const ISP_BIN_INFO_T& rBinInfo, EIspProfile_T eIspProfile, TuningMgr& rTuning, MINT32 i4SubsampleIdex)
{
    ...
    if(bSL2F_EN){
        ...
        MINT32 maxR         = _maxR(SL2_CENTR_X, SL2_CENTR_Y, rBinInfo.u4BIN_Width, rBinInfo.u4BIN_Height);
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    {
    case ESensorDev_Main: //  Main Sensor
        return  ISP_MGR_SL2G_DEV<ESensorDev_Main>::getInstance();
    case ESensorDev_MainSecond: //  Main Second Sensor
        return  ISP_MGR_SL2G_DEV<ESensorDev_MainSecond>::getInstance();
    case ESensorDev_Sub: //  Sub Sensor
        return  ISP_MGR_SL2G_DEV<ESensorDev_Sub>::getInstance();
    default:
        CAM_LOGE("eSensorDev = %d", eSensorDev);
        return  ISP_MGR_SL2G_DEV<ESensorDev_Main>::getInstance();
    }
...
apply(const CROP_RZ_INFO_T& rCropRz, EIspProfile_T eIspProfile, dip_x_reg_t* pReg)
{
    ...
    //ISP_MGR_CTL_EN_P2_T::getInstance(m_eSensorDev).setEnable_SL2G(bSL2G_EN);
...
transform_SL2(const CROP_RZ_INFO_T& rCropRz, ISP_NVRAM_SL2_T const& rParam)
{
    ...
    REG_INFO_VALUE(DIP_X_SL2H_RZ)       = (2048<<16) | 2048;
    ...
    REG_INFO_VALUE(DIP_X_SL2I_RZ)       = (2048<<16) | 2048;
...
apply(const CROP_RZ_INFO_T& rCropRz, const CROP_RZ_INFO_T& rCropRz2, EIspProfile_T eIspProfile, dip_x_reg_t* pReg)
{
    ...
    //ISP_MGR_CTL_EN_P2_T::getInstance(m_eSensorDev).setEnable_SL2B(bSL2_EN);
    //ISP_MGR_CTL_EN_P2_T::getInstance(m_eSensorDev).setEnable_SL2C(bSL2_EN);
    //ISP_MGR_CTL_EN_P2_T::getInstance(m_eSensorDev).setEnable_SL2D(bSL2_EN);
    //ISP_MGR_CTL_EN_P2_T::getInstance(m_eSensorDev).setEnable_SL2H(bSL2_EN);
    //ISP_MGR_CTL_EN_P2_T::getInstance(m_eSensorDev).setEnable_SL2I(bSL2_EN);
