...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
static std::array<MY_INST_AECONFIG, SENSOR_IDX_MAX> gConfigMultiton;
...
getInstance(MINT32 const eSensorDev)
{
    ...
    MY_INST_AECONFIG& rSingleton = gConfigMultiton[i4SensorIdx];
    std::call_once(rSingleton.onceFlag, [&]
    {
        rSingleton.instance = std::make_unique<ISP_AE_CONFIG_T>(eSensorDev);
    });
