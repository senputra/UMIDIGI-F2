...
public:
...
#if CAM3_STEREO_FEATURE_EN
    MBOOL setAWBSyncInfo(MINT32 i4SensorDev, AWB_SYNC_INPUT_N3D_T i4ZoomRatio);
#endif
    MBOOL CalSencondSensorDefaultGain(MINT32 i4SensorDev,AWB_GAIN_T &gain, MINT32 cct);

    MBOOL getAWBUnitGain(MINT32 i4SensorDev,AWB_CALIBRATION_DATA_T &a_rAWBCalData);
  ...
  MBOOL backup(MINT32 const i4SensorDev);
   ...
   MRESULT reconfigReg(MINT32 i4SensorDev, MINT32 i4SensorWidth, MINT32 i4SensorHeight, AWBResultConfig_T *pResultConfig);
