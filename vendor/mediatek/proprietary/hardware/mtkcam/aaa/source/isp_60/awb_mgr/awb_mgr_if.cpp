...
MRESULT IAwbMgr::reconfigReg(MINT32 i4SensorDev, MINT32 i4SensorWidth, MINT32 i4SensorHeight, AWBResultConfig_T *pResultConfig)
{
  MINT32 ret_main, ret_sub, ret_main2, ret_sub2;
   ret_main = ret_sub = ret_main2 = ret_sub2 = S_AWB_OK;

   if (i4SensorDev & ESensorDev_Main)
       ret_main = AwbMgr::getInstance(ESensorDev_Main).reconfigReg(i4SensorWidth, i4SensorHeight, pResultConfig);
   if (i4SensorDev & ESensorDev_Sub)
       ret_sub = AwbMgr::getInstance(ESensorDev_Sub).reconfigReg(i4SensorWidth, i4SensorHeight, pResultConfig);
   if (i4SensorDev & ESensorDev_MainSecond)
       ret_main2 = AwbMgr::getInstance(ESensorDev_MainSecond).reconfigReg(i4SensorWidth, i4SensorHeight, pResultConfig);
   if (i4SensorDev & ESensorDev_SubSecond)
       ret_sub2 = AwbMgr::getInstance(ESensorDev_SubSecond).reconfigReg(i4SensorWidth, i4SensorHeight, pResultConfig);
