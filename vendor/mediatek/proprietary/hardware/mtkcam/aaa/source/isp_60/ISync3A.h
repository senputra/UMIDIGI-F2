...
public:
     ...
     */
    virtual MINT32 syncAF(MINT32 i4Sensor, MBOOL initLens = 0, MBOOL bIsDataSync = 0) = 0;
    ...
    virtual MINT32 getAFMasterDev() const = 0;

    virtual MINT32 getAFSlaveDev() const = 0;
...
public:
    ...
    enum ESync3ACtrl_T
    {
        ESync3ACtrl_SetIsStart = 0,
        ESync3ACtrl_GetIsStart = 1,
    };
    ...
    virtual MINT32 sendSync3ACtrl(ESync3ACtrl_T eSync3ACtrl, MINTPTR iArg1, MINTPTR iArg2) = 0;

    virtual MINT32 isUninitSync(MINT32 i4Sensor, Stereo_Param_T const &rNewParam) = 0;
