...
initStt(MINT32 i4SensorDevId, MINT32 i4SensorOpenIndex, const ConfigInfo_T& rConfigInfo)
{
    ...
    m_i4SttPortEnable = property_get_int32("vendor.debug.stt_flow.enable", 31);
    //m_i4SensorDev = i4SensorDevId;
    //m_i4SensorIdx = i4SensorOpenIndex;
     ...
     ********************************/
    {
        ...
        CAM_LOGD("[%s] Statistic Pipe config, enable_AFO = %d, enable_FLK = %d, SensorIdx = %d, CamFeatureMode = %d\n", __FUNCTION__, (int)enable_AFO, (int)enable_FLK, m_i4SensorIdx, m_rConfigInfo.i4CamFeatureMode);
        ...
        if(m_rConfigInfo.i4CamFeatureMode == 0)
