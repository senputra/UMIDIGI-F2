...
LOCAL_SRC_FILES += isp_config/isp_awb_config.cpp
...
LOCAL_SRC_FILES += ae_mgr/AeFlow/AeFlowCustom.cpp
...
LOCAL_SRC_FILES += isp_config/isp_ae_config.cpp
...
LOCAL_SRC_FILES += $(MTKCAM_3A_AFMGR_PATH)/af_mgr_private.cpp
...
LOCAL_SRC_FILES += $(MTKCAM_3A_AFMGR_PATH)/CxUAF/af_cxu_if.cpp
LOCAL_SRC_FILES += $(MTKCAM_3A_AFMGR_PATH)/CxUAF/af_cxu_flow.cpp
LOCAL_SRC_FILES += $(MTKCAM_3A_AFMGR_PATH)/CxUAF/af_cpu_imp.cpp
LOCAL_SRC_FILES += $(MTKCAM_3A_AFMGR_PATH)/CxUAF/af_ccu_imp.cpp
...
LOCAL_SHARED_LIBRARIES += libmtkcam.atmseventmgr
#
...
LOCAL_HEADER_LIBRARIES += custom_common_atms_eventmgr_headers
#-----------------------------------------------------------
#
