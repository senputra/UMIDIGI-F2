...
#include "ShadingTblTransform.h" //LSC_CALI_INFO_T, vLsc_Remap_to_Bayer0, ...
...
char gb_MT6779_ISP_ID_TEXT[ISP_ID_TEXT_LENGTH] = "6779";
...
MINT32 giCctNvramNumber[CCT_NVRAM_STRUCT_MAXIMUM][2] = {
    ...
    {  CCT_NVRAM_STRUCT_NUMBER_SLK,                   NVRAM_SLK_TBL_NUM           },
    {  CCT_NVRAM_STRUCT_NUMBER_DM,                    NVRAM_DM_TBL_NUM            },
    {  CCT_NVRAM_STRUCT_NUMBER_YNR,                   NVRAM_YNR_TBL_NUM           },
    {  CCT_NVRAM_STRUCT_NUMBER_YNR_LCE_LINK,          NVRAM_YNR_LCE_LINK_TBL_NUM  },
    {  CCT_NVRAM_STRUCT_NUMBER_YNR_FD,                NVRAM_YNR_FD_TBL_NUM        },
    {  CCT_NVRAM_STRUCT_NUMBER_CNR_CNR,               NVRAM_CNR_CNR_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_EE,                    NVRAM_EE_TBL_NUM            },
    {  CCT_NVRAM_STRUCT_NUMBER_NR3D,                  NVRAM_NR3D_TBL_NUM          },
    {  CCT_NVRAM_STRUCT_NUMBER_DSDN,                  NVRAM_DSDN_TBL_NUM          },
    {  CCT_NVRAM_STRUCT_NUMBER_OBC,                   NVRAM_OBC_TBL_NUM           },
    {  CCT_NVRAM_STRUCT_NUMBER_BPC_BPC,               NVRAM_BPC_BPC_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_BPC_CT,                NVRAM_BPC_CT_TBL_NUM        },
    {  CCT_NVRAM_STRUCT_NUMBER_BPC_PDC,               NVRAM_BPC_PDC_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_LDNR,                  NVRAM_LDNR_TBL_NUM          },
    {  CCT_NVRAM_STRUCT_NUMBER_CNR_CCR,               NVRAM_CNR_CCR_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_CNR_ABF,               NVRAM_CNR_ABF_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_LPCNR,                 NVRAM_LPCNR_TBL_NUM         },
    {  CCT_NVRAM_STRUCT_NUMBER_FUS,                   NVRAM_FUS_TBL_NUM           },
    {  CCT_NVRAM_STRUCT_NUMBER_ZFUS,                  NVRAM_ZFUS_TBL_NUM          },
    {  CCT_NVRAM_STRUCT_NUMBER_MFB,                   NVRAM_MFB_TBL_NUM           },
    {  CCT_NVRAM_STRUCT_NUMBER_MIX,                   NVRAM_MIX_TBL_NUM           },
    {  CCT_NVRAM_STRUCT_NUMBER_YNR_TBL,               NVRAM_YNR_TBL_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_YNRS,                  NVRAM_YNRS_TBL_NUM          },
    {  CCT_NVRAM_STRUCT_NUMBER_SWNR,                  NVRAM_SWNR_TBL_NUM          },
    {  CCT_NVRAM_STRUCT_NUMBER_SWNR_THRES,            NVRAM_SWNR_THRES_TBL_NUM    },
    {  CCT_NVRAM_STRUCT_NUMBER_MFNR,                  NVRAM_MFNR_TBL_NUM          },
    {  CCT_NVRAM_STRUCT_NUMBER_MFNR_THRES,            NVRAM_MFNR_THRES_TBL_NUM    },
    {  CCT_NVRAM_STRUCT_NUMBER_ClearZoom,             NVRAM_ClearZoom_TBL_NUM     },
    {  CCT_NVRAM_STRUCT_NUMBER_CA_LTM,                NVRAM_CA_LTM_TBL_NUM        },
    {  CCT_NVRAM_STRUCT_NUMBER_HFG,                   NVRAM_HFG_TBL_NUM           },
    {  CCT_NVRAM_STRUCT_NUMBER_CCM,                   NVRAM_CCM_TBL_NUM           },
    {  CCT_NVRAM_STRUCT_NUMBER_COLOR_PARAM,           NVRAM_COLOR_PARAM_TBL_NUM   },
    {  CCT_NVRAM_STRUCT_NUMBER_COLOR,                 NVRAM_COLOR_TBL_NUM         },
    ...
    {  CCT_NVRAM_STRUCT_NUMBER_GMA,                   ISP_NVRAM_GMA_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_LCE,                   ISP_NVRAM_LCE_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_DCE,                   ISP_NVRAM_DCE_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_HLR,                   ISP_NVRAM_HLR_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_LTM,                   ISP_NVRAM_LTM_TBL_NUM       },
    {  CCT_NVRAM_STRUCT_NUMBER_ISO,                   NVRAM_ISP_REGS_ISO_GROUP_NUM},
    {  CCT_NVRAM_STRUCT_NUMBER_AINR,                  NVRAM_AINR_TBL_NUM          },
    {  CCT_NVRAM_STRUCT_NUMBER_BSS,                   NVRAM_BSS_TBL_NUM           }
...
cct_getSensorStaticInfo()
{
    ...
    CAM_ULOG_ASSERT(Utils::ULog::MOD_ISP_MGR, pHalSensorList != nullptr, "[%s]: make HAL sensor list fail!", __FUNCTION__);
...
{
    ISP_MGR_OBC_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
setIspOnOff_BPC(MBOOL const fgOn)
{
    ...
    ISP_MGR_BPC_T::getInstance((MUINT32)m_eSensorEnum).setCCTBPCEnable(fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    ISP_MGR_DM_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
MVOID
CctHandle::
setIspOnOff_LDNR(MBOOL const fgOn)
{
    ISP_MGR_LDNR_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    ISP_MGR_YNR_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    ISP_MGR_GGM_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
//    EECtrl_Clip.SEEE_OVRSH_CLIP_EN = fgOn;//definition change: CAM_SEEE_CLIP_CTRL CAM+AA4H
    ...
    ISP_MGR_EE_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    ISP_MGR_CNR_T::getInstance((MUINT32)m_eSensorEnum).setCCTCNREnable(fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    ISP_MGR_COLOR::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
MVOID
CctHandle::
setIspOnOff_LPCNR(MBOOL const fgOn)
{
    ISP_MGR_LPCNR_T::getInstance((MUINT32)m_eSensorEnum).setEnable(0, fgOn);
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOGD("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    return ISP_MGR_OBC_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
{
    return  ISP_MGR_BPC_T::getInstance((MUINT32)m_eSensorEnum).isCCTBPCEnable();
}
...
{
    return  ISP_MGR_DM_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}

MBOOL
CctHandle::
getIspOnOff_LDNR() const
{
    return  ISP_MGR_LDNR_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
{
    return ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
{
    return ISP_MGR_YNR_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
{
    return  ISP_MGR_GGM_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
{
    return ISP_MGR_EE_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
{
    return ISP_MGR_CNR_T::getInstance((MUINT32)m_eSensorEnum).isCCTCNREnable();
}
...
{
    return  ISP_MGR_COLOR::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}

MBOOL
CctHandle::
getIspOnOff_LPCNR() const
{
    return  ISP_MGR_LPCNR_T::getInstance((MUINT32)m_eSensorEnum).isEnable(0);
}
...
#define SET_ISP_ON_OFF(_category)\
    case ISP_CATEGORY_##_category:\
        ...
        MY_LOGD("[setIspOnOff] < %s >", #_category);\
        break
    ...
    switch  ( u4Category )
    {
        ...
        SET_ISP_ON_OFF(LPCNR);

        default:
            MY_ERR("[setIspOnOff] Unsupported Category(%d)", u4Category);
            return  CCTIF_BAD_PARAM;
    }
    MY_LOGD("[%s] (u4Category, fgOn) = (%d, %d)", __FUNCTION__, u4Category, fgOn);
...
#define GET_ISP_ON_OFF(_category)\
    case ISP_CATEGORY_##_category:\
        MY_LOGD("[getIspOnOff] < %s >", #_category);\
    ...
    switch  ( u4Category )
    {
        ...
        GET_ISP_ON_OFF(LPCNR);

        default:
            MY_ERR("[getIspOnOff] Unsupported Category(%d)", u4Category);
            return  CCTIF_BAD_PARAM;
    }
    MY_LOGD("[%s] (u4Category, rfgOn) = (%d, %d)", __FUNCTION__, u4Category, rfgOn);
    return  CCTIF_NO_ERROR;
}
                ...
                MUINT32 *pu4RealParaOutLen )
{
    ...
    case FT_CCT_OP_AE_SET_ON_OFF:
        if (u4ParaInLen == sizeof(MBOOL)) {
            ...
            if (enable) {
                ...
                m_pIHal3A->send3ACtrl(E3ACtrl_SetOperMode, NSIspTuning::EOperMode_Normal, 0);
                IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_EnableAE, NULL, NULL, NULL, NULL);
            }
            else {
                MY_LOGD("set meta mode");
                m_pIHal3A->send3ACtrl(E3ACtrl_SetOperMode, NSIspTuning::EOperMode_Meta, 0);
                IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_DisableAE, NULL, NULL, NULL, NULL);
            }
        } else
            err = CCTIF_BAD_PARAM;
        *pu4RealParaOutLen = 0;
    ...
    case FT_CCT_OP_FLASH_GET_MODE:
        if (puParaOut != NULL) {
            MY_LOGD("ACDK_CCT_OP_FLASH_GET_INFO line=%d\n",__LINE__);
    ...
    case FT_CCT_OP_FLASH_SET_MODE:
        if (u4ParaInLen == sizeof(MINT32)) {
            MY_LOGD("ACDK_CCT_OP_FLASH_ENABLE line=%d\n",__LINE__);
                ...
                MUINT32 *pu4RealParaOutLen )
{
    ...
    case FT_CCT_OP_GET_ID:
        ...
        if ( ISP_ID_TEXT_LENGTH != u4ParaOutLen || ! pu4RealParaOutLen || ! puParaOut ) {
            ...
            *pu4RealParaOutLen = 0;
            ...
            strncpy((char *)puParaOut, gb_MT6779_ISP_ID_TEXT, ISP_ID_TEXT_LENGTH);

            *pu4RealParaOutLen = ISP_ID_TEXT_LENGTH;
            MY_LOGD("( FT_CCT_OP_GET_ID ) done, ID:%s\n", (char *)(puParaOut));
        }
        }
        break;
    case FT_CCT_OP_ISP_GET_ON_OFF:
        ...
        *pu4RealParaOutLen = sizeof(ACDK_CCT_FUNCTION_ENABLE_STRUCT);
        MY_LOGD("[-FT_CCT_OP_ISP_GET_ON_OFF] (eCategory, rfgEnable)=(%d, %d)", eCategory, rfgEnable);
        }
        break;
    case FT_CCT_OP_ISP_SET_ON_OFF:
        {
        MY_LOGD("[-FT_CCT_OP_ISP_SET_ON_OFF] size=%d, %d, %d, %p", sizeof(CCT_ISP_CATEGORY_T), sizeof(MBOOL), u4ParaInLen, puParaIn);
        ...
        *pu4RealParaOutLen = 0;
        ...
        MY_LOGD("[-FT_CCT_OP_ISP_SET_ON_OFF] eCategory(%d), err(%x)", eCategory, err);
        }
        break;
    case FT_CCT_OP_ISP_GET_CCM_FIXED_ON_OFF:
        ...
        *pu4RealParaOutLen = 0;
        ...
        dyccm = NSIspTuning::IspTuningMgr::getInstance().getDynamicCCM((MINT32)m_eSensorEnum);
        if(dyccm < 0) {
    ...
    case FT_CCT_OP_ISP_SET_CCM_FIXED_ON_OFF:
        ...
        MY_LOGD("CCM ON/OFF, DYNAMIC_BYPASS_MODE =%d", enable);

        if (enable) {
            ret = NSIspTuning::IspTuningMgr::getInstance().setDynamicCCM((MINT32)m_eSensorEnum, MFALSE);
            ret &= NSIspTuning::IspTuningMgr::getInstance().setDynamicBypass((MINT32)m_eSensorEnum, MTRUE);
        }
        else {
            ret = NSIspTuning::IspTuningMgr::getInstance().setDynamicCCM((MINT32)m_eSensorEnum, MTRUE);
            ret &= NSIspTuning::IspTuningMgr::getInstance().setDynamicBypass((MINT32)m_eSensorEnum, MFALSE);
        }
    ...
    case FT_CCT_OP_ISP_GET_CCM_MATRIX:
        ...
        *pu4RealParaOutLen = 0;
        ...
        //ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).reset();
        ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).get(ISP_MGR_CCM::ECCM_D1, ccm);
        ...
        *pu4RealParaOutLen = sizeof(ACDK_CCT_CCM_STRUCT);
        ...
        MY_LOGD("[ACDK_CCT_V2_OP_AWB_GET_CURRENT_CCM]\n");
        MY_LOGD("M11 0x%03X\n", pDst->M11);
        MY_LOGD("M12 0x%03X\n", pDst->M12);
        MY_LOGD("M13 0x%03X\n", pDst->M13);
        MY_LOGD("M21 0x%03X\n", pDst->M21);
        ...
        MY_LOGD("( FT_CCT_OP_ISP_GET_CCM_MATRIX ) done\n");
        }
        break;
    case FT_CCT_OP_ISP_SET_CCM_MATRIX:
        ...
        *pu4RealParaOutLen = 0;
        MY_LOGD("[ACDK_CCT_V2_OP_AWB_SET_CURRENT_CCM]\n");
    ...
    */
        ...
        //ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).reset();
        ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).put(ISP_MGR_CCM::ECCM_D1, rDst);
        NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
        //ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
        //NSIspTuning::ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuning::EIspProfile_NormalCapture);
        usleep(200000);
        MY_LOGD("M11 0x%03X", pSrc->M11);
        MY_LOGD("M12 0x%03X", pSrc->M12);
        MY_LOGD("M13 0x%03X", pSrc->M13);
        MY_LOGD("M21 0x%03X", pSrc->M21);
        MY_LOGD("M22 0x%03X", pSrc->M22);
        MY_LOGD("M23 0x%03X", pSrc->M23);
        MY_LOGD("M31 0x%03X", pSrc->M31);
        MY_LOGD("M32 0x%03X", pSrc->M32);
        MY_LOGD("M33 0x%03X", pSrc->M33);

        MY_LOGD("( FT_CCT_OP_ISP_SET_CCM_MATRIX ) done\n");
        }
        break;
...
//yiyi
        ...
        *pu4RealParaOutLen = sizeof(CUSTOM_NVRAM_REG_INDEX);
        ...
        MY_LOGD("FT_CCT_OP_ISP_GET_INDEX done\n");
        }
#else
        err = CCTIF_BAD_PARAM;
#endif
    ...
    case FT_CCT_OP_GET_SHADING_ON_OFF:
        ...
        *pu4RealParaOutLen = 0;
        ACDK_CCT_FUNCTION_ENABLE_STRUCT*const pShadingPara = reinterpret_cast<ACDK_CCT_FUNCTION_ENABLE_STRUCT*>(puParaOut);

        NSIspTuning::ILscMgr* pLscMgr = NSIspTuning::ILscMgr::getInstance((MUINT32)m_eSensorEnum);
        pShadingPara->Enable = pLscMgr->getOnOff();
        *pu4RealParaOutLen = sizeof(ACDK_CCT_FUNCTION_ENABLE_STRUCT);
        MY_LOGD("[%s] GET_SHADING_ON_OFF(%s)", __FUNCTION__, (pShadingPara->Enable ? "On":"Off"));
        }
        break;
    case FT_CCT_OP_SET_SHADING_ON_OFF:
        ...
        *pu4RealParaOutLen = 0;
        ACDK_CCT_FUNCTION_ENABLE_STRUCT*const pShadingPara = reinterpret_cast<ACDK_CCT_FUNCTION_ENABLE_STRUCT*>(puParaIn);

        NSIspTuning::ILscMgr* pLscMgr = NSIspTuning::ILscMgr::getInstance((MUINT32)m_eSensorEnum);
        pLscMgr->setOnOff(pShadingPara->Enable);
        pLscMgr->updateLsc();

        MY_LOGD("[%s] SET_SHADING_ON_OFF(%s)", __FUNCTION__, (pShadingPara->Enable ? "On":"Off"));
        }
        break;
    case FT_CCT_OP_GET_SHADING_INDEX:
        ...
        *pShadingIndex = pLscMgr->getCTIdx();
        ...
        MY_LOGD("[%s] GET_SHADING_INDEX(%d)", __FUNCTION__, *pShadingIndex);
    ...
    case FT_CCT_OP_SET_SHADING_INDEX:
        ...
        *pu4RealParaOutLen = 0;
        ...
        MY_LOGD("[%s] SET_SHADING_INDEX(%d)", __FUNCTION__, u4CCT);
    ...
    case FT_CCT_OP_GET_SHADING_TSF_ON_OFF:
        ...
        UINT32 u4OnOff;
        *pu4RealParaOutLen = 0;
        MY_LOGD("[%s] + GET_SHADING_TSF_ONOFF", __FUNCTION__);

        NSIspTuning::ILscMgr* pLscMgr = NSIspTuning::ILscMgr::getInstance((MUINT32)m_eSensorEnum);
        u4OnOff = pLscMgr->getTsfOnOff();
        *(reinterpret_cast<UINT32*>(puParaOut)) = u4OnOff;

        MY_LOGD("[%s] - GET_SHADING_TSF_ONOFF(%d)", __FUNCTION__, u4OnOff);
        }
        break;
    case FT_CCT_OP_SET_SHADING_TSF_ON_OFF:
        ...
        *pu4RealParaOutLen = 0;
        MY_LOGD("[%s] + SET_SHADING_TSF_ONOFF(%d)", __FUNCTION__, u4OnOff);

        NSIspTuning::ILscMgr* pLscMgr = NSIspTuning::ILscMgr::getInstance((MUINT32)m_eSensorEnum);
        pLscMgr->setTsfOnOff(u4OnOff);

        MY_LOGD("[%s] - SET_SHADING_TSF_ONOFF", __FUNCTION__);
        }
        break;
    default:
        MY_LOGD("Not support cmd %d", (int)op);
...
cctNvram_GetNvramStruct(MINT32 inSize, MINT32 *pInBuf, MINT32 outSize, MINT32 *pOutBuf, MINT32 *pRealOutSize)
{
    *pRealOutSize = 0;
    if(inSize == 0)
    {
        MY_LOGD("[%s] get all NVRAM structure parameters", __FUNCTION__);
        int output_count = CCT_NVRAM_STRUCT_MAXIMUM;
        int output_size = output_count * sizeof(MINT32);
        if( outSize < output_size )
        {
            MY_LOGE("[%s] outSize too small (%d, %d)", __FUNCTION__, outSize, output_size);
            return CCTIF_BAD_PARAM;
        }
    ...
    {
        //partial modules
        MY_LOGE("[%s] partial modules not support", __FUNCTION__);
        return CCTIF_BAD_PARAM;
    }
    return 0;
}
...
cct_HandleEmcamOp(CCT_OP_ID op,
                    ...
                    MUINT32 *pu4RealParaOutLen )
{
    MY_LOGD("[%s] op(%x), u4ParaInLen(%d), puParaIn(%p), (*puParaIn)(%d), u4ParaOutLen(%d), puParaOut(%p), pu4RealParaOutLen(%p)", __FUNCTION__, \
      op, u4ParaInLen, puParaIn, (MINT32 *)puParaIn, u4ParaOutLen, puParaOut, pu4RealParaOutLen);
        ...
        *pu4RealParaOutLen = 0;
        ...
        if (u4ParaInLen == sizeof(MINT32) && puParaIn != NULL)
        {
            ...
            if(manualPos > af_range.i4InfPos && manualPos < af_range.i4MacroPos){
                MY_LOGD("manualPos:(%d) is in the manual range, move to the manual pos",manualPos);
                ...
                MY_LOGE("manualPos:(%d) is out of the manual range!!! It will do AF and move to best pos",manualPos);
                err = NS3Av3::IAfMgr::getInstance(mSensorDev).CCTOPAFOpeartion();
                if( err != S_AF_OK ){
                    MY_LOGE("[%s] CCTOPMFOpeartion failed", __FUNCTION__);
                    break;
    ...
    case FT_CCT_OP_AE_BRECKET_STEP:
        *pu4RealParaOutLen = 0;
        ...
        {
            i32In = (MINT32 *) puParaIn;
            MY_LOGD("setAEEVCompIndex : %d (x 0.1ev)", *i32In);
            IAeMgr::getInstance().setAEEVCompIndex(mSensorDev, *i32In, 0.1f);
            //
            sResult = android::String8::format("Result=OK\n");
            saveResult(sResult);
        }
    ...
    case FT_CCT_OP_AE_BRECKET_STEP_HIGH_PERSION_EV:
        *pu4RealParaOutLen = 0;
        MY_LOGD("FT_CCT_OP_AE_BRECKET_STEP_HIGH_PERSION_EV");
        if(u4ParaInLen == sizeof(MINT32) && puParaIn != NULL)
        {
            //get realISO
            AE_DEVICES_INFO_T rDeviceInfo;
            IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_GetSensorDeviceInfo, reinterpret_cast<MINTPTR>(&rDeviceInfo), NULL, NULL, NULL);
            MINT64 isoBase = rDeviceInfo.u4MiniISOGain;

            //get current EV value
            CCU_strAEOutput aeOutput;
            i32In = (MINT32 *) puParaIn;
            IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_GetCapDiffEVState, *i32In, reinterpret_cast<MINTPTR>(&aeOutput), NULL, NULL);
            MY_LOGD("EAECtrl_GetCapDiffEVState : %d (x 0.001ev)", *i32In);
            //set EVValue
            //AE off
            {
                MUINT32 aeMode = MTK_CONTROL_AE_MODE_OFF;
                IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_SetAEMode, aeMode, MTRUE, NULL, NULL);
                MY_LOGD("set MTK_CONTROL_AE_MODE (OFF)");
            }
            AE_SENSOR_PARAM_T strSensorParams;
            strSensorParams.u4Sensitivity   = ( MUINT32 )( ( MINT64 ) aeOutput.EvSetting.u4AfeGain*aeOutput.EvSetting.u4IspGain*isoBase/1024/4096); //ISP6: must /4096, ISP5 & older: must / 1024
            strSensorParams.u8ExposureTime  = ((MUINT64) aeOutput.EvSetting.u4Eposuretime)*1000;
            //strSensorParams.u8FrameDuration = rNewParam.i8FrameDuration;
            MY_LOGD("rDeviceInfo.u4MiniISOGain(%d), aeOutput: EvSetting.u4AfeGain(%d) EvSetting.u4IspGain(%d) ", rDeviceInfo.u4MiniISOGain, aeOutput.EvSetting.u4AfeGain, aeOutput.EvSetting.u4IspGain);
            ...
            IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_SetSensorParams, reinterpret_cast<MINTPTR>(&(strSensorParams)), NULL, NULL, NULL);
            //
            ...
            err = IAeMgr::getInstance().getAEInfo(mSensorDev, AEPerframeInfo);
            //
            acdk_ae_cfg.u4ExposureMode = 0;
            acdk_ae_cfg.u4Eposuretime = AEPerframeInfo.rAEISPInfo.u8P1Exposuretime_ns / 1000;
            acdk_ae_cfg.u4GainMode = 0;
            acdk_ae_cfg.u4AfeGain = AEPerframeInfo.rAEISPInfo.u4P1SensorGain;
            acdk_ae_cfg.u4IspGain = AEPerframeInfo.rAEISPInfo.u4P1DGNGain;
            acdk_ae_cfg.u4ISO = AEPerframeInfo.rAEISPInfo.u4P1RealISOValue;
            acdk_ae_cfg.u2FrameRate = AEPerframeInfo.rAEUpdateInfo.u2FrameRate_x10;
            acdk_ae_cfg.u2CaptureFlareGain = AEPerframeInfo.rAEISPInfo.i2FlareGain;
            acdk_ae_cfg.u2CaptureFlareValue = AEPerframeInfo.rAEISPInfo.i2FlareOffset;
            //
    ...
    case FT_CCT_OP_AF_SET_AFMODE:
        *pu4RealParaOutLen = 0;
        ...
        if(u4ParaInLen == sizeof(MINT32) && puParaIn != NULL)
        {
            ...
            err = NS3Av3::IAfMgr::getInstance(mSensorDev).setAFMode(mSensorDev, *i32In);
            if( err != S_AF_OK ){
    ...
    case FT_CCT_OP_AE_SET_AE_MODE:
        *pu4RealParaOutLen = 0;
        ...
        if(u4ParaInLen == sizeof(MINT32) && puParaIn != NULL)
        {
            ...
            err = NS3Av3::IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_SetAEMode, *i32In, MTRUE, NULL, NULL);
            if( err != S_AF_OK ){
    ...
    case FT_CCT_OP_AF_FULL_SCAN_TRIGGER: {
        *pu4RealParaOutLen = 0;
        ...
        err = NS3Av3::IAfMgr::getInstance(mSensorDev).setFullScanstep(i4FullScanStep);
        err = NS3Av3::IAfMgr::getInstance(mSensorDev).CCTOPAFOpeartion();
    ...
    case FT_CCT_OP_AF_SET_AREA:
        ...
        *pu4RealParaOutLen = 0;
        if(u4ParaInLen == sizeof(MINT32) && puParaIn != NULL)
        {
            ...
            {
#if 0 //FIX 3A API
                err = NS3Av3::IAfMgr::getInstance(mSensorDev).CCTOPAFSetAfArea(*i32In);
#endif
    ...
    case FT_CCT_OP_AE_APPLY_CAPTURE_AE_PARAM:
        ...
        if(u4ParaInLen == sizeof(MINT32) && puParaIn != NULL)
        {
            ...
            acdk_ae_cfg.u2CaptureFlareValue = AEPerframeInfo.rAEISPInfo.i2FlareOffset;
            //
            strSensorParams.u4Sensitivity   = acdk_ae_cfg.u4ISO;
            strSensorParams.u8ExposureTime  = ((MINT64)acdk_ae_cfg.u4Eposuretime)*1000;
            //
            ...
            else    //sensor gain
            {
                ...
                else
                {
                    ...
                    IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_GetSensorDeviceInfo, reinterpret_cast<MINTPTR>(&rDeviceInfo), NULL, NULL, NULL);
                    MINT64 isoBase = rDeviceInfo.u4MiniISOGain;
                    strSensorParams.u4Sensitivity   = ( MUINT32 )( ( MINT64 ) acdk_ae_cfg.u4AfeGain*acdk_ae_cfg.u4IspGain*isoBase/1024/4096); //ISP6: must /4096, ISP5 & older: must / 1024
                    MY_LOGD("u4Sensitivity(%d) = u4AfeGain(%d)*u4IspGain(%d)*isoBase(%d)/1024/4096",strSensorParams.u4Sensitivity,acdk_ae_cfg.u4AfeGain,acdk_ae_cfg.u4IspGain,isoBase);
    ...
    case FT_CCT_OP_AE_SET_VHDR_RATIO:
        ...
        *pu4RealParaOutLen = 0;
        ...
        {
            i32In = (MINT32 *)puParaIn;
            IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_SetEMVHDRratio, *i32In, NULL, NULL, NULL);
                                  ...
                                  ACDK_CDVT_SENSOR_TEST_OUTPUT_T *a_prSensorTestOutput)
{
    ...
    if(a_i4SensorMode==CT_PROFILE_MODE_CAPTURE){
        ...
        minISOGain = pAENVRAMArr[0]->rDevicesInfo.u4MiniISOGain;
        free(pAENVRAMBuffer);
                                     ...
                                     ACDK_CDVT_SENSOR_CALIBRATION_OUTPUT_T *prSensorCalibrationOutput)
{
    ...
    */
    if((backup_bypass = NSIspTuning::IspTuningMgr::getInstance().getDynamicBypass(mSensorDev)) == -1)
    {
        MY_LOGE("[getDynamicBypass] Get Dynamic Bypass Fail ");
        prSensorCalibrationOutput->i4ErrorCode = 1; // RAW analysis error
        goto Exit;
    }
    //NSIspTuning::IspTuningMgr::getInstance().setDynamicBypass(mSensorDev, MTRUE);
...
SetShadingAE(MINT32 i4SensorDev)
{
    ...
    u4AfeGainTemp = pAENVRAMArr[0]->rDevicesInfo.u4MinGain;
...
{
    MUINT32 u4RetLen = 0;
    ACDK_CCT_FUNCTION_ENABLE_STRUCT rOnOff;

    cct_OpDispatch(FT_CCT_OP_GET_SHADING_ON_OFF, 0, NULL, sizeof(ACDK_CCT_FUNCTION_ENABLE_STRUCT), (MUINT8*)&rOnOff, &u4RetLen);
...
setShadingOnOff(MBOOL fgOnOff)
{
    ...
    cct_OpDispatch(FT_CCT_OP_SET_SHADING_ON_OFF, sizeof(ACDK_CCT_FUNCTION_ENABLE_STRUCT), (MUINT8*)&rOnOff, 0, NULL, &u4RetLen);
    ...
    case FT_CCT_OP_CAL_FLASH:
        {
            ...
            MINT32 fgRetTemp = TakePicture(CT_PROFILE_MODE_CAPTURE, CT_FORMAT_PURE);
            FlashMgr::getInstance(mSensorDev)->cctSetSpModeNormal();

            if(fgRetTemp != S_CCT_CALIBRATION_OK){
                MY_LOGE("CCT TakePicture Fail, Please use Flash Calibration Property for instead");
            }
            else{
                ...
                MUINT32 *pu4RealParaOutLen )
{
    ...
    case FT_CCT_OP_AE_SET_AEMODE:
        if (u4ParaInLen == sizeof(MUINT32)) {
            ...
            err = IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_SetAEMode, mode, MTRUE, NULL, NULL);
        } else {
            err = CCTIF_BAD_PARAM;
        }
        *pu4RealParaOutLen = 0;
    ...
    case FT_CCT_OP_AE_SET_SENSOR_PARA:
        if (u4ParaInLen == sizeof(AE_SENSOR_PARAM_T)) {
            ...
            err = IAeMgr::getInstance().sendAECtrl(mSensorDev, EAECtrl_SetSensorParams, reinterpret_cast<MINTPTR>(&(*param)), NULL, NULL, NULL);
        } else {
            err = CCTIF_BAD_PARAM;
        }
        *pu4RealParaOutLen = 0;
    ...
    case FT_CCT_OP_AF_SET_ON_OFF:
        if (u4ParaInLen == sizeof(MBOOL)) {
            ...
            if (enable)
                err |= NS3Av3::IAfMgr::getInstance(mSensorDev).CCTOPAFEnable();
            else
                err |= NS3Av3::IAfMgr::getInstance(mSensorDev).CCTOPAFDisable();
        } else
            err = CCTIF_BAD_PARAM;
        *pu4RealParaOutLen = 0;
        break;
    case FT_CCT_OP_GET_SHADING_PARA:
        ...
        *pu4RealParaOutLen = 0;
        ...
        MY_LOGD("[%s] GET_SHADING_PARA SensorMode(%d)", __FUNCTION__, eSensorMode);
        ...
        // log nvram data
        MY_LOGD("[%s -] GET_SHADING_PARA SensorMode(%d): (%dx%d, %d,%d,%d,%d)", __FUNCTION__, eSensorMode,
    ...
    case FT_CCT_OP_SET_SHADING_TABLE_POLYCOEF:
        ...
        *pu4RealParaOutLen = 0;
        ...
        NSIspTuning::ILscMgr* pLscMgr = NSIspTuning::ILscMgr::getInstance((MUINT32)m_eSensorEnum);
        NSIspTuning::ILscNvram* pLscNvram = NSIspTuning::ILscNvram::getInstance((MUINT32)m_eSensorEnum);
        ...
        //}
        MY_LOGD("[%s] - SET_SHADING_TABLE", __FUNCTION__);
...
cctNvram_GetNvramData(CCT_NVRAM_DATA_T dataType, MINT32 inSize, MUINT8 *pInBuf, MINT32 outSize, void *pOutBuf, MINT32 *pRealOutSize)
{
    ...
    MY_LOGD("[%s] dataType=%d, inSize=%d, outSize=%d", __FUNCTION__, dataType, inSize, outSize);
    ...
    if( pRealOutSize ) {
        MY_LOGD("[%s] err=%d, pRealOutSize=%d", __FUNCTION__, err, *pRealOutSize);
    }
    return err;
}
...
cctNvram_SetNvramData(CCT_NVRAM_DATA_T dataType, MINT32 inSize, MUINT8 *pInBuf)
{
    ...
    MY_LOGD("[%s] dataType=%d, inSize=%d", __FUNCTION__, dataType, inSize);
    ...
    case CCT_NVRAM_DATA_LSC_TABLE:
        ...
        MY_LOGD("[%s +] SET_SHADING_TABLE: SensorMode(%d),CT(%d),Src(%p),Size(%d)", __FUNCTION__,
    ...
    case CCT_NVRAM_DATA_FEATURE:
        ...
        *pNvram = *pCctNvram;
        ...
        // MY_LOGD("apply mfll_iso_th old(%d) apply(%d) new(%d)", th_old, th_apply, th_new );
        }
        break;
    case CCT_NVRAM_DATA_STROBE:
    ...
    MY_LOGD("[%s] err=%d", __FUNCTION__, err);
    return err;
}
...
cctNvram_SetPartialNvramData(CCT_NVRAM_DATA_T dataType, MINT32 inSize, MUINT32 bufOffset, MUINT8 *pInBuf)
{
    ...
    MY_LOGD("[%s] dataType=%d, inSize=%d, bufOffset=%d", __FUNCTION__, dataType, inSize, bufOffset);
...
cctNvram_SaveNvramData(CCT_NVRAM_DATA_T dataType)
{
    ...
    MY_LOGD("[%s] dataType=%d", __FUNCTION__, dataType);
    ...
    case CCT_NVRAM_DATA_LSC_TABLE:
        ...
        if (pLscNvram->writeNvramTbl()) {
            MY_LOGD("[%s] SDTBL_SAVE_TO_NVRAM OK", __FUNCTION__);
        }
        else {
...
#endif
    case CCT_NVRAM_DATA_ISP:
        MY_LOGD("IMP_CCT_CTRL( ACDK_CCT_OP_ISP_SAVE_TO_NVRAM )");
        ...
        if  ( 0 != ret ) {
            ...
            MY_LOGD("IMP_CCT_CTRL( ACDK_CCT_OP_ISP_SAVE_TO_NVRAM ) done");
        break;
    case CCT_NVRAM_DATA_FEATURE:
        err = NvBufUtil::getInstance().write(CAMERA_NVRAM_DATA_FEATURE, mSensorDev);
        break;
    case CCT_NVRAM_DATA_STROBE:
        MY_LOGD("ACDK_CCT_OP_STROBE_WRITE_NVRAM");
...
//Chooo
    ...
    if (index < NVRAM_SL2F_TBL_NUM) {
        ...
        ISP_MGR_SL2F_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->SL2F[index]));
        ISP_MGR_SL2G_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->SL2F[index]));
    }
    ...
    if (index < NVRAM_DBS_TBL_NUM) {
        ...
        ISP_MGR_DBS_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->DBS[index]));
        ISP_MGR_DBS2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->DBS[index]));
    }

    index = pIspRegs->Idx.ADBS;
    if (index < NVRAM_ADBS_TBL_NUM) {
        m_rISPRegs.ADBS[index] = (pIspRegs->ADBS[index]);
        m_rISPRegsIdx.ADBS = static_cast<MUINT8>(index);
        ISP_MGR_ADBS_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->ADBS[index]));
        ISP_MGR_ADBS2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->ADBS[index]));
    }
    ...
    if (index < NVRAM_OBC_TBL_NUM) {
        ...
        ISP_MGR_OBC_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->OBC[index]));
        ISP_MGR_OBC2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->OBC[index]));
    }
    ...
    if (index < NVRAM_BPC_TBL_NUM) {
        ...
        ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->BNR_BPC[index]));
        ISP_MGR_BNR2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->BNR_BPC[index]));
    }
    ...
    if (index < NVRAM_NR1_TBL_NUM) {
        ...
        ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->BNR_NR1[index]));
        ISP_MGR_BNR2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->BNR_NR1[index]));
    }
    ...
    if (index < NVRAM_PDC_TBL_NUM) {
        ...
        ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->BNR_PDC[index]));
        ISP_MGR_BNR2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->BNR_PDC[index]));
    }
#if 0
    ...
    if (index < NVRAM_RMM_TBL_NUM) {
        ...
        ISP_MGR_RMM_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->RMM[index]));
        ISP_MGR_RMM2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->RMM[index]));
    }
#endif
    ...
    if (index < NVRAM_RNR_TBL_NUM) {
        ...
        ISP_MGR_RNR_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->RNR[index]));
    }
    ...
    if (index < NVRAM_SL2_TBL_NUM) {
        ...
        ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->SL2[index]));
    }
    ...
    if (index < NVRAM_UDM_TBL_NUM) {
        ...
        ISP_MGR_UDM_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->UDM[index]));
    }
    ...
    if (index < NVRAM_CCM_TBL_NUM) {
        ...
        ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->CCM[index]));
    }
    ...
    if (index < NVRAM_GGM_TBL_NUM) {
        ...
        ISP_MGR_GGM_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->GGM[index]));
    }
    ...
    if (index < NVRAM_IHDR_GGM_TBL_NUM) {
        ...
        //ISP_MGR_IHDR_GGM_T::getInstance((MUINT32)m_eSensorEnum).put(&(pIspRegs->IHDR_GGM[index]));     //????????
    }
#endif
    ...
    if (index < NVRAM_ANR_TBL_NUM) {
        ...
        ISP_MGR_NBC_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->NBC_ANR[index]));
    }
    ...
    if (index < NVRAM_ANR2_TBL_NUM) {
        ...
        ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->NBC2_ANR2[index]));
    }
    ...
    if (index < NVRAM_CCR_TBL_NUM) {
        ...
        ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->NBC2_CCR[index]));
    }
    ...
    if (index < NVRAM_HFG_TBL_NUM) {
        ...
        ISP_MGR_HFG_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->HFG[index]));
    }
    ...
    if (index < NVRAM_EE_TBL_NUM) {
        ...
        ISP_MGR_SEEE_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->EE[index]));
    }
    ...
    if (index < NVRAM_MFB_TBL_NUM) {
        ...
        ISP_MGR_MFB_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->MFB[index]));
    }
    ...
    if (index < NVRAM_MIXER3_TBL_NUM) {
        ...
        ISP_MGR_MIXER3_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->MIXER3[index]));
    }

#endif
    NSIspTuning::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);

    MY_LOGD("[%s] done ", __FUNCTION__);
    return  CCTIF_NO_ERROR;
}
