...
#-----------------------------------------------------------
LOCAL_SRC_FILES += IHalISP.cpp
LOCAL_SRC_FILES += HalIspImp.cpp
LOCAL_SRC_FILES += ../IspMgrIf.cpp

LOCAL_SRC_FILES += ../isp_tuning/capturenr/capturenr.cpp
LOCAL_SRC_FILES += ../../common/hal3a/$(MTKCAM_COMMON_HAL3A_VERSION)/debug/IDebugEntry.cpp
LOCAL_SRC_FILES += ../../common/hal3a/$(MTKCAM_COMMON_HAL3A_VERSION)/debug/DebugUtil.cpp
