...
doInit()
{
    ...
    if (m_rConfigInfo.i4SubsampleCount > 1 && m_rConfigInfo.i4RequestCount > 1) //Slow motion video recording
    {
        ...
        mpHal3aObj = Hal3AIf::getInstance(mi4SensorIdx, Hal3AIf::E_FlowControl_Type_SMVR, m_rConfigInfo.i4SubsampleCount);
    }
    else
    {
    ...
    if(mpResultPoolObj == NULL)
    {
        ...
        if(mpResultPoolObj)
        {
            ...
            mpResultPoolObj->updateCapacity(mu4MetaResultQueueCapacity, i4LastSubsampleCount);
