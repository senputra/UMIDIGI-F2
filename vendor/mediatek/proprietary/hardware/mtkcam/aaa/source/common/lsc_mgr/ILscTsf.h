...
public:
    ...
    virtual MBOOL               init(ESensorMode_T eFullSensorMode) = 0;
    virtual MBOOL               uninit() = 0;
    virtual MBOOL               setOnOff(MBOOL fgOnOff) = 0;
    virtual MBOOL               getOnOff() const = 0;
    virtual MBOOL               setIsFactory(MBOOL fgOnOff) = 0;
    ...
    virtual MBOOL               config(NS3Av3::shadingConfig_T /*rConfig*/) { return MFALSE; }
    virtual MBOOL               isInit(){return MTRUE;}
    virtual MBOOL               getTsfsConfig(TSFS_INFO_STRUCT &rConfig) { return MFALSE; }
