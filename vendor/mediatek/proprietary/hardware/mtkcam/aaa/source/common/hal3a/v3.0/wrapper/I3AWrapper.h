...
public:
    ...
    static I3AWrapper*  getInstance(E_TYPE_T eType, MINT32 const i4SensorOpenIndex);
    ...
    virtual MINT32      getCurrResult(MUINT32 i4FrmId) const = 0;
