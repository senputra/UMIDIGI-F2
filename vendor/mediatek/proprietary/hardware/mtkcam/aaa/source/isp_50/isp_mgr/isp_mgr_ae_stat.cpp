...
{
    int i4SensorIdx = NS3Av3::mapSensorDevToIdx(eSensorDev);
    ...
    std::call_once(rSingleton.onceFlag, [&] {
        rSingleton.instance = std::make_unique<ISP_MGR_AE_STAT_CONFIG_T>(eSensorDev);
    } );
...
config(AE_STAT_PARAM_T& rAEStatConfig)
{
    ...
    property_get("vendor.debug.isp_mgr_ae.enable", value, "0");
    m_bDebugEnable = atoi(value);

#if 1
    if(m_u4BlockNumW <= 120) {
        BlockNumW = m_u4BlockNumW;
    } else {
        CAM_LOGE("Wrong  m_u4BlockNumW = %d", m_u4BlockNumW);
        BlockNumW = 120;
    }
    if(m_u4BlockNumH <= 90) {
        BlockNumH = m_u4BlockNumH;
    } else {
        CAM_LOGE("Wrong  m_u4BlockNumH = %d", m_u4BlockNumH);
        BlockNumH = 90;
    }
...
*/
    ...
    if (m_u4AAOmode){
        // CAM_AE_LMT2_0
        AeLmt20.Bits.AE_LMT2_G = 0x3FFF;
        AeLmt20.Bits.AE_LMT2_R = 0x3FFF;
        // CAM_AE_LMT2_1
        AeLmt21.Bits.AE_LMT2_B = 0x3FFF;
    }else{
        // CAM_AE_LMT2_0
...
*/
    ...
    AeOverExpoCfg.Bits.AE_OVER_EXPO_THR = m_u4AEOverExpCntThr;
    AeOverExpoCfg.Bits.AE_OVER_EXPO_SFT = m_u4AEOverExpCntShift;
    ...
    AePixHstCtl.Bits.AE_PIX_HST4_EN = rAEStatConfig.rAEPixelHistWinCFG[4].bAEHistEn;
    AePixHstCtl.Bits.AE_PIX_HST5_EN = rAEStatConfig.rAEPixelHistWinCFG[5].bAEHistEn;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST_CTL : %d/%d/%d/%d/%d/%d", __FUNCTION__,
                AePixHstCtl.Bits.AE_PIX_HST0_EN,
                AePixHstCtl.Bits.AE_PIX_HST1_EN,
                AePixHstCtl.Bits.AE_PIX_HST2_EN,
                AePixHstCtl.Bits.AE_PIX_HST3_EN,
                AePixHstCtl.Bits.AE_PIX_HST4_EN,
                AePixHstCtl.Bits.AE_PIX_HST5_EN);
    ...
    CAM_REG_AE_PIX_HST_SET_1 AePixHstSet1;
    AePixHstSet1.Bits.AE_PIX_BIN_MODE_4 = rAEStatConfig.rAEPixelHistWinCFG[4].uAEHistBin;
    AePixHstSet1.Bits.AE_PIX_BIN_MODE_5 = rAEStatConfig.rAEPixelHistWinCFG[5].uAEHistBin;
    AePixHstSet1.Bits.AE_PIX_COLOR_MODE_4 = rAEStatConfig.rAEPixelHistWinCFG[4].uAEHistOpt;
    AePixHstSet1.Bits.AE_PIX_COLOR_MODE_5 = rAEStatConfig.rAEPixelHistWinCFG[5].uAEHistOpt;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST_SET_1 : BIN (%d/%d) COLOR (%d/%d)", __FUNCTION__,
                AePixHstSet1.Bits.AE_PIX_BIN_MODE_4,
                AePixHstSet1.Bits.AE_PIX_BIN_MODE_5,
                AePixHstSet1.Bits.AE_PIX_COLOR_MODE_4,
                AePixHstSet1.Bits.AE_PIX_COLOR_MODE_5);
    ...
    CAM_REG_AE_PIX_HST4_YRNG AePixHst4Yrng;
    AePixHst4Yrng.Bits.AE_PIX_Y_LOW_4 = rAEStatConfig.rAEPixelHistWinCFG[4].uAEHistYLow ;
    AePixHst4Yrng.Bits.AE_PIX_Y_HI_4  = rAEStatConfig.rAEPixelHistWinCFG[4].uAEHistYHi;

    // CAM_AE_PIX_HST4_XRNG
    CAM_REG_AE_PIX_HST4_XRNG AePixHst4Xrng;
    AePixHst4Xrng.Bits.AE_PIX_X_LOW_4 = rAEStatConfig.rAEPixelHistWinCFG[4].uAEHistXLow;
    AePixHst4Xrng.Bits.AE_PIX_X_HI_4  = rAEStatConfig.rAEPixelHistWinCFG[4].uAEHistXHi;

    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST4 : Y-LOW/HIGH (%d/%d) X-LOW/HIGH (%d/%d)", __FUNCTION__,
                AePixHst4Yrng.Bits.AE_PIX_Y_LOW_4,
                AePixHst4Yrng.Bits.AE_PIX_Y_HI_4,
                AePixHst4Xrng.Bits.AE_PIX_X_LOW_4,
                AePixHst4Xrng.Bits.AE_PIX_X_HI_4);

    // CAM_AE_PIX_HST5_YRNG
    CAM_REG_AE_PIX_HST5_YRNG AePixHst5Yrng;
    AePixHst5Yrng.Bits.AE_PIX_Y_LOW_5 = rAEStatConfig.rAEPixelHistWinCFG[5].uAEHistYLow ;
    AePixHst5Yrng.Bits.AE_PIX_Y_HI_5  = rAEStatConfig.rAEPixelHistWinCFG[5].uAEHistYHi;

    // CAM_AE_PIX_HST5_XRNG
    CAM_REG_AE_PIX_HST5_XRNG AePixHst5Xrng;
    AePixHst5Xrng.Bits.AE_PIX_X_LOW_5 = rAEStatConfig.rAEPixelHistWinCFG[5].uAEHistXLow;
    AePixHst5Xrng.Bits.AE_PIX_X_HI_5  = rAEStatConfig.rAEPixelHistWinCFG[5].uAEHistXHi;

    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST5 : Y-LOW/HIGH (%d/%d) X-LOW/HIGH (%d/%d)", __FUNCTION__,
                AePixHst5Yrng.Bits.AE_PIX_Y_LOW_5,
                AePixHst5Yrng.Bits.AE_PIX_Y_HI_5,
                AePixHst5Xrng.Bits.AE_PIX_X_LOW_5,
                AePixHst5Xrng.Bits.AE_PIX_X_HI_5);

/*
    // CAM_AE_HST_SEL
    CAM_REG_AE_HST_SEL AeHstSel;
    AeHstSel.Bits.AE_HST_SEL = m_bDisablePixelHistConfig;
*/
    // CAM_AE_STAT_EN
    CAM_REG_AE_STAT_EN AeStatEn;
    AeStatEn.Bits.AE_TSF_STAT_EN = m_bEnableTSFConfig;
    AeStatEn.Bits.AE_OVERCNT_EN  = m_bEnableOverCntConfig;
    AeStatEn.Bits.AE_HDR_STAT_EN = m_bEnableHDRYConfig;
    AeStatEn.Bits.AE_HST_DMA_OUT_EN = (AE_PARAM_AE_HST_DMA_OUT_EN > 0) ? MTRUE : MFALSE;
    AeStatEn.Bits.AE_LINEAR_STAT_EN = (AE_PARAM_AE_LINEAR_STAT_EN > 0) ? MTRUE : MFALSE;

    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_STAT_EN : %d/%d/%d/%d/%d", __FUNCTION__,
                AeStatEn.Bits.AE_TSF_STAT_EN,
                AeStatEn.Bits.AE_OVERCNT_EN,
                AeStatEn.Bits.AE_HDR_STAT_EN,
                AeStatEn.Bits.AE_HST_DMA_OUT_EN,
                AeStatEn.Bits.AE_LINEAR_STAT_EN);

    // CAM_AAO_XSIZE
    CAM_REG_AAO_XSIZE AaoXsize;
    MUINT32 u4EnCnt = AePixHstCtl.Bits.AE_PIX_HST0_EN
                    + AePixHstCtl.Bits.AE_PIX_HST1_EN
                    + AePixHstCtl.Bits.AE_PIX_HST2_EN
                    + AePixHstCtl.Bits.AE_PIX_HST3_EN
                    + AePixHstCtl.Bits.AE_PIX_HST4_EN
                    + AePixHstCtl.Bits.AE_PIX_HST5_EN;
    if( AePixHstSet.Bits.AE_PIX_BIN_MODE_0    == 0 ||
        AePixHstSet.Bits.AE_PIX_COLOR_MODE_0  == 5 ||
        AePixHstSet.Bits.AE_PIX_COLOR_MODE_1  == 5 ||
        AePixHstSet.Bits.AE_PIX_COLOR_MODE_2  == 5 ||
        AePixHstSet.Bits.AE_PIX_COLOR_MODE_3  == 5 ||
        AePixHstSet1.Bits.AE_PIX_COLOR_MODE_4 == 5 ||
        AePixHstSet1.Bits.AE_PIX_COLOR_MODE_5 == 5 )
        AaoXsize.Bits.XSIZE = BlockNumH*(BlockNumW*8+BlockNumW*12*AeStatEn.Bits.AE_LINEAR_STAT_EN+BlockNumW*2+BlockNumW*1*AeStatEn.Bits.AE_OVERCNT_EN)+u4EnCnt*128*3*AeStatEn.Bits.AE_HST_DMA_OUT_EN;
    else
        AaoXsize.Bits.XSIZE = BlockNumH*(BlockNumW*8+BlockNumW*12*AeStatEn.Bits.AE_LINEAR_STAT_EN+BlockNumW*2+BlockNumW*1*AeStatEn.Bits.AE_OVERCNT_EN)+u4EnCnt*256*3*AeStatEn.Bits.AE_HST_DMA_OUT_EN;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AAO_XSIZE : %d, BlockNumW/H: %d/%d, u4EnCnt: %d, AE_PIX_BIN_MODE: %d/%d/%d/%d/%d/%d, AE_PIX_COLOR_MODE: %d/%d/%d/%d/%d/%d", __FUNCTION__,
                AaoXsize.Bits.XSIZE, BlockNumW, BlockNumH, u4EnCnt,
                AePixHstSet.Bits.AE_PIX_BIN_MODE_0, AePixHstSet.Bits.AE_PIX_BIN_MODE_1, AePixHstSet.Bits.AE_PIX_BIN_MODE_2,
                AePixHstSet.Bits.AE_PIX_BIN_MODE_3, AePixHstSet1.Bits.AE_PIX_BIN_MODE_4, AePixHstSet1.Bits.AE_PIX_BIN_MODE_5,
                AePixHstSet.Bits.AE_PIX_COLOR_MODE_0, AePixHstSet.Bits.AE_PIX_COLOR_MODE_1, AePixHstSet.Bits.AE_PIX_COLOR_MODE_2,
                AePixHstSet.Bits.AE_PIX_COLOR_MODE_3, AePixHstSet1.Bits.AE_PIX_COLOR_MODE_4, AePixHstSet1.Bits.AE_PIX_COLOR_MODE_5);
    // CAM_AAO_YSIZE
    CAM_REG_AAO_YSIZE AaoYsize;
    AaoYsize.Bits.YSIZE = 1;
//    // CAM_AAO_STRIDE
//    CAM_REG_AAO_STRIDE AaoStride;
//    AaoStride.Bits.STRIDE = AaoXsize.Bits.XSIZE;

    // CAM_AE_YCOEF
    CAM_REG_AE_YCOEF AeYCoef;
    AeYCoef.Bits.AE_YCOEF_R = m_u4AEYCoefR;
    AeYCoef.Bits.AE_YCOEF_G = m_u4AEYCoefG;
    AeYCoef.Bits.AE_YCOEF_B = m_u4AEYCoefB;


    // [PSO]

    // CAM_PS_AE_YCOEF0
    CAM_REG_PS_AE_YCOEF0 PSAeYCoef0;
    PSAeYCoef0.Bits.AE_YCOEF_R = 4809;
    PSAeYCoef0.Bits.AE_YCOEF_GR = 4809;
    // CAM_PS_AE_YCOEF1
    CAM_REG_PS_AE_YCOEF1 PSAeYCoef1;
    PSAeYCoef1.Bits.AE_YCOEF_GB = 4809;
    PSAeYCoef1.Bits.AE_YCOEF_B = 1867;

    // CAM_PS_DATA_TYPE
    CAM_REG_PS_DATA_TYPE PSDataType;
    PSDataType.Bits.SENSOR_TYPE = 0;
    PSDataType.Bits.G_LE_FIRST = 0;
    PSDataType.Bits.R_LE_FIRST = 0;
    PSDataType.Bits.B_LE_FIRST = 0;
    PSDataType.Bits.EXP_MODE = (AE_PARAM_PS_EXP_MODE > 0) ? MTRUE : MFALSE;
//    if(_RMG_EN == 1 && _PS_EN == 1) { // temp: from RMG
//        if(AE_PARAM_PS_RMBN_SEL == 1 || AE_PARAM_PS_RMBN_SEL == 2) {
//            if(_RMG_ZHDR_EN == 1) {
//                PSDataType.Bits.SENSOR_TYPE = 2;
//                PSDataType.Bits.G_LE_FIRST = _RMG_ZHDR_GLE;
//                PSDataType.Bits.R_LE_FIRST = _RMG_ZHDR_RLE;
//                PSDataType.Bits.B_LE_FIRST = _RMG_ZHDR_BLE;
//            }
//            else if(_RMG_IHDR_EN == 1) {
//                PSDataType.Bits.SENSOR_TYPE = 1;
//                PSDataType.Bits.G_LE_FIRST = _RMG_IHDR_LE_FIRST;
//            }
//            else
//                PSDataType.Bits.SENSOR_TYPE = 0;
//        }
//    }
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_PS_DATA_TYPE : %d/%d/%d/%d/%d", __FUNCTION__,
                PSDataType.Bits.SENSOR_TYPE,
                PSDataType.Bits.G_LE_FIRST,
                PSDataType.Bits.R_LE_FIRST,
                PSDataType.Bits.B_LE_FIRST,
                PSDataType.Bits.EXP_MODE);
    // CAM_PS_HST_CFG
    CAM_REG_PS_HST_CFG PSHstCfg;
    PSHstCfg.Bits.PS_HST_EN = rAEStatConfig.rPSPixelHistWinCFG.bPSHistEn;
    PSHstCfg.Bits.PS_HST_SEP_G = AE_PARAM_PS_HST_SEP_G;
    PSHstCfg.Bits.PS_CCU_HST_END_Y = AE_PARAM_PS_CCU_HST_END;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_PS_HST_CFG : %d/%d/%d", __FUNCTION__,
                PSHstCfg.Bits.PS_HST_EN,
                PSHstCfg.Bits.PS_HST_SEP_G,
                PSHstCfg.Bits.PS_CCU_HST_END_Y);
    // CAM_PS_HST_ROI_X
    CAM_REG_PS_HST_ROI_X PSHstRoiX;
    PSHstRoiX.Bits.PS_X_LOW = rAEStatConfig.rPSPixelHistWinCFG.uPSHistXLow;
    PSHstRoiX.Bits.PS_X_HI = rAEStatConfig.rPSPixelHistWinCFG.uPSHistXHi;
    // CAM_PS_HST_ROI_Y
    CAM_REG_PS_HST_ROI_Y PSHstRoiY;
    PSHstRoiY.Bits.PS_Y_LOW = rAEStatConfig.rPSPixelHistWinCFG.uPSHistYLow;
    PSHstRoiY.Bits.PS_Y_HI = rAEStatConfig.rPSPixelHistWinCFG.uPSHistYHi;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_PS_HST_ROI : X-LOW/HIGH (%d/%d) Y-LOW/HIGH (%d/%d)", __FUNCTION__,
                PSHstRoiX.Bits.PS_X_LOW,
                PSHstRoiX.Bits.PS_X_HI,
                PSHstRoiY.Bits.PS_Y_LOW,
                PSHstRoiY.Bits.PS_Y_HI);

    // CAM_PSO_XSIZE
    CAM_REG_PSO_XSIZE PSOXsize;
    if(PSDataType.Bits.SENSOR_TYPE == 0) // 0:normal type
        PSOXsize.Bits.XSIZE = BlockNumH*(BlockNumW*8+BlockNumW*2)+1024*3*PSHstCfg.Bits.PS_HST_EN;
    else { // 1:ihdr type or 2:zhdr type
        if(PSDataType.Bits.EXP_MODE == 2) // 2:both(le+se) mode
            PSOXsize.Bits.XSIZE = BlockNumH*(BlockNumW*8+BlockNumW*8+BlockNumW*2+BlockNumW*2)+256*3*2*PSHstCfg.Bits.PS_HST_EN;
        else // 0:le mode or 1:se mode
            PSOXsize.Bits.XSIZE = BlockNumH*(BlockNumW*8+BlockNumW*2)+256*3*PSHstCfg.Bits.PS_HST_EN;
    }
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_PSO_XSIZE : %d, BlockNumW/H: %d/%d", __FUNCTION__,
                PSOXsize.Bits.XSIZE,
                BlockNumW, BlockNumH);
    // CAM_PSO_YSIZE
    CAM_REG_PSO_YSIZE PSOYsize;
    PSOYsize.Bits.YSIZE = 1;
//    // CAM_PSO_STRIDE
//    CAM_REG_PSO_STRIDE PSOStride;
//    PSOStride.Bits.STRIDE = PSOXsize.Bits.XSIZE;
...
//    REG_INFO_VALUE(CAM_AE_HST3_RNG) = (MUINT32)AeHst3Rng.Raw;
    ...
    REG_INFO_VALUE(CAM_AE_PIX_HST_SET_1) = (MUINT32)AePixHstSet1.Raw;
    ...
    REG_INFO_VALUE(CAM_AE_PIX_HST4_YRNG) = (MUINT32)AePixHst4Yrng.Raw;
    REG_INFO_VALUE(CAM_AE_PIX_HST4_XRNG) = (MUINT32)AePixHst4Xrng.Raw;
    REG_INFO_VALUE(CAM_AE_PIX_HST5_YRNG) = (MUINT32)AePixHst5Yrng.Raw;
    REG_INFO_VALUE(CAM_AE_PIX_HST5_XRNG) = (MUINT32)AePixHst5Xrng.Raw;
...
//    REG_INFO_VALUE(CAM_AAO_STRIDE) = (MUINT32)AaoStride.Raw;
    REG_INFO_VALUE(CAM_AE_YCOEF) = (MUINT32)AeYCoef.Raw;
    // [PSO]
    REG_INFO_VALUE(CAM_PS_AE_YCOEF0) = (MUINT32)PSAeYCoef0.Raw;
    REG_INFO_VALUE(CAM_PS_AE_YCOEF1) = (MUINT32)PSAeYCoef1.Raw;
    REG_INFO_VALUE(CAM_PS_DATA_TYPE) = (MUINT32)PSDataType.Raw;
    REG_INFO_VALUE(CAM_PS_HST_CFG) = (MUINT32)PSHstCfg.Raw;
    REG_INFO_VALUE(CAM_PS_HST_ROI_X) = (MUINT32)PSHstRoiX.Raw;
    REG_INFO_VALUE(CAM_PS_HST_ROI_Y) = (MUINT32)PSHstRoiY.Raw;
    REG_INFO_VALUE(CAM_PSO_XSIZE) = (MUINT32)PSOXsize.Raw;
    REG_INFO_VALUE(CAM_PSO_YSIZE) = (MUINT32)PSOYsize.Raw;
//    REG_INFO_VALUE(CAM_PSO_STRIDE) = (MUINT32)PSOStride.Raw;
    return MTRUE;
}
...
MBOOL
ISP_MGR_AE_STAT_CONFIG_T::
reconfig(MVOID *pDBinInfo, MVOID *pOutRegCfg, AE_STAT_PARAM_T & rAEStatConfig)
{
    MINT32 i4BinRatioX = 0;
    MINT32 i4BinRatioY = 0;
    MUINT32 u4Offset = 0;
    ...
    psOutRegCfg->Bypass.Bits.AA = 0; /* need to update AA config */
    psOutRegCfg->Bypass.Bits.PS = 0; /* need to update PS config */
    ...
    // CAM_AE_OVER_EXPO_CFG
    CAM_REG_AE_OVER_EXPO_CFG AeOverExpoCfg;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_OVER_EXPO_CFG))/4;
    AeOverExpoCfg.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_OVER_EXPO_CFG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AeOverExpoCfg.Bits.AE_OVER_EXPO_THR = m_u4AEOverExpCntThr;
    AeOverExpoCfg.Bits.AE_OVER_EXPO_SFT = m_u4AEOverExpCntShift;
    *(pIspReg+u4Offset) = AeOverExpoCfg.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_OVER_EXPO_CFG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST0_YRNG
    CAM_REG_AE_PIX_HST0_YRNG AePixHst0Yrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST0_YRNG))/4;
    AePixHst0Yrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST0_YRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst0Yrng.Bits.AE_PIX_Y_LOW_0 = rAEStatConfig.rAEPixelHistWinCFG[0].uAEHistYLow;
    AePixHst0Yrng.Bits.AE_PIX_Y_HI_0  = rAEStatConfig.rAEPixelHistWinCFG[0].uAEHistYHi;
    *(pIspReg+u4Offset) = AePixHst0Yrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST0_YRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST0_XRNG
    CAM_REG_AE_PIX_HST0_XRNG AePixHst0Xrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST0_XRNG))/4;
    AePixHst0Xrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST0_XRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst0Xrng.Bits.AE_PIX_X_LOW_0 = rAEStatConfig.rAEPixelHistWinCFG[0].uAEHistXLow;
    AePixHst0Xrng.Bits.AE_PIX_X_HI_0  = rAEStatConfig.rAEPixelHistWinCFG[0].uAEHistXHi;
    *(pIspReg+u4Offset) = AePixHst0Xrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST0_XRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST1_YRNG
    CAM_REG_AE_PIX_HST1_YRNG AePixHst1Yrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST1_YRNG))/4;
    AePixHst1Yrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST1_YRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst1Yrng.Bits.AE_PIX_Y_LOW_1 = rAEStatConfig.rAEPixelHistWinCFG[1].uAEHistYLow;
    AePixHst1Yrng.Bits.AE_PIX_Y_HI_1  = rAEStatConfig.rAEPixelHistWinCFG[1].uAEHistYHi;
    *(pIspReg+u4Offset) = AePixHst1Yrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST1_YRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST1_XRNG
    CAM_REG_AE_PIX_HST1_XRNG AePixHst1Xrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST1_XRNG))/4;
    AePixHst1Xrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST1_XRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst1Xrng.Bits.AE_PIX_X_LOW_1 = rAEStatConfig.rAEPixelHistWinCFG[1].uAEHistXLow;
    AePixHst1Xrng.Bits.AE_PIX_X_HI_1  = rAEStatConfig.rAEPixelHistWinCFG[1].uAEHistXHi;
    *(pIspReg+u4Offset) = AePixHst1Xrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST1_XRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST2_YRNG
    CAM_REG_AE_PIX_HST2_YRNG AePixHst2Yrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST2_YRNG))/4;
    AePixHst2Yrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST2_YRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst2Yrng.Bits.AE_PIX_Y_LOW_2 = rAEStatConfig.rAEPixelHistWinCFG[2].uAEHistYLow;
    AePixHst2Yrng.Bits.AE_PIX_Y_HI_2  = rAEStatConfig.rAEPixelHistWinCFG[2].uAEHistYHi;
    *(pIspReg+u4Offset) = AePixHst2Yrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST2_YRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST2_XRNG
    CAM_REG_AE_PIX_HST2_XRNG AePixHst2Xrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST2_XRNG))/4;
    AePixHst2Xrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST2_XRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst2Xrng.Bits.AE_PIX_X_LOW_2 = rAEStatConfig.rAEPixelHistWinCFG[2].uAEHistXLow;
    AePixHst2Xrng.Bits.AE_PIX_X_HI_2  = rAEStatConfig.rAEPixelHistWinCFG[2].uAEHistXHi;
    *(pIspReg+u4Offset) = AePixHst2Xrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST2_XRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST3_YRNG
    CAM_REG_AE_PIX_HST3_YRNG AePixHst3Yrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST3_YRNG))/4;
    AePixHst3Yrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST3_YRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst3Yrng.Bits.AE_PIX_Y_LOW_3 = rAEStatConfig.rAEPixelHistWinCFG[3].uAEHistYLow;
    AePixHst3Yrng.Bits.AE_PIX_Y_HI_3  = rAEStatConfig.rAEPixelHistWinCFG[3].uAEHistYHi;
    *(pIspReg+u4Offset) = AePixHst3Yrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST3_YRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST3_XRNG
    CAM_REG_AE_PIX_HST3_XRNG AePixHst3Xrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST3_XRNG))/4;
    AePixHst3Xrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST3_XRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst3Xrng.Bits.AE_PIX_X_LOW_3 = rAEStatConfig.rAEPixelHistWinCFG[3].uAEHistXLow;
    AePixHst3Xrng.Bits.AE_PIX_X_HI_3  = rAEStatConfig.rAEPixelHistWinCFG[3].uAEHistXHi;
    *(pIspReg+u4Offset) = AePixHst3Xrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST3_XRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST4_YRNG
    CAM_REG_AE_PIX_HST4_YRNG AePixHst4Yrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST4_YRNG))/4;
    AePixHst4Yrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST4_YRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst4Yrng.Bits.AE_PIX_Y_LOW_4 = rAEStatConfig.rAEPixelHistWinCFG[4].uAEHistYLow;
    AePixHst4Yrng.Bits.AE_PIX_Y_HI_4  = rAEStatConfig.rAEPixelHistWinCFG[4].uAEHistYHi;
    *(pIspReg+u4Offset) = AePixHst4Yrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST4_YRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST4_XRNG
    CAM_REG_AE_PIX_HST4_XRNG AePixHst4Xrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST4_XRNG))/4;
    AePixHst4Xrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST4_XRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst4Xrng.Bits.AE_PIX_X_LOW_4 = rAEStatConfig.rAEPixelHistWinCFG[4].uAEHistXLow;
    AePixHst4Xrng.Bits.AE_PIX_X_HI_4  = rAEStatConfig.rAEPixelHistWinCFG[4].uAEHistXHi;
    *(pIspReg+u4Offset) = AePixHst4Xrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST4_XRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST5_YRNG
    CAM_REG_AE_PIX_HST5_YRNG AePixHst5Yrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST5_YRNG))/4;
    AePixHst5Yrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST5_YRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst5Yrng.Bits.AE_PIX_Y_LOW_5 = rAEStatConfig.rAEPixelHistWinCFG[5].uAEHistYLow;
    AePixHst5Yrng.Bits.AE_PIX_Y_HI_5  = rAEStatConfig.rAEPixelHistWinCFG[5].uAEHistYHi;
    *(pIspReg+u4Offset) = AePixHst5Yrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST5_YRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_AE_PIX_HST5_XRNG
    CAM_REG_AE_PIX_HST5_XRNG AePixHst5Xrng;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_AE_PIX_HST5_XRNG))/4;
    AePixHst5Xrng.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST5_XRNG : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    AePixHst5Xrng.Bits.AE_PIX_X_LOW_5 = rAEStatConfig.rAEPixelHistWinCFG[5].uAEHistXLow;
    AePixHst5Xrng.Bits.AE_PIX_X_HI_5  = rAEStatConfig.rAEPixelHistWinCFG[5].uAEHistXHi;
    *(pIspReg+u4Offset) = AePixHst5Xrng.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_AE_PIX_HST5_XRNG : %x -", __FUNCTION__, *(pIspReg+u4Offset));
    ...
    // CAM_PS_HST_ROI_Y
    CAM_REG_PS_HST_ROI_Y PSHstRoiY;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_PS_HST_ROI_Y))/4;
    PSHstRoiY.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_PS_HST_ROI_Y : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    PSHstRoiY.Bits.PS_Y_LOW = rAEStatConfig.rPSPixelHistWinCFG.uPSHistYLow;
    PSHstRoiY.Bits.PS_Y_HI  = rAEStatConfig.rPSPixelHistWinCFG.uPSHistYHi;
    *(pIspReg+u4Offset) = PSHstRoiY.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_PS_HST_ROI_Y : %x -", __FUNCTION__, *(pIspReg+u4Offset));

    // CAM_PS_HST_ROI_X
    CAM_REG_PS_HST_ROI_X PSHstRoiX;
    u4Offset = ((MUINT32)offsetof(cam_reg_t, CAM_PS_HST_ROI_X))/4;
    PSHstRoiX.Raw = *(pIspReg+u4Offset);
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_PS_HST_ROI_X : %x +", __FUNCTION__, *(pIspReg+u4Offset));
    PSHstRoiX.Bits.PS_X_LOW = rAEStatConfig.rPSPixelHistWinCFG.uPSHistXLow;
    PSHstRoiX.Bits.PS_X_HI  = rAEStatConfig.rPSPixelHistWinCFG.uPSHistXHi;
    *(pIspReg+u4Offset) = PSHstRoiX.Raw;
    CAM_LOGD_IF(m_bDebugEnable, "[%s] CAM_PS_HST_ROI_X : %x -", __FUNCTION__, *(pIspReg+u4Offset));
...
{
    CAM_LOGD_IF(m_bDebugEnable, "[AEconfig] u4NumW/u4NumH/bHDR/bOverCnt/bTSF/bPixel/thr/shift = %d/%d/%d/%d/%d/%d/%d/%d -> %d/%d/%d/%d/%d/%d/%d/%d \n",
...
{
    CAM_LOGD_IF(m_bDebugEnable, "[AEAEYCoef] u4AEYCoefR/G/B = %d/%d/%d\n", u4AEYCoefR, u4AEYCoefG, u4AEYCoefB);
...
{
    rTuning.updateEngine(eTuningMgrFunc_AA, MTRUE, i4SubsampleIdex);
    rTuning.updateEngine(eTuningMgrFunc_PS, MTRUE, i4SubsampleIdex);

    // Register setting
    TUNING_MGR_WRITE_BITS_CAM(&rTuning, CAM_CTL_EN, AA_EN, 1, i4SubsampleIdex);
