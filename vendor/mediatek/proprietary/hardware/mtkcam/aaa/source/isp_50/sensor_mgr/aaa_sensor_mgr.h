...
public:
    ...
    MRESULT setSensorDualGain(MINT32 i4SensorDev, MUINT32 a_u4LESensorGain, MUINT32 a_u4SESensorGain);
    MRESULT setSensorHDRTriGain(MINT32 i4SensorDev, MUINT32 a_u4LESensorGain, MUINT32 a_u4MESensorGain, MUINT32 a_u4SESensorGain);
    MRESULT setSensorATR(MINT32 i4SensorDev, MUINT32 a_u4LimitGain, MUINT32 a_u4LtcRate);
    ...
    MRESULT set2ShutterControl(MINT32 i4SensorDev, MUINT32 a_u4LEExpTime, MUINT32 a_u4SEExpTime,MINT32 a_i4LVvalue);
    MRESULT set3ShutterControl(MINT32 i4SensorDev, MUINT32 a_u4LEExpTime, MUINT32 a_u4MEExpTime, MUINT32 a_u4SEExpTime);
    MRESULT setSensorAWBGain(MINT32 i4SensorDev, strSensorAWBGain *strSensorAWBInfo);
    MRESULT setSensorShadingTbl(MINT32 i4SensorDev, std::vector<MUINT16*> &vecGain, MUINT32 tblSize);
    MRESULT getSensorVCinfo(MINT32 i4SensorDev, SENSOR_VC_INFO_T *a_rSensorVCInfo, MINT32 i4SensorMode=0);
    ...
    MRESULT setStereoFrameSyncExpAndFps(MINT32 i4SensorDev,MUINT32 i4ExpTime ,MUINT32 i4Fps);
    MRESULT updateStereoFrameSyncFps(MINT32 i4SensorDev,MINT32 i4SensorDev2,MUINT32 i4ExpTimeMain,MUINT32 i4ExpTimeMain2);
    // I2C buffer mode
    MRESULT enableSensorI2CBuffMode(MINT32 i4SensorDev, MBOOL bEnableBuffMode);
    MRESULT disableFrameSync();
    MRESULT enableSensorTestPattern(MINT32 i4SensorDev);
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Data member
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    ...
    MBOOL    m_bFlickerState[20];
    MUINT32  m_u4SensorFrameRate[20];
    MINT32   m_pSensorModeDelay[11];
    HWSyncDrv* m_pHwSyncDrvObj;
    MUINT32 m_i4FrameSyncFps[20];
    // I2c buffer mode
    MBOOL    m_bEnableBuffMode[20];
};
