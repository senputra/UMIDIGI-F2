...
config(AF_CONFIG_T &a_sAFConfig, AREA_T &sOutHWROI, MINT32 &i4OutHWBlkNumX, MINT32 &i4OutHWBlkNumY, MINT32 &i4OutHWBlkSizeX, MINT32 &i4OutHWBlkSizeY, MINT32 &i4FirstTimeConfig)
{
    ...
    reg_af_con.Bits.AF_VFLT_MODE    = a_sAFConfig.AF_V_FLT_MODE;
    ...
    /**************************     CAM_REG_AF_CON2     ********************************/
    CAM_REG_AF_CON2 reg_af_con2;
    reg_af_con2.Raw = 0x0; //default value
    reg_af_con2.Bits.AF_DS_EN       = a_sAFConfig.AF_DS_En;
    reg_af_con2.Bits.AF_H_FV1_ABS   = a_sAFConfig.AF_FV_H0_ABS;
    reg_af_con2.Bits.AF_H_FV2_ABS   = a_sAFConfig.AF_FV_H1_ABS;
    reg_af_con2.Bits.AF_V_FV_ABS    = a_sAFConfig.AF_FV_V_ABS;
    reg_af_con2.Bits.AF_H_MAXFV_ABS = a_sAFConfig.AF_FV_MAX_ABS;
    reg_af_con2.Bits.AF_H_WFV_ABS   = a_sAFConfig.AF_FV_WEIGHT_ABS;
    reg_af_con2.Bits.AF_H_FV2_EN    = a_sAFConfig.AF_FV_H1_En;
    ...
    if( win_h_size > 40)
    {
        ...
        CAM_LOGD("HW-%s WAR : BlkSzW set to 40, blkNumX %d->%d", __FUNCTION__, i4OutHWBlkNumX, nh);
    ...
    if (win_v_size > 128)
    {
        ...
        CAM_LOGD("HW-%s WAR : BlkSzH set to 128, blkNumY %d->%d", __FUNCTION__, i4OutHWBlkNumY, nv);
    ...
    /**************************     CAM_REG_AF_BLK_2     ******************************/
    CAM_REG_AF_BLK_2 reg_af_blk_2;
    reg_af_blk_2.Raw = 0;
    reg_af_blk_2.Bits.AF_PROT_BLK_XSIZE = PROT_BLOCK_X_SIZE;
    reg_af_blk_2.Bits.AF_PROT_BLK_YSIZE = PROT_BLOCK_Y_SIZE;
    ...
    /**************************     CAM_REG_AF_FLT_9     ******************************/
    CAM_REG_AF_FLT_9 reg_af_flt_9;
    reg_af_flt_9.Raw =0;
    reg_af_flt_9.Bits.AF_VFLT_X4 = a_sAFConfig.AF_FIL_V[4];
    reg_af_flt_9.Bits.AF_VFLT_X5 = a_sAFConfig.AF_FIL_V[5];
    /**************************     CAM_REG_AF_FLT_10    ******************************/
    CAM_REG_AF_FLT_10 reg_af_flt_10;
    reg_af_flt_10.Raw =0;
    reg_af_flt_10.Bits.AF_VFLT_X6 = a_sAFConfig.AF_FIL_V[6];
    reg_af_flt_10.Bits.AF_VFLT_X7 = a_sAFConfig.AF_FIL_V[7];
    /**************************     CAM_REG_AF_FLT_11    ******************************/
    CAM_REG_AF_FLT_11 reg_af_flt_11;
    reg_af_flt_11.Raw =0;
    reg_af_flt_11.Bits.AF_VFLT_X8 = a_sAFConfig.AF_FIL_V[8];
    reg_af_flt_11.Bits.AF_VFLT_X9 = a_sAFConfig.AF_FIL_V[9];
    /**************************     CAM_REG_AF_FLT_12    ******************************/
    CAM_REG_AF_FLT_12 reg_af_flt_12;
    reg_af_flt_12.Raw =0;
    reg_af_flt_12.Bits.AF_VFLT_X10 = a_sAFConfig.AF_FIL_V[10];
    reg_af_flt_12.Bits.AF_VFLT_X11 = a_sAFConfig.AF_FIL_V[11];
    /**************************     CAM_REG_AF_LUT_H0_0  ******************************/
    CAM_REG_AF_LUT_H0_0 reg_af_lut_h0_0;
    ...
    /**************************     CAM_REG_AF_LUT_H0_1  ******************************/
    CAM_REG_AF_LUT_H0_1 reg_af_lut_h0_1;
    ...
    /**************************     CAM_REG_AF_LUT_H0_2  ******************************/
    CAM_REG_AF_LUT_H0_2 reg_af_lut_h0_2;
    ...
    /**************************     CAM_REG_AF_LUT_H0_3  ******************************/
    CAM_REG_AF_LUT_H0_3 reg_af_lut_h0_3;
    ...
    /**************************     CAM_REG_AF_LUT_H0_4  ******************************/
    CAM_REG_AF_LUT_H0_4 reg_af_lut_h0_4;
    ...
    /**************************     CAM_REG_AF_LUT_H1_0  ******************************/
    CAM_REG_AF_LUT_H1_0 reg_af_lut_h1_0;
    ...
    /**************************     CAM_REG_AF_LUT_H1_1  ******************************/
    CAM_REG_AF_LUT_H1_1 reg_af_lut_h1_1;
    ...
    /**************************     CAM_REG_AF_LUT_H1_2  ******************************/
    CAM_REG_AF_LUT_H1_2 reg_af_lut_h1_2;
    ...
    /**************************     CAM_REG_AF_LUT_H1_3  ******************************/
    CAM_REG_AF_LUT_H1_3 reg_af_lut_h1_3;
    ...
    /**************************     CAM_REG_AF_LUT_H1_4  ******************************/
    CAM_REG_AF_LUT_H1_4 reg_af_lut_h1_4;
    ...
    /**************************     CAM_REG_AF_LUT_V_0  ******************************/
    CAM_REG_AF_LUT_V_0 reg_af_lut_v_0;
    ...
    /**************************     CAM_REG_AF_LUT_V_1  ******************************/
    CAM_REG_AF_LUT_V_1 reg_af_lut_v_1;
    ...
    /**************************     CAM_REG_AF_LUT_V_2  ******************************/
    CAM_REG_AF_LUT_V_2 reg_af_lut_v_2;
    ...
    /**************************     CAM_REG_AF_LUT_V_3  ******************************/
    CAM_REG_AF_LUT_V_3 reg_af_lut_v_3;
    ...
    /**************************     CAM_REG_AF_LUT_V_4  ******************************/
    CAM_REG_AF_LUT_V_4 reg_af_lut_v_4;
...
#define FOOTPRINT_SIZ 40 /* AF_EXT_STAT_EN must be TRUE */
    ...
    if (m_bIsCCUSupport > 0)
    {
        ...
        pIsp_reg_af->CAM_CTL_EN2.Bits.SGG5_EN                = 1;
        ...
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AFO_STRIDE)       = xsize + FOOTPRINT_SIZ; /* xsize + the size of footprint */
        ...
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_FLT_9)         = reg_af_flt_9.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_FLT_10)        = reg_af_flt_10.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_FLT_11)        = reg_af_flt_11.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_FLT_12)        = reg_af_flt_12.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_H0_0)      = reg_af_lut_h0_0.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_H0_1)      = reg_af_lut_h0_1.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_H0_2)      = reg_af_lut_h0_2.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_H0_3)      = reg_af_lut_h0_3.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_H0_4)      = reg_af_lut_h0_4.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_H1_0)      = reg_af_lut_h1_0.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_H1_1)      = reg_af_lut_h1_1.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_H1_2)      = reg_af_lut_h1_2.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_H1_3)      = reg_af_lut_h1_3.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_H1_4)      = reg_af_lut_h1_4.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_V_0)       = reg_af_lut_v_0.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_V_1)       = reg_af_lut_v_1.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_V_2)       = reg_af_lut_v_2.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_V_3)       = reg_af_lut_v_3.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_LUT_V_4)       = reg_af_lut_v_4.Raw;
        REG_AF_INFO_VALUE(pIsp_reg_af, CAM_AF_CON2)          = reg_af_con2.Raw;
        ...
        /* Twin mode register or 3-raw setting*/
        ...
        memcpy((void *)&m_rIspAFRegInfo.data_c, (void *)&m_rIspAFRegInfo.data, sizeof(CAM_REG_AF_DATA));

        if (i4FirstTimeConfig == 0)
        {
        ...
        PrintReg = memcmp((void *)&m_rIspAFRegInfo.data, (void *)&m_rPreIspRegData, sizeof(CAM_REG_AF_DATA));

        if (m_bDebugEnable & 2)
        {
            for (MUINT32 i = 0; i < REG_AF_NUM; i++)
            {
                ...
                CAM_LOGD("CCU_REG_C : Addr : %04x\tData : %x", m_rIspAFRegInfo.addr[i], m_rIspAFRegInfo.data_c.val[i]);
            }
    ...
    else
    {
         ...
         *-----------------------------------------------------------------------------------------------------*/
        {
            ...
            REG_INFO_VALUE(CAM_AF_FLT_9)    = reg_af_flt_9.Raw;
            REG_INFO_VALUE(CAM_AF_FLT_10)   = reg_af_flt_10.Raw;
            REG_INFO_VALUE(CAM_AF_FLT_11)   = reg_af_flt_11.Raw;
            REG_INFO_VALUE(CAM_AF_FLT_12)   = reg_af_flt_12.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_H0_0) = reg_af_lut_h0_0.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_H0_1) = reg_af_lut_h0_1.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_H0_2) = reg_af_lut_h0_2.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_H0_3) = reg_af_lut_h0_3.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_H0_4) = reg_af_lut_h0_4.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_H1_0) = reg_af_lut_h1_0.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_H1_1) = reg_af_lut_h1_1.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_H1_2) = reg_af_lut_h1_2.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_H1_3) = reg_af_lut_h1_3.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_H1_4) = reg_af_lut_h1_4.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_V_0)  = reg_af_lut_v_0.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_V_1)  = reg_af_lut_v_1.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_V_2)  = reg_af_lut_v_2.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_V_3)  = reg_af_lut_v_3.Raw;
            REG_INFO_VALUE(CAM_AF_LUT_V_4)  = reg_af_lut_v_4.Raw;
            REG_INFO_VALUE(CAM_AF_CON2)     = reg_af_con2.Raw;
            ...
            //REG_INFO_VALUE(CAM_AF_BLK_2)    = reg_af_blk_2.Raw;
        ...
        PrintReg = memcmp( m_rIspRegInfo, m_rIspRegInfoPre, ERegInfo_NUM*sizeof(RegInfo_T));
    }
    ...
    if (PrintReg != 0)
    {
        ...
        CAM_LOGD("HW-AFOSz %d %d ; AFSz %d ; EXT Mode %d", xsize, ysize, reg_af_size.Bits.AF_IMAGE_WD, reg_af_con.Bits.AF_EXT_STAT_EN);
        CAM_LOGD_IF(m_bDebugEnable, "HW-BLF %d, %d, %d ,%d",
                 reg_af_con.Bits.AF_BLF_EN,
                 reg_af_con.Bits.AF_BLF_D_LVL,
                 reg_af_con.Bits.AF_BLF_R_LVL,
                 reg_af_con.Bits.AF_BLF_VFIR_MUX);
        CAM_LOGD_IF(m_bDebugEnable, "HW-GONLY H %d, V %d ; VAvgLV %d",
        ...
        CAM_LOGD("HW-Start %d %d ; BlkSz %d %d ; BlkNum %d %d",
                 ...
                 reg_af_blk_1.Bits.AF_BLK_XNUM,
                 reg_af_blk_1.Bits.AF_BLK_YNUM);
        CAM_LOGD_IF(m_bDebugEnable, "HW-TH_H %d %d ; TH_V %d ; TH_G %d",
                 reg_af_th_0.Bits.AF_H_TH_0,
                 reg_af_th_0.Bits.AF_H_TH_1,
                 reg_af_th_1.Bits.AF_V_TH,
                 reg_af_th_1.Bits.AF_G_SAT_TH);
        CAM_LOGD_IF(m_bDebugEnable, "HW-FIL0 %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d",
        ...
        CAM_LOGD_IF(m_bDebugEnable, "HW-FIL1 %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d",
        ...
        CAM_LOGD_IF(m_bDebugEnable, "HW-EXT Mode %d", reg_af_con.Bits.AF_EXT_STAT_EN);
        CAM_LOGD_IF(m_bDebugEnable, "HW-TH_R %d TH_B %d", reg_af_th_1.Bits.AF_R_SAT_TH, reg_af_th_1.Bits.AF_B_SAT_TH);
        CAM_LOGD_IF(m_bDebugEnable, "HW-SGG5 %d, %d, %d, %d, %d, %d, %d ; SGG5Gain %d",
...
isHWRdy( MUINT32  &i4Config)
{
    ...
    if( m_bIsApplied==MTRUE)
    {
        ...
        {
            CAM_LOGD("HW-Rdy (%d) - (%d)", m_i4AppliedConfigNum, i4Config);
        }
    }
    else
    {
...
sendAFConfigCtrl(MUINT32 eAFCtrl, MINTPTR iArg1, MINTPTR iArg2)
{
    ...
    switch(eAFCtrl)
    {
        ...
        case EAFConfigCtrl_IsAF_DSSupport:
            ...
            break;
        case EAFConfigCtrl_SetSecureFlag:
            m_bIsSecureCam = (MBOOL)iArg1;
            break;
...
isCCUSupport(MINT32 i4SensorDev, MINT32 i4SensorIdx)
{
    ...
    if (m_bIsCCUSupport == -1)
    {
        ...
        if (m_bIsCCUSupport)
        {
            ...
            if (m_bIsSecureCam != MFALSE)
            {
                m_bIsCCUSupport = 0;
                CAM_LOGD("[%s] SecureCam doen't support CCU", __FUNCTION__);
            }
        }
