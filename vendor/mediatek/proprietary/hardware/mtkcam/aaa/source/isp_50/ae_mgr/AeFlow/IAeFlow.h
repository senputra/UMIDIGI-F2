...
typedef enum
{
    E_AE_FLOW_CCU_TRIGGER_APINFO = 0,
    E_AE_FLOW_CCU_TRIGGER_MAXFPS,
    E_AE_FLOW_CCU_TRIGGER_FLICKER_FPS,
    E_AE_FLOW_CCU_TRIGGER_SENSOR_SUPPORT,
    E_AE_FLOW_CCU_TRIGGER_SENSOR_INIT
...
typedef enum
{
    ...
    E_AE_FLOW_CCU_LONG_EXP_CONTROL
...
public:
    ...
    virtual MVOID      pause(MBOOL IsNeedCCUSensorInit = MTRUE) = 0;
    ...
    virtual MVOID      update(AE_CORE_CTRL_CPU_EXP_INFO* input) = 0;
    virtual MVOID      getdebuginfo(AE_DEBUG_INFO_T &exif_info) = 0;
    virtual MVOID      getAEInfoForISP(AE_INFO_T &ae_info) = 0;
    virtual MVOID      PresetControlCCU(AE_FLOW_CONTROL_INFO_T* pcontrolInfo) = 0;
    virtual MVOID      getCCUResult(AE_CORE_MAIN_OUT* poutput,MBOOL isCCUResultGet) = 0;
...
#define MY_INST_AEFLOW INST_T<IAeFlow>
};
#endif //_I_AE_FLOW_H_
