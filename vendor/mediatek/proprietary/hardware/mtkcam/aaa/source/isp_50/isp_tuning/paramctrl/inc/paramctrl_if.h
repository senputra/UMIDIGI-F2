...
public:     // Attributes
    ...
    virtual MERROR_ENUM setRawSize(MBOOL const fgBin, ISP_RAW_SIZE_T const RawSize) = 0;
    ...
    virtual MERROR_ENUM setEnableSuperNightMode(MBOOL bEnable) = 0;
    ...
    virtual MERROR_ENUM setDebugInfo4CCU(MUINT32 const u4Rto, ISP_NVRAM_OBC_T const &OBCResult, NSIspExifDebug::IspExifDebugInfo_T& rDbgIspInfo) = 0;
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    virtual MVOID getDefaultObc(MVOID*& pISP_NVRAM_Reg)=0;
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
