...
getSensorResolution()
{
    ...
    //Check Rule #3
    if(m_rSensorCropWin[m_eFullSensorMode].w1 !=  m_rSensorCropWin[m_eFullSensorMode].w1r || m_rSensorCropWin[m_eFullSensorMode].h1!=  m_rSensorCropWin[m_eFullSensorMode].h1r)
    ...
    {
        //Check Rule #1
        if(m_rSensorCropWin[i].w0 !=  m_rSensorCropWin[m_eFullSensorMode].w0 || m_rSensorCropWin[i].h0 !=  m_rSensorCropWin[m_eFullSensorMode].h0)
