...
public: // Attributes
     ...
     * @param [in] isManualAE
     */
    MBOOL setAEManual(MINT32 const i4SensorDev, MBOOL const manual);
     ...
     * @param [out] rIspExifDebugInfo ISP debug info
     */
    MBOOL setDebugInfo4CCU(MINT32 const i4SensorDev, MUINT32 const u4Rto, ISP_NVRAM_OBC_T const &rOBCResult, NSIspExifDebug::IspExifDebugInfo_T& rDbgIspInfo);
...
public: // Operations.
     ...
     * @param [out] rIspExifDebugInfo ISP debug info
     */
    MBOOL getDebugInfo(MINT32 const i4SensorDev, const NSIspTuning::ISP_INFO_T& rIspInfo, NSIspExifDebug::IspExifDebugInfo_T& rIspExifDebugInfo, const void* pTuningBuf);
    ...
    /**
     * @brief notify set Super night mode
     * @param [in] i4SensorDev sensor device
     * @param [in] Enable Super Night mode or not
     */
    MBOOL setEnableSuperNightMode(MINT32 const i4SensorDev, MBOOL bEnable);
 ...
 */
    MVOID getDefaultObc(MINT32 const i4SensorDev, MVOID*& pISP_NVRAM_Reg);
    /**
    ...
    EZoom_T getZoomIdx(MINT32 const i4SensorDev, MUINT32 const i4ZoomRatio_x100);
    ...
    enum E_ISPTUNING_CTRL
    {
        ...
        //for face assisted
        E_ISPTUNING_FD_TUNING_INFO     = 0x7000,
        //
