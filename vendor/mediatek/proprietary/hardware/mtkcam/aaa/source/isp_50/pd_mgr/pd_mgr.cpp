...
PDMgr::PDBufThreadLoop(MVOID *arg)
{
    ...
    while(1)
    {
        ...
        //
        {
            ...
            {
                _this->m_pAnalysisData_Calculate->numDa = _this->m_pAnalysisData_Update->numDa;
                for (MUINT32 i = 0; i < _this->m_pAnalysisData_Update->numDa; i++) {
                    _this->m_pAnalysisData_Calculate->Da[i].sRoiInfo = _this->m_pAnalysisData_Update->Da[i].sRoiInfo;
                    _this->m_pAnalysisData_Calculate->Da[i].sHandlePDInput.i4MinLensPos =
                      _this->m_pAnalysisData_Update->Da[i].sHandlePDInput.i4MinLensPos;
                    _this->m_pAnalysisData_Calculate->Da[i].sHandlePDInput.i4MaxLensPos =
                      _this->m_pAnalysisData_Update->Da[i].sHandlePDInput.i4MaxLensPos;
                }
