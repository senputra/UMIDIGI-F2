...
MBOOL ISP_MGR_AWB_STAT_CONFIG_T::config(AWB_STAT_CONFIG_T& rAWBStatConfig, MBOOL bHBIN2Enable, int imgW, int imgH, int blkW, int blkH)
{
    ...
    property_get("vendor.debug.isp_mgr_awb.enable", value, "1");
    m_bDebugEnable = atoi(value);
    m_imgW = (MUINT32)imgW;
    m_imgH = (MUINT32)imgH;
    m_blkW = (MUINT32)blkW;
    m_blkH = (MUINT32)blkH;
    CAM_LOGD_IF(m_bDebugEnable, "WOrg %d/%d WSi/%d/%d WP/%d/%d WN/%d/%d PG %d/%d/%d PGL %d/%d/%d Lth %d/%d/%d Hth %d/%d/%d PC %d/%d/%d ",
...
#if 0    
    CAM_LOGD_IF(m_bDebugEnable, "Eth %d/%d Cord/%d/%d L0/%d/%d/%d/%d L1/%d/%d/%d/%d L2/%d/%d/%d/%d L3/%d/%d/%d/%d L4/%d/%d/%d/%d L5/%d/%d/%d/%d ",
    ...
    CAM_LOGD_IF(m_bDebugEnable, "L6/%d/%d/%d/%d L7/%d/%d/%d/%d L8/%d/%d/%d/%d L9/%d/%d/%d/%d",
...
MBOOL
ISP_MGR_AWB_STAT_CONFIG_T::
Cbreconfig(MVOID *pDBinInfo, MVOID *pOutRegCfg)
{
    MUINT32 u4Offset = 0;
    MUINT32* pIspReg = NULL;
