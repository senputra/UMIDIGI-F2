...
get_LVIdx_neighbor(RAWIspCamInfo& rIspCamInfo, ELV_T const LVIdx)
{
      ...
      if (rIspCamInfo.rAEInfo.i4RealLightValue_x10 >= (MINT32)m_rIspParam.ISPRegs.Lv_Env.IDX_Partition[m_rIspParam.ISPRegs.Lv_Env.u2Length-1]){
...
get_IspLVIdx_neighbor(RAWIspCamInfo& rIspCamInfo, EIspLV_T const IspLVIdx)
{
      ...
      if (rIspCamInfo.rAEInfo.i4RealLightValue_x10 >= (MINT32)m_rIspParam.ISPRegs.IspLv_Env.IDX_Partition[m_rIspParam.ISPRegs.IspLv_Env.u2Length-1]){
...
get_ISOIdx_neighbor(RAWIspCamInfo& rIspCamInfo, EISO_T const IsoIdx, MUINT32 const u4Iso, EISO_GROUP_T u4ISO_Group)
{
      ...
      if (u4Iso >= (MUINT32)m_rIspParam.ISPRegs.Iso_Env[u4ISO_Group].IDX_Partition[m_rIspParam.ISPRegs.Iso_Env[u4ISO_Group].u2Length-1]){
