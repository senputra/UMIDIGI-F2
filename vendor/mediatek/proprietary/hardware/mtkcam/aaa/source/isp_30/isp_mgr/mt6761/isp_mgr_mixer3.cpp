...
#define MY_INST_MIXER3 NS3Av3::INST_T<ISP_MGR_MIXER3_T>
static std::array<MY_INST_MIXER3, SENSOR_IDX_MAX> gMultitonMIXER3;
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    MY_INST_MIXER3& rSingleton = gMultitonMIXER3[i4SensorIdx];
