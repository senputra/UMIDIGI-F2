...
public: // Attributes
     ...
     * @param [out] rIspExifDebugInfo ISP debug info
     */
    MBOOL setDebugInfo4CCU(MINT32 const /*i4SensorDev*/, MUINT32 const /*u4Rto*/, ISP_NVRAM_OBC_T const& /*rOBCResult*/, NSIspExifDebug::IspExifDebugInfo_T& /*rDbgIspInfo*/){return true;};
...
public: // Operations.
     ...
     * @param [out] rIspExifDebugInfo ISP debug info
     */
    MBOOL getDebugInfo(MINT32 const i4SensorDev, const ISP_INFO_T& rIspInfo, NSIspExifDebug::IspExifDebugInfo_T& rIspExifDebugInfo, const void* pTuningBuf);
     ...
     */
    MBOOL getDebugInfo_MultiPassNR(MINT32 const i4SensorDev, const ISP_INFO_T& rIspInfo, DEBUG_RESERVEA_INFO_T& rDebugInfo, const void* pRegBuf);
 ...
 */
   // MVOID getDefaultObc(MINT32 const i4SensorDev, MUINT32 eIspProfile, MUINT32 eSensorMode, MVOID*& pObc, MUINT16& i4idx);
    ...
    enum E_SHADING_RATIO_MODE
    {
        E_SHADING_RATIO_FREE_RUN,
        E_SHADING_RATIO_LOCK,
        E_SHADING_RATIO_UNLOCK
    };
