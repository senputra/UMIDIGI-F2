...
public:
    ...
    */
     ...
     */
    MRESULT setMVHDR3ExpoProcInfo(MINT32 i4SensorDev, MVOID *pMVHDR3ExpoStatBuf, MUINT32 u4MVHDRRatio_x100){return 0;};
    #endif
    /**
     ...
     * @param [in] pAEStatBuf AE statistic buffer pointer
     */
    MRESULT doPvAE_TG_INT(MINT32 /*i4SensorDev*/, MVOID* /**pAEStatBuf*/) {return MFALSE;};
    /**
    ...
    */
    MRESULT updateISPNvramOBCTable(MINT32 /*i4SensorDev*/, MVOID* /*pISPNvramOBCTable*/, MINT32 /*i4Tableidx*/) {return MFALSE;};
    /**
    ...
    */
     ...
     * @param [in] i4SensorDev sensor device; please refer to ESensorDev_T in isp_tuning.h
     * @param [in] bIsEVChange check if setAEEVCompIndex() calls this function
    */
    ...
    */
    MRESULT getTgIntAEInfo(MINT32 /*i4SensorDev*/, MBOOL& /*&bTgIntAEEn*/, MFLOAT& /*&fTgIntAERatio*/) {return MFALSE;};
    /**
    ...
    */
     ...
     */
    MRESULT getAAOSize(MINT32 /*i4SensorDev*/, MUINT32& /*u4BlockNumW*/, MUINT32& /*u4BlockNumH*/){return true;};
    // EM feature APIs.
    /**
    ...
    */
     ...
     */
    MRESULT reconfig(MINT32 /*i4SensorDev*/, MVOID* /*pDBinInfo*/, MVOID* /*pOutRegCfg*/){return 0;};
    /**
     ...
     */
    MRESULT setCCUOnOff(MINT32 /*i4SensorDev*/,MBOOL /*enable*/){return true;};
    /**
     ...
     */
    MRESULT resetMvhdrRatio(MINT32 /*i4SensorDev*/, MBOOL /*bReset*/){return true;};
    /**
     * @brief get AE ISO thres status
     * @param [out] a_ISOIdx1Status ISO1 status value
     * @param [out] a_ISOIdx2Status ISO2 status value
     */
	MRESULT getISOThresStatus(MINT32 /*i4SensorDev*/, MINT32* /**a_ISOIdx1Status*/, MINT32* /**a_ISOIdx2Status*/){return true;};
    /**
     ...
     */
    MRESULT resetGetISOThresStatus(MINT32 /*i4SensorDev*/, MINT32* /**a_ISOIdx1Status*/, MINT32* /**a_ISOIdx2Status*/){return true;};
    // CCT feature APIs.
    /**
     * @brief Enable AE
    */
