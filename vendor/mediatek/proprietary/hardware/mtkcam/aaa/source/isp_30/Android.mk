...
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_ALGO_INCLUDE)
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_ALGO_INCLUDE)/lib3a
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_ALGO_INCLUDE)/libflicker
LOCAL_MODULE := libmtkcam_3a_algo_headers
...
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_ctl.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_obc.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_bnr.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_lsc.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_rpg.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_pgn.cpp
ifneq ($(TARGET_BOARD_PLATFORM), mt6761)
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_sl2.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_nsl2a.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_cfa.cpp
endif
ifeq ($(TARGET_BOARD_PLATFORM), mt6761)
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_udm.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_nbc2.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_lce.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_nr3d.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_mfb.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_mixer3.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_nsl2.cpp
endif

LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_ccm.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_ggm.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_g2c.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_nbc.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_pca.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_seee.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_dbs.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_awb_stat.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_ae_stat.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_af_stat.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_pdo.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_flk.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_mgr_helper.cpp
LOCAL_SRC_FILES += isp_mgr/$(TARGET_BOARD_PLATFORM)/isp_debug.cpp
LOCAL_SRC_FILES += ispdrv_mgr/$(TARGET_BOARD_PLATFORM)/ispdrv_mgr.cpp
...
LOCAL_SRC_FILES += buf_mgr/StatisticPipeWrapper/$(TARGET_BOARD_PLATFORM)/aao_buf_mgr.cpp
LOCAL_SRC_FILES += buf_mgr/StatisticPipeWrapper/$(TARGET_BOARD_PLATFORM)/afo_buf_mgr.cpp
LOCAL_SRC_FILES += buf_mgr/StatisticPipeWrapper/$(TARGET_BOARD_PLATFORM)/flko_buf_mgr.cpp
...
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/isp_tuning_mgr.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/isp_tuning_buf.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/paramctrl/paramctrl_lifetime.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/paramctrl/paramctrl_user.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/paramctrl/paramctrl_attributes.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/paramctrl/paramctrl_validate.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/paramctrl/paramctrl_per_frame.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/paramctrl/paramctrl_frameless.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/paramctrl/paramctrl_exif.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/paramctrl/pca_mgr/pca_mgr.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/paramctrl/ccm_mgr/ccm_mgr.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/paramctrl/ggm_mgr/ggm_mgr.cpp
LOCAL_SRC_FILES += isp_tuning/$(TARGET_BOARD_PLATFORM)/capturenr/capturenr.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_COMMON)/iopipe/NormalPipeUtils.cpp
#LOCAL_SRC_FILES += lsc_mgr/LscTbl.cpp
LOCAL_SRC_FILES += lsc_mgr/$(TARGET_BOARD_PLATFORM)/LscBufImp.cpp
LOCAL_SRC_FILES += lsc_mgr/$(TARGET_BOARD_PLATFORM)/LscNvramImp.cpp
LOCAL_SRC_FILES += lsc_mgr/$(TARGET_BOARD_PLATFORM)/LscMgrDefault.cpp
LOCAL_SRC_FILES += lsc_mgr/$(TARGET_BOARD_PLATFORM)/LscMgrDefault.misc.cpp
LOCAL_SRC_FILES += lsc_mgr/$(TARGET_BOARD_PLATFORM)/OpenShading.cpp
LOCAL_SRC_FILES += lsc_mgr/$(TARGET_BOARD_PLATFORM)/TsfDft.cpp
LOCAL_SRC_FILES += lsc_mgr/$(TARGET_BOARD_PLATFORM)/TsfRto2.cpp
LOCAL_SRC_FILES += lsc_mgr/$(TARGET_BOARD_PLATFORM)/LscTsf.cpp
LOCAL_SRC_FILES += lsc_mgr/$(TARGET_BOARD_PLATFORM)/LscMgr.cpp
...
MTKCAM_DRV_30_INCLUDE := $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/drv/include/isp_30
LOCAL_C_INCLUDES += $(MTKCAM_DRV_30_INCLUDE)
# LOCAL_C_INCLUDES += $(MTKCAM_DRV_30_INCLUDE)/drv
...
LOCAL_HEADER_LIBRARIES += libmtkcam_3a_algo_headers
...
LOCAL_C_INCLUDES += $(MTKCAM_3A_PATH)/isp_interpolation/$(TARGET_BOARD_PLATFORM)
...
$(info MTK_PLATFORM_TEST = $(MTK_PLATFORM))
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/$(MTKCAM_3A_PATH)/nvram_mgr
...
ifeq ($(TARGET_BOARD_PLATFORM), mt6761)
#ISP RAW PATH - HBIN1
LOCAL_CFLAGS += -DISP_RAW_PATH_BININFO=1
else
#ISP RAW PATH - HBIN
LOCAL_CFLAGS += -DISP_RAW_PATH_BININFO=0
endif
...
LOCAL_HEADER_LIBRARIES += libandroid_sensor_headers libhardware_headers libcustom_isp_headers
