...
init()
{
    ...
    property_get("vendor.debug.isp_debug.enable", value, "1");
...
#if 0
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.debug.dma", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
#if 0
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.debug.dbs", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.debug.obc", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
#if 0
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.debug.bnr", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.debug.lsc", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.debug.rpg", value, "0"); // 0: disable, 1: TG1, 2: TG2, 3: TG1/TG2
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.debug.pgn", value, "0"); // 0: disable, 1: enable
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.debug.udm", value, "0"); // 0: disable, 1: enable
    MBOOL bDebugEnable = atoi(value);
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.debug.nbc2", value, "0"); // 0: disable, 1: enable
    MBOOL bDebugEnable = atoi(value);
