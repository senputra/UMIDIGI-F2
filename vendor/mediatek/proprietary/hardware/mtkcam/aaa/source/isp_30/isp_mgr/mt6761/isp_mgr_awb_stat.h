...
public: ////
    static MyType&  getInstance(ESensorDev_T const eSensorDev, ESensorTG_T eSensorTG = ESensorTG_1);
...
public: //    Interfaces
    MBOOL config(AWB_STAT_CONFIG_T& rAWBStatConfig, MBOOL bHBIN2Enable, MINT32 mAaoW, MINT32 mAaoH, MINT32 i4WindowNumX, MINT32 i4WindowNumY, MINT32 i4SensorIndex);
