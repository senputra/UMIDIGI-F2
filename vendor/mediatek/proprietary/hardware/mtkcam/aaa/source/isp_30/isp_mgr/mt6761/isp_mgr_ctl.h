...
public:
    ...
    {
        reinterpret_cast<ISP_CAM_CTL_EN_P1_T*>(REG_INFO_VALUE_PTR(CAM_CTL_EN_P1))->DBS_EN = bEnable;
    }
...
public:
    ISP_MGR_CTL_EN_P1_D(ESensorDev_T const eSensorDev)
        : ISP_MGR_BASE_T(m_rIspRegInfo, ERegInfo_NUM, m_u4StartAddr, eSensorDev)
...
public:
    ...
    setEnable_DBS(MBOOL bEnable)
    {
        reinterpret_cast<ISP_CAM_CTL_EN_P1_D_T*>(REG_INFO_VALUE_PTR(CAM_CTL_EN_P1_D))->DBS_D_EN = bEnable;
    }
...
public:
    ...
    MVOID
    setEnable_NSL2(MBOOL bEnable)
    {
        reinterpret_cast<ISP_CAM_CTL_EN_P2_T*>(REG_INFO_VALUE_PTR(CAM_CTL_EN_P2))->NSL2_EN = bEnable;
    }

    MBOOL
    getEnable_NSL2()
    {
        return reinterpret_cast<ISP_CAM_CTL_EN_P2_T*>(REG_INFO_VALUE_PTR(CAM_CTL_EN_P2))->NSL2_EN;
    }

    MVOID
    setEnable_UDM(MBOOL bEnable)
    {
        reinterpret_cast<ISP_CAM_CTL_EN_P2_T*>(REG_INFO_VALUE_PTR(CAM_CTL_EN_P2))->UDM_EN = bEnable;
    }
    ...
    {
        reinterpret_cast<ISP_CAM_CTL_EN_P2_T*>(REG_INFO_VALUE_PTR(CAM_CTL_EN_P2))->NBC2_EN = bEnable;
    }
