...
#define MY_INST_CTL_EN_P1_D NS3Av3::INST_T<ISP_MGR_CTL_EN_P1_D_T>
static std::array<MY_INST_CTL_EN_P1_D, SENSOR_IDX_MAX> gMultitonP1_D;
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    MY_INST_CTL_EN_P1_D& rSingleton = gMultitonP1_D[i4SensorIdx];
    std::call_once(rSingleton.onceFlag, [&] {
        rSingleton.instance = std::make_unique<ISP_MGR_CTL_EN_P1_D_T>(eSensorDev);
    } );
