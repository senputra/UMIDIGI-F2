...
private:
    ...
    mutable Mutex mLock_TG1;
    mutable Mutex mLock_TG2;
...
public:
        ...
        , m_bEnableTSFConfig(0)
    {
        ...
        if (eSensorTG == ESensorTG_1) {
            ...
            INIT_REG_INFO_ADDR(CAM_AE_STAT_EN);  // CAM+0x0698
        }
        else {
            ...
            INIT_REG_INFO_ADDR(CAM_AE_D_STAT_EN);  // CAM+0x2698
        }
...
public: //    Interfaces
    ...
    MBOOL setAEconfigParam(MBOOL bTSF);
    ...
    MBOOL apply();
    MBOOL sendAENormalPipe( MINT32 i4SensorIndex, MINT32 cmd, MINTPTR arg1, MINTPTR arg2, MINTPTR arg3);
