...
{
public:
    static MVOID setPerFramePropEnable(MBOOL bEnable);
protected:
...
protected:
     ...
     , m_eSensorDev(eSensorDev)
    {
        ...
        if (m_eSensorDev == ESensorDev_Main || m_eSensorDev == ESensorDev_MainThird) {
        ...
        else if (m_eSensorDev == ESensorDev_SubSecond){
            INIT_ISP_DRV_SCENARIO(EIspProfile_Preview, eSoftwareScenario_Sub2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_Video, eSoftwareScenario_Sub2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_Capture, eSoftwareScenario_Sub2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_ZSD_Capture, eSoftwareScenario_Sub2_ZSD_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture, eSoftwareScenario_Sub2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_Capture, eSoftwareScenario_Sub2_Pure_Raw_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_N3D_Preview, eSoftwareScenario_Sub2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_N3D_Video, eSoftwareScenario_Sub2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_N3D_Capture, eSoftwareScenario_Sub2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_Capture_EE_Off, eSoftwareScenario_Sub2_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_Capture_EE_Off_SWNR, eSoftwareScenario_Sub2_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_Blending_All_Off, eSoftwareScenario_Sub2_Mfb_Blending);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_Blending_All_Off_SWNR, eSoftwareScenario_Sub2_Mfb_Blending);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_PostProc_EE_Off, eSoftwareScenario_Sub2_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_PostProc_ANR_EE, eSoftwareScenario_Sub2_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_PostProc_ANR_EE_SWNR, eSoftwareScenario_Sub2_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_PostProc_Mixing, eSoftwareScenario_Sub2_Mfb_Mixing);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_PostProc_Mixing_SWNR, eSoftwareScenario_Sub2_Mfb_Mixing);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VFB_PostProc, eSoftwareScenario_Sub2_Vfb_Stream_2);
            INIT_ISP_DRV_SCENARIO(EIspProfile_IHDR_Preview, eSoftwareScenario_Sub2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_IHDR_Video, eSoftwareScenario_Sub2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_Capture_MultiPass_ANR_1, eSoftwareScenario_Sub2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_Capture_MultiPass_ANR_2, eSoftwareScenario_Sub2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture_MultiPass_ANR_1, eSoftwareScenario_Sub2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture_MultiPass_ANR_2, eSoftwareScenario_Sub2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_MultiPass_ANR_1, eSoftwareScenario_Sub2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_MultiPass_ANR_2, eSoftwareScenario_Sub2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_Capture_SWNR, eSoftwareScenario_Sub2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture_SWNR, eSoftwareScenario_Sub2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_Capture_SWNR, eSoftwareScenario_Sub2_Pure_Raw_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MHDR_Preview, eSoftwareScenario_Sub2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MHDR_Video, eSoftwareScenario_Sub2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MHDR_Capture, eSoftwareScenario_Sub2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Capture_EE_Off, eSoftwareScenario_Sub2_VSS_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Capture_EE_Off_SWNR, eSoftwareScenario_Sub2_VSS_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Blending_All_Off, eSoftwareScenario_Sub2_VSS_Mfb_Blending);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Blending_All_Off_SWNR, eSoftwareScenario_Sub2_VSS_Mfb_Blending);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_EE_Off, eSoftwareScenario_Sub2_VSS_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_ANR_EE, eSoftwareScenario_Sub2_VSS_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_ANR_EE_SWNR, eSoftwareScenario_Sub2_VSS_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_Mixing, eSoftwareScenario_Sub2_VSS_Mfb_Mixing);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_Mixing_SWNR, eSoftwareScenario_Sub2_VSS_Mfb_Mixing);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_MultiPass_ANR_1, eSoftwareScenario_Sub2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_MultiPass_ANR_2, eSoftwareScenario_Sub2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_TPipe_Capture, eSoftwareScenario_Sub2_IP_Raw_TPipe_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_TPipe_Capture_SWNR, eSoftwareScenario_Sub2_IP_Raw_TPipe_Stream);
            }
        else { // ESensorDev_MainSecond
            INIT_ISP_DRV_SCENARIO(EIspProfile_Preview, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_Video, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_Capture, eSoftwareScenario_Main2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_ZSD_Capture, eSoftwareScenario_Main2_ZSD_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture, eSoftwareScenario_Main2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_Capture, eSoftwareScenario_Main2_Pure_Raw_Stream);
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_Capture_EE_Off, eSoftwareScenario_Main2_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_Capture_EE_Off_SWNR, eSoftwareScenario_Main2_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_Blending_All_Off, eSoftwareScenario_Main2_Mfb_Blending);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_Blending_All_Off_SWNR, eSoftwareScenario_Main2_Mfb_Blending);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_PostProc_EE_Off, eSoftwareScenario_Main2_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_PostProc_ANR_EE, eSoftwareScenario_Main2_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_PostProc_ANR_EE_SWNR, eSoftwareScenario_Main2_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_PostProc_Mixing, eSoftwareScenario_Main2_Mfb_Mixing);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_PostProc_Mixing_SWNR, eSoftwareScenario_Main2_Mfb_Mixing);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VFB_PostProc, eSoftwareScenario_Main2_Vfb_Stream_2);
            INIT_ISP_DRV_SCENARIO(EIspProfile_IHDR_Preview, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_IHDR_Video, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_Capture_MultiPass_ANR_1, eSoftwareScenario_Main2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_Capture_MultiPass_ANR_2, eSoftwareScenario_Main2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture_MultiPass_ANR_1, eSoftwareScenario_Main2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture_MultiPass_ANR_2, eSoftwareScenario_Main2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_MultiPass_ANR_1, eSoftwareScenario_Main2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MFB_MultiPass_ANR_2, eSoftwareScenario_Main2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_Capture_SWNR, eSoftwareScenario_Main2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture_SWNR, eSoftwareScenario_Main2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_Capture_SWNR, eSoftwareScenario_Main2_Pure_Raw_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MHDR_Preview, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MHDR_Video, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_MHDR_Capture, eSoftwareScenario_Main2_Normal_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Capture_EE_Off, eSoftwareScenario_Main2_VSS_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Capture_EE_Off_SWNR, eSoftwareScenario_Main2_VSS_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Blending_All_Off, eSoftwareScenario_Main2_VSS_Mfb_Blending);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Blending_All_Off_SWNR, eSoftwareScenario_Main2_VSS_Mfb_Blending);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_EE_Off, eSoftwareScenario_Main2_VSS_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_ANR_EE, eSoftwareScenario_Main2_VSS_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_ANR_EE_SWNR, eSoftwareScenario_Main2_VSS_Mfb_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_Mixing, eSoftwareScenario_Main2_VSS_Mfb_Mixing);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_Mixing_SWNR, eSoftwareScenario_Main2_VSS_Mfb_Mixing);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_MultiPass_ANR_1, eSoftwareScenario_Main2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_MultiPass_ANR_2, eSoftwareScenario_Main2_VSS_Capture);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_TPipe_Capture, eSoftwareScenario_Main2_IP_Raw_TPipe_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_TPipe_Capture_SWNR, eSoftwareScenario_Main2_IP_Raw_TPipe_Stream);
        }
...
protected:
    ...
    inline
    MBOOL
    writeRegs(RegInfo_T*const pRegInfo, MUINT32 const u4RegInfoNum, isp_reg_t* pReg, MUINT32 destination_size)
    {
        if (pReg)
        {
            MUINT32 i;
            ...
            {
                if (destination_size >= pRegInfo[i].addr + sizeof(MUINT32))
