...
getInstance(ESensorDev_T const eSensorDev, ESensorTG_T const eSensorTG)
{
    ...
    case ESensorDev_SubSecond: //  Sub Sensor
        if (eSensorTG == ESensorTG_1)
            return  ISP_MGR_OBC_DEV<ESensorDev_SubSecond, ESensorTG_1>::getInstance();
        else
            return  ISP_MGR_OBC_DEV<ESensorDev_SubSecond, ESensorTG_2>::getInstance();
    default:
...
getInstance(ESensorDev_T const eSensorDev, ESensorTG_T const eSensorTG)
{
    ...
    case ESensorDev_Main: //  Main Sensor
        if (eSensorTG == ESensorTG_1)
            return  ISP_MGR_OBC2_DEV<ESensorDev_Main, ESensorTG_1>::getInstance();
        else
            return  ISP_MGR_OBC2_DEV<ESensorDev_Main, ESensorTG_2>::getInstance();
    case ESensorDev_MainSecond: //  Main Second Sensor
        if (eSensorTG == ESensorTG_1)
            return  ISP_MGR_OBC2_DEV<ESensorDev_MainSecond, ESensorTG_1>::getInstance();
        else
            return  ISP_MGR_OBC2_DEV<ESensorDev_MainSecond, ESensorTG_2>::getInstance();
    case ESensorDev_Sub: //  Sub Sensor
        if (eSensorTG == ESensorTG_1)
            return  ISP_MGR_OBC2_DEV<ESensorDev_Sub, ESensorTG_1>::getInstance();
        else
            return  ISP_MGR_OBC2_DEV<ESensorDev_Sub, ESensorTG_2>::getInstance();
    case ESensorDev_SubSecond: //  Sub Sensor
        if (eSensorTG == ESensorTG_1)
            return  ISP_MGR_OBC2_DEV<ESensorDev_SubSecond, ESensorTG_1>::getInstance();
        else
            return  ISP_MGR_OBC2_DEV<ESensorDev_SubSecond, ESensorTG_2>::getInstance();
    default:
        MY_ERR("eSensorDev = %d, eSensorTG = %d", eSensorDev, eSensorTG);
        return  ISP_MGR_OBC2_DEV<ESensorDev_Main, ESensorTG_1>::getInstance();
    }
