...
#define MY_INST_SEEE NS3Av3::INST_T<ISP_MGR_SEEE_T>
static std::array<MY_INST_SEEE, SENSOR_IDX_MAX> gMultitonSEEE;
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    MY_INST_SEEE& rSingleton = gMultitonSEEE[i4SensorIdx];
