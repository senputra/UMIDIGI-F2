...
MBOOL IFLKOBufMgrWrapper::init(MINT32 const i4SensorDev, MINT32 const i4SensorIdx)
{
    ...
    if (i4SensorDev & ESensorDev_SubSecond)
        ret_sub2 = FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).init(i4SensorIdx);
    if (i4SensorDev & ESensorDev_MainThird)
        ret_main3 = FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).init(i4SensorIdx);
...
MBOOL IFLKOBufMgrWrapper::uninit(MINT32 const i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_SubSecond)
        ret_sub2 = FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).uninit();
    if (i4SensorDev & ESensorDev_MainThird)
        ret_main3 = FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).uninit();
...
MBOOL IFLKOBufMgrWrapper::DMAInit(MINT32 const i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_SubSecond)
        ret_sub2 = FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).DMAInit(MTRUE);
    if (i4SensorDev & ESensorDev_MainThird)
        ret_main3 = FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).DMAInit(MTRUE);
...
MBOOL IFLKOBufMgrWrapper::DMAUninit(MINT32 const i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_SubSecond)
        ret_sub2 = FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).DMAUninit();
    if (i4SensorDev & ESensorDev_MainThird)
        ret_main3 = FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).DMAUninit();
...
MBOOL IFLKOBufMgrWrapper::enqueueHwBuf(MINT32 const i4SensorDev, BufInfo_T& rBufInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).enqueueHwBuf(rBufInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).enqueueHwBuf(rBufInfo);
...
MBOOL IFLKOBufMgrWrapper::dequeueHwBuf(MINT32 const i4SensorDev, BufInfo_T& rBufInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).dequeueHwBuf(rBufInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).dequeueHwBuf(rBufInfo);
...
MBOOL IFLKOBufMgrWrapper::updateDMABaseAddr(MINT32 const i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).updateDMABaseAddr(FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).getNextHwBuf());
    else if (i4SensorDev & ESensorDev_MainThird)
        return FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).updateDMABaseAddr(FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).getNextHwBuf());
...
MBOOL IFLKOBufMgrWrapper::setTGInfo(MINT32 const i4SensorDev, MINT32 const i4TGInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).setTGInfo(i4TGInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).setTGInfo(i4TGInfo);
...
MBOOL IFLKOBufMgrWrapper::initPipe(MINT32 const i4SensorDev, MINT32 const i4SensorIdx, MINT32 const i4TGInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).initPipe(i4SensorIdx, i4TGInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).initPipe(i4SensorIdx, i4TGInfo);
...
MBOOL IFLKOBufMgrWrapper::uninitPipe(MINT32 const i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).uninitPipe();
    else if (i4SensorDev & ESensorDev_MainThird)
        return FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).uninitPipe();
...
MBOOL IFLKOBufMgrWrapper::startPipe(MINT32 const i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).startPipe();
    else if (i4SensorDev & ESensorDev_MainThird)
        return FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).startPipe();
...
MBOOL IFLKOBufMgrWrapper::stopPipe(MINT32 const i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).stopPipe();
    else if (i4SensorDev & ESensorDev_MainThird)
        return FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).stopPipe();
...
MBOOL IFLKOBufMgrWrapper::dequePipe(MINT32 const i4SensorDev, BufInfo_T& rBufInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).dequePipe(rBufInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).dequePipe(rBufInfo);
...
MBOOL IFLKOBufMgrWrapper::enquePipe(MINT32 const i4SensorDev, BufInfo_T& rBufInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return FLKOBufMgrWrapper::getInstance(ESensorDev_SubSecond).enquePipe(rBufInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return FLKOBufMgrWrapper::getInstance(ESensorDev_MainThird).enquePipe(rBufInfo);
...
FLKOBufMgrWrapper& FLKOBufMgrWrapper::getInstance(MINT32 const i4SensorDev)
{
    ...
    case ESensorDev_MainThird: //  Main Third Sensor
        return  FLKOBufMgrDev<ESensorDev_MainThird>::getInstance();
    case ESensorDev_Sub: //  Sub Sensor
        return  FLKOBufMgrDev<ESensorDev_Sub>::getInstance();
    case ESensorDev_SubSecond: //  Sub Second Sensor
        return  FLKOBufMgrDev<ESensorDev_SubSecond>::getInstance();
    default:
...
{
    MBOOL ret = init(i4SensorIdx);
    if(ret != MTRUE)
        CAM_LOGE("init fail(It should not happen).");

    ret = setTGInfo(i4TGInfo);
    if(ret != MTRUE)
        CAM_LOGE("setTGInfo fail.");
...
MBOOL FLKOBufMgrWrapper::uninitPipe()
{
    MBOOL ret = uninit();
    if(ret != MTRUE)
        CAM_LOGE("uninit fail(It should not happen).");
...
{
    MBOOL ret = DMAInit(MTRUE);
    if(ret != MTRUE)
        CAM_LOGE("DMAInit fail.");
