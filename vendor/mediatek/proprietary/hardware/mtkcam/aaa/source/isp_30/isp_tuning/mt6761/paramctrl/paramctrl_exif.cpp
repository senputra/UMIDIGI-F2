...
getDebugInfoP1(NSIspExifDebug::IspExifDebugInfo_T& rDebugInfo, MBOOL const /*fgReadFromHW*/) const
{
    ...
    MUINT32 u4RegCnt = (_A_P1(CAM_BNR_D_PDC_POS) - _A_P1(CAM_CTL_START)) / 4 + 1;
    ...
    else
    {
        if (pP1TuningBuffer != NULL)
        {
            ...
            rDebugInfo.P1RegInfo.u4HwVersion = 8;
...
getDebugInfo(const NSIspTuning::ISP_INFO_T& rIspInfo, NSIspExifDebug::IspExifDebugInfo_T& rDebugInfo, const void* pRegBuf) const
{
    ...
    setIspIdx(rTags, IDX_DBS, m_ISP_INT.u2DbsLowerIdx);
    ...
    setIspIdx(rTags, IDX_BPC, m_ISP_INT.u2BpcLowerIdx);
    ...
    setIspIdx(rTags, IDX_NR1, m_ISP_INT.u2Nr1LowerIdx);
    ...
    // UDM
    MY_LOG_IF(m_bDebugEnable,"UDM:");
    setIspIdx(rTags, IDX_UDM, rCamInfo.rIspIntInfo.u2UdmLowerIdx);
    ...
    // ANR
    MY_LOG_IF(m_bDebugEnable,"ANR:");
    setIspIdx(rTags, IDX_ANR, rCamInfo.rIspIntInfo.u2AnrLowerIdx);
    ...
    //  EE
    MY_LOG_IF(m_bDebugEnable,"EE:");
    setIspIdx(rTags, IDX_EE, rCamInfo.rIspIntInfo.u2EELowerIdx);
    ...
    MUINT32 p2Size = (_A_P1(CAM_BOK_RSV1) - _A_P1(CAM_CTL_START)) / 4 + 1;
    ...
    else
    {
        ...
        rDebugInfo.P2RegInfo.u4HwVersion = 8;
