...
public:
    ...
    virtual MERROR_ENUM validatePerFrameP2(MINT32 flowType, const ISP_INFO_T& rIspInfo, void* pRegBuf);
...
protected:  ////    Module.
    ...
    MBOOL   prepareHw_PerFrame_OBC2(const RAWIspCamInfo& rIspCamInfo, const IndexMgr& rIdx);
    MBOOL   prepareHw_PerFrame_DBS2(RAWIspCamInfo& rIspCamInfo, const IndexMgr& rIdx);
    MBOOL   prepareHw_PerFrame_BPC2(RAWIspCamInfo& rIspCamInfo, const IndexMgr& rIdx);
    ...
    MBOOL   prepareHw_PerFrame_CCR(RAWIspCamInfo& rIspCamInfo, const IndexMgr& rIdx);
    MBOOL   prepareHw_PerFrame_PCA(RAWIspCamInfo& rIspCamInfo, const IndexMgr& rIdx);
    ...
    MBOOL   prepareHw_PerFrame_NSL2(const RAWIspCamInfo& rIspCamInfo, const IndexMgr& rIdx);
	...
	MBOOL   prepareHw_PerFrame_LSC_2(const ISP_INFO_T& rIspInfo);
...
protected:  ////    ISP Shading Manager.
    ...
    MBOOL m_bFlkEnable;
    ISP_NVRAM_PCA_LUT_T m_SmoothPCA_Prv;
    MBOOL m_bSmoothPCA_FirstTimeBoot;
    MINT32 m_IspInterpCtrl;
    ISP_INT_INFO_T m_ISP_INT;
    ISP_DYNAMIC_INFO_T m_ISP_DYM;
    MINT32  m_i4LscMgrRatio;
};
