...
getInstance(ESensorDev_T const eSensorDev, ESensorTG_T const eSensorTG)
{
    ...
    std::call_once(rSingleton.onceFlag, [&] {
        rSingleton.instance = std::make_unique<ISP_MGR_AWB_STAT_CONFIG_T>(eSensorDev, eSensorTG);
    } );
...
MBOOL
ISP_MGR_AWB_STAT_CONFIG_T::
config(AWB_STAT_CONFIG_T& rAWBStatConfig, MBOOL bHBIN2Enable, MINT32 mAaoW, MINT32 mAaoH, MINT32 i4WindowNumX, MINT32 i4WindowNumY, MINT32 i4SensorIndex)
{
    ...
    if (m_eSensorTG == ESensorTG_1) {
        ...
        // CAM_AWB_WIN_SIZE
        reinterpret_cast<ISP_CAM_AWB_WIN_SIZE_T*>(REG_INFO_VALUE_PTR(CAM_AWB_WIN_SIZE))->AWB_W_HSIZE = (bHBIN2Enable) ? ((rAWBStatConfig.i4WindowSizeX/4)*2) : rAWBStatConfig.i4WindowSizeX;
        reinterpret_cast<ISP_CAM_AWB_WIN_SIZE_T*>(REG_INFO_VALUE_PTR(CAM_AWB_WIN_SIZE))->AWB_W_VSIZE = rAWBStatConfig.i4WindowSizeY;
        MINT32 i4PixelCountR=0;
        MINT32 i4PixelCountG=0;
        MINT32 i4PixelCountB=0;


        {
            MINT32 winX = reinterpret_cast<ISP_CAM_AWB_WIN_SIZE_T*>(REG_INFO_VALUE_PTR(CAM_AWB_WIN_SIZE))->AWB_W_HSIZE;
            MINT32 winY = reinterpret_cast<ISP_CAM_AWB_WIN_SIZE_T*>(REG_INFO_VALUE_PTR(CAM_AWB_WIN_SIZE))->AWB_W_VSIZE;
            MINT32 i4WindowPixelNumR = (winX * winY) / 4;
            MINT32 i4WindowPixelNumG = i4WindowPixelNumR * 2;
            MINT32 i4WindowPixelNumB = i4WindowPixelNumR;
            i4PixelCountR = ((1 << 24) + (i4WindowPixelNumR >> 1)) / i4WindowPixelNumR;
            i4PixelCountG = ((1 << 24) + (i4WindowPixelNumG >> 1)) / i4WindowPixelNumG;
            i4PixelCountB = ((1 << 24) + (i4WindowPixelNumB >> 1)) / i4WindowPixelNumB;
        }
        // CAM_AWB_WIN_PIT
        ...
        // CAM_AWB_PIXEL_CNT0
            reinterpret_cast<ISP_CAM_AWB_PIXEL_CNT0_T*>(REG_INFO_VALUE_PTR(CAM_AWB_PIXEL_CNT0))->AWB_PIXEL_CNT0 = i4PixelCountR;//(bHBIN2Enable) ? (rAWBStatConfig.i4PixelCountR * 2) : rAWBStatConfig.i4PixelCountR;
            // CAM_AWB_PIXEL_CNT1
            reinterpret_cast<ISP_CAM_AWB_PIXEL_CNT1_T*>(REG_INFO_VALUE_PTR(CAM_AWB_PIXEL_CNT1))->AWB_PIXEL_CNT1 = i4PixelCountG;//(bHBIN2Enable) ? (rAWBStatConfig.i4PixelCountG * 2) : rAWBStatConfig.i4PixelCountG;
            // CAM_AWB_PIXEL_CNT2
            reinterpret_cast<ISP_CAM_AWB_PIXEL_CNT2_T*>(REG_INFO_VALUE_PTR(CAM_AWB_PIXEL_CNT2))->AWB_PIXEL_CNT2 = i4PixelCountB;//(bHBIN2Enable) ? (rAWBStatConfig.i4PixelCountB * 2) : rAWBStatConfig.i4PixelCountB;
    ...
    // Backup AWB statistics config
    m_rAWBStatConfig = rAWBStatConfig;
...
{
#if 0
    if ((eIspProfile == EIspProfile_MFB_Blending_All_Off) ||
        (eIspProfile == EIspProfile_MFB_PostProc_EE_Off) ||
        (eIspProfile == EIspProfile_MFB_PostProc_ANR_EE) ||
        (eIspProfile == EIspProfile_MFB_PostProc_Mixing) ||
        (eIspProfile == EIspProfile_VSS_MFB_Blending_All_Off) ||
        (eIspProfile == EIspProfile_VSS_MFB_PostProc_EE_Off) ||
        (eIspProfile == EIspProfile_VSS_MFB_PostProc_ANR_EE) ||
        (eIspProfile == EIspProfile_VSS_MFB_PostProc_Mixing) ||
        (eIspProfile == EIspProfile_VFB_PostProc) ||
    ...
    if (m_eSensorTG == ESensorTG_1) {
        //reinterpret_cast<ISP_CAM_AWB_GAIN1_0_T*>(REG_INFO_VALUE_PTR(CAM_AWB_GAIN1_0))->AWB_GAIN1_R = (m_rAWBStatConfig.i4PreGainR * m_i4IspAEGain + (AWB_SCALE_UNIT >> 1)) / AWB_SCALE_UNIT;
        //reinterpret_cast<ISP_CAM_AWB_GAIN1_0_T*>(REG_INFO_VALUE_PTR(CAM_AWB_GAIN1_0))->AWB_GAIN1_G = (m_rAWBStatConfig.i4PreGainG * m_i4IspAEGain + (AWB_SCALE_UNIT >> 1)) / AWB_SCALE_UNIT;
        //reinterpret_cast<ISP_CAM_AWB_GAIN1_1_T*>(REG_INFO_VALUE_PTR(CAM_AWB_GAIN1_1))->AWB_GAIN1_B = (m_rAWBStatConfig.i4PreGainB * m_i4IspAEGain + (AWB_SCALE_UNIT >> 1)) / AWB_SCALE_UNIT;

        return apply_TG1();
    }
    else {
        //reinterpret_cast<ISP_CAM_AWB_D_GAIN1_0_T*>(REG_INFO_VALUE_PTR(CAM_AWB_D_GAIN1_0))->AWB_GAIN1_R = (m_rAWBStatConfig.i4PreGainR * m_i4IspAEGain + (AWB_SCALE_UNIT >> 1)) / AWB_SCALE_UNIT;
        //reinterpret_cast<ISP_CAM_AWB_D_GAIN1_0_T*>(REG_INFO_VALUE_PTR(CAM_AWB_D_GAIN1_0))->AWB_GAIN1_G = (m_rAWBStatConfig.i4PreGainG * m_i4IspAEGain + (AWB_SCALE_UNIT >> 1)) / AWB_SCALE_UNIT;
        //reinterpret_cast<ISP_CAM_AWB_D_GAIN1_1_T*>(REG_INFO_VALUE_PTR(CAM_AWB_D_GAIN1_1))->AWB_GAIN1_B = (m_rAWBStatConfig.i4PreGainB * m_i4IspAEGain + (AWB_SCALE_UNIT >> 1)) / AWB_SCALE_UNIT;
...
apply_TG2()
{
    ...
    // get module handle
    if (MFALSE == pPipe->sendCommand(NSImageioIsp3::NSIspio::EPIPECmd_GET_MODULE_HANDLE,
                           NSImageioIsp3::NSIspio::EModule_AWB_D, (MINTPTR)&handle, (MINTPTR)(&("isp_mgr_awb_stat_tg2"))))
    {
        //Error Handling
        MY_ERR("EPIPECmd_GET_MODULE_HANDLE fail");
        goto lbExit;
...
lbExit:
    ...
    // release handle
    if (MFALSE==pPipe->sendCommand(NSImageioIsp3::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINTPTR)(&("isp_mgr_awb_stat_tg2")), MNULL))
    {
        // Error Handling
        MY_ERR("EPIPECmd_SET_MODULE_CFG_DONE fail");
    }
