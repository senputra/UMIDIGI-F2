...
#define MY_INST_FLK NS3Av3::INST_T<ISP_MGR_FLK_CONFIG_T>
static std::array<MY_INST_FLK, SENSOR_IDX_MAX> gMultitonFLK;
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    MY_INST_FLK& rSingleton = gMultitonFLK[i4SensorIdx];
