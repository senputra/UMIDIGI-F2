...
static std::array<MY_INST_G2C_SHADE, SENSOR_IDX_MAX> gMultitonG2C_SHADE;
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    MY_INST_G2C_SHADE& rSingleton = gMultitonG2C_SHADE[i4SensorIdx];
    std::call_once(rSingleton.onceFlag, [&] {
