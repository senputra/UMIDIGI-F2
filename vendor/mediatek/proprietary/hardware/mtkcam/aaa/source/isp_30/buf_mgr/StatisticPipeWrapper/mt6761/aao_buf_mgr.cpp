...
init(MINT32 const i4SensorDev, MINT32 const i4SensorIdx)
{
    ...
    if (i4SensorDev & ESensorDev_SubSecond)
        ret_sub2 = AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).init(i4SensorIdx);
    if (i4SensorDev & ESensorDev_MainThird)
        ret_main3 = AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).init(i4SensorIdx);
...
uninit(MINT32 const i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_SubSecond)
       ret_sub2 = AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).uninit();
    if (i4SensorDev & ESensorDev_MainThird)
       ret_main3 = AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).uninit();
...
DMAInit(MINT32 const i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_SubSecond)
        ret_sub2 = AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).DMAInit();
    if (i4SensorDev & ESensorDev_MainThird)
        ret_main3 = AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).DMAInit();
...
DMAUninit(MINT32 const i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_SubSecond)
        ret_sub2 = AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).DMAUninit();
    if (i4SensorDev & ESensorDev_MainThird)
        ret_main3 = AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).DMAUninit();
...
AAStatEnable(MINT32 const i4SensorDev, MBOOL En)
{
    ...
    if (i4SensorDev & ESensorDev_SubSecond)
        ret_sub2 = AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).AAStatEnable(En);
    if (i4SensorDev & ESensorDev_MainThird)
        ret_main3 = AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).AAStatEnable(En);
...
enqueueHwBuf(MINT32 const i4SensorDev, BufInfo_T& rBufInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).enqueueHwBuf(rBufInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).enqueueHwBuf(rBufInfo);
...
dequeueHwBuf(MINT32 const i4SensorDev, BufInfo_T& rBufInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).dequeueHwBuf(rBufInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).dequeueHwBuf(rBufInfo);
...
updateDMABaseAddr(MINT32 const i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).updateDMABaseAddr(AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).getNextHwBuf(1));
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).updateDMABaseAddr(AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).getNextHwBuf(1));
...
setTGInfo(MINT32 const i4SensorDev, MINT32 const i4TGInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).setTGInfo(i4TGInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).setTGInfo(i4TGInfo);
...
MBOOL IAAOBufMgrWrapper::initPipe(MINT32 const i4SensorDev, MINT32 const i4SensorIdx, MINT32 const i4TGInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).initPipe(i4SensorIdx, i4TGInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).initPipe(i4SensorIdx, i4TGInfo);
...
MBOOL IAAOBufMgrWrapper::uninitPipe(MINT32 const i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).uninitPipe();
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).uninitPipe();
...
MBOOL IAAOBufMgrWrapper::startPipe(MINT32 const i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).startPipe();
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).startPipe();
...
MBOOL IAAOBufMgrWrapper::stopPipe(MINT32 const i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).stopPipe();
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).stopPipe();
...
MBOOL IAAOBufMgrWrapper::dequePipe(MINT32 const i4SensorDev, BufInfo_T& rBufInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).dequePipe(rBufInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).dequePipe(rBufInfo);
...
MBOOL IAAOBufMgrWrapper::enquePipe(MINT32 const i4SensorDev, BufInfo_T& rBufInfo)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).enquePipe(rBufInfo);
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).enquePipe(rBufInfo);
...
MBOOL IAAOBufMgrWrapper::abortDeque(MINT32 const i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        ...
        return AAOBufMgrWrapper::getInstance(ESensorDev_SubSecond).abortDeque();
    else if (i4SensorDev & ESensorDev_MainThird)
        return AAOBufMgrWrapper::getInstance(ESensorDev_MainThird).abortDeque();
...
getInstance(MINT32 const i4SensorDev)
{
    ...
    case ESensorDev_SubSecond: // sub Second Sensor
        return  AAOBufMgrDev<ESensorDev_SubSecond>::getInstance();
    case ESensorDev_MainThird: //  Main Third Sensor
        return  AAOBufMgrDev<ESensorDev_MainThird>::getInstance();
    default:
...
init(MINT32 const i4SensorIdx)
{
    ...
    case ESensorDev_SubSecond: //  Sub Second Sensor
        ...
        break;
    case ESensorDev_MainThird: //  Main Third Sensor
        rAWBStatParam = getAWBStatParam<ESensorDev_MainThird>();
        break;
    default:
    ...
    m_u4AAOBufSize = m_u4AEStateSize + m_u4AEHistSize + m_u4AWBStateSize + AE_TSF_ENABLE * 2 * rAWBStatParam.i4WindowNumX * rAWBStatParam.i4WindowNumY;
...
DMAInit()
{
    ...
    if (m_eSensorTG == ESensorTG_1) { // TG1
        ...
        MY_LOG_IF(m_bDebugEnable,"[%s()] EPIPECmd_SET_MODULE_En(MTRUE): EModule_AWB_D\n", __FUNCTION__);
        IOPIPE_SET_MODUL_ENABLE(NSImageioIsp3::NSIspio::EModule_AWB_D, MTRUE);

        MY_LOG_IF(m_bDebugEnable,"[%s()] EPIPECmd_SET_MODULE_En(MTRUE): EModule_AAO_D\n", __FUNCTION__);
...
{
    return init(i4SensorIdx) & setTGInfo(i4TGInfo);
}
