...
#define MY_INST_NSL2A NS3Av3::INST_T<ISP_MGR_NSL2A_T>
static std::array<MY_INST_NSL2A, SENSOR_IDX_MAX> gMultitonNSL2A;
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    MY_INST_NSL2A& rSingleton = gMultitonNSL2A[i4SensorIdx];
    std::call_once(rSingleton.onceFlag, [&] {
        rSingleton.instance = std::make_unique<ISP_MGR_NSL2A_T>(eSensorDev);
    } );
