...
#define MY_INST_NR3D NS3Av3::INST_T<ISP_MGR_NR3D_T>
static std::array<MY_INST_NR3D, SENSOR_IDX_MAX> gMultitonNR3D;
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    MY_INST_NR3D& rSingleton = gMultitonNR3D[i4SensorIdx];
