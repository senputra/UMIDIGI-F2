...
#define REG_INFO_D(reg)\
    (m_rIspRegInfo_D[ERegInfo_##reg])\

#define REG_INFO_VALUE_D(reg)\
    (REG_INFO_D(reg).val)

#define REG_INFO_VALUE_D_READ_OUT(reg)\
    (m_rIspRegInfoRdOut[ERegInfo_##reg].val = ISP_READ_REG_NOPROTECT(m_pIspReg, reg))

#define REG_INFO_VALUE_D_HW(reg)\
    (m_rIspRegInfoRdOut_D[ERegInfo_##reg].val)
...
private:
    ...
    enum
    {
        ...
        ERegInfo_CAM_AF_D_CON,
        ERegInfo_CAM_AF_D_TH_0,
        ERegInfo_CAM_AF_D_TH_1,
        ERegInfo_CAM_AF_D_FLT_1,
        ERegInfo_CAM_AF_D_FLT_2,
        ERegInfo_CAM_AF_D_FLT_3,
        ERegInfo_CAM_AF_D_FLT_4,
        ERegInfo_CAM_AF_D_FLT_5,
        ERegInfo_CAM_AF_D_FLT_6,
        ERegInfo_CAM_AF_D_FLT_7,
        ERegInfo_CAM_AF_D_FLT_8,
        ERegInfo_CAM_AF_D_SIZE,
        ERegInfo_CAM_AF_D_VLD,
        ERegInfo_CAM_AF_D_BLK_0,
        ERegInfo_CAM_AF_D_BLK_1,
        ERegInfo_CAM_SGG1_D_PGN,
        ERegInfo_CAM_SGG1_D_GMRC_1,
        ERegInfo_CAM_SGG1_D_GMRC_2,
        ERegInfo_CAM_AF_D_TH_2,
        ERegInfo_CAM_SGG5_D_PGN,
        ERegInfo_CAM_SGG5_D_GMRC_1,
        ERegInfo_CAM_SGG5_D_GMRC_2,
        ERegInfo_D_NUM
    };
    ...
    RegInfo_T   m_rIspRegInfo_D[ERegInfo_D_NUM];
    RegInfo_T   m_rIspRegInfoPre_D[ERegInfo_D_NUM];
    RegInfo_T   m_rIspRegInfoRdOut_D[ERegInfo_D_NUM];
