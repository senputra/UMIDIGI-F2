            ...
            switch(m_rIspCamInfo.eIspProfile) {
                ...
                case EIspProfile_MHDR_Video:
                    if (m_eSensorDev == ESensorDev_Main)
                        ...
                        eSoftwareScenario = eSoftwareScenario_Sub2_Normal_Stream;
                ...
                case EIspProfile_MHDR_Capture:
                    if (m_eSensorDev == ESensorDev_Main)
                        ...
                        eSoftwareScenario = eSoftwareScenario_Sub2_Normal_Capture;
                    else if (m_eSensorDev == ESensorDev_Sub)
                ...
                case EIspProfile_ZSD_Capture:
                    if (m_eSensorDev == ESensorDev_Main)
                        ...
                        eSoftwareScenario = eSoftwareScenario_Sub2_ZSD_Capture;
                    else if (m_eSensorDev == ESensorDev_Sub)
                ...
                case EIspProfile_VSS_Capture_MultiPass_ANR_2:
                    if (m_eSensorDev == ESensorDev_Main)
                        ...
                        eSoftwareScenario = eSoftwareScenario_Main2_VSS_Capture;
                    else if (m_eSensorDev == ESensorDev_SubSecond)
                        eSoftwareScenario = eSoftwareScenario_Sub2_VSS_Capture;
                    else if (m_eSensorDev == ESensorDev_Sub)
                ...
                case EIspProfile_PureRAW_Capture_SWNR:
                    if (m_eSensorDev == ESensorDev_Main)
                        ...
                        eSoftwareScenario = eSoftwareScenario_Sub2_Pure_Raw_Stream;
                    else if (m_eSensorDev == ESensorDev_Sub)
                ...
                case EIspProfile_PureRAW_TPipe_Capture_SWNR:
                    if (m_eSensorDev == ESensorDev_Main)
                        ...
                        eSoftwareScenario = eSoftwareScenario_Sub2_IP_Raw_TPipe_Stream;
                    else if (m_eSensorDev == ESensorDev_Sub)
                ...
                case EIspProfile_MFB_PostProc_ANR_EE_SWNR:
                    if (m_eSensorDev == ESensorDev_Main)
                        ...
                        eSoftwareScenario = eSoftwareScenario_Sub2_Mfb_Capture;
                    else if (m_eSensorDev == ESensorDev_Sub)
                ...
                case EIspProfile_MFB_Blending_All_Off_SWNR:
                    if (m_eSensorDev == ESensorDev_Main)
                        ...
                        eSoftwareScenario = eSoftwareScenario_Sub2_Mfb_Blending;
                    else if (m_eSensorDev == ESensorDev_Sub)
                ...
                case EIspProfile_MFB_PostProc_Mixing_SWNR:
                    if (m_eSensorDev == ESensorDev_Main)
                        ...
                        eSoftwareScenario = eSoftwareScenario_Sub2_Mfb_Mixing;
                    else if (m_eSensorDev == ESensorDev_Sub)
...
setAWBInfo(AWB_INFO_T const &rAWBInfo)
{
   ...
   /*if (m_bDebugEnable)
    ...
    if  ( checkParamChange(eIdx_PCA_LUT_old, eIdx_PCA_LUT_new) )
    {
        ...
        //m_rIspCamInfo.eIdx_CT = eIdx_PCA_LUT_new;
...
setISPAEGain(MBOOL bEnableWorkAround, MUINT32 u4NewIspAEGain)
{
    ...
    if(bEnableWorkAround == MTRUE) {   // enable iVHDR work around
        ...
        ISP_MGR_OBC_T::getInstance(m_eSensorDev, m_eSensorTG).getIspAEGain(&u4CurrentIspGain);
        if (checkParamChange(u4CurrentIspGain, u4NewIspAEGain)) {
...
sendIspTuningIOCtrl(MUINT32 ctrl, MINTPTR arg1, MINTPTR arg2)
{
    ...
    case IspTuningMgr::E_ISPTUNING_UPDATE_OBC_INFO:
        ...
        break;
    default:
        MY_LOG_IF(m_bDebugEnable, "%s: ctrl not supported (ctrl, arg1, arg2) = (%d, %x, %x)", __FUNCTION__, ctrl, (MUINT32)arg1, (MUINT32)arg2);
        break;
    }
}
