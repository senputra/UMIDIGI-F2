...
static const NVRAM_CAMERA_FEATURE_SWNR_STRUCT *getTuningFromNvram(MUINT32 openId, SWNR_SCENARIO scenario, MUINT32 idx)
{
    ...
    {
        SWNR_LOGE("NVRAM_CAMERA_FEATURE_SWNR_STRUCT size %d, NRTuningInfo size %d",
    ...
    MUINT32 openId)
{
    ...
    // 1. update swnr type
    NRType = ESWNRType_2_DrvNRObject((ESWNRType)get_swnr_type(sensorDev));//always return eSWNRType_Default
...
MBOOL SwNR::doSwNR(SWNRParam const& param, NSCam::IImageBuffer* pBuf)
{
    ...
    HFGTuningInfo    newHFGTunning;
    CCRTuningInfo    newCCRTuning;
    ...
    setupTuningInfo(&mTuningInfo.u.NR, &newNrTunning, &newHFGTunning);
    ...
    MyNRInitInfo.pHFGTuningInfo = &newHFGTunning;
...
void SwNR::setupTuningInfo(NRTuningInfo* tuningInfo, NR2TuningInfo* nr2Info, HFGTuningInfo *pHFGTunning)
{
    // NR2Info
    nr2Info->NR_S                 = tuningInfo->ANR_Y_LUMA_SCALE_RANGE;
    nr2Info->NR_BLD_W             = tuningInfo->ANR_C_CHROMA_SCALE;
    nr2Info->NR_K                 = tuningInfo->ANR_KSIZE_HI_TH;
    nr2Info->NR_BLD_TH            = tuningInfo->ANR_KSIZE_LO_TH;
    //nr2Info->NR_SEED
    nr2Info->NR_SMTH              = tuningInfo->ANR_LPF_HALFKERNEL;
    // HFG
    pHFGTunning->HFG_ENABLE       = tuningInfo->ANR_PTY_HGAIN;
    //pHFGTunning->HFG_NOISE_GSEED  = ;
    pHFGTunning->HFG_SD0          = tuningInfo->ANR_ACT_BLD_BASE_Y;
    pHFGTunning->HFG_SD1          = tuningInfo->ANR_ACT_BLD_TH_Y;
    pHFGTunning->HFG_SD2          = tuningInfo->ANR_ACT_SLANT_Y;
    pHFGTunning->HFG_TX_S         = tuningInfo->ANR_PTY_GAIN_TH;
    pHFGTunning->HFG_LUMA_CPX1    = tuningInfo->ANR_Y_CPX1;
    pHFGTunning->HFG_LUMA_CPX2    = tuningInfo->ANR_Y_CPX2;
    pHFGTunning->HFG_LUMA_CPX3    = tuningInfo->ANR_Y_CPX3;
    pHFGTunning->HFG_LUMA_CPY0    = tuningInfo->ANR_Y_SCALE_CPY0;
    pHFGTunning->HFG_LUMA_CPY1    = tuningInfo->ANR_Y_SCALE_CPY1;
    pHFGTunning->HFG_LUMA_CPY2    = tuningInfo->ANR_Y_SCALE_CPY2;
    pHFGTunning->HFG_LUMA_CPY3    = tuningInfo->ANR_Y_SCALE_CPY3;
    pHFGTunning->HFG_LUMA_SP0     = tuningInfo->ANR_LCE_GAIN0;
    pHFGTunning->HFG_LUMA_SP1     = tuningInfo->ANR_LCE_GAIN1;
    pHFGTunning->HFG_LUMA_SP2     = tuningInfo->ANR_LCE_GAIN2;
    pHFGTunning->HFG_LUMA_SP3     = tuningInfo->ANR_LCE_GAIN3;
