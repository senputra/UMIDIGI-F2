...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    case ESensorDev_Main: //  Main Sensor
        return  ISP_MGR_FLC_DEV<ESensorDev_Main>::getInstance();
    case ESensorDev_MainSecond: //  Main Second Sensor
        return  ISP_MGR_FLC_DEV<ESensorDev_MainSecond>::getInstance();
    case ESensorDev_Sub: //  Sub Sensor
        return  ISP_MGR_FLC_DEV<ESensorDev_Sub>::getInstance();
    case ESensorDev_SubSecond: //  Main Second Sensor
        return  ISP_MGR_FLC_DEV<ESensorDev_SubSecond>::getInstance();
    default:
