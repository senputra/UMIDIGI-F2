    ...
    switch (eSensorDev)
{
    case ESensorDev_Main: //  Main Sensor
        return  ISP_MGR_NDG_DEV<ESensorDev_Main>::getInstance();
    case ESensorDev_MainSecond: //  Main Second Sensor
        return  ISP_MGR_NDG_DEV<ESensorDev_MainSecond>::getInstance();
    case ESensorDev_Sub: //  Sub Sensor
        return  ISP_MGR_NDG_DEV<ESensorDev_Sub>::getInstance();
    case ESensorDev_SubSecond: //  Main Second Sensor
        return  ISP_MGR_NDG_DEV<ESensorDev_SubSecond>::getInstance();
    default:
...
apply(const CROP_RZ_INFO_T& rRzCrop, EIspProfile_T /*eIspProfile*/, dip_x_reg_t* pReg)
{
    ...
    reinterpret_cast<ISP_DIP_X_NDG_RAN_2_T*>(REG_INFO_VALUE_PTR(DIP_X_NDG_RAN_2))->RANSED_IMG_WD = rRzCrop.i4RzWidth;

    MUINT32 padding_16_w = (16 - (rRzCrop.i4RzWidth % 16))%16;
    MUINT32 padding_16_h = (16 - (rRzCrop.i4RzHeight % 16))%16;
    reinterpret_cast<ISP_DIP_X_NDG_RAN_3_T*>(REG_INFO_VALUE_PTR(DIP_X_NDG_RAN_3))->NDG_T_WIDTH = (rRzCrop.i4RzWidth + padding_16_w);
    reinterpret_cast<ISP_DIP_X_NDG_RAN_3_T*>(REG_INFO_VALUE_PTR(DIP_X_NDG_RAN_3))->NDG_T_HEIGHT = (rRzCrop.i4RzHeight + padding_16_h);
    reinterpret_cast<ISP_DIP_X_NDG_CROP_X_T*>(REG_INFO_VALUE_PTR(DIP_X_NDG_CROP_X))->NDG_CROP_STR_X = 0;
    reinterpret_cast<ISP_DIP_X_NDG_CROP_X_T*>(REG_INFO_VALUE_PTR(DIP_X_NDG_CROP_X))->NDG_CROP_END_X = (rRzCrop.i4RzWidth - 1);
    reinterpret_cast<ISP_DIP_X_NDG_CROP_Y_T*>(REG_INFO_VALUE_PTR(DIP_X_NDG_CROP_Y))->NDG_CROP_STR_Y = 0;
    reinterpret_cast<ISP_DIP_X_NDG_CROP_Y_T*>(REG_INFO_VALUE_PTR(DIP_X_NDG_CROP_Y))->NDG_CROP_END_Y = (rRzCrop.i4RzHeight - 1);
