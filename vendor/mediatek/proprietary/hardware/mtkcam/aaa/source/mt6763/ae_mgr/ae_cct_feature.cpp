...
{
    //MUINT32 u4SensorID;  /* fix build warning */
    //CAMERA_DUAL_CAMERA_SENSOR_ENUM eSensorEnum;  /* fix build warning */
    MRESULT err = S_AE_OK;
...
{
    //MINT32 err;
    //MUINT32 u4AFEGain = 0, u4IspGain = 1024;  /* fix build warning */
    MUINT32 u4BinningRatio = 1, u4SensitivityRatio = 1024;
    strAEInput rAEInput;
