...
protected:
        ...
        , m_u4StartAddr(REG_ADDR_P1(CAM_AFO_XSIZE))
    {
        ...
        // INIT_REG_AF_INFO_ADDR(m_pIspAFRegInfo, CAM_AFO_DRS);
        ...
        // INIT_REG_AF_INFO_ADDR(m_pIspAFRegInfo, CAM_AFO_CON);
        // INIT_REG_AF_INFO_ADDR(m_pIspAFRegInfo, CAM_AFO_CON2);
        // INIT_REG_AF_INFO_ADDR(m_pIspAFRegInfo, CAM_AFO_CON3);
        // INIT_REG_AF_INFO_ADDR(m_pIspAFRegInfo, CAM_AFO_CON4);
        // INIT_REG_AF_INFO_ADDR(m_pIspAFRegInfo, CAM_AFO_ERR_STAT);
