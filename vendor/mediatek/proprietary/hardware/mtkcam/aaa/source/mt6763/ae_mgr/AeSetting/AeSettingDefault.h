 ...
 ************************************************************************************************/
#ifndef _AE_SETTING_DFT_H_
#define _AE_SETTING_DFT_H_
...
namespace NS3Av3
{
class AeSettingDefault : public IAeSetting
{
public:
