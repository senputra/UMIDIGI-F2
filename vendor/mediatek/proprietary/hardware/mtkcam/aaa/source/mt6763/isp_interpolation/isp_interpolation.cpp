                          ...
                          ISP_NVRAM_ANR_LUT_T& rSmoothANR_TBL)
{
    ...
    //MUINT32 isFlash = rCamInfo.rFlashInfo.isFlash;

	//u4RealCT = 6500; // dont care CT, use CT_00
	...
	else
{
	...
	double RATIO_L_L = (double)(RATIO_CT_lo * RATIO_LV_lo);
	double RATIO_L_U = (double)(RATIO_CT_lo * RATIO_LV_up);
	double RATIO_U_L = (double)(RATIO_CT_up * RATIO_LV_lo);
	double RATIO_U_U = (double)(RATIO_CT_up * RATIO_LV_up);

	INTER_LOG_IF(u4SmoothANRTbldebug,"[%s()] u4RealCT: %d, u4UpperCT = %d, u4LowerCT = %d\n", __FUNCTION__, u4RealCT, u4UpperCT, u4LowerCT);
	INTER_LOG_IF(u4SmoothANRTbldebug,"[%s()] u4RealLV: %d, u4UpperLV = %d, u4LowerLV = %d\n", __FUNCTION__, u4RealLV, u4UpperLV, u4LowerLV);
	INTER_LOG_IF(u4SmoothANRTbldebug,"[%s()] u4UpperCT_Idx: %d, u4LowerCT_Idx = %d, u4UpperLV_Idx = %d, u4LowerLV_Idx = %d\n", __FUNCTION__, u4UpperCT_Idx, u4LowerCT_Idx, u4UpperLV_Idx, u4LowerLV_Idx);
	INTER_LOG_IF(u4SmoothANRTbldebug,"[%s()] RATIO_L_L: %f, RATIO_L_U = %f, RATIO_U_L = %f, RATIO_U_U = %f\n", __FUNCTION__, RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U);


	MUINT32 ANR_TBL_Y0_L_L;
	MUINT32 ANR_TBL_Y0_L_U;
	MUINT32 ANR_TBL_Y0_U_L;
	MUINT32 ANR_TBL_Y0_U_U;
	MUINT32 ANR_TBL_U0_L_L;
	MUINT32 ANR_TBL_U0_L_U;
	MUINT32 ANR_TBL_U0_U_L;
	MUINT32 ANR_TBL_U0_U_U;
	MUINT32 ANR_TBL_V0_L_L;
	MUINT32 ANR_TBL_V0_L_U;
	MUINT32 ANR_TBL_V0_U_L;
	MUINT32 ANR_TBL_V0_U_U;
	MUINT32 ANR_TBL_Y1_L_L;
	MUINT32 ANR_TBL_Y1_L_U;
	MUINT32 ANR_TBL_Y1_U_L;
	MUINT32 ANR_TBL_Y1_U_U;
	MUINT32 ANR_TBL_U1_L_L;
	MUINT32 ANR_TBL_U1_L_U;
	MUINT32 ANR_TBL_U1_U_L;
	MUINT32 ANR_TBL_U1_U_U;
	MUINT32 ANR_TBL_V1_L_L;
	MUINT32 ANR_TBL_V1_L_U;
	MUINT32 ANR_TBL_V1_U_L;
	MUINT32 ANR_TBL_V1_U_U;


	for(int i = 0; i < ANR_HW_TBL_NUM; ++i){

		ANR_TBL_Y0_L_L = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_Y0;
		ANR_TBL_Y0_L_U = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_Y0;
		ANR_TBL_Y0_U_L = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_Y0;
		ANR_TBL_Y0_U_U = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_Y0;
		ANR_TBL_U0_L_L = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_U0;
		ANR_TBL_U0_L_U = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_U0;
		ANR_TBL_U0_U_L = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_U0;
		ANR_TBL_U0_U_U = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_U0;
		ANR_TBL_V0_L_L = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_V0;
		ANR_TBL_V0_L_U = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_V0;
		ANR_TBL_V0_U_L = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_V0;
		ANR_TBL_V0_U_U = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_V0;
		ANR_TBL_Y1_L_L = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_Y1;
		ANR_TBL_Y1_L_U = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_Y1;
		ANR_TBL_Y1_U_L = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_Y1;
		ANR_TBL_Y1_U_U = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_Y1;
		ANR_TBL_U1_L_L = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_U1;
		ANR_TBL_U1_L_U = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_U1;
		ANR_TBL_U1_U_L = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_U1;
		ANR_TBL_U1_U_U = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_U1;
		ANR_TBL_V1_L_L = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_V1;
		ANR_TBL_V1_L_U = rNVRAM_ANR_TBL[u4LowerCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_V1;
		ANR_TBL_V1_U_L = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4LowerLV_Idx].lut[i].bits.ANR_TBL_V1;
		ANR_TBL_V1_U_U = rNVRAM_ANR_TBL[u4UpperCT_Idx][u4UpperLV_Idx].lut[i].bits.ANR_TBL_V1;


		rSmoothANR_TBL.lut[i].bits.ANR_TBL_Y0 =  InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_TBL_Y0_L_L, ANR_TBL_Y0_L_U, ANR_TBL_Y0_U_L, ANR_TBL_Y0_U_U,0);
		rSmoothANR_TBL.lut[i].bits.ANR_TBL_U0 =  InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_TBL_U0_L_L, ANR_TBL_U0_L_U, ANR_TBL_U0_U_L, ANR_TBL_U0_U_U,0);
		rSmoothANR_TBL.lut[i].bits.ANR_TBL_V0 =  InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_TBL_V0_L_L, ANR_TBL_V0_L_U, ANR_TBL_V0_U_L, ANR_TBL_V0_U_U,0);
		rSmoothANR_TBL.lut[i].bits.ANR_TBL_Y1 =  InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_TBL_Y1_L_L, ANR_TBL_Y1_L_U, ANR_TBL_Y1_U_L, ANR_TBL_Y1_U_U,0);
		rSmoothANR_TBL.lut[i].bits.ANR_TBL_U1 =  InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_TBL_U1_L_L, ANR_TBL_U1_L_U, ANR_TBL_U1_U_L, ANR_TBL_U1_U_U,0);
		rSmoothANR_TBL.lut[i].bits.ANR_TBL_V1 =  InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_TBL_V1_L_L, ANR_TBL_V1_L_U, ANR_TBL_V1_U_L, ANR_TBL_V1_U_U,0);
               ...
               ISP_NVRAM_HFG_T& rSmoothHFG)   // Output
{
	...
	MINT32 HFC_LCE_LINK_EN   = InterParam_HFG(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, HFC_LCE_LINK_EN_L_L, HFC_LCE_LINK_EN_L_U, HFC_LCE_LINK_EN_U_L, HFC_LCE_LINK_EN_U_U,1);
