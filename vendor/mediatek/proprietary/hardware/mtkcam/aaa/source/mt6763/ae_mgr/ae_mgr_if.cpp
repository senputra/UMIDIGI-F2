...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT IAeMgr::checkCCUWorkingStatus(MINT32 i4SensorDev)
{
  MINT32 ret_main, ret_sub, ret_main2, ret_sub2;
  ret_main = ret_sub = ret_main2 = ret_sub2 = S_AE_OK;

  if (i4SensorDev & ESensorDev_Main)
        ret_main = AeMgr::getInstance(ESensorDev_Main).checkCCUWorkingStatus();
  if (i4SensorDev & ESensorDev_Sub)
        ret_sub = AeMgr::getInstance(ESensorDev_Sub).checkCCUWorkingStatus();
  if (i4SensorDev & ESensorDev_MainSecond)
        ret_main2 = AeMgr::getInstance(ESensorDev_MainSecond).checkCCUWorkingStatus();
  if (i4SensorDev & ESensorDev_SubSecond)
        ret_sub2 = AeMgr::getInstance(ESensorDev_SubSecond).checkCCUWorkingStatus();
