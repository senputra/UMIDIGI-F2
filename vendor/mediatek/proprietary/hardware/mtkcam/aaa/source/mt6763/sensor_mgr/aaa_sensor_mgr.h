...
public:
    ...
    MRESULT setSensorFlashlight(MINT32 i4SensorDev, MUINT16 a_u2FlashMode);
    ...
    MRESULT set2ShutterControl(MINT32 i4SensorDev, MUINT32 a_u4LEExpTime, MUINT32 a_u4SEExpTime);
...
private:
    ...
    MBOOL    m_bFlickerState_Main;
    MBOOL    m_bFlickerState_Sub;
    MBOOL    m_bFlickerState_MainTwo;
    MBOOL    m_bFlickerState_SubTwo;
    MUINT32 m_u4SensorFrameRateMain;
    MUINT32 m_u4SensorFrameRateSub;
    MUINT32 m_u4SensorFrameRateMain2;
    MUINT32 m_u4SensorFrameRateSub2;
    MINT32 m_pSensorModeDelay[11];
    HWSyncDrv* m_pHwSyncDrvObj;
    MUINT32 m_i4FrameSyncMainFps;
    MUINT32 m_i4FrameSyncSubFps;
    MUINT32 m_i4FrameSyncMain2Fps;
    MUINT32 m_i4FrameSyncSub2Fps;
    // I2c buffer mode
    MBOOL    m_bEnableBuffMode_Main;
    MBOOL    m_bEnableBuffMode_Sub;
    MBOOL    m_bEnableBuffMode_MainTwo;
    MBOOL    m_bEnableBuffMode_SubTwo;
};
