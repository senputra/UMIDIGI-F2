...
public:
    ...
    virtual MBOOL       notifyP1PwrOn(){return MTRUE;};
    virtual MBOOL       notifyP1PwrOff(){return MTRUE;};
    ...
    , m_u4MagicNumber(0)
{
    ...
    m_rGainDelay.u4SensorGain_Delay = 0;
    m_rGainDelay.u4SutterGain_Delay = 0;
    m_rGainDelay.u4ISPGain_Delay = 0;
