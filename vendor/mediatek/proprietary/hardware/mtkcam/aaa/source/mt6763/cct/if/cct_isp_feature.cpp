...
IMP_CCT_CTRL( ACDK_CCT_OP_QUERY_ISP_ID )
{
    ...
    *reinterpret_cast<MUINT32 *>(puParaOut) = sizeof(MUINTPTR) == 4 ? 0x67638A00 : 0x67638AFF; // 00 means 32bit; FF means 64bit
...
IMP_CCT_CTRL( ACDK_CCT_V2_OP_QUERY_ISP_INDEX_SET )
{
  ...
  //MY_LOG("IMP_CCT_CTRL( ACDK_CCT_V2_OP_QUERY_ISP_INDEX_SET ) done, SL2F(%d) DBS(%d) OBC(%d) BPC(%d) NR1(%d) PDC(%d) RMM(%d) HLR(%d) RNR(%d) SL2(%d) UDM(%d) ANR(%d) ANR2(%d) CCR(%d) ABF(%d) BOK(%d) HFG(%d) EE(%d) NR3D(%d) MFB(%d) MIX3(%d)\n",
    MY_LOG("IMP_CCT_CTRL( ACDK_CCT_V2_OP_QUERY_ISP_INDEX_SET ) done, SL2F(%d) DBS(%d) OBC(%d) BPC(%d) NR1(%d) PDC(%d) RMM(%d) RNR(%d) SL2(%d) UDM(%d) ANR(%d) ANR2(%d) CCR(%d) BOK(%d) HFG(%d) EE(%d) NR3D(%d) MFB(%d) MIX3(%d)\n",
    ...
    pCustNvramRegIdx->RNR, pCustNvramRegIdx->SL2, pCustNvramRegIdx->UDM, pCustNvramRegIdx->ANR, pCustNvramRegIdx->ANR2, pCustNvramRegIdx->CCR,
    pCustNvramRegIdx->HFG, pCustNvramRegIdx->EE, pCustNvramRegIdx->NR3D, pCustNvramRegIdx->MFB, pCustNvramRegIdx->MIXER3);
