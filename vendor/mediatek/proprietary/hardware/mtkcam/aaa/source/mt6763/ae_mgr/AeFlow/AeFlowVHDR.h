...
protected:
    ...
    virtual            ~AeFlowVHDR();
private:
    MVOID updatePreviewParamsByiVHDR(MBOOL bIs60Hz, strAEOutput *sAEInfo);
    MVOID updatePreviewParamsBymVHDR(MBOOL bIs60Hz, strAEOutput *sAEInfo);
    MVOID updatePreviewParamsByzVHDR(MBOOL bIs60Hz, strAEOutput *sAEInfo);
