...
MBOOL IspTuningMgr::setFDInfo(MINT32 const i4SensorDev, MVOID* const a_sFaces, MUINT32 const TGSize)
{
    ...
    memcpy(&(fd_tuning_info.YUVsts), &(pFaces->YUVsts), sizeof(fd_tuning_info.YUVsts));
    ...
    if (i4SensorDev & ESensorDev_Main) {
        if (m_pParamctrl_Main) {
            ...
            m_pParamctrl_Main->sendIspTuningIOCtrl(E_ISPTUNING_FD_TUNING_INFO, (MINTPTR)(&fd_tuning_info), (MINTPTR)NULL);
        }
        else {
            MY_ERR("m_pParamctrl_Main is NULL");
            return MFALSE;
    ...
    if (i4SensorDev & ESensorDev_Sub) {
        if (m_pParamctrl_Sub) {
            ...
            m_pParamctrl_Sub->sendIspTuningIOCtrl(E_ISPTUNING_FD_TUNING_INFO, (MINTPTR)(&fd_tuning_info), (MINTPTR)NULL);
        }
        else {
            MY_ERR("m_pParamctrl_Sub is NULL");
            return MFALSE;
    ...
    if (i4SensorDev & ESensorDev_MainSecond) {
        if (m_pParamctrl_Main2) {
            ...
            m_pParamctrl_Main2->sendIspTuningIOCtrl(E_ISPTUNING_FD_TUNING_INFO, (MINTPTR)(&fd_tuning_info), (MINTPTR)NULL);
        }
        else {
            MY_ERR("m_pParamctrl_Main2 is NULL");
            return MFALSE;
    ...
    if (i4SensorDev & ESensorDev_SubSecond) {
        if (m_pParamctrl_Sub2) {
            ...
            m_pParamctrl_Sub2->sendIspTuningIOCtrl(E_ISPTUNING_FD_TUNING_INFO, (MINTPTR)(&fd_tuning_info), (MINTPTR)NULL);
        }
        else {
            MY_ERR("m_pParamctrl_Sub2 is NULL");
            return MFALSE;
