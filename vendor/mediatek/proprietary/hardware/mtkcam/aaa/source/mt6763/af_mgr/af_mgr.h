...
public:
    ...
    /**
     * @Brief :
     *          get AF is support or not.
     * @Param :
     *          [ in] NA
     * @Return:
     *          [out] return time status
     */
    MINT32  isAFSupport();
     ...
     * @Param :
     *          [ in] eAFCtrl [Ref] include\mtkcam\aaa\aaa_hal_common.h
     *          [ in] iArg1
     *          [ in] iArg2
     * @Return:
     *          [out] Status
...
private :
    ...
    NVRAM_LENS_DATA_PARA_STRUCT    m_sNVRam;      /* nv ram scenario data */
    ...
    // For triggerAF while launching camera
    ...
    // WaitForceTrigger(TRUE) && get AutoFocus ==> set WaitForceTrigger to FALSE when Timeout_Count>40.
    // To prevent NE because of capture timeout.
    MINT32 Timeout_WaitForceTrigger;
    MINT32 Timeout_AutoFocus;
    MINT32 Timeout_Count;

    MINT32 m_i4IsCAFWithoutFace;
    MBOOL m_bNotToSkipAlgo;
};
