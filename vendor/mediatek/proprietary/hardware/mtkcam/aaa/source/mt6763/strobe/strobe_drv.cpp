...
#define LOG_TAG "strobe_drv_2led.cpp"
...
#define logI(fmt, arg...)  STROB_DRV_DBG( fmt, ##arg)
#define logE(fmt, arg...)  STROB_DRV_ERR("error: line=%d, " fmt, __LINE__, ##arg)
...
StrobeDrv*
StrobeDrv::getInstance(int typeId, int ctId)
{
    logI("qq %d %d", typeId, ctId);
    return FlashlightDrv::getInstance(typeId, ctId);
}
