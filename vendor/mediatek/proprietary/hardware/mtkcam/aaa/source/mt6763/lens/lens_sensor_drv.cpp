...
LensSensorDrv::init(unsigned int a_u4CurrSensorDev)
{
    ...
    else if(a_u4CurrSensorDev==MCU_DEV_SUB_2)
    {
        ...
        a_userCnt = m_userCnt_sub2;
        a_u4CurrLensIdx=MCUDrv::m_u4CurrLensIdx_sub2;
        sprintf(cBuf, "/dev/%s", MCUDrv::m_LensInitFunc_sub2[a_u4CurrLensIdx].LensDrvName);
    ...
    else if(a_u4CurrSensorDev==MCU_DEV_SUB_2)   m_userCnt_sub2  = a_userCnt;
...
LensSensorDrv::moveMCU(int a_i4FocusPos, unsigned int a_u4CurrSensorDev)
{
    ...
    if(a_u4CurrSensorDev==MCU_DEV_MAIN)
    {
        m_i4FocusPos_main=a_i4FocusPos;
    }
    else if(a_u4CurrSensorDev==MCU_DEV_MAIN_2)
    {
        m_i4FocusPos_main2=a_i4FocusPos;
    }
    else if(a_u4CurrSensorDev==MCU_DEV_SUB)
    {
        m_i4FocusPos_sub=a_i4FocusPos;
    }
    else if(a_u4CurrSensorDev==MCU_DEV_SUB_2)
    {
        m_i4FocusPos_sub2=a_i4FocusPos;
    }
...

{
    ...
    {
        a_fdMCU = m_fdMCU_main;
        a_i4FocusPos=m_i4FocusPos_main;
    }
    else if(a_u4CurrSensorDev==MCU_DEV_MAIN_2)
    {
        a_fdMCU = m_fdMCU_main2;
        a_i4FocusPos=m_i4FocusPos_main2;
    }
    else if(a_u4CurrSensorDev==MCU_DEV_SUB)
    {
        a_fdMCU = m_fdMCU_sub;
        a_i4FocusPos=m_i4FocusPos_sub;
    }
    else if(a_u4CurrSensorDev==MCU_DEV_SUB_2)
    {
        a_fdMCU = m_fdMCU_sub2;
        a_i4FocusPos=m_i4FocusPos_sub2;
    }
...
********************************************************************************/
int
LensSensorDrv::getMCUCalPos(mcuMotorCalPos* /*a_pMotorCalPos*/,unsigned int /*a_u4CurrSensorDev*/)
{
    return MCUDrv::MCU_NO_ERROR;
}
/*******************************************************************************
...
********************************************************************************/
int
LensSensorDrv::setMCUParam(int /*a_CmdId*/, int /*a_Param*/,unsigned int /*a_u4CurrSensorDev*/ )
{
    return MCUDrv::MCU_NO_ERROR;
}
...
********************************************************************************/
int
LensSensorDrv::getMCUOISInfo(mcuMotorOISInfo* /*a_pMotorOISInfo*/, unsigned int /*a_u4CurrSensorDev*/)
{
    return MCUDrv::MCU_NO_ERROR;
}