...
MBOOL AwbMgr::setIspAwbInfo(MINT32 const i4SensorDev, AWB_INFO_T &rAWBInfo)
{
  ...
  AWB_LOG( "[%s()] m_eSensorDev: %d, awb_gain: %d/%d/%d, PreGain1: %d/%d/%d, CCM: [%d/%d/%d/%d/%d/%d/%d/%d/%d], bAWBLock: %d (m_bAWBLock:%d, m_eAWBMode:%d)\n",
    ...
    rAWBInfo.rCscCCM[0], rAWBInfo.rCscCCM[1], rAWBInfo.rCscCCM[2],
    rAWBInfo.rCscCCM[3], rAWBInfo.rCscCCM[4], rAWBInfo.rCscCCM[5],
    rAWBInfo.rCscCCM[6], rAWBInfo.rCscCCM[7], rAWBInfo.rCscCCM[8],
...
{
    colorTemperature = m_rAWBOutput.rAWBInfo.i4CCT;
    return MTRUE;
}
