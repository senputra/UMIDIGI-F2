...
config(const ConfigInfo_T& /*rConfigInfo*/)
{
    if (m_pCamIO == NULL)
    {
        ...
        ISP_MGR_AF_STAT_CONFIG_T::getInstance(static_cast<ESensorDev_T>(m_u4SensorDev)).config(testcfg, sArea_HW, i4HWBlkNumX, i4HWBlkNumY, i4HWBlkSizeX, i4HWBlkSizeY, i4FirstTimeConfig);
