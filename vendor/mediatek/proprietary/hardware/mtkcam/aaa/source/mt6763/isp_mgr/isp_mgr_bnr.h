...
private:
    ...
    MVOID* m_pPDCBuffer_3;
    MVOID* m_pPDCBuffer_4;
    CAMERA_PD_TBL_STRUCT* m_pBpciBuf_1;
    CAMERA_PD_TBL_STRUCT* m_pBpciBuf_2;
    CAMERA_PD_TBL_STRUCT* m_pBpciBuf_3;
    CAMERA_PD_TBL_STRUCT* m_pBpciBuf_4;
    std::mutex            m_Lock;
...
public: // Interfaces.
    ...
    MVOID
    setPDSensorInfo(MUINT32 u4PDSensorFmt)
    {
        m_u4PDSensorFmt = u4PDSensorFmt;
        /*********************************************************************************
         * PD sensor format :
