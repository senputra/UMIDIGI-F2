    ...
    getInstance(MINT32 const i4SensorDev)
{
    ...
    case ESensorDev_MainFourth:
        return  AwbMgrDev<ESensorDev_MainFourth>::getInstance();
    case ESensorDev_MainFifth:
        return  AwbMgrDev<ESensorDev_MainFifth>::getInstance();
    case ESensorDev_MainSixth:
        return  AwbMgrDev<ESensorDev_MainSixth>::getInstance();
...
*/
    ...
    case ESensorDev_MainThird: //  Main Third Sensor
        ...
        break;
    case ESensorDev_MainFourth:
        m_bEnableAWB = isAWBEnabled<ESensorDev_MainFourth>();
        break;
    case ESensorDev_MainFifth:
        m_bEnableAWB = isAWBEnabled<ESensorDev_MainFifth>();
        break;
    case ESensorDev_MainSixth:
        m_bEnableAWB = isAWBEnabled<ESensorDev_MainSixth>();
        break;
...
MBOOL AwbMgr::getEEPROMData()
{
    ...
    case ESensorDev_MainThird:
        ...
        break;
    case ESensorDev_MainFourth:
        i4SensorDevID = SENSOR_DEV_MAIN_4;
        break;
    case ESensorDev_MainFifth:
        i4SensorDevID = SENSOR_DEV_MAIN_5;
        break;
    case ESensorDev_MainSixth:
        i4SensorDevID = SENSOR_DEV_MAIN_6;
        break;
    ...
    result= m_pCamCalDrvObj->GetCamCalCalData(m_eSensorDev, enCamCalEnum, (void *)&GetCamCalData);
...
MBOOL AwbMgr::AWBInit()
{
    ...
    case ESensorDev_MainThird: //  Main Third
        ...
        break;
    case ESensorDev_MainFourth:
        m_rAWBInitInput.rAWBParam = getAWBParam<ESensorDev_MainFourth>();
        m_rAWBInitInput.rAWBStatParam = getAWBStatParam<ESensorDev_MainFourth>();
        m_rAWBStatParam = getAWBStatParam<ESensorDev_MainFourth>();
        break;
    case ESensorDev_MainFifth:
        m_rAWBInitInput.rAWBParam = getAWBParam<ESensorDev_MainFifth>();
        m_rAWBInitInput.rAWBStatParam = getAWBStatParam<ESensorDev_MainFifth>();
        m_rAWBStatParam = getAWBStatParam<ESensorDev_MainFifth>();
        break;
    case ESensorDev_MainSixth:
        m_rAWBInitInput.rAWBParam = getAWBParam<ESensorDev_MainSixth>();
        m_rAWBInitInput.rAWBStatParam = getAWBStatParam<ESensorDev_MainSixth>();
        m_rAWBStatParam = getAWBStatParam<ESensorDev_MainSixth>();
        break;
