...
LOCAL_MODULE := lib3a_mt6765_hal3_headers
...
LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/
LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/wrapper
LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/flash_mgr
...
LOCAL_HEADER_LIBRARIES += lib3a_mt6765_hal3_headers
...
LOCAL_SRC_FILES += Thread/ThreadAEStartImp.cpp
LOCAL_SRC_FILES += Thread/ThreadAFStartImp.cpp
...
# MTKCAM_DISABLE_CCU_SUPPORT
ifneq ($(filter $(TARGET_PRODUCT),full_tb8768p1_64_bsp full_tb8768tp1_64_bsp vnd_tb8768p1_64_bsp vnd_tb8768tp1_64_bsp), )
LOCAL_CFLAGS += -DMTKCAM_DISABLE_CCU_SUPPORT
endif
...
LOCAL_HEADER_LIBRARIES += libmtkcam_flickerhal_headers libcustom_isp_headers
