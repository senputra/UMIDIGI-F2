...
AwbStateMgr::getInstance(MINT32 const i4SensorDev)
{
    ...
    case ESensorDev_SubSecond: //  Sub Second Sensor
        return  AwbStateMgrDev<ESensorDev_SubSecond>::getInstance();
    case ESensorDev_MainThird: //  Main Third Sensor
        return  AwbStateMgrDev<ESensorDev_MainThird>::getInstance();
    case ESensorDev_MainFourth:
        return  AwbStateMgrDev<ESensorDev_MainFourth>::getInstance();
    case ESensorDev_MainFifth:
        return  AwbStateMgrDev<ESensorDev_MainFifth>::getInstance();
    case ESensorDev_MainSixth:
        return  AwbStateMgrDev<ESensorDev_MainSixth>::getInstance();
    default:
...
transitState(EAWBState_T const eNewState)
{
    ...
    if  ( ! pNewState )
    {
        CAM_LOGE("[IAwbState::transitState()] pNewState==NULL");
        return  this;
    }

    CAM_LOGD("[IAwbState::transitState] %s --> %s", this->getName(), pNewState->getName());
...
{
    CAM_LOGD("[InactiveNotAuto::sendIntent]<eIntent_AWBModeAuto>");
...
{
    CAM_LOGD("[InactiveAuto::sendIntent]<eIntent_AWBModeNotAuto>");
...
{
    CAM_LOGD("[InactiveAuto::sendIntent]<eIntent_AWBScan>");
...
{
    CAM_LOGD("[InactiveAuto::sendIntent]<eIntent_AWBScanFinished>");
...
{
    CAM_LOGD("[InactiveAuto::sendIntent]<eIntent_AWBLockOn>");
...
sendIntent(intent2type<eIntent_AWBModeNotAuto>)
{
    CAM_LOGD("[Searching::sendIntent]<eIntent_AWBModeNotAuto>");
...
sendIntent(intent2type<eIntent_AWBScanFinished>)
{
    CAM_LOGD("[Searching::sendIntent]<eIntent_AWBScanFinished>");
...
sendIntent(intent2type<eIntent_AWBLockOn>)
{
    CAM_LOGD("[Searching::sendIntent]<eIntent_AWBLockOn>");
...
sendIntent(intent2type<eIntent_AWBModeNotAuto>)
{
    CAM_LOGD("[Converged::sendIntent]<eIntent_AWBModeNotAuto>");
    // State transition: eState_Searching --> eState_InactiveNotAuto
    return transitState(eState_InactiveNotAuto);
}
...
sendIntent(intent2type<eIntent_AWBScan>)
{
    CAM_LOGD("[Converged::sendIntent]<eIntent_AWBScan>");
...
sendIntent(intent2type<eIntent_AWBLockOn>)
{
    CAM_LOGD("[Converged::sendIntent]<eIntent_AWBLockOn>");
...
sendIntent(intent2type<eIntent_AWBModeNotAuto>)
{
    CAM_LOGD("[Locked::sendIntent]<eIntent_AWBModeNotAuto>");
...
{
    CAM_LOGD("[Locked::sendIntent]<eIntent_AWBLockOff>");
