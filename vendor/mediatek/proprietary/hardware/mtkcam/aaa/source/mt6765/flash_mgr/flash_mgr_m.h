...
//    int setAFLampOffSch(int ms);
    ...
    */
    ...
    /** \brief set driver in control
    *   @param bIsDriverInControl: set the current instance has driver control or not
    */
    inline int setIsDriverInControl(int bIsDriverInControl)
    {
        mIsDriverInControl = bIsDriverInControl;
        return 0;
    }
    /** \brief get driver in control
    *   @return get the current instance has driver control or not
    */
    inline bool getIsDriverInControl()
    {
        return mIsDriverInControl;
    }

    /** \brief set driver in control
    *   @param bIsDriverInControl: set the current instance has driver control or not
    */
    inline int setAAOMode(int bAAOMode)
    {
        mAAOMode = bAAOMode;
        return 0;
    }
    ...
    int getFlashState();
    // For Preflash
    int setPreFlashOnOff(int en);
    int getFlashOnFrmCnt();
