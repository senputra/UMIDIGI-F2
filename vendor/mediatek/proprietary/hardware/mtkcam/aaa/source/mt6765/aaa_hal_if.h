...
public:
    ...
    enum ECallBack_T
    {
        ...
        eID_NOTIFY_RAW_STTMAGICNUM,
        eID_NOTIFY_AF_FSC_INFO,
        eID_MSGTYPE_NUM,
        eID_NOTIFY_P1_DONE_FROMSTT
    };
...
public:
    ...
    //
    static Hal3AIf*     createInstance(MINT32 const i4SensorOpenIndex, E_FlowControl_Type type, MINT32 i4SubsampleCount = 1);
    ...
    virtual MINT32      getResult(MUINT32 u4FrmId, Result_T& rResult) = 0;
    virtual MINT32      getResultCur(MUINT32 u4FrmId, Result_T& rResult) = 0;
    ...
    virtual MVOID       SttP1Done(MUINT32 u4MagicNum, MVOID* pvArg = 0) = 0;
