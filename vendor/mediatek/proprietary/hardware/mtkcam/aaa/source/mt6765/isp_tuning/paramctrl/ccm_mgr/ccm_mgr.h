...
{
public:
    static CcmMgr* createInstance(MUINT32 const eSensorDev, ISP_NVRAM_MULTI_CCM_STRUCT& rISPMultiCCM, NSIspTuning::IspTuningCustom* pIspTuningCustom);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    CcmMgr(MUINT32 const eSensorDev, ISP_NVRAM_MULTI_CCM_STRUCT& rISPMultiCCM, IspTuningCustom* pIspTuningCustom)
