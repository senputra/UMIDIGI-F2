...
{
public:
    static GgmMgr* createInstance(MUINT32 const eSensorDev);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    GgmMgr(MUINT32 const eSensorDev)
...
public:
	...
	MBOOL array_to_GMA(MFLOAT* request_X, MFLOAT* request_Y, MINT32 numRequest, MINT32* out_hw_GMA);
