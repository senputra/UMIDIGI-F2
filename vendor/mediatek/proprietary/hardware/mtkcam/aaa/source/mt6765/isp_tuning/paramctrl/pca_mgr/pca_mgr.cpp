...
#define MY_INST NS3Av3::INST_T<PcaMgr>
...
PcaMgr*
PcaMgr::
createInstance(MUINT32 const eSensorDev, ISP_NVRAM_COLOR_STRUCT& rIspColor)
{
    ...
    std::call_once(rSingleton.onceFlag, [&] {
        rSingleton.instance = std::make_unique<PcaMgr>(eSensorDev, rIspColor);
    } );
