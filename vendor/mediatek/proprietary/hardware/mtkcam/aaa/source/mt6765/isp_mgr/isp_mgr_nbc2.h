...
private:
    ...
    enum
    {
      ...
      ERegInfo_DIP_X_CCR_L4LUT1,
      ERegInfo_DIP_X_CCR_L4LUT2,
      ERegInfo_DIP_X_CCR_L4LUT3,

      ERegInfo_DIP_X_BOK_CON,
      ERegInfo_DIP_X_BOK_TUN,
      ERegInfo_DIP_X_BOK_OFF,

      ERegInfo_DIP_X_ABF_CON1,
      ERegInfo_DIP_X_ABF_CON2,
      ERegInfo_DIP_X_ABF_RCON,
      ERegInfo_DIP_X_ABF_YLUT,
      ERegInfo_DIP_X_ABF_CXLUT,
      ERegInfo_DIP_X_ABF_CYLUT,
      ERegInfo_DIP_X_ABF_YSP,
      ERegInfo_DIP_X_ABF_CXSP,
      ERegInfo_DIP_X_ABF_CYSP,
      ERegInfo_DIP_X_ABF_CLP,
      ERegInfo_DIP_X_ABF_DIFF,
...
public:
    ISP_MGR_NBC2(MUINT32 const eSensorDev)
        ...
        , m_u4StartAddr(REG_ADDR_P2(DIP_X_ANR2_CON1))
    {
        ...
        INIT_REG_INFO_ADDR_P2(DIP_X_ANR2_MED5);
        ...
        INIT_REG_INFO_ADDR_P2(DIP_X_CCR_L4LUT1);
        INIT_REG_INFO_ADDR_P2(DIP_X_CCR_L4LUT2);
        INIT_REG_INFO_ADDR_P2(DIP_X_CCR_L4LUT3);

        INIT_REG_INFO_ADDR_P2(DIP_X_BOK_CON);
        INIT_REG_INFO_ADDR_P2(DIP_X_BOK_TUN);
        INIT_REG_INFO_ADDR_P2(DIP_X_BOK_OFF);

        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_CON1);
        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_CON2);
        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_RCON);
        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_YLUT);
        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_CXLUT);
        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_CYLUT);
        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_YSP);
        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_CXSP);
        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_CYSP);
        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_CLP);
        INIT_REG_INFO_ADDR_P2(DIP_X_ABF_DIFF);
