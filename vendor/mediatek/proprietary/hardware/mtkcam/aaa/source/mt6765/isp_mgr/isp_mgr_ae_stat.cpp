...
{
#if 1
    MUINT32 BlockNumH = m_u4BlockNumH;
    MUINT32 BlockNumW = m_u4BlockNumW;
/*
    // CAM_AE_HST_CTL
...
*/
    ...
    if (m_u4AAOmode)
        AaoXsize.Bits.XSIZE = BlockNumH*(BlockNumW*4+BlockNumW*1+BlockNumW*1*AeStatEn.Bits.AE_HDR_STAT_EN+BlockNumW*1*AeStatEn.Bits.AE_OVERCNT_EN+BlockNumW*2*AeStatEn.Bits.AE_TSF_STAT_EN)+4*128*3;
    else
    ...
    if (m_u4AAOmode)
        PSOXsize.Bits.XSIZE = BlockNumH*(BlockNumW*4+BlockNumW*1+BlockNumW*1*AeStatEn.Bits.AE_HDR_STAT_EN+BlockNumW*4*AeStatEn.Bits.AE_TSF_STAT_EN);
    else
        PSOXsize.Bits.XSIZE = BlockNumH*(BlockNumW*4+BlockNumW*1+BlockNumW*0.5*AeStatEn.Bits.AE_HDR_STAT_EN+BlockNumW*4*AeStatEn.Bits.AE_TSF_STAT_EN);
    // CAM_PSO_YSIZE
