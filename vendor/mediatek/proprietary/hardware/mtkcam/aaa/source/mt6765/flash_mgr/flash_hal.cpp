#define LOG_TAG "mtkcam-flash_mgr"
...
MINT32
FlashHal::
egGetDutyRange(int* st, int* ed)
{
    return FlashMgr::getInstance().egGetDutyRange(m_eSensorDev, st, ed);
}


MINT32
FlashHal::
egGetStepRange(int* st, int* ed)
{
    return FlashMgr::getInstance().egGetStepRange(m_eSensorDev, st, ed);
}


MINT32
FlashHal::
egSetMfDutyStep(int duty, int step)
{
    return FlashMgr::getInstance().egSetMfDutyStep(m_eSensorDev, duty, step);
}
