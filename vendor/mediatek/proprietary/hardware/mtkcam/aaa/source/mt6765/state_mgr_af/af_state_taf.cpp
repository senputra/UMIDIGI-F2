...
sendIntent(intent2type<eIntent_Uninit>)
{
    ...
    m_pAfStateMgr->_transitState(eState_TAF, eState_Uninit);
    CAM_LOGD("[StateTAF::sendIntent]<eIntent_Uninit>");
    return  S_3A_OK;
}
...
sendIntent(intent2type<eIntent_CameraPreviewEnd>)
{
    ...
    CAM_LOGD("[StateTAF::sendIntent]<eIntent_CameraPreviewEnd>");
    // State transition: eState_CameraPreview --> eState_Init
    m_pAfStateMgr->_transitState(eState_TAF, eState_Init);
...
{
    CAM_LOGD("[StateTAF::sendIntent]<eIntent_AFStart>");
...
{
    CAM_LOGD("[StateTAF::sendIntent]<eIntent_AFEnd>");
