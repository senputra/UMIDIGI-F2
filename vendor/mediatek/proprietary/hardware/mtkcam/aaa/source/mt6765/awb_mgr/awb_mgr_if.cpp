...
{
    MBOOL ret_main, ret_sub, ret_main2, ret_sub2, ret_main3, ret_main4, ret_main5, ret_main6;
    ret_main = ret_sub = ret_main2 =  ret_sub2 = ret_main3 = ret_main4 = ret_main5 = ret_main6 = MTRUE;
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).cameraPreviewInit(i4SensorIdx, rParam, initPara);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).cameraPreviewInit(i4SensorIdx, rParam, initPara);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).cameraPreviewInit(i4SensorIdx, rParam, initPara);

    return ret_main && ret_sub && ret_main2 && ret_sub2 && ret_main3 && ret_main4 && ret_main5 && ret_main6;
}
...
camcorderPreviewInit(MINT32 i4SensorDev, MINT32 i4SensorIdx, Param_T &rParam, IAWBInitPara* initPara)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).camcorderPreviewInit(i4SensorIdx, rParam, initPara);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).camcorderPreviewInit(i4SensorIdx, rParam, initPara);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).camcorderPreviewInit(i4SensorIdx, rParam, initPara);
...
cameraCaptureInit(MINT32 i4SensorDev, IAWBInitPara* initPara)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).cameraCaptureInit(initPara);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).cameraCaptureInit(initPara);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).cameraCaptureInit(initPara);
...
cameraPreviewReinit(MINT32 i4SensorDev, IAWBInitPara* initPara)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).cameraPreviewReinit(initPara);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).cameraPreviewReinit(initPara);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).cameraPreviewReinit(initPara);
...
start(MINT32 i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).start();
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).start();
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).start();
...
stop(MINT32 i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).stop();
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).stop();
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).stop();
...
init(MINT32 i4SensorDev, MINT32 i4SensorIdx, IAWBInitPara* initPara)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).init(i4SensorIdx, initPara);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).init(i4SensorIdx, initPara);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).init(i4SensorIdx, initPara);
...
uninit(MINT32 i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).uninit();
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).uninit();
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).uninit();
...
isAWBEnable(MINT32 i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).isAWBEnable();
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).isAWBEnable();
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).isAWBEnable();
...
setAWBMode(MINT32 i4SensorDev, MINT32 i4NewAWBMode)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).setAWBMode(i4NewAWBMode);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).setAWBMode(i4NewAWBMode);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).setAWBMode(i4NewAWBMode);
...
setSensorMode(MINT32 i4SensorDev, MINT32 i4NewSensorMode, MINT32 i4BinWidth, MINT32 i4BinHeight, MINT32 i4QbinWidth, MINT32 i4QbinHeight)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).setSensorMode(i4NewSensorMode, i4BinWidth, i4BinHeight, i4QbinWidth, i4QbinHeight);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).setSensorMode(i4NewSensorMode, i4BinWidth, i4BinHeight, i4QbinWidth, i4QbinHeight);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).setSensorMode(i4NewSensorMode, i4BinWidth, i4BinHeight, i4QbinWidth, i4QbinHeight);
...
getAWBMode(MINT32 i4SensorDev)
{
    ...
    else if (i4SensorDev & ESensorDev_MainFourth) {
        return AwbMgr::getInstance(ESensorDev_MainFourth).getAWBMode();
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).getAWBMode();
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).getAWBMode();
    }
...
setStrobeMode(MINT32 i4SensorDev, MINT32 i4NewStrobeMode)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).setStrobeMode(i4NewStrobeMode);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).setStrobeMode(i4NewStrobeMode);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).setStrobeMode(i4NewStrobeMode);
...
getStrobeMode(MINT32 i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).getStrobeMode();
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).getStrobeMode();
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).getStrobeMode();
    }
...
setFlashAWBData(MINT32 i4SensorDev, FLASH_AWB_PASS_FLASH_INFO_T &rFlashAwbData)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).setFlashAWBData(rFlashAwbData);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).setFlashAWBData(rFlashAwbData);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).setFlashAWBData(rFlashAwbData);
...
setAWBLock(MINT32 i4SensorDev, MBOOL bAWBLock)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).setAWBLock(bAWBLock);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).setAWBLock(bAWBLock);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).setAWBLock(bAWBLock);
...
enableAWB(MINT32 i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).enableAWB();
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).enableAWB();
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).enableAWB();
...
disableAWB(MINT32 i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).disableAWB();
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).disableAWB();
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).disableAWB();
                     ...
                     MINT32 i4CropRegionHeight)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).setAWBStatCropRegion(i4SensorMode, i4CropOffsetX, i4CropOffsetY, i4CropRegionWidth, i4CropRegionHeight);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).setAWBStatCropRegion(i4SensorMode, i4CropOffsetX, i4CropOffsetY, i4CropRegionWidth, i4CropRegionHeight);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).setAWBStatCropRegion(i4SensorMode, i4CropOffsetX, i4CropOffsetY, i4CropRegionWidth, i4CropRegionHeight);
...
doPvAWB(MINT32 i4SensorDev, MINT32 i4FrameCount, MBOOL bAEStable, MINT32 i4SceneLV, MVOID *pAWBStatBuf, MUINT32 u4ExposureTime, MBOOL bApplyToHW)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).doPvAWB(i4FrameCount, bAEStable, i4SceneLV, pAWBStatBuf, u4ExposureTime, bApplyToHW);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).doPvAWB(i4FrameCount, bAEStable, i4SceneLV, pAWBStatBuf, u4ExposureTime, bApplyToHW);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).doPvAWB(i4FrameCount, bAEStable, i4SceneLV, pAWBStatBuf, u4ExposureTime, bApplyToHW);
...
doAFAWB(MINT32 i4SensorDev, MINT32 i4SceneLV, MVOID *pAWBStatBuf, MBOOL bApplyToHW)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).doAFAWB(pAWBStatBuf, i4SceneLV, bApplyToHW);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).doAFAWB(pAWBStatBuf, i4SceneLV, bApplyToHW);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).doAFAWB(pAWBStatBuf, i4SceneLV, bApplyToHW);
...
doPreCapAWB(MINT32 i4SensorDev, MINT32 i4SceneLV, MVOID *pAWBStatBuf, MBOOL bApplyToHW)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).doPreCapAWB(i4SceneLV, pAWBStatBuf, bApplyToHW);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).doPreCapAWB(i4SceneLV, pAWBStatBuf, bApplyToHW);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).doPreCapAWB(i4SceneLV, pAWBStatBuf, bApplyToHW);
...
doCapAWB(MINT32 i4SensorDev, MINT32 i4SceneLV, MVOID *pAWBStatBuf, MBOOL bApplyToHW)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).doCapAWB(i4SceneLV, pAWBStatBuf, bApplyToHW);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).doCapAWB(i4SceneLV, pAWBStatBuf, bApplyToHW);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).doCapAWB(i4SceneLV, pAWBStatBuf, bApplyToHW);
...
doCapFlashAWBDisplay(MINT32 i4SensorDev, MBOOL bApplyToHW)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).doCapFlashAWBDisplay(bApplyToHW);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).doCapFlashAWBDisplay(bApplyToHW);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).doCapFlashAWBDisplay(bApplyToHW);
...
applyAWB(MINT32 i4SensorDev, AWB_SYNC_OUTPUT_N3D_T &rAWBSyncOutput)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        AwbMgr::getInstance(ESensorDev_MainFourth).applyAWB(rAWBSyncOutput);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        AwbMgr::getInstance(ESensorDev_MainFifth).applyAWB(rAWBSyncOutput);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        AwbMgr::getInstance(ESensorDev_MainSixth).applyAWB(rAWBSyncOutput);
        return MTRUE;
    }
...
getDebugInfo(MINT32 i4SensorDev, AWB_DEBUG_INFO_T &rAWBDebugInfo, AWB_DEBUG_DATA_T &rAWBDebugData)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        AwbMgr::getInstance(ESensorDev_MainFourth).getDebugInfo(rAWBDebugInfo, rAWBDebugData);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        AwbMgr::getInstance(ESensorDev_MainFifth).getDebugInfo(rAWBDebugInfo, rAWBDebugData);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        AwbMgr::getInstance(ESensorDev_MainSixth).getDebugInfo(rAWBDebugInfo, rAWBDebugData);
        return MTRUE;
    }
...
getAWBCCT(MINT32 i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).getAWBCCT();
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).getAWBCCT();
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).getAWBCCT();
    }
...
getASDInfo(MINT32 i4SensorDev, AWB_ASD_INFO_T &a_rAWBASDInfo)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        AwbMgr::getInstance(ESensorDev_MainFourth).getASDInfo(a_rAWBASDInfo);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        AwbMgr::getInstance(ESensorDev_MainFifth).getASDInfo(a_rAWBASDInfo);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        AwbMgr::getInstance(ESensorDev_MainSixth).getASDInfo(a_rAWBASDInfo);
        return MTRUE;
    }
...
getAWBOutput(MINT32 i4SensorDev, AWB_OUTPUT_T &a_rAWBOutput)
{
    ...
    if (i4SensorDev & ESensorDev_MainThird) {
        ...
        AwbMgr::getInstance(ESensorDev_MainFourth).getAWBOutput(a_rAWBOutput);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        AwbMgr::getInstance(ESensorDev_MainFifth).getAWBOutput(a_rAWBOutput);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        AwbMgr::getInstance(ESensorDev_MainSixth).getAWBOutput(a_rAWBOutput);
        return MTRUE;
    }
...
getAWBGain(MINT32 i4SensorDev, AWB_GAIN_T &rAwbGain, MINT32& i4ScaleUnit) const
{
    ...
    if (i4SensorDev & ESensorDev_MainThird) {
        ...
        AwbMgr::getInstance(ESensorDev_MainFourth).getAWBGain(rAwbGain, i4ScaleUnit);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        AwbMgr::getInstance(ESensorDev_MainFifth).getAWBGain(rAwbGain, i4ScaleUnit);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        AwbMgr::getInstance(ESensorDev_MainSixth).getAWBGain(rAwbGain, i4ScaleUnit);
        return MTRUE;
    }
...
getAWBParentStat(MINT32 i4SensorDev, AWB_PARENT_BLK_STAT_T &a_rAWBParentState, MINT32 *a_ParentBlkNumX, MINT32 *a_ParentBlkNumY )
{
    ...
    if (i4SensorDev & ESensorDev_MainThird) {
        ...
        AwbMgr::getInstance(ESensorDev_MainFourth).getAWBParentStat(a_rAWBParentState, a_ParentBlkNumX, a_ParentBlkNumY);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        AwbMgr::getInstance(ESensorDev_MainFifth).getAWBParentStat(a_rAWBParentState, a_ParentBlkNumX, a_ParentBlkNumY);
        return MTRUE;
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        AwbMgr::getInstance(ESensorDev_MainSixth).getAWBParentStat(a_rAWBParentState, a_ParentBlkNumX, a_ParentBlkNumY);
        return MTRUE;
    }
...
setAFLV(MINT32 i4SensorDev, MINT32 i4AFLV)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        AwbMgr::getInstance(ESensorDev_MainFourth).setAFLV(i4AFLV);
    if (i4SensorDev & ESensorDev_MainFifth)
        AwbMgr::getInstance(ESensorDev_MainFifth).setAFLV(i4AFLV);
    if (i4SensorDev & ESensorDev_MainSixth)
        AwbMgr::getInstance(ESensorDev_MainSixth).setAFLV(i4AFLV);
...
getAFLV(MINT32 i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).getAFLV();
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).getAFLV();
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).getAFLV();
    }
...
setTGInfo(MINT32 const i4SensorDev, MINT32 const i4TGInfo)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).setTGInfo(i4TGInfo);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).setTGInfo(i4TGInfo);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).setTGInfo(i4TGInfo);
    }
...
IAwbMgr::setAWBNvramIdx(MINT32 const i4SensorDev, MINT32 const i4AWBNvramIdx)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).setAWBNvramIdx(i4AWBNvramIdx);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).setAWBNvramIdx(i4AWBNvramIdx);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).setAWBNvramIdx(i4AWBNvramIdx);
    }
...
{
    MBOOL ret_main, ret_sub, ret_main2, ret_sub2, ret_main3, ret_main4, ret_main5, ret_main6;
    ret_main = ret_sub = ret_main2 =  ret_sub2 = ret_main3 = ret_main4 = ret_main5 = ret_main6 = S_AWB_OK;
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).setCamScenarioMode(u4CamScenarioMode);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).setCamScenarioMode(u4CamScenarioMode);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).setCamScenarioMode(u4CamScenarioMode);
...
IAwbMgr::getColorCorrectionGain(MINT32 const i4SensorDev, MFLOAT& fGain_R, MFLOAT& fGain_G, MFLOAT& fGain_B)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).getColorCorrectionGain(fGain_R, fGain_G, fGain_B);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).getColorCorrectionGain(fGain_R, fGain_G, fGain_B);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).getColorCorrectionGain(fGain_R, fGain_G, fGain_B);
    }
...
IAwbMgr::setIsMono(MINT32 const i4SensorDev, int bMono, MUINT32 i4SensorType)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).setIsMono(bMono, i4SensorType);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).setIsMono(bMono, i4SensorType);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).setIsMono(bMono, i4SensorType);
    }
...
IAwbMgr::setColorCorrectionGain(MINT32 const i4SensorDev, MFLOAT fGain_R, MFLOAT fGain_G, MFLOAT fGain_B)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).setColorCorrectionGain(fGain_R, fGain_G, fGain_B);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).setColorCorrectionGain(fGain_R, fGain_G, fGain_B);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).setColorCorrectionGain(fGain_R, fGain_G, fGain_B);
    }
...
IAwbMgr::getAWBState(MINT32 const i4SensorDev, mtk_camera_metadata_enum_android_control_awb_state_t& eAWBState)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).getAWBState(eAWBState);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).getAWBState(eAWBState);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).getAWBState(eAWBState);
    }
...
MRESULT IAwbMgr::setFDenable(MINT32 i4SensorDev, MBOOL bFDenable)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).setFDenable(bFDenable);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).setFDenable(bFDenable);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).setFDenable(bFDenable);
...
MRESULT IAwbMgr::setFDInfo(MINT32 i4SensorDev, MVOID* a_sFaces, MINT32 i4tgwidth, MINT32 i4tgheight)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).setFDInfo(a_sFaces, i4tgwidth, i4tgheight);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).setFDInfo(a_sFaces, i4tgwidth, i4tgheight);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).setFDInfo(a_sFaces, i4tgwidth, i4tgheight);
...
MRESULT IAwbMgr::setZoomWinInfo(MINT32 i4SensorDev, MUINT32 u4XOffset, MUINT32 u4YOffset, MUINT32 u4Width, MUINT32 u4Height)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).setZoomWinInfo(u4XOffset, u4YOffset, u4Width, u4Height);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).setZoomWinInfo(u4XOffset, u4YOffset, u4Width, u4Height);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).setZoomWinInfo(u4XOffset, u4YOffset, u4Width, u4Height);
...
MRESULT IAwbMgr::getFocusArea(MINT32 i4SensorDev, android::Vector<MINT32> &vecOut, MINT32 i4tgwidth, MINT32 i4tgheight)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).getFocusArea(vecOut, i4tgwidth, i4tgheight);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).getFocusArea(vecOut, i4tgwidth, i4tgheight);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).getFocusArea(vecOut, i4tgwidth, i4tgheight);
...
MBOOL IAwbMgr::backup(MINT32 const i4SensorDev)
{
  if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).backup();
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).backup();
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).backup();
    }
...
MBOOL IAwbMgr::restore(MINT32 const i4SensorDev)
{
  if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).restore();
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).restore();
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).restore();
    }
...
MBOOL IAwbMgr::SetAETargetMode(MINT32 const i4SensorDev, int mode) //for hdr
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).SetAETargetMode(mode);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).SetAETargetMode(mode);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).SetAETargetMode(mode);
    }
...
IAwbMgr::setColorCorrectionMode(MINT32 const i4SensorDev, MINT32 i4ColorCorrectionMode)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).setColorCorrectionMode(i4ColorCorrectionMode);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).setColorCorrectionMode(i4ColorCorrectionMode);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).setColorCorrectionMode(i4ColorCorrectionMode);
    }
...
CCTOPAWBEnable(MINT32 i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBEnable();
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBEnable();
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBEnable();
...
CCTOPAWBDisable(MINT32 i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBDisable();
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBDisable();
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBDisable();
...
CCTOPAWBGetEnableInfo(MINT32 i4SensorDev, MINT32 *a_pEnableAWB,MUINT32 *a_pOutLen)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBGetEnableInfo(a_pEnableAWB, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBGetEnableInfo(a_pEnableAWB, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBGetEnableInfo(a_pEnableAWB, a_pOutLen);
...
CCTOPAWBGetAWBGain(MINT32 i4SensorDev, MVOID *a_pAWBGain, MUINT32 *a_pOutLen)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBGetAWBGain(a_pAWBGain, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBGetAWBGain(a_pAWBGain, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBGetAWBGain(a_pAWBGain, a_pOutLen);
...
CCTOPAWBSetAWBGain(MINT32 i4SensorDev, MVOID *a_pAWBGain)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBSetAWBGain(a_pAWBGain);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBSetAWBGain(a_pAWBGain);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBSetAWBGain(a_pAWBGain);
...
CCTOPAWBApplyNVRAMParam(MINT32 i4SensorDev, MVOID *a_pAWBNVRAM, MUINT32 u4CamScenarioMode)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBApplyNVRAMParam(a_pAWBNVRAM, u4CamScenarioMode);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBApplyNVRAMParam(a_pAWBNVRAM, u4CamScenarioMode);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBApplyNVRAMParam(a_pAWBNVRAM, u4CamScenarioMode);
...
CCTOPAWBGetNVRAMParam(MINT32 i4SensorDev, MVOID *a_pAWBNVRAM, MUINT32 *a_pOutLen)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBGetNVRAMParam(a_pAWBNVRAM, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBGetNVRAMParam(a_pAWBNVRAM, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBGetNVRAMParam(a_pAWBNVRAM, a_pOutLen);
...
CCTOPAWBGetNVRAMParam(MINT32 i4SensorDev, CAM_SCENARIO_T eIdx, MVOID *a_pAWBNVRAM)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBGetNVRAMParam(eIdx, a_pAWBNVRAM);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBGetNVRAMParam(eIdx, a_pAWBNVRAM);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBGetNVRAMParam(eIdx, a_pAWBNVRAM);
...
CCTOPAWBSaveNVRAMParam(MINT32 i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBSaveNVRAMParam();
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBSaveNVRAMParam();
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBSaveNVRAMParam();
...
CCTOPAWBSetAWBMode(MINT32 i4SensorDev, MINT32 a_AWBMode)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBSetAWBMode(a_AWBMode);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBSetAWBMode(a_AWBMode);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBSetAWBMode(a_AWBMode);
...
CCTOPAWBGetAWBMode(MINT32 i4SensorDev, MINT32 *a_pAWBMode, MUINT32 *a_pOutLen)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBGetAWBMode(a_pAWBMode, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBGetAWBMode(a_pAWBMode, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBGetAWBMode(a_pAWBMode, a_pOutLen);
...
CCTOPAWBGetLightProb(MINT32 i4SensorDev, MVOID *a_pAWBLightProb, MUINT32 *a_pOutLen)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBGetLightProb(a_pAWBLightProb, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBGetLightProb(a_pAWBLightProb, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBGetLightProb(a_pAWBLightProb, a_pOutLen);
...
CCTOPAWBBypassCalibration(MINT32 i4SensorDev, MBOOL bBypassCalibration)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPAWBBypassCalibration(bBypassCalibration);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPAWBBypassCalibration(bBypassCalibration);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPAWBBypassCalibration(bBypassCalibration);
...
CCTOPFlashAWBApplyNVRAMParam(MINT32 i4SensorDev, MVOID *a_pFlashAWBNVRAM)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPFlashAWBApplyNVRAMParam(a_pFlashAWBNVRAM);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPFlashAWBApplyNVRAMParam(a_pFlashAWBNVRAM);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPFlashAWBApplyNVRAMParam(a_pFlashAWBNVRAM);
...
CCTOPFlashAWBGetNVRAMParam(MINT32 i4SensorDev, MVOID *a_pFlashAWBNVRAM, MUINT32 *a_pOutLen)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPFlashAWBGetNVRAMParam(a_pFlashAWBNVRAM, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPFlashAWBGetNVRAMParam(a_pFlashAWBNVRAM, a_pOutLen);
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPFlashAWBGetNVRAMParam(a_pFlashAWBNVRAM, a_pOutLen);
...
CCTOPFlashAWBSaveNVRAMParam(MINT32 i4SensorDev)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        return AwbMgr::getInstance(ESensorDev_MainFourth).CCTOPFlashAWBSaveNVRAMParam();
    if (i4SensorDev & ESensorDev_MainFifth)
        return AwbMgr::getInstance(ESensorDev_MainFifth).CCTOPFlashAWBSaveNVRAMParam();
    if (i4SensorDev & ESensorDev_MainSixth)
        return AwbMgr::getInstance(ESensorDev_MainSixth).CCTOPFlashAWBSaveNVRAMParam();
...
{
    MINT32 ret_main, ret_sub, ret_main2, ret_sub2, ret_main3, ret_main4, ret_main5, ret_main6;
    ret_main = ret_sub = ret_main2 = ret_sub2 = ret_main3 = ret_main4 = ret_main5 = ret_main6 = S_AE_OK;
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).setAAOMode(u4AWBAAOmode);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).setAAOMode(u4AWBAAOmode);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).setAAOMode(u4AWBAAOmode);
...
MBOOL IAwbMgr::getAAOConfig(MINT32 i4SensorDev, AWB_AAO_CONFIG_Param_T &rAWBConfig)
{
    ...
    if (i4SensorDev & ESensorDev_MainFourth)
        ret_main4 = AwbMgr::getInstance(ESensorDev_MainFourth).getAAOConfig(rAWBConfig);
    if (i4SensorDev & ESensorDev_MainFifth)
        ret_main5 = AwbMgr::getInstance(ESensorDev_MainFifth).getAAOConfig(rAWBConfig);
    if (i4SensorDev & ESensorDev_MainSixth)
        ret_main6 = AwbMgr::getInstance(ESensorDev_MainSixth).getAAOConfig(rAWBConfig);
...
MBOOL IAwbMgr::setMWBColorTemperature(MINT32 i4SensorDev, int colorTemperature)
{
    if (i4SensorDev & ESensorDev_Main) {
       ...
       return AwbMgr::getInstance(ESensorDev_SubSecond).setMWBColorTemperature(colorTemperature);
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).setMWBColorTemperature(colorTemperature);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).setMWBColorTemperature(colorTemperature);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).setMWBColorTemperature(colorTemperature);
    }
...
MBOOL IAwbMgr::getSupportMWBColorTemperature(MINT32 i4SensorDev,MUINT32 &max, MUINT32 &min)
{
    ...
    if (i4SensorDev & ESensorDev_Main) {
       ...
       return AwbMgr::getInstance(ESensorDev_SubSecond).getSuppotMWBColorTemperature(max, min);
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).getSuppotMWBColorTemperature(max, min);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).getSuppotMWBColorTemperature(max, min);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).getSuppotMWBColorTemperature(max, min);
    }
...
MBOOL IAwbMgr::getAWBColorTemperature(MINT32 i4SensorDev, MUINT32 &colorTemperature)
{
    ...
    if (i4SensorDev & ESensorDev_Main) {
       ...
       return AwbMgr::getInstance(ESensorDev_SubSecond).getAWBColorTemperature(colorTemperature);
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).getAWBColorTemperature(colorTemperature);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).getAWBColorTemperature(colorTemperature);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).getAWBColorTemperature(colorTemperature);
    }
...
MBOOL IAwbMgr::SetTorchMode(MINT32 i4SensorDev, MBOOL is_torch_now)
{
    ...
    if (i4SensorDev & ESensorDev_Main) {
       ...
       return AwbMgr::getInstance(ESensorDev_SubSecond).SetTorchMode(is_torch_now);
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).SetTorchMode(is_torch_now);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).SetTorchMode(is_torch_now);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).SetTorchMode(is_torch_now);
    }
...
MBOOL IAwbMgr::SetMainFlashInfo(MINT32 i4SensorDev, MBOOL is_main_flash_on)
{
    ...
    if (i4SensorDev & ESensorDev_Main) {
       ...
       return AwbMgr::getInstance(ESensorDev_SubSecond).SetMainFlashInfo(is_main_flash_on);
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).SetMainFlashInfo(is_main_flash_on);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).SetMainFlashInfo(is_main_flash_on);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).SetMainFlashInfo(is_main_flash_on);
    }
...
MBOOL IAwbMgr::setMaxFPS(MINT32 i4SensorDev, MINT32 i4MaxFPS)
{
    if (i4SensorDev & ESensorDev_Main) {
       ...
       return AwbMgr::getInstance(ESensorDev_MainThird).setMaxFPS(i4MaxFPS);
        ...
        return AwbMgr::getInstance(ESensorDev_MainFourth).setMaxFPS(i4MaxFPS);
    }
    else if (i4SensorDev & ESensorDev_MainFifth) {
        return AwbMgr::getInstance(ESensorDev_MainFifth).setMaxFPS(i4MaxFPS);
    }
    else if (i4SensorDev & ESensorDev_MainSixth) {
        return AwbMgr::getInstance(ESensorDev_MainSixth).setMaxFPS(i4MaxFPS);
    }
