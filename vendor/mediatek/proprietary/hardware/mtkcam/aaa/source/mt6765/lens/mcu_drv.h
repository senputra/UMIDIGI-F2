...
enum {
    ...
    MCU_DEV_MAIN_3  = 0x10,    /*!<Main3 camera device (used in 3D scenario) */
};
...
public:     //// Interfaces
    ...
    static MSDK_LENS_INIT_FUNCTION_STRUCT m_LensInitFunc_main3[MAX_NUM_OF_SUPPORT_LENS] ;
    ...
    static unsigned int  m_u4CurrLensIdx_main3;
