...
BIND_ISP_TYPES(ISP_NVRAM_SL2F_GET_T, ISP_MGR_SL2F_T);
BIND_ISP_TYPES(ISP_NVRAM_SL2G_GET_T, ISP_MGR_SL2G_T);
...
BIND_ISP_TYPES(ISP_NVRAM_RMM_GET_T, ISP_MGR_RMM_T);
BIND_ISP_TYPES(ISP_NVRAM_RMG_T, ISP_MGR_RMG_T);
BIND_ISP_TYPES(ISP_NVRAM_RNR_T, ISP_MGR_RNR_T);
BIND_ISP_TYPES(ISP_NVRAM_LSC_T, ISP_MGR_LSC_T);
BIND_ISP_TYPES(ISP_NVRAM_SL2_T, ISP_MGR_SL2_T);
BIND_ISP_TYPES(ISP_NVRAM_SL2_GET_T, ISP_MGR_SL2_T);
BIND_ISP_TYPES(ISP_NVRAM_SL2B_GET_T, ISP_MGR_SL2_T);
BIND_ISP_TYPES(ISP_NVRAM_SL2C_GET_T, ISP_MGR_SL2_T);
BIND_ISP_TYPES(ISP_NVRAM_SL2D_GET_T, ISP_MGR_SL2_T);
BIND_ISP_TYPES(ISP_NVRAM_SL2H_GET_T, ISP_MGR_SL2_T);
BIND_ISP_TYPES(ISP_NVRAM_SL2I_GET_T, ISP_MGR_SL2_T);
...
//BIND_ISP_TYPES(ISP_NVRAM_CCM_CTL_T, ISP_MGR_CCM_T);
...
BIND_ISP_TYPES(ISP_NVRAM_HFG_GET_T, ISP_MGR_HFG_T);
...
BIND_ISP_TYPES(ISP_NVRAM_LCS_T, ISP_MGR_LCS_T);
...
MVOID
getIspHWBuf(MUINT32 const eSensorDev, ISP_XXX_T& rParam)
{
...
template <class ISP_XXX_T>
MVOID
getIspHWBuf(MUINT32 const eSensorDev, ESensorTG_T const /*eSensorTG*/, ISP_XXX_T& rParam)
{
    typedef typename ISPType2Type<ISP_XXX_T>::type ISP_MGR_T;
    ISP_MGR_T::getInstance(eSensorDev).get(rParam);
}
...
template <class ISP_XXX_T>
MVOID
putIspHWBuf(MUINT32 const eSensorDev, ISP_XXX_T const& rParam)
{
    typedef typename ISPType2Type<ISP_XXX_T>::type ISP_MGR_T;
...
template <class ISP_XXX_T>
MVOID
putIspHWBuf(MUINT32 const eSensorDev, ESensorTG_T const /*eSensorTG*/, ISP_XXX_T const& rParam)
{
    typedef typename ISPType2Type<ISP_XXX_T>::type ISP_MGR_T;
    ISP_MGR_T::getInstance(eSensorDev).put(rParam);
}
...
template <class ISP_XXX_T>
MVOID
getIspReg(MUINT32 const eSensorDev, ISP_XXX_T& rParam)
{
    typedef typename ISPType2Type<ISP_XXX_T>::type ISP_MGR_T;
...
template <class ISP_XXX_T>
MVOID
getIspReg(MUINT32 const eSensorDev, ESensorTG_T const /*eSensorTG*/, ISP_XXX_T& rParam)
{
    typedef typename ISPType2Type<ISP_XXX_T>::type ISP_MGR_T;
    ISP_MGR_T::getInstance(eSensorDev).reset();
    ISP_MGR_T::getInstance(eSensorDev).get(rParam);
