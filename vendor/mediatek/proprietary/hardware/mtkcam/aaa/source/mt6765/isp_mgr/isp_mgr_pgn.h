...
private:
    ...
    enum
    {
        ERegInfo_DIP_X_PGN_SATU_1,
        ERegInfo_DIP_X_PGN_SATU_2,
        ERegInfo_DIP_X_PGN_GAIN_1,
        ERegInfo_DIP_X_PGN_GAIN_2,
        ERegInfo_DIP_X_PGN_OFST_1,
        ERegInfo_DIP_X_PGN_OFST_2,
        ERegInfo_NUM
    };
...
public:
    ISP_MGR_PGN(MUINT32 const eSensorDev)
        : ISP_MGR_BASE_T(m_rIspRegInfo, ERegInfo_NUM, m_u4StartAddr, eSensorDev)
        , m_bEnable(MTRUE)
        , m_u4StartAddr(REG_ADDR_P2(DIP_X_PGN_SATU_1))
    {
        // register info addr init
        INIT_REG_INFO_ADDR_P2(DIP_X_PGN_SATU_1); // CAM+0x0880
        INIT_REG_INFO_ADDR_P2(DIP_X_PGN_SATU_2); // CAM+0x0884
        INIT_REG_INFO_ADDR_P2(DIP_X_PGN_GAIN_1); // CAM+0x0888
        INIT_REG_INFO_ADDR_P2(DIP_X_PGN_GAIN_2); // CAM+0x088C
        INIT_REG_INFO_ADDR_P2(DIP_X_PGN_OFST_1); // CAM+0x0890
        INIT_REG_INFO_ADDR_P2(DIP_X_PGN_OFST_2); // CAM+0x0894

        // register info value init
        INIT_REG_INFO_VALUE(DIP_X_PGN_SATU_1,ISP_NVRAM_PGN_SATU_1_T::DEFAULT);
        INIT_REG_INFO_VALUE(DIP_X_PGN_SATU_2,ISP_NVRAM_PGN_SATU_2_T::DEFAULT);
...
public: // Interfaces.
    ...
    inline MVOID getIspFlare(MINT32 *pi4FlareGain, MINT32 *pi4FlareOffset)
    {
        *pi4FlareGain = m_i4FlareGain;
        *pi4FlareOffset = m_i4FlareOffset;
    }
