...
////////Modify Exposure for manual control/////////////
    ...
    if((pinputinfo->u4AEMode == LIB3A_AE_MODE_OFF) && ((pinputinfo->u4TargetExp == 0) || (pinputinfo->u4TargetISO == 0))) {
        ...
        memset(&strExpInput, 0, sizeof(AE_EXP_SETTING_INPUT_T));
        ...
        if((strExpOutput.bOverSpec == MTRUE) && (strExpInput.u4TargetExposureTime <= MAX_MANUAL_EXP_VALUE) && (strExpInput.u4TargetSensitivity <= MAX_MANUAL_ISO_VALUE))
        {
