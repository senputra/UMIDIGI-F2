...
{
public:
    static PcaMgr* createInstance(MUINT32 const eSensorDev, ISP_NVRAM_COLOR_STRUCT& rIspColor);
...
private:
    //  PCA index
    MUINT32         m_u4Idx;
    //  Reference to m_rIspParam.ISPColorTbl
    ISP_NVRAM_COLOR_STRUCT&   m_rIspPca;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    PcaMgr(MUINT32 const eSensorDev, ISP_NVRAM_COLOR_STRUCT& rIspColor)
        : m_u4ChangeCount(1)
        , m_u4Idx(0)
        , m_rIspPca     (rIspColor)
        , m_rIspPcaCfg  (rIspColor.Config)
        , m_rIspPcaLUT (rIspColor.PCA_LUT)
