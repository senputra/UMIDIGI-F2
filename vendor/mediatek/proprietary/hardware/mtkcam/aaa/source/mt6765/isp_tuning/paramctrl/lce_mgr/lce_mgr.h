...
{
public:
    static LceMgr* createInstance(MUINT32 const eSensorDev, ISP_NVRAM_LCE_TUNING_PARAM_T* pIspNvramLcePara);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    LceMgr(MUINT32 const eSensorDev, ISP_NVRAM_LCE_TUNING_PARAM_T* pIspNvramLcePara);
