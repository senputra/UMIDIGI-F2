...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT IAfMgr::SetAETargetMode(MINT32 i4SensorDev __unused, MINT32 eAETargetMode __unused)
{
    return MFALSE;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
{
    return AfMgr::getInstance(i4SensorDev).passPDBuffer(ptrInPDData);
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
{
    return AfMgr::getInstance(i4SensorDev).getPdInfoForSttCtrl(i4SensorIdx, i4SensorMode, u4PDOSizeW, u4PDOSizeH, PDAFStatus);
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
