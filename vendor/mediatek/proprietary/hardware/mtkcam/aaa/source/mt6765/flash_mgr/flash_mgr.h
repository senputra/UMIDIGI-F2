...
public:
    ...
    int start(int senorDev);
    int stop(int senorDev);
    ...
    int setIsFlashOnCapture(int senorDev, int flashOnCapture);
    ...
    int isFlashOnCalibration(int senorDev);
    ...
    int setAAOMode(int senorDev, int aaoMode);

    // Sync from Everes
    int setPreFlashOnOff(int senorDev, int en);
    int getFlashOnFrmCnt(int senorDev);

    // driver control
    int setIsDriverInControl(int senorDev, int inControl);
    int getIsDriverInControl(int senorDev);
    int getExp(int senorDev);
