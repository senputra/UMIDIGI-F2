...
{
    CAM_LOGD("[StateUninitAF::sendIntent]<eIntent_Init>");
    // State transition: eState_Uninit --> eState_Init
    m_pAfStateMgr->_transitState(eState_Uninit, eState_Init);
...
{
    CAM_LOGD("[StateInitAF::sendIntent]<eIntent_Uninit>");
    // State transition: eState_Init --> eState_Uninit
    m_pAfStateMgr->_transitState(eState_Init, eState_Uninit);
...
{
    CAM_LOGD("[StateInit::sendIntent]<eIntent_CameraPreviewStart>");
    // State transition: eState_Init --> eState_CAF
    m_pAfStateMgr->_transitState(eState_Init, eState_CAF);
