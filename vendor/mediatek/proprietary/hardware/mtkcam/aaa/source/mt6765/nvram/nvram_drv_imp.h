...
public:
    ...
    virtual void setAndroidMode(int isAndroid){ isAndroid = 0; };
    ...
    virtual unsigned int readModuleIdFromEEPROM(CAMERA_DUAL_CAMERA_SENSOR_ENUM a_eSensorType, MINT32 r_i4SensorIdx, int forceWait);
