...
CcmMgr*
CcmMgr::
createInstance(MUINT32 const eSensorDev, ISP_NVRAM_MULTI_CCM_STRUCT& rISPMultiCCM, IspTuningCustom* pIspTuningCustom)
{
    ...
    std::call_once(rSingleton.onceFlag, [&] {
        rSingleton.instance = std::make_unique<CcmMgr>(eSensorDev, rISPMultiCCM, pIspTuningCustom);
    } );
