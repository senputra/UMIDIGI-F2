...
MINT32 giCctCmdOutBufSize[CCT_CMD_OUTBUF_SIZE_COUNT][2] = {
   ...
   {  FT_CCT_OP_AE_SET_CAPTURE_ISO_WITH_AUTO_EXP,0 }
...
cct_getSensorStaticInfo()
{
    ...
    if(pHalSensorList == NULL) {
        MY_LOGE("[AAA Sensor Mgr] Can not create IHalSensorList\n");
...
{
    ISP_MGR_SL2F_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    //ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
    //ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuning::EIspProfile_NormalCapture);
...
{
    ISP_MGR_DBS_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    //ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
    //ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuning::EIspProfile_NormalCapture);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
setIspOnOff_OBC(MBOOL const fgOn)
{
    ...
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    //ISP_MGR_OBC_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
    //ISP_MGR_OBC_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuningv3::EIspProfile_NormalCapture);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
setIspOnOff_BPC(MBOOL const fgOn)
{
    ...
    ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).setCCTBPCEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    //ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
    //ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuningv3::EIspProfile_NormalCapture);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
setIspOnOff_NR1(MBOOL const fgOn)
{
    ...
    ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).setCCTCTEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    //ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
    //ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuningv3::EIspProfile_NormalCapture);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
setIspOnOff_RMM(MBOOL const fgOn)
{
    ...
    ISP_MGR_RMM_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    //ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
    //ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuningv3::EIspProfile_NormalCapture);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
setIspOnOff_RNR(MBOOL const fgOn)
{
    ...
    ISP_MGR_RNR_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    //ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
    //ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuningv3::EIspProfile_NormalCapture);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
setIspOnOff_SL2(MBOOL const fgOn)
{
    ...
    ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    //ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
    //ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuningv3::EIspProfile_NormalCapture);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
setIspOnOff_UDM(MBOOL const fgOn)
{
    ...
    ISP_MGR_UDM::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);

    (fgOn == MTRUE) ? (ISP_MGR_UDM::getInstance((MUINT32)m_eSensorEnum).put(m_rISPRegs.UDM[u4Index]))
                    : (ISP_MGR_UDM::getInstance((MUINT32)m_eSensorEnum).put(m_rISPRegs.UDM[NVRAM_UDM_TBL_NUM - 1]));

    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    //ISP_MGR_CFA::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
    //ISP_MGR_CFA::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuningv3::EIspProfile_NormalCapture);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
setIspOnOff_CCM(MBOOL const fgOn)
{
    ...
    //ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuningv3::EIspProfile_NormalCapture);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
setIspOnOff_GGM(MBOOL const fgOn)
{
    ...
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    //ISP_MGR_GGM_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
    //ISP_MGR_GGM_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuningv3::EIspProfile_NormalCapture);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    ISP_MGR_PCA_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
setIspOnOff_ANR(MBOOL const fgOn)
{
    ...
    ISP_MGR_NBC_T::getInstance((MUINT32)m_eSensorEnum).setCCTANR1Enable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
setIspOnOff_ANR2(MBOOL const fgOn)
{
    ...
    ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).setCCTANR2Enable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
setIspOnOff_CCR(MBOOL const fgOn)
{
    ...
    ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).setCCTCCREnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
setIspOnOff_BOK(MBOOL const fgOn)
{
    ...
    ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).setCCTBOKEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
setIspOnOff_HFG(MBOOL const fgOn)
{
    ...
    ISP_MGR_HFG_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
//    EECtrl_Clip.SEEE_OVRSH_CLIP_EN = fgOn;//definition change: CAM_SEEE_CLIP_CTRL CAM+AA4H
    ...
    ISP_MGR_SEEE_T::getInstance((MUINT32)m_eSensorEnum).setCCTEEEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
...
{
    //Temp. Mark
    ISP_MGR_NR3D_T::getInstance((MUINT32)m_eSensorEnum).setNr3dEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    //Temp. Mark
    ISP_MGR_MFB_T::getInstance((MUINT32)m_eSensorEnum).setEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    //Temp. Mark
    ISP_MGR_MIXER3_T::getInstance((MUINT32)m_eSensorEnum).setEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    ISP_MGR_NR3D_T::getInstance((MUINT32)m_eSensorEnum).setCCTColorEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    //ISP_MGR_HLR_T::getInstance((MUINT32)m_eSensorEnum).setCCTEnable(fgOn);
    //NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
...
{
    ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).setABFEnable(fgOn);
    NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
    MY_LOG("[%s] fgOn = %d", __FUNCTION__, fgOn);
}
...
{
    return ISP_MGR_SL2F_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
{
    return ISP_MGR_DBS_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
{
    return  ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).isCCTBPCEnable();
}
...
{
    return  ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).isCCTCTEnable();
}
...
{
    return  ISP_MGR_BNR_T::getInstance((MUINT32)m_eSensorEnum).isCCTPDCEnable();
}
...
getIspOnOff_RMM() const
{
    ...
    return  ISP_MGR_RMM_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
...
getIspOnOff_RNR() const
{
    ...
    return  ISP_MGR_RNR_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
...
getIspOnOff_SL2() const
{
    ...
    return  ISP_MGR_SL2_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
...
getIspOnOff_UDM() const
{
    ...
    return  ISP_MGR_UDM::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
...
{
    return  ISP_MGR_PCA_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
getIspOnOff_ANR() const
{
        ...
        return (ISP_MGR_NBC_T::getInstance((MUINT32)m_eSensorEnum).isCCTANR1Enable());
}
...
getIspOnOff_ANR2() const
{
        ...
        return (ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).isCCTANR2Enable());
}
...
getIspOnOff_CCR() const
{
        ...
        return ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).isCCTCCREnable();
...
getIspOnOff_BOK() const
{
        ...
        return ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).isCCTBOKEnable();
...
{
    return ISP_MGR_HFG_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
{
    return ISP_MGR_SEEE_T::getInstance((MUINT32)m_eSensorEnum).isCCTEEEnable();
}
...
{
    return ISP_MGR_NR3D_T::getInstance((MUINT32)m_eSensorEnum).isNr3dEnable();
}
...
getIspOnOff_MFB() const
{
    return MFALSE;
    //Temp. Mark
    //return ISP_MGR_MFB_T::getInstance((MUINT32)m_eSensorEnum).isEnable();
}
...
getIspOnOff_MIXER3() const
{
    return MFALSE;
    //Temp. Mark
    //return ISP_MGR_MIXER3_T::getInstance((MUINT32)m_eSensorEnum).isEnable();
}
...
{
    return  ISP_MGR_NR3D_T::getInstance((MUINT32)m_eSensorEnum).isCCTColorEnable();
}
...
{
    return  MFALSE;
    //return  ISP_MGR_HLR_T::getInstance((MUINT32)m_eSensorEnum).isCCTEnable();
}
...
{
    return  ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).isABFEnable();
}
                ...
                MUINT32 *pu4RealParaOutLen )
{
    ...
    case FT_CCT_OP_ISP_GET_CCM_MATRIX:
        ...
        *pu4RealParaOutLen = 0;
        ...
        ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).get(ccm);
    ...
    */
        ...
        ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).reset();
        ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).put(rDst);
        NSIspTuningv3::IspTuningMgr::getInstance().forceValidate((MINT32)m_eSensorEnum);
        //ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).apply(EIspProfile_Preview);
        //NSIspTuningv3::ISP_MGR_CCM_T::getInstance((MUINT32)m_eSensorEnum).apply(NSIspTuningv3::EIspProfile_NormalCapture);
        usleep(200000);
                    ...
                    MUINT32 *pu4RealParaOutLen )
{
    ...
    case FT_CCT_OP_AE_BRECKET_STEP:
        *pu4RealParaOutLen = 0;
        ...
        if(u4ParaInLen == sizeof(MINT32) && puParaIn != NULL)
        {
            ...
            MY_LOGD("setAeDiffEvValue : %d ", ((*i32In)/10));
            //set EVValue
            //AE off
            {
            ...
            strSensorParams.u8ExposureTime  = ((MINT64)aeOutput.EvSetting.u4Eposuretime)*1000;
    ...
    case FT_CCT_OP_SET_RESULT_FILE_PATH:
        ...
        *pu4RealParaOutLen = 0;
        ...
        //
        break;
    case FT_CCT_OP_AE_SET_CAPTURE_ISO_WITH_AUTO_EXP:
        MY_LOGD("FT_CCT_OP_AE_SET_CAPTURE_ISO_WITH_AUTO_EXP");
        *pu4RealParaOutLen = 0;
        if(u4ParaInLen == sizeof(MINT32) && puParaIn != NULL)
        {
            i32In = (MINT32 *)puParaIn;
            IAeMgr::getInstance().setAEISOSpeed(mSensorDev, *i32In);
            MY_LOGD("set setAEISOSpeed(%d)",*i32In);
            //
            sResult = android::String8::format("Result=OK\n");
            saveResult(sResult);
        }
...
MRESULT CctHandle::UnpackRAWImage()
{
    ...
    {
        if(unpackBufSize != fread(rawUnpackBuf, 1, unpackBufSize, packFile)) {MY_LOGE("fread failed");}
    }
    else
    {
        ...
        if(packFileSize != fread(t_packBuf, 1, packFileSize, packFile)) {MY_LOGE("fread failed");}
...
MRESULT CctHandle::mrCalLenShading(INT32 a_i4XINIBorder, INT32 a_i4XENDBorder, INT32 a_i4YINIBorder, INT32 a_i4YENDBorder,  UINT16 a_u2AttnRatio, UINT32 a_u4Index, INT32 a_i4SensorMode, UINT8 a_u1FixShadingIndex, INT32 a_i4AvgWinSize)
{
    ...
    cct_OpDispatch(FT_CCT_OP_SET_SHADING_INDEX, sizeof(MUINT32), (MUINT8*)&a_u4Index, 0, NULL, &u4RetLen);
    {
        ...
        char strFile[512] = {'\0'};
        snprintf(strFile, 512, "/data/vendor/shading/KLSC_F_CFG(%dx%d_%dx%d)_BD(%d,%d,%d,%d)_ATT(%d)_WIN(%d)_IDX(%d).log",
        ...
        snprintf(strFile, 512, "/data/vendor/shading/KLSC_G_CFG(%dx%d_%dx%d)_BD(%d,%d,%d,%d)_ATT(%d)_WIN(%d)_IDX(%d).log",
                    rLSCCaliINIParam.i4GridXNUM, rLSCCaliINIParam.i4GridYNUM, rawWidth, rawHeight,
                    a_i4XINIBorder, a_i4XENDBorder, a_i4YINIBorder, a_i4YENDBorder, a_u2AttnRatio, a_i4AvgWinSize, a_u4Index);
...
cctNvram_SetIspNvramData(ISP_NVRAM_REGISTER_STRUCT *pIspRegs)
{
    ...
    if (index < NVRAM_ANR_TBL_NUM) {
        ...
        ISP_MGR_NBC_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->ANR[index]));
    }
    ...
    if (index < NVRAM_ANR2_TBL_NUM) {
        ...
        ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->ANR2[index]));
    }
    ...
    if (index < NVRAM_CCR_TBL_NUM) {
        ...
        ISP_MGR_NBC2_T::getInstance((MUINT32)m_eSensorEnum).put((pIspRegs->CCR[index]));
    }
