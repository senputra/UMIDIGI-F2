...
ISP_MGR_PCA_T&
ISP_MGR_PCA_T::
getInstance(MUINT32 const eSensorDev, EPCAMode_T const ePCAMode)
{
    ...
    MY_ASSERT(ePCAMode < EPCAMode_NUM);
    MY_ASSERT(ePCAMode >= 0);

    MY_ASSERT(i4InstIdx < INST_MAX);
    MY_ASSERT(i4InstIdx >= 0);
