  ...
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_CameraPreviewStart>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_CameraPreviewStart", m_pcszName);
  ...
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_CameraPreviewEnd>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_CameraPreviewEnd", m_pcszName);
  ...
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_PrecaptureStart>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_PrecaptureStart", m_pcszName);
  ...
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_PrecaptureEnd>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_PrecaptureEnd", m_pcszName);
            return  E_3A_UNSUPPORT_COMMAND;
        }
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_CaptureStart>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_CaptureStart", m_pcszName);
            return  E_3A_UNSUPPORT_COMMAND;
        }
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_CaptureEnd>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_CaptureEnd", m_pcszName);
  ...
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_RecordingStart>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_RecordingStart", m_pcszName);
  ...
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_RecordingEnd>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_RecordingEnd", m_pcszName);
  ...
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_VsyncUpdate>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_VsyncUpdate", m_pcszName);
            return  E_3A_UNSUPPORT_COMMAND;
        }
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_AFUpdate>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_AFUpdate", m_pcszName);
            return  E_3A_UNSUPPORT_COMMAND;
        }
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_AFStart>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_AFStart", m_pcszName);
            return  E_3A_UNSUPPORT_COMMAND;
        }
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_AFEnd>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_AFEnd", m_pcszName);
            return  E_3A_UNSUPPORT_COMMAND;
        }
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_Init>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_Init", m_pcszName);
  ...
  /**
    ...
    */
    virtual MRESULT  sendIntent(intent2type<eIntent_Uninit>) {
            CAM_LOGE("[%s]E_3A_UNSUPPORT_COMMAND: eIntent_Uninit", m_pcszName);
...
*/
    virtual MRESULT  sendIntent(intent2type<eIntent_CaptureStart>);
    MRESULT  doUpdate();
    MRESULT  doCaptureEnd();
    MRESULT  doRestore(MBOOL bIsFlashOn = MFALSE);
};
...
struct StatePrecapture : public IState
{
    ...
    MRESULT  sendPrecapIntent(intent2type<eIntent_VsyncUpdate>, state2type<ePrecap_AE>, MVOID* pBufInfo, StatisticBufInfo* rPSOBufInfo);
...
struct StateAF : public IState
{
    ...
    MRESULT  sendAFIntent(intent2type<eIntent_VsyncUpdate>, state2type<eAFState_PreAF>, MVOID* pBufInfo, StatisticBufInfo* rPSOBufInfo);
    MRESULT  sendAFIntent(intent2type<eIntent_VsyncUpdate>, state2type<eAFState_AF>, MVOID* pBufInfo, StatisticBufInfo* rPSOBufInfo);
    MRESULT  sendAFIntent(intent2type<eIntent_VsyncUpdate>, state2type<eAFState_PostAF>, MVOID* pBufInfo, StatisticBufInfo* rPSOBufInfo);
    //MRESULT exitPreview();
