...
public: // Dynamic Tuning
    ...
    virtual MVOID   	enableDynamicShading(MBOOL fgEnable) = 0;
    ...
    virtual MVOID       getLCSparam(ISP_LCS_IN_INFO_T &lcs_info) = 0;
...
public:     // Attributes
    ...
    virtual MERROR_ENUM setFrontBinInfo(ISP_BIN_INFO_T const BinInfo) = 0;
    ...
    virtual MERROR_ENUM setAEManual(MBOOL const manual) = 0;
    virtual MERROR_ENUM setAEInfoP2(AE_INFO_T const &rAEInfo) = 0;
    ...
    virtual MERROR_ENUM setDebugInfo4TG(MUINT32 const u4Rto, MINT32 const OBCGain, NSIspExifDebug::IspExifDebugInfo_T& rDbgIspInfo) = 0;
    ...
    virtual MERROR_ENUM setFDInfo(float const FD_ratio) = 0;
    virtual MERROR_ENUM setFlkEnable(MBOOL const flkEnable) = 0;
    virtual MVOID*      getDMGItable() = 0;
...
public:     ////    Operations.
    ...
    static void setPerFramePropEnable(MBOOL bEnable);
    static MINT32 propertyGet(const char* pProperty, MINT32 i4Default);
    virtual MERROR_ENUM init(MINT32 const i4SubsampleCount=1) = 0;
    virtual MERROR_ENUM uninit() = 0;
    virtual MERROR_ENUM validate(NS3Av3::RequestSet_T const RequestSet, MBOOL const fgForce = MFALSE, MINT32 i4SubsampleIdex=0) = 0;
    virtual MERROR_ENUM validateFrameless() = 0;
    virtual MERROR_ENUM validatePerFrame(NS3Av3::RequestSet_T const RequestSet, MBOOL const fgForce = MFALSE, MINT32 i4SubsampleIdex=0) = 0;
    virtual MERROR_ENUM validatePerFrameP2(MINT32 flowType, const ISP_INFO_T& rIspInfo, void* pTuningBuf) = 0;
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    virtual MVOID sendIspTuningIOCtrl(MUINT32 ctrl, MINTPTR arg1, MINTPTR arg2)=0;
    virtual MVOID* getDefaultISPIndex(MUINT32 eIspProfile, MUINT32 eSensorMode, MUINT32 eIdx_ISO)=0;
    virtual MVOID getDefaultObc(MUINT32 eIspProfile, MUINT32 eSensorMode, MVOID*& pObc, MUINT16& i4idx)=0;
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
