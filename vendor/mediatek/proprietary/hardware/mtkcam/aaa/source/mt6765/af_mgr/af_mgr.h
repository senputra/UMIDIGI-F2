...
#define ISPINFO_QUEUE_SIZE 64
#define ISPINFO_QUEUE_MASK (ISPINFO_QUEUE_SIZE - 1)
typedef struct ISINFO_QUEUE_t
{
    const static MUINT32 queueSize = ISPINFO_QUEUE_SIZE;
    ...
    VOID pushIdx(MUINT32 FrmId, ISP_SENSOR_INFO_T input)
    {
        content[(FrmId & ISPINFO_QUEUE_MASK)] = input;
    }
} ISINFO_QUEUE_T;
...
private :
    ...
    AREA_T m_sArea_TheLastFocusing; /* The Last Focusing area*/
    ...
    MUINT32 m_sArea_TheLastTypeSel;
