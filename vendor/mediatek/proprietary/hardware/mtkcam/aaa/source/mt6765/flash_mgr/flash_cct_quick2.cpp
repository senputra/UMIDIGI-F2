...
#define STATE_END2 6
    ...
    if(m_pfFrameCount==0){
        ...
        ISP_MGR_AWB_STAT_CONFIG_T::getInstance((MUINT32)m_sensorDev).getIspAWBPreGain1(&awbPreGain1Prev);
    ...
    ISP_MGR_AWB_STAT_CONFIG_T::getInstance((MUINT32)m_sensorDev).setIspAWBPreGain1(awbPreGain1Curr);
...
//          e_errBrightness_environmentNotDark,
    //        e_errBrightness_overExposure,
        ...
        //----------------
        ISP_MGR_AWB_STAT_CONFIG_T::getInstance((MUINT32)m_sensorDev).setIspAWBPreGain1(awbPreGain1Prev);
        g_CaliData.clear();
        g_CaliData1.clear();
        g_CaliData2.clear();
        g_CaliData3.clear();
