...
protected:
    ...
    MINT32                  convert3AROI(const android::Vector<MINT32> &vec3AROI, MetaSet_T& rMetaResult, const mtk_camera_metadata_tag_t &tag) const;
    ...
    IMetadata::Memory       mBackupCamInfo;
...
protected:
    ...
    MUINT32                 mi4PreTgWidth;
    MUINT32                 mi4PreTgHeight;
    MUINT32                 mi4AppfgCrop;
    // for previous metaResultQueue index
    MINT32                  mi4PreMetaResultQueueIdx;
    MBOOL                   mbDoPreCapInFlashAF;
    MBOOL                   mbDbgInfoEnable;
    MUINT32                 mu4ProcessP2;
