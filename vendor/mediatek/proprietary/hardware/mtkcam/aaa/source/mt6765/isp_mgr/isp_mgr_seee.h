...
public: // Interfaces.
    ...
    isCCTEEEnable()
    {
        return m_bCCTEEEnable;
    }

    MVOID
    setCCTEEEnable(MBOOL bEnable)
    {
        m_bCCTEEEnable = bEnable;
    }
