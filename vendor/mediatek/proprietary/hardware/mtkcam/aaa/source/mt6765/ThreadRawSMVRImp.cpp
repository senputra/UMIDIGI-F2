...
protected: //private:
    ThreadRawSMVRImp();
    ThreadRawSMVRImp(I3AWrapper* pHal3A, MINT32 iSensorDev, MINT32 iSensorIdx);
...
IThreadRaw*
IThreadRawSMVR::createInstance(I3AWrapper* pHal3A, MINT32 iSensorDev, MINT32 iSensorIdx)
{
