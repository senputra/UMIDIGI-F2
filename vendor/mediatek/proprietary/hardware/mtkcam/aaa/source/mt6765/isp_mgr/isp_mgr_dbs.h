...
public:
    ISP_MGR_DBS(MUINT32 const eSensorDev)
        ...
        , m_u4StartAddr(REG_ADDR_P1(CAM_DBS_SIGMA))
    {
        ...
        INIT_REG_INFO_ADDR_P1(CAM_DBS_SIGMA_2);
        INIT_REG_INFO_ADDR_P1(CAM_DBS_YGN);
        INIT_REG_INFO_ADDR_P1(CAM_DBS_SL_Y12);
        INIT_REG_INFO_ADDR_P1(CAM_DBS_SL_Y34);
        INIT_REG_INFO_ADDR_P1(CAM_DBS_SL_G12);
        INIT_REG_INFO_ADDR_P1(CAM_DBS_SL_G34);
        INIT_REG_INFO_ADDR_P1(CAM_DBS_CTL_2);
    }
...
private:
    ...
    enum
    {
        ...
        ERegInfo_DIP_X_DBS2_SIGMA_2,
        ERegInfo_DIP_X_DBS2_YGN,
        ERegInfo_DIP_X_DBS2_SL_Y12,
        ERegInfo_DIP_X_DBS2_SL_Y34,
        ERegInfo_DIP_X_DBS2_SL_G12,
        ERegInfo_DIP_X_DBS2_SL_G34,
        ERegInfo_DIP_X_DBS2_CTL_2,
        ERegInfo_NUM
    };
...
public:
    ISP_MGR_DBS2(MUINT32 const eSensorDev)
        : ISP_MGR_BASE_T(m_rIspRegInfo, ERegInfo_NUM, m_u4StartAddr, eSensorDev)
        , m_bEnable(MTRUE)
        , m_bCCTEnable(MTRUE)
        , m_u4IspAEGain(512)
        , m_u4StartAddr(REG_ADDR_P2(DIP_X_DBS2_SIGMA))
    {
        ...
        INIT_REG_INFO_ADDR_P2(DIP_X_DBS2_SIGMA_2);
        INIT_REG_INFO_ADDR_P2(DIP_X_DBS2_YGN);
        INIT_REG_INFO_ADDR_P2(DIP_X_DBS2_SL_Y12);
        INIT_REG_INFO_ADDR_P2(DIP_X_DBS2_SL_Y34);
        INIT_REG_INFO_ADDR_P2(DIP_X_DBS2_SL_G12);
        INIT_REG_INFO_ADDR_P2(DIP_X_DBS2_SL_G34);
        INIT_REG_INFO_ADDR_P2(DIP_X_DBS2_CTL_2);
    }
