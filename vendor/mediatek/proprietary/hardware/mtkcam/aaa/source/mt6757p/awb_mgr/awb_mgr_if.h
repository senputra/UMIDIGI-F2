...
public:
     ...
     */
    MBOOL cameraPreviewInit(MINT32 i4SensorDev, MINT32 i4SensorIdx, Param_T &rParam, IAWBInitPara* initPara=0);
     ...
     */
    MBOOL camcorderPreviewInit(MINT32 i4SensorDev, MINT32 i4SensorIdx, Param_T &rParam, IAWBInitPara* initPara=0);

    /**
     * @brief camera capture init
     * @param [in] i4SensorDev sensor device; please refer to ESensorDev_T in isp_tuning.h
     */
    MBOOL cameraCaptureInit(MINT32 i4SensorDev, IAWBInitPara* initPara=0);

    /**
     * @brief camera preview re-init
     * @param [in] i4SensorDev sensor device; please refer to ESensorDev_T in isp_tuning.h
     */
    MBOOL cameraPreviewReinit(MINT32 i4SensorDev, IAWBInitPara* initPara=0);
 ...
 //   MBOOL getInitInputParam(MINT32 i4SensorDev, SYNC_CTC_INIT_PARAM &CCTInitParam, NORMAL_GAIN_INIT_INPUT_PARAM &NoramlGainInitParam);
    ...
    /**
     * @brief set eng mode dump capture AAO
     * @param [in] i4SensorDev sensor device; please refer to ESensorDev_T in isp_tuning.h
     * @param [in] fgSave, save file flag
     * @param [in] filename, path & file name
     */
    MRESULT setEMDumpCapAAO(MINT32 i4SensorDev, MBOOL fgSave, const char* filename);
  ...
  MBOOL backup(MINT32 const i4SensorDev);
    ...
    MBOOL SetAETargetMode(MINT32 const i4SensorDev, int mode); //for hdr
     ...
     * @param [in] i4tgheight QBIN image height
     */
    MRESULT getFocusArea(MINT32 i4SensorDev, android::Vector<MINT32> &vecOut, MINT32 i4tgwidth, MINT32 i4tgheight);
