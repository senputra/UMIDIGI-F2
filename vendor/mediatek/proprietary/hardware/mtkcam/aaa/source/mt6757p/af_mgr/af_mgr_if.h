...
public:
    ...
    MINT32 isAFEnable(MINT32 i4SensorDev);
    ...
    MBOOL sendAFCtrl(MINT32 i4SensorDev, MUINT32 eAFCtrl, MINTPTR iArg1, MINTPTR iArg2);
    ...
    MVOID SyncAFSetInfo(MINT32 i4SensorDev, MINT32 a_i4Pos);
