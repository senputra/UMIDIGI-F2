...
)
{
    ...
    case ACDK_CCT_OP_DEV_AE_GET_INFO:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAEGetNVRAMParam(mSensorDev, (VOID *)puParaOut, pu4RealParaOutLen);
        break;
    ...
    case ACDK_CCT_OP_DEV_AE_APPLY_INFO:
        scenario = u4ParaOutLen;
        MY_LOG("scenario(%d)", scenario);
        err = NS3Av3::IAeMgr::getInstance().CCTOPAEApplyNVRAMParam(mSensorDev, (VOID *)puParaIn, scenario);
        break;
    ...
    case ACDK_CCT_OP_AE_GET_ISP_OB:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAEGetIspOB(mSensorDev, (MUINT32 *)puParaOut, pu4RealParaOutLen);
        break;
    case ACDK_CCT_OP_AE_SET_ISP_OB:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAESetIspOB(mSensorDev, *u32In);
        break;
    case ACDK_CCT_OP_AE_GET_ISP_RAW_GAIN:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAEGetIspRAWGain(mSensorDev, (MUINT32 *)puParaOut, pu4RealParaOutLen);
        break;
    case ACDK_CCT_OP_AE_SET_ISP_RAW_GAIN:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAESetIspRAWGain(mSensorDev, *u32In);
        break;
    case ACDK_CCT_OP_AE_SET_SENSOR_EXP_TIME:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAESetSensorExpTime(mSensorDev, *u32In);
        break;
    case ACDK_CCT_OP_AE_SET_SENSOR_EXP_LINE:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAESetSensorExpLine(mSensorDev, *u32In);
        break;
    case ACDK_CCT_OP_AE_SET_SENSOR_GAIN:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAESetSensorGain(mSensorDev, *u32In);
        break;
    case ACDK_CCT_OP_AE_CAPTURE_MODE:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAESetCaptureMode(mSensorDev, *u32In);
        break;
    ...
    case ACDK_CCT_OP_DEV_AE_GET_FLARE_CALIBRATION:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAEGetFlareOffset(mSensorDev, *u32In, (MUINT32 *)puParaOut, pu4RealParaOutLen);
        break;
    ...
    case ACDK_CCT_OP_DEV_AE_GET_PLINE:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAEGetPlineNVRAM(mSensorDev, (VOID *)puParaOut, pu4RealParaOutLen);
        break;
    case ACDK_CCT_OP_DEV_AE_APPLY_PLINE:
        err = NS3Av3::IAeMgr::getInstance().CCTOPAEApplyPlineNVRAM(mSensorDev, (VOID *)puParaIn);
        break;
    ...
    case ACDK_CCT_V2_OP_AWB_APPLY_CAMERA_PARA2:
        scenario = u4ParaOutLen;
        MY_LOG("scenario(%d)", scenario);
        err = NS3Av3::IAwbMgr::getInstance().CCTOPAWBApplyNVRAMParam(mSensorDev, (VOID *)puParaIn, scenario);
        break;
    case ACDK_CCT_V2_OP_AWB_GET_AWB_PARA:
        err = NS3Av3::IAwbMgr::getInstance().CCTOPAWBGetNVRAMParam(mSensorDev, (VOID *)puParaOut, pu4RealParaOutLen);
        break;
    ...
    case ACDK_CCT_OP_AWB_APPLY_FLASH_AWB_PARA:
        err = NS3Av3::IAwbMgr::getInstance().CCTOPFlashAWBApplyNVRAMParam(mSensorDev, (VOID *)puParaIn);
        break;
    case ACDK_CCT_OP_AWB_GET_FLASH_AWB_PARA:
        err = NS3Av3::IAwbMgr::getInstance().CCTOPFlashAWBGetNVRAMParam(mSensorDev, (VOID *)puParaOut, pu4RealParaOutLen);
        break;
    ...
    case ACDK_CCT_V2_OP_MF_OPERATION:
        ...
        if( *i32In > 0 )
        {
             err = NS3Av3::IAfMgr::getInstance().CCTOPMFOpeartion(mSensorDev, (*i32In)-1);
        }

        err = NS3Av3::IAfMgr::getInstance().CCTOPMFOpeartion(mSensorDev, *i32In);
        break;
    case ACDK_CCT_V2_OP_GET_AF_INFO:
        err = NS3Av3::IAfMgr::getInstance().CCTOPAFGetAFInfo(mSensorDev, (VOID *)puParaOut, pu4RealParaOutLen);
        break;
    ...
    case ACDK_CCT_V2_OP_AF_CALI_OPERATION:
        err = NS3Av3::IAfMgr::getInstance().CCTOPAFCaliOperation(mSensorDev, (VOID *)puParaOut, pu4RealParaOutLen);
        break;
    case ACDK_CCT_V2_OP_AF_SET_RANGE:
        err = NS3Av3::IAfMgr::getInstance().CCTOPAFSetFocusRange(mSensorDev, (VOID *)puParaIn);
        break;
    ...
    case ACDK_CCT_V2_OP_AF_READ:
        err = NS3Av3::IAfMgr::getInstance().CCTOPAFGetNVRAMParam(mSensorDev, (VOID *)puParaOut, pu4RealParaOutLen);
        break;
    case ACDK_CCT_V2_OP_AF_APPLY:
        scenario = u4ParaOutLen;
        MY_LOG("scenario(%d)", scenario);
        err = NS3Av3::IAfMgr::getInstance().CCTOPAFApplyNVRAMParam(mSensorDev, (VOID *)puParaIn, scenario);
        break;
    case ACDK_CCT_V2_OP_AF_GET_FV:
        err = NS3Av3::IAfMgr::getInstance().CCTOPAFGetFV(mSensorDev, (VOID *)puParaIn, (VOID *)puParaOut, pu4RealParaOutLen);
        break;
    case ACDK_CCT_OP_AF_ENABLE:
        bIsAfMode = MTRUE;
        m_pAcdkCctBaseObj->sendcommand(ACDK_CMD_SET_AF_MODE, (UINT8 *)&bIsAfMode, sizeof(bIsAfMode), NULL, 0, &u4RetLen);
    ...
    case ACDK_CCT_OP_AF_GET_ENABLE_INFO:
        err = NS3Av3::IAfMgr::getInstance().CCTOPAFGetEnableInfo(mSensorDev, (VOID *)puParaOut, pu4RealParaOutLen);
        break;
    case ACDK_CCT_AF_INIT:
        err = NS3Av3::IAfMgr::getInstance().init(mSensorDev, 1/*sensoridx*/);
        MY_LOG("ACDK_CCT_AF_INIT: IAfMgr init() done\n");
        break;
    case ACDK_CCT_AF_UNINIT:
        err = NS3Av3::IAfMgr::getInstance().uninit(mSensorDev);
        MY_LOG("ACDK_CCT_AF_UNINIT: IAfMgr uninit() done\n");
        break;
    case ACDK_CCT_MCU_NAME_INIT:
        err = NS3Av3::IAfMgr::getInstance().CCTMCUNameinit(mSensorDev, 1/*sensoridx*/);
        MY_LOG("ACDK_CCT_MCU_NAME_INIT: IAfMgr init() done\n");
        break;
    case ACDK_CCT_MCU_NAME_UNINIT:
        err = NS3Av3::IAfMgr::getInstance().CCTMCUNameuninit(mSensorDev);
