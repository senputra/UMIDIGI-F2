...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    case ESensorDev_SubSecond: //  Sub Sensor
        return  ISP_MGR_LSC_DEV<ESensorDev_SubSecond>::getInstance();
    default:
...
//    REG_INFO_VALUE(CAM_LSC_GAIN_TH)     = 0x03F00000;
    ...
    rTuning.updateEngineFD(eTuningMgrFunc_LSC, i4SubsampleIdex, m_FD);
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    case ESensorDev_SubSecond: //  Sub Sensor
        return  ISP_MGR_LSC2_DEV<ESensorDev_SubSecond>::getInstance();
    default:
        CAM_LOGE("eSensorDev = %d", eSensorDev);
        return  ISP_MGR_LSC2_DEV<ESensorDev_Main>::getInstance();
    }
