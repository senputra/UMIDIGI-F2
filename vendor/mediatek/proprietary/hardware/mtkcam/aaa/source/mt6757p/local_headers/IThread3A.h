...
#ifndef _ITHREAD_3A_H_
#define _ITHREAD_3A_H_
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    virtual MBOOL isEnd() const = 0;
    virtual VOID enableListenUpdate(MBOOL bEnable) = 0;
...
protected:  //    Ctor/Dtor.
        ...
        IThread3A(const IThread3A&);
        IThread3A& operator=(const IThread3A&);
};
}; // namespace NS3Av3
