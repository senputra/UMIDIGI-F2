...
#-----------------------------------------------------------
MTKCAM_3A_PATH    := $(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/$(SPECIFIC_TGT_BD_PLATFORM)
MTKCAM_3A_COMMON_PATH := $(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/common
MTKCAM_ALGO_INCLUDE := $(MTK_PATH_SOURCE)/hardware/mtkcam/include/algorithm/$(COMMON_TGT_BD_PLATFORM)

ifeq ($(MTKCAM_AAA_PLATFORM), isp_40)
    LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_COMMON_PATH)/flash_mgr
else
    LOCAL_EXPORT_C_INCLUDE_DIRS += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/$(SPECIFIC_TGT_BD_PLATFORM)/flash_mgr
endif

LOCAL_MODULE := lib3a_mt6757p_cct_headers
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/drv/src/sensor/$(SPECIFIC_TGT_BD_PLATFORM)
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/drv/src/isp/$(SPECIFIC_TGT_BD_PLATFORM)/tuning/drv
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/drv/src/sensor/$(COMMON_TGT_BD_PLATFORM)
#
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_3a/libaf_core_lib/$(COMMON_TGT_BD_PLATFORM)/include
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_3a/libawb_core_lib/$(COMMON_TGT_BD_PLATFORM)/include
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_3a/libflash_lib/$(COMMON_TGT_BD_PLATFORM)/include
...
#
LOCAL_HEADER_LIBRARIES += lib3a_mt6757p_cct_headers
#
