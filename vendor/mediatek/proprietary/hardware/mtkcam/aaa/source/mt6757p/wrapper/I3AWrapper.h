...
public:
    ...
    static I3AWrapper*  createInstance(E_TYPE_T eType, MINT32 const i4SensorOpenIndex, MINT32 i4SubsampleCount = 1);
    virtual MVOID       destroyInstance() = 0;
    virtual MINT32      config() = 0;
    ...
    virtual MVOID       setIspSensorInfo2AF(ISP_SENSOR_INFO_T& rIspSensorInfo) = 0;
    ...
    virtual MINT32      getCurrResult(MUINT32 i4FrmId, Result_T& rResult, MINT32 i4SubsampleIndex = 0) const = 0;
    ...
    virtual MUINT32     queryMagicNumber() const = 0;
    ...
    virtual MBOOL       dumpP1Params(MUINT32 u4MagicNum) = 0;
    ...
    virtual MBOOL       notifyResult4TG(MINT32 i4PreFrmId, Result_T *rPreResult) = 0;
    virtual MBOOL       notify4CCU(MUINT32 u4PreFrmId, Result_T *rPreResult) = 0;
protected:  //    Ctor/Dtor.
                        I3AWrapper(){}
    virtual             ~I3AWrapper(){}
