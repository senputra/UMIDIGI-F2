...
public:
    //
    static Hal3AIf*     createInstance(MINT32 const i4SensorOpenIndex, MINT32 i4SubsampleCount);
...
protected:  //    Ctor/Dtor.
    ...
    virtual MRESULT     init(MINT32 i4SensorDevId, MINT32 i4SensorOpenIndex, MINT32 i4SubsampleCount);
    virtual MRESULT     uninit();
    virtual MBOOL       doUpdateCmdDummy();
    virtual MVOID       on3AProcFinish(const RequestSet_T rRequestSet, MUINT32 u4MagicNumCur);
    virtual MVOID       updateResult(MUINT32 u4MagicNum, MINT32 i4SubsampleCount);
...
class Hal3AFlowCtrl_SMVR_Dev : public Hal3AFlowCtrl_SMVR
{
public:
    static Hal3AFlowCtrl_SMVR_Dev* getInstance()
    {
        static Hal3AFlowCtrl_SMVR_Dev<sensorDev> singleton;
        return &singleton;
    }
    Hal3AFlowCtrl_SMVR_Dev()
        : Hal3AFlowCtrl_SMVR()
    {
    }
