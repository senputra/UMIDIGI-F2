...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    case ESensorDev_SubSecond: //  Sub 2 Sensor
        return  ISP_MGR_SL2F_DEV<ESensorDev_SubSecond>::getInstance();
    default:
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    case ESensorDev_SubSecond: //  Sub 2 Sensor
        return  ISP_MGR_SL2G_DEV<ESensorDev_SubSecond>::getInstance();
    default:
        CAM_LOGE("eSensorDev = %d", eSensorDev);
        return  ISP_MGR_SL2G_DEV<ESensorDev_Main>::getInstance();
    }
