...
class ISP_MGR_RMG_DEV : public ISP_MGR_RMG_T
{
public:
    static
    ISP_MGR_RMG_T&
    getInstance()
    {
        static ISP_MGR_RMG_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_RMG_DEV()
        : ISP_MGR_RMG_T(eSensorDev)
    {}

    virtual ~ISP_MGR_RMG_DEV() {}
...
template <ESensorDev_T const eSensorDev>
class ISP_MGR_RMG2_DEV : public ISP_MGR_RMG2_T
{
public:
    static
    ISP_MGR_RMG2_T&
    getInstance()
    {
        static ISP_MGR_RMG2_DEV<eSensorDev> singleton;
        return singleton;
    }
    virtual MVOID destroyInstance() {}

    ISP_MGR_RMG2_DEV()
        : ISP_MGR_RMG2_T(eSensorDev)
    {}

    virtual ~ISP_MGR_RMG2_DEV() {}
