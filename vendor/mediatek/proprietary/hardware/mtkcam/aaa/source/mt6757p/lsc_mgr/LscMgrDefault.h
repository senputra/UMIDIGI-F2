...
public:
    ...
    virtual MBOOL                   syncBufAndRatio(ILscBuf** pBuf, MUINT32 ratio, E_LSC_MODULE_T eModu=LSC_P1){return MFALSE;}
...
//    virtual MBOOL                   writeNvramTbl(void);
    ...
    virtual MBOOL                   getGainTable(MUINT32 gridPointNum, MINT32 i4MagicNum, std::vector<MUINT16*> &vecGain) const {return MFALSE;}
...
//    virtual MINT32                  setCoefTable(const MUINT32* pCoefTbl);
    ...
    virtual MBOOL                   config(NS3Av3::shadingConfig_T rConfig) { return true;};
...
protected:
    ...
    struct SENSOR_RESOLUTION_INFO_T {
        ...
        SENSOR_RESOLUTION_INFO_T()
            : u4SensorPreviewWidth(0)
            , u4SensorPreviewHeight(0)
            , u4SensorCaptureWidth(0)
            , u4SensorCaptureHeight(0)
            , u4SensorVideoWidth(0)
            , u4SensorVideoHeight(0)
            , u4SensorVideo1Width(0)
            , u4SensorVideo1Height(0)
            , u4SensorVideo2Width(0)
            , u4SensorVideo2Height(0)
            , u4SensorCustom1Width(0)
            , u4SensorCustom1Height(0)
            , u4SensorCustom2Width(0)
            , u4SensorCustom2Height(0)
            , u4SensorCustom3Width(0)
            , u4SensorCustom3Height(0)
            , u4SensorCustom4Width(0)
            , u4SensorCustom4Height(0)
            , u4SensorCustom5Width(0)
            , u4SensorCustom5Height(0)
        {}
    };
