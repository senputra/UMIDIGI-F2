...
$(warning "MTK_PATH_COMMON:$(MTK_PATH_COMMON)")
$(warning "MTK_PATH_CUSTOM:$(MTK_PATH_CUSTOM)")
...
LOCAL_C_INCLUDES += \
    ...
    $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/ver2 \
    $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc \
    $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/aaa/ver2 \
...
LOCAL_SHARED_LIBRARIES += libpixelflinger liblog
