...
public:
    ...
    /**
     * @brief config pdo hw, need to be called after start and setPDCaliData
     */
    MRESULT configPdoHW();
    /**
     * @brief start pd mgr.
     */
    EPDBuf_Type_t start(MINT32 i4SensorIdx, SPDProfile_t *iPDProfile, MUINT32 uPdPipeCtrl);
     ...
     */
    MRESULT setPDCaliData( MVOID *ptrInTuningData, MVOID *ptrInCaliData, MINT32 &i4OutInfoSz, MINT32 **ptrOutInfo);
    /**
