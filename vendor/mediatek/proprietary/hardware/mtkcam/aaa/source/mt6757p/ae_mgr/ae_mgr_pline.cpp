...
MRESULT AeMgr::setAEMinMaxFrameRatePlineIdx(MINT32 a_eAEMinFrameRate, MINT32 a_eAEMaxFrameRate)
{
    ...
    AE_LOG("[setAEMinMaxFrameRatePlineIdx:s] m_u4FinerEVIdxBase: %d MaxFps/MaxIdx/MinIdx/Idx/MaxIdxF/MinIdxF/IdxF/Fps :%d/%d/%d/%d/%d/%d/%d/%d \n", m_u4FinerEVIdxBase, a_eAEMaxFrameRate, m_u4IndexMax, m_u4IndexMin, m_u4Index, m_u4IndexFMax, m_u4IndexFMin, m_u4IndexF, i4fps);
...
{
    AE_LOG("[updateAEidxtoExpsetting:s] m_u4Index/m_u4IndexF/m_i4DeltaSensitivityIdx/m_i4DeltaBVIdx : %d/%d/%d/%d\n", m_u4Index, m_u4IndexF, m_i4DeltaSensitivityIdx, m_i4DeltaBVIdx);
