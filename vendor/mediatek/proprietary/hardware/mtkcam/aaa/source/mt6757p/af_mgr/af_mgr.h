...
public:
    ...
    /**
     * @Brief :
     *          get AF status is enable or not.
     * @Param :
     *          [ in] NA
     * @Return:
     *          [out] return af_mgr AF enable status
     */
    MINT32  isAFEnable();
     ...
     *          [out] Status
     */
    MBOOL sendAFCtrl(MUINT32 eAFCtrl, MINTPTR iArg1, MINTPTR iArg2);
...
private :
    ...
    MINT32  m_i4ThermalLensPos;
    MINT32  m_i4IsSMVR;
    MINT32  m_i4AFMaxAreaNum;
    MINT32  m_i4PostureDac;
