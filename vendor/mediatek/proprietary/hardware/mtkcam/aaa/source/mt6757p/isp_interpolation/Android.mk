...
LOCAL_C_INCLUDES += \
    ...
    $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/aaa/$(MTK_CAM_SW_VERSION) \
    $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/isp_tuning \
    $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/isp_tuning/$(MTK_CAM_SW_VERSION) \
    $(MTK_PATH_COMMON)/kernel/imgsensor/inc \
    $(MTK_PATH_SOURCE)/hardware/mtkcam/include \
    $(MTK_PATH_SOURCE)/hardware/libcamera_feature/libispfeature_lib/$(PLATFORM)/include/$(MTK_CAM_SW_VERSION) \
