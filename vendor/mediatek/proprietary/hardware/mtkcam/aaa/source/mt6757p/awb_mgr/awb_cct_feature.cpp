...
)
{
    ...
    ISP_MGR_RPG_T::getInstance(m_eSensorDev).setIspAWBGain(m_rAWBOutput.rPreviewAWBGain);
...
)
{
    ...
    memcpy(a_pAWBNVRAM, m_pNVRAM_3A->rAWBNVRAM, sizeof(AWB_NVRAM_T)*CAM_SCENARIO_NUM);
