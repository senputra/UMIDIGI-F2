...
doUpdate()
{
    ...
    CAM_LOGD_IF(m_i4EnableLog
            , "[StateCameraPreview::doUpdate()] Sensor(%d), bSyncEnable(%d), i4AfState(%d), frameCnt(%d), isPerframeAE(%d)"
            , m_SensorDevId, bSyncEnable, i4AfState, i4FrmCount, pSync3A->isPerframeAE());
