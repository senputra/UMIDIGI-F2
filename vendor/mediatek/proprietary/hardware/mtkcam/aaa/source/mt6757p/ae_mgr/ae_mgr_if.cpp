...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL IAeMgr::checkCCUWorkingStatus(MINT32 i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        return AeMgr::getInstance(ESensorDev_Main).checkCCUWorkingStatus();
    if (i4SensorDev & ESensorDev_Sub)
        return AeMgr::getInstance(ESensorDev_Sub).checkCCUWorkingStatus();
    if (i4SensorDev & ESensorDev_MainSecond)
        return AeMgr::getInstance(ESensorDev_MainSecond).checkCCUWorkingStatus();
    if (i4SensorDev & ESensorDev_SubSecond)
        return AeMgr::getInstance(ESensorDev_SubSecond).checkCCUWorkingStatus();
