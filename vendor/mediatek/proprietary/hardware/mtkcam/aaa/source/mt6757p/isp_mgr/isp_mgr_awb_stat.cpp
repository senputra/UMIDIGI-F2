...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    case ESensorDev_SubSecond: //  Sub Sensor
        return  ISP_MGR_AWB_STAT_CONFIG_DEV<ESensorDev_SubSecond>::getInstance();
    default:
...
{
#if 0
    CAM_LOGD("exrAWBStatConfig.i4WindowOriginX = %d", (int)rAWBStatConfig.i4WindowOriginX);
CAM_LOGD("exrAWBStatConfig.i4WindowOriginY = %d", (int)rAWBStatConfig.i4WindowOriginY);
CAM_LOGD("exrAWBStatConfig.i4WindowSizeX = %d", (int)rAWBStatConfig.i4WindowSizeX);
CAM_LOGD("exrAWBStatConfig.i4WindowSizeY = %d", (int)rAWBStatConfig.i4WindowSizeY);
CAM_LOGD("exrAWBStatConfig.i4WindowPitchX = %d", (int)rAWBStatConfig.i4WindowPitchX);
CAM_LOGD("exrAWBStatConfig.i4WindowPitchY = %d", (int)rAWBStatConfig.i4WindowPitchY);
CAM_LOGD("exrAWBStatConfig.i4WindowNumX = %d", (int)rAWBStatConfig.i4WindowNumX);
CAM_LOGD("exrAWBStatConfig.i4WindowNumY = %d", (int)rAWBStatConfig.i4WindowNumY);
CAM_LOGD("exrAWBStatConfig.i4PreGainR = %d", (int)rAWBStatConfig.i4PreGainR);
CAM_LOGD("exrAWBStatConfig.i4PreGainG = %d", (int)rAWBStatConfig.i4PreGainG);
CAM_LOGD("exrAWBStatConfig.i4PreGainB = %d", (int)rAWBStatConfig.i4PreGainB);
CAM_LOGD("exrAWBStatConfig.i4PreGainLimitR = %d", (int)rAWBStatConfig.i4PreGainLimitR);
CAM_LOGD("exrAWBStatConfig.i4PreGainLimitG = %d", (int)rAWBStatConfig.i4PreGainLimitG);
CAM_LOGD("exrAWBStatConfig.i4PreGainLimitB = %d", (int)rAWBStatConfig.i4PreGainLimitB);
CAM_LOGD("exrAWBStatConfig.i4LowThresholdR = %d", (int)rAWBStatConfig.i4LowThresholdR);
CAM_LOGD("exrAWBStatConfig.i4LowThresholdG = %d", (int)rAWBStatConfig.i4LowThresholdG);
CAM_LOGD("exrAWBStatConfig.i4LowThresholdB = %d", (int)rAWBStatConfig.i4LowThresholdB);
CAM_LOGD("exrAWBStatConfig.i4HighThresholdR = %d", (int)rAWBStatConfig.i4HighThresholdR);
CAM_LOGD("exrAWBStatConfig.i4HighThresholdG = %d", (int)rAWBStatConfig.i4HighThresholdG);
CAM_LOGD("exrAWBStatConfig.i4HighThresholdB = %d", (int)rAWBStatConfig.i4HighThresholdB);
CAM_LOGD("exrAWBStatConfig.i4PixelCountR = %d", (int)rAWBStatConfig.i4PixelCountR);
CAM_LOGD("exrAWBStatConfig.i4PixelCountG = %d", (int)rAWBStatConfig.i4PixelCountG);
CAM_LOGD("exrAWBStatConfig.i4PixelCountB = %d", (int)rAWBStatConfig.i4PixelCountB);
CAM_LOGD("exrAWBStatConfig.i4ErrorThreshold = %d", (int)rAWBStatConfig.i4ErrorThreshold);
CAM_LOGD("exrAWBStatConfig.i4ErrorShiftBits = %d", (int)rAWBStatConfig.i4ErrorShiftBits);
CAM_LOGD("exrAWBStatConfig.i4Cos = %d", (int)rAWBStatConfig.i4Cos);
CAM_LOGD("exrAWBStatConfig.i4Sin = %d", (int)rAWBStatConfig.i4Sin);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINL[0] = %d", (int)rAWBStatConfig.i4AWBXY_WINL[0]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINR[0] = %d", (int)rAWBStatConfig.i4AWBXY_WINR[0]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIND[0] = %d", (int)rAWBStatConfig.i4AWBXY_WIND[0]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINU[0] = %d", (int)rAWBStatConfig.i4AWBXY_WINU[0]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINL[1] = %d", (int)rAWBStatConfig.i4AWBXY_WINL[1]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINR[1] = %d", (int)rAWBStatConfig.i4AWBXY_WINR[1]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIND[1] = %d", (int)rAWBStatConfig.i4AWBXY_WIND[1]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINU[1] = %d", (int)rAWBStatConfig.i4AWBXY_WINU[1]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINL[2] = %d", (int)rAWBStatConfig.i4AWBXY_WINL[2]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINR[2] = %d", (int)rAWBStatConfig.i4AWBXY_WINR[2]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIND[2] = %d", (int)rAWBStatConfig.i4AWBXY_WIND[2]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINU[2] = %d", (int)rAWBStatConfig.i4AWBXY_WINU[2]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINL[3] = %d", (int)rAWBStatConfig.i4AWBXY_WINL[3]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINR[3] = %d", (int)rAWBStatConfig.i4AWBXY_WINR[3]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIND[3] = %d", (int)rAWBStatConfig.i4AWBXY_WIND[3]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINU[3] = %d", (int)rAWBStatConfig.i4AWBXY_WINU[3]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINL[4] = %d", (int)rAWBStatConfig.i4AWBXY_WINL[4]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINR[4] = %d", (int)rAWBStatConfig.i4AWBXY_WINR[4]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIND[4] = %d", (int)rAWBStatConfig.i4AWBXY_WIND[4]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINU[4] = %d", (int)rAWBStatConfig.i4AWBXY_WINU[4]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINL[5] = %d", (int)rAWBStatConfig.i4AWBXY_WINL[5]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINR[5] = %d", (int)rAWBStatConfig.i4AWBXY_WINR[5]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIND[5] = %d", (int)rAWBStatConfig.i4AWBXY_WIND[5]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINU[5] = %d", (int)rAWBStatConfig.i4AWBXY_WINU[5]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINL[6] = %d", (int)rAWBStatConfig.i4AWBXY_WINL[6]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINR[6] = %d", (int)rAWBStatConfig.i4AWBXY_WINR[6]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIND[6] = %d", (int)rAWBStatConfig.i4AWBXY_WIND[6]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINU[6] = %d", (int)rAWBStatConfig.i4AWBXY_WINU[6]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINL[7] = %d", (int)rAWBStatConfig.i4AWBXY_WINL[7]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINR[7] = %d", (int)rAWBStatConfig.i4AWBXY_WINR[7]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIND[7] = %d", (int)rAWBStatConfig.i4AWBXY_WIND[7]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINU[7] = %d", (int)rAWBStatConfig.i4AWBXY_WINU[7]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINL[8] = %d", (int)rAWBStatConfig.i4AWBXY_WINL[8]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINR[8] = %d", (int)rAWBStatConfig.i4AWBXY_WINR[8]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIND[8] = %d", (int)rAWBStatConfig.i4AWBXY_WIND[8]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINU[8] = %d", (int)rAWBStatConfig.i4AWBXY_WINU[8]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINL[9] = %d", (int)rAWBStatConfig.i4AWBXY_WINL[9]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINR[9] = %d", (int)rAWBStatConfig.i4AWBXY_WINR[9]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WIND[9] = %d", (int)rAWBStatConfig.i4AWBXY_WIND[9]);
CAM_LOGD("exrAWBStatConfig.i4AWBXY_WINU[9] = %d", (int)rAWBStatConfig.i4AWBXY_WINU[9]);
#endif
#if 0 //
...
/*
    ...
    CAM_LOGD("[configAAO_AWB] PitchW/PitchH = %d/%d , SizeW/SizeH = %d/%d , OriginX/OriginY = %d/%d", PitchW,PitchH, SizeW,SizeH,OriginX,OriginY);
    ...
    CAM_LOGD("[configAAO_AWB] i4WindowPixelNumR/G/B = %d/%d/%d , i4PixelCountR/G/B = %d/%d/%d",
...
*/
        ...
        REG_INFO_VALUE(CAM_AWB_GAIN1_1) = (MUINT32)AwbGain11.Raw;
            m_rIspAWBPreGain1.i4R = rAWBStatConfig.i4PreGainR;
            m_rIspAWBPreGain1.i4G = rAWBStatConfig.i4PreGainG;
            m_rIspAWBPreGain1.i4B = rAWBStatConfig.i4PreGainB;
        }

        // CAM_AWB_LMT1_0
        CAM_REG_AWB_LMT1_0 AwbLmt10;
        AwbLmt10.Bits.AWB_LMT1_R = rAWBStatConfig.i4PreGainLimitR;//0xFFF;
        AwbLmt10.Bits.AWB_LMT1_G = rAWBStatConfig.i4PreGainLimitG;//0xFFF;
        ...
        AwbLmt11.Bits.AWB_LMT1_B = rAWBStatConfig.i4PreGainLimitB;//0xFFF;
...
#define RWB_CFG(BOUND)  (BOUND>=0 ? BOUND: (1 << 12) + BOUND)
   ...
   for (int i = 0; i < 9 ; i++)
   CAM_LOGD("rCscCCM %d = %x", i, rCscCCM[i]);
...
MBOOL
ISP_MGR_AWB_STAT_CONFIG_T::
setIspAWBPreGain1(AWB_GAIN_T& rIspAWBGain, bool bLockIspAWBPreGain1)
{
    // CAM_AWB_GAIN1_0
    reinterpret_cast<ISP_CAM_AWB_GAIN1_0_T*>(REG_INFO_VALUE_PTR(CAM_AWB_GAIN1_0))->AWB_GAIN1_R = rIspAWBGain.i4R;
    reinterpret_cast<ISP_CAM_AWB_GAIN1_0_T*>(REG_INFO_VALUE_PTR(CAM_AWB_GAIN1_0))->AWB_GAIN1_G = rIspAWBGain.i4G;
    // CAM_AWB_GAIN1_1
    reinterpret_cast<ISP_CAM_AWB_GAIN1_1_T*>(REG_INFO_VALUE_PTR(CAM_AWB_GAIN1_1))->AWB_GAIN1_B = rIspAWBGain.i4B;

    m_bLockIspAWBPreGain1 = bLockIspAWBPreGain1;
