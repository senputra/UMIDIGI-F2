...
apply(EIspProfile_T eIspProfile, dip_x_reg_t* pReg)
{
   ...
   reinterpret_cast<ISP_DIP_X_ANR2_CON1_T*>(REG_INFO_VALUE_PTR(DIP_X_ANR2_CON1))->ANR2_ENY = bANR2_ENC;
   reinterpret_cast<ISP_DIP_X_ANR2_CON1_T*>(REG_INFO_VALUE_PTR(DIP_X_ANR2_CON1))->ANR2_ENC = bANR2_ENY;
