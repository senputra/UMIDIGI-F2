                ...
                ISP_NVRAM_BNR_BPC_T& rSmoothBPC)   // Output
{
    ...
    INTER_LOG_IF(bSmoothBPCDebug, "[L,S,U]BPC_XSIZE           = %d, %d, %d", rLowerBPC.tbli2.bits.BPC_XSIZE, rSmoothBPC.tbli2.bits.BPC_XSIZE, rUpperBPC.tbli2.bits.BPC_XSIZE);
    INTER_LOG_IF(bSmoothBPCDebug, "[L,S,U]BPC_YSIZE           = %d, %d, %d", rLowerBPC.tbli2.bits.BPC_YSIZE, rSmoothBPC.tbli2.bits.BPC_YSIZE, rUpperBPC.tbli2.bits.BPC_YSIZE);
                ...
                ISP_NVRAM_UDM_T& rSmoothUDM)   // Output
{
	...
	INTER_LOG_IF(bSmoothUDMDebug,"[%s()] u4RealZoom: %f, u4UpperZoom = %f, u4LowerZoom = %f\n", __FUNCTION__, fRealZoom, fUpperZoom, fLowerZoom);
               ...
               ISP_NVRAM_ANR_T& rSmoothANR)
{
	...
	INTER_LOG_IF(bSmoothANRDebug,"[%s()] u4RealZoom: %f, u4UpperZoom = %f, u4LowerZoom = %f\n", __FUNCTION__, fRealZoom, fUpperZoom, fLowerZoom);
	...
	MINT32 ANR_MEDIAN_EN_L_L	 = rParam.rLowerIso_LowerZoom.con1.bits.ANR_MEDIAN_EN;
	...
	MINT32 ANR_C_MED_EN_L_L 	 = rParam.rLowerIso_LowerZoom.con2.bits.ANR_C_MED_EN;
	...
	// CAM_ANR_MED1
	MINT32 ANR_COR_TH_L_L		 = rParam.rLowerIso_LowerZoom.med1.bits.ANR_COR_TH;
	MINT32 ANR_COR_SL_L_L		 = rParam.rLowerIso_LowerZoom.med1.bits.ANR_COR_SL;
	MINT32 ANR_MCD_TH_L_L		 = rParam.rLowerIso_LowerZoom.med1.bits.ANR_MCD_TH;
	MINT32 ANR_MCD_SL_L_L		 = rParam.rLowerIso_LowerZoom.med1.bits.ANR_MCD_SL;
	MINT32 ANR_LCL_TH_L_L		 = rParam.rLowerIso_LowerZoom.med1.bits.ANR_LCL_TH;

	// CAM_ANR_MED2
	MINT32 ANR_LCL_SL_L_L		 = rParam.rLowerIso_LowerZoom.med2.bits.ANR_LCL_SL;
	MINT32 ANR_LCL_LV_L_L		 = rParam.rLowerIso_LowerZoom.med2.bits.ANR_LCL_LV;
	MINT32 ANR_SCL_TH_L_L		 = rParam.rLowerIso_LowerZoom.med2.bits.ANR_SCL_TH;
	MINT32 ANR_SCL_SL_L_L		 = rParam.rLowerIso_LowerZoom.med2.bits.ANR_SCL_SL;
	MINT32 ANR_SCL_LV_L_L		 = rParam.rLowerIso_LowerZoom.med2.bits.ANR_SCL_LV;

	// CAM_ANR_MED3
	MINT32 ANR_NCL_TH_L_L		 = rParam.rLowerIso_LowerZoom.med3.bits.ANR_NCL_TH;
	MINT32 ANR_NCL_SL_L_L		 = rParam.rLowerIso_LowerZoom.med3.bits.ANR_NCL_SL;
	MINT32 ANR_NCL_LV_L_L		 = rParam.rLowerIso_LowerZoom.med3.bits.ANR_NCL_LV;
	MINT32 ANR_VAR_L_L			 = rParam.rLowerIso_LowerZoom.med3.bits.ANR_VAR;
	MINT32 ANR_Y0_L_L			 = rParam.rLowerIso_LowerZoom.med3.bits.ANR_Y0;

	// CAM_ANR_MED4
	MINT32 ANR_Y1_L_L			 = rParam.rLowerIso_LowerZoom.med4.bits.ANR_Y1;
	MINT32 ANR_Y2_L_L			 = rParam.rLowerIso_LowerZoom.med4.bits.ANR_Y2;
	MINT32 ANR_Y3_L_L			 = rParam.rLowerIso_LowerZoom.med4.bits.ANR_Y3;
	MINT32 ANR_Y4_L_L			 = rParam.rLowerIso_LowerZoom.med4.bits.ANR_Y4;

	// CAM_ANR_MED5
	MINT32 ANR_LCL_OFT_L_L			 = rParam.rLowerIso_LowerZoom.med5.bits.ANR_LCL_OFT;
	MINT32 ANR_SCL_OFT_L_L			 = rParam.rLowerIso_LowerZoom.med5.bits.ANR_SCL_OFT;
	MINT32 ANR_NCL_OFT_L_L			 = rParam.rLowerIso_LowerZoom.med5.bits.ANR_NCL_OFT;

	// CAM_ANR_HP1 CAM+A54H
	MINT32 ANR_HP_A_L_L 		 = rParam.rLowerIso_LowerZoom.hp1.bits.ANR_HP_A;
	MINT32 ANR_HP_B_L_L 		 = rParam.rLowerIso_LowerZoom.hp1.bits.ANR_HP_B;
	MINT32 ANR_HP_C_L_L 		 = rParam.rLowerIso_LowerZoom.hp1.bits.ANR_HP_C;
	MINT32 ANR_HP_D_L_L 		 = rParam.rLowerIso_LowerZoom.hp1.bits.ANR_HP_D;
	MINT32 ANR_HP_E_L_L 		 = rParam.rLowerIso_LowerZoom.hp1.bits.ANR_HP_E;

	// CAM_ANR_HP2 CAM+A58H
	MINT32 ANR_HP_S1_L_L		 = rParam.rLowerIso_LowerZoom.hp2.bits.ANR_HP_S1;
	MINT32 ANR_HP_S2_L_L		 = rParam.rLowerIso_LowerZoom.hp2.bits.ANR_HP_S2;
	MINT32 ANR_HP_X1_L_L		 = rParam.rLowerIso_LowerZoom.hp2.bits.ANR_HP_X1;
	MINT32 ANR_HP_F_L_L 		 = rParam.rLowerIso_LowerZoom.hp2.bits.ANR_HP_F;

	// CAM_ANR_HP3 CAM+A5CH
	MINT32 ANR_HP_Y_GAIN_CLIP_L_L= rParam.rLowerIso_LowerZoom.hp3.bits.ANR_HP_Y_GAIN_CLIP;
	MINT32 ANR_HP_Y_SP_L_L		 = rParam.rLowerIso_LowerZoom.hp3.bits.ANR_HP_Y_SP;
	MINT32 ANR_HP_Y_LO_L_L		 = rParam.rLowerIso_LowerZoom.hp3.bits.ANR_HP_Y_LO;
	MINT32 ANR_HP_CLIP_L_L		 = rParam.rLowerIso_LowerZoom.hp3.bits.ANR_HP_CLIP;

	// CAM_ANR_ACT1 CAM+A64H
	MINT32 ANR_ACT_LCE_GAIN_L_L  = rParam.rLowerIso_LowerZoom.act1.bits.ANR_ACT_LCE_GAIN;
	MINT32 ANR_ACT_SCALE_OFT_L_L = rParam.rLowerIso_LowerZoom.act1.bits.ANR_ACT_SCALE_OFT;
	MINT32 ANR_ACT_SCALE_GAIN_L_L= rParam.rLowerIso_LowerZoom.act1.bits.ANR_ACT_SCALE_GAIN;
	...
	MINT32 ANR_COR_TH1_L_L		 = rParam.rLowerIso_LowerZoom.act2.bits.ANR_COR_TH1;
	MINT32 ANR_COR_SL1_L_L		 = rParam.rLowerIso_LowerZoom.act2.bits.ANR_COR_SL1;

	// CAM_ANR_ACT3 CAM+A64H
	MINT32 ANR_COR_ACT_TH_L_L	 = rParam.rLowerIso_LowerZoom.act3.bits.ANR_COR_ACT_TH;
	MINT32 ANR_COR_ACT_SL1_L_L	 = rParam.rLowerIso_LowerZoom.act3.bits.ANR_COR_ACT_SL1;
	MINT32 ANR_COR_ACT_SL2_L_L	 = rParam.rLowerIso_LowerZoom.act3.bits.ANR_COR_ACT_SL2;

	// CAM_ANR_ACTC CAM+A64H
	MINT32 ANR_ACT_TH_C_L_L 	 = rParam.rLowerIso_LowerZoom.actc.bits.ANR_ACT_TH_C;
	MINT32 ANR_ACT_BLD_BASE_C_L_L= rParam.rLowerIso_LowerZoom.actc.bits.ANR_ACT_BLD_BASE_C;
	MINT32 ANR_ACT_SLANT_C_L_L	 = rParam.rLowerIso_LowerZoom.actc.bits.ANR_ACT_SLANT_C;
	MINT32 ANR_ACT_BLD_TH_C_L_L  = rParam.rLowerIso_LowerZoom.actc.bits.ANR_ACT_BLD_TH_C;
	...
	MINT32 ANR_MEDIAN_EN_L_U	 = rParam.rLowerIso_UpperZoom.con1.bits.ANR_MEDIAN_EN;
	...
	MINT32 ANR_C_MED_EN_L_U 	 = rParam.rLowerIso_UpperZoom.con2.bits.ANR_C_MED_EN;
	...
	// CAM_ANR_MED1
	MINT32 ANR_COR_TH_L_U		 = rParam.rLowerIso_UpperZoom.med1.bits.ANR_COR_TH;
	MINT32 ANR_COR_SL_L_U		 = rParam.rLowerIso_UpperZoom.med1.bits.ANR_COR_SL;
	MINT32 ANR_MCD_TH_L_U		 = rParam.rLowerIso_UpperZoom.med1.bits.ANR_MCD_TH;
	MINT32 ANR_MCD_SL_L_U		 = rParam.rLowerIso_UpperZoom.med1.bits.ANR_MCD_SL;
	MINT32 ANR_LCL_TH_L_U		 = rParam.rLowerIso_UpperZoom.med1.bits.ANR_LCL_TH;

	// CAM_ANR_MED2
	MINT32 ANR_LCL_SL_L_U		 = rParam.rLowerIso_UpperZoom.med2.bits.ANR_LCL_SL;
	MINT32 ANR_LCL_LV_L_U		 = rParam.rLowerIso_UpperZoom.med2.bits.ANR_LCL_LV;
	MINT32 ANR_SCL_TH_L_U		 = rParam.rLowerIso_UpperZoom.med2.bits.ANR_SCL_TH;
	MINT32 ANR_SCL_SL_L_U		 = rParam.rLowerIso_UpperZoom.med2.bits.ANR_SCL_SL;
	MINT32 ANR_SCL_LV_L_U		 = rParam.rLowerIso_UpperZoom.med2.bits.ANR_SCL_LV;

	// CAM_ANR_MED3
	MINT32 ANR_NCL_TH_L_U		 = rParam.rLowerIso_UpperZoom.med3.bits.ANR_NCL_TH;
	MINT32 ANR_NCL_SL_L_U		 = rParam.rLowerIso_UpperZoom.med3.bits.ANR_NCL_SL;
	MINT32 ANR_NCL_LV_L_U		 = rParam.rLowerIso_UpperZoom.med3.bits.ANR_NCL_LV;
	MINT32 ANR_VAR_L_U			 = rParam.rLowerIso_UpperZoom.med3.bits.ANR_VAR;
	MINT32 ANR_Y0_L_U			 = rParam.rLowerIso_UpperZoom.med3.bits.ANR_Y0;

	// CAM_ANR_MED4
	MINT32 ANR_Y1_L_U			 = rParam.rLowerIso_UpperZoom.med4.bits.ANR_Y1;
	MINT32 ANR_Y2_L_U			 = rParam.rLowerIso_UpperZoom.med4.bits.ANR_Y2;
	MINT32 ANR_Y3_L_U			 = rParam.rLowerIso_UpperZoom.med4.bits.ANR_Y3;
	MINT32 ANR_Y4_L_U			 = rParam.rLowerIso_UpperZoom.med4.bits.ANR_Y4;

	// CAM_ANR_MED5
	MINT32 ANR_LCL_OFT_L_U			 = rParam.rLowerIso_UpperZoom.med5.bits.ANR_LCL_OFT;
	MINT32 ANR_SCL_OFT_L_U			 = rParam.rLowerIso_UpperZoom.med5.bits.ANR_SCL_OFT;
	MINT32 ANR_NCL_OFT_L_U			 = rParam.rLowerIso_UpperZoom.med5.bits.ANR_NCL_OFT;

	// CAM_ANR_HP1 CAM+A54H
	MINT32 ANR_HP_A_L_U 		 = rParam.rLowerIso_UpperZoom.hp1.bits.ANR_HP_A;
	MINT32 ANR_HP_B_L_U 		 = rParam.rLowerIso_UpperZoom.hp1.bits.ANR_HP_B;
	MINT32 ANR_HP_C_L_U 		 = rParam.rLowerIso_UpperZoom.hp1.bits.ANR_HP_C;
	MINT32 ANR_HP_D_L_U 		 = rParam.rLowerIso_UpperZoom.hp1.bits.ANR_HP_D;
	MINT32 ANR_HP_E_L_U 		 = rParam.rLowerIso_UpperZoom.hp1.bits.ANR_HP_E;

	// CAM_ANR_HP2 CAM+A58H
	MINT32 ANR_HP_S1_L_U		 = rParam.rLowerIso_UpperZoom.hp2.bits.ANR_HP_S1;
	MINT32 ANR_HP_S2_L_U		 = rParam.rLowerIso_UpperZoom.hp2.bits.ANR_HP_S2;
	MINT32 ANR_HP_X1_L_U		 = rParam.rLowerIso_UpperZoom.hp2.bits.ANR_HP_X1;
	MINT32 ANR_HP_F_L_U 		 = rParam.rLowerIso_UpperZoom.hp2.bits.ANR_HP_F;

	// CAM_ANR_HP3 CAM+A5CH
	MINT32 ANR_HP_Y_GAIN_CLIP_L_U= rParam.rLowerIso_UpperZoom.hp3.bits.ANR_HP_Y_GAIN_CLIP;
	MINT32 ANR_HP_Y_SP_L_U		 = rParam.rLowerIso_UpperZoom.hp3.bits.ANR_HP_Y_SP;
	MINT32 ANR_HP_Y_LO_L_U		 = rParam.rLowerIso_UpperZoom.hp3.bits.ANR_HP_Y_LO;
	MINT32 ANR_HP_CLIP_L_U		 = rParam.rLowerIso_UpperZoom.hp3.bits.ANR_HP_CLIP;

	// CAM_ANR_ACT1 CAM+A64H
	MINT32 ANR_ACT_LCE_GAIN_L_U  = rParam.rLowerIso_UpperZoom.act1.bits.ANR_ACT_LCE_GAIN;
	MINT32 ANR_ACT_SCALE_OFT_L_U = rParam.rLowerIso_UpperZoom.act1.bits.ANR_ACT_SCALE_OFT;
	MINT32 ANR_ACT_SCALE_GAIN_L_U= rParam.rLowerIso_UpperZoom.act1.bits.ANR_ACT_SCALE_GAIN;
	...
	MINT32 ANR_COR_TH1_L_U		 = rParam.rLowerIso_UpperZoom.act2.bits.ANR_COR_TH1;
	MINT32 ANR_COR_SL1_L_U		 = rParam.rLowerIso_UpperZoom.act2.bits.ANR_COR_SL1;

	// CAM_ANR_ACT3 CAM+A64H
	MINT32 ANR_COR_ACT_TH_L_U	 = rParam.rLowerIso_UpperZoom.act3.bits.ANR_COR_ACT_TH;
	MINT32 ANR_COR_ACT_SL1_L_U	 = rParam.rLowerIso_UpperZoom.act3.bits.ANR_COR_ACT_SL1;
	MINT32 ANR_COR_ACT_SL2_L_U	 = rParam.rLowerIso_UpperZoom.act3.bits.ANR_COR_ACT_SL2;

	// CAM_ANR_ACTC CAM+A64H
	MINT32 ANR_ACT_TH_C_L_U 	 = rParam.rLowerIso_UpperZoom.actc.bits.ANR_ACT_TH_C;
	MINT32 ANR_ACT_BLD_BASE_C_L_U= rParam.rLowerIso_UpperZoom.actc.bits.ANR_ACT_BLD_BASE_C;
	MINT32 ANR_ACT_SLANT_C_L_U	 = rParam.rLowerIso_UpperZoom.actc.bits.ANR_ACT_SLANT_C;
	MINT32 ANR_ACT_BLD_TH_C_L_U  = rParam.rLowerIso_UpperZoom.actc.bits.ANR_ACT_BLD_TH_C;
	...
	MINT32 ANR_MEDIAN_EN_U_L	 = rParam.rUpperIso_LowerZoom.con1.bits.ANR_MEDIAN_EN;
	...
	MINT32 ANR_C_MED_EN_U_L 	 = rParam.rUpperIso_LowerZoom.con2.bits.ANR_C_MED_EN;
	...
	// CAM_ANR_MED1
	MINT32 ANR_COR_TH_U_L		 = rParam.rUpperIso_LowerZoom.med1.bits.ANR_COR_TH;
	MINT32 ANR_COR_SL_U_L		 = rParam.rUpperIso_LowerZoom.med1.bits.ANR_COR_SL;
	MINT32 ANR_MCD_TH_U_L		 = rParam.rUpperIso_LowerZoom.med1.bits.ANR_MCD_TH;
	MINT32 ANR_MCD_SL_U_L		 = rParam.rUpperIso_LowerZoom.med1.bits.ANR_MCD_SL;
	MINT32 ANR_LCL_TH_U_L		 = rParam.rUpperIso_LowerZoom.med1.bits.ANR_LCL_TH;

	// CAM_ANR_MED2
	MINT32 ANR_LCL_SL_U_L		 = rParam.rUpperIso_LowerZoom.med2.bits.ANR_LCL_SL;
	MINT32 ANR_LCL_LV_U_L		 = rParam.rUpperIso_LowerZoom.med2.bits.ANR_LCL_LV;
	MINT32 ANR_SCL_TH_U_L		 = rParam.rUpperIso_LowerZoom.med2.bits.ANR_SCL_TH;
	MINT32 ANR_SCL_SL_U_L		 = rParam.rUpperIso_LowerZoom.med2.bits.ANR_SCL_SL;
	MINT32 ANR_SCL_LV_U_L		 = rParam.rUpperIso_LowerZoom.med2.bits.ANR_SCL_LV;

	// CAM_ANR_MED3
	MINT32 ANR_NCL_TH_U_L		 = rParam.rUpperIso_LowerZoom.med3.bits.ANR_NCL_TH;
	MINT32 ANR_NCL_SL_U_L		 = rParam.rUpperIso_LowerZoom.med3.bits.ANR_NCL_SL;
	MINT32 ANR_NCL_LV_U_L		 = rParam.rUpperIso_LowerZoom.med3.bits.ANR_NCL_LV;
	MINT32 ANR_VAR_U_L			 = rParam.rUpperIso_LowerZoom.med3.bits.ANR_VAR;
	MINT32 ANR_Y0_U_L			 = rParam.rUpperIso_LowerZoom.med3.bits.ANR_Y0;

	// CAM_ANR_MED4
	MINT32 ANR_Y1_U_L			 = rParam.rUpperIso_LowerZoom.med4.bits.ANR_Y1;
	MINT32 ANR_Y2_U_L			 = rParam.rUpperIso_LowerZoom.med4.bits.ANR_Y2;
	MINT32 ANR_Y3_U_L			 = rParam.rUpperIso_LowerZoom.med4.bits.ANR_Y3;
	MINT32 ANR_Y4_U_L			 = rParam.rUpperIso_LowerZoom.med4.bits.ANR_Y4;

	// CAM_ANR_MED5
	MINT32 ANR_LCL_OFT_U_L			 = rParam.rUpperIso_LowerZoom.med5.bits.ANR_LCL_OFT;
	MINT32 ANR_SCL_OFT_U_L			 = rParam.rUpperIso_LowerZoom.med5.bits.ANR_SCL_OFT;
	MINT32 ANR_NCL_OFT_U_L			 = rParam.rUpperIso_LowerZoom.med5.bits.ANR_NCL_OFT;

	// CAM_ANR_HP1 CAM+A54H
	MINT32 ANR_HP_A_U_L 		 = rParam.rUpperIso_LowerZoom.hp1.bits.ANR_HP_A;
	MINT32 ANR_HP_B_U_L 		 = rParam.rUpperIso_LowerZoom.hp1.bits.ANR_HP_B;
	MINT32 ANR_HP_C_U_L 		 = rParam.rUpperIso_LowerZoom.hp1.bits.ANR_HP_C;
	MINT32 ANR_HP_D_U_L 		 = rParam.rUpperIso_LowerZoom.hp1.bits.ANR_HP_D;
	MINT32 ANR_HP_E_U_L 		 = rParam.rUpperIso_LowerZoom.hp1.bits.ANR_HP_E;

	// CAM_ANR_HP2 CAM+A58H
	MINT32 ANR_HP_S1_U_L		 = rParam.rUpperIso_LowerZoom.hp2.bits.ANR_HP_S1;
	MINT32 ANR_HP_S2_U_L		 = rParam.rUpperIso_LowerZoom.hp2.bits.ANR_HP_S2;
	MINT32 ANR_HP_X1_U_L		 = rParam.rUpperIso_LowerZoom.hp2.bits.ANR_HP_X1;
	MINT32 ANR_HP_F_U_L 		 = rParam.rUpperIso_LowerZoom.hp2.bits.ANR_HP_F;

	// CAM_ANR_HP3 CAM+A5CH
	MINT32 ANR_HP_Y_GAIN_CLIP_U_L= rParam.rUpperIso_LowerZoom.hp3.bits.ANR_HP_Y_GAIN_CLIP;
	MINT32 ANR_HP_Y_SP_U_L		 = rParam.rUpperIso_LowerZoom.hp3.bits.ANR_HP_Y_SP;
	MINT32 ANR_HP_Y_LO_U_L		 = rParam.rUpperIso_LowerZoom.hp3.bits.ANR_HP_Y_LO;
	MINT32 ANR_HP_CLIP_U_L		 = rParam.rUpperIso_LowerZoom.hp3.bits.ANR_HP_CLIP;

	// CAM_ANR_ACT1 CAM+A64H
	MINT32 ANR_ACT_LCE_GAIN_U_L  = rParam.rUpperIso_LowerZoom.act1.bits.ANR_ACT_LCE_GAIN;
	MINT32 ANR_ACT_SCALE_OFT_U_L = rParam.rUpperIso_LowerZoom.act1.bits.ANR_ACT_SCALE_OFT;
	MINT32 ANR_ACT_SCALE_GAIN_U_L= rParam.rUpperIso_LowerZoom.act1.bits.ANR_ACT_SCALE_GAIN;
	...
	MINT32 ANR_COR_TH1_U_L		 = rParam.rUpperIso_LowerZoom.act2.bits.ANR_COR_TH1;
	MINT32 ANR_COR_SL1_U_L		 = rParam.rUpperIso_LowerZoom.act2.bits.ANR_COR_SL1;

	// CAM_ANR_ACT3 CAM+A64H
	MINT32 ANR_COR_ACT_TH_U_L	 = rParam.rUpperIso_LowerZoom.act3.bits.ANR_COR_ACT_TH;
	MINT32 ANR_COR_ACT_SL1_U_L	 = rParam.rUpperIso_LowerZoom.act3.bits.ANR_COR_ACT_SL1;
	MINT32 ANR_COR_ACT_SL2_U_L	 = rParam.rUpperIso_LowerZoom.act3.bits.ANR_COR_ACT_SL2;

	// CAM_ANR_ACTC CAM+A64H
	MINT32 ANR_ACT_TH_C_U_L 	 = rParam.rUpperIso_LowerZoom.actc.bits.ANR_ACT_TH_C;
	MINT32 ANR_ACT_BLD_BASE_C_U_L= rParam.rUpperIso_LowerZoom.actc.bits.ANR_ACT_BLD_BASE_C;
	MINT32 ANR_ACT_SLANT_C_U_L	 = rParam.rUpperIso_LowerZoom.actc.bits.ANR_ACT_SLANT_C;
	MINT32 ANR_ACT_BLD_TH_C_U_L  = rParam.rUpperIso_LowerZoom.actc.bits.ANR_ACT_BLD_TH_C;
	...
	MINT32 ANR_MEDIAN_EN_U_U	 = rParam.rUpperIso_UpperZoom.con1.bits.ANR_MEDIAN_EN;
	...
	MINT32 ANR_C_MED_EN_U_U 	 = rParam.rUpperIso_UpperZoom.con2.bits.ANR_C_MED_EN;
	...
	// CAM_ANR_MED1
	MINT32 ANR_COR_TH_U_U		 = rParam.rUpperIso_UpperZoom.med1.bits.ANR_COR_TH;
	MINT32 ANR_COR_SL_U_U		 = rParam.rUpperIso_UpperZoom.med1.bits.ANR_COR_SL;
	MINT32 ANR_MCD_TH_U_U		 = rParam.rUpperIso_UpperZoom.med1.bits.ANR_MCD_TH;
	MINT32 ANR_MCD_SL_U_U		 = rParam.rUpperIso_UpperZoom.med1.bits.ANR_MCD_SL;
	MINT32 ANR_LCL_TH_U_U		 = rParam.rUpperIso_UpperZoom.med1.bits.ANR_LCL_TH;

	// CAM_ANR_MED2
	MINT32 ANR_LCL_SL_U_U		 = rParam.rUpperIso_UpperZoom.med2.bits.ANR_LCL_SL;
	MINT32 ANR_LCL_LV_U_U		 = rParam.rUpperIso_UpperZoom.med2.bits.ANR_LCL_LV;
	MINT32 ANR_SCL_TH_U_U		 = rParam.rUpperIso_UpperZoom.med2.bits.ANR_SCL_TH;
	MINT32 ANR_SCL_SL_U_U		 = rParam.rUpperIso_UpperZoom.med2.bits.ANR_SCL_SL;
	MINT32 ANR_SCL_LV_U_U		 = rParam.rUpperIso_UpperZoom.med2.bits.ANR_SCL_LV;

	// CAM_ANR_MED3
	MINT32 ANR_NCL_TH_U_U		 = rParam.rUpperIso_UpperZoom.med3.bits.ANR_NCL_TH;
	MINT32 ANR_NCL_SL_U_U		 = rParam.rUpperIso_UpperZoom.med3.bits.ANR_NCL_SL;
	MINT32 ANR_NCL_LV_U_U		 = rParam.rUpperIso_UpperZoom.med3.bits.ANR_NCL_LV;
	MINT32 ANR_VAR_U_U			 = rParam.rUpperIso_UpperZoom.med3.bits.ANR_VAR;
	MINT32 ANR_Y0_U_U			 = rParam.rUpperIso_UpperZoom.med3.bits.ANR_Y0;

	// CAM_ANR_MED4
	MINT32 ANR_Y1_U_U			 = rParam.rUpperIso_UpperZoom.med4.bits.ANR_Y1;
	MINT32 ANR_Y2_U_U			 = rParam.rUpperIso_UpperZoom.med4.bits.ANR_Y2;
	MINT32 ANR_Y3_U_U			 = rParam.rUpperIso_UpperZoom.med4.bits.ANR_Y3;
	MINT32 ANR_Y4_U_U			 = rParam.rUpperIso_UpperZoom.med4.bits.ANR_Y4;

	// CAM_ANR_MED5
	MINT32 ANR_LCL_OFT_U_U			 = rParam.rUpperIso_UpperZoom.med5.bits.ANR_LCL_OFT;
	MINT32 ANR_SCL_OFT_U_U			 = rParam.rUpperIso_UpperZoom.med5.bits.ANR_SCL_OFT;
	MINT32 ANR_NCL_OFT_U_U			 = rParam.rUpperIso_UpperZoom.med5.bits.ANR_NCL_OFT;

	// CAM_ANR_HP1 CAM+A54H
	MINT32 ANR_HP_A_U_U 		 = rParam.rUpperIso_UpperZoom.hp1.bits.ANR_HP_A;
	MINT32 ANR_HP_B_U_U 		 = rParam.rUpperIso_UpperZoom.hp1.bits.ANR_HP_B;
	MINT32 ANR_HP_C_U_U 		 = rParam.rUpperIso_UpperZoom.hp1.bits.ANR_HP_C;
	MINT32 ANR_HP_D_U_U 		 = rParam.rUpperIso_UpperZoom.hp1.bits.ANR_HP_D;
	MINT32 ANR_HP_E_U_U 		 = rParam.rUpperIso_UpperZoom.hp1.bits.ANR_HP_E;

	// CAM_ANR_HP2 CAM+A58H
	MINT32 ANR_HP_S1_U_U		 = rParam.rUpperIso_UpperZoom.hp2.bits.ANR_HP_S1;
	MINT32 ANR_HP_S2_U_U		 = rParam.rUpperIso_UpperZoom.hp2.bits.ANR_HP_S2;
	MINT32 ANR_HP_X1_U_U		 = rParam.rUpperIso_UpperZoom.hp2.bits.ANR_HP_X1;
	MINT32 ANR_HP_F_U_U 		 = rParam.rUpperIso_UpperZoom.hp2.bits.ANR_HP_F;

	// CAM_ANR_HP3 CAM+A5CH
	MINT32 ANR_HP_Y_GAIN_CLIP_U_U= rParam.rUpperIso_UpperZoom.hp3.bits.ANR_HP_Y_GAIN_CLIP;
	MINT32 ANR_HP_Y_SP_U_U		 = rParam.rUpperIso_UpperZoom.hp3.bits.ANR_HP_Y_SP;
	MINT32 ANR_HP_Y_LO_U_U		 = rParam.rUpperIso_UpperZoom.hp3.bits.ANR_HP_Y_LO;
	MINT32 ANR_HP_CLIP_U_U		 = rParam.rUpperIso_UpperZoom.hp3.bits.ANR_HP_CLIP;

	// CAM_ANR_ACT1 CAM+A64H
	MINT32 ANR_ACT_LCE_GAIN_U_U  = rParam.rUpperIso_UpperZoom.act1.bits.ANR_ACT_LCE_GAIN;
	MINT32 ANR_ACT_SCALE_OFT_U_U = rParam.rUpperIso_UpperZoom.act1.bits.ANR_ACT_SCALE_OFT;
	MINT32 ANR_ACT_SCALE_GAIN_U_U= rParam.rUpperIso_UpperZoom.act1.bits.ANR_ACT_SCALE_GAIN;
	...
	MINT32 ANR_COR_TH1_U_U		 = rParam.rUpperIso_UpperZoom.act2.bits.ANR_COR_TH1;
	MINT32 ANR_COR_SL1_U_U		 = rParam.rUpperIso_UpperZoom.act2.bits.ANR_COR_SL1;

	// CAM_ANR_ACT3 CAM+A64H
	MINT32 ANR_COR_ACT_TH_U_U	 = rParam.rUpperIso_UpperZoom.act3.bits.ANR_COR_ACT_TH;
	MINT32 ANR_COR_ACT_SL1_U_U	 = rParam.rUpperIso_UpperZoom.act3.bits.ANR_COR_ACT_SL1;
	MINT32 ANR_COR_ACT_SL2_U_U	 = rParam.rUpperIso_UpperZoom.act3.bits.ANR_COR_ACT_SL2;

	// CAM_ANR_ACTC CAM+A64H
	MINT32 ANR_ACT_TH_C_U_U 	 = rParam.rUpperIso_UpperZoom.actc.bits.ANR_ACT_TH_C;
	MINT32 ANR_ACT_BLD_BASE_C_U_U= rParam.rUpperIso_UpperZoom.actc.bits.ANR_ACT_BLD_BASE_C;
	MINT32 ANR_ACT_SLANT_C_U_U	 = rParam.rUpperIso_UpperZoom.actc.bits.ANR_ACT_SLANT_C;
	MINT32 ANR_ACT_BLD_TH_C_U_U  = rParam.rUpperIso_UpperZoom.actc.bits.ANR_ACT_BLD_TH_C;
	...
	ANR_HP_B_L_L		= (ANR_HP_B_L_L > 31) ? (ANR_HP_B_L_L - 64) : ANR_HP_B_L_L;
	ANR_HP_C_L_L		= (ANR_HP_C_L_L > 15) ? (ANR_HP_C_L_L - 32) : ANR_HP_C_L_L;
	ANR_HP_D_L_L		= (ANR_HP_D_L_L > 7)  ? (ANR_HP_D_L_L - 16) : ANR_HP_D_L_L;
	ANR_HP_E_L_L		= (ANR_HP_E_L_L > 7)  ? (ANR_HP_E_L_L - 16) : ANR_HP_E_L_L;
	ANR_HP_F_L_L		= (ANR_HP_F_L_L > 3)  ? (ANR_HP_F_L_L - 8)	: ANR_HP_F_L_L;
	...
	ANR_HP_B_L_U		= (ANR_HP_B_L_U > 31) ? (ANR_HP_B_L_U - 64) : ANR_HP_B_L_U;
	ANR_HP_C_L_U		= (ANR_HP_C_L_U > 15) ? (ANR_HP_C_L_U - 32) : ANR_HP_C_L_U;
	ANR_HP_D_L_U		= (ANR_HP_D_L_U > 7)  ? (ANR_HP_D_L_U - 16) : ANR_HP_D_L_U;
	ANR_HP_E_L_U		= (ANR_HP_E_L_U > 7)  ? (ANR_HP_E_L_U - 16) : ANR_HP_E_L_U;
	ANR_HP_F_L_U		= (ANR_HP_F_L_U > 3)  ? (ANR_HP_F_L_U - 8)	: ANR_HP_F_L_U;
	...
	ANR_HP_B_U_L		= (ANR_HP_B_U_L > 31) ? (ANR_HP_B_U_L - 64) : ANR_HP_B_U_L;
	ANR_HP_C_U_L		= (ANR_HP_C_U_L > 15) ? (ANR_HP_C_U_L - 32) : ANR_HP_C_U_L;
	ANR_HP_D_U_L		= (ANR_HP_D_U_L > 7)  ? (ANR_HP_D_U_L - 16) : ANR_HP_D_U_L;
	ANR_HP_E_U_L		= (ANR_HP_E_U_L > 7)  ? (ANR_HP_E_U_L - 16) : ANR_HP_E_U_L;
	ANR_HP_F_U_L		= (ANR_HP_F_U_L > 3)  ? (ANR_HP_F_U_L - 8)	: ANR_HP_F_U_L;
	...
	ANR_HP_B_U_U		= (ANR_HP_B_U_U > 31) ? (ANR_HP_B_U_U - 64) : ANR_HP_B_U_U;
	ANR_HP_C_U_U		= (ANR_HP_C_U_U > 15) ? (ANR_HP_C_U_U - 32) : ANR_HP_C_U_U;
	ANR_HP_D_U_U		= (ANR_HP_D_U_U > 7)  ? (ANR_HP_D_U_U - 16) : ANR_HP_D_U_U;
	ANR_HP_E_U_U		= (ANR_HP_E_U_U > 7)  ? (ANR_HP_E_U_U - 16) : ANR_HP_E_U_U;
	ANR_HP_F_U_U		= (ANR_HP_F_U_U > 3)  ? (ANR_HP_F_U_U - 8)	: ANR_HP_F_U_U;
	...
	//	  ====================================================================================================================================
		...
		ANR_C_MED_EN	   = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_C_MED_EN_L_L, ANR_C_MED_EN_L_U, ANR_C_MED_EN_U_L, ANR_C_MED_EN_U_U,1);
		...
		ANR_HP_A			= InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_A_L_L, ANR_HP_A_L_U, ANR_HP_A_U_L, ANR_HP_A_U_U,1);
		ANR_HP_B			= InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_B_L_L, ANR_HP_B_L_U, ANR_HP_B_U_L, ANR_HP_B_U_U,1);
		ANR_HP_C			= InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_C_L_L, ANR_HP_C_L_U, ANR_HP_C_U_L, ANR_HP_C_U_U,1);
		ANR_HP_D			= InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_D_L_L, ANR_HP_D_L_U, ANR_HP_D_U_L, ANR_HP_D_U_U,1);
		ANR_HP_E			= InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_E_L_L, ANR_HP_E_L_U, ANR_HP_E_U_L, ANR_HP_E_U_U,1);
		ANR_HP_F			= InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_F_L_L, ANR_HP_F_L_U, ANR_HP_F_U_L, ANR_HP_F_U_U,1);
		ANR_HP_S1			 = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_S1_L_L, ANR_HP_S1_L_U, ANR_HP_S1_U_L, ANR_HP_S1_U_U,1);
		ANR_HP_S2			 = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_S2_L_L, ANR_HP_S2_L_U, ANR_HP_S2_U_L, ANR_HP_S2_U_U,1);
		ANR_HP_X1			 = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_X1_L_L, ANR_HP_X1_L_U, ANR_HP_X1_U_L, ANR_HP_X1_U_U,1);
		ANR_HP_Y_GAIN_CLIP			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_Y_GAIN_CLIP_L_L, ANR_HP_Y_GAIN_CLIP_L_U, ANR_HP_Y_GAIN_CLIP_U_L, ANR_HP_Y_GAIN_CLIP_U_U,1);
		ANR_HP_Y_SP 		   = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_Y_SP_L_L, ANR_HP_Y_SP_L_U, ANR_HP_Y_SP_U_L, ANR_HP_Y_SP_U_U,1);
		ANR_HP_Y_LO 		   = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_Y_LO_L_L, ANR_HP_Y_LO_L_U, ANR_HP_Y_LO_U_L, ANR_HP_Y_LO_U_U,1);
		ANR_HP_CLIP 		   = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_HP_CLIP_L_L, ANR_HP_CLIP_L_U, ANR_HP_CLIP_U_L, ANR_HP_CLIP_U_U,1);
		...
		ANR_ACT_SCALE_OFT			 = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_ACT_SCALE_OFT_L_L, ANR_ACT_SCALE_OFT_L_U, ANR_ACT_SCALE_OFT_U_L, ANR_ACT_SCALE_OFT_U_U,0);
		ANR_ACT_SCALE_GAIN			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_ACT_SCALE_GAIN_L_L, ANR_ACT_SCALE_GAIN_L_U, ANR_ACT_SCALE_GAIN_U_L, ANR_ACT_SCALE_GAIN_U_U,0);
		...
		ANR_COR_TH1 		   = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_COR_TH1_L_L, ANR_COR_TH1_L_U, ANR_COR_TH1_U_L, ANR_COR_TH1_U_U,0);
		ANR_COR_SL1 		   = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_COR_SL1_L_L, ANR_COR_SL1_L_U, ANR_COR_SL1_U_L, ANR_COR_SL1_U_U,0);
		ANR_COR_ACT_TH			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_COR_ACT_TH_L_L, ANR_COR_ACT_TH_L_U, ANR_COR_ACT_TH_U_L, ANR_COR_ACT_TH_U_U,0);
		ANR_COR_ACT_SL1 		   = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_COR_ACT_SL1_L_L, ANR_COR_ACT_SL1_L_U, ANR_COR_ACT_SL1_U_L, ANR_COR_ACT_SL1_U_U,0);
		ANR_COR_ACT_SL2 		   = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_COR_ACT_SL2_L_L, ANR_COR_ACT_SL2_L_U, ANR_COR_ACT_SL2_U_L, ANR_COR_ACT_SL2_U_U,0);
		ANR_ACT_TH_C			= InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_ACT_TH_C_L_L, ANR_ACT_TH_C_L_U, ANR_ACT_TH_C_U_L, ANR_ACT_TH_C_U_U,0);
		...
		ANR_ACT_SLANT_C 		   = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_ACT_SLANT_C_L_L, ANR_ACT_SLANT_C_L_U, ANR_ACT_SLANT_C_U_L, ANR_ACT_SLANT_C_U_U,0);
		ANR_ACT_BLD_TH_C			= InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_ACT_BLD_TH_C_L_L, ANR_ACT_BLD_TH_C_L_U, ANR_ACT_BLD_TH_C_U_L, ANR_ACT_BLD_TH_C_U_U,0);
		...
		ANR_MEDIAN_EN			 = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_MEDIAN_EN_L_L, ANR_MEDIAN_EN_L_U, ANR_MEDIAN_EN_U_L, ANR_MEDIAN_EN_U_U,1);
		ANR_COR_TH			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_COR_TH_L_L, ANR_COR_TH_L_U, ANR_COR_TH_U_L, ANR_COR_TH_U_U,0);
		ANR_COR_SL			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_COR_SL_L_L, ANR_COR_SL_L_U, ANR_COR_SL_U_L, ANR_COR_SL_U_U,0);
		ANR_MCD_TH			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_MCD_TH_L_L, ANR_MCD_TH_L_U, ANR_MCD_TH_U_L, ANR_MCD_TH_U_U,0);
		ANR_MCD_SL			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_MCD_SL_L_L, ANR_MCD_SL_L_U, ANR_MCD_SL_U_L, ANR_MCD_SL_U_U,0);
		ANR_LCL_TH			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_LCL_TH_L_L, ANR_LCL_TH_L_U, ANR_LCL_TH_U_L, ANR_LCL_TH_U_U,0);
		ANR_LCL_SL			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_LCL_SL_L_L, ANR_LCL_SL_L_U, ANR_LCL_SL_U_L, ANR_LCL_SL_U_U,0);
		ANR_LCL_LV			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_LCL_LV_L_L, ANR_LCL_LV_L_U, ANR_LCL_LV_U_L, ANR_LCL_LV_U_U,0);
		ANR_SCL_TH			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_SCL_TH_L_L, ANR_SCL_TH_L_U, ANR_SCL_TH_U_L, ANR_SCL_TH_U_U,0);
		ANR_SCL_SL			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_SCL_SL_L_L, ANR_SCL_SL_L_U, ANR_SCL_SL_U_L, ANR_SCL_SL_U_U,0);
		ANR_SCL_LV			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_SCL_LV_L_L, ANR_SCL_LV_L_U, ANR_SCL_LV_U_L, ANR_SCL_LV_U_U,0);
		ANR_NCL_TH			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_NCL_TH_L_L, ANR_NCL_TH_L_U, ANR_NCL_TH_U_L, ANR_NCL_TH_U_U,0);
		ANR_NCL_SL			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_NCL_SL_L_L, ANR_NCL_SL_L_U, ANR_NCL_SL_U_L, ANR_NCL_SL_U_U,0);
		ANR_NCL_LV			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_NCL_LV_L_L, ANR_NCL_LV_L_U, ANR_NCL_LV_U_L, ANR_NCL_LV_U_U,0);
		ANR_VAR 		   = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_VAR_L_L, ANR_VAR_L_U, ANR_VAR_U_L, ANR_VAR_U_U,0);
		ANR_Y0			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_Y0_L_L, ANR_Y0_L_U, ANR_Y0_U_L, ANR_Y0_U_U,0);
		ANR_Y1			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_Y1_L_L, ANR_Y1_L_U, ANR_Y1_U_L, ANR_Y1_U_U,0);
		ANR_Y2			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_Y2_L_L, ANR_Y2_L_U, ANR_Y2_U_L, ANR_Y2_U_U,0);
		ANR_Y3			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_Y3_L_L, ANR_Y3_L_U, ANR_Y3_U_L, ANR_Y3_U_U,0);
		ANR_Y4			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_Y4_L_L, ANR_Y4_L_U, ANR_Y4_U_L, ANR_Y4_U_U,0);
		ANR_LCL_OFT			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_LCL_OFT_L_L, ANR_LCL_OFT_L_U, ANR_LCL_OFT_U_L, ANR_LCL_OFT_U_U,0);
		ANR_SCL_OFT			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_SCL_OFT_L_L, ANR_SCL_OFT_L_U, ANR_SCL_OFT_U_L, ANR_SCL_OFT_U_U,0);
		ANR_NCL_OFT			  = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR_NCL_OFT_L_L, ANR_NCL_OFT_L_U, ANR_NCL_OFT_U_L, ANR_NCL_OFT_U_U,0);
	...
	// CAM_ANR_MED5
	rSmoothANR.med5.bits.ANR_LCL_OFT = ANR_LCL_OFT;
	rSmoothANR.med5.bits.ANR_SCL_OFT = ANR_SCL_OFT;
	rSmoothANR.med5.bits.ANR_NCL_OFT = ANR_NCL_OFT;
...
#define ANR_DUMP(item1, item2)   \
	...
	ANR_DUMP(med5, ANR_LCL_OFT);
	ANR_DUMP(med5, ANR_SCL_OFT);
	ANR_DUMP(med5, ANR_NCL_OFT);
                ...
                ISP_NVRAM_ANR2_T& rSmoothANR2)
{
    ...
    MINT32 ANR2_C_MED_EN_L_L      = rParam.rLowerIso_LowerZoom.con2.bits.ANR2_C_MED_EN;
    ...
    MINT32 ANR2_ACT_TH_Y_L_L      = rParam.rLowerIso_LowerZoom.acty.bits.ANR2_ACT_TH_Y;
    MINT32 ANR2_ACT_BLD_BASE_Y_L_L= rParam.rLowerIso_LowerZoom.acty.bits.ANR2_ACT_BLD_BASE_Y;
    MINT32 ANR2_ACT_SLANT_Y_L_L   = rParam.rLowerIso_LowerZoom.acty.bits.ANR2_ACT_SLANT_Y;
    MINT32 ANR2_ACT_BLD_TH_Y_L_L  = rParam.rLowerIso_LowerZoom.acty.bits.ANR2_ACT_BLD_TH_Y;

    // CAM_ANR2_ACTC CAM+A64H
    MINT32 ANR2_ACT_TH_C_L_L      = rParam.rLowerIso_LowerZoom.actc.bits.ANR2_ACT_TH_C;
    MINT32 ANR2_ACT_BLD_BASE_C_L_L= rParam.rLowerIso_LowerZoom.actc.bits.ANR2_ACT_BLD_BASE_C;
    MINT32 ANR2_ACT_SLANT_C_L_L   = rParam.rLowerIso_LowerZoom.actc.bits.ANR2_ACT_SLANT_C;
    MINT32 ANR2_ACT_BLD_TH_C_L_L  = rParam.rLowerIso_LowerZoom.actc.bits.ANR2_ACT_BLD_TH_C;
    ...
    // CAM_ANR2_CON2 CAM+A24H
    MINT32 ANR2_C_MED_EN_L_U      = rParam.rLowerIso_UpperZoom.con2.bits.ANR2_C_MED_EN;
    ...
    // CAM_ANR2_ACTY CAM+A60H
    MINT32 ANR2_ACT_TH_Y_L_U      = rParam.rLowerIso_UpperZoom.acty.bits.ANR2_ACT_TH_Y;
    MINT32 ANR2_ACT_BLD_BASE_Y_L_U= rParam.rLowerIso_UpperZoom.acty.bits.ANR2_ACT_BLD_BASE_Y;
    MINT32 ANR2_ACT_SLANT_Y_L_U   = rParam.rLowerIso_UpperZoom.acty.bits.ANR2_ACT_SLANT_Y;
    MINT32 ANR2_ACT_BLD_TH_Y_L_U  = rParam.rLowerIso_UpperZoom.acty.bits.ANR2_ACT_BLD_TH_Y;

    // CAM_ANR2_ACTC CAM+A64H
    MINT32 ANR2_ACT_TH_C_L_U      = rParam.rLowerIso_UpperZoom.actc.bits.ANR2_ACT_TH_C;
    MINT32 ANR2_ACT_BLD_BASE_C_L_U= rParam.rLowerIso_UpperZoom.actc.bits.ANR2_ACT_BLD_BASE_C;
    MINT32 ANR2_ACT_SLANT_C_L_U   = rParam.rLowerIso_UpperZoom.actc.bits.ANR2_ACT_SLANT_C;
    MINT32 ANR2_ACT_BLD_TH_C_L_U  = rParam.rLowerIso_UpperZoom.actc.bits.ANR2_ACT_BLD_TH_C;
    ...
    // CAM_ANR2_CON2 CAM+A24H
    MINT32 ANR2_C_MED_EN_U_L      = rParam.rUpperIso_LowerZoom.con2.bits.ANR2_C_MED_EN;
    ...
    // CAM_ANR2_ACTY CAM+A60H
    MINT32 ANR2_ACT_TH_Y_U_L      = rParam.rUpperIso_LowerZoom.acty.bits.ANR2_ACT_TH_Y;
    MINT32 ANR2_ACT_BLD_BASE_Y_U_L= rParam.rUpperIso_LowerZoom.acty.bits.ANR2_ACT_BLD_BASE_Y;
    MINT32 ANR2_ACT_SLANT_Y_U_L   = rParam.rUpperIso_LowerZoom.acty.bits.ANR2_ACT_SLANT_Y;
    MINT32 ANR2_ACT_BLD_TH_Y_U_L  = rParam.rUpperIso_LowerZoom.acty.bits.ANR2_ACT_BLD_TH_Y;

    // CAM_ANR2_ACTC CAM+A64H
    MINT32 ANR2_ACT_TH_C_U_L      = rParam.rUpperIso_LowerZoom.actc.bits.ANR2_ACT_TH_C;
    MINT32 ANR2_ACT_BLD_BASE_C_U_L= rParam.rUpperIso_LowerZoom.actc.bits.ANR2_ACT_BLD_BASE_C;
    MINT32 ANR2_ACT_SLANT_C_U_L   = rParam.rUpperIso_LowerZoom.actc.bits.ANR2_ACT_SLANT_C;
    MINT32 ANR2_ACT_BLD_TH_C_U_L  = rParam.rUpperIso_LowerZoom.actc.bits.ANR2_ACT_BLD_TH_C;
    ...
    // CAM_ANR2_CON2 CAM+A24H
    MINT32 ANR2_C_MED_EN_U_U      = rParam.rUpperIso_UpperZoom.con2.bits.ANR2_C_MED_EN;
    ...
    // CAM_ANR2_ACTY CAM+A60H
    MINT32 ANR2_ACT_TH_Y_U_U      = rParam.rUpperIso_UpperZoom.acty.bits.ANR2_ACT_TH_Y;
    MINT32 ANR2_ACT_BLD_BASE_Y_U_U= rParam.rUpperIso_UpperZoom.acty.bits.ANR2_ACT_BLD_BASE_Y;
    MINT32 ANR2_ACT_SLANT_Y_U_U   = rParam.rUpperIso_UpperZoom.acty.bits.ANR2_ACT_SLANT_Y;
    MINT32 ANR2_ACT_BLD_TH_Y_U_U  = rParam.rUpperIso_UpperZoom.acty.bits.ANR2_ACT_BLD_TH_Y;

    // CAM_ANR2_ACTC CAM+A64H
    MINT32 ANR2_ACT_TH_C_U_U      = rParam.rUpperIso_UpperZoom.actc.bits.ANR2_ACT_TH_C;
    MINT32 ANR2_ACT_BLD_BASE_C_U_U= rParam.rUpperIso_UpperZoom.actc.bits.ANR2_ACT_BLD_BASE_C;
    MINT32 ANR2_ACT_SLANT_C_U_U   = rParam.rUpperIso_UpperZoom.actc.bits.ANR2_ACT_SLANT_C;
    MINT32 ANR2_ACT_BLD_TH_C_U_U  = rParam.rUpperIso_UpperZoom.actc.bits.ANR2_ACT_BLD_TH_C;
    ...
    ANR2_C_MED_EN            = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR2_C_MED_EN_L_L, ANR2_C_MED_EN_L_U, ANR2_C_MED_EN_U_L, ANR2_C_MED_EN_U_U,1);
    ...
    ANR2_ACT_TH_Y            = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR2_ACT_TH_Y_L_L, ANR2_ACT_TH_Y_L_U, ANR2_ACT_TH_Y_U_L, ANR2_ACT_TH_Y_U_U,0);
    ANR2_ACT_BLD_BASE_Y            = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR2_ACT_BLD_BASE_Y_L_L, ANR2_ACT_BLD_BASE_Y_L_U, ANR2_ACT_BLD_BASE_Y_U_L, ANR2_ACT_BLD_BASE_Y_U_U,0);
    ANR2_ACT_SLANT_Y            = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR2_ACT_SLANT_Y_L_L, ANR2_ACT_SLANT_Y_L_U, ANR2_ACT_SLANT_Y_U_L, ANR2_ACT_SLANT_Y_U_U,0);
    ANR2_ACT_BLD_TH_Y            = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR2_ACT_BLD_TH_Y_L_L, ANR2_ACT_BLD_TH_Y_L_U, ANR2_ACT_BLD_TH_Y_U_L, ANR2_ACT_BLD_TH_Y_U_U,0);
    ANR2_ACT_TH_C            = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR2_ACT_TH_C_L_L, ANR2_ACT_TH_C_L_U, ANR2_ACT_TH_C_U_L, ANR2_ACT_TH_C_U_U,0);
    ...
    ANR2_ACT_SLANT_C            = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR2_ACT_SLANT_C_L_L, ANR2_ACT_SLANT_C_L_U, ANR2_ACT_SLANT_C_U_L, ANR2_ACT_SLANT_C_U_U,0);
    ANR2_ACT_BLD_TH_C            = InterParam_NR(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, ANR2_ACT_BLD_TH_C_L_L, ANR2_ACT_BLD_TH_C_L_U, ANR2_ACT_BLD_TH_C_U_L, ANR2_ACT_BLD_TH_C_U_U,0);
    ...
    // CAM_ANR2_CON2 CAM+A24H
    rSmoothANR2.con2.bits.ANR2_C_MED_EN = ANR2_C_MED_EN;
    ...
    // CAM_ANR2_ACTY CAM+A60H
    rSmoothANR2.acty.bits.ANR2_ACT_TH_Y = ANR2_ACT_TH_Y;
    rSmoothANR2.acty.bits.ANR2_ACT_BLD_BASE_Y = ANR2_ACT_BLD_BASE_Y;
    rSmoothANR2.acty.bits.ANR2_ACT_SLANT_Y = ANR2_ACT_SLANT_Y;
    rSmoothANR2.acty.bits.ANR2_ACT_BLD_TH_Y = ANR2_ACT_BLD_TH_Y;

    // CAM_ANR2_ACTC CAM+A64H
    rSmoothANR2.actc.bits.ANR2_ACT_TH_C = ANR2_ACT_TH_C;
    rSmoothANR2.actc.bits.ANR2_ACT_BLD_BASE_C = ANR2_ACT_BLD_BASE_C;
    rSmoothANR2.actc.bits.ANR2_ACT_SLANT_C = ANR2_ACT_SLANT_C;
    rSmoothANR2.actc.bits.ANR2_ACT_BLD_TH_C = ANR2_ACT_BLD_TH_C;
               ...
               ISP_NVRAM_HFG_T& rSmoothHFG)   // Output
{
	...
	INTER_LOG_IF(bSmoothHFGDebug,"[%s()] u4RealZoom: %f, u4UpperZoom = %f, u4LowerZoom = %f\n", __FUNCTION__, fRealZoom, fUpperZoom, fLowerZoom);
...
{       // Output
	...
	INTER_LOG_IF(bSmoothEEDebug,"[%s()] u4RealZoom: %f, u4UpperZoom = %f, u4LowerZoom = %f\n", __FUNCTION__, fRealZoom, fUpperZoom, fLowerZoom);
...
{       
	...
	INTER_LOG_IF(bSmoothMIXER3Debug,"[%s()] u4RealZoom: %f, u4UpperZoom = %f, u4LowerZoom = %f\n", __FUNCTION__, fRealZoom, fUpperZoom, fLowerZoom);
    ...
    //  Registers that can be interpolated
    MINT32 MIX3_DT            = InterParam_MIXER3(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, MIX3_DT_L_L, MIX3_DT_L_U, MIX3_DT_U_L, MIX3_DT_U_U,0);
	...
	MINT32 MIX3_M1            = InterParam_MIXER3(RATIO_L_L, RATIO_L_U, RATIO_U_L, RATIO_U_U, MIX3_M1_L_L, MIX3_M1_L_U, MIX3_M1_U_L, MIX3_M1_U_U,0);
...
{       // Output
	...
	INTER_LOG_IF(bSmoothMFBDebug,"[%s()] u4RealZoom: %f, u4UpperZoom = %f, u4LowerZoom = %f\n", __FUNCTION__, fRealZoom, fUpperZoom, fLowerZoom);
               ...
               ISP_NR3D_SMOOTH_INFO_T const& rNR3D_SW_Params)  // Output
{
	...
	if (bSmoothNR3DDebug>=2 && bmCount % 33 == 0)
	{
		...
		INTER_LOG_IF(bSmoothNR3DDebug>=2,"[%s()] u4RealZoom: %f, u4UpperZoom = %f, u4LowerZoom = %f\n", __FUNCTION__, fRealZoom, fUpperZoom, fLowerZoom);
	}
