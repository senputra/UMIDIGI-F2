...
LOCAL_EXPORT_C_INCLUDE_DIRS += $(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_feature/libispfeature_lib/libcamalgo.ispfeature/$(TARGET_BOARD_PLATFORM)/include/ver2
LOCAL_EXPORT_C_INCLUDE_DIRS += $(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_3a/libgma_lib/lib3a.gma/$(TARGET_BOARD_PLATFORM)/include
LOCAL_EXPORT_C_INCLUDE_DIRS += $(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_3a/liblce_lib/lib3a.lce/$(TARGET_BOARD_PLATFORM)/include
LOCAL_MODULE := libcustom_isp_tone_headers
...
MTKCAM_3A_PATH    := $(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/mt6757p
MTKCAM_INCLUDE := $(MTK_PATH_SOURCE)/hardware/mtkcam/include
MTKCAM_3A_COMMON_PATH := $(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/common
MTKCAM_3A_IP_PATH     := $(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/$(MTKCAM_AAA_PLATFORM)

LOCAL_EXPORT_C_INCLUDE_DIRS += $(TOP)/$(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/isp_tuning
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_COMMON_PATH)/flash_mgr
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_COMMON_PATH)/strobe
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_COMMON_PATH)/flicker
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_COMMON_PATH)
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_COMMON_PATH)/hal3a/$(MTKCAM_COMMON_HAL3A_VERSION)
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_COMMON_PATH)/hal3a/$(MTKCAM_COMMON_HAL3A_VERSION)/debug
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_COMMON_PATH)/hal3a/$(MTKCAM_COMMON_HAL3A_VERSION)/wrapper
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_COMMON_PATH)/hal3a/$(MTKCAM_COMMON_HAL3A_VERSION)/buf_mgr
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_COMMON_PATH)/hal3a/$(MTKCAM_COMMON_HAL3A_VERSION)/ResultPool
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_IP_PATH)/
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_IP_PATH)/wrapper
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_IP_PATH)/flash_mgr

LOCAL_MODULE := lib3a_mt6757p_hal3_headers
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
#-----------------------------------------------------------
include $(BUILD_HEADER_LIBRARY)
...
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/debug
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/local_headers
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/EventIrq
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/state_mgr
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/state_mgr_n3d
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/flash_mgr
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/strobe
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/flicker
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/buf_mgr
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/ResultBufMgr
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/wrapper
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_3A_PATH)/ResultBufCtrl

LOCAL_MODULE := lib3a_mt6757p_hal1_headers
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
#-----------------------------------------------------------
include $(BUILD_HEADER_LIBRARY)
...
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTKCAM_ALGO_INCLUDE)/libsync3a

LOCAL_MODULE := lib3a_mt6757p_headers
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
#-----------------------------------------------------------
include $(BUILD_HEADER_LIBRARY)
...
# Begin of 3A Framework Strategy
ifeq ($(MTKCAM_AAA_PLATFORM), isp_40)
################################################################################
# CAMERA HAL3: Use 3A IP Base Framework
################################################################################
MTKCAM_3A_IP_PATH     := $(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/$(MTKCAM_AAA_PLATFORM)
RELATIVE_PATH_MTKCAM_3A_IP_PATH := ../$(MTKCAM_AAA_PLATFORM)

LOCAL_CFLAGS += -DMT6757P_API=1
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/Hal3AMisc.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/Hal3ACbHub.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/ThreadRawImp.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/ThreadRawSMVRImp.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/wrapper/Hal3ARawImp.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/wrapper/Hal3ARawSMVRImp.cpp
# LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/wrapper/Hal3AYuvImp.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/aaa_hal_sttCtrl.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/buf_mgr/FLKOBufMgr.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/flash_mgr/flash_custom_adapter.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/flash_mgr/flash_platform_adapter.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/flash_mgr/flash_algo_adapter.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/flicker/flicker_platform_adapter.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/Thread/ThreadSensorGainImp.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/Thread/ThreadSensorI2CImp.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/Thread/ThreadStatisticBufImp.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/Thread/ThreadSensorBufferModeImp.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/Thread/ThreadSetCCUParaImp.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/ITask.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/Task3APreview.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/Task3ATouch.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/Task3APrecapture.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/Task3AFlash.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/Task3AFlashFront.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/Task3AFlashBack.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/Task3ACapture.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/TaskAFNormal.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/TaskAFTrigger.cpp
LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/TaskMgr.cpp
...
LOCAL_CFLAGS += -DCAM3_3A_ISP_40_PLATFORM_MIX_VER_1=$(MTKCAM_IS_ISP_40_PLATFORM_MIX_VER_1)

# for Stereo Feature
ifeq ($(MTK_CAM_STEREO_CAMERA_SUPPORT),yes)
    LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/Sync3A.cpp
    LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/TaskSync2A.cpp
    LOCAL_SRC_FILES += $(RELATIVE_PATH_MTKCAM_3A_IP_PATH)/task/TaskSyncAF.cpp
    LOCAL_SHARED_LIBRARIES += lib3a.n3d3a
    LOCAL_CFLAGS += -DCAM3_STEREO_FEATURE_EN=1
endif

LOCAL_HEADER_LIBRARIES += lib3a_mt6757p_hal3_headers

else
################################################################################
# CAMERA HAL1: Use 3A Platform Framework
################################################################################
...
LOCAL_SRC_FILES += flash_mgr/flash_cct_quick2.cpp
...
ifeq ($(MTK_CAM_STEREO_CAMERA_SUPPORT),yes)
    ...
    LOCAL_SRC_FILES += state_mgr_n3d/aaa_state_n3d.cpp
    LOCAL_SRC_FILES += state_mgr_n3d/aaa_state_camera_preview_n3d.cpp
    LOCAL_SRC_FILES += state_mgr_n3d/aaa_state_af_n3d.cpp
    LOCAL_SRC_FILES += state_mgr_n3d/aaa_state_precapture_n3d.cpp
    LOCAL_SHARED_LIBRARIES += lib3a.n3d3a
    LOCAL_CFLAGS += -DCAM3_STEREO_FEATURE_EN=1
endif

LOCAL_HEADER_LIBRARIES += lib3a_mt6757p_hal1_headers

endif
# End of 3A Framework Strategy
#-----------------------------------------------------------
...
LOCAL_SRC_FILES += ae_mgr/ae_mgr_ccu.cpp
...
LOCAL_SRC_FILES += isp_mgr/isp_mgr_abf.cpp
...
LOCAL_SRC_FILES += buf_mgr/AAOSeparation.cpp
...
LOCAL_SRC_FILES += laser_mgr/laser_drv.cpp
LOCAL_SRC_FILES += laser_mgr/laser_mgr_if.cpp
LOCAL_SRC_FILES += isp_interpolation/isp_interpolation.cpp


LOCAL_SRC_FILES += cct_svr/cctsvr_entry.cpp
#ACDK
MTKCAM_ACDK := $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/acdk/$(MTK_CAM_SW_VERSION)

#------------------ip base new include path-----------------------
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/mtkcam/include

LOCAL_C_INCLUDES += $(MTKCAM_INCLUDE)
LOCAL_C_INCLUDES += $(MTKCAM_INCLUDE)/$(MTK_CAM_SW_VERSION)
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_feature/libispfeature_lib/$(TARGET_BOARD_PLATFORM)/include/ver2
...
LOCAL_SHARED_LIBRARIES += libcamdrv_ccuif

LOCAL_HEADER_LIBRARIES += libcustom_isp_tone_headers lib3a_mt6757p_headers libcustom_isp_headers
...
LOCAL_C_INCLUDES += $(MTKCAM_3A_PATH)/isp_interpolation
...
#Use CT_3 Shading Table when Flash is ON
LOCAL_CFLAGS += -DCAM3_FLASH_ON_SHADING_CT_3_TABLE=0

LOCAL_CFLAGS += -DMTKCAM_CMDQ_SUPPORT
LOCAL_CFLAGS += -DMTKCAM_AF_EXTMODE_SUPPORT
...
ifneq ($(BUILD_MTK_LDVT),true)
    ...
    # LOCAL_SHARED_LIBRARIES += libispfeature
...
$(INTERMEDIATES)/aaa_exif_tag_chksum.h: \
 $(CHKSUM) \
 $(CHKSUMEXE) \
 $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_ae_param.h \
 $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_af_param.h \
 $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_awb_param.h \
 $(MTK_AAA_EXIF_TAG_PATH)/dbg_flash_param.h \
 $(MTK_AAA_EXIF_TAG_PATH)/dbg_flicker_param.h \
 $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_isp_param.h \
 $(MTK_AAA_EXIF_TAG_PATH)/dbg_shading_param.h
	echo "generate $@ from $^"
	rm -rf $@
	$(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_ae_param.h $(CHKSUMEXE)      && \
	$(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_af_param.h $(CHKSUMEXE)      && \
	$(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_awb_param.h $(CHKSUMEXE)     && \
	$(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/dbg_flash_param.h $(CHKSUMEXE)   && \
	$(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/dbg_flicker_param.h $(CHKSUMEXE) && \
	$(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_isp_param.h $(CHKSUMEXE)     && \
	$(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/dbg_shading_param.h $(CHKSUMEXE) || \
	{ >2 echo "generate $@ fail"; exit -1; }
	echo "#define CHKSUM_DBG_AE_PARAM      $(shell $(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_ae_param.h $(CHKSUMEXE))" >> $@
	echo "#define CHKSUM_DBG_AF_PARAM      $(shell $(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_af_param.h $(CHKSUMEXE))" >> $@
	echo "#define CHKSUM_DBG_AWB_PARAM     $(shell $(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_awb_param.h $(CHKSUMEXE))" >> $@
	...
	echo "#define CHKSUM_DBG_ISP_PARAM     $(shell $(CHKSUM) $(MTK_AAA_EXIF_TAG_PATH)/$(MTK_CAM_SW_VERSION)/dbg_isp_param.h $(CHKSUMEXE))" >> $@
...
include $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/isp_40/flicker/Android.mk
