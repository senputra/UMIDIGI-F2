...
{
public:
    static CcmMgr* createInstance(ESensorDev_T const eSensorDev, ISP_NVRAM_MULTI_CCM_STRUCT& rISPMultiCCM, NSIspTuning::IspTuningCustom* pIspTuningCustom);
...
private:
    ISP_NVRAM_CCM_T (&m_rIspCCMInput)[(ISP_NVRAM_CCM_LV_NUM + ISP_NVRAM_CCM_FLASH_NUM)][ISP_NVRAM_CCM_CT_NUM];
    ISP_NVRAM_CCM_T m_rCCMOutput;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    CcmMgr(ESensorDev_T const eSensorDev, ISP_NVRAM_MULTI_CCM_STRUCT& rISPMultiCCM, IspTuningCustom* pIspTuningCustom)
        : m_eSensorDev  (eSensorDev)
        , m_rIspCCMInput   (rISPMultiCCM.CCM)
        ...
        , m_rCCMOutput (rISPMultiCCM.CCM[0][0])
...
public:
    ...
    MVOID
    calculateCCM(ISP_NVRAM_CCM_T& rCCM, MUINT16& rVer, MBOOL bWithPreferenceGain, MBOOL bRWBSensor, RAWIspCamInfo const& rIspCamInfo);

    MVOID
    RWB_CCM_decomposition(ISP_NVRAM_CCM_T& ccm_out, MFLOAT isp_ccm_ratio);
