...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    MUINT32            m_P1TuningBuffer[P1_BUFFER_SIZE];
    //
};

template <MINT32 sensorDevId>
class IspTuningBufCtrlDev : public IspTuningBufCtrl
{
public:
    static IspTuningBufCtrlDev* getInstance()
    {
        static IspTuningBufCtrlDev<sensorDevId> singleton;
        return &singleton;
    }
    IspTuningBufCtrlDev()
        : IspTuningBufCtrl()
