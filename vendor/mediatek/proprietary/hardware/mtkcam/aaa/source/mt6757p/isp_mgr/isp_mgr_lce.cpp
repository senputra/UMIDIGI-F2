...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    case ESensorDev_Main: //  Main Sensor
        return  ISP_MGR_LCS_DEV<ESensorDev_Main>::getInstance();
    case ESensorDev_MainSecond: //  Main Second Sensor
        return  ISP_MGR_LCS_DEV<ESensorDev_MainSecond>::getInstance();
    case ESensorDev_Sub: //  Sub Sensor
        return  ISP_MGR_LCS_DEV<ESensorDev_Sub>::getInstance();
    case ESensorDev_SubSecond: //  Sub Sensor
        return  ISP_MGR_LCS_DEV<ESensorDev_SubSecond>::getInstance();
    default:
...
getInstance(ESensorDev_T const eSensorDev)
{
    ...
    case ESensorDev_SubSecond: //  Sub Sensor
        return  ISP_MGR_LCE_DEV<ESensorDev_SubSecond>::getInstance();
    default:
...
put(ISP_NVRAM_LCE_T const& rParam)
{
        ...
        reinterpret_cast<ISP_DIP_X_LCE25_TM_PARA0_T*>(REG_INFO_VALUE_PTR(DIP_X_LCE25_TM_PARA0))->LCE_GLOB_TONE = rParam.tm_para0.bits.LCE_GLOB_TONE;
...
transform_LCE(const CROP_RZ_INFO_T& rRzCrop)
{
    ...
    if (i4RrzCropInX == 0 || i4RrzCropInY == 0)
    {
        ...
        //dummy
        DIP_X_REG_LCE25_TPIPE_SLM     slm = {0};
        DIP_X_REG_LCE25_TPIPE_OFFSET  offset = {0};
        DIP_X_REG_LCE25_TPIPE_OUT     out = {0};
