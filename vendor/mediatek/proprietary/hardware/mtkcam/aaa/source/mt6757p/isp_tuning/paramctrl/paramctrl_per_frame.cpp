...
prepareHw_PerFrame_All(const ISP_INFO_T& rIspInfo)
{
    ...
    MBOOL fgRet = MTRUE
        ...
        &&  prepareHw_PerFrame_DBS_2(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_OBC_2(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_BPC_2(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_NR1_2(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_PDC_2(rIspInfo.rCamInfo)
        ...
        &&  prepareHw_PerFrame_ANR(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_ANR_TBL(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_ANR2(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_CCR(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_BOK(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_PCA(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_HFG(rIspInfo.rCamInfo)
        &&  prepareHw_PerFrame_EE(rIspInfo.rCamInfo)
        ...
        &&  prepareHw_PerFrame_MIXER3(rIspInfo.rCamInfo)
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.sl2f.disable", value, "1"); // 0: enable, 1: disable
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.isp.sl2g.disable", value, "1"); // 0: enable, 1: disable
    MBOOL bDisable = atoi(value);
...
prepareHw_PerFrame_LSC_2(const ISP_INFO_T& rIspInfo)
{
    ...
    if (fgLsc2En && rIspInfo.rLscData.size())
    {
        ...
        else
        {
            ...
            if (m_pLscMgr->getRawSize((ESensorMode_T) rIspInfo.rCamInfo.eSensorMode, u4W, u4H))
            {
                ...
                m_pLscMgr->syncTbl(rTbl, ILscMgr::LSC_P2);
                                //Add profile
                if(rIspInfo.strFileNamePrefix.size())
                {
                    std::string strFile = rIspInfo.strFileNamePrefix +"-"+ std::to_string(profile);
                    if(m_pLscMgr->setDumbFilePrefix(strFile, ILscMgr::LSC_P2) == MFALSE)
                    {
                        CAM_LOGE("[%s] setDumbFilePrefix is not unsupported", __FUNCTION__);
                    }
                }
                else
                    CAM_LOGE("[%s] NamePrefixSize(%d)", __FUNCTION__, rIspInfo.strFileNamePrefix.size());
        ...
        fgLsc2En = (profile != EIspProfile_N3D_Denoise) && (profile != EIspProfile_N3D_Denoise_toGGM) && (profile != EIspProfile_N3D_HighRes);
...
prepareHw_PerFrame_UDM(const RAWIspCamInfo& rIspCamInfo)
{
        ...
        &&m_pIspTuningCustom->is_to_invoke_isp_interpolation(rIspCamInfo))
    {
              if ( rIspCamInfo.eIdx_ISO_L != rIspCamInfo.eIdx_ISO_U || rIspCamInfo.eIdx_Zoom_L != rIspCamInfo.eIdx_Zoom_U)
              {
                  ...
                  m_ISP_INT.sUdm.u2UpperIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_U, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).UDM;
                  m_ISP_INT.sUdm.u2LowerIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_L, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).UDM;
...
prepareHw_PerFrame_CCM(const RAWIspCamInfo& rIspCamInfo)
{
    ...
    if ((bDisable) ||
        ...
        if(((rIspCamInfo.eColorCorrectionMode != MTK_COLOR_CORRECTION_MODE_TRANSFORM_MATRIX) && (!rIspCamInfo.rAWBInfo.bAWBLock)) ||
            ...
            (rIspCamInfo.eIspProfile == EIspProfile_MFNR_Before_Blend)    ||
            (rIspCamInfo.eIspProfile == EIspProfile_zHDR_Capture_MFNR_Before_Blend)  ||
            (rIspCamInfo.eIspProfile == EIspProfile_MFNR_Before_ZOOM1)  ||
            (rIspCamInfo.eIspProfile == EIspProfile_MFNR_Before_ZOOM2))
        {
            // Dynamic CCM
            if (isDynamicCCM())
            {
    ...
    )
    {
            ...
            &&m_pIspTuningCustom->is_to_invoke_isp_interpolation(rIspCamInfo))
        {
              if ( rIspCamInfo.eIdx_ISO_L != rIspCamInfo.eIdx_ISO_U || rIspCamInfo.eIdx_Zoom_L != rIspCamInfo.eIdx_Zoom_U)
              {
                  ...
                  m_ISP_INT.sAnr.u2UpperIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_U, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).ANR;
                  m_ISP_INT.sAnr.u2LowerIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_L, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).ANR;
        ...
        (!(m_pFeatureCtrl[rIspCamInfo.eIspProfile] & M_ANR2_EN)))
    {
            ...
            &&m_pIspTuningCustom->is_to_invoke_isp_interpolation(rIspCamInfo))
        {
              if ( rIspCamInfo.eIdx_ISO_L != rIspCamInfo.eIdx_ISO_U || rIspCamInfo.eIdx_Zoom_L != rIspCamInfo.eIdx_Zoom_U)
              {
                  ...
                  m_ISP_INT.sAnr2.u2UpperIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_U, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).ANR2;
                  m_ISP_INT.sAnr2.u2LowerIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_L, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).ANR2;
...
prepareHw_PerFrame_HFG(const RAWIspCamInfo& rIspCamInfo)
{
    ...
    if ((bDisable) ||(!rHfg.isCCTEnable()) ||
        (rIspCamInfo.eControlMode == MTK_CONTROL_MODE_OFF) ||
        (!(m_pFeatureCtrl[rIspCamInfo.eIspProfile] & M_HFG_EN)))
    {
            ...
            &&m_pIspTuningCustom->is_to_invoke_isp_interpolation(rIspCamInfo))
        {
              if ( rIspCamInfo.eIdx_ISO_L != rIspCamInfo.eIdx_ISO_U || rIspCamInfo.eIdx_Zoom_L != rIspCamInfo.eIdx_Zoom_U)
              {
                  ...
                  m_ISP_INT.sHfg.u2UpperIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_U, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).HFG;
                  m_ISP_INT.sHfg.u2LowerIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_L, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).HFG;
        ...
        (!(m_pFeatureCtrl[rIspCamInfo.eIspProfile] & M_EE_EN)) )
    {
            ...
            &&m_pIspTuningCustom->is_to_invoke_isp_interpolation(rIspCamInfo))
        {
              if ( rIspCamInfo.eIdx_ISO_L != rIspCamInfo.eIdx_ISO_U || rIspCamInfo.eIdx_Zoom_L != rIspCamInfo.eIdx_Zoom_U)
              {
                  ...
                  m_ISP_INT.sEe.u2UpperIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_U, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).EE;
                  m_ISP_INT.sEe.u2LowerIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_L, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).EE;
...
prepareHw_PerFrame_NR3D(const RAWIspCamInfo& rIspCamInfo)
{
        ...
        &&m_pIspTuningCustom->is_to_invoke_isp_interpolation(rIspCamInfo))
    {
              if ( rIspCamInfo.eIdx_ISO_L != rIspCamInfo.eIdx_ISO_U || rIspCamInfo.eIdx_Zoom_L != rIspCamInfo.eIdx_Zoom_U)
          {
                  ...
                  m_ISP_INT.sNr3d.u2UpperIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_U, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).NR3D;
                  m_ISP_INT.sNr3d.u2LowerIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_L, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).NR3D;
    ...
    m_pIspTuningCustom->adaptive_NR3D_setting(rIspCamInfo, NR3D_SW_Params, nr3d, GMVLevelTh);
...
prepareHw_PerFrame_COLOR(const RAWIspCamInfo& rIspCamInfo)
{
    ...
    if ((bDisable) || (!rNr3d.isCCTColorEnable()) ||
    ...
    CAM_LOGD_IF(m_bDebugEnable, "[%s] fgRPGEnable(%d)", __FUNCTION__, fgRPGEnable);
         ...
         &&m_pIspTuningCustom->is_to_invoke_isp_interpolation(rIspCamInfo))
     {
           if ( rIspCamInfo.eIdx_ISO_L != rIspCamInfo.eIdx_ISO_U || rIspCamInfo.eIdx_Zoom_L != rIspCamInfo.eIdx_Zoom_U)
           {
               ...
               m_ISP_INT.sMfb.u2UpperIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_U, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).MFB;
               m_ISP_INT.sMfb.u2LowerIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_L, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).MFB;
...
prepareHw_PerFrame_MIXER3(const RAWIspCamInfo& rIspCamInfo)
{
        ...
        &&m_pIspTuningCustom->is_to_invoke_isp_interpolation(rIspCamInfo))
    {
          if ( rIspCamInfo.eIdx_ISO_L != rIspCamInfo.eIdx_ISO_U || rIspCamInfo.eIdx_Zoom_L != rIspCamInfo.eIdx_Zoom_U)
          {
              ...
              m_ISP_INT.sMix3.u2UpperIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_U, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).MIXER3;
              m_ISP_INT.sMix3.u2LowerIso_LowerZoom = getISPIndex_byISOIdx(rIspCamInfo.eIdx_ISO_L, rIspCamInfo.eIdx_Zoom_L, rIspCamInfo).MIXER3;
