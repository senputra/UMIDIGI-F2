...
private:    //// ISP feature control
    ...
    MVOID   setIspOnOff_BNR_BPC(MBOOL const fgOn);
    MVOID   setIspOnOff_BNR_NR1(MBOOL const fgOn);
    MVOID   setIspOnOff_BNR_PDC(MBOOL const fgOn);
    ...
    MBOOL   getIspOnOff_BNR_BPC() const;
    MBOOL   getIspOnOff_BNR_NR1() const;
    MBOOL   getIspOnOff_BNR_PDC() const;
...
private:    ////    NVRAM buffer.
    ...
    ISP_NVRAM_COLOR_TABLE_STRUCT&   m_rISPColorTbl;
...
public:
    ...
    //
    MINT32 setCctImpObj(AcdkCctBase *a_pAcdkCctBaseObj);
    //
