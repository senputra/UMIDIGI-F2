...
LOCAL_MODULE := lib3a_isp40_hal3_headers
...
ifneq (,$(filter $(strip $(TARGET_BOARD_PLATFORM)), mt6765))
    ...
    include $(MTKCAM_3A_PLATFORM_PATH)/Android.mk
else
    ...
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/awb_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/pd_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/laser_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/ae_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/flash_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/isp_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/isp_tuning
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/isp_tuning/paramctrl/inc
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/isp_tuning/paramctrl/pca_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/isp_tuning/paramctrl/ccm_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/isp_tuning/paramctrl/ggm_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/isp_tuning/paramctrl/gma_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/isp_tuning/paramctrl/lce_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/isp_interpolation
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/lsc_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/sensor_mgr
    ...
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/cct_svr
    ...
    #### Include
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/af_mgr
    LOCAL_C_INCLUDES += $(MTKCAM_3A_IP_PATH)/lens
    ...
    LOCAL_HEADER_LIBRARIES += lib3a_isp40_hal3_headers
