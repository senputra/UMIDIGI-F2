...
put(ISP_NVRAM_LCE_T const& rParam)
{
    ...
    difference[0] = rParam.tm_para4.bits.LCE_TC_O1   - rParam.tm_para1.bits.LCE_TC_P1 ;
    difference[1] = rParam.tm_para4.bits.LCE_TC_O50  - rParam.tm_para2.bits.LCE_TC_P50;
    difference[2] = rParam.tm_para5.bits.LCE_TC_O500 - rParam.tm_para2.bits.LCE_TC_P500 ;
    difference[3] = rParam.tm_para5.bits.LCE_TC_O950 - rParam.tm_para3.bits.LCE_TC_P950 ;
    difference[4] = rParam.tm_para6.bits.LCE_TC_O999 - rParam.tm_para3.bits.LCE_TC_P999 ;
    ...
    m_LCE_Gain = (pow(10,(Max/1024.0f)) * 1000.0f);
