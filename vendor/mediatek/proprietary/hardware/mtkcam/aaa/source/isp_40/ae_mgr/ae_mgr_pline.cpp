...
MRESULT AeMgr::setManualAETable(MUINT32 a_AEPreTableID, MUINT32 a_AECapTableID)
{
    ...
    switch(a_AEPreTableID)
    {
        ...
        case AE_PLINE_SM240FPS:
            ePreviewPLineTableID = AETABLE_HIGH_FPS_240;
            break;
        ...
        case AE_PLINE_STEREO_VIDEO:
            ...
            break;
        case AE_PLINE_SM120FPS:
            ePreviewPLineTableID = AETABLE_HIGH_FPS_120;
            break;
        default:
            AE_LOG("[%s()] The Preview AE table enum value is incorrect:%d\n", __FUNCTION__, a_AEPreTableID);
    ...
    switch(a_AECapTableID)
    {
        case AE_PLINE_EISRECORD:
            ...
            break;
        case AE_PLINE_SM240FPS:
            eCapturePLineTableID = AETABLE_HIGH_FPS_240;
            break;
        case AE_PLINE_STEREO_PREVIEW:
        ...
        case AE_PLINE_STEREO_VIDEO:
            ...
            break;
        case AE_PLINE_SM120FPS:
            eCapturePLineTableID = AETABLE_HIGH_FPS_120;
            break;
        default:
            AE_LOG("[%s()] The Capture AE table enum value is incorrect:%d\n", __FUNCTION__, a_AECapTableID);
    ...
    {
        ePreviewPLineTableID = m_pPreviewTableCurrent->eID;
        AE_LOG("[%s()] The Preview Manual AE table doesn't exist:%d->%d\n", __FUNCTION__, ePreviewPLineTableID, m_pPreviewTableCurrent->eID);
    }
    if (!bNewCapturePLineTableID)
    {
        eCapturePLineTableID = m_pCaptureTable->eID;
        AE_LOG("[%s()] The Capture Manual AE table doesn't exist:%d->%d\n", __FUNCTION__, eCapturePLineTableID, m_pCaptureTable->eID);
    }
