...
{
public:
    static GmaMgr* createInstance(ESensorDev_T const eSensorDev, ISP_NVRAM_TONEMAP_PARAM_T& rIspNvramReg, ISP_NVRAM_GMA_TUNING_PARAM_T* pIspNvramGmaPara);
...
private:
    ...
    ISP_NVRAM_TONEMAP_PARAM_T& m_rIspNvramReg;
    ESensorDev_T m_eSensorDev;
    ISP_NVRAM_GMA_TUNING_PARAM_T* m_pIspNvramGmaPara;
    MTKGma* m_pGmaAlgo;
    MTK_GMA_ENV_INFO_STRUCT mEnv;
    MTK_GMA_NVRAM_PARAM_T mGMA_Normal_Tbl;
    MTK_GMA_NVRAM_PARAM_T mGMA_HDR_Tbl;
    ...
    MINT32 mLogEn;
    MINT32 mAlgoEn;
    eMTKGMA_TUNING_SET_T m_ePrev_Tuning_Set;
    MBOOL mfgGMA_HDR;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    GmaMgr(ESensorDev_T const eSensorDev, ISP_NVRAM_TONEMAP_PARAM_T& rIspNvramReg, ISP_NVRAM_GMA_TUNING_PARAM_T* pIspNvramGmaPara);
