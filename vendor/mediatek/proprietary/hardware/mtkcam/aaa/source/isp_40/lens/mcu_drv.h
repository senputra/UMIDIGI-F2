...
enum {
    ...
    MCU_CMD_SET_SOF_TS     = 0x1000,
    MCU_CMD_SET_AFO_TS     = 0x1001,
};
...
typedef struct {
    ...
    MUINT64      u8SofTimestamp; // Unit : us
    MUINT64      u8AfoTimestamp; // Unit : us
} mcuMotorInfo;
...
private:
    ...
    MUINT64 m_SofTS; // Unit : us
    MUINT64 m_AfoTS; // Unit : us
