...
public:
    ...
    virtual MVOID      start(MVOID* pAInput) {(void)pAInput;}
    virtual MVOID      stop() {}
    ...
    virtual MVOID      updateSensor(MVOID* input) {(void)input;}
    virtual MVOID      updateSensorFast(MVOID* input) {(void)input;}
    virtual MVOID      updateSensorGain(MVOID* input) {(void)input;}
    virtual MVOID      updateSensorExp(MVOID* input) {(void)input;}
    virtual MVOID      updateISP(MVOID* input) {(void)input;}
