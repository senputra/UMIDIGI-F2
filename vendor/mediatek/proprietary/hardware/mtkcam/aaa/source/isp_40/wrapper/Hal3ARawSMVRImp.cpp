...
config(const ConfigInfo_T& rConfigInfo)
{
    ...
    MUINT32 u4OBCNVRAMIndex = m_pIdxMgr->query(static_cast<MUINT32>(m_i4SensorDev), NSIspTuning::EModule_OBC, rMapping_Info, __FUNCTION__);
...
#if MTK_CAM_NEW_NVRAM_SUPPORT
    m_pIdxMgr->getMappingInfo(static_cast<MUINT32>(m_i4SensorDev), rMapping_Info, m_rParam.i4MagicNum);
    MUINT32 u4AWBNVRAMIndex = m_pIdxMgr->query(static_cast<MUINT32>(m_i4SensorDev), NSIspTuning::EModule_AWB, rMapping_Info, __FUNCTION__);
...
#if MTK_CAM_NEW_NVRAM_SUPPORT
    m_pIdxMgr->getMappingInfo(static_cast<MUINT32>(m_i4SensorDev), rMapping_Info, m_rParam.i4MagicNum);
    MUINT32 u4FlashAENVRAMIndex = m_pIdxMgr->query(static_cast<MUINT32>(m_i4SensorDev), NSIspTuning::EModule_Flash_AE, rMapping_Info, __FUNCTION__);
    MUINT32 u4FlashAWBNVRAMIndex = m_pIdxMgr->query(static_cast<MUINT32>(m_i4SensorDev), NSIspTuning::EModule_Flash_AWB, rMapping_Info, __FUNCTION__);
    MUINT32 u4FlashCaliNVRAMIndex = m_pIdxMgr->query(static_cast<MUINT32>(m_i4SensorDev), NSIspTuning::EModule_Flash_Calibration, rMapping_Info, __FUNCTION__);
    ...
    // AF start
#if MTK_CAM_NEW_NVRAM_SUPPORT
    m_pIdxMgr->getMappingInfo(static_cast<MUINT32>(m_i4SensorDev), rMapping_Info, m_rAfParam.i4MagicNum);
    MUINT32 u4AFNVRAMIndex = m_pIdxMgr->query(static_cast<MUINT32>(m_i4SensorDev), NSIspTuning::EModule_AF, rMapping_Info, __FUNCTION__);
...
/*    IspTuningMgr::getInstance().setIspUserIdx_Bright(m_i4SensorDev, rNewParam.i4BrightnessMode);
    ...
    if (bUpdateScenario){
        CAM_IDX_QRY_COMB rMapping_Info;
        m_pIdxMgr->getMappingInfo(static_cast<MUINT32>(m_i4SensorDev), rMapping_Info, rNewParam.i4MagicNum);
        MUINT32 u4AENVRAMIndex = m_pIdxMgr->query(static_cast<MUINT32>(m_i4SensorDev), NSIspTuning::EModule_AE, rMapping_Info, __FUNCTION__);
        MUINT32 u4AWBNVRAMIndex = m_pIdxMgr->query(static_cast<MUINT32>(m_i4SensorDev), NSIspTuning::EModule_AWB, rMapping_Info, __FUNCTION__);
        MUINT32 u4AFNVRAMIndex = m_pIdxMgr->query(static_cast<MUINT32>(m_i4SensorDev), NSIspTuning::EModule_AF, rMapping_Info, __FUNCTION__);
        MUINT32 u4FlashAENVRAMIndex = m_pIdxMgr->query(static_cast<MUINT32>(m_i4SensorDev), NSIspTuning::EModule_Flash_AE, rMapping_Info, __FUNCTION__);
        ...
        CAM_LOGD_IF(m_3ALogEnable, "[%s] NVRAM Index AE(%d) AWB(%d) AF(%d) F_AE(%d) F_AWB(%d) F_Cali(%d) OBC(%d)",
                        __FUNCTION__, u4AENVRAMIndex, u4AWBNVRAMIndex, u4AFNVRAMIndex, u4FlashAENVRAMIndex, u4FlashAWBNVRAMIndex, u4FlashCaliNVRAMIndex, u4OBCNVRAMIndex);
    }
#else
...
updateTGInfo()
{
    ...
    CAM_LOGD_IF(m_3ALogEnable, "[%s] TG size(%d,%d), i4SensorDevId(%d)", __FUNCTION__, m_i4TgWidth, m_i4TgHeight, i4SensorDevId);
...
#else
            CAM_LOGW("[%s] unsupport cmd (%d)", __FUNCTION__, e3ACtrl);
#endif
            break;
