 ...
 */
#ifndef _MTK_HARDWARE_MTKCAM_PIPELINE_EXTENSION_DCMF_IMP_H_
#define _MTK_HARDWARE_MTKCAM_PIPELINE_EXTENSION_DCMF_IMP_H_
...
//
#include "controller/BaseDCCtrler.h"
...
// class DCMFVendorImp.
class DCMFVendorImp
    : public virtual DCMFVendor // implement DCMFVendor
...
public:
    // Controller type
    typedef BaseDCCtrler CtrlerType;
...
protected:
    ...
    std::shared_ptr<CtrlerType> getCtrler(CTRLER u, NSCamFeature::NSFeaturePipe::NSDCMF::DualCamMFType mode);
    ...
    bool                        updateAppSettings(
                                    IMetadata* appMeta,
                                    MINT32 openId,
                                    NSCamFeature::NSFeaturePipe::NSDCMF::DualCamMFType featureMode,
                                    MINT32 shotIndex,
                                    MINT32& rEV);
    ...
    static inline void store_app_setting(NSCam::IMetadata* pAppMeta, BaseDCCtrler* ctrler);
...
public:
    ...
    DCMFVendorImp(const DCMFVendorImp&) = delete;
    DCMFVendorImp(DCMFVendorImp&&) = delete;

    virtual ~DCMFVendorImp();
public:
// static
    static wp<DCMFVendor> mThis;
    static sp<NSCamFeature::NSFeaturePipe::NSDCMF::IDualCamMFPipe> gspFeaturePipe;
...
private:
    ...
    _DualCamMFType mFeatureMode  = _DualCamMFType::TYPE_DCMF_unknown;
};

} // namespace plugin
} // namespace NSCam
#endif // _MTK_HARDWARE_MTKCAM_PIPELINE_EXTENSION_DCMF_IMP_H_
