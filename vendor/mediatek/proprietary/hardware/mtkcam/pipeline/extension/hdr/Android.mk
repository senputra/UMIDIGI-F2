...
# generate libcam.extension.hdr if only if MTK_CAM_HDR_SUPPORT defined
ifneq ($(strip $(MTK_CAM_HDR_SUPPORT)),0)
# -----------------------------------------------------------------------------
# Source code
# -----------------------------------------------------------------------------
LOCAL_SRC_FILES += HDRImp.cpp
LOCAL_SRC_FILES += HDRVendorFactory.cpp
LOCAL_SRC_FILES += controller/HDRCtrler.cpp
#!++ add for DataCollection
LOCAL_SRC_FILES += CollectImp.cpp
#!-- add for DataCollection
...
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/aaa/$(MTK_CAM_SW_VERSION) # workaround aaa
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/$(MTK_CAM_SW_VERSION) # CUSTOM (platform)
...
# -----------------------------------------------------------------------------
LOCAL_MODULE := libcam.extension.hdr
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
LOCAL_MODULE_TAGS := optional
include $(MTK_STATIC_LIBRARY)

endif # ifneq MTK_CAM_HDR_SUPPORT
