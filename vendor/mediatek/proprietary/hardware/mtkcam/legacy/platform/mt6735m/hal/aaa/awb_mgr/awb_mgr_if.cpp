...
MBOOL
IAwbMgr::
cameraPreviewInit(MINT32 i4SensorDev, MINT32 /*i4SensorDev_same*/, MINT32 i4SensorIdx)
{
    MBOOL ret_main, ret_sub, ret_main2;
    ret_main = ret_sub = ret_main2 = MTRUE;

    if (i4SensorDev & ESensorDev_Main)
        ret_main = AwbMgr::getInstance(ESensorDev_Main).cameraPreviewInit(i4SensorDev, i4SensorIdx);
    if (i4SensorDev & ESensorDev_Sub)
        ret_sub = AwbMgr::getInstance(ESensorDev_Sub).cameraPreviewInit(i4SensorDev, i4SensorIdx);
    if (i4SensorDev & ESensorDev_MainSecond)
        ret_main2 = AwbMgr::getInstance(ESensorDev_MainSecond).cameraPreviewInit(i4SensorDev, i4SensorIdx);
...
camcorderPreviewInit(MINT32 i4SensorDev, MINT32 i4SensorIdx, Param_T &rParam)
{
    ...
    if (i4SensorDev & ESensorDev_Main)
        ret_main = AwbMgr::getInstance(ESensorDev_Main).camcorderPreviewInit(i4SensorDev, i4SensorIdx);
    if (i4SensorDev & ESensorDev_Sub)
        ret_sub = AwbMgr::getInstance(ESensorDev_Sub).camcorderPreviewInit(i4SensorDev, i4SensorIdx);
    if (i4SensorDev & ESensorDev_MainSecond)
        ret_main2 = AwbMgr::getInstance(ESensorDev_MainSecond).camcorderPreviewInit(i4SensorDev, i4SensorIdx);
...
IAwbMgr::getColorCorrectionGain(MINT32 const i4SensorDev, MFLOAT& fGain_R, MFLOAT& fGain_G, MFLOAT& fGain_B)
{
    ...
    MY_ERR("Err IAwbMgr::getColorCorrectionGain()\n");
...
IAwbMgr::setColorCorrectionGain(MINT32 const i4SensorDev, MFLOAT fGain_R, MFLOAT fGain_G, MFLOAT fGain_B)
{
    ...
    MY_ERR("Err IAwbMgr::setColorCorrectionGain()\n");
...
IAwbMgr::getAWBState(MINT32 const i4SensorDev, mtk_camera_metadata_enum_android_control_awb_state_t& eAWBState)
{
    ...
    MY_ERR("Err IAwbMgr::getAWBState()\n");
...
IAwbMgr::setColorCorrectionMode(MINT32 const i4SensorDev, MINT32 i4ColorCorrectionMode)
{
    ...
    MY_ERR("Err IAwbMgr::setColorCorrectionMode()\n");
