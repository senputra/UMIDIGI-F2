...
AEBufMgr(ESensorDev_T const eSensorDev)
    ...
    , mfd(0)
{
    memset(&m_rHwBufList, 0, sizeof(BufInfoList_T));
    memset(&m_rAAOBufInfo, 0, MAX_AAO_BUFFER_CNT*sizeof(BufInfo_T));
}
