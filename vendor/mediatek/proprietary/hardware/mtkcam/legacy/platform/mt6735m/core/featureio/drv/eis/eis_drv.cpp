...
MINT32 EisDrv::init()
{
    ...
    EIS_LOG("EisIMem : memID(%d),size(%u),virAdd(%p),phyAddr(%p)",mEisIMemInfo.memID,
                                                                  mEisIMemInfo.size,
                                                                  (void*)mEisIMemInfo.virtAddr,
                                                                  (void*)mEisIMemInfo.phyAddr);
    ...
    EIS_LOG("mISPRegAddr = %p",mISPRegAddr);
...
MVOID EisDrv::resetRegister()
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_CTL_SPARE3, EIS_DB_LD_SEL,0);

    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, PREP_DS_IIR_H, 1);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, PREP_DS_IIR_V, 1);

    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_NUM_HRP, 0);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_NUM_VRP, 0);

    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_AD_KNEE, 0);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_AD_CLIP, 0);

    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_NUM_HWIN, 0);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_NUM_VWIN, 0);

    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL2, PREP_GAIN_H, 0);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL2, PREP_GAIN_IIR_H, 3);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL2, PREP_FIR_H, 16);

    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL2, PREP_GAIN_IIR_V, 3);

    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_LMV_TH, LMV_TH_X_CENTER, 0);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_LMV_TH, LMV_TH_X_SOURROUND, 0);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_LMV_TH, LMV_TH_Y_CENTER, 0);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_LMV_TH, LMV_TH_Y_SURROUND, 0);

    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_MB_OFFSET, MB_OFFSET_H,0);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_MB_OFFSET, MB_OFFSET_V,0);

    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_MB_INTERVAL, MB_INTERVAL_H,0);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_MB_INTERVAL, MB_INTERVAL_V,0);
...
MVOID EisDrv::enableEIS(MBOOL a_Enable)
{
    ...
    if(a_Enable == MTRUE)   //enable
    {
        ...
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_CTL_CDP_DCM_DIS, EIS_DCM_DIS, 1);   // only need in MT6589

        #if 1    //disable this block if Af is ready
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_SGG_PGN, SGG_GAIN, 16);
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_SGG_GMR, SGG_GMR1, 31);
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_SGG_GMR, SGG_GMR2, 63);
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_SGG_GMR, SGG_GMR3, 127);
    ...
    else if(a_Enable == MFALSE)  //disable
    {
        ...
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_CTL_CDP_DCM_DIS, EIS_DCM_DIS, 0);  // only need in MT6589
    }
    else
    {
        EIS_ERR("wrong value");
...
MVOID EisDrv::setEISFilterDS(MINT32 a_DS)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, PREP_DS_IIR_H, (a_DS & 0x7));
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, PREP_DS_IIR_V, (a_DS & 0x7));
...
MVOID EisDrv::setRPNum(MINT32 a_RPNum_H, MINT32 a_RPNum_V)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_NUM_HRP, (a_RPNum_H & 0x1F));
    ...
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_NUM_VRP, (a_RPNum_V & 0xF));
...
void EisDrv::setADKneeClip(MINT32 a_Knee, MINT32 a_Clip)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_AD_KNEE, (a_Knee & 0xF));
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_AD_CLIP, (a_Clip & 0xF));
}
...
MVOID EisDrv::setMBNum(MINT32 a_MBNum_H, MINT32 a_MBNum_V)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_NUM_HWIN, (a_MBNum_H & 0x7));
    ...
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL1, ME_NUM_VWIN, (a_MBNum_V & 0xF));
...
MVOID EisDrv::setFilter_H(MINT32 a_Gain, MINT32 a_IIRGain, MINT32 a_FIRGain)
{
    ...
    {
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL2, PREP_GAIN_H, (a_Gain & 0x3));
    }
    ...
    {
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL2, PREP_GAIN_IIR_H, (a_IIRGain & 0x7));
    }
    ...
    {
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL2, PREP_FIR_H, (a_FIRGain & 0x3F));
    }
}
...
MVOID EisDrv::setFilter_V(MINT32 a_IIRGain)
{
    ...
    {
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL2, PREP_GAIN_IIR_V, (a_IIRGain & 0x7));
    }
}
...
MVOID EisDrv::setWRPEnable(MBOOL a_Enable)
{
    ...
    {
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL2, EIS_WRP_EN, (a_Enable & 0x1));
    }
}
...
MVOID EisDrv::setFirstFrame(MBOOL a_First)
{
    ...
    {
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_PREP_ME_CTRL2, EIS_FIRST_FRM, (a_First & 0x1));
    }
}
...
MVOID EisDrv::setLMV_TH(MINT32 a_Center_X, MINT32 a_Surrond_X, MINT32 a_Center_Y, MINT32 a_Surrond_Y)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_LMV_TH, LMV_TH_X_CENTER, (a_Center_X  & 0xFF));
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_LMV_TH, LMV_TH_X_SOURROUND, (a_Surrond_X & 0xFF));
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_LMV_TH, LMV_TH_Y_CENTER, (a_Center_Y  & 0xFF));
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_LMV_TH, LMV_TH_Y_SURROUND, (a_Surrond_Y & 0xFF));
}
...
MVOID EisDrv::setFLOffset(MINT32 a_FLOffset_H, MINT32 a_FLOffset_V)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_FL_OFFSET, FL_OFFSET_H, (a_FLOffset_H & 0xFFF));
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_FL_OFFSET, FL_OFFSET_V, (a_FLOffset_V & 0xFFF));
...
MVOID EisDrv::setMBOffset_H(MINT32 a_MBOffset_H)
{
    ...
    else
    {
        ...
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_MB_OFFSET, MB_OFFSET_H,(a_MBOffset_H & 0xFFF));
...
MVOID EisDrv::setMBOffset_V(MINT32 a_MBOffset_V)
{
    ...
    else
    {
        ...
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_MB_OFFSET, MB_OFFSET_V,(a_MBOffset_V & 0xFFF));
...
MVOID EisDrv::setMBInterval_H(MINT32 a_MBInterval_H)
{
    ...
    else
    {
        ...
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_MB_INTERVAL, MB_INTERVAL_H,(a_MBInterval_H & 0xFFF));
    }
}
...
MVOID EisDrv::setMBInterval_V(MINT32 a_MBInterval_V)
{
    ...
    else
    {
        ...
        ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_MB_INTERVAL, MB_INTERVAL_V, (a_MBInterval_V & 0xFFF));
    }
}
...
MVOID EisDrv::setEISImage(MINT32 a_ImgWidth, MINT32 a_ImgHeight)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_IMAGE_CTRL, WIDTH,(a_ImgWidth & 0x1FFF));
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EIS_IMAGE_CTRL, HEIGHT,(a_ImgHeight & 0x1FFF));
...
{
    EIS_LOG("VA(%p),PA(%p)", (void*)mEisIMemInfo.virtAddr, (void*)mEisIMemInfo.phyAddr);

    isp_reg_t *pEis = (isp_reg_t *)mISPRegAddr;

    ISP_WRITE_REG(pEis, CAM_EISO_BASE_ADDR, mEisIMemInfo.phyAddr);
    ISP_IOCTL_WRITE_BITS(m_pISPDrvObj, m_pISPDrvObj->getRegAddrMap(), CAM_EISO_XSIZE, XSIZE, EIS_MEMORY_SIZE-1); // fix number : 0x197(407)
}
...
MVOID EisDrv::getStatistic(EIS_STATISTIC_T *a_pEIS_Stat)
{
    ...
    for(MINT32 i = 0; i < EIS_MAX_WIN_NUM; ++i)
    {
        if(i != 0)
        {
            ...
            if(g_debugDump == 3)
            {
                EIS_LOG("1. i(%d),pEISOAddr(%p)",i,pEISOAddr);
            }
        }
