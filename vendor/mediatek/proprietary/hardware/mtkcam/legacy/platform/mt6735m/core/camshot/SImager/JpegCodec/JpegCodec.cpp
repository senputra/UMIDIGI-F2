...
)
{
    ...
    if (checkIfNeedImgTransform(rSrcBufInfo, rDstBufInfo, rROI, u4Rotation, u4Flip))
    {
        ...
        // (2). Encode
        encode(rTempImgBuf, rDstBufInfo, u4Quality, u4IsSOI, eCodecType, u4EncSize);
        //
        deallocMem(rTempMemBuf);
    }
    else
    {
        ret = encode(rSrcBufInfo, rDstBufInfo, u4Quality, u4IsSOI, eCodecType, u4EncSize);
    }
    return ret;
}
...
MBOOL
JpegCodec::
encode(ImgBufInfo const rSrcBufInfo, ImgBufInfo const rDstBufInfo, MUINT32 const u4Quality, MUINT32 const u4IsSOI, MUINT32 const eCodecType, MUINT32 &u4EncSize)
{
    FUNCTION_LOG_START;
    ...
    if (eImgFmt_YUY2 == rSrcBufInfo.eImgFmt)
    {
        ...
        pJpgEncoder->setSrcBufSize(rSrcBufInfo.u4Stride[0] * 2,rSrcBufInfo.u4BufSize, 0);
    }
    ...
    else if (eImgFmt_YV12 == rSrcBufInfo.eImgFmt)
    {
        pJpgEncoder->setEncSize(
                        rSrcBufInfo.u4ImgWidth,
                        rSrcBufInfo.u4ImgHeight,
                        JpgEncHal:: kENC_YV12_Format);
        pJpgEncoder->setSrcAddr(
                        (void *)rSrcBufInfo.u4BufVA,
                        (void *)(rSrcBufInfo.u4BufVA + rSrcBufInfo.u4ImgWidth * rSrcBufInfo.u4ImgHeight + rSrcBufInfo.u4ImgWidth * rSrcBufInfo.u4ImgHeight/4),
                        (void *)(rSrcBufInfo.u4BufVA + rSrcBufInfo.u4ImgWidth * rSrcBufInfo.u4ImgHeight));
        pJpgEncoder->setSrcBufSize(
                        rSrcBufInfo.u4Stride[0],
                        rSrcBufInfo.u4ImgWidth * rSrcBufInfo.u4ImgHeight,
                        rSrcBufInfo.u4ImgWidth * rSrcBufInfo.u4ImgHeight / 4,
                        rSrcBufInfo.u4ImgWidth * rSrcBufInfo.u4ImgHeight / 4);
    }
    else
    {
