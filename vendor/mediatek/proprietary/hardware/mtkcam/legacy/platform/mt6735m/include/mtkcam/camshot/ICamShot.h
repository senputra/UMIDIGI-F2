...
public:     ////    Settings.
    ...
    /**
     * @brief Turn on/off SwNR
     *
     * @details
     *
     * @note
     *
     * @param[in] enableSwNR: Do SwNR or not
     * @param[in] iso: The iso value       
     */
    virtual MVOID setSwNR(MBOOL enableSwNR) = 0;
    virtual MVOID setSwNR(MBOOL enableSwNR, MUINT32 iso) = 0;
