...
FdNodeImp::
ASDImp::
updateASD(MUINT8* pRGBImg __attribute__((unused)),
        MINT32 BufWidth __attribute__((unused)),
        MINT32 BufHeight __attribute__((unused)),
        MINT32 FaceNum __attribute__((unused)),
        ASDInfo* Result __attribute__((unused)))
{
    ...
    ////////////////////////////////////////////////////////////////////////////
    {
        ...
        //  Input Image Stream: YUV
        {
            ...
            MUINT const usage = eBUFFER_USAGE_SW_READ_OFTEN |
                ...
                ;
             MY_LOGW_IF(mLogLevel > 0, "[FIXME] lock usage %x" , usage);
...
//*********************************************************************//
    ...
    //if(1)
    {
       ...
       sprintf(szFileName, "/data/vendor/camera_dump/640x480_Y1_%d.raw", Count);
