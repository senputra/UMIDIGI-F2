...
{
    int ret = 0;
    LOG_MSG("[setTg2GrabRange] pixelStart = %ld, pixelEnd = %ld, lineStart = %ld, lineEnd = %ld\n",
		pixelStart, pixelEnd, lineStart, lineEnd);
/*    isp_reg_t *pisp = (isp_reg_t *) mpIspHwRegAddr;
...
{
    int ret = 0;
    LOG_MSG("[setSV1GrabRange] pixelStart = %lu, pixelEnd = %lu, lineStart = %lu, lineEnd = %lu\n",
	pixelStart, pixelEnd, lineStart, lineEnd);
 /*   isp_reg_t *pisp = (isp_reg_t *) mpIspHwRegAddr;
...
{
    int ret = 0;
    LOG_MSG("[setSV2GrabRange] pixelStart = %lu, pixelEnd = %lu, lineStart = %lu, lineEnd = %lu\n",
	pixelStart, pixelEnd, lineStart, lineEnd);
 /*   isp_reg_t *pisp = (isp_reg_t *) mpIspHwRegAddr;
...
)
{
    ...
    LOG_MSG("[setTg2ViewFinderMode] spMode = %lu\n", spMode);
...
)
{
    ...
    LOG_MSG("[setSV1ViewFinderMode] spMode = %lu\n", spMode);
  /*  isp_reg_t *pisp = (isp_reg_t *) mpIspHwRegAddr;
...
)
{
    ...
    LOG_MSG("[setSV2ViewFinderMode] spMode = %lu\n", spMode);
  /*  isp_reg_t *pisp = (isp_reg_t *) mpIspHwRegAddr;
...
int SeninfDrvImp::sendCommand(int cmd, unsigned long arg1, unsigned long arg2, unsigned long arg3)
{
    ...
    LOG_MSG("[sendCommand] cmd: 0x%x, arg1 = %lu, arg2 = %lu, arg3 = %lu\n",
		cmd, arg1, arg2, arg3);
    switch (cmd) {
    case CMD_SET_DEVICE:
        mDevice = arg1;
...
)
{
    int ret = 0;
   isp_reg_t *pisp = (isp_reg_t *) mpIspHwRegAddr;
   LOG_MSG("[setTg1Cfg] inDataType = %d, senInLsb = %d, twoPxlMode = %d\n"
   	, inDataType, senInLsb, twoPxlMode);
...
{
    int ret = 0;
    LOG_MSG("[setTg2Cfg] inDataType = %d, senInLsb = %d, twoPxlMode = %d\n"
	, inDataType, senInLsb, twoPxlMode);
...
{
    int ret = 0;
    LOG_MSG("[setSV1Cfg] inDataType = %d, senInLsb = %d, twoPxlMode = %d\n"
	, inDataType, senInLsb, twoPxlMode);
...
{
    int ret = 0;
    LOG_MSG("[setSV2Cfg] inDataType = %d, senInLsb = %d, twoPxlMode = %d\n"
	, inDataType, senInLsb, twoPxlMode);
...
int SeninfDrvImp::setN3DCfg(unsigned long n3dEn, unsigned long i2c1En, unsigned long i2c2En, unsigned long n3dMode, unsigned long diffCntEn, unsigned long diffCntThr)
{
    ...
    LOG_MSG("diffCntEn = %lu, diffCntThr = %lu\n", diffCntEn, diffCntThr);
