...
createBuffer()
{
    ...
    MY_LOGW_IF( mbufInfo.virtAddr & (L1_CACHE_BYTES-1), "bufAddr(%d) not aligned!", (int)mbufInfo.virtAddr);
    //
    MY_LOGD("CapBuffer + 0x%x(0x%x)", (unsigned int)mbufInfo.virtAddr, (unsigned int)mbufInfo.size);
    FUNCTION_OUT;
}
