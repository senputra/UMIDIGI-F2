...
public: //isp driver operation
    ...
    /**
      *@brief  Dump register
      */
    inline int dumpRegister( int mode ){mode;return (int)m_pPhyIspDrv->dumpReg();}
...
public:
    DMAI_B():dupCqIdx(0),burstQueIdx(0),CQ(CAM_ISP_CQ_NONE),sceID(0),cqTrigSrc(-1),cqTrigSrc_D(-1),isP2IspOnly(0),p2MdpSrcFmt(eImgFmt_YV12),p2MdpSrcW(0),p2MdpSrcH(0),p2MdpSrcYStride(0),p2MdpSrcUVStride(0),p2MdpSrcSize(0),p2MdpSrcCSize(0),p2MdpSrcVSize(0)
        {
...
public: /*[IspFunction_B]*/
    ...
    /**
      ...
      */
    virtual int checkBusy( unsigned long* param ){param;return 0;}
private: /*[IspFunction_B]*/
    ...
    /**
      *@brief  Enable
      */
    virtual int _enable( void* pParam ){pParam;return 0;}
