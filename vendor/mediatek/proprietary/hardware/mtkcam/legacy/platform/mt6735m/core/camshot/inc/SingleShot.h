...
public:     ////    Settings.
    ...
    virtual MVOID   setSwNR(MBOOL enableSwNR){ mbSwNR = enableSwNR; return; };
    virtual MVOID   setSwNR(MBOOL enableSwNR, MUINT32 iso){ mbSwNR = enableSwNR; mIso = iso; return; };
...
protected:    //// helper function
    ...
    ImgBufInfo querySwNRImgBufInfo();
...
private:
    ...
    MBOOL    _preAllocMem();
    MVOID    doSwNR(ImgBufInfo const & rDstImgBufInfo);
