...
#include <mtkcam/v3/hal/aaa_hal_cmd.h>
...
{
    E3ACtrl_Begin = 0,
    E3ACtrl_SetExposureParam    = 0x0000,
    // shading
    ...
    //
    E3ACtrl_GetExposureParam    = 0x1000,
    E3ACtrl_GetHdrCapInfo       = 0x1001,
    //
    E3ACtrl_Enable3ASetParams   = 0x2000,
    //
    E3ACtrl_Num
};
*/
