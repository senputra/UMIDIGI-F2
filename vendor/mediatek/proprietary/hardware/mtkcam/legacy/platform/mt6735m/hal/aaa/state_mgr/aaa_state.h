...
public:     //    Interfaces
    ...
    virtual MRESULT  sendIntent(intent2type<eIntent_PrecaptureStart>) {
            ...
            /*AEE_ASSERT_3A_STATE("3A_UNSUPPORT_COMMAND: PrecaptureStart");*///2189156
            return  E_3A_UNSUPPORT_COMMAND;
        }
    /**
...
struct StateAF : public IState
{
    ...
    MRESULT  sendAFIntent(intent2type<eIntent_VsyncUpdate>, state2type<eAFState_Flash>, MVOID* pBufInfo);
    MRESULT  sendAFIntent(intent2type<eIntent_AFUpdate>, state2type<eAFState_Flash>, MVOID* pBufInfo);
