                          ...
                          void *a_pCamCalData)
{
   ...
   // dumpEnable = 1; // Jessy add this, adb shell setprop camcaldrv.log cannot work
    ...
    CAM_CAL_DRV_LOG_IF(dumpEnable, "i4SensorDevId0x%8lx \n", i4SensorDevId);
        ...
        (a_pCamCalData == NULL) )
    {
        ...
        CAM_CAL_DRV_LOG_IF(dumpEnable,"i4SensorDevId(0x%8lx),a_eCamCalDataType(0x%8x),a_pCamCalData(%p) \n", i4SensorDevId, a_eCamCalDataType, (void *) a_pCamCalData);
    ...
    CAM_CAL_DRV_LOG_IF(dumpEnable, "Get the sensor id of sensor dev: %lu \n", i4SensorDevId);
