...
MBOOL Hal3A::set3AEXIFInfo(IBaseCamExif *pIBaseCamExif) const
{
    ...
    rCaptureInfo.u4Eposuretime = 0; // add initial value for Coverity
    rCaptureInfo.u4RealISO = 0; // add initial value for Coverity
...
MBOOL Hal3A::setDebugInfo(IBaseCamExif *pIBaseCamExif) const
{
    ...
    MY_LOG("AAA_DEBUG_INFO_T(%d)",(int)sizeof(AAA_DEBUG_INFO_T));
    ...
    MY_LOG("AE_DEBUG_INFO_T(%d) AF_DEBUG_INFO_T(%d) AWB_DEBUG_INFO_T(%d) FLASH_DEBUG_INFO_T(%d) FLICKER_DEBUG_INFO_T(%d) AWB_DEBUG_DATA_T(%d)",
            (int)sizeof(AE_DEBUG_INFO_T),
            (int)sizeof(AF_DEBUG_INFO_T),
            (int)sizeof(AWB_DEBUG_INFO_T),
            (int)sizeof(FLASH_DEBUG_INFO_T),
            (int)sizeof(FLICKER_DEBUG_INFO_T),
            (int)sizeof(AWB_DEBUG_DATA_T) );
