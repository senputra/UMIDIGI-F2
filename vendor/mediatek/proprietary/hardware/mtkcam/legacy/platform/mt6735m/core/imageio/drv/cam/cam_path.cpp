...
//SL TEST_MDP removed. Should no used        ret = this->DMADispo.config(); //SL
        ...
        ISP_PATH_DBG("[DISPO]base(0x%x)\n",(MUINT32)this->cdpPipe.dispo_out.memBuf.base_pAddr);
    ...
    if ( ISP_DMA_VIDO & dmaChannel ) {
        ...
        ISP_PATH_INF("[VIDO]base(0x%x)-0x%x-0x%x\n",(MUINT32)this->cdpPipe.vido_out.memBuf.base_pAddr,
                (MUINT32)this->cdpPipe.vido_out.memBuf_c.base_pAddr,(MUINT32)this->cdpPipe.vido_out.memBuf_v.base_pAddr);
