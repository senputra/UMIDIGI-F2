...
MBOOL AwbMgr::setAWBMode(MINT32 i4NewAWBMode)
{
    ...
    MY_LOG_IF(m_bDebugEnable,"i4NewAWBMode: %d\n", i4NewAWBMode);
...
{
    MY_LOG_IF(m_bDebugEnable,"[%d] bAWBLock: %d\n", m_eSensorDev, bAWBLock);
...
MRESULT AwbMgr::doPvAWB(MINT32 /*i4FrameCount*/, MBOOL bAEStable, MINT32 i4SceneLV, MVOID *pAWBStatBuf, MBOOL bApplyToHW)
{
    ...
    char value_debug[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.debug.awb_log.enable", value_debug, "0");
...
MBOOL AwbMgr::doCapAWB(MINT32 i4SceneLV, MVOID *pAWBStatBuf, MBOOL bApplyToHW)
{
    ...
    if(strlen(mEngFileName)!=0)
    {
        ...
        FILE* fp;
        char engStatFileName[300];
        if(rAWBInput.bIsStrobeFired == MTRUE)
        {
            sprintf(engStatFileName, "%s_AwbStatFlash.bin", mEngFileName);
            fp = fopen(engStatFileName, "wb");
            if(fp == NULL)
            {
            ...
            char engInfoFileName[300];
            sprintf(engInfoFileName, "%sAwbinfo.txt", mEngFileName);
            fp = fopen(engInfoFileName, "wb");
            if(fp == NULL)
            {
        ...
        {
            sprintf(engStatFileName, "%s_AwbStatNoFlash.bin", mEngFileName);
            fp = fopen(engStatFileName, "wb");
            if(fp == NULL)
            {
                MY_LOG("Open fptr2 fail!!");
...
#if 1
    MY_LOG_IF(m_bDebugEnable,"sizeof(m_pNVRAM_3A->SensorId) = %d\n", (int)sizeof(m_pNVRAM_3A->SensorId));
    MY_LOG_IF(m_bDebugEnable,"sizeof(m_pNVRAM_3A->rAENVRAM) = %d\n", (int)sizeof(m_pNVRAM_3A->rAENVRAM));
    MY_LOG_IF(m_bDebugEnable,"sizeof(m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx]) x 2 = %d\n", (int)sizeof(m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx]));
    MY_LOG_IF(m_bDebugEnable,"sizeof(m_pNVRAM_3A->rFlashAWBNVRAM) = %d\n", (int)sizeof(m_pNVRAM_3A->rFlashAWBNVRAM));
    MY_LOG_IF(m_bDebugEnable,"sizeof(m_pNVRAM_3A) = %d\n", (int)sizeof(*m_pNVRAM_3A));
#endif
...
MBOOL AwbMgr::getEEPROMData()
{
    ...
    {
        MY_LOG_IF(m_bDebugEnable,"NO err (%s)", CamCalErrString[enCamCalEnum]);
...
MBOOL AwbMgr::AWBStatConfig()
{
    ...
    for (sensorMode = ESensorMode_Preview; sensorMode < ESensorMode_NUM; sensorMode++)
    {
       ...
       for (awbMode = LIB3A_AWB_MODE_AUTO; awbMode < LIB3A_AWB_MODE_NUM; awbMode++)
        ...
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4RightBound = %d\n", m_eSensorDev, pAWBArea->rTungsten.i4RightBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4LeftBound = %d\n", m_eSensorDev, pAWBArea->rTungsten.i4LeftBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4LowerBound = %d\n", m_eSensorDev, pAWBArea->rTungsten.i4LowerBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4UpperBound = %d\n", m_eSensorDev, pAWBArea->rTungsten.i4UpperBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4RightBound = %d\n", m_eSensorDev, pAWBArea->rWarmFluorescent.i4RightBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4LeftBound = %d\n", m_eSensorDev, pAWBArea->rWarmFluorescent.i4LeftBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4LowerBound = %d\n", m_eSensorDev, pAWBArea->rWarmFluorescent.i4LowerBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4UpperBound = %d\n", m_eSensorDev, pAWBArea->rWarmFluorescent.i4UpperBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4RightBound = %d\n", m_eSensorDev, pAWBArea->rFluorescent.i4RightBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4LeftBound = %d\n", m_eSensorDev, pAWBArea->rFluorescent.i4LeftBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4LowerBound = %d\n", m_eSensorDev, pAWBArea->rFluorescent.i4LowerBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4UpperBound = %d\n", m_eSensorDev, pAWBArea->rFluorescent.i4UpperBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4RightBound = %d\n", m_eSensorDev, pAWBArea->rCWF.i4RightBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4LeftBound = %d\n", m_eSensorDev, pAWBArea->rCWF.i4LeftBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4LowerBound = %d\n", m_eSensorDev, pAWBArea->rCWF.i4LowerBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4UpperBound = %d\n", m_eSensorDev, pAWBArea->rCWF.i4UpperBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4RightBound = %d\n", m_eSensorDev, pAWBArea->rDaylight.i4RightBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4LeftBound = %d\n", m_eSensorDev, pAWBArea->rDaylight.i4LeftBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4LowerBound = %d\n", m_eSensorDev, pAWBArea->rDaylight.i4LowerBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4UpperBound = %d\n", m_eSensorDev, pAWBArea->rDaylight.i4UpperBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4RightBound = %d\n", m_eSensorDev, pAWBArea->rDaylightFluorescent.i4RightBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4LeftBound = %d\n", m_eSensorDev, pAWBArea->rDaylightFluorescent.i4LeftBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4LowerBound = %d\n", m_eSensorDev, pAWBArea->rDaylightFluorescent.i4LowerBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4UpperBound = %d\n", m_eSensorDev, pAWBArea->rDaylightFluorescent.i4UpperBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4RightBound = %d\n", m_eSensorDev, pAWBArea->rStrobe.i4RightBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4LeftBound = %d\n", m_eSensorDev, pAWBArea->rStrobe.i4LeftBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4LowerBound = %d\n", m_eSensorDev, pAWBArea->rStrobe.i4LowerBound);
        MY_LOG_IF(m_bDebugEnable,"[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4UpperBound = %d\n", m_eSensorDev, pAWBArea->rStrobe.i4UpperBound);
