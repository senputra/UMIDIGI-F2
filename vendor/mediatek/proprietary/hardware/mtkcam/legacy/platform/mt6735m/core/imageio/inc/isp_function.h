...
class IspDrv_B
{
    public:
        ...
        /**
             ...
             */
        IspDrv_B():
            m_pPhyIspDrv_bak(0x0),
            m_pPhyIspReg_bak(0x0),
            m_pCdpDrv(0x0),
            m_pTpipeDrv(0x0),
            m_pIMemDrv(0x0),
            m_pIspEventThread(0x0)
            {
                memset(m_pVirtIspDrv, 0x0, sizeof(m_pVirtIspDrv));
                memset(m_pVirtIspReg, 0x0, sizeof(m_pVirtIspReg));
            }
...
public:
    ...
    /**
      *@brief  Constructor
      */
    DMAO_B() {CQ = 0; dma_cfg.pixel_byte = 1;};
...
public:
    ...
    /**
      ...
      */
    virtual unsigned long reg_Base_Addr_Phy( void )     {   return (unsigned long)0x0;  }

    /**
      *@brief  Get register range
      */
    virtual unsigned long reg_Range( void )             {   return (unsigned long)0x0;  }
protected:
...
public:
    ...
    /**
      ...
      */
    ISP_RAW_PIPE():
        enable1(0),src_img_w(0),src_img_h(0),cdrz_in_w(0),CQ(CAM_ISP_CQ_NONE){};
