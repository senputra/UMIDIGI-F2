                                       ...
                                       MUINT32 dstImgH)
{
    ...
    ACDK_LOGD("srcImem : size(%u),vir(0x%x),phy(0x%x),mimID(%d)",srcImem.size,(int)srcImem.virtAddr,(int)srcImem.phyAddr,srcImem.memID);
    ACDK_LOGD("dstImem : size(%u),vir(0x%x),phy(0x%x),mimID(%d)",dstImem.size,(int)dstImem.virtAddr,(int)dstImem.phyAddr,dstImem.memID);
                                       ...
                                       MUINT32 a_Stride)
{
    ...
    ACDK_LOGD("srcImem : VA(0x%x),PA(0x%x),ID(%d),SZ(%u)", (int)srcImem.virtAddr,
                                                           (int)srcImem.phyAddr,
                                                           srcImem.memID,
                                                           srcImem.size);

    ACDK_LOGD("dstImem : VA(0x%x),PA(0x%x),ID(%d),SZ(%u)", (int)dstImem.virtAddr,
                                                           (int)dstImem.phyAddr,
                                                           dstImem.memID,
                                                           dstImem.size);
