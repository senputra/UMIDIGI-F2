...
do_validatePerFrame(MINT32 const i4FrameID)
{
    ...
    MY_LOG_IF(m_bDebugEnable, "[do_validatePerFrame] new");
	...
	else if (m_i4IspProfile == EIspProfile_NormalCapture_CC)
	{
	    m_rIspCamInfo.eIspProfile = EIspProfile_NormalCapture_CC;
	}
	else if (m_i4IspProfile == EIspProfile_ZsdPreview_CC)
	{
	    m_rIspCamInfo.eIspProfile = EIspProfile_ZsdPreview_CC;
	}
	else if (m_i4IspProfile == EIspProfile_ZsdPreview_NCC)
	{
	    m_rIspCamInfo.eIspProfile = EIspProfile_ZsdPreview_NCC;
	}
	else if (m_i4IspProfile == EIspProfile_NormalCapture_16M)
	{
	    m_rIspCamInfo.eIspProfile = EIspProfile_NormalCapture_16M;
	}
	else if (m_i4IspProfile == EIspProfile_VideoCapture)
	{
