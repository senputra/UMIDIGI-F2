...
onCmd_capture()
{
    ...
    //pthread_attr_t attr = {0, NULL, 1024 * 1024, 4096, SCHED_OTHER, 0/*ANDROID_PRIORITY_FOREGROUND*/};
    pthread_attr_t attr;
    struct sched_param pthread_param = {
            .sched_priority = 0/*ANDROID_PRIORITY_FOREGROUND*/
    };
...
requestBufs()
{
    ...
    if(mu4SourceSize< (MUINT32)(mShotParam.mi4PostviewWidth * mShotParam.mi4PostviewHeight * 2) )
