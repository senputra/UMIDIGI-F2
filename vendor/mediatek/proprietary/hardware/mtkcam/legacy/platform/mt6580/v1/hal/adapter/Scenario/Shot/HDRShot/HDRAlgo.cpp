    ...
    switch(mHdrRoundTotal) {
        case 1:
            ...
            for (MUINT32 i = 0; i < u4OutputFrameNum; i++)
            {
                ...
                rHdrPipeConfigParam.pSmallImgBufAddr[i] = (MUINT8*)mpSmallImgBuf[i].virtAddr;
            }
            break;
        case 2:
            ...
            for (MUINT32 i = 0; i < u4OutputFrameNum; i++)
            {
                rHdrPipeConfigParam.pSourceImgBufAddr[i] = (MUINT8*)mpFirstRunSourceImgBuf[i].virtAddr;
                rHdrPipeConfigParam.pSmallImgBufAddr[i] =(MUINT8*)mpSmallImgBuf[i].virtAddr;
            }
            break;
    }
