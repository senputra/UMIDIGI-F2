...
public:
     ...
     */
    MRESULT init(MINT32 eSensorDev, MINT32 i4SensorIdx);
    ...
    /**
     * @brief retrigger AF with flash on.
     */
    MRESULT retriggerAFWithFlashOn(MINT32 i4isTurnOn);
     ...
     */
    MINT32  getAFMaxAreaNum(MINT32 eSensorDev);
...
private:
    ...
    */
    ...
    static MVOID*  createSensorListenerThread(MVOID *arg);
    MVOID EnableGGyro();
...
private:
    ...
    MBOOL m_isTriggerAFS;
    MINT32 m_i4SearchDone;
    MINT32 mi4IsAFDoneFlg_cur;
    MINT32 mi4IsAFDoneFlg_pre;
    LIB3A_AF_MODE_T m_i4BackupAFModeWithFlash;
    MINT32 m_i4EnableBackupAFMode;

    MINT32 m_i4InitAFCmd;
    MINT32 m_i4AutoFocusCmd;
    MINT32 m_i4CancelAutoFocusCmd;
    MINT32 m_i4SetAFModeCmd;
    MINT32 m_i4ChangeSearchingState;
    MINT32 m_i4AuotoFocusInContiPicMode;
    MINT32 m_i4LockAFInContiMode;
    MINT32 m_i4IsAFAlgoSearchDone;
    MINT32 m_i4InactiveCntInContiPicMode;
    NS3A::EAfState_T m_eAFState;
    MINT32 m_i4AutoFocusInAutoMode;
    MINT32 m_i4TriggerAlgoInAutoMode;
    MINT32 m_i4AFPos;
