...
}RES_MGR_DRV_ITEM_ENUM;
//
typedef enum
{
    RES_MGR_DRV_CONTROL_BEFORE,
    RES_MGR_DRV_CONTROL_AFTER
...
class ResMgrDrv
{
    ...
    public:
        ...
        virtual MBOOL   setItem(RES_MGR_DRV_ITEM_ENUM item, MUINT32 value) = 0;
        virtual RES_MGR_DRV_CONTROL_ENUM queryCtrlType() = 0;
