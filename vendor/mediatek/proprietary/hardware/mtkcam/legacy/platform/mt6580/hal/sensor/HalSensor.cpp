...
SENSOR_DRIVER_SCENARIO_T g_ScenarioconfMain; /*LukeHu++150410=For ESD*/
SENSOR_DRIVER_SCENARIO_T g_ScenarioconfSub;    /*LukeHu++150410=For ESD*/
SENSOR_DRIVER_SCENARIO_T g_ScenarioconfMain2;/*LukeHu++150410=For ESD*/
...
)
{
    ...
    if (mpSensorDrv) {
        ...
        if( sensorDev & SENSOR_DEV_SUB) {//sub cam power off  reset cal flag for scam
            MY_LOGD("!!!scam clear calibration flag %d\n");
            best_delay_value = -1;
