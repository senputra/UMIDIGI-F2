...
class IspDrv_B
{
    public:
        ...
        IspDrv_B():
            ...
            {
                for(int j=0;j<ISP_DRV_CQ_NUM;j++)
                {
                    m_pVirtIspDrv[j] = NULL;
                    m_pVirtIspReg[j] = NULL;
                }
            }
...
public:
    ...
    ISP_TOP_CTRL():
        ...
        isIspOn(0)
        {
            ...
            en_Top.dma=0;
            ctl_int.int_en=0;
            ctl_int.int_status=0;
            ctl_int.dma_int=0;
            ctl_int.intb_en=0;
            ctl_int.intb_status=0;
            ctl_int.dmab_int=0;
            ctl_int.intc_en=0;
            ctl_int.intc_status=0;
            ctl_int.dmac_int=0;
            ctl_int.int_statusx=0;
            ctl_int.dma_intx=0;
        };
