    ...
    if (m_pIspTuningCustom->is_to_invoke_isp_interpolation(m_rIspCamInfo)) {
        if (m_rIspCamInfo.u4ISOValue >= m_pIspTuningCustom->map_ISO_index_to_value(m_rIspCamInfo.eIdx_ISO)) {
             if (m_rIspCamInfo.eIdx_ISO < eIDX_ISO_3200) {
                ...
                m_rIspCamInfo.rIspIntInfo.u2CfaUpperIdx = (m_IspNvramMgr.getIdx_CFA() == (IspNvramMgr::NUM_CFA - 1)) ? m_IspNvramMgr.getIdx_CFA() : m_IspNvramMgr.getIdx_CFA()+1;
             ...
             if (m_rIspCamInfo.eIdx_ISO > eIDX_ISO_100) {
                ...
                m_rIspCamInfo.rIspIntInfo.u2CfaLowerIdx = (m_IspNvramMgr.getIdx_CFA() == 0) ? m_IspNvramMgr.getIdx_CFA() : m_IspNvramMgr.getIdx_CFA()-1;
    ...
    if (m_pIspTuningCustom->is_to_invoke_isp_interpolation(m_rIspCamInfo)) {
         if (m_rIspCamInfo.u4ISOValue >= m_pIspTuningCustom->map_ISO_index_to_value(m_rIspCamInfo.eIdx_ISO)) {
             if (m_rIspCamInfo.eIdx_ISO < eIDX_ISO_3200) {
                ...
                m_rIspCamInfo.rIspIntInfo.u2AnrUpperIdx = (m_IspNvramMgr.getIdx_ANR() == (IspNvramMgr::NUM_ANR - 1)) ? m_IspNvramMgr.getIdx_ANR() : m_IspNvramMgr.getIdx_ANR()+1;
             ...
             if (m_rIspCamInfo.eIdx_ISO > eIDX_ISO_100) {
                ...
                m_rIspCamInfo.rIspIntInfo.u2AnrLowerIdx = (m_IspNvramMgr.getIdx_ANR() == 0) ? m_IspNvramMgr.getIdx_ANR() : m_IspNvramMgr.getIdx_ANR()-1;
	...
	if (m_pIspTuningCustom->is_to_invoke_isp_interpolation(m_rIspCamInfo)) {
         if (m_rIspCamInfo.u4ISOValue >= m_pIspTuningCustom->map_ISO_index_to_value(m_rIspCamInfo.eIdx_ISO)) {
             if (m_rIspCamInfo.eIdx_ISO < eIDX_ISO_3200) {
                ...
                m_rIspCamInfo.rIspIntInfo.u2EEUpperIdx = (m_IspNvramMgr.getIdx_EE() == (IspNvramMgr::NUM_EE - 1)) ? m_IspNvramMgr.getIdx_EE() : m_IspNvramMgr.getIdx_EE()+1;
             ...
             if (m_rIspCamInfo.eIdx_ISO > eIDX_ISO_100) {
                ...
                m_rIspCamInfo.rIspIntInfo.u2EELowerIdx = (m_IspNvramMgr.getIdx_EE() == 0) ? m_IspNvramMgr.getIdx_EE() : m_IspNvramMgr.getIdx_EE()-1;
