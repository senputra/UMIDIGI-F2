...
*/    //
    ...
    public:     //// constructors.
        ...
        ):scenario(0),isMdpCropEn(0),CQ(0),tpipe(0),tcm_en(0),isIspOn(0),isConcurrency(0),isEn1C24StatusFixed(0),
          isEn1C02StatusFixed(0),isEn1CfaStatusFixed(0),isEn1HrzStatusFixed(0),isEn1MfbStatusFixed(0),isEn2CdrzStatusFixed(0),
          isEn2G2cStatusFixed(0),isEn2C42StatusFixed(0),isImg2oStatusFixed(0),isImgoStatusFixed(0),isAaoStatusFixed(0),
          isEsfkoStatusFixed(0),isFlkiStatusFixed(0),isLcsoStatusFixed(0),isEn1AaaGropStatusFixed(0),isApplyTurn(0),
          isShareDmaCtlByTurn(0),bypass_ispRawPipe(0),bypass_ispRgbPipe(0),bypass_ispYuvPipe(0),bypass_ispCdpPipe(0),pix_id(0)
        {
			...
			memset(&en_Top, 0, sizeof(en_Top));
            memset(&ctl_int, 0, sizeof(ctl_int));

			src_color_format = RAW10;
            updateTdri = {
                .updateType = TPIPE_DRV_UPDATE_TYPE_CQ1_FULL_SAVE,
                .partUpdateFlag = 0
            };
        }
