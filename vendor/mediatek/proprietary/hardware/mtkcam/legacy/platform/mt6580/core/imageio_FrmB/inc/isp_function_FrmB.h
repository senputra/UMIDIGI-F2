...
public:
    ...
    /**
      *@brief  Constructor
      */
    IspFunction_B(): m_Reg_Base_Addr(0),bypass(0),m_pP1CurCQDIspReg(NULL){};
...
public:
    DMAI_B():dupCqIdx(0),burstQueIdx(0),CQ(CAM_ISP_CQ_NONE),sceID(0),isP2IspOnly(0),p2MdpSrcFmt(eImgFmt_YV12),p2MdpSrcW(0),p2MdpSrcH(0),p2MdpSrcYStride(0),p2MdpSrcUVStride(0),p2MdpSrcSize(0),p2MdpSrcCSize(0),p2MdpSrcVSize(0),p2MdpSrcPlaneNum(0),cqTrigSrc(-1),cqTrigSrc_D(-1)
