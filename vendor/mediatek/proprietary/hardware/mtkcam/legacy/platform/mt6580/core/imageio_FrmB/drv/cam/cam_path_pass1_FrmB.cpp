...
MUINT32 CamPathPass1::setP1MagicNum(UINT32 const magicNum){
    ...
    //ISP_PATH_INF("setP1MagicNum(0x%x)\n",magicNum);
...
int CamPathPass1::setP1HrzCfg(IspHrzCfg const hrz_cfg)
{
    ...
    if ( ISP_PASS1 == hrz_cfg.pass1_path) {
        ...
        ISP_QuerySize(EPortIndex_IMG2O,ISP_QUERY_XSIZE_BYTE,(EImageFormat)DMAImg2o.dma_cfg.lIspColorfmt,DMAImg2o.dma_cfg.crop.w,queryRst,ISP_QUERY_1_PIX_MODE);
        ...
        ISP_PATH_DBG("crop[%d,%d], hrz_in_size(%d,%d), outSize(%d,%d), magicNum=%d", \
             DMAImg2o.dma_cfg.crop.x ,DMAImg2o.dma_cfg.crop.y, \
             ispRawPipe.hrz_in.w, ispRawPipe.hrz_in.h, hrz_cfg.hrz_out_size.w, hrz_cfg.hrz_out_size.h,\
              hrz_cfg.m_num_0);
    }
