...
#define UTIL_VRB(fmt,...)      ALOGV("[%s]" fmt"\n", __FUNCTION__, ##__VA_ARGS__)
#define UTIL_DBG(fmt,...)      ALOGD("[%s]" fmt"\n", __FUNCTION__, ##__VA_ARGS__)
#define UTIL_INF(fmt,...)      ALOGI("[%s]" fmt"\n", __FUNCTION__, ##__VA_ARGS__)
#define UTIL_WRN(fmt,...)      ALOGW("[%s]" fmt"\n", __FUNCTION__, ##__VA_ARGS__)
#define UTIL_ERR(fmt,...)      ALOGE("[%s]" fmt"\n", __FUNCTION__, ##__VA_ARGS__)
