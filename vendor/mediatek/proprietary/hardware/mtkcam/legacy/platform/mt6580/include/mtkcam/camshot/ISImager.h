...
enum ESImagerEncType {
    // try to use hw jpeg encode first
    JPEGENC_HW_FIRST,
    // use sw jpeg encode
    JPEGENC_SW,
};
...
public:     ////    Settings
     ...
     *
     */
    virtual MBOOL   setEncodeParam(MUINT32 const &u4IsSOI, MUINT32 const &u4Quality, MUINT32 const &eCodecType = JPEGENC_HW_FIRST) = 0;
    /**
