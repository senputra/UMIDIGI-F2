...
)
{
    ...
    //Allen: IspTuningMgr::getInstance().setISPAEGain((ESensorDev_T)m_eSensorDev,
    //Allen:                                                             MFALSE, m_rAEOutput.rPreviewMode.u4IspGain>>1);
...
)
{
    ...
    //Allen:IspTuningMgr::getInstance().setISPAEGain((ESensorDev_T)m_eSensorDev, MFALSE, a_IspRAWGain>>1);
