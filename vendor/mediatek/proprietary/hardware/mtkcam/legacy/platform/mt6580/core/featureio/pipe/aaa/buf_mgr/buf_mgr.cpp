...
init()
{
    ...
    property_get("vendor.debug.buf_mgr.enable", value, "0");
...
DMAConfig(camdma2type<ECamDMA_AAO>)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspReg , CAM_AAO_OFST_ADDR, OFFSET_ADDR, AAO_OFFSET_ADDR); // CAM_AAO_OFST_ADDR
    ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspReg , CAM_AAO_XSIZE, XSIZE, AAO_XSIZE); // CAM_AAO_XSIZE
    //ISP_IOCTL_WRITE_BITS(m_pIspDrv,m_pIspReg , CAM_AAO_YSIZE, YSIZE, AAO_YSIZE); // CAM_AAO_YSIZE
    ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspReg , CAM_AAO_STRIDE, BUS_SIZE, AAO_STRIDE_BUS_SIZE); // CAM_AAO_STRIDE
...
updateDMABaseAddr(camdma2type<ECamDMA_AAO>, MUINT32 u4BaseAddr)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspReg , CAM_AAO_BASE_ADDR, BASE_ADDR, u4BaseAddr); // CAM_AAO_BASE_ADDR
...
DMAConfig(camdma2type<ECamDMA_AFO>)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspReg , CAM_AFO_XSIZE, XSIZE, AFO_XSIZE); // CAM_AFO_XSIZE
...
updateDMABaseAddr(camdma2type<ECamDMA_AFO>, MUINT32 u4BaseAddr)
{
    ...
    ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspReg , CAM_AFO_BASE_ADDR, BASE_ADDR, u4BaseAddr); // CAM_AFO_BASE_ADDR
