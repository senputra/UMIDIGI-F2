...
protected:
        ...
        , m_u4StartAddr(REG_ADDR(CAM_OBC_OFFST0))
    {
        ...
        INIT_ISP_DRV_MODE(EIspProfile_NormalCapture_CC, ISPDRV_MODE_CQ0); // PASS1:CQ0
        INIT_ISP_DRV_MODE(EIspProfile_NormalCapture_16M, ISPDRV_MODE_CQ0); // PASS1:CQ0
...
protected:
        ...
        , m_u4StartAddr(REG_ADDR(CAM_PGN_SATU01))
    {
        ...
        INIT_ISP_DRV_MODE(EIspProfile_NormalCapture_CC, ISPDRV_MODE_CQ1_SYNC);
        INIT_ISP_DRV_MODE(EIspProfile_NormalCapture_16M, ISPDRV_MODE_CQ1_SYNC);
