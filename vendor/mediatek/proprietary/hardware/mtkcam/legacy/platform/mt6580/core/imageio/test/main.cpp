...
extern int main_IT_Imageio(int argc, char** argv);
...
int main(int argc, char** argv)
{
    ...
    if( argc < 2 )
    {
        ...
        printf("    %s <TestCase> <arg 1> ...\n", argv[0]);
        printf("        TestCase : 0: CamIOPipe UT, 1: PostProc UT, 2: ImageIO IT\n");
        return -1;
    }
...
#if 0
        case 1:
            ret=main_PostProc(num, arg);
            break;
#endif
        case 2:
            main_IT_Imageio(num, arg);
            break;
        case 3:
            ret=ef_test();
            break;
