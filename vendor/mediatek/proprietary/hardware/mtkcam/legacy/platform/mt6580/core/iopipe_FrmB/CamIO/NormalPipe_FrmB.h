...
protected:
    ...
    IHalSensor::ConfigParam    m_sensorConfigParam[4];
...
private:
    ...
    struct Statistics {
        ...
        Statistics() :
            numOfUserEnqued(0), numOfUserDequed(0)
        {
        }
...
#endif
    mutable android::Mutex               mDmyContainerLock;  //protect sw enque container which is accessed by drv_thread & other user threads
