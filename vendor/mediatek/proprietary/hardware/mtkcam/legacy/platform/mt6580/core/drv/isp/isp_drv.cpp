...
MUINT32 IspDrv::getTpipeMgrVaCq1(MUINT32 *pDescArray, MUINT32 *pDescNum, MUINT32 *pCtlEn1, MUINT32 *pCtlEn2, MUINT32 *pCtlDma)
{
    ...
    *pDescArray = (unsigned long)tdriMgrInfoCq1.mTurUpdTable;
    *pDescNum = (unsigned long)&tdriMgrInfoCq1.updateCqDescriptorNum;
    *pCtlEn1 = (unsigned long)&tdriMgrInfoCq1.topCtlEn1;
    *pCtlEn2 = (unsigned long)&tdriMgrInfoCq1.topCtlEn2;
    *pCtlDma = (unsigned long)&tdriMgrInfoCq1.topCtlDma;
...
MUINT32 IspDrv::getTpipeMgrVaCq2(MUINT32 *pDescArray, MUINT32 *pDescNum, MUINT32 *pCtlEn1, MUINT32 *pCtlEn2,  MUINT32 *pCtlDma)
{
    ...
    *pDescArray = (unsigned long)tdriMgrInfoCq2.mTurUpdTable;
    *pDescNum = (unsigned long)&tdriMgrInfoCq2.updateCqDescriptorNum;
    *pCtlEn1 = (unsigned long)&tdriMgrInfoCq2.topCtlEn1;
    *pCtlEn2 = (unsigned long)&tdriMgrInfoCq2.topCtlEn2;
    *pCtlDma = (unsigned long)&tdriMgrInfoCq2.topCtlDma;
...
MBOOL IspDrvImp::uninit()
{
    ...
    if(!m_fgIsGdmaMode)    // Normal Mode (i.e. not GDMA).
    {
        ...
        LOCAL_PROFILING_LOG_PRINT("m_pIMemDrv->uninit() && m_pIMemDrv->destroyInstance()");
...
{
    LOG_DBG("cq(%d),ispVirRegAddr(0x%p)", cq, ispVirRegAddr);
