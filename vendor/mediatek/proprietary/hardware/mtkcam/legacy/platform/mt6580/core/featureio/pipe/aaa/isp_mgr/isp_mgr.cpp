...
#define CLAMP(x,min,max)       (((x) > (max)) ? (max) : (((x) < (min)) ? (min) : (x)))
    ...
    #define MY_LOG(fmt, arg...)    CAM_LOGD(LOG_TAG " " fmt, ##arg)
...
apply(EIspProfile_T eIspProfile)
{
    ...
    property_get("vendor.debug.obc_apply.log", value, "0");
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.debug.bnr_apply.ctrl", value, "-1");
    ...
    if (m_rIspDrvMode[eIspProfile] & ISPDRV_MODE_CQ0) { // PASS 1
        ...
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ0), CAM_BPC_CON, BPC_ENABLE, bBPC_EN);
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ0), CAM_NR1_CON, NR1_CT_EN, bCT_EN);
    }
    ...
    if (m_rIspDrvMode[eIspProfile] & ISPDRV_MODE_CQ1_SYNC) { // PASS 2 (CQ1)
        ...
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ1_SYNC), CAM_BPC_CON, BPC_ENABLE, isBPCEnable());
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ1_SYNC), CAM_NR1_CON, NR1_CT_EN, isCTEnable());
    ...
    if (m_rIspDrvMode[eIspProfile] & ISPDRV_MODE_CQ2_SYNC) { // PASS 2 (CQ2)
        ...
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ2_SYNC), CAM_BPC_CON, BPC_ENABLE, isBPCEnable());
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ2_SYNC), CAM_NR1_CON, NR1_CT_EN, isCTEnable());
...
apply(EIspProfile_T eIspProfile)
{
    ...
    //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_ISP), CAM_LSCI_ERR_STAT, ERR_STAT, 0xffff);
    ...
    if (m_rIspDrvMode[eIspProfile] & ISPDRV_MODE_CQ0) { // PASS 1
        ...
        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSCI_OFST_ADDR, OFFSET_ADDR, LSCI_OFFSET);
        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSCI_XSIZE, XSIZE, LSCI_XSIZE);
        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSCI_YSIZE, YSIZE, LSCI_YSIZE);
        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSCI_STRIDE, STRIDE, LSCI_STRIDE);
        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSCI_BASE_ADDR, BASE_ADDR, u4BaseAddr);

        ISP_WRITE_REG(getIspReg(drv_mode), CAM_LSC_CTL1, 0x30000000);

        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSC_CTL2, SDBLK_WIDTH, Width); //sdblk_width,
        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSC_CTL3, SDBLK_HEIGHT, Height);//sdblk_height,
        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSC_CTL2, SDBLK_XNUM, XNum);//sdblk_xnum,
        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSC_CTL3, SDBLK_YNUM, YNum);//sdblk_ynum,
        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSC_LBLOCK, SDBLK_lWIDTH, lWidth); //sdblk_width,
        ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(drv_mode), CAM_LSC_LBLOCK, SDBLK_lHEIGHT, lHeight);
...
#define ISP_SL2_LOG(cq) \
    ...
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.debug.sl2_apply.ctrl", value, "-1");
    MINT32 ctrl = atoi(value);
...
apply(EIspProfile_T eIspProfile)
{
    ...
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.debug.ccm_apply.ctrl", value, "-1");
    MINT32 ctrl = atoi(value);
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.debug.ggm_apply.ctrl", value, "-1");
    MINT32 ctrl = atoi(value);
    ...
    if (m_rIspDrvMode[eIspProfile] & ISPDRV_MODE_CQ0) { // PASS 1
        ...
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ0), CAM_GGM_CTRL, GAMMA_EN, bGAMMA_EN);
        // GGM_RB
    ...
    if (m_rIspDrvMode[eIspProfile] & ISPDRV_MODE_CQ1_SYNC) { // PASS 2 (CQ1)
        ...
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ1_SYNC), CAM_GGM_CTRL, GAMMA_EN, bGAMMA_EN);
    ...
    if (m_rIspDrvMode[eIspProfile] & ISPDRV_MODE_CQ2_SYNC) { // PASS 2 (CQ2)
        ...
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ2_SYNC), CAM_GGM_CTRL, GAMMA_EN, bGAMMA_EN);
...
apply(EIspProfile_T eIspProfile)
{
    ...
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.debug.g2c_apply.ctrl", value, "-1");
    MINT32 ctrl = atoi(value);
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.debug.nbc_apply.ctrl", value, "-1");
    MINT32 ctrl = atoi(value);
    ...
    if (m_rIspDrvMode[eIspProfile] & ISPDRV_MODE_CQ0) { // PASS 1
        ...
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ0), CAM_ANR_CON1, ANR_ENY, bANR_ENY);
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ0), CAM_ANR_CON1, ANR_ENC, bANR_ENC);
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ0), CAM_CCR_CON, CCR_EN, bCCR_ENC);
    ...
    if (m_rIspDrvMode[eIspProfile] & ISPDRV_MODE_CQ1_SYNC) { // PASS 2 (CQ1)
        ...
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ1_SYNC), CAM_ANR_CON1, ANR_ENY, bANR_ENY);
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ1_SYNC), CAM_ANR_CON1, ANR_ENC, bANR_ENC);
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ1_SYNC), CAM_CCR_CON, CCR_EN, bCCR_ENC);
    ...
    if (m_rIspDrvMode[eIspProfile] & ISPDRV_MODE_CQ2_SYNC) { // PASS 2 (CQ2)
        ...
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ2_SYNC), CAM_ANR_CON1, ANR_ENY, bANR_ENY);
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ2_SYNC), CAM_ANR_CON1, ANR_ENC, bANR_ENC);
        //ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_CQ2_SYNC), CAM_CCR_CON, CCR_EN, bCCR_ENC);
...
apply(EIspProfile_T eIspProfile)
{
    ...
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.debug.pca_apply.ctrl", value, "-1");
    MINT32 ctrl = atoi(value);
...
apply(EIspProfile_T eIspProfile)
{
    ...
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.debug.seee_apply.ctrl", value, "-1");
    MINT32 ctrl = atoi(value);
...
config(AE_STAT_PARAM_T& rAEStatConfig)
{
    ...
    // CAM_AE_HST_CTL
    ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_ISP), CAM_AE_HST_CTL, AE_HST0_EN, rAEStatConfig.rAEHistWinCFG[0].bAEHistEn);
    ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_ISP), CAM_AE_HST_CTL, AE_HST1_EN, rAEStatConfig.rAEHistWinCFG[1].bAEHistEn);
    ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_ISP), CAM_AE_HST_CTL, AE_HST2_EN, rAEStatConfig.rAEHistWinCFG[2].bAEHistEn);
    ISP_IOCTL_WRITE_BITS(m_pIspDrv,getIspReg(ISPDRV_MODE_ISP), CAM_AE_HST_CTL, AE_HST3_EN, rAEStatConfig.rAEHistWinCFG[3].bAEHistEn);
