...
// [CS]+
    ...
    virtual MVOID         getReadBuf() = 0;
    virtual MBOOL         returnJpegBuf() = 0;
    virtual MVOID         finishJpegBufCallback();
...
protected:      //// data members
    ...
    MBOOL                        mbJpegSemPost;
    MUINT32                    mu4JpegWriteSize;
    MUINT32                    mu4JpegReadySize;
    MUINT32                    mu4ThumbnailWriteSize;
    MUINT32                    mu4ThumbnailReadySize;
