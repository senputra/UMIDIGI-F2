...
*/
    ...
    FDFTInitInfo.FDTBufWidth = image_width_array[0];// 320x240
    ...
    MY_LOGD("FDSrcWidth = %d", FDFTInitInfo.FDTBufWidth);
    MY_LOGD("FDSrcHeight = %d", FDFTInitInfo.FDTBufHeight);
...
)
{
    ...
    MY_LOGI("[GetFaceNum] NUM_Face:%d,", FdResult_Num);
