...
#define logE(fmt, arg...) CAM_LOGD("MError: func=%s line=%d: " fmt, __FUNCTION__, __LINE__, ##arg)
//=====================================================
// variable
//=====================================================
...
/*
        ...
        logV("FFLK func=%s line=%d ",__FUNCTION__, __LINE__);
...
MINT32 FlickerHal::setFlickerWinConfig(FLKWinCFG_T* ptFlkWinCfg)
{
    ...
    logV("[setFlickerConfig]:flicker win (x,y)=0x%08x\n", (int) ISP_READ_REG(m_pIspRegMap, CAM_FLK_SOFST));
    logV("[setFlickerConfig]:flicker win (w,h)=0x%08x\n", (int) ISP_READ_REG(m_pIspRegMap, CAM_FLK_WSIZE));
