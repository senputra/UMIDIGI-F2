...
initImageCreateThread()
{
    ...
    if  (
        ...
        ||  OK != (status = mpImageCreateThread->run("MultiShotNcc::ImageCreateThread"))
        )
    {
        MY_LOGE(
    ...
    if  (
        ...
        ||  OK != (status = mpYuvImageCreateThread->run("MultiShotNcc::YuvImageCreateThread"))
        )
    {
        MY_LOGE(
    ...
    if  (
        ...
        ||  OK != (status = mpThumbnailImageCreateThread->run("MultiShotNcc::ThumbnailImageCreateThread"))
        )
    {
        MY_LOGE(
    ...
    if  (
        ...
        ||  OK != (status = mpJpegImageCreateThread->run("MultiShotNcc::JpegImageCreateThread"))
        )
    {
        MY_LOGE(
