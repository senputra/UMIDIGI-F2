...
initImageCreateThread()
{
    ...
    if  (
        ...
        ||  OK != (status = mpImageCreateThread->run("MultiShotCc::ImageCreateThread"))
        )
    {
        MY_LOGE(
    ...
    if  (
        ...
        ||  OK != (status = mpYuvImageCreateThread->run("MultiShotCc::YuvImageCreateThread"))
        )
    {
        MY_LOGE(
    ...
    if  (
        ...
        ||  OK != (status = mpThumbnailImageCreateThread->run("MultiShotCc::ThumbnailImageCreateThread"))
        )
    {
        MY_LOGE(
    ...
    if  (
        ...
        ||  OK != (status = mpJpegImageCreateThread->run("MultiShotCc::JpegImageCreateThread"))
        )
    {
        MY_LOGE(
