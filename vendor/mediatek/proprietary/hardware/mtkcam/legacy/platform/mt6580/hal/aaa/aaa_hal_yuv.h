...
public:
     ...
     */
    static Hal3AYuv* createInstance(MINT32 const i4SensorDevId, MINT32 const i4SensorOpenIndex);
    /**
     ...
     */
    virtual MBOOL sendCommandDerived(ECmd_T const eCmd, MINTPTR const i4Arg = 0){return MTRUE;};
    ...
    virtual MINT32 get3AStatusFromSensor();
...
public:
     ...
     * @param [in] i4SensorDev, i4SensorOpenIndex
     */
