...
public:
    ...
    MBOOL isAFEngMode(MINT32 i4SensorDev);
    ...
    MVOID doPDBuffer(MINT32 i4SensorDev, MVOID * buffer, MINT32 w,MINT32 h, MINT32 stride, MUINT32 i4FrmNum=0);
    ...
    MVOID VsyncSignal(MINT32 i4SensorDev);
