...
onInit()
{
    ...
    if(mpIspSyncCtrl)
    {
        ...
        {
            mpIspSyncCtrl->setCurZoomRatio(mspParamsMgr->getZoomRatio());
        }
        //
        ...
        if( pHalSensorList != NULL )
        {
            ...
            if( val > -1 ) {
                isPDAFOn = val;
                MY_LOGD("vendor.debug.pass1.pdafon %d", isPDAFOn);
            }
            ...
            if( isPDAFOn )
            {
                ...
                if( val > -1 ) {
                    mPDAFFrameCount = val;
                    MY_LOGD("vendor.debug.pass1.pdafframe %d", mPDAFFrameCount);
                }
                #else
                {
