      ...
      pJpgConfigVa(NULL)
{
    ...
    //
    std::strncpy((char*)m_szUsrName,(char const*)szUsrName,std::strlen((char const*)szUsrName));
    m_szUsrName[std::strlen((char const*)szUsrName)] = '\0';
...
PrintPipePortInfo(vector<PortInfo const*>const& vInPorts, vector<PortInfo const*>const& vOutPorts)
{
    ...
    switch (vInPorts.size())
    {
        case 1:
            ...
            PIPE_INF("vInPorts:[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x)",\
                                                            vInPorts[0]->eImgFmt,
                                                            ...
                                                            vInPorts[0]->u4BufVA[0],
                                                            vInPorts[0]->u4BufVA[1],
                                                            vInPorts[0]->u4BufVA[2],
                                                            vInPorts[0]->u4BufPA[0],
                                                            vInPorts[0]->u4BufPA[1],
                                                            vInPorts[0]->u4BufPA[2],
                                                            vInPorts[0]->memID[0],
                                                            vInPorts[0]->memID[1],
                                                            vInPorts[0]->memID[2],
                                                            vInPorts[0]->u4MagicNum);
            break;
        case 2:
            if ( (0 == vInPorts[0]) ||  (0 == vInPorts[1])) { break; }
            PIPE_INF("vInPorts:[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x),\n\
                      vInPorts:[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x)",\
                                                            vInPorts[0]->eImgFmt,
                                                            vInPorts[0]->u4ImgWidth,
                                                            vInPorts[0]->u4ImgHeight,
                                                            vInPorts[0]->u4Stride[ESTRIDE_1ST_PLANE],
                                                            ...
                                                            vInPorts[1]->u4BufVA[0],
                                                            vInPorts[1]->u4BufVA[1],
                                                            vInPorts[1]->u4BufVA[2],
                                                            vInPorts[1]->memID[0],
                                                            vInPorts[1]->memID[1],
                                                            vInPorts[1]->memID[2],
                                                            vInPorts[1]->u4MagicNum);
            break;
        case 3:
            if ( (0 == vInPorts[0]) || (0 == vInPorts[1]) || (0 == vInPorts[2])) { break; }
            PIPE_INF("vInPorts:[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x),\n\
                      vInPorts:[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x),\n\
                      vInPorts:[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x)",\
                                                            vInPorts[0]->eImgFmt,
                                                            vInPorts[0]->u4ImgWidth,
                                                            vInPorts[0]->u4ImgHeight,
                                                            vInPorts[0]->u4Stride[ESTRIDE_1ST_PLANE],
                                                            ...
                                                            vInPorts[1]->u4BufVA[1],
                                                            vInPorts[1]->u4BufVA[2],
                                                            vInPorts[1]->u4BufPA[0],
                                                            vInPorts[1]->u4BufPA[1],
                                                            vInPorts[1]->u4BufPA[2],
                                                            vInPorts[1]->memID[0],
                                                            vInPorts[1]->memID[1],
                                                            vInPorts[1]->memID[2],
                                                            vInPorts[1]->u4MagicNum,
                                                            ...
                                                            vInPorts[2]->u4BufVA[0],
                                                            vInPorts[2]->u4BufVA[1],
                                                            vInPorts[2]->u4BufVA[2],
                                                            vInPorts[2]->u4BufPA[0],
                                                            vInPorts[2]->u4BufPA[1],
                                                            vInPorts[2]->u4BufPA[2],
                                                            vInPorts[2]->memID[0],
                                                            vInPorts[2]->memID[1],
                                                            vInPorts[2]->memID[2],
                                                            vInPorts[2]->u4MagicNum);
            break;
        case 4:
            ...
            PIPE_INF("vInPorts:[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x),\n\
                      vInPorts:[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x),\n\
                      vInPorts:[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x),\n\
                      vInPorts:[3]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x)",\
                                                            vInPorts[0]->eImgFmt,
                                                            vInPorts[0]->u4ImgWidth,
                                                            vInPorts[0]->u4ImgHeight,
                                                            vInPorts[0]->u4Stride[ESTRIDE_1ST_PLANE],
                                                            ...
                                                            vInPorts[3]->u4BufVA[0],
                                                            vInPorts[3]->u4BufVA[1],
                                                            vInPorts[3]->u4BufVA[2],
                                                            vInPorts[3]->u4BufPA[0],
                                                            vInPorts[3]->u4BufPA[1],
                                                            vInPorts[3]->u4BufPA[2],
                                                            vInPorts[3]->memID[0],
                                                            vInPorts[3]->memID[1],
                                                            vInPorts[3]->memID[2],
                                                            vInPorts[3]->u4MagicNum);
        ...
        case 5:
            ...
            PIPE_INF("vInPorts:[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x),\n\
                      ...
                      vInPorts:[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x),\n\
                      vInPorts:[3]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x),\n\
                      vInPorts:[4]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x)",\
                                                            vInPorts[0]->eImgFmt,
                                                            vInPorts[0]->u4ImgWidth,
                                                            vInPorts[0]->u4ImgHeight,
                                                            vInPorts[0]->u4Stride[ESTRIDE_1ST_PLANE],
                                                            ...
                                                            vInPorts[4]->u4BufVA[0],
                                                            vInPorts[4]->u4BufVA[1],
                                                            vInPorts[4]->u4BufVA[2],
                                                            vInPorts[4]->u4BufPA[0],
                                                            vInPorts[4]->u4BufPA[1],
                                                            vInPorts[4]->u4BufPA[2],
                                                            vInPorts[4]->memID[0],
                                                            vInPorts[4]->memID[1],
                                                            vInPorts[4]->memID[2],
                                                            vInPorts[4]->u4MagicNum);
            break;
        default:
            PIPE_ERR("please add PrintPipePortInfo vInPorts switch case:%d\n", vInPorts.size());
            break;
    }
    ...
    switch (vOutPorts.size())
    {
        case 1:
            ...
            PIPE_INF("vOutPorts:[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x)",\
                                                            vOutPorts[0]->eImgFmt,
                                                            ...
                                                            vOutPorts[0]->u4BufVA[0],
                                                            vOutPorts[0]->u4BufVA[1],
                                                            vOutPorts[0]->u4BufVA[2],
                                                            vOutPorts[0]->u4BufPA[0],
                                                            vOutPorts[0]->u4BufPA[1],
                                                            vOutPorts[0]->u4BufPA[2],
                                                            vOutPorts[0]->memID[0],
                                                            vOutPorts[0]->memID[1],
                                                            vOutPorts[0]->memID[2]);
            break;
        case 2:
            ...
            PIPE_INF("vOutPorts:[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),\n\
                      vOutPorts:[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x)",\
                                                            vOutPorts[0]->eImgFmt,
                                                            vOutPorts[0]->u4ImgWidth,
                                                            vOutPorts[0]->u4ImgHeight,
                                                            vOutPorts[0]->u4Stride[ESTRIDE_1ST_PLANE],
                                                            ...
                                                            vOutPorts[1]->u4BufVA[0],
                                                            vOutPorts[1]->u4BufVA[1],
                                                            vOutPorts[1]->u4BufVA[2],
                                                            vOutPorts[1]->u4BufPA[0],
                                                            vOutPorts[1]->u4BufPA[1],
                                                            vOutPorts[1]->u4BufPA[2],
                                                            vOutPorts[1]->memID[0],
                                                            vOutPorts[1]->memID[1],
                                                            vOutPorts[1]->memID[2]);
            break;
        case 3:
            ...
            PIPE_INF("vOutPorts:[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),\n\
                      vOutPorts:[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),\n\
                      vOutPorts:[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x)",\
                                                            vOutPorts[0]->eImgFmt,
                                                            vOutPorts[0]->u4ImgWidth,
                                                            vOutPorts[0]->u4ImgHeight,
                                                            vOutPorts[0]->u4Stride[ESTRIDE_1ST_PLANE],
                                                            ...
                                                            vOutPorts[2]->u4BufVA[0],
                                                            vOutPorts[2]->u4BufVA[1],
                                                            vOutPorts[2]->u4BufVA[2],
                                                            vOutPorts[2]->u4BufPA[0],
                                                            vOutPorts[2]->u4BufPA[1],
                                                            vOutPorts[2]->u4BufPA[2],
                                                            vOutPorts[2]->memID[0],
                                                            vOutPorts[2]->memID[1],
                                                            vOutPorts[2]->memID[2]);
            break;
        case 4:
            ...
            PIPE_INF("vOutPorts:[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),\n\
                      vOutPorts:[1]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),\n\
                      vOutPorts:[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),\n\
                      vOutPorts:[3]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x)",\
                                                            vOutPorts[0]->eImgFmt,
                                                            vOutPorts[0]->u4ImgWidth,
                                                            vOutPorts[0]->u4ImgHeight,
                                                            vOutPorts[0]->u4Stride[ESTRIDE_1ST_PLANE],
                                                            ...
                                                            vOutPorts[3]->u4BufVA[0],
                                                            vOutPorts[3]->u4BufVA[1],
                                                            vOutPorts[3]->u4BufVA[2],
                                                            vOutPorts[3]->u4BufPA[0],
                                                            vOutPorts[3]->u4BufPA[1],
                                                            vOutPorts[3]->u4BufPA[2],
                                                            vOutPorts[3]->memID[0],
                                                            vOutPorts[3]->memID[1],
                                                            vOutPorts[3]->memID[2]);
            break;
        case 5:
            ...
            PIPE_INF("vOutPorts:[0]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),\n\
                      ...
                      vOutPorts:[2]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),\n\
                      vOutPorts:[3]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),\n\
                      vOutPorts:[4]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x)",\
                                                            vOutPorts[0]->eImgFmt,
                                                            vOutPorts[0]->u4ImgWidth,
                                                            vOutPorts[0]->u4ImgHeight,
                                                            vOutPorts[0]->u4Stride[ESTRIDE_1ST_PLANE],
                                                            ...
                                                            vOutPorts[4]->u4BufVA[0],
                                                            vOutPorts[4]->u4BufVA[1],
                                                            vOutPorts[4]->u4BufVA[2],
                                                            vOutPorts[4]->u4BufPA[0],
                                                            vOutPorts[4]->u4BufPA[1],
                                                            vOutPorts[4]->u4BufPA[2],
                                                            vOutPorts[4]->memID[0],
                                                            vOutPorts[4]->memID[1],
                                                            vOutPorts[4]->memID[2]);
            break;
        ...
        default:
            PIPE_ERR("please add PrintPipePortInfo vOutPorts switch case:%d\n", vOutPorts.size());
            break;
    }
...
//    }
    ...
    for (MUINT32 i = 0 ; i < vInPorts.size() ; i++ )
    {
        ...
        //
        PIPE_DBG("vInPorts:[%d]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x),magicNum(0x%x)",\
                                                        i,
                                                        vInPorts[i]->eImgFmt,
        ...
        switch(vInPorts[i]->index)
        {
            case EPortIndex_IMGI:
                ...
                PIPE_DBG("[Imgi][crop_1](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,h,tarW,tarH)=(%d,%d,%d,%d)-[crop_2](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,h,tarW,tarH)=(%d,%d,%d,%d)-[crop_3](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,h,tarW,tarH)=(%d,%d,%d,%d),pass2_CQ(%d),dupCqIdx(%d)", \
    ...
    for (MUINT32 i = 0 ; i < vOutPorts.size() ; i++ )
    {
        ...
        //
        PIPE_DBG("vOutPorts:[%d]:(0x%x),w(%d),h(%d),stride(%d,%d,%d),type(%d),idx(%d),dir(%d),Size(0x%08x,0x%08x,0x%08x),VA(0x%08x,0x%08x,0x%08x),PA(0x%08x,0x%08x,0x%08x),memID(0x%x,0x%x,0x%x)",i,\
                                                        vOutPorts[i]->eImgFmt,
    ...
    // check rrz info. and pixel id
        ...
        {
        PIPE_DBG("NULL cookie for eImgFmt(0x%08x)",vInPorts[idx_imgi]->eImgFmt);
        }
        else
        {
        PIPE_DBG("[warning]NULL cookie");
        }
    }
...
//                en_p2_dma |=  CAM_CTL_DMA_EN_VIPI_EN;
    ...
    PIPE_INF("[Imgi][crop_1](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,h,tarW,tarH)=(%d,%d,%d,%d)-[crop_2](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,h,tarW,tarH)=(%d,%d,%d,%d)-[crop_3](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,h,tarW,tarH)=(%d,%d,%d,%d),pass2_CQ(%d),dupCqIdx(%d),drvScenario(%d),mdpCheck1(%d),mdpCheck2(%d),crop1TableIdx(%d),privateData(0x%lx)", \
            portInfo_imgi.crop1.x,portInfo_imgi.crop1.floatX,portInfo_imgi.crop1.y,portInfo_imgi.crop1.floatY, \
            portInfo_imgi.crop1.w,portInfo_imgi.crop1.h,portInfo_imgi.resize1.tar_w,portInfo_imgi.resize1.tar_h, \
            portInfo_imgi.crop2.x,portInfo_imgi.crop2.floatX,portInfo_imgi.crop2.y,portInfo_imgi.crop2.floatY, \
            portInfo_imgi.crop2.w,portInfo_imgi.crop2.h,portInfo_imgi.resize2.tar_w,portInfo_imgi.resize2.tar_h,
            portInfo_imgi.crop3.x,portInfo_imgi.crop3.floatX,portInfo_imgi.crop3.y,portInfo_imgi.crop3.floatY, \
            portInfo_imgi.crop3.w,portInfo_imgi.crop3.h,portInfo_imgi.resize3.tar_w,portInfo_imgi.resize3.tar_h,pass2_CQ,pPipePackageInfo->dupCqIdx, \
            drvScenario,mdpCheck1,mdpCheck2,crop1TableIdx, (unsigned long)pPipePackageInfo->pPrivateData);
