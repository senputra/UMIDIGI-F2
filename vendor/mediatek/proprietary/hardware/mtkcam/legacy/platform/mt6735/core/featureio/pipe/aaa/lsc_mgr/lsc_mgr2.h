...
#define EN_LSC_LOG_GAIN_TABLE   (0x1 << 10)
#define EN_LSC_LOG_SHOW_RESOLUTION_INFO   (0x1 << 11)
...
public:
    ...
    MRESULT                 setTsfCapBypass(MBOOL fgBypass){m_fgBypassTsfCap = fgBypass; return 0;}
