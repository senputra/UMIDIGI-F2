...
init()
{
    ...
    //
    property_get("vendor.mfll.dump.all", value, "0");
    MBOOL dumpAll = atoi(value) || TEST_DUMP;
    //
    property_get("vendor.mfll.dump.raw", value, "0");
    MBOOL dumpRaw = atoi(value) || dumpAll || TEST_DUMP_RAW;
    property_get("vendor.mfll.dump.yuv", value, "0");
    MBOOL dumpYuv = atoi(value) || dumpAll || TEST_DUMP_YUV;
    property_get("vendor.mfll.dump.mfb", value, "0");
    MBOOL dumpMfb = atoi(value) || dumpAll || TEST_DUMP_MFB;
    property_get("vendor.mfll.dump.mixer", value, "0");
    MBOOL dumpMixer = atoi(value) || dumpAll || TEST_DUMP_MIXER;
    property_get("vendor.mfll.dump.jpeg", value, "0");
    MBOOL dumpJpeg = atoi(value) || dumpAll || TEST_DUMP_JPEG;
    property_get("vendor.mfll.dump.postview", value, "0");
    MBOOL dumpPostview = atoi(value) || dumpAll || TEST_DUMP_POSTVIEW;
    property_get("vendor.mfll.dump.exif", value, "0");
    MBOOL dumpExif = atoi(value) || TEST_DUMP_EXIF;
    property_get("vendor.mfll.dump.15raw", value, "0");
    ...
    //
    property_get("vendor.mfll.dump.sdcard", value, TEST_DUMP_TO_SDCARD);
    ...
    property_get("vendor.mfll.skipmfb", value, "0");
    mSkipMfb = atoi(value);
    if(mSkipMfb) {
    ...
    property_get("vendor.mfll.bss", value, "-1");
    if(atoi(value) != -1) {
...
void MfllShot::readProperty(void)
{
    ...
    property_get("vendor.mfll.mrp", p, "-1");
    v = atoi(p);
    if (v != -1) {
        switch (v) {
        case eMrpMode_None:
...
initInStartOne(SensorParam const & rSensorParam)
{
    ...
    ********************************************************************************/
    ...
    {
        char value[PROPERTY_VALUE_MAX] = {'\0'};
        property_get("vendor.mfll.nr", value, "-1");
        ...
        case ECamShot_NRTYPE_SWNR:
            {
                ...
                ISwNR *swnr = ISwNR::createInstance(mSensorParam.u4OpenID);
...
getCaptureInfo(MUINT32 mfbMode, MUINT32 sensorId, MUINT32 &frameNumber, MUINT32 &exp, MUINT32 &iso,MBOOL &needUpdateAE)
{
    ...
    {
        char value[PROPERTY_VALUE_MAX] = {'\0'};
        property_get("vendor.mfll.exp", value, "-1");
        MINT32 forceExp = atoi(value);
        if(forceExp!=-1) {
            exp = forceExp * 1000;
        }
        property_get("vendor.mfll.iso", value, "-1");
    ...
    {
        char value[PROPERTY_VALUE_MAX] = {'\0'};
        property_get("vendor.mfll.force", value, "-1");
