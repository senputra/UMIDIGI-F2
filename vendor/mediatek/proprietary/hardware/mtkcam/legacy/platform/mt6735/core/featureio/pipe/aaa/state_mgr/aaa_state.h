...
protected:
    ...
    static MINT64 TimeStampAutoFocus;
    static MBOOL NeedCheckTimeOut;
    #define TIMEOUT_PERIOD 600000 // default 600000(ms), user can change to the desired value(ex: 1800)
