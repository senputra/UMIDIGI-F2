...
init(const ConfigParam& rCfg, const char* strUser)
{
    ...
    m_rWaitIrq.UserInfo.Type    = ISP_DRV_IRQ_TYPE_INT_P1_ST;//ISP_DRV_IRQ_TYPE_INT;
    if (m_rCfgParam.eEventType == E_Event_Vsync) {
        m_rWaitIrq.UserInfo.Status = CAM_CTL_INT_P1_STATUS_VS1_INT_ST;//ISP_DRV_IRQ_INT_STATUS_SOF1_INT_ST;
    }
