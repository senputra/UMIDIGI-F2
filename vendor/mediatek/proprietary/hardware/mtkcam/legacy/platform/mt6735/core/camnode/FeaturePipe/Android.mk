...
LOCAL_C_INCLUDES += $(TOP)/$(MTKCAM_C_INCLUDES)/../D1/mtkcam/v1
...
LOCAL_HEADER_LIBRARIES := liblog_headers libutils_headers libcutils_headers libhardware_headers
