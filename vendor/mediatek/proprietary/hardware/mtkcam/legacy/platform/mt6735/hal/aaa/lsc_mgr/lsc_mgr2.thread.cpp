...
tsfBatchCap()
{
    ...
    if (fgDumpEn)
    {
        ...
        if (dumpSdblk("/data/vendor/tsfInput", rLscCfg, reinterpret_cast<MUINT32*>(m_rTsfSetProc.ShadingTbl)) != 0)
    ...
    tsfSetProcInfo(m_rTsfSetProc, fgDumpEn, "/data/vendor/tsfAwbStat.bin");
