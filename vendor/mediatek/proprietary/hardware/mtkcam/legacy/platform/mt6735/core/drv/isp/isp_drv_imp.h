...
class IspDrvImp : public IspDrv
{
    ...
    public:
        ...
        virtual MUINT32 getTuningUpdateFuncBit(ETuningQueAccessPath ePath, MINT32 magicNum, MINT32 cq,MUINT32 drvScenario);
...
class IspDrvVirImp : public IspDrv
{
    ...
    virtual MBOOL checkCQBufAllocated(void){/*LOG_ERR("Not support");*/return MTRUE;}
        ...
        virtual MUINT32 getTuningUpdateFuncBit(ETuningQueAccessPath ePath, MINT32 magicNum, MINT32 cq,MUINT32 drvScenario){return eIspTuningMgrFunc_Null;};
