...
typedef enum
{
    MTKPIPEFACEBEAUTY_IMAGE_YUV422 = 0,                 // input image format
    MTKPIPEFACEBEAUTY_IMAGE_YV12,
...
public:
    ...
    virtual MINT32 mHalSTEP2(void* ImgSrcAddr, void* FaceMetadata, MTKPipeFaceBeautyPos* BeautifiedFacePos, void* FaceBeautyResultInfo) {
        (void)ImgSrcAddr;
        (void)FaceMetadata;
        (void)BeautifiedFacePos;
        (void)FaceBeautyResultInfo;
        return 0;}
...
public:
    ...
    virtual MINT32 getWorkingBuffSize(int SrcImgWidth, int SrcImgHeight, int Step2SrcImgWidth, int Step2SrcImgHeight, int Step1SrcImgWidth, int Step1SrcImgHeight){
        (void)SrcImgWidth;
        (void)SrcImgHeight;
        (void)Step2SrcImgWidth;
        (void)Step2SrcImgHeight;
        (void)Step1SrcImgWidth;
        (void)Step1SrcImgHeight;
        return 0;}
};
