...
#define MHAL_LOG(fmt, arg...)    ALOGD(EEPROM_LOG_TAG fmt, ##arg)
...
#if COEF_FXX_BIT >= 0
    f00 = binfo.f00<<COEF_FXX_BIT;
    f10 = binfo.f10<<COEF_FXX_BIT;
    f01 = binfo.f01<<COEF_FXX_BIT;
    f11 = binfo.f11<<COEF_FXX_BIT;
#else
    f00 = binfo.f00>>(-COEF_FXX_BIT);
    f10 = binfo.f10>>(-COEF_FXX_BIT);
    f01 = binfo.f01>>(-COEF_FXX_BIT);
