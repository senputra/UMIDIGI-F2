...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/v1/adapter/inc
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_CUSTOM)/hal/D1/inc
#
LOCAL_C_INCLUDES += $(TOP)/$(MTKCAM_C_INCLUDES)/v1/camutils
LOCAL_C_INCLUDES += $(TOP)/system/media/camera/include
#
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_CUSTOM)/hal/D1/inc/camera_feature
