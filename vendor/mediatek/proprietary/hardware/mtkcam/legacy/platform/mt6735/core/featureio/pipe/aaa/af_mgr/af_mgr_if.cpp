...
MBOOL IAfMgr::isAFEngMode(MINT32 i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        return AfMgr::getInstance(ESensorDev_Main).isAFEngMode();
    if (i4SensorDev & ESensorDev_Sub)
        return AfMgr::getInstance(ESensorDev_Sub).isAFEngMode();
    if (i4SensorDev & ESensorDev_MainSecond)
        return AfMgr::getInstance(ESensorDev_MainSecond).isAFEngMode();
...
MVOID IAfMgr::VsyncSignal(MINT32 i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
        AfMgr::getInstance(ESensorDev_Main).VsyncSignal();
    if (i4SensorDev & ESensorDev_Sub)
        AfMgr::getInstance(ESensorDev_Sub).VsyncSignal();
    if (i4SensorDev & ESensorDev_MainSecond)
        AfMgr::getInstance(ESensorDev_MainSecond).VsyncSignal();
}
