...
MBOOL MfbllHal::init(void *pInitInData)
{
    ...
    property_get("vendor.mfllhal.dump", value, "0");
    mDump = atoi(value);
    //
    property_get("vendor.mfllhal.dump.memc", value, "0");
    MBOOL dumpMemc = atoi(value);
    property_get("vendor.mfllhal.dump.swmixer", value, "0");
