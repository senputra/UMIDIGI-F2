...
*/
    ...
    {
        m_cctctrl_prop.isp_prop.m_pispdrv->uninit("cct_main");
    }
...
MINT32 CctImp::init(MINT32 sensorType)
{
    ...
    */
    ...
    if(!err){
        MY_ERR("[CctImp::init] m_pSensorHalObj init fail\n");
        return -1;
    }
...
//    m_cctctrl_prop.sen_prop.m_sen_id = sen_id;
    ...
    */
    ...
    err = pisp_drv->init("cct_main");
    if(!err){
        MY_ERR("[CctImp::init] m_pispdrv init fail\n");
        return -1;
    }
...
getSensorID(SensorDrv& rSensorDrv, CAMERA_DUAL_CAMERA_SENSOR_ENUM const eSensorEnum)
{
    ...
    case DUAL_CAMERA_MAIN_SENSOR:
        return  rSensorDrv.getSensorID(IMGSENSOR_SENSOR_IDX_MAIN);
    case DUAL_CAMERA_SUB_SENSOR:
        return  rSensorDrv.getSensorID(IMGSENSOR_SENSOR_IDX_SUB);
    default:
        break;
    }
    return  -1;
