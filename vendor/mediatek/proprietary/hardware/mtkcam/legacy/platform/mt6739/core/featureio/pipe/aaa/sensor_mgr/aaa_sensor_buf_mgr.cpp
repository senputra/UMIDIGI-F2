...
init(MINT32 const i4SensorIdx)
{
    ...
    if( m_Users>0)
    {
        MY_LOG("[%s] Dev(%d) SensorIdx(%d) CurUsers(%d) : aaa_sensor_buf_mgr has been created so skip doing initialization", __FUNCTION__, m_eSensorDev, m_i4SensorIdx, m_Users);
