...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MVOID IAfMgr::doPDBuffer(MINT32 i4SensorDev, MVOID * buffer, MINT32 w,MINT32 h, MINT32 stride, MUINT32 i4FrmNum, MUINT32 i4RawFmt)
{
    if (i4SensorDev & ESensorDev_Main)
        return AfMgr::getInstance(ESensorDev_Main).doPDBuffer(buffer, w,h, stride, i4FrmNum, i4RawFmt);
    if (i4SensorDev & ESensorDev_Sub)
        return AfMgr::getInstance(ESensorDev_Sub).doPDBuffer(buffer, w,h, stride, i4FrmNum, i4RawFmt);
    if (i4SensorDev & ESensorDev_MainSecond)
        return AfMgr::getInstance(ESensorDev_MainSecond).doPDBuffer(buffer, w,h, stride, i4FrmNum, i4RawFmt);
...
{
    if (i4SensorDev & ESensorDev_Main)
        AfMgr::getInstance(ESensorDev_Main).VSyncIrq();
    if (i4SensorDev & ESensorDev_Sub)
        AfMgr::getInstance(ESensorDev_Sub).VSyncIrq();
    if (i4SensorDev & ESensorDev_MainSecond)
        AfMgr::getInstance(ESensorDev_MainSecond).VSyncIrq();
}

MVOID IAfMgr::pauseAF(MINT32 i4SensorDev, MBOOL a_bIsPaused)
{
    if (i4SensorDev & ESensorDev_Main)
        AfMgr::getInstance(ESensorDev_Main).pauseAF(a_bIsPaused);
    if (i4SensorDev & ESensorDev_Sub)
        AfMgr::getInstance(ESensorDev_Sub).pauseAF(a_bIsPaused);
    if (i4SensorDev & ESensorDev_MainSecond)
        AfMgr::getInstance(ESensorDev_MainSecond).pauseAF(a_bIsPaused);
}
