...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class I3ACallBack : public virtual android::RefBase {
...
struct RRZOInfo
{
    ...
    MUINT32 RSZ_W;
    MUINT32 RSZ_H;
    RRZOInfo(): RRZOInfo(0, 0, 0, 0, 0, 0){}
    RRZOInfo(MUINT32 _a, MUINT32 _b, MUINT32 _c, MUINT32 _d, MUINT32 _e, MUINT32 _f)
      : TG_W(_a)
      , TG_H(_b)
      , CROP_W(_c)
      , CROP_H(_d)
