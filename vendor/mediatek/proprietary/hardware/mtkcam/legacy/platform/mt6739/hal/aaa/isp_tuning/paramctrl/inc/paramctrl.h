...
protected:  ////    Module.
    ...
    MBOOL   prepareHw_PerFrame_NSL2A();
    ...
    MBOOL   prepareHw_PerFrame_NSL2A(const RAWIspCamInfo& rIspCamInfo, const IndexMgr& rIdx);
    MBOOL   prepareHw_PerFrame_PGN(const RAWIspCamInfo& rIspCamInfo, const IndexMgr& rIdx);
    MBOOL   prepareHw_PerFrame_CFA(RAWIspCamInfo& rIspCamInfo, const IndexMgr& rIdx);
