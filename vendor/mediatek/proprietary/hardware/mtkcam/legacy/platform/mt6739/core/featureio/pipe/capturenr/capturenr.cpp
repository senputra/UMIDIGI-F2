        ...
        )
{
    ...
    if( profile == NS3A::EIspProfile_VSS_Capture_MultiPass_ANR_1 ||
        profile == NS3A::EIspProfile_VSS_Capture_MultiPass_ANR_2 ||
        profile == NS3A::EIspProfile_VSS_MFB_MultiPass_ANR_1 ||
        profile == NS3A::EIspProfile_VSS_MFB_MultiPass_ANR_2 )
    {
