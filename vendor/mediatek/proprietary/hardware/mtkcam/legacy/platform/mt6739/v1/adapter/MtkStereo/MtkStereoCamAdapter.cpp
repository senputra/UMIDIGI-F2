...
CamAdapter(
    ...
    , mspDefaultCtrlNode(NULL)
    , mpDefaultCtrlNode_Main2(NULL)
    , mspDefaultCtrlNode_Main2(NULL)
    //
    , mpSyncNode(NULL)
    , mpStereoNode(NULL)
...
init()
{
    ...
    mpCapBufMgr         = CapBufMgr::createInstance(getOpenId_Main());        //getOpenId_Main()
    mpCapBufMgr_Main2   = CapBufMgr::createInstance(getOpenId_Main2());        //getOpenId_Main2()
    ...
    mspDefaultCtrlNode      = mpDefaultCtrlNode;
    mpDefaultCtrlNode_Main2 = DefaultCtrlNode::createInstance("", DefaultCtrlNode::CTRL_NODE_DEFAULT);
    mspDefaultCtrlNode_Main2= mpDefaultCtrlNode_Main2;
    mpSyncNode              = SyncNode::createInstance();
    mpSyncNode->setSensorIdx( getOpenId_Main() );;
