...
********************************************************************************/
IHalPostProcPipe*
PrvStereo::createPipe()
{
    IHalSensorList* const pHalSensorList = IHalSensorList::get();
    EFeatureStreamTag eTag = EFeatureStreamTag_Stream;
    MY_LOGD("call IFeatureStream::createInstance(): eTag=%d, openedSensorIndex=%d",eTag, getSensorIdx());
    return IFeatureStream::createInstance(getName(), eTag, getSensorIdx());
}
