...
public:
     ...
     * @brief start pd mgr.
    */
    EPDBUF_TYPE_t start(MINT32 i4SensorDev, MINT32 i4SensorIdx, SPDProfile_t *iPDProfile, MVOID *ptrInTuningData, MINT32 &i4OutInfoSz, MINT32 **ptrOutInfo);
    /**
     * @brief stop pd mgr.
     */
    ...
    */
     ...
     */
    MRESULT UpdatePDParam(MINT32 i4SensorDev, MUINT32 u4FrmNum, MINT32 i4InputPDAreaNum, AREA_T *tInputPDArea);
