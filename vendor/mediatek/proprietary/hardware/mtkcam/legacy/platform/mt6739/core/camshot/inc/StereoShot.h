...
private:    //// data members
    ...
    //        graph/node
    ICamGraph*                      mpGraph;
    Pass1Node*                      mpPass1;            // normal capture: Pass1Node; ZSD:CapBufNode
    Pass1Node*                      mpPass1_Main2;      // normal capture: Pass1Node; ZSD:CapBufNode
    StereoShotCtrlNode*             mpCtrl;
    StereoShotCtrlNode*             mpCtrl_Main2;
    sp<RefBase>                     mspCtrl;            // just use this to hold sp
    sp<RefBase>                     mspCtrl_Main2;      // just use this to hold sp

    Pass2Node*                      mpStereoCapNode;
    StereoNode*                     mpStereoNode;
    StereoNode*                     mpStereoNode_Main2;
    StereoCtrlNode*                 mpStereoCtrlNode;
    ImgTransformNode*               mpITNode;               // for bokeh image
    ImgTransformNode*               mpITNode_CleanImage;    // for clean image
