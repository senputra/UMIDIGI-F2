...
*
********************************************************************************/
AcdkMhalBase *AcdkMhalBase::createInstance(MUINT32 OpenMode, MBOOL CctOn)
{
    AcdkMhalBase * new_instance;
    if(OpenMode == 0)
    {
        ACDK_LOGD("createInstance : AcdkMhalPure\n");
        new_instance = new AcdkMhalPure;
        //return new AcdkMhalPure;
    }
    else
    {
        ACDK_LOGD("createInstance : AcdkMhalEng\n");
        new_instance = new AcdkMhalEng;
        //return new AcdkMhalEng;
    }
    new_instance->mCctOn = CctOn;
    return new_instance;
    /*char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.camera.acdkmhal.pure", value, "0");
