...
#define AF_ALGO_IF_REVISION 7205001

#define ZION_OLD_API 0
...
public:
    ...
    virtual void    updateAFOTPInfo(AF_OTPInfo_T * S2aAF_t) = 0;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    virtual MRESULT getFocusWindows(AREA_T inAfRoi, AREA_T* outWins, MINT32* outWinNum) = 0;
#endif
};
