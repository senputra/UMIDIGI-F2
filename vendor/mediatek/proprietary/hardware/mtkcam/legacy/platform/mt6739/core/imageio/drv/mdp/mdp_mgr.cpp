...
//         if(cfgData.dstDma[index].withCropM && cfgData.dstDma[index].enSrcCrop)
        {
            ...
            LOG_INF("dstSizeList=(0x%8x,0x%8x,0x%8x),dstVirList=(0x%8x,0x%8x,0x%8x),dstPhyList=(0x%8x,0x%8x,0x%8x),plane num(%d)",
                dstSizeList[0],dstSizeList[1],dstSizeList[2],(unsigned int*)dstVirList[0],(unsigned int*)dstVirList[1],(unsigned int*)dstVirList[2],
...
MINT32 MdpMgrImp::startMdp(MDPMGR_CFG_STRUCT cfgData)
{
    ...
    LOG_DBG("+,cqIndx(%u),sceID(%u),cqPA(0x%x),tpipVa(0x%x),tpipPa(0x%x),isWaitBuf(%d),venc(%d)", \
            cfgData.cqIdx,sceID,cfgData.ispTpipeCfgInfo.drvinfo.DesCqPa,(unsigned int*)cfgData.ispTpipeCfgInfo.drvinfo.tpipeTableVa,cfgData.ispTpipeCfgInfo.drvinfo.tpipeTablePa, \
...
DpIspStream *MdpMgrImp::allocDpStream(MUINT32 sceID)
{
    ...
    LOG_DBG("-,pRetDpIspStream(0x%x)",(unsigned int*)pRetDpIspStream);
