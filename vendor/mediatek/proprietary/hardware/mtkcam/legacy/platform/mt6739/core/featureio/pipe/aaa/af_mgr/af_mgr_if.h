...
public:
    ...
    MRESULT Hal3AInitState(MINT32 i4SensorDev, MINT32 i4SensorIdx,MINT32 isInitMCU=1);
    MRESULT Hal3AUninitState(MINT32 i4SensorDev,MINT32 isInitMCU=1);
    ...
    MVOID doPDBuffer(MINT32 i4SensorDev, MVOID * buffer, MINT32 w,MINT32 h, MINT32 stride, MUINT32 i4FrmNum=0, MUINT32 i4RawFmt=0);
    MINT32 PDPureRawInterval(MINT32 i4SensorDev);
    MRESULT enableAF(MINT32 i4SensorDev, MINT32 a_i4En);
    MRESULT getPdInfoForSttCtrl(MINT32 i4SensorDev, MINT32 i4SensorIdx, MINT32 i4SensorMode, FEATURE_PDAF_STATUS &PDAFStatus);
    ...
    MVOID VSyncIrq(MINT32 i4SensorDev);
    MVOID pauseAF(MINT32 i4SensorDev, MBOOL a_bIsPaused);
    MBOOL IsFullScanMode(MINT32 i4SensorDev);
    ...
    MVOID SaveAfMgrInfo(MINT32 i4SensorDev, const char *);
    ...
    MINT32 CCTOPAFApplyNVRAMParam(MINT32 i4SensorDev,MVOID *a_pAFNVRAM, MUINT32 u4CamScenarioMode);
