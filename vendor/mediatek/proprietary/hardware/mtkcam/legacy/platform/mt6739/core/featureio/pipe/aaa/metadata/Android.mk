...
#    MY_CUST_METADATA_FILE_LIST := $(call my-all-config_xxx-under, config/imgsensor)
    ...
    MY_CUST_METADATA_FILE_LIST := $(call my-all-config_xxx-under, $(MTK_PATH_CUSTOM_PLATFORM_HAL1), hal/imgsensor)
    MY_CUST_METADATA_FILE_LIST += $(call my-all-config_xxx-under, $(MTK_PATH_CUSTOM_PLATFORM_HAL1), hal/lens)
    MY_CUST_METADATA_FILE_FULL := $(addprefix $(MTK_PATH_CUSTOM_PLATFORM_HAL1)/,$(MY_CUST_METADATA_FILE_LIST))
endif
#
