    ...
    if (i4SensorDev & ESensorDev_SubSecond) {
        if (!m_pParamctrl_Sub2) {
            ...
            if (m_pParamctrl_Sub2) {
                ...
                MY_ERR("m_pParamctrl_SubSecond2 is NULL");
                return MFALSE;
            }
        }
        else {
            MY_ERR("m_pParamctrl_SubSecond2 is not NULL");
            return MFALSE;
        }
    }
    return MTRUE;
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL IspTuningMgr::getIspGamma(MINT32 const i4SensorDev, MUINT32* pIspGamma, MBOOL* pEnable)
{
    if (i4SensorDev & ESensorDev_Main) {
        if (m_pParamctrl_Main) {
             m_pParamctrl_Main->getIspGamma(pIspGamma, pEnable);
        }
        else {
            MY_ERR("m_pParamctrl_Main is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Sub) {
            m_pParamctrl_Sub->getIspGamma(pIspGamma, pEnable);
        }
        else {
            MY_ERR("m_pParamctrl_Sub is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Main2) {
            m_pParamctrl_Main2->getIspGamma(pIspGamma, pEnable);
        }
        else {
            MY_ERR("m_pParamctrl_Main2 is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Sub2) {
            m_pParamctrl_Sub2->getIspGamma(pIspGamma, pEnable);
        }
        else {
            MY_ERR("m_pParamctrl_Sub2 is NULL");
            return MFALSE;
        ...
        MY_ERR("Err IspTuningMgr::getIspGamma()\n");
        return MFALSE;
    }
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL IspTuningMgr::setISO(MINT32 const i4SensorDev, MINT32 const i4ISOValue)
{
    if (i4SensorDev & ESensorDev_Main) {
        if (m_pParamctrl_Main) {
             m_pParamctrl_Main->setISO(i4ISOValue);
        }
        else {
            MY_ERR("m_pParamctrl_Main is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Sub) {
            m_pParamctrl_Sub->setISO(i4ISOValue);
        }
        else {
            MY_ERR("m_pParamctrl_Sub is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Main2) {
            m_pParamctrl_Main2->setISO(i4ISOValue);
        }
        else {
            MY_ERR("m_pParamctrl_Main2 is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Sub2) {
            m_pParamctrl_Sub2->setISO(i4ISOValue);
        }
        else {
            MY_ERR("m_pParamctrl_Sub2 is NULL");
            return MFALSE;
        ...
        MY_ERR("Err IspTuningMgr::setISO()\n");
        return MFALSE;
    }
...
MBOOL IspTuningMgr::setFlashDynamicInfo(MINT32 const i4SensorDev, MINT32 const i4FlashOnOff)
{
    ...
    if (i4SensorDev & ESensorDev_SubSecond) {
        if (m_pParamctrl_Sub2) {
            m_pParamctrl_Sub2->setFlashDynamicInfo(i4FlashOnOff);
        }
        else {
            MY_ERR("m_pParamctrl_Sub2 is NULL");
            return MFALSE;
...
MBOOL IspTuningMgr::getDebugInfo(MINT32 const i4SensorDev, NSIspExifDebug::IspExifDebugInfo_T& rIspExifDebugInfo, MBOOL const fgReadFromHW)
{
    if (i4SensorDev & ESensorDev_Main) {
        ...
        if (m_pParamctrl_Sub2) {
            m_pParamctrl_Sub2->getDebugInfo(rIspExifDebugInfo, fgReadFromHW);
        }
        else {
            MY_ERR("m_pParamctrl_Sub2 is NULL");
            return MFALSE;
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL IspTuningMgr::setRRZInfo(MINT32 const i4SensorDev, const RRZOInfo& rRrzInfo)
{
    //MY_LOG_IF(m_bDebugEnable,"%s(): i4SensorDev = %d, i4TGInfo = %d\n", __FUNCTION__, i4SensorDev, i4TGInfo);
    ISP_RRZ_INFO_T rRrzInfo_dst;

    rRrzInfo_dst.bEnable = MTRUE;
    rRrzInfo_dst.OfstX = (rRrzInfo.TG_W - rRrzInfo.CROP_W)>>1;
    rRrzInfo_dst.OfstY = (rRrzInfo.TG_H - rRrzInfo.CROP_H)>>1;
    rRrzInfo_dst.RtoW = (MFLOAT)rRrzInfo.RSZ_W/(MFLOAT)rRrzInfo.CROP_W;
    rRrzInfo_dst.RtoH = (MFLOAT)rRrzInfo.RSZ_H/(MFLOAT)rRrzInfo.CROP_H;

    if (i4SensorDev & ESensorDev_Main) {
        if (m_pParamctrl_Main) {
            m_pParamctrl_Main->setRRZInfo(rRrzInfo_dst);
        }
        else {
            MY_ERR("m_pParamctrl_Main is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Sub) {
            m_pParamctrl_Sub->setRRZInfo(rRrzInfo_dst);
        }
        else {
            MY_ERR("m_pParamctrl_Sub is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Main2) {
            m_pParamctrl_Main2->setRRZInfo(rRrzInfo_dst);
        }
        else {
            MY_ERR("m_pParamctrl_Main2 is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Sub2) {
            m_pParamctrl_Sub2->setRRZInfo(rRrzInfo_dst);
        }
        else {
            MY_ERR("m_pParamctrl_Sub2 is NULL");
            return MFALSE;
        ...
        MY_ERR("Err IspTuningMgr::setRRZInfo()\n");
        return MFALSE;
    }
