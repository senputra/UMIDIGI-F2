...
BIND_ISP_TYPES(ISP_NVRAM_BNR_BPC_T, ISP_MGR_BNR_T);
//BIND_ISP_TYPES(ISP_NVRAM_BPC_RMM_T, ISP_MGR_BNR_T);
BIND_ISP_TYPES(ISP_NVRAM_BNR_NR1_T, ISP_MGR_BNR_T);
BIND_ISP_TYPES(ISP_NVRAM_BNR_PDC_T, ISP_MGR_BNR_T);
BIND_ISP_TYPES(ISP_NVRAM_LSC_T, ISP_MGR_LSC_T);
BIND_ISP_TYPES(ISP_NVRAM_SL2_T, ISP_MGR_SL2_T);
BIND_ISP_TYPES(ISP_NVRAM_NSL2A_T, ISP_MGR_NSL2A_T);
BIND_ISP_TYPES(ISP_NVRAM_NSL2A_GET_T, ISP_MGR_NSL2A_T);
