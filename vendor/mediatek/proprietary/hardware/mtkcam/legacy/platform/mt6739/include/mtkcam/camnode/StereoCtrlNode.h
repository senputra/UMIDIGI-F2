...
enum StereoCtrlType
{
    ...
    STEREO_CTRL_ZSD         = 0x0008,
    STEREO_CTRL_EIS         = 0x0010,
...
struct SCNodeInitCfg
{
    ...
    MUINT32         mAlgoImgWidth;  // preview output size
    MUINT32         mAlgoImgHeight;
    MUINT32         mMainImgWidth;  // Capture Bokeh image size
    MUINT32         mMainImgHeight;
    MUINT32         mDepthmapWidth;  // Capture depthmap size
    MUINT32         mDepthmapHeight;
    MUINT32         mTransform;
    MUINT32         mMainSensorMode;
    MUINT32         mMain2SensorMode;
    ...
    SCNodeInitCfg(
        ...
        , mMainSensorMode (_mainMode)
        , mMain2SensorMode (_main2Mode)
        , mDepthmapWidth (0)
        , mDepthmapHeight (0)
    {}
    SCNodeInitCfg(
            ...
            MUINT32 _mainMode,
            MUINT32 _main2Mode,
            MUINT32 _depthmapWidth,
            MUINT32 _depthmapHeight)
        : mScenarioType (_scen)
        , mAlgoImgWidth (_algoWidth)
        , mAlgoImgHeight (_algoHeight)
        , mMainImgWidth (_mainWidth)
        ...
        , mMainSensorMode (_mainMode)
        , mMain2SensorMode (_main2Mode)
        , mDepthmapWidth (_depthmapWidth)
        , mDepthmapHeight (_depthmapHeight)
    {}
