...
#else
//#define MY_LOGD(fmt, arg...)    do {CAM_LOGD(LOG_TAG fmt, ##arg);printf(LOG_TAG fmt "\n", ##arg);} while (0)
//#define MY_LOGE(fmt, arg...)    do {CAM_LOGE("error" LOG_TAG fmt, ##arg);printf(LOG_TAG fmt "\n", ##arg);} while (0)
//#define MY_LOGD(fmt, arg...)    CAM_LOGD(LOG_TAG fmt, ##arg)
//#define MY_LOGE(fmt, arg...)    CAM_LOGE("error" LOG_TAG fmt, ##arg)
//#define MY_LOGD                 CAM_LOGD
//#define MY_LOGE                 CAM_LOGE
#endif
