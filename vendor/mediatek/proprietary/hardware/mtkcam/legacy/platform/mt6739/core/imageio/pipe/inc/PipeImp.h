...
public:     ////    Operations.
    ...
    inline MVOID    enableNotifyMsg(MINT32 const i4MsgTypes)            { int err_ret = ::android_atomic_or(i4MsgTypes, &mi4NotifyMsgSet);err_ret; }
    inline MVOID    disableNotifyMsg(MINT32 const i4MsgTypes)           { int err_ret = ::android_atomic_and(~i4MsgTypes, &mi4NotifyMsgSet);err_ret; }
    //
    //  data callback
    inline MBOOL    isDataMsgEnabled(MINT32 const i4MsgTypes) const     { return (i4MsgTypes & mi4DataMsgSet); }
    inline MVOID    enableDataMsg(MINT32 const i4MsgTypes)              { int err_ret = ::android_atomic_or(i4MsgTypes, &mi4DataMsgSet);err_ret; }
    inline MVOID    disableDataMsg(MINT32 const i4MsgTypes)             { int err_ret = ::android_atomic_and(~i4MsgTypes, &mi4DataMsgSet);err_ret; }
...
protected:  ////    Data Members.
    //
    EDrvScenario const   meScenarioID;
    EScenarioFmt const  meScenarioFmt;
    //EScenarioFmt        meScenarioFmtD;
...
public:     ////    Operations.
    ...
    static  MINT32  mapScenarioFormatToSubmode(EDrvScenario const eScenarioID, EScenarioFmt const eScenarioFmt);
};
