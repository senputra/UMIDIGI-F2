 ...
 enum ECamShotNotifyMsg
{
    ...
    ECamShot_NOTIFY_MSG_ALL           = 0x100F,       /*!< all message notify  */
};
...
enum ECamShotDataMsg
{
    ...
    ECamShot_DATA_MSG_META           = 0x0040,           /*!< meta data callback message */
    ECamShot_DATA_MSG_JPEG_CLEANIMG  = 0x0080,           /*!< clean image jpeg data callback message */
    ECamShot_DATA_MSG_DEPTHMAP       = 0x0100,           /*!< depthmap data callback message */
...
enum ECamShotImgBufType {
    ...
    ECamShot_BUF_TYPE_JPEG_CLEANIMG  = 0x0020,        /*!< buffer type for clean image jpeg data */
    ECamShot_BUF_TYPE_ALL            = 0x003F,        /*!< buffer type all */
};
...
enum ECamShotCmd
{
    ...
    ECamShot_CMD_SET_P2OUT_BUF       = 0x0020,              /*!< set pass2 out buffer for ZSD */
    ECamShot_CMD_ALL                 = 0x003F,              /*!< all command */
};
