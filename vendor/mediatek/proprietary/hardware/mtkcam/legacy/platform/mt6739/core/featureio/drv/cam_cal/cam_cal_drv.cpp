                          ...
                          void *a_pCamCalData)
{
   ...
   // dumpEnable = 1; // Jessy add this, adb shell setprop vendor.camcaldrv.log cannot work
    ...
    if ( (i4SensorDevId & (!(SENSOR_DEV_MAIN_3D|SENSOR_DEV_SUB))) ||
        (a_eCamCalDataType > CAMERA_CAM_CAL_DATA_PDAF)||
        (a_pCamCalData == NULL) )
    {
    ...
    switch(a_eCamCalDataType) {
        ...
        case CAMERA_CAM_CAL_DATA_PDAF:                               //seanlin 121016 return none or N3D3D
