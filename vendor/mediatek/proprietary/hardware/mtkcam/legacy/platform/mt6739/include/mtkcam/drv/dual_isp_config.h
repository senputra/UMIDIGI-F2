...
#define DUAL_IN_OUT_STRUCT_LUT_HW(CMD, a, b, c, d, e, f) \
	...
	/* DBS */\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_SIGMA, CAM_DBS_SIGMA, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_BSTBL_0, CAM_DBS_BSTBL_0, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_BSTBL_1, CAM_DBS_BSTBL_1, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_BSTBL_2, CAM_DBS_BSTBL_2, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_BSTBL_3, CAM_DBS_BSTBL_3, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_CTL, CAM_DBS_CTL, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_CTL_2, CAM_DBS_CTL_2, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_SIGMA_2, CAM_DBS_SIGMA_2, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_YGN, CAM_DBS_YGN, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_SL_Y12, CAM_DBS_SL_Y12, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_SL_Y34, CAM_DBS_SL_Y34, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_SL_G12, CAM_DBS_SL_G12, R)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_SL_G34, CAM_DBS_SL_G34, R)\
	/* DBS_D */\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_SIGMA, CAM_DBS_D_SIGMA, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_BSTBL_0, CAM_DBS_D_BSTBL_0, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_BSTBL_1, CAM_DBS_D_BSTBL_1, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_BSTBL_2, CAM_DBS_D_BSTBL_2, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_BSTBL_3, CAM_DBS_D_BSTBL_3, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_CTL, CAM_DBS_D_CTL, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_CTL_2, CAM_DBS_D_CTL_2, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_SIGMA_2, CAM_DBS_D_SIGMA_2, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_YGN, CAM_DBS_D_YGN, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_SL_Y12, CAM_DBS_D_SL_Y12, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_SL_Y34, CAM_DBS_D_SL_Y34, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_SL_G12, CAM_DBS_D_SL_G12, W)\
	CMD(a, b, c, d, e, f, CAM_REG_DBS_D_SL_G34, CAM_DBS_D_SL_G34, W)\
	/* OB */\
	...
	/* BPC */\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_CON, CAM_BNR_BPC_CON, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_TH1, CAM_BNR_BPC_TH1, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_TH2, CAM_BNR_BPC_TH2, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_TH3, CAM_BNR_BPC_TH3, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_TH4, CAM_BNR_BPC_TH4, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_DTC, CAM_BNR_BPC_DTC, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_COR, CAM_BNR_BPC_COR, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_TBLI1, CAM_BNR_BPC_TBLI1, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_TBLI2, CAM_BNR_BPC_TBLI2, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_TH1_C, CAM_BNR_BPC_TH1_C, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_TH2_C, CAM_BNR_BPC_TH2_C, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_BPC_TH3_C, CAM_BNR_BPC_TH3_C, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_NR1_CON, CAM_BNR_NR1_CON, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_NR1_CT_CON, CAM_BNR_NR1_CT_CON, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_RSV1, CAM_BNR_RSV1, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_RSV2, CAM_BNR_RSV2, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_CON, CAM_BNR_PDC_CON, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_GAIN_L0, CAM_BNR_PDC_GAIN_L0, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_GAIN_L1, CAM_BNR_PDC_GAIN_L1, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_GAIN_L2, CAM_BNR_PDC_GAIN_L2, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_GAIN_L3, CAM_BNR_PDC_GAIN_L3, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_GAIN_L4, CAM_BNR_PDC_GAIN_L4, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_GAIN_R0, CAM_BNR_PDC_GAIN_R0, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_GAIN_R1, CAM_BNR_PDC_GAIN_R1, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_GAIN_R2, CAM_BNR_PDC_GAIN_R2, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_GAIN_R3, CAM_BNR_PDC_GAIN_R3, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_GAIN_R4, CAM_BNR_PDC_GAIN_R4, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_TH_GB, CAM_BNR_PDC_TH_GB, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_TH_IA, CAM_BNR_PDC_TH_IA, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_TH_HD, CAM_BNR_PDC_TH_HD, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_SL, CAM_BNR_PDC_SL, R)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_PDC_POS, CAM_BNR_PDC_POS, W)\
	/* BPC_D */\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_CON, CAM_BNR_D_BPC_CON, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_TH1, CAM_BNR_D_BPC_TH1, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_TH2, CAM_BNR_D_BPC_TH2, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_TH3, CAM_BNR_D_BPC_TH3, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_TH4, CAM_BNR_D_BPC_TH4, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_DTC, CAM_BNR_D_BPC_DTC, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_COR, CAM_BNR_D_BPC_COR, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_TBLI1, CAM_BNR_D_BPC_TBLI1, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_TBLI2, CAM_BNR_D_BPC_TBLI2, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_TH1_C, CAM_BNR_D_BPC_TH1_C, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_TH2_C, CAM_BNR_D_BPC_TH2_C, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_BPC_TH3_C, CAM_BNR_D_BPC_TH3_C, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_NR1_CON, CAM_BNR_D_NR1_CON, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_NR1_CT_CON, CAM_BNR_D_NR1_CT_CON, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_RSV1, CAM_BNR_D_RSV1, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_RSV2, CAM_BNR_D_RSV2, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_CON, CAM_BNR_D_PDC_CON, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_GAIN_L0, CAM_BNR_D_PDC_GAIN_L0, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_GAIN_L1, CAM_BNR_D_PDC_GAIN_L1, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_GAIN_L2, CAM_BNR_D_PDC_GAIN_L2, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_GAIN_L3, CAM_BNR_D_PDC_GAIN_L3, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_GAIN_L4, CAM_BNR_D_PDC_GAIN_L4, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_GAIN_R0, CAM_BNR_D_PDC_GAIN_R0, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_GAIN_R1, CAM_BNR_D_PDC_GAIN_R1, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_GAIN_R2, CAM_BNR_D_PDC_GAIN_R2, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_GAIN_R3, CAM_BNR_D_PDC_GAIN_R3, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_GAIN_R4, CAM_BNR_D_PDC_GAIN_R4, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_TH_GB, CAM_BNR_D_PDC_TH_GB, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_TH_IA, CAM_BNR_D_PDC_TH_IA, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_TH_HD, CAM_BNR_D_PDC_TH_HD, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_SL, CAM_BNR_D_PDC_SL, W)\
	CMD(a, b, c, d, e, f, CAM_REG_BNR_D_PDC_POS, CAM_BNR_D_PDC_POS, W)\
	/* BPCI */\
	...
	CMD(a, b, c, d, e, f, CAM_REG_RRZ_RLB_AOFST, CAM_RRZ_RLB_AOFST, W)\
	...
	CMD(a, b, c, d, e, f, CAM_REG_RRZ_D_RLB_AOFST, CAM_RRZ_D_RLB_AOFST, W)\
