...
//don't use perfservice after Android O
...
{
    CAM_LOGD("EnablePerfService+");
    int PerfServiceHandle = PerfServiceNative_userRegBigLittle(4, 1274000, 4, 1274000);
