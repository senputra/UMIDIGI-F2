...
onHandleStartPreview()
{
    ...
    //
    {
        ...
        property_get( "vendor.debug.tworunpass2.enable", value, "0");
    ...
    {
        char value[PROPERTY_VALUE_MAX] = {'\0'};
        property_get( "vendor.debug.lowPowerVR.enable", value, "-1");
        MINT32 val = atoi(value);
        if( val > -1 )
        {
    ...
    { // for sensor porting debug
        char value[PROPERTY_VALUE_MAX] = {'\0'};
        property_get( "vendor.debug.force_sensormode", value, "-1");
        MINT32 val = atoi(value);
        if( val > 0 ) {
            sensorScenario = val;
    ...
    {
        char value[PROPERTY_VALUE_MAX] = {'\0'};
        property_get( "vendor.debug.pass1.rawtype", value, "-1");
        MINT32 val = atoi(value);
        if( val > -1 ) {
            rawType = val;
