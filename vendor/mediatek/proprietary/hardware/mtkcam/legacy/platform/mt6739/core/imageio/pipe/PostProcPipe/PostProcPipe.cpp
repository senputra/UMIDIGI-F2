    ...
    for (MUINT32 i = 0 ; i < vInPorts.size() ; i++ )
    {
        ...
        switch(vInPorts[i]->index)
        {
            case EPortIndex_IMGI:
                ...
                break;
            case EPortIndex_VIPI:    //may multi-plane, vipi~vip3i, Not Support
            #if 0
                idx_vipi = i;
            ...
            tcm_en_collect |= CAM_CTL_TPIPE_VIPI_TCM_EN;
                ...
                break;
            case EPortIndex_VIP3I: //only vip3i input(weighting table), there are only vipi+vip3i without vip2i for mfb mixing path, Not Support
            #if 0
                idx_vip3i = i;
                en_p2_dma |=  CAM_CTL_EN_P2_DMA_VIP3I_EN;
                tcm_en_collect |= CAM_CTL_TPIPE_VIP3I_TCM_EN;
                ...
                PIPE_ERR("[Error]Not support this input port(%d),i(%d)",vInPorts[i]->index,i);
                break;
            case EPortIndex_LCEI:// Not Support
            #if 0
                idx_lcei = i;
                ...
                PIPE_ERR("[Error]Not support this input port(%d),i(%d)",vInPorts[i]->index,i);
                break;
            case EPortIndex_UFDI:// Not Support
            #if 0
                idx_ufdi = i;
    ...
    for (MUINT32 i = 0 ; i < vOutPorts.size() ; i++ )
    {
        ...
        switch(vOutPorts[i]->index){
            case EPortIndex_IMG2O:
                ...
                break;
            case EPortIndex_IMG3O:// Not Support
            #if 0
                idx_img3o = i;
             ...
             #endif
                PIPE_ERR("[Error]Not support this input port(%d),i(%d)",vOutPorts[i]->index,i);
                break;
            case EPortIndex_WROTO:
                idx_wroto = i;
            ...
            case EPortIndex_JPEGO:
                ...
                break;
            case EPortIndex_FEO:// Not Support
            #if 0
                if(meScenarioID == eDrvScenario_CC_vFB_FB)
                {
            ...
            case EPortIndex_IMGO: // ip raw scenario
                ...
                break;
            case EPortIndex_MFBO: // mfb blending, Not Support
            #if 0
                idx_mfbo = i;
    ...
    // check rrz info. and pixel id
        ...
        PIPE_DBG("[rrz]dma=%d,pixIdP2(%d)",(((stISP_BUF_INFO*)(pPipePackageInfo->pPrivateData))->dma),pixIdP2);
            ...
            if((((stISP_BUF_INFO*)(pPipePackageInfo->pPrivateData))->rrz_info.dstH)) {
                ...
                PIPE_ERR("[Error]wrong dstH(%d),pCookie(0x%x),rrz_info(0x%x)",(((stISP_BUF_INFO*)(pPipePackageInfo->pPrivateData))->rrz_info.dstH),(unsigned int*)(pPipePackageInfo->pPrivateData),(unsigned int*)(&(((stISP_BUF_INFO*)(pPipePackageInfo->pPrivateData))->rrz_info)));
            }
            PIPE_DBG("[rrz]pCookie(0x%x),src(%d,%d,%d,%d),dst(%d,%d)",(unsigned int*)(pPipePackageInfo->pPrivateData), \
...
//                en_p2_dma |=  CAM_CTL_DMA_EN_VIPI_EN;
    ...
    if(pPipePackageInfo->isV3==true){
            ...
            if(en_p1_dma & CAM_CTL_EN_P1_DMA_LSCI_EN){
                ...
                PIPE_DBG("[LSCI](x,y)=(0x%x,0x%x),s(0x%x),pa(0x%x)",\
            ...
            //
            PIPE_DBG("[V3]pIspPhyReg(0x%08x)",(unsigned int*)pIspPhyReg);
        ...
        if(pPipePackageInfo->mP1PrivateData.ResizeDstH) {
            ...
            PIPE_ERR("[Error]wrong dstH(%d),hrz_info(0x%x)",pPipePackageInfo->mP1PrivateData.ResizeDstH,(unsigned int)rrzRatio);
        }
    ...
    PIPE_DBG("Pass(%d),imgi.fmt(0x%x),meScenarioID(%d),isCropG1En(%d),m_CrzEn(%d),mdpSrcFmt(0x%x),mdp_src(0x%x,0x%x,0x%x,0x%x),en_p2_dma(0x%08x),crop1TableIdx(%d),mdpCheck1(%d),mdpCheck2(%d),drvScenario(%d),tcm_en(0x%x)",\
    ...
    if (-1 != idx_vipi ) {
        ...
        PIPE_DBG("[vipi]size(0x%08x),Va(0x%08x),Pa(0x%08x),offset(0x%08x),align(0x%08x),stride(0x%08x)",
                m_camPass2Param.vipi.memBuf.size,m_camPass2Param.vipi.memBuf.base_vAddr,m_camPass2Param.vipi.memBuf.base_pAddr,m_camPass2Param.vipi.memBuf.ofst_addr,m_camPass2Param.vipi.memBuf.alignment,(unsigned int)m_camPass2Param.vipi.size.stride);
        ...
        {    //multi-plane input image, vipi/vip2i/vip3i
            ...
            PIPE_DBG("[vip2i]size[0x%x,0x%x](0x%08x),offset(0x%08x),align(0x%08x),stride(0x%08x)",m_camPass2Param.vip2i.size.w,m_camPass2Param.vip2i.size.h,
                    m_camPass2Param.vip2i.memBuf.size,m_camPass2Param.vip2i.memBuf.ofst_addr,m_camPass2Param.vip2i.memBuf.alignment,(unsigned int)m_camPass2Param.vip2i.size.stride);
            ...
            if (-1 != idx_vip3i )
            {
                ...
                PIPE_DBG("[vip3i]size[0x%x,0x%x](0x%08x),Va(0x%08x),Pa(0x%08x),offset(0x%08x),align(0x%08x),stride(0x%08x),vipi_uv_swap(%d)",m_camPass2Param.vip3i.size.w,m_camPass2Param.vip3i.size.h,
                        m_camPass2Param.vip3i.memBuf.size,m_camPass2Param.vip3i.memBuf.base_vAddr,m_camPass2Param.vip3i.memBuf.base_pAddr,m_camPass2Param.vip3i.memBuf.ofst_addr,m_camPass2Param.vip3i.memBuf.alignment,(unsigned int)m_camPass2Param.vip3i.size.stride,vipi_uv_swap);
            }
        }
        else
        {
    ...
    if (-1 != idx_img3o ) {
        ...
        PIPE_DBG("[img3o]size(0x%08x),Va(0x%08x),Pa(0x%08x),offset(0x%08x),align(0x%08x),stride(0x%08x)",
                m_camPass2Param.img3o.memBuf.size,m_camPass2Param.img3o.memBuf.base_vAddr,m_camPass2Param.img3o.memBuf.base_pAddr,m_camPass2Param.img3o.memBuf.ofst_addr,m_camPass2Param.img3o.memBuf.alignment,(unsigned int)m_camPass2Param.img3o.size.stride);
        ...
        if (-1 != idx_img3bo )
        {
            ...
            PIPE_DBG("[img3bo]size[0x%x,0x%x](0x%08x),offset(0x%08x),align(0x%08x),stride(0x%08x)",m_camPass2Param.img3bo.size.w,m_camPass2Param.img3bo.size.h,
                    m_camPass2Param.img3bo.memBuf.size,m_camPass2Param.img3bo.memBuf.ofst_addr,m_camPass2Param.img3bo.memBuf.alignment,(unsigned int)m_camPass2Param.img3bo.size.stride);
            ...
            if (-1 != idx_img3co )
            {
                ...
                PIPE_DBG("[img3co]size[0x%x,0x%x](0x%08x),Va(0x%08x),Pa(0x%08x),offset(0x%08x),align(0x%08x),stride(0x%08x),img3o_uv_swap(%d)",m_camPass2Param.img3co.size.w,m_camPass2Param.img3co.size.h,
                        m_camPass2Param.img3co.memBuf.size,m_camPass2Param.img3co.memBuf.base_vAddr,m_camPass2Param.img3co.memBuf.base_pAddr,m_camPass2Param.img3co.memBuf.ofst_addr,m_camPass2Param.img3co.memBuf.alignment,(unsigned int)m_camPass2Param.img3co.size.stride,img3o_uv_swap);
            }
        }
    }
