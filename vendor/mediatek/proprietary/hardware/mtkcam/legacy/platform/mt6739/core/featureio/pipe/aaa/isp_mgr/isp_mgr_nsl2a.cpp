...
MBOOL
ISP_MGR_NSL2A_T::
apply(EIspProfile_T eIspProfile, ISP_RRZ_INFO_T rRrzInfo)
{
    addressErrorCheck("Before ISP_MGR_NSL2A_T::apply()");
    ...
    if(u4NSL2a_EN){
        ...
        ISP_RRZ_INFO_T rRrzInfo_ = rRrzInfo;

        if(!rRrzInfo_.bEnable){
            rRrzInfo_.OfstX = 0;
            rRrzInfo_.OfstY = 0;
            rRrzInfo_.RtoW = 1.0f;
            rRrzInfo_.RtoH = 1.0f;
        ...
        reinterpret_cast<ISP_CAM_NSL2A_RZ_T*>(REG_INFO_VALUE_PTR(CAM_NSL2A_RZ))->SL2_HRZ_COMP = (MUINT32)(2048.0f/rRrzInfo_.RtoW);
        reinterpret_cast<ISP_CAM_NSL2A_RZ_T*>(REG_INFO_VALUE_PTR(CAM_NSL2A_RZ))->SL2_VRZ_COMP = (MUINT32)(2048.0f/rRrzInfo_.RtoH);

        reinterpret_cast<ISP_CAM_NSL2A_CEN_T*>(REG_INFO_VALUE_PTR(CAM_NSL2A_CEN))->SL2_CENTR_X = (m_PureSL2.cen.bits.SL2_CENTR_X - rRrzInfo_.OfstX);
        reinterpret_cast<ISP_CAM_NSL2A_CEN_T*>(REG_INFO_VALUE_PTR(CAM_NSL2A_CEN))->SL2_CENTR_Y = (m_PureSL2.cen.bits.SL2_CENTR_Y - rRrzInfo_.OfstY);
    ...
    addressErrorCheck("After ISP_MGR_NSL2A_T::apply()");
