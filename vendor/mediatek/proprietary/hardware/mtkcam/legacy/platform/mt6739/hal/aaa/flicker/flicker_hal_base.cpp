...
{   \
    ...
    if (senorDev & e_SensorDevSub2)    \
        errSub2 = FlickerHal::getInstance(e_SensorDevSub2)->function();  \
...
{   \
    ...
    if (senorDev & e_SensorDevSub2)    \
        errSub2 = FlickerHal::getInstance(e_SensorDevSub2)->function(v1);  \
    return errOp(errMain, errSub, errMain2, errSub2);    \
}
...
{   \
    ...
    if (senorDev & e_SensorDevSub2)    \
        errSub2 = FlickerHal::getInstance(e_SensorDevSub2)->function(v1, v2);  \
    return errOp(errMain, errSub, errMain2, errSub2);    \
}
...
#define def_ImpBody1(function,senorDev,p1) \
    ...
    if (senorDev & e_SensorDevSub2)    \
        errSub2 = FlickerHal::getInstance(e_SensorDevSub2)->function(p1);  \
    return errOp(errMain, errSub, errMain2, errSub2);
...
#define def_ImpBody2(function,senorDev,p1, p2) \
    ...
    if (senorDev & e_SensorDevSub2)    \
        errSub2 = FlickerHal::getInstance(e_SensorDevSub2)->function(p1, p2);  \
    return errOp(errMain, errSub, errMain2, errSub2);
