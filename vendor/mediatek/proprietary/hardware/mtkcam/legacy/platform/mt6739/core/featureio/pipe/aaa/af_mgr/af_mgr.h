...
public:
    ...
    */
    ...
    //===================================================================================================
    //===================================================================================================
    MVOID doPDBuffer(MVOID * buffer, MINT32 w,MINT32 h, MINT32 stride, MUINT32 i4FrmNum, MUINT32 i4RawFmt);
...
private:
    ...
    NVRAM_LENS_PARA_STRUCT  m_sNVRam;
