...
protected: //private:
    ...
    */
    ...
    virtual MRESULT EnableCamSVThread(MINT32 a_bEnable);
...
private:
    ...
    */
    ...
    /**
    * @Cam Simple Version thread execution function
    */
    static MVOID* CamSVThreadFunc(void *arg);
...
protected:
    ...
    pthread_t        mAFThread;
    pthread_t       mCamSVThread;
    StateMgr*       mpStateMgr;
    MBOOL           m_bFaceDetectEnable;
    MBOOL           m_CamSVthreadAlive = 1;
