...
#define REFOCUS_MDP_CALLBACK    (0)    // only use 0 for platform without MDP callback support
...
struct VSDOFParamCopy   //! Note -> should be the same as DpDataType.h
{
    ...
    // constructor
    VSDOFParamCopy():feature(ISP_FEATURE_COPY_REFOCUS),
        defaultUpTable(10),
        defaultDownTable(10),
        IBSEGain(0)
    {
