...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL ISP_MGR_AF_STAT_CONFIG_T::config(  MINT32 i4SensorTG, AF_CONFIG_T &a_sAFConfig, AREA_T &sOutHWROI, MINT32 &i4OutHWBlkNumX, MINT32 &i4OutHWBlkNumY, MINT32 &i4OutHWBlkSizeX, MINT32 &i4OutHWBlkSizeY)
{
    ...
    MINTPTR handleSGG5;
    {
        ...
        MBOOL bAFOPortOK = MFALSE;
        if(SensorTG==1)
        {
            // AFO_D
            bAFOPortOK = sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_AFO, (MINTPTR)&handleAFO, (MINTPTR)(&("AFMgr::ConfigHWReg()")));
            if(MTRUE == bAFOPortOK)
            {
                m_u4AFStride = xsize + af_blk_sz;
                IOPIPE_SET_MODUL_REG(handleAFO, CAM_AFO_XSIZE,  xsize-1);
                IOPIPE_SET_MODUL_REG(handleAFO, CAM_AFO_YSIZE,  ysize-1);
                IOPIPE_SET_MODUL_REG(handleAFO, CAM_AFO_STRIDE, m_u4AFStride);
                if(i4ConfigChanged!=0 || m_bDebugEnable)
                {
                    CAM_LOGD( "SW : CAM_AFO_XSIZE(0x%x) CAM_AFO_YSIZE(0x%x) CAM_AFO_STRIDE(0x%x)",
                              xsize-1,
                              ysize-1,
                              m_u4AFStride);
                }
        ...
        {
            // AFO_D
            bAFOPortOK = sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_AFO_D, (MINTPTR)&handleAFO, (MINTPTR)(&("AFMgr::ConfigHWReg()")));
            if(MTRUE == bAFOPortOK)
            {
                m_u4AFStride = xsize + af_blk_sz;
        ...
        // AF
        MBOOL bAFPortOK = MFALSE;
        if(SensorTG==1)
        {
            bAFPortOK = sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_AF, (MINTPTR)&handleAF, (MINTPTR)(&("AFMgr::ConfigHWReg()")));
            if (MTRUE == bAFPortOK)
            {
                // AF
        ...
        {
            bAFPortOK = sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_AF_D, (MINTPTR)&handleAF, (MINTPTR)(&("AFMgr::ConfigHWReg()")));
            if (MTRUE == bAFPortOK)
            {
                // AF
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_SIZE,     reg_af_size.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_CON,      reg_af_con.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_VLD,      reg_af_vld.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_BLK_0,    reg_af_blk_0.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_BLK_1,    reg_af_blk_1.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_TH_0,     reg_af_th_0.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_TH_1,     reg_af_th_1.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_FLT_1,    reg_af_flt_1.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_FLT_2,    reg_af_flt_2.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_FLT_3,    reg_af_flt_3.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_FLT_4,    reg_af_flt_4.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_FLT_5,    reg_af_flt_5.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_FLT_6,    reg_af_flt_6.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_FLT_7,    reg_af_flt_7.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_FLT_8,    reg_af_flt_8.Raw);
                IOPIPE_SET_MODUL_REG(handleAF, CAM_AF_D_TH_2,     reg_af_th_2.Raw);
                if(i4ConfigChanged!=0 || m_bDebugEnable)
                {
                    CAM_LOGD( "SW : CAM_AF_D_SIZE(0x%x) CAM_AF_D_CON(0x%x) CAM_AF_D_VLD(0x%x)",
                              reg_af_size.Raw,
                              reg_af_con.Raw,
                              reg_af_vld.Raw);
                    CAM_LOGD( "SW : CAM_AF_D_BLK_0(0x%x) CAM_AF_D_BLK_1(0x%x)",
                              reg_af_blk_0.Raw,
                              reg_af_blk_1.Raw);
                    CAM_LOGD( "SW : CAM_AF_D_TH_0(0x%x) CAM_AF_D_TH_1(0x%x) CAM_AF_D_TH_2(0x%x)",
                              reg_af_th_0.Raw,
                              reg_af_th_1.Raw,
                              reg_af_th_2.Raw);
                    CAM_LOGD( "SW : CAM_AF_D_FLT_1(0x%x) CAM_AF_D_FLT_2(0x%x) CAM_AF_D_FLT_3(0x%x) CAM_AF_D_FLT_4(0x%x) CAM_AF_D_FLT_5(0x%x) CAM_AF_D_FLT_6(0x%x) CAM_AF_FLT_D_7(0x%x) CAM_AF_FLT_D_8(0x%x)",
                              reg_af_flt_1.Raw,
                              reg_af_flt_2.Raw,
                              reg_af_flt_3.Raw,
                              reg_af_flt_4.Raw,
        ...
        // SGG1
        MBOOL bSGG1PortOK = MFALSE;
        if(SensorTG==1)
        {
            bSGG1PortOK = sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_SGG1, (MINTPTR)&handleSGG1, (MINTPTR)(&("AFMgr::ConfigHWReg()")));
        ...
        {
            bSGG1PortOK = sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_SGG1_D, (MINTPTR)&handleSGG1, (MINTPTR)(&("AFMgr::ConfigHWReg()")));
            if (MTRUE ==bSGG1PortOK)
            {
                IOPIPE_SET_MODUL_REG(handleSGG1, CAM_SGG1_D_PGN,    reg_sgg1_pgn.Raw);
                IOPIPE_SET_MODUL_REG(handleSGG1, CAM_SGG1_D_GMRC_1, reg_sgg1_gmrc_1.Raw);
                IOPIPE_SET_MODUL_REG(handleSGG1, CAM_SGG1_D_GMRC_2, reg_sgg1_gmrc_2.Raw);
                if(i4ConfigChanged!=0 || m_bDebugEnable)
                {
                    CAM_LOGD( "SW : CAM_SGG1_D_PGN(0x%x) CAM_SGG1_D_GMRC_1(0x%x) CAM_SGG1_D_GMRC_2(0x%x)",
                              reg_sgg1_pgn.Raw,
                              reg_sgg1_gmrc_1.Raw,
                              reg_sgg1_gmrc_2.Raw);
                }
        ...
        // SGG5
        MBOOL bSGG5PortOK = MFALSE;
        if(SensorTG==1)
        {
            bSGG5PortOK = sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_SGG5, (MINTPTR)&handleSGG5, (MINTPTR)(&("AFMgr::ConfigHWReg()")));
        ...
        {
            bSGG5PortOK = sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_SGG5_D, (MINTPTR)&handleSGG5, (MINTPTR)(&("AFMgr::ConfigHWReg()")));
            if(MTRUE == bSGG5PortOK)
            {
                // SGG5
                IOPIPE_SET_MODUL_REG(handleSGG5, CAM_SGG5_D_PGN,    reg_sgg5_pgn.Raw);
                IOPIPE_SET_MODUL_REG(handleSGG5, CAM_SGG5_D_GMRC_1, reg_sgg5_gmrc_1.Raw);
                IOPIPE_SET_MODUL_REG(handleSGG5, CAM_SGG5_D_GMRC_2, reg_sgg5_gmrc_2.Raw);
                if(i4ConfigChanged!=0 || m_bDebugEnable)
                {
                    CAM_LOGD( "SW : CAM_SGG5_D_PGN(0x%x) CAM_SGG5_GMRC_D_1(0x%x) CAM_SGG5_D_GMRC_2(0x%x)",
                              reg_sgg5_pgn.Raw,
                              reg_sgg5_gmrc_1.Raw,
                              reg_sgg5_gmrc_2.Raw);
                }
    ...
    if(i4ConfigChanged!=0 || m_bDebugEnable)
    {
        if( m_pIspReg)
        {
            if(SensorTG==1)
            {
                CAM_LOGD( "HW-AFO XSIZE(0x%x) YSIZE(0x%x) STRIDE(0x%x)",
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AFO_XSIZE ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AFO_YSIZE ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AFO_STRIDE));
            ...
            else if(SensorTG==2)
            {
                ...
                CAM_LOGD( "HW-AF_D SIZE(0x%x) CON(0x%x) VLD(0x%x)",
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_SIZE     ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_CON      ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_VLD      ));

                CAM_LOGD( "HW-AF_D BLK_0(0x%x) BLK_1(0x%x)",
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_BLK_0    ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_BLK_1    ));

                CAM_LOGD( "HW-AF_D TH_0(0x%x) TH_1(0x%x) TH_2(0x%x)",
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_TH_0     ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_TH_1     ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_TH_2     ));

                CAM_LOGD( "HW-AF_D FLT_1(0x%x) FLT_2(0x%x) FLT_3(0x%x) FLT_4(0x%x) FLT_5(0x%x) FLT_6(0x%x) FLT_7(0x%x) FLT_8(0x%x)",
                          ...
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_FLT_6    ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_FLT_7    ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_AF_D_FLT_8    ));

                CAM_LOGD( "HW-SGG1_D PNG(0x%x) GMRC_1(0x%x) GMRC_2(0x%x)",
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_SGG1_D_PGN,   ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_SGG1_D_GMRC_1 ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_SGG1_D_GMRC_2 ));

                CAM_LOGD( "HW-SGG5_D PNG(0x%x) GMRC_1(0x%x) GMRC_2(0x%x)",
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_SGG5_D_PGN    ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_SGG5_D_GMRC_1 ),
                          ISP_READ_REG_NOPROTECT(m_pIspReg, CAM_SGG5_D_GMRC_2 ));
            }
        }
        else
        {
