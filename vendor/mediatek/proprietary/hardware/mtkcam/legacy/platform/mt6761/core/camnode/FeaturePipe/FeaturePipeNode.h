...
typedef struct
{
    ...
    MUINT32      mFrameNo;
} FeaturePipeNodeTagImgReqJob_s; //vFB only
...
public:
    ...
    void  getGraphicBuffer(vector< sp<NativeBufferWrapper>* >& vpGB);
...
private:
    ...
    sem_t            mCallbackSem;
    sp<NativeBufferWrapper>* mFullImgGB = NULL;
    MUINT32         mFullImgBGSize = 0;
};
...
private:
    ...
    sp<NativeBufferWrapper> mGfxYuvBuffer;
    sp<NativeBufferWrapper> mGfxRgbaBuffer[GPU_NODE_BUFFER_NUM];
...
private:
    ...
    // EIS 3.0 params
    queue<MdpInfoReqJob_s> mqJobMdpInfo; // for eis crop info queue
};
