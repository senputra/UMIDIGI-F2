...
class Pass2NodeImpl : public Pass2Node
{
    public: // ctor & dtor
        ...
        //
        virtual void    setIs4CellCaptureFlow(bool is4Cell) { mIs4CellRemoFlow = is4Cell; }
    protected: // operations
        ...
        virtual void    setCropSize(MBOOL bUseCrop,MRect crop_region);
    ...
    protected:
        ...
        //
        float                   mCropRatio;
        //WorkAround for 4cell
        MBOOL                   mIs4CellRemoFlow;
    private:
        MBOOL                   mbUseSelfDefCrop;
        MRect                   mSelfDefCrop;
};
...
class FeaturePass2 : public PrvPass2
{
    ...
    private:
        ...
        MBOOL                                   mbGDPreview;
        MBOOL                                   mbSDPreview;
        MBOOL                                   mbRecordingHint; // Video Preview may set this variable TRUE
        MBOOL                                   mbIsRecording; // True only after startRecording()
...
class CapPass2 : public Pass2NodeImpl
{
    ...
    protected:
        ...
        MBOOL doRemosaicRawProcess(ProcessingParams const& param);
        IImageBuffer* createOutputBuffer(
            char const *szName,
            MINT32 format,
            MSize size);
    private:
