...
//-----------Dual Camera Feature---------------------
  ...
  ,FT_CCT_V2_OP_GET_ISP_CCM_RATIO
  ,FT_CCT_V2_OP_SET_ISP_CCM_RATIO
  ...
  ,FT_CCTIA_GET_AEPLINE
  ,FT_CCTIA_ISP_GET_TUNING_PARAS
    ,FT_CCTIA_ISP_GET_NVRAM_DATA
    ,FT_CCT_D1_GET_DNG_PARA
    ,FT_CCT_D1_SET_DNG_PARA
    ,FT_CCTIA_AWB_GET_AWB_PARA
  ,FT_CCT_OP_END
  } FT_CCT_OP;
  ...
  typedef struct
  {
    ...
    unsigned int      device_id;
        unsigned int            rawFmtType; //Bayer or Mono,....
...
typedef struct AWB_NVRAM_ALL_T
{
  ...
  typedef union
  {
    ...
    ACDK_CCT_SET_CURRENT_CCM_STRUCT     dev_6238_awb_current_ccm;
    ...
    unsigned int                        ccm_type;  //Type; //0: ISP (default); 1: MDP
    float                               isp_ccm_ratio;
    ...
    ACDK_CCT_SET_CCM_POLY22_STRUCT  set_ccm_poly22;
    ...
    ACDK_CCT_SET_CCM_WB_STRUCT      set_ccm_wb_gain;
    ...
    ISP_NVRAM_DNG_METADATA_T        set_DNGMetadata;
    unsigned int                    set_3a_nvram_scenario;
  } FT_CCT_CMD;
  ...
  typedef union
  {
    ...
    ISP_NVRAM_DNG_METADATA_T        get_DNGMetadata;
  } FT_CCT_RESULT;
...
*/
  ...
  typedef struct{
    unsigned int data[MAX_SHADING_PvwFrm_SIZE];
  }ispTable;
