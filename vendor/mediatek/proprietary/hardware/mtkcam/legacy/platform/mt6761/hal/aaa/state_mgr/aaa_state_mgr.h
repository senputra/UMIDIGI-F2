...
public:
    ...
    inline MVOID updateMainFlashOnThisFrame(MBOOL bMainFlashOnThisFrame)
    {
        m_bMainFlashOnThisFrame = bMainFlashOnThisFrame;
    }

    inline MBOOL queryMainFlashOnThisFrame()
    {
        return m_bMainFlashOnThisFrame;
    }
