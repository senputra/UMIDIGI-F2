...
class Pass2Node : public ICamThreadNode
{
    public:     /*createInstance()*/
        ...
        virtual MBOOL       startRecording(
                                ...
                                MUINT32 fps,
                                MBOOL   isYuv,
                                sp<IParamsManager>  spParamsMgr) {return MTRUE;};
        ...
        // for capture only: set self-defined crop region for full size image
        virtual void        setCropSize(MBOOL bUseCrop,MRect crop_region) = 0;
        ...
        virtual void        setIs4CellCaptureFlow(bool is4Cell) = 0;
