...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_CUSTOM_PLATFORM_HAL1)/hal/camera
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_CUSTOM_PLATFORM_HAL1)/hal/camera_3a
#
...
ifeq ($(MTK_CAM_STEREO_CAMERA_SUPPORT),yes)
    LOCAL_CFLAGS += -DNVRAM_STEREO_FEATURE_EN=1
endif
