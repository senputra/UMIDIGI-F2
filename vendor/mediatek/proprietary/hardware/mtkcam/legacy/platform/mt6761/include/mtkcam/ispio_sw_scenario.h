...
enum ESoftwareScenario
{
    ...
    eSoftwareScenario_Main_VSS_Mfb_Capture,
    eSoftwareScenario_Main_VSS_Mfb_Blending,
    eSoftwareScenario_Main_VSS_Mfb_Mixing,
    ...
    eSoftwareScenario_Main_IP_Raw_TPipe_Stream,
    ...
    eSoftwareScenario_Sub_VSS_Mfb_Capture,
    eSoftwareScenario_Sub_VSS_Mfb_Blending,
    eSoftwareScenario_Sub_VSS_Mfb_Mixing,
    ...
    eSoftwareScenario_Sub_IP_Raw_TPipe_Stream,
    ...
    eSoftwareScenario_Main2_VSS_Mfb_Capture,
    eSoftwareScenario_Main2_VSS_Mfb_Blending,
    eSoftwareScenario_Main2_VSS_Mfb_Mixing,
    ...
    eSoftwareScenario_Main2_IP_Raw_TPipe_Stream,
