...
public:
    ...
    virtual MINT32 ConfigRSCMEEis(const EIS_HAL_CONFIG_DATA &aEisConfig) = 0;
    ...
    virtual MINT32 DoRSCMEEis(EIS_HAL_CONFIG_DATA *apEisConfig = NULL, MINT64 aTimeStamp = -1) = 0;
