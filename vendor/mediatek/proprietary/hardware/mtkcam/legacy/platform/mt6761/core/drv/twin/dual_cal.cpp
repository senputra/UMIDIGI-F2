...
static ISP_MESSAGE_ENUM dual_cal_bnr(const ISP_DUAL_IN_CONFIG_STRUCT *ptr_in_param, ISP_DUAL_OUT_CONFIG_STRUCT *ptr_out_param)
{
		...
		ptr_in_param->CAM_CTL_EN_P1.Bits.RMX_EN && ptr_in_param->CAM_CTL_EN_P1.Bits.DMX_EN)
	{
		if (ptr_in_param->CAM_CTL_EN_P1.Bits.BNR_EN)
		{
			...
			if (ptr_out_param->CAM_DMX_D_CROP.Bits.DMX_STR_X & 0x3)
			{
				ptr_out_param->CAM_BNR_D_BPC_CON.Bits.BNR_LE_INV_CTL = 0x2 + 0x8;/* 0x1: LE, 0x2: R, 0x4: G, 0x8: B */
			}
			/* left side */
			...
			/* copy */
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BPC_TABLE_END_MODE, CAM_BNR_D_BPC_CON.Bits.BPC_TABLE_END_MODE);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BPC_AVG_MODE, CAM_BNR_D_BPC_CON.Bits.BPC_AVG_MODE);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BPC_DTC_MODE, CAM_BNR_D_BPC_CON.Bits.BPC_DTC_MODE);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BPC_CS_MODE, CAM_BNR_D_BPC_CON.Bits.BPC_CS_MODE);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BPC_CRC_MODE, CAM_BNR_D_BPC_CON.Bits.BPC_CRC_MODE);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BPC_EXC, CAM_BNR_D_BPC_CON.Bits.BPC_EXC);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BPC_BLD_MODE, CAM_BNR_D_BPC_CON.Bits.BPC_BLD_MODE);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BNR_OSC_COUNT, CAM_BNR_D_BPC_CON.Bits.BNR_OSC_COUNT);
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BNR_EDGE, CAM_BNR_D_BPC_CON.Bits.BNR_EDGE);
			...
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_PDC_POS.Raw, CAM_BNR_D_PDC_POS.Raw);
		...
		DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BPC_EN, CAM_BNR_D_BPC_CON.Bits.BPC_EN);
		DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_BNR_BPC_CON.Bits.BPC_LUT_EN, CAM_BNR_D_BPC_CON.Bits.BPC_LUT_EN);
	}
	return result;
}
...
static ISP_MESSAGE_ENUM dual_cal_rmg(const ISP_DUAL_IN_CONFIG_STRUCT *ptr_in_param, ISP_DUAL_OUT_CONFIG_STRUCT *ptr_out_param)
{
		...
		ptr_in_param->CAM_CTL_EN_P1.Bits.RMX_EN && ptr_in_param->CAM_CTL_EN_P1.Bits.DMX_EN)
	{
		if (ptr_in_param->CAM_CTL_EN_P1.Bits.RMG_EN)
		{
			...
			DUAL_COPY_L2R(ptr_in_param, ptr_out_param, CAM_RMG_HDR_CFG.Raw, CAM_RMG_D_HDR_CFG.Raw);
