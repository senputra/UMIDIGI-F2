...
public: // Attributes
    ...
    /**  
     * @brief set current ISO value of ISP tuning
     * @param [in] i4SensorDev sensor device
     * @param [in] i4ISOValue AE ISO value
     */
    MBOOL setISO(MINT32 const i4SensorDev, MINT32 const i4ISOValue);
     ...
     * @brief get OBC info
     * @param [in] i4SensorDev sensor device
     * @param [out] pOBCInfo pointer to OBC info
     */
    MBOOL getPureOBCInfo(MINT32 const i4SensorDev, ISP_NVRAM_OBC_T *pOBCInfo);

    /**  
     * @brief get DNG color matrix 1
     * @param [in] i4SensorDev sensor device
     * @param [out] cm reference to color matrix
     */
    MBOOL getDNGColorMatrix1(MINT32 const i4SensorDev, double cm[3][3]) const;

    /**  
     * @brief get DNG forward matrix 1
     * @param [in] i4SensorDev sensor device
     * @param [out] fm reference to forward matrix
     */
    MBOOL getDNGForwardMatrix1(MINT32 const i4SensorDev, double fm[3][3]) const;
