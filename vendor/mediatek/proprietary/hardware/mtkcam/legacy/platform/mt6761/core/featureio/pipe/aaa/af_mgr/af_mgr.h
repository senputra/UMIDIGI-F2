...
#define E_AF_STATE_T EAfState_T
...
public:
     ...
     *          [out] status
     */
    MRESULT CmdSetAFArea( CameraFocusArea_T &sInAFArea);
     ...
     *          [out] status
     */
    MRESULT CmdTriggerAF( MUINT32 u4Caller);
     ...
     */
    MVOID CmdAutoFocus();
    MVOID autoFocus(MBOOL &bIsAutoFocusFromHost);
     ...
     *          [out] NA
     */
    MVOID CmdCancelAutoFocus();
    MVOID cancelAutoFocus(MBOOL &bIsCancelAutoFocusFromHost);
     ...
     *          [out] status
     */
    MRESULT CmdSetAFMode( MINT32 a_eAFMode, MUINT32 u4Caller);
     ...
     *          [out] status
     */
    MRESULT CmdSetMFPos( MINT32 a_i4Pos, MUINT32 u4Caller);
     ...
     *          [out] NA
     */
    MVOID  setCurFrmNum(MUINT32 u4FrmNum);
     ...
     *          [out] state.
     */
    MRESULT CmdSetFullScanstep( MINT32 a_i4Step);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    MVOID   CmdSetFocusDistance( MFLOAT lens_focusDistance);
...
private:
    ...
    */
     ...
     *          [out] new af state.
     */
    EAfState_T UpdateStateMFMode( EAfState_T &eInCurSate, AF_EVENT_T &sInEvent);
     ...
     *          [out] new af state.
     */
    EAfState_T UpdateStateOFFMode( EAfState_T &eInCurSate, AF_EVENT_T &sInEvent);
     ...
     *          [out] new af state.
     */
    EAfState_T UpdateStateContinuousMode( EAfState_T &eInCurSate, AF_EVENT_T &sInEvent);
     ...
     *          [out] af state.
     */
    EAfState_T UpdateState( AF_EVENT_T sInEvent);
...
private :
    ...
    EAfState_T m_eAFState;
    EAfState_T m_eAFStatePre;
    EAfState_T m_eAFStatePreForCallback;
