...
//------------------------------------------------------------------------------
   ...
   /* CONFIG_METADATA_BEGIN(MTK_REQUEST_MAX_OUTPUT_RAW)//new synthetic
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_REQUEST_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_STATISTICS_OBJECT_TRACKING_ENABLE, MINT32)
        CONFIG_ENTRY_VALUE(MTK_STATISTICS_OBJECT_TRACKING_INIT, MINT32)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_RESULT_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_STATISTICS_OBJECT_TRACKING_SCORE, MINT32)
        CONFIG_ENTRY_VALUE(MTK_STATISTICS_OBJECT_TRACKING_RECT, MINT32)
    CONFIG_METADATA_END()
    //==========================================================================
