...
public:
    ...
    MRESULT passPDBuffer(MINT32 i4SensorDev, MVOID *ptrInPDData);
    MVOID doPDBuffer(MINT32 i4SensorDev, MVOID * buffer, MINT32 w,MINT32 h, MINT32 stride, MUINT32 i4FrmNum, MUINT32 i4RawFmt, IImageBuffer *imgbuf);
