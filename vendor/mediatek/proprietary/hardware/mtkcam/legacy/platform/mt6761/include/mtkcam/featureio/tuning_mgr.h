 ...
 **************************************************************************/
    enum ETuningMgrFunc  // need mapping to EIspTuningMgrFunc
    {
       ...
       eTuningMgrFunc_Dbs           = eIspTuningMgrFunc_Dbs       ,
       eTuningMgrFunc_Dbs_d         = eIspTuningMgrFunc_Dbs_d     ,
       ...
       eTuningMgrFunc_Nsl2           = eIspTuningMgrFunc_Nsl2       ,
       //eTuningMgrFunc_Cfa           = eIspTuningMgrFunc_Cfa       ,
       eTuningMgrFunc_Udm           = eIspTuningMgrFunc_Udm       ,
       ...
       eTuningMgrFunc_Nsl2b         = eIspTuningMgrFunc_Nsl2b      ,
       ...
       eTuningMgrFunc_Nbc2          = eIspTuningMgrFunc_Nbc2       ,
       eTuningMgrFunc_Nsl2a         = eIspTuningMgrFunc_Nsl2a      ,
       eTuningMgrFunc_Nbc_Tbl		= eIspTuningMgrFunc_Nbc_Tbl		,	// for ANR table
       eTuningMgrFunc_Rwb         	= eIspTuningMgrFunc_Rwb      ,	// add for RWB sensor
       eTuningMgrFunc_Iso         	= eIspTuningMgrFunc_Iso      ,	// add for ISO adaptive
