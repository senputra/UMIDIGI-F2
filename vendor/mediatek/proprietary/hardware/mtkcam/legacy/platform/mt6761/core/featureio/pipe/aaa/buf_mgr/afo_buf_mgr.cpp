...
MBOOL AFOBufMgr::updateDMABaseAddr(MUINT32 u4BaseAddr)
{
    ...
    {
        if (MFALSE ==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE, NSImageio::NSIspio::EModule_AFO, (MINTPTR)&handle, (MINTPTR)(&("AFOBufMgr::DMAConfig()"))))
        {
    ...
    {
        if (MFALSE ==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE, NSImageio::NSIspio::EModule_AFO_D, (MINTPTR)&handle, (MINTPTR)(&("AFOBufMgr::DMAConfig()"))))
        {
            MY_ERR("EPIPECmd_GET_MODULE_HANDLE fail");
        }
        else
...
//=================================================================
    if (m_eSensorTG == ESensorTG_1)
    {
        if (MFALSE ==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE, NSImageio::NSIspio::EModule_AF, (MINTPTR)&handle, (MINTPTR)(&("AF::DMAConfig()"))))
        {
    ...
    {
        if (MFALSE ==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE, NSImageio::NSIspio::EModule_AF_D, (MINTPTR)&handle, (MINTPTR)(&("AF::DMAConfig()"))))
        {
            MY_ERR("EPIPECmd_GET_MODULE_HANDLE AF fail");
        }
        else
...
MBOOL AFOBufMgr::DMAInit()
{
    ...
    MINT32 EnableAF = IAfMgr::getInstance().isAFSupport(m_eSensorDev);
    if (m_eSensorTG == ESensorTG_1)
    {
        ...
        if (MFALSE==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_SET_MODULE_EN, NSImageio::NSIspio::EModule_AFO, EnableAF, MNULL))
        {
    ...
    {
        if (MFALSE==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_SET_MODULE_EN, NSImageio::NSIspio::EModule_AFO_D, EnableAF, MNULL))
        {
            MY_ERR("EPIPECmd_SET_MODULE_En fail: EModule_AFO_D");
            return MFALSE;
        }
...
MBOOL AFOBufMgr::DMAUninit()
{
    ...
    if (m_eSensorTG == ESensorTG_1)
    {
        ...
        {
            MY_ERR("EPIPECmd_SET_MODULE_En fail: EModule_AF0_D");
            return MFALSE;
        }
    }
    else if (m_eSensorTG == ESensorTG_2)
...
{
    MINT32 EnableAF = IAfMgr::getInstance().isAFSupport(m_eSensorDev) && En;
    MY_LOG_IF(m_bDebugEnable,"AFO m_eSensorDev(%d) AFStatEnable(%d)\n",m_eSensorDev, EnableAF);

    if (m_eSensorTG == ESensorTG_1)
    {
        if (MFALSE==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_SET_MODULE_EN, NSImageio::NSIspio::EModule_AF, EnableAF, MNULL))
        {
            MY_ERR("EPIPECmd_SET_MODULE_En fail: EModule_AF");
            return MFALSE;
        }
        if (MFALSE==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_SET_MODULE_EN, NSImageio::NSIspio::EModule_SGG1, EnableAF, MNULL))
        {
            MY_ERR("EPIPECmd_SET_MODULE_En fail: EModule_SGG1");
            return MFALSE;
        }
        if (MFALSE==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_SET_MODULE_EN, NSImageio::NSIspio::EModule_SGG5, EnableAF, MNULL))
        {
            MY_ERR("EPIPECmd_SET_MODULE_En fail: EModule_SGG5");
            return MFALSE;
        }
    }
    else if (m_eSensorTG == ESensorTG_2)
    {
        if (MFALSE==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_SET_MODULE_EN, NSImageio::NSIspio::EModule_AF_D, EnableAF, MNULL))
        {
            MY_ERR("EPIPECmd_SET_MODULE_En fail: EModule_AF");
            return MFALSE;
        }
        if (MFALSE==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_SET_MODULE_EN, NSImageio::NSIspio::EModule_SGG1_D, EnableAF, MNULL))
        {
            MY_ERR("EPIPECmd_SET_MODULE_En fail: EModule_SGG1");
            return MFALSE;
        }
        if (MFALSE==sendCommandNormalPipe(NSImageio::NSIspio::EPIPECmd_SET_MODULE_EN, NSImageio::NSIspio::EModule_SGG5_D, EnableAF, MNULL))
        {
            MY_ERR("EPIPECmd_SET_MODULE_En fail: EModule_SGG5");
            return MFALSE;
        }
