...
class ZipImageCallbackThread : public Thread
{
    ...
    public:
        ...
        status_t    readyToRun();
        void        setShotMode(uint32_t const u4ShotMode, const IState::ENState nextState, bool const isZsdWithFlash = false);
