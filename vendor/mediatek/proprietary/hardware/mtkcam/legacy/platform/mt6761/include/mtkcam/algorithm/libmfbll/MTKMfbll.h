...
#define MEMC_FLOW_V2
//#define MEMC_SUPPORT_YV16_16ALIGN
...
#ifdef MEMC_FLOW_V2
    MFBLL_STATE_ME,
    MFBLL_STATE_ME_READY,
    MFBLL_STATE_MC,
    MFBLL_STATE_MC_READY,
#else
...
{
    MUINT8   bSkip_MEMC;
} MFBLL_PROC_ME_OUT_STRUCT,*P_MFBLL_PROC_ME_OUT_STRUCT;
...
} MFBLL_PROC_MC_OUT_STRUCT,*P_MFBLL_PROC_MC_OUT_STRUCT;
