...
protected:
     ...
     , m_eSensorDev(eSensorDev)
    {
        ...
        if (m_eSensorDev == ESensorDev_Main) {
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_TPipe_Capture, eSoftwareScenario_Main_IP_Raw_TPipe_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_TPipe_Capture_SWNR, eSoftwareScenario_Main_IP_Raw_TPipe_Stream);            
        }
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_N3D_Preview, eSoftwareScenario_Sub_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_N3D_Video, eSoftwareScenario_Sub_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_N3D_Capture, eSoftwareScenario_Sub_Normal_Stream);
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_TPipe_Capture, eSoftwareScenario_Sub_IP_Raw_TPipe_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_TPipe_Capture_SWNR, eSoftwareScenario_Sub_IP_Raw_TPipe_Stream);            
        }
