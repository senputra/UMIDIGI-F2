...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL IspTuningMgr::getPureOBCInfo(MINT32 const i4SensorDev, ISP_NVRAM_OBC_T *pOBCInfo)
{
    if (i4SensorDev & ESensorDev_Main) {
        if (m_pParamctrl_Main) {
            m_pParamctrl_Main->getPureOBCInfo(pOBCInfo);
        }
        else {
            MY_ERR("m_pParamctrl_Main is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Sub) {
            m_pParamctrl_Sub->getPureOBCInfo(pOBCInfo);
        }
        else {
            MY_ERR("m_pParamctrl_Sub is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Main2) {
            m_pParamctrl_Main2->getPureOBCInfo(pOBCInfo);
        }
        else {
            MY_ERR("m_pParamctrl_Main2 is NULL");
            return MFALSE;
        ...
        MY_ERR("Err IspTuningMgr::getPureOBCInfo()\n");
        return MFALSE;
    }
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL IspTuningMgr::getDNGColorMatrix1(MINT32 const i4SensorDev, double cm[3][3]) const
{
    if (i4SensorDev & ESensorDev_Main) {
        if (m_pParamctrl_Main) {
            m_pParamctrl_Main->getDNGColorMatrix1(cm);
        }
        else {
            MY_ERR("m_pParamctrl_Main is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Sub) {
            m_pParamctrl_Sub->getDNGColorMatrix1(cm);
        }
        else {
            MY_ERR("m_pParamctrl_Sub is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Main2) {
            m_pParamctrl_Main2->getDNGColorMatrix1(cm);
        }
        else {
            MY_ERR("m_pParamctrl_Main2 is NULL");
            return MFALSE;
        ...
        MY_ERR("Err IspTuningMgr::getDNGColorMatrix1()\n");
        return MFALSE;
    }
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL IspTuningMgr::getDNGForwardMatrix1(MINT32 const i4SensorDev, double fm[3][3]) const
{
    if (i4SensorDev & ESensorDev_Main) {
        if (m_pParamctrl_Main) {
            m_pParamctrl_Main->getDNGForwardMatrix1(fm);
        }
        else {
            MY_ERR("m_pParamctrl_Main is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Sub) {
            m_pParamctrl_Sub->getDNGForwardMatrix1(fm);
        }
        else {
            MY_ERR("m_pParamctrl_Sub is NULL");
            return MFALSE;
        ...
        if (m_pParamctrl_Main2) {
            m_pParamctrl_Main2->getDNGForwardMatrix1(fm);
        }
        else {
            MY_ERR("m_pParamctrl_Main2 is NULL");
            return MFALSE;
        ...
        MY_ERR("Err IspTuningMgr::getDNGForwardMatrix1()\n");
        return MFALSE;
    }
