...
struct STEREO_PARAMS_T
{
    ...
    char *dualcamCallbackItems; // inform APP whitch kinds of buffer will be callback
...
public:
    ...
    static MSize getDepthmapSize();
    static MSize getAlgoImageSize(MINT32 idx);
    static void getMain1FullSzCrop(MBOOL &bSensorMaxCrop, MRect &main1FullCrop);
    //
    static bool hasHWFE();
    static bool getStereoCameraFOV(float &mainFOV, float &main2FOV);
    static bool getStereoCameraSensorBit(MUINT32 &main1_bits, MUINT32 &main2_bits);
    ...
    static bool IsMain2MonoSensor();
    static bool IsMain2YuvSensor();
