...
LOCAL_SRC_FILES += af_mgr/af_platform_based.cpp
...
LOCAL_SRC_FILES += aaa_util/LogCollector.cpp
...
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM_HAL1)/hal/inc/isp_tuning
...
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM_HAL1)/hal/inc/mtkcam
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM_HAL1)/hal/inc/debug_exif/aaa
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM_HAL1)/hal/inc/debug_exif/cam
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM_HAL1)/hal/inc/pd_buf_mgr
...
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/laser_mgr
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/aaa/aaa_util
...
ifeq ($(MTK_CAM_SW_VERSION), ver2)
       LOCAL_CFLAGS += -DCAM3_SW_SUPPORT
endif
...
LOCAL_SHARED_LIBRARIES += libmtkcam_stdutils libcam_utils
