    ...
    switch(a_u4CurrSensorDev)
    {
        case MCU_DEV_MAIN:
            if (m_LensDev[MCU_IDX_MAIN].m_McuThreadEn == 0 && m_LensDev[MCU_IDX_MAIN].m_InitDone == 0)
            {
                ...
                pthread_create(&m_LensDev[MCU_IDX_MAIN].m_InitThread, NULL, initMCUThread<MCU_IDX_MAIN>, this);
                DRV_DBG("[%s][%s] : pthread_create\n", DEV_NAME[MCU_IDX_MAIN], __FUNCTION__);
            }
            break;
        case MCU_DEV_MAIN_2:
            if (m_LensDev[MCU_IDX_MAIN_2].m_McuThreadEn == 0 && m_LensDev[MCU_IDX_MAIN_2].m_InitDone == 0)
            {
                ...
                pthread_create(&m_LensDev[MCU_IDX_MAIN_2].m_InitThread, NULL, initMCUThread<MCU_IDX_MAIN_2>, this);
        ...
        case MCU_DEV_SUB:
            if (m_LensDev[MCU_IDX_SUB].m_McuThreadEn == 0 && m_LensDev[MCU_IDX_SUB].m_InitDone == 0)
            {
                ...
                pthread_create(&m_LensDev[MCU_IDX_SUB].m_InitThread, NULL, initMCUThread<MCU_IDX_SUB>, this);
        ...
        case MCU_DEV_SUB_2:
            if (m_LensDev[MCU_IDX_SUB_2].m_McuThreadEn == 0 && m_LensDev[MCU_IDX_SUB_2].m_InitDone == 0)
            {
                ...
                pthread_create(&m_LensDev[MCU_IDX_SUB_2].m_InitThread, NULL, initMCUThread<MCU_IDX_SUB_2>, this);
