...
public:
     ...
     * @brief start pd mgr.
    */
    EPDBUF_TYPE_t start(MINT32 i4SensorDev, MINT32 i4SensorIdx, SPDProfile_t *iPDProfile, PD_NVRAM_T *ptrInPDNvRam);
    /**
     * @brief stop pd mgr.
     */
    ...
    */
    MRESULT postToPDTask(MINT32 i4SensorDev, PD_CALCULATION_INPUT *ptrInputData);
    /**
    * @brief pd result..
    */
    MRESULT getPDTaskResult(MINT32 i4SensorDev, PD_CALCULATION_OUTPUT **ptrOutputRes);
    /**
    ...
    */
     ...
     */
    MRESULT GetDebugInfo(MINT32 i4SensorDev, AF_DEBUG_INFO_T &sOutDbgInfo);
    /**
     * @brief update PD parameters
     */
    MRESULT UpdatePDParam(MINT32 i4SensorDev, MUINT32 u4FrmNum, MINT32 i4InputPDAreaNum, AFPD_BLOCK_ROI_T *tInputPDArea, MINT32 i4MinLensPos, MINT32 i4MaxLensPos);
