...
//#define LENS_DEV_NUM 4

typedef struct LENS_DEV_DATA_t
{
    int m_fdMCU;
    int m_userCnt;
...
public:     //// Interfaces
    ...
    //
    /////////////////////////////////////////////////////////////////////////
    virtual int init(unsigned int a_u4CurrSensorDev, int a_i4InitPos);

    template <EMcuDev_T eMcuDev> int initMCU();

    template <EMcuDev_T eMcuDev> static void* initMCUThread(void *arg);
    ...
    //
    /////////////////////////////////////////////////////////////////////////
    virtual int getMCUOISInfo(mcuMotorOISInfo *a_pMotorOISInfo,unsigned int a_u4CurrSensorDev );
    ...
    //
    /////////////////////////////////////////////////////////////////////////
    virtual int  getOISPosInfo(mcuOISPosInfo *a_pOISPosInfo,unsigned int a_u4CurrSensorDev );

private:
    //
    LENS_DEV_DATA_T m_LensDev[MCU_DEV_NUM];
