                ...
                ISP_NVRAM_BNR_NR1_T& rSmoothNR1)   // Output
{
    ...
    property_get("debug.smooth_nr1.enable", value, "0");
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("debug.smooth_bpc.enable", value, "0");
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("debug.smooth_dbs.enable", value, "0");
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("debug.smooth_udm.enable", value, "0");
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("debug.smooth_ee.enable", value, "0");
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("debug.smooth_anr.enable", value, "0");
                    ...
                    ISP_NVRAM_BNR_PDC_T& rSmoothBNR_PDC)   // Output
{
    ...
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("debug.smooth_bnr_pdc.enable", value, "0");
...
{
      char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("debug.smooth_ccr.enable", value, "0");
...
{
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("debug.smooth_swnr.enable", value, "0");
    MBOOL bSmoothSWNRDebug = atoi(value);
