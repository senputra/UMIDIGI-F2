...
public:
    CAM_TDRI_PIPE():dupCqIdx(0),burstQueIdx(0),enTdri(0),CQ(CAM_ISP_CQ_NONE),isV3(MFALSE),isApplyTuning(MFALSE),tcm_en(0),tdr_en(0),tdr_dbg_tcm_en(0),magicNum(0),drvScenario(0),sub_mode(0),lceInputW(0),lceInputH(0){};
