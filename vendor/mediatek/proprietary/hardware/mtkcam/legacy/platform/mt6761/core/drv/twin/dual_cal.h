...
#define DUAL_HW_LUT(CMD, a, b, c, d, e, f) \
    ...
    CMD(a, b, c, d, e, f, int, BPC_EN, 0x4, CAM_BNR_BPC_CON.BPC_EN, R, CAM_BNR_BPC_CON, BPC_EN)\
    CMD(a, b, c, d, e, f, int, BPC_LUT_EN, 0x4, CAM_BNR_BPC_CON.BPC_LUT_EN, R, CAM_BNR_BPC_CON, BPC_LUT_EN)\
    CMD(a, b, c, d, e, f, int, BPC_TABLE_END_MODE, 0x4, CAM_BNR_BPC_CON.BPC_TABLE_END_MODE, R, CAM_BNR_BPC_CON, BPC_TABLE_END_MODE)\
    CMD(a, b, c, d, e, f, int, BPC_AVG_MODE, 0x4, CAM_BNR_BPC_CON.BPC_AVG_MODE, R, CAM_BNR_BPC_CON, BPC_AVG_MODE)\
    CMD(a, b, c, d, e, f, int, BPC_DTC_MODE, 0x4, CAM_BNR_BPC_CON.BPC_DTC_MODE, R, CAM_BNR_BPC_CON, BPC_DTC_MODE)\
    CMD(a, b, c, d, e, f, int, BPC_CS_MODE, 0x4, CAM_BNR_BPC_CON.BPC_CS_MODE, R, CAM_BNR_BPC_CON, BPC_CS_MODE)\
    CMD(a, b, c, d, e, f, int, BPC_CRC_MODE, 0x4, CAM_BNR_BPC_CON.BPC_CRC_MODE, R, CAM_BNR_BPC_CON, BPC_CRC_MODE)\
    CMD(a, b, c, d, e, f, int, BPC_EXC, 0x4, CAM_BNR_BPC_CON.BPC_EXC, R, CAM_BNR_BPC_CON, BPC_EXC)\
    CMD(a, b, c, d, e, f, int, BPC_BLD_MODE, 0x4, CAM_BNR_BPC_CON.BPC_BLD_MODE, R, CAM_BNR_BPC_CON, BPC_BLD_MODE)\
    CMD(a, b, c, d, e, f, int, BNR_LE_INV_CTL, 0x4, CAM_BNR_BPC_CON.BNR_LE_INV_CTL, R, CAM_BNR_BPC_CON, BNR_LE_INV_CTL)\
    CMD(a, b, c, d, e, f, int, BNR_OSC_COUNT, 0x4, CAM_BNR_BPC_CON.BNR_OSC_COUNT, R, CAM_BNR_BPC_CON, BNR_OSC_COUNT)\
    CMD(a, b, c, d, e, f, int, BNR_EDGE, 0x4, CAM_BNR_BPC_CON.BNR_EDGE, R, CAM_BNR_BPC_CON, BNR_EDGE)\
    CMD(a, b, c, d, e, f, int, BPC_TH_LWB, 0x4, CAM_BNR_BPC_TH1.BPC_TH_LWB, R, CAM_BNR_BPC_TH1, BPC_TH_LWB)\
    CMD(a, b, c, d, e, f, int, BPC_TH_Y, 0x4, CAM_BNR_BPC_TH1.BPC_TH_Y, R, CAM_BNR_BPC_TH1, BPC_TH_Y)\
    CMD(a, b, c, d, e, f, int, BPC_BLD_SLP0, 0x4, CAM_BNR_BPC_TH1.BPC_BLD_SLP0, R, CAM_BNR_BPC_TH1, BPC_BLD_SLP0)\
    CMD(a, b, c, d, e, f, int, BPC_TH_UPB, 0x4, CAM_BNR_BPC_TH2.BPC_TH_UPB, R, CAM_BNR_BPC_TH2, BPC_TH_UPB)\
    CMD(a, b, c, d, e, f, int, BPC_BLD0, 0x4, CAM_BNR_BPC_TH2.BPC_BLD0, R, CAM_BNR_BPC_TH2, BPC_BLD0)\
    CMD(a, b, c, d, e, f, int, BPC_BLD1, 0x4, CAM_BNR_BPC_TH2.BPC_BLD1, R, CAM_BNR_BPC_TH2, BPC_BLD1)\
    CMD(a, b, c, d, e, f, int, BPC_TH_XA, 0x4, CAM_BNR_BPC_TH3.BPC_TH_XA, R, CAM_BNR_BPC_TH3, BPC_TH_XA)\
    CMD(a, b, c, d, e, f, int, BPC_TH_XB, 0x4, CAM_BNR_BPC_TH3.BPC_TH_XB, R, CAM_BNR_BPC_TH3, BPC_TH_XB)\
    CMD(a, b, c, d, e, f, int, BPC_TH_SLA, 0x4, CAM_BNR_BPC_TH3.BPC_TH_SLA, R, CAM_BNR_BPC_TH3, BPC_TH_SLA)\
    CMD(a, b, c, d, e, f, int, BPC_TH_SLB, 0x4, CAM_BNR_BPC_TH3.BPC_TH_SLB, R, CAM_BNR_BPC_TH3, BPC_TH_SLB)\
    CMD(a, b, c, d, e, f, int, BPC_DK_TH_XA, 0x4, CAM_BNR_BPC_TH4.BPC_DK_TH_XA, R, CAM_BNR_BPC_TH4, BPC_DK_TH_XA)\
    CMD(a, b, c, d, e, f, int, BPC_DK_TH_XB, 0x4, CAM_BNR_BPC_TH4.BPC_DK_TH_XB, R, CAM_BNR_BPC_TH4, BPC_DK_TH_XB)\
    CMD(a, b, c, d, e, f, int, BPC_DK_TH_SLA, 0x4, CAM_BNR_BPC_TH4.BPC_DK_TH_SLA, R, CAM_BNR_BPC_TH4, BPC_DK_TH_SLA)\
    CMD(a, b, c, d, e, f, int, BPC_DK_TH_SLB, 0x4, CAM_BNR_BPC_TH4.BPC_DK_TH_SLB, R, CAM_BNR_BPC_TH4, BPC_DK_TH_SLB)\
    CMD(a, b, c, d, e, f, int, BPC_RNG, 0x4, CAM_BNR_BPC_DTC.BPC_RNG, R, CAM_BNR_BPC_DTC, BPC_RNG)\
    CMD(a, b, c, d, e, f, int, BPC_CS_RNG, 0x4, CAM_BNR_BPC_DTC.BPC_CS_RNG, R, CAM_BNR_BPC_DTC, BPC_CS_RNG)\
    CMD(a, b, c, d, e, f, int, BPC_CT_LV, 0x4, CAM_BNR_BPC_DTC.BPC_CT_LV, R, CAM_BNR_BPC_DTC, BPC_CT_LV)\
    CMD(a, b, c, d, e, f, int, BPC_TH_MUL, 0x4, CAM_BNR_BPC_DTC.BPC_TH_MUL, R, CAM_BNR_BPC_DTC, BPC_TH_MUL)\
    CMD(a, b, c, d, e, f, int, BPC_NO_LV, 0x4, CAM_BNR_BPC_DTC.BPC_NO_LV, R, CAM_BNR_BPC_DTC, BPC_NO_LV)\
    CMD(a, b, c, d, e, f, int, BPC_DIR_MAX, 0x4, CAM_BNR_BPC_COR.BPC_DIR_MAX, R, CAM_BNR_BPC_COR, BPC_DIR_MAX)\
    CMD(a, b, c, d, e, f, int, BPC_DIR_TH, 0x4, CAM_BNR_BPC_COR.BPC_DIR_TH, R, CAM_BNR_BPC_COR, BPC_DIR_TH)\
    CMD(a, b, c, d, e, f, int, BPC_RANK_IDXR, 0x4, CAM_BNR_BPC_COR.BPC_RANK_IDXR, R, CAM_BNR_BPC_COR, BPC_RANK_IDXR)\
    CMD(a, b, c, d, e, f, int, BPC_RANK_IDXG, 0x4, CAM_BNR_BPC_COR.BPC_RANK_IDXG, R, CAM_BNR_BPC_COR, BPC_RANK_IDXG)\
    CMD(a, b, c, d, e, f, int, BPC_DIR_TH2, 0x4, CAM_BNR_BPC_COR.BPC_DIR_TH2, R, CAM_BNR_BPC_COR, BPC_DIR_TH2)\
    CMD(a, b, c, d, e, f, int, NR1_CT_EN, 0x4, CAM_BNR_NR1_CON.NR1_CT_EN, R, CAM_BNR_NR1_CON, NR1_CT_EN)\
    CMD(a, b, c, d, e, f, int, NR1_CT_MD, 0x4, CAM_BNR_NR1_CT_CON.NR1_CT_MD, R, CAM_BNR_NR1_CT_CON, NR1_CT_MD)\
    CMD(a, b, c, d, e, f, int, NR1_CT_MD2, 0x4, CAM_BNR_NR1_CT_CON.NR1_CT_MD2, R, CAM_BNR_NR1_CT_CON, NR1_CT_MD2)\
    CMD(a, b, c, d, e, f, int, NR1_CT_THRD, 0x4, CAM_BNR_NR1_CT_CON.NR1_CT_THRD, R, CAM_BNR_NR1_CT_CON, NR1_CT_THRD)\
    CMD(a, b, c, d, e, f, int, NR1_MBND, 0x4, CAM_BNR_NR1_CT_CON.NR1_MBND, R, CAM_BNR_NR1_CT_CON, NR1_MBND)\
    CMD(a, b, c, d, e, f, int, NR1_CT_SLOPE, 0x4, CAM_BNR_NR1_CT_CON.NR1_CT_SLOPE, R, CAM_BNR_NR1_CT_CON, NR1_CT_SLOPE)\
    CMD(a, b, c, d, e, f, int, NR1_CT_DIV, 0x4, CAM_BNR_NR1_CT_CON.NR1_CT_DIV, R, CAM_BNR_NR1_CT_CON, NR1_CT_DIV)\
    CMD(a, b, c, d, e, f, int, PDC_EN, 0x4, CAM_BNR_PDC_CON.PDC_EN, R, CAM_BNR_PDC_CON, PDC_EN)\
    CMD(a, b, c, d, e, f, int, PDC_CT, 0x4, CAM_BNR_PDC_CON.PDC_CT, R, CAM_BNR_PDC_CON, PDC_CT)\
    CMD(a, b, c, d, e, f, int, PDC_MODE, 0x4, CAM_BNR_PDC_CON.PDC_MODE, R, CAM_BNR_PDC_CON, PDC_MODE)\
    CMD(a, b, c, d, e, f, int, PDC_OUT, 0x4, CAM_BNR_PDC_CON.PDC_OUT, R, CAM_BNR_PDC_CON, PDC_OUT)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_L00, 0x4, CAM_BNR_PDC_GAIN_L0.PDC_GCF_L00, R, CAM_BNR_PDC_GAIN_L0, PDC_GCF_L00)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_L10, 0x4, CAM_BNR_PDC_GAIN_L0.PDC_GCF_L10, R, CAM_BNR_PDC_GAIN_L0, PDC_GCF_L10)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_L01, 0x4, CAM_BNR_PDC_GAIN_L1.PDC_GCF_L01, R, CAM_BNR_PDC_GAIN_L1, PDC_GCF_L01)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_L20, 0x4, CAM_BNR_PDC_GAIN_L1.PDC_GCF_L20, R, CAM_BNR_PDC_GAIN_L1, PDC_GCF_L20)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_L11, 0x4, CAM_BNR_PDC_GAIN_L2.PDC_GCF_L11, R, CAM_BNR_PDC_GAIN_L2, PDC_GCF_L11)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_L02, 0x4, CAM_BNR_PDC_GAIN_L2.PDC_GCF_L02, R, CAM_BNR_PDC_GAIN_L2, PDC_GCF_L02)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_L30, 0x4, CAM_BNR_PDC_GAIN_L3.PDC_GCF_L30, R, CAM_BNR_PDC_GAIN_L3, PDC_GCF_L30)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_L21, 0x4, CAM_BNR_PDC_GAIN_L3.PDC_GCF_L21, R, CAM_BNR_PDC_GAIN_L3, PDC_GCF_L21)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_L12, 0x4, CAM_BNR_PDC_GAIN_L4.PDC_GCF_L12, R, CAM_BNR_PDC_GAIN_L4, PDC_GCF_L12)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_L03, 0x4, CAM_BNR_PDC_GAIN_L4.PDC_GCF_L03, R, CAM_BNR_PDC_GAIN_L4, PDC_GCF_L03)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_R00, 0x4, CAM_BNR_PDC_GAIN_R0.PDC_GCF_R00, R, CAM_BNR_PDC_GAIN_R0, PDC_GCF_R00)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_R10, 0x4, CAM_BNR_PDC_GAIN_R0.PDC_GCF_R10, R, CAM_BNR_PDC_GAIN_R0, PDC_GCF_R10)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_R01, 0x4, CAM_BNR_PDC_GAIN_R1.PDC_GCF_R01, R, CAM_BNR_PDC_GAIN_R1, PDC_GCF_R01)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_R20, 0x4, CAM_BNR_PDC_GAIN_R1.PDC_GCF_R20, R, CAM_BNR_PDC_GAIN_R1, PDC_GCF_R20)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_R11, 0x4, CAM_BNR_PDC_GAIN_R2.PDC_GCF_R11, R, CAM_BNR_PDC_GAIN_R2, PDC_GCF_R11)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_R02, 0x4, CAM_BNR_PDC_GAIN_R2.PDC_GCF_R02, R, CAM_BNR_PDC_GAIN_R2, PDC_GCF_R02)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_R30, 0x4, CAM_BNR_PDC_GAIN_R3.PDC_GCF_R30, R, CAM_BNR_PDC_GAIN_R3, PDC_GCF_R30)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_R21, 0x4, CAM_BNR_PDC_GAIN_R3.PDC_GCF_R21, R, CAM_BNR_PDC_GAIN_R3, PDC_GCF_R21)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_R12, 0x4, CAM_BNR_PDC_GAIN_R4.PDC_GCF_R12, R, CAM_BNR_PDC_GAIN_R4, PDC_GCF_R12)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_R03, 0x4, CAM_BNR_PDC_GAIN_R4.PDC_GCF_R03, R, CAM_BNR_PDC_GAIN_R4, PDC_GCF_R03)\
    CMD(a, b, c, d, e, f, int, PDC_GTH, 0x4, CAM_BNR_PDC_TH_GB.PDC_GTH, R, CAM_BNR_PDC_TH_GB, PDC_GTH)\
    CMD(a, b, c, d, e, f, int, PDC_BTH, 0x4, CAM_BNR_PDC_TH_GB.PDC_BTH, R, CAM_BNR_PDC_TH_GB, PDC_BTH)\
    CMD(a, b, c, d, e, f, int, PDC_ITH, 0x4, CAM_BNR_PDC_TH_IA.PDC_ITH, R, CAM_BNR_PDC_TH_IA, PDC_ITH)\
    CMD(a, b, c, d, e, f, int, PDC_ATH, 0x4, CAM_BNR_PDC_TH_IA.PDC_ATH, R, CAM_BNR_PDC_TH_IA, PDC_ATH)\
    CMD(a, b, c, d, e, f, int, PDC_NTH, 0x4, CAM_BNR_PDC_TH_HD.PDC_NTH, R, CAM_BNR_PDC_TH_HD, PDC_NTH)\
    CMD(a, b, c, d, e, f, int, PDC_DTH, 0x4, CAM_BNR_PDC_TH_HD.PDC_DTH, R, CAM_BNR_PDC_TH_HD, PDC_DTH)\
    CMD(a, b, c, d, e, f, int, PDC_GSL, 0x4, CAM_BNR_PDC_SL.PDC_GSL, R, CAM_BNR_PDC_SL, PDC_GSL)\
    CMD(a, b, c, d, e, f, int, PDC_BSL, 0x4, CAM_BNR_PDC_SL.PDC_BSL, R, CAM_BNR_PDC_SL, PDC_BSL)\
    CMD(a, b, c, d, e, f, int, PDC_ISL, 0x4, CAM_BNR_PDC_SL.PDC_ISL, R, CAM_BNR_PDC_SL, PDC_ISL)\
    CMD(a, b, c, d, e, f, int, PDC_ASL, 0x4, CAM_BNR_PDC_SL.PDC_ASL, R, CAM_BNR_PDC_SL, PDC_ASL)\
    CMD(a, b, c, d, e, f, int, PDC_GCF_NORM, 0x4, CAM_BNR_PDC_SL.PDC_GCF_NORM, R, CAM_BNR_PDC_SL, PDC_GCF_NORM)\
    CMD(a, b, c, d, e, f, int, PDC_XCENTER, 0x4, CAM_BNR_PDC_POS.PDC_XCENTER, R, CAM_BNR_PDC_POS, PDC_XCENTER)\
    CMD(a, b, c, d, e, f, int, PDC_YCENTER, 0x4, CAM_BNR_PDC_POS.PDC_YCENTER, R, CAM_BNR_PDC_POS, PDC_YCENTER)\
    CMD(a, b, c, d, e, f, int, BPC_XOFFSET, 0x4, CAM_BNR_BPC_TBLI1.BPC_XOFFSET, W, CAM_BNR_BPC_TBLI1, BPC_XOFFSET)\
    CMD(a, b, c, d, e, f, int, BPC_YOFFSET, 0x4, CAM_BNR_BPC_TBLI1.BPC_YOFFSET, W, CAM_BNR_BPC_TBLI1, BPC_YOFFSET)\
    CMD(a, b, c, d, e, f, int, BPC_XSIZE, 0x4, CAM_BNR_BPC_TBLI2.BPC_XSIZE, W, CAM_BNR_BPC_TBLI2, BPC_XSIZE)\
    CMD(a, b, c, d, e, f, int, BPC_YSIZE, 0x4, CAM_BNR_BPC_TBLI2.BPC_YSIZE, W, CAM_BNR_BPC_TBLI2, BPC_YSIZE)\
	CMD(a, b, c, d, e, f, int, BPC_C_TH_LWB, 0x4, CAM_BNR_BPC_TH1_C.BPC_C_TH_LWB, R, CAM_BNR_BPC_TH1_C, BPC_C_TH_LWB)\
	CMD(a, b, c, d, e, f, int, BPC_C_TH_Y, 0x4, CAM_BNR_BPC_TH1_C.BPC_C_TH_Y, R, CAM_BNR_BPC_TH1_C, BPC_C_TH_Y)\
	CMD(a, b, c, d, e, f, int, BPC_C_TH_UPB, 0x4, CAM_BNR_BPC_TH2_C.BPC_C_TH_UPB, R, CAM_BNR_BPC_TH2_C, BPC_C_TH_UPB)\
	CMD(a, b, c, d, e, f, int, BPC_RANK_IDXB, 0x4, CAM_BNR_BPC_TH2_C.BPC_RANK_IDXB, R, CAM_BNR_BPC_TH2_C, BPC_RANK_IDXB)\
	CMD(a, b, c, d, e, f, int, BPC_BLD_LWB, 0x4, CAM_BNR_BPC_TH2_C.BPC_BLD_LWB, R, CAM_BNR_BPC_TH2_C, BPC_BLD_LWB)\
	CMD(a, b, c, d, e, f, int, BPC_C_TH_XA, 0x4, CAM_BNR_BPC_TH3_C.BPC_C_TH_XA, R, CAM_BNR_BPC_TH3_C, BPC_C_TH_XA)\
	CMD(a, b, c, d, e, f, int, BPC_C_TH_XB, 0x4, CAM_BNR_BPC_TH3_C.BPC_C_TH_XB, R, CAM_BNR_BPC_TH3_C, BPC_C_TH_XB)\
	CMD(a, b, c, d, e, f, int, BPC_C_TH_SLA, 0x4, CAM_BNR_BPC_TH3_C.BPC_C_TH_SLA, R, CAM_BNR_BPC_TH3_C, BPC_C_TH_SLA)\
	CMD(a, b, c, d, e, f, int, BPC_C_TH_SLB, 0x4, CAM_BNR_BPC_TH3_C.BPC_C_TH_SLB, R, CAM_BNR_BPC_TH3_C, BPC_C_TH_SLB)\
	/* BNR_D */\
    CMD(a, b, c, d, e, f, int, BNR_D_EN, 0x4, CAM_CTL_EN_P1_D.BNR_D_EN, W, CAM_CTL_EN_P1_D, BNR_D_EN)\
    CMD(a, b, c, d, e, f, int, BPC_D_EN, 0x4, CAM_BNR_D_BPC_CON.BPC_EN, W, CAM_BNR_D_BPC_CON, BPC_EN)\
    CMD(a, b, c, d, e, f, int, BPC_D_LUT_EN, 0x4, CAM_BNR_D_BPC_CON.BPC_LUT_EN, W, CAM_BNR_D_BPC_CON, BPC_LUT_EN)\
    CMD(a, b, c, d, e, f, int, BPC_D_TABLE_END_MODE, 0x4, CAM_BNR_D_BPC_CON.BPC_TABLE_END_MODE, W, CAM_BNR_D_BPC_CON, BPC_TABLE_END_MODE)\
    CMD(a, b, c, d, e, f, int, BPC_D_AVG_MODE, 0x4, CAM_BNR_D_BPC_CON.BPC_AVG_MODE, W, CAM_BNR_D_BPC_CON, BPC_AVG_MODE)\
    CMD(a, b, c, d, e, f, int, BPC_D_DTC_MODE, 0x4, CAM_BNR_D_BPC_CON.BPC_DTC_MODE, W, CAM_BNR_D_BPC_CON, BPC_DTC_MODE)\
    CMD(a, b, c, d, e, f, int, BPC_D_CS_MODE, 0x4, CAM_BNR_D_BPC_CON.BPC_CS_MODE, W, CAM_BNR_D_BPC_CON, BPC_CS_MODE)\
    CMD(a, b, c, d, e, f, int, BPC_D_CRC_MODE, 0x4, CAM_BNR_D_BPC_CON.BPC_CRC_MODE, W, CAM_BNR_D_BPC_CON, BPC_CRC_MODE)\
    CMD(a, b, c, d, e, f, int, BPC_D_EXC, 0x4, CAM_BNR_D_BPC_CON.BPC_EXC, W, CAM_BNR_D_BPC_CON, BPC_EXC)\
    CMD(a, b, c, d, e, f, int, BPC_D_BLD_MODE, 0x4, CAM_BNR_D_BPC_CON.BPC_BLD_MODE, W, CAM_BNR_D_BPC_CON, BPC_BLD_MODE)\
    CMD(a, b, c, d, e, f, int, BNR_D_LE_INV_CTL, 0x4, CAM_BNR_D_BPC_CON.BNR_LE_INV_CTL, W, CAM_BNR_D_BPC_CON, BNR_LE_INV_CTL)\
    CMD(a, b, c, d, e, f, int, BNR_D_OSC_COUNT, 0x4, CAM_BNR_D_BPC_CON.BNR_OSC_COUNT, W, CAM_BNR_D_BPC_CON, BNR_OSC_COUNT)\
    CMD(a, b, c, d, e, f, int, BNR_D_EDGE, 0x4, CAM_BNR_D_BPC_CON.BNR_EDGE, W, CAM_BNR_D_BPC_CON, BNR_EDGE)\
    CMD(a, b, c, d, e, f, int, BPC_D_TH_LWB, 0x4, CAM_BNR_D_BPC_TH1.BPC_TH_LWB, W, CAM_BNR_D_BPC_TH1, BPC_TH_LWB)\
    CMD(a, b, c, d, e, f, int, BPC_D_TH_Y, 0x4, CAM_BNR_D_BPC_TH1.BPC_TH_Y, W, CAM_BNR_D_BPC_TH1, BPC_TH_Y)\
    CMD(a, b, c, d, e, f, int, BPC_D_BLD_SLP0, 0x4, CAM_BNR_D_BPC_TH1.BPC_BLD_SLP0, W, CAM_BNR_D_BPC_TH1, BPC_BLD_SLP0)\
    CMD(a, b, c, d, e, f, int, BPC_D_TH_UPB, 0x4, CAM_BNR_D_BPC_TH2.BPC_TH_UPB, W, CAM_BNR_D_BPC_TH2, BPC_TH_UPB)\
    CMD(a, b, c, d, e, f, int, BPC_D_BLD0, 0x4, CAM_BNR_D_BPC_TH2.BPC_BLD0, W, CAM_BNR_D_BPC_TH2, BPC_BLD0)\
    CMD(a, b, c, d, e, f, int, BPC_D_BLD1, 0x4, CAM_BNR_D_BPC_TH2.BPC_BLD1, W, CAM_BNR_D_BPC_TH2, BPC_BLD1)\
	CMD(a, b, c, d, e, f, int, BPC_D_TH_XA, 0x4, CAM_BNR_D_BPC_TH3.BPC_TH_XA, W, CAM_BNR_D_BPC_TH3, BPC_TH_XA)\
	CMD(a, b, c, d, e, f, int, BPC_D_TH_XB, 0x4, CAM_BNR_D_BPC_TH3.BPC_TH_XB, W, CAM_BNR_D_BPC_TH3, BPC_TH_XB)\
    CMD(a, b, c, d, e, f, int, BPC_D_TH_SLA, 0x4, CAM_BNR_D_BPC_TH3.BPC_TH_SLA, W, CAM_BNR_D_BPC_TH3, BPC_TH_SLA)\
    CMD(a, b, c, d, e, f, int, BPC_D_TH_SLB, 0x4, CAM_BNR_D_BPC_TH3.BPC_TH_SLB, W, CAM_BNR_D_BPC_TH3, BPC_TH_SLB)\
    CMD(a, b, c, d, e, f, int, BPC_D_DK_TH_XA, 0x4, CAM_BNR_D_BPC_TH4.BPC_DK_TH_XA, W, CAM_BNR_D_BPC_TH4, BPC_DK_TH_XA)\
    CMD(a, b, c, d, e, f, int, BPC_D_DK_TH_XB, 0x4, CAM_BNR_D_BPC_TH4.BPC_DK_TH_XB, W, CAM_BNR_D_BPC_TH4, BPC_DK_TH_XB)\
    CMD(a, b, c, d, e, f, int, BPC_D_DK_TH_SLA, 0x4, CAM_BNR_D_BPC_TH4.BPC_DK_TH_SLA, W, CAM_BNR_D_BPC_TH4, BPC_DK_TH_SLA)\
    CMD(a, b, c, d, e, f, int, BPC_D_DK_TH_SLB, 0x4, CAM_BNR_D_BPC_TH4.BPC_DK_TH_SLB, W, CAM_BNR_D_BPC_TH4, BPC_DK_TH_SLB)\
    CMD(a, b, c, d, e, f, int, BPC_D_RNG, 0x4, CAM_BNR_D_BPC_DTC.BPC_RNG, W, CAM_BNR_D_BPC_DTC, BPC_RNG)\
    CMD(a, b, c, d, e, f, int, BPC_D_CS_RNG, 0x4, CAM_BNR_D_BPC_DTC.BPC_CS_RNG, W, CAM_BNR_D_BPC_DTC, BPC_CS_RNG)\
    CMD(a, b, c, d, e, f, int, BPC_D_CT_LV, 0x4, CAM_BNR_D_BPC_DTC.BPC_CT_LV, W, CAM_BNR_D_BPC_DTC, BPC_CT_LV)\
    CMD(a, b, c, d, e, f, int, BPC_D_TH_MUL, 0x4, CAM_BNR_D_BPC_DTC.BPC_TH_MUL, W, CAM_BNR_D_BPC_DTC, BPC_TH_MUL)\
    CMD(a, b, c, d, e, f, int, BPC_D_NO_LV, 0x4, CAM_BNR_D_BPC_DTC.BPC_NO_LV, W, CAM_BNR_D_BPC_DTC, BPC_NO_LV)\
    CMD(a, b, c, d, e, f, int, BPC_D_DIR_MAX, 0x4, CAM_BNR_D_BPC_COR.BPC_DIR_MAX, W, CAM_BNR_D_BPC_COR, BPC_DIR_MAX)\
    CMD(a, b, c, d, e, f, int, BPC_D_DIR_TH, 0x4, CAM_BNR_D_BPC_COR.BPC_DIR_TH, W, CAM_BNR_D_BPC_COR, BPC_DIR_TH)\
    CMD(a, b, c, d, e, f, int, BPC_D_RANK_IDXR, 0x4, CAM_BNR_D_BPC_COR.BPC_RANK_IDXR, W, CAM_BNR_D_BPC_COR, BPC_RANK_IDXR)\
    CMD(a, b, c, d, e, f, int, BPC_D_RANK_IDXG, 0x4, CAM_BNR_D_BPC_COR.BPC_RANK_IDXG, W, CAM_BNR_D_BPC_COR, BPC_RANK_IDXG)\
    CMD(a, b, c, d, e, f, int, BPC_D_DIR_TH2, 0x4, CAM_BNR_D_BPC_COR.BPC_DIR_TH2, W, CAM_BNR_D_BPC_COR, BPC_DIR_TH2)\
    CMD(a, b, c, d, e, f, int, NR1_D_CT_EN, 0x4, CAM_BNR_D_NR1_CON.NR1_CT_EN, W, CAM_BNR_D_NR1_CON, NR1_CT_EN)\
    CMD(a, b, c, d, e, f, int, NR1_D_CT_MD, 0x4, CAM_BNR_D_NR1_CT_CON.NR1_CT_MD, W, CAM_BNR_D_NR1_CT_CON, NR1_CT_MD)\
    CMD(a, b, c, d, e, f, int, NR1_D_CT_MD2, 0x4, CAM_BNR_D_NR1_CT_CON.NR1_CT_MD2, W, CAM_BNR_D_NR1_CT_CON, NR1_CT_MD2)\
    CMD(a, b, c, d, e, f, int, NR1_D_CT_THRD, 0x4, CAM_BNR_D_NR1_CT_CON.NR1_CT_THRD, W, CAM_BNR_D_NR1_CT_CON, NR1_CT_THRD)\
    CMD(a, b, c, d, e, f, int, NR1_D_MBND, 0x4, CAM_BNR_D_NR1_CT_CON.NR1_MBND, W, CAM_BNR_D_NR1_CT_CON, NR1_MBND)\
    CMD(a, b, c, d, e, f, int, NR1_D_CT_SLOPE, 0x4, CAM_BNR_D_NR1_CT_CON.NR1_CT_SLOPE, W, CAM_BNR_D_NR1_CT_CON, NR1_CT_SLOPE)\
    CMD(a, b, c, d, e, f, int, NR1_D_CT_DIV, 0x4, CAM_BNR_D_NR1_CT_CON.NR1_CT_DIV, W, CAM_BNR_D_NR1_CT_CON, NR1_CT_DIV)\
    CMD(a, b, c, d, e, f, int, PDC_D_EN, 0x4, CAM_BNR_D_PDC_CON.PDC_EN, W, CAM_BNR_D_PDC_CON, PDC_EN)\
    CMD(a, b, c, d, e, f, int, PDC_D_CT, 0x4, CAM_BNR_D_PDC_CON.PDC_CT, W, CAM_BNR_D_PDC_CON, PDC_CT)\
    CMD(a, b, c, d, e, f, int, PDC_D_MODE, 0x4, CAM_BNR_D_PDC_CON.PDC_MODE, W, CAM_BNR_D_PDC_CON, PDC_MODE)\
    CMD(a, b, c, d, e, f, int, PDC_D_OUT, 0x4, CAM_BNR_D_PDC_CON.PDC_OUT, W, CAM_BNR_D_PDC_CON, PDC_OUT)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_L00, 0x4, CAM_BNR_D_PDC_GAIN_L0.PDC_GCF_L00, W, CAM_BNR_D_PDC_GAIN_L0, PDC_GCF_L00)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_L10, 0x4, CAM_BNR_D_PDC_GAIN_L0.PDC_GCF_L10, W, CAM_BNR_D_PDC_GAIN_L0, PDC_GCF_L10)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_L01, 0x4, CAM_BNR_D_PDC_GAIN_L1.PDC_GCF_L01, W, CAM_BNR_D_PDC_GAIN_L1, PDC_GCF_L01)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_L20, 0x4, CAM_BNR_D_PDC_GAIN_L1.PDC_GCF_L20, W, CAM_BNR_D_PDC_GAIN_L1, PDC_GCF_L20)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_L11, 0x4, CAM_BNR_D_PDC_GAIN_L2.PDC_GCF_L11, W, CAM_BNR_D_PDC_GAIN_L2, PDC_GCF_L11)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_L02, 0x4, CAM_BNR_D_PDC_GAIN_L2.PDC_GCF_L02, W, CAM_BNR_D_PDC_GAIN_L2, PDC_GCF_L02)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_L30, 0x4, CAM_BNR_D_PDC_GAIN_L3.PDC_GCF_L30, W, CAM_BNR_D_PDC_GAIN_L3, PDC_GCF_L30)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_L21, 0x4, CAM_BNR_D_PDC_GAIN_L3.PDC_GCF_L21, W, CAM_BNR_D_PDC_GAIN_L3, PDC_GCF_L21)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_L12, 0x4, CAM_BNR_D_PDC_GAIN_L4.PDC_GCF_L12, W, CAM_BNR_D_PDC_GAIN_L4, PDC_GCF_L12)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_L03, 0x4, CAM_BNR_D_PDC_GAIN_L4.PDC_GCF_L03, W, CAM_BNR_D_PDC_GAIN_L4, PDC_GCF_L03)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_R00, 0x4, CAM_BNR_D_PDC_GAIN_R0.PDC_GCF_R00, W, CAM_BNR_D_PDC_GAIN_R0, PDC_GCF_R00)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_R10, 0x4, CAM_BNR_D_PDC_GAIN_R0.PDC_GCF_R10, W, CAM_BNR_D_PDC_GAIN_R0, PDC_GCF_R10)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_R01, 0x4, CAM_BNR_D_PDC_GAIN_R1.PDC_GCF_R01, W, CAM_BNR_D_PDC_GAIN_R1, PDC_GCF_R01)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_R20, 0x4, CAM_BNR_D_PDC_GAIN_R1.PDC_GCF_R20, W, CAM_BNR_D_PDC_GAIN_R1, PDC_GCF_R20)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_R11, 0x4, CAM_BNR_D_PDC_GAIN_R2.PDC_GCF_R11, W, CAM_BNR_D_PDC_GAIN_R2, PDC_GCF_R11)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_R02, 0x4, CAM_BNR_D_PDC_GAIN_R2.PDC_GCF_R02, W, CAM_BNR_D_PDC_GAIN_R2, PDC_GCF_R02)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_R30, 0x4, CAM_BNR_D_PDC_GAIN_R3.PDC_GCF_R30, W, CAM_BNR_D_PDC_GAIN_R3, PDC_GCF_R30)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_R21, 0x4, CAM_BNR_D_PDC_GAIN_R3.PDC_GCF_R21, W, CAM_BNR_D_PDC_GAIN_R3, PDC_GCF_R21)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_R12, 0x4, CAM_BNR_D_PDC_GAIN_R4.PDC_GCF_R12, W, CAM_BNR_D_PDC_GAIN_R4, PDC_GCF_R12)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_R03, 0x4, CAM_BNR_D_PDC_GAIN_R4.PDC_GCF_R03, W, CAM_BNR_D_PDC_GAIN_R4, PDC_GCF_R03)\
    CMD(a, b, c, d, e, f, int, PDC_D_GTH, 0x4, CAM_BNR_D_PDC_TH_GB.PDC_GTH, W, CAM_BNR_D_PDC_TH_GB, PDC_GTH)\
    CMD(a, b, c, d, e, f, int, PDC_D_BTH, 0x4, CAM_BNR_D_PDC_TH_GB.PDC_BTH, W, CAM_BNR_D_PDC_TH_GB, PDC_BTH)\
    CMD(a, b, c, d, e, f, int, PDC_D_ITH, 0x4, CAM_BNR_D_PDC_TH_IA.PDC_ITH, W, CAM_BNR_D_PDC_TH_IA, PDC_ITH)\
    CMD(a, b, c, d, e, f, int, PDC_D_ATH, 0x4, CAM_BNR_D_PDC_TH_IA.PDC_ATH, W, CAM_BNR_D_PDC_TH_IA, PDC_ATH)\
    CMD(a, b, c, d, e, f, int, PDC_D_NTH, 0x4, CAM_BNR_D_PDC_TH_HD.PDC_NTH, W, CAM_BNR_D_PDC_TH_HD, PDC_NTH)\
    CMD(a, b, c, d, e, f, int, PDC_D_DTH, 0x4, CAM_BNR_D_PDC_TH_HD.PDC_DTH, W, CAM_BNR_D_PDC_TH_HD, PDC_DTH)\
    CMD(a, b, c, d, e, f, int, PDC_D_GSL, 0x4, CAM_BNR_D_PDC_SL.PDC_GSL, W, CAM_BNR_D_PDC_SL, PDC_GSL)\
    CMD(a, b, c, d, e, f, int, PDC_D_BSL, 0x4, CAM_BNR_D_PDC_SL.PDC_BSL, W, CAM_BNR_D_PDC_SL, PDC_BSL)\
    CMD(a, b, c, d, e, f, int, PDC_D_ISL, 0x4, CAM_BNR_D_PDC_SL.PDC_ISL, W, CAM_BNR_D_PDC_SL, PDC_ISL)\
    CMD(a, b, c, d, e, f, int, PDC_D_ASL, 0x4, CAM_BNR_D_PDC_SL.PDC_ASL, W, CAM_BNR_D_PDC_SL, PDC_ASL)\
    CMD(a, b, c, d, e, f, int, PDC_D_GCF_NORM, 0x4, CAM_BNR_D_PDC_SL.PDC_GCF_NORM, W, CAM_BNR_D_PDC_SL, PDC_GCF_NORM)\
    CMD(a, b, c, d, e, f, int, PDC_D_XCENTER, 0x4, CAM_BNR_D_PDC_POS.PDC_XCENTER, W, CAM_BNR_D_PDC_POS, PDC_XCENTER)\
    CMD(a, b, c, d, e, f, int, PDC_D_YCENTER, 0x4, CAM_BNR_D_PDC_POS.PDC_YCENTER, W, CAM_BNR_D_PDC_POS, PDC_YCENTER)\
    CMD(a, b, c, d, e, f, int, BPC_D_XOFFSET, 0x4, CAM_BNR_D_BPC_TBLI1.BPC_XOFFSET, W, CAM_BNR_D_BPC_TBLI1, BPC_XOFFSET)\
    CMD(a, b, c, d, e, f, int, BPC_D_YOFFSET, 0x4, CAM_BNR_D_BPC_TBLI1.BPC_YOFFSET, W, CAM_BNR_D_BPC_TBLI1, BPC_YOFFSET)\
    CMD(a, b, c, d, e, f, int, BPC_D_XSIZE, 0x4, CAM_BNR_D_BPC_TBLI2.BPC_XSIZE, W, CAM_BNR_D_BPC_TBLI2, BPC_XSIZE)\
    CMD(a, b, c, d, e, f, int, BPC_D_YSIZE, 0x4, CAM_BNR_D_BPC_TBLI2.BPC_YSIZE, W, CAM_BNR_D_BPC_TBLI2, BPC_YSIZE)\
	CMD(a, b, c, d, e, f, int, BPC_D_C_TH_LWB, 0x4, CAM_BNR_D_BPC_TH1_C.BPC_C_TH_LWB, W, CAM_BNR_D_BPC_TH1_C, BPC_C_TH_LWB)\
	CMD(a, b, c, d, e, f, int, BPC_D_C_TH_Y, 0x4, CAM_BNR_D_BPC_TH1_C.BPC_C_TH_Y, W, CAM_BNR_D_BPC_TH1_C, BPC_C_TH_Y)\
	CMD(a, b, c, d, e, f, int, BPC_D_C_TH_UPB, 0x4, CAM_BNR_D_BPC_TH2_C.BPC_C_TH_UPB, W, CAM_BNR_D_BPC_TH2_C, BPC_C_TH_UPB)\
	CMD(a, b, c, d, e, f, int, BPC_D_RANK_IDXB, 0x4, CAM_BNR_D_BPC_TH2_C.BPC_RANK_IDXB, W, CAM_BNR_D_BPC_TH2_C, BPC_RANK_IDXB)\
	CMD(a, b, c, d, e, f, int, BPC_D_BLD_LWB, 0x4, CAM_BNR_D_BPC_TH2_C.BPC_BLD_LWB, W, CAM_BNR_D_BPC_TH2_C, BPC_BLD_LWB)\
	CMD(a, b, c, d, e, f, int, BPC_D_C_TH_XA, 0x4, CAM_BNR_D_BPC_TH3_C.BPC_C_TH_XA, W, CAM_BNR_D_BPC_TH3_C, BPC_C_TH_XA)\
	CMD(a, b, c, d, e, f, int, BPC_D_C_TH_XB, 0x4, CAM_BNR_D_BPC_TH3_C.BPC_C_TH_XB, W, CAM_BNR_D_BPC_TH3_C, BPC_C_TH_XB)\
	CMD(a, b, c, d, e, f, int, BPC_D_C_TH_SLA, 0x4, CAM_BNR_D_BPC_TH3_C.BPC_C_TH_SLA, W, CAM_BNR_D_BPC_TH3_C, BPC_C_TH_SLA)\
	CMD(a, b, c, d, e, f, int, BPC_D_C_TH_SLB, 0x4, CAM_BNR_D_BPC_TH3_C.BPC_C_TH_SLB, W, CAM_BNR_D_BPC_TH3_C, BPC_C_TH_SLB)\
	/* BPCI */\
