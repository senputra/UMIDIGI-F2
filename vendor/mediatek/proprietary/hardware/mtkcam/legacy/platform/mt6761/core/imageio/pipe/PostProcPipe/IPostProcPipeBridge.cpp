...
public:     ////    Buffer Quening.
    ...
    //
    virtual MBOOL   endequeFrameCtrl(EPIPE_BUFQUECmd cmd,MUINT32 callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx,MINT32 frameNum,MINT32 timeout=0);//christopher
    //
...
*
********************************************************************************/
MBOOL IPostProcPipeBridge::endequeFrameCtrl(EPIPE_BUFQUECmd cmd,MUINT32 callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx,MINT32 frameNum,MINT32 timeout)
{
    Mutex::Autolock _lock(mLock);
    return  getImp()->endequeFrameCtrl(cmd,callerID,p2burstQIdx,p2dupCQIdx,frameNum,timeout);
}
/*******************************************************************************
* ICmd
********************************************************************************/
