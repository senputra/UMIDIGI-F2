                                 ...
                                 , public I3ACallBack
{
    ...
    public: // ctor & dtor
        ...
        virtual MBOOL is4CellShot(
                        String8& rs8ShotMode,
                        uint32_t& ru4ShotMode) const;
        virtual MBOOL get4CellSensorSupported() const;
        ...
        virtual void startZsdExtShot(ZSD_EXT_MODE extMode,MINT32 framenum = 0);
    ...
    private:
        ...
        //EIS lossless support
        //    lossless use 120% input size, and crop out 100% content
        //    lossy use 100% input size, crop out 80% content, then scale up to 100% for output
        MBOOL                   mEisLosslessSupport;            // TRUE: lossless , FALSE: lossy
