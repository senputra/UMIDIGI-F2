...
#ifndef _MTK_RWB_ERRCODE_H
#define _MTK_RWB_ERRCODE_H
...
#define MODULE_MTK_RWB (0) // Temp value

#define MTK_RWB_OKCODE(errid)         OKCODE(MODULE_MTK_RWB, errid)
#define MTK_RWB_ERRCODE(errid)        ERRCODE(MODULE_MTK_RWB, errid)


// Detection error code
#define S_RWB_OK                  MTK_RWB_OKCODE(0x0000)

#define E_RWB_NEED_OVER_WRITE     MTK_RWB_ERRCODE(0x0001)
#define E_RWB_NULL_OBJECT         MTK_RWB_ERRCODE(0x0002)
#define E_RWB_WRONG_STATE         MTK_RWB_ERRCODE(0x0003)
#define E_RWB_WRONG_CMD_ID        MTK_RWB_ERRCODE(0x0004)
#define E_RWB_WRONG_CMD_PARAM     MTK_RWB_ERRCODE(0x0005)
#define E_RWB_INSUFF_WORK_BUF     MTK_RWB_ERRCODE(0x0006)
#define E_RWB_EGL_CONFIG          MTK_RWB_ERRCODE(0x0006)

#define E_RWB_ERR                 MTK_RWB_ERRCODE(0x0100)
