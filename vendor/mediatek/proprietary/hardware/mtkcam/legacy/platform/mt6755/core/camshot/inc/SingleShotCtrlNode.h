 ...
 ************************************************************************************************/
#ifndef _MTK_CAMERA_CORE_CAMSHOT_INC_CAMSHOT_SINGLESHOTCTRL_H_
#define _MTK_CAMERA_CORE_CAMSHOT_INC_CAMSHOT_SINGLESHOTCTRL_H_
//
...
*
********************************************************************************/
class SShotCtrlNode : public ICamNode
{
    public:     /*createInstance()*/

        static SShotCtrlNode* createInstance(
...
#endif  //  _MTK_CAMERA_CORE_CAMSHOT_INC_CAMSHOT_SINGLESHOTCTRL_H_
