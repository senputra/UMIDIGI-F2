...
IMP_CCT_CTRL( ACDK_CCT_OP_QUERY_ISP_ID )
{
    ...
    *reinterpret_cast<MUINT32 *>(puParaOut) = sizeof(MUINTPTR) == 4 ? 0x67558A00 : 0x67558AFF; // 00 means 32bit; FF means 64bit
...
IMP_CCT_CTRL( ACDK_CCT_V2_OP_QUERY_ISP_INDEX_SET )
{
    ...
    *pu4RealParaOutLen = sizeof(o_type);
    ...
    MY_LOG("IMP_CCT_CTRL( ACDK_CCT_V2_OP_QUERY_ISP_INDEX_SET ) done, DBS(%d) OBC(%d) BPC(%d) NR1(%d) UDM(%d) GGM(%d) ANR(%d) ANR2(%d) CCR(%d) BOK(%d) EE(%d) NR3D(%d) MFB(%d) LCE(%d)\n",
    pCustNvramRegIdx->DBS,pCustNvramRegIdx->OBC, pCustNvramRegIdx->BPC,  pCustNvramRegIdx->NR1, pCustNvramRegIdx->UDM, pCustNvramRegIdx->GGM, pCustNvramRegIdx->ANR, pCustNvramRegIdx->ANR2,
    pCustNvramRegIdx->CCR,pCustNvramRegIdx->BOK, pCustNvramRegIdx->NR3D, pCustNvramRegIdx->MFB, pCustNvramRegIdx->LCE);
