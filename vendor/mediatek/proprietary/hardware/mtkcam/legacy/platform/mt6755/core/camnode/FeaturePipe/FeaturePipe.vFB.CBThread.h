...
#ifndef _MTK_PLATFORM_HARDWARE_CORE_FEATUREIO_PIPE_FEATUREPIPE_VFB_CBTHREAD_H_
#define _MTK_PLATFORM_HARDWARE_CORE_FEATUREIO_PIPE_FEATUREPIPE_VFB_CBTHREAD_H_
//
 ...
 ******************************************************************************/
class VFBCBThread : public Thread
{
public:     ////                    Instantiation.
    //
    static sp<VFBCBThread>           createInstance();
                                    VFBCBThread();
    virtual                         ~VFBCBThread();
...
#endif  //_MTK_PLATFORM_HARDWARE_CORE_FEATUREIO_PIPE_FEATUREPIPE_VFB_CBTHREAD_H_
