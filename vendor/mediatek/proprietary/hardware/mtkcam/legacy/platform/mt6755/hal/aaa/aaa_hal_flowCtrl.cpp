...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL Hal3AFlowCtrl::validatePass2(MINT32 flowType __unused, const NSIspTuning::RAWIspCamInfo& rCamInfo __unused, void* pRegBuf __unused)
{
    return MTRUE;
}
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL Hal3AFlowCtrl::setSensorAndPass1(const ParamIspProfile_T& rParamIspProfile_ __unused, MBOOL fgPerframe __unused)
{
    return MTRUE;
}
...
MBOOL Hal3AFlowCtrl::postCommandDerived(ECmd_T const r3ACmd __unused, MINTPTR const i4Arg __unused)
{
    MY_ERR("[%s] it should be overwritten", __FUNCTION__);
    return MTRUE;
}

MBOOL Hal3AFlowCtrl::sendCommandDerived(ECmd_T const eCmd __unused, MINTPTR const i4Arg __unused)
{
    MY_ERR("[%s] it should be overwritten", __FUNCTION__);
    return MTRUE;
}
...
MVOID
Hal3AFlowCtrl::notifyP1Done(MUINT32 u4MagicNum, MVOID* pvArg __unused)
{
    MY_LOG_IF(m_3ALogEnable, "[%s] u4MagicNum(%d)", __FUNCTION__, u4MagicNum);
...
MBOOL Hal3AFlowCtrl::setFlashLightOnOff(MBOOL bOnOff __unused/*1=on; 0=off*/, MBOOL bMainPre __unused/*1=main; 0=pre*/)
{
    MY_ERR("[%s] it should be overwritten", __FUNCTION__);
    return MTRUE;
}
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL Hal3AFlowCtrl::setParams(Param_T const &rNewParam __unused)
{
    MY_ERR("[%s] it should be overwritten", __FUNCTION__);
    return MFALSE;
#if 0
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL Hal3AFlowCtrl::setZoom(MUINT32 u4ZoomRatio_x100 __unused, MUINT32 u4XOffset __unused, MUINT32 u4YOffset __unused, MUINT32 u4Width __unused, MUINT32 u4Height __unused)
{
    return MTRUE;
}
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MINT32 Hal3AFlowCtrl::getDelayFrame(EQueryType_T const eQueryType __unused) const
{
    return 0;
}
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MINT32 Hal3AFlowCtrl::updateCaptureParams(CaptureParam_T &a_rCaptureInfo __unused)
{
    return S_3A_OK;
}

MVOID Hal3AFlowCtrl::setSensorMode(MINT32 i4SensorMode __unused)
{
...
MINT32
Hal3AFlowCtrl::
send3ACtrl(E3ACtrl_T e3ACtrl __unused, MINTPTR i4Arg1 __unused, MINTPTR i4Arg2 __unused)
{
/*
    switch (e3ACtrl)
    {
