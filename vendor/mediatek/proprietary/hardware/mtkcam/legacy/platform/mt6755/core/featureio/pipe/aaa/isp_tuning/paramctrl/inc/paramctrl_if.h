...
public:     // Attributes
    ...
    virtual MBOOL        setISO(MINT32 const i4ISOValue) = 0;
    ...
    virtual MERROR_ENUM getDNGColorMatrix1(double cm[3][3]) const = 0;
    virtual MERROR_ENUM getDNGForwardMatrix1(double fm[3][3]) const = 0;
