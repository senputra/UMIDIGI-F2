...
{
    ISP_FUNC_DBG("+,cq(%d),subMode(%d),isApplyTuning(%d)",
        imageioPackage.cq,imageioPackage.subMode, imageioPackage.isApplyTuning);
...
cam_isp_nsl2_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage)
{
    ...
    if (imageioPackage.isApplyTuning) { //0x15004A78 ~ 0x15004A9C
        ...
        //
        ISP_FUNC_DBG("eTuningCqFunc1(%d),eTuningCqFunc2(%d)",
            tuningPackage.eTuningCqFunc1,tuningPackage.eTuningCqFunc2);
        //
        if (tuningPackage.eTuningCqFunc1 == CAM_ISP_NSL2) {
            ...
            ISP_FUNC_DBG("rrzCropX(%d),rrzCropY(%d),rrzRatio(%f)",
                tuningPackage.rrzCropX, tuningPackage.rrzCropY, tuningPackage.rrzRatio);
            ...
            ISP_FUNC_DBG("[NSL2]CentrXLsc(%d),CentrYLsc(%d),Rr0Lsc(%d),Rr1Lsc(%d),Rr2Lsc(%d),Slp1Lsc(%d),Slp2Lsc(%d),Slp3Lsc(%d),Slp4Lsc(%d)",
                nsl2CentrXLsc, nsl2CentrYLsc, nsl2Rr0Lsc, nsl2Rr1Lsc, nsl2Rr2Lsc, nsl2Slp1Lsc, nsl2Slp2Lsc, nsl2Slp3Lsc, nsl2Slp4Lsc);
        }
    }
...
cam_isp_mfb_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage)
{
    ...
    ISP_FUNC_DBG("+(bld_mode(0x%x),mfbout(%lu,%lu,%lu),out_xofst(%d))",
            imageioPackage.mfbCfg.bld_mode,
            imageioPackage.mfbCfg.mfb_out.w,
            imageioPackage.mfbCfg.mfb_out.h,
            imageioPackage.mfbCfg.mfb_out.stride,
            imageioPackage.mfbCfg.out_xofst);
...
cam_isp_lce_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage)
{
    ...
    if (imageioPackage.isApplyTuning) {  //0x150049C0 ~ 0x150049E8
        ...
        MUINT32 addrOffset, moduleSize;
        //
        ISP_FUNC_DBG("eTuningCqFunc1(%d),eTuningCqFunc2(%d),eTuningCqDma(%d)",
            tuningPackage.eTuningCqFunc1, tuningPackage.eTuningCqFunc2, tuningPackage.eTuningCqDma);
        //
        ...
        if ((lceSlmWd - 1 > 0) && (lceSlmHt - 1 > 0)) {
            ...
            ISP_FUNC_DBG("tuningPackage.lceInput(%u,%u)",
                tuningPackage.lceInputW, tuningPackage.lceInputH);
            ISP_FUNC_DBG("lceBcmkX(%d),lceBcmkY(%d)", lceBcmkX, lceBcmkY);
        }else if (imageioPackage.finalEnP2 & CAM_CTL_EN_P2_LCE_EN) {
            ISP_FUNC_ERR("[Error]size error lceSlmWd(%d),lceSlmHt(%d),finalEnP2(0x%x)",
                lceSlmWd, lceSlmHt, imageioPackage.finalEnP2);
        }
    }
...
cam_isp_nr3d_cfg( IspImageioPackage imageioPackage, IspTuningPackage tuningPackage)
{
    ...
    ISP_FUNC_DBG("fbcntOff_xoff(%d),fbcntOff_yoff(%d),fbcntSiz_xsiz(%d),fbcntSiz_ysiz(%d),fbCount_cnt(%d)",
        imageioPackage.nr3dCfg.fbcntOff_xoff, imageioPackage.nr3dCfg.fbcntOff_yoff,
        imageioPackage.nr3dCfg.fbcntSiz_xsiz, imageioPackage.nr3dCfg.fbcntSiz_ysiz,
        imageioPackage.nr3dCfg.fbCount_cnt);
    ...
    ISP_FUNC_DBG("ctrl_lmtOutCntTh(%d),ctrl_onEn(%d),onOff_onOfStX(%d),onOff_onOfStY(%d),onSiz_onWd(%d),onSiz_onHt(%d)",
        imageioPackage.nr3dCfg.ctrl_lmtOutCntTh, imageioPackage.nr3dCfg.ctrl_onEn,
        imageioPackage.nr3dCfg.onOff_onOfStX, imageioPackage.nr3dCfg.onOff_onOfStY,
        imageioPackage.nr3dCfg.onSiz_onWd, imageioPackage.nr3dCfg.onSiz_onHt);
    ...
    */
    if (imageioPackage.isApplyTuning) { //0x15004A20 ~ 0x15004A44
        ...
        if (tuningPackage.eTuningCqFunc1 == CAM_ISP_NSL2A) {
            ...
            ISP_FUNC_DBG("[NSL2A]CentrXLsc(%d),CentrYLsc(%d),Rr0Lsc(%d),Rr1Lsc(%d),Rr2Lsc(%d),HrzComp(%d),VrzComp(%d),Gain0Lsc(%d),Gain1Lsc(%d),Gain2Lsc(%d),Gain3Lsc(%d),Gain4Lsc(%d),Slp1Lsc(%d),Slp2Lsc(%d),Slp3Lsc(%d),Slp4Lsc(%d)",
                nsl2CentrXLsc, nsl2CentrYLsc, nsl2Rr0Lsc, nsl2Rr1Lsc, nsl2Rr2Lsc, nsl2HrzComp, nsl2VrzComp, nsl2Gain0Lsc, nsl2Gain1Lsc, nsl2Gain2Lsc, nsl2Gain3Lsc, nsl2Gain4Lsc, nsl2Slp1Lsc, nsl2Slp2Lsc, nsl2Slp3Lsc, nsl2Slp4Lsc);
        }
    }
    ...
    */
    if (imageioPackage.isApplyTuning) { //0x15004A50 ~ 0x15004A74
        ...
        if (tuningPackage.eTuningCqFunc1 == CAM_ISP_NSL2B) {
            ...
            ISP_FUNC_DBG("[NSL2B]CentrXLsc(%d),CentrYLsc(%d),Rr0Lsc(%d),Rr1Lsc(%d),Rr2Lsc(%d),HrzComp(%d),VrzComp(%d),Gain0Lsc(%d),Gain1Lsc(%d),Gain2Lsc(%d),Gain3Lsc(%d),Gain4Lsc(%d),Slp1Lsc(%d),Slp2Lsc(%d),Slp3Lsc(%d),Slp4Lsc(%d)",
                nsl2CentrXLsc, nsl2CentrYLsc, nsl2Rr0Lsc, nsl2Rr1Lsc, nsl2Rr2Lsc, nsl2HrzComp, nsl2VrzComp, nsl2Gain0Lsc, nsl2Gain1Lsc, nsl2Gain2Lsc, nsl2Gain3Lsc, nsl2Gain4Lsc, nsl2Slp1Lsc, nsl2Slp2Lsc, nsl2Slp3Lsc, nsl2Slp4Lsc);
        }
    }
    ...
    */
    if (imageioPackage.isApplyTuning) {  //0x15004FC0 ~ 0x15004FD8
        ...
        if (tuningPackage.eTuningCqFunc1 == CAM_ISP_SL2C) {
            ...
            ISP_FUNC_DBG("[SL2C]CentrXLsc(%d),CentrYLsc(%d),Rr0Lsc(%d),Rr1Lsc(%d),Rr2Lsc(%d),HrzComp(%d)",
                sl2cCentrXLsc, sl2cCentrYLsc, sl2cRr0Lsc, sl2cRr1Lsc, sl2cRr2Lsc, sl2cHrzComp);
        }
    }
...
cam_isp_udm_cfg(IspImageioPackage imageioPackage, IspTuningPackage tuningPackage)
{
    ...
    if (imageioPackage.isApplyTuning) {  //0x150048A0 ~ 0x150048E8
        ...
        MUINT32 addrOffset, moduleSize;
        //
        ISP_FUNC_DBG("eTuningCqFunc1(%d),eTuningCqFunc2(%d),fgModeRegBit(0x%x),reg_cam_udm_dsb(0x%x)",
            tuningPackage.eTuningCqFunc1, tuningPackage.eTuningCqFunc2, fgModeRegBit, reg_cam_udm_dsb);
        //
...
{
    ISP_FUNC_DBG("+,m_pP2IspDrv(%p),cq(%d),subMode(%d),isApplyTuning(0x%08x)",
        m_pP2IspDrv, imageioPackage.cq, imageioPackage.subMode, imageioPackage.isApplyTuning);
...
cam_isp_c42_cfg(IspImageioPackage /*imageioPackage*/, IspTuningPackage /*tuningPackage*/)
{
    ...
    m_pP2IspDrv->writeReg(((MUINT32)((MUINT8*)&ispReg.CAM_C42_CON - (MUINT8*)&ispReg)),
                0x00000000, ISP_DRV_USER_ISPF, 0);
...
cam_isp_rrz_cfg(IspDrv* pCurDrv, IspSize in, IspRect crop, IspSize out, MUINT32 ctrl, MUINT32 h_step, MUINT32 v_step, MUINT32 isRaw_D)
{
    ...
    ISP_FUNC_DBG("+[setRRZToCQ](ctrl(0x%x),in(%lu,%lu),out(%lu,%lu),step(0x%x,0x%x),ofst(%d,%d,%d,%d/%lu,%lu))",
                 ctrl, in.w, in.h, out.w, out.h, h_step, v_step,
                 crop.x, crop.floatX, crop.y, crop.floatY, crop.w, crop.h);
...
MINT32 IspDrv_B::cam_isp_srz1_cfg(MUINT32 ctrl, SrzSizeCfg inout_size, IspRect crop, MUINT32 h_step, MUINT32 v_step)
{
    ISP_FUNC_DBG("+(ctrl(0x%x),in(%d,%d),out(%d,%d),step(0x%x,0x%x),ofst(%d,%d,%d,%d,))",
            ctrl, inout_size.in_w, inout_size.in_h, inout_size.out_w, inout_size.out_h,
            h_step, v_step, crop.x, crop.floatX, crop.y, crop.floatY);
...
{
    ISP_FUNC_DBG(":E cq(%d),isP2IspOnly(%d),burstQIdx(%d),m_trigSsrc(%d)",
        cq, isP2IspOnly, burstQIdx, this->m_trigSsrc);
    ...
    switch (cq) {
        ...
        case CAM_ISP_CQ0B:
            ...
            break;
        case CAM_ISP_CQ0C:
            ISP_FUNC_DBG("CAM_ISP_CQ0C(%p),m_trigSsrc(%d)",
                m_pPhyIspDrv_bak->getCQDescBufPhyAddr(cq, burstQIdx, dupCqIdx), this->m_trigSsrc);
...
controlBurstQueBuffer(EIspControlBufferCmd cmd, MUINT32 burstQueueNum)
{
    ...
    if (eIspControlBufferCmd_Alloc == cmd) {
        ...
        =============================================*/
        gMdpBufInfo.size =
            (burstQueueNum * sizeof(int**) +
             burstQueueNum * ISP_DRV_P2_CQ_NUM * sizeof(int*) +
             burstQueueNum * ISP_DRV_P2_CQ_NUM * ISP_DRV_P2_CQ_DUPLICATION_NUM * sizeof(MDPMGR_CFG_STRUCT)) +
             (7 + 1) + 0x100;
        ...
        for (k = 0; k < burstQueueNum; k++) {
            for (i = 0; i < ISP_DRV_P2_CQ_NUM; i++) {
                for (j = 0; j < ISP_DRV_P2_CQ_DUPLICATION_NUM; j++) {
                    ...
                    ISP_FUNC_INF("[Tpipe]i(%d),j(%d)va(%p),pa(0x%08x)", i, j, gpMdpMgrCfgData[k][i][j].ispTpipeCfgInfo.drvinfo.tpipeTableVa, gpMdpMgrCfgData[k][i][j].ispTpipeCfgInfo.drvinfo.tpipeTablePa);
                    #endif
                }
            }
        }
        ...
        MUINT32 &tuningDmaTag)
{
    ...
    ISP_FUNC_DBG("tunStas(%d),drvScenario(%d),subMode(%d),tuningEn1Tag(0x%08x),tuningEn2Tag(0x%08x),tuningDmaTag(0x%08x)",
        m_pPhyIspDrv->getP2TuningStatus((ISP_DRV_CQ_ENUM)cq), drvScenario, subMode, tuningEn1Tag, tuningEn2Tag, tuningDmaTag);
        ...
        MUINT32 &tuningDmaTag)
{
    ...
    ISP_FUNC_DBG("tunStas(%d),drvScenario(%d),subMode(%d),tuningEnTag(0x%08x),tuningDmaTag(0x%08x)",
        m_pPhyIspDrv->getP2TuningStatus((ISP_DRV_CQ_ENUM)cq), drvScenario, subMode, tuningEnTag, tuningDmaTag);
...
int DMAI_B::_config( void )
{
    ...
    ISP_FUNC_DBG("DMAI(%lu),[%s]:m_pP2IspDrv(%p),pa(0x%" PRIxPTR "),ofst(0x%08X),size(%lu,%lu,%lu,%lu),pixel_byte(%d),crop(%d,%d), flip(%d),isTwin(%d),CQ(0x%x/0x%x)",
        this->id(),
        this->name_Str(),
        m_pP2IspDrv,
    ...
    switch (this->id())
    {
        case ISP_DMA_TDRI:
            ...
            //
            ISP_FUNC_DBG("CAM_TDRI_BASE_ADDR = 0x%" PRIxPTR, this->dma_cfg.memBuf.base_pAddr);
        ...
        case ISP_DMA_UFDI:
            ...
            //
            ISP_FUNC_DBG("CAM_UFDI_BASE_ADDR=[0x%" PRIxPTR "]",
...
//            ISP_WRITE_REG(_targetVirDrv, CAM_BPCI_D_CON,0x80000020, ISP_DRV_USER_ISPF); // ultra-
        ...
        case ISP_DMA_LCEI:
            ...
            //
            ISP_FUNC_DBG("CAM_LCEI_BASE_ADDR=[0x%" PRIxPTR "]", this->dma_cfg.memBuf.base_pAddr + this->dma_cfg.memBuf.ofst_addr);
        ...
        case ISP_DMA_IMGI:
            ...
            ISP_FUNC_DBG("[imgi]format_en(%d),format(0x%x),bus_size_en(%d),bus_size(%d)",
                this->dma_cfg.format_en, this->dma_cfg.format, this->dma_cfg.bus_size_en, this->dma_cfg.bus_size);


            ISP_FUNC_DBG("[imgi]p2cq(%d),cq(%d),dupCqIdx(%d),burstQueIdx(%d)",
                p2Cq, gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].cqIdx, this->dupCqIdx, this->burstQueIdx);

            ISP_FUNC_DBG("[mdp]Fmt(0x%x),W(%d),H(%d),stride(%d,%d),VA(0x%8x),PA(0x%8x),Size(0x%8x)",
                        gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].mdpSrcFmt,
                        gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].mdpSrcW,
                        gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].mdpSrcH,
                        gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].mdpSrcYStride,
                        gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].mdpSrcYStride,
                        gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].srcVirAddr,
                        gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].srcPhyAddr,
                        gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].mdpSrcBufSize);
        ...
        case ISP_DMA_VIPI:
            ...
            #endif
            //
            ISP_FUNC_DBG("ISP_DMA_VIPI = 0x%" PRIxPTR, this->dma_cfg.memBuf.base_pAddr);
        ...
        case ISP_DMA_VIP2I:
            ...
            #endif
            //
            ISP_FUNC_DBG("CAM_VIP2I_BASE_ADDR = 0x%" PRIxPTR, this->dma_cfg.memBuf.base_pAddr);
        ...
        case ISP_DMA_VIP3I:
            ...
            #endif
            //
            ISP_FUNC_DBG("CAM_VIP3I_BASE_ADDR = 0x%" PRIxPTR, this->dma_cfg.memBuf.base_pAddr);
...
int DMAI_B::_write2CQ(void)
{
    ...
    ISP_FUNC_DBG("_,[id:0X%lX]", this->id());
...
int DMAO_B::_config( void )
{
    ...
    ISP_FUNC_DBG("DMAO(%lu),[%s]:cq(%d/%d),pa(0x%" PRIxPTR "),ofst(0x%X),size(%lu,%lu,%lu,%lu), pixel_byte(%d),cropW(%d,%d,%lu,%lu),format(0x%x),fps(%d),cropX_inbussize(%d)",
        this->id(), \
        this->name_Str(), \
        this->CQ, this->CQ_D,\
        this->dma_cfg.memBuf.base_pAddr, \
...
//            ISP_WRITE_REG(_targetVirDrv, CAM_RRZO_CON2,0x00808000, ISP_DRV_USER_ISPF);
            ...
            ISP_FUNC_DBG("ISP_DMA_RRZO, pxl_byte=%d, w=0x%lx,x=0x%lx,stride=0x%lx, cropXY=%d,%d", this->dma_cfg.pixel_byte, this->dma_cfg.size.w, this->dma_cfg.size.xsize, this->dma_cfg.size.stride, this->dma_cfg.crop.y, this->dma_cfg.crop.x);
            //currently , slow motion will map to this case
            if (this->m_fps > FPS_BOUNDARY) {
#if SRAM_SWITCH
...
//            ISP_WRITE_REG(_targetVirDrv, CAM_RRZO_D_CON2,0x00808000, ISP_DRV_USER_ISPF);
            ...
            //
            ISP_FUNC_DBG("ISP_DMA_RRZOD, pxl_byte=%d, w=0x%lx,x=0x%lx,stride=0x%lx, cropXY=%d,%d",\
...
int DMAO_B::_write2CQ(void)
{
    ...
    unsigned int myCq = CAM_ISP_CQ_NONE;
    ISP_FUNC_DBG("+,");
    ISP_FUNC_DBG("[id:0X%lX],CQ(%d)", this->id(), this->CQ);
    ...
    if ( ISP_PASS1 == pSrcTopCtrl->path || ISP_PASS1_D == pSrcTopCtrl->pathD ) {
        ...
        else
        {
            ...
            if (ISP_PASS1 == pSrcTopCtrl->path) {
                ...
                mRawIspDrv =
                    pSrcTopCtrl->m_pIspDrvShell->ispDrvGetCQIspDrv(mTopCtrl.CQ, mTopCtrl.burstQueIdx, mTopCtrl.dupCqIdx);
#if 1
            ...
            if (ISP_PASS1_D == pSrcTopCtrl->pathD) {
                ...
                mRawDIspDrv =
                    pSrcTopCtrl->m_pIspDrvShell->ispDrvGetCQIspDrv(mTopCtrl.CQ_D, mTopCtrl.burstQueIdx, mTopCtrl.dupCqIdx);
                ...
                pIspTop->CAM_CTL_CQ_EN.Raw = ((pSrcTopCtrl->isp_top_ctl.CAM_CTL_CQ_EN.Raw |
                           ISP_READ_REG_NOPROTECT(mRawIspDrv, CAM_CTL_CQ_EN)) & CAM_CTL_CQ_EN_MASK) |
                          (ISP_READ_REG_NOPROTECT(mpPhyIspDrv, CAM_CTL_CQ_EN) & (~CAM_CTL_CQ_EN_MASK));
                ISP_FUNC_DBG("RAW_CENTRAL::D Final CQ_EN=0x%x, input:0x%x",
                    pIspTop->CAM_CTL_CQ_EN.Raw, pSrcTopCtrl->isp_top_ctl.CAM_CTL_CQ_EN.Raw);
...
int ISP_TOP_CTRL::_config( void )
{
    ...
    if ( ISP_PASS1   == this->path || ISP_PASS1_D == this->pathD ) {
        ...
        if (ISP_PASS1 == this->path) {
            ...
            ISP_WRITE_REG(m_pPhyIspDrv, CAM_CTL_INT_P1_EN,
                ISP_READ_REG_NOPROTECT(m_pPhyIspDrv, CAM_CTL_INT_P1_EN)  | ptop->isp_top_ctl.CAM_CTL_INT_P1_EN.Raw, ISP_DRV_USER_ISPF);
            ISP_WRITE_REG(m_pPhyIspDrv, CAM_CTL_INT_P1_EN2,
                ISP_READ_REG_NOPROTECT(m_pPhyIspDrv, CAM_CTL_INT_P1_EN2) | ptop->isp_top_ctl.CAM_CTL_INT_P1_EN2.Raw, ISP_DRV_USER_ISPF);
        ...
        if (ISP_PASS1_D == this->pathD) {
            ...
            ISP_WRITE_REG(m_pPhyIspDrv, CAM_CTL_CQ_EN,
                ISP_READ_REG_NOPROTECT(m_pPhyIspDrv, CAM_CTL_CQ_EN)|ptop->isp_top_ctl.CAM_CTL_CQ_EN.Raw, ISP_DRV_USER_ISPF);
            ISP_WRITE_REG(m_pPhyIspDrv, CAM_CTL_INT_P1_EN_D,
                ISP_READ_REG_NOPROTECT(m_pPhyIspDrv, CAM_CTL_INT_P1_EN_D)  | ptop->isp_top_ctl.CAM_CTL_INT_P1_EN_D.Raw, ISP_DRV_USER_ISPF);
            ISP_WRITE_REG(m_pPhyIspDrv, CAM_CTL_INT_P1_EN2_D,
                ISP_READ_REG_NOPROTECT(m_pPhyIspDrv, CAM_CTL_INT_P1_EN2_D) | ptop->isp_top_ctl.CAM_CTL_INT_P1_EN2_D.Raw, ISP_DRV_USER_ISPF);
        ...
        if (ISP_PASS1_CAMSV == this->path) {
            ISP_WRITE_REG(m_pPhyIspDrv, CAMSV_CAMSV_INT_EN,
                ISP_READ_REG_NOPROTECT(m_pPhyIspDrv, CAMSV_CAMSV_INT_EN)  |ptop->isp_top_ctl.CAMSV_CAMSV_INT_EN.Raw, ISP_DRV_USER_ISPF);
        } else if (ISP_PASS1_CAMSV_D == this->pathD) {
            ISP_WRITE_REG(m_pPhyIspDrv, CAMSV_CAMSV2_INT_EN,
                ISP_READ_REG_NOPROTECT(m_pPhyIspDrv, CAMSV_CAMSV2_INT_EN) |ptop->isp_top_ctl.CAMSV_CAMSV2_INT_EN.Raw, ISP_DRV_USER_ISPF);
        }
...
RUN_P2_CFG:
    ...
    if ((this->path == ISP_PASS2) || (this->path == ISP_PASS2B) || (this->path == ISP_PASS2C))
    {
        ...
        ISP_WRITE_REG(m_pP2IspDrv, CAM_CTL_SEL_GLOBAL_SET,
            this->isp_top_ctl.CAM_CTL_SEL_GLOBAL.Raw, ISP_DRV_USER_ISPF);
        ISP_WRITE_REG(m_pP2IspDrv, CAM_CTL_SEL_GLOBAL_CLR,
            this->isp_top_ctl.CAM_CTL_SEL_GLOBAL_MASK, ISP_DRV_USER_ISPF);
        if (this->isp_top_ctl.CAM_CTL_EN_P2.Raw & CAM_CTL_EN_P2_MIX3_EN)
        {   //mfb mixing, mfb on/mix3 on, mfb_mode in 15004040 should be off
            ISP_WRITE_REG(m_pP2IspDrv, CAM_CTL_SEL_GLOBAL_CLR,
                this->isp_top_ctl.CAM_CTL_SEL_GLOBAL.Raw & this->isp_top_ctl.CAM_CTL_SEL_GLOBAL_MASK, ISP_DRV_USER_ISPF);
        }
        ...
        {   //mfb blending, mfb on/mix3 off, mfb_mode in 15004040 should be on
            ISP_WRITE_REG(m_pP2IspDrv, CAM_CTL_SEL_GLOBAL_SET,
                this->isp_top_ctl.CAM_CTL_SEL_GLOBAL.Raw | this->isp_top_ctl.CAM_CTL_SEL_GLOBAL_MASK, ISP_DRV_USER_ISPF);
            ISP_WRITE_REG(m_pP2IspDrv, CAM_CTL_SEL_GLOBAL_CLR,
                ISP_READ_REG_NOPROTECT(m_pP2IspDrv, CAM_CTL_SEL_GLOBAL_CLR) & (~this->isp_top_ctl.CAM_CTL_SEL_GLOBAL_MASK), ISP_DRV_USER_ISPF);
        }
        #endif
        //
        //ISP_WRITE_REG(m_pP2IspDrv, CAM_CTL_SEL_GLOBAL_CLR,(~0x0), ISP_DRV_USER_ISPF);
        //
        ISP_WRITE_REG(m_pPhyIspDrv, CAM_CTL_INT_P2_EN,
            ISP_READ_REG_NOPROTECT(m_pPhyIspDrv, CAM_CTL_INT_P2_EN) | this->isp_top_ctl.CAM_CTL_INT_P2_EN.Raw, ISP_DRV_USER_ISPF);
        //
        if (this->isV3)
        {
...
int ISP_TOP_CTRL::_enable( void* pParam  )
{
    ...
    irq_TG_ClrDone.UserName = (char*)"pass1";
    ...
    if ( CAM_ISP_PASS2_START == *start || CAM_ISP_PASS2B_START == *start || CAM_ISP_PASS2C_START == *start ) {
        ISP_FUNC_DBG("path(%d),start(%d),isP2IspOnly(%d),dupCqIdx(%d),burstQueIdx(%d),SCEN(%d)",
            this->path,*start, this->isP2IspOnly, this->dupCqIdx, this->burstQueIdx, this->isp_top_ctl.CAM_CTL_SCENARIO.Bits.SCENARIO);
        _localVar = &this->m_pIspDrvShell->gPass2Lock;
    } else {
        if (( CAM_CTL_EN_P1_TG1_EN & this->isp_top_ctl.CAM_CTL_EN_P1.Raw) ||
            ( CAM_ISP_PASS1_CQ0_START == (*start) ) ||
            ( CAM_ISP_PASS1_CQ0B_START == (*start) ))
    ...
    if ( CAM_ISP_PASS1_START == (*start) ) {
        ...
        if ( CAM_CTL_EN_P1_D_TG1_D_EN & this->isp_top_ctl.CAM_CTL_EN_P1_D.Raw) {
            ...
            irq_TG_ClrDone.UserNumber=(int)ISP_DRV_IRQ_USER_ISPDRV;
            irq_TG_ClrDone.UserName = (char*)"pass1_d";
            //
            if ( MFALSE == this->m_pPhyIspDrv->waitIrq( &irq_TG_ClrDone )) {
                ISP_FUNC_ERR("clr irq status fail");
                return -1;
        ...
        if ( CAMSV_CAMSV_MODULE_TG_EN & this->isp_top_ctl.CAMSV_CAMSV_MODULE_EN.Raw) {
            ...
            irq_TG_ClrDone.UserNumber=(int)ISP_DRV_IRQ_USER_ISPDRV;
            irq_TG_ClrDone.UserName = (char*)"camsv";
            //
            if ( MFALSE == this->m_pPhyIspDrv->waitIrq( &irq_TG_ClrDone )) {
                ISP_FUNC_ERR("clr irq status fail");
                return -1;
        ...
        if ( CAMSV_CAMSV2_MODULE_TG_EN & this->isp_top_ctl.CAMSV_CAMSV2_MODULE_EN.Raw) {
            ...
            irq_TG_ClrDone.UserNumber=(int)ISP_DRV_IRQ_USER_ISPDRV;
            irq_TG_ClrDone.UserName = (char*)"camsv_d";
            //
            if ( MFALSE == this->m_pPhyIspDrv->waitIrq( &irq_TG_ClrDone )) {
                ISP_FUNC_ERR("clr irq status fail");
                return -1;
        ...
        if (this->isP2IspOnly) {
            ...
            irqPass2Done.UserName = (char*)"isp_function";
...
int ISP_TOP_CTRL::_disable( void )
{
    ...
    irq_vs_int.UserName = (char*)"TOP_CTL";
    ...
    irq_vs2_int.UserName = (char*)"TOP_CTL";
    ...
    irq_csv_int.UserName = (char*)"TOP_CTL";
    ...
    irq_csv2_int.UserName = (char*)"TOP_CTL";
...
///////////////////E
        ...
        while(_clrPort--) {
            ISP_FUNC_DBG("[TopCtrl::Disable][before]rt_dma(%d),size:hw(%zu)",
                _dma[_clrPort], ISP_BUF_CTRL::m_hwbufL[_dma[_clrPort]].bufInfoList.size());
            buf_ctrl.ctrl = ISP_RT_BUF_CTRL_CLEAR;
            buf_ctrl.buf_id = (_isp_dma_enum_)_dma[_clrPort];
            buf_ctrl.data_ptr = &dummy;
            buf_ctrl.pExtend = 0;
            ISP_FUNC_DBG("rtBufCtrl.ctrl(%d)/id(%d)/ptr(%p)",
                buf_ctrl.ctrl, buf_ctrl.buf_id, buf_ctrl.data_ptr);
            if ( MTRUE != this->m_pIspDrvShell->m_pPhyIspDrv_bak->rtBufCtrl((void*)&buf_ctrl) ) {
                ISP_FUNC_ERR("ERROR:rtBufCtrl");
                return -1;
            }
            ISP_FUNC_DBG("[TopCtrl::Disable][after]rt_dma(%d),size:hw(%zu)",
                _dma[_clrPort], ISP_BUF_CTRL::m_hwbufL[_dma[_clrPort]].bufInfoList.size());
        }
...
{
    ISP_FUNC_DBG("TOP_CTRL+,path(0x%x/0x%x),hwScenario(%d)",
        this->path, this->pathD, this->isp_top_ctl.CAM_CTL_SCENARIO.Bits.SCENARIO);
    //TOP
    ...
    if (ISP_PASS1_D == this->pathD) { //will update rawD
        ...
        if (isTwinMode) {
            ...
            int raw_CQ = rawCentralCtrl.getRawPathCQ();
            for (int i=0;i<ISP_DRV_P1_CQ_DUPLICATION_NUM; i++) {
                if (this->CQ != raw_CQ) {
         ...
         ISP_PASS2C == this->path)
    {
...
#ifdef __LP64__
                ISP_FUNC_DBG("tuningUpdateBit(0x%016lx),pTuningBuf(%p)", tuningUpdateBit, tuningPackage.pTuningBuf);
#else
                ISP_FUNC_DBG("tuningUpdateBit(0x%016llx),pTuningBuf(%p)", tuningUpdateBit, tuningPackage.pTuningBuf);
#endif
            }
...
#ifdef __LP64__
            ISP_FUNC_DBG("(ISP_RAW_PIPE),isApplyTuning(0x%x),finalEnP2(0x%x),tuningUpdateBit(0x%lx)", this->isApplyTuning, finalEnP2, tuningUpdateBit);
#else
            ISP_FUNC_DBG("(ISP_RAW_PIPE),isApplyTuning(0x%x),finalEnP2(0x%x),tuningUpdateBit(0x%llx)", this->isApplyTuning, finalEnP2, tuningUpdateBit);
#endif
        }
        else
        {
...
#ifdef __LP64__
                ISP_FUNC_DBG("tuningUpdateBit(0x%016lx),tuningEnP2(0x%08x),tuningEnP2Dma(0x%08x),pTuningBuf(%p)", tuningUpdateBit, tuningEnP2, tuningEnP2Dma, tuningPackage.pTuningBuf);
#else
                ISP_FUNC_DBG("tuningUpdateBit(0x%016llx),tuningEnP2(0x%08x),tuningEnP2Dma(0x%08x),pTuningBuf(%p)", tuningUpdateBit, tuningEnP2, tuningEnP2Dma, tuningPackage.pTuningBuf);
#endif
            }
            if (NSImageio::NSIspio::eDrvScenario_IP == this->drvScenario) {
                finalEnP1 = ((~tuningEnP1Tag)&this->en_p1) | (tuningEnP1Tag&tuningEnP1);
                ISP_FUNC_INF("(ISP_RAW_PIPE),en_p1(0x%x),tuningEnP1Tag(0x%x),tuningEnP1(0x%x),finalEnP1(0x%x)",
                    this->en_p1, tuningEnP1Tag, tuningEnP1, finalEnP1);
            }
            finalEnP2 = ((~tuningEnP2Tag)&this->en_p2)|(tuningEnP2Tag&tuningEnP2);
        }


        ISP_FUNC_DBG("(ISP_RAW_PIPE),cq(%d),drvScenario(%d),sub_mode(%d),en_p2(0x%08x),finalEnP2(0x%08x)",
            this->CQ, this->drvScenario, this->sub_mode, this->en_p2, finalEnP2);
        //
        for (i = 0; i < CHECK_TUNING_P2_EN_BITS; i++) {
            if (((finalEnP2 & gIspModuleMappingTableP2En[i].ctrlByte) ||
                 (tuningUpdateBit & gIspModuleMappingTableP2En[i].eTuningFunc1) ||
                 (tuningUpdateBit & gIspModuleMappingTableP2En[i].eTuningFunc2)) &&
                ...
                //
                if (((tuningPackage.eTuningCqFunc1 != CAM_DUMMY_) || (tuningPackage.eTuningCqFunc2 != CAM_DUMMY_)) &&
                    (gIspModuleMappingTableP2En[i].eTuningCqDma != CAM_DUMMY_))
        ...
        if (NSImageio::NSIspio::eDrvScenario_IP == this->drvScenario) { // only for scenario ip
            for (i=0;i<CHECK_TUNING_P1_EN_BITS; i++) {
                if ((finalEnP1 & gIspModuleMappingTableP1En[i].ctrlByte) &&
                    ...
                    //
                    if (((tuningPackage.eTuningCqFunc1!=CAM_DUMMY_) || (tuningPackage.eTuningCqFunc2 != CAM_DUMMY_)) &&
                        (tuningEnP1Dma&gIspModuleMappingTableP1En[i].dmaCtrlByte))
        ...
        if (!this->isV3)
        {
            ...
            if (CAM_CTL_EN_P1_RRZ_EN & this->en_p1 && 1 == this->isTwinMode) {
                ...
                ISP_FUNC_DBG("isTwinMode,path(0x%x), m_pIspDrvShell=%p, m_pTwinDrv=%p", path, m_pIspDrvShell,
                    this->m_pIspDrvShell->m_pTwinDrv);
            ...
            /*
                ...
                */
                ...
                ISP_FUNC_DBG("ISP_RAW_PIPE::_config(setP1RrzCfg:0x%x_0x%x):Twin lsc_en=%lu E:path(%lu),rrz_in_w/h(%lu/%lu),rrz_crop_x/y/fx/fy/w/h(%d/%d/%d/%d/%lu/%lu),rrz_out_w/h(%lu/%lu), sd_lw/xn(%lu/%lu),m_num(0x%lx)",
                    this->path, this->pathD,\
                    rrz_cfg.lsc_en,\
                    rrz_cfg.pass1_path, \
                ...
                ISP_FUNC_INF("ISP_RAW_PIPE::_config(setP1RrzCfg:0x%x_0x%x):NonTwin lsc_en=%lu E:path(%lu),rrz_in_w/h(%lu/%lu),rrz_crop_x/y/fx/fy/w/h(%d/%d/%d/%d/%lu/%lu),rrz_out_w/h(%lu/%lu), sd_lw/xn(%lu/%lu),m_num(0x%lx)", \
                    this->path, this->pathD,\
                    rrz_cfg.lsc_en,\
                    rrz_cfg.pass1_path, \
                    rrz_cfg.rrz_in_size.w, \
...
int ISP_RAW_PIPE::_write2CQ(void)
{
    ...
    ISP_FUNC_DBG("+(ISP_RAW_PIPE),cq(%d/%d),drvScenario(%d),sub_mode(%d),en_p2(0x%08x)",
        this->CQ, this->CQ_D, this->drvScenario, this->sub_mode, this->en_p2);
         ...
         ISP_PASS2C == this->path)
    {
        ...
        if (this->isV3)
        {
            ...
            if (isApplyTuning == MTRUE) {
                tuningUpdateBit = 0xffffffffffffffff;
                ISP_FUNC_DBG("tuningUpdateBit(0xffffffffffffffff)");
            }
            finalEnP2 = ((~tuningEnP2Tag)&this->en_p2)|(tuningEnP2Tag&tuningEnP2);
...
#ifdef __LP64__
                ISP_FUNC_DBG("tuningUpdateBit(0x%016lx),tuningEnP2(0x%08x),tuningEnP2Dma(0x%08x)", tuningUpdateBit, tuningEnP2, tuningEnP2Dma);
#else
        ...
        if (NSImageio::NSIspio::eDrvScenario_IP == this->drvScenario) {
            for (i = 0; i < CHECK_TUNING_P1_EN_BITS; i++) {
                if (((finalEnP1 & gIspModuleMappingTableP1En[i].ctrlByte) ||
                    (tuningUpdateBit & gIspModuleMappingTableP1En[i].eTuningFunc1) ||
                    (tuningUpdateBit & gIspModuleMappingTableP1En[i].eTuningFunc2)) &&
...
MUINT32 ISP_RAW_PIPE::setEIS(void)
{
    ...
    if (this->pP1Tuning) {
        ...
        ISP_FUNC_DBG("Update EIS,w/h(%d_%d,%d_%d,%d_%d),isTwin=%d\n,submode=%d",
            ...
            input.sTGOut.w, input.sTGOut.h,
            input.sRMXOut.w, input.sRMXOut.h, this->isTwinMode, this->sub_mode);
        ISP_FUNC_DBG("+");
...
int ISP_RAW_PIPE::checkLscLsciCfg(MUINT32* pLscCfg, MUINT32* pLsciCfg)
{
    ...
    if (lsci_x != temp) {
        ISP_FUNC_ERR("[Error] LSCI_x != (LSC_x+1)<<6 -1. (%d,%d), XNUM=%d",
            lsci_x, temp, pLsc_ctl2->Bits.LSC_SDBLK_XNUM);
        return -1;
    }

    if (lsci_y != pLsc_ctl3->Bits.LSC_SDBLK_YNUM) {
        ISP_FUNC_ERR("[Error] LSCI_y != LSC_y. (%d,%d)",
            lsci_y, pLsc_ctl3->Bits.LSC_SDBLK_YNUM);
        return -1;
    }
...
int ISP_RAW_PIPE::_suspendTuneCfg(MUINT32 mNum)
{
    ...
    if (mNum & _DUMMY_MAGIC) {
        ...
        MUINT32 path = 0;
        if (ISP_PASS1 == this->path) {
            _dma_en = (CAM_CTL_EN_P1_DMA_IMGO_EN |
                       CAM_CTL_EN_P1_DMA_RRZO_EN |
                       CAM_CTL_EN_P1_DMA_LSCI_EN |
                       CAM_CTL_EN_P1_DMA_BPCI_EN);
            _cq = this->CQ;
            path = this->path;
        }
        else if (ISP_PASS1_D == this->pathD) {
            _dma_en = (CAM_CTL_EN_P1_DMA_D_IMGO_D_EN |
                       CAM_CTL_EN_P1_DMA_D_RRZO_D_EN |
                       CAM_CTL_EN_P1_DMA_D_LSCI_D_EN |
                       CAM_CTL_EN_P1_DMA_D_BPCI_D_EN);
            _cq = this->CQ_D;
            path = this->pathD;
        }
        else{
...
#ifdef __LP64__
    ISP_FUNC_DBG("P1Dbg_RPG: senDev=%d, mNum=0x%x, UpdateBit=0x%lx, EnP1=0x%x, EnP1Dma=0x%x, pBuf=%p", senDev, mNum, cfg.tuningUpdateBit, cfg.tuningEnP1,cfg.tuningEnP1Dma, cfg.pTuningBuf);
#else
...
int ISP_RGB_PIPE::_config( void )
{
    ...
    IspImageioPackage imageioPackage;
    //
    ISP_FUNC_DBG("+(ISP_RGB_PIPE),cq(%d),drvScenario(%d),sub_mode(%d),en_p2(0x%08x),enFgMode(%d)",
        this->CQ, this->drvScenario, this->sub_mode, this->en_p2, this->enFgMode);
    //
    if (this->isV3)
    {
        getP2EnTuningTag(MTRUE, (ISP_DRV_CQ_ENUM)this->CQ, this->magicNum, this->drvScenario, this->sub_mode, tuningEnP2Tag, tuningEnP2DmaTag); // get P2 tuning En & Dma Tag
...
#else
            ISP_FUNC_DBG("tuningUpdateBit(0x%016llx),pTuningBuf(%p),hrz_crop(%d,%d)",
#endif
        ...
        imageioPackage.finalEnP2 = finalEnP2;
#ifdef __LP64__
        ISP_FUNC_DBG("(ISP_RGB_PIPE),isApplyTuning(0x%x),finalEnP2(0x%x),tuningUpdateBit(0x%lx)", this->isApplyTuning, finalEnP2, tuningUpdateBit);
#else
        ISP_FUNC_DBG("(ISP_RGB_PIPE),isApplyTuning(0x%x),finalEnP2(0x%x),tuningUpdateBit(0x%llx)", this->isApplyTuning, finalEnP2, tuningUpdateBit);
#endif
    }
    else
    {
    ...
    if (this->en_p2 & CAM_CTL_EN_P2_MFB_EN)
    {
        ...
        ISP_FUNC_DBG("[TEST] imagioPak->mfb_cfg.bld_mode(%d),x(%lu),y(%lu),xofst(%d)",
            imageioPackage.mfbCfg.bld_mode,
            imageioPackage.mfbCfg.mfb_out.w,
    ...
    for (i = 0; i < CHECK_TUNING_P2_EN_BITS; i++) {
        if (((finalEnP2 & gIspModuleMappingTableP2En[i].ctrlByte) ||
            ...
            if (tuningUpdateBit & gIspModuleMappingTableP2En[i].eTuningFunc2)
                ...
                tuningPackage.eTuningCqFunc2 = CAM_DUMMY_;
            //
            if (((tuningPackage.eTuningCqFunc1 != CAM_DUMMY_) ||
                (tuningPackage.eTuningCqFunc2 != CAM_DUMMY_)) &&
                (gIspModuleMappingTableP2En[i].eTuningCqDma != CAM_DUMMY_))
                tuningPackage.eTuningCqDma = gIspModuleMappingTableP2En[i].eTuningCqDma;
            else
...
int ISP_RGB_PIPE::_write2CQ(void)
{
    ...
    ISP_FUNC_DBG("+(ISP_RGB_PIPE),cq(%d),drvScenario(%d),sub_mode(%d),en_p2(0x%08x)",
        this->CQ, this->drvScenario, this->sub_mode, this->en_p2);
    //
    if (this->isV3)
    {
        ISP_FUNC_DBG("ISP_RGB_PIPE::_write2CQ");
...
int ISP_YUV_PIPE::_config( void )
{
    ...
    IspImageioPackage imageioPackage;
    //
    ISP_FUNC_DBG("+(ISP_YUV_PIPE),cq(%d),scenario(%d),sub_mode(%d),en_p2(0x%08x)",
        this->CQ, this->drvScenario, this->sub_mode, this->en_p2);
...
#ifdef __LP64__
            ISP_FUNC_DBG("tuningUpdateBit(0x%016lx),tuningEnP2(0x%08x),tuningEnP2Dma(0x%08x),pTuningBuf(%p),nr3dGainWeighting(0x%x)", tuningUpdateBit, tuningEnP2, tuningEnP2Dma, tuningPackage.pTuningBuf, tuningPackage.nr3dGainWeighting);
#else
            ISP_FUNC_DBG("tuningUpdateBit(0x%016llx),tuningEnP2(0x%08x),tuningEnP2Dma(0x%08x),pTuningBuf(%p),nr3dGainWeighting(0x%x)", tuningUpdateBit, tuningEnP2, tuningEnP2Dma, tuningPackage.pTuningBuf, tuningPackage.nr3dGainWeighting);
#endif
        }
        finalEnP2 = ((~tuningEnP2Tag)&this->en_p2) | (tuningEnP2Tag&tuningEnP2);
        imageioPackage.finalEnP2 = finalEnP2;
#ifdef __LP64__
        ISP_FUNC_DBG("(ISP_YUV_PIPE),isApplyTuning(0x%x),finalEnP2(0x%x),tuningUpdateBit(0x%lx)", this->isApplyTuning, finalEnP2, tuningUpdateBit);
#else
        ISP_FUNC_DBG("(ISP_YUV_PIPE),isApplyTuning(0x%x),finalEnP2(0x%x),tuningUpdateBit(0x%llx)", this->isApplyTuning, finalEnP2, tuningUpdateBit);
#endif
    }
    else
    {
    ...
    if (imageioPackage.isApplyTuning == MTRUE) {
        ...
        for (i = 0; i < ISP_RWB_MATRIX_CELL_NUM; i++)
        {
            ...
            ISP_FUNC_DBG("gpMdpMgrCfgData[%d][%d][%d].rwbMatrix[%d] = %x",
                this->burstQueIdx, p2Cq, this->dupCqIdx, i,
                gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].rwbMatrix[i]);
        ...
        ISP_FUNC_DBG("gpMdpMgrCfgData[%d][%d][%d].isoValue = %x",
            this->burstQueIdx, p2Cq, this->dupCqIdx,
            gpMdpMgrCfgData[this->burstQueIdx][p2Cq][this->dupCqIdx].isoValue);
        // add for ISO adaptive -----
    }
    ISP_FUNC_DBG("-(ISP_YUV_PIPE),p2TuningEnTag(0x%08x),p2EnConfig(0x%08x)",
        tuningEnP2Tag, finalEnP2);
    return 0;
...
int ISP_YUV_PIPE::_write2CQ(void)
{
    ...
    ISP_FUNC_DBG("+(ISP_YUV_PIPE),cq(%d),drvScenario(%d),sub_mode(%d),en_p2(0x%08x)",
        this->CQ, this->drvScenario, this->sub_mode, this->en_p2);
    //
    if (this->isV3)
    {
...
int ISP_MDP_PIPE::_config( void )
{
    ...
    //
    this->m_pIspDrvShell->m_pPhyIspDrv_bak->mapCqToP2Cq((ISP_DRV_CQ_ENUM)this->CQ, p2Cq);
    ISP_FUNC_DBG("+,CQ(%d),p2Cq(%d),burstQueIdx(%d),dupCqIdx(%d),drvScenario(%d),p2Dma(0x%x),isWaitBuf(%d),imgxoEnP2(0x%x)",
        this->CQ, p2Cq, this->burstQueIdx, this->dupCqIdx, this->drvScenario,
        this->p2_dma_enable, this->isWaitBuf, this->mdp_imgxo_p2_en);
...
//        this->src_crop.h);
    ...
    if (enPureMdpOut == MFALSE) {
        ...
        ISP_FUNC_DBG("imgxo va(0x%" PRIxPTR "),pa(0x%" PRIxPTR "),size(%d)",
            this->imgxo_out.memBuf.base_vAddr, this->imgxo_out.memBuf.base_pAddr,
            this->imgxo_out.memBuf.size);
...
//            }
        ...
        */
            ...
            if (p2TuningFieldEnTag & CAM_CTL_EN_P2_MFB_EN ) {
                ...
                ISP_FUNC_DBG("[MFB Tdr] bld_deblock_en/bld_brz_en TDR(0x%x/0x%x), TUN(0x%x/0x%x)",
                    pDst->mfb.bld_deblock_en, pDst->mfb.bld_brz_en,
                    tuningField.mfb.bld_deblock_en, tuningField.mfb.bld_brz_en);
            }
            ...
            if (p2TuningFieldEnTag & CAM_CTL_EN_P2_LCE_EN ) {
                ...
                if ((pDst->lce.lce_slm_width - 1 > 0) && (pDst->lce.lce_slm_height - 1 > 0)) {
                    ...
                    ISP_FUNC_ERR("[Error]size error lce_slm_width(%d),lce_slm_height(%d)",
                        pDst->lce.lce_slm_width,pDst->lce.lce_slm_height);
                }

                ISP_FUNC_DBG("lce_slm_width(%d),lce_slm_height(%d),lce_bc_mag_kubnx(%d),lce_bc_mag_kubny(%d)",
                    pDst->lce.lce_slm_width, pDst->lce.lce_slm_height,
                    pDst->lce.lce_bc_mag_kubnx, pDst->lce.lce_bc_mag_kubny);
            }
    ...
    ISP_FUNC_DBG("VirCqPa(0x%x),dupCqIdx(%d)",
        pDst->drvinfo.DesCqPa, pDst->drvinfo.dupCqIdx);
...
int CAM_TDRI_PIPE::_config( void )
{
    ...
    // MUINT32 p2Cq;
    //
    ISP_FUNC_DBG("+,enTdri(%d),tcm_en(0x%08x),tdr_en(0x%08x),cq(%d),dupCqIdx(%d),burstQueIdx(%d)",
        this->enTdri, this->tcm_en, this->tdr_en, this->CQ, this->dupCqIdx, this->burstQueIdx);
    //
    ...
    ISP_FUNC_DBG("-,enTdri(%d),tcm_en(0x%08x),tdr_en(0x%08x),tdr_dbg_tcm_en(0x%08x),cq(%d),dupCqIdx(%d),burstQueIdx(%d)",
        this->enTdri, this->tcm_en, this->tdr_en, this->tdr_dbg_tcm_en, this->CQ, this->dupCqIdx, this->burstQueIdx);
    // for control extension -----
...
int ISP_PASS1_CTRL::keepP1RrzCfg( IspRrzCfg const rrz_cfg )
{
    if ( ISP_PASS1 == rrz_cfg.pass1_path ) {
        ...
        ISP_FUNC_ERR("rrz keeper path err 0x%lx", rrz_cfg.pass1_path);
        return -1;
    }
    return 0;
}
...
int ISP_PASS1_CTRL::setP1RrzCfg( IspRrzCfg const rrz_cfg )
{
    ...
    ISP_FUNC_DBG("ISP_PASS1_CTRL::setP1RrzCfg E:path(%lu),rrz_in_w/h(%lu/%lu),rrz_crop_x/y/fx/fy/w/h(%d/%d/%d/%d/%lu/%lu),rrz_out_w/h(%lu/%lu), sd_lw/xn(%lu/%lu),m_num(0x%lx)",
        rrz_cfg.pass1_path, \
        rrz_cfg.rrz_in_size.w, \
        rrz_cfg.rrz_in_size.h, \
        rrz_cfg.rrz_in_roi.x, \
    ...
    if ( rrz_cfg.isTwinMode) {
        if ((rrz_cfg.rrz_in_roi.x*2 + rrz_cfg.rrz_in_roi.w) > rrz_cfg.rrz_in_size.w) {
            ISP_FUNC_DBG("rrz input crop out of range: (x,y,floatx,floatxy,w,h = %d, %d, %d, %d, %lu, %lu),(size: %lu, %lu)",
                rrz_cfg.rrz_in_roi.x, rrz_cfg.rrz_in_roi.y,
                rrz_cfg.rrz_in_roi.floatX, rrz_cfg.rrz_in_roi.floatY,
                rrz_cfg.rrz_in_roi.w, rrz_cfg.rrz_in_roi.h,
                rrz_cfg.rrz_in_size.w, rrz_cfg.rrz_in_size.h);
        }
        else if ((rrz_cfg.rrz_in_roi.x * 2 + rrz_cfg.rrz_in_roi.w) < rrz_cfg.rrz_in_size.w) {
            ISP_FUNC_DBG("rrz view-angle issue: (x,y,floatx,floatxy,w,h = 0x%x,0x%x,0x%x,0x%x,0x%lx,0x%lx),(size:0x%lx,0x%lx)",
                rrz_cfg.rrz_in_roi.x, rrz_cfg.rrz_in_roi.y,
                rrz_cfg.rrz_in_roi.floatX, rrz_cfg.rrz_in_roi.floatY,
                rrz_cfg.rrz_in_roi.w, rrz_cfg.rrz_in_roi.h,
                rrz_cfg.rrz_in_size.w, rrz_cfg.rrz_in_size.h);
...
waitBufReady( MUINT32 dmaChannel )
{
    ...
    if ( _imgo_ == rt_dma || _imgo_d_ == rt_dma || _rrzo_ == rt_dma || _rrzo_d_ == rt_dma || _camsv_imgo_ == rt_dma || _camsv2_imgo_ == rt_dma) {
        ...
        ISP_FUNC_DBG("waitBufReady[%d]:[%x,%x] rtBufCtrl.ctrl(%d)/id(%d)/ptr(%p)",
            rt_dma, this->path, this->path_D, buf_ctrl.ctrl, buf_ctrl.buf_id, buf_ctrl.data_ptr);
        ...
        //if (bWaitBufRdy) {
            ...
            irq_TG_DONE.UserName = (char*)"pass1";
            ...
            if (( _imgo_d_ == rt_dma ) || (_rrzo_d_ == rt_dma)) {
                ...
                irq_TG_DONE.UserName = (char*)"pass1_d";
            }
                ...
                irq_TG_DONE.UserNumber = (int)ISP_DRV_IRQ_USER_ISPDRV;
                irq_TG_DONE.UserName = (char*)"camsv";
            }
                ...
                irq_TG_DONE.UserNumber = (int)ISP_DRV_IRQ_USER_ISPDRV;
                irq_TG_DONE.UserName = (char*)"camsv_d";
            }
            //
            ...
            if (ret != MTRUE)
            {
                ...
                irq_TG_SOF.UserName = (char*)"pass1";
...
enqueueHwBuf( MUINT32 dmaChannel, stISP_BUF_INFO bufInfo, MINT32 enqueCq, MINT32 dupCqIdx, MBOOL bImdMode)
{
    ...
    if ( ISP_PASS1   == this->path ||
        ...
        if ( NULL != bufInfo.next ) {
            ISP_QUE_INF(rt_dma, "dma(%d),id(%d),size(0x%x),VA(0x%" PRIxPTR "),PA(0x%" PRIxPTR "),S/C(%d/%d),bufidx(%d),replace:new(0x%" PRIxPTR "),bufidx(%d),bImdMode(%d)",
                        rt_dma,
                        buf_info.memID,
                        buf_info.size,
                        buf_info.virtAddr,
            ...
            ISP_QUE_INF(rt_dma, "dma(%d),id(%d),size(0x%x),VA(0x%" PRIxPTR "),PA(0x%" PRIxPTR "),S/C(%d/%d),bufidx(%d),bImdMode(%d)",
                        rt_dma,
                        buf_info.memID,
                        buf_info.size,
                        buf_info.virtAddr,
        ...
        //
        ISP_FUNC_DBG("enqueCq(%d),p2Cq(%d),dupCqIdx(%d),dma(%d),memID(0x%x),size(%lu),vAddr(0x%" PRIxPTR "),pAddr(0x%" PRIxPTR ")",
...
ISP_BUF_CTRL::returnDeqBufInfo( MINT32 rt_dma, stISP_BUF_INFO* bufInfo)
{
    ...
    if ( NULL == bufInfo->next ) {
        ...
        if (i < ISP_BUF_INFO_NODE_MAX_CNT) {
            ...
            ISP_QUE_DBG(rt_dma,"[MyDeQ]returnDeqBufInfo:: node=0x%" PRIxPTR,
                plist->mN[i].mInfo.base_pAddr);
        ...
        else
        {
            if (bVF_en) {
                ...
                ISP_FUNC_ERR("dma:0x%x: find no match baseaddr, 0x%" PRIxPTR "\n",
                    rt_dma, bufInfo->base_pAddr);

                ISP_FUNC_ERR("current available base addr\n");
                for (i = 0; i < ISP_BUF_INFO_NODE_MAX_CNT; i++) {
                    if (plist->mN[i].mOccupied) {
                        ISP_FUNC_ERR("0x%" PRIxPTR, plist->mN[i].mInfo.base_pAddr);
                    }
                }
            }
        }
        ...
        if (i < ISP_BUF_INFO_NODE_MAX_CNT) {
            ...
            else
            {
                if (bVF_en) {
                    ...
                    ISP_QUE_DBG(rt_dma,"dma:0x%x: find no match baseaddr, 0x%" PRIxPTR "\n",
                        rt_dma, bufInfo->next->base_vAddr);

                    ISP_QUE_DBG(rt_dma,"current available base addr\n");
                    for (i = 0; i < ISP_BUF_INFO_NODE_MAX_CNT; i++) {
                        if (plist->mN[i].mOccupied) {
                            ISP_QUE_DBG(rt_dma,"0x%" PRIxPTR,
                                plist->mN[i].mInfo.base_pAddr);
                        }
                    }
                }
            ...
            ISP_QUE_DBG(rt_dma,"dma:0x%x:find no match baseaddr,caused this is exchange buf, 0x%" PRIxPTR "\n",
...
saveDeqBufInfo( MINT32 rt_dma )
{
    ...
    for (i = 0; i < ISP_BUF_INFO_NODE_MAX_CNT; i++) {
        ...
        if (!plist->mN[i].mOccupied) {
            ...
            ISP_QUE_DBG(rt_dma,"saveDeqBufInfo[A] plist=%p,[%d]PA=0x%" PRIxPTR ", mIdx=%d",
                plist, i, ptr->base_pAddr, plist->mIdx);
    ...
    if (1) {
        for (i = 0; i < ISP_BUF_INFO_NODE_MAX_CNT; i+=8) {
            ...
            ISP_FUNC_ERR("saveDeqBufInfo[C] Fail. dma=%d,plist=%p, mOccupied:[%d[0x%" PRIxPTR "]/%d[0x%" PRIxPTR "]/%d[0x%" PRIxPTR "]/%d[0x%" PRIxPTR "]/%d[0x%" PRIxPTR "]/%d[0x%" PRIxPTR "]/%d[0x%" PRIxPTR "]/%d[0x%" PRIxPTR "]]",
                        rt_dma, plist,
                        plist->mN[i+0].mOccupied, plist->mN[i+0].mInfo.base_pAddr,
                        plist->mN[i+1].mOccupied, plist->mN[i+1].mInfo.base_pAddr,
                        plist->mN[i+2].mOccupied, plist->mN[i+2].mInfo.base_pAddr,
                        plist->mN[i+3].mOccupied, plist->mN[i+3].mInfo.base_pAddr,
                        plist->mN[i+4].mOccupied, plist->mN[i+4].mInfo.base_pAddr,
                        plist->mN[i+5].mOccupied, plist->mN[i+5].mInfo.base_pAddr,
                        plist->mN[i+6].mOccupied, plist->mN[i+6].mInfo.base_pAddr,
                        plist->mN[i+7].mOccupied, plist->mN[i+7].mInfo.base_pAddr);
        }
    }
    ...
    if (ptr != NULL)
    {
        ISP_QUE_DBG(rt_dma,"[MyDeQ]saveDeqBufInfo: node=0x%" PRIxPTR, ptr->base_pAddr);
    }
    return ptr;
}
//
    ...
    if ( ISP_PASS1   == this->path || \
        ...
        if ( _imgo_ == rt_dma || \
            ...
            for (MUINT32 i = 0; i < count; i++) {
                ...
                if ((bufInfo->timeStampS == 0) && (bufInfo->timeStampUs == 0) ) {
                    ...
                    ISP_FUNC_ERR("\n CQ0:\n");
                    for (int i = 0; i < 3; i++) {
                        this->m_pIspDrvShell->m_pPhyIspDrv_bak->dumpCQTable(
                            (ISP_DRV_CQ_ENUM)ISP_DRV_CQ0,
                                                       0,
                                                       i,
                            (ISP_DRV_CQ_CMD_DESC_STRUCT*)this->m_pPhyIspDrv->getCQDescBufVirAddr(ISP_DRV_CQ0, 0, i),
                            this->m_pPhyIspDrv->getCQVirBufVirAddr(ISP_DRV_CQ0, 0, i));
                    }
                    ISP_FUNC_ERR("\n CQ0_D:\n");
                    for (int i = 0; i < 3; i++) {
                        this->m_pIspDrvShell->m_pPhyIspDrv_bak->dumpCQTable(
                            (ISP_DRV_CQ_ENUM)ISP_DRV_CQ0_D,
                                                         0,
                                                         i,
                            (ISP_DRV_CQ_CMD_DESC_STRUCT*)this->m_pPhyIspDrv->getCQDescBufVirAddr(ISP_DRV_CQ0_D, 0, i),
        ...
        while(count--) {
            ...
            if (bufSize) {
                ...
                if (_jpeg_ == rt_dma)
                {
                    m_p2HwBufL[p2Cq][this->dequeDupCqIdx][rt_dma].bufInfoList.front().jpg_size =
                        g_pMdpMgr->getJPEGSize(gpMdpMgrCfgData[this->dequeBurstQueIdx][p2Cq][this->dequeDupCqIdx]);
                    ISP_QUE_INF(rt_dma, "jpeg real size(0x%x)",
                        m_p2HwBufL[p2Cq][this->dequeDupCqIdx][rt_dma].bufInfoList.front().jpg_size);
                }
                //
                //add to bufList
                ...
                //
                ISP_FUNC_DBG("dma(%d),hwsize(%zu),p2Cq(%d),dequeDupCqIdx(%d),imgxoEnP2(0x%x),memID(0x%x),size(%zu),vaddr(0x%" PRIxPTR "),paddr(0x%" PRIxPTR ")",
                        rt_dma, m_p2HwBufL[p2Cq][this->dequeDupCqIdx][rt_dma].bufInfoList.size(), p2Cq, this->dequeDupCqIdx,
                        gpMdpMgrCfgData[this->dequeBurstQueIdx][p2Cq][this->dequeDupCqIdx].imgxoEnP2,
                        bufList.pBufList->back().memID, bufList.pBufList->size(),
                        bufList.pBufList->back().base_vAddr, bufList.pBufList->back().base_pAddr);
...
getCurrHwBuf( MUINT32 dmaChannel )
{
    ...
    if ( ISP_PASS1   == this->path || \
        ...
        //
        ISP_FUNC_DBG("dma:(%d)/memID(0x%x)/vAddr:(0x%" PRIxPTR ")/pAddr:(0x%" PRIxPTR ")",
                        rt_dma,
...
debugPrint( MUINT32 dmaChannel )
{
    ...
    for ( it = m_hwbufL[rt_dma].bufInfoList.begin(); it != m_hwbufL[rt_dma].bufInfoList.end(); it++ ) {
        ISP_FUNC_DBG("m_hwbufL[%d].base_vAddr:[0x%" PRIxPTR "]/base_pAddr:[0x%" PRIxPTR "]", rt_dma, it->base_vAddr, it->base_pAddr);
    }
    ISP_FUNC_DBG("X");
...
#ifdef __LP64__
    pthread_attr_t const attr = {0, NULL, 1024 * 1024, 4096, SCHED_RR, PRIO_RT_ISP_EVENT_THREAD, {0}};
#else
...
MVOID* IspEventThreadImp::ispEventThread(void *arg)
{
    ...
    irq_SOF.UserName = (char*)"isp_eventT";
    //ISP_FUNC_DBG("[ispEventthread] Wait m_semIspEventthread");
