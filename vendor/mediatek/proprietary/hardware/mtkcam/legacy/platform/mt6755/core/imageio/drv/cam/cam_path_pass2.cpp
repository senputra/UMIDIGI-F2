...
//    cdpPipe.conf_cdrz = 0;
    //
    ISP_PATH_DBG("[mdpcrop] imgi in[%lu, %lu] mdpCrop[%d, %d, %lu, %lu]_f(0x%x, 0x%x)", p_parameter->imgi.size.w, p_parameter->imgi.size.h, \
    ...
    ISP_PATH_DBG("[CRZ][CROP](x,y,w,h)=(%d,%d,%lu,%lu),floatx,y=(%u,%u)", crzPipe.crz_crop.x, crzPipe.crz_crop.y, crzPipe.crz_crop.w, crzPipe.crz_crop.h, crzPipe.crz_crop.floatX, crzPipe.crz_crop.floatY);
    ...
    ISP_PATH_DBG("CDRZ:in[%lu, %lu] crop[%d %d %lu %lu]_f(0x%x, 0x%x) out[%lu,%lu]", crzPipe.crz_in.w,crzPipe.crz_in.h, \
    ...
    ISP_PATH_DBG("[imgi](%lu , %lu , %lu) vidoRotate(%d),pa(0x%" PRIxPTR ")",
        p_parameter->imgi.size.w, p_parameter->imgi.size.h, p_parameter->imgi.size.stride,
        crzPipe.vido_out.Rotation, p_parameter->imgi.memBuf.base_pAddr);
    ...
    ISP_PATH_DBG("[LCEI]bypass(%d),size(0x%x),Va(0x%" PRIxPTR "),Pa(0x%" PRIxPTR "),(w,h,s)=(%lu,%lu,%lu),crop(x,y,w,h)=(%d,%d,%lu,%lu)",
    ...
    if ( CAM_CTL_EN_P2_DMA_IMG3O_EN & ispTopCtrl.isp_top_ctl.CAM_CTL_EN_P2_DMA.Raw)
    {
        ...
        ISP_PATH_DBG("[IMG3O]bypass(%d),size(0x%x),Va(0x%" PRIxPTR "),Pa(0x%" PRIxPTR "),(w,h,s)=(%lu,%lu,%lu),crop(x,y,w,h)=(%d,%d,%lu,%lu)",
    ...
    if ( CAM_CTL_EN_P2_DMA_IMG2O_EN & ispTopCtrl.isp_top_ctl.CAM_CTL_EN_P2_DMA.Raw){
        ...
        ISP_PATH_DBG("[IMG2O]bypass(%d),size(0x%x),Va(0x%" PRIxPTR "),Pa(0x%" PRIxPTR "),(w,h,s)=(%lu,%lu,%lu),crop(x,y,w,h)=(%d,%d,%lu,%lu)",
