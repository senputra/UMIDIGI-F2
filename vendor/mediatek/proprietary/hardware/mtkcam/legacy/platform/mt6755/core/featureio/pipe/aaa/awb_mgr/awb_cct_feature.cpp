...
MRESULT AwbMgr::CCTOPAWBGetAWBParam(AWB_PARAM_T* out)
{
    switch (m_eSensorDev)
    {
    case ESensorDev_Main: //  Main Sensor
        *out = getAWBParam<ESensorDev_Main>();
        break;
    case ESensorDev_MainSecond: //  Main Second Sensor
        *out = getAWBParam<ESensorDev_MainSecond>();
        break;
    case ESensorDev_Sub: //  Sub Sensor
        *out = getAWBParam<ESensorDev_Sub>();
        break;
    default:
        MY_ERR("AwbMgr::CCTOPAWBGetAWBParam m_eSensorDev = %d", m_eSensorDev);
