...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    /**
      * @brief notify start video record for EIS 2.5 support.
      */
    virtual void                    startEISRecord();

    virtual void                    stopEISRecord();

    virtual void                    notifyEISRecordStopping();
...
#ifdef USING_MTK_CPUCTRL
    MBOOL            misCpuCtrl;
    MUINT32          misCpuCtrl_count;
    CpuCtrl*         mpCpuCtrl;
#endif
    // for callback thread
    sp<VFBCBThread>   mpVFBCBThread;
