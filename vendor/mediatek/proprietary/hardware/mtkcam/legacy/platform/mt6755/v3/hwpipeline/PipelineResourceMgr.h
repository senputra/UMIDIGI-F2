...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  IPipelineResourceMgr Interfaces.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     //                       Operations
...
//  Operations.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    MERROR                              createNodeLocked(
                                            NodeId_T nodeid,
                                            InitParams const& rParams
                                        );

    MERROR                              createStreamLocked(
                                            android::sp<IImageStreamInfo>&        pStreamInfo
                                        );
    ...
    MERROR                              updateConfigParams_P1_main2(
                                            NodeId_T nodeid,
                                            P1Node::ConfigParams* params
                                        );
    ...
    MERROR                              checkConfigParams_P1_main2(
                                            NodeId_T nodeid,
                                            P1Node::ConfigParams* params
                                        );
...
protected:  //                       Data Members
    ...
    NodeList                            mvAvailableNodes;
    StreamList                          mvAvailableStreams;
    ...
    // Stereo
    android::sp<P1Node>                 mpNode_P1_main2;
    ...
    // Stereo
    P1Node::ConfigParams                mConfigParams_P1_main2;
    JpegNode::ConfigParams              mConfigParams_Jpeg;

    android::DefaultKeyedVector< NodeId_T, IPipelineModel* >
                                        mvNodeOwnership;
};
