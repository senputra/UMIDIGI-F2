...
*
********************************************************************************/
MVOID EisHalImp_R::GetSensorData()
{
...
MINT32 EisHalImp_R::Init()
{
    ...
    if (mpSensorProvider->enableSensor(SENSOR_TYPE_GYRO, 33) == true &&
        mpSensorProvider->enableSensor(SENSOR_TYPE_ACCELERATION, 33) == true)
    {
        mAccEnable = MTRUE;
        mGyroEnable = MTRUE;
    }
