...
class FeaturePipeBufHandlerImpl : public FeaturePipeBufHandler
{
    public:
        ...
        virtual MBOOL   requestBuffer_GB(MUINT32 const data, AllocInfo const & info, sp<NativeBufferWrapper>* pGraphicBuffer);
        virtual MBOOL   getGraphicBuffer(MUINT32 const data, IImageBuffer const * pImageBuffer, Warp_SPTR* pGraphicBuffer);
...
MBOOL
FeaturePipeBufHandlerImpl::
requestBuffer_GB(MUINT32 const data, AllocInfo const & info, sp<NativeBufferWrapper>* pGraphicBuffer)
{
    MBOOL ret = MFALSE;
...
MBOOL
FeaturePipeBufHandlerImpl::
getGraphicBuffer(MUINT32 const data, IImageBuffer const * pImageBuffer, Warp_SPTR* pGraphicBuffer)
{
    // try to find data
    FeaturePipeDataHandler* pData;
    if( !findData(data, &pData) )
