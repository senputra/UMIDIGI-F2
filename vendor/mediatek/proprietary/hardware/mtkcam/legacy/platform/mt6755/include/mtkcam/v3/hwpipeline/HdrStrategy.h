...
#ifndef _MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWPIPELINE_HDRSTRATEGY_H_
#define _MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWPIPELINE_HDRSTRATEGY_H_
//
...
struct  evaluate_request
{
    ...
    IPipelineBufferSetFrameControl::IAppCallback*
                                pAppCallback;
	//IPipelineBufferSetFrameControl::IPipelineCallback*
	//							pHdrCallback;
    ...
    android::Vector<
        android::sp<IPipelineFrame>
                        >*      vFrame;
    /**
     * @param[in, out] The sub-frame count of main hdr frame.
     *  By default, this field is 1. The callee is responsible for
     *  filling it by query HDR effect hal?
     */
    MUINT32                     subFrameCnt;

    /**
     * @param[out] The sub-frame number of main hdr frame.
     *  The callee is responsible for duplicating main frame to
     *  sub frame w/ different sensor setting when evaluating.
     */
    MUINT32                     subFrameNo;
 ...
 *
 */
struct  RequestAppStreamsBuffer
{
...
struct  evaluate_request_pipeline
{
    ...
    android::Vector<NodeId_T>   vNodeWhite;
...
struct create_capture_parame_to_halmeta_control
{
    /**
     * @param[in] Request Hal meta stream info set.
     *  The caller must ensure its content.
...
public:     ////                Operations.
    ...
    /**
     * Create Hdr capture params for meta stream buffers.
     *
     * @param[in,out] rParams: input/output parameters.
     *
     * @return
...
#endif  //_MTK_HARDWARE_INCLUDE_MTKCAM_V3_PIPELINE_DEFAULTSTRATEGY_H_
