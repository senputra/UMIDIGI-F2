...
config(MINT32 i4SensorIndex, AE_STAT_PARAM_T& rAEStatConfig)
{
    ...
    if (m_eSensorTG == ESensorTG_1) {
        ...
        // CAM_AE_D_RC_CNV_0
        reinterpret_cast<ISP_CAM_AE_D_MATRIX_COEF0_T*>(REG_INFO_VALUE_PTR(CAM_AE_D_RC_CNV_0))->RC_CNV00 = 0x000;
        reinterpret_cast<ISP_CAM_AE_D_MATRIX_COEF0_T*>(REG_INFO_VALUE_PTR(CAM_AE_D_RC_CNV_0))->RC_CNV01 = 0x200;
        // CAM_AE_D_RC_CNV_1
        ...
        reinterpret_cast<ISP_CAM_AE_D_MATRIX_COEF3_T*>(REG_INFO_VALUE_PTR(CAM_AE_D_RC_CNV_3))->RC_CNV21 = 0x200;
        // CAM_AE_D_RC_CNV_4
        reinterpret_cast<ISP_CAM_AE_D_MATRIX_COEF4_T*>(REG_INFO_VALUE_PTR(CAM_AE_D_RC_CNV_4))->RC_CNV22 = 0x000;
