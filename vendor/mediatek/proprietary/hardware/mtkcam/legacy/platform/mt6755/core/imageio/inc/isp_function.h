...
class ISP_RAW_CENTRAL_CTRL_INFO : public IspFunction_B
{
    ...
    public:
        ...
        int      getRawPathCQ(void)             { return mTopCtrl.CQ; }
        int      getRawDPathCQ(void)           { return mTopCtrl.CQ_D; }
...
class CAM_CRZ_PIPE:public IspFunction_B
{
    ...
    public:
        CAM_CRZ_PIPE():tpipeMode(CRZ_DRV_MODE_TPIPE),conf_cdrz(0),conf_rotDMA(0),CQ(CAM_ISP_CQ_NONE),dupCqIdx(0),burstQueIdx(0),isV3(MFALSE),isApplyTuning(MFALSE){};
    public:
...
class CAM_TDRI_PIPE:public IspFunction_B
{
    ...
    public:
        CAM_TDRI_PIPE():dupCqIdx(0),burstQueIdx(0),enTdri(0),CQ(CAM_ISP_CQ_NONE),tcm_en(0),tdr_en(0),tdr_dbg_tcm_en(0),magicNum(0),drvScenario(0),sub_mode(0),lceInputW(0),lceInputH(0),isV3(MFALSE),isApplyTuning(MFALSE){};
