...
#ifndef _MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_P2ANODE_H_
#define _MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_P2ANODE_H_
//
...
public:     ////                    Definitions.
    ...
    struct  ConfigParams
    {
        ...
        /**
         * A pointer to a set of input hal meta stream info of p1Node output.
         */
		...
		/**
         * A pointer to 3DNR image stream info.
         */
		android::sp<IImageStreamInfo> pOutNR3DImage;
...
public:     ////                    Operations.
    ...
    static android::sp<P2aNode>      createInstance(ePass2Type type);
...
public:     ////                    Attributes.
    ...
    virtual MERROR                  freeAllStreams() = 0;
};
...
#endif  //_MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_P2ANODE_H_
