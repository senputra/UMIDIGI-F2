...
)
{
    ...
    property_get("vendor.camera.hwsync.enable", value, "1");
    // int hwsyncEnable=atoi(value);

    // get property for ef test
    char value2[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.camera.ef.test", value2, "0");
    ...
    MUINTPTR arg3)
{
   ...
   case SENSOR_CMD_GET_SENSOR_PDAF_INFO:
        ...
        pSensorDrv->sendCommand((SENSOR_DEV_ENUM)sensorDevId,cmdId, arg1, arg2);
        MY_LOGD("  SENSOR_CMD_GET_SENSOR_PDAF_INFO: scenario = 0x%lx 0x%lx\n", (unsigned long)arg1, (unsigned long)arg2);
        if(ret < 0) {
...
MVOID HalSensor::pixelModeArrange(MUINT currSensorDev)
{
    ...
    //get property for ef test
    char value[PROPERTY_VALUE_MAX] = {'\0'};
    property_get("vendor.camera.ef.test", value, "0");
    ...
    if (1 == enable) {
        ...
        switch(meSensorDev) {
                ...
                if (sensorPara[0].inSrcTypeSel >= VIRTUAL_CHANNEL_1) {
                    if(sensorPara[0].mipiPad == 0) {
                        if (sensorPara[0].inSrcTypeSel == VIRTUAL_CHANNEL_1) {
                            ...
                            ret = pSeninfDrv->setSV1Cfg((TG_FORMAT_ENUM)sensorPara[0].inDataType, (SENSOR_DATA_BITS_ENUM)sensorPara[0].senInLsb, TWO_PIXEL_MODE);
                            ...
                            sensorPara[0].u1VsyncPol,sensorPara[0].u1MIPILaneNum,1,sensorPara[0].u1MIPIPacketECCOrder,0,1/*HSRXDE*/,sensorPara[0].DPCM_TYPE);
                            ...
                            ret = pSeninfDrv->setSV2Cfg((TG_FORMAT_ENUM)sensorPara[0].inDataType, (SENSOR_DATA_BITS_ENUM)sensorPara[0].senInLsb, TWO_PIXEL_MODE);
                        ...
                        if (sensorPara[0].inSrcTypeSel == VIRTUAL_CHANNEL_1) {
                            ...
                            ret = pSeninfDrv->setSeninfTopMuxCtrl(SENINF_TOP_TG1,SENINF_2);
                            ret = pSeninfDrv->setSeninfTopMuxCtrl(SENINF_TOP_SV2,SENINF_2);
                            sensorDynamicInfo[0].TgVR1Info = CAM_TG_NONE;
                            sensorDynamicInfo[0].TgVR2Info = CAM_SV_2;
                    ...
                    if(sensorPara[0].mipiPad == 0) {
                        if(sensorPara[0].MIPI_OPHY_TYPE == 1) // CSI2
                        {
                            ...
                            ret = pSeninfDrv->setSeninf1NCSI2(sensorPara[0].u1MIPIDataTermDelay,sensorPara[0].u1MIPIDataSettleDelay,sensorPara[0].u1MIPIClkTermDelay,
                                sensorPara[0].u1VsyncPol,sensorPara[0].u1MIPILaneNum,1,sensorPara[0].u1MIPIPacketECCOrder,1,1/*HSRXDE*/,sensorPara[0].DPCM_TYPE);
                        }
                        else
                        {
                    ...
                    if(sensorPara[1].mipiPad == 2) {
                        ...
                        if(sensorPara[1].MIPI_OPHY_TYPE == 1) // CSI2
                        {
                            ...
                            ret = pSeninfDrv->setSeninf3NCSI2(sensorPara[1].u1MIPIDataTermDelay,sensorPara[1].u1MIPIDataSettleDelay,sensorPara[1].u1MIPIClkTermDelay,
                                sensorPara[1].u1VsyncPol,sensorPara[1].u1MIPILaneNum,1,sensorPara[1].u1MIPIPacketECCOrder,1,1/*HSRXDE*/,sensorPara[1].DPCM_TYPE);
                        }
                        else
                        {
                            ret = pSeninfDrv->setSeninf3Ctrl((PAD2CAM_DATA_ENUM)sensorPara[1].padSel, (SENINF_SOURCE_ENUM)sensorPara[1].inSrcTypeSel);
                            ret = pSeninfDrv->setSeninf3NCSI2(sensorPara[1].u1MIPIDataTermDelay,sensorPara[1].u1MIPIDataSettleDelay,sensorPara[1].u1MIPIClkTermDelay,
                            sensorPara[1].u1VsyncPol,sensorPara[1].u1MIPILaneNum,1,sensorPara[1].u1MIPIPacketECCOrder,0,1/*HSRXDE*/,sensorPara[1].DPCM_TYPE);
                        }
                    ...
                    if(sensorPara[2].mipiPad == 2) {
                        ...
                        if(sensorPara[2].MIPI_OPHY_TYPE == 1) // CSI2
                        {
                            ...
                            ret = pSeninfDrv->setSeninf3NCSI2(sensorPara[2].u1MIPIDataTermDelay,sensorPara[2].u1MIPIDataSettleDelay,sensorPara[2].u1MIPIClkTermDelay,
                                sensorPara[2].u1VsyncPol,sensorPara[2].u1MIPILaneNum,1,sensorPara[2].u1MIPIPacketECCOrder,1,1/*HSRXDE*/,sensorPara[2].DPCM_TYPE);
                        }
                        else
                        {
                            ret = pSeninfDrv->setSeninf3Ctrl((PAD2CAM_DATA_ENUM)sensorPara[2].padSel, (SENINF_SOURCE_ENUM)sensorPara[2].inSrcTypeSel);
                            ret = pSeninfDrv->setSeninf3NCSI2(sensorPara[2].u1MIPIDataTermDelay,sensorPara[2].u1MIPIDataSettleDelay,sensorPara[2].u1MIPIClkTermDelay,
                            sensorPara[2].u1VsyncPol,sensorPara[2].u1MIPILaneNum,1,sensorPara[2].u1MIPIPacketECCOrder,0,1/*HSRXDE*/,sensorPara[2].DPCM_TYPE);
                        }
            ...
            case (SENSOR_DEV_MAIN|SENSOR_DEV_SUB|SENSOR_DEV_MAIN_2)://should not support this case
                ...
                ret = pSeninfDrv->setSV1Cfg((TG_FORMAT_ENUM)sensorPara[2].inDataType, (SENSOR_DATA_BITS_ENUM)sensorPara[2].senInLsb, TWO_PIXEL_MODE);


                ret = pSeninfDrv->setSeninf3MuxCtrl(sensorPara[2].u1HsyncPol?0 : 1,
                                                        sensorPara[2].u1VsyncPol? 0 : 1,(SENINF_SOURCE_ENUM)sensorPara[2].inSrcTypeSel, (TG_FORMAT_ENUM)sensorPara[2].inDataType, TWO_PIXEL_MODE);
