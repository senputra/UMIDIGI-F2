...
#define FEATURE_MASK_ENABLE_EIS_Q(x)      (x)|=(1<<4)
#define FEATURE_MASK_IS_EIS_Q_ENABLED(x)  ((x&(1<<4))?true:false)
...
public:
    ...
    virtual void                    startEISRecord() = 0;

    virtual void                    stopEISRecord() = 0;

    virtual void                    notifyEISRecordStopping() = 0;
