                                       ...
                                       MUINT32 /*dstImgH*/)
{
    ...
    ACDK_LOGD("srcImem : size(%u),vir(0x%" PRIxPTR "),phy(0x%" PRIxPTR "),mimID(%d)",
        srcImem.size, srcImem.virtAddr, srcImem.phyAddr, srcImem.memID);
    ACDK_LOGD("dstImem : size(%u),vir(0x%" PRIxPTR "),phy(0x%" PRIxPTR "),mimID(%d)",
        dstImem.size, dstImem.virtAddr, dstImem.phyAddr, dstImem.memID);
...
MINT32 AcdkUtility::rawImgUnpack(IMEM_BUF_INFO srcImem,
                                       ...
                                       MUINT32 a_Stride)
{
    ACDK_LOGD("srcImem : VA(0x%" PRIxPTR "),PA(0x%" PRIxPTR "),ID(%d),SZ(%u)",
                                                           srcImem.virtAddr,
                                                           srcImem.phyAddr,
                                                           srcImem.memID,
                                                           srcImem.size);

    ACDK_LOGD("dstImem : VA(0x%" PRIxPTR "),PA(0x%" PRIxPTR "),ID(%d),SZ(%u)",
                                                           dstImem.virtAddr,
                                                           dstImem.phyAddr,
                                                           dstImem.memID,
                                                           dstImem.size);
