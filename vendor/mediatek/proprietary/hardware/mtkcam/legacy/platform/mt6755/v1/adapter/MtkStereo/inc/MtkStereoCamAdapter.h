...
protected:  ////                    Data Members.
    ...
    sp<DefaultCtrlNode>             mspDefaultCtrlNode;   // sp
    sp<DefaultCtrlNode>             mspDefaultCtrlNode_Main2;   // sp
    //
    SyncNode*                       mpSyncNode;
    StereoNode*                     mpStereoNode;
    StereoNode*                     mpStereoNode_Main2;
    sp<StereoNode>                  mspStereoNode;   // sp
    sp<StereoNode>                  mspStereoNode_Main2;   // sp
    StereoCtrlNode*                 mpStereoCtrlNode;
    sp<StereoCtrlNode>              mspStereoCtrlNode;  // sp
