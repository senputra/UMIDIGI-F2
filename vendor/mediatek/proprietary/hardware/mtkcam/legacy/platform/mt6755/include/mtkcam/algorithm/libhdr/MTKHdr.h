...
{
    MUINT32 BRatio;
    MUINT32 Gain[MAX_PYRAMID_LEVEL]; //Gain for top N level
...
typedef struct
{
    ...
    //MUINT32 small_image_addr[3]; //To to HDR and weighting
    //MUINT32 input_source_image[3];  //The image to be done by HDR
    MUINT8 *small_image_addr[3]; //To to HDR and weighting
