...
public:
    ...
    virtual MINT32 DoRSCMEEis(EIS_HAL_CONFIG_DATA *apEisConfig = NULL, MINT64 aTimeStamp = -1);
...
private:
    ...
    /**
         *@brief Get Gyro/Accel sensor data from SensorProvider
       */
    MVOID GetSensorData();
    ...
    sp<NSCam::Utils::SensorProvider> mpSensorProvider;
