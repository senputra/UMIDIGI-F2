...
class IspDrvImp : public IspDrv
{
    ...
    public:
        ...
        //
        virtual MBOOL getIspCQModuleInfo(CAM_MODULE_ENUM /*eModule*/, ISP_DRV_CQ_MODULE_INFO_STRUCT &outInfo) {(void)outInfo; return MFALSE;}//not support in phy
...
class IspDrvVirImp : public IspDrv
{
    ...
    public:
        ...
        virtual void    destroyInstance(void);
        virtual MINT32 isp_fd_open(const char* userName=""){/*LOG_ERR("Not support");*/(void)userName; return MTRUE;}
        virtual MINT32 isp_fd_close(MINT32 /*mIspFd*/){/*LOG_ERR("Not support");*/return MTRUE;}
        virtual MBOOL   init(const char* userName=""){ /*LOG_ERR("Not support");*/(void)userName; return MTRUE;}
        virtual MBOOL   uninit(const char* userName=""){/*LOG_ERR("Not support");*/(void)userName; return MTRUE;}
        ...
        // debug information
        virtual MBOOL dumpCQTable(ISP_DRV_CQ_ENUM /*cq*/, MINT32 burstQIdx=0, MUINT32 dupCqIdx=0, ISP_DRV_CQ_CMD_DESC_STRUCT* cqDesVa=0, MUINT32* cqVirVa=0){(void)burstQIdx; (void)dupCqIdx; (void)cqDesVa; (void)cqVirVa; return MTRUE;};
        ...
        virtual MUINT32 getTuningTop(ETuningQueAccessPath /*ePath*/, ETuningTopEn /*top*/, MINT32 /*cq*/, MUINT32 magicNum=0){(void)magicNum; return -1;};
        virtual MUINT32* getTuningBuf(ETuningQueAccessPath /*ePath*/, MINT32 /*cq*/){return NULL;};
        virtual MBOOL   getCqInfoFromScenario(ESoftwareScenario /*softScenario*/, ISP_DRV_CQ_ENUM &cq){(void)cq; return MFALSE;};
        virtual MBOOL   getP2cqInfoFromScenario(ESoftwareScenario /*softScenario*/, ISP_DRV_P2_CQ_ENUM &p2Cq){(void)p2Cq; return MFALSE;};
        virtual MBOOL   getTuningTpipeFiled(ISP_DRV_P2_CQ_ENUM /*p2Cq*/, MUINT32* /*pTuningBuf*/, stIspTuningTpipeFieldInf &pTuningField){(void)pTuningField; return MFALSE;};
        virtual MBOOL   mapCqToP2Cq(ISP_DRV_CQ_ENUM /*cq*/, ISP_DRV_P2_CQ_ENUM &p2Cq){(void)p2Cq; return MFALSE;};
        //
        virtual MBOOL getCqModuleInf(CAM_MODULE_ENUM moduleId, MUINT32 &addrOffset, MUINT32 &moduleSize);
        // slow motion feature, support burst Queue control
        virtual MBOOL cqTableControl(ISP_DRV_CQTABLE_CTRL_ENUM /*cmd*/, int /*burstQnum*/) {return MFALSE;};
        virtual MINT32 cqNumInfoControl(ISP_DRV_CQNUMINFO_CTRL_ENUM /*cmd*/, int newValue=0) {(void)newValue; return MFALSE;};
        //
        // dequeue mechanism in ihalpipewarpper
        ...
        virtual MBOOL   queryScenarioValue(MUINT32& value) {(void)value; return MFALSE;};
        //
        //
        //temp remove later
    ...
    private:
        virtual MBOOL   searchTuningQue(ISP_DRV_P2_CQ_ENUM /*p2Cq*/, MINT32 /*magicNum*/, MINT32 &getQueIdx) {(void)getQueIdx; return MFALSE;};
        virtual MBOOL   orderSearchTuningQue(ISP_DRV_P2_CQ_ENUM /*p2Cq*/, MINT32 /*magicNum*/, MUINT32 /*start*/, MUINT32 /*end*/, MINT32 &getQueIdx) {(void)getQueIdx; return MFALSE;};
        virtual MUINT32* getRegAddr(void);
        mutable Mutex   mLock;
