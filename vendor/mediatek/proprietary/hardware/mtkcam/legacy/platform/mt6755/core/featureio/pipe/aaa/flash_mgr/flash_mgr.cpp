...
int FlashMgr::egSetMfDutyStep(int senorDev, int duty, int /*step*/)  /* fix build warning */
{
...
int FlashMgr::getAfLampMode(int /*senorDev*/)  /* fix build warning */
{
    return 0;
}

int FlashMgr::egGetDutyRange(int /*senorDev*/, int* st, int* ed)  /* fix build warning */
{
    *st=0;
    *ed=1;
    return 0;
}
int FlashMgr::egGetStepRange(int /*senorDev*/, int* st, int* ed)  /* fix build warning */
{
    *st=0;
    *ed=0;
    return 0;
