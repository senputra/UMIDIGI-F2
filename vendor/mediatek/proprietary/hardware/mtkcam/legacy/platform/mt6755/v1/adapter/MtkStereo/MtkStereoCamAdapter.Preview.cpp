...
onHandleStartPreview()
{
    ...
    MUINT32 pass1RingBufNum = 6, sensorScenario = 0, sensorMain2Scenario = 0, rotationAnagle = 270;
    ...
    mspStereoNode       = mpStereoNode;   // sp
    mpStereoNode_Main2  = StereoNode::createInstance(SNodeInitCfg);
    mspStereoNode_Main2 = mpStereoNode_Main2;   // sp
