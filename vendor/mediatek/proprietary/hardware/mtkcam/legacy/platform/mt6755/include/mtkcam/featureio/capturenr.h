...
class SwNRParam
{
    ...
    public:
        ...
        //
        MBOOL      update();
        MINT32     getNRType() { return mType; }
        MBOOL      getTuning(NRTuningInfo* pNR, HFGTuningInfo* pHFG, CCRTuningInfo* pCCR);
        MBOOL      getTuning(IIRTuningInfo* pNR, HFGTuningInfo* pHFG, CCRTuningInfo* pCCR);
    ...
    protected:
        ...
        MBOOL      getTuningFromNvram(MUINT32 idx, MVOID** ppNvram);
        MBOOL      getTuningFromFile(MUINT32 idx, MVOID* pNvram);
