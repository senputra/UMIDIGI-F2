...
{
    int32_t sensorType = IHalSensorList::get()->queryType(0);
    int32_t sensorDev = IHalSensorList::get()->querySensorDevIdx(0);
    const char* sensorDrvName = IHalSensorList::get()->queryDriverName(0);
    //
    mInfo = Info(i4OpenId, sensorDev, sensorType, sensorDrvName);
    //
    showCustInfo();
