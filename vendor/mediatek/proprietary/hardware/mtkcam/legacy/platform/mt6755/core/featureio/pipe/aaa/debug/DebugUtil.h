...
template <int sensorDevId>
class DebugUtilDev : public DebugUtil
{
public:
    static DebugUtilDev* getInstance()
    {
        static DebugUtilDev<sensorDevId> singleton;
        return &singleton;
    }
    DebugUtilDev()
        : DebugUtil(sensorDevId)
    {
    }
