...
MVOID AfMgr::printAFConfigLog0()
{
    ...
    MY_LOG_IF((m_bDebugEnable&1), "DoAFSW TG%d [P1/P1D]0x%x/0x%x, [P1DMA/P1DDMA]0x%x/0x%x [AFDdone]%x ", m_eSensorTG,
...
{
    MINT32 fdistidx __unused = 0;
    MINT32 i4distmm __unused;
    MINT32 i4tblLL __unused;
    MINT32 i4ResultDac __unused;
...
{
    MINT32 fdacidx __unused = 0;
    MINT32 i4tblLL __unused;
    MINT32 i4ResultDist __unused = 100;
    MFLOAT retDist=200;
#if 0
    if (m_i4EnableAF == 0)
    {
...
MVOID AfMgr::getFocusRange (MFLOAT *vnear, MFLOAT *vfar)
{
    ...
    MINT32 i4tblLL __unused;
    MINT32 i4ResultDist  __unused = 100;
    MINT32 i4ResultRange __unused = 100;
...
MVOID AfMgr::VsyncSignal()
{
...

    {
        ...
        if( m_cur_frm_num<4)
        {
            MY_LOG_IF(m_bDebugEnable, "[Dev %d] cur_frm_num is less than 4 skip calculate PD buffer", m_i4CurrSensorDev);
            return;
        }
