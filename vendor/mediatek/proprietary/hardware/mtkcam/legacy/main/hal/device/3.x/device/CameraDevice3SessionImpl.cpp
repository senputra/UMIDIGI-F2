...
) -> ::android::status_t
{
    ...
    //
    {
        ...
        params.operationMode        = static_cast<uint32_t>(requestedConfiguration.operationMode);
...
{
    CAM_TRACE_NAME("constructDefaultRequestSettings");
...
Return<void>
ThisNamespace::
configureStreams(const StreamConfiguration& requestedConfiguration, configureStreams_cb _hidl_cb)
{
    CAM_TRACE_CALL();
    ...
    HalStreamConfiguration halStreamConfiguration;
    {
        ::android::Mutex::Autolock _lOpsLock(mOpsLock);
...
Return<void>
ThisNamespace::
processCaptureRequest(const hidl_vec<CaptureRequest>& requests, const ::android::hardware::hidl_vec<BufferCache>& cachesToRemove, processCaptureRequest_cb _hidl_cb)
{
