...
int xcCmdProcStaSetSecurity(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(ssec->akmSuiteType, str, 128);
        }
        ...
        else if(strcasecmp(str, "password") == 0)
        {
            ...
            strncpy(ssec->passphrase, str, 32);
        }
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(ssec->serverCert, str, 32);
        }
        else if(strcasecmp(str, "domain") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(ssec->domainMatch, str, 32);
        }
        else if(strcasecmp(str, "DomainSuffix") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(ssec->domainSuffixMatch, str, 32);
        }
...
{
    dutCommand_t *dutcmd = (dutCommand_t *) (aBuf+sizeof(wfaTLV));
    caStaDevExecAction_t *action = (caStaDevExecAction_t *) &dutcmd->cmdsu.devExecAction;
    char *str;
    DPRINT_INFO(WFA_OUT, "Entering xcCmdProcDevExecAction ...\n");
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(action->prog, str, 8);
            DPRINT_INFO(WFA_OUT, "program %s \n", action->prog);
        }
        else if (strcasecmp(str, "interface") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(action->intf, str, WFA_IF_NAME_LEN);
            DPRINT_INFO(WFA_OUT, "interface %s \n", action->intf);
        }
        else if (strcasecmp(str, "ServerCertTrust") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(action->serverCertTrust, str, 32);
            DPRINT_INFO(WFA_OUT, "serverCertTrust %s \n", action->serverCertTrust);
        }
    ...
    wfaEncodeTLV(WFA_STA_DEV_EXEC_ACTION_TLV, sizeof(dutCommand_t), (BYTE *)dutcmd, aBuf);
    *aLen = 4+sizeof(dutCommand_t);
