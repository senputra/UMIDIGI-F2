...
if TEST_ALL or TEST_SCV:
    send_resp(client_socket, "sta_set_security,type,eaptls,interface,wlan0,ssid,SCV-11.1.1_TLS_330,username,rsa-user1,ClientCertificate,rsa_user1_w1_fi.pem,ServerCert,rsa_server1_w1_fi.pem,CertType,RSA,AKMSuiteType,1;5,PairwiseCipher,AES-CCMP-128,GroupCipher,AES-CCMP-128,GroupMgntCipher,BIP-CMAC-128,PMKSACaching,disabled,PMF,Optional")
    send_resp(client_socket, "sta_set_security,type,eapttls,interface,wlan0,ssid,SCV-11.1.1_TTLS_380,username,wifi-user,password,test%11,ServerCert,rsa_server1_w1_fi.pem,CertType,RSA,AKMSuiteType,1;5,PairwiseCipher,AES-CCMP-128,GroupCipher,AES-CCMP-128,GroupMgntCipher,BIP-CMAC-128,PMKSACaching,disabled,PMF,Optional")
    send_resp(client_socket, "sta_set_security,type,eappeap,interface,wlan0,ssid,SCV-11.1.1_TLS_330,username,rsa-user1,password,12345678,trustedRootCA,DEFAULT,DomainSuffix,wfatestorg.org,CertType,RSA,AKMSuiteType,6,PairwiseCipher,AES-CCMP-128,GroupCipher,AES-CCMP-128,GroupMgntCipher,BIP-CMAC-128,innerEAP,MSCHAPv2,peapVersion,0,PMKSACaching,disabled,PMF,Optional");
    send_resp(client_socket, "sta_set_security,type,eapttls,interface,wlan0,ssid,SCV-11.1.7_TTLS_UOSC-DA_340,username,wifi-user,password,test%11,trustedRootCA,rsa_ca1_w1_fi.pem,domain,server2.w1-fi.org,CertType,RSA,AKMSuiteType,1;5,PairwiseCipher,AES-CCMP-128,GroupCipher,AES-CCMP-128,GroupMgntCipher,BIP-CMAC-128,PMKSACaching,disabled,PMF,Optional")
    send_resp(client_socket, "dev_exec_action,program,WPA3,interface,wlan0,ServerCertTrust,Accept")
