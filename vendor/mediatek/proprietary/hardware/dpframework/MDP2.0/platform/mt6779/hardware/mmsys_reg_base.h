...
#define ISP_DIP1_BASE       (0x15021000)
#define ISP_DIP2_BASE       (0x15022000)
#define ISP_WPE_A_BASE      (0x15011000)
#define ISP_MFB_BASE        (0x15010000)
