...
{
    {  tCAMIN, {     tHDR0,       tSCL1,         tAAL0,    tNone,   tNone},       ISP_MOUT_EN},
    { tCAMIN2, {     tHDR0,       tSCL1,         tAAL0,    tNone,   tNone},       IPU_MOUT_EN},
    {  tRDMA0, {     tHDR0,       tSCL1,   tPATH0_SOUT,    tAAL0,   tNone}, MDP_RDMA0_MOUT_EN},
    {  tRDMA1, {     tHDR0,       tSCL1,   tPATH1_SOUT,    tNone,   tNone}, MDP_RDMA1_MOUT_EN},
    {   tAAL0, {     tHDR0,       tSCL1,         tSCL0,    tNone,   tNone},   MDP_AAL_MOUT_EN},
    {   tSCL0, { tPATH0_SOUT,     tTDSHP0,       tNone,    tNone,   tNone},  MDP_PRZ0_MOUT_EN},
    {   tSCL1, { tPATH0_SOUT,     tTDSHP0, tPATH1_SOUT, tWDMA_EX,   tNone},  MDP_PRZ1_MOUT_EN},
...
{
    {       tAAL0, {      tCAMIN,        tRDMA0, tCAMIN2,    tHDR0,   tNone,   tNone,   tNone, tNone},    MDP_AAL_SEL_IN},
    {       tHDR0, {      tCAMIN,        tRDMA0,  tRDMA1,  tCAMIN2,   tAAL0,   tNone,   tNone, tNone},  MDP_CCORR_SEL_IN},
    {       tSCL0, {       tAAL0,         tHDR0,   tNone,    tNone,   tNone,   tNone,   tNone, tNone},   MDP_PRZ0_SEL_IN},
    {       tSCL1, {      tCAMIN,        tRDMA0,  tRDMA1,  tTO_RSZ, tCAMIN2,   tAAL0,   tNone, tNone},   MDP_PRZ1_SEL_IN},
    ...
    { tPATH1_SOUT, {       tSCL1,       tCOLOR0,  tRDMA1,    tNone,   tNone,   tNone,   tNone, tNone},  MDP_PATH1_SEL_IN},
    {      tWROT0, { tPATH0_SOUT, tTO_WROT_SOUT,   tNone,    tNone,   tNone,   tNone,   tNone, tNone},  MDP_WROT0_SEL_IN},
    {      tWROT1, { tPATH1_SOUT, tTO_WROT_SOUT,   tNone,    tNone,   tNone,   tNone,   tNone, tNone},  MDP_WROT1_SEL_IN},
...
{
    {       tHDR0, {   tAAL0,     tSCL0},    MDP_CCORR_SOUT_SEL},
    { tPATH0_SOUT, {  tWROT0, tTO_DISP0},    MDP_PATH0_SOUT_SEL},
    { tPATH1_SOUT, {  tWROT1, tTO_DISP1},    MDP_PATH1_SOUT_SEL},
    //{  tTO_WROT_SOUT, {  tWROT0,    tWROT1}, DISP_TO_WROT_SOUT_SEL},
};


DP_STATUS_ENUM DpPathConnection::initTilePath(struct TILE_PARAM_STRUCT *p_tile_param, struct WPE_TPIPE_CONFIG_STRUCT *p_wpe_param)
{
    ...
    for (iterator = m_pPath->begin(); iterator != m_pPath->end(); iterator++)
    {
        ...
        case tIMGI:
            ...
            break;
        case tWPEI:
            static_cast<DpWrapper_WPE*>(&*iterator)->initTilePath(p_tile_param, p_wpe_param);
        ...
        case tHDR0:          ptr_tile_reg_map->HDR0_EN        = 1; break;
    ...
    for (index = 0; index < SEL_IN_NUM; index++)
    {
        ...
        {
        case tHDR0:       ptr_tile_reg_map->HDR0_SEL       = m_sInInfo[index]; break;
    ...
    for (index = 0; index < SEL_OUT_NUM; index++)
    {
        ...
        {
        case tHDR0:            ptr_tile_reg_map->HDR0_SOUT        = m_sOutInfo[index]; break;
