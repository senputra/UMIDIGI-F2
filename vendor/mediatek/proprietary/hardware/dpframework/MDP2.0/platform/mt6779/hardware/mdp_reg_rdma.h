...
#define MDP_RDMA_COMP_CON               (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x0038)
...
#define MDP_RDMA_UNCOMP_MON             (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x02c0)
#define MDP_RDMA_COMP_MON               (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x02c8)
...
// MASK
#define MDP_RDMA_EN_MASK                    (0xFFFFF1)
...
#define MDP_RDMA_GMCIF_CON_MASK             (0xFFFB3FF7)
#define MDP_RDMA_SRC_CON_MASK               (0xF3FFFFFF)
#define MDP_RDMA_COMP_CON_MASK              (0xF1AC0080)
...
#define MDP_RDMA_MF_PAR_MASK                (0x1FFFF7FF)
#define MDP_RDMA_SF_BKGD_SIZE_IN_BYTE_MASK  (0x01FFFFF)
#define MDP_RDMA_SF_PAR_MASK                (0x1FFFF7FF)
...
#define MDP_RDMA_DMABUF_CON_3_MASK          (0x073F001F)
#define MDP_RDMA_DMAULTRA_CON_3_MASK        (0x3F3F3F3F)
#define MDP_RDMA_RESV_DUMMY_0_MASK          (0xFFFFFFFF)
#define MDP_RDMA_UNCOMP_MON_MASK            (0x3FFFFFF)
#define MDP_RDMA_COMP_MON_MASK              (0x3FFFFFE)
...
#define MDP_RDMA_DEBUG_CON_MASK             (0x01F1F)
