...
#define MDP_HFG_CTRL                  (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x500)
#define MDP_HFG_RAN_0                 (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x504)
#define MDP_HFG_RAN_1                 (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x508)
#define MDP_HFG_RAN_2                 (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x50C)
#define MDP_HFG_RAN_3                 (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x510)
#define MDP_HFG_RAN_4                 (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x514)
#define MDP_HFG_CROP_X                (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x518)
#define MDP_HFG_CROP_Y                (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x51C)
#define MDP_HFC_CON_0                 (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x524)
#define MDP_HFC_LUMA_0                (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x528)
#define MDP_HFC_LUMA_1                (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x52C)
#define MDP_HFC_LUMA_2                (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x530)
#define MDP_HFC_SL2_0                 (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x534)
#define MDP_HFC_SL2_1                 (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x538)
#define MDP_HFC_SL2_2                 (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x53C)
#define MDP_SL2_CEN                   (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x544)
#define MDP_SL2_RR_CON0               (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x548)
#define MDP_SL2_RR_CON1               (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x54C)
#define MDP_SL2_GAIN                  (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x550)
#define MDP_SL2_RZ                    (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x554)
#define MDP_SL2_XOFF                  (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x558)
#define MDP_SL2_YOFF                  (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x55C)
#define MDP_SL2_SLP_CON0              (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x560)
#define MDP_SL2_SLP_CON1              (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x564)
#define MDP_SL2_SLP_CON2              (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x568)
#define MDP_SL2_SLP_CON3              (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x66C)
#define MDP_SL2_SIZE                  (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x670)
#define MDP_HFG_OUTPUT_COUNT          (ID_ADDR(m_identifier)+ MDP_TDSHP0_BASE + 0x678)
