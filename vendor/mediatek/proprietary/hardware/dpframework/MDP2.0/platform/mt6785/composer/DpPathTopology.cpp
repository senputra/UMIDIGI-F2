                                           ...
                                           uint32_t)
{
    ...
    switch (portType)
    {
        ...
        case PORT_MDP2:
            if ((0 != rotation) || (flipStatus == true))
                ...
                {
                    DPLOGE("DpPathTopology: can not merge path 0.0\n");
            ...
            else if (tIMGI == sourceEng || tWPEI2 == sourceEng || numOutputPort == 2 || scenario == STREAM_2ND_BITBLT)
            {
                ...
                {
                    DPLOGE("DpPathTopology: can not merge path 0.1\n");
                    return DP_STATUS_CAN_NOT_MERGE;
                }
            }
            else if (tWPEI == sourceEng || tRDMA1 == sourceEng)
            {
                ...
                {
                    DPLOGE("DpPathTopology: can not merge path 0.2\n");
                    return DP_STATUS_CAN_NOT_MERGE;
                }
            }
            else // tRDMA0
            {
                ...
                {
                    DPLOGE("DpPathTopology: can not merge path 0.3\n");
                    return DP_STATUS_CAN_NOT_MERGE;
                }
            }
            ...
            if (tSCL0 == curRSZ)
            {
                ...
                {
                    DPLOGE("DpPathTopology: can not merge path 0.4\n");
                    return DP_STATUS_CAN_NOT_MERGE;
                }
            }
            else if (tSCL1 == curRSZ)
            {
                ...
                {
                    DPLOGE("DpPathTopology: can not merge path 0.5\n");
                    return DP_STATUS_CAN_NOT_MERGE;
                }
            }
            break;
        case PORT_ISP:
            ...
            {
                DPLOGE("DpPathTopology: can not merge path 1.0\n");
                return DP_STATUS_CAN_NOT_MERGE;
            }
            break;
        case PORT_WPE:
            ...
            {
                DPLOGE("DpPathTopology: can not merge path 2.0\n");
                return DP_STATUS_CAN_NOT_MERGE;
            }
            break;
#if 0
        ...
        case PORT_VENC:
            ...
            {
                DPLOGE("DpPathTopology: can not merge path 3.0\n");
                return DP_STATUS_CAN_NOT_MERGE;
            }
            ...
            if (IS_ENGINE_FREE(engFlag, tVENC))
            {
                ...
                {
                    DPLOGE("DpPathTopology: can not merge path due to failure in adding WROT1 before VENC\n");
                    return DP_STATUS_CAN_NOT_MERGE;
                }
            }
            break;
    ...
    if (targetPort.getTDSHPStatus())
    {
        ...
        if (0 != DpDriver::getInstance()->getPQSupport())
        {
            ...
            {
                DPLOGE("DpPathTopology: can not merge path 4.0\n");
                return DP_STATUS_CAN_NOT_MERGE;
            }
        }
#endif // BASIC_PACKAGE
