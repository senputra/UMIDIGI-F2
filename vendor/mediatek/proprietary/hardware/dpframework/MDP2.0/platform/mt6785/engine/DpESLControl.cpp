                          ...
                          DpColorFormat colorFormat)
{
    ...
    uint32_t dmabuf_con_3 = 0;

    dmabuf_con_0 |= (3 << 24);

    if (blockMode) {
        dmabuf_con_0 |= (32 << 0);
        dmaultra_con_0 |= (58 << 24) + (39 << 8);
        dmabuf_con_1 |= (1 << 24) + (16 << 0);
        dmaultra_con_1 |= (29 << 24) + (19 << 8);
        dmabuf_con_2 |= (0 << 24);
        dmabuf_con_3 |= (0 << 24);
    }
        ...
        dmabuf_con_0 |= (32 << 0);
        dmaultra_con_0 |= (58 << 24) + (39 << 8);
        dmabuf_con_1 |= (0 << 24) + (20 << 0);
        dmaultra_con_1 |= (15 << 24) + (10 << 8);
        dmabuf_con_2 |= (0 << 24) + (20 << 0);
        dmaultra_con_2 |= (15 << 24) + (10 << 8);
    }
    else if (planeCount == 2) {
        dmabuf_con_0 |= (32 << 0);
        dmaultra_con_0 |= (58 << 24) + (39 << 8);
        dmabuf_con_1 |= (1 << 24) + (20 << 0);
        dmaultra_con_1 |= (29 << 24) + (19 << 8);
    }
    else if (uniqueID == 0 || uniqueID == 1) { //RGB
        dmabuf_con_0 |= (32 << 0);
        dmaultra_con_0 |= (122 << 24) + (82 << 8);
        dmabuf_con_2 |= (0 << 24);
        dmaultra_con_2 |= (2 << 24) + (1 << 8);
    }
    else if (uniqueID == 2 || uniqueID == 3) { //ARGB
        dmabuf_con_0 |= (32 << 0);
        dmaultra_con_0 |= (233 << 24) + (156 << 8);
    }
    else if (uniqueID == 4 || uniqueID == 5) { //UYVY
        dmabuf_con_0 |= (32 << 0);
        dmaultra_con_0 |= (117 << 24) + (78 << 8);
    }
    ...
    MM_REG_WRITE(command, MDP_RDMA_DMABUF_CON_3, dmabuf_con_3, 0x073F003F);
    return DP_STATUS_RETURN_SUCCESS;
}
                          ...
                          DpColorFormat colorFormat)
{
    ...
    if (planeCount == 3 || planeCount == 2 || uniqueID == 7) { //3-plane, 2-plane, Y8
        vido_dma_preultra = (216 << 12) + (196 << 0);
    }
    else if (uniqueID == 0 || uniqueID == 1) { //RGB
        vido_dma_preultra = (136 << 12) + (76 << 0);
    }
    else if (uniqueID == 2 || uniqueID == 3) { //ARGB
        vido_dma_preultra = (96 << 12) + (16 << 0);
    }
    else if (uniqueID == 4 || uniqueID == 5) { //UYVY
        vido_dma_preultra = (176 << 12) + (136 << 0);
    }
    else {
        return DP_STATUS_RETURN_SUCCESS;
    }
