...
#define DISP_COLOR_BASE     (0x1400b000)
#define DISP_CCORR_BASE     (0x1400c000)
#define DISP_AAL_BASE       (0x1400d000)
#define DISP_GAMMA_BASE     (0x1400e000)
#define DISP_DITHER_BASE    (0x1401f000)
#define DISP_UFOE_BASE      (0x14010000)
#define DSI0_BASE           (0x14011000)
#define DPI0_BASE           (0x14012000)
#define DISP_PWM0_BASE      (0x14013000)

#define MMSYS_CMDQ_BASE     (0x10217000)
