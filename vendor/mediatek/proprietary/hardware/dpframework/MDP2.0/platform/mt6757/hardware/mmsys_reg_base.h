...
#define MDP_COLOR0_BASE     (0x1400a000)
...
#define DISP_COLOR_BASE     (0x14013000)
#define DISP_CCORR_BASE     (0x14014000)
#define DISP_AAL_BASE       (0x14015000)
#define DISP_GAMMA_BASE     (0x14016000)
#define DISP_OD_BASE        (0x14017000)
#define DISP_DITHER_BASE    (0x14018000)
#define DSI_UFOE_BASE       (0x14019000)
#define DSI_DSC_BASE        (0x1401a000)
#define DSI_SPLIT_BASE      (0x1401b000)
#define DSI0_BASE           (0x1401c000)
#define DSI1_BASE           (0x1401d000)
#define DPI0_BASE           (0x1401e000)
...
#define ISP_DIP_A_BASE      (0x15022000)
...
#define USE_ENGBASE_ISP_DIP_A		1
