...
{
    { tCAMIN,   { tSCL0, tSCL1,  tSCL2,   tNone,  tNone }, ISP_MOUT_EN       },
    { tRDMA0,   { tSCL0, tSCL1,  tSCL2,   tWROT0, tNone }, MDP_RDMA0_MOUT_EN },
    { tSCL0,    { tWDMA, tWROT0, tTDSHP0, tSCL1,  tNone }, MDP_PRZ0_MOUT_EN  },
    { tSCL1,    { tWDMA, tWROT0, tTDSHP0, tWROT1, tNone }, MDP_PRZ1_MOUT_EN  },
    { tSCL2,    { tWDMA, tWROT1, tTDSHP0, tNone,  tNone }, MDP_PRZ2_MOUT_EN  },
    { tCOLOR0,  { tWDMA, tWROT0, tWROT1,  tNone,  tNone }, MDP_COLOR_MOUT_EN },
};
...
const DpPathConnection::sel_t DpPathConnection::s_selInMap[SEL_IN_SIZE] =
{
    ...
    { tSCL2,    { tCAMIN, tRDMA0, tRDMA1,  tNone,  tNone, tNone, tNone, tNone }, MDP_PRZ2_SEL_IN   },
    { tTDSHP0,  { tSCL0,  tSCL1,  tSCL2,   tNone,  tNone, tNone, tNone, tNone }, MDP_TDSHP_SEL_IN  },
    { tWDMA,    { tSCL0,  tSCL1,  tCOLOR0, tSCL2,  tNone, tNone, tNone, tNone }, MDP_WDMA_SEL_IN   },
    { tWROT0,   { tSCL0,  tSCL1,  tCOLOR0, tRDMA0, tNone, tNone, tNone, tNone }, MDP_WROT0_SEL_IN  },
    { tWROT1,   { tSCL1,  tSCL2,  tCOLOR0, tNone,  tNone, tNone, tNone, tNone }, MDP_WROT1_SEL_IN  },
};
...
DP_STATUS_ENUM DpPathConnection::initTilePath(struct TILE_PARAM_STRUCT *p_tile_param)
{
    ...
    for (iterator = m_pPath->begin(); iterator != m_pPath->end(); iterator++)
    {
        ...
        case tSCL2:     ptr_tile_reg_map->PRZ2_EN       = 1; break;
    ...
    for (index = 0; index < MOUT_NUM; index++)
    {
        ...
        case tSCL2:     ptr_tile_reg_map->PRZ2_OUT      = m_mOutInfo[index]; break;
    ...
    for (index = 0; index < SEL_IN_NUM; index++)
    {
        ...
        case tSCL2:     ptr_tile_reg_map->PRZ2_SEL      = m_sInInfo[index]; break;
