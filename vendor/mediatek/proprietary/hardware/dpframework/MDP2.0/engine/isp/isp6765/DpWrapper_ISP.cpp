                                           ...
                                           DpConfig  &config)
{
    ...
    if (m_ISPConfig.drvinfo.dip_secure_tag&0x1) // For secure camera path
    {
        ...
        {
            secureRegAddr[0] = 0x15022230;
            secureRegAddr[1] = 0x15022260;
            secureRegAddr[2] = 0;
            planeOffset[0] = 0;
        ...
        {
            secureRegAddr[0] = 0x15022290;
            secureRegAddr[1] = 0x150222C0;
            secureRegAddr[2] = 0x150222F0;
            planeOffset[0] = 0;
        ...
        if (m_ISPConfig.drvinfo.dip_mfbo_secure_tag != 0) // MFBO
        {
            secureRegAddr[0] = 0x15022350;
            secureRegAddr[1] = 0;
            secureRegAddr[2] = 0;
            planeOffset[0] = 0;
            planeOffset[1] = 0;
            planeOffset[2] = 0;
            flag = (uint64_t)(1LL<<CMDQ_ENG_ISP_IMG2O);
            command.secure(CMDQ_ENG_ISP_IMG2O, flag, secureRegAddr, (DpSecure)m_ISPConfig.drvinfo.dip_mfbo_secure_tag, m_ISPConfig.drvinfo.dip_mfbo_base_addr, offset, m_ISPConfig.drvinfo.dip_mfbo_size, planeOffset);
        }
        if (m_ISPConfig.drvinfo.dip_imgi_secure_tag != 0) // IMGI
        {
            secureRegAddr[0] = 0x15022400;
            secureRegAddr[1] = 0x15022430;
            secureRegAddr[2] = 0x15022460;
            planeOffset[0] = 0;
            planeOffset[1] = m_ISPConfig.drvinfo.dip_imgbi_base_addr;
            planeOffset[2] = m_ISPConfig.drvinfo.dip_imgci_base_addr;
        ...
        {
            secureRegAddr[0] = 0x15022490;
            secureRegAddr[1] = 0x150224C0;
            secureRegAddr[2] = 0x150224F0;
            planeOffset[0] = 0;
        ...
        planeOffset[1] = 0;
        planeOffset[2] = 0;
        flag = (uint64_t)(1LL<<CMDQ_ENG_ISP_IMGI) | (uint64_t)(1LL<<CMDQ_ENG_ISP_LCEI); // For CQ DMA
        switch (m_ISPConfig.drvinfo.cqIdx) {
            case ISP_DRV_DIP_CQ_THRE0:
                secureRegAddr[0] = 0x15022108;
                ...
                break;
            case ISP_DRV_DIP_CQ_THRE1:
                secureRegAddr[0] = 0x15022114;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE2:
                secureRegAddr[0] = 0x15022120;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE3:
                secureRegAddr[0] = 0x1502212C;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE4:
                secureRegAddr[0] = 0x15022138;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE5:
                secureRegAddr[0] = 0x15022144;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE6:
                secureRegAddr[0] = 0x15022150;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE7:
                secureRegAddr[0] = 0x1502215C;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE8:
                secureRegAddr[0] = 0x15022168;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE9:
                secureRegAddr[0] = 0x15022174;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE10:
                secureRegAddr[0] = 0x15022180;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE11:
                secureRegAddr[0] = 0x1502218C;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE12:
                secureRegAddr[0] = 0x15022198;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE13:
                secureRegAddr[0] = 0x150221A4;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
            case ISP_DRV_DIP_CQ_THRE14:
                secureRegAddr[0] = 0x150221B0;
                planeOffset[0] = m_ISPConfig.drvinfo.DesCqOft;
                memSize[0] = m_ISPConfig.drvinfo.cqSecSize - m_ISPConfig.drvinfo.DesCqOft;
                command.secure(CMDQ_ENG_ISP_LCEI, flag, secureRegAddr, DP_SECURE, m_ISPConfig.drvinfo.cqSecHdl, offset, memSize, planeOffset);
                break;
    ...
    MM_REG_WRITE_MASK(command, 0x15022230, m_ISPConfig.drvinfo.dip_img2o_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022260, m_ISPConfig.drvinfo.dip_img2bo_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022290, m_ISPConfig.drvinfo.dip_img3o_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x150222C0, m_ISPConfig.drvinfo.dip_img3bo_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x150222F0, m_ISPConfig.drvinfo.dip_img3co_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022320, m_ISPConfig.drvinfo.dip_feo_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022350, m_ISPConfig.drvinfo.dip_mfbo_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022400, m_ISPConfig.drvinfo.dip_imgi_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022430, m_ISPConfig.drvinfo.dip_imgbi_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022460, m_ISPConfig.drvinfo.dip_imgci_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022490, m_ISPConfig.drvinfo.dip_vipi_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x150224C0, m_ISPConfig.drvinfo.dip_vip2i_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x150224F0, m_ISPConfig.drvinfo.dip_vip3i_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022520, m_ISPConfig.drvinfo.dip_dmgi_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022550, m_ISPConfig.drvinfo.dip_depi_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022580, m_ISPConfig.drvinfo.dip_lcei_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x150225B0, m_ISPConfig.drvinfo.dip_ufdi_base_addr, 0xFFFFFFFF, &m_frameConfigLabel[index++]);
                                           ...
                                           DpConfig  &config)
{
    ...
    MM_REG_WRITE_MASK(command, 0x15022230, m_ISPConfig.drvinfo.dip_img2o_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022260, m_ISPConfig.drvinfo.dip_img2bo_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022290, m_ISPConfig.drvinfo.dip_img3o_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x150222C0, m_ISPConfig.drvinfo.dip_img3bo_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x150222F0, m_ISPConfig.drvinfo.dip_img3co_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022320, m_ISPConfig.drvinfo.dip_feo_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022350, m_ISPConfig.drvinfo.dip_mfbo_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022400, m_ISPConfig.drvinfo.dip_imgi_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022430, m_ISPConfig.drvinfo.dip_imgbi_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022460, m_ISPConfig.drvinfo.dip_imgci_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022490, m_ISPConfig.drvinfo.dip_vipi_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x150224C0, m_ISPConfig.drvinfo.dip_vip2i_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x150224F0, m_ISPConfig.drvinfo.dip_vip3i_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022520, m_ISPConfig.drvinfo.dip_dmgi_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022550, m_ISPConfig.drvinfo.dip_depi_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x15022580, m_ISPConfig.drvinfo.dip_lcei_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
    MM_REG_WRITE_MASK(command, 0x150225B0, m_ISPConfig.drvinfo.dip_ufdi_base_addr, 0xFFFFFFFF, NULL, m_frameConfigLabel[index++]);
...
DP_STATUS_ENUM DpWrapper_ISP::onConfigTile(DpCommand &command)
{
    ...
    uint32_t       memSize[3] = {0};
    uint32_t       planeOffset[3] = {0};
    uint32_t       flag = (uint64_t)(1LL<< CMDQ_ENG_ISP_IMGI);
