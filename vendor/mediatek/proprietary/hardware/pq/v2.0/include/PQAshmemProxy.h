...
enum ProxyCustBuffer {
    ...
    PROXY_TDSHP_CUST,
    PROXY_COLOR_CUST,
    PROXY_DRE_TRANSISTION_PREFLOAT_CURVE,
    PROXY_DRE_TRANSISTION_CURTGT_CURVE_FINALlCOEF,
    PROXY_CUST_MAX
};
...
enum ProxyDCBuffer {
    ...
    PROXY_DC_CUST_USERINFO,
    PROXY_DC_CUST_PRETARGETCURVE,
    PROXY_DC_CUST_PREFINALCURVE,
    PROXY_DC_CUST_MAX
};
...
enum ProxyDRETransistionBuffer {
    PROXY_DRE_INFO_BUFFER = 0,
    PROXY_DRE_PREFLOAT_CURVE_BUFFER,
    PROXY_DRE_CURTGT_CURVE_BUFFER,
    PROXY_DRE_TRANSISTION_FINALlCOEF_BUFFER,
    PROXY_DRE_TRANSISTION_DRESKINWGTSET_BUFFER,
    PROXY_DRE_TRANSISTION_MAX
};
