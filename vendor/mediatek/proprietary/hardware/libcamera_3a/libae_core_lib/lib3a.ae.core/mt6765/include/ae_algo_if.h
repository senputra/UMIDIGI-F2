...
#define AE_ALGO_IF_REVISION     8045001
...
public:
    ...
    */
     ...
     */
    virtual MRESULT setEVIdxInfo_v4p0(MUINT32 u4MaxEVidx, MUINT32 u4MinEVidx, MUINT32 u4CurrentEVidx,MUINT32 u4MaxEVidxF, MUINT32 u4MinEVidxF, MUINT32 u4CurrentEVidxF, MBOOL bUpdateLockIdx = MFALSE) = 0;
    /**
     * @brief update AE pline pointer
     * @param [in] AE tuning file
     */
