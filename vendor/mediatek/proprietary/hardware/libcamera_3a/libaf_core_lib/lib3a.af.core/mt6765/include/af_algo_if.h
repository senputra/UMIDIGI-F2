...
#define AF_ALGO_IF_REVISION 8362002
...
public:
     ...
     */
    template <EAAAOpt_T const eAAAOpt>
    static MVOID destroyInstance(MINT32 const i4SensorDev);
    /**
     ...
     */
    virtual MRESULT initAF(AF_INPUT_T const &a_sAFInput, AF_OUTPUT_T &a_sAFOutput) = 0;
     ...
     */
    virtual void    updateAFtableBoundary(MINT32 a_i4InfPos, MINT32 a_i4MacroPos, MINT32 *a_i4TabStr, MINT32 *a_i4TabEnd) = 0;
