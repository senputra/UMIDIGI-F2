...
#include "aaa/aaa_algo_option.h"
#include "aaa/aaa_error_code.h"
#include "debug_exif/aaa/dbg_awb_param.h"
#include "awb_param.h"
...
* @param [out] pAWBStatBufOut AWB statistic data
  @ if you donn't like create IAwbAlgo class instance, you can call this function get AWB Statistic data
*/
MVOID getAWBStat_ext(AWB_INPUT_T &a_rAWBInput, MINT32 i4IsLinearMode, MUINT32 i4WinPixCnt, MINT32 i4WindowNumX, MINT32 i4WindowNumY, MVOID *pAWBStatBufOut);
...
public:
   ...
   /**
    ...
    /**
     * @brief get real time debug info
     * @param [out] AWB_RT_DEBUG_INFO_T AWB debug info; please refer to dbg_awb_param.h
     */
    virtual MRESULT getRTDebugInfo(AWB_RT_DEBUG_INFO_T &a_rAWBRTDebugInfo) = 0;
    ...
    */
    ...
    /**
    * @brief disable AWB multi-frame update; please set it before initAWB() if expect update every frame
    */
    virtual MRESULT disableAWBMultiFrmUpdate() = 0;

    /**
    * @brief print algorithm version info
    */
