...
LOCAL_SHARED_LIBRARIES_64 := libutils libcutils liblog lib3a.log lib3a.awb libcamalgo.utility
...
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_TAGS := optional
LOCAL_SHARED_LIBRARIES := libutils libcutils liblog lib3a.log lib3a.awb libcamalgo.utility
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/include
LOCAL_MULTILIB := 32
