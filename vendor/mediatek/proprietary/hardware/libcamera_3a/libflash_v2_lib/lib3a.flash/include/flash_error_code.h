...
#ifndef FLASH_ERROR_CODE_H
#define FLASH_ERROR_CODE_H

/*!
    \file flash_error_code.h
    \brief Flash error code header file
    \version 0.1
    \date 2019-12-18
*/
...
///////////////////////////////////////////////////////////////////////////
#define FLASH_ERROR_CODE_DEFINE(modid, errid) \
   ((MINT32)                            \
    ((MUINT32)(0x80000000) |            \
...
#define FLASH_OK_CODE_DEFINE(modid, okid)   \
   ((MINT32)                          \
    ((MUINT32)(0x00000000) |          \
    (MUINT32)((modid & 0x7f) << 24) | \
    (MUINT32)(okid & 0xffff))         \
...
#define MTKFLASH_OKCODE(errid)     FLASH_OK_CODE_DEFINE(MODULE_MTK_FLASH, errid)
#define MTKFLASH_ERRCODE(errid)    FLASH_ERROR_CODE_DEFINE(MODULE_MTK_FLASH, errid)
