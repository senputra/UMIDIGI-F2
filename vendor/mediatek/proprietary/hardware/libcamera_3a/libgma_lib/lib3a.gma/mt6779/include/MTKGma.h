...
*/
#define GMA_ALGO_CHIP_VERSION       (6779)
...
typedef enum
{
    ...
    MTKGMA_FEATURE_GET_GGMD1_RESULT,	// feature id to get result ggmd1
    MTKGMA_FEATURE_GET_IGGMD1_RESULT,	// feature id to get result iggmd1
    MTKGMA_FEATURE_GET_RESULT,	// feature id to get result ggmd3
...
#define GMA_AE_HISTOGRAM_BIN            (256)
