...
LOCAL_MODULE := $$(notdir $$(LOCAL_MODULE:.24.50.208.504=))
LOCAL_SRC_FILES := $(2)
...
#$(info NN_INSTALL_SERVICE\($(1), $(2)\), $(3))
# $1: arch type   ex: 32 or 64
# $2: target path ex: eng/android.nnservice or eng64/android.nnservice
include $$(CLEAR_VARS)
LOCAL_INIT_RC :=  $(2).rc
LOCAL_MULTILIB := $(1)
LOCAL_MODULE := $$(notdir $(2))
...
$(call GPU_INSTALL_FIRM,$(1),$(2)/rgx.fw.24.50.208.504)
...
$(call GPU_INSTALL_LIB,$(1),$(2)/libtqvalidate.so)
# For OCL
...
#ifeq ($(1),NO_COPY_HERE_COPY_BY_GPU_NN_LIB) # only for 64-bit
ifeq ($(1),64) # only for 64-bit
