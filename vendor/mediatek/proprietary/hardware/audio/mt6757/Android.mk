...
LOCAL_SRC_FILES+= \
    ...
    $(LOCAL_COMMON_PATH)/utility/audio_memory_control.c \
...
#    LOCAL_CFLAGS += -DAUDIO_UTIL_PULSE_LEVEL=16000
    ...
    LOCAL_C_INCLUDES += \
        ...
        $(MTK_PATH_SOURCE)/external/aurisys/utility \
...
LOCAL_SRC_FILES += $(LOCAL_COMMON_PATH)/V3/aud_drv/audio_messenger_ipi.c
