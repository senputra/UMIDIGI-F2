...
LOCAL_CFLAGS += -DPCM_DEEP_BUFFER=\"Playback_2\"

# For New DC Trim Calibration Flow
LOCAL_CFLAGS += -DNEW_PMIC_DCTRIM_FLOW

# Record lock time out information
LOCAL_CFLAGS += -DMAX_RAW_DATA_LOCK_TIME_OUT_MS=6000
LOCAL_CFLAGS += -DMAX_PROCESS_DATA_LOCK_TIME_OUT_MS=6000
...
# speech bt_spk dual path device
# only support cvsd bt, not for merge interface bt path
MTK_BT_SPK_DUAL_PATH_SUPPORT = no

# voice mixer
MTK_SPEECH_VOICE_MIXER_SUPPORT = yes
...
#LOCAL_CFLAGS += -DSPEECH_PMIC_RESET_DCC
#LOCAL_CFLAGS += -DSPEECH_PMIC_RESET_ACC
