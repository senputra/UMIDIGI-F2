...
// External SIM [Start]
#ifndef __RMC_VSIM_URC_HANDLER_H__
#define __RMC_VSIM_URC_HANDLER_H__
...
private:
    ...
    void handleVsimAuthEventDetected (const sp<RfxMclMessage>& msg);
};
#endif /* __RMC_VSIM_URC_HANDLER_H__ */
// External SIM [End]
