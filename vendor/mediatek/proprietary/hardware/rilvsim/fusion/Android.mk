...
LOCAL_SRC_FILES:= \
    RmcVsimRequestHandler.cpp \
    RmcVsimUrcHandler.cpp

LOCAL_SHARED_LIBRARIES := libutils librilfusion libmtkrilutils librilutils libmtkrillog libssl libcrypto liblog
...
LOCAL_C_INCLUDES += $(TOP)/system/core/include/utils \
    ...
    $(TOP)/$(MTK_PATH_SOURCE)/hardware/ril/libratconfig/include \
