...
public class ApnPreferenceController extends TelephonyBasePreferenceController implements
    ...
    public int getAvailabilityStatus(int subId) {
        ...
        final boolean showCdmaApn = true;
//        final boolean showCdmaApn = (carrierConfig == null
...
//                        CarrierConfigManager.KEY_SHOW_APN_SETTING_CDMA_BOOL));
        ...
        final boolean showGsmApn  = (carrierConfig == null
                ? false : carrierConfig.getBoolean(
                        CarrierConfigManager.KEY_APN_EXPAND_BOOL));
        final boolean isCdmaApn = isCdmaOpt && showCdmaApn;
        final boolean isGsmApn = isGsmOpt && showGsmApn;
        /// @}
        ...
        Log.i(TAG, "getAvailabilityStatus, subId=" + subId
                + ", isCdmaApn=" + isCdmaApn + ", isGsmApn=" + isGsmApn
                + ", isCdmaOpt=" + isCdmaOpt + ", showCdmaApn=" + showCdmaApn
                + ", isGsmOpt=" + isGsmOpt + ", showGsmApn=" + showGsmApn
                + ", hideCarrierNetwork=" + hideCarrierNetwork);
    ...
    public void updateState(Preference preference) {
        ...
        ((RestrictedPreference) mPreference).setDisabledByAdmin(
                MobileNetworkUtils.isDpcApnEnforced(mContext)
                        ...
                        : null);
        /// M: Add more condition for enabled state.
        mPreference.setEnabled(mPreference.isEnabled()
