...
import com.mediatek.settings.network.PlmnSettings;
import com.mediatek.settings.network.PlmnEditor;
/// @}
/// M: Add for Smart call fwd settings. @{
...
public class SettingsGateway {
    ...
    public static final String[] ENTRY_FRAGMENTS = {
            ...
            /// M: Add for PLMN list setting. @{
            PlmnSettings.class.getName(),
            PlmnEditor.class.getName(),
            /// @}
