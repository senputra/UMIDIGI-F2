...
public abstract class DashboardFragment extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        /// M: Handle the case when when current activity is null  @{
        final Activity activity = getActivity();
        if(activity == null)
        {
          Log.d(TAG, "Current activity is null, returning");
          return;
        }
        /// M: @}
    ...
    public void onDestroy() {
      super.onDestroy();
      if (mSummaryLoader != null) {
          Log.d(TAG, "Release SummaryLoader and its Handler thread");
