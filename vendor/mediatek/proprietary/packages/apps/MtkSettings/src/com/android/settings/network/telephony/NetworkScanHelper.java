...
/// M: Add for cancelling available networks.
import com.mediatek.telephony.MtkTelephonyManagerEx;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;
/// M: Add for handle the empty operators case.
...
public class NetworkScanHelper {
    ...
    public void stopNetworkQuery() {
        ...
        if (mNetworkScanFuture != null) {
            ...
            mNetworkScanFuture = null;
            /// M: Add for cancelling available networks. @{
            MtkTelephonyManagerEx.getDefault().cancelAvailableNetworks(
        ...
        public void run() {
            ...
            if (result.getStatus() == CellNetworkScanResult.STATUS_SUCCESS) {
                ...
                if (result.getOperators() == null
                        || result.getOperators().isEmpty()) {
                    final List<CellInfo> emptyCellInfos = new ArrayList<CellInfo>();
                    Log.d(TAG, "Sync network scan completed, cellInfos is empty.");
                    mCallback.set(emptyCellInfos);
                    return;
                }
                /// @}
