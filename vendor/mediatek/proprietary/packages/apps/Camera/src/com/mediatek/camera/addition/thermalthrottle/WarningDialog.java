...
public class WarningDialog {
     ...
     */
    public WarningDialog(ICameraContext app) {
        mApp = app;
    ...
    public void uninitView() {
        if (mRoot != null) {
            mApp.getCameraAppUi().getNormalViewLayer().removeView(mRoot);
        }
    }
    ...
    private void initView() {
        if (mRoot == null) {
            ...
            int button = mActivity.getResources().getIdentifier("alert_dialog_button", "id",
                    mActivity.getPackageName());
            mRoot = (RelativeLayout) mActivity.getLayoutInflater().inflate(layout, null);
            mApp.getCameraAppUi().getNormalViewLayer().addView(mRoot);
