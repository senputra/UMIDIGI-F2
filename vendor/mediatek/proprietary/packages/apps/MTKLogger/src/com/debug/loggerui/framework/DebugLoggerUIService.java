...
public class DebugLoggerUIService extends Service {
    ...
    public void onCreate() {
        ...
        registerReceiver(mUSBStatusReceiver, mUSBStatusIntentFilter, "android.permission.SET_DEBUG_APP",
                null);
        ...
        registerReceiver(mStorageStatusReceiver, mSDStatusIntentFilter, "android.permission.SET_DEBUG_APP",
                null);
        ...
        registerReceiver(mStorageStatusReceiver, mPhoneStorageIntentFilter,
                "android.permission.SET_DEBUG_APP", null);
        ...
        registerReceiver(mShutdonwReceiver, shutdownIntentFilter, "android.permission.SET_DEBUG_APP", null);
        ...
        registerReceiver(mTimeChangedReceiver, timeChangedIntentFilter, "android.permission.SET_DEBUG_APP",
                null);

        if (Utils.isDeviceOwner()) {
            IntentFilter btFilter = new IntentFilter();
            btFilter.addAction(BluetoothAdapter.ACTION_STATE_CHANGED);
            registerReceiver(mBTStateChangedReceiver, btFilter, "android.permission.SET_DEBUG_APP", null);
        }
