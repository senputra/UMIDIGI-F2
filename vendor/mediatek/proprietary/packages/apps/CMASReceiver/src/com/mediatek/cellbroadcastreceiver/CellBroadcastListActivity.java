...
//                .cancel(CMASPresentationService.NOTIFICATION_ID);
//
//        clearNotification(
//            getIntent().getBooleanExtra(CMASAlertFullWindow.FROM_NOTIFICATION_EXTRA, false));

        if (CellBroadcastAlertDialog.getInstance() != null) {
            Log.d(TAG, "CellBroadcastListActivity oncreate dismissAll...");
            CellBroadcastAlertDialog.getInstance().dismissAll();
        }
    }
...
//        showWindow.showView(cbm, msgRowId, false);
        Intent i = new Intent(CellBroadcastListActivity.this, CellBroadcastAlertDialog.class);
...
//        if (intent.getBooleanExtra(CMASAlertFullWindow.FROM_NOTIFICATION_EXTRA, false)) {
            //clear notification
//            clearNotification(
//                getIntent().getBooleanExtra(CMASAlertFullWindow.FROM_NOTIFICATION_EXTRA, false));
...
//            dismissAllDialogShow();
            if (CellBroadcastAlertDialog.getInstance() != null) {
                Log.d(TAG, "CellBroadcastListActivity onNewIntent dismissAll...");
                CellBroadcastAlertDialog.getInstance().dismissAll();
            }
//        }
    }
