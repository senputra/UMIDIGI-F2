...
public class CMASPresentationService extends Service {
    ...
    private static NotificationChannel mDefaultNotificationChannel;
    private static final String CHANNEL_ID = "cmas_channel";
    private static final String CHANNEL_NAME = "cmas_channel";
...
//        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        ...
        if (message.isCmasMessage()) {
            ...
            duration = Integer.parseInt(ALERT_SOUND_DEFAULT_DURATION) * 1000;
        }
        ...
        notifyIntent.putExtra(CMASAlertFullWindow.FROM_NOTIFICATION_EXTRA, true);
        ...
        if (!CmasConfigManager.isTwProfile()) {
            ...
            notificationManager.createNotificationChannel(mDefaultNotificationChannel);
