...
#define TP_FEATURE_COMBINATION_MULTICAM        (NO_FEATURE_NORMAL)
#define TP_FEATURE_COMBINATION_YUV_REPROCESS   (NO_FEATURE_NORMAL   | MTK_FEATURE_NR| TP_FEATURE_FB)
#define TP_FEATURE_COMBINATION_RAW_REPROCESS   (NO_FEATURE_NORMAL   | MTK_FEATURE_NR| MTK_FEATURE_CZ| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DCE| TP_FEATURE_FB)
#define TP_FEATURE_COMBINATION_PRO             (NO_FEATURE_NORMAL   | MTK_FEATURE_NR| MTK_FEATURE_CZ| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DCE)
#define TP_FEATURE_COMBINATION_SUPER_NIGHT_RAW_REPROCESS (NO_FEATURE_NORMAL | MTK_FEATURE_NR| MTK_FEATURE_CZ| MTK_FEATURE_DRE| MTK_FEATURE_HFG| MTK_FEATURE_DCE| TP_FEATURE_FB)
...
#define TP_FEATURE_COMBINATION_VIDEO_NORMAL       (MTK_FEATURE_FB|MTK_FEATURE_ASYNC_ASD|TP_FEATURE_FB|TP_FEATURE_ASYNC_ASD)
#define TP_FEATURE_COMBINATION_VIDEO_NORMAL_VIDEO (MTK_FEATURE_FB|MTK_FEATURE_ASYNC_ASD|TP_FEATURE_FB|TP_FEATURE_ASYNC_ASD|MTK_FEATURE_EIS|TP_FEATURE_EIS)
#define TP_FEATURE_COMBINATION_VIDEO_DUAL_YUV     (MTK_FEATURE_FB|MTK_FEATURE_ASYNC_ASD|MTK_FEATURE_DUAL_YUV|TP_FEATURE_FB|TP_FEATURE_ASYNC_ASD|TP_FEATURE_DUAL_YUV)
...
#define TP_FEATURE_COMBINATION_VIDEO_DUAL_FOVA    (MTK_FEATURE_FB||TP_FEATURE_FB)
// ======================================================================================================
//
/******************************************************************************
 *
...
const std::vector<std::unordered_map<int32_t, ScenarioFeatures>>  gCustomerScenarioFeaturesMaps =
{
    // openId = 0
    {
        ...
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL, NO_FEATURE_NORMAL)
        CAMERA_SCENARIO_END
        //
        ...
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL, TP_FEATURE_COMBINATION_SUPER_NIGHT_RAW_REPROCESS)
        CAMERA_SCENARIO_END
        //
        ...
        ADD_CAMERA_FEATURE_SET(NO_FEATURE_NORMAL, TP_FEATURE_COMBINATION_VIDEO_NORMAL_VIDEO)
        CAMERA_SCENARIO_END
        //
...
) -> bool
{
    ...
    if (scenarioHint.captureScenarioIndex > 0) {  // force by vendor tag (ex:Pro mode))
        ...
        if (scenarioHint.dualDevicePath == static_cast<int32_t>(DualDevicePath::Feature)) {
            ...
            MY_LOGE("Unknow dual device path scenario!");
        }
    }
    else {
...
{
    if(scenarioHint.isVideoMode)
    {
        MUINT32 margin = (MUINT32)::property_get_int32("vendor.debug.scenario.s.eisMargin", 0);
        if(margin)
        {
            scenarioConfig.fixedMargins.push_back(margin);
        }
    }
...
)
{
    ...
    return customer_get_streaming_scenario(scenario, scenarioHint, pAppMetadata) &&
           customer_get_features_table_by_scenario(openId, scenario, scenarioFeatures) &&
           customer_get_streaming_config(scenario, scenarioFeatures, scenarioConfig, openId, scenarioHint, pAppMetadata);
}
