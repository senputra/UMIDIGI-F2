...
#include "../def/ImageFormat.h"
#include "../def/ImageBufferInfo.h"
...
public:     ////
    ...
    virtual MBOOL                   lockBuf(
                                        ...
                                        MINT usage = eBUFFER_USAGE_HW_TEXTURE | eBUFFER_USAGE_SW_READ_OFTEN
                                    )                                           = 0;
...
{
public:
    ImgBufCreator(MINT manualFormat = eImgFmt_UNKNOWN)
    {
...
public:     ////
     ...
     */
    virtual IImageBuffer*           createImageBuffer(ImgBufCreator* pCreator = NULL)                    = 0;
...
public:     ////                    Params for Allocations.
                                    ...
                                    size_t  bufCustomSizeInBytes[3];// the buffer size that caller wants to specifiy manually, usually use for vertical padding, can be 0.
                                    size_t  bufReusableSizeInBytes[3];// the buffer size that caller wants to reuse, usually use for vertical padding, can be 0.
                                            //
