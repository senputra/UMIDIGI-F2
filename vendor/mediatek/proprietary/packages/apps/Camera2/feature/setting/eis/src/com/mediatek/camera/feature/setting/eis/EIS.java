    ...
    private EISSettingView.OnEISViewListener mEISViewListener
        ...
        public void onItemViewClick(boolean isOn) {
            ...
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    EISCaptureRequestConfig eisCaptureRequestConfig = (EISCaptureRequestConfig) mSettingChangeRequester;

                    mSettingController.postRestriction(
                            EisRestriction.getsNorRelationGroup().getRelation(value, true));
