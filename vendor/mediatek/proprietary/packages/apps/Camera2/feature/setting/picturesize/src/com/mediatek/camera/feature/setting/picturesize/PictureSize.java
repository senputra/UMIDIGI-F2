...
public class PictureSize extends SettingBase implements
    ...
    public void onValueInitialized(List<String> supportedPictureSize) {
        ...
        if ("com.mediatek.camera.feature.mode.matrix.MatrixMode".equals(mModeKey)
                || "com.mediatek.camera.feature.mode.vfacebeauty.VendorFaceBeautyMode".equals(mModeKey)
                || "com.mediatek.camera.feature.mode.facebeauty.FaceBeautyMode".equals(mModeKey)) {
            ...
            LogHelper.d(TAG, "[onValueInitialized], GPU Mode, after check, supportedPictureSize:"
                    + supportedPictureSize);
        }
        if("com.mediatek.camera.feature.mode.hdr.HdrMode".equals(mModeKey)){
            List<String> supportedPictureSizeAfterCheck = new ArrayList<String>();
            for (String pictureSize : supportedPictureSize) {
