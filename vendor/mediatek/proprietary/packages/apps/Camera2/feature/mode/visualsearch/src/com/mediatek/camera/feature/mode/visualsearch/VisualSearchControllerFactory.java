...
public class VisualSearchControllerFactory {
     ...
     */
    @Nonnull
    public IVisualSearchDeviceController createDeviceController(
            @Nonnull Activity activity,
            @Nonnull CameraDeviceManagerFactory.CameraApi cameraApi,
            @Nonnull ICameraContext context) {
        return new VisualSearchDevice2Controller(activity, context);
    }
}
