...
public class FaceBeautyRestriction {

    private static RelationGroup sRelationGroup = new RelationGroup();

    static {
        sRelationGroup.setHeaderKey(
                "com.mediatek.camera.feature.mode.facebeauty.FaceBeautyMode");
        sRelationGroup.setBodyKeys("key_hdr,key_dng,key_zsd,key_white_balance,key_anti_flicker," +
        ...
        sRelationGroup.addRelation(
                new Relation.Builder("com.mediatek.camera.feature.mode.dof.DofMode", "on")
