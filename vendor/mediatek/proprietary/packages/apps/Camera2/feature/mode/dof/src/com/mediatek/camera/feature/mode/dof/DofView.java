...
public class DofView {
    ...
    private static final long PROGRESS_DELAY_TIME = 500;
    ...
    private void initView() {
        ...
        mSdofLayout = (RotateLayout) mApp.getActivity().getLayoutInflater()
                .inflate(R.layout.dof_view,
                        mRootViewGroup, false).findViewById(R.id.dof_rotate_layout);
        mSdofView = (RelativeLayout) mSdofLayout.findViewById(R.id.dof_bottom_controls);
        mTextView = (TextView) mSdofLayout.findViewById(R.id.dof_text_view);
        mDofBar = (SeekBar) mSdofLayout.findViewById(R.id.dof_bar);
        mDofBar.setVisibility(View.VISIBLE);
        mDofBar.setIndeterminate(false);
        mDofBar.setOnSeekBarChangeListener(mChangeListener);
        LogHelper.i(TAG, "[setProgress] = " + mProgress);
        mDofBar.setProgress(mProgress);
        mRootViewGroup.addView(mSdofLayout);
    }

    private void unInitView() {
        mProgress = mLevel * PROGRESS_MAX / LEVEL_DEFAULT;
    ...
    private SeekBar.OnSeekBarChangeListener mChangeListener
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
            ...
            int wantToLevel = Math.round(progress * LEVEL_DEFAULT / PROGRESS_MAX);
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            ...
            mLevel = Math.round(mProgress * LEVEL_DEFAULT / PROGRESS_MAX);
