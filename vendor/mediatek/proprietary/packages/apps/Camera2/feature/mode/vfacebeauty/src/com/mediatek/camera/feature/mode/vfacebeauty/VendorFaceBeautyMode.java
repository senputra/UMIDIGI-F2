...
public class VendorFaceBeautyMode extends CameraModeBase
        implements IVendorFaceBeautyDeviceController.CaptureDataCallback,
        IVendorFaceBeautyDeviceController.DeviceCallback,
        IVendorFaceBeautyDeviceController.PreviewSizeCallback,
        IMemoryManager.IMemoryListener {
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(VendorFaceBeautyMode.class.getSimpleName());
    ...
    protected IVendorFaceBeautyDeviceController mIDeviceController;
    ...
    private VendorFaceBeautyView mFaceBeautyView;
    ...
    public void init(@Nonnull IApp app, @Nonnull ICameraContext cameraContext,
        ...
        mIDeviceController = new VendorFaceBeautyDeviceController(app.getActivity(),
                mICameraContext);
        ...
        mFaceBeautyView = new VendorFaceBeautyView(app, Integer.valueOf(mCameraId),
                mICameraContext, mModeHandler);
...
//        }
    ...
    public void onDataReceived(
            IVendorFaceBeautyDeviceController.DataCallbackInfo dataCallbackInfo) {
    ...
    private void prepareAndOpenCamera(boolean needOpenCameraSync, String cameraId,
        ...
        //prepare device info.
        VendorFaceBeautyDeviceInfo info = new VendorFaceBeautyDeviceInfo();
