...
import com.mediatek.omacp.ext.IOmacpExt;
...
public class OmacpMessageNotification {
    ...
    private static final String[] OMACP_STATUS_PROJECTION = new String[] {
            ...
            OmacpProviderDatabase.SUMMARY, OmacpProviderDatabase.SUB_ID
    };
    ...
    private static final int COLUMN_SUBID = 4;
    ...
    public static final String OMACP_NOTIFICATION_CHANNEL =
                      "omacp_notification_channel";
    ...
    private static final class OmacpNotificationInfo {
        ...
        public OmacpNotificationInfo(Intent clickIntent, String description, int iconResourceId,
                CharSequence ticker, long timeMillis, String title, int subId, int count) {
        ...
        public void deliver(Context context, boolean isNew, int count, int uniqueThreads) {
            updateNotification(context, mClickIntent, mDescription, mIconResourceId, isNew,
                    (isNew ? mTicker : null), // only display the ticker if the
                                              // message is new
                    mTimeMillis, mTitle, mSubId, count, uniqueThreads);
        }
    ...
    public static final OmacpNotificationInfo getOmacpNewMessageNotificationInfo(Context context) {
        ...
        try {
            ...
            int subId = cursor.getInt(COLUMN_SUBID);

            OmacpNotificationInfo info = getNewMessageNotificationInfo(context, messageId, title,
                    summary, messageType, R.drawable.status_notify, timeMillis, subId,
                    cursor.getCount());
            return info;
        } finally {
            cursor.close();
    ...
    private static OmacpNotificationInfo getNewMessageNotificationInfo(Context context,
            ...
            long timeMillis, int subId, int count) {
    ...
    public static void cancelNotification(Context context, int notificationId) {
        ...
        nm.createNotificationChannel(new NotificationChannel(
                OMACP_NOTIFICATION_CHANNEL, OMACP_NOTIFICATION_CHANNEL, nm.IMPORTANCE_DEFAULT));
    ...
    private static void updateNotification(Context context, Intent clickIntent, String description,
            ...
            int subId, int messageCount, int uniqueThreadCount) {

        SharedPreferences sp = null;
        Context otherAppContext = null;
        if (OmacpUtils.isPackageExisted(context, "com.android.mms")) {
            try {
            ...
            sp = otherAppContext.getSharedPreferences("com.android.mms_preferences",
        ...
        Notification notification = builder.setContentIntent(pendingIntent)
                    .setSmallIcon(iconRes).setTicker(ticker).setWhen(timeMillis)
        ...
        if (isNew) {
            ...
            IOmacpExt plugin = OmacpUtils.getPluginInstance(context);
            String ringtoneStr = null;
            if (OmacpUtils.isPackageExisted(context, "com.android.mms")) {
                ringtoneStr = sp.getString(plugin.getRingtoneKey(NOTIFICATION_RINGTONE, subId),
                    null);
            }
            else {
                ringtoneStr = "";
