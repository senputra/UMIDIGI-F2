...
import com.mediatek.omacp.utils.OmacpUtils;
...
public class OmacpMessageList extends ListActivity {
    ...
    private boolean capabilities_captured = false;
    ...
    private static final String[] ALL_MESSAGES_PROJECTION = {
            OmacpProviderDatabase._ID, OmacpProviderDatabase.SUB_ID, OmacpProviderDatabase.SENDER,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(mResultReceiver,
                        new IntentFilter(APP_CAPABILITY_RESULT_ACTION),
    ...
    protected void onStart() {
        super.onStart();
        MTKlog.d(TAG, "OmacpMessageList onStart.");
    ...
    protected void onResume() {
        MTKlog.d(TAG, "OmacpMessageList onResume.");
        super.onResume();
    }
    ...
    protected void onStop() {
        ...
        MTKlog.d(TAG, "OmacpMessageList onStop.");
        super.onStop();
        //mListAdapter.changeCursor(null);
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        // created.
        MTKlog.d(TAG, "OmacpMessageList onNewIntent.");
        startAsyncQuery();
    }
    ...
    private final BroadcastReceiver mResultReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(APP_CAPABILITY_RESULT_ACTION)) {
                ...
                MTKlog.d(TAG, "OmacpMessageList mResultReceiver received capability, appid is : " + appId);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        menu.clear();
        MTKlog.d(TAG, "OmacpMessageList onPrepareOptionsMenu count = " + mListAdapter.getCount());
    ...
    private final OmacpMessageListAdapter.OnContentChangedListener mContentChangedListener =
        ...
        public void onContentChanged(OmacpMessageListAdapter adapter) {
            MTKlog.d(TAG, "OmacpMessageList onContentChanged.");
            startAsyncQuery();
        }
    };
    ...
    private final class MessageListQueryHandler extends AsyncQueryHandler {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            if (token == MESSAGE_LIST_QUERY_TOKEN) {
                MTKlog.d(TAG, "OmacpMessageList onQueryComplete cursor count = " + cursor.getCount());
        ...
        protected void onDeleteComplete(int token, Object cookie, int result) {
            if (token == DELETE_MESSAGE_TOKEN) {
                ...
                // be deleted.
                MTKlog.e(TAG, "OmacpMessageList onDeleteComplete begin");
    ...
    private static void blockingMarkAllMessagesAsSeen(final Context context) {
        ...
        MTKlog.d(TAG, "OmacpMessageList mark " + count + " messages as seen.");
        if (count == 0) {
            return;
        }
    ...
    private void openMessage(long messageId) {
        MTKlog.d(TAG, "OmacpMessageList openMessage id = " + messageId);
        Boolean mms_exist = OmacpUtils.isPackageExisted(this, "com.android.mms");
        if (!mms_exist || capabilities_captured) {
            startActivity(OmacpMessageSettingsDetail.createIntent(this, messageId));
        } else {
            Toast.makeText(this, getString(R.string.not_ready_msg),
