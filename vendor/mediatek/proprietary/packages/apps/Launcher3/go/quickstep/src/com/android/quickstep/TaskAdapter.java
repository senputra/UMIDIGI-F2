...
public final class TaskAdapter extends Adapter<ViewHolder> {
    ...
    public static final int MAX_TASKS_TO_DISPLAY = is512mDevice() ? 3 : 6;;
    ...
    /**
    * Judge whether the device memory is 512M.
    */
    public static boolean is512mDevice(){
         return getTotalMemory() < 512 * 1024;
    }
    /**
    *Get the total memory of the current system.
    */
    public static long getTotalMemory() {
            MemInfoReader memInfo = new MemInfoReader();
            memInfo.readMemInfo();
            long[] meminfoRaw = memInfo.getRawInfo();
            return meminfoRaw[Debug.MEMINFO_TOTAL];
    }
