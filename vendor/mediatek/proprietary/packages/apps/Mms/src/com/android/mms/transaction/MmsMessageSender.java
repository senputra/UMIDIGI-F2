...
public class MmsMessageSender implements MessageSender {
    ...
    public static void sendReadRec(Context context, String to,
        ...
        // check if the read report has been send before.
        String selection = Mms.MESSAGE_TYPE + " = " + MtkPduHeaders.MESSAGE_TYPE_READ_REC_IND
                + " and " + Mms.MESSAGE_ID + " = \"" + messageId + "\"";
        Cursor cursor = SqliteWrapper.query(context, context.getContentResolver(),
                Mms.CONTENT_URI, new String[] { Mms._ID }, selection, null, null);
        try {
