    ...
    public void onClick(View view) {
        ...
        if (view == mContinueButton) {
            ...
            if (manager.isCtaSupported()) {
                ...
                // Save apps that clicked confirm buttom
                // to update permission review flag in whitelistAllSystemAppPermissions
                PackageInfo packageInfo = getArguments().getParcelable(EXTRA_PACKAGE_INFO);
                ...
                Log.d(LOG_TAG, "hasConfirmedPkgName: " + pkgName
                         + ", CurrentPkgName: " + packageInfo.packageName);
