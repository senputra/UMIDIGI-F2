...
public class KeyguardPasswordView extends KeyguardAbsKeyInputView
    ...
    protected void resetState() {
        ...
        // pausing stage.
        // M: Add for CTA.If CTA support,need to enable passwordEntry whether
        // passwordview resume or not.
        CtaManager manager = CtaManagerFactory.getInstance().makeCtaManager();
        if ((!mResumed || !mPasswordEntry.isVisibleToUser()) && !manager.isCtaSupported()) {
            return;
        }
