...
public class InCallPresenter implements CallList.Listener, AudioModeProvider.AudioModeListener {
  ...
  public void setUp(
    ...
    /// M: ALPS05388549, remove listener if needed. @{
    if (this.motorolaInCallUiNotifier != null) {
      removeListener(this.motorolaInCallUiNotifier);
    }
    /// @}
  ...
  private void attemptCleanup() {
    if (isReadyForTearDown()) {
      ...
      if (motorolaInCallUiNotifier != null) {
        removeListener(motorolaInCallUiNotifier);
      }
  ...
  /// M: ALPS05388549, remove listener if needed.
  MotorolaInCallUiNotifier motorolaInCallUiNotifier;
