    ...
    public static ICallLogExt getCallLogExt() {
        if (sCallLogExt == null) {
            synchronized (sLockCallLogExt) {
                if (sCallLogExt == null) {
                    sCallLogExt = OpDialerCustomizationUtils
                            .getOpFactory(sContext).makeCallLogExt();
                    Log.i(TAG, "[getCallLogExt]create ext instance: "
                            + sCallLogExt);
                }
            }
        }
    ...
    public static ICallDetailsExtension getCallDetailsExt() {
        if (sCallDetailsExtension == null) {
            synchronized (sLockCallDetailsExt) {
                if (sCallDetailsExtension == null) {
                    sCallDetailsExtension = OpDialerCustomizationUtils
                            .getOpFactory(sContext).makeCallDetailsExt();
                    Log.i(TAG, "[getCallDetailsExt]create ext instance: "
                            + sCallDetailsExtension);
                }
            }
        }
    ...
    public static IDialerOthersExtension getDialerOthersExtension() {
        ...
        if (sDialerOthersExtension == null) {
            synchronized (sLockDialerOthersExtension) {
                if (sDialerOthersExtension == null) {
                    sDialerOthersExtension = OpDialerCustomizationUtils
                            .getOpFactory(sContext).makeDialerOthersExt();
                    Log.i(TAG, "[getDialerOthersExtension]create ext instance: "
                            + sDialerOthersExtension);
                }
            }
        }
