...
public class DialerSettingsActivity extends AppCompatPreferenceActivity {
  ...
  /// M:for op08 enrich call.
  public IDialerSettingExt mDialerSettingExt;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    /// M:for op08 enrich call.@{
    if (mDialerSettingExt == null) {
      mDialerSettingExt = ExtensionManager.getDialerOthersExtension().getDialerSettingExt(this);
      LogUtil.i("DialerSettingsActivity.onCreate","mDialerSettingExt:" + mDialerSettingExt);
    }
    /// @}
  }
  ...
  public void onBuildHeaders(List<Header> target) {
    ...
    mDialerSettingExt.onBuildHeaders(target);
    /// @}
  }
