...
public interface IAnswerExt {
   ...
   */
  boolean updateRightIconAction(Object obj);

  /**
   * Show menu popup when slid right button in the bottom
   * @param obj the Object of fragment
   */
  void showAdditionMenu(Object obj);
   ...
   */
  boolean handleAdditionSelected(Object obj, CharSequence text);
   ...
   */
  boolean shouldShowCustomizationView(List<CharSequence> items);
}