...
public interface IInCallExt {
   ...
   */
  void onConnectionEvent(Object call, String event, Bundle extras);
   ...
   */
  void addFilterBundle(List<String> intentBundle, List<String> extraBundle);
   ...
   */
  void onAnswer(boolean isUpgrade, Object obj);

  /**
   * Called when details change.
   * @param obj the DialerCall Object
   * @param oldDetails the old call detail
   * @param newDetails the new call detail
   */
  void onCallDetailChanged(Object obj, android.telecom.Call.Details oldDetails,
