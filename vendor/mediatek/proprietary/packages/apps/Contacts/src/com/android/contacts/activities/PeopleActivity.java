...
public class PeopleActivity extends AppCompatContactsActivity implements
    ...
    protected void onPause() {
        Log.i(TAG, "[onPause]");
        mResumed = false;
        /// M: [Google Issue][ALPS04193567] 1/2, better to stop watcher
        /// in onStop() for covering multi-window mode scenario. @{
        ...
        ///[ALPS04782810] close option menu @{
    ...
    protected void onStop() {
        ...
        /// M: [Google Issue][ALPS04193567] 2/2 @{
        mProviderStatusWatcher.stop();
        /// @}
        super.onStop();
        PDebug.End("onStop");
    ...
    public void onAccountViewSelected(ContactListFilter filter) {
        Log.d(TAG, "[onAccountViewSelected] filter=" + filter + ", accountType=" +
                    filter.accountType + ", accountName=" + Log.anonymize(filter.accountName));
        final Intent intent = new Intent();
        intent.putExtra(AccountFilterActivity.EXTRA_CONTACT_LIST_FILTER, filter);
