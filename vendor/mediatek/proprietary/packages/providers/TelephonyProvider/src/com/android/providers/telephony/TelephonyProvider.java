...
import static mediatek.telephony.MtkTelephony.Carriers.APN;
import static mediatek.telephony.MtkTelephony.Carriers.APN_SET_ID;
import static mediatek.telephony.MtkTelephony.Carriers.AUTH_TYPE;
import static mediatek.telephony.MtkTelephony.Carriers.BEARER;
import static mediatek.telephony.MtkTelephony.Carriers.BEARER_BITMASK;
import static mediatek.telephony.MtkTelephony.Carriers.CARRIER_DELETED;
import static mediatek.telephony.MtkTelephony.Carriers.CARRIER_DELETED_BUT_PRESENT_IN_XML;
import static mediatek.telephony.MtkTelephony.Carriers.CARRIER_EDITED;
import static mediatek.telephony.MtkTelephony.Carriers.CARRIER_ENABLED;
import static mediatek.telephony.MtkTelephony.Carriers.CARRIER_ID;
import static mediatek.telephony.MtkTelephony.Carriers.CONTENT_URI;
import static mediatek.telephony.MtkTelephony.Carriers.CONTENT_URI_DM;
import static mediatek.telephony.MtkTelephony.Carriers.CSD_NUM;
import static mediatek.telephony.MtkTelephony.Carriers.CURRENT;
import static mediatek.telephony.MtkTelephony.Carriers.DEFAULT_SORT_ORDER;
import static mediatek.telephony.MtkTelephony.Carriers.EDITED_STATUS;
import static mediatek.telephony.MtkTelephony.Carriers.IMSI;
import static mediatek.telephony.MtkTelephony.Carriers.MAX_CONNECTIONS;
import static mediatek.telephony.MtkTelephony.Carriers.TIME_LIMIT_FOR_MAX_CONNECTIONS;
import static mediatek.telephony.MtkTelephony.Carriers.MCC;
import static mediatek.telephony.MtkTelephony.Carriers.MMSC;
import static mediatek.telephony.MtkTelephony.Carriers.MMSPORT;
import static mediatek.telephony.MtkTelephony.Carriers.MMSPROXY;
import static mediatek.telephony.MtkTelephony.Carriers.MNC;
import static mediatek.telephony.MtkTelephony.Carriers.MODEM_PERSIST;
import static mediatek.telephony.MtkTelephony.Carriers.MTU;
import static mediatek.telephony.MtkTelephony.Carriers.MVNO_MATCH_DATA;
import static mediatek.telephony.MtkTelephony.Carriers.MVNO_TYPE;
import static mediatek.telephony.MtkTelephony.Carriers.NAME;
import static mediatek.telephony.MtkTelephony.Carriers.NAP_ID;
import static mediatek.telephony.MtkTelephony.Carriers.NETWORK_TYPE_BITMASK;
import static mediatek.telephony.MtkTelephony.Carriers.NO_APN_SET_ID;
import static mediatek.telephony.MtkTelephony.Carriers.NUMERIC;
import static mediatek.telephony.MtkTelephony.Carriers.OMACP_ID;
import static mediatek.telephony.MtkTelephony.Carriers.OWNED_BY;
import static mediatek.telephony.MtkTelephony.Carriers.OWNED_BY_DPC;
import static mediatek.telephony.MtkTelephony.Carriers.OWNED_BY_OTHERS;
import static mediatek.telephony.MtkTelephony.Carriers.PASSWORD;
import static mediatek.telephony.MtkTelephony.Carriers.PNN;
import static mediatek.telephony.MtkTelephony.Carriers.PORT;
import static mediatek.telephony.MtkTelephony.Carriers.PPP;
import static mediatek.telephony.MtkTelephony.Carriers.PROFILE_ID;
import static mediatek.telephony.MtkTelephony.Carriers.PROTOCOL;
import static mediatek.telephony.MtkTelephony.Carriers.PROXY;
import static mediatek.telephony.MtkTelephony.Carriers.PROXY_ID;
import static mediatek.telephony.MtkTelephony.Carriers.ROAMING_PROTOCOL;
import static mediatek.telephony.MtkTelephony.Carriers.SERVER;
import static mediatek.telephony.MtkTelephony.Carriers.SKIP_464XLAT;
import static mediatek.telephony.MtkTelephony.Carriers.SKIP_464XLAT_DEFAULT;
import static mediatek.telephony.MtkTelephony.Carriers.SOURCE_TYPE;
import static mediatek.telephony.MtkTelephony.Carriers.SPN;
import static mediatek.telephony.MtkTelephony.Carriers.SUBSCRIPTION_ID;
import static mediatek.telephony.MtkTelephony.Carriers.TYPE;
import static mediatek.telephony.MtkTelephony.Carriers.UNEDITED;
import static mediatek.telephony.MtkTelephony.Carriers.USER;
import static mediatek.telephony.MtkTelephony.Carriers.USER_DELETED;
import static mediatek.telephony.MtkTelephony.Carriers.USER_DELETED_BUT_PRESENT_IN_XML;
import static mediatek.telephony.MtkTelephony.Carriers.USER_EDITABLE;
import static mediatek.telephony.MtkTelephony.Carriers.USER_EDITED;
import static mediatek.telephony.MtkTelephony.Carriers.USER_VISIBLE;
import static mediatek.telephony.MtkTelephony.Carriers.WAIT_TIME_RETRY;
import static mediatek.telephony.MtkTelephony.Carriers._ID;
...
public class TelephonyProvider extends ContentProvider
{
    ...
    // When MTK internal upgrading DB, b value should be increased only.
    private static final int DATABASE_VERSION = (41 << 16) + (1 << 8);
    /// @}
    ...
    /// M: Add for supporting Tethering.
    private static final int URL_PREFERTETHERINGAPN = 51;
    /// M: Add for supporting DM. @{
    private static final int URL_TELEPHONY_DM = 52;
    private static final int URL_ID_DM = 53;
    /// @}
    ...
    static {
        ...
        /// M: Add network_type_bitmask into unique fields.
        CARRIERS_UNIQUE_FIELDS_DEFAULTS.put(NETWORK_TYPE_BITMASK, "0");
        /// M: Add sourcetype into unique fields.
        CARRIERS_UNIQUE_FIELDS_DEFAULTS.put(SOURCE_TYPE, "0");
        /// M: Add omacpid into unique fields.
        CARRIERS_UNIQUE_FIELDS_DEFAULTS.put(OMACP_ID, "");
    ...
    public static String getStringForCarrierTableCreation(String tableName) {
        return "CREATE TABLE " + tableName +
                ...
                MODEM_PERSIST + " BOOLEAN DEFAULT 1," +
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void createCarriersTable(SQLiteDatabase db, String tableName) {
            ...
            /// M: Add for supporting DM. @{
            if (DBG) log("dbh.createDmCarriersTable: " + CARRIERS_DM_TABLE);
            db.execSQL("DROP TABLE IF EXISTS " + CARRIERS_DM_TABLE);
            db.execSQL(getStringForCarrierTableCreation(CARRIERS_DM_TABLE));
            if (DBG) log("dbh.createDmCarriersTable:-");
            /// @}
        }
        ...
        private void initDatabase(SQLiteDatabase db) {
            ...
            try {
                ...
                /// M: Use transaction to loading APNs. @{
                db.beginTransaction();
                try {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            /// M: For ALPS00231650, don't add new fields for version 7. @{
            ...
            /// @}
            /// M: Add new fields for APN. @{
            if (oldVersion < (9 << 16 | 6)) {
                // Add MVNO related fields.
                // The new fields spn and imsi are added based on version 8
                // but the version number is not increased to 9.
                // So, catch the exception issue of inserting duplicate field.
                try {
                    db.execSQL("ALTER TABLE " + CARRIERS_TABLE
            ...
            if (oldVersion < (12 << 16 | 6)) {
                // Add operator field for SIMINFO table.
                try {
                    db.execSQL("ALTER TABLE " + SIMINFO_TABLE
            ...
            /// @}
            /// M: Add new fields that added in AOSP. @{
            ...
            /// @}
            /// M: Add MTK version number into database. @{
            ...
            if (oldVersion < ((26 << 16) + (1 << 8) | 6)) {
                try {
                    ...
                    e.printStackTrace();
                    Log.e(TAG, "Add OMACP column fail with table " + CARRIERS_TABLE + ".");
                }
                oldVersion = (26 << 16) + (1 << 8) | 6;
            }
        ...
        private void copyApnValuesV17(ContentValues cv, Cursor c) {
            ...
            /// M: Get source_type field.
            getIntValueFromCursor(cv, c, SOURCE_TYPE);
            /// M: Get OMACP fields. @{
            getStringValueFromCursor(cv, c, OMACP_ID);
            getStringValueFromCursor(cv, c, NAP_ID);
            getStringValueFromCursor(cv, c, PROXY_ID);
            /// @}
        }
            ...
            if (c != null && mContext.getResources() != null) {
                try {
                    ...
                    while (c.moveToNext()) {
                        ...
                        if (c.getInt(c.getColumnIndex(SOURCE_TYPE)) != 1) {
                            continue;
                        }
        ...
        private ContentValues getRow(XmlPullParser parser) {
            ...
            /// M: Get values in MVNO fields. @{
            addStringAttribute(parser, "spn", map, SPN);
            addStringAttribute(parser, "imsi", map, IMSI);
            addStringAttribute(parser, "pnn", map, PNN);
            addStringAttribute(parser, "ppp", map, PPP);
            /// @}
        ...
        private void loadApns(SQLiteDatabase db, XmlPullParser parser) {
            if (parser != null) {
                try {
                    ...
                    /// M: For ALPS02839078, get default subscription id only once. @{
                    // When switch between multi-user, there will be two phone processes
                    // at the same time for a short while, calling to SubscriptionManager
                    // API may be binder call, which takes a lot of time in "while loop"
                    // and leads ANR, so call it only once here.
        ...
        /// M: For ALPS02839078, avoid calling SubscriptionManager API in "while loop". @{
    ...
    public synchronized Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        switch (match) {
            case URL_TELEPHONY_USING_SUBID: {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("query URL_TELEPHONY_USING_SUBID, subIdString="
                            + subIdString + ", subId=" + subId);
                }
                /// @}
                /// M: Add for revising the SIM operator numeric.
                constraints.add(NUMERIC + " = '"
                        + getSimOperatorNumeric(subId, mTelephonyManager) + "'");
            ...
            case URL_CURRENT_USING_SUBID: {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("query URL_CURRENT_USING_SUBID, subIdString="
                            + subIdString + ", subId=" + subId);
                }
                /// @}
                // TODO b/74213956 turn this back on once insertion includes correct sub id
            ...
            case URL_PREFERAPN_NO_UPDATE_USING_SUBID: {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("query URL_PREFERAPN_USING_SUBID or "
                            + "URL_PREFERAPN_NO_UPDATE_USING_SUBID"
                            + ", subIdString=" + subIdString + ", subId=" + subId);
                }
                /// @}
                // TODO b/74213956 turn this back on once insertion includes correct sub id
                // constraints.add(SUBSCRIPTION_ID + "=" + subIdString);
            ...
            case URL_PREFERAPNSET_USING_SUBID: {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("query URL_PREFERAPNSET_USING_SUBID, subIdString="
                            + subIdString + ", subId=" + subId);
                }
                /// @}
                // TODO b/74213956 turn this back on once insertion includes correct sub id
    ...
    private Cursor getSubscriptionMatchingAPNList(SQLiteQueryBuilder qb, String[] projectionIn,
        ...
        SQLiteDatabase db = getReadableDatabase();
        /// M: Add for revising the SIM operator numeric.
        String mccmnc = getSimOperatorNumeric(subId, tm);
        ...
        /// M: Get the IccRecords according to the phone type. @{
        ...
        while (ret.moveToNext()) {
            ...
            /**
             *  when mvno1!=null,and mvno = gid
             *  need get the gid from 3GPP
             *  So need changed the iccRecords.
             */
            IccRecords iccRecords_3GPP = null;
            String mvnoGidType = ret.getString(mvnoIndex);
            if (DBG) log("mvnoGidType:  " + mvnoGidType);
            if (!TextUtils.isEmpty(mvnoGidType) && mvnoGidType.equalsIgnoreCase("gid")) {
                iccRecords_3GPP = UiccController.getInstance().getIccRecords(
                        SubscriptionManager.getPhoneId(subId), UiccController.APP_FAM_3GPP);
                if (null != iccRecords_3GPP) {
                    if (DBG) log("iccRecords = iccRecords_3GPP");
                    iccRecords = iccRecords_3GPP;
                }
            }
    ...
    public synchronized Uri insert(Uri url, ContentValues initialValues) {
        /// M: Add log. @{
        log("insert, match=" + s_urlMatcher.match(url)
                + ", binderPid=" + Binder.getCallingPid()
        ...
        /// M: Add log. @{
        log("insert, rowId=" + rowAndNotify.first + ", notify=" + rowAndNotify.second);
        /// @}
    ...
    private Pair<Uri, Boolean> insertSingleRow(Uri url, ContentValues initialValues) {
        ...
        switch (match)
        {
            case URL_TELEPHONY_USING_SUBID:
            {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("insertSingleRow URL_TELEPHONY_USING_SUBID, subIdString="
                            + subIdString + ", subId=" + subId);
                }
                /// @}
            }
            ...
            case URL_CURRENT_USING_SUBID:
            {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("insertSingleRow URL_CURRENT_USING_SUBID, subIdString="
                            + subIdString + ", subId=" + subId);
                }
                /// @}
            ...
            case URL_PREFERAPN_NO_UPDATE_USING_SUBID:
            {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("insertSingleRow URL_PREFERAPN_USING_SUBID or "
                            + "URL_PREFERAPN_NO_UPDATE_USING_SUBID"
                            + ", subIdString=" + subIdString + ", subId=" + subId);
                }
                /// @}
            ...
            case URL_TELEPHONY_DM: {
                ...
                values = DatabaseHelper.setDefaultValue(values);
                if (values.containsKey(MCC)
                        && values.containsKey(MNC)) {
                    String mcc = values.getAsString(MCC);
                    String mnc = values.getAsString(MNC);
                    String numeric = mcc + mnc;
                ...
                if (rowID > 0) {
                    result = ContentUris.withAppendedId(CONTENT_URI_DM, rowID);
                    notify = true;
                }
    ...
    public synchronized int delete(Uri url, String where, String[] whereArgs) {
        ...
        /// M: Add log. @{
        log("delete, match=" + match + ", binderPid=" + Binder.getCallingPid()
                + ", binderUid=" + Binder.getCallingUid());
        /// @}
        ...
        switch (match)
        {
            ...
            case URL_TELEPHONY_USING_SUBID:
            {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("delete URL_TELEPHONY_USING_SUBID, subIdString="
                            + subIdString + ", subId=" + subId);
                }
                /// @}
            ...
            case URL_CURRENT_USING_SUBID: {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("delete URL_CURRENT_USING_SUBID, subIdString="
                            + subIdString + ", subId=" + subId);
                }
                /// @}
                // FIXME use subId in query
            ...
            case URL_RESTOREAPN_USING_SUBID: {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("delete URL_RESTOREAPN_USING_SUBID, subIdString="
                            + subIdString + ", subId=" + subId);
                }
                /// @}
            }
            ...
            case URL_PREFERAPN_NO_UPDATE_USING_SUBID: {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("delete URL_PREFERAPN_USING_SUBID or "
                            + "URL_PREFERAPN_NO_UPDATE_USING_SUBID"
                            + ", subIdString=" + subIdString + ", subId=" + subId);
                }
                /// @}
            ...
            case URL_PREFERTETHERINGAPN: {
                ...
                setPreferredApnId((long) -1, subId, true);
                count = 1;
                break;
            }
            /// @}
            ...
            case URL_TELEPHONY_DM: {
                ...
                if (count > 0) {
                    getContext().getContentResolver().notifyChange(CONTENT_URI_DM, null);
                }
                break;
            }
            /// @}
    ...
    public synchronized int update(Uri url, ContentValues values, String where, String[] whereArgs)
    {
        ...
        /// M: Add log. @{
        log("update, match=" + match + ", binderPid=" + Binder.getCallingPid()
                + ", binderUid=" + Binder.getCallingUid());
        /// @}
        ...
        switch (match)
        {
            case URL_TELEPHONY_USING_SUBID:
            {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("update URL_TELEPHONY_USING_SUBID, subIdString="
                            + subIdString + ", subId=" + subId);
                }
                /// @}
                //FIXME use subId in the query
            ...
            case URL_CURRENT_USING_SUBID:
            {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("update URL_CURRENT_USING_SUBID, subIdString="
                            + subIdString + ", subId=" + subId);
                }
                /// @}
                //FIXME use subId in the query
            ...
            case URL_PREFERAPN_NO_UPDATE_USING_SUBID:
            {
                ...
                /// M: Revise log. @{
                if (DBG) {
                    log("update URL_PREFERAPN_USING_SUBID or "
                            + "URL_PREFERAPN_NO_UPDATE_USING_SUBID"
                            + ", subIdString=" + subIdString + ", subId=" + subId);
                }
                /// @}
    ...
    private void restoreDefaultAPN(int subId) {
        ...
        TelephonyManager telephonyManager =
                (TelephonyManager) getContext().getSystemService(Context.TELEPHONY_SERVICE);
        String where = null;
        /// M: Delete all APNs to avoid the ANR. @{
        // If deleting the sub related APNs only, there will be lots of
        // conflicts when loading default the APNs. The restoring progress
        // will take long time and ANR may occur.
    ...
    private String getWhereClauseForRestoreDefaultApn(SQLiteDatabase db, int subId) {
        ...
        TelephonyManager telephonyManager =
                (TelephonyManager) getContext().getSystemService(Context.TELEPHONY_SERVICE);
        /// M: Add for revising the SIM operator numeric.
        String simOperator = getSimOperatorNumeric(subId, telephonyManager);
    ...
    /// M: Add for revising the SIM operator numeric. @{
    private String getSimOperatorNumeric(int subId, TelephonyManager tm) {
        String mccmnc = "";
