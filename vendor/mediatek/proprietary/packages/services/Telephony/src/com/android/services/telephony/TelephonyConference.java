...
public class TelephonyConference extends Conference implements Holdable {
    ...
    private boolean disconnectCall(Connection connection, String pendingCallAction) {
        Call call = getMultipartyCallForConnection(connection, "onDisconnect");
        if (call != null) {
            Log.d(this, "Found multiparty call to hangup for conference, with pending action");
            ...
            Log.d(this, "pendingCallAction = " + pendingCallAction);
                ...
                for (com.android.internal.telephony.Connection conn: call.getConnections()) {
                    if (conn != null && conn.isAlive()) {
                        try {
                            ...
                            Log.e(this, e, "Exception thrown trying to hangup conference member");
                            return false;
                        }
                    }
                }
