...
void config_L2_size()
{
	...
	/*
	 * disable L2 access @ axi1to3 engine.
	 * Set 0x10200600[7:6] from 2’b11 to 2’b01.
	 */

	data = mmio_read_32(0x10200600);
	data &= ~(0x3 << 6);
	data |= (0x1 << 6);
	mmio_write_32(0x10200600, data);
}
#if 0
