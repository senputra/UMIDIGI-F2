...
#define ISRM_RET_IRQ_AUX	(ISRM_RET_IRQ9 | ISRM_RET_IRQ8 | ISRM_RET_IRQ7 | ISRM_RET_IRQ6 | \
				 ISRM_RET_IRQ5 | ISRM_RET_IRQ4 | ISRM_RET_IRQ3 | ISRM_RET_IRQ2 | \
				 ISRM_RET_IRQ1)
...
struct pwr_ctrl {
	...
	uint8_t mcu_ddren_req_dbc_en;
	uint8_t mcu_apsrc_sel;
	uint8_t mm_mask_b;
	...
	uint8_t dsi0_vsync_mask_b;
	uint8_t dsi1_vsync_mask_b;
	uint8_t dpi_vsync_mask_b;
	uint8_t isp0_vsync_mask_b;
	uint8_t isp1_vsync_mask_b;
	uint8_t md_srcclkena_0_infra_mask_b;
	uint8_t md_srcclkena_1_infra_mask_b;
	uint8_t conn_srcclkena_infra_mask_b;
	uint8_t sspm_srcclkena_infra_mask_b;
	...
	/* SPM_SRC2_MASK */
	uint8_t dvfs_halt_mask_b;
	uint8_t vdec_req_mask_b;
	uint8_t gce_req_mask_b;
	uint8_t cpu_md_dvfs_req_merge_mask_b;
	uint8_t md_ddr_en_dvfs_halt_mask_b;
	uint8_t dsi0_vsync_dvfs_halt_mask_b;
	uint8_t dsi1_vsync_dvfs_halt_mask_b;
	uint8_t dpi_vsync_dvfs_halt_mask_b;
	uint8_t isp0_vsync_dvfs_halt_mask_b;
	uint8_t isp1_vsync_dvfs_halt_mask_b;
	uint8_t conn_ddr_en_mask_b;
	uint8_t disp_req_mask_b;
	uint8_t disp1_req_mask_b;
	uint8_t mfg_req_mask_b;
	uint8_t mcu_ddren_req_mask_b;
	...
	uint8_t dramc_spcmd_apsrc_req_mask_b;
	uint8_t emi_boost_dvfs_req_2_mask_b;
	uint8_t emi_bw_dvfs_req_2_mask;
...
extern uint32_t _spm_get_wake_period(int pwake_time, unsigned int last_wr);
