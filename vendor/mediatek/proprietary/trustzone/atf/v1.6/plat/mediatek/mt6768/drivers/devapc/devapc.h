...
#define MASTER_INFRA_SSPM               21
#define MASTER_INFRA_MAX_INDEX          29

#define SLAVE_INFRA_MAX_INDEX           150
#define SLAVE_MM_MAX_INDEX              91
#define SLAVE_MD_MAX_INDEX              31

#define SLAVE_MM2ND_MAX_INDEX		76

#define VIO_MASK_STA_NUM		9
#define SRAMROM_VIO_INDEX		270
