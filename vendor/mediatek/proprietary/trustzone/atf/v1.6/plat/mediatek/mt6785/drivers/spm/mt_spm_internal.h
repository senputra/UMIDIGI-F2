...
/* SPM_POWER_ON_VAL1 */
#define POWER_ON_VAL1_DEF	0x80015850
...
struct pcm_desc {
	...
	uint32_t base_dma;	/* dma addr of base */
	uint32_t pmem_words;
...
struct pwr_ctrl {
	...
	uint8_t reg_spm_mcusys_pwr_event_req;
	...
	uint8_t reg_md_ddr_en2_0_mask_b;
	...
	uint8_t reg_md_ddr_en2_1_mask_b;
	...
	uint8_t reg_conn_ddr_en2_mask_b;
	...
	uint8_t reg_infrasys_ddr_en2_mask_b;
	uint8_t reg_md32_srcclkena_mask_b;
	uint8_t reg_conn_vfe28_req_mask_b;
	...
	uint8_t reg_md32_ddr_en2_mask_b;
	...
	uint8_t reg_scp_ddr_en2_mask_b;
	...
	uint8_t reg_gce_ddr_en2_mask_b;
	uint8_t reg_emi_ch0_ddr_en_mask_b;
	uint8_t reg_emi_ch1_ddr_en_mask_b;
	uint8_t reg_emi_ch0_ddr_en2_mask_b;
	uint8_t reg_emi_ch1_ddr_en2_mask_b;
	...
	uint8_t reg_spm_ddr_en2_reserved_mask_b;
	...
	uint8_t reg_audio_dsp_ddr_en2_mask_b;
	uint8_t reg_mcusys_pwr_event_mask_b;
	...
	uint8_t reg_msdc0_ddr_en2_mask_b;
	uint8_t reg_conn_srcclkenb2pwrap_mask_b;

	/* SPM_SRC4_MASK */
	uint32_t ccif_event_mask_b;
	uint8_t reg_apu_core0_srcclkena_mask_b;
	uint8_t reg_apu_core0_infra_req_mask_b;
	uint8_t reg_apu_core0_apsrc_req_mask_b;
	uint8_t reg_apu_core0_vrf18_req_mask_b;
	uint8_t reg_apu_core0_ddr_en_mask_b;
	uint8_t reg_apu_core1_srcclkena_mask_b;
	uint8_t reg_apu_core1_infra_req_mask_b;
	uint8_t reg_apu_core1_apsrc_req_mask_b;
	uint8_t reg_apu_core1_vrf18_req_mask_b;
	uint8_t reg_apu_core1_ddr_en_mask_b;
	uint8_t reg_apu_core2_srcclkena_mask_b;
	uint8_t reg_apu_core2_infra_req_mask_b;
	uint8_t reg_apu_core2_apsrc_req_mask_b;
	uint8_t reg_apu_core2_vrf18_req_mask_b;
	uint8_t reg_apu_core2_ddr_en_mask_b;
	uint8_t reg_apu_core2_ddr_en2_mask_b;

	/* SPM_SRC5_MASK */
	uint32_t reg_mcusys_merge_apsrc_req_mask_b;
	uint32_t reg_mcusys_merge_ddr_en_mask_b;
	uint32_t reg_mcusys_merge_ddr_en2_mask_b;
	uint8_t reg_apu_core0_ddr_en2_mask_b;
	uint8_t reg_apu_core1_ddr_en2_mask_b;
	uint8_t reg_cg_check_ddr_en_mask_b;
	uint8_t reg_cg_check_ddr_en2_mask_b;
	...
	uint8_t reg_msdc1_ddr_en2_mask_b;
	uint8_t reg_msdc1_srcclkena_ack_mask;
	uint8_t reg_msdc1_infra_ack_mask;
	uint8_t reg_msdc1_apsrc_ack_mask;
	uint8_t reg_msdc1_vrf18_ack_mask;
	uint8_t reg_msdc1_ddr_en_ack_mask;
	uint8_t reg_msdc1_ddr_en2_ack_mask;
	...
	/* MP0_CPU4_WFI_EN */
	uint8_t mp0_cpu4_wfi_en;

	/* MP0_CPU5_WFI_EN */
	uint8_t mp0_cpu5_wfi_en;

	/* MP0_CPU6_WFI_EN */
	uint8_t mp0_cpu6_wfi_en;

	/* MP0_CPU7_WFI_EN */
	uint8_t mp0_cpu7_wfi_en;
...
extern struct spm_lp_scen __spm_dram_bus26m;
extern struct spm_lp_scen __spm_syspll;
