...
static struct pmic_wrap_setting pw = {
	...
	.set[PMIC_WRAP_PHASE_ALLINONE] = {
		._[CMD_0]    = {BUCK_VCORE_ELR0, _BITS_(6:0, VOLT_TO_PMIC_VAL(80000)),},  /* 0.8 V */
		._[CMD_1]    = {BUCK_VCORE_ELR0, _BITS_(6:0, VOLT_TO_PMIC_VAL(75000)),},  /* 0.75 V */
		._[CMD_2]    = {BUCK_VCORE_ELR0, _BITS_(6:0, VOLT_TO_PMIC_VAL(70000)),},  /* 0.7 V */
		._[CMD_3]    = {BUCK_VCORE_ELR0, _BITS_(6:0, VOLT_TO_PMIC_VAL(70000)),},  /* 0.7 V */
		._[CMD_4]    = {BUCK_VCORE_ELR0, _BITS_(6:0, VOLT_TO_PMIC_VAL(65000)),},  /* 0.65 V */
		._[CMD_5]    = {TOP_SPI_CON0, _BITS_(0:0, 1),},
		._[CMD_6]    = {TOP_SPI_CON0, _BITS_(0:0, 0),},
		._[CMD_7]    = {BUCK_VPROC11_CON0, _BITS_(1:0, 0),}, /* Off */
		._[CMD_8]    = {BUCK_VPROC11_CON0, _BITS_(1:0, 1),}, /* Normal */
		._[CMD_9]    = {LDO_VSRAM_PROC11_CON0, _BITS_(1:0, 0),}, /* Off */
		._[CMD_10]   = {LDO_VSRAM_PROC11_CON0, _BITS_(1:0, 1),}, /* Normal */
		._[CMD_11]   = {BUCK_VPROC12_CON0, _BITS_(1:0, 0),}, /* Off */
		._[CMD_12]   = {BUCK_VPROC12_CON0, _BITS_(1:0, 1),}, /* Normal */
		._[CMD_13]   = {LDO_VSRAM_PROC12_CON0, _BITS_(1:0, 0),}, /* Off */
		._[CMD_14]   = {LDO_VSRAM_PROC12_CON0, _BITS_(1:0, 1),}, /* Normal */
		._[CMD_15]   = {BUCK_VPROC11_CON0, _BITS_(1:0, 3),}, /* Low power */
		._[CMD_21]   = {LDO_VSRAM_PROC11_CON0, _BITS_(1:0, 3),}, /* Low power */
		._[CMD_22]   = {BUCK_VPROC12_CON0, _BITS_(1:0, 3),}, /* Low power */
		._[CMD_23]   = {LDO_VSRAM_PROC12_CON0, _BITS_(1:0, 3),}, /* Low power */
		.nr_idx = NR_IDX_ALL,
	},
};
