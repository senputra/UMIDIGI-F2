...
#else
#define WAKE_SRC_FOR_SUSPEND \
	(__WAKE_SRC_FOR_SUSPEND_COMMON__ | WAKE_SRC_R12_SEJ_WDT_GPT_B)
#endif
...
static struct pwr_ctrl suspend_ctrl = {
	...
	.disp0_ddren_mask_b = 0,
	.disp1_ddren_mask_b = 0,
	.gce_ddren_mask_b = 0,
	...
	.spm_wakeup_event_mask = 0xF1782210,
...
static void spm_clean_before_wfi(void)
{
	/* clear SPM_PASR_DPD_0/1 for re-record 26M off time interval */
	mmio_write_32(SPM_PASR_DPD_0, 0);
	mmio_write_32(SPM_PASR_DPD_1, 0);
}
