...
#define MP1_CPU_AVG_STALL_RATIO	(MCUSYS_MP0 + 0x3600)
#define MP1_CPU0_AVG_STALL_RATIO_CTRL	(MCUSYS_MP0 + 0x3604)
#define MP1_CPU1_AVG_STALL_RATIO_CTRL	(MCUSYS_MP0 + 0x3608)
#define MP1_CPU2_AVG_STALL_RATIO_CTRL	(MCUSYS_MP0 + 0x360C)
#define MP1_CPU3_AVG_STALL_RATIO_CTRL	(MCUSYS_MP0 + 0x3610)
#define MP1_AVG_STALL_RATIO_STATUS	(MCUSYS_MP0 + 0x3614)
#define MP1_CPU0_STALL_COUNTER	(MCUSYS_MP0 + 0x3618)
#define MP1_CPU1_STALL_COUNTER	(MCUSYS_MP0 + 0x361C)
#define MP1_CPU2_STALL_COUNTER	(MCUSYS_MP0 + 0x3620)
#define MP1_CPU3_STALL_COUNTER	(MCUSYS_MP0 + 0x3624)
#define MP1_CPU0_NON_WFI_COUNTER	(MCUSYS_MP0 + 0x3628)
#define MP1_CPU1_NON_WFI_COUNTER	(MCUSYS_MP0 + 0x362C)
#define MP1_CPU2_NON_WFI_COUNTER	(MCUSYS_MP0 + 0x3630)
#define MP1_CPU3_NON_WFI_COUNTER	(MCUSYS_MP0 + 0x3634)
#define MP1_CPU_STALL_INFO	(MCUSYS_MP0 + 0x3638)
