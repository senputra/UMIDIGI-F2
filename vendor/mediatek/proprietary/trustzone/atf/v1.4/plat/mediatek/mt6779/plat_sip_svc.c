		...
		if (mtk_lk_stage == 1) {
			if (((el != MODE_EL2) && (GET_RW(spsr) == MODE_RW_64)) ||
				...
				case MTK_SIP_LK_AMMS_MD_BASE_ADDR_AARCH32:
					rc = sip_amms_set_md_base_address(
				...
				case MTK_SIP_LK_AMMS_MD_POS_ADDR_AARCH32:
					rc = sip_amms_set_md_pos_addr((unsigned long long)x1);
					break;
				case MTK_SIP_LK_AMMS_MD_POS_LENGTH_AARCH32:
					rc = sip_amms_set_md_pos_length((unsigned long long)x1);
					break;
				...
				case MTK_SIP_KERNEL_EMIMPU_SET_AARCH32:
					...
					break;
				case MTK_SIP_KERNEL_LAST_EMI_RESET_AARCH32:
					rc = sip_last_emi_reset(x1, x2);
					break;
			...
			if (((el != MODE_EL2) && (GET_RW(spsr) == MODE_RW_64)) ||
				...
				case MTK_SIP_KERNEL_I2C_SEC_WRITE_AARCH64:
					...
					break;
				case MTK_M4U_DEBUG_DUMP_AARCH64:
					rc = m4u_dump_secure_reg(x1, &m4u_val0);
					SMC_RET2(handle, rc, m4u_val0);
					break;
				...
				case MTK_SIP_KERNEL_EMIMPU_SET_AARCH64:
					...
					rc = sip_emi_mpu_set_protection(x1, x2, x3);
					break;
				case MTK_SIP_KERNEL_LAST_EMI_RESET_AARCH64:
					rc = sip_last_emi_reset(x1, x2);
					break;
#ifdef MTK_DEVMPU_SUPPORT
				case MTK_SIP_KERNEL_DEVMPU_VIO_GET_AARCH64:
					...
					SMC_RET3(handle, rc, x1, x2);
					break;
				case MTK_SIP_KERNEL_DEVMPU_VIO_CLR_AARCH32:
				case MTK_SIP_KERNEL_DEVMPU_VIO_CLR_AARCH64:
					rc = sip_devmpu_vio_clr();
					SMC_RET1(handle, rc);
					break;
#if (1 == TARGET_BUILD_VARIANT_ENG)
				...
				case MTK_SIP_HYP_DEVMPU_PERM_SET_AARCH64:
					...
					SMC_RET1(handle, rc);
					break;
				case MTK_SIP_HYP_DEVMPU_DOMAIN_REMAP_SET_AARCH64:
					rc = sip_devmpu_domain_remap_set(x1, x2);
					SMC_RET1(handle, rc);
					break;
#endif
#endif
				case MTK_SIP_KERNEL_APU_VCORE_CG_CTL_AARCH64:
					apu_vcore_cg_ctl(x1);
					break;
				default:
					rc = SMC_UNK;
				...
				case MTK_SIP_KERNEL_I2C_SEC_WRITE_AARCH32:
					rc = i2c_set_secure_reg(x1, x2, x3);
					break;
				case MTK_M4U_DEBUG_DUMP_AARCH32:
					rc = m4u_dump_secure_reg(x1, &m4u_val0);
					SMC_RET2(handle, rc, m4u_val0);
					break;
				...
				case MTK_SIP_HYP_DEVMPU_PERM_SET_AARCH32:
					...
					SMC_RET1(handle, rc);
					break;
				case MTK_SIP_HYP_DEVMPU_DOMAIN_REMAP_SET_AARCH32:
					rc = sip_devmpu_domain_remap_set(x1, x2);
					SMC_RET1(handle, rc);
					break;
#endif
