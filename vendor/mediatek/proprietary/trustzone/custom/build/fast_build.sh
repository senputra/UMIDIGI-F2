...
MICROTRUST_TEE_LITE_SUPPORT=$(get_build_var MICROTRUST_TEE_LITE_SUPPORT)
WATCHDATA_TEE_SUPPORT=$(get_build_var WATCHDATA_TEE_SUPPORT)
TRUSTKERNEL_TEE_SUPPORT=$(get_build_var TRUSTKERNEL_TEE_SUPPORT)
...
echo "MICROTRUST_TEE_LITE_SUPPORT = ${MICROTRUST_TEE_LITE_SUPPORT}"
