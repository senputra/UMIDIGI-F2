                ...
                if(pMarshal)
                {
...
#if 0
                            SPI_PERFORMANCE("map_spiData_time: (0x%x, 0x%x) %dus\n",
                                (unsigned int)(map_spiData_end>>32)-(unsigned int)(excute_beg>>32),
                                (unsigned int)(map_spiData_end)-(unsigned int)(excute_beg),
                                (unsigned int)(map_spiData_end)-(unsigned int)(excute_beg));
                            SPI_PERFORMANCE("map_txbuf_time: (0x%x, 0x%x) %dus\n",
                                (unsigned int)(map_tx_buf_end>>32)-(unsigned int)(map_spiData_end>>32),
                                (unsigned int)(map_tx_buf_end)-(unsigned int)(map_spiData_end),
                                (unsigned int)(map_tx_buf_end)-(unsigned int)(map_spiData_end));
                            SPI_PERFORMANCE("map_rxbuf_time: (0x%x, 0x%x) %dus\n",
                                (unsigned int)(map_rx_buf_end>>32)-(unsigned int)(map_tx_buf_end>>32),
                                (unsigned int)(map_rx_buf_end)-(unsigned int)(map_tx_buf_end),
                                (unsigned int)(map_rx_buf_end)-(unsigned int)(map_tx_buf_end));
                            SPI_PERFORMANCE("map_chip_config_time: (0x%x, 0x%x) %dus\n",
                                (unsigned int)(map_chip_config_end>>32)-(unsigned int)(map_rx_buf_end>>32),
                                (unsigned int)(map_chip_config_end)-(unsigned int)(map_rx_buf_end),
                                (unsigned int)(map_chip_config_end)-(unsigned int)(map_rx_buf_end));
                            SPI_PERFORMANCE("setup_reg_time: (0x%x, 0x%x) %dus\n",
                                (unsigned int)(setup_reg_end>>32)-(unsigned int)(map_chip_config_end>>32),
                                (unsigned int)(setup_reg_end)-(unsigned int)(map_chip_config_end),
                                (unsigned int)(setup_reg_end)-(unsigned int)(map_chip_config_end));
                            if (packet_loop == 0) {
                                SPI_PERFORMANCE("sngl_trsf_sw_time: (0x%x, 0x%x) %dus\n",
                                    (unsigned int)(sngl_trsf_sw>>32)-(unsigned int)(setup_reg_end>>32),
                                    (unsigned int)(sngl_trsf_sw)-(unsigned int)(setup_reg_end),
                                    (unsigned int)(sngl_trsf_sw)-(unsigned int)(setup_reg_end));
                                SPI_PERFORMANCE("sngl_trsf_hw_time: (0x%x, 0x%x) %dus\n",
                                    (unsigned int)(sngl_trsf_hw>>32)-(unsigned int)(sngl_trsf_sw>>32),
                                    (unsigned int)(sngl_trsf_hw)-(unsigned int)(sngl_trsf_sw),
                                    (unsigned int)(sngl_trsf_hw)-(unsigned int)(sngl_trsf_sw));
                                SPI_PERFORMANCE("sngl_trsf_total len:%d time: (0x%x, 0x%x) %dus\n", total_len,
                                    (unsigned int)(sngl_trsf_hw>>32)-(unsigned int)(excute_beg>>32),
                                    (unsigned int)(sngl_trsf_hw)-(unsigned int)(excute_beg),
                                    (unsigned int)(sngl_trsf_hw)-(unsigned int)(excute_beg));
                            } else {
                                SPI_PERFORMANCE("fst_trsf_sw_time: (0x%x, 0x%x) %dus\n",
                                    (unsigned int)(fst_trsf_sw>>32)-(unsigned int)(setup_reg_end>>32),
                                    (unsigned int)(fst_trsf_sw)-(unsigned int)(setup_reg_end),
                                    (unsigned int)(fst_trsf_sw)-(unsigned int)(setup_reg_end));
                                SPI_PERFORMANCE("fst_trsf_hw_time: (0x%x, 0x%x) %dus\n",
                                    (unsigned int)(fst_trsf_hw>>32)-(unsigned int)(fst_trsf_sw>>32),
                                    (unsigned int)(fst_trsf_hw)-(unsigned int)(fst_trsf_sw),
                                    (unsigned int)(fst_trsf_hw)-(unsigned int)(fst_trsf_sw));
                                SPI_PERFORMANCE("scnd_trsf_sw_time: (0x%x, 0x%x) %dus\n",
                                    (unsigned int)(scnd_trsf_sw>>32)-(unsigned int)(fst_trsf_hw>>32),
                                    (unsigned int)(scnd_trsf_sw)-(unsigned int)(fst_trsf_hw),
                                    (unsigned int)(scnd_trsf_sw)-(unsigned int)(fst_trsf_hw));
                                SPI_PERFORMANCE("scnd_trsf_hw_time: (0x%x, 0x%x) %dus\n",
                                    (unsigned int)(scnd_trsf_hw>>32)-(unsigned int)(scnd_trsf_sw>>32),
                                    (unsigned int)(scnd_trsf_hw)-(unsigned int)(scnd_trsf_sw),
                                    (unsigned int)(scnd_trsf_hw)-(unsigned int)(scnd_trsf_sw));
								SPI_PERFORMANCE("twice_trsf_total len:%d time:(0x%x, 0x%x) %dus\n", total_len,
                                    (unsigned int)(scnd_trsf_hw>>32)-(unsigned int)(excute_beg>>32),
                                    (unsigned int)(scnd_trsf_hw)-(unsigned int)(excute_beg),
                                    (unsigned int)(scnd_trsf_hw)-(unsigned int)(excute_beg));
                            }

							SPI_PERFORMANCE("poll len:%d time:(0x%x, 0x%x) %dus\n", total_len,
                                    (unsigned int)(scnd_poll_end>>32)-(unsigned int)(scnd_poll_beg>>32),
                                    (unsigned int)(scnd_poll_end)-(unsigned int)(scnd_poll_beg),
                                    (unsigned int)(scnd_poll_end)-(unsigned int)(scnd_poll_beg));
#endif
					...
					case FID_DR_GETONEIMG_EXECUTE:
						...
						if(CMD_SPI_DRV_SEND == spiData->commandId) {
							...
							SPI_MSG("Chen.Sha --> begin run into  gf_dr_spi_read_image...!!\n");
