...
//	tlset_module_apc(DAPC_INDEX_SPI5,0,1); // lock SPI, only secure world can access
...
//	tlset_module_apc(DAPC_INDEX_SPI5, 0, 0); // unlock SPI make normal world can access
	return ret;
