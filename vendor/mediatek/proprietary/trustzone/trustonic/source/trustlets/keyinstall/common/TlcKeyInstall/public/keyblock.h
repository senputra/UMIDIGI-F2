...
int earse_keyblock(char *KBPath);

int nw_decrypt_drmkey(unsigned char *encDrmKeyBlock, unsigned int inLength,
        unsigned int *outLength, unsigned long long *p_decrypt_drmky_buffer_handle);

int nw_free_drmkey(unsigned long long *p_decrypt_drmky_buffer_handle);
