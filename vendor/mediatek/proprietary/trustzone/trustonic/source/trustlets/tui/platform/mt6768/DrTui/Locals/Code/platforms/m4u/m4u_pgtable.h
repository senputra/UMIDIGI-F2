...
#define F_PGD_PA_PAGETABLE_MSK            F_MSK(32, 10)
#define F_PGD_PA_PAGETABLE_SET(val)       F_VAL(val, 32, 10)
#define F_PGD_PA_SECTION_MSK            F_MSK(32, 20)
#define F_PGD_PA_SECTION_SET(val)       F_VAL(val, 32, 20)
#define F_PGD_PA_SUPERSECTION_MSK            F_MSK(32, 24)
