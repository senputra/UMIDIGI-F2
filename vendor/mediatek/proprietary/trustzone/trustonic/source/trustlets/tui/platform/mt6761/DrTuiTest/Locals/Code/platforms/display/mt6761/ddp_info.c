...
char *ddp_get_module_name(enum DISP_MODULE_ENUM module)
{
	...
	case DISP_MODULE_WDMA0:
		return "wdma0 ";
	case DISP_MODULE_WDMA_VIRTUAL0:
		return "wdma_virtual0 ";
	case DISP_MODULE_WDMA_VIRTUAL1:
		return "wdma_virtual1 ";
	...
	case DISP_MODULE_RSZ0:
		return "rsz0";
	case DISP_MODULE_RSZ0_VIRTUAL0:
		return "rsz0_virt0";
	case DISP_MODULE_RSZ0_VIRTUAL1:
		return "rsz0_virt1";
	default:
