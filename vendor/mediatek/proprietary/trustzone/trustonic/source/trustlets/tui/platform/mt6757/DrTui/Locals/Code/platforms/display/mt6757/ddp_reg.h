...
/*STATIC_ASSERT(0x0070 == offsetof(DSI_PHY_REGS, MIPITX_DSI_GPI_CON0));*/
...
/*#define DISPSYS_CCORR_BASE		        DDP_REG_BASE_DISP_CCORR0*/

#define DISPSYS_AAL0_BASE		        DDP_REG_BASE_DISP_AAL0
#define DISPSYS_AAL1_BASE		        DDP_REG_BASE_DISP_AAL1
/*#define DISPSYS_AAL_BASE		        DDP_REG_BASE_DISP_AAL0*/
...
/*#define DISPSYS_DITHER_BASE		        DDP_REG_BASE_DISP_DITHER0*/
...
#define MIPITX0_BASE					DDP_REG_BASE_MIPITX0
#define MIPITX1_BASE					DDP_REG_BASE_MIPITX1
...
#define DISP_REG_GET_FIELD(field, reg32) \
	REG_FLD_VAL_GET(field, (*(volatile unsigned int*)(reg32)))
...
//#define DISP_REG_SMI_LARB0_SEC_EN (DISPSYS_SMI_LARB0_BASE+0xfc0)
/* SMI_LARB4 */
...
#define DISP_REG_SPLIT_DUMMY				(DISPSYS_SPLIT0_BASE+0x80)
...
#define DISP_REG_UFO_DBG_0B				(DISPSYS_UFOE_BASE+0x140)
#define DISP_REG_UFO_DBG_1B				(DISPSYS_UFOE_BASE+0x144)
#define DISP_REG_UFO_DBG_2B				(DISPSYS_UFOE_BASE+0x148)
#define DISP_REG_UFO_DBG_3B				(DISPSYS_UFOE_BASE+0x14C)
#define DISP_REG_UFO_DBG_4B				(DISPSYS_UFOE_BASE+0x150)
#define DISP_REG_UFO_DBG_5B				(DISPSYS_UFOE_BASE+0x154)
#define DISP_REG_UFO_DBG_6B				(DISPSYS_UFOE_BASE+0x158)
#define DISP_REG_UFO_DBG_7B				(DISPSYS_UFOE_BASE+0x15C)
...
#define START_FLD_DISP_DSC_STALL_CLK_GATE_EN	REG_FLD(1, 9)
