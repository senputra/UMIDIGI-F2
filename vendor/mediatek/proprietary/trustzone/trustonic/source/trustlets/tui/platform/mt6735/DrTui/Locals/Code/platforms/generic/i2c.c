...
static inline U32 i2c_clock_enable(mt_i2c * i2c )
{
	...
	{
		case 0:
			I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR,
				( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR) | (1<<I2C0_PDN) ) );
			break;
		case 1:
			I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR,
				( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR) | (1<<I2C1_PDN) ) );
			break;
		case 2:
			I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR,
				( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR) | (1<<I2C2_PDN) ) );
			break;
		case 3:
			I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR,
				( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR) | (1<<I2C3_PDN) ) );
			break;
		case 4:
			I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR,
				( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR) | (1<<I2C4_PDN) ) );
			break;
		default:
...
static inline U32 i2c_clock_disable(mt_i2c * i2c )
{
	...
	{
		case 0:
			I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET,
				 ( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET) | (1<<I2C0_PDN) ) );
			break;
		case 1:
			I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET,
				 ( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET) | (1<<I2C1_PDN) ) );
			break;
		case 2:
			I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET,
				 ( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET) | (1<<I2C2_PDN) ) );
			break;
		case 3:
			I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET,
				 ( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET) | (1<<I2C3_PDN) ) );
			break;
		case 4:
			I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET,
				 ( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET) | (1<<I2C4_PDN) ) );
			break;
		default:
			I2CERR("invalid para: i2c->id=%d\n",i2c->id);
	}
...
{
	I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR,
		( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_CLR) | (1<<AP_DMA_PDN) ) );
	return 0;
}
...
{
	I2C_WRITE(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET,
		( I2C_READ(clock_gate + OFFSET_FERI_GLOBALCON_PDN0_SET) | (1<<AP_DMA_PDN) ) );
	return 0;
}
...
static inline void i2c_secure_enable(mt_i2c * i2c)
{
    switch(i2c->id) {
        case 0:
			set_module_apc(51, 0, 1);
            break;
        case 1:
			set_module_apc(52, 0, 1);
            break;
        case 2:
			set_module_apc(53, 0, 1);
            break;
    	default:
		    I2CERR("invalid para: i2c->id=%d\n",i2c->id);
    }
...
static inline void i2c_secure_disable(mt_i2c * i2c)
{
    switch(i2c->id) {
        case 0:
			set_module_apc(51, 0, 0);
            break;
        case 1:
			set_module_apc(52, 0, 0);
            break;
        case 2:
			set_module_apc(53, 0, 0);
            break;
    	default:
		    I2CERR("invalid para: i2c->id=%d\n",i2c->id);
    }
...
{
	I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_GSEC_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_GSEC_SEC_EN) | 0x1 ) );
	switch(i2c->id)
	{
		case 0:
			I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C0_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C0_SEC_EN) & ~(3<<1) ) );
			I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C0_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C0_SEC_EN) | 0x1 ) );
			break;
		case 1:
			I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C1_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C1_SEC_EN) & ~(3<<1) ) );
			I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C1_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C1_SEC_EN) | 0x1 ) );
			break;
		case 2:
			I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C2_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C2_SEC_EN) & ~(3<<1) ) );
			I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C2_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C2_SEC_EN) | 0x1 ) );
			break;
		default:
			I2CERR("invalid para: i2c->id=%d\n",i2c->id);
			I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_GSEC_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_GSEC_SEC_EN) | 0x0 ) );
	}
	return 0;
}
...
static inline U32 ap_dma_secure_disable(mt_i2c * i2c)
{
	...
	switch(i2c->id)
	{
		case 0:
			I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C0_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C0_SEC_EN) & ~(3<<1) ) );
			//I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C0_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C0_SEC_EN) | 0x0 ) );
			break;
		case 1:
			I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C1_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C1_SEC_EN) & ~(3<<1) ) );
			//I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C1_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C1_SEC_EN) | 0x0 ) );
			break;
		case 2:
			I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C2_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C2_SEC_EN) & ~(3<<1) ) );
			//I2C_WRITE(DMA_BASE_VA + OFFSET_AP_DMA_I2C2_SEC_EN, ( I2C_READ(DMA_BASE_VA + OFFSET_AP_DMA_I2C2_SEC_EN) | 0x0 ) );
			break;
		default:
			I2CERR("invalid para: i2c->id=%d\n",i2c->id);
	}
...
void _i2c_write_reg(mt_i2c *i2c)
{
  ...
  if(i2c->dma_en)
  {
    ...
    I2CLOG("DMA Register:TX_LEN:0x%x, RX_LEN:0x%x, EN_LEN:0x%x",\
                  DRV_Reg32(i2c->pdmabase + OFFSET_INT_FLAG),\
                  DRV_Reg32(i2c->pdmabase + OFFSET_CON),\
...
S32 i2c_write(mt_i2c *i2c, U8 *buffer, U32 len)
{
    ...
    i2c->msg_buf = buffer;
    i2c->msg_len = len;
    i2c->pdmabase = DMA_BASE_VA + 0x180 + (0x80*(i2c->id));
...
int mt_i2c_test_eeprom2(int id)
{
  ...
  U8 *write_byte_pa = 0xA8100000, *read_byte_pa = 0xA8110000;
  ...
  write_byte[1] = 0x55;
/*
  drApiVirt2Phys(0, write_byte, &write_byte_test);
  drApiMapPhysicalBuffer((uint64_t)write_byte_pa,0x100,mapFlag,(void **)&write_byte_test_va );
  I2CLOG("Debug: ======== v : p ========>%x : %x  \n", write_byte, write_byte_test);
  I2CLOG("Debug:2 ======== v : v : v ========>%x : %x : %x \n", write_byte_test_va, write_byte_test_va[0], write_byte_test_va[1]);
*/
  len=2;
...
void test_i2c(void)
{
  ...
  drApiMapPhysicalBuffer((uint64_t)0x10002000,0x1000,mapFlag,(void **)&clock_gate);
  ...
  I2CMSG("fwqclock _map_regiser CFG, hasMapped [%x]\n", (clock_gate+0x18));
  I2CMSG("fwq _clockSTA[%x]\n", (*(volatile uint32_t*)(clock_gate+0x18)));
  I2CMSG("fwq _clockSTA2[%x]\n", (*(volatile uint32_t*)(clock_gate+0x18)));
  I2CERR("fwq0   base=%x, base= %x\n",I2C0_BASE );
  I2CERR("fwq1   base=%x, base= %x\n",(U32*)I2C1_BASE );
  I2CERR("fwq2   base=%x, base= %x\n",I2C2_BASE );
  #if 1
  for(i=2;i<=2;i++){
