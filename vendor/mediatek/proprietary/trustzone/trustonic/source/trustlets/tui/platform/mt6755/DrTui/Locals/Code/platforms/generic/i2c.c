...
void _config_mt_i2c(mt_i2c *i2c)
{
  ...
  switch(i2c->id)
  {
    case 0:
	  ...
	  //I2CERR("fwq config0 va=%x, base= %x\n",I2C0_BASE,i2c->base);
      break;
    case 1:
      i2c->base = (U32*)I2C1_BASE;
	  //I2CERR("fwq config1 va=%x, base= %x\n",I2C1_BASE,i2c->base);
      break;
    case 2:
      i2c->base = (U32*)I2C2_BASE;
	  //I2CERR("fwq config2 va=%x, base= %x\n",I2C2_BASE,i2c->base);
      break;
    default:
      I2CERR("invalid para: i2c->id=%d\n",i2c->id);
      break;
...
int mt_i2c_test_eeprom2(int id)
{
  ...
  U8 *write_byte_pa = 0xa3c00000, *read_byte_pa = 0xa3c10000;
