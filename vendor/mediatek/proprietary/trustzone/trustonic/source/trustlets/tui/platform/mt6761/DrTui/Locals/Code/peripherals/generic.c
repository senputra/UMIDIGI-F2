...
/* Defines for generic touch screen(Need modify) */
/*#define TOUCH_INTR_NUM  151
#define TOUCH_EINT_NUM  0

#define TOUCH_RESOLUTION_WIDTH  720
#define TOUCH_RESOLUTION_HEIGHT 1280*/
...
extern int unmap_i2c_dma_buffer(void);
extern int is_extra_mem_inited(void);
...
drTuiHalError_t tuiHalTouchGetInfoV2(drTouchInfoV2_t *pTouchInfo)
{
    ...
    pTouchInfo->width  = TOUCH_RESOLUTION_WIDTH;
    pTouchInfo->height = TOUCH_RESOLUTION_HEIGHT;
    /*
