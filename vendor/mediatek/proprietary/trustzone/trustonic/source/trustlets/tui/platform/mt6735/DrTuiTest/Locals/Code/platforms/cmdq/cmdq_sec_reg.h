...
/* register mapping */
#define GCE_BASE_PA					(0x10217000)
#define CMD_BUFFER_BASE_PA			(0xA8000000)
...
#define CMDQ_GPR_R32_PA(id)          (GCE_BASE_VA + (0x004 * id) + 0x80)
...
#define CMDQ_SECURE_IRQ_ID	(GIC_PRIVATE_SIGNALS + 148)
