...
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_RDMA0_SOF, 2)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_RSZ0_SOF, 4)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_RSZ1_SOF, 5)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_TDSHP_SOF, 6)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_WROT0_SOF, 7)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_WDMA_SOF, 8)

/* Display start frame */
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL0_SOF, 9)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL0_2L_SOF, 10)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL1_2L_SOF, 11)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_WDMA0_SOF, 12)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_COLOR0_SOF, 13)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_CCORR0_SOF, 14)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_AAL0_SOF, 15)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_GAMMA0_SOF, 16)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DITHER0_SOF, 17)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_PWM0_SOF, 18)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DSI0_SOF, 19)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DPI0_SOF, 20)

/* MDP frame done */
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_RDMA0_EOF, 23)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_RDMA1_EOF, 24)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_RDMA0_EOF, 25)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_RSZ0_EOF, 27)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_RSZ1_EOF, 28)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_TDSHP_EOF, 29)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_WROT0_WRITE_EOF, 30)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_WDMA_EOF, 31)

/* Display frame done */
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL0_EOF, 32)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL0_2L_EOF, 33)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL1_2L_EOF, 34)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_WDMA0_EOF, 35)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_COLOR0_EOF, 36)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_CCORR0_EOF, 37)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_AAL0_EOF, 38)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_GAMMA0_EOF, 39)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DITHER0_EOF, 40)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DSI0_EOF, 41)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DPI0_EOF, 42)
...
/* Display underrun */
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_RDMA0_UNDERRUN, 142)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_RDMA1_UNDERRUN, 143)

/* Display TE */
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DSI0_TE, 144)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DSI0_IRQ_EVENT, 145)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DSI0_DONE_EVENT, 146)

/* Reset Event */
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_WDMA0_RST_DONE, 150)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_WDMA_RST_DONE, 151)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_WROT0_RST_DONE, 152)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_RDMA0_RST_DONE, 154)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL0_RST_DONE, 155)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL0_2L_RST_DONE, 156)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL1_2L_RST_DONE, 157)
