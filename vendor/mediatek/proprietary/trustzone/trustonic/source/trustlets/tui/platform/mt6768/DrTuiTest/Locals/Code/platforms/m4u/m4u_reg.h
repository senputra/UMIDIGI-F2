...
#ifndef _MT6765_M4U_REG_H__
#define _MT6765_M4U_REG_H__

/* #include "mach/mt_reg_base.h" */

#define M4U0_REG_BASE  0x10205000
#define LARB0_BASE     0x14003000
#define LARB1_BASE     0x16010000
#define LARB2_BASE     0x15021000
#define LARB3_BASE     0x1a002000
#define LARB4_BASE     0x17010000
/* ================================================= */
/* common macro definitions */
#define F_VAL(val, msb, lsb) (((val)&((1<<(msb-lsb+1))-1))<<lsb)
#define F_MSK(msb, lsb)     F_VAL(0xfffffffff, msb, lsb)
...
#define F_INT_MMU0_MAU_MSK	   F_BIT_SET(14)
#define F_INT_MMU1_MAU_MSK	   F_BIT_SET(15)
...
/*operate register*/
#define M4U_REG_SET(reg32, val) ((*(volatile unsigned int *)(reg32)) = (unsigned int)(val))
#define M4U_REG_GET(reg32) (*(volatile unsigned int *)(reg32))
...
{
    unsigned int val;
    val = ioread32((void *)(intptr_t)(M4uBase+Offset));
