...
static unsigned long smiLarbBasePA[SMI_LARB_NR] = {LARB0_BASE, LARB1_BASE,
						   LARB2_BASE, LARB3_BASE, LARB4_BASE};

static unsigned int m4u_port0_in_larbx[SMI_LARB_NR] = {M4U_PORT_DISP_OVL0, M4U_PORT_HW_VDEC_MC_EXT, M4U_PORT_CAM_IMGI,
				       ...
				       unsigned int prot)
{
	...
	M4ULOGV("mva_start = 0x%x, mva_end = 0x%x, pa=0x%x, buf size = 0x%x, required_desc_cnt = %u\n",
