...
#define I2CLOG(fmt, arg...) TUI_LOGV(fmt, ##arg)
#define I2CMSG(fmt, arg...) TUI_LOGI(fmt, ##arg)
#define I2CERR(fmt, arg...) TUI_LOGE("err %d: "fmt, __LINE__, ##arg)
#define I2CFUC() TUI_LOGV("%s\n", __FUNCTION__)
...
#else
#define I2C_CLK_RATE		  124800 / DEFAULT_DIV /*13650*/
#endif
#define DEFAULT_DIV		  5

#define I2C_MB()
#define I2C_BUG_ON(a)
#define I2C_M_RD       0x0001

#define AP_MCH_OFFSET             0x100

#define I2C0_BASE_PA (0x11007000)
#define I2C0_BASE (i2c0_va)
#define I2C1_BASE_PA (0x11011000)
#define I2C1_BASE (i2c1_va)
#define I2C2_BASE_PA (0x11009000)
#define I2C2_BASE (i2c2_va)
#define I2C3_BASE_PA (0x1100f000)
#define I2C3_BASE (i2c3_va)
#define I2C4_BASE_PA (0x11008000)
#define I2C4_BASE (i2c4_va)
#define I2C5_BASE_PA (0x11016000)
#define I2C5_BASE (i2c5_va)
...
enum I2C_REGS_OFFSET {
	...
	OFFSET_HS             = 0x30,   //0X30
	OFFSET_IO_CONFIG      = 0x34,   //0X34
	OFFSET_TRANSFER_LEN_AUX = 0x44,   //0X44
	OFFSET_CLOCK_DIV      = 0x48,   //0X48
...
#define OFFSET_SW_DMA_SET	0x88
#define OFFSET_SW_DMA_CLR	0x8c
#define OFFSET_SW_CG_0_SET	0x80
#define OFFSET_SW_CG_0_CLR	0x84
#define OFFSET_SW_CG_1_SET	0x80
#define OFFSET_SW_CG_1_CLR	0x84
#define OFFSET_SW_CG_2_SET	0x80
#define OFFSET_SW_CG_2_CLR	0x84
#define OFFSET_SW_CG_3_SET	0x80
#define OFFSET_SW_CG_3_CLR	0x84
#define OFFSET_SW_CG_4_SET	0xa4
#define OFFSET_SW_CG_4_CLR	0xa8
#define OFFSET_SW_CG_5_SET	0xa4
#define OFFSET_SW_CG_5_CLR	0xa8
...
#define OFFSET_AP_DMA_I2C2_SEC_EN	0x38
#define OFFSET_AP_DMA_I2C3_SEC_EN	0x3C
#define OFFSET_AP_DMA_I2C4_SEC_EN	0x2C
#define OFFSET_AP_DMA_I2C5_SEC_EN	0x48
...
extern S32 i2c_write_64(mt_i2c *i2c, U64 buffer, U32 len);
extern S32 i2c_read_64(mt_i2c *i2c, U64 buffer, U32 len);
extern S32 i2c_write_read_64(mt_i2c *i2c, U64 buffer, U32 write_len, U32 read_len);
extern S32 i2c_set_speed(mt_i2c *i2c, U32 clk_src_in_hz);
extern S32 tui_lock_i2c(int id, int lock);
