...
#include "cmdq_sec_tlDriverApi.h"
...
//--------------------------------------------------------------------------
#define CMDQ_TZ_PROF_START(tag) cmdq_tz_sectrace_profile_start(tag)

#define CMDQ_TZ_PROF_END(tag) cmdq_tz_sectrace_profile_end(tag)

#define CMDQ_TZ_PROF_ONESHOT(tag) cmdq_tz_sectrace_profile_oneshot(tag)
//--------------------------------------------------------------------------
...
int32_t cmdqTzComposeAndSubmitTaskAsync(iwcCmdqMessage_ptr pIwcMessage, tlApiCmdqExecMetadata_ptr pMetadata, TaskStruct **ppTaskOut);
