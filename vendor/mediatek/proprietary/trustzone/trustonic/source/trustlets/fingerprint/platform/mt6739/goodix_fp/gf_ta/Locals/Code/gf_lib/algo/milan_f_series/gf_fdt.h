...
// chip specific parameter for K
#define IMAGE_ROW_K       (80)        // number of chip row pixel
#define IMAGE_COL_K       (80)       // number of chip column pixel

// chip specific parameter for J
#define IMAGE_ROW_J       (64)        // number of chip row pixel
#define IMAGE_COL_J       (120)       // number of chip column pixel

// chip specific parameter for H
#define IMAGE_ROW_H       (64)        // number of chip row pixel
#define IMAGE_COL_H       (80)       // number of chip column pixel
...
typedef enum {
    ...
    // FDT INT is caused by touch & release too quickly to capture a void image
    GF_FDT_RET_VOID   = 2,
 ...
 *
 */
gf_error_t gf_fdt_init(gf_chip_series_t chip_series, gf_chip_type_t chip_type,
        gf_fdt_params_t* init_params);
