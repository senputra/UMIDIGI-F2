 ...
 * All Rights Reserved.
 */
#ifndef __CPL_MEMORY_H__
#define __CPL_MEMORY_H__

#include <stdint.h>

#define CPL_MEM_MALLOC(size)        \
    cpl_malloc((int32_t)(size), 0, (const int8_t *)__FILE__, (const int8_t *)__FUNCTION__, __LINE__)
#define CPL_MEM_REALLOC(src, size)  \
    cpl_realloc((void *)(src), (int32_t)(size), (const int8_t *)__FILE__, \
