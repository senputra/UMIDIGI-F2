...
typedef enum gf_error {
    ...
    GF_ERROR_INVALID_BASE = GF_ERROR_BASE + 59,
    ...
    GF_ERROR_COVER_SENSOR_IS_BROKEN = GF_ERROR_BASE + 63,
    ...
    GF_ERROR_UNKNOWN_CMD = GF_ERROR_BASE + 71,

    //test spi transfer
    GF_ERROR_TEST_SPI_TRANSFER_TIMEOUT = GF_ERROR_BASE + 72,

    //Dynamic enroll
    GF_ERROR_INIT_ALGO_REGISTER_INFO = GF_ERROR_BASE + 73,
    GF_ERROR_ENROLL_CONTINUOUS_INVALID_PRESS = GF_ERROR_BASE + 74,
    GF_ERROR_ERNOLL_INCOMPLETE_TEMPLATE = GF_ERROR_BASE + 75,
