#ifndef __GF_TEE_STORAGE_API_H__
#define __GF_TEE_STORAGE_API_H__
...
#ifdef __TEE_NUTLET
gf_error_t gf_tee_write_object_data(uint8_t *object_id, GF_TEE_HANDLE *so_handle, uint8_t *buffer, uint32_t size);
#else
