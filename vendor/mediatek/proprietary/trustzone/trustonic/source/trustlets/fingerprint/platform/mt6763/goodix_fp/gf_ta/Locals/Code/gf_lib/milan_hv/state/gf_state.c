...
{ 1, MODE_IMAGE_CONTINUE },         /* OPERATION_ENROLL = 0*/
...
{ 0, MODE_TEST_PIXEL_OPEN_DEFAULT },/* OPERATION_TEST_PIXEL_OPEN_STEP1, 24*/
{ 0, MODE_TEST_PIXEL_OPEN_POSITIVE },/* OPERATION_TEST_PIXEL_OPEN_STEP2, 25*/
{ 0, MODE_TEST_BAD_POINT_FINGER_BASE },  /* OPERATION_TEST_BAD_POINT_RECODE_BASE, 26*/
{ 0, MODE_TEST_BAD_POINT },         /* OPERATION_TEST_BAD_POINT, 27*/
...
{ 0, MODE_IMAGE_CONTINUE },         /* OPERATION_TEST_UNTRUSTED_ENROLL, 34*/
...
{ 1, MODE_BROKEN_CHECK_DEFAULT },   /* OPERATION_BROKEN_CHECK_DEFAULT, 50*/
{ 1, MODE_BROKEN_CHECK_NEGATIVE },  /* OPERATION_BROKEN_CHECK_NEGATIVE, 51*/
{ 1, MODE_BROKEN_CHECK_POSITIVE },  /* OPERATION_BROKEN_CHECK_POSITIVE, 52*/
