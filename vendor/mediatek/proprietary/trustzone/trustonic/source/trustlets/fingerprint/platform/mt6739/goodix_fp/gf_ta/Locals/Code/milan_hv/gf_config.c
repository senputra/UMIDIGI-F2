...
void gf_config_init_by_chip_type(gf_chip_type_t chip_type) {
    ...
    if (GF_CHIP_5288 == chip_type) {
        g_config.valid_image_quality_threshold = 20;
    }
    ...
    /************** TX enable/disable strategy ***************/
    g_config.enable_fdt_tx_strategy = 1;
    ...
    g_config.require_down_and_up_in_pairs_for_nav_mode = 1;
    ...
    g_config.support_hv_dac_adjust = 1;
    /*********************************************/
}
