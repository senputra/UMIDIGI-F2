################################################################################
#
# <t-sdk tee_sanity Driver
#
################################################################################

# output binary name without path or extension
OUTPUT_NAME := drtee_sanity

#-------------------------------------------------------------------------------
# MobiConvert parameters, see manual for details
#-------------------------------------------------------------------------------
DRIVER_UUID := 05160000000000000000000000000000
...
DRIVER_NUMBER := 0x0305 # drtee_sanity
...
HAL_LIBS += $(ANDROID_STATIC_LIBRARIES_OUT_DIR)/drtee_sanity_core_intermediates/drtee_sanity_core.lib
