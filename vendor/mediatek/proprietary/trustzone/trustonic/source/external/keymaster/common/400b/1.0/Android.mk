...
# =============================================================================
# Module: libSoterProvision.so - Provisioning libs for SOTER ATTK
# =============================================================================
ifeq ($(strip $(MTK_SOTER_SUPPORT)), yes)

include $(CLEAR_VARS)
LOCAL_MODULE := libSoterProvision
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
LOCAL_MODULE_TAGS := optional
LOCAL_CPPFLAGS := -Wall
...
# =============================================================================
# Module: soter_attk_privision - Provisioning tool for SOTER ATTK
# =============================================================================
include $(CLEAR_VARS)
LOCAL_MODULE := soter_attk_provision
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
LOCAL_MODULE_TAGS := optional
LOCAL_CPPFLAGS := -Wall
...
ALL_SRC_FILES := $(wildcard ${LOCAL_PATH}/util/*.cpp)
LOCAL_SRC_FILES := $(ALL_SRC_FILES:$(LOCAL_PATH)/%=%)
LOCAL_C_INCLUDES := $(LOCAL_PATH)/include
LOCAL_C_INCLUDES += vendor/mediatek/proprietary/hardware/keymaster/include

LOCAL_SHARED_LIBRARIES := libSoterProvision
LOCAL_SHARED_LIBRARIES += liblog
LOCAL_SHARED_LIBRARIES += libcrypto
