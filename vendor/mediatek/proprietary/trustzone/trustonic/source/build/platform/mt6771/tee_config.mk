...
TEE_ALL_MODULE_MAKEFILE += $(call mtk_tee_find_module_makefile,spi5,platform,Drspi)
TEE_ALL_MODULE_MAKEFILE += $(call mtk_tee_find_module_makefile,spi5,platform,Tlspi)
...
ifeq ($(strip $(MTK_TEE_GP_SUPPORT)), yes)
  ...
  TEE_ALL_MODULE_MAKEFILE += $(call mtk_tee_find_module_makefile,IRIS_GPIO,common,DrGPIO)
  TEE_ALL_MODULE_MAKEFILE += $(call mtk_tee_find_module_makefile,IRIS_I2C,common,DrI2C)
  # tee_sanity is for secure os basic test
#  TEE_ALL_MODULE_MAKEFILE += $(call mtk_tee_find_module_makefile,tee_sanity,common,drv)
#  TEE_ALL_MODULE_MAKEFILE += $(call mtk_tee_find_module_makefile,tee_sanity,common,ta)
else
...
ifeq ($(strip $(MTK_SEC_VIDEO_PATH_SUPPORT)), yes)
  ...
  MTK_TPLAY_UT_SUPPORT := no
  ifeq ($(strip $(MTK_TPLAY_UT_SUPPORT)), yes)
    TEE_ALL_MODULE_MAKEFILE += $(call mtk_tee_find_module_makefile,tplay,platform,Drtplay)
    TEE_ALL_MODULE_MAKEFILE += $(call mtk_tee_find_module_makefile,tplay,platform,Tltplay)
  endif
endif
...
TEE_GLOBAL_MAKE_OPTION += COMP_PATH_HW_VCODEC=$(CURDIR)/vendor/mediatek/proprietary/hardware/libvcodec
