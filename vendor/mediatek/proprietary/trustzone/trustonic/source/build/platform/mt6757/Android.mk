...
-include $(LOCAL_PATH)/vendor/mediatek/proprietary/trustzone/trustonic/secure/trustlets/video/platform/$(shell echo $(MTK_PLATFORM) | tr A-Z a-z)/MtkH264Vdec/MtkH264SecVdecTLC/Locals/Code/Android.mk

LOCAL_PATH := $(TOP)

-include $(LOCAL_PATH)/vendor/mediatek/proprietary/trustzone/trustonic/secure/trustlets/video/platform/$(shell echo $(MTK_PLATFORM) | tr A-Z a-z)/MtkH265Vdec/MtkH265SecVdecTLC/Locals/Code/Android.mk
...
ifeq ($(MTK_FINGERPRINT_SELECT), $(filter $(MTK_FINGERPRINT_SELECT), GF316M GF318M GF3118M GF518M GF5118M GF516M))
LOCAL_PATH := $(TOP)
-include $(LOCAL_PATH)/vendor/mediatek/proprietary/trustzone/trustonic/source/trustlets/fingerprint/platform/mt6797/goodix_fp/gf_ca/Android.mk
endif
endif
