...
GPAPI_LIB := $(INTERNAL_TASDK_DIR)/Bin/GpApi/GpApi_400b.lib
...
TASDK_SRC_ASM :=
TASDK_DIR_INC := \
    $(INTERNAL_TASDK_DIR)/Public_400b \
    $(INTERNAL_TASDK_DIR)/Public_400b/MobiCore/inc \
    $(INTERNAL_TASDK_DIR)/Public_400b/GPD_TEE_Internal_API
TLAPI_LIB := $(INTERNAL_TASDK_DIR)/Bin/TlApi/TlApi_400b.lib
...
ifeq ($(TOOLCHAIN),GNU)
ARCHIVER_OPTS := -rcs
DEP_OPTS = -MP -MD -MF $(addsuffix .d,$(basename $@))
else
