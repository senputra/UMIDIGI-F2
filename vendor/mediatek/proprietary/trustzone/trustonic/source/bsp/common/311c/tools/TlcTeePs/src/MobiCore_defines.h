...
static __inline__ uint32_t threadid_get_taskid(uint32_t threadid) {
    ...
    #define MC_FC_PM_SUSPEND             MC_FC_STD64(42) /**< put drivers to sleep, then enter power-sleep if r1 is not 0 */
    #define MC_FC_PM_SUSPEND_CANCEL      MC_FC_STD64(43) /**< wake up drivers */
    #define MC_FC_PM_QUERY               MC_FC_STD64(44) /**< query the state of drivers (for test) */
    ...
    #define MC_FC_FIQ_FORWARD_CONFIG     MC_FC_STD64(56)  /**< Configure FIQ forwarding to ARM Trusted Firmware */
#else
...
static inline const char *fcTypeToString(uint32_t fc){
    switch( fc ) {
        ...
        case MC_FC_SLEEP:               return "FC sleep"; break;
        case MC_FC_CORE_X_WAKEUP:       return "FC core X wakeup"; break;
        case MC_FC_AFTR:                return "FC AFTR"; break;
        case MC_FC_CMD_SAVE:            return "FC cmd save"; break;
        case MC_FC_CMD_SHUTDOWN:        return "FC cmd shutdown"; break;
        case MC_FC_ENABLE_INTERRUPT_FIQ_DUMP: return "FC enable interrupt FIQ dump"; break;
        case MC_FC_C15_RESUME:          return "FC C15 resume"; break;
        ...
        case MC_FC_SW_RESET:            return "FC SW reset"; break;
...
static inline const char *sysCtrlToString(uint32_t sysCtrl) {
    switch(sysCtrl) {
        ...
        case CTRL_READ_OEM_DATA :              return "CTRL_READ_OEM_DATA";
