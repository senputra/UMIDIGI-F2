...
# DRIVER_INTERFACE_VERSION : major.minor
ifeq ($(DRIVER_INTERFACE_VERSION),)
$(info - DRIVER_INTERFACE_VERSION  is  not  set,  default  is : 0.0)
...
# DR_ROLLBACK_PROTECTED
ifeq ($(DR_ROLLBACK_PROTECTED),)
$(info - DR_ROLLBACK_PROTECTED  is  not  set,  default  is : N)
DR_ROLLBACK_PROTECTED ?= N
endif
...
$(info MODE                      : $(MODE))
$(info DRIVER_INTERFACE_VERSION  : $(DRIVER_INTERFACE_VERSION))
$(info TBASE_API_LEVEL           : $(TBASE_API_LEVEL))
$(info HW_FLOATING_POINT         : $(HW_FLOATING_POINT))
$(info DR_ROLLBACK_PROTECTED     : $(DR_ROLLBACK_PROTECTED))
...
ifneq ($(DR_ROLLBACK_PROTECTED),N)
    ifneq ($(DR_ROLLBACK_PROTECTED),Y)
        $(error ERROR : DR_ROLLBACK_PROTECTED value is not correct : $(DR_ROLLBACK_PROTECTED))
    endif
endif

DOWNGRADE_PROTECTED :=
ifeq ($(DR_ROLLBACK_PROTECTED),Y)
...
include $(DRSDK_DIR)/driver_mtk.mk
...
LIBS := $(TLAPI_LIB) $(GPAPI_LIB) $(DRAPI_LIB) $(DRENTRY_LIB) $(EXTRA_LIBS)
LIBS += $(HAL_LIBS)
