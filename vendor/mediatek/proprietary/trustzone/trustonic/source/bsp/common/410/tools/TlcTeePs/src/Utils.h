...
// #define BOLD(x)     "\e[1m" x "\e[0m" // please keep this macro
#define BOLD(x)     x
// #define HIGHLIGHT(x) BG_WHITE(BLACK(BOLD(x))) // please keep this macro
#define HIGHLIGHT(x)       x
// #define HIGHLIGHT_ERROR(x) BG_RED(WHITE(BOLD(x))) // please keep this macro
#define HIGHLIGHT_ERROR(x) x
