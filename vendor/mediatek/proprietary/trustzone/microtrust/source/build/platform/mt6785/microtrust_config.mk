...
### VP9 VDEC
MICROTRUST_ALL_MODULE_MAKEFILE += $(call mtk_microtrust_find_module_makefile,video,common,MtkVP9Vdec/drv)
MICROTRUST_ALL_MODULE_MAKEFILE += $(call mtk_microtrust_find_module_makefile,video,common,MtkVP9Vdec/ta)
