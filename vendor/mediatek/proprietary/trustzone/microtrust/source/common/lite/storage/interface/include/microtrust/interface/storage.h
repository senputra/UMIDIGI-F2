...
#define STORAGE_DISK_PROXY_PORT_PERSIST    "com.android.trusty.storage.persist"
#define STORAGE_DISK_PROXY_PORT_PROINFO    "com.android.trusty.storage.proinfo"
...
enum storage_cmd {
	...
	STORAGE_INIT_OK         = 20 << STORAGE_REQ_SHIFT,
	STORAGE_INIT_PROINFO_OK         = 21 << STORAGE_REQ_SHIFT,
	STORAGE_INIT_PERSIST_OK         = 22 << STORAGE_REQ_SHIFT,
};
...
enum storage_file_open_flag {
	...
	STORAGE_FILE_OPEN_PERSISTENT_FILE    = (1 << 3),
	STORAGE_FILE_OPEN_PROINFO_FILE       = (1 << 4),
    STORAGE_FILE_OPEN_VFS                = (1 << 5),
	STORAGE_FILE_OPEN_MASK               = STORAGE_FILE_OPEN_CREATE |
					       STORAGE_FILE_OPEN_TRUNCATE |
					       STORAGE_FILE_OPEN_CREATE_EXCLUSIVE |
					       STORAGE_FILE_OPEN_PERSISTENT_FILE  |
						   STORAGE_FILE_OPEN_PROINFO_FILE |
						   STORAGE_FILE_OPEN_VFS,
};
