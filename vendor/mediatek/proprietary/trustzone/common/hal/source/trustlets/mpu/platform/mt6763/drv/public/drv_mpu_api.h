...
#define msee_get_chip_hw_code mt_get_chip_hw_code
#define msee_set_emi_mpu_protection emi_mpu_set_region_protection
#define MSEE_SET_ACCESS_PERMISSON SET_ACCESS_PERMISSON
