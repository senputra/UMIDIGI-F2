...
LOCAL_SHARED_LIBRARIES_64 := libcutils libnetutils libc liblog libTEECommon libion libion_mtk
LOCAL_MULTILIB := 64
...
LOCAL_MODULE_SUFFIX := .so
LOCAL_PROPRIETARY_MODULE := true
LOCAL_SHARED_LIBRARIES := libcutils libnetutils libc liblog libTEECommon libion libion_mtk
LOCAL_MULTILIB := 32
