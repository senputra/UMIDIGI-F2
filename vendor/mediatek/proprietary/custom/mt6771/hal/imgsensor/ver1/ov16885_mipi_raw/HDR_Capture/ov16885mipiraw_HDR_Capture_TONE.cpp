...
const ISP_NVRAM_LCE_TUNING_PARAM_T ov16885mipiraw_LCE_0008 = {
        .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T ov16885mipiraw_GMA_0008 = {
        .GGM_Reg =
    {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov16885mipiraw_DCE_0008 = {
        .rDceParam=
    {
        100, //i4HistCCLB_DCE
        { //rDCELUTs
