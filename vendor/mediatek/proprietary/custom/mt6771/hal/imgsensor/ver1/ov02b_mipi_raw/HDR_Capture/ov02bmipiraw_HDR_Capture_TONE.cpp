...
const ISP_NVRAM_LCE_TUNING_PARAM_T ov02bmipiraw_LCE_0008 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T ov02bmipiraw_GMA_0008 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov02bmipiraw_DCE_0008 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
