...
const ISP_NVRAM_LCE_TUNING_PARAM_T gc2375mipiraw_LCE_0009 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T gc2375mipiraw_GMA_0009 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T gc2375mipiraw_DCE_0009 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
