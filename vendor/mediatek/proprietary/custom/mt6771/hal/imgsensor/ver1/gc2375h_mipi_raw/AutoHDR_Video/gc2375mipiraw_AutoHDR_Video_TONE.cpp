...
#include "gc2375mipiraw_AutoHDR_Video.h"

const ISP_NVRAM_LCE_TUNING_PARAM_T gc2375mipiraw_LCE_0004 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T gc2375mipiraw_GMA_0004 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T gc2375mipiraw_DCE_0004 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
