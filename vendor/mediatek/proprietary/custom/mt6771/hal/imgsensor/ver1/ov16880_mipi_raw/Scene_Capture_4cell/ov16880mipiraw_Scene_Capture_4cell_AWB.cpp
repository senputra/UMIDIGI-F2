...
#include "ov16880mipiraw_Scene_Capture_4cell.h"

#define NVRAM_AWB_TUNING_PARAM_NUM 7522001

const AWB_NVRAM_T ov16880mipiraw_AWB_0001 =
AWB_NVRAM_START
{
...
/******************************************************************************/
    ...
    //******************************************************************************//
        // AWB gain of AWB light source
        {
            ...
            // HORIZON
            {
                 ...
                 585, // AWBGAIN_HORIZON_G
                1560  // AWBGAIN_HORIZON_B
            },
            // A
            {
                 564, // AWBGAIN_A_R
    ...
    //******************************************************************************//
        // AWB light area
        {
            ...
            // TUNGSTEN
            {
                -137, // TUNGSTEN RightBound
                -795, // TUNGSTEN LeftBound
                -260, // TUNGSTEN UpperBound
                -391  // TUNGSTEN LowerBound
            },
            // WARM FLUORESCENT
            {
                -137, // WARM FLUORESCENT RightBound
                -795, // WARM FLUORESCENT LeftBound
                -391, // WARM FLUORESCENT UpperBound
                -548  // WARM FLUORESCENT LowerBound
            },
            // FLUORESCENT
            {
                  16, // FLUORESCENT RightBound
                -137, // FLUORESCENT LeftBound
                -304, // FLUORESCENT UpperBound
                -444  // FLUORESCENT LowerBound
            },
            // CWF
            {
                  73, // CWF RightBound
            ...
            // DAYLIGHT
            {
                 214, // DAYLIGHT RightBound
                  16, // DAYLIGHT LeftBound
                -304, // DAYLIGHT UpperBound
                -444  // DAYLIGHT LowerBound
            },
            // SHADE
            {
    ...
    //******************************************************************************//
        ...
        // PWB light area
        {
            ...
            // SHADE
            {
                 ...
                 164, // SHADE LeftBound
                -304, // SHADE UpperBound
                -444  // SHADE LowerBound
            },
            // TWILIGHT
            {
                  16, // TWILIGHT RightBound
                -144, // TWILIGHT LeftBound
                -304, // TWILIGHT UpperBound
                -444  // TWILIGHT LowerBound
            },
            // FLUORESCENT
            {
                 234, // FLUORESCENT RightBound
                -161, // FLUORESCENT LeftBound
                -314, // FLUORESCENT UpperBound
                -508  // FLUORESCENT LowerBound
            },
            // WARM FLUORESCENT
            {
                -150, // WARM FLUORESCENT RightBound
                -350, // WARM FLUORESCENT LeftBound
                -314, // WARM FLUORESCENT UpperBound
                -508  // WARM FLUORESCENT LowerBound
            },
            // INCANDESCENT
            {
                -150, // INCANDESCENT RightBound
                -350, // INCANDESCENT LeftBound
                -304, // INCANDESCENT UpperBound
                -444  // INCANDESCENT LowerBound
            },
            // GRAY_WORLD
            {
    ...
    //******************************************************************************//
        // PWB default gain
        {
            ...
            // FLUORESCENT
            {
                913, // PWB_FLUORESCENT_R
                 512, // PWB_FLUORESCENT_G
                875  // PWB_FLUORESCENT_B
            },
            // WARM FLUORESCENT
            {
                 608, // PWB_WARM FLUORESCENT_R
                 512, // PWB_WARM FLUORESCENT_G
                1264  // PWB_WARM FLUORESCENT_B
            },
            // INCANDESCENT
            {
                 580, // PWB_INCANDESCENT_R
                 512, // PWB_INCANDESCENT_G
                1199  // PWB_INCANDESCENT_B
            },
            // GRAY_WORLD
            {
    ...
    //******************************************************************************//
             // Sunset Prop
             {
                 ...
                 {
                       81, // i4Sunset_BoundXr_Thr
                     -391, // i4Sunset_BoundYr_Thr
                 },
             },
    //******************************************************************************//
    //Feature name:
    ...
    //******************************************************************************//
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-587, -263}, {-587, -263}, {-587, -263}},  // TUNGSTEN
                        {{-442, -281}, {-442, -281}, {-442, -281}},  // WARM FLUORESCENT
                        {{-265, -362}, {-265, -362}, {-265, -362}},  // FLUORESCENT
                        {{-195, -413}, {-195, -413}, {-195, -413}},  // CWF
                        {{ -138, -326}, { -138, -326}, { -138, -326}},  // DAYLIGHT
                        {{  -7, -289}, {  -7, -289}, {  -7, -289}},  // SHADE
                        {{  -19, -380}, {  -19, -380}, {  -19, -380}},  // DF
                    },
                },
