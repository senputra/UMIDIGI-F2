...
const ISP_NVRAM_LCE_TUNING_PARAM_T ov16885mipiraw_LCE_0004 = {
        .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T ov16885mipiraw_GMA_0004 = {
        .GGM_Reg =
    {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov16885mipiraw_DCE_0004 = {
        .rDceParam=
    {
        30, //i4HistCCLB_DCE
        { //rDCELUTs
