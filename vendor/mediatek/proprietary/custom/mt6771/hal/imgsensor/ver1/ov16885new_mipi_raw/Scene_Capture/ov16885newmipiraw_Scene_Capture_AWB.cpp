...
const AWB_NVRAM_T ov16885newmipiraw_AWB_0000 =
AWB_NVRAM_START
{
    ...
    //******************************************************************************//
        // AWB gain of AWB light source
        {
            ...
            // HORIZON
            {
                 ...
                 632, // AWBGAIN_HORIZON_G
                1780  // AWBGAIN_HORIZON_B
            },
            // A
            {
                 519, // AWBGAIN_A_R
    ...
    //******************************************************************************//
        // AWB light area
        {
            ...
            // TUNGSTEN
            {
                -173, // TUNGSTEN RightBound
                -837, // TUNGSTEN LeftBound
                -261, // TUNGSTEN UpperBound
                -401  // TUNGSTEN LowerBound
            },
            // WARM FLUORESCENT
            {
                -173, // WARM FLUORESCENT RightBound
                -837, // WARM FLUORESCENT LeftBound
                -401, // WARM FLUORESCENT UpperBound
                -568  // WARM FLUORESCENT LowerBound
            },
            // FLUORESCENT
            {
                  -21, // FLUORESCENT RightBound
                -173, // FLUORESCENT LeftBound
                -304, // FLUORESCENT UpperBound
                -461  // FLUORESCENT LowerBound
            },
            // CWF
            {
                  23, // CWF RightBound
            ...
            // DAYLIGHT
            {
                 153, // DAYLIGHT RightBound
                  -21, // DAYLIGHT LeftBound
                -304, // DAYLIGHT UpperBound
                -461  // DAYLIGHT LowerBound
            },
            // SHADE
            {
                 483, // SHADE RightBound
                 153, // SHADE LeftBound
                -304, // SHADE UpperBound
                -410  // SHADE LowerBound
            },
            // DF
            {
                 153, // DF RightBound
    ...
    //******************************************************************************//
        ...
        // PWB light area
        {
            ...
            // CLOUDY_D
            {
                 278, // CLOUDY_D RightBound
                 103, // CLOUDY_D LeftBound
                -304, // CLOUDY_D UpperBound
                -461  // CLOUDY_D LowerBound
            },
            // SHADE
            {
                 378, // SHADE RightBound
                 103, // SHADE LeftBound
                -304, // SHADE UpperBound
                -461  // SHADE LowerBound
            },
            // TWILIGHT
            {
                  -21, // TWILIGHT RightBound
                -181, // TWILIGHT LeftBound
                -304, // TWILIGHT UpperBound
                -461  // TWILIGHT LowerBound
            },
            // FLUORESCENT
            {
                 173, // FLUORESCENT RightBound
                -186, // FLUORESCENT LeftBound
                -314, // FLUORESCENT UpperBound
                -528  // FLUORESCENT LowerBound
            },
            // WARM FLUORESCENT
            {
                -204, // WARM FLUORESCENT RightBound
                -404, // WARM FLUORESCENT LeftBound
                -314, // WARM FLUORESCENT UpperBound
                -528  // WARM FLUORESCENT LowerBound
            },
            // INCANDESCENT
            {
                -204, // INCANDESCENT RightBound
                -404, // INCANDESCENT LeftBound
                -304, // INCANDESCENT UpperBound
                -461  // INCANDESCENT LowerBound
            },
            // GRAY_WORLD
            {
    ...
    //******************************************************************************//
        // PWB default gain
        {
            ...
            // FLUORESCENT
            {
                861, // PWB_FLUORESCENT_R
                 512, // PWB_FLUORESCENT_G
                950  // PWB_FLUORESCENT_B
            },
            // WARM FLUORESCENT
            {
                 560, // PWB_WARM FLUORESCENT_R
                 512, // PWB_WARM FLUORESCENT_G
                1380  // PWB_WARM FLUORESCENT_B
            },
            // INCANDESCENT
            {
                 533, // PWB_INCANDESCENT_R
                 512, // PWB_INCANDESCENT_G
                1305  // PWB_INCANDESCENT_B
            },
            // GRAY_WORLD
            {
    ...
    //******************************************************************************//
            ...
            {
                -560,  // RotatedXCoordinate0
                -427,  // RotatedXCoordinate1
                -209,  // RotatedXCoordinate2
                -112,  // RotatedXCoordinate3
    ...
    //******************************************************************************//
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-629, -264}, {-629, -264}, {-629, -264}},  // TUNGSTEN
                        {{-496, -288}, {-496, -288}, {-496, -288}},  // WARM FLUORESCENT
                        {{-290, -375}, {-290, -375}, {-290, -375}},  // FLUORESCENT
                        {{-235, -433}, {-235, -433}, {-235, -433}},  // CWF
                        {{ -180, -318}, { -180, -318}, { -180, -318}},  // DAYLIGHT
                        {{  -68, -289}, {  -68, -289}, {  -68, -289}},  // SHADE
                        {{  -81, -397}, {  -81, -397}, {  -81, -397}},  // DF
                    },
                },
