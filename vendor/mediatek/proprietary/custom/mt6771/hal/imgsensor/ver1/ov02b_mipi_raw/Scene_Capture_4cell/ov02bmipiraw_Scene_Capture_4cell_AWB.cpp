...
#include "ov02bmipiraw_Scene_Capture_4cell.h"

#define NVRAM_AWB_TUNING_PARAM_NUM 7522001

const AWB_NVRAM_T ov02bmipiraw_AWB_0001 =
AWB_NVRAM_START
{
...
//note: rGain = {0, 0 ,0} means this unit not doing calibration for DNP
    ...
    //******************************************************************************//
        // AWB gain of AWB light source
        {
            ...
            // HORIZON
            {
                 ...
                 655, // AWBGAIN_HORIZON_G
                1275  // AWBGAIN_HORIZON_B
            },
            // A
            {
                 512, // AWBGAIN_A_R
    ...
    //******************************************************************************//
        // AWB light area
        {
            ...
            // TUNGSTEN
            {
                -150, // TUNGSTEN RightBound
                -722, // TUNGSTEN LeftBound
                -108, // TUNGSTEN UpperBound
                -248  // TUNGSTEN LowerBound
            },
            // WARM FLUORESCENT
            {
                -150, // WARM FLUORESCENT RightBound
                -722, // WARM FLUORESCENT LeftBound
                -248, // WARM FLUORESCENT UpperBound
                -423  // WARM FLUORESCENT LowerBound
            },
            // FLUORESCENT
            {
                  -41, // FLUORESCENT RightBound
                -150, // FLUORESCENT LeftBound
                -155, // FLUORESCENT UpperBound
                -306  // FLUORESCENT LowerBound
            },
            // CWF
            {
                  21, // CWF RightBound
            ...
            // DAYLIGHT
            {
                 140, // DAYLIGHT RightBound
                  -41, // DAYLIGHT LeftBound
                -155, // DAYLIGHT UpperBound
                -306  // DAYLIGHT LowerBound
            },
            // SHADE
            {
                 470, // SHADE RightBound
                 140, // SHADE LeftBound
                -155, // SHADE UpperBound
                -262  // SHADE LowerBound
            },
            // DF
            {
                 140, // DF RightBound
    ...
    //******************************************************************************//
        ...
        // PWB light area
        {
            ...
            // CLOUDY_D
            {
                 265, // CLOUDY_D RightBound
                 90, // CLOUDY_D LeftBound
                -155, // CLOUDY_D UpperBound
                -306  // CLOUDY_D LowerBound
            },
            // SHADE
            {
                 365, // SHADE RightBound
                 90, // SHADE LeftBound
                -155, // SHADE UpperBound
                -306  // SHADE LowerBound
            },
            // TWILIGHT
            {
                  -41, // TWILIGHT RightBound
                -201, // TWILIGHT LeftBound
                -155, // TWILIGHT UpperBound
                -306  // TWILIGHT LowerBound
            },
            // FLUORESCENT
            {
                 160, // FLUORESCENT RightBound
                -193, // FLUORESCENT LeftBound
                -165, // FLUORESCENT UpperBound
                -383  // FLUORESCENT LowerBound
            },
            // WARM FLUORESCENT
            {
                -136, // WARM FLUORESCENT RightBound
                -336, // WARM FLUORESCENT LeftBound
                -165, // WARM FLUORESCENT UpperBound
                -383  // WARM FLUORESCENT LowerBound
            },
            // INCANDESCENT
            {
                -136, // INCANDESCENT RightBound
                -336, // INCANDESCENT LeftBound
                -155, // INCANDESCENT UpperBound
                -306  // INCANDESCENT LowerBound
            },
            // GRAY_WORLD
            {
    ...
    //******************************************************************************//
        // PWB default gain
        {
            ...
            // FLUORESCENT
            {
                701, // PWB_FLUORESCENT_R
                 512, // PWB_FLUORESCENT_G
                781  // PWB_FLUORESCENT_B
            },
            // WARM FLUORESCENT
            {
                 508, // PWB_WARM FLUORESCENT_R
                 512, // PWB_WARM FLUORESCENT_G
                1023  // PWB_WARM FLUORESCENT_B
            },
            // INCANDESCENT
            {
                 481, // PWB_INCANDESCENT_R
                 512, // PWB_INCANDESCENT_G
                960  // PWB_INCANDESCENT_B
            },
            // GRAY_WORLD
            {
    ...
    //******************************************************************************//
            ...
            {
                -432,  // RotatedXCoordinate0
                -346,  // RotatedXCoordinate1
                -203,  // RotatedXCoordinate2
                -126,  // RotatedXCoordinate3
    ...
    //******************************************************************************//
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-514, -111}, {-514, -111}, {-514, -111}},  // TUNGSTEN
                        {{-428, -146}, {-428, -146}, {-428, -146}},  // WARM FLUORESCENT
                        {{-297, -210}, {-297, -210}, {-297, -210}},  // FLUORESCENT
                        {{-224, -288}, {-224, -288}, {-224, -288}},  // CWF
                        {{ -207, -198}, { -207, -198}, { -207, -198}},  // DAYLIGHT
                        {{  -81, -140}, {  -81, -140}, {  -81, -140}},  // SHADE
                        {{  -99, -252}, {  -99, -252}, {  -99, -252}},  // DF
                    },
                },
