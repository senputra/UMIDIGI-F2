...
const ISP_NVRAM_LCE_TUNING_PARAM_T ov2659mipiyuv_LCE_0001 = {
    .i4AutoHDREnable =
        0,
...
const ISP_NVRAM_GMA_STRUCT_T ov2659mipiyuv_GMA_0001 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov2659mipiyuv_DCE_0001 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
