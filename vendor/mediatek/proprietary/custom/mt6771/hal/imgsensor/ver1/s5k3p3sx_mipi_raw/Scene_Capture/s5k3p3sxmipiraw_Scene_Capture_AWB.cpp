//Chenyee <CY_BSP_CAMERA> <zhanght> <20180207> add for CSW1703A begin
/* Copyright Statement:
 *
...
const AWB_NVRAM_T s5k3p3sxmipiraw_AWB_0000 =
AWB_NVRAM_START
{
    ...
    //******************************************************************************//
        // AWB gain of AWB light source
        {
            ...
            // HORIZON
            {
                 519, // AWBGAIN_HORIZON_R
                 512, // AWBGAIN_HORIZON_G
                1533  // AWBGAIN_HORIZON_B
            },
            // A
            {
                 653, // AWBGAIN_A_R
    ...
    //******************************************************************************//
        // AWB light area
        {
            ...
            // TUNGSTEN
            {
                -118, // TUNGSTEN RightBound
                -800, // TUNGSTEN LeftBound
                -335, // TUNGSTEN UpperBound
                -472  // TUNGSTEN LowerBound
            },
            // WARM FLUORESCENT
            {
                -118, // WARM FLUORESCENT RightBound
                -800, // WARM FLUORESCENT LeftBound
                -472, // WARM FLUORESCENT UpperBound
                -651  // WARM FLUORESCENT LowerBound
            },
            // FLUORESCENT
            {
                  37, // FLUORESCENT RightBound
                -118, // FLUORESCENT LeftBound
                -373, // FLUORESCENT UpperBound
                -540  // FLUORESCENT LowerBound
            },
            // CWF
            {
                  92, // CWF RightBound
            ...
            // DAYLIGHT
            {
                 258, // DAYLIGHT RightBound
                  37, // DAYLIGHT LeftBound
                -373, // DAYLIGHT UpperBound
                -540  // DAYLIGHT LowerBound
            },
            // SHADE
            {
                 588, // SHADE RightBound
                 258, // SHADE LeftBound
                -373, // SHADE UpperBound
                -484  // SHADE LowerBound
            },
            // DF
            {
                 258, // DF RightBound
    ...
    //******************************************************************************//
        ...
        // PWB light area
        {
            ...
            // CLOUDY_D
            {
                 383, // CLOUDY_D RightBound
                 208, // CLOUDY_D LeftBound
                -373, // CLOUDY_D UpperBound
                -540  // CLOUDY_D LowerBound
            },
            // SHADE
            {
                 483, // SHADE RightBound
                 208, // SHADE LeftBound
                -373, // SHADE UpperBound
                -540  // SHADE LowerBound
            },
            // TWILIGHT
            {
                  37, // TWILIGHT RightBound
                -123, // TWILIGHT LeftBound
                -373, // TWILIGHT UpperBound
                -540  // TWILIGHT LowerBound
            },
            // FLUORESCENT
            {
                 278, // FLUORESCENT RightBound
                -133, // FLUORESCENT LeftBound
                -383, // FLUORESCENT UpperBound
                -611  // FLUORESCENT LowerBound
            },
            // WARM FLUORESCENT
            {
                -146, // WARM FLUORESCENT RightBound
                -346, // WARM FLUORESCENT LeftBound
                -383, // WARM FLUORESCENT UpperBound
                -611  // WARM FLUORESCENT LowerBound
            },
            // INCANDESCENT
            {
                -146, // INCANDESCENT RightBound
                -346, // INCANDESCENT LeftBound
                -373, // INCANDESCENT UpperBound
                -540  // INCANDESCENT LowerBound
            },
            // GRAY_WORLD
            {
    ...
    //******************************************************************************//
        // PWB default gain
        {
            ...
            // FLUORESCENT
            {
                1107, // PWB_FLUORESCENT_R
                 512, // PWB_FLUORESCENT_G
                910  // PWB_FLUORESCENT_B
            },
            // WARM FLUORESCENT
            {
                 719, // PWB_WARM FLUORESCENT_R
                 512, // PWB_WARM FLUORESCENT_G
                1400  // PWB_WARM FLUORESCENT_B
            },
            // INCANDESCENT
            {
                 681, // PWB_INCANDESCENT_R
                 512, // PWB_INCANDESCENT_G
                1325  // PWB_INCANDESCENT_B
            },
            // GRAY_WORLD
            {
    ...
    //******************************************************************************//
            ...
            {
                -628,  // RotatedXCoordinate0
                -474,  // RotatedXCoordinate1
                -261,  // RotatedXCoordinate2
    ...
    //******************************************************************************//
        // Preference gain for each light source
        {
            ...
            { // DAYLIGHT
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {510, 512, 515},
                //    LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17             LV18
                {508, 512, 518}, {506, 512, 522}, {506, 512, 522}, {506, 512, 522}, {506, 512, 522}, {506, 512, 522}, {506, 512, 522}, {506, 512, 522}, {506, 512, 522}
            },
            { // SHADE
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {510, 512, 515},
    ...
    //******************************************************************************//
             // Sunset Prop
             {
                 ...
                 {
                       96, // i4Sunset_BoundXr_Thr
                     -444, // i4Sunset_BoundYr_Thr
                 },
             },
    //******************************************************************************//
    //Feature name:
    ...
    //******************************************************************************//
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-592, -338}, {-592, -338}, {-592, -338}},  // TUNGSTEN
                        {{-438, -353}, {-438, -353}, {-438, -353}},  // WARM FLUORESCENT
                        {{-237, -451}, {-237, -451}, {-237, -451}},  // FLUORESCENT
                        {{-193, -516}, {-193, -516}, {-193, -516}},  // CWF
                        {{ -121, -379}, { -121, -379}, { -121, -379}},  // DAYLIGHT
                        {{  37, -358}, {  37, -358}, {  37, -358}},  // SHADE
                        {{  23, -479}, {  23, -479}, {  23, -479}},  // DF
                    },
                },
