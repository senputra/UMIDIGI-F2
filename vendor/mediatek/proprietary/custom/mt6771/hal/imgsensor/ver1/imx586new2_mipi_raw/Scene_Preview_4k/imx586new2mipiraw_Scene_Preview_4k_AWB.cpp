...
#include "imx586new2mipiraw_Scene_Preview_4k.h"

const AWB_NVRAM_T imx586new2mipiraw_AWB_0002 =
AWB_NVRAM_START
{
...
//Feature name:
    ...
    //******************************************************************************//
        // AWB Light source probability (P1) look-up table (Max: 100; Min: 0)
        {
            ...
            {{  80,  80,  80,  80,  80,  80, 100, 100, 100, 100, 100,  83,  50,  40,  33,  33,  20,  20,  20}}, // SHADE
