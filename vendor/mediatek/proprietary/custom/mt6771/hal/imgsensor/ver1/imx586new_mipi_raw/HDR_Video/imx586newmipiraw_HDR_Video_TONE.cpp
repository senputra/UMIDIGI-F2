...
const ISP_NVRAM_LCE_TUNING_PARAM_T imx586newmipiraw_LCE_0007 = {
        .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T imx586newmipiraw_GMA_0007 = {
        .GGM_Reg =
    {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T imx586newmipiraw_DCE_0007 = {
        .rDceParam=
    {
        30, //i4HistCCLB_DCE
        { //rDCELUTs
