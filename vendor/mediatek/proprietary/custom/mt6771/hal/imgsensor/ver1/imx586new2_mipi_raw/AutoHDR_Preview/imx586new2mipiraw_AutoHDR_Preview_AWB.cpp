...
#include "imx586new2mipiraw_AutoHDR_Preview.h"

const AWB_NVRAM_T imx586new2mipiraw_AWB_0003 =
AWB_NVRAM_START
{
    ...
    //******************************************************************************//
        // AWB daylight locus probability (Statistic Weighting) look-up table (Max: 100; Min: 0)
        {
            ...
            {{  100,  100,  100,  100,  100,  100,  100,  100,  100,  90,  80,  55,  30,  30,  30,  30,   0,   0,   0}}, // CWF
