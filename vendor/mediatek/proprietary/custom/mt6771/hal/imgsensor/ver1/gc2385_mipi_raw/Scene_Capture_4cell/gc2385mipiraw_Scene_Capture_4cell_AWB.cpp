...
#include "gc2385mipiraw_Scene_Capture_4cell.h"

#define NVRAM_AWB_TUNING_PARAM_NUM 7522001

const AWB_NVRAM_T gc2385mipiraw_AWB_0001 =
AWB_NVRAM_START
{
    ...
    //******************************************************************************//
        // AWB gain of AWB light source
        {
            ...
            // HORIZON
            {
                 ...
                 726, // AWBGAIN_HORIZON_G
                1500  // AWBGAIN_HORIZON_B
            },
            // A
            {
                 512, // AWBGAIN_A_R
    ...
    //******************************************************************************//
        // AWB light area
        {
            ...
            // TUNGSTEN
            {
                -253, // TUNGSTEN RightBound
                -807, // TUNGSTEN LeftBound
                -29, // TUNGSTEN UpperBound
                -184  // TUNGSTEN LowerBound
            },
            // WARM FLUORESCENT
            {
                -253, // WARM FLUORESCENT RightBound
                -807, // WARM FLUORESCENT LeftBound
                -184, // WARM FLUORESCENT UpperBound
                -369  // WARM FLUORESCENT LowerBound
            },
            // FLUORESCENT
            {
                  -152, // FLUORESCENT RightBound
                -253, // FLUORESCENT LeftBound
                -79, // FLUORESCENT UpperBound
                -259  // FLUORESCENT LowerBound
            },
            // CWF
            {
                  -103, // CWF RightBound
            ...
            // DAYLIGHT
            {
                 37, // DAYLIGHT RightBound
                  -152, // DAYLIGHT LeftBound
                -79, // DAYLIGHT UpperBound
                -259  // DAYLIGHT LowerBound
            },
            // SHADE
            {
                 367, // SHADE RightBound
                 37, // SHADE LeftBound
                -79, // SHADE UpperBound
                -195  // SHADE LowerBound
            },
            // DF
            {
                 37, // DF RightBound
    ...
    //******************************************************************************//
        ...
        // PWB light area
        {
            // DAYLIGHT
            {
                 5000, // DAYLIGHT RightBound
                  -5000, // DAYLIGHT LeftBound
                5000, // DAYLIGHT UpperBound
                -5000  // DAYLIGHT LowerBound
            },
            // CLOUDY_D
            {
                 162, // CLOUDY_D RightBound
                 -13, // CLOUDY_D LeftBound
                -79, // CLOUDY_D UpperBound
                -259  // CLOUDY_D LowerBound
            },
            // SHADE
            {
                 262, // SHADE RightBound
                 -13, // SHADE LeftBound
                -79, // SHADE UpperBound
                -259  // SHADE LowerBound
            },
            // TWILIGHT
            {
                  -152, // TWILIGHT RightBound
                -312, // TWILIGHT LeftBound
                -79, // TWILIGHT UpperBound
                -259  // TWILIGHT LowerBound
            },
            // FLUORESCENT
            {
                 57, // FLUORESCENT RightBound
                -304, // FLUORESCENT LeftBound
                -89, // FLUORESCENT UpperBound
                -329  // FLUORESCENT LowerBound
            },
            // WARM FLUORESCENT
            {
                -226, // WARM FLUORESCENT RightBound
                -426, // WARM FLUORESCENT LeftBound
                -89, // WARM FLUORESCENT UpperBound
                -329  // WARM FLUORESCENT LowerBound
            },
            // INCANDESCENT
            {
                -226, // INCANDESCENT RightBound
                -426, // INCANDESCENT LeftBound
                -79, // INCANDESCENT UpperBound
                -259  // INCANDESCENT LowerBound
            },
            // GRAY_WORLD
            {
    ...
    //******************************************************************************//
        // PWB default gain
        {
            ...
            // FLUORESCENT
            {
                597, // PWB_FLUORESCENT_R
                 512, // PWB_FLUORESCENT_G
                794  // PWB_FLUORESCENT_B
            },
            // WARM FLUORESCENT
            {
                 465, // PWB_WARM FLUORESCENT_R
                 512, // PWB_WARM FLUORESCENT_G
                1068  // PWB_WARM FLUORESCENT_B
            },
            // INCANDESCENT
            {
                 439, // PWB_INCANDESCENT_R
                 512, // PWB_INCANDESCENT_G
                1017  // PWB_INCANDESCENT_B
            },
            // GRAY_WORLD
            {
    ...
    //******************************************************************************//
            ...
            {
                -414,  // RotatedXCoordinate0
                -333,  // RotatedXCoordinate1
                -211,  // RotatedXCoordinate2
                -134,  // RotatedXCoordinate3
    ...
    //******************************************************************************//
        // Preference gain for each light source
        {
            ...
            { // WARM FLUORESCENT
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {510, 512, 510}, {516, 512, 520}, {512, 512, 516}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512},
                //    LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17             LV18
                {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
            },
            { // FLUORESCENT
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {508, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {506, 512, 512}, {504, 512, 512}, {502, 512, 512}, {502, 512, 512}, {503, 512, 512}, {503, 512, 512},
                //    LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17             LV18
                {507, 512, 508}, {507, 512, 504}, {510, 512, 500}, {508, 512, 500}, {508, 512, 502}, {508, 512, 506}, {508, 512, 506}, {508, 512, 506}, {508, 512, 506}
            },
            { // CWF
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {508, 512, 512}, {512, 512, 524}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {508, 512, 512}, {504, 512, 512}, {500, 512, 512}, {500, 512, 512},
                //    LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17             LV18
                {500, 512, 508}, {504, 512, 508}, {508, 512, 508}, {512, 512, 508}, {512, 512, 508}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
            },
            { // DAYLIGHT
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {508, 512, 512}, {516, 512, 522}, {516, 512, 520}, {516, 512, 520}, {512, 512, 512}, {505, 512, 516}, {505, 512, 516}, {505, 512, 512}, {508, 512, 508}, {516, 512, 508},
                //    LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17             LV18
                {510, 512, 498}, {510, 512, 500}, {516, 512, 490}, {518, 512, 498}, {510, 512, 512}, {506, 512, 512}, {506, 512, 514}, {506, 512, 516}, {506, 512, 516}
            },
            { // SHADE
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {508, 512, 512}, {508, 512, 512}, {508, 512, 512}, {512, 512, 508}, {512, 512, 512}, {508, 512, 512}, {512, 512, 512}, {512, 512, 508}, {512, 512, 500}, {512, 512, 500},
                //    LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17             LV18
                {512, 512, 502}, {512, 512, 508}, {512, 512, 512}, {508, 512, 514}, {504, 512, 516}, {504, 512, 516}, {504, 512, 516}, {504, 512, 516}, {504, 512, 516}
            },
            { // DF
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {524, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 514}, {512, 512, 516}, {512, 512, 520}, {512, 512, 520}, {512, 512, 516}, {500, 512, 514},
                //    LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17             LV18
    ...
    //******************************************************************************//
         ...
         {
             { // TUNGSTEN
                 {   0,  481, 963, 1444, 1926, 2407, 2889, 3370, 3852, 4333, 4815, 5296, 5778, 6259, 6741, 7222, 7704, 8185, 8667, 9148, 9630},
                 {   0,  914,  577, 722, 914, 1059, 1300, 1444, 1588, 1733, 1926, 2118, 2311, 2503, 2696, 2889, 3274, 3659, 4044, 4429, 4815}
             },
             { // WARM FLUORESCENT
                 {   0,  481, 963, 1444, 1926, 2407, 2889, 3370, 3852, 4333, 4815, 5296, 5778, 6259, 6741, 7222, 7704, 8185, 8667, 9148, 9630},
                 {   0,  433,  718, 1055, 1296, 1437, 1629, 1922, 2214, 2407, 2600, 2792, 2985, 3177, 3370, 3563, 3755, 3852, 3852, 3852, 3852}
             },
             { // SHADE
                 {   0,  614, 1229, 1844, 2458, 3073, 3688, 4303, 4917, 5532, 6147, 6762, 7376, 7991, 8606, 9221, 9835, 10450, 11065, 11680, 12294},
                 {   0,  429, 982, 1700, 2212, 2827, 3688, 4548, 5532, 5532, 6147, 6762, 7376, 7991, 8606, 9221, 9835, 10450, 11065, 11680, 12294}
             },
         },
    //******************************************************************************//
    //Feature name:
    ...
    //******************************************************************************//
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-599, -32}, {-599, -32}, {-599, -32}},  // TUNGSTEN
                        {{-518, -58}, {-518, -58}, {-518, -58}},  // WARM FLUORESCENT
                        {{-408, -171}, {-408, -171}, {-408, -171}},  // FLUORESCENT
                        {{-356, -234}, {-356, -234}, {-356, -234}},  // CWF
                        {{ -318, -98}, { -318, -98}, { -318, -98}},  // DAYLIGHT
                        {{  -184, -64}, {  -184, -64}, {  -184, -64}},  // SHADE
                        {{  -214, -195}, {  -214, -195}, {  -214, -195}},  // DF
                    },
                },
            ...
            {
                1,    //i4Enable
                {0, 18, 18, 18, 18, 18, 18, 18},  //i4StatWinShrinkOffset
                0,    //Reserved1
                0,    //Reserved2
                0,    //Reserved3
                0,    //Reserved4
    ...
    // AWB Statistics Parameter
    {
        ...
        0x00000FFF, // Maximum limit clipping for R color
        0x00000FFF, // Maximum limit clipping for G color
        0x00000FFF, // Maximum limit clipping for B color
        // AWB error threshold
