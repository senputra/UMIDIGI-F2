...
const ISP_NVRAM_LCE_TUNING_PARAM_T ov2659mipiyuv_LCE_0010 = {
    .i4AutoHDREnable =
        0,
...
const ISP_NVRAM_GMA_STRUCT_T ov2659mipiyuv_GMA_0010 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov2659mipiyuv_DCE_0010 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
