...
#include "ov2659mipiyuv_AutoHDR_Preview.h"

const ISP_NVRAM_LCE_TUNING_PARAM_T ov2659mipiyuv_LCE_0003 = {
    .i4AutoHDREnable =
        0,
...
const ISP_NVRAM_GMA_STRUCT_T ov2659mipiyuv_GMA_0003 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov2659mipiyuv_DCE_0003 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
