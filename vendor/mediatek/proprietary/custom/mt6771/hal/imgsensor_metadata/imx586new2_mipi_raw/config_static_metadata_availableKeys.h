...
STATIC_METADATA2_BEGIN(PLATFORM, AVAILABLE_KEYS, SENSOR_DRVNAME_IMX586NEW2_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
...
//        CONFIG_ENTRY_VALUE(MTK_SENSOR_EXPOSURE_TIME, MINT32)
    ...
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_REQUEST_KEYS)//new hidden
        CONFIG_ENTRY_VALUE(MTK_STREAMING_FEATURE_XAPI_ROTATION, MINT32)
    APPEND_METADATA_END()
    //==========================================================================
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_RESULT_KEYS)//new hidden
        CONFIG_ENTRY_VALUE(MTK_STREAMING_FEATURE_XAPI_SCENE_RESULT, MINT32)
    APPEND_METADATA_END()
    #endif
    //xapi added, end
    //==========================================================================
    ...
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_SESSION_KEYS)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_CAPTURE_XAPI_PRV_FEATURE, MINT32)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_CAPTURE_XAPI_CAP_FEATURE, MINT32)
    APPEND_METADATA_END()
    #endif
    //xapi added, end
    //==========================================================================
